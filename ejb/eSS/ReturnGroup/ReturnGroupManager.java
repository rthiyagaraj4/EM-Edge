...
*	view-type="both"
*	jndi-name="ReturnGroup"
*	local-jndi-name="ReturnGroup"
*	impl-class-name="eSS.ReturnGroup.ReturnGroupManager"
...
*	local-class="eSS.ReturnGroup.ReturnGroupLocal"
*	remote-class="eSS.ReturnGroup.ReturnGroupRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eSS.ReturnGroup.ReturnGroupLocalHome"
*	remote-class="eSS.ReturnGroup.ReturnGroupHome"
*	generate= "local,remote"
*
*
*/
...
public class  ReturnGroupManager extends SsEJBSessionAdapter {
...
/**
	...
	*/
	...
	public HashMap insert(HashMap hmData, HashMap hmSQL)	{
		...
		try {
			...
			System.err.println("@@@@@ 222 sql="+sql);
			System.err.println("@@@@@ 222 alData="+alData);
			preparedStatement = connection.prepareStatement(sql);
			setData(preparedStatement,alData);
			iResult = preparedStatement.executeUpdate();
	...
	*/
	...
	public HashMap modify(HashMap hmData, HashMap hmSQL)	 {
		...
		System.err.println("@@@@  managaer modify");
		Connection	connection = null;
		HashMap hmReturn = new HashMap();
		PreparedStatement preparedStatement	=	null;
		String sql =	"";
		...
		try {
			...
			// Added by Sakti against 48905. Commit not happened for case:1
			if(isUpdateSuccessful){
					connection.commit();
					hmReturn.put(RESULT,TRUE);
					hmReturn.put(MESSAGE,RECORD_MODIFIED);  
