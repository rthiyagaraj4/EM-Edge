...
*	view-type="both"
*	jndi-name="CheckList"
*	local-jndi-name="CheckList"
*	impl-class-name="eSS.CheckList.CheckListManager"
*	
*
* @ejb.interface
*	extends="javax.ejb.EJBObject"
*	local-extends="javax.ejb.EJBLocalObject" 
*	local-class="eSS.CheckList.CheckListLocal"
*	remote-class="eSS.CheckList.CheckListRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eSS.CheckList.CheckListLocalHome"
*	remote-class="eSS.CheckList.CheckListHome"
*	generate= "local,remote"
*
*
*/

public class CheckListManager extends StEJBSessionAdapter
{
...
//			System.err.println("arrHDrUpdData--------in ejb----->"+arrHDrUpdData);
...
//			System.err.println("arrDtlUpdData--------in ejb----->"+arrDtlUpdData);
			...
			//System.err.println("hashmapResult-------line 103---->"+hashmapResult);

			throwExceptionWhenFailed(hashmapResult);

			arrDtlInsertData = (ArrayList)hashmap.get("DtlInsertData");
//			System.err.println("arrDtlDeletedata--------110----->"+arrDtlInsertData);
			if(arrDtlInsertData.size()>0){
				hashmapHDrUpdData.put("DATA",arrDtlInsertData);
				hashmapHDrUpdDataQ.put(BATCH_SQL,dtlInsertSQL);
				hashmapResult =  operateBatch(connection, hashmapHDrUpdData, hashmapHDrUpdDataQ);
				//System.err.println("hashmapResult-------line 110---->"+hashmapResult);
				throwExceptionWhenFailed(hashmapResult);
			}

/*			arrDtlDeletedata = (ArrayList)hashmap.get("DtlDeleteData");
			System.err.println("arrDtlDeletedata--------114----->"+arrDtlDeletedata);
			if(arrDtlDeletedata.size()>0){
				...
				//System.err.println("hashmapResult--------123----->"+hashmapResult);
