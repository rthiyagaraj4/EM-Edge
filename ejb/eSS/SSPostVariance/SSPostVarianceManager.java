...
*	view-type="both"
*	jndi-name="SSPostVariance"
*	local-jndi-name="SSPostVariance"
*	impl-class-name="eSS.SSPostVariance.SSPostVarianceManager"
...
*	local-class="eSS.SSPostVariance.SSPostVarianceLocal"
*	remote-class="eSS.SSPostVariance.SSPostVarianceRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eSS.SSPostVariance.SSPostVarianceLocalHome"
*	remote-class="eSS.SSPostVariance.SSPostVarianceHome"
*	generate= "local,remote"
*
*
*/
...
public class  SSPostVarianceManager extends SsEJBSessionAdapter {
...
//		ArrayList alRecords = new ArrayList();
		...
		try {
			...
			message_id = callableStatement.getString(9);
			value = callableStatement.getInt(10);
			if (value>=0) {
				result = true;
				connection.commit();
			}
