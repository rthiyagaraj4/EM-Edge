...
*
* @ejb.bean
*	name="VendorLoanRequest"
*	type="Stateless"
*	transaction-type="Bean"
*	view-type="both"
*	jndi-name="VendorLoanRequest"
*	local-jndi-name="VendorLoanRequest"
*	impl-class-name="eSS.VendorLoanRequest.VendorLoanRequestManager"
...
*	local-class="eSS.VendorLoanRequest.VendorLoanRequestLocal"
*	remote-class="eSS.VendorLoanRequest.VendorLoanRequestRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eSS.VendorLoanRequest.VendorLoanRequestLocalHome"
*	remote-class="eSS.VendorLoanRequest.VendorLoanRequestHome"
*	generate= "local,remote"
*
*
*/
...
public class  VendorLoanRequestManager extends SsEJBSessionAdapter {
	...
	*/
	...
	public HashMap delete( HashMap hmData, HashMap hmSQL ) {
		...
		try {
			...
			/*	stSQL				=	(String)	hmSQL.get ("UpdateGroupForStoreReduceSQL");Commented against IN057333
...
/**
	...
	*/
	...
	public HashMap insert(HashMap hmData, HashMap hmSQL) {
		...
		//ArrayList	alPendReqData		=	null; Commented for unused variable IN063878
		...
		/*		alPendReqData		=	new ArrayList();Commented against IN057333			
	...
	public HashMap modify(HashMap hmData, HashMap hmSQL) {
		...
		try {
			...
			for (int i=0; i<alDtlData.size();i++ ) {
				...
				/*	stSQL				=	(String)	hmSQL.get ("UpdateGroupForStoreSQL");Commented against IN057333
					hmArgData.put(DATA,alPendReqData);
					hmArgSQL.put(UPDATE_SQL,stSQL);
					hmResult	=	update(connection, hmArgData, hmArgSQL);
