 ...
 ******************************************************************************/
package eOR.ORSpecimenForOrderable;
...
*
* @ejb.bean
*	name="ORSpecimenForOrderable"
*	type="Stateless"
*	transaction-type="Bean"
*	view-type="both"
*	jndi-name="ORSpecimenForOrderable"
*	local-jndi-name="ORSpecimenForOrderable"
*	impl-class-name="eOR.ORSpecimenForOrderable.ORSpecimenForOrderableManager"
*	
*
* @ejb.interface
*	extends="javax.ejb.EJBObject"
*	local-extends="javax.ejb.EJBLocalObject" 
*	local-class="eOR.ORSpecimenForOrderable.ORSpecimenForOrderableLocal"
*	remote-class="eOR.ORSpecimenForOrderable.ORSpecimenForOrderableRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eOR.ORSpecimenForOrderable.ORSpecimenForOrderableLocalHome"
*	remote-class="eOR.ORSpecimenForOrderable.ORSpecimenForOrderableHome"
*	generate= "local,remote"
*
*
*/

public class ORSpecimenForOrderableManager extends OrEJBSessionAdapter {
...
*/
    ...
    public HashMap insert( HashMap tabDataParam, HashMap sqlMap ){
		...
		int [] deleteCounts ;
		int [] updateCounts ;
        String SQL_OR_SPECIMEN_FOR_ORDERABLE_INSERT = (String) sqlMap.get("SQL_OR_SPECIMEN_FOR_ORDERABLE_INSERT");
		String SQL_OR_SPECIMEN_FOR_ORDERABLE_DELETE = (String) sqlMap.get("SQL_OR_SPECIMEN_FOR_ORDERABLE_DELETE");
		String SQL_OR_SPECIMEN_FOR_ORDERABLE_UPDATE_DEFAULT_YN= (String) sqlMap.get("SQL_OR_SPECIMEN_FOR_ORDERABLE_UPDATE_DEFAULT_YN");
		...
		try{
			...
			if(updateArrList.size() >0)
				...
				update_flag = true;
              if(insertArrList.size() >0){
				pstmt					= connection.prepareStatement(SQL_OR_SPECIMEN_FOR_ORDERABLE_INSERT);
			...
			if(insert_flag && deleteArrList.size() >0 ){
                pstmt_del	= connection.prepareStatement(SQL_OR_SPECIMEN_FOR_ORDERABLE_DELETE);
