...
*	view-type="both"
*	jndi-name="PHProblemStage"
*	local-jndi-name="PHProblemStage"
*	impl-class-name="ePH.PHProblemStage.PHProblemStageManager"
*	
*
* @ejb.interface
*	extends="javax.ejb.EJBObject"
*	local-extends="javax.ejb.EJBLocalObject" 
*	local-class="ePH.PHProblemStage.PHProblemStageLocal"
*	remote-class="ePH.PHProblemStage.PHProblemStageRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="ePH.PHProblemStage.PHProblemStageLocalHome"
*	remote-class="ePH.PHProblemStage.PHProblemStageHome"
*	generate= "local,remote"
*
*
*/
...
public class PHProblemStageManager extends PhEJBSessionAdapter {
/**
	...
	*/
	...
	try {
		...
		String SQL_PH_PROBLEM_STAGE_INSERT				= (String) sqlMap.get("SQL_PH_PROBLEM_STAGE_INSERT");
		String SQL_PH_PROBLEM_STAGE_DUPLICATE_CHK_MULIPLE = (String) sqlMap.get("SQL_PH_PROBLEM_STAGE_DUPLICATE_CHK_MULIPLE");
		...
		for(int s=1 ; s <= noOfRecords ; s++){
			...
			sqlParam2 = sqlParam2 + "'" + (String)temp.get("problem_stage_id") + "',";
		}
...
//		int result=0;
		...
		String duplicates[] = giveDuplicateValues(SQL_PH_PROBLEM_STAGE_DUPLICATE_CHK_MULIPLE,connection,arrChkDup);
		if(duplicates != null )
		{
...
//		  String msg =  "@for following ID" ;
		...
		/*Batch insertion*/
		pstmt = connection.prepareStatement(SQL_PH_PROBLEM_STAGE_INSERT);

		for(int k=1 ; k<= noOfRecords ; k++){

				HashMap tabData  = (HashMap)tabDataMultiple.get(String.valueOf(k));
				traceVal.append(tabData.toString());
				pstmt.setString(1 ,(String)tabData.get("problem_stage_id"));
				pstmt.setString(2 ,(String)tabData.get("indicator"));
				pstmt.setString(3 ,(String)tabData.get("problem_stage_short_desc"));
				pstmt.setString(4 ,(String)tabData.get("problem_stage_long_desc"));
...
/****************************************************************************/
	...
	*/
	public HashMap modify( HashMap tabDataParam, HashMap sqlMap )  {
		...
		connection  = null ;
		Properties pt =	(Properties)tabDataParam.get( "properties" ) ;
		String SQL_PH_PROBLEM_STAGE_UPDATE = (String) sqlMap.get("SQL_PH_PROBLEM_STAGE_UPDATE");
		try
		{
			 connection = getConnection(pt) ;
			 HashMap tabData = (HashMap)tabDataParam.get("records");
	         pstmt = connection.prepareStatement(SQL_PH_PROBLEM_STAGE_UPDATE);
			 pstmt.setString(1 ,(String)tabData.get("problem_stage_long_desc"));
			 pstmt.setString(2 ,(String)tabData.get("problem_stage_short_desc"));
			 ...
			 pstmt.setString(7 ,((String)tabData.get("problem_stage_id")).trim());
