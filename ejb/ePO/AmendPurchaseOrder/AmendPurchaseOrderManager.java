...
*
* @ejb.bean
*	name="AmendPurchaseOrder"
*	type="Stateless"
*	transaction-type="Bean"
*	view-type="both" 
*	jndi-name="AmendPurchaseOrder"
*	local-jndi-name="AmendPurchaseOrder"
*	impl-class-name="ePO.AmendPurchaseOrder.AmendPurchaseOrderManager"
*	
*
* @ejb.interface
*	extends="javax.ejb.EJBObject"
*	local-extends="javax.ejb.EJBLocalObject" 
*	local-class="ePO.AmendPurchaseOrder.AmendPurchaseOrderLocal"
*	remote-class="ePO.AmendPurchaseOrder.AmendPurchaseOrderRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="ePO.AmendPurchaseOrder.AmendPurchaseOrderLocalHome"
*	remote-class="ePO.AmendPurchaseOrder.AmendPurchaseOrderHome"
*	generate= "local,remote"
*
*
*/
...
public class  AmendPurchaseOrderManager extends PoEJBSessionAdapter {
...
//		String   trn_type		=	"PO";
	...
	//		ArrayList	alStatusData			=	null;
		...
		try {
			...
			// Insert Item Delivery Detail Value
			
				ArrayList delivery_dtl=(ArrayList) hmData.get("DELIVERY_DTL");
			...
			// Insert Bill Delivery Details Value
				...
				preparedStatement = connection.prepareStatement(sql);
				setData(preparedStatement,alData);
				iBillResult = preparedStatement.executeUpdate();
				if(preparedStatement!=null)
						preparedStatement.close();
				if(iBillResult != 0) {
					hmReturn.put(RESULT,TRUE);
					...
					connection.rollback();
					throw new EJBException("Insert failed in Bill Delivery");
				}
				iaResult = null;
				sql = null;
				alData = null;
...
//		int sResult = 0;
		...
		try {
			...
			if(alData.get(3).equals("RA")){
				int rev_no = Integer.parseInt((String)alData.get(0));
				alData.set(0,""+(rev_no+1));
			}
