...
*
* @ejb.bean
*	name="InterventionForPatientClass"
*	type="Stateless"
*	transaction-type="Bean"
*	view-type="both"
*	jndi-name="InterventionForPatientClass"
*	local-jndi-name="InterventionForPatientClass"
*	impl-class-name="eCP.InterventionForPatientClass.InterventionForPatientClassManager"
...
*	local-class="eCP.InterventionForPatientClass.InterventionForPatientClassLocal"
*	remote-class="eCP.InterventionForPatientClass.InterventionForPatientClassRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eCP.InterventionForPatientClass.InterventionForPatientClassLocalHome"
*	remote-class="eCP.InterventionForPatientClass.InterventionForPatientClassHome"
*	generate= "local,remote"
*
*
*/

public class InterventionForPatientClassManager implements SessionBean
{
	Connection con;
    PreparedStatement pstmt;

    public InterventionForPatientClassManager()
    {
    }
	...
	*/	
    public HashMap SpecialityAddModify(Properties properties, HashMap hashtable)
    {
        ...
        patient_class = (String)hashtable.get("patient_class");
        ...
        try
        {
            ...
            String sql_delete = "";
            int j = 0;
            sql_delete = "delete from ca_pat_class_intervention where  patient_class=?";
			...
			String sql_insert = "Insert into ca_pat_class_intervention (patient_class,intervention_code,  ADDED_BY_ID, ADDED_DATE, ADDED_AT_WS_NO, ADDED_FACILITY_ID, MODIFIED_BY_ID, MODIFIED_DATE, MODIFIED_AT_WS_NO, MODIFIED_FACILITY_ID) values ( ?, ?, ?, sysdate, ?, ?, ?, sysdate, ?, ? )";
