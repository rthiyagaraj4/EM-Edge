      	...
      	<thead>  
			...
			//Added V180725-Gayathri/MMS-DM-CRF-0126/Ends%>	
			 ...
			 <tr>
				...
				<td nowrap>
					<input type='text' id='bg_code_filter' name='bg_code_filter' id='bg_code_filter' size='12'   value='<%=bgCodeFilter %>' onblur="if(this.value!=''){ if(criteriaFilter.value!=''){ callBGDescCode(2,criteriaFilter,bg_desc_filter,bg_code_filter); } else{ alert('Please select Type'); } } else{ fnClearCode(bg_desc_filter); } " >
					<input type='text' id='bg_desc_filter' name='bg_desc_filter' id='bg_desc_filter'  size='20'  value='<%=bgDescFilter %>' onblur="if(this.value!=''){ if(criteriaFilter.value!=''){ callBGDesc(2,criteriaFilter,bg_desc_filter,bg_code_filter); } else{ alert('Please select Type'); } } else{ fnClearCode(bg_code_filter); }">
