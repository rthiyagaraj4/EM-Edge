...
<tr>
	...
	<td class='fields'>
		<input type='button' name="gen_disch_clear_btn" id="gen_disch_clear_btn" id="gen_disch_clear_btn" value="<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eBL.CAN_DISC_CLEARANCE.label","bl_labels")%>" class='button' onclick='cancel_disch_clearance()' >
	</td>
