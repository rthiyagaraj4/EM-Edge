...
%>
	...
	<td class='COLUMNHEADER' width='4%'><fmt:message key="eBL.TID_NO.label" bundle="${bl_labels}"/></td>
	<%} %>
	<td class='COLUMNHEADER' width='5%'><fmt:message key="eBL.PAYER_NAME.label" bundle="${bl_labels}"/></td>
	<td class='COLUMNHEADER' width='5%'><fmt:message key="eBL.PAYER_DEP_REF_NO.label" bundle="${bl_labels}"/></td>
	<td class='COLUMNHEADER' width='4%'><fmt:message key="eBL.ONLINE_APPROVAL.label" bundle="${bl_labels}"/></td>
	</tr></thead>
<%
	int  record_select=0;
...
<tbody>
	...
	<td class=<%=classval%> width="6%" ><input type='text' name='shortdesc<%=i%>' id='shortdesc<%=i%>' size='10' maxlength='20'value='<%=output1[19]%>'>
	...
	<input type= hidden name="instremarkcode<%=i%>" id="instremarkcode<%=i%>"  value='<%=output1[18]%>'>	        
	 ...
	 <!--  Added by Monika Gupta for NMC-JD-CRF-0199		 -->
	 <%if(cc_terminal_id_enable){ %>
		<td class=<%=classval%> width="4%"><input type='text' name='cc_term_id_num<%=i%>' id='cc_term_id_num<%=i%>' size='20' maxlength='30' value='<%=output1[18]%>' readonly></td>	
	<%}else{ %>	
		<input type='hidden' name='cc_term_id_num<%=i%>' id='cc_term_id_num<%=i%>' size='20' maxlength='30' value='<%=output1[18]%>'>
	<%} %>	
	 <td class=<%=classval%>width="5%" ><input type='text' name='payername<%=i%>' id='payername<%=i%>' size='20' maxlength='20' value='<%=output1[13]%>' readonly></td>
	 <td class=<%=classval%> width="5%"><input type='text' name='recrefidno<%=i%>' id='recrefidno<%=i%>' size='20' maxlength='20' value='<%=output1[14]%>' readonly></td>
	...
	<td class=<%=classval%> width="4%"><input type='checkbox' name='onlineapproval<%=i%>' id='onlineapproval<%=i%>' <%=output1[17]%> readonly  onclick='check_box(<%=i%>)'></td>		
...
%>
	...
	<td class=<%=classval%> width="6%"><INPUT TYPE="TEXT" name='billslmtamt<%=i%>' id='billslmtamt<%=i%>' id='billslmtamt<%=i%>' SIZE="10" MAXLENGTH="20" 	VALUE='<%=a1.get(i)%>'  style='text-align:right' onBlur=''> </td>	
	
	<td class=<%=classval%> width="6%" ><input type='text' name='shortdesc<%=i%>' id='shortdesc<%=i%>' size='20' maxlength='40' value='<%=a2.get(i)%>'>
	...
	<input type= hidden name="instremarkcode<%=i%>" id="instremarkcode<%=i%>"  value='<%=a11.get(i)%>'>	        
	 ...
	 <td class=<%=classval%>width="5%" ><input type='text' name='saledraftno<%=i%>' id='saledraftno<%=i%>' size='20' maxlength='20' value='<%=a14.get(i)%>'></td>
	  <!--  Added by Monika Gupta for NMC-JD-CRF-0199		 -->
	  <%if(cc_terminal_id_enable){ %>
	 <td class=<%=classval%> width="4%"><input type='text' name='cc_term_id_num<%=i%>' id='cc_term_id_num<%=i%>' size='20' maxlength='30' value='<%=a21.get(i)%>' readonly></td>	
	 <%} else{ %>	
		<input type='hidden' name='cc_term_id_num<%=i%>' id='cc_term_id_num<%=i%>' size='20' maxlength='30' value='<%=a21.get(i)%>' >
	 <%} %>	
	 <td class=<%=classval%>width="5%" ><input type='text' name='payername<%=i%>' id='payername<%=i%>' size='20' maxlength='20' value='<%=a15.get(i)%>'></td>
	...
	<td width="4%" class=<%=classval%> ><input type='checkbox' name='onlineapproval<%=i%>' id='onlineapproval<%=i%>' value='<%=a17.get(i)%>' <%=a17.get(i)%> readonly    onclick='check_box(<%=i%>)'></td>			
	</tr>
...
%>
	...
	<tr>
	<td class=<%=classval%> width='6%'><input type="checkbox" name='selected_row<%=i%>' id='selected_row<%=i%>' value='<%=i%>' onClick="selected(<%=i%>)"></td>	
	<td class=<%=classval%> width="6%"><INPUT TYPE="TEXT" name='billslmtamt<%=i%>' id='billslmtamt<%=i%>' id='billslmtamt<%=i%>' SIZE="10" MAXLENGTH="20" 	VALUE='<%=str_doc_amt%>'  style='text-align:right' readonly> </td>					
...
%>
	...
	<td class=<%=classval%> width="6%"><INPUT TYPE="TEXT" name='billslmtamt<%=i%>' id='billslmtamt<%=i%>' id='billslmtamt<%=i%>' SIZE="10" MAXLENGTH="20" 	VALUE=''  style='text-align:right' readonly> </td>	
	...
	<td class=<%=classval%> width="6%" ><input type='text' name='instref<%=i%>' id='instref<%=i%>' size='10' maxlength='20' readonly>
...
<script>
	...
	parent.frames[3].location.href="../../eBL/jsp/BLBillSlmtTypeBtnIRB.jsp?<%=querystring%>";	
		}
</script>
