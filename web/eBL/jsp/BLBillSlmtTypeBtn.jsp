...
function cancel()
{
	...
	{
		parent.frames[2].document.forms[0].target='BillSlmtSubmitFrame';
		parent.frames[2].document.forms[0].action="../../eBL/jsp/BLBillSlmtValidation.jsp?bill_print_format_enabled_yn="+bill_print_format_enabled_yn+"&billAlreadyPrinted="+parent.BillSlmtEntryFrame.document.forms[0].billAlreadyPrinted.value+"&billdoctypecode=<%=strbilldoctypecode%>&billdocnum=<%=strbilldocnum%>&episodetype=<%=strepisodetype%>&called_frm_cancel=Y";
		parent.frames[2].document.forms[0].submit();			
	}
	else
	{ //V210113 start
...
%>
	...
	<input type='hidden' name='GHL_site_spec' id='GHL_site_spec' value='<%=GHL_site_spec%>' > <!--ghl-crf-0646 V220110-->
	<input type="hidden" name="result" id="result" value="<%=result%>">
	<input type="hidden" name="strBlrblprt" id="strBlrblprt" value="<%=strBlrblprt%>">
	<input type="hidden" name="p_login_user" id="p_login_user" value="<%=p_login_user%>">
