		...
		<table border='0' cellpadding='3' cellspacing='0' align='center' width='100%'>
			<tr>
				...
				<td width="17%" class="fields">
					<select id="episode_type" name="episode_type" id="episode_type" onchange="fnClearCode(this)">
			...
			<tr>
				...
				<td width="17%" class="fields" width="25%">
					...
					onBlur="ChangeUpperCase(this);if(this.value!=''){doctypeLookUp(doctype_from, docnum_from, 'T','FROM');docNoFromToValidation('FROM');}else{ fnClearCode('docnum_from'); }"
					...
					onBlur="ChangeUpperCase(this);if(this.value!=''){doctypeLookUp(doctype_from, docnum_from, 'N','FROM');docNoFromToValidation('FROM');}else{ fnClearCode('doctype_from'); }"
					onKeyPress="return CheckForSpecChars(event);">&nbsp;
				...
				<td width="17%" class="fields" width="25%">
					...
					onBlur="ChangeUpperCase(this);if(this.value!=''){doctypeLookUp(doctype_to, docnum_to, 'T', 'TO');docNoFromToValidation('TO');}else{ fnClearCode(doctype_to); }"
					onKeyPress="return CheckForSpecChars(event);">&nbsp;
					<input type="text"  name="docnum_to" id="docnum_to" id='docnum_to' size="10"  maxlength='40'
					onBlur="ChangeUpperCase(this);if(this.value!=''){doctypeLookUp(doctype_to, docnum_to, 'N', 'TO');docNoFromToValidation('TO');}else{ fnClearCode(docnum_to); }"
					onKeyPress="return CheckForSpecChars(event);">&nbsp;
