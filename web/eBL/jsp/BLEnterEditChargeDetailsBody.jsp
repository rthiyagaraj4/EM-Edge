...
<%@ page import="java.sql.*,java.util.*,webbeans.eCommon.*,eBL.*,webbeans.op.CurrencyFormat,com.ehis.util.*,eOR.*,eOR.Common.*,eCommon.XSSRequestWrapper" contentType="text/html;charset=UTF-8" %>
...
<tr id=row<%=i%>>
	...
	<td class=<%=classval%> width='4%' ><input type='text' name='total_qty<%=i%>' id='total_qty<%=i%>' id='total_qty<%=i%>'  size='10' readonly maxlength='7'  value="<%=a13.get(i)%>" style='text-align:right'></td>
</tr>
<tr>
...
%>
	<td class=<%=classval%> width='15%' ><input type='text' name='original_qty<%=i%>' id='original_qty<%=i%>' id='original_qty<%=i%>' size='10' readonly maxlength='7'  value='<%=l_serv_qty%>' style='text-align:right'><input type=hidden name='modify_qty_yn<%=i%>' id='modify_qty_yn<%=i%>' value='<%=modify_qty_yn%>' ></td>
	...
	<td class=<%=classval%> width='4%' ><input type='text' name='total_qty<%=i%>' id='total_qty<%=i%>'  id='total_qty<%=i%>'  size='10' readonly maxlength='7'  value="<%=panel_qty%>" style='text-align:right'></td>
</tr>
<tr>
	<td class=<%=classval%> width='9%' ></td>
...
<input type='hidden' name='str' id='str' value="<%=str_preapp_yn%>" >
