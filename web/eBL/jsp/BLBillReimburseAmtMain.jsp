...
%>
		...
		<iframe name='commontoolbarFrame' id='commontoolbarFrame'	src='../../eCommon/jsp/commonToolbar.jsp?<%=params%>'  frameborder=0 scrolling='no' noresize style='height:8vh;width:100vw'></iframe>
			<iframe name='BLBillReimburseAmtQueryFrame' id='BLBillReimburseAmtQueryFrame' 	src='../../eBL/jsp/BLBillReimburseAmtQueryFrame.jsp?<%=params%>' frameborder=0 scrolling='' noresize style='height:80vh;width:100vw'></iframe>
