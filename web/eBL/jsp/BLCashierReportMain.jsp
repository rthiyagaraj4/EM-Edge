...
<iframe name='bl_cashier_report' id='bl_cashier_report' 	src='BLCashierReport.jsp?<%=params %>' frameborder=0 scrolling='no' noresize style='height:83vh;width:100vw'></iframe>
