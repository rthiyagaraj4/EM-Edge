...
%>
   ...
   <iframe name='commontoolbarFrame' id='commontoolbarFrame'	src='../../eCommon/jsp/commonToolbar.jsp?<%=params%>'  frameborder=0  noresize scrolling="no" style='height:8vh;width:100vw'></iframe>
			<iframe name='BLChargePatientQueryFrame' id='BLChargePatientQueryFrame' src='../../eBL/jsp/BLChargePatientQueryFrame.jsp?<%=params%>' frameborder=0  noresize style='height:83vh;width:100vw'></iframe>					
