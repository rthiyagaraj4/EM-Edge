...
<%@ page  import="java.sql.*,java.io.*,webbeans.eCommon.*,webbeans.op.CurrencyFormat,ecis.utils.OnlineReport,ecis.utils.OnlineReports,eCommon.Common.*,eBL.Common.*" contentType="text/html;charset=UTF-8" %>
...
<body onLoad="test()" onMouseDown="CodeArrest()" onKeyDown="lockKey()">
	<form>
		...
		<input type="hidden" name="called_butt" id="called_butt" value="<%=called_butt%>">
		<input type="hidden" name="billdoctypecode" id="billdoctypecode" id="billdoctypecode"
			value="<%=strbilldoctypecode%>">
		<input type="hidden"
			name="billdocnum" id="billdocnum" id="billdocnum" value="<%=strbilldocnum%>"> <input type="hidden" name="slmt_reqd_yn" id="slmt_reqd_yn" value="<%=str_slmt_reqd_yn%>">
		<input type="hidden" name="storecode" id="storecode" value="<%=p_store_code%>">
		<input type="hidden" name="blnggrp" id="blnggrp" value="<%=p_blng_grp_id%>">
		<input type="hidden" name="module_id" id="module_id" value="<%=called_module_id%>">
		<input type="hidden" name="function_id" id="function_id" value="<%=p_function_id%>">
		<input type="hidden" name="final_message" id="final_message" value="<%=strFinalMessage%>">
		<input type="hidden" name="error_flag" id="error_flag" value="<%=error_flag%>">
		<input type="hidden" name="GHL_site_spec" id="GHL_site_spec" value="<%=GHL_site_spec%>"><!--added for GHL-CRF-0646 V220110-->
		<input type="hidden" name="result" id="result" value="<%=result%>">
		<input type="hidden" name="settmnt_ind" id="settmnt_ind" value="<%=settmnt_ind%>">
		<input type="hidden" name="strbillpayableamt" id="strbillpayableamt" value="<%=strbillpayableamt%>">
		<input type="hidden" name="strbillpayableamount" id="strbillpayableamount" value="<%=strbillpayableamount%>">
		<input type="hidden" name="strCustCode" id="strCustCode" value="<%=strCustCode%>"> <!--added for GHL-CRF-646 V220110-->
		 <!--endsfor GHL-CRF-646 V220110-->
		<input type="hidden" name="sys_mesage_id" id="sys_mesage_id"
			value="<%=str_sysmesage_id%>">
	...
	<input type="hidden" name="str_error_text" id="str_error_text"  value="<%=str_error_text%>">
			<!--added against GHL-CRF-0646 V220110-->
			<!--form name="report_server_form" method="Post"-->
			<input type="hidden" name="user_id" id="user_id" id="user_id" value="<%=user_id%>">
			<input type="hidden" name="strBlrblprt" id="strBlrblprt" id="strBlrblprt" value="<%=strBlrblprt%>">
			<input type="hidden"	name="reportserver" id="reportserver"	value="<%=reportServer%>">
			<!--input type="hidden"	name="billdocnum"	value="<%=strbilldocnum%>"-->
			<!--input type="hidden"	name="billdoctypecode"	value="<%=strbilldoctypecode%>"-->
			<!--input type="hidden"	name="strloggeduser"	value="<%=strloggeduser%>"-->
			...
			<input type="hidden"	name="str_patient_id" id="str_patient_id"	value="<%=str_patient_id%>"><!-- V221117 -->
			<input type="hidden"	name="str_episode_id" id="str_episode_id"	value="<%=str_episode_id%>"><!-- V221117 --> 
			<input type="hidden"	name="str_visit_id" id="str_visit_id"	value="<%=str_visit_id%>"><!-- V221117 -->
			<input type="hidden"	name="mpi_id1" id="mpi_id1"	value="<%=mpi_id%>"><!-- V221117 -->
			<input type="hidden"	name="insBillCount" id="insBillCount"	value="<%=insBillCount%>"><!-- V221117 -->
			<input type="hidden"	name="eSignatureFlag" id="eSignatureFlag"	value="<%=eSignatureFlag%>"><!-- V221117 -->
			<input type="hidden"	name="Zatca_msg" id="Zatca_msg"	id="Zatca_msg"	value="<%=Zatca_msg%>"><!-- V221230 -->
			<input type="hidden"	name="zatca_error_code" id="zatca_error_code"	id="zatca_error_code"	value="<%=zatca_error_code%>"><!-- V221230 -->
			<input type="hidden"	name="ZatcaYN" id="ZatcaYN"	id="ZatcaYN"	value="<%=ZatcaYN%>"><!-- V221230 -->
