...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td class="fields"><input type="radio" name="search_by" id="search_by" class="label" value="C"    onclick="AllergenStoreVal(this)" checked><script>document.write(fieldLegend["CODE_LEGEND"])</script>
		<input type="radio" name="search_by" id="search_by" class="label" value="D" onclick="AllergenStoreVal(this)" ><script>document.write(fieldLegend["DESC_LEGEND"])</script></td>
