...
<table  cellpadding=3 cellspacing=0 width="100%" align="center">
	...
	<thead><tr>
			<td class='COLUMNHEADER' width='18%'><fmt:message key="eBL.SERVICE_DATE.label" bundle="${bl_labels}"/></td>
			<td class='COLUMNHEADER' width='18%'><fmt:message key="Common.TransactionDate.label" bundle="${common_labels}"/></td>
			...
			<td class='COLUMNHEADER' width='16%'><fmt:message key="eBL.DOC_REF.label" bundle="${bl_labels}"/></td>				
		</tr></thead>
<%				int i=0;	
	/*try{
...
%>	<tbody>
	<tr id=row<%=i%>>			
		<td class=<%=classval%> width='18%'><%=strServiceDate%></td>	 
		<td class=<%=classval%> width='18%'><%=strTrxDate%></td>	 
		<td class=<%=classval%> width="8%" ><%=strBlngServiceCode%></td>
		<td class=<%=classval%> width='10%'><%=strServiceQty%></td>	 
		<td class=<%=classval%> width="10%"><%=strUpdGrossChrAmt%></td>
		<td class=<%=classval%> width="10%"><%=strUpdDiscAmt%></td>		
		<td class=<%=classval%> width="10%"><%=strUpdNetChrAmt%></td>					
		<td class=<%=classval%> width="16%"><%=strTrxDoc%></td> 			
	</tr>
<%
		i++;	
	}//while
