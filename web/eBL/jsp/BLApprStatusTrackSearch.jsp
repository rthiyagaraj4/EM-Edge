...
%>		
		...
		<tr>
				...
				<td><input type='text' name='Effective_from' id='Effective_from' id="Effective_from" maxlength="10" onBlur="isValidDate(this);"		value="<%=daysBeforeDate%>">
		...
		<input type='hidden' name = "PreAuthEclaimYN"  id = "PreAuthEclaimYN" value="<%=PreAuthEclaimYN%>">
