...
if(type.equals("G")){
%>
<select name='srvLimit_type<%=i%>' id='srvLimit_type<%=i%>'  <%=modifyStatus%> onChange='onBlngGrpSrvLimitServiceTypeChange(this,"<%=i%>")'>
...
<select name='srvLimit_type<%=i%>' id='srvLimit_type<%=i%>'	<%=modifyStatus%> onChange='onBlngGrpSrvLimitServiceTypeChange(this,"<%=i%>")'><option value='S' <%=srvLimit_type.equals("S")?"selected":""%>><fmt:message key="Common.BillingService.label" bundle="${common_labels}"/></option></select>
<%}
%>
</td>
					
<td class='fields' nowrap WIDTH=''><input type='text' name='srvLimit_service_code<%=i%>' id='srvLimit_service_code<%=i%>'	<%=modifyStatus%> value='<%=srvLimit_service_code%>' size='10' onBlur="blngGrpSrvLimitCodeLookUp(srvLimit_service_desc<%=i%>,this,srvLimit_type<%=i%>,'<%=i%>')"><input type='text' name = 'srvLimit_service_desc<%=i%>' size='10' maxlength='10'	 <%=modifyStatus%> onBlur="before_blngGrpSrvLimitServiceLookUp(this,srvLimit_service_code<%=i%>,srvLimit_type<%=i%>,'<%=i%>')" value="<%=srvLimit_service_desc%>"><INPUT type='hidden' name='srvLimit_service_code_temp<%=i%>' id='srvLimit_service_code_temp<%=i%>' value=''><INPUT type='hidden' name='srvLimit_service_desc_temp<%=i%>' id='srvLimit_service_desc_temp<%=i%>' value=''><input type='button' name='srvLimit_service_button<%=i%>' id='srvLimit_service_button<%=i%>' class='button' value='?'	 <%=modifyStatus%> onclick="blngGrpSrvLimitServiceLookUp(srvLimit_service_desc<%=i%>,srvLimit_service_code<%=i%>,srvLimit_type<%=i%>,'<%=i%>')"></td>

<td class='fields' nowrap WIDTH='60' ><input type='checkbox' name='exludeService<%=i%>' id='exludeService<%=i%>'	id='exludeService<%=i%>' <%=modifyStatus%>  <%=exludeService.equals("Y")?"checked":""%> onClick='chkBlngGrpExludeService(this,"<%=i%>");changeSplitReqd(this,"exclude","<%=i%>");IncludeHomeMedicationBlngGrpExclude(this,srvLimit_service_code<%=i%>,srvLimit_type<%=i%>,"<%=i%>");' value="<%=exludeService%>" /></td>
			
<td class='fields' nowrap WIDTH=''><input type='text'    name='srvLimit_qty_limit<%=i%>' id='srvLimit_qty_limit<%=i%>' <%=modifyStatus%>  size='5' <%=disabledAll%> onBlur='chkBlngGrpSrvLimitQtyLimit(this);' onkeypress='return allowValidNumber(this,event,"<%=noofdecimal%>");' value="<%=srvLimit_qty_limit%>" /></td>

<td  class='fields' nowrap WIDTH=''>
<select name='srvLimit_amt_limit_ind<%=i%>' id='srvLimit_amt_limit_ind<%=i%>' onChange='validateBlngGrpInd(this,"<%=i%>")' <%=modifyStatus%> <%=disabledAll%>>
...
<td class='fields' nowrap WIDTH=''><input type='text' name='srvLimit_amt_limit<%=i%>' id='srvLimit_amt_limit<%=i%>' <%=modifyStatus%>  <%=disabledAll%> size='5' maxlength='13' 	<%=((srvLimit_amt_limit_ind.equals("")||srvLimit_amt_limit_ind.equals("U"))?"disabled":"")%> onBlur='chkBlngGrpSrvLimitAmtLimit(this,"<%=i%>","<%=noofdecimal%>")' onkeypress='return allowValidNumber(this,event,"10","<%=noofdecimal%>");' value="<%=srvLimit_amt_limit%>"/></td>
...
<%if(ss){%>	
	<td class='fields' nowrap WIDTH='75'><input type='checkbox'   <%=modifyStatus%> name='includeHomeMedication<%=i%>' id='includeHomeMedication<%=i%>' value='<%=includeHomeMedication %>' <%="Y".equals(includeHomeMedication)?" checked ":""%> <%="Y".equals(enableDisParam)?"":"disabled" %>  onclick="checkInclHomeMedi(this); IncludeHomeMedicationUnchkExclude(this,'blngGrprateexclude','<%=i%>');">
...
<%if(dailyLimitSiteSpec) { %>	
	<td class='fields' WIDTH='' nowrap >
		<select name='dailyLmtIndicator<%=i%>' id='dailyLmtIndicator<%=i%>' id='dailyLmtIndicator<%=i%>' <%=modifyStatus%> <%=indicatorFldDisabled%> onchange='dailyLmtIndicatorOnChange(this,<%=i%>,document.blng_grp_srvLimit_rate_based_dtl)' >
...
<input type='checkbox'   <<%=disabledAll%> name='srvLimit_replace<%=i%>' <%=modifyStatus%> <%=srvLimit_replace.equals("Y")?"checked":""%>onClick='blngGrpSrvLimitChkReplace(this,"<%=i%>")' value="<%=srvLimit_replace%>"/>
<%if(srvLimit_replace.equals("Y")){%><a name='srvLimit_replace_dtls<%=i%>'  <%=disabledAll%> href='#'	onClick='blngGrpSrvLimitShowReplaceDtls("<%=i%>")'><fmt:message key="eBL.Dtls.label" bundle="${bl_labels}"/></a>
...
<td class='fields' nowrap WIDTH='60'><input type='checkbox'   <%=disabledAll%>		<%=modifyStatus%> name='srvLimit_refund<%=i%>' <%=srvLimit_refund.equals("Y")?"checked":""%> onClick='blngGrpSrvLimitChkRefund(this,"<%=i%>")' value="<%=srvLimit_refund%>"/><%if(srvLimit_refund.equals("Y")){%><input type='text' name='srvLimit_refundAmt<%=i%>' id='srvLimit_refundAmt<%=i%>' value='<%=srvLimit_refundAmt%>'   <%=modifyStatus%> <%=disabledAll%> onBlur='validPercentageForRefundBlngGrp(this,"srvLimit_autoRefund<%=i%>")' onkeypress='return allowValidNumber(this,event,"<%=noofdecimal%>")' size='2' maxlength='4'  ><%}%></td>
<td class='fields' nowrap WIDTH='60'><input type='checkbox'  <%=disabledAll%>	  <%=modifyStatus%> name='srvLimit_autoRefund<%=i%>' <%=srvLimit_auto_refund.equals("Y")?"checked":""%>	  <%=srvLimit_refundAmt.equals("")?" disabled":""%> onClick='chkBlngGrpAutoRefund(this,"srvLimit_refundAmt<%=i%>")' value="<%=srvLimit_auto_refund%>"/></td>
<td class='fields' nowrap WIDTH='80'>
<input type='checkbox' name='srvLimit_factor_appl<%=i%>' id='srvLimit_factor_appl<%=i%>' <%=disabledAll%>	 <%=modifyStatus%> <%=srvLimit_factor_appl.equals("Y")?"checked":""%> onClick='blngGrpSrvLimitFactorAppl(this,"<%=i%>")' value="<%=srvLimit_factor_appl%>" /></td>
...
<td class='fields' nowrap WIDTH='50'><input type='checkbox' 	 <%=modifyStatus%> name='srvLimit_deleteService<%=i%>' onClick='chkBlngGrpSrvLimitDeleteService(this,"<%=i%>");' value='N'/></td>
...
if(type.equals("G")){
%>
<select name='srvLimit_type0' id='srvLimit_type0' <%=modifyStatus%> onChange='onBlngGrpSrvLimitServiceTypeChange(this,"0")'>
...
<select name='srvLimit_type0' id='srvLimit_type0' <%=modifyStatus%> onChange='onBlngGrpSrvLimitServiceTypeChange(this,"0")'><option value='S' ><fmt:message key="Common.BillingService.label" bundle="${common_labels}"/></option></select>
<%}
%>
</td>
					
<td class='fields' nowrap WIDTH=''>
	<input type='text' name='srvLimit_service_code0' id='srvLimit_service_code0'	<%=modifyStatus%> value='' size='10' onBlur="blngGrpSrvLimitCodeLookUp(srvLimit_service_desc0,this,srvLimit_type0,'0')">
	<input type='text' name = 'srvLimit_service_desc0' size='10' maxlength='10'	 <%=modifyStatus%> onBlur="before_blngGrpSrvLimitServiceLookUp(this,srvLimit_service_code0,srvLimit_type0,'0')" value="">
	...
	<input type='button' name='srvLimit_service_button0' id='srvLimit_service_button0' class='button' value='?'	 <%=modifyStatus%> onclick="blngGrpSrvLimitServiceLookUp(srvLimit_service_desc0,srvLimit_service_code0,srvLimit_type0,'0')"></td>

<td class='fields' nowrap WIDTH='60' ><input type='checkbox' name='exludeService0' id='exludeService0'	 <%=modifyStatus%> disabled  onClick='chkBlngGrpExludeService(this,"0");changeSplitReqd(this,"exclude","0");IncludeHomeMedicationBlngGrpExclude(this,srvLimit_service_code0,srvLimit_type0,"0");' value="" /></td>
			
<td class='fields' nowrap WIDTH=''><input type='text'    name='srvLimit_qty_limit0' id='srvLimit_qty_limit0'  	<%=modifyStatus%> size='5' disabled onBlur='chkBlngGrpSrvLimitQtyLimit(this);' onkeypress='return allowValidNumber(this,event,"<%=noofdecimal%>");' value="" /></td>

<td  class='fields' nowrap WIDTH=''>
<select name='srvLimit_amt_limit_ind0' id='srvLimit_amt_limit_ind0' onChange='validateBlngGrpInd(this,"0")' <%=modifyStatus%> >
<option value='' <%=(srvLimit_amt_limit_ind.equals("")?"selected":"")%> >--<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>--</option>
<option value='A' <%=(srvLimit_amt_limit_ind.equals("A")?"selected":"")%>><fmt:message key="Common.amount.label" bundle="${common_labels}"/></option>
<option value='P'<%=(srvLimit_amt_limit_ind.equals("P")?"selected":"")%> ><fmt:message key="Common.Percent.label" bundle="${common_labels}"/></option>
</select>
...
<%if(ss){%>
	<td class='fields' nowrap WIDTH='75'>
		<input type='checkbox'   <%=modifyStatus%>	name='includeHomeMedication0' id='includeHomeMedication0' value='<%=includeHomeMedication %>' <%="Y".equals(includeHomeMedication)?" checked ":""%> <%="Y".equals(enableDisParam)?"":"disabled" %>  onclick="checkInclHomeMedi(this); IncludeHomeMedicationUnchkExclude(this,'blngGrprateexclude','0');" >
...
<%if(dailyLimitSiteSpec) { %>	
	<td class='fields' WIDTH='' nowrap >
		<select name='dailyLmtIndicator0' id='dailyLmtIndicator0' id='dailyLmtIndicator0' <%=modifyStatus%> <%=indicatorFldDisabled%> onchange='dailyLmtIndicatorOnChange(this,0,document.blng_grp_srvLimit_rate_based_dtl)' >
			<option value="*"><fmt:message key="Common.Select.label" bundle="${common_labels}"/></option>
			<% if("G".equals(parDailyLmtInd) || "B".equals(parDailyLmtInd)) { %>
...
<% } %>
<td  class='fields' nowrap WIDTH='60'>
<input type='checkbox'  disabled name='srvLimit_replace0' id='srvLimit_replace0' <%=modifyStatus%> onClick='blngGrpSrvLimitChkReplace(this,"0")' value=""/>
...
<td class='fields' nowrap WIDTH='60'><input type='checkbox'   disabled	 <%=modifyStatus%> name='srvLimit_refund0'  onClick='blngGrpSrvLimitChkRefund(this,"0")' value=""/></td>
<td align="left" nowrap WIDTH='60'><input type='checkbox'   disabled	 <%=modifyStatus%> name='srvLimit_autoRefund0'    onClick='chkBlngGrpAutoRefund(this,"srvLimit_refundAmt0")' value=""/></td>
<td align="left" nowrap WIDTH='80'>
<input type='checkbox' name='srvLimit_factor_appl0' id='srvLimit_factor_appl0' disabled <%=modifyStatus%> onClick='blngGrpSrvLimitFactorAppl(this,"0")' value="" /></td>
...
<td class='fields' nowrap WIDTH='50'><input type='checkbox'  name='srvLimit_deleteService0' id='srvLimit_deleteService0'	<%=modifyStatus%> onClick='chkBlngGrpSrvLimitDeleteService(this,"0");' value='N'/></td>
