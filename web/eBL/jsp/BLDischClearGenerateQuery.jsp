...
<TABLE border='0' cellpadding='3' cellspacing='0'>
		...
		<tr>	
			<td class="label" ><fmt:message key="eBL.DischAdvFromDate.label" bundle="${bl_labels}"/></td>
			<td class='fields'>
			...
			<td class="label" ><fmt:message key="eBL.DischAdvToDate.label" bundle="${bl_labels}"/></td>
			<td class='fields'>
		...
		<tr>	
			...
			<td class='fields'>
				<input type='button' name="search_button" id="search_button" id="search_button" value="<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext, "Common.search.label", "common_labels")%>" class='button' onclick='gen_disch_clearance_reultset()' >
			</td>			
		</tr>
