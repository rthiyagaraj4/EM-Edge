...
%>
			<tr>		
			<td class="label" width="25%"><fmt:message key="eBL.CHQ_CARD_BANK_NO.label" bundle="${bl_labels}"/></td>		 
			<td class="fields" width="25%" ><input type='text' name='instref' id='instref' size='20' maxlength='20' value="<%=instref%>" onKeyPress='return CheckForSpecChars_local(event)' <%=readonly_fld%> >
...
<!--	<td align="right" class="label">Instrument Ref</td>		 -->
		<td class="label" width="25%"><fmt:message key="eBL.CHQ_CARD_BANK_NO.label" bundle="${bl_labels}"/></td>		 
		<td class="fields" width="25%" ><input type='text' name='instref' id='instref' size='20' maxlength='20' value="<%=instref%>" onKeyPress='return CheckForSpecChars(event)' <%=readonly_fld%> onblur="callCardNoValidation(this)">
		<%if("Y".equals(credit_card_num_yn)){ %>
		<img src='../../eCommon/images/mandatory.gif'>
		<%} %>
		</td>		
