...
<div>
	...
	<tr><th align = 'left' class='columnHeader' colspan='16'><fmt:message key="Common.PaymentDetails.label" bundle="${common_labels}"/></th></tr>
	</table></div>
	<%
...
%>
		...
		<td class='COLUMNHEADER' width='6%'><fmt:message key="eBL.AMT_COLL.label" bundle="${bl_labels}"/></td>
		<td class='COLUMNHEADER' width='6%'><fmt:message key="Common.SettlementType.label" bundle="${common_labels}"/></td>
				
		<%if(custId.equals("GP")){ %>				
		<td class='COLUMNHEADER' width="6%"><fmt:message key="eBL.AMOUNT_REND.label" bundle="${bl_labels}"/></td>		
		<%}else{ %>		
		<td class='COLUMNHEADER' width="6%"><fmt:message key="eBL.CASH_GIVEN.label" bundle="${bl_labels}"/></td>
		<%} %>
					
		<td class='COLUMNHEADER' width="6%"><fmt:message key="eBL.CASH_RETURNED.label" bundle="${bl_labels}"/></td>
		<%if(chequeLengthChange){ %>
			<td class='COLUMNHEADER' width='8%'><fmt:message key="eBL.CHQ_CARD_BANK_NO_OTH.label" bundle="${bl_labels}"/></td>
		<%}else{ %>
			<td class='COLUMNHEADER' width='8%'><fmt:message key="eBL.CHQ_CARD_BANK_NO.label" bundle="${bl_labels}"/></td>
		<%} %>	
		
		<td class='COLUMNHEADER' width='6%'><fmt:message key="Common.date.label" bundle="${common_labels}"/></td>
		<td class='COLUMNHEADER' width='9%'><fmt:message key="eBL.CREDIT_CARD_CO.label" bundle="${bl_labels}"/></td>	
		<td class='COLUMNHEADER' width='9%'><fmt:message key="eBL.BANK_NAME.label" bundle="${bl_labels}"/></td>
		...
		<td class='COLUMNHEADER' width='6%'><fmt:message key="eBL.TID_NO.label" bundle="${bl_labels}"/></td>
		<%} %>
...
<tbody>
	<tr id=row<%=i%>>
	<tr>
	<td class=<%=classval%> width='6%'><input type="checkbox" name='selected_row<%=i%>' id='selected_row<%=i%>' value='<%=i%>' onClick="selected(<%=i%>)"></td>	 

	<td class=<%=classval%> width="6%"><INPUT TYPE="TEXT" name='billslmtamt<%=i%>' id='billslmtamt<%=i%>' SIZE="10" MAXLENGTH="20" 	VALUE='<%=output1[0]%>'  style='text-align:right' readonly> </td>	
	
	<td class=<%=classval%> width="6%" >
	<input type='text' name='shortdesc<%=i%>' id='shortdesc<%=i%>' size='10' maxlength='20'value='<%=output1[19]%>'>
	<input type='hidden' name='Case' id='Case' value='1'>
	<input type='hidden' name='slmttype<%=i%>' id='slmttype<%=i%>' value='<%=output1[1]%>' readonly>
	<input type='hidden' name='couponcode<%=i%>' id='couponcode<%=i%>' value='<%=output1[20]%>' >
	</td>
	<td class=<%=classval%> width="6%" class="fields"><input type='text' name='cash_given<%=i%>' id='cash_given<%=i%>' size='10' maxlength='30' value='<%=output1[2]%>' readonly> </td>
	<td class=<%=classval%> width="6%" class="fields"><input type='text' name='cash_return<%=i%>' id='cash_return<%=i%>' size='10' maxlength='30' value='<%=output1[3]%>' readonly> </td>

	<td class=<%=classval%> width="8%" ><input type='text' name='instref<%=i%>' id='instref<%=i%>' size='10' maxlength='20' value='<%=output1[4]%>' readonly>
	<td class=<%=classval%> width="6%"><input type='text' name='instdate<%=i%>' id='instdate<%=i%>' size='10' maxlength='10' value='<%=output1[5]%>' readonly></td>	
	<td class=<%=classval%> width="9%"><input type='text' readonly name='creditcardco<%=i%>' id='creditcardco<%=i%>' maxlength='30' size='10'  tabindex='0' value='<%=output1[6]%>' readonly></td>
	<td class=<%=classval%> width="9%"><input type='text' readonly name='instbankname<%=i%>' id='instbankname<%=i%>' maxlength='60' size='10' value='<%=output1[7]%>' readonly></td>  
	...
	<input type= hidden name="instremarkcode<%=i%>" id="instremarkcode<%=i%>"  value='<%=output1[18]%>'>	        
	 ...
	 <td class=<%=classval%>width="4%"><input type='text' name='batchno<%=i%>' id='batchno<%=i%>' size='10' maxlength='10' value='<%=output1[10]%>' readonly>4</td>	
...
<!--  Added by Monika Gupta for NMC-JD-CRF-0199		 -->
	<%if(cc_terminal_id_enable){ %>
	<td class=<%=classval%> width="6%"><input type='text' name='cc_term_id_num<%=i%>' id='cc_term_id_num<%=i%>' size='20' maxlength='30' value='<%=output1[18]%>' readonly></td>	
	<%}else{ %>	
		<input type='hidden' name='cc_term_id_num<%=i%>' id='cc_term_id_num<%=i%>' size='20' maxlength='30' value='<%=output1[18]%>'>
	<%} %>
	...
	<INPUT TYPE="HIDDEN" name='Cash_check<%=i%>' id='Cash_check<%=i%>' VALUE='<%=output1[25]%>'>
...
%>
	...
	<td class=<%=classval%> width="6%"><INPUT TYPE="TEXT" name='billslmtamt<%=i%>' id='billslmtamt<%=i%>' SIZE="10" MAXLENGTH="20" 	VALUE='<%=a1.get(i)%>'  style='text-align:right' onBlur=''> </td>	
	
	<td class=<%=classval%> width="6%" >
	<input type='text' name='shortdesc<%=i%>' id='shortdesc<%=i%>' size='20' maxlength='40' value='<%=a2.get(i)%>'>
	<input type='hidden' name='Case' id='Case' value='1'>
	<input type='hidden' name='slmttype<%=i%>' id='slmttype<%=i%>' value='<%=a3.get(i)%>'>
	<input type='hidden' name='couponcode<%=i%>' id='couponcode<%=i%>' value='<%=a22.get(i)%>' >
	</td>

	<td class=<%=classval%> width="6%" class="fields"><input type='text' name='cash_given<%=i%>' id='cash_given<%=i%>' size='10' maxlength='30' style='text-align:right' value='<%=a4.get(i)%>'> </td>
	<td class=<%=classval%> width="6%" class="fields"><input type='text' name='cash_return<%=i%>' id='cash_return<%=i%>' size='10' maxlength='30' style='text-align:right' value='<%=a5.get(i)%>'> </td>

	<td class=<%=classval%> width="8%" ><input type='text' name='instref<%=i%>' id='instref<%=i%>' size='10' maxlength='20'value='<%=a6.get(i)%>'>
	<td width="6%" class=<%=classval%>><input type='text' name='instdate<%=i%>' id='instdate<%=i%>' size='10' maxlength='10'value='<%=a7.get(i)%>'></td>	
	<td width="9%" class=<%=classval%>><input type='text' readonly name='creditcardco<%=i%>' id='creditcardco<%=i%>' maxlength='30' size='10'  tabindex='0' value='<%=a8.get(i)%>'></td>
	<td class=<%=classval%> width="9%"><input type='text' readonly name='instbankname<%=i%>' id='instbankname<%=i%>' maxlength='60' size='10' value='<%=a9.get(i)%>' ></td>  	
	...
	<input type= hidden name="instremarkcode<%=i%>" id="instremarkcode<%=i%>"  value='<%=a11.get(i)%>'>	        
	 ...
	 <td class=<%=classval%>width="5%" ><input type='text' name='saledraftno<%=i%>' id='saledraftno<%=i%>' size='20' maxlength='20' value='<%=a14.get(i)%>'></td>
	   <!--  Added by Monika Gupta for NMC-JD-CRF-0199		 -->
	   <%if(cc_terminal_id_enable){ %>
	 <td class=<%=classval%> width="4%"><input type='text' name='cc_term_id_num<%=i%>' id='cc_term_id_num<%=i%>' size='20' maxlength='30' value='<%=a23.get(i)%>' readonly></td>	
	 <%} else{ %>	
		<input type='hidden' name='cc_term_id_num<%=i%>' id='cc_term_id_num<%=i%>' size='20' maxlength='30' value='<%=a23.get(i)%>' >
	<%} %>
	...
	<INPUT TYPE="HIDDEN" name='Cash_check<%=i%>' id='Cash_check<%=i%>' VALUE='<%=a21.get(i)%>'>
...
%>
				...
				<tr>
				<td class=<%=classval%> width='6%'><input type="checkbox" name='selected_row<%=i%>' id='selected_row<%=i%>' value='<%=i%>' onClick="selected(<%=i%>)"></td>	
				<td class=<%=classval%> width="6%"><INPUT TYPE="TEXT" name='billslmtamt<%=i%>' id='billslmtamt<%=i%>' SIZE="10" MAXLENGTH="20" 	VALUE='<%=str_doc_amt%>'  style='text-align:right' readonly> </td>					
				<td class=<%=classval%> width="6%" ><input type='text' name='shortdesc<%=i%>' id='shortdesc<%=i%>' size='20' maxlength='40' value='<%=str_slmt_short_desc%>'>
				...
				<td class=<%=classval%> width="6%" class="fields"><input type='text' name='cash_given<%=i%>' id='cash_given<%=i%>' size='10' maxlength='30' value='<%=str_cash_amt_given%>' readonly> </td>
				<td class=<%=classval%> width="6%" class="fields"><input type='text' name='cash_return<%=i%>' id='cash_return<%=i%>' size='10' maxlength='30' value='<%=str_cash_amt_return%>' readonly> </td>

				<td class=<%=classval%> width="8%" ><input type='text' name='instref<%=i%>' id='instref<%=i%>' size='10' maxlength='20' value='<%=str_slmt_doc_ref_desc%>' readonly>
				...
				<td width="9%" class=<%=classval%>><input type='text' readonly name='creditcardco<%=i%>' id='creditcardco<%=i%>' maxlength='30' size='10'  tabindex='0' value='' value='' readonly></td>
				<td class=<%=classval%> width="9%"><input type='text' readonly name='instbankname<%=i%>' id='instbankname<%=i%>' maxlength='60' size='15' value='<%=str_bank_name%>' readonly></td>  
				...
				<INPUT TYPE="HIDDEN" name='credit_card_machine_int_yn<%=i%>' id='credit_card_machine_int_yn<%=i%>' VALUE=''>
				<INPUT TYPE="HIDDEN" name='Cash_check<%=i%>' id='Cash_check<%=i%>' VALUE=''> <!-- Added V070618-Subha/IN67859  -->
...
%>
	...
	<td class=<%=classval%> width="6%"><INPUT TYPE="TEXT" name='billslmtamt<%=i%>' id='billslmtamt<%=i%>' SIZE="10" MAXLENGTH="20" 	VALUE=''  style='text-align:right' readonly> </td>	
	...
	<td class=<%=classval%> width="6%" class="fields"><input type='text' name='cash_given<%=i%>' id='cash_given<%=i%>' size='10' maxlength='30' value='' readonly> </td>
	<td class=<%=classval%> width="6%" class="fields"><input type='text' name='cash_return<%=i%>' id='cash_return<%=i%>' size='10' maxlength='30' value='' readonly> </td>

	<td class=<%=classval%> width="8%" ><input type='text' name='instref<%=i%>' id='instref<%=i%>' size='10' maxlength='20' readonly>
	<td width="6%" class=<%=classval%>><input type='text' name='instdate<%=i%>' id='instdate<%=i%>' size='10' maxlength='10' readonly></td>	
	<td width="9%" class=<%=classval%>><input type='text' readonly name='creditcardco<%=i%>' id='creditcardco<%=i%>' maxlength='30' size='10'  tabindex='0' value='' readonly></td>
	<td class=<%=classval%> width="9%"><input type='text' readonly name='instbankname<%=i%>' id='instbankname<%=i%>' maxlength='60' size='15' value='' readonly></td>  
...
%>
	...
	<input type=hidden name='cc_terminal_id_enable' id='cc_terminal_id_enable' value="<%=cc_terminal_id_enable%>">		<!--Added by Monika for NMC-JD-CRF-0199 on 04/08/2023 -->	
...
<script>
	...
	parent.frames[3].location.href="../../eBL/jsp/BLBillSlmtTypeBtn.jsp?<%=querystring%>";	
		}
</script>
