...
<%		}else{
%>
		 <fmt:message key="eBL.ADM_DEP.label" bundle="${bl_labels}"/>
<%
			}
%>
...
%>
	...
	<!--  <iframe name='pat_banner_frame' id='pat_banner_frame' SRC="../../eBL/jsp/BLPatBanner.jsp?<%=params%>" frameborder=0 scrolling='no' noresize style='height:7%;width:100vw'></iframe> 	-->
		...
		<iframe name='details_frame' id='details_frame' SRC="../../eBL/jsp/BLEnterReceiptRefundDtl.jsp?<%=params%>" frameborder=0 scrolling='auto' noresize style='height:23vh;width:100vw'></iframe> 		
		<iframe SRC="../../eBL/jsp/BLBillSlmtType.jsp?function_id=<%=function_id%>&billdoctypecode=<%=strbilldoctypecode%>&billdocnum=<%=strbilldocnum%>&billpayableamt=<%=strbillpayableamt%>&facilityid=<%=facilityid%>&loggeduser=<%=strloggeduser%>&patientid=<%=patient_id%>&episodetype=<%=episode_type%>&episodeid=<%=episode_id%>&visitid=<%=visit_id%>&slmtidno=<%=strslmtidno%>&slmtpayername=<%=strslmtpayername%>&cashcounter=<%=strcashcountercode%>&strblnggrpid=<%=strblnggrpid%>" name="BillSlmtTypeFrame" id="BillSlmtTypeFrame" frameborder=0 noresize scrolling='NO'	style='height:43vh;width:100vw'></iframe> 
		...
		<iframe name='details_frame' id='details_frame' SRC="../../eBL/jsp/BLEnterReceiptRefund.jsp?<%=params%>" frameborder=0 scrolling='no' noresize style='height:15vh;width:100vw'></iframe> 
