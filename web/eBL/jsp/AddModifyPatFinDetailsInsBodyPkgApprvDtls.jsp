...
%>
	...
	<table class='grid' width='100%' id="PkgDtls_tbl">
		<tr>
			...
			<td  class='COLUMNHEADER' ><fmt:message key="eBL.packageApprovalAmt.label" bundle="${bl_labels}"/></td>
...
%>
			...
			<td  class='fields' ><input type="text" name='aprv_amt<%=i%>' id='aprv_amt<%=i%>' value='<%=aprv_amt%>' style='text-align:right'   onKeyPress='return(ChkNumberInput(this,event,document.forms[0].noofdecimal.value));' onblur='return CheckSplApprPkgAmt(this,"<%=i%>");' <%=disable_credit_apprd_amt%>></td>	
<%
			}
			else
			{
%>
			...
			<td  class='fields' ><input type="text" name='aprv_amt<%=i%>' id='aprv_amt<%=i%>' value='' style='text-align:right'   onKeyPress='return(ChkNumberInput(this,event,document.forms[0].noofdecimal.value));' onblur='return CheckSplApprPkgAmt(this,"<%=i%>");' <%=disable_credit_apprd_amt%>></td>	
<%
			}
%>
			<td class='fields'>
...
%>
		...
		<input type='hidden' name='appr_amt_rest_chk' id='appr_amt_rest_chk' value="<%=apprd_amt_restrict_check%>" >
