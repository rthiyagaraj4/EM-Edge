...
function date_cri_link(obj,val)
{
	...
	if(val=="I")
	{
	  ...
	  if(flag=="")
		{
	  document.getElementById("test1").innerHTML="&nbsp;&nbsp;&nbsp;"+""+getLabel("Common.from.label","Common") +"&nbsp;&nbsp;&nbsp;"+"<input type='text' name='p_fm_iss_date' id='p_fm_iss_date' size='10' onBlur = 'if(validDateObj(this,\"DMY\",\""+localeName+"\")){setDate(this);DateCompare(this,p_fm_iss_date, \"messageFrame\",\"to\");}' maxlength='10' value='' id='date_from'><input type='image' onClick=\"return showCalendar('date_from');\"   src='../../eCommon/images/CommonCalendar.gif' ";
		}
	 else{ 
		 if(value=="identity"){		
			   document.getElementById("test1").innerHTML=getLabel("Common.from.label","Common") +"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<input type='text' name='p_fm_iss_date' id='p_fm_iss_date' size='10' onBlur='if(validDateObj(this,\"DMY\",\""+localeName+"\")){setDate(this);DateCompare(this,p_fm_iss_date, \"messageFrame\",\"to\");}' maxlength='10' value='' id='date_from'><input type='image' onClick=\"return showCalendar('date_from');\"  src='../../eCommon/images/CommonCalendar.gif'  id='from_calend'>";		 
		 document.getElementById("test2").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+""+getLabel('Common.to.label','Common') +"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<input type='text' name='p_to_iss_date' id='p_to_iss_date' size='10'  maxlength='10' onBlur ='if(validDateObj(this,\"DMY\",\""+localeName+"\")){setDate(this);DateCompare(this,p_to_iss_date, \"messageFrame\",\"to\");}' value='' id='date_to' ><input type='image' onClick=\"return showCalendar('date_to');\" src='../../eCommon/images/CommonCalendar.gif'  id='to_calend'>";
		 }
		 else{
		 document.getElementById("test1").innerHTML="&nbsp;&nbsp;&nbsp;"+""+getLabel("Common.from.label","Common") +"&nbsp;&nbsp;&nbsp;&nbsp;"+"<input type='text' name='p_fm_iss_date' id='p_fm_iss_date' size='10' onBlur='if(validDateObj(this,\"DMY\",\""+localeName+"\")){setDate(this);DateCompare(this,p_fm_iss_date, \"messageFrame\",\"to\");}' maxlength='10' value='' id='date_from'><input type='image' onClick=\"return showCalendar('date_from');\"  src='../../eCommon/images/CommonCalendar.gif'  id='from_calend'>";
