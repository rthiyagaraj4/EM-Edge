		...
		<td width="100%" class="Border" >
				...
				<tr>
					...
					<td class='fields' ><select name='p_order_by' id='p_order_by' tabIndex='4'>
						<option value='1'><fmt:message key="eFM.FSLocationCode.label" bundle="${fm_labels}"/></option>
						<option value='2'><fmt:message key="eFM.FSLocationDescription.label" bundle="${fm_labels}"/></option>
						</select>
					</td>
				</tr>
