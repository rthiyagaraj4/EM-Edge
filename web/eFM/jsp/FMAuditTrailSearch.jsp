	...
	<tr>
			 ...
			 if (file_type_yn.equals("N"))
		{
		 ...
		 %>
		    ...
		    <td width='30%' id="fileid" class='fields'><input type='text' name='fileno' id='fileno' size='20'  tabIndex="2" maxlength='<%=p_file_no_length%>' value='' onKeyPress='return CheckForSpecChars(event)' onBlur="CheckFileExists(this.value)" ><img src='../../eCommon/images/mandatory.gif' align='center'></img> 			</td>
		</tr>
		<tr>
			<td class='label' width='10%'><fmt:message key="eFM.VolumeNo.label" bundle="${fm_labels}"/></td>
