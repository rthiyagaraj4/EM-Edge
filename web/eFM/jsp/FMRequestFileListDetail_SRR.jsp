...
%>
	<table width='70%' cellPadding="5" cellSpacing="0"  align='center' >
		...
		<tr>
			...
			<td	class='fields' colspan='3'><select name='p_iss_fs_locn' id='p_iss_fs_locn'  onChange=''><%=sb.toString()%></select><img align=center src='../../eCommon/images/mandatory.gif'></img></td>
		       ...
		       <tr>
               <td width='45%'  class='label' ><fmt:message key="Common.date.label" bundle="${common_labels}"/> <fmt:message key="Common.criteria.label" bundle="${common_labels}"/>
	           </td>
				<td  class='fields' ><select name="P_DATE_CRITERIA" id="P_DATE_CRITERIA"  onchange='date_cri_link(this,"<%=flag%>");' > 
			  <option value=' ' >------<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>-----</option>
              <option value='1' ><fmt:message key="Common.Request.label" bundle="${common_labels}"/> <fmt:message key="Common.date.label" bundle="${common_labels}"/> </option>
			    <option value='2' > <fmt:message key="eFM.RequireonDate.label" bundle="${fm_labels}"/> </option> </select><img src='../../eCommon/images/mandatory.gif' align='center'></img></td>
			   </tr>
	...
	<!--	<tr>
		...
		<tr>
			<table width='70%' cellPadding="5" cellSpacing="0"  align='center' ><tr> <td class='label' width='45%'><fmt:message key="Common.orderBy.label" bundle="${common_labels}"/></td>
