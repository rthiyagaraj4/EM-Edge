...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<iframe name='commontoolbarFrame' id='commontoolbarFrame' src='<%=source%>' frameborder='0' scrolling=no noresize style='height:8vh;width:100vw'></iframe>
		<iframe name='f_query_add_mod' id='f_query_add_m</iframe>od' src='../../eFM/jsp/FMChangeStorageLocnMain.jsp?user_security_yn=<%=user_security_yn%>&p_access_all=<%=p_access_all%>' frameborder='0' scrolling='no' style='width:100%;height:86vh'></iframe>
