...
<td  class='label' width="15%"><fmt:message key="eFM.DocumentFolder.label" bundle="${fm_labels}"/></td>
<td  class='fields' width="25%"><input type='text' name='doc_folder_name' id='doc_folder_name' value='' maxlength=30 size=20 ></td>
<td class='label'  width="14%"><fmt:message key="Common.searchby.label" bundle="${common_labels}"/></td>
<td class='fields' width='20%' ><select name='search_by' id='search_by'>
<option value=''>--------<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>-------</option>
<option value='M'><fmt:message key="Common.Mandatory.label" bundle="${common_labels}"/></option>
<option value='S'><fmt:message key="eFM.Statutory.label" bundle="${fm_labels}"/></option>
