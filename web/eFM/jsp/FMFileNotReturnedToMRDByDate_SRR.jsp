...
%>
             ...
             <tr>
               <td width='50%'  class='label' ><fmt:message key="Common.date.label" bundle="${common_labels}"/> <fmt:message key="Common.criteria.label" bundle="${common_labels}"/>
	           </td>
              ...
              <option value='I' ><fmt:message key="Common.Issue.label" bundle="${common_labels}"/> <fmt:message key="Common.date.label" bundle="${common_labels}"/> </option>
			    <option value='P' ><fmt:message key="Common.Pending.label" bundle="${common_labels}"/> <fmt:message key="Common.date.label" bundle="${common_labels}"/> </option> </select><img src='../../eCommon/images/mandatory.gif' align='center'></img></td>
			   </tr>
	 ...
	 <tr>
					  ...
					  {
%>
					   <td  class='label' width='50%'><fmt:message key="eFM.IncludeInpatients.label" bundle="${fm_labels}"/></td>
