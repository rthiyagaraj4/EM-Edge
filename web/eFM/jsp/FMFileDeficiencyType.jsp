...
%>
			...
			<tr>
						...
						name='p_from_date' id='p_from_date' value=''  size="10"	maxlength="10" onBlur='validDateObj(this,"DMY","<%=localeName%>");'><input type="image" src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('date_from');"></td>
						<td  class='label' >&nbsp;</td>
