...
<body onMouseDown="CodeArrest()" onKeyDown = 'lockKey();'>
  ...
  <tr> 
		...
		<td width="7%" class='label'><font size=1>&nbsp;&nbsp;<b> <fmt:message key="eFM.ApptCancelled.label" bundle="${fm_labels}"/> </b></font></td>

		<td width="1%" style='background-color:#FF9999;'>&nbsp;</td>
		<td width="7%" class='label'><font size=1>&nbsp;&nbsp;<b> <fmt:message key="eFM.ScheduleCancelled.label" bundle="${fm_labels}"/> </b></font></td>

		<td width="1%" style='background-color:#FF66FF'>&nbsp;</td>
		<td width="8%" class='label'><font size=1>&nbsp;&nbsp;<b> <fmt:message key="eFM.ApptTransfered.label" bundle="${fm_labels}"/></b></font></td>
