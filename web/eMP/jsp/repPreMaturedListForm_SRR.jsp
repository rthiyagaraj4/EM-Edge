...
<tr>
	<td  class="label" width="25%"><fmt:message key="eMP.NewBorn.label" bundle="${mp_labels}"/>&nbsp;<fmt:message key="Common.weight.label" bundle="${common_labels}"/> </td>
...
%>
	...
	<input type="hidden" name="currdate" id="currdate"		value="<%= Sdate %>">
	 ...
	 <input type="hidden" name="min_weight" id="min_weight"		value="<%=min_weight%>">
	 <input type="hidden" name="max_weight" id="max_weight"		value="<%=max_weight%>">
