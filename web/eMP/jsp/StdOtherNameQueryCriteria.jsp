...
<table border=0 align='center' width="90%" cellpadding=2 cellspacing=0>
	...
	<TR>
				<TD class="label" width='40%'><fmt:message key="eMP.OtherName.label" bundle="${mp_labels}"/></td>
				<td class='fields' >
	...
	<TR>
				<TD class="label" ><fmt:message key="eMP.OtherNamOtherLang.label" bundle="${mp_labels}"/></td>
				<%
				...
				<table width='100%'>
					...
					<tr>	<td nowrap width='45%'  align='center'>
									<select name='orderbycols' id='orderbycols' size='5' >
										<option value='other_name_loc_lang'><fmt:message key="eMP.OtherNamOtherLang.label" bundle="${mp_labels}"/></option>
										</select>
										</td>
							<td align='center' width='3%' >
								...
								<option value='other_name'><fmt:message key="eMP.OtherName.label" bundle="${mp_labels}"/></option>
								</select>
								</td>
					</tr>
			 </table>
