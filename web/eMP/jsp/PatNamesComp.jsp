...
<SCRIPT LANGUAGE="JavaScript"> 
	...
	function populateLocalValues(obj,fromobj,toobj,lang,CalledFromFunction){		
		...
		if(document.getElementById("language_direction").value == "R"){
	...
	async function callSearch(fromobj, toobj, field_lang,CalledFromFunction){   
		...
		if(document.getElementById("pat_names_in_oth_lang_yn").length > 0){
			...
			names_in_oth_lang = document.getElementById("pat_names_in_oth_lang_yn").value;
		}
		var lang_dir = ""; 
		
		//if(document.forms[0].language_direction.length > 0) {	
		if(document.getElementById("language_direction").length > 0) {
			lang_dir = document.forms[0].language_direction[1].value;	
		}else{
			//lang_dir = document.forms[0].language_direction.value;	
			lang_dir = document.getElementById("language_direction").value;
		}
		if(lang_dir == 'R'){
...
<% 
	...
	String familyNametextBoxSize	= "7"; //20
		...
		<%
				...
				{ %>
					...
					{ 
						...
						%>
						<script>
							if(document.getElementById('name_prefix_img').length > 0)
								document.getElementById('name_prefix_img')[1].style.visibility='visible';
							else 
						...
						%>
								<script>
								/*
									if(document.forms[0].name_prefix_img && document.forms[0].name_pfx_reqd_for_org_mem_yn.value=='Y') {
								...
								*/
									if(document.getElementById('name_prefix_img') && document.getElementById('name_pfx_reqd_for_org_mem_yn').value=='Y') {
										document.getElementById('name_prefix_img').style.visibility='visible';
							...
							prefix_length = NamePrefixArray.length;
								for(i = 0; i < prefix_length; i++) {
									...
									if('<%=CalledFromFunction%>'=='NewbornDtls') {
										...
										if('<%=CalledFromFunction%>'=='NewbornDtls') {
											if(document.forms[0].name_prefix && document.forms[0].name_prefix)  {
												document.forms[0].name_prefix[1].options.add(opt);		
											}
										} else { 
											if(document.forms[0].name_prefix){
					 ...
					 for(int i=1;i<=4;++i)
					 {
						 ...
						 if (order.equals("First_Name_Order"))
						 {
							...
							{ 
								...
								else out.print(" value = \"\" >");%><input type='button' style='<%=name_comp_visibility%>' class='button' value='?' onclick="callSearch(first_name,'first_name_oth_lang','English','<%=CalledFromFunction%>')" name='bf' id='bf'></td><td class='label' ></td> <%
							}
							else
							{
								emptyCnt++;
						 ...
						 if (order.equals("Second_Name_Order"))
						 {
							...
							{ 
								...
								} else out.print(" value = \"\" >");%><input type='button' style='<%=name_comp_visibility%>' class='button' value='?' onclick="callSearch(second_name,'second_name_oth_lang','English','<%=CalledFromFunction%>')" name='bs' id='bs'></td><td class='label' >&nbsp;</td><%
							}
							else
							{
								emptyCnt++;
						 ...
						 if (order.equals("Third_Name_Order"))
						 {
							...
							{ 
								...
								}else out.print(" value = \"\" >");%><input type='button' style='<%=name_comp_visibility%>' class='button' value='?' onclick="callSearch(third_name,'third_name_oth_lang','English','<%=CalledFromFunction%>')" name='bt' id='bt'></td><td class='label' >&nbsp;</td> <%
							}
							else
							{
								emptyCnt++;
						 ...
						 if (order.equals("Family_Name_Order"))
						 {
							...
							{   
								...
								if (pat_name_as_multipart_yn.equals("Y")) { %><input type='button' style='<%=name_comp_visibility%>' class='button' value='?' onclick="callSearch(family_name,'family_name_oth_lang','English','<%=CalledFromFunction%>')" name='bfam' id='bfam'> 
								<% } %> 
		...
		{ 
			...
			{ 
				...
				else
				{
					...
					%>
						<script>							
							if ((document.getElementById('name_prefix_oth')) && (document.getElementById('name_pfx_reqd_for_org_mem_yn').value=='Y')) { 		document.getElementById('name_prefix_oth').style.visibility='visible' 
							} else {
			 ...
			 for(int i=1;i<=4;++i)
			 {
				 ...
				 if (order.equals("First_Name_Order"))
				 {
					...
					{ 
						...
						%><input type='button' class='button' value='?' style='visibility:hidden' onclick="document.forms[0].first_name_oth_lang.focus();callSearch('first_name_oth_lang','first_name','Others','<%=CalledFromFunction%>')" name='bfo' id='bfo'>
						</td><td class='label' >&nbsp;</td>
						<%
					}
					else
				 ...
				 if (order.equals("Second_Name_Order"))
				 {
					...
					{ 
						...
						%><input type='button' class='button' style='visibility:hidden' value='?'onclick="callSearch(second_name_oth_lang,second_name,'Others','<%=CalledFromFunction%>')" name='bso' id='bso'> 
						</td><td class='label' >&nbsp;</td>
						<%
					}
					else
				 ...
				 if (order.equals("Third_Name_Order"))
				 {
					...
					{ 
						...
						%><input type='button' class='button' value='?' style='visibility:hidden' onclick="callSearch(third_name_oth_lang,third_name,'Others','<%=CalledFromFunction%>')" name='bto' id='bto'>
						</td><td class='label' >&nbsp;</td>
						<%
					}
					else
				 ...
				 if (order.equals("Family_Name_Order"))
				 {
					...
					%><input type='button' class='button' value='?' style='visibility:hidden' onclick="callSearch(family_name_oth_lang,family_name,'Others','<%=CalledFromFunction%>')" id='bfamo' name='bfamo'>
						</td><td class='label' >&nbsp;</td>
						<%
				  }
				  else
			...
			for(int i=4;i>0;--i)
			 {
				 ...
				 if (order.equals("Family_Name_Order"))
				 {
					...
					%><input type='button' class='button' value='?' style='<%=name_comp_visibility%>' onclick="callSearch(family_name_oth_lang,family_name,'Others','<%=CalledFromFunction%>')" id='bfamo' name='bfamo'>
						</td><td class='label' >&nbsp;</td>
						<%
				  }
				  else
			  ...
			  else 	if (order.equals("Third_Name_Order"))
				 {
					...
					{ 
						...
						%><input type='button' class='button' value='?' style='<%=name_comp_visibility%>' onclick="callSearch(third_name_oth_lang,third_name,'Others','<%=CalledFromFunction%>')" name='bto' id='bto'>
						</td><td class='label' >&nbsp;</td>
						<%
					}
					else
				 ...
				 else if (order.equals("Second_Name_Order"))
				 {
					...
					{ 
						...
						%><input type='button' class='button' style='<%=name_comp_visibility%>' value='?'onclick="callSearch(second_name_oth_lang,second_name,'Others','<%=CalledFromFunction%>')" name='bso'id='bso'> 
						</td><td class='label' >&nbsp;</td>
						<%
					}
					else
				 ...
				 else  if (order.equals("First_Name_Order"))
				 {
					...
					{ 
						...
						%><input type='button' class='button' value='?' style='<%=name_comp_visibility%>' onclick="callSearch(first_name_oth_lang,first_name,'Others','<%=CalledFromFunction%>')" name='bfo' id='bfo'>
						</td><td class='label' >&nbsp;</td>
						<%
					}
					else
