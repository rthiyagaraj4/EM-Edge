	...
	<td width="80%" class="Border" align='center'>
				...
				<tr>
					...
					<td class='fields'><select name='p_order_by' id='p_order_by'>
						<option value='1'><fmt:message key="Common.CategoryCode.label" bundle="${common_labels}"/>
						<option value='2'><fmt:message key="Common.CategoryDescription.label" bundle="${common_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
