...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
		...
		<form name='patEncBannerDtlForm' id='patEncBannerDtlForm'>
			<table  align='center' cellpadding=3 cellspacing=0 border=0 width='100%'>
				<tr>
					<td align='right' width='80%'><input type='button' class='button' name='defaultBannerView' id='defaultBannerView' onclick="loadDefault()" value="<fmt:message key='eMP.ViewDefaultBanner.label' bundle='${mp_labels}'/>"></td>
					<td align='right'><input type='button' class='button' name='Preview' id='Preview' onclick="buildHTMLForPreviewBanner()" value="<fmt:message key='eMP.PreviewBanner.label' bundle='${mp_labels}'/>"></td>
				<tr>
			</table>

			<table  align='center' cellpadding=3 cellspacing=0 border=1 width='100%'>
				<tr>
					<th colspan='5'><fmt:message key='Common.Values.label' bundle='${common_labels}'/>			
					</th>
					<th colspan='3'><fmt:message key='eMP.Legend.label' bundle='${mp_labels}'/>					
					</th>
				</tr>
				<tr>
					<td class='CAFLOWSHEETLEVEL1'><fmt:message key="Common.defaultSelect.label" bundle='${common_labels}'/></td>
					<td class='CAFLOWSHEETLEVEL1'><fmt:message key="Common.DisplayOrder.label" bundle='${common_labels}'/></td>
					<td class='CAFLOWSHEETLEVEL1'><fmt:message key="eMP.FieldName.label" bundle='${mp_labels}'/></td>
					<td class='CAFLOWSHEETLEVEL1'><fmt:message key="eMP.ActualLength.label" bundle='${mp_labels}'/></td>
					<td class='CAFLOWSHEETLEVEL1'><fmt:message key="eMP.DisplayLenght.label" bundle='${mp_labels}'/></td>
					<td class='CAFLOWSHEETLEVEL1'><fmt:message key="eMP.SpaceBeforeText.label" bundle='${mp_labels}'/></td>
					<td class='CAFLOWSHEETLEVEL1'><fmt:message key="eMP.DisplayText.label" bundle='${mp_labels}'/></td>
					<td class='CAFLOWSHEETLEVEL1'><fmt:message key="eMP.ToolTipText.label" bundle='${mp_labels}'/></td>
				</tr>
				<%
					if(loadFirstTime.equals("Yes"))
					{							
