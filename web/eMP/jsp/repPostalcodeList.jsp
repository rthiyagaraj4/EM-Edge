	...
	<tr>
		<td width="80%" class="Border" >
				<table width='80%' cellPadding="3" cellSpacing="0" align='center'>
					...
					<tr>
						<td class='label'><fmt:message key="eMP.postalcode.label" bundle="${mp_labels}"/></td>
				...
				<tr>
					...
					<td class='fields'><select name='p_order_by' id='p_order_by'>
						<option value='1'><fmt:message key="eMP.postalcode.label" bundle="${mp_labels}"/>
						<option value='2'><fmt:message key="eMP.PostalDesc.label" bundle="${mp_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
