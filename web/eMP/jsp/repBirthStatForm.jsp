<!DOCTYPE html>
<%@ page import="java.sql.*, webbeans.eCommon.*,webbeans.eCommon.ConnectionManager,eCommon.Common.*"  contentType="text/html;charset=UTF-8"%>
...
<!-- previous code onBlur="CheckMonth(this)" -->
		...
		<tr>
			...
			<td class='fields'><select name="p_outcome" id="p_outcome" onChange="enableFields(this)">
				...
				<option value="L" selected><fmt:message key="eMP.Alive.label" bundle="${mp_labels}"/></option><!-- Added by Rameswar on 23rd June 2015 against HSA-CRF-0223 IN050565 -->
				<%}else{%>
