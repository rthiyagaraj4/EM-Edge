	...
	<tr>
		<td width="80%" class="Border" >
				...
				<tr>
					...
					<option value="7"><fmt:message key="Common.ReasonCode.label" bundle="${common_labels}"/>
					<option value="8"><fmt:message key="Common.ReasonDescription.label" bundle="${common_labels}"/>
					</select>
					</td>
				</tr>
				<tr>
					...
					<option value="1"><fmt:message key="Common.area.label" bundle="${common_labels}"/>&nbsp;<fmt:message key="Common.code.label" bundle="${common_labels}"/>
					<option value="2"><fmt:message key="Common.area.label" bundle="${common_labels}"/>&nbsp;<fmt:message key="Common.description.label" bundle="${common_labels}"/>
					</select>
					</td>
				</tr>
				<tr>
