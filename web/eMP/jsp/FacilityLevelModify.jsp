 ...
 <br><br><br><br><br>
  <table border="0" cellpadding="3" cellspacing="0" width="90%" align=center>
    ...
    <tr>
      ...
      <td width="65%"  class='fields' ><input type="text" name="Facility_Name" id="Facility_Name" value="<%=facility_name%>" size='40' readonly></td>
    </tr>
	<%
			if(tm_req.equals("N"))
			{
  ...
  <% } %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="90%" align=center>
  	<tr>
    		<td class='columnheader'><b><fmt:message key="eMP.MedicalRecordAdministration.label" bundle="${mp_labels}"/></b></td>
    	</tr>
    </table>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="90%" align=center>
  	<tr>
  			...
  			<table border="0" cellpadding="3" cellspacing="0" width="80%" align=center>
               <tr><td colspan=''>&nbsp;</td></tr>
				<tr>
  				<td class="querydata" colspan=0><fmt:message key="eMP.FileMaintenance.label" bundle="${mp_labels}"/></td>
    				<td class="querydata" colspan=2><fmt:message key="eMP.NumberingControl.label" bundle="${mp_labels}"/></td>
				...
				%>
	       			  <fmt:message key="Common.single.label" bundle="${common_labels}"/>
    				</td>
				...
				%>
    				<fmt:message key="eMP.AllowseparateMRN.label" bundle="${mp_labels}"/>
    				</td>
				...
				%>
				     ...
				     <fmt:message key="Common.multiple.label" bundle="${common_labels}"/>
    				</td>
				...
				%>
			    	<fmt:message key="eMP.KeepFileNumbersameasPatientID.label" bundle="${mp_labels}"/>
			    	</td>
...
%>
	  ...
	  <tr>
	  	<td width=100% class="BORDER">
			 ...
			 <tr><td width=23% align="right" class="label">Face Sheet Declaration</td><td width=77% align='left' valign='top'>&nbsp;<input type='text' name='Face_Sheet_1' id='Face_Sheet_1' size='70' maxlength='80' onBlur="makeValidString(this);" Value="<%=Line1%>"></td></tr>
