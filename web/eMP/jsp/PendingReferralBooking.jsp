...
<html>
  ...
  <iframe name='commontoolbarFrame' id='commontoolbarFrame' src=<%= source %> frameborder=0 scrolling='no' noresize style='height:8vh;width:100vw'></iframe>
		<iframe name='f_query_add_mod_main' id='f_query_add_mod_main' 	src='../../eMP/jsp/ReferralSearchFrameset.jsp?<%=source%>' frameborder=0 style='height:83vh;width:100vw'></iframe>
