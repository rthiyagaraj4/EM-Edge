...
else if ( f_query_add_mod.document.repBirthStat.dmy_ind.value == 'M')
{
		...
		var names2  = new Array ( getLabel('eMP.WeightRange.label','MP'), getLabel('Common.from.label','common')+" "+ getLabel('Common.month.label','common'),getLabel('Common.to.label','common')+" "+ getLabel('Common.month.label','common'));
 ...
 if( f_query_add_mod.checkFields( fields2, names2, messageFrame))
	{
	 ...
	 {
		 if(  f_query_add_mod.doDateCheckMsg(  f_query_add_mod.document.forms[0].ds_from_date1,  f_query_add_mod.document.forms[0].ds_to_date1, messageFrame,'DMY' ) ) 
		{
	...
	// if( validateMonth_Year("month", f_query_add_mod.document.forms[0].ds_from_date2,  f_query_add_mod.document.forms[0].ds_to_date2, messageFrame ) ) 
		if(f_query_add_mod.doDateCheckMsg(f_query_add_mod.document.forms[0].ds_from_date2,  f_query_add_mod.document.forms[0].ds_to_date2, messageFrame,'MY' ))
		{			
	 ...
	 // if( validateMonth_Year("year", f_query_add_mod.document.forms[0].ds_from_date3,  f_query_add_mod.document.forms[0].ds_to_date3, messageFrame ) ) 
	  if( f_query_add_mod.doDateCheckMsg(f_query_add_mod.document.forms[0].ds_from_date3,  f_query_add_mod.document.forms[0].ds_to_date3, messageFrame,'YY' ) ) 
		{			
...
async function searchCode(obj,target)
{
	...
	{
		tit=getLabel('eMP.AttendingMidwife.label','MP');
