...
function ReadSmartCard_04(Calledfrom,inst,theLocation,subFrame,opCall){
	...
	//if(Calledfrom=='P' || Calledfrom=='OAAP' || Calledfrom=='PS' ||Calledfrom=='VSTREG' || Calledfrom =='REGREF' || Calledfrom =='REFQUR' || Calledfrom =='AE'|| Calledfrom=='CP' ){
		if(inst=='NC'){
			clear_smart_card_values_04(Calledfrom,inst);
		}
		if(inst=='PS' ){
			clear_smart_card_values_ps_04(Calledfrom,inst);
		}
...
function populate_Sekure_new_04(Calledfrom,inst,theLocation,subFrame,opCall,pat_name,nric_no,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,time_of_birth,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,old_ic_no){
			...
			*/			
			...
			if(inst=='CP'){  
				...
				setTimeout("populate_smart_crd_data_04('"+pat_name+"','"+nric_no+"','"+addr_1+"','"+addr_2+"','"+addr_3+"','"+city_desc+"','"+state_desc+"','"+post_code+"','"+b_date+"','"+b_place+"','"+citizen_yn+"','"+race_desc+"','"+religion_desc+"','"+gender+"','"+time_of_birth+"','"+birth_cert_no+"','"+father_name+"','"+father_ic_no+"','"+mother_name+"','"+mother_ic_no+"','"+flg_pop_dat+"','"+Calledfrom+"','"+inst+"','"+old_ic_no+"')",1000);
			...
			if(inst=='PS' ){ 
				...
				setTimeout("populate_smart_crd_data_ps_04('"+pat_name+"','"+nric_no+"','"+addr_1+"','"+addr_2+"','"+addr_3+"','"+city_desc+"','"+state_desc+"','"+post_code+"','"+b_date+"','"+b_place+"','"+citizen_yn+"','"+race_desc+"','"+religion_desc+"','"+gender+"','"+time_of_birth+"','"+birth_cert_no+"','"+father_name+"','"+father_ic_no+"','"+mother_name+"','"+mother_ic_no+"','"+flg_pop_dat+"','"+Calledfrom+"','"+inst+"','"+old_ic_no+"')",2000);
...
function populate_smart_crd_data_04(pat_name,nric_no,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,time_of_birth,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,flg_pop_dat,Calledfrom,inst,old_ic_no){
	...
	if(document.forms[0].txtSmartcard_dup.value=="1"){
		...
		if(document.forms[0].national_id_no.value==''){
			...
			set_values_04(pat_name,nric_no,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,time_of_birth,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,flg_pop_dat,Calledfrom,inst,old_ic_no);
		}	
		...
		setTimeout("populate_smart_crd_data_04('"+pat_name+"','"+nric_no+"','"+addr_1+"','"+addr_2+"','"+addr_3+"','"+city_desc+"','"+state_desc+"','"+post_code+"','"+b_date+"','"+b_place+"','"+citizen_yn+"','"+race_desc+"','"+religion_desc+"','"+gender+"','"+time_of_birth+"','"+birth_cert_no+"','"+father_name+"','"+father_ic_no+"','"+mother_name+"','"+mother_ic_no+"','"+flg_pop_dat+"','"+Calledfrom+"','"+inst+"','"+old_ic_no+"')",3000);
...
function set_values_04(pat_name,nric_no,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,time_of_birth,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,flg_pop_dat,Calledfrom,inst,old_ic_no){
...
function clear_smart_card_values_04(Calledfrom,inst){
...
function populate_smart_crd_data_ps_04(pat_name,nric_no,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,time_of_birth,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,flg_pop_dat,Calledfrom,inst,old_ic_no){
...
function clear_smart_card_values_ps_04(Calledfrom,inst){
