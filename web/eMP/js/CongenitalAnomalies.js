function show() 
{
	parent.parent.window.document.title = getLabel('Common.setup.label','common')+" "+ getLabel('eMP.CongenitalAnomalies.label','MP') ;
}

function create() 
{
	f_query_add_mod.location.href = "../../eMP/jsp/CongenitalAnomalies.jsp" ;
}

function query() 
{
	f_query_add_mod.location.href ="../../eMP/jsp/CongenitalAnomaliesQueryPage.jsp";
}
function apply() 
{
...
if (! (checkIsValidForProceed()) )
	...
	var fields = new Array ( f_query_add_mod.document.res_town_form.cong_anomalies_code,
	...
	var splField = new Array (f_query_add_mod.document.res_town_form.cong_anomalies_code);
