...
if(f_query_add_mod.document.repAppointmentsForOPD.isVirtualConsVisit.value=='true'){
	if(f_query_add_mod.document.repAppointmentsForOPD.p_virtual_consultation_visit.checked){
		f_query_add_mod.document.repAppointmentsForOPD.p_vcv.value = 'Y';
	}else{
		f_query_add_mod.document.repAppointmentsForOPD.p_vcv.value = 'N';
	}
	}
