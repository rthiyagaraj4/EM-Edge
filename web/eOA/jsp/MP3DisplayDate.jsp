...
String day_show3="";
	...
	<table border=0 width="100%" cellpadding=0 cellspacing=0>
		<tr>
			...
			<td class='fields'>
			<input id = 'date_of_expiry' type=text size=10 maxlength = 10 name='valid_date' id='valid_date' value='<%=valid_date_display1%>' onkeypress="return check_val(event)" onblur="DateCheck_new1('<%=sysdate%>',this)" <%=read_only_date%> style="width:75"><img src="../../eCommon/images/CommonCalendar.gif" id='cal1' onClick="document.forms[0].valid_date.select();return showCalendar('date_of_expiry');" style='visibility'><img src="../../eCommon/images/mandatory.gif" align='center'></img></td>
				
			<td  class='label' id = day1 width = '10%'><b><%=day_show1%></b></td>
				
			<td class='button'>
			
			<script>document.forms[0].date_of_expiry.focus();hide();</script>
				
			<input type='button' name='go' id='go' value='<fmt:message key="Common.Go.label" bundle="${common_labels}"/>' class='button' onClick='blankdatechk()'>
			
			<input type=hidden size='1' name='gggg' id='gggg' value=<%=display%> disabled style='visibility:hidden'>
			</td>
		</tr>
	</table>
	</td>
	...
	<table border=0 width="100%" cellpadding=0 cellspacing=0>
		<tr>
			...
			<td class='fields'><input id = 'date_of_expiry1' type=text size=10 maxlength = 10 name='valid_date1' id='valid_date1' value='<%=valid_date_display2%>' onkeypress="return check_val(event)" onblur="DateCheck_new2('<%=sysdate%>',this)" <%=read_only_date%> style="width:75"><img   src="../../eCommon/images/CommonCalendar.gif" id='cal2' onClick="document.forms[0].valid_date1.select();return showCalendar('date_of_expiry1');" style='visibility'><img src="../../eCommon/images/mandatory.gif" align='center'></img></td>
				
			<td class='label' id = day2 ><b><%=day_show2%></b></td>
			
			<td class='button'>
			
			<script>document.forms[0].date_of_expiry1.focus();hide();</script>
			
			<input type='button' name='goY' id='goY' value='<fmt:message key="Common.Go.label" bundle="${common_labels}"/>' class='button' onClick='blankdatechk()' >
			
			<input type=hidden size='1' name='gggg' id='gggg' value=<%=display%> disabled style='visibility:hidden'></td>
		</tr>
	</table>
	</td>
		...
		<tr>	
			...
			<td class='fields' ><input id = 'date_of_expiry2' type=text size=10 maxlength = 10 name='valid_date2' id='valid_date2' value='<%=valid_date_display3%>' onkeypress="return check_val(event)" onblur="DateCheck_new3('<%=sysdate%>',this)" <%=read_only_date%> style="width:75"><img src="../../eCommon/images/CommonCalendar.gif" id='cal3' onClick="document.forms[0].valid_date2.select();return showCalendar('date_of_expiry2');" style='visibility'><img src="../../eCommon/images/mandatory.gif" align='center'></img></td>
				
			<td class='label' id = day3 ><b><%=day_show3%></b></td>
			
			<td class='button'>
			
			<script>document.forms[0].date_of_expiry2.focus();hide();</script>
				
			<input type='button' name='goX' id='goX' value='<fmt:message key="Common.Go.label" bundle="${common_labels}"/>' class='button' onClick='blankdatechk()' >
			...
			<input type='hidden' name='clinic3' id='clinic3' value=<%=clinic_code3%> >
			<input type='hidden' name='practitioner3' id='practitioner3' value=<%=practitioner_id3%> >
			...
			<input type="hidden" name='rd_appt_yn' id='rd_appt_yn' value='<%=rd_appt_yn%>'><!-- added for the incident 40965-->
