...
<frameset cols='50%,4%,46%'>
	...
	<frame name='result1' id='result1' 	src='../../eOA/jsp/MultiSelectionApptReschedulingResult1.jsp?from_speciality=<%=from_speciality%>&to_speciality=<%=to_speciality%>&locn_type=<%=locn_type%>&from_locn=<%=from_locn%>&to_locn=<%=to_locn%>&from_resc=<%=from_resc%>&to_resc=<%=to_resc%>&from_date=<%=from_date%>&to_date=<%=to_date%>&from_res_class=<%=from_res_class%>&to_res_class=<%=to_res_class%>&oper_stn=<%=oper_stn%>&from_page=<%=from_page%>&visit_limit_rule=<%=visit_limit_rule%>' frameborder=0  scrolling='auto' noresize>
	<frame name='gopage' id='gopage' 	src='../../eOA/jsp/MultiSelectionApptReschedulingResultGo.jsp?from_speciality=<%=from_speciality%>&to_speciality=<%=to_speciality%>&locn_type=<%=locn_type%>&from_locn=<%=from_locn%>&to_locn=<%=to_locn%>&from_resc=<%=from_resc%>&to_resc=<%=to_resc%>&from_date=<%=from_date%>&to_date=<%=to_date%>&from_res_class=<%=from_res_class%>&to_res_class=<%=to_res_class%>&oper_stn=<%=oper_stn%>&from_page=<%=from_page%>&visit_limit_rule=<%=visit_limit_rule%>' frameborder=0 scrolling='auto' noresize>
	<frame name='result2' id='result2' 	src='../../eOA/jsp/MultiSelectionApptReschedulingResult2.jsp?from_speciality=<%=from_speciality%>&to_speciality=<%=to_speciality%>&locn_type=<%=locn_type%>&from_locn=<%=from_locn%>&to_locn=<%=to_locn%>&from_resc=<%=from_resc%>&to_resc=<%=to_resc%>&from_date=<%=from_date%>&to_date=<%=to_date%>&from_res_class=<%=from_res_class%>&to_res_class=<%=to_res_class%>&oper_stn=<%=oper_stn%>&from_page=<%=from_page%>&visit_limit_rule=<%=visit_limit_rule%>' frameborder=0 scrolling='auto' noresize>
