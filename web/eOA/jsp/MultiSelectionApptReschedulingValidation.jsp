...
<%
	...
	if(!time_table_type_from.equals("") && !time_table_type_to.equals("")){
		if(time_table_type_from.equals(time_table_type_to )){			
			...
			<%}else{
				%>parent.frames[1].document.getElementById('time_table_type').value='<%=time_table_type_from%>';
				flag1=true;<%
			}
		}else{
			%>flag1=false;<%
	...
	}else if(steps.equals("REMOVE_ADD_BULK_SEC_TO_SESSION"))
	{
		...
		parent.frames[1].document.getElementById('specialty_code1').value="<%=speciality_code%>";
		...
		parent.frames[1].document.getElementById('location_code2').value="<%=location%>";
		parent.frames[1].document.getElementById('specialty_code2').value="<%=speciality_code%>";
		parent.frames[1].document.getElementById('locationType2').value="<%=clinic_type%>";
		<%
