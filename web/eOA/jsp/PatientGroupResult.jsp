...
if(noOfRecords == 0){	  
	...
	<tr>
	<th><b><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.patientId.label","common_labels") %></b></th>
	<%
	...
	%>
	<th><b><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.gender.label","common_labels")%></b></th>
	<th><b><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.DateofBirth.label","common_labels")%></b></th>

	<th><b><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.MobileNo.label","common_labels")%></b></th>
	<th>Select All&nbsp;<input type='checkbox' name="checkall" id="checkall" value='N' ></th>
	 ...
	 <%while(rset.next()){
	 	...
	 	<tr >
	 		<td  class="<%=classValue%>"  ><%=(rset.getString("PATIENT_ID")==null)?"&nbsp;":rset.getString("PATIENT_ID")%></td>
	 		<%if(First_Name_Accept_Yn.equals("Y")){%>
	 			<td  class="<%=classValue%>"   ><%=(rset.getString("FIRST_NAME")==null)?"&nbsp;":rset.getString("FIRST_NAME")%></td>
	 		<%}%>
	 		<%if(Second_Name_Accept_Yn.equals("Y")){ %>
	 			<td  class="<%=classValue%>"   ><%=(rset.getString("SECOND_NAME")==null)?"&nbsp;":rset.getString("SECOND_NAME")%></td>
	 		<%}%>
	 		<%if(Third_Name_Accept_Yn.equals("Y")){ %>
	 			<td  class="<%=classValue%>"  ><%=(rset.getString("THIRD_NAME")==null)?"&nbsp;":rset.getString("THIRD_NAME")%></td>
	 		<%}%>
	 		<%if(Family_Name_Accept_Yn.equals("Y")){ %>
	 			<td  class="<%=classValue%>"  ><%=(rset.getString("FAMILY_NAME")==null)?"&nbsp;":rset.getString("FAMILY_NAME")%></td>
	 		<%}%>
	 		<td class="<%=classValue%>"  ><%=gender%></td>
	 		<td class="<%=classValue%>"  ><%=(rset.getString("DATE_OF_BIRTH")==null)?"&nbsp;":rset.getString("DATE_OF_BIRTH")%></td>
	 		
	 		<td class="<%=classValue%>"  ><%=(rset.getString("CONTACT1_NO")==null)?"&nbsp;":rset.getString("CONTACT1_NO")%></td>
	 		<td class="<%=classValue%>"  ><input name="pat_id_chk" id="pat_id_chk" type="checkbox" value="<%=rset.getString("PATIENT_ID")%>" ></td>
