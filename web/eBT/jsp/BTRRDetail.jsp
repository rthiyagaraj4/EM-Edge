...
function showToolLinks(obj,objVal,objVal1)
{
	...
	"<tr><td class=SENPAT nowrap><fmt:message key="Common.RequestedBy.label" bundle="${common_labels}" /></td><td class=SENPAT nowrap><fmt:message key="Common.date.label" bundle="${common_labels}" /></td></tr><tr><td class=SENPAT nowrap>";
...
try
{
	...
	<input type='button' name='Reqprint' id='Reqprint' value='<fmt:message key="eBT.RequestReprint.label" bundle="${bt_labels}" />'  class='button' onClick='onRecord(this)'>
	<input type='button' name='Reprint' id='Reprint'  value='<fmt:message key="Common.Reprint.label" bundle="${common_labels}" />' class='button' onClick='onRecord(this)' >		
	</td>	
	...
	<input type='hidden' name='facility' id='facility' value="<%=strFacilityId%>">
	<%
}
catch(Exception exp)
{
