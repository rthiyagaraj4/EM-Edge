...
$.fn.buttonMarkup = function( options ) {
	...
	for ( var i = 0; i < $workingSet.length; i++ ) {
		...
		while ( e.firstElementChild && !buttonElements) {
			buttonText.appendChild( e.firstElementChild );
		}
...
$.widget( "mobile.listview", $.mobile.widget, {
	...
	_addThumbClasses: function( containers )
	{
		...
		for ( i = 0; i < len; i++ ) {
			img = $( this._findFirstElementByTagName( containers[ i ].firstElementChild, "nextSibling", "img", "IMG" ) );
			if ( img.length ) {
