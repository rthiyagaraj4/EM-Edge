<%@page import="eIPAD.chartsummary.activeproblems.healthobject.DiagnosisDetailsHO"%>
<%@page import="eIPAD.chartsummary.activeproblems.response.DiagnosisDetailsResponse"%>
...
<body>
	<div id="divParent" class="divParent" data-role="page" style="padding: 0px">
		<form name = "frmModifyDiag" id = "frmModifyDiag" style="width: 100%; height: 100%" action="${path}/mobile/chartsummary/DiagnosisTransaction">
			...
			<div id="allergyHeader" class="AllergyHeader" style="padding: 0px"
									...
									<div style="display:table-row">
						 				...
						 				<div style="display:table-cell;width:60%;">
						 					<div class="cstFieldContainer1 cstFieldContainerTheme cstFieldDull" >
						 						...
						 						<input type="hidden" name="hdnDiagSet" id="hdnDiagSet" id="hdnDiagSet" value='<%=diagDetails.getDiagSetId() %>' />
						 					</div>
						 				</div>
						 					...
						 					<div class="cstFieldContainer1 cstFieldContainerTheme cstFieldDull">
						 						...
						 						<div style="display:table">
						 							<div style="display:table-row">
						 								...
						 								<%=diagDetails.getDiagCode()%>
						 								</div>
						 								<input type="hidden" name="hdnDiagCode" id="hdnDiagCode" id="hdnDiagCode" value='<%=diagDetails.getDiagCode()%>' data-mandatory="true" data-errmsg1="An active record already exists for this Diagnosis"/>
									...
									<div style="display:table-row">
						 				...
						 				<div style="display:table-cell;width:60%;">
						 					<div class="cstFieldContainer2 cstFieldContainerTheme cstFieldDull">
						 						<textarea class="csttxtArea" maxlength="500" data-role="none" id="txtDiagDesc" name="txtDiagDesc" style="display: block" data-mandatory="true" value="<%=diagDetails.getDiagDesc()%>" readonly><%=diagDetails.getDiagDesc()%></textarea>
						 					</div>
						 				</div>
						 				<div style="display:table-cell;width:10%"></div>
						 			</div>
						 					...
						 					<div class="cstFieldContainer1" >
												<div  class="parent" data-role="none">
													<div id="EncStageSlider" class="scale scaleTheme" data-role="none">
														...
														data-valuefield="hdnEncStage" data-value1="A" data-value2="D" data-value3="I" data-defaultvalue="<%=diagDetails.getEncounterStage()%>" 
														data-selstylelabel="slSelectedLabel"></div>
														<input type="hidden" id="hdnEncStage" name="hdnEncStage" id="hdnEncStage" value="<%=diagDetails.getEncounterStage()%>">
									...
									<div style="display:table-row">
						 				...
						 				<div style="display:table-cell;width:60%;">
						 					<div class="cstFieldContainer1 cstFieldContainerTheme" >
												...
												<input type="hidden" name="hdnDiagClass" id="hdnDiagClass" id="hdnDiagClass" value='<%=diagDetails.getDiagClassCode()%>' />
						 					</div>
						 				</div>
						 				<div style="display:table-cell;width:10%"></div>
						 			</div>
						 					...
						 					<div class="cstFieldContainer1" >
												<div  class="parent" data-role="none">
													<div id="NatureSlider" class="scale scaleTheme" data-role="none">
														...
														data-valuefield="hdnNature" data-value1="A" data-value2="W" data-value3="P" data-defaultvalue="<%=diagDetails.getNature()%>" 
														data-selstylelabel="slSelectedLabel"></div>
														<input type="hidden" id="hdnNature" name="hdnNature" id="hdnNature" value="<%=diagDetails.getNature()%>">
						 					...
						 					<div class="cstFieldContainer1 cstFieldContainerTheme" >
								 				...
								 				<script>
													$("#cmbAccuracy").kendoComboBox({
														dataTextField: "desc",
								                        dataValueField: "code",
								                        value: "<%=diagDetails.getAccuracyCode()%>",
								                        change: function(e) {
								                            if(this.select()==-1){
								                            	this.value('');
								                            	$("#hdnDiagAcc").val("");
												...
												<input type="hidden" name="hdnDiagAcc" id="hdnDiagAcc" id="hdnDiagAcc" value='<%=diagDetails.getAccuracyCode()%>' />
												<input type="hidden" name="hdnDiagAccInd" id="hdnDiagAccInd" id="hdnDiagAccInd" value='<%=diagDetails.getAccuracyInd()%>' />
						 					</div>
						 				</div>
						 				<div style="display:table-cell;width:10%"></div>
						 			</div>
						 					...
						 					<div class="cstFieldContainer1" >
												<div  class="parent" data-role="none">
													<div id="SeveritySlider" class="scale scaleTheme2" data-role="none">
														...
														data-valuefield="hdnSeverity" data-value1="D" data-value2="L" data-value3="S" data-value4="E" data-defaultvalue="<%=diagDetails.getSeverity()%>" 
														data-selstylelabel="slSelectedLabel"></div>
														<input type="hidden" id="hdnSeverity" name="hdnSeverity" id="hdnSeverity" value="<%=diagDetails.getSeverity()%>">
						 					...
						 					<div class="cstFieldContainer1" >
												<div  class="parent" data-role="none">
													<div id="PrioritySlider" class="scale scaleTheme2" data-role="none">
														...
														data-valuefield="hdnPriority" data-value1="N" data-value2="H" data-value3="C" data-defaultvalue="<%=diagDetails.getPriority()%>" 
														data-selstylelabel="slSelectedLabel"></div>
														<input type="hidden" id="hdnPriority" name="hdnPriority" id="hdnPriority" value="<%=diagDetails.getPriority()%>">
						 					...
						 					<div class="cstFieldContainer1" >
												<div  class="parent" data-role="none">
													<div id="OnsetTypeSlider" class="scale scaleTheme" data-role="none">
														...
														data-valuefield="hdnOnsetType" data-value1="N" data-value2="A" data-value3="C" data-defaultvalue="<%=diagDetails.getOnsetType()%>" 
														data-selstylelabel="slSelectedLabel"></div>
														<input type="hidden" id="hdnOnsetType" name="hdnOnsetType" id="hdnOnsetType" value="<%=diagDetails.getOnsetType()%>">
						 				...
						 				<div style="display:table-cell;width:60%;">
						 					<div class="cstFieldContainer1 cstFieldContainerTheme cstFieldDull" >
												...
												<input id="OnsetDate" data-type="Date" data-count="I" style="text-align:right" data-role="none" onchange="validate(this)"
											            ...
											            $(document).ready(function() {
											               ...
											               // var today1 = new Date();
											                $("#OnsetDate").kendoDateTimePicker({
											        			value: StringToDate("<%=diagDetails.getOnsetDate()%>"),
											        ...
											        <input type="hidden" id="hdnOnsetDateTime" name="hdnOnsetDateTime" id="hdnOnsetDateTime" value="<%=diagDetails.getOnsetDate()%>">
						 					</div>
						 				</div>
						 				<div style="display:table-cell;width:10%"></div>
						 			</div>
						 				...
						 				<div style="display:table-cell;width:60%;">
						 					<div class="cstFieldContainer1 cstFieldContainerTheme" >
												...
												<input id="AsOnDate" data-type="Date" style="text-align:right" data-role="none" onchange="validate(this)"
														...
														$(document).ready(function() {
											               ...
											               // onsetDTPicker = $("#OnsetDate").data("kendoDateTimePicker");
											                $("#AsOnDate").kendoDatePicker({
											        			value: StringToDate("<%=diagDetails.getStatusDate()%>"),
											        			format: "dd/MM/yyyy",
											        			max: today,
											        			min:patDOB,
											        			change: function() {
											        ...
											        <input type="hidden" id="hdnAsOnDate" name="hdnAsOnDate" id="hdnAsOnDate" value="<%=diagDetails.getStatusDate()%>">
						 					</div>
						 				</div>
						 				<div style="display:table-cell;width:10%"></div>
						 			</div>
						 													...
						 													<div class = "sliderSmallParent" data-role = "none"> 
																		  		<div  class = "sliderSmallScale sfsScaleTheme" id="AnatomicalSlider"  data-role = "none" >
																			  		<div class="sliderSfsIns sliderSfsInsTheme">
																						...
																						data-valuefield="hdnAnatomicalSite" data-value1="C" data-value2="O" data-defaultvalue="<%=diagDetails.getAnatomicalSite()%>" 
																						data-selstylelabel="slSelectedLabel" data-readonly="Y">
																			  		    </div>
																			  		    <input type="hidden" id="hdnAnatomicalSite" name="hdnAnatomicalSite" id="hdnAnatomicalSite" value="<%=diagDetails.getAnatomicalSite()%>">
																			  		</div>
																		  		</div>
				 												...
				 												<input id="cmbAnatSite" name="cmbAnatSite" id="cmbAnatSite" data-type="ComboBox" data-role="none"/>
													 				<script>
																		$("#cmbAnatSite").kendoComboBox({
																			dataTextField: "desc",
													                        dataValueField: "code",
													                        value: "<%=diagDetails.getAnatomicalSiteCode()%>",
													                        change: function(e) {
													                            if(this.select()==-1){
													                            	this.value('');
																	...
																	<input type="hidden" id="hdnAnatomicalSiteVal" name="hdnAnatomicalSiteVal" id="hdnAnatomicalSiteVal" value="<%=diagDetails.getAnatomicalSiteCode()%>">
						 									</div>
						 								</div>
						 							</div>
						 						</div>
						 					...
						 					<div class="cstFieldContainer1 cstFieldContainerTheme cstFieldDull" >
								 				...
								 				<script>
													$("#cmbApplSide").kendoComboBox({
														...
														dataTextField: "name",
														dataValueField: "id",
														value: "<%=diagDetails.getApplicableSide()%>",
														change: function(e) {
								                            if(this.select()==-1){
								                            	this.value('');
								                            	$("#hdnDiagApplSide").val("");
												...
												<input type="hidden" name="hdnDiagApplSide" id="hdnDiagApplSide" id="hdnDiagApplSide" value="<%=diagDetails.getApplicableSide()%>" />
						 					</div>
						 				</div>
						 				<div style="display:table-cell;width:10%"></div>
						 			</div>
									...
									<div style="display:table-row">
						 				...
						 				<div style="display:table-cell;width:60%;">
						 					<div class="cstFieldContainer2 cstFieldContainerTheme">
						 						<textarea class="csttxtArea" maxlength="2000" data-role="none" id="txtRemarks" name="txtRemarks" style="display: block" rows="50" cols="10"><%=diagDetails.getRemarks()%></textarea>
						 					</div>
						 				</div>
						 				<div style="display:table-cell;width:10%"></div>
						 			</div>
				...
				<input type = "hidden" name = "hdnOccurSrlNo" id = "hdnOccurSrlNo" value="<%=diagDetails.getOccurSrlNo()%>"/>
				<input type = "hidden" name = "hdnAccessionNum" id = "hdnAccessionNum" value="<%=diagDetails.getAccessionNum()%>"/>
				<input type = "hidden" name = "hdnRelnId" id = "hdnRelnId" value="<%=diagDetails.getRelationshipId()%>"/>
				<input type = "hidden" name = "hdnLocnCode" id = "hdnLocnCode" value="<%=diagDetails.getLocnCode()%>"/>
				<input type = "hidden" name = "hdnLocnType" id = "hdnLocnType" value="<%=diagDetails.getLocnType()%>"/>
				<input type = "hidden" name = "hdnDiagEncounterId" id = "hdnDiagEncounterId" value="<%=diagDetails.getEncounterId()%>"/>
				<input type = "hidden" name = "hdnDiagFacilityId" id = "hdnDiagFacilityId" value="<%=diagDetails.getFacilityId()%>"/>
				<input type = "hidden" name = "hdnCodeIndicator" id = "hdnCodeIndicator" value="<%=diagDetails.getCodeIndicator()%>"/>
				<input type = "hidden" name = "hdnDiffGrpId" id = "hdnDiffGrpId" value="<%=diagDetails.getDiffGrpId()%>"/>
				<input type = "hidden" name = "hdnHighRiskCode" id = "hdnHighRiskCode" value="<%=diagDetails.getHighRiskCode()%>"/>
				<input type = "hidden" name = "hdnOldOnsetType" id = "hdnOldOnsetType" value="<%=diagDetails.getOnsetType()%>"/>
				<input type = "hidden" name = "hdnNotifiableCode" id = "hdnNotifiableCode" value="<%=diagDetails.getNotifiableCode()%>"/>
				<input type = "hidden" name = "hdnStatus" id = "hdnStatus" value="<%=diagDetails.getStatus()%>"/>
		</form>
	</div>
</body>
</html>
