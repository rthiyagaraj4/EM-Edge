...
if(nListSize > 0)
{
  ...
  %>
			       <tr class="trWidgetRows<%=nCssCount %>">
			          ...
			          <td style ="width:93%"  align ="left"> <div class = "spanWidRows" ><%=oPendingSchedules.getsApptDate()%>&nbsp;<%=oPendingSchedules.getsFromTime()%>-<%=oPendingSchedules.getsToTime() %>-<%=oPendingSchedules.getsLocationDesc()%>-<%=oPendingSchedules.getsResourceName()%></div></td>
			      </tr>	      
