...
*/
function reset() {
	f_query_add_mod.formROFProcessTimingDetail.reset();
}

function run(){
	var formObj=parent.f_query_add_mod.formROFProcessTimingDetail; 
...
async function searchStoreCode( obj ) {
	...
	dataValueArray[0]= document.formROFProcessTimingDetail.p_facility_id.value;
	dataTypeArray [0]= STRING

	argumentArray[0] = document.formROFProcessTimingDetail.SQL_SS_STORE_LOOKUP.value;
		dataNameArray  [1]="LANGUAGE_ID"
	dataValueArray [1]=document.formROFProcessTimingDetail.locale.value;
...
async function searchDocType( obj ) {
	...
	dataValueArray[1]= "ROF";
	dataTypeArray [1]= STRING

	argumentArray[0] = document.formROFProcessTimingDetail.SQL_SS_TRN_DOC_TYPE_LOOKUP_FOR_REPORT.value;
		dataNameArray  [2]="LANGUAGE_ID"
	dataValueArray [2]=document.formROFProcessTimingDetail.locale.value;
