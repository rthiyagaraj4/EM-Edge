...
function reset() {
	f_query_add_mod.document.formProductivityReport.reset();
}
...
async function searchCodeStoreMaster(obj) {
	...
	dataValueArray [0]=document.formProductivityReport.p_facility_id.value;
	dataTypeArray  [0]=STRING;


 // argumentArray[0] = document.formProductivityReport.SQL_SS_STORE_LOOKUP.value;
	argumentArray[0] =document.formProductivityReport.SQL_SS_STORE_PRINT_COUNT_OWNER_SELECT_LIST.value; 
	dataNameArray  [1]="LANGUAGE_ID";
	dataValueArray [1]=document.formProductivityReport.locale.value;
...
function run()
{
   ...
   var formObj=f_query_add_mod.document.formProductivityReport;
      ...
      return ;	
	   ...
	   if( isValidFromToField( formObj.P_fm_store_code,formObj.P_to_store_code,STRING, "Owner Store" ,messageFrame )  )
