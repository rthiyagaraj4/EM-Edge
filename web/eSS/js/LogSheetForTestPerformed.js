...
function reset() {
	f_query_add_mod.document.formLogSheetForTestPerformed.reset();
}

function run()
{
   var formObj=f_query_add_mod.document.formLogSheetForTestPerformed;
				 
   var fields=new Array(formObj.p_wash_unit_code);
   var names = new Array ( getLabel("eSS.AutoclaveUnit.label","eSS"));
   ...
   var blankObject	=	null;
	...
	if (blankObject != true) {
		...
		return;
    			...
    			//	if (isValidFromToField(formObj.p_fm_date, formObj.p_to_date, DATE, "Test Date", messageFrame)) 
