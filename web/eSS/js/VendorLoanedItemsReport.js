...
function reset() {
	f_query_add_mod.document.formVendorLoanedItemsReport.reset();
}
...
function searchCodeSterileGroupMaster(obj) {
	...
	dataValueArray [0]=document.formVendorLoanedItemsReport.locale.value;
	dataTypeArray  [0]=STRING;
	argumentArray[0] =document.formVendorLoanedItemsReport.SQL_SS_GROUP_LOOKUP.value; 
	argumentArray[1] = dataNameArray;
	argumentArray[2] = dataValueArray;
	argumentArray[3] = dataTypeArray;
	argumentArray[4] = "2,3";
...
function searchCodeVendorMaster	(obj) {
	...
	dataValueArray [0]=document.formVendorLoanedItemsReport.locale.value;
	dataTypeArray  [0]=STRING;
	argumentArray[0] =document.formVendorLoanedItemsReport.SQL_AP_SUPPLIER_SELECT_LIST1.value; 
	argumentArray[1] = dataNameArray;
	argumentArray[2] = dataValueArray;
	argumentArray[3] = dataTypeArray;
	argumentArray[4] = "2,3";
...
function run()
{
	    formObj = f_query_add_mod.document.formVendorLoanedItemsReport;
		...
		formObj.p_req_to_date.value = convertDate(formObj.p_req_to_date1.value, "DMY", formObj.p_language_id.value, "en");
	     if(formObj.p_req_from_date.value != "" && formObj.p_req_to_date.value != "" ){
		   ...
		   formObj.p_report_id.value = "SSVENLONITMSUM" ;
		   else
		   formObj.p_report_id.value = "SSVENLONITMDTL";
