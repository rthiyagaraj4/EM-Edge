...
function reset() {
	f_query_add_mod.document.formMonthlyServiceStatisticsByStore.reset();
}
...
function run()
{
		...
		var formObj	=	parent.f_query_add_mod.document.formMonthlyServiceStatisticsByStore;
		var messageFrame	=	parent.messageFrame;	
			...
			{
				if( isValidFromToField( formObj.p_from_store,formObj.p_to_store,STRING, "Store" ,messageFrame )  ){
...
async function searchCodeStoreMaster(obj) {
	...
	dataValueArray [0]=document.formMonthlyServiceStatisticsByStore.p_facility_id.value;
	dataTypeArray  [0]=STRING


	argumentArray[0] = document.formMonthlyServiceStatisticsByStore.SQL_SS_STORE_LOOKUP.value;
		dataNameArray  [1]="LANGUAGE_ID"
	dataValueArray [1]=document.formMonthlyServiceStatisticsByStore.locale.value;
...
async function searchCodeDocumentType(obj) {
	...
	argumentArray[0] = document.formMonthlyServiceStatisticsByStore.SQL_SS_DOC_TYPE_ROF_LIST_LOOKUP.value;
	argumentArray[1] = dataNameArray;
	argumentArray[2] = dataValueArray;
	argumentArray[3] = dataTypeArray;
	argumentArray[4] = "2,3";
