		...
		%>
			 <TR>
				<td align="center" class="<%=classValue %>" >
					<input type="text" name="code_<%=cnt %>" id="code_<%=cnt %>"  size="4" maxlength="4" class="UPPER" onKeyPress="return CheckForSpecChars(event)" onBlur="resetColorCode(this);convertToUpperCase(this);checkSpecialChars(this);">
				</td>
				<td align="center" class="<%=classValue %>" >
