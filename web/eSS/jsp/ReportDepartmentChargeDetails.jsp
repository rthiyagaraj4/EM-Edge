	...
	<body onLoad="FocusFirstElement();"onMouseDown='CodeArrest();'>
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					<td align="right" class="label" ><fmt:message key="eSS.ReportOrder.label" bundle="${ss_labels}"/></td>
					<td class=label colspan='3'>&nbsp;&nbsp;<select name="p_report_order" id="p_report_order" >
					<%=bean.getDepartmentChargeDetails()%>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
				...
				<tr>
					<td align="right" class="label" nowrap><fmt:message key="Common.department.label" bundle="${common_labels}"/></td>
			...
			<input type="hidden" name="SQL_SS_DEPT_LOOKUP" id="SQL_SS_DEPT_LOOKUP"	value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_DEPT_LOOKUP")%>">
		</form>
		<%
