	...
	try{
		...
		%>
			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%" align="center">
				<th><fmt:message key="eSS.AutoclaveUnit.label" bundle="${ss_labels}"/></th>
				<th><fmt:message key="eSS.LoadNo.label" bundle="${ss_labels}"/></th>
				<th><fmt:message key="eSS.AutoclavingDate.label" bundle="${ss_labels}"/></th>
		...
		%>
						<td class="<%=classvalue%>" onclick="disableClick(event);" align="<%=(colCount==1)?"right":(((colCount==2)||(colCount==4))?"center":"")%>"
						<%
