	...
	<body onLoad="FocusFirstElement();"onMouseDown='CodeArrest();'>
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					<td align="right" class="label" nowrap><fmt:message key="Common.userid.label" bundle="${common_labels}"/></td>
				...
				<tr>
					<td align="right" class="label" nowrap><fmt:message key="eSS.StoreCode.label" bundle="${ss_labels}"/></td>
				...
				<tr>
					...
					<%=bean.getOrderByUserAccessForStore()%>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
			...
			<input type="hidden" name="SQL_SS_USER_LOOKUP" id="SQL_SS_USER_LOOKUP"		value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_USER_LOOKUP")%>">
		</form>
	</body>
</html>	
