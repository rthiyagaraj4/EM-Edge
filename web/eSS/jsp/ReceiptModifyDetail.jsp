		...
		<form name="formDispatchDetail" id="formDispatchDetail" >
			...
			<table border="0" cellpadding="3" cellspacing="0" width='100%' align='center'>
				...
				<tr>
					...
					<td>&nbsp;&nbsp;<input type='text' name="group_desc" id="group_desc" value="<%=bean.getGroup_desc()%>" maxLength='15' size='15' readOnly ><input type='button' class='BUTTON' value='?' name="group_search" id="group_search" disabled ><input type="hidden" name="group_code" id="group_code" value="<%=bean.getGroup_code()%>"></td>
				</tr>
				<tr>
				...
				<tr>
					<td  class="label"><fmt:message key="Common.ReceivedDate.label" bundle="${common_labels}"/></td>
					<td>&nbsp;&nbsp;<input type='text' name="dispatch_date" id="dispatch_date" value="<%=com.ehis.util.DateUtils.convertDate(bean.getDispatch_date(),"DMY","en",locale)%>"  maxLength="10" size="10"
					onBlur ="chkReceivedDate(this);"
					<%=disabled%>>&nbsp;<img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dispatch_date');"></img><%=bean.getMandatoryImageTag()%>
			...
			<input type='hidden' name="docdate" id="docdate"			value="<%=bean.getDoc_date()%>">
