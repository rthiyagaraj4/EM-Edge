...
%>
	<frameset rows='100,*'>
		<frame name='frameDispatchHeader'				src="../../eSS/jsp/ReceiptAddModify.jsp?<%=request.getQueryString()%>" frameborder=0 scrolling='no'   noresize>
		<frameset cols="40%,*" >
			<frame name='frameDispatchDetail'			src="../../eSS/jsp/ReceiptModifyDetail.jsp?<%=request.getQueryString()%>"					frameborder=0 scrolling='no'   noresize>
<!-- 			<frameset rows="15,*">
				<frame name='framePackingListHeader'	src='../../eSS/html/PackingListHeader.html'			frameborder=0 scrolling='no'   noresize>
 -->				<frame name='frameDispatchList'			src="../../eSS/jsp/ReceiptList.jsp?<%=request.getQueryString()%>"					frameborder=0 scrolling='auto' noresize>
<!-- 			</frameset>
 -->		</frameset>
