	...
	<body onLoad="FocusFirstElement();"onMouseDown='CodeArrest();'>
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					<td align="right" class="label"><fmt:message key="eSS.AutoclaveWashUnitCode.label" bundle="${ss_labels}"/></td>
				...
				<tr>
					<td align="right" class="label" ><fmt:message key="eSS.UnitType.label" bundle="${ss_labels}"/>
</td>
				...
				<tr>
					...
					<%=bean.getOrderByAutoclaveWashingUnit()%>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
