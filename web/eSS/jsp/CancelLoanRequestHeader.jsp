	...
	<body onload="FocusFirstElement();"onMouseDown="CodeArrest()">
		<form name="formCancelRequestHeader" id="formCancelRequestHeader"onReset="FocusFirstElement();">
			<table border="0" cellpadding="0" cellspacing="0" width='100%' height='100%' align='center'>
				...
				<input type="text" value="<%=strEnterdByName%>" name="added_by_name" maxLength="10" size="10" disabled></td>
				...
				<tr>
					...
					<td  colspan=5>&nbsp;&nbsp;<textarea cols='43' rows='3' name="cancelled_remarks" onKeyPress="return setTextAreaMaxLength(this,200);" onBlur="checkSetTextAreaMaxLength(this,200);" ></textarea><%=bean.getMandatoryImageTag()%></td>
				</tr>			
			</table>
