...
<jsp:useBean id="we" class="eSS.LoanRequestGroupBean"/>
		...
		<form name="formLoanRequestGroupHeader" id="formLoanRequestGroupHeader"onReset="FocusFirstElement();">
			<table border="0" cellpadding="0" cellspacing="0" width='100%' height='100%' align='center'>
				...
				<tr>
					...
					<td class="label">&nbsp;&nbsp;<select name="req_on_store_code" id="req_on_store_code" <%=disabled%>><%=bean.getReq_on_store_code_List()%></select><%=bean.getMandatoryImageTag()%></td>
