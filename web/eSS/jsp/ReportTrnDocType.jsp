	...
	<body onLoad="FocusFirstElement();"onMouseDown='CodeArrest();'>
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					<td align="right" class="label"><fmt:message key="eSS.DocTypeCode.label" bundle="${ss_labels}"/></td>
...
<input type="hidden" name="locale" id="locale" value="<%=locale%>">
			...
			<input type="hidden" name="SQL_SS_TRN_DOC_TYPE_LOOKUP" id="SQL_SS_TRN_DOC_TYPE_LOOKUP" value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_TRN_DOC_TYPE_LOOKUP")%>">
		</form>
	</body>
</html>	
