...
//		String p_report_id			=	null;
	...
	<body onLoad="FocusFirstElement();"onMouseDown='CodeArrest();'>
		<form name="formRep_MonthlyServiceStatistics" id="formRep_MonthlyServiceStatistics" action="../../eCommon/jsp/report_options.jsp"  target="messageFrame" >
		<br><br>
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<%=bean.getMonthlyServiceStatisticsList()%>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
			...
			<input type="hidden" name="p_report_id" id="p_report_id" 		value="SSBMONSS">
