	...
	try{
		...
		%>
			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%" align="center">
				...
				<th><fmt:message key="eSS.DocNo.label" bundle="${common_labels}"/></th>
				<th><fmt:message key="eSS.DocDate.label" bundle="${common_labels}"/></th>
				<th><fmt:message key="eSS.ReceivingStore.label" bundle="${common_labels}"/></th>
				<th><fmt:message key="eSS.EntryCompleted.label" bundle="${common_labels}"/></th>
		<%
		...
		%>
						<td class="<%=classvalue%>" onclick="disableClick(event);" align="<%=(colCount==1)?"right":(((colCount==2)||(colCount==5))?"center":"")%>"
						<%
