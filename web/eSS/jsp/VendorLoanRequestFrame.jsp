...
--%>
 <jsp:useBean id="obj0" scope="page" class="eSS.VendorLoanRequestBean"/>
...
%>
	<iframe name="frameVendorLoanRequestHeader" id="frameVendorLoanRequestHeader" frameborder="0" scrolling="no" noresize src="../../eSS/jsp/VendorLoanRequestHeader.jsp?<%=request.getQueryString()%>" style="height:150%;width:100vw"></iframe><iframe name="frameVendorLoanRequestList" id="frameVendorLoanRequestList" src="../../eSS/jsp/VendorLoanRequestLists.jsp?<%=request.getQueryString()%>" frameborder="0" noresize scrolling="auto" style="height:100vh;width:100vw"></iframe>
