...
//		ReportsMasterCodeBean bean = (ReportsMasterCodeBean) mh.getBeanObject( bean_id, request,  bean_name);
	...
	<body onLoad="FocusFirstElement();"onMouseDown='CodeArrest();'>
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<input type="hidden" name="SQL_SS_STORE_RTG_FROM_SELECT_LIST_LOOKUP" id="SQL_SS_STORE_RTG_FROM_SELECT_LIST_LOOKUP"	value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_STORE_RTG_FROM_SELECT_LIST_LOOKUP")%>">
			<input type="hidden" name="SQL_SS_STORE_RTG_TO_SELECT_LIST_LOOKUP" id="SQL_SS_STORE_RTG_TO_SELECT_LIST_LOOKUP"		value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_STORE_RTG_TO_SELECT_LIST_LOOKUP")%>">
