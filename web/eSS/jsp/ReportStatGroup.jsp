...
//		String p_report_id		=	 null;
	...
	<input type="hidden" name="locale" id="locale" value="<%=locale%>">
			...
			<input type="hidden" name="SQL_SS_STAT_GROUP_LOOKUP" id="SQL_SS_STAT_GROUP_LOOKUP" value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_STAT_GROUP_LOOKUP")%>">
		</form>
	</body>
</html>
