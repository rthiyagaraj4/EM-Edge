...
<body onMouseDown="CodeArrest()" onKeyDown="lockKey()">
	...
	<form name="MReportForm" id="MReportForm" action="../../eCommon/jsp/report_options.jsp" target="messageFrame">
		...
		<tr>
			<td align="right" width="25%" class="label"><fmt:message key="eOH.GStatusCodeFrom.Label" bundle="${oh_labels}"/> &nbsp;</td>
			<td align="left">
				...
				%>	
						<option value="<%=gingival_status_code%>" > <%=gingival_status_desc%> </option>
					<% 
					}
				}catch(Exception e){
					out.println("exp"+e);
