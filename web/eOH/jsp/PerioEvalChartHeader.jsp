	...
	<form name="perioChartHeaderForm" id="perioChartHeaderForm" method="post" target="messageFrame">
		<table width="100%" cellpadding =4 cellspacing=0 border=0>
			<tr>
				...
				<td width="25%" class='LABEL' nowrap><fmt:message key="eOH.BaselineChart.Label" bundle="${oh_labels}"/></td>
				<td width="25%" class="field" nowrap>
			...
			<tr>
				...
				<td width="25%" class="field" nowrap>
					<select name="perio_status" id="perio_status" onChange="closeChart(this,'EC')" DB_Value="<%=baseline_status%>">
						<option value=""><fmt:message key="eOH.DefaultSelect.Label" bundle="${oh_labels}"/></option>
		...
		<input type = "hidden" name= "active_closed_chart" value = "<%=active_closed_chart%>">
