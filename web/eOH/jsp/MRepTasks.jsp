...
<body onMouseDown="CodeArrest()" onKeyDown="lockKey()">
	...
	<form name="MReportForm" id="MReportForm" action="../../eCommon/jsp/report_options.jsp" target="messageFrame">
		...
		<tr>
			<td width="22%" class="label"><fmt:message key="eOH.TaskCodeFrom.Label" bundle="${oh_labels}"/> &nbsp;</td>

		    <td class='fields' width='25%'>
				<input type='hidden' name='param6' id='param6' value=""> 
				<input type='hidden' name="P_TASK_FROM" id="P_TASK_FROM" value=""> 
				<input type='text' name='param5_desc' id='param5_desc' size='25' title='<%=fromTaskCode%>'  param1 = 'P_TASK_FROM'  param2 = 'param6' key ='TASKS' onBlur="if(this.value!='')callCommonMasterLookup(this); else P_TASK_FROM.value='',param6.value='' "> 
		...
		<td class='fields' width='25%'>
				...
				<input type='text' name='param7_desc' id='param7_desc' size='25' title='<%=toTaskTo%>'  param1 = 'P_TASK_TO'  param2 = 'param8' key ='TASKS' onBlur="if(this.value!='')callCommonMasterLookup(this); else P_TASK_TO.value='',param8.value='' "> 
