...
<body onMouseDown="CodeArrest()" onKeyDown="lockKey()">
	...
	<form name="MReportForm" id="MReportForm" action="../../eCommon/jsp/report_options.jsp" target="messageFrame">
		...
		<tr>
			<td width="25%" class="label" nowrap><fmt:message key="eOH.CompositionClassCodeFrom.Label" bundle="${oh_labels}"/> &nbsp;</td>
			...
			<select name="p_composition_class_code_from" id="p_composition_class_code_from">
				...
				try{
					...
					%>	
						<option value= "<%=composition_class_code%>"> <%=composition_class_desc%> </option>
					<% 
					}
				}catch(Exception e){
					out.println("exp"+e);
