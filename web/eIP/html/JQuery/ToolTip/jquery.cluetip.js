...
(function($) {
  ...
  $.cluetip = {
    ...
    */
    defaults: {
      ...
      //width:            674,      // The width of the clueTip
      ...
      //mouseOutClose:    true,    // close when clueTip is moused out: false, 'cluetip', 'link', 'both'
  ...
  $.fn.cluetip = function(js, options) {
	...
	//var cluetipPadding = (parseInt($cluetip.css('paddingLeft'), 10) || 0) + (parseInt($cluetip.css('paddingRight'), 10) || 0); By Sudhakar
    var cluetipPadding = (parseInt($cluetip.css('paddingLeft'),0) || 0) + (parseInt($cluetip.css('paddingRight'),0) || 0);
    ...
    this.each(function(index) {
      ...
      //var tOffset = parseInt(opts.topOffset, 10), lOffset = parseInt(opts.leftOffset, 10); below is modified by sudhakar
...
// now that content is loaded, finish the positioning
      ...
      $cluetip.css({top: 70 + 'px'}).attrProp({'className': standardClasses + dynamicClasses});
