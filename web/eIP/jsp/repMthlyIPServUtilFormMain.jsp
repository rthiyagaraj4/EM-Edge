...
%>
			...
			<tr>
				<td  class="label" width="20%"> <fmt:message key="Common.month.label" bundle="${common_labels}"/> &nbsp;</td>
			...
			<tr>
				...
				<td  class="label" width="20%"> <fmt:message key="Common.Ward.label" bundle="${common_labels}"/></td>
