	...
	<tr>
		...
		<td width="100%" class="Border" align='center'>
			...
			<table width='80%' cellPadding="0" cellSpacing="0"  align='center' >
				...
				<tr>
						<td align='left' width='30%' class="label"><fmt:message key="Common.bedtype.label" bundle="${common_labels}"/>&nbsp;<fmt:message key="Common.code.label" bundle="${common_labels}"/>&nbsp;</td>
