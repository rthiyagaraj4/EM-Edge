	...
	<tr>
		...
		<td width="100%" class="Border" align='center'>
			...
			<table width='80%' cellPadding="0" cellSpacing="0"  align='center' >
				...
				<tr>
						<td align='right' width='30%' class="label" nowrap><fmt:message key="eIP.PreferredAdmissionDate.label" bundle="${ip_labels}"/>&nbsp;</td>
						<td class='fields' width='30%'  >
							<input type=text id="adm_date_from"  name='p_fm_admission_date' id='p_fm_admission_date' size="10" maxlength="10" align="center" onblur='if(validDateObj(this,"DMY","<%=localeName%>")){/*chkWithSysDt(this);*/}'><img src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('adm_date_from');"/>
						</td>
						<td class='fields' width='40%'> 
							<input type=text id="adm_date_to"  name='p_to_admission_date' id='p_to_admission_date' size="10" maxlength="10" align="center" onblur='if(validDateObj(this,"DMY","<%=localeName%>")){/*chkWithSysDt(this);*/}'><img src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('adm_date_to');"/>
						</td>
				</tr>
