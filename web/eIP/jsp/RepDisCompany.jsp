			...
			<table width='80%' cellPadding="0" cellSpacing="0"  align='center' >
				...
				<tr>
					...
					<td  width='30%' align="left">
						...
						<option value='3'><fmt:message key="Common.PatientName.label" bundle="${common_labels}"/>
				...
				<tr>
					...
					<td  width='30%' align="left">
						...
						<option value='1'><fmt:message key="Common.nursingUnit.label" bundle="${common_labels}"/>
						<option value='2'><fmt:message key="eIP.AdmittedDate.label" bundle="${ip_labels}"/>
						<option value='3'><fmt:message key="eBL.CompanyName.label" bundle="${bl_labels}"/>
						<option value='4'><fmt:message key="Common.none.label" bundle="${common_labels}"/>
