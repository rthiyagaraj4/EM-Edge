...
async function callCanRev(valu)
{
	...
	var arguments   = "" ;
	retVal = await window.showModalDialog("../../eIP/jsp/AmendBookingMain.jsp?calling=AB&bookingRefNo="+escape(valu)+"&call_function=<%=call_function%>",arguments,features);
}
</script>
    ...
    <form name = 'BookingReferenceLookupResult_form'>
			...
			{*/
				...
				if((priority_ind_scr.equals("")) && ((call_function.equals("AB")) || (call_function.equals("RCB")) ))
				{
					...
					{	%>
						<tr>
							<!--<td colspan='7' class='CAGROUPHEADING' align='left'><%--=priority_ind_desc--%></td> modified on 12-03-2008 for CRF20056-0231-->
							<td colspan='11' class='CAGROUPHEADING' align='left'><%=priority_ind_desc%></td>
						</tr>
				<%	}
					temp = priority_ind;
				}
