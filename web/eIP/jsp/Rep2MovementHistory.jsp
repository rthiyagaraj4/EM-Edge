  ...
  async function searchCode(obj,target)
	{
			...
			var arguments	= "" ;
			retVal = await window.showModalDialog("../../eIP/jsp/IPEncounterDisplayFrame.jsp?patient_id="+document.forms[0].p_patient_id.value,arguments,features);
			if(retVal !=null)
				target.value = retVal;
				target.focus();
	}
	...
	<tr>
		...
		<td width="100%" class="Border" align='center'>
			...
			<table width='80%' cellPadding="0" cellSpacing="0"  align='center' >
				...
				<tr>
					<td align='left' width='30%' class="label"><fmt:message key="Common.patientId.label" bundle="${common_labels}"/> &nbsp;</td>
					<td><input type=text  name='p_patient_id' id='p_patient_id' size=<%=pat_length%> maxlength=<%=pat_length%> onBlur="ChangeUpperCase(this);disbutt(this)" align="center"><input type='button' name='patient_id' id='patient_id' value='?' class='button' onclick='callSearchScreen()'></td>
