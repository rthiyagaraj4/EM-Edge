...
<iframe name='commontoolbarFrame' id='commontoolbarFrame'	src=<%= source %> frameborder=0 scrolling='no' noresize style='height:40%;width:100vw'></iframe>
	<iframe name='f_query_add_mod' id='f_query_add_mod' 	src='../jsp/ViewPrepareDischargeAdviseListMain.jsp?function_id=<%=function_id%>&win_height=33&win_width=50&call_function=ChangedAdmDtls' frameborder=0 scrolling='no' noresize style='height:150%;width:100vw'></iframe>
