		...
		<td width="100%" class="Border" align='center'>
			...
			<table width='80%' cellPadding="0" cellSpacing="0"  align='center' >
				...
				<tr>
						...
						<td width='30%'  >
							<input type=text  name='p_fm_admission_date_time' id='p_fm_admission_date_time' size="10" maxlength="10" align="center" onblur='validDateObj(this,"DMY","<%=localeName%>")'><img src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('p_fm_admission_date_time','dd/mm/y',null)"/>
						</td>
						<td width='40%'> 
							<input type=text  name='p_to_admission_date_time' id='p_to_admission_date_time' size="10" maxlength="10" align="center" onblur='validDateObj(this,"DMY","<%=localeName%>")'><img src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('p_to_admission_date_time','dd/mm/y',null)"/>
						</td>
				</tr>
				...
				<tr>
						<td align='left' width='30%' class="label"><fmt:message key="Common.NationalityCode.label" bundle="${common_labels}"/> &nbsp;</td>
						<td width='30%'  >
				...
				<tr>
						<td align='left' width='30%' class="label"><fmt:message key="eIP.LengthofStay.label" bundle="${ip_labels}"/>(<fmt:message key="Common.days.label" bundle="${common_labels}"/>) &nbsp;</td>
						<td width='30%'  >
