			...
			<table width='80%' cellPadding="0" cellSpacing="0"  align='center' >
				...
				<tr>
						...
						<td class='fields' width='20%'  >
							<input type=text id="adm_date_from"  name='p_fm_preferred_date' id='p_fm_preferred_date' size="10" maxlength="10" align="center" onblur='validDateObj(this,"DMY","<%=localeName%>")'><input type="image" src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('adm_date_from');">
						</td>
						<td class='fields' width='40%'> 
							<input type=text id="adm_date_to"  name='p_to_preferred_date' id='p_to_preferred_date' size="10" maxlength="10" align="center" onblur='validDateObj(this,"DMY","<%=localeName%>")'><input type="image" src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('adm_date_to');">
						</td>
				</tr>
