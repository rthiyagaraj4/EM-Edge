...
<head>
	...
	<title><fmt:message key="eIP.CancelledAdmission.label" bundle="${ip_labels}"/></title>
	<script>
		function reset()
		{
...
%>
	...
	<iframe name='commontoolbarFrame' id='commontoolbarFrame'	src="<%= source %>" frameborder=0 scrolling='no' noresize style='height:8vh;width:100vw'></iframe>
		<iframe src="../../eIP/jsp/QueryUnassignedPatientsCriteria.jsp?function_id=<%=function_id%>&fromQuery=CA" name="criteria" frameborder=0 scrolling='no' noresize style='height:20vh;width:100vw'></iframe>
