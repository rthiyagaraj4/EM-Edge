...
public class CommonQueryPage
{
    ...
    public StringBuffer getQueryPage(Connection connection, ArrayList arraylist, String s, String s1, String s2, String s3, String s4, String s5, String as[], String as1[], String s6)
    {
        ...
        for(int i = 0; i < arraylist.size(); i++)
        {
            ...
            if(arraylist2.get(0).equals("Text"))
                stringbuffer.append("<tr><td  width='40%' class='label' >" + arraylist2.get(1) + "</td>" + "<td  class='fields' width='60%'><input type=text name = '" + arraylist2.get(2) + "' size='" + arraylist2.get(3) + "' maxlength='" + arraylist2.get(4) + "' onBlur='makeValidQueryCriteria(this);'></td></tr>");
            ...
            else if(arraylist2.get(0).equals("List"))
            {
                ...
                if(s7.substring(0, 6).equalsIgnoreCase("SELECT"))
                {
					...
					//stringbuffer.append("<tr><td  width='40%' class='label'>" + arraylist2.get(1) + "</td><td width='60%' class='fields' ><select name='"+arraylist2.get(2)+"'><option value=''>----Select----</option>" + s9 + "&nbsp;</td></tr><script>var selc_val='---'+getLabel('Common.defaultSelect.label','Common')+'---';	document.forms[0]."+(String)arraylist2.get(2)+"(0).text=selc_val;</script>");
					stringbuffer.append("<tr><td  width='40%' class='label'>" + arraylist2.get(1) + "</td><td width='60%' class='fields' ><select name='"+arraylist2.get(2)+"'><option value=''>----Select----</option>" + s9 + "&nbsp;</td></tr><script>var selc_val='---'+getLabel('Common.defaultSelect.label','Common')+'---';	document.forms[0]."+(String)arraylist2.get(2)+"[0].text=selc_val;</script>");
				}
                else
                {
                    String s8 = getDelimitedValue(s7);
                    stringbuffer.append("<tr><td  width='40%' class='label'>" + arraylist2.get(1) + "</td><td width='60%' class='fields' ><select name='" + arraylist2.get(2) + "'>" + s8 + "&nbsp;</td></tr>");
                }
            }
            else if(arraylist2.get(0).equals("Check"))
                stringbuffer.append("<tr><td  class='label'>" + arraylist2.get(1) + "</td><td width='60%'  class='fields'><input type='checkbox' name='" + arraylist2.get(2) + "' ></td></tr>");
        ...
        stringbuffer.append("<table width='100%' align='center'><th width='20%' align='left'>" + s2 + "</td><tr><td width='60%' > <p  title='" + s2 + "'><table width='100%'><td align='center'><b>" + s4 + "</td><td>&nbsp;</td><td align='center'><b>" + s5 + "</td><tr><td width='45%'  align='center'><select name='orderbycols' size='5' >");
    ...
    public StringBuffer getMultiColumnQueryPage(Connection connection, ArrayList arraylist, String s, String s1, String s2, String s3, String s4, String s5, String as[], String as1[], String s6)
    {
        ...
        stringbuffer.append("<link rel='stylesheet' type='text/css' href='../../eCommon/html/CommonCalendar.css'></link>");
        stringbuffer.append("<script src='../../eCommon/js/CommonCalendar.js' language='JavaScript'></script><Script src='../../eCommon/js/ValidateControl.js' language='JavaScript'></script><Script src='../../eCommon/js/common.js' language='JavaScript'></Script><script  language='javascript'>function focusObject(){document.forms[0].elements[0].focus();}    function addOrderByCol()    {       var i=0; var from = document.all.item('orderbycols'); if ( from.options.length > 0 ) { var to = document.all.item('orderbycolumns'); var element = document.createElement('OPTION'); element.text = from.options[from.selectedIndex].text; element.value= from.options[from.selectedIndex].value; to.add(element);          from.remove(from.selectedIndex); if(from.options[i])  from.options[i].selected=true ; i++; } } function removeOrderByCol()  {  var j=0; var from = document.all.item('orderbycolumns'); if ( from.options.length > 0 ){ var to = document.all.item('orderbycols');var element = document.createElement('OPTION'); element.text = from.options[from.selectedIndex].text; element.value = from.options[from.selectedIndex].value; to.add(element);    from.remove(from.selectedIndex); if(from.options[j]) from.options[j].selected=true; j++;   } }      function SelectAll(){var i = 0; document.all.orderbycolumns.selectedIndex=0; while ( i < document.all.orderbycolumns.length) {  document.all.orderbycolumns.options[i].selected=true; i++; }}  function execQuery(){  if(document.all.orderbycolumns.options.length >0 ){SelectAll(); document.query_form.submit();}else{alert(getMessage('ORDERBY_NOT_BLANK','Common'))}}</script> ");
        stringbuffer.append("</head><body onLoad='focusObject()' onKeyDown = 'lockKey()' OnMouseDown='CodeArrest()' ><form name='query_form' method='post' action='");
        stringbuffer.append(s1 + "' onsubmit='SelectAll()'>");
        stringbuffer.append("<Script src='../../eCommon/js/common.js' language='JavaScript'></Script><table width='100%' align='center'><tr><th align='left' width='30%'>" + s3 + "</th></tr><tr><td nowrap width='60%' ><p class='' ><table width='100%'  border='0' >");
        ArrayList arraylist1 = new ArrayList();
        ...
        for(int j = 0; j < i; j += 2)
        {
            ...
            for(int k = j; k < j + 2 && k < i; k++)
            {
                ...
                if(arraylist2.get(0).equals("Text"))
                    stringbuffer.append("<td nowrap  width='25%' class='label'>" + arraylist2.get(1) + "</td>" + "<td nowrap class='fields' width='25%'><input type=text name = '" + arraylist2.get(2) + "' size='" + arraylist2.get(3) + "' maxlength='" + arraylist2.get(4) + "' onBlur='makeValidQueryCriteria(this);'></td>");
                else if(arraylist2.get(0).equals("Date"))
                    stringbuffer.append("<td  width='40%' class='label' >" + arraylist2.get(1) + "</td>" + "<td  class='fields' width='60%'><input type=text name = '" + arraylist2.get(2) + "' size='10' maxlength='10' onBlur='CheckDate(this);'><input type='image'  src='../../eCommon/images/CommonCalendar.gif' onClick=\"document.all." + arraylist2.get(2) + ".focus();return showCalendar('" + arraylist2.get(2) + "');\" tabIndex=-1></td>");
                else if(arraylist2.get(0).equals("List"))
                {
                    ...
                    if(s9.substring(0, 6).equalsIgnoreCase("SELECT"))
                    {
                        ...
                        //stringbuffer.append("<td nowrap  width='25%' class='label'>" + arraylist2.get(1) + "</td><td nowrap width='25%' class='fields'><select name='" + arraylist2.get(2) + "'><option value=''>----Select----</option>" + s13 + "&nbsp;</td><script>var selc_val='---'+getLabel('Common.defaultSelect.label','Common')+'---';	document.forms[0]."+(String)arraylist2.get(2)+"(0).text=selc_val;</script>");
						stringbuffer.append("<td nowrap  width='25%' class='label'>" + arraylist2.get(1) + "</td><td nowrap width='25%' class='fields'><select name='" + arraylist2.get(2) + "'><option value=''>----Select----</option>" + s13 + "&nbsp;</td><script>var selc_val='---'+getLabel('Common.defaultSelect.label','Common')+'---';	document.forms[0]."+(String)arraylist2.get(2)+"[0].text=selc_val;</script>");
					}
                    else
                    {
                        String s11 = getDelimitedValue(s9);
                        stringbuffer.append("<td nowrap  width='25%' class='label'>" + arraylist2.get(1) + "</td><td nowrap width='25%' class='fields' ><select name='" + arraylist2.get(2) + "'>" + s11 + "&nbsp;</td>");
                    }
                }
                else if(arraylist2.get(0).equals("Check"))
                    stringbuffer.append("<td nowrap width='25%'  class='label'>" + arraylist2.get(1) + "</td><td nowrap width='25%'  class='fields'><input type='check' name='" + arraylist2.get(2) + "' ></td>");
                else if(arraylist2.get(0).equals("Hidden"))
                    stringbuffer.append("<input type='hidden' name='" + arraylist2.get(1) + "' value='" + arraylist2.get(2) + "' >");
            }
        ...
        if(s7.equals("span"))
        {
            ...
            if(arraylist3.get(0).equals("Text"))
                stringbuffer.append("<tr><td nowrap  width='25%' class='label' >" + arraylist3.get(1) + "</td>" + "<td nowrap  class='fields' width='25%'><input type=text name = '" + arraylist3.get(2) + "' size='" + arraylist3.get(3) + "' maxlength='" + arraylist3.get(4) + "' onBlur='makeValidQueryCriteria(this);'></td></tr>");
            else if(arraylist3.get(0).equals("Date"))
                stringbuffer.append("<tr><td  width='40%' class='label' >" + arraylist3.get(1) + "</td>" + "<td  class='fields' width='60%'><input type=text name = '" + arraylist3.get(2) + "' size='10' maxlength='10' onBlur='CheckDate(this);'><input type='image'  src='../../eCommon/images/CommonCalendar.gif' onClick=\"document.all." + arraylist3.get(2) + ".focus();return showCalendar('" + arraylist3.get(2) + "');\"  tabIndex=-1></td></tr>");
            else if(arraylist3.get(0).equals("List"))
            {
                ...
                if(s8.substring(0, 6).equalsIgnoreCase("SELECT"))
                {
                    ...
                    //stringbuffer.append("<tr><td nowrap width='25%' class='label'>" + arraylist3.get(1) + "</td><td nowrap width='25%' class='fields' ><select name='" + arraylist3.get(2) + "'><option value=''>----Select----</option>" + s12 + "&nbsp;</td></tr><script>var selc_val='---'+getLabel('Common.defaultSelect.label','Common')+'---';	document.forms[0]."+(String)arraylist3.get(2)+"(0).text=selc_val;</script>");
					stringbuffer.append("<tr><td nowrap width='25%' class='label'>" + arraylist3.get(1) + "</td><td nowrap width='25%' class='fields' ><select name='" + arraylist3.get(2) + "'><option value=''>----Select----</option>" + s12 + "&nbsp;</td></tr><script>var selc_val='---'+getLabel('Common.defaultSelect.label','Common')+'---';	document.forms[0]."+(String)arraylist3.get(2)+"[0].text=selc_val;</script>");
				}
                else
                {
                    String s10 = getDelimitedValue(s8);
                    stringbuffer.append("<tr><td nowrap width='25%' class='label' >" + arraylist3.get(1) + "</td><td nowrap  class='fields' width='25%'><select name='" + arraylist3.get(2) + "'>" + s10 + "&nbsp;</td></tr>");
                }
            }
            else if(arraylist3.get(0).equals("Check"))
                stringbuffer.append("<tr><td nowrap  width='25%' class='label' >" + arraylist3.get(1) + "</td><td nowrap  class='fields' width='25%'><input type='check' name='" + arraylist3.get(2) + "' ></td></tr>");
            else if(arraylist3.get(0).equals("Hidden"))
                stringbuffer.append("<input type='hidden' name='" + arraylist3.get(1) + "' value='" + arraylist3.get(2) + "' >");
        }
        stringbuffer.append("</table>");
        stringbuffer.append("</td></tr></table></p>");
        stringbuffer.append("<table width='100%' align='center'><th width='20%' align='left'>" + s2 + "</td><tr><td nowrap  width='60%' > <p  title='" + s2 + "'><table width='100%'><td nowrap align='center'><b>" + s4 + "</td><td>&nbsp;</td><td nowrap align='center'><b>" + s5 + "</td><tr><td nowrap width='45%'  align='center'><select name='orderbycols' size='5' >");
        for(int l = 1; l < as.length; l++)
            stringbuffer.append("<option value='" + as1[l] + "'>" + as[l] + "</option>");

        stringbuffer.append("</select></td>");
        stringbuffer.append("<td align='center' width='3%' ><input type='button' name='add' class='button' onclick='addOrderByCol()' value='---->'> <input type='button' name='add' class='button'  value='<----' onclick='removeOrderByCol()'></img></td>");
        stringbuffer.append("<td nowrap width='45%' align='center'><select name='orderbycolumns' size='5' multiple='true'>");
        stringbuffer.append("<option value='" + as1[0] + "'>" + as[0] + "</option></select></td></tr></table></p></td></tr></table>");
        stringbuffer.append("<br><table border='0' width='100%' align='center'><tr><td nowrap width='100%' align='center' class='white'><input type='button' name='ExecuteQuery' class='Button' onclick='execQuery()' Value='Execute'></td></tr></table><script>var exe=getLabel('Common.Execute.label','common'); document.forms[0].ExecuteQuery.value=exe;</script> ");
        stringbuffer.append("</form></body></html>");
        return stringbuffer;
    }
}
