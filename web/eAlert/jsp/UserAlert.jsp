...
<%
AlertUserResponse alertUserResponse = null;
...
if(request.getAttribute("AlertUserResponse") != null){
	alertUserResponse = (AlertUserResponse)request.getAttribute("AlertUserResponse");
	
	if(alertUserResponse != null)
	{
		userAlertList = alertUserResponse.getUserAlertList();
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="67%" align="right" valign="middle">
             <div class="FlagBTN" id="filterbutton">
  ...
  <tr>
    ...
    <td width="91%" align="left" valign="top"><table width="99%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <%}
        if(sFlagged.equalsIgnoreCase("Y") && sReviewed.equalsIgnoreCase("N") && sForwarded.equalsIgnoreCase("N")) {
        	if(reminderInt > 0){ %>
...
<%if(icount == 0){%>
window.parent.startAlertId = <%=userAlert.getPatientAlertSeqId()%>;
<%}%>
window.parent.endAlertId = <%=userAlert.getPatientAlertSeqId()%>;
</script>
