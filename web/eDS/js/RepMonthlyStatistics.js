	...
	function isValidDate(obj){
		if(obj.value!=""){
			...
			if (arr_date.length != 2) return cal_error (getMessage('INVALID_DATE_FMT','SM'),obj);//flag=false;
			...
			var dt_numdays = new Date(arr_date[1], arr_date[0], 1);
			dt_date.setDate(1);
			if (dt_date.getMonth() != (arr_date[0]-1)) flag=false;
			if (flag==false){
