...
-->
<%@page
import="java.sql.Connection,java.sql.Statement,java.sql.*,java.sql.ResultSet,webbeans.eCommon.ConnectionManager,eCommon.XSSRequestWrapper,eCommon.Common.*,eDS.DSCommonBean,eDS.*,java.util.ArrayList,java.net.URLEncoder"%><!-- Modified Against ML-MMOH-CRF-1125 -->
...
<!-- ML-MMOH-CRF-0681-->
	...
	if ( !(start <= 0) ) {%>
	<td>
	<A HREF="../../eDS/jsp/DocumentMealServedEMRecord.jsp?from=<%=(start-13)%>&to=<%=(end-13)%>" text-decoration='none'><fmt:message key="Common.previous.label" bundle='${common_labels}' /></A>
	</td>
	<%}%>
	<td id="hrefNextMealOrder">
	<A HREF="../../eDS/jsp/DocumentMealServedEMRecord.jsp?from=<%=(start+13)%>&to=<%=(end+13)%>" text-decoration='none'><fmt:message key="Common.next.label" bundle='${common_labels}' /></A>
	</td>
	</tr>
	</table>
	<br><br>
