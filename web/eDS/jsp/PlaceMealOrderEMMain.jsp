...
Date			: Aug-2013
-->
<%@ page import="webbeans.eCommon.ConnectionManager,eCommon.Common.*,eCommon.XSSRequestWrapper,java.sql.Connection,java.sql.ResultSet,java.sql.PreparedStatement,java.net.URLEncoder,java.sql.Timestamp,java.text.DateFormat,java.text.SimpleDateFormat"%>
...
<input type="hidden" name="location" id="location" value="<%=location%>"> <!---ML-MMOH-CRF-0596--->
...
<input type="hidden" name="LATE_IRREGULAR_DIET_ORD_FOR_EM" id="LATE_IRREGULAR_DIET_ORD_FOR_EM" id="LATE_IRREGULAR_DIET_ORD_FOR_EM" value="<%=LATE_IRREGULAR_DIET_ORD_FOR_EM%>" /><!-- Added Against ML-MMOH-CRF-0825 -->
...
async function toLoadData()
{
	...
	EMMealTypes = strMealTypes;	
	 ...
	 var newTH = document.createElement('th');
	 tHead.rows[0].appendChild(newTH); //append ne th to table 
	 newTH.innerHTML = "<fmt:message key='eOT.preparatoryInstruction.Label' bundle='${ot_labels}' /></TH>";
	 //CRF-417 ends
