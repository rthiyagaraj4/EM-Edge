...
<!--<fmt:setBundle basename="eDS.resources.Labels" var="ds_labels"/>-->
    ...
    <form >
	<div id="placeOrder">
	<table width="100%" ><tr><td align=right><INPUT type="button" disabled align=right name="btnplaceOrder" id="btnplaceOrder" value="<fmt:message key="eDS.placeOrder.Label" bundle="${ds_labels}" />" class="button" onClick="placeOPMealOrder();"/>
	</td></tr>
	</table>
	</div>
