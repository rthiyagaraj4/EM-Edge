		...
		<form name="complaints_form" id="complaints_form"  onload='FocusFirstElement()'  action="../../servlet/eDS.ComplaintsServlet" method="post" target="messageFrame">
			<table border='0' cellpadding='2' cellspacing='0' width='75%' align='center'>
				<tr>
					...
					<td>
						<input type="text" name="complaints" id="complaints" value="<%=complaints %>" size="4" maxlength="4" onkeyup="setFieldToUpperCase(this)"  onkeypress="return checkAlpha(event)" <%=disabled_flag %>/>
			...
			<input type='hidden' name='updComplaints' id='updComplaints' value='<%=complaints%>'>
		</form>
	</body>
</html>
