...
<%
	...
	System.out.println("access access access access access ------->>>>>"+request.getParameter("access"));
					...
					<td class="COMMON_TOOLBAR" align="left" width="50%">
						<table cellspacing='0' cellpading='0'>
							<tr class="COMMON_TOOLBAR">
								...
								%>
								<td class="COMMON_TOOLBAR">
									 <input type='button' onclick="parent.create();parent.messageFrame.location.href='DSN_MstCodeError.jsp'" value='<fmt:message key="Common.create.label" bundle="${common_labels}"/>' name='create' class='BUTTON'></input>
								</td>
									<%
								}
							%>
								...
								%>
								<td class="COMMON_TOOLBAR">
									 <input type='button' onclick="parent.query();parent.messageFrame.location.href='DSN_MstCodeError.jsp'" value='<fmt:message key="Common.query.label" bundle="${common_labels}"/>' name='query' class='BUTTON'></input>
								</td>
									<%
								}
							%>
							...
							%>
								<td class="COMMON_TOOLBAR">
									<input type='button' onclick="onDelete();" value='<fmt:message key="Common.delete.label" bundle="${common_labels}"/>' class='BUTTON' name='Delete'></input>
								</td>
							<%
								}
							%>
							...
							%>
								...
								<td class="COMMON_TOOLBAR">
									<input type='button' onclick="parent.reset();parent.messageFrame.location.href='DSN_MstCodeError.jsp'" value='<fmt:message key="Common.reset.label" bundle="${common_labels}"/>' name='reset' class='BUTTON'></input>
								</td>
								...
								<td class="COMMON_TOOLBAR">
									...
									value='<fmt:message key="Common.menu.label" bundle="${common_labels}"/>' name='home' class='BUTTON'></input>
									<%}%>
								</td>
