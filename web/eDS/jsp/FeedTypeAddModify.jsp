		...
		<form name="mealClass_form" id="mealClass_form"  onload='FocusFirstElement()'  action="../../servlet/eDS.FeedTypeServlet" method="post" target="messageFrame">
			<table border='0' cellpadding='2' cellspacing='0' width='75%' align='center'>
				<tr>
					...
					<td>
						<input type="text" name="feed_Type" id="feed_Type" value="<%=feedType %>" size="4" maxlength="4" onkeyup="setFieldToUpperCase(this)"  onkeypress="return checkAlpha(event)" <%=disabled_flag %>/>
			...
			<input type='hidden' name='updFeedType' id='updFeedType' value='<%=feedType%>'>
		</form>
	</body>
</html>
