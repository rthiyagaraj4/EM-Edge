...
try
{
	...
	if(defnlevelRs!=null)
	{
		if(defnlevelRs.next())
		{
			...
			%>
			<script>
			parent.f_term_result_header.document.getElementById("dynlevel").innerText="Classification Levels  "+"<%=defnlevel%>";
			parent.f_term_result_header.document.term_code_result_header.class_lvl.value="<%=defnlevel%>";
			parent.f_term_code_set.document.frm_terminology_code.dyanmic_level.value="<%=defnlevel%>";
