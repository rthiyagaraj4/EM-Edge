...
<body  OnMouseDown="CodeArrest()"  onKeyDown = 'lockKey()'>
    ...
    <form name="HolidayForMRD_Result" id="HolidayForMRD_Result" action="../../servlet/eMR.MRPHolidayServlet" method="post" target="messageFrame">
		...
		<td class="QRYODD"  width='30%'><input type="text" name="holiday_reasion_<%=totChk%>" id="holiday_reasion_<%=totChk%>" onBlur="makeValidString(this);reasonCheck(this,<%=totChk%>);chkChar(this);" onKeyPress='return SpeCharRestriction(event)' size="30" maxlength="30" ></td>
