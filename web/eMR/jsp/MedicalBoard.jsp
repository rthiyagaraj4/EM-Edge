...
%>
	...
	<iframe name='tabsFrame' id='tabsFrame' src='../../eMR/jsp/MedicalBoardTabs.jsp?call_function=<%=call_function%>&function_id=<%=call_function%>' frameborder='0' scrolling='no' noresize style='height:3vh;width:100vw'></iframe>
