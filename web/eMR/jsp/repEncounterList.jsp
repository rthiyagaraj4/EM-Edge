	...
	<tr>
		...
		%>	
		 ...
		 <td class='fields' colspan='4'>
               <input type='text' id='ecfrom' name='p_fr_enc_date' id='p_fr_enc_date' value='' size='10' maxlength='10' Onblur="validDateObj(this,'DMY','<%=localeName%>');validate_date(this);ComparePeriodFromToTime(this,p_to_enc_date)"><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('ecfrom');"/><img src="../../eCommon/images/mandatory.gif"></img>
        </td>
        <td class="label" ><td class="label"><fmt:message key="Common.to.label" bundle="${common_labels}"/>  </td>
         <td class='fields' colspan='4'> <input type='text' id='ecto' name='p_to_enc_date' id='p_to_enc_date' value='' size='10' maxlength='10'Onblur="validDateObj(this,'DMY','<%=localeName%>');validate_date(this);ComparePeriodFromToTime(p_fr_enc_date,this)"><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('ecto');"/><img src="../../eCommon/images/mandatory.gif"></img>
	    </td>
		</tr>
		 <tr>
