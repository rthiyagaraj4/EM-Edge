	...
	<tr>
		...
		<td width="100%" class="Border" align='center'>
				...
				<tr>
					...
					<tr>
						<td align='right' width='30%' class="label"><fmt:message key="Common.ICDCode.label" bundle="${common_labels}"/>&nbsp;</td>
				...
				<tr>
					<td align='right' width='30%' class="label"><fmt:message key="Common.FacilityID.label" bundle="${common_labels}"/>&nbsp;</td>
				...
				<tr>
					...
					<td  width='20%' align="left">
						...
						<option value='1,2,3'><fmt:message key="Common.code.label" bundle="${common_labels}"/>
						<option value='1,2,4'><fmt:message key="Common.description.label" bundle="${common_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
