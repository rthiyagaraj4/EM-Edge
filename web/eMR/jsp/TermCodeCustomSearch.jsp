...
<script>
	...
	function CallDescFrame()
	{
		...
		parent.frames[1].location.href='TermCodeCustomResult.jsp?<%=queryString%>&Search_By='+radioval+'&Search_Criteria='+listval+'&sensitive_yn='+sensitive_yn+'&Search_Text='+textbox+'&opt_notifiable='+notifiable;
...
<tr>
	<td class='label'  colspan="1" align="left" ><fmt:message key="Common.searchtext.label" bundle="${common_labels}"/>
		<input type="text"  name="Search_text" id="Search_text" value='<%=searchTxt%>' width=30% align="left" size='20' maxlength='20'>
	</td>
