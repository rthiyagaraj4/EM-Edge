...
<%
	...
	{	
		...
		<%	}	%>
			<frame scrolling="no" name='f_query_add_mod' src='../../eMR/jsp/ReportRequestQueryCriteria.jsp?call_function=<%=call_function%>&called_from=<%=called_from%>' noresize frameborder=0>
