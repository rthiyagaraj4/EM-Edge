...
<input type='Button'  name='record' id='record' title='Record' class="Button" onclick="apply1()" disabled value='<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.record.label","common_labels")%>'>
