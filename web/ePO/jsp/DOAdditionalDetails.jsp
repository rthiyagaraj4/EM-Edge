...
<form name="formDOAdditionalDetails" id="formDOAdditionalDetails">
	<table border='0' cellpadding='2' cellspacing='0' width='80%' align=center scrolling=yes>
		<tr>
			<td align="right" class="label" ><fmt:message key="ePO.InvoiceNo.label" bundle="${po_labels}"/></td>
			<td>&nbsp;&nbsp;<input type="text" value = "<%=bean.getInv_no()%>" name="inv_no" size='30' maxLength='30' ></td>
		...
		<tr>
			<td align="right" class="label" ><fmt:message key="ePO.InvoiceDate.label" bundle="${po_labels}"/></td>
			<td class="fields">&nbsp;&nbsp;<input type="text" value="<%=bean.getInv_date()%>" name="inv_date"  maxLength="10" size="10"  onBlur="CheckDate(this);"  >&nbsp;
		...
		<tr>
			<td align="right" class="label" ><fmt:message key="ePO.InvoiceReceivedBy.label" bundle="${po_labels}"/></td>
			<td>&nbsp;<input type=text value = "<%=bean.getInv_recdBy()%>" name="inv_recdBy" size='20' maxlength='30' class="UPPER" onKeyPress="return CheckForSpecChars(event);" onBlur="checkSpecialChars(this);" > </td>
		...
		<tr>
			<td align="right" class="label" ><fmt:message key="ePO.DeliveryRemarks.label" bundle="${po_labels}"/></td>
			<td class="fields"   colspan='3' >&nbsp;<textarea   name="delivery_remarks" rows='4' cols='40' onBlur="SPCheckMaxLen('Delivery Remarks',this,400);" onPaste="checkMaxLengthPaste(this,400);" onKeyPress="checkMaxLimit(this,400);" ><%=bean.getDelivery_remarks()%></textarea>
			<input type="hidden" name="remarks_code_2" id="remarks_code_2" value = "<%=bean.getDelivery_remarks()%>" >
