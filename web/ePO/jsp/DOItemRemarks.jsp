...
<html>
	<head>
		<title><fmt:message key="ePO.ItemRmks.label" bundle="${po_labels}"/></title>
<%
...
<form name="formDOItemRemarks" id="formDOItemRemarks">
	<table border='0' cellpadding='2' cellspacing='0' width='100%' align=center>
		...
		<tr>
			...
			<td class=fields>&nbsp;&nbsp;<textarea name="item_remarks" rows='4' cols='40' onBlur="SPCheckMaxLen('Item Remarks',this,1000);" onPaste="checkMaxLengthPaste(this,1000);" onKeyPress="checkMaxLimit(this,1000);"  <%=rdOnly%> ><%=ItemRemarks%></textarea> 
