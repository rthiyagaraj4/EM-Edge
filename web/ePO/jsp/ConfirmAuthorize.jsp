...
<html>
<head>
	<title><fmt:message key="Common.ConfirmAuthorize.label" bundle="${common_labels}"/></title>
	<%
...
<form name='ConfirmTransactionForm' id='ConfirmTransactionForm' method='post'>
	...
	<tr>
		<td  colspan=2>
			<center> <h5> <fmt:message key="Common.Authorize.label" bundle="${common_labels}"/>? </h5> </center>
		</td>
	</tr>
	<tr>
		<td colspan=2> 
