...
<html>
	<head>
		<title><fmt:message key="ePO.OrderRemarks.label" bundle="${po_labels}"/></title>
<%
...
<form name="formOrderRemarks" id="formOrderRemarks">
	<table border='0' cellpadding='2' cellspacing='0' width='100%' align=center>
				...
				<tr>
					...
					<td class=fields>&nbsp;&nbsp;<textarea name="order_remarks" rows='4' cols='40'  onBlur="SPCheckMaxLen('Item Remarks',this,2000);" onPaste="checkMaxLengthPaste(this,2000);" onKeyPress="checkMaxLimit(this,2000);" ><%=bean.getOrder_remarks()%></textarea> 
