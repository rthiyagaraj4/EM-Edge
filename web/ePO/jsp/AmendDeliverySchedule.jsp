...
<form name="formDeliverySchedule" id="formDeliverySchedule">
	<table border='0' cellpadding='0' cellspacing='0' width='100%' align=center scrolling=yes>
				<tr><td class="label" colspan=2><fmt:message key="Common.item.label"	bundle="${common_labels}"/>&nbsp;
				<%=item_code%>  &nbsp;&nbsp;  <%=item_desc%></td></tr>
				<tr><td class="label" colspan=2>Total Ordered Quantity : <%=order_qty%> &nbsp;&nbsp; <%=temp_uom%></td></tr>
				<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><tr>
			...
			%>				
				...
				<input type="text" name="order_qty_<%=ct%>" id="order_qty_<%=ct%>" class='NUMBER' size="10" maxlength="10"  value="<%=bean.checkForNull(order_qty)%>" onKeyPress="return isValidInteger();" onBlur="checkIntegerFormat(this);"> <%=temp_uom%></td>
				<td class="fields" align=center>
			...
			%>				
				<tr>
				<td class="fields" align=center>
				<input type="text" name="order_qty_<%=cnt%>" id="order_qty_<%=cnt%>" class='NUMBER' size="10" maxlength="10"  value="<%=bean.checkForNull(order_qty)%>" onKeyPress="return isValidInteger();" onBlur="checkIntegerFormat(this);"> <%=temp_uom%></td>
				<td class="fields" align=center>
			...
			%>				
				<tr>
				<td class="fields" align=center>
				<input type="text" name="order_qty_<%=j%>" id="order_qty_<%=j%>" class='NUMBER' size="10" maxlength="10"  value="<%=order_qty%>" onKeyPress="return isValidInteger();" onBlur="checkIntegerFormat(this);"> <%=temp_uom%></td>
				<td class="fields" align=center>
