...
<body onload='FocusFirstElement();document.formSTPOCancelRequestQueryCriteria.submit();'>
	...
	<table border="0" cellspacing="0" width="100%" align=center>
	  <tr>
		...
		<td class='fields'>&nbsp;&nbsp;<select name="req_code" id="req_code"  ><%=bean.getPODocTypeCodes()%></select></td>
		<td  class="label"><fmt:message key="ePO.RequestNo.label" bundle="${po_labels}"/></td>
		...
		<td class='fields'>&nbsp;&nbsp;<select name="request_by_store" id="request_by_store" onBlur=""><%=bean.getRequestByStore()%></select></td>
	    ...
	    <tr>
	 	<td class="label"><fmt:message key="ePO.RequestDateFrom.label" bundle="${po_labels}"/> 
		</td>
