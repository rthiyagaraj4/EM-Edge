		...
		<td width="80%" class="Border" align='center'>
				...
				<tr>
					...
					<tr>
						...
						<td width="25%"><input type=text  name='p_fm_pat_seen_date' id='p_fm_pat_seen_date' size="15" maxlength="16" onBlur="validDateObj(this,'DMYHM','<%=localeName%>')"><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendarDateTime('p_fm_pat_seen_date','dd/mm/yyyy' ,'hh:mm',null);" style='cursor:pointer'></img><img src='../../eCommon/images/mandatory.gif'></img> 
						<td width="25%">&nbsp;<input type=text name='p_to_pat_seen_date' id='p_to_pat_seen_date' size="15" maxlength="16" onBlur="validDateObj(this,'DMYHM','<%=localeName%>')" ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendarDateTime('p_to_pat_seen_date','dd/mm/yyyy' ,'hh:mm',null );" style='cursor:pointer'></img><img src='../../eCommon/images/mandatory.gif'></img> 
						</td>
						<td width="25%"></td>
				</tr>
				<tr>
