	...
	try
	{
		...
		if(rs!=null && rs.next()){
			...
			%>
				...
				<iframe name='f_query_add_mod' id='f_query_add_mod' src='../../eAE/jsp/AEManagePatientMain.jsp?<%=query_string.toString()%>&function_id=<%=function_id%>' frameborder=0 scrolling='no' noresize style='height:88vh;width:100vw'></iframe>
