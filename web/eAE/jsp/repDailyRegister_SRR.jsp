...
<script language='javascript' src='../../eAE/js/AEPractitioneplsrComponent.js'></script>

<script src="../../eAE/js/AERepDailyRegister_SRR.js"></script>
	...
	<tr>
		...
		<td width="80%" class="Border" align='center' >
				...
				<table width='80%' cellPadding="2" cellSpacing="0" align='center' border=0>
								...
								<tr> <!--Below line modified for this SCF [SRR20056-9516]  -->
						<td  class='label' width="25%"><fmt:message key="Common.VisitDate.label" bundle="${common_labels}"/></td>
						<td width="25%"><input type=text id='dlyregs' name='p_visit_date1' id='p_visit_date1' size="10" maxlength="10" onBlur="validDateObj(this,'DMY','<%=localeName%>')" ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dlyregs');" style='cursor:pointer'></img><img src='../../eCommon/images/mandatory.gif'></img>
						</td>
...
<input type="hidden" name="p_visit_date" id="p_visit_date"		value="">
<!--End SCF [SRR20056-9516] -->
...
%>
<script>document.forms[0].p_visit_date1.focus();</script>
</body>
</html>
