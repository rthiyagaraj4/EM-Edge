...
<tr>
	...
	<td  class="label" width="25%"><%if(("AE_PAT_DEPARTMENT_DEAD").equals(function_id)){%><fmt:message key="Common.DeceasedDate.label" bundle="${common_labels}"/><%}else{%><fmt:message key="Common.VisitDate.label" bundle="${common_labels}"/><%}%></td>
...
<tr>
	<!--Modified by Ashwini on 08-Mar-2019 for ML-MMOH-CRF-1296-->
	<td  class="label" width="25%"><%if(("AE_PAT_DEPARTMENT_DEAD").equals(function_id)){%><fmt:message key="Common.deceased.label" bundle="${common_labels}"/>&nbsp;<fmt:message key="Common.code.label" bundle="${common_labels}"/><%}else{%><fmt:message key="Common.VisitTypeCode.label" bundle="${common_labels}"/><%}%></td>
