...
var fields = new Array (f_query_add_mod.document.RepWaitTimeStat.p_fm_visit_date1,f_query_add_mod.document.RepWaitTimeStat.p_to_visit_date1);
...
if(f_query_add_mod.document.RepWaitTimeStat){
     if(f_query_add_mod.checkFields( fields, names, messageFrame)){
         if(f_query_add_mod.isBeforeNow(f_query_add_mod.document.RepWaitTimeStat.p_fm_visit_date1.value,"DMY",locale)){
			 if(f_query_add_mod.isBeforeNow(f_query_add_mod.document.RepWaitTimeStat.p_to_visit_date1.value,"DMY",locale)){
					if(f_query_add_mod.isBefore(f_query_add_mod.document.RepWaitTimeStat.p_fm_visit_date1.value,f_query_add_mod.document.RepWaitTimeStat.p_to_visit_date1.value,"DMY",locale)){
					
					f_query_add_mod.document.RepWaitTimeStat.p_fm_visit_date.value=convertDate(f_query_add_mod.document.RepWaitTimeStat.p_fm_visit_date1.value,"DMY",f_query_add_mod.document.RepWaitTimeStat.locale.value,"en");
					f_query_add_mod.document.RepWaitTimeStat.p_to_visit_date.value=convertDate(f_query_add_mod.document.RepWaitTimeStat.p_to_visit_date1.value,"DMY",f_query_add_mod.document.RepWaitTimeStat.locale.value,"en");
