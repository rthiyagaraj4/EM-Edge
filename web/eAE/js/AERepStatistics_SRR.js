...
function run() 
{
		...
		var locale=f_query_add_mod.document.RepStatistics.locale.value;
		/*Below line modified for this SCF  SCF SRR20056-9516 */

var fields = new Array (f_query_add_mod.document.RepStatistics.p_fm_visit_date1,f_query_add_mod.document.RepStatistics.p_to_visit_date1);
...
if(f_query_add_mod.document.RepStatistics){
   if(f_query_add_mod.checkFields( fields, names, messageFrame)){
			...
			if(f_query_add_mod.isBeforeNow(f_query_add_mod.document.RepStatistics.p_fm_visit_date1.value,"DMY",locale)){
			 if(f_query_add_mod.isBeforeNow(f_query_add_mod.document.RepStatistics.p_to_visit_date1.value,"DMY",locale)){
					if(f_query_add_mod.isBefore(f_query_add_mod.document.RepStatistics.p_fm_visit_date1.value,f_query_add_mod.document.RepStatistics.p_to_visit_date1.value,"DMY",locale)){
					f_query_add_mod.document.RepStatistics.p_fm_visit_date.value=convertDate(f_query_add_mod.document.RepStatistics.p_fm_visit_date1.value,"DMY",f_query_add_mod.document.RepStatistics.locale.value,"en");
					f_query_add_mod.document.RepStatistics.p_to_visit_date.value=convertDate(f_query_add_mod.document.RepStatistics.p_to_visit_date1.value,"DMY",f_query_add_mod.document.RepStatistics.locale.value,"en");
