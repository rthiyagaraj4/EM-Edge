...
<script type='text/javascript' src='<%=request.getContextPath()%>/dwr/interface/MessageReader.js'></script>
	...
	<Script Language="JavaScript" src="<%=request.getContextPath()%>/eLC/RepInfectedLinen/js/InfectedLinen.js"></Script>     
...
<body onmousemove="call();" onblur="call();" OnMouseDown="CodeArrest()" onKeyDown="lockKey()">
		<br>
		<ibaHTML:form action="/RepInfectedLinenAction.do" target="messageFrame" method="GET">
			...
			<tr>
				<td align="right" class="label">
						<ibaBean:message key="com.iba.ehis.lc.linenItem" bundle="lcLabels" />
								...
								<td>
									<ibaHTML:text property="vo.linenItem" size="30" maxlength="30"/>
					...
					<td align="right" class="label">
						<ibaBean:message key="com.iba.ehis.lc.source" bundle="lcLabels" />
							...
							<td>
						<ibaHTML:text property="vo.sourceCode" size="30" maxlength="30"/>
