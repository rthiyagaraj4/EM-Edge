		...
		<ibaHTML:form action="/RepLinenMasterCodesAction.do" target="messageFrame" method="GET">
			...
			<tr>
				...
				<tr>
					<td align="right" class="label">
						<ibaBean:message key="com.iba.ehis.lc.agencyCode.agencyCode" bundle="lcLabels" />
								...
								<td>
									<ibaHTML:text property="vo.agencyCodeFrom" size="30" maxlength="30"/>
										<input type='hidden' name="agencyCodeHiddenFrom" id="agencyCodeHiddenFrom" value=''/>
											<input type='button' class='button' value='?' onClick="showLookup('agencyCode','ACLookupFrom');" />
													...
													<td>
													<ibaHTML:text property="vo.agencyCodeTo" size="30" maxlength="30"/>
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					...
					<ibaHTML:hidden property="vo.repId" value="LCRAGNCY"/>
