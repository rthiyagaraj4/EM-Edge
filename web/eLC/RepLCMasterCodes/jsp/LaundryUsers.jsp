			...
			<tr>
				...
				<tr>
					...
					<td align="right" class="label">
						<ibaBean:message key="com.iba.ehis.lc.laundryUserId" bundle="lcLabels" />
							</td>
								<td>
									<ibaHTML:text property="vo.laundryFrom" size="30" maxlength="30"/>
									...
									<td>
								<ibaHTML:text property="vo.laundryTo" size="30" maxlength="30"/>
				...
				<tr>
				<td align="right" class="label">
					<ibaBean:message key="com.iba.ehis.lc.overrideWardConf" bundle="lcLabels" />
						</td>
							<td>
								<ibaHTML:select property="vo.overRide">
									<ibaHTML:option value="Y"><ibaBean:message key="com.iba.ehis.lc.select" bundle="lcLabels" /></ibaHTML:option>
				...
				<ibaHTML:hidden property="vo.repId" value="LCRUSERS"/>
