	...
	<table border='0 ' cellpadding='2' cellspacing='0' width='100%' align='center' class='COMMON_TOOLBAR'	>
		<tr>
			...
			<td class='label' nowrap="nowrap">
				<ibaHTML:text property="vo.cleaningDate" value="<%=conDate%>" size="18" readonly="true"  onkeydown="assignDate(this,false);" onkeypress="assignDate(this,false);" /><a onclick="return showCal('vo. ', '%d/%m/%Y %H:%M', true, true,'cutOffTimeForLinenRecptid');" name='.cutOffTimeForLinenRecptid' id='cutOffTimeForLinenRecptid'><img src="<%=request.getContextPath()%>/framework/images/img.gif"></a><input type='hidden' name='vo.cleaningDate.pattern' id='vo.cleaningDate.pattern' value='dd/MM/yyyy HH:mm'>
