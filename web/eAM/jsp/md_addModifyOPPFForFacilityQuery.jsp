...
%>
<%@ page contentType="text/html;charset=UTF-8" import ="webbeans.eCommon.*,java.sql.*, java.text.*,java.util.*,eCommon.XSSRequestWrapper" %>
	...
	Obj.value='N';
		...
		if(chkPractitionerList())
		{
			...
			{			
				...
				Commented on 30-01-2023 by Ajay H. for ML-MMOH-SCF-2337
			*/
			...
			<table border='0' cellpadding='0' cellspacing='0' align='center' width='85%'>
				...
				<tr>
    				...
    				<tr>
    				     ...
    				     <td  align='left' >&nbsp;<select name='facility' id='facility' onChange='chgFacility()'>
    				     <option>----------<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>---------</option>
    				       <%
    				    		stmt=con.createStatement();
    				    		String sqlfac="Select facility_name,facility_id  from sm_facility_for_user_vw where appl_user_id ='"+ globaluser+"' and nvl(access_eff_date_to,TO_DATE('31/12/9999','DD/MM/RRRR')) >= TRUNC(SYSDATE) order by upper(facility_name)";
    				    ...
    				    %>
    				     ...
    				     <td  align='right' nowrap  class='label'><fmt:message key="Common.primaryspeciality.label" bundle="${common_labels}"/></td>
