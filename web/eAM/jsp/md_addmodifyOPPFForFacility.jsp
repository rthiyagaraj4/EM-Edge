...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<iframe name='f_query_add_mod_query' id='f_query_add_mod_query' 	 src='../../eAM/jsp/md_addModifyOPPFForFacilityQuery.jsp?facility_id=<%=facility_id%>' frameborder=0 noresize scrolling='no' style='height:22vh;width:100vw'></iframe><iframe name='f_query_add_mod_res' id='f_query_add_mod_res' 	 src='../../eCommon/html/blank.html' frameborder=0 noresize scrolling='no' style='height:78vh;width:100vw'></iframe>
</html>
