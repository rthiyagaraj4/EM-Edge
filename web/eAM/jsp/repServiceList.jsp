...
<tr>
				...
				<tr>
				<td align='right' width='30%' class='label'><fmt:message key="Common.medical.label" bundle="${common_labels}"/>&nbsp;</td>
				...
				<tr>
					<td align='right' width='30%' class='label'><fmt:message key="eAM.Ancillary.label" bundle="${am_labels}"/>&nbsp;</td>
					<td  width='20%' align="left">
