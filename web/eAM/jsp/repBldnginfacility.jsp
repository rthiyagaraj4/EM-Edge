<!DOCTYPE html>
<%--
	fiename				:	repBldnginfacility.jsp
	Version				:	3
			...
			<tr>
				...
				<tr>
					...
					<td  width='20%' align="left">
						...
						<option value='1'><fmt:message key="Common.building.label" bundle="${common_labels}"/> <fmt:message key="Common.code.label" bundle="${common_labels}"/>
						<option value='2'><fmt:message key="Common.building.label" bundle="${common_labels}"/> <fmt:message key="Common.description.label" bundle="${common_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
