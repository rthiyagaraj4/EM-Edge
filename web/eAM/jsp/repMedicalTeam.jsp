	...
	<tr>
		...
		<tr>
			...
			<td colspan='2'><select name='p_facility' id='p_facility' onChange="checkVal(this.value);">
				...
				<tr>
					<td align='right' width='30%' class="label"><fmt:message key="Common.TeamID.label" bundle="${common_labels}"/>&nbsp;&nbsp;</td>
				...
				<tr>
					<td align='right' width='30%' class="label"><fmt:message key="eAM.ApplicableForOutpatients.label" bundle="${am_labels}"/>&nbsp;&nbsp;</td>
				...
				<tr>
					<td align='right' width='30%' class="label"><fmt:message key="eAM.ApplicableForInpatients.label" bundle="${am_labels}"/>&nbsp;&nbsp;</td>
				...
				<tr>
					...
					<td  width='20%' align="left">
						...
						<option value='2,3'><fmt:message key="Common.TeamID.label" bundle="${common_labels}"/>
						<option value='2,4'><fmt:message key="Common.description.label" bundle="${common_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
