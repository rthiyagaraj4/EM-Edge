			...
			<%
				...
				<tr>
					...
					<td  width='20%' align="left">
						...
						<option value='1'><fmt:message key="Common.roomno.label" bundle="${common_labels}"/>
						<option value='2'><fmt:message key="Common.room.label" bundle="${common_labels}"/> <fmt:message key="Common.description.label" bundle="${common_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
