...
function apply() {
	if (! checkIsValidForProceed() ) {
		...
		return false ;
            ...
            var formObj = f_query_add_mod.document.order_category;
			...
			if(result1) {
					...
					eval(formApply(f_query_add_mod.document.order_category, OR_CONTROLLER));
...
function onSuccess() {
	...
	f_query_add_mod.location.href = "../../eOR/jsp/OrderCategoryAmend.jsp?mode="+MODE_MODIFY
}
