...
//System.out.println("###in AuthorizeOrdersBottomRightBtn.jsp, begin##");
 //   String readOnly = "" ;
...
<table cellpadding=3 cellspacing=0 border=0 width="100%" height="100%" align=center>
	<tr>
		...
		<INPUT TYPE="button" value='<fmt:message key="Common.Authorize.label" bundle="${common_labels}"/>' class='button' onClick='authorise()'>
...
<%//System.out.println("###in AuthorizeOrdersBottomRightBtn.jsp, ends##");%>
</body>
</html>
