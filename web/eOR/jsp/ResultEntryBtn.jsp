...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	if(resportsrlno[1].equals("3") && requestFrom.equals("RA"))
		showRecordButton = true;     // from false to true modified by Arvind For INC 21459 
	/*
		Added By Arvind For CRF-804
	*/
	if(performed_only.equalsIgnoreCase("Y") ||(resportsrlno[1].equals("3") && requestFrom.equals("RA")))
