...
%>
	<tr>
	   <th width='3%'><fmt:message key="eOR.SNO.label" bundle="${or_labels}"/></th><!-- added for multi consent on 04/05/2007 -->
	...
	<%}%>
		...
		<td class=columnheader width='15%'><fmt:message key="eOR.OrderCatalogs.label" bundle="${or_labels}"/></td>
		<td class=columnheader width='40%'><fmt:message key="Common.OrderDetails.label" bundle="${common_labels}"/></td>
	</tr>
</table>
</form>
</body>
