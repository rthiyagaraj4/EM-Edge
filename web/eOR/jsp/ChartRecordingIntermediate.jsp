...
%>
			<script>
				...
				if("<%=toDate%>"!="")
				qs +="&toDate="+"<%=toDate%>";
				parent.ChartRecordingDetailFrame.location.href="../jsp/ChartRecordingDetail.jsp?chartId="+"<%=chtId%>"+"&defaultDate="+"<%=dateDefault%>"+"&sysdate="+"<%=sysdate%>"+"&function_from="+"<%=function_from%>"+"&"+qs+"&sort_by="+"<%=sort_by%>"+"&errorAuth="+"<%=errorAuth%>"+"&modifyYN="+"<%=modifyYN%>";

				parent.ChartRecordingToolBarFrame.location.href = "../jsp/ChartRecordingToolBar.jsp?chartId="+"<%=chtId%>"+"&function_from="+"<%=function_from%>"+"&result="+"<%=result%>"+"&"+qs+"&errorAuth="+"<%=errorAuth%>";
			</script>
<%
		}
