...
<table cellpadding=3 cellspacing=0 border=0 width="100%" align=center>
	...
	<tr>
		...
		<INPUT TYPE="button" value='<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOR.RecordCancellation.label","or_labels")%>' class='button' onClick='cancelOrder()'>
