...
<%@page  import="java.util.*,eOR.*,eOR.Common.*,webbeans.eCommon.*,eCommon.Common.*,eCommon.XSSRequestWrapper" %>
...
<body onMouseDown="CodeArrest()" onKeyDown="lockKey()" onLoad="callDisable();searchResult();">
<%
...
%>
       ...
       <input type="radio" name="search_by" id="search_by" class="label" value="D"  checked  onclick="storeVal(this)"><fmt:message key="Common.description.label" bundle="${common_labels}"/>
		...
		<td colspan=3></td>
        <td class="button" align="right" nowrap ><input type="button" align="left" name="Search" id="Search" value="<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.search.label","common_labels")%>" onClick="searchResult()" class="button" >
...
<%
	// Added By Shaiju for Incident # 21657 Starts
...
// Added By Shaiju for Incident # 21657 Ends
