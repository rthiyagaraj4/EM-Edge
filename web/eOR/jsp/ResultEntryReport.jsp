...
<!--  <input type="hidden" name="prac_sql" id="prac_sql" value="<%//=OrRepository.getOrKeyValue("SQL_OR_USER_FOR_REVIEW_PRAC_LOOKUP")%>"> -->
 <input type="hidden" name="prac_sql" id="prac_sql" value="<%=OrRepositoryExt.getOrKeyValue("SQL_OR_PRACTITIONER_LOOKUP")%>">
 <input type="hidden" name="prac_sql2" id="prac_sql2" value="<%=OrRepositoryExt.getOrKeyValue("SQL_OR_PRACTITIONER_LOOKUP_SQL2")%>">
