...
%>
	<tr>
		<td class='COLUMNHEADER' width='15%'><!--<input type=checkbox name='select_all' id='select_all' onClick='clickAll()' disabled>--><fmt:message key="Common.bookappointment.label" bundle="${common_labels}"/></td>
	...
	<%}%>
		<td class='COLUMNHEADER' width='19%'><fmt:message key="eOR.OrderedAt.label" bundle="${or_labels}"/></td>
		<td class='COLUMNHEADER' width='15%'><fmt:message key="Common.ordercatalog.label" bundle="${common_labels}"/></td>
		<td class='COLUMNHEADER' width='40%'><fmt:message key="eOR.PatientDetail.label" bundle="${or_labels}"/></td>
	</tr>
</table>
</form>
</body>
