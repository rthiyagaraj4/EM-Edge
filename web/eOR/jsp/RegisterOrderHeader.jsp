...
<table id="tableheader" cellpadding=3 cellspacing=0 border=1 width='100%' height="100%">
	<tr>
		...
		<td class=columnheader width='' nowrap><fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>
		<td class=columnheader width='' nowrap><fmt:message key="eOR.ChargeDtls.label" bundle="${or_labels}"/>
