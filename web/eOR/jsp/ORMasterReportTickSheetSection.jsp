...
<input type=hidden  name='SQL_OR_REPORTS_TICK_SHEET_SECTION_LOOKUP' id='SQL_OR_REPORTS_TICK_SHEET_SECTION_LOOKUP'     value='<%=OrRepository.getOrKeyValue("SQL_OR_REPORTS_TICK_SHEET_SECTION_LOOKUP")%>' >
