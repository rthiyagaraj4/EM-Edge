...
<script language='javascript' src='../../eSM/js/TranslationManager.js'></script>
...
<tr>
  <td class=label width='25%'><fmt:message key="Common.Language.label" bundle="${common_labels}"/>&nbsp;</td>
		  <td class="fields" width='25%'><select name=language onChange='getMaster1(this);'>
		  ...
		  <td class=label  width='25%'><fmt:message key="Common.display.label" bundle="${common_labels}"/>&nbsp;</td>
		   <td class="fields" width='25%'><select name=display  >
		  ...
		  <tr>
		  <td class=label width='25%' id='searchTextID'>
		  ...
		  <td class="fields"  id='obj1' nowrap><select name="start_ends_contains" id="start_ends_contains" >
		   ...
		   <INPUT TYPE="text" name="searchtext" id="searchtext" width=30></td>
		   <td class=label id='obj5'></td>
		   <td class="fields"  id='obj2'></td>
		  </tr>
		  <tr>
		  <td class=label width='25%' id='obj3'></td>
		  <td class="fields"   width='25%' id='obj4'></td>
		  <td align='right' colspan=2>
		  <INPUT TYPE="button" name="Search" id="Search" value='<fmt:message key="Common.search.label" bundle="${common_labels}"/>'  class=button onClick='showResultPage()'>
		  <!--&nbsp;-->
		  <INPUT TYPE="button"  class=button name="clear" id="clear" value='<fmt:message key="Common.clear.label" bundle="${common_labels}"/>' onClick='clearData()' ></td>
		  </tr>
 ...
 <%}else{%>
			<script>
			alert(getMessage("TRANS_MGR_NOT_APPL","Common"));
			location.href='../../eCommon/jsp/home.jsp';
			document.location.href='../../eCommon/jsp/dmenu.jsp';
			parent.commontoolbarFrame.location.href='../../eCommon/html/blank.html';
