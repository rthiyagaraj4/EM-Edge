  ...
  function run() 
{
	...
	f_query_add_mod.document.forms[0].p_relgn_from_code.value = f_query_add_mod.document.forms[0].p_fm_relgn_code.value;	
	f_query_add_mod.document.forms[0].p_relgn_to_code.value = f_query_add_mod.document.forms[0].p_to_relgn_code.value;	
	...
	if(f_query_add_mod.checkFields( fields, names, messageFrame))
	{
	 ...
	 {
		if(f_query_add_mod.CheckString( getLabel("Common.ReligionCode.label","Common"),f_query_add_mod.document.forms[0].p_fm_relgn_code,f_query_add_mod.document.forms[0].p_to_relgn_code,messageFrame))
