...
parent.frames[1].frames[1].frames[1].document.forms[0].action="../../servlet/eOP.ClinicRoomServlet";
...
function create() {
	f_query_add_mod.location.href = "../../eOP/jsp/ClinicMain.jsp?param=create&called_from=1" ;
}

function query() {
	f_query_add_mod.location.href ="../../eOP/jsp/ClinicRoomCriteria.jsp" ;
}
