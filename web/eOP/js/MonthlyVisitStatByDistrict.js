...
function run() 
{
	...
	f_query_add_mod.document.forms[0].p_stat_date.value = f_query_add_mod.document.forms[0].p_st_date.value;	
		...
		if(CheckString1( getLabel("Common.TownCode.label","Common"),f_query_add_mod.document.forms[0].p_fm_restown,f_query_add_mod.document.forms[0].p_to_restown,messageFrame))			if(CheckString1(getLabel("Common.SpecialtyCode.label","Common"),f_query_add_mod.document.forms[0].p_fm_specialty_code,f_query_add_mod.document.forms[0].p_to_specialty_code,messageFrame))
