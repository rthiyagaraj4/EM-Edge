...
function create() {
    ...
    f_query_add_mod.location.href = "../../eOP/jsp/AddClinicResource.jsp?function_id="+document.forms[0].function_id.value+"&call_func=Clinic&function_id=CLINIC" ;
}
...
function query() {
    f_query_add_mod.location.href ="../../eOP/jsp/QueryClinicResourcePage.jsp?function=Clinic&function_id=CLINIC" ;
}
...
function apply()
{
var i=9; // added by mujafar for GHL-CRF-0527	
...
if (! (checkIsValidForProceed()) )
	...
	var mr_sec_type=f_query_add_mod.clinic_sub.document.getElementById("mr_section_type").value;
	...
	if(mr_sec_type == "D")
	{	
	  fields[i]=f_query_add_mod.clinic_sub.document.clinic_resource_form.mr_location_code;
	  names[i]=getLabel("Common.FileStorageLocation.label",'Common');
	  i =i+1; // added by mujafar for GHL-CRF-0527
	}
	if(isAlertApplicableforBookAppt=="true")
...
*/
//var num_appl_yn=f_query_add_mod.clinic_sub.document.getElementById("num_appl_yn").value;
		

		//var by_pract_yn=f_query_add_mod.clinic_sub.document.getElementById("by_pract_yn").value;
		
		//var by_room_yn=f_query_add_mod.clinic_sub.document.getElementById("by_room_yn").value;
		
		//var by_res_yn=f_query_add_mod.clinic_sub.document.getElementById("by_res_yn").value;
		
		//var other_res=f_query_add_mod.clinic_sub.document.getElementById("other_res").value;
	...
	if(f_query_add_mod.clinic_sub.checkFields( fields, names, messageFrame)) 
	{
     ...
     //Added by Ajay for MMS-DM-CRF-0209.4
		...
		f_query_add_mod.clinic_sub.document.clinic_resource_form.specialist_clinic_yn.value =    f_query_add_mod.clinic_main.document.clinic_main_resource_form.specialist_clinic_yn.value;	 

		f_query_add_mod.clinic_sub.document.clinic_resource_form.visit_pract_yn.value =    f_query_add_mod.clinic_main.document.clinic_main_resource_form.visit_pract_yn.value;
...
function reset()
{
   ...
   if(f_query_add_mod.location.href.indexOf("QueryClinicResource.jsp")!=-1)
		     return false;
	 else
			f_query_add_mod.location.reload() ;
...
function clearlist(obj)
{
	...
	{			
		...
		var length2=parent.frames[1].document.forms[0].dflt_file_type.length;
		for(i=0;i<length1;i++)
		{
	...
	{
		var length  =parent.frames[1].document.forms[0].other_type.length;	
		
		for(i=1;i<length;i++)
				parent.frames[1].document.forms[0].other_type.remove[1];
	}
...
function moveToTab(TabIndex) {	
	...
	{		
		...
		//parent.parent.frames[1].pat_frame.rows="145,*,0"; // from 115 to 145  modified by mujafar for GHL-CRF-0527
		...
		{
		//parent.parent.frames[1].pat_frame.rows="115,*,0";
		parent.parent.frames[1].document.getElementById("clinic_main").style.height="25vh";
		parent.parent.frames[1].document.getElementById("clinic_sub").style.height="75vh";
		parent.parent.frames[1].document.getElementById("dummyframe").style.height="0vh";
		}
	...
	{		
		...
		{				
			if(parent.frames[1].document.getElementById("speciality") && parent.frames[1].document.getElementById("speciality").disabled==false)//condition modified for the CRF - Bru-HIMS-CRF-0198			
	...
	{
		if(parent.frames[0].document.getElementById("isAlertApplicableforBookAppt").value=="true"){
		//parent.parent.frames[1].pat_frame.rows="24%,10%,*"; // from 18 to 24  modified by mujafar for GHL-CRF-0527
		parent.parent.frames[1].document.getElementById("clinic_main").style.height="25vh";
		parent.parent.frames[1].document.getElementById("clinic_sub").style.height="75vh";
		parent.parent.frames[1].document.getElementById("dummyframe").style.height="0vh";
		}
...
function assignvalspec(obj)
	{
		...
		if(obj.checked==true)
		{
			...
			else
			{
			  ...
			  parent.frames[0].document.forms[0].visit_pract.disabled=false;
				}
			}
	     }
		 else if(obj.checked==false)
		 {
			  ...
			  else
			  {
				 if(parent.frames[0].document.forms[0])
				  ...
				  parent.frames[0].document.forms[0].visit_pract.disabled=true;
				  parent.frames[0].document.forms[0].visit_pract.checked=false;
...
function CheckTime(obj,fld)
{
		...
		if (obj.value!="")
		{
			...
			{		
				...
				alert(errors);
				obj.value=''; // Thursday, March 25, 2010  20280 Venkat S
				//obj.select();				
				return false;				
			}	
			/*else 
...
function assignval(obj)
{
		...
		if(obj.name == "diagnosis_not_mndt")
		{
...
function GetValues(obj)
	{
		...
		*/
		...
		{
			 if((document.forms[0].call_function.value == 'Clinic') && (document.forms[0].clinic_code.value != "") && (document.forms[0].online_mr_notfn_yn.checked == true) && (document.forms[0].reportCount.value >0) && (document.forms[0].mr_section_type.value =='D') ) {					
					alert(getMessage("FM_ONLINE_REP_RULE_NOT_DEFINED","FM"));
					document.forms[0].mr_section_type.value ='C';						  
					if(document.forms[0].mr_section.value == "") {
					...
					if(parent.frames[1].document.getElementById("fm_install").value == "Y")
					{
						...
						else
						{
							...
							if(parent.frames[1].document.forms[0].level_of_care!=null)
							{
								...
								else if(parent.frames[1].document.forms[0].level_of_care.value=="E")
								{
									parent.frames[1].document.getElementById("popUp").style.visibility='hidden';
									parent.frames[1].document.forms[0].online_mr_notfn_yn.disabled=true;
								}
			...
			else
			{
				if(parent.frames[1].document.forms[0].level_of_care.value != null)
				{
					...
					if(chkfunction!="DaycareUnit")
						...
						var opt=document.createElement("OPTION");
						var opt1=document.createElement("OPTION");
						opt1.text=getLabel("Common.visittype.label","Common");
						opt1.value="X";
					   opt.text=getLabel("Common.resource.label","Common");
				       opt.value="P";
					   parent.frames[1].document.forms[0].ident_at_checkin.add(opt1);
...
function vitalenable()
		{
		   ...
		   var callfunc=parent.frames[1].document.forms[0].call_function.value;
			...
			if(callfunc!="DaycareUnit"){
			 ...
			 if(parent.frames[1].document.forms[0].allow_visit_regn_yn.checked==false)
			{
			     parent.frames[1].document.forms[0].vitalsignsb.disabled=true;		   parent.frames[1].document.forms[0].disp_in_ca_queue_after.disabled=true;
...
//Changes for the CRF - Bru-HIMS-CRF 192.1 - start
...
//Changes for the CRF - Bru-HIMS-CRF 192.1 - end
...
function Queuenomandate_change() 
{
 	 if (clinic_resource_form.Queuenomandate.checked == true)
 	 {
		clinic_resource_form.Queuenomandate.value="Y";
 	    clinic_resource_form.Queuenomandate_yn.value="Y";
 	 }
 	 else
 	 {
		clinic_resource_form.Queuenomandate.value="N";
 	    clinic_resource_form.Queuenomandate_yn.value="N";
 	 }
 	}
