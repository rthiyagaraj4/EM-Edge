...
<iframe name='RegPatReferralPrintFrame' id='RegPatReferralPrintFrame'	src='../../eOP/jsp/RegPatReferralPrint.jsp?<%=params%>' frameborder=0 scrolling='no' noresize style='height:99vh;width:100vw'></iframe>
