	...
	<th class='columnheader' align="left" width='100%'><fmt:message key="Common.reportcritera.label" bundle="${common_labels}"/></th>
			...
			<table width='80%' cellPadding="2" cellSpacing="0"  align='center'>
				<tr>
					...
					<td class="querydata" width='32%'><fmt:message key="Common.to.label" bundle="${common_labels}"/></td>
				</tr>
				<tr>
...
<tr>
	...
	<td class='fields'><input type="text" name="p_fm_pract_id" id="p_fm_pract_id" size="15" maxlength="15" onBlur='searchCode2(pract_id1,this)'><input type='button' name='pract_id1' id='pract_id1' value='?' class='button' onclick='searchCode2(this,p_fm_pract_id,"<%=p_facility_id%>","",document.forms[0].fm_pract_type.value)'>
	</td>	
	<td class='fields'><input type="text" name="p_to_pract_id" id="p_to_pract_id" size="15" maxlength="15" onBlur='searchCode2(pract_id2,this)'><input type='button' name='pract_id2' id='pract_id2' value='?' class='button' onclick='searchCode2(this,p_to_pract_id)'>
				...
				<tr>
					...
					<td class='fields' colspan='2'>
						...
						<option value='3'><fmt:message key="Common.practitionerid.label" bundle="${common_labels}"/>
						<option value='4'><fmt:message key="Common.practitionername.label" bundle="${common_labels}"/>
						</select>
					</td>
				</tr>				
			</table>		
