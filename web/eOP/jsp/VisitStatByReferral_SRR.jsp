...
<th class='columnheader' width='100%'><fmt:message key="Common.reportcritera.label" bundle="${common_labels}"/></th>
</table>
<table cellpadding='2' border = '0' cellspacing='0' width='80%'>
<tr><td width='33%'>&nbsp;</td>
<td class="querydata" width='33%'><fmt:message key="Common.from.label" bundle="${common_labels}"/>
