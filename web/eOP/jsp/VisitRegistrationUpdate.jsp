...
<%@ page contentType="text/html;charset=UTF-8" import ="java.sql.*,java.util.*, java.text.*,java.io.*, javax.servlet.jsp.JspWriter,webbeans.eCommon.ConnectionManager,webbeans.eCommon.*" %>
<html>
    <head>
		<% 
