...
function getSearchFormHTML()
{
	...
	var sButton="<form name=\""+sFormName+"\" id=\""+sFormName+"\" method=\"POST\" action=\"javascript:searchB("+gnForm+")\">"
	sButton+="<input type=\"text\" name=\"searchString\" id=\"searchString\" value=\"- Full Text search -\" size=\"20\"/>";
	if(""=="text")
	{
