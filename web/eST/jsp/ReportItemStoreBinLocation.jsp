		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<option value="STBITSTB"><fmt:message key="Common.item.label" bundle="${common_labels}"/></option>
					<option value="STBSTITB"><fmt:message key="Common.Store.label" bundle="${common_labels}"/></option>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
