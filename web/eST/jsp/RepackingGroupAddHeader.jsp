	...
	<td width='100%' align='center' class="WHITE">	
		...
		%>
			 <tr>
				...
				<td align="center" class="<%=classValue %>" >
					<input type="text" name="long_desc_<%=cnt %>" id="long_desc_<%=cnt %>"  size="25" maxlength="40" onBlur="makeValidString(this);resetColorCode(this);">
				</td>
				<td align="center" class="<%=classValue %>" >
					<input type="text" name="short_desc_<%=cnt %>" id="short_desc_<%=cnt %>" size="11" maxlength="15" onBlur="makeValidString(this);resetColorCode(this);">
				</td>
				<td align="center" class="<%=classValue %>">
				...
				<td align="center" class="<%=classValue %>">
					<input type="checkBox" name="eff_status_<%=cnt %>" id="eff_status_<%=cnt %>" value="E" >
				</td>
			</tr>
	<%
		}
