...
textarea {
  resize: none;
	...
	<title><fmt:message key="eST.RejectionRemarks.label" bundle="${st_labels}"/></title>
</head>
<%
...
<body onload='FocusFirstElement();'>
	...
	<table border="0" cellspacing="0" width="100%" align=center>
	  ...
	  <tr>
		<td  class="label" nowrap><fmt:message key="eST.RejectionRemarks.label" bundle="${common_labels}"/></td>
