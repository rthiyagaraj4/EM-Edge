...
<tr>
	...
	<td align="left"  colspan="2">&nbsp;&nbsp;
		<select name="summary_code" id="summary_code" onchange="loadPage();">
			...
			<%if(site_id.equals("SHALM")){ %> <!--Added by B.Badmavathi on 12-04-2016 against ML-MMOH-CRF-0375-->
				<option  value='O'><fmt:message key="eST.CondemnBatches.label" bundle="${st_labels}"/></option>
