<!DOCTYPE html>
 ...
 <%@page import="java.util.HashMap,java.util.ArrayList,java.util.Properties,eST.*, java.sql.*" contentType="text/html;charset=UTF-8" %>
	...
	%>
		<table cellpadding=0 cellspacing=0 width="100%" align="center">
			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%" align="center" id='tb1'>
				<tr>
					<th rowspan=2><fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/><input type="checkbox" name="checkAll" id="checkAll" value="" onClick="toggleCheck(formComputeStockLevelsStoresResult);" checked></th>
		...
		%>
				...
				<td class="<%=classvalue%>" onclick="disableClick(event);" align="right" width=10><input type="text" class="NOBORDER" name ="reorder_level_<%=records.get(0)%>" value="<%=hmCalculatedDetail.get("reorder_level")%>" size="12" maxlength="12"  onkeypress = "return isValidNumber(this,event,12,0);" onFocus="return changeRowColor(tr_<%=i%>);"   >
				<td class="<%=classvalue%>" onclick="disableClick(event);" align="right" width=10><input type="text" class="NOBORDER" name ="reorder_qty_<%=records.get(0)%>" value="<%=hmCalculatedDetail.get("reorder_qty")%>" size="12" maxlength="12"  onkeypress = "return isValidNumber(this,event,12,0);" onFocus="return changeRowColor(tr_<%=i%>);"   >
				</td>
				...
				<td class="<%=classvalue%>" onclick="disableClick(event);" align="right"><%=records.get(6)%></td>
			</tr>
		<%
					i++;
		...
		<input type="hidden" name="total_index" id="total_index" value="<%= i/2%>">
