...
<%@ page import=" eST.SalesAndSalesReturnHistoryBean,java.util.HashMap,java.sql.*,java.text.*,webbeans.eCommon.*"  contentType="text/html;charset=UTF-8"  %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" >
   <tr>
		...
		<td class='field'>&nbsp;<select name="p_sal_doc_type" id="p_sal_doc_type" ><%=bean.getAllDoc_type_code_ListOptions("")%></select></td> <!-- Modified for IN0069649 -->
  ...
  <tr> 
		...
		<td align="left">&nbsp;<input type="text" name="p_to_date" id="p_to_date" size="8" maxlength="10"  value="<%=currentdate%>" onBlur="CheckDate(this);"><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('p_to_date');"></img>
		</td> 
  ...
  <tr>
		...
		<td>&nbsp;<input type='text' name='p_patient_id' id='p_patient_id' class="UPPER" size=20 maxLength="<%=pat_length%>" value="" onBlur="searchpatientName(document.formSalesAndSalesReturnHistoryReport);"><input type='button' class='button' value="?" onclick="searchPatient();"></td>
  ...
  <tr>
		...
		<input type="hidden" name="p_currentdate" id="p_currentdate"  value="<%=currentdate %>">
