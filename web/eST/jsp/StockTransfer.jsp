<!DOCTYPE html>
<%@ page contentType="text/html;charset=UTF-8" import=" eST.StockTransferBean,eCommon.Common.*," %>
...
%>
		<script>
			parent.workAreaFrame.f_query_add_mod.document.location.href = "../../eST/jsp/StockTransferQueryFrame.jsp?mode=2&<%=params%>" ;
		</script>
<%
}
%>
