	...
	<body onLoad="FocusFirstElement();">
		<form name="formadjustmentsummary" id="formadjustmentsummary" action="../../eCommon/jsp/report_options.jsp"  target="messageFrame" >
				...
				<tr>
					...
					<%if(restrict_stores_user_access_yn){ %> <!-- modified for MOHE-CRF-0084.1 -->
						<select name="p_report_id" id="p_report_id" onChange ='setReportIdValue(p_report_id)' >
							<option value="<%=rep_id_1%>"><fmt:message key="eST.ByItem.label" bundle="${st_labels}"/> </option>
							<option value="<%=rep_id_2%>"><fmt:message key="eST.ByStore.label" bundle="${st_labels}"/></option> 	
						</select>
						<%} else { %>
				...
				<tr>
					...
					if( trn_type.equalsIgnoreCase("SPB") || trn_type.equalsIgnoreCase("CBL") ){ %> <!-- added for MOHE-CRF-0084.1  -->
					...
					<%if(restrict_stores_user_access_yn){ //<!-- added for MOHE-CRF-0084.1  -->
						if( trn_type.equalsIgnoreCase("SPB") || trn_type.equalsIgnoreCase("CBL")  ){ %> <!-- MODIFIED FOR MOHE-CRF-0084.1 -->
				...
				<tr>
					...
					<td class=fields>&nbsp;&nbsp;<input type=text name="dt_from_1" id="dt_from_1" size=10 maxlength=10 class="DATE" value="" onBlur="return CheckDate(this,'<%=locale%>');">
					<img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dt_from_1');" ></img>
					&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td class="label">&nbsp;</td><td class=fields colspan=5>&nbsp;&nbsp;<input type=text name="dt_to_1" id="dt_to_1" size=10 maxlength=10 class="DATE" value="" onBlur="return CheckDate(this,'<%=locale%>');">
					<img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dt_to_1');" ></img>
					&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
                <tr>
					<td  class="label">&nbsp;<fmt:message key="Common.ItemAnalysis.label" bundle="${common_labels}"/>1</td><!-- Modified for IN:074037  -->
					<td class=fields >&nbsp;&nbsp;<select name="p_item_anal1_code" id="p_item_anal1_code" >
					<%=bean.getItemAnal_code_List()%>
					</select></td>
					<td  class="label">&nbsp;<fmt:message key="Common.ItemAnalysis.label" bundle="${common_labels}"/>2</td><!-- Modified for IN:074037  -->
					<td class=fields >&nbsp;&nbsp;<select name="p_item_anal2_code" id="p_item_anal2_code" >
					<%=bean.getItemAnal_code_List()%>
					</select></td>
				</tr>
				<tr>
					<td class="label">&nbsp;<fmt:message key="Common.ItemAnalysis.label" bundle="${common_labels}"/>3</td><!-- Modified for IN:074037  -->
		...
		<!--<input type="hidden" name="p_report_id" id="p_report_id" 				value="STBADJSM"> -->
			...
			<input type="hidden" name="p_report_id_value" id="p_report_id_value"			value="<%=p_report_id_value%>">
