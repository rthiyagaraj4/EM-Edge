		...
		<table border="0" cellpadding="0" cellspacing="0" width='75%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<td align="right" >&nbsp;</td>
					<td class="fields" colspan=6>&nbsp;&nbsp;<fmt:message key="Common.to.label" bundle="${common_labels}"/> </td>
				...
				<tr>
					...
					<td class="label">&nbsp;</td><td class=fields colspan=6>&nbsp;&nbsp;<input type=text name=dt_to_1 size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this,'<%=locale%>');"  ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dt_to_1');" ></img>
					&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
				<tr>
...
<!-- 				<tr>
 ...
 -->
				...
				<tr>
					...
					<td class="label" align = right><fmt:message key="Common.ItemAnalysis.label" bundle="${common_labels}"/> 2&nbsp;</td>
					<td class=fields colspan=6>&nbsp;&nbsp;<select name="p_item_anal_2" id="p_item_anal_2"><%=bean.getItem_analList()%>
					</select></td>
				</tr>
				<tr>
					<td  class="label"><fmt:message key="Common.ItemAnalysis.label" bundle="${common_labels}"/> 3</td>
					<td class=fields  colspan=6>&nbsp;&nbsp;<select name="p_item_anal_3" id="p_item_anal_3"> <%=bean.getItem_analList()%>
					</select></td>
					<td class=label align=right></td>					
					<td class=label align=right></td>					
				</tr>
