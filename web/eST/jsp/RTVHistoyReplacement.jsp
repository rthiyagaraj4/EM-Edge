<!DOCTYPE html>
<%@ page import="eST.RTVHistoryBean,java.util.*,java.lang.*,webbeans.eCommon.*" contentType="text/html;charset=UTF-8"%>
...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	try{
		...
		*/
		...
		sqlMap.put("sqlData", eST.Common.StRepository.getStKeyValue("ST_SQL_REPL_RTV_GRN_DTLS"));

		displayFields.add("doc_type_code");	                     
		displayFields.add("doc_no");	                         
		displayFields.add("DOC_SRL_NO");                    
		displayFields.add("RTV_REPL_QTY");
		displayFields.add("PEND_REPL_QTY");	
		...
		<table border="1" cellpadding="0" cellspacing="0" width="99%" align="center" id='tb1'>
			...
			<th><fmt:message key="eST.ReplGRNQuantity.label" bundle="${st_labels}"/></th>
			...
			<tr>
				...
				<!-- 					
						...
						* @Date - 19/02/2010
						* @Inc# - IN019466
						* @Desc - To right align Repl GRN Qty.				
					-->
				<td class = "<%=className%>" style="TEXT-ALIGN:right"> <%=bean.setNumber(bean.checkForNull((String)data.get(5),"0"),no_of_decimals)%>&nbsp;</td>
...
<%	
	...
	out.println(CommonBean.setForm (request ,"../../eST/jsp/RTVHistoryGRNFrameList.jsp", searched));
	}
				catch(Exception e) {
					e.printStackTrace();
				}
