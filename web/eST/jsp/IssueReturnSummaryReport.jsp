...
<%@page contentType="text/html;charset=UTF-8" import="java.util.*, eST.*,java.lang.*, eST.Common.* , eCommon.Common.*,webbeans.eCommon.*,java.sql.*" %>
	...
	<body onLoad="FocusFirstElement();">
		...
		<table cellpadding="0" cellspacing="0" width="75%" align="center" border="0">
				...
				<tr>
					...
					<option value="STBRETS3"><fmt:message key="eST.ByItem.label" bundle="${st_labels}"/> </option>
					<option value="STBRETS1"><fmt:message key="eST.ByFromStore.label" bundle="${st_labels}"/></option> 	
					<option value="STBRETS2"><fmt:message key="eST.ByToStore.label" bundle="${st_labels}"/></option> 	
					</select></td>
					<td align="right" class="label"><fmt:message key="eST.ByItemClass.label" bundle="${st_labels}"/></td>
				...
				<tr>
					<td  class="label"><fmt:message key="Common.ReturnFromStore.label" bundle="${common_labels}"/></td>
				...
				<tr>
					<td  class="label"><fmt:message key="Common.ReturnToStore.label" bundle="${common_labels}"/></td>
					<% if(restrict_stores_user_access_yn){ %> <!-- added for 20203 START-->
				...
				<tr>
					...
					<td class=fields>&nbsp;&nbsp;<input type=text name="dt_from_1" id="dt_from_1" size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this,'<%=locale%>');"  ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dt_from_1');" ></img>
					&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td class="fields">&nbsp;</td><td class=fields colspan=5>&nbsp;&nbsp;<input type=text name="dt_to_1" id="dt_to_1" size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this,'<%=locale%>');"  >
				...
				<tr>
					<td  class="label" ><fmt:message key="eST.ReturnType.label" bundle="${st_labels}"/></td>
					<td class=fields COLSPAN=7>&nbsp;&nbsp;<select name="p_iss_type" id="p_iss_type" >
					<option value="BO"><fmt:message key="Common.all.label" bundle="${common_labels}"/></option> 	
					<option value="SR"><fmt:message key="eST.StockReturns.label" bundle="${st_labels}"/></option> 	
					<option value="NS"><fmt:message key="eST.NonStockReturns.label" bundle="${st_labels}"/> </option>
					</select></td>
				</tr>
				<tr>
