...
<body onload='FocusFirstElement();'>
	...
	<table border="0" cellspacing="0" width="100%" align=center>
	  ...
	  <tr>
		...
		<td class='fields'>
			&nbsp;
			<input type="text" name="from_doc_date" id="from_doc_date" size="10" maxlength="10" value="<%=currentdateminus%>" onBlur="CheckDateLeap(this,'DMY','<%=locale%>');"><!-- ChekDate(this,'<%=locale%>'); removed for Leap year issue, added CheckDateLeap(this,'DMY','<%=locale%>') by Badmavathi for SRR20056-SCF-14071-->
		...
		<td class='fields'>
			&nbsp;
			<input type="text" name="to_doc_date" id="to_doc_date" size="10" maxlength="10" value="<%=currentdate%>" onBlur="CheckDateLeap(this,'DMY','<%=locale%>');"><!-- ChekDate(this,'<%=locale%>'); removed for Leap year issue, added CheckDateLeap(this,'DMY','<%=locale%>') by Badmavathi for SRR20056-SCF-14071-->
