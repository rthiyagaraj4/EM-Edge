		...
		<table border="0" cellpadding="0" cellspacing="0" width='75%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<option value="STBSALS1"><fmt:message key="eST.ByItem.label" bundle="${st_labels}"/> </option>
					<option value="STBSALS2"><fmt:message key="eST.ByStore.label" bundle="${st_labels}"/></option> 	
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
					...
					<td align="right" >&nbsp;</td>
					<td  class="label" colspan=5>&nbsp;&nbsp;<fmt:message key="Common.to.label" bundle="${common_labels}"/></td>
				</tr>
				<tr>
