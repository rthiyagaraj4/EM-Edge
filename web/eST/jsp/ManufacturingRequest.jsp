...
<iframe name='f_query_add_mod' id='f_query_add_mod' src='../../eST/jsp/ManufacturingRequestFrame.jsp?mode=<%=eCommon.Common.CommonRepository.getCommonKeyValue("MODE_INSERT")%>' frameborder=0 style='height:82vh;width:100vw'></iframe>
