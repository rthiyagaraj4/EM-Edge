		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<td  class="label" ><fmt:message key="Common.StoreType.label" bundle="${common_labels}"/></td>
                    ...
                    <option value="S" ><fmt:message key="eST.SubStore.label" bundle="${st_labels}"/></option>
                    <option value="P" ><fmt:message key="Common.pharmacy.label" bundle="${common_labels}"/></option>
                    <option value="N" ><fmt:message key="eST.NonStockStore.label" bundle="${st_labels}"/></option>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
				...
				<tr>
					...
					<option value='1'><fmt:message key="Common.StoreCode.label" bundle="${common_labels}"/></option>
					<option value='2'><fmt:message key="Common.StoreDescription.label" bundle="${common_labels}"/></option>
					<option value='3'><fmt:message key="Common.DepartmentCode.label" bundle="${common_labels}"/></option>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
			...
			<input type="hidden" name="SQL_ST_STORE_LOOKUP_FOR_REPORT" id="SQL_ST_STORE_LOOKUP_FOR_REPORT" value="<%= eST.Common.StRepository.getStKeyValue("SQL_ST_STORE_LOOKUP_FOR_REPORT")%>">
