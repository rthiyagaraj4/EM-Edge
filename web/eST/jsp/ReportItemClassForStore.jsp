		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<option  value='3'><fmt:message key="Common.ItemClassCode.label" bundle="${common_labels}"/></option>
					<option  value='4'><fmt:message key="Common.ItemClassDescription.label" bundle="${common_labels}"/></option>	
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
