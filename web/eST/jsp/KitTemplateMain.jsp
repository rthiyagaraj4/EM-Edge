	...
	<body onMouseDown="CodeArrest()">
		<form name="KitTemplateMainform" id="KitTemplateMainform" >
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
				      <td class=label><fmt:message key="eST.KitTemplateDescription.label" bundle="${st_labels}"/>&nbsp;&nbsp;</td><td class='fields'><input type=text name='kit_template_desc' id='kit_template_desc' size=40 maxlength=60 value="<%=kit_template_desc%>" ><img src="../../eCommon/images/mandatory.gif" align="center"></img></td></tr>
				<tr>
