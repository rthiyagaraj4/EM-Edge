	...
	%>
			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%" align=center>
				<tr>
					...
					<th width='20%'><fmt:message key="Common.DocNo.label" bundle="${common_labels}"/></th>
					<th width='30%'><fmt:message key="Common.DocDate.label" bundle="${common_labels}"/></th>
					<th width='20%'><fmt:message key="Common.Store.label" bundle="${common_labels}"/></th><!-- Modified for IN:074037  -->
				</tr>		
		<%
		...
		%>
				<tr onClick="Modify(this,'<%=records.get(0)%>','<%=records.get(4)%>','','<%=locale%>','<%=CommonBean.checkForNull((String)records.get(7))%>');" >
