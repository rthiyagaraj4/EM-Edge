...
%>
<title><fmt:message key="eST.ManufacturingRequestDetails.label" bundle="${st_labels}"/></title>
<iframe name='detailframe' id='detailframe' src="../../eST/jsp/ManufacturingRequestListResult.jsp?mode=<%=mode%>&index=<%=index%>&seq_no=<%=seq_no%>" frameborder=0 style='height:60%;width:100vw'></iframe><iframe name='addModframe' id='addModframe'	src="../../eST/jsp/ManufacturingRequestAddModify.jsp?mode=<%=mode%>&seq_no=<%=seq_no%>"  frameborder=0 scrolling='no' noresize style='height:100vh;width:100vw'></iframe>
