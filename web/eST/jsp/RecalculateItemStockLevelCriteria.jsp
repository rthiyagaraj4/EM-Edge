	...
	<body onLoad="FocusFirstElement();">
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					<td class=label align="left"><fmt:message key="eST.BufferonMinStock.label"   bundle="${st_labels}"/></td>
...
<option value='S'><fmt:message key="Common.shortdescription.label" bundle="${common_labels}"/></option>
				...
				<tr>
					...
					<td class=label align="left"><fmt:message key="eST.ExcludeExternalStores.label"   bundle="${st_labels}"/>&nbsp;</td>	
