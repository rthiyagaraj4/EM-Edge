...
var formObj = "";
function reset() {
	formObj = f_query_add_mod.document.formFacilityWiseYearSummaryReport;
	formObj.reset();
}
...
function run() {
	formObj = f_query_add_mod.document.formFacilityWiseYearSummaryReport;
	if (f_query_add_mod.document.formFacilityWiseYearSummaryReport) {  
			//alert(formObj.p_fm_year.value);
