	...
	if(obj.value!=""){
		...
		if (arr_date.length != 3) return cal_error (obj);//flag=false;
		if(arr_date[0]!=null)
		{
...
function cal_error (obj) {
	...
	return null;
		...
		function checkNullDS(fieldName,fields)
		 { 
		 	var f1;
		 	var error="";
	...
	//----------------------------------------------------------------
	// setFieldToUpperCase(input_object)
	//   Sets value of form field toUpperCase() for a field
	//----------------------------------------------------------------
