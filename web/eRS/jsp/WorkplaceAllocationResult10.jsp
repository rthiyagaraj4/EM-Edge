...
<form name='calender1' id='calender1'>
		...
		<td  align="left" class=Day width="13%" nowrap><b><fmt:message key="Common.Position.label" bundle="${common_labels}"/>/<fmt:message key="eRS.WorkPlace.label" bundle="${rs_labels}"/>/<fmt:message key="Common.SHIFT.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;</b><input type='hidden' name='u1' id='u1' value='u1'>
		</td>
...
%>
		<tr >
		<td class='ShiftChange' colspan=15 nowrap><b><%=wp_temp%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
		<%
...
<tr >
		<td class='Total' width='3%' nowrap><b><%=sh_temp%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
		<%
	...
	%>
		<tr >
		<td class='Total'  nowrap><b><fmt:message key="eRS.TotalByWorkPlace.label" bundle="${rs_labels}"/>&nbsp;&nbsp;</b></td>
		<%
		...
		%>
		<td class=<%=classval%> width='3%' align='center'>&nbsp;<%=disp%>&nbsp;</td>
		<% 
			if(total_pos[kkk1]==0){
