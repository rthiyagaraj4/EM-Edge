...
public class GradeServlet extends javax.servlet.http.HttpServlet
{
	...
	public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if ( operation.equals("insert") )   insertGrade(req, res);
			if ( operation.equals("modify"))    modifyGrade(req, res);
	...
	private void modifyGrade(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			gradecode=req.getParameter("grade_code");
			...
			tabdata.put("grade_code",gradecode);
			...
			condflds.put("grade_code",gradecode);
		...
		catch ( Exception e )
		{
			...
			out.println( gradecode+ " "+longDesc + " "+shortDesc + " "+ effectiveStatus );
		}
	}

	private void insertGrade(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			gradecode=req.getParameter("grade_code");
