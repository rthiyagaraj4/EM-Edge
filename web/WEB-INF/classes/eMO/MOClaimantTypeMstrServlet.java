...
public class MOClaimantTypeMstrServlet extends HttpServlet {

    PrintWriter out;
    Properties p;
   	String claimant_type_mstr_code = "";
	String short_desc = "";
	String long_desc = "";
    ...
    public MOClaimantTypeMstrServlet() {
	...
	try {
			...
			claimant_type_mstr_code = httpservletrequest.getParameter("claimant_type_mstr_code");
			if(claimant_type_mstr_code == null) claimant_type_mstr_code = "";
			...
			if(s.equals("insert"))
			insertClaimantTypeMstr(httpservletresponse);
			if(s.equals("modify"))
			modifyClaimantTypeMstr(httpservletresponse);
		}
    ...
    private void modifyClaimantTypeMstr(HttpServletResponse httpservletresponse) {
        try {
            ...
            hashmap1.put("CLAIMANT_TYPE_MSTR_CODE", claimant_type_mstr_code);
            
		   String tabname = "MO_CLAIMANT_TYPE_MSTR";
		...
		results.clear();
            ...
            out.println(claimant_type_mstr_code + " " + short_desc + " " + effectiveStatus);
        }
    }

    private void insertClaimantTypeMstr(HttpServletResponse httpservletresponse) {
        try {
            ...
            java.sql.Date date1 = java.sql.Date.valueOf(s3);
            HashMap hashmap = new HashMap();
            hashmap.put("CLAIMANT_TYPE_MSTR_CODE", claimant_type_mstr_code);
            hashmap.put("LONG_DESC", long_desc);
            hashmap.put("SHORT_DESC", short_desc);
            hashmap.put("EFF_STATUS", effectiveStatus);
            hashmap.put("added_by_id", s);
