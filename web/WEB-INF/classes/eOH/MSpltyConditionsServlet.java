...
public class MSpltyConditionsServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	String table_name="OH_CONDITION";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String condition_code=checkForNull(req.getParameter("condition_code"));
			String condition_desc=checkForNull(req.getParameter("condition_desc"));
			...
			tabdata.put("condition_code",condition_code);
			tabdata.put("condition_desc",condition_desc);
			tabdata.put("splty_module_id",splty_module_id);
			tabdata.put("condition_type",condition_type);
			...
			String condition_desc=checkForNull(req.getParameter("condition_desc"),req.getParameter("condition_desc1") );
			String splty_module_id=checkForNull(req.getParameter("splty_module_id"),req.getParameter("splty_module_id1"));
			String condition_type=checkForNull(req.getParameter("condition_type"),req.getParameter("condition_type1"));
			String eff_status = checkForNull(req.getParameter("eff_status"),"D");
			tabdata.put("condition_desc",condition_desc);
			tabdata.put("splty_module_id",splty_module_id);
			tabdata.put("condition_type",condition_type);
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String condition_code=checkForNull(req.getParameter("condition_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("condition_code",condition_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
