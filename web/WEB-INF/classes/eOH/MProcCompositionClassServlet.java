...
public class MProcCompositionClassServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	String table_name="OH_COMPOSITION_CLASS";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			...
			String composition_class_desc=checkForNull(req.getParameter("composition_class_desc"));
...
//			String trmt_category_type=checkForNull(req.getParameter("trmt_category_type"));
			...
			tabdata.put("composition_class_desc",composition_class_desc);
			//below line is commented by bshankar on 18th Feb as new master for treatment category types association is being created
//			tabdata.put("trmt_category_type",trmt_category_type);
			...
			String composition_class_desc=checkForNull(req.getParameter("composition_class_desc"),req.getParameter("composition_class_desc1") );
			//below line is commented by bshankar on 18th Feb as new master for treatment category types association is being created
...
//			tabdata.put("trmt_category_type",trmt_category_type);
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"composition_class_code"};
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String composition_class_code=checkForNull(req.getParameter("composition_class_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("composition_class_code",composition_class_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
