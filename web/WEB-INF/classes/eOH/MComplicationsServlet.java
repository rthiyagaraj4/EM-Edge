...
public class MComplicationsServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	String table_name="OH_COMPLICATION";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String complication_code=checkForNull(req.getParameter("complication_code"));
			String complication_desc=checkForNull(req.getParameter("complication_desc"));
...
//			String trmt_category_type=checkForNull(req.getParameter("trmt_category_type"));
			...
			tabdata.put("complication_code",complication_code);
			tabdata.put("complication_desc",complication_desc);
			//below line is commented by bshankar on 18th Feb as new master for treatment category types association is being created
			...
			String complication_desc=checkForNull(req.getParameter("complication_desc"),req.getParameter("complication_desc1") );
			//below line is commented by bshankar on 18th Feb as new master for treatment category types association is being created
...
//			tabdata.put("trmt_category_type",trmt_category_type);
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"complication_code"};
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String complication_code=checkForNull(req.getParameter("complication_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("complication_code",complication_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
