...
public class MExtPermLocationServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	String table_name="OH_EXT_PERFORM_LOCATIONS";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String extPermLoc_code=checkForNull(req.getParameter("extPermLoc_code"));
			String extPermLoc_desc=checkForNull(req.getParameter("extPermLoc_desc"));
			String eff_status = checkForNull(req.getParameter("eff_status"),"D");
			tabdata.put("ext_Loc_code",extPermLoc_code);
			tabdata.put("ext_Loc_desc",extPermLoc_desc);
			...
			String extPermLoc_desc=checkForNull(req.getParameter("extPermLoc_desc"),req.getParameter("extPermLoc_desc1") );
			String eff_status = checkForNull(req.getParameter("eff_status"),"D");
			tabdata.put("ext_Loc_desc",extPermLoc_desc);
			tabdata.put("eff_status",eff_status);
			tabdata.put("modified_by_id",login_user);
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String extPermLoc_code=checkForNull(req.getParameter("extPermLoc_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		//condflds.put("extPermLoc_code",extPermLoc_code);
		condflds.put("ext_Loc_code",extPermLoc_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
