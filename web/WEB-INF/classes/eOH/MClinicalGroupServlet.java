...
public class MClinicalGroupServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	String table_name="OH_CLINICAL_GROUP";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			...
			String clinical_group_desc=checkForNull(req.getParameter("clinical_group_desc"));
			String eff_status = checkForNull(req.getParameter("eff_status"),"D");
			tabdata.put("clinical_group_code",clinical_group_code);
			tabdata.put("clinical_group_desc",clinical_group_desc);
			...
			String clinical_group_desc=checkForNull(req.getParameter("clinical_group_desc"),req.getParameter("clinical_group_desc1") );
			String eff_status = checkForNull(req.getParameter("eff_status"),"D");
			tabdata.put("clinical_group_desc",clinical_group_desc);
			tabdata.put("eff_status",eff_status);
			tabdata.put("modified_by_id",login_user);
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"clinical_group_code"};
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String clinical_group_code=checkForNull(req.getParameter("clinical_group_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("clinical_group_code",clinical_group_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
