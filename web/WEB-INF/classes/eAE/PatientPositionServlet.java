...
public class PatientPositionServlet extends HttpServlet implements SingleThreadModel{
	PrintWriter out;
	String facilityId;
	HttpSession session;
	Properties p;
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		try	{
			...
			if(mode.equalsIgnoreCase("INSERT"))
			     insertPatientPosition(req,res);
            else 
			     modifyPatientPosition(req,res);
 ...
 private void  insertPatientPosition(HttpServletRequest req, HttpServletResponse res){
  try{
		...
		tabdata.put("PAT_POSITION_CODE",req.getParameter("pat_position_code")==null?"":req.getParameter("pat_position_code"));
		...
		tabdata.put("MODIFIED_AT_WS_NO",modifiedAtWorkstation );
   		...
   		String dupflds[]={"PAT_POSITION_CODE"};
		try{
			boolean local_ejbs = false;
			String tablename ="AE_PAT_POSITION";
 ...
 private void  modifyPatientPosition(HttpServletRequest req, HttpServletResponse res){
  try{
		...
		java.util.HashMap condflds=new HashMap();
				condflds.put("PAT_POSITION_CODE",req.getParameter("pat_position_code")==null?"":req.getParameter("pat_position_code"));
