...
public class ProtectiveDeviceServlet extends HttpServlet implements SingleThreadModel{
	PrintWriter out;
	String facilityId;
	HttpSession session;
	Properties p;
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		try	{
			...
			if(mode.equalsIgnoreCase("INSERT"))
			     insertProtectiveDevice(req,res);
            else 
			     modifyProtectiveDevice(req,res);
 ...
 private void  insertProtectiveDevice(HttpServletRequest req, HttpServletResponse res){
  try{
		...
		tabdata.put("PROTECTIVE_DEVICE_CODE",req.getParameter("protective_device_code")==null?"":req.getParameter("protective_device_code"));
...
req.getParameter("short_desc")==null?"":req.getParameter("short_desc"));
		...
		tabdata.put("MODIFIED_AT_WS_NO",modifiedAtWorkstation );
   		...
   		String dupflds[]={"PROTECTIVE_DEVICE_CODE"};
		try{
			boolean local_ejbs = false;
			String tablename ="AE_PROTECTIVE_DEVICE";
 ...
 private void  modifyProtectiveDevice(HttpServletRequest req, HttpServletResponse res){
  try{
...
req.getParameter("short_desc")==null?"":req.getParameter("short_desc"));
		...
		condflds.put("PROTECTIVE_DEVICE_CODE",req.getParameter("protective_device_code")==null?"":req.getParameter("protective_device_code"));
