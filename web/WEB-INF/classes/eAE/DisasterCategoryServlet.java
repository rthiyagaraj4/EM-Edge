...
public class DisasterCategoryServlet extends HttpServlet	
{
PrintWriter out;
java.util.Properties p;

String disaster_catg_code;
String longDesc ;
String shortDesc ;
...
private void modifyPatientSuspension(HttpServletRequest req, HttpServletResponse res)	{
	try {
	disaster_catg_code=req.getParameter("disaster_catg_code");
...
String modifiedAtWorkstation = addedAtWorkstation ;
			...
			tabdata.put("disaster_category_code",disaster_catg_code);
			...
			condflds.put("disaster_category_code",disaster_catg_code);
			...
			argArray[1] = tabdata;
			argArray[2] = condflds;
			argArray[3] = "ae_disaster_category";
...
String modifiedAtWorkstation = addedAtWorkstation ;
			...
			String dupflds[]={"disaster_category_code"};
