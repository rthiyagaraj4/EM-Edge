...
public class PractforTreatmentAreaServlet extends HttpServlet implements SingleThreadModel{
	PrintWriter out;
	String facilityId;
	HttpSession session;
	Properties p;
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		try	{
			...
			if(mode.equalsIgnoreCase("INSERT"))
			     insertPractTreatmentArea(req,res);
            else if(mode.equalsIgnoreCase("modify"))
			     modifyPractTreatmentArea(req,res);
			else 
				deletePractTreatmentArea(req,res);
 ...
 private void  insertPractTreatmentArea(HttpServletRequest req, HttpServletResponse res){
  try{
		...
		java.util.HashMap tabdata=new HashMap();
				...
				tabdata.put("PRACTITIONER_ID",req.getParameter("practitioner_id_val")==null?"":req.getParameter("practitioner_id_val"));
   			...
   			String dupflds[]={"CLINIC_CODE","TREATMENT_AREA_CODE","PRACTITIONER_ID","FACILITY_ID"};
		try{
			boolean local_ejbs = false;
			String tablename ="AE_PRACT_FOR_TMT_AREA";
 ...
 private void  modifyPractTreatmentArea(HttpServletRequest req, HttpServletResponse res){
  try{
		...
		java.util.HashMap tabdata=new HashMap();
			...
			java.util.HashMap condflds=new HashMap();
				...
				condflds.put("PRACTITIONER_ID",req.getParameter("practitioner_id_val")==null?"":req.getParameter("practitioner_id_val"));
		...
		try{
		   ...
		   results.clear();
			...
			{
			 // out.println("From Servlet--Calling EJB:"+e.toString());
			  e.printStackTrace();
			  String error = "Error ";
			  String error_value = "0" ;
			  res.sendRedirect("../eCommon/jsp/MstCodeError.jsp?err_num=" + java.net.URLEncoder.encode( error, "UTF-8"  ) + "&err_value=" + error_value );                  
  ...
  private void  deletePractTreatmentArea(HttpServletRequest req, HttpServletResponse res){
  try{
