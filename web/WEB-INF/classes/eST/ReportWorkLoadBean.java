...
public class ReportWorkLoadBean extends StAdapter
...
public String getRepackGroup(){
	...
	arr_lang.add(getLanguageId());
		return getListOptionTag(getListOptionArrayList(eST.Common.StRepository.getStKeyValue("SQL_ST_ITEM_REPACKING_UNIT_SELECT_LIST"),arr_lang));
