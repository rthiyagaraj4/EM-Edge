...
public class RequestStatusDetailBean implements Serializable {
	private int srl_no;
	...
	public RequestStatusDetailBean() {
	}

	public RequestStatusDetailBean(java.sql.ResultSet resultSetRecord) {
	...
	public String toString() {
		return srl_no+" = "+item_code + " = " +item_desc + " = " + required_qty+ " = " + issued_qty + " = " + pending_item_qty;
	}
}
