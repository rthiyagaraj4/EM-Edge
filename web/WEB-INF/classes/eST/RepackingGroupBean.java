...
public class RepackingGroupBean extends StMultipleInsertMasterBean
...
//	private String code[];
    ...
    public RepackingGroupBean()
    {
        ...
        super.InsertSQL = StRepository.getStKeyValue("SQL_ST_REPACKING_GROUP_INSERT");
        super.ModifySQL = StRepository.getStKeyValue("SQL_ST_REPACKING_GROUP_SELECT_SINGLE");

        super.UpdateSQL = StRepository.getStKeyValue("SQL_ST_REPACKING_GROUP_UPDATE");
        super.SelectSQL = StRepository.getStKeyValue("SQL_ST_REPACKING_GROUP_COUNT");
        super.codeFieldName = "repacking_group_code";
		SelectBatchSQL = StRepository.getStKeyValue("SQL_ST_REPACKING_GROUP_SELECT_BATCH_ID"); 
		UpdateBatchSQL=StRepository.getStKeyValue("SQL_ST_REPACKING_GROUP_UPDATE_BATCH");
