...
public class ItemLabelBean extends StTransaction
...
*/
	...
	public String getStore_code_List(){
		ArrayList alParameters=new  ArrayList();//Added for NMC-JD-CRF-0208
		alParameters.add(getLoginFacilityId());//Added for NMC-JD-CRF-0208
		alParameters.add(getLanguageId());//Added for NMC-JD-CRF-0208
