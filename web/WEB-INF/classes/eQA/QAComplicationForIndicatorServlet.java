...
public class QAComplicationForIndicatorServlet extends HttpServlet implements SingleThreadModel{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		try	{
			...
			indicator_code			    = req.getParameter("indicator_code")==null?"":req.getParameter("indicator_code"); 
			complication_code		    = req.getParameter("complication_code")==null?"":req.getParameter("complication_code"); 
			complication_desc		    = req.getParameter("complication_desc")==null?"":req.getParameter("complication_desc"); 
			mode 						= req.getParameter("mode")==null?"I":req.getParameter("mode");
 ...
 private void  insertParameter(HttpServletResponse res){
  try{
		...
		HashMap tabdata=new HashMap();
			...
			tabdata.put("QIND_CLIND_ID",indicator_code);
			tabdata.put("COMPL_CODE",complication_code);
			tabdata.put("COMPL_DESCRIPTION",complication_desc);
			...
			String dupflds[]={"QIND_CLIND_ID","COMPL_CODE" };
		try{
				...
				//final java.util.Hashtable results = singleTabHandlerManagerRemote.insert(p,tabdata,dupflds,"QA_QIND_CLIND_COMPL");
				String tabname="QA_QIND_CLIND_COMPL";
 ...
 private void  modifyParameter(HttpServletResponse res){
  try{
		...
		HashMap tabdata=new HashMap();
			...
			condflds.put("QIND_CLIND_ID",indicator_code);
			condflds.put("COMPL_CODE",complication_code);
		try{
			//InitialContext context = new InitialContext();
			//Object homeObject = context.lookup("java:comp/env/SingleTabHandler");
			//final SingleTabHandlerManagerHome singleTabHandlerManagerHome  = (SingleTabHandlerManagerHome) PortableRemoteObject.narrow(homeObject ,SingleTabHandlerManagerHome.class);
			//final SingleTabHandlerManagerRemote singleTabHandlerManagerRemote = singleTabHandlerManagerHome.create();
			//final java.util.Hashtable results = singleTabHandlerManagerRemote.update(p,tabdata,condflds,"QA_QIND_CLIND_COMPL");
