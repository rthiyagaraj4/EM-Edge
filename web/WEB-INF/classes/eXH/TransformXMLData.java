...
public class TransformXMLData {	
    ...
    public static String getTransformData(String xmlDataStr, String xslStr) {		
		...
		if (isDebugYN)	
			System.out.println(" TransformXMLData xmlDataStr ::: "+xmlDataStr);

		if (isDebugYN)	
			System.out.println(" TransformXMLData xslStr ::: "+xslStr);
		...
		if (isDebugYN)	
			System.out.println(" TransformXMLData responseString ::: "+responseString);
