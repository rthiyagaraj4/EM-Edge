...
public class XHApplicationDerivationElementsBean 
{ 
...
/**
   ...
   */  
   public XHApplicationDerivationElementsBean(String code,String desc,String validationType,String inuse,String condition,String expectedValue,String execOrder,String expectedValue2,String position,String Application_id,String Profile )
   {
...
//System.out.println(this.elementCode+","+this.elementDesc+","+this.inuseYN+","+this.validationType+","+this.expectedValue+","+this.execOrder+","+this.condition+","+this.expectedValue2+","+this.position+"this.application_id"+this.application_id+"end");    
    arrList.add(this.elementCode);
...
//System.out.println(this.elementCode+","+this.elementDesc+","+this.inuseYN+","+this.validationType+","+this.expectedValue+","+this.execOrder+","+this.condition+","+this.expectedValue2+","+this.position+"this.application_id"+this.application_id+"end");
   ...
   return(new String[]{"",this.elementCode,this.elementDesc,this.inuseYN, this.validationType,this.expectedValue,this.execOrder,this.condition,this.expectedValue2,this.position,this.application_id,this.profile});
  }
 /**
