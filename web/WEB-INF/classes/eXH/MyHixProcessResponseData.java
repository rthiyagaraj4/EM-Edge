...
public class MyHixProcessResponseData {
    ...
    public static StringBuffer prcoessData(StringBuffer xmlData){

		String xmlDataStr = "";

		//xmlDataStr = xmlData.toString(); // For Dynamic 
		//StringBuffer strBuffer = new StringBuffer(xmlDataStr); // Dynamic coding


		// This is for hardcoded testing
		// Discharge Summary
		...
		// Referral XML Data -- Harcoded value show
		...
		summaryHtmlData = getXMLData(strBuffer);
		return summaryHtmlData;
    }

	public static StringBuffer getXMLData(StringBuffer xmlData) {
	    ...
	    is.setCharacterStream(new StringReader(xmlData.toString()));    
