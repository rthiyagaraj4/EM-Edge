...
public class XHApplicationDerivationProfileSetupControllerBean implements java.io.Serializable
{
...
/**
   ...
   */  public String[][] getDatabaseData()
  {
    ...
    XHApplicationDerivationProfileSetupElementsBean xhBean = null;
...
/**
   ...
   */   
  public XHApplicationDerivationProfileSetupElementsBean getCodeDesc(String key)
  {
    return((XHApplicationDerivationProfileSetupElementsBean)treemp.get(key));
  }
/**
...
/**
  ...
  public void getAllParameterValues(HttpServletRequest request,Connection conn)
  {
    ...
    XHApplicationDerivationProfileSetupElementsBean xhCode = null;
	try{
...
/**
 ...
 public static XHApplicationDerivationProfileSetupControllerBean getBean(String strBeanName,
														  HttpServletRequest request,
														  HttpSession session)
 {
     String action  = XHDBAdapter.checkNullZero(request.getParameter("action_type"));
     XHApplicationDerivationProfileSetupControllerBean xhBean = null;
     if(action.equals("S")||action.equals("0"))
     {
      session.removeAttribute(strBeanName); 
  xhBean = new XHApplicationDerivationProfileSetupControllerBean();
      session.setAttribute(strBeanName,xhBean); 
    }
    else
    {
      xhBean = (XHApplicationDerivationProfileSetupControllerBean) session.getAttribute(strBeanName);
    }
    return(xhBean);
 }
...
PreparedStatement pstmt = null;
    ...
    { 
      ...
      while(rset.next())
      {
        treemp.put(rset.getString(1)+rset.getString(3),new XHApplicationDerivationProfileSetupElementsBean(
    ...
    {
       System.out.println("Error in populatexhcodedesc method of XHApplicationDerivationProfileSetupControllerBean :"+exp.toString());
	   exp.printStackTrace(System.err);
    }
  }
