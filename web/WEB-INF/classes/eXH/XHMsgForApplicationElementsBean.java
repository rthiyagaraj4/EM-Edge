...
public class XHMsgForApplicationElementsBean 
{ 
...
/**
   ...
   */  
   public XHMsgForApplicationElementsBean(String code,String desc,String standcode,String masttype,String inuse,String dtltype,String standdesc,String msgtype,String status,String fieldchange) 
   {
...
/**
   ...
   public String[] getDatabaseData()
  {
    ...
    return(new String[]{"",this.elementCode,this.elementDesc,this.stndCode,this.Msgtype,this.MastType,this.inuseYN, this.DTLType,this.status,this.stndDesc,this.fieldchange});
  }
 /**
