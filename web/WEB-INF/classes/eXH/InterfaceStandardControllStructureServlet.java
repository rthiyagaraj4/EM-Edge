 ...
 *
 */
public class InterfaceStandardControllStructureServlet extends HttpServlet
{
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response)throws IOException, ServletException 
	{
		...
		String standard_code=XHDBAdapter.checkNull(request.getParameter("segment_type_id"));
		String standard_desc=XHDBAdapter.checkNull(request.getParameter("element_name"));
		String standard_type=XHDBAdapter.checkNull(request.getParameter("element_seq"));
...
//		  System.out.println("standard_code11"+standard_code11);
//		  System.out.println("standard_code"+standard_code);
         ...
         ostmt.setString(4,standard_desc);
