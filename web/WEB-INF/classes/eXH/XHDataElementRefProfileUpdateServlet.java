 ...
 *
 */
public class XHDataElementRefProfileUpdateServlet extends HttpServlet 
{
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
	 ...
	 int columCount=Integer.parseInt(request.getParameter("Num_colu"));
...
//		 System.out.println("values"+Action_type+"applicationid,"+applicationid+"elementid,"+elementid+"derivation_type,"+derivation_type+"cond_exprsn,"+cond_exprsn+"expected_value,"+expected_value+"execution_order,"+execution_order+"position,"+position_value);
