...
public class XHApplicationDerivationSetupElementsBean 
{ 
...
/**
   ...
   */  
   public XHApplicationDerivationSetupElementsBean(String code,String desc,String validationType,String inuse,String condition,String expectedValue,String execOrder,String expectedValue2,String position )
   {
...
//System.out.println(this.elementCode+","+this.elementDesc+","+this.inuseYN+","+this.validationType+","+this.expectedValue+","+this.execOrder+","+this.condition+","+this.expectedValue2+","+this.position+"end");

    return(new String[]{"",this.elementCode,this.elementDesc,this.inuseYN, this.validationType,this.expectedValue,this.execOrder,this.condition,this.expectedValue2,this.position});
  }
 /**
