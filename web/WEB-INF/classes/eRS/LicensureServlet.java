...
public class LicensureServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		license_code=req.getParameter("license_code")==null ? "":req.getParameter("license_code");
		license_desc=req.getParameter("license_desc")==null ? "":req.getParameter("license_desc");
		license_expl_text=req.getParameter("license_expl_text")==null ? "":req.getParameter("license_expl_text");
		eff_status=req.getParameter("eff_status")==null ? "D":req.getParameter("eff_status");
			...
			if ( operation.equals("modify")) modifyOperation( res);
		}catch(Exception e)
		{
			e.printStackTrace();
		}
     ...
     throws Exception
	{
		...
		tabData.put("license_code",license_code);
		tabData.put("license_desc",license_desc);
		tabData.put("license_expl_text",license_expl_text);
		...
		try{
				...
				String table_name="rs_licensure";
				argArray[0] =p;
				argArray[1] =tabData;
				argArray[2] =dupflds;
		...
		throws Exception
	{
		...
		try{
			...
			HashMap condflds=new HashMap();
					condflds.put("license_code",license_code);
