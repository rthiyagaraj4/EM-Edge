...
import java.util.*;
import java.io.*;
public class RequestStatusBean extends eSS.Common.SsTransaction implements Serializable { 
...
*/	}
	...
	public String getReqByStores() {
		...
		alParam.add(getLoginFacilityId());
		alParam.add(getLanguageId());
		return getListOptionTag( getListOptionArrayList(getSsRepositoryValue("SQL_SS_STORE_QUERY_REQ_SELECT_LIST"),alParam));
