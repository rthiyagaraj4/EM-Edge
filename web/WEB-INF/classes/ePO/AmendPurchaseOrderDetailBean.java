...
public class AmendPurchaseOrderDetailBean extends ePO.Common.PoTransaction implements java.io.Serializable { 
...
//	private String stock_item_yn;
	...
	public AmendPurchaseOrderDetailBean() {
	}

	public AmendPurchaseOrderDetailBean(java.util.Hashtable detailRecord) {

		System.out.println("detailRecord in po detail bean = "+detailRecord);
		
				
		this.item_code = (String)detailRecord.get("item_code");
	//	this.item_code = (String)detailRecord.get("itemCode_reqNO");
	...
	public AmendPurchaseOrderDetailBean(java.util.HashMap detailRecord) {
	...
	public AmendPurchaseOrderDetailBean(java.sql.ResultSet resultSetRecord) {
		try {
