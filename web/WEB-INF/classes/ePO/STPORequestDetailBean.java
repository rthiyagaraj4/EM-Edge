...
public class STPORequestDetailBean extends ePO.Common.PoTransaction implements java.io.Serializable { 
...
//	private String stock_item_yn;
	...
	public STPORequestDetailBean() {
	}

	public STPORequestDetailBean(java.util.Hashtable detailRecord) {
	/**
	* @Name - krishna
	* @Date - 22/01/2010
	* @Inc# - IN015496
	...
	*/
		...
		if(getAllowDecimalsYN((String)detailRecord.get("item_code")).equals("Y")){
			this.required_qty = setNumber((String)detailRecord.get("required_qty"),no_of_decimals);//base uom  qty
		...
		this.required_by_date = (String)detailRecord.get("required_by_date");
		this.remarks = (String)detailRecord.get("remarks");

	}

	public STPORequestDetailBean(java.sql.ResultSet resultSetRecord) {
		try {
	...
	*/
			...
			setRequired_qty(setNumber((String)resultSetRecord.getString("REQ_GEN_UOM_QTY"),Integer.parseInt((String)resultSetRecord.getString("no_of_decimals"))));//REQ_QTY
			setReqUomQty(setNumber((String)resultSetRecord.getString("req_qty"),Integer.parseInt((String)resultSetRecord.getString("no_of_decimals")))); //REQ_GEN_UOM_QTY
			...
			//commented by Rabbani on 28/09/12 #inc no:35347
			...
			String conver=(String)stEqvl_value1.get("EQVL_VALUE")+" "+resultSetRecord.getString("gen_uom_desc")+" = "+(String)stEqvl_value1.get("EQVL_UOM_QTY")+" "+resultSetRecord.getString("req_uom_desc");
			...
			String conver=stEqvl_value+" "+resultSetRecord.getString("gen_uom_desc")+" = 1 "+resultSetRecord.getString("req_uom_desc");
			...
			String conver="1 "+resultSetRecord.getString("gen_uom_desc")+" = 1 "+resultSetRecord.getString("req_uom_desc");
			setPur_uom_conv_id( conver);
			}
			
			setRequired_by_date(resultSetRecord.getString("REQD_BY_DATE"));
			setRemarks(resultSetRecord.getString("REQ_ITEM_REMARKS"));
...
//	}
 ...
 public void setCheck_box_status(String check_box_status ){
	...
	*/
		...
		setRequired_by_date((String)detailRecord.get("required_by_date"));
		setRemarks((String)detailRecord.get("remarks"));
	}
