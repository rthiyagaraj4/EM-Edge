   ...
   public static Map<String,String> getFacilityMap(String locale) throws Exception
	{
		...
		return RDHelper.getCodeDescMap(FACILITY_SQL, null, FACILITY_WHERE, "", " ORDER BY FACILITY_NAME");
	}
	...
	public static Map<String,String> getPatientClassMap(String locale) throws Exception
	{
		...
		return RDHelper.getCodeDescMap(PATIENT_CLASS_SQL, null, PATIENT_CLASS_WHERE, "", " ORDER BY SHORT_DESC");
	}
	...
	public static Map<String,String> getOptionMap(String locale) throws Exception
	{
		...
		return RDHelper.getCodeDescMap(OPTION_SQL, null, OPTION_WHERE, "", " ORDER BY A.LIST_SRL_NO");
	}
	...
	public static Map<String,String> getPaymentBasisIndMap(String locale) throws Exception
	{
		...
		return RDHelper.getCodeDescMap(PAYMENT_BASIS_IND_SQL, null, PAYMENT_BASIS_IND_WHERE, "", " ORDER BY A.LIST_SRL_NO");
	}
