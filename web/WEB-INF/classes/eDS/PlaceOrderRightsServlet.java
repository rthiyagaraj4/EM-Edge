...
//New file PlaceOrderRightsServlet.java created against ML-MMOH-CRF-0677
package eDS;
...
public class PlaceOrderRightsServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String table_name="DS_PLACE_DIET_ORDER_RIGHTS";
...
/* populateTabData Method for Insert and Modify */
private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res) {
	...
	if("insert".equals(mode)){
		...
		String edit_meals_yn=checkForNull(req.getParameter("edit_meals_yn"),"N");
		String nutrient_supplement_yn=checkForNull(req.getParameter("nutrient_supplement_yn"),"N");
		String food_dislike_yn=checkForNull(req.getParameter("food_dislike_yn"),"N");
		String special_food_order_yn=checkForNull(req.getParameter("special_food_order_yn"),"N");
	
		tabdata.put("appl_user_id",appl_user_id);
		tabdata.put("operating_facility_id",facility_id);
		tabdata.put("edit_meals_yn",edit_meals_yn);
		tabdata.put("nutrient_supplement_yn",nutrient_supplement_yn);
		tabdata.put("food_dislike_yn",food_dislike_yn);
		tabdata.put("special_food_order_yn",special_food_order_yn);
