...
public class OperationTypesServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String table_name="OT_OPER_TYPE";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String oper_type=checkForNull(req.getParameter("oper_type"));
			...
			tabdata.put("oper_type",oper_type);
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String oper_type=checkForNull(req.getParameter("oper_type1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("oper_type",oper_type);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
