...
public class ProsthesisCategoryServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	String table_name="OT_PROSTHESIS_CATEGORY";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			...
			String prosthesis_cat_desc=checkForNull(req.getParameter("prosthesis_cat_desc"));
			String status = checkForNull(req.getParameter("status"),"D");
			tabdata.put("prosthesis_cat_code",prosthesis_cat_code);
			tabdata.put("prosthesis_cat_desc",prosthesis_cat_desc);
			...
			String prosthesis_cat_desc=checkForNull(req.getParameter("prosthesis_cat_desc"),req.getParameter("prosthesis_cat_desc1") );
			String status = checkForNull(req.getParameter("status"),"D");
			tabdata.put("prosthesis_cat_desc",prosthesis_cat_desc);
			tabdata.put("status",status);
			tabdata.put("modified_by_id",login_user);
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"prosthesis_cat_code"};
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String prosthesis_cat_code=checkForNull(req.getParameter("prosthesis_cat_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("prosthesis_cat_code",prosthesis_cat_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
