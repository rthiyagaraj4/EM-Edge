...
public class StatusDescriptionsServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		String status_desc=checkForNull(req.getParameter("status_desc"),checkForNull(req.getParameter("status_desc1")));
		String color_ind=checkForNull(req.getParameter("color_ind"),checkForNull(req.getParameter("color_ind1")));
		String text_color=checkForNull(req.getParameter("text_color"),checkForNull(req.getParameter("text_color1")));
		tabdata.put("status_desc",status_desc);
		tabdata.put("color_ind",color_ind);
		tabdata.put("text_color",text_color);
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String status_code=checkForNull(req.getParameter("status_code1"));
		String status_desc_sysdef=checkForNull(req.getParameter("status_desc_sysdef"),checkForNull(req.getParameter("status_desc_sysdef1")));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("status_code",status_code);
		condflds.put("status_desc_sysdef",status_desc_sysdef);
