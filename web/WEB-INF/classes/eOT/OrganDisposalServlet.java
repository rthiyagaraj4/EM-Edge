...
public class OrganDisposalServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale=""; 
	String table_name="OT_ORGAN_DISPOSAL";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String disposal_code=checkForNull(req.getParameter("disposal_code"));
			String disposal_desc=checkForNull(req.getParameter("disposal_desc"));
			String status = checkForNull(req.getParameter("status"),"D");
			tabdata.put("disposal_code",disposal_code);
			tabdata.put("disposal_desc",disposal_desc);
			...
			String disposal_desc=checkForNull(req.getParameter("disposal_desc"),checkForNull(req.getParameter("disposal_desc1")));
			String status = checkForNull(req.getParameter("status"),"D");
			tabdata.put("disposal_desc",disposal_desc);
			tabdata.put("status",status);
			tabdata.put("modified_by_id",login_user);
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String disposal_code=checkForNull(req.getParameter("disposal_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("disposal_code",disposal_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
