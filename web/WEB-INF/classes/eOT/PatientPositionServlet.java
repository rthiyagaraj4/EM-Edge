...
public class PatientPositionServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String position_code=checkForNull(req.getParameter("position_code"));
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String position_code=checkForNull(req.getParameter("position_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("position_code",position_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
