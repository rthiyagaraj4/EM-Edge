...
public class StaffAssignmentBean extends OTAdapter implements Serializable 
{
	public int NO_OF_PATIENTS = 5;
	public int totalPatients = 0;
	public int lisIterCount = 0;
	public int roomCountPagination = 0;
	public int staffCountRoom = 0;
	...
	public void populateInformation(int patientCount)
	{
		...
		this.staffCountRoom = patientCount;
