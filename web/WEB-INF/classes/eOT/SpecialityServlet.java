...
public class SpecialityServlet extends javax.servlet.http.HttpServlet
{
	...
	String login_user="";
	String locale="";
	String table_name="OT_OPER_CATEGORY";
	HttpSession session;
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			...
			String oper_cat_code=checkForNull(req.getParameter("category"));
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		...
		condflds.put("oper_group_code",checkForNull(req.getParameter("oper_group_code1")));
        condflds.put("oper_cat_code",checkForNull(req.getParameter("oper_cat_code1")));
	...
	{
		HashMap tabData = populateTabData(req,res);
		String dupflds[]={"oper_group_code","oper_cat_code"};
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = dupflds;
