...
public class ProsthesisTypeServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	String table_name="OT_PROSTHESIS_TYPE";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String prosthesis_type=checkForNull(req.getParameter("prosthesis_type"));
			String prosthesis_type_desc=checkForNull(req.getParameter("prosthesis_type_desc"));
			String status = checkForNull(req.getParameter("status"),"D");
			tabdata.put("prosthesis_type",prosthesis_type);
			tabdata.put("prosthesis_type_desc",prosthesis_type_desc);
			...
			String prosthesis_type_desc=checkForNull(req.getParameter("prosthesis_type_desc"),req.getParameter("prosthesis_type_desc1") );
			String status = checkForNull(req.getParameter("status"),"D");
			tabdata.put("prosthesis_type_desc",prosthesis_type_desc);
			tabdata.put("status",status);
			tabdata.put("modified_by_id",login_user);
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"prosthesis_type"};
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String prosthesis_type=checkForNull(req.getParameter("prosthesis_type1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("prosthesis_type",prosthesis_type);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
