...
public class FunctionStatusServlet extends javax.servlet.http.HttpServlet {
	...
	throws javax.servlet.ServletException,IOException{
		...
		String status_code = CommonBean.checkForNull(req.getParameter("status_code"));
		PrintWriter out;
...
//		String modified_date="";
		...
		try{
				...
				String select_value = "";
				String msg="";
                String sqlDelete="DELETE FROM OT_FUNCT_APPL_FOR_STATUS WHERE STATUS_CODE=? AND FUNCTION_ID=?";
				String sqlInsert="INSERT INTO OT_FUNCT_APPL_FOR_STATUS (STATUS_CODE,FUNCTION_ID,ADDED_BY_ID,ADDED_DATE,ADDED_AT_WS_NO,ADDED_FACILITY_ID,MODIFIED_BY_ID,MODIFIED_DATE,MODIFIED_AT_WS_NO,MODIFIED_FACILITY_ID) VALUES (?,?,?,SYSDATE,?,?,?,SYSDATE,?,?)";
				...
				if(tabData!=null && tabData.size()>0){
					...
					if(select_value.equals("N")){
						// pstmt = pstmt1;
					     pstmt1.setString(1,status_code);
						...
						//pstmt=pstmt2;
						pstmt2.setString(1,status_code);
