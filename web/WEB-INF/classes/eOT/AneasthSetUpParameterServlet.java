...
public class AneasthSetUpParameterServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
...
//		String locale = p.getProperty("LOCALE") ;
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String pre_anes_note_type=checkForNull(req.getParameter("pre_anes_note_type"));
			String intra_anes_note_type=checkForNull(req.getParameter("intra_anes_note_type"));
			String post_anes_note_type=checkForNull(req.getParameter("post_anes_note_type"));
			String intra_anaesthesia_chart_id=checkForNull(req.getParameter("intra_anaesthesia_chart_id"));
			String post_anaesthesia_chart_id=checkForNull(req.getParameter("post_anaesthesia_chart_id"));
			tabdata.put("pre_anes_note_type",pre_anes_note_type);
			tabdata.put("intra_anes_note_type",intra_anes_note_type);
			tabdata.put("post_anes_note_type",post_anes_note_type);
			tabdata.put("intra_anaesthesia_chart_id",intra_anaesthesia_chart_id);
			tabdata.put("post_anaesthesia_chart_id",post_anaesthesia_chart_id);
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"pre_anes_note_type"};
