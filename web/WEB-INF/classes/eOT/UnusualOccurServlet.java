...
public class UnusualOccurServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String table_name="OT_UNUSUAL_OCCUR_CODE";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String unusual_occur_code=checkForNull(req.getParameter("unusual_occur_code"));
			...
			String print_yn = checkForNull(req.getParameter("print_yn"),"N");
			tabdata.put("unusual_occur_code",unusual_occur_code);
			tabdata.put("long_desc",long_desc);
			tabdata.put("short_desc",short_desc);
			tabdata.put("print_yn",print_yn);
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"unusual_occur_code"};
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String unusual_occur_code=checkForNull(req.getParameter("unusual_occur_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("unusual_occur_code",unusual_occur_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
