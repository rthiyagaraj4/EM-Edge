 ...
 *  
 */
package eIPAD.DiaryView.bc;

import eIPAD.DiaryView.dao.DiaryViewDAO;
import eIPAD.DiaryView.daoimpl.DiaryViewDAOImpl;
...
public class DiaryViewBC {
	public DiaryViewResponse getDiaryViewDetails (DiaryViewRequest diaryViewRequest){
		...
		DiaryViewDAO dao = new DiaryViewDAOImpl();
		diaryViewResponse = dao.getDiaryViewDetails(diaryViewRequest);
	...
	/*public OTProcDetailResponse getProcDetails (String bookingNo, String facilityID, String locale){
		...
		DiaryViewDAO dao = new DiaryViewDAOImpl();
		procDetailResponse = dao.getProcDetails(bookingNo, facilityID,locale);
