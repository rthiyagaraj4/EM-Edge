...
import eMR.TerminologySetforSpecialty.*;

public class TerminologySetForSpecialtyServlet extends javax.servlet.http.HttpServlet implements SingleThreadModel
{
	PrintWriter out;
 ...
 private void SpecialityAddModify(HttpServletRequest req, HttpServletResponse res)
 {
	try
	{
		...
		for(int i=0;i< TerminologyForSpecialty.getSize();i++)
		{
			tabdata.put( ("chk"+i), (String)TerminologyForSpecialty.getObject(i) );
		}
		String slCount	=	""+TerminologyForSpecialty.getSize();
		...
		Object home = com.ehis.eslp.ServiceLocator.getInstance().getHome("java:comp/env/TerminologySetforSpecialty",TerminologySetforSpecialtyHome.class,local_ejbs);
