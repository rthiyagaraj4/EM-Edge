...
public class RhesusFactorServlet extends javax.servlet.http.HttpServlet
{
	PrintWriter out;
	Properties p;
	String rhesusfactor;
	...
	public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		{			
			...
			if ( operation.equals("insert") )   insertRhesusFactor(req, res);
			if ( operation.equals("modify"))    modifyRhesusFactor(req, res);
		}
		catch(Exception e)
		{
	...
	private void modifyRhesusFactor(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			rhesusfactor =req.getParameter("rhesus_factor_code");
			...
			condflds.put("rhesus_factor_code",rhesusfactor);
						
			String tableName = "MR_RHESUS_FACTOR";
		...
		catch ( Exception e )
		{
			...
			out.println( rhesusfactor + " "+longDesc + " "+shortDesc + " "+ effectiveStatus ); */
			
			e.printStackTrace();
		}
	}

	private void insertRhesusFactor(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			rhesusfactor =req.getParameter("rhesus_factor_code");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("rhesus_factor_code",rhesusfactor);
			tabdata.put("long_desc",longDesc);
			tabdata.put("short_desc",shortDesc);
			tabdata.put("eff_status",effectiveStatus);
			tabdata.put("added_by_id",addedById);
			...
			String dupflds[]={"rhesus_factor_code"};
