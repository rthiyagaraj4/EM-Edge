 ...
 ******************************************************************************/
/***** Last Modified Date 9/22/2005 11:14 AM *******/
package eMP;
...
public class DeliveryIndicationServlet extends javax.servlet.http.HttpServlet
{
	PrintWriter out;
	java.util.Properties p;

	String deliveryindicationcode;
	String longDesc ;
	String shortDesc ;
        ...
        throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if ( operation.equals("insert") )
				insertDeliveryIndication(req, res);
			if ( operation.equals("modify"))
				modifyDeliveryIndication(req, res);
		}
		catch (Exception e)
		{
	...
	private void modifyDeliveryIndication(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			deliveryindicationcode			= req.getParameter("dely_ind_code");
			...
			condflds.put("dely_ind_code",deliveryindicationcode);
			...
			argArray[1] = tabdata;
			argArray[2] = condflds;
			argArray[3] = "MP_DELIVERY_INDICATION";
	...
	private void insertDeliveryIndication(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			deliveryindicationcode		  = req.getParameter("dely_ind_code");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("dely_ind_code",deliveryindicationcode);
			tabdata.put("long_desc",longDesc);
			tabdata.put("short_desc",shortDesc);
			tabdata.put("eff_status",effectiveStatus);
