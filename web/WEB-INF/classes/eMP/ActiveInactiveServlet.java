...
public class ActiveInactiveServlet extends javax.servlet.http.HttpServlet	
{
        ...
        throws javax.servlet.ServletException,IOException
	{
	 	...
	 	try
		{
			...
			if(operation.equals("insert")) insertActiveInactive(req, res);
			if(operation.equals("modify")) modifyActiveInactive(req, res);
		}
		catch (Exception e)	
		{
	...
	private void modifyActiveInactive(HttpServletRequest req, HttpServletResponse res)	
	{
		try
		{
			...
			reason_for_active_yn = req.getParameter("reason_for_active_yn")==null?"N":req.getParameter("reason_for_active_yn");
			...
			tabdata.put("reason_for_active_yn",reason_for_active_yn);
			...
			argArray[1] = tabdata;
			argArray[2] = condflds;
			argArray[3] = "MP_PAT_INACTIVATE_REASON";
		...
		catch(Exception e) 
		{
			...
			out.println( reasonCode + " "+longDesc + " "+shortDesc +" "+ effectiveDateFrom+" "+ effectiveDateTo + " "+ effectiveStatus ); */
			e.printStackTrace();
		}
	}

	private void insertActiveInactive(HttpServletRequest req, HttpServletResponse res)	
	{
		try 
		{
			reasonCode = req.getParameter("reason_code");
