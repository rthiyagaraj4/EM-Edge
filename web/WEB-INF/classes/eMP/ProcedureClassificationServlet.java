 ...
 ******************************************************************************/
/****** Last Modified Date Time 9/22/2005 11:56 AM ******/
package eMP;
...
public class ProcedureClassificationServlet extends javax.servlet.http.HttpServlet
{
	PrintWriter out;
	java.util.Properties p;

	String procclasscode;
	String longDesc ;
	String shortDesc ;
	...
	HttpSession session=null;
		...
		try
		{
			...
			if ( operation.equals("insert") )
				insertProcedureClassification(req, res);
			if ( operation.equals("modify"))
				modifyProcedureClassification(req, res);
		}
		catch (Exception e)
		{
	...
	private void modifyProcedureClassification(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			procclasscode	= req.getParameter("proc_class_code");
			...
			condflds.put("proc_class_code",procclasscode);
			...
			argArray[1] = tabdata;
			argArray[2] = condflds;
			argArray[3] = "MP_proc_classification";
	...
	private void insertProcedureClassification(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			procclasscode		  = req.getParameter("proc_class_code");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("proc_class_code",procclasscode);
			tabdata.put("long_desc",longDesc);
			...
			String dupflds[]={"proc_class_code"};
