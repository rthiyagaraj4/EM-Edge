 ...
 ******************************************************************************/
/***** Last Modified Date 9/22/2005 11:15 AM *******/
package eMP;
...
public class DeliverySurgicalClassificationServlet extends javax.servlet.http.HttpServlet	
{
	PrintWriter out;
	java.util.Properties p;
	
	String DelySurgClassCode;
	String longDesc ;
	String shortDesc ;
        ...
        throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if ( operation.equals("insert") )
				insertDeliverySurgicalClassification(req, res);
			if ( operation.equals("modify"))
				modifyDeliverySurgicalClassification(req, res);
		}
		catch (Exception e)
		{
	...
	private void modifyDeliverySurgicalClassification(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			DelySurgClassCode	= req.getParameter("Dely_Surg_Class_Code");
			...
			condflds.put("Dely_Surg_Class_Code",DelySurgClassCode);
			...
			argArray[1] = tabdata;
			argArray[2] = condflds;
			argArray[3] = "MP_Dely_Surg_Classification";
	...
	private void insertDeliverySurgicalClassification(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			DelySurgClassCode		  = req.getParameter("Dely_Surg_Class_Code");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("Dely_Surg_Class_Code",DelySurgClassCode);
			tabdata.put("long_desc",longDesc);
			tabdata.put("short_desc",shortDesc);
			tabdata.put("eff_status",effectiveStatus);
			...
			String dupflds[]={"Dely_Surg_Class_Code"};
