...
public class ReligionServlet extends javax.servlet.http.HttpServlet	
{
	PrintWriter out;
        ...
        throws javax.servlet.ServletException,IOException
	{
		...
		try 
		{
			...
			if ( operation.equals("insert") )
				insertReligion(req, res);
			if ( operation.equals("modify"))
				modifyReligion(req, res);
		}
		catch (Exception e)	
		{
			// out.println(e.toString());
			e.printStackTrace(); // Added by lakshmanan for security issue ID 174035632 on 04-09-2023
		}
	}
	...
	private void modifyReligion(HttpServletRequest req, HttpServletResponse res)	
	{
		try 
		{
			...
			condflds.put("RELGN_CODE",religioncode);
		...
		catch ( Exception e ) 
		{
			...
			// out.println( religioncode + " "+longDesc + " "+shortDesc +" "+ effectiveDateFrom+" "+ effectiveDateTo + " "+ effectiveStatus );
		}
	}

	private void insertReligion(HttpServletRequest req, HttpServletResponse res)	
	{
		try 
		{
			religioncode	= req.getParameter("relgn_code");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("relgn_code",religioncode);
			tabdata.put("long_desc",longDesc);
			tabdata.put("short_desc",shortDesc);
			tabdata.put("eff_status",effectiveStatus);
