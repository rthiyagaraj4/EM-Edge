...
public class OccupationClassServlet extends javax.servlet.http.HttpServlet	
{
        ...
        throws javax.servlet.ServletException,IOException
	{
  		...
  		try
		{
			...
			if ( operation.equals("insert") )
				insertOccupationClass(req, res);
			if ( operation.equals("modify"))
				modifyOccupationClass(req, res);
		}
		catch (Exception e)
		{
	...
	private void modifyOccupationClass(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			...
			condflds.put("OCPN_CLASS_CODE",occupationClassCode);
			...
			argArray[1] = tabdata;
			argArray[2] = condflds;
			argArray[3] = "MP_OCCUPATION_CLASS";
		...
		catch ( Exception e )
		{
			...
			e.printStackTrace(); // Added by lakshmanan for security issue ID 169527926 on 05-09-2023
		}
	}

	private void insertOccupationClass(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			occupationClassCode = req.getParameter("occupation_class_code");
			...
			String dupflds[]={"ocpn_class_code"};
