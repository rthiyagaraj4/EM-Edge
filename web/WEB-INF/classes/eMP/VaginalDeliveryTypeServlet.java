 ...
 ******************************************************************************/
/****** Last Modified Date Time 9/22/2005 10:23 AM *****/
package eMP;
...
public class VaginalDeliveryTypeServlet extends javax.servlet.http.HttpServlet	
{
	...
	private void modifyProcedureClassification(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			vagdelytype	= req.getParameter("vag_dely_type");
			...
			condflds.put("vag_dely_type",vagdelytype);
			...
			argArray[1] = tabdata;
			argArray[2] = condflds;
			argArray[3] = "MP_VAGINAL_DELY_TYPE";
	...
	private void insertProcedureClassification(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			...
			HashMap tabdata=new HashMap();
			tabdata.put("vag_dely_type",vagdelytype);
			tabdata.put("long_desc",longDesc);
