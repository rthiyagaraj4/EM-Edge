...
public class StdFamilyNameServlet extends javax.servlet.http.HttpServlet implements SingleThreadModel
{
	PrintWriter out;
	java.util.Properties p;

	String last_name;
	String last_name_loc_lang;
	String eff_status;
	String facilityId ;
	...
	public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if ( operation.equals("insert") )  insertStdFamilyName(req, res);
			if ( operation.equals("modify"))  modifyStdFamilyName(req, res);
		}
		catch(Exception e)
		{
	...
	private void insertStdFamilyName(HttpServletRequest req, HttpServletResponse res)
	{
		out.println("<Script language='javascript' src='../../eCommon/js/messages.js'></script>");
		try
		{
			last_name				 =req.getParameter("last_name");
			last_name_loc_lang =req.getParameter("last_in_oth_lang");
			eff_status					=req.getParameter("eff_status");

			if(last_name==null || last_name.equals("null"))last_name="";
			if(last_name_loc_lang==null || last_name_loc_lang.equals("null"))last_name_loc_lang="";
			

			/*if(!(last_name_loc_lang.equals("")))
			{
			...
			try
			{
				if(last_name != null)
				{
						...
						pstmt=con.prepareStatement("Select * from mp_std_family_name where upper(last_name) = upper(?)" );
				   ...
				   if(!rs.next())
				   {
						...
						tabdata.put("last_name",last_name);
						tabdata.put("last_name_loc_lang",last_name_loc_lang);
	...
	private void modifyStdFamilyName(HttpServletRequest req, HttpServletResponse res)
	{
		...
		try
		{
			...
			String modifiedAtWorkstation = addedAtWorkstation ;
				...
				condflds.put("last_name",last_name);
