...
public class LanguageServlet extends javax.servlet.http.HttpServlet	
{
	PrintWriter out;
	Properties p;
    String language_id;
	...
	throws ServletException,IOException 
	{
		...
		try	
		{
			...
			if(operation.equals("insert")) insertLanguage(req, res);
			if(operation.equals("modify")) modifyLanguage(req, res);
		}
		catch(Exception e)
		{
	...
	private void modifyLanguage(HttpServletRequest req, HttpServletResponse res)
	{
		try	
		{
			language_id	= req.getParameter("language_id");
			longName			= req.getParameter("long_desc");
			shortName			= req.getParameter("short_desc");
			dflt_lang			= req.getParameter("dflt_lang")==null?"":req.getParameter("dflt_lang");
			...
			tabdata.put("dflt_lang_online_report",dflt_lang);
			...
			condflds.put("lang_id",language_id);
		...
		catch(Exception e)
		{
			...
			//out.println( " "+longName + " "+shortName +" "+ effectiveStatus );
			e.printStackTrace();
		}
	}

	private void insertLanguage(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			language_id		  = req.getParameter("language_id");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("lang_id",language_id);
			tabdata.put("long_name",longName);
			tabdata.put("short_name",shortName);
			tabdata.put("dflt_lang_online_report",dflt_lang);
			tabdata.put("eff_status",effectiveStatus);
