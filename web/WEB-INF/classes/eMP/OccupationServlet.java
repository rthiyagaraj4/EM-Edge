 ...
 ******************************************************************************/
/****** Last Modified Date Time 9/22/2005 11:26 AM *****/
package eMP;
...
public class OccupationServlet extends javax.servlet.http.HttpServlet
{
		...
		try
		{
			...
			String operation = req.getParameter("function");
				...
				if ( operation.equals("insert") )
					insertOccupation(req, res);
				if ( operation.equals("modify"))
						modifyOccupation(req, res);
		}
		catch (Exception e)
		{
	...
	private void modifyOccupation(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			...
			tabdata.put("ocpn_class_code",occupationClassCode);
			...
			condflds.put("OCPN_CODE",occupationCode);
		...
		catch ( Exception e )
		{
			...
			// out.println( occupationCode + " "+longDesc + " "+shortDesc +" "+ effectiveDateFrom+" "+ effectiveDateTo + " "+ effectiveStatus );
			e.printStackTrace(); // Added by lakshmanan for security issue ID 169536058 on 12-09-2023
		}
	}

	private void insertOccupation(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			occupationCode	= req.getParameter("occupation_code");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("ocpn_code",occupationCode);
			tabdata.put("ocpn_class_code",occupationClassCode);
			tabdata.put("long_desc",longDesc);
			tabdata.put("short_desc",shortDesc);
			tabdata.put("eff_status",effectiveStatus);
