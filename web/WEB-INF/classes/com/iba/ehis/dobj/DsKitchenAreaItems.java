...
/**
 * DsKitchenAreaItems generated by MyEclipse - Hibernate Tools
 */

public class DsKitchenAreaItems  implements java.io.Serializable {


    // Fields    

     private DsKitchenAreaItemsId id;
    ...
    /** default constructor */
    public DsKitchenAreaItems() {
    }

	/** minimal constructor */
    public DsKitchenAreaItems(DsKitchenAreaItemsId id) {
        this.id = id;
    }
    
    /** full constructor */
    public DsKitchenAreaItems(DsKitchenAreaItemsId id, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
    ...
    public DsKitchenAreaItemsId getId() {
        return this.id;
    }
    
    public void setId(DsKitchenAreaItemsId id) {
        this.id = id;
    }
