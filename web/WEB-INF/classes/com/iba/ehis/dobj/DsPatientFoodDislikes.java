...
/**
 * DsPatientFoodDislikes generated by MyEclipse - Hibernate Tools
 */

public class DsPatientFoodDislikes  implements java.io.Serializable {


    // Fields    

     private DsPatientFoodDislikesId id;
    ...
    /** default constructor */
    public DsPatientFoodDislikes() {
    }

	/** minimal constructor */
    public DsPatientFoodDislikes(DsPatientFoodDislikesId id) {
        this.id = id;
    }
    
    /** full constructor */
    public DsPatientFoodDislikes(DsPatientFoodDislikesId id, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
    ...
    public DsPatientFoodDislikesId getId() {
        return this.id;
    }
    
    public void setId(DsPatientFoodDislikesId id) {
        this.id = id;
    }
