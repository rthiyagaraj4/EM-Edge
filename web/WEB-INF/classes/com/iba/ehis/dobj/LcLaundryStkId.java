...
// Source File Name:   LcLaundryStkId.java
...
public class LcLaundryStkId
    implements Serializable
{

    public LcLaundryStkId()
    {
    }

    public LcLaundryStkId(String operatingFacilityId, LcLinenItem lcLinenItem)
    {
    ...
    public boolean equals(Object other)
    {
        ...
        if(other == null)
            return false;
        if(!(other instanceof LcLaundryStkId))
            return false;
        LcLaundryStkId castOther = (LcLaundryStkId)other;
