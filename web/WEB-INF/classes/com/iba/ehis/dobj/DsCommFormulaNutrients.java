...
/**
 * DsCommFormulaNutrients generated by MyEclipse - Hibernate Tools
 */

public class DsCommFormulaNutrients  implements java.io.Serializable {


    // Fields    

     private DsCommFormulaNutrientsId id;
    ...
    /** default constructor */
    public DsCommFormulaNutrients() {
    }

	/** minimal constructor */
    public DsCommFormulaNutrients(DsCommFormulaNutrientsId id) {
        this.id = id;
    }
    
    /** full constructor */
    public DsCommFormulaNutrients(DsCommFormulaNutrientsId id, Double contentValue, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
    ...
    public DsCommFormulaNutrientsId getId() {
        return this.id;
    }
    
    public void setId(DsCommFormulaNutrientsId id) {
        this.id = id;
    }
