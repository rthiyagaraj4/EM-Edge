...
public class CaseTypeServlet extends HttpServlet 
{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		case_type_nature=req.getParameter("case_type_nature")==null ? "":req.getParameter("case_type_nature");
     ...
     throws Exception
	{
		...
		tabData.put("case_type_nature",case_type_nature);
...
try{
				...
				final java.util.HashMap results = singleTabHandlerManagerRemote.insert(p,tabData,dupflds,"cp_case_type");
				*/
			...
			String table_name="cp_case_type";
			argArray[0] =p;
			argArray[1] =tabData;
			argArray[2] =dupflds;
...
public void modifyOperation(HttpServletRequest req,HttpServletResponse res)
		throws Exception
	{
        ...
        case_type_nature=req.getParameter("case_type_nature1")==null ? "":req.getParameter("case_type_nature1");
		...
		try{
			...
			final java.util.HashMap results = singleTabHandlerManagerRemote.update(p,tabData,condflds,"cp_case_type");*/
