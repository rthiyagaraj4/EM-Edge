...
package eCP;
 ...
 public void insertOperation(HttpServletRequest req,HttpServletResponse res)
     throws Exception
	{
		...
		try{
		 ...
		 added_by_id 	= p.getProperty( "login_user" ) ;
	   	 stage_code=req.getParameter("stage_code")==null ? "":req.getParameter("stage_code");
		 ...
		 stage_indicator=req.getParameter("stage_indicator")==null?"":req.getParameter("stage_indicator");
		...
		tabData.put("stage_indicator",stage_indicator);
	...
	try{
				...
				final java.util.HashMap results = singleTabHandlerManagerRemote.insert(p,tabData,dupflds,"cp_stage");*/
  ...
  public void modifyOperation(HttpServletRequest req,HttpServletResponse res)throws Exception{
       try{	
			...
			added_by_id 	= p.getProperty( "login_user" ) ;
			 ...
			 short_desc=req.getParameter("short_desc")==null ? "":req.getParameter("short_desc");
			 eff_status=req.getParameter("eff_status")==null ? "D":req.getParameter("eff_status");
			 stage_indicator=req.getParameter("stage_indicator1")==null?"":req.getParameter("stage_indicator1");
		...
		condflds.put("stage_code",stage_code);
			...
			try{
				...
				final java.util.HashMap results = singleTabHandlerManagerRemote.update(p,tabData,condflds,"cp_stage");*/
