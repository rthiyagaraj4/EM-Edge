...
import eCP.AgeGroupForAssessNote.*;

public class AgeGroupForAssessNoteServlet extends javax.servlet.http.HttpServlet 
{
	...
	private void SpecialityAddModify(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
            ...
            to			=	(req.getParameter("to")==null)		?	"0"	:	req.getParameter("to");
                 ...
                 AgeGroupForAssessNote	=	(webbeans.eCommon.RecordSet)	session.getAttribute("AgeGroupForAssessNote");
				 			...
				 			for(int i=0;i<AgeGroupForAssessNote.getSize();i++)
				 			{
				 				tabdata.put( ("chk"+i), (String)AgeGroupForAssessNote.getObject(i) );

							}
					String slCount	=	""+AgeGroupForAssessNote.getSize();
	  ...
	  /*  InitialContext context = new InitialContext();
		Object homeObject = context.lookup("java:comp/env/AgeGroupForAssessNote");
		AgeGroupForAssessNoteHome home = (AgeGroupForAssessNoteHome) PortableRemoteObject.narrow(homeObject ,AgeGroupForAssessNoteHome.class);
		AgeGroupForAssessNoteRemote remote = home.create();
		java.util.Hashtable results = remote.SpecialityAddModify(p,tabdata) ;*/

				boolean local_ejbs = false;
				ServletContext context = getServletConfig().getServletContext();
				if ((context.getInitParameter("LOCAL_EJBS") !=null) && (context.getInitParameter("LOCAL_EJBS").equalsIgnoreCase("TRUE"))) 
				local_ejbs = true;
				Object obj = com.ehis.eslp.ServiceLocator.getInstance().getHome("java:comp/env/AgeGroupForAssessNote",eCP.AgeGroupForAssessNote.AgeGroupForAssessNoteHome.class, local_ejbs);
			...
			session.removeAttribute("AgeGroupForAssessNote");
		}
	}//E.O.Method
}
