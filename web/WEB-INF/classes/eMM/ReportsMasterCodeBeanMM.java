...
public class ReportsMasterCodeBeanMM extends eMM.Common.MmAdapter implements java.io.Serializable{

	public String module_id="MM";
//private String language;
 public ReportsMasterCodeBeanMM() {
...
public String getLanguageId() {
	...
	public ArrayList getStoreList() throws Exception
	{
		...
		try {
				connection = getConnection();
				pstmt = connection.prepareStatement(MmRepository.getMmKeyValue("SQL_MM_STORE_SELECT"));
				pstmt.setString(1, getLanguageId());
				//Commented by Martin eSS.Common.SsInterface.SQL_SS_SURGERYTYPE_MODIFY
				resultSet = pstmt.executeQuery();
