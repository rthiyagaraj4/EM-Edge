...
public class MmUtils
{
	...
	public MmUtils( Properties jdbc_props )
	{
        this.jdbc_props	=	jdbc_props;
	}

	public java.util.HashMap checkDuplicateExists( String SQL_MM_CODE_EXISTS, ArrayList arrPKFields ) throws Exception
	{
		...
		{
			map		=	new	HashMap();
			pstmt	=	intializeSQLPStatement ( SQL_MM_CODE_EXISTS );
		...
		{
			String	error_msg	=	"Exception@checkDuplicateExists() method...SQL Is : " + SQL_MM_CODE_EXISTS + " Exception@1 : " + e.toString();
	...
	public String getListOptions( String SQL_STMT, ArrayList arrValues, String defaultValue,String language_id ) throws java.sql.SQLException, Exception
	{
		...
		{
			String select_option=getMMMessage(language_id,"SELECT_OPTION","ST") ;
	...
	public Map getSubFunctionProperties(String menu_id, String function_id, Properties jdbc_props) throws Exception 
	{
		...
		{
			this.jdbc_props	=	jdbc_props;
			intializeSQLPStatement(MmRepository.getMmKeyValue("SQL_MM_SUBFUNCTION_SELECT"));		
