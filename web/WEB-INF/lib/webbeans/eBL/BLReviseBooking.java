...
//		System.out.println("Entered the billPatientBooking Method");
		...
		String str_appt_bkng_ref_no="",str_rev_appt_bkng_ref_date="";		
		try
		{
...
//			System.out.println("strFacilityId" +strFacilityId);
			...
			strPatientId=(String)tabdata.get("P_PATIENT_ID");
...
//			System.out.println("str_appt_bkng_ref_no" +str_appt_bkng_ref_no);
			...
			str_rev_appt_bkng_ref_date=(String) tabdata.get("admissiondate");
			if(str_rev_appt_bkng_ref_date == null) str_rev_appt_bkng_ref_date="";
//			System.out.println("str_appt_bkng_ref_date" +str_rev_appt_bkng_ref_date);							
			
			if (insertable)
			{
				String sql = "{call blcommon.bl_update_bkng_fin_dtls('"+strFacilityId+"','"+episode_type+"','"+strPatientId+"',to_date('"+str_rev_appt_bkng_ref_date+"','dd/mm/yyyy hh24:mi '),'"+str_appt_bkng_ref_no+"',?,?,?)}";							
