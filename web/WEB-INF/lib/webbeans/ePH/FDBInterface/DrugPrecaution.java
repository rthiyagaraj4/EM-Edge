...
public class DrugPrecaution
{

    public DrugPrecaution()
        throws IOException
    {
...
public void setPREGSignificanceFilter(int pregseverityfiltertype)
    ...
    private void setDrugPrecautionResult()
        throws FDBException
    {
				...
				if (LookupResultsDDIM.count() > 0)
				{
					for (int i=0; i<LookupResultsDDIM.count(); i++)
					{
						...
						if (LookupResultDDIM.getClinicalEffectCode2()!=null)
						{
							...
							if(cecDesc2==null) cecDesc2="";
							if (!cecDesc1.equals("")) cecDesc1 = cecDesc1 + "<br>";
...
System.err.println("==drugFoodInteractionResult===="+drugFoodInteractionResult);
				}
			}
	    }catch (Exception e)
		{
