...
<%
 ...
 %>
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" align='center' width='100%'>
	   <tr>		      
		      <td class='label' width='30%'><fmt:message key="eMO.StartingAutopsyNo.label" bundle="${mo_labels}"/></td>
		...
		<tr>		      
		      <td class='label'><fmt:message key="eMO.NextAutopsyNo.label" bundle="${mo_labels}"/></td>
		      <td class='fields'>
			  <%if(mode.equals("insert")){%>
		...
		<tr>		      
		      <td class='label' ><fmt:message key="eMO.EndAutopsyNo.label" bundle="${mo_labels}"/></td>
		      <td class='fields'>
			  <%if(mode.equals("insert")){%>
        ...
        <tr>	     
		      <td class='label'><fmt:message key="eMO.AutopsyNoDetailsRequired.label" bundle="${mo_labels}"/> </td>
		      <td class='fields'>
			  <%if(mode.equals("insert")){%>
		...
		<tr>		      
		     <td class='label' ><fmt:message key="eMO.AutopsyNoFormat.label" bundle="${mo_labels}"/></td>
