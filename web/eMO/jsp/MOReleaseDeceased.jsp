...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<iframe name='commontoolbarFrame' id='commontoolbarFrame' src="<%=source%>" frameborder=0 scrolling='no' noresize style='height:8vh;width:100vw'></iframe>
		<iframe name='f_query_add_mod</iframe>' id='f_query_add_mod' src='../../eMO/jsp/MORegnDtlsQueryCriteria.jsp?callfrom=releaseDeceased&function_id=<%=function_id%>' frameborder=0 scrolling='no' style='height:35vh;width:100vw'></iframe>
