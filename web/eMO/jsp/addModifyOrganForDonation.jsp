...
<br><br><br><br><br><br><br><br><br><br>
	...
	<tr>
		...
		<td class='fields'><input type="text" name="organ_code" id="organ_code" size="4" maxlength="4" value="<%=code%>"  onKeyPress="return CheckForSpecChars(event)" <%=codeTextAttribute%> <%=eventFunctionForCase%>>
