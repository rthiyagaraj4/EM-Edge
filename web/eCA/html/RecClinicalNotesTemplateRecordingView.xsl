 ...
 <!--   <xsl:choose>
  ...
  <xsl:template match="SHORT-TEXT">
   ...
   <xsl:template name="SHORT-TEXT-WTD" match="SHORT-TEXT-WTD">  
   	<!-- <textarea rows="1"> 68801 -->
   	<textarea rows="2">    <!-- 68801 by Twinkle -->        
            <xsl:if test="@GRID-COMP = 'Y'">
...
<!-- <xsl:attribute name="OnBlur">CheckMaximumLength('<xsl:value-of select="@PROMPT"/>',this,'<xsl:value-of select="@SIZE"/>',top.messageFrame)</xsl:attribute> 68801-->            	     
