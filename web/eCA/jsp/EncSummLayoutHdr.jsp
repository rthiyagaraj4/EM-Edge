	...
	<form name="HeaderForm" id="HeaderForm" >
		...
		<table border="0" cellpadding="3" cellspacing="0" width="100%" align="center"> 
			<tr>
				...
				<td class='fields'>
					<input type='hidden' name='summary' id='summary' value='<%=summaryCode %>' ><input type='text' name ='summaryCode' onBlur='getSummaryCode(this)' OnChange='resetValues();setValue()' value='<%=summaryDesc %>'>
