...
<script>
	...
	<iframe name='' id='' src='../../eCA/jsp/RecClinicalNotesFileUploadShowDoc.jsp?<%=request.getQueryString()%>' frameborder='0' scrolling='auto' noresize style='height:100vh;width:100vw'></iframe>
