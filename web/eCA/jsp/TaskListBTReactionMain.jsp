...
-->
<iframe name='group_head' id='group_head' src='../../eCA/jsp/TaskListBTReactionCriteria.jsp?<%=queryString%>' noresize  frameborder='0' marginheight=0 marginwidth=0 scrolling='no' style='height:20%;width:100vw'></iframe><iframe name='code_desc' id='code_desc'    src='../../eCommon/html/blank.html'  noresize  scrolling=no frameborder=no marginheight=0 marginwidth=0 style='height:100vh;width:100vw'></iframe><iframe name='group_head1' id='group_head1' src='../../eCommon/jsp/GeneralCancel.jsp' noresize  frameborder=no marginheight=0 marginwidth=0 style='height:8%;width:100vw'></iframe>
</html>
