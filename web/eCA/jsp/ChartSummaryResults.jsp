...
%>
			...
			<!--IN065341 starts-->
			 <!--<tr><td colspan='3' class='gridData'><a class='gridLink' href="javascript:callResults('<%=patient_id%>','<%=title%>','<%=reln_id%>','<%=enc_id%>','<%=facility_id%>','<%=content_ID%>')"><fmt:message key="eCA.MoreDtlRef.label" bundle="${ca_labels}"/></a></td></tr> <!--added arguments facility_id and content_ID for IN038454 --> 
			 <tr><td colspan='3' class='gridData'><a class='gridLink' href="javascript:callResults('<%=patient_id%>','<%=title%>','<%=reln_id%>','<%=enc_id%>','<%=facility_id%>','<%=content_ID%>','<%=RepDb%>','<%=clob_data%>')"><fmt:message key="eCA.MoreDtlRef.label" bundle="${ca_labels}"/></a></td></tr>
			<!--IN065341 ends-->
<%
		}
	}	
