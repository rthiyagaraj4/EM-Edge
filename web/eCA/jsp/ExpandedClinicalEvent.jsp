...
*/
%>
<%@page import="java.sql.*,java.io.*,webbeans.eCommon.*,eCA.*,java.util.*,java.util.zip.*,java.util.Date,java.text.SimpleDateFormat,java.math.*,eCommon.XSSRequestWrapper" %><!-- IN042733 --><!--IN064688 Added  math.*-->
...
<input type="hidden" name="checkbox__cnt" id="checkbox__cnt" value='<%=cnt%>'>
...
<!-- Added for ML-MMOH-CRF-2149 start -->
 <%-- <%
	...
	System.out.println("Expanded clinical event page  "+resCEHView+"000000copyRestrict value"+copyRestrict );
    if(resCEHView != null){
	if(copyRestrict.equals("Y") && resCEHView.equals("FLOW_SHEET1")  ){
%>  
