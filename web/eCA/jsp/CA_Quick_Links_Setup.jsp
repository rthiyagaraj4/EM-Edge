...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<script>
		...
		function callJSPs(val)
		{
			...
			*/
		    ...
		    if(val == 'DefineQuickLinks'){					
				parent.frames[1].location.href = '../../eCA/jsp/DefineQuickLinksMain.jsp?module_id=CA&function_id=Encounter Details&function_name=Define Quick Link&function_type=F&access=YYYNN';
			}
			if(val == 'QuickLinksResp'){					
				parent.frames[1].location.href = '../../eCA/jsp/QuickLinksForRespMain.jsp?module_id=CA&function_id=Encounter Details&function_name=Quick Link For Responsibility&function_type=F&access=YYNNN';
			}
}	
	...
	<table cellspacing=1 cellpadding=2 width='100%' border=0 id='t'>
		...
		<tr onclick='chcol(this)'>
			<td  class='MENUSUBLEVELCOLOR' onClick="javascript:callJSPs('DefineQuickLinks')"><fmt:message key="eCA.DefineQuickLink.label" bundle="${ca_labels}"/></td>
		</tr>
		<tr onclick='chcol(this)'>
			<td  class='MENUSUBLEVELCOLOR' onClick="javascript:callJSPs('QuickLinksResp')"><fmt:message key="eCA.QuickLinkForResponsibility.label" bundle="${ca_labels}"/></td>
		</tr>
