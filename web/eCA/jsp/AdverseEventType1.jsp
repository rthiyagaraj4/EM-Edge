 ...
 }else
{
 ...
 if ( tabdata != null ) tabdata.clear();
		...
		parent.frames[2].document.forms[0].onset_date.value='<%=on_set_date%>';
		parent.frames[2].document.forms[0].onset_date.disabled=true;
			parent.frames[2].document.forms[0].cal2.disabled=true;<%}else
		{%>parent.frames[2].document.forms[0].onset_date.disabled=false;
		...
		{%>
		eval("parent.frames[5].document.forms[0].third"+<%=j%>).style.display='Inline';
		eval("parent.frames[5].document.forms[0].third"+<%=j%>).style.visibility='visible';
		<%}
			...
			if(cnt > 0)
			{
				...
				eval("parent.frames[5].document.forms[0].second"+<%=i%>).style.display='Inline';
				eval("parent.frames[5].document.forms[0].second"+<%=i%>).style.visibility='visible';
		...
		}else
		{
			for(int j=cnt2;j<cnt_head;j++)
		{%>
		eval("parent.frames[5].document.forms[0].third"+<%=j%>).style.display='none';
		eval("parent.frames[5].document.forms[0].third"+<%=j%>).style.visibility='hidden';
		<%}
			if(cnt > 0)
			{
				for(int i=cnt2;i<cnt3;i++)
				...
				eval("parent.frames[5].document.forms[0].second"+<%=i%>).style.display='none';
				eval("parent.frames[5].document.forms[0].second"+<%=i%>).style.visibility='hidden';
				<%}
			}
		}
		...
		if(rs !=null)
		{
			...
			parent.frames[3].document.forms[0].reaction_value.value='<%=final_string%>';
			parent.frames[3].document.forms[0].react_code_final.value='<%=reac_code_final.toString()%>';
			parent.frames[3].document.forms[0].reac_desc1_val.value='<%=reac_desc_final.toString()%>';
			 //parent.frames[3].document.forms[0].reaction_value.disabled=true;
			 <% if(tabdata2.contains("UNKN") && !reac_code_final.equals("")){%>
			// parent.frames[3].document.forms[0].other_reaction.disabled=false;<%
			 }else{
			%>//parent.frames[3].document.forms[0].other_reaction.disabled=true;<%
			 }
		...
		%>parent.frames[3].document.forms[0].react_code_final.value='<%=reac_code_val_last.toString()%>';<%
