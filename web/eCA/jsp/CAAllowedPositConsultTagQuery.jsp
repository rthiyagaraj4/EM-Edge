...
<script language='javascript' src='../js/CAAllowedPositConsultTag.js'></script>

</head>
<body  class='CONTENT' OnMouseDown="CodeArrest()" onload='FocusFirstElement()' onKeyDown="lockKey()">

<form name="CAAllowedPositConsultTagQry" id="CAAllowedPositConsultTagQry">
<table border=0 cellspacing=0 cellpadding=3 width='100%' align=center>

<tr>
	<td class='label' ><fmt:message key="eCA.AllowedPractitionerType.label" bundle="${ca_labels}"/></td>	
	<td class='fields'><select name=practitioner_type id=practitioner_type onchange="callOnChange(this)">
	<option value=''>------------<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>------------</option>	
	<%
			sql1="select a.PRACT_TYPE,B.DESC_USERDEF from CA_PRACT_CONSULTA_TAG a inner join am_pract_type b ON a.pract_type = b.pract_type and b.EFF_STATUS='E' order by 2";
