...
<script language='javascript' src='../../eCA/js/CAContSpecialtyPositionPatListByLoc.js'></script>
</head>
<%
...
String or_bean_id 						= "@CAContSpecialtyPositionPatListByLocBean";
String or_bean_name 					= "eCA.CAContSpecialtyPositionPatListByLocBean";
CAContSpecialtyPositionPatListByLocBean bean		= (CAContSpecialtyPositionPatListByLocBean)getBeanObject( or_bean_id, or_bean_name, request ) ;
...
<form name='CAContSpecPositionPatListByLocResultForm' id='CAContSpecPositionPatListByLocResultForm' >
...
<tr>
<td class='columnheadercenter' width='2%'><fmt:message key="eCA.Code.label" bundle="${ca_labels}"/>
<td class='columnheadercenter' width='5%'><fmt:message key="eCA.Position.label" bundle="${ca_labels}"/>
<td class='columnheadercenter' width='2%'><fmt:message key="Common.selectall.label" bundle="${common_labels}"/>
...
<%
	...
	%>
<tr>
<td class='gridData'><%=position_code%></td>
