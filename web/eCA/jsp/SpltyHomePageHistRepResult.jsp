            ...
            %>
				...
				<td class=CAHIGHERLEVELCOLOR colspan=2>
			        ...
			        {		
						...
						%>	
						<input type="checkbox" name="chkbox<%=x%>" id="chkbox<%=x%>" onClick="perform(this)" value="<%=x%>" <%=checkstatus%>     >
				
							<%=event_date_str%>
						
						
				
                <input type='hidden' name='chk_value<%=x%>' id='chk_value<%=x%>' value="<%=rowid%>">
				<input type='hidden' name='ret_value<%=x%>' id='ret_value<%=x%>' value='D<%=d%>'> 
				...
				<tr>
					<td  class=CAGROUP colspan=2><input type="checkbox" name="chkbox<%=x%>" id="chkbox<%=x%>" onClick="perform(this)" value="<%=x%>" <%=checkstatus%> ><%=event_group_desc%></td>
					<input type='hidden' name='chk_value<%=x%>' id='chk_value<%=x%>' value="<%=rowid%>">
                    <input type='hidden' name='ret_value<%=x%>' id='ret_value<%=x%>' value='D<%=d%>T<%=t%>'> 
				...
				<tr>	
					...
					<input type="checkbox" name="chkbox<%=++x%>" id="chkbox<%=++x%>" onClick="performchkbox(this)" value="<%=x%>" <%=checkstatus%>  >
					...
					<input type='hidden' name='chk_value<%=x%>' id='chk_value<%=x%>' value="<%=rowid%>">
                    <input type='hidden' name='ret_value<%=x%>' id='ret_value<%=x%>' value='D<%=d%>T<%=t%>E<%=time%>'> 
					<input type='hidden' name='hist_data_type<%=x%>' id='hist_data_type<%=x%>' value = '<%=hist_data_type%>'>
					</tr>
					</table>
				</td>
				</tr>
