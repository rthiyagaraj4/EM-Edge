...
<link rel='StyleSheet' href='../../eCommon/html/<%=sessionStyle%>' type='text/css' /><!-- [IN035950] -->
...
%>
	...
	<tr>
				...
				<td align='center' nowrap class='COLUMNHEADERCENTER'><font>&nbsp;</font></td>
				<td align='center' nowrap class='COLUMNHEADERCENTER'><font align='top'><fmt:message key="Common.Set.label" bundle="${common_labels}"/></font></td>
				<td align='center'  wrap class='COLUMNHEADERCENTER'><font  align='top'><fmt:message key="Common.diagnosis.label" bundle="${common_labels}"/>/<fmt:message key="Common.Problem.label" bundle="${common_labels}"/></font></td>
				<td align='center'  nowrap class='COLUMNHEADERCENTER' ><font align='top'><fmt:message key="Common.description.label" bundle="${common_labels}"/></font></td>
	...
	%>
	<tr>
				<td align='center' nowrap class='COLUMNHEADERCENTER<%=content_ID%>'><font align='top'>&nbsp;</font></td>
				<td align='center' nowrap class='COLUMNHEADERCENTER<%=content_ID%>'><font align='top'>&nbsp;</font></td>
				<td align='center' nowrap class='COLUMNHEADERCENTER<%=content_ID%>'><font align='top'><fmt:message key="Common.Set.label" bundle="${common_labels}"/></font></td>
				...
				<td align='center' nowrap class='COLUMNHEADERCENTER<%=content_ID%>'><font align='top'><fmt:message key="eCA.DiagnosisRemarks.label" bundle="${ca_labels}"/></font></td><!--38981-->
			<%if(!called_from.equals("CDR")){%><!--IN065341-->
	...
	while(rs1.next())
	{
		...
		classValue="gridData";
%>
	<tr><td class='<%=classValue%>' >&nbsp;</td><td class='<%=classValue%>'>&nbsp;</td><td class='<%=classValue%>'>&nbsp;</td><td class='<%=classValue%>'><img src='../../eCommon/images/Problems.gif'><%=complaint_id%></td><td class='<%=classValue%>'><%=complaint_desc%></td><td class='<%=classValue%>'><%=onset_datetime%></td></tr><!--Removed the Decoder from complaint desc for EMR fix-->
<%
    ...
    while(rs.next())
	{
			...
			<td class='<%=classValue%>'><%=termSetDesc%></td><td class='<%=classValue%>' nowrap>
		...
		<%if(!isSiteSpecific){%><!--IN069327-->
			...
			<%}
		}else{%><!--IN069327 starts-->
			<td  class='<%=classValue%>'><%=term_code_short_desc_1%> </td>
		<%}%><!--IN069327 ends-->
		<td  class='<%=classValue%>'><%=onset_datetime_col%> </td><!--IN65780 col name misspelled--> 
	    <!-- start 38981 -->
        <% if(curr_remarks!=""){
