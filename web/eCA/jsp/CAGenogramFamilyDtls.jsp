										...
										try{
											...
											%>	
												<tr bgcolor="#FF0000"  >
													...
													<td class='<%=className%>1' ><input type="radio" name="fromRelation" id="fromRelation" value="<%=rs.getString("GENO_ID")==null?"":(String)rs.getString("GENO_ID") %>|<%=rs.getString("SRL_NO")==null?"":(String)rs.getString("SRL_NO") %>|<%=rs.getString("NON_PATIENT_ID")==null?"":(String)rs.getString("NON_PATIENT_ID") %>" onClick="clickFromRelation();">&nbsp;</td>
