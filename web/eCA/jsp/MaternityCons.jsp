...
/** ends here **/
	top.content.matFrame.location.href='../../eCA/jsp/MaternityConsTreeMain.jsp?<%=queryString%>'
	top.content.workAreaFrame.location.href='../../eCA/jsp/MaternityConsMain.jsp?<%=queryString%>'
	</script>
</html>
