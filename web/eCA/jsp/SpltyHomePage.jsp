...
<FRAMESET ROWS="18%,12%,*,0%,6%" id='myFrameSetControls' FRAMEBORDER=NO>
		<FRAME SRC="../../eCA/jsp/SpltyHomePageHeader.jsp?<%=request.getQueryString()%>" name='headerFrame' FRAMESPACING=NO FRAMEBORDER=NO scrolling=auto>  
		<FRAME SRC="../../eCA/jsp/SpltyHomePageControl.jsp?<%=request.getQueryString()%>" name='controlsFrame' FRAMESPACING=NO FRAMEBORDER=NO scrolling=no>  
