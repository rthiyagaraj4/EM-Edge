...
<body onMouseDown="CodeArrest()" onKeyDown="lockKey()" class='CONTENT' >
	...
	<p align='left'>
		...
		<input type="radio" name="chkt" id = "chkt"  class="label" value="t" onClick="chgretn(this)" <%=textchkbox%> >
		<font size='1'><fmt:message key="Common.Text.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="chkl"  id = "chkl" class="label" value="l" onClick="chgretn(this)" <%=tablechkbox%>><font size='1'><fmt:message key="Common.Table.label" bundle="${common_labels}"/>&nbsp;&nbsp;
