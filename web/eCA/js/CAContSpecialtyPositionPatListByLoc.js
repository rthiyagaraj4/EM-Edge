...
function create()
{
	f_query_add_mod.location.href='../../eCA/jsp/CAContSpecialtyPositionPatListByLoc.jsp?mode=insert';
...
function apply()
{
	var formResultObj = f_query_add_mod.f_query_add_mod_res.document.CAContSpecPositionPatListByLocResultForm;
	if(formResultObj === undefined)
	{
	msg =getMessage("PRACTITIONER_CANNOT_BE_BLANK",'CA');
	messageFrame.location.href="../../eCommon/jsp/MstCodeError.jsp?err_num="+msg+"&err_value=0";
	return false;
	}
	var from = f_query_add_mod.f_query_add_mod_res.document.CAContSpecPositionPatListByLocResultForm.fm_disp.value;	
	var to = f_query_add_mod.f_query_add_mod_res.document.CAContSpecPositionPatListByLocResultForm.to_disp.value;	
	...
	f_query_add_mod.f_query_add_mod_res.document.CAContSpecPositionPatListByLocResultForm.optionValStr.value = optionValStr;
	f_query_add_mod.f_query_add_mod_res.document.forms[0].action="../../servlet/eCA.CAContSpecialtyPositionPatListByLocServlet";
	f_query_add_mod.f_query_add_mod_res.document.CAContSpecPositionPatListByLocResultForm.target="messageFrame";
	f_query_add_mod.f_query_add_mod_res.document.CAContSpecPositionPatListByLocResultForm.method="post";
	f_query_add_mod.f_query_add_mod_res.document.CAContSpecPositionPatListByLocResultForm.submit();	
}
...
function populateData(){
	...
	{
		parent.f_query_add_mod_res.location.href='../../eCA/jsp/CAContSpecialtyPositionPatListByLocResult.jsp?practitioner_type='+practitioner_type;
