 ...
 function apply()
 {
	...
	//var optionValStr1 = "",optionValStr2 = "",optionValStr3= "", listValue1 = "", listName1 = "",listValue2="",listName2="";//IN035914
	var optionValStr1 = "",optionValStr2 = "",optionValStr3= "",optionValStr5="", listValue1 = "", listName1 = "",listValue2="",listName2="",listValue3="",listValue4="",listValue5="";//IN035914
	for (i=from; i<=to; i++){
        listValue0 = eval("formResultObj.opt_id"+i+".value");
		listName0  = eval("formResultObj.opt_id"+i+".name");
		if(listValue0 == "") listValue0 = "0";
		listValue1 = eval("formResultObj.usd"+i+".value");
		listName1  = eval("formResultObj.usd"+i+".name");
		//IN038579 Starts
		//	if(listValue1 == "") listValue1 = "0";
		if(listValue1 == "")
		{
			listValue1 = "0";
			index++;
		...
		//IN038579 Ends
		listValue2 = eval("formResultObj.uld"+i+".value");
		listName2  = eval("formResultObj.uld"+i+".name");	
		if(listValue2 == "") listValue2 = "0";
		//IN035914 Starts
		
		listValue3 = eval("formResultObj.uDescLegend"+i+".value");
		listName3  = eval("formResultObj.uDescLegend"+i+".name");	
		if(listValue3 == "") listValue3 = "0";
		...
		//IN035914 Ends
	//optionValStr += listName0 +"||"+listValue0+"~"+listName1+"||"+listValue1+"~"+listName2+"||"+listValue2+"~";
          optionValStr1 += listName0 +"||"+listValue0+"~";
		  optionValStr2 += listName1 +"||"+listValue1+"~";
		  optionValStr3 += listName2 +"||"+listValue2+"~";
	}//for
    
	//f_query_add_mod.document.forms[0].action="../../servlet/eCA.CAOptionRedefineServlet?optionValStr1="+optionValStr1+"&optionValStr2="+optionValStr2+"&optionValStr3="+optionValStr3;//IN035914 Starts
	//IN038579 Starts
	/*f_query_add_mod.document.forms[0].action="../../servlet/eCA.CAOptionRedefineServlet?optionValStr1="+optionValStr1+"&optionValStr2="+optionValStr2+"&optionValStr3="+optionValStr3+"&optionValStr5="+optionValStr5;//IN035914 Starts
	f_query_add_mod.document.forms[0].target="messageFrame";
	f_query_add_mod.document.forms[0].method="post";
    f_query_add_mod.document.forms[0].submit();*/
	if(index >0)
	{	
		var err_msg = getMessage("CA_SHORT_DESC_BLANK","CA");
...
function reset()
{
	f_query_add_mod.location.href='../../eCA/jsp/CAOptionRedefine.jsp?dispMode=';
}
...
{
	//var strCheck='0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_*  ';//CHL-CRF-006-Nijitha
	var strCheck='0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_/  ';//CHL-CRF-006-Nijitha
...
function copyBackgroundAndFontColor(color) {
	...
	var formObj = document.caOptionRedefine;
	var textColor = 50;
	var bckColor = "";
	var combinedcolor = "";
	var isBoldEnabled = "";
...
function CheckForSpecCharsWithCopyPaste(textObj)
{
	...
	//var ValidChars = /^[0-9a-zA-Z-_\/]*$/; //Commented [Nijitha]
	var ValidChars = /^[0-9a-zA-Z-_\/ ]*$/;  //Added Space in Reg Exp
