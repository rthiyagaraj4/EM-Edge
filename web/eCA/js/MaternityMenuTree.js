...
function dTree(objName) {
	...
	this.icon = {
		...
		babyOpen			: '../images/MCT_BabyOpen.gif',
		babyClose			: '../images/MCT_BabyClose.gif'
	};
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		if (!node.icon && node.id != 'MOTHER' && node.id != 'FOETUS') node.icon = (this.root.id == node.pid) ? this.icon.root : ((node._hc) ? this.icon.folder : this.icon.node);
		else if(!node.icon && (node.id != 'MOTHER' || node.id != 'FOETUS'))
		{
			if(node.id == 'MOTHER') node.icon = (this.root.id == node.pid) ? this.icon.root : ((node._hc) ? this.icon.motherClose : this.icon.motherOpen);
			else if(node.id == 'FOETUS') node.icon = (this.root.id == node.pid) ? this.icon.root : ((node._hc) ? this.icon.babyClose : this.icon.babyOpen);
		}
		if (!node.iconOpen && node.id != 'MOTHER' && node.id != 'FOETUS') node.iconOpen = (node._hc) ? this.icon.folderOpen : this.icon.node;
		else if(!node.iconOpen && (node.id == 'MOTHER' || node.id == 'FOETUS'))
		{
			if(node.id == 'MOTHER') node.iconOpen = (node._hc) ? this.icon.motherOpen : this.icon.motherClose;
			else if(node.id == 'FOETUS') node.iconOpen = (node._hc) ? this.icon.babyOpen : this.icon.babyClose;
		}
