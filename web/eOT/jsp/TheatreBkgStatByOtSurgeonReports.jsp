...
<!--57888 starts-->
	...
	<input type='hidden' name='param1' id='param1' value='<%=DateUtils.convertDate(booking_date,"DMY",locale,"en")%>'>
	 ...
	 <td class='fields' width='42%'>
		  <input type='text' name='param11_disp' id='param11_disp' size='8' value='<%=booking_date%>' onKeyPress="return checkForSpecCharsforID(event);" onBlur="isValidDate(this);" maxlength='10'>
...
<!--57888 ends-->
	...
	<fmt:message key="Common.OperatingRoom.label" bundle="${common_labels}"/>
     ...
     <td class='fields' width='42%'>
		...
		<input type='text' name='from_oper_room_desc' id='from_oper_room_desc' size='20' title='<%=operationRoom_title%>' param1 = 'param12'  param2 = 'param13' key ='OPER_ROOM' onBlur="if(this.value!='')callCommonLookup(this); else param12.value='',param13.value='' " maxlength='70' onKeyPress="return CheckForSpecChars_local(event);"> 
...
%>
    ...
    <input type="hidden" name="mandatory_fm_2" id="mandatory_fm_2" value="param11##<%=tobookingdate%>" disabled>
