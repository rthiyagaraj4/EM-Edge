...
<tr>
	<td class='label' width='25%'><fmt:message key="Common.Procedure.label" bundle="${common_labels}"/></td>
     <td class='fields' width='25%'>
		...
		<input type='text' name='proc5_desc' id='proc5_desc' size='20' title='<%=procedure_title%>' param1 = 'param5'  param2 = 'param6' key ='PROCEDURE' onBlur="if(this.value!='')callCommonLookup(this); else callClearParam(param5,param6); " colspan="2" maxlength='70' onkeypress="return CheckForSpecChars_local(event);">
...
<tr>
    ...
    <td class='fields' width='25%'>
		...
		<input type='text' name='param10_desc' id='param10_desc' size='20' title='<%=speciality_title%>' param1 = 'param10'  param2 = 'param11' key ='SPECIALITY' onBlur="if(this.value!='')callCommonLookup(this); else param10.value='',param11.value='' " maxlength='70' onkeypress="return CheckForSpecChars_local(event);"> 
...
<tr>
	<td class='label' width='25%'><fmt:message key="Common.OperatingRoom.label" bundle="${common_labels}"/></td>
     <td class='fields' width='25%' colspan='3'>
		...
		<input type='text' name='param5_desc' id='param5_desc' size='20' title='<%=operationroom_title%>' param1 = 'param3'  param2 = 'param4' key ='OPER_ROOM' onBlur="if(this.value!='')callCommonLookup(this); else callClearParam(param3,param4)" colspan="2" maxlength='70' onkeypress="return CheckForSpecChars_local(event);">
