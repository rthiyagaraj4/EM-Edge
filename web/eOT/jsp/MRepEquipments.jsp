...
<TABLE WIDTH="70%" ALIGN="center" CELLPADDING="0" CELLSPACING="0" BORDER="0">
		...
		<TR>
			...
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE=text name="param1" id="param1" SIZE="10" maxlength="8" onKeyPress="return CheckForSpecChars(event)" tabIndex="1" onblur="if(this.value!='')searchCode(document.all, 'EQUIPMENTS','<%=equipment_title%>', document.forms[0].param1); else this.value='' ">
				<INPUT TYPE="button" name="equipmentsFrom" id="equipmentsFrom" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'EQUIPMENTS','<%=equipment_title%>', document.forms[0].param1)">
			</TD>
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE=text name="param2" id="param2" SIZE="10" maxlength="8" onKeyPress="return CheckForSpecChars(event)" tabIndex="2" onblur="if(this.value!='')searchCode(document.all, 'EQUIPMENTS','<%=equipment_title%>', document.forms[0].param2); else this.value='' ">
				<INPUT TYPE="button" name="equipmentsTo" id="equipmentsTo" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'EQUIPMENTS','<%=equipment_title%>', document.forms[0].param2)">
			</TD>
			<TD WIDTH="25%">&nbsp;</TD>
		</TR>
		</TR>
