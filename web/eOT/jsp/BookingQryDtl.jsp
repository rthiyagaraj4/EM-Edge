...
<div id="tableContainer">
	<THEAD>
		<TR>
			...
			<th class ='columnheader' nowrap><fmt:message key="eOT.BookingNO.Label" bundle="${ot_labels}"/></th>
			<th class ='columnheader' nowrap><fmt:message key="eIP.BookingDateTime.label" bundle="${ip_labels}"/></th>
			<th class ='columnheader' nowrap><fmt:message key="Common.waitlistno.label" bundle="${common_labels}"/></th>
