...
<tr>
	<td class='label' width='25%'><fmt:message key="Common.Procedure.label" bundle="${common_labels}"/></td>
     <td class='fields' width='25%'>
		...
		<input type='text' name='param9_desc' id='param9_desc' size='20' title='<%=procedure_title%>' param1 = 'param9'  param2 = 'param10' key ='PROCEDURE' onBlur="if(this.value!='')callCommonLookup(this); else param9.value='',param10.value='' "> 
 ...
 -->
	...
	<td class='label' width='25%'><fmt:message key="eOT.OperationType.Label" bundle="${ot_labels}"/></td>
     <td class='fields' width='25%'>
		...
		<input type='text' name='param11_desc' id='param11_desc' size='20' title='<%=opertype_title%>' param1 = 'param11'  param2 = 'param12' key ='OPER_TYPE' onBlur="if(this.value!='')callCommonLookup(this); else param11.value='',param12.value='' "> 
...
<tr>
	<td class='label' width='25%'><fmt:message key="Common.Surgeon.label" bundle="${common_labels}"/></td>
     <td class='fields' width='25%'>
		...
		<input type='text' name='param3_desc' id='param3_desc' size='20' title='<%=surgeon_title%>' param1 = 'param3'  param2 = 'param4' key ='SURGEON' onBlur="if(this.value!='')callCommonLookup(this); else param3.value='',param4.value='' "> 
