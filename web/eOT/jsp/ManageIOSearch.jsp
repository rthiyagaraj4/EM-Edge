<!DOCTYPE html>
<html>           
<%@page  import ="java.sql.Connection,java.sql.PreparedStatement,java.sql.ResultSet,webbeans.eCommon.ConnectionManager,eOT.Common.OTRepository,eCommon.XSSRequestWrapper,eCommon.Common.*" contentType="text/html;charset=UTF-8" %>
...
<form name="addlSearchCriteriaForm" id="addlSearchCriteriaForm" method='post' action='../../eOT/jsp/ManageIOSearch.jsp'>
...
System.err.println("strOrderId::"+strOrderId+"strPatientId:::"+strPatientId);
...
<tr>
		...
		<td class='fields' >
			<input type='text' name='to_date' id='to_date' size='11'   value='<%=strSysDate%>' maxlength='10' onblur='checkDateFormat(this)'>
			<img src="../../eCommon/images/CommonCalendar.gif" 
...
<tr>
	<td class="label">
		<fmt:message key="eOT.BookingNumber.Label" bundle="${ot_labels}"/>
	</td>
	<td class="fields">
		<input type='text' name='bookingNum_desc' id='bookingNum_desc' maxlength='20' size='20'>
...
<tr>
	...
	<fmt:message key="eOT.OrderID.Label" bundle="${ot_labels}"/>
	</td>
	<td  class="fields">
		<input type='text' name='ORDER_ID' id='ORDER_ID' maxlength='20' size='20' value= "<%=strOrderId%>" >
...
<td class="label">
	...
	<td class='fields'>
		...
		<input type='text' name='operation_desc' id='operation_desc' size='20'  value="<%=strOperationDesc%>" maxlength='20' onBlur="if(this.value!='') searchBookingQryOperation(oper_code,operation_desc); else oper_code.value=''" >
...
<td class="label">
	...
	<td  class="fields">
		<input type='hidden' name='oper_type_code' id='oper_type_code' value="<%=strOperationCode%>"> 
		<input type='text' name='OperationType' id='OperationType' maxlength='20' size='20' value= "<%=strSpeciality%>"  onBlur="if(this.value!='') searchBookingQryOperation(oper_code,operation_desc); else oper_code.value=''" >
			<input type='button' class='button' value='?' name='OperationLookUp' id='OperationLookUp' onClick="searchBookingQryOperation(oper_code,operation_desc)" ></td>
	</td>
