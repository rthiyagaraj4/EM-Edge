...
<body onMouseDown="CodeArrest()" onKeyDown="lockKey()" onload="document.MrepWoundTypeform.param1.focus();">
	...
	<FORM name="MrepWoundTypeform" id="MrepWoundTypeform" ACTION="../../eCommon/jsp/report_options.jsp" TARGET="messageFrame">
		...
		<TR>
			<TD ALIGN="left" WIDTH="25%" CLASS="label"><fmt:message key="eOT.WoundType.Label" bundle="${ot_labels}"/>&nbsp;</TD>
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE='text' name="param1" id="param1" SIZE="8" maxlength="8" onBlur="if(this.value!='')searchCode(document.all, 'WOUNDTYPE','<%=woundtype_title%>', document.forms[0].param1); else this.value='' " onKeyPress="return CheckForSpecChars(event)" tabIndex="1" >
				<INPUT TYPE="button" name="narrationFrom" id="narrationFrom" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'WOUNDTYPE','<%=woundtype_title%>', document.forms[0].param1)">
			</TD>
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE='text' name="param2" id="param2" SIZE="8" maxlength="8" onBlur="if(this.value!='')searchCode(document.all, 'WOUNDTYPE','<%=woundtype_title%>', document.forms[0].param2); else this.value='' " onKeyPress="return CheckForSpecChars(event)" tabIndex="2" >
				<INPUT TYPE="button" name="narrationTo" id="narrationTo" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'WOUNDTYPE','<%=woundtype_title%>', document.forms[0].param2)">
			</TD>
			<TD WIDTH="25%">&nbsp;</TD>
		</TR>
		<TR>
