...
<table align="center"  border="0" width="100%" cellspacing="0" cellpadding=3 >
   <tr width="100">
      <td colspan=3  class="label">
		...
		<fmt:message key="Common.OrderDateTime.label" bundle="${common_labels}"/> 
   	</td>
    ...
    <tr>
        <td class="label" colspan=3><fmt:message key="Common.searchtext.label" bundle="${common_labels}"/>
        <input type="text"   name="search_text" id="search_text" value="" width="30%" align="left" size="40" maxlength="70" >
        </td>
        <td><input type="button" align="left" name="Search" id="Search" value='<fmt:message key="Common.search.label" bundle="${common_labels}"/>' onClick="valtextorderid(search_text); this.disabled=true;" class="button" >
        <input type="button" align="left" name="Reset" id="Reset" value='<fmt:message key="Common.reset.label" bundle="${common_labels}"/>' onClick="resetFormorderid(this.form)" class="button" >
        </td>
    </tr>
	<tr>
	<td colspan='4'>
