...
<%@page  import ="java.sql.Connection,java.sql.Statement,java.sql.ResultSet,webbeans.eCommon.ConnectionManager"%>
...
<tr>
	...
	<td class='fields' width="25%" >
		<input type="text" name="surgery_date" id="surgery_date" size="10" maxlength=10 value="<%=surgery_date%>" onkeypress="return checkForSpecCharsforID(event);" onblur='if(!isValidDate(this)) this.value="";'  >
	...
	<td class='fields' width="25%" >
		<input type="text" name="surgery_date2" id="surgery_date2" size="10" maxlength=10 value="<%=surgery_date2%>" onkeypress="return checkForSpecCharsforID(event);" onblur='if(!isValidDate(this)) this.value="";'  > 
	...
	<td class='fields' width="25%"  >
	<!-- <input type="text" name="surgery_date" id="surgery_date" size="10" maxlength=10 value="<%=surgery_date%>" onBlur='checkDateFormat(this);'> -->
		<input type="text" name="order_date" id="order_date" size="10" maxlength=10 value="<%=order_date%>" onkeypress="return checkForSpecCharsforID(event);" onblur='if(!isValidDate(this)) this.value="";'  > 
	...
	<td class='fields' width="25%"  >
	<!-- <input type="text" name="surgery_date" id="surgery_date" size="10" maxlength=10 value="<%=surgery_date%>" onBlur='checkDateFormat(this);'> -->
		<input type="text" name="order_date2" id="order_date2" size="10" maxlength=10 value="<%=order_date2%>" onkeypress="return checkForSpecCharsforID(event);" onblur='if(!isValidDate(this)) this.value="";'  > 
...
<td class='fields' width="25%"></td>
<td class='fields' width="25%" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" class="button" name="search" id="search" value='<fmt:message key="Common.search.label" bundle="${common_labels}"/>'
		onClick="anesthesiaPatientDetails()">
		<!--against AAkH CRF-0069 <input type="button" class="button" name="clear" id="clear" 
		 value='<fmt:message key="Common.clear.label" bundle="${common_labels}"/>' 	onClick="funClearAll();">-->
	</td>
</tr>
</table>
