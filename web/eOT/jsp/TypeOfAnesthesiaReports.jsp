...
<tr>
	<td class='label' width='25%'>
     ...
     <td class='fields' width='25%'>
		...
		<input type='text' name='param3_desc' id='param3_desc' size='20' title='<%=procedure_title%>' param1 = 'param3'  param2 = 'param4' key ='PROCEDURE' onBlur="if(this.value!='')callCommonLookup(this); else param3.value='',param4.value='' " maxlength='70'> 
...
<!-- 	<td class='label' align='right'nowrap>To Procedure&nbsp;</td>
 ...
 -->
    ...
    <td class='fields' width='25%'>
		...
		<input type='text' name='param5_desc' id='param5_desc' size='20' title='<%=anaesthetist_title%>' param1 = 'param5'  param2 = 'param6' key ='ANAESTHETIST' onBlur="if(this.value!='')callCommonLookup(this); else param5.value='',param6.value='' " maxlength='70'> 
...
<tr>
	...
	<td class='label' width='25%'>
     ...
     <td class='fields' width='25%'>
		...
		<input type='text' name='param9_desc' id='param9_desc' size='20' title='<%=speciality_title%>' param1 = 'param9'  param2 = 'param10' key ='SPECIALITY' onBlur="if(this.value!='')callCommonLookup(this); else param9.value='',param10.value='' " maxlength='70'> 
...
<tr> 
	...
	<!-- /* this Code is only for Siriraj Purpose*/ <td class='label' align='right' nowrap><fmt:message key="Common.SurgeryType.label" bundle="${common_labels}"/> &nbsp;</td>
	<td align='left'>
