...
<tr>
    ...
    <td class='fields' width='25%'>
		...
		<input type='text' name='from_oper_room_desc' id='from_oper_room_desc' size='20' title='<%=operationRoom_title%>' param1 = 'p3'  param2 = 'p4' key ='OPER_ROOM' onBlur="if(this.value!='')callCommonLookup(this); else callClearParam(p3,p4); " onkeypress="return CheckForSpecChars_local(event);"  maxlength='70'> 
...
<tr>
    ...
    <td class='fields' width='25%'>
		...
		<input type='text' name='param7_desc' id='param7_desc' size='20' title='<%=surgeon_title%>' param1 = 'p7'  param2 = 'p8' key ='SURGEON' onBlur="if(this.value!='')callCommonLookup(this); else p7.value='',p8.value='' " maxlength='70' onkeypress="return CheckForSpecChars_local(event);"> 
    ...
    <td class='fields' width='25%'>
		...
		<input type='text' name='param9_desc' id='param9_desc' size='20' title='<%=speciality_title%>' param1 = 'p9'  param2 = 'p10' key ='SPECIALITY' onBlur="if(this.value!='')callCommonLookup(this); else p9.value='',p10.value='' " maxlength='70' onkeypress="return CheckForSpecChars_local(event);"> 
