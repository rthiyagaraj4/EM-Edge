...
function createTable(){   
  ...
  tab_data+="<th class='columnHeaderCenter'> <fmt:message key="Common.Instrument.label" bundle="${common_labels}"/></th>"
  tab_data+="<th class='columnHeaderCenter'><fmt:message key="eOT.ActualUnits.Label" bundle="${ot_labels}"/></th>"
  tab_data+="<th class='columnHeaderCenter'><fmt:message key="Common.TrayNo.label" bundle="${common_labels}"/></th>"
		   ...
		   if(rows[jj]!=null  && rows[jj].db_mode!='D'){
			    ...
			    if(jj%2==0)
			     ...
			     <% if( nursing_doc_comp_yn.equals("Y") ) { %> 
				   ...
				   tab_data+="<td nowrap class="+qryVal+"><B><font color='Indigo' ><fmt:message key="Common.total.label" bundle="${common_labels}"/>:&nbsp;"+arr[0]+"</font>&nbsp;&nbsp;<font color='crimson' ><fmt:message key="eOT.Payable.Label" bundle="${ot_labels}"/>:&nbsp;"+arr[1]+"</font>&nbsp;&nbsp;<font color='green' ><fmt:message key="Common.Paid.label" bundle="${common_labels}"/>:&nbsp;"+arr[2]+"</font></B>";
