...
<tr>
	<td class='label'>
     ...
     <td class='fields'>
		...
		<input type='text' name='param3_desc' id='param3_desc' size='20'  onBlur="if(this.value!='')srchCommonCode(param3,param3_desc, param4, '<%=procedure_title%>', document.forms[0].sql_text_1.value );else param3.value='' "> 
		<input type='button' class='button' value='?' name='OperCodeLookUp' id='OperCodeLookUp' onClick="srchCommonCode(param3,param3_desc, param4, '<%=procedure_title%>', document.forms[0].sql_text_1.value );" >
	</td>
    ...
    <td class='fields' width='25%'>
		...
		<input type='text' name='param5_desc' id='param5_desc' size='20'   onBlur="if(this.value!='')searchSurgeon(param5,param5_desc,param6,'<%=anaesthetist_title%>', document.forms[0].sql_text_3.value);else param5.value='' " > 
		<input type='button' class='button' value='?' name='SurgeonLookUp' id='SurgeonLookUp' onClick="searchSurgeon(param5,param5_desc,param6,'<%=anaesthetist_title%>', document.forms[0].sql_text_3.value);" >
	</td>
...
<tr>
	<td class='label'>
     ...
     <td class='fields'>
		...
		<input type='text' name='param7_desc' id='param7_desc' size='20'  onBlur="if(this.value!='')srchCommonCode(param7,param7_desc, param8,'<%=anaesthesia_title%>', document.forms[0].sql_text_5.value );else param7.value='' " > 
		<input type='button' class='button' value='?' name='OperTypeLookUp' id='OperTypeLookUp' onClick="srchCommonCode(param7,param7_desc, param8,'<%=anaesthesia_title%>', document.forms[0].sql_text_5.value ); " >
	</td>
    ...
    <td class='fields'>
		...
		<input type='text' name='param9_desc' id='param9_desc' size='20'   onBlur="if(this.value!='')srchCommonCode(param9,param9_desc,param10,'<%=speciality_title%>',document.forms[0].sql_text_2.value);else param9.value='' "> 
		<input type='button' class='button' value='?' name='SpecialityLookUp' id='SpecialityLookUp' onClick="srchCommonCode(param9,param9_desc,param10,'<%=speciality_title%>',document.forms[0].sql_text_2.value);" >
	</td>
