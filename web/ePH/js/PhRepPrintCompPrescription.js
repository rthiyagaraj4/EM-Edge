...
if(pat_id=="") {
	...
	if(patient_id !="" || orig_order_id != ""){
		   ...
		   parent.messageFrame.location.href="../../eCommon/jsp/error.jsp?err_num=";
			parent.f_query_results.location.href="../../ePH/jsp/PhRepPrintCompPrescriptionResult.jsp?patient_id="+patient_id+"&orig_order_id="+orig_order_id+"&order_date_from="+order_date_from+"&encounter_id="+encounter_id+"&pres_practitioner_id="+pres_practitioner_id+"&locn_type="+locn_type+"&locn_code"+locn_code+"&iv_type=6";
	...
	var locn_type=formObj.locn_type.value;
	var locn_code=formObj.locn_code.value;
	parent.f_query_results.location.href="../../ePH/jsp/PhRepPrintCompPrescriptionResult.jsp?patient_id="+patient_id+"&orig_order_id="+orig_order_id+"&order_date_from="+order_date_from+"&encounter_id="+encounter_id+"&pres_practitioner_id="+pres_practitioner_id+"&locn_type="+locn_type+"&locn_code"+locn_code;
		parent.f_query_status.location.href="../../ePH/jsp/PhRepPrintPrescriptionStatus.jsp";
}
}
...
async function showReportPrescription(order_id,patient_id,encounter_id,patient_class,locn_code,iv_type){
	...
	var arguments	= "" ;
	var retVal = await window.showModalDialog("../../ePH/jsp/PhRepPrintIVPrescriptionWindow.jsp?order_id="+order_id+"&patient_id="+patient_id+"&encounter_id="+encounter_id+"&patient_class="+patient_class+"&locn_code="+locn_code+"&iv_type=6",arguments,features);
}
