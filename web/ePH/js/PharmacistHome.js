...
async function showLoginWindow(identityForSwitch){
	...
	var dialogHeight= "10" ;//10
	var dialogWidth	= "30" ;//30
	var dialogTop = "195" ;//195
	var center = "1" ;
	var status="no";
...
function switchToLogin(){
	parent.parent.document.getElementById("content").src="../../ePH/jsp/PharmacistHome.jsp?identityForSwitch=Switch";
}
	...
	//alert("func 2");
		...
		if(checkFlds( fields, names)){
			...
			if(result){
				...
				dialogBody.contentWindow.returnValue = "PROCEED";
...
function goHome(){
	...
	parent.parent.document.getElementById('dialog-body').contentWindow.returnValue="GOHOME";
...
function loadOrUnloadMenus(obj1){
	...
	if(obj1.name == 'ShowMenu' ){
		...
		parent.document.getElementById("menuFrame").style.width = "13vw";
		parent.document.getElementById("matFrame").style.width = "13vw";
		parent.document.getElementById("workAreaFrame").style.width = "82vw";
	}
		...
		parent.document.getElementById("menuFrame").style.width = "0vw";
		parent.document.getElementById("matFrame").style.width = "0vw";
		parent.document.getElementById("workAreaFrame").style.width = "99vw";
	}
	//parent.workArea.removeAttribute(cols);
	//parent.workArea.cols = cols;
	//parent.workAreaFrame.removeAttribute('cols');
	//parent.workAreaFrame.cols = cols;
