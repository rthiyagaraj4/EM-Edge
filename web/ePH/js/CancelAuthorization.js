...
async function displayPending(trObj) {
	...
	retVal=await window.showModalDialog("../../eST/jsp/CancelRequestList.jsp?function_id="+parent.parent.function_id+"&doc_type_code="+doc_type_code+"&doc_no="+doc_no,'','dialogHeight:15; dialogWidth:40; center:0; status: no; dialogLeft :75; dialogTop :250;');
