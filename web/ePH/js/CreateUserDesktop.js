function create() { 
	//f_query_add_mod.location.href = "../../ePH/jsp/AddModifyCreateUserDesktop.jsp" ;
	//f_query_add_mod1.location.href = "../../ePH/jsp/AddModifyCreateUserDesktopResult.jsp" ;
	f_query_add_mod.location.href = "../../ePH/jsp/AddModifyCreateUserDesktopFrame.jsp" ;
}
	...
	function Getvalues(obj)
{
   ...
   HTMLVal = "<html><head><link rel='stylesheet' type='text/css' href='../../eCommon/html/IeStyle.css'></head><BODY class='message'><form name='form1' id='form1' method='post' action='../../ePH/jsp/GetUserDesktopValue.jsp'><input type='hidden' name='module_id' id='module_id' value='"+module_id+"'></form></BODY></HTML>";
