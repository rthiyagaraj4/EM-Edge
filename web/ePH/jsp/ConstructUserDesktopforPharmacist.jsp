...
<body class='CONTENT' OnMouseDown='CodeArrest()'  onKeyDown ='lockKey()' >
	...
	<tr>
			<td class='fields' ><b><fmt:message key="eSM.Summary.label" bundle="${sm_labels}"/>&nbsp;<fmt:message key="Common.Header.label" bundle="${common_labels}"/></b><br>
			<Select name="Menuopts" id="Menuopts"   <%=disableval%> rowspan="5" size="50" style="HEIGHT: 140px; WIDTH: 275px" Onclick="Menufun()">
		<% // 187px   275px
