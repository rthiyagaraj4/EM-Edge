	...
	<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
		...
		<td align="left">
				<select name="p_rep_type" id="p_rep_type" style="width:150px" onChange="changeLegends(this);">
					<option value ="D"><fmt:message key="ePH.ByDispensingLocation.label" bundle="${ph_labels}"/> </option>
					<option value ="M"><fmt:message key="ePH.ByMonth.label" bundle="${ph_labels}"/></option>
				</select>&nbsp;<img src="../../eCommon/images/mandatory.gif"  align="center">
			</td>	
		</tr>
		<tr><td class='label' colspan='4' height='6'></td></tr>
		<tr>
		<td align="right" class="label" id='date_from' style="display:inline"><fmt:message key="Common.date.label" bundle="${common_labels}"/></td>
		...
		<td align="right" class="label" id="month_year_from" style="display:none"><fmt:message key="Common.Month/Year.label" bundle="${common_labels}"/></td>	
