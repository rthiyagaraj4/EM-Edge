...
<body onMouseDown="CodeArrest()" onKeyDown="lockKey()"  onload="document.formPHRepDrugList.p_from_genid.focus();">
	...
	<TABLE WIDTH="70%" ALIGN="center" CELLPADDING="0" CELLSPACING="0" BORDER="0">
		...
		<TR>
	<TD ALIGN="right" WIDTH="30%" CLASS="label"><fmt:message key="Common.DrugCode.label" bundle="${common_labels}"/>&nbsp;</TD>
		...
		<TR>
			...
			<TD COLSPAN="2" ALIGN="left">
				<SELECT name="p_orderby" id="p_orderby" tabIndex="10">
					<OPTION VALUE="2"><fmt:message key="Common.DrugCode.label" bundle="${common_labels}"/></OPTION>
