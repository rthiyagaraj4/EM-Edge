...
<% } %>
	<iframe name="f_query_add_mod" id="f_query_add_mod" frameborder="0" scrolling="no" noresize src="../../ePH/jsp/SRRPhRepPrescriptionCriteria.jsp?patient_id=<%=patient_id%>&order_type=<%=sOrderType%>" style="height:23vh;width:100vw"></iframe>
