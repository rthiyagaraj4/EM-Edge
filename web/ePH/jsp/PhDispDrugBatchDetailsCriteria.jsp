...
<form name="PhDispDrugBatchDetails" id="PhDispDrugBatchDetails" ACTION="../../eCommon/jsp/report_options.jsp"    TARGET="messageFrame">
	...
	<tr>
        <td class="label"><fmt:message key="ePH.DispensedDrugName.label" bundle="${ph_labels}"/></td>
