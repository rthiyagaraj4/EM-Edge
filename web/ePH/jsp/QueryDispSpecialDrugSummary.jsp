...
<%
	...
	String sql=PhRepository.getPhKeyValue("SQL_QUERY_DISP_SPECIAL_DRUG_SUMMARY");
	...
	%>
		...
		<tr>
		<th align="left"><fmt:message key="ePH.SpecialDrugs.label" bundle="${ph_labels}"/></th>
		</tr>
		</table>
<%
	...
	%>
		<table border="1" cellpadding="0" cellspacing="0" width="100%" align="center" topmargin='0'>
				<th width="34%">Drug Name</th>
				<th width="22%" ><fmt:message key="ePH.NoofPatients.label" bundle="${ph_labels}"/></th>
				<th width="22%">Qty Dispensed</th>
				<th width="22%">Returned Qty</th>
				</tr>
