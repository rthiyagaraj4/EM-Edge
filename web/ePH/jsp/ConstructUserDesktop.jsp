	...
	%>	
						...
						<table border="0" cellspacing="0" cellpadding="3" width="100%" align='center'>
							<tr>
								...
								<Select name="funcopt" id="funcopt"  <%=disableval%> rowspan="5"  valign="top" size="5" style="HEIGHT: 140px; WIDTH: 275px" Onclick="clearfun()" >
<%
...
%>
						...
						<Select name="MainMenus" id="MainMenus"   <%=disableval%> size="15" style="HEIGHT: 290px; WIDTH: 337px" Onclick="putVal()" scrolling="auto">
						</td> <!-- 390px   337px -->
						<td class='label' >&nbsp;</td>
				  </tr>
				  <tr>
