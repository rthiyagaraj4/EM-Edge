		...
		<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
			<tr >
				<td class='label' >
					...
					<input type="text" name="TotInfVolume" id="TotInfVolume" value="<%=tot_volume%>" readonly style="text-align:right"><label id='TotInfVolUnit' maxlength='10'><%=stock_uom_desc%></label> <!-- Changed stock_uom_code to stock_uom_desc , SKR-SCF-0215.1 -->
				</td>
				<td class='label' >
...
%>
			<tr>
				<td class='label' >&nbsp;1</td>
				<td class='label' >
					<input type="text" name="InfVolume1" id="InfVolume1" class="number" value="<%=volume%>"  maxlength='5' size='5' onKeyPress="return allowValidNumber(this,event,5,0);" onchange="showValidateGif(1)"><label id='InfVolUnit1'><%=stock_uom_desc%></label><!-- Changed stock_uom_code to stock_uom_desc , SKR-SCF-0215.1 -->
				</td>
				<td class='label' >
				<!-- Changed stock_uom_code to stock_uom_desc , SKR-SCF-0215.1 -->
...
%>
		...
		<table align='right'>
			...
			<tr align='right'>
				<td  class="white" align='right'> 
					<input type="button" value='<fmt:message key="Common.ok.label" bundle="${common_labels}"/>'  class="button" onClick="saveMFR();">
				</td>
				<td>
		...
		<input type="hidden" name="site_MFR_greater_than_24hr" id="site_MFR_greater_than_24hr" value='<%=site_MFR_greater_than_24hr%>'>
