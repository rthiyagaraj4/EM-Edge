	...
	String to = CommonBean.checkForNull(request.getParameter("to"));
	  ...
	  int query_result_size		= 14;
		...
		if ( to == null || to.equals(""))
			...
			result=bean.MedicationList(patient_id,fr_dispdate,to_dispdate,p_encounter,p_fr_pre,p_tokfr,p_tokto,p_disp_locn_code,locn_type,p_locn_code,p_fill_id,p_facility_id,locale);
...
if( (result != null && result.size()>0)){ %>
 ...
 <%
       ...
       for( int j=1; j<start; i++,j++ ) {   }
		...
		//record[0]=com.ehis.util.DateUtils.convertDate(record[0],"DMY","en",locale); Commented By Sandhya for incident 25075
	...
	%>
		<tr>
			<td class="<%=classvalue%>" style="font-size=9" nowrap><%=com.ehis.util.DateUtils.convertDate(record[0],"DMY","en",locale)%></td>
