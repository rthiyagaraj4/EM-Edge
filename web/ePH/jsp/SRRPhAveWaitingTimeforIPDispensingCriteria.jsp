...
%>
	...
	<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
		...
		<td COLSPAN="3" align="left"><SELECT name="p_report_type" id="p_report_type"  onChange="disable()" style="width:150px">
			...
			<option value ="F"><fmt:message key="ePH.FillWithoutFillList.label" bundle="${ph_labels}"/></option>	
			<option value ="V"><fmt:message key="ePH.Verification.label" bundle="${ph_labels}"/></option>	
    	  </select>
        </td>
    </tr>
	<tr><td class='label' colspan='4' height='6'></td></tr>
		...
		<tr><td class='label' colspan='4' height='6'></td></tr>
		<tr>
        <td align="right" class="label"><fmt:message key="ePH.DailySeqNo.label" bundle="${ph_labels}"/></td>	
			<td  align="left">
		...
		<tr><td class='label' colspan='4' height='6'></td></tr>
		<tr>
		<td  class='label' align ='left'><label><fmt:message key="ePH.IntervalOption.label" bundle="${ph_labels}"/></td>
		<td>
		...
		<td colspan='4' class="label"><fmt:message key="ePH.TypeofOrder.label" bundle="${ph_labels}"/>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="p_type_order" id="p_type_order" style="width:150px"><option value="ALL" selected><fmt:message key="Common.all.label" bundle="${common_labels}"/></option>
