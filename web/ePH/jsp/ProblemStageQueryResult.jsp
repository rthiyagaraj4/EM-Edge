...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	function Modify(obj){
		...
		document.location.href="ProblemStageAddModify.jsp?mode=2&code="+code+"&function_id="+parent.function_id;
	}
	</script>
 ...
 <%
    ...
    String problem_stage_id		= request.getParameter("problem_stage_id").trim();
    String problem_stage_short_desc = request.getParameter("problem_stage_short_desc").trim();
    String problem_stage_long_desc = request.getParameter("problem_stage_long_desc").trim();
    String eff_status			= request.getParameter("eff_status").trim();

	if(indicator == null){indicator = "";}
	if(problem_stage_id == null){problem_stage_id = "";}else{problem_stage_id = problem_stage_id.toUpperCase();}
	if(problem_stage_short_desc == null){problem_stage_short_desc = "";}
	if(problem_stage_long_desc == null){problem_stage_long_desc = "";}
	...
	sqlMap.put( "sqlData", PhRepository.getPhKeyValue("SQL_PH_PROBLEM_STAGE_SELECT"));
	...
	chkFields.add( problem_stage_id + "%");
	chkFields.add( problem_stage_long_desc + "%");
	chkFields.add( problem_stage_short_desc + "%");
...
//					out.println("IBA");
		...
		<script>alert(getMessage("NO_RECORD_FOUND_FOR_CRITERIA","Common"));history.go(-1);</script>
			<%}out.println(CommonBean.setForm(request ,"ProblemStageQueryResult.jsp", searched));
	}
	catch(Exception e) {
