...
<% 
					...
					if(!ord_qty.equals("")){
%>
						<td class='<%=classValue%>' style="font-size:9" width="6%" id='td_ord_qty_<%=count%>'>&nbsp;&nbsp;<%=ord_qty%>&nbsp;<b><%=(String)cons_item_dtl.get("ORDER_UOM")%></b></td>
<%
					}
					else{
%>	
