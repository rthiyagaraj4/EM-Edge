...
if(document.forms[0].expectedvalue2.value=='Y')
 ...
 fields = new Array ( 
					     document.forms[0].expected_value,document.forms[0].expected_value2,document.forms[0].Position_value,document.forms[0].derivation_type,document.forms[0].execution_order
					   );
 names = new Array (getLabel("eXH.ExpectedValue.Label","XH"),getLabel("eXH.ExpectedValue2.Label","XH"),getLabel("eXH.Position.Label","XH"),getLabel("eXH.DerivationType.Label","XH"),getLabel("eXH.ExecOrder.Label","XH"));
 ...
 fields = new Array ( 
					     document.forms[0].expected_value,document.forms[0].Position_value,document.forms[0].derivation_type,document.forms[0].execution_order
					   );

 names = new Array (getLabel("eXH.ExpectedValue.Label","XH"),getLabel("Common.Position.label","common"),getLabel("eXH.DerivationType.Label","XH"),getLabel("eXH.ExecOrder.Label","XH"));
...
if(document.forms[0].expectedvalue2.value=='Y')
 ...
 fields = new Array ( 
					    document.forms[0].expected_value2,document.forms[0].Position_value,document.forms[0].derivation_type,document.forms[0].execution_order
					   );

 names = new Array (getLabel("eXH.ExpectedValue2.Label","XH"),getLabel("Common.Position.label","common"),getLabel("eXH.DerivationType.Label","XH"),getLabel("eXH.ExecOrder.Label","XH"));
		}
else
		{

		fields = new Array ( 
					   document.forms[0].Position_value,document.forms[0].derivation_type,document.forms[0].execution_order
					   );
		 names = new Array (getLabel("Common.Position.label","common"),getLabel("eXH.DerivationType.Label","XH"),getLabel("eXH.ExecOrder.Label","XH"));
		}
