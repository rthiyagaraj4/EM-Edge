...
function funModify(obj)
{
	...
	this.document.forms[0].field_acc_no.value = obj.getAttribute('field_acc_no');
	this.document.forms[0].field_seperator.value = obj.getAttribute('field_seperator');
	this.document.forms[0].query_text.value = obj.getAttribute('query_text');
	this.document.forms[0].sys_def_struct.value = obj.getAttribute('sys_def_struct');
