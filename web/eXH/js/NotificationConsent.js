...
function create()
{
	window.transactionFrame.location.href = "../../servlet/eXH.NotificationConsentServlet?requestType=CREATE";	
	window.messageFrame.location.href = "../../eCommon/html/blank.html";
}

function query()
{
	window.transactionFrame.location.href = "../../eXH/jsp/NotificationConsentQueryCriteria.jsp";
	window.messageFrame.location.href = "../../eCommon/html/blank.html";
}

function funModify(obj)
{
	document.forms[0].action = "../servlet/eXH.NotificationConsentServlet?requestType=CONSENT_INFO&typeCode="+obj.typeCode;	
