...
<title>Electronic Remittance Advice</title>
	...
	<iframe name='f_query_add_mod' id='f_query_add_mod' src="../../eXH/jsp/MediERATransactionMaster.jsp?<%=params%>" frameborder=0  scrolling='no' style='height:12vh;width:100vw'></iframe>
