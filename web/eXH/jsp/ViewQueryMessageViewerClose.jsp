...
<input type='hidden'  name='whereClause' id='whereClause' id='whereClause' value='<%=whereClause%>'>

<td class=white align='right'><%if(protocolMode.equals("O"))
{
%><input  type='button' class='button' value='<fmt:message key="eXH.Rebuild.Label" bundle="${xh_labels}"/>'  onClick="processMSG('rebuild')"  <%=rebuildop.equals("true")?"":"disabled"%> ><input  type='button' class='button' value='<fmt:message key="eXH.Replay.Label" bundle="${xh_labels}"/>' onClick="processMSG('replay')" <%=replayop.equals("true")?"":"disabled"%>  >
<%} 
else if(protocolMode.equals("I")) 
{ 
%><input  type='button' class='button' value='<fmt:message key="eXH.Reload.Label" bundle="${xh_labels}"/>' onClick="processMSG('reload')"  <%=reloadop.equals("true")?"":"disabled"%> ><%}%><input  type='button' class='button' value='<fmt:message key="Common.close.label" bundle="${common_labels}"/>' onClick='windowclose()'></td></tr>  	
