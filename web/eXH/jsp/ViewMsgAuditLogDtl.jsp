...
<input  type="hidden" name=appl_name value='<%=appl_name%>' />
<input  type="hidden" name=facility value='<%=facility%>' />
<input  type="hidden" name=event_type value='<%=event_type%>' />
<input  type="hidden" name=msg_type value='<%=msg_type%>' />
<input  type="hidden" name=status value='<%=status%>' />
<input  type="hidden" name=msg_id value='<%=msg_id%>' />
<input  type="hidden" name=amsg_dt1 value='<%=amsg_dt1%>' />
<input  type="hidden" name=amsg_dt2 value='<%=amsg_dt2%>' />
...
<tr>
	<td class='COLUMNHEADER' align="center"><a name='MESSAGE_ID' id='MESSAGE_ID' href="javascript:callSort('MESSAGE_ID');" ><font color=white><fmt:message key="eXH.MessageID.Label" bundle="${xh_labels}"/></font></td> 
	<td class='COLUMNHEADER' align="center"><a name='FACILITY_ID' id='FACILITY_ID'  href="javascript:callSort('FACILITY_ID');" ><font color=white><fmt:message key="Common.facility.label" bundle="${common_labels}"/></font></td>
	<td class='COLUMNHEADER' align="center"><a name='STATUS' id='STATUS'  href="javascript:callSort('STATUS');" ><font color=white><fmt:message key="Common.action.label" bundle="${common_labels}"/></font></td>
   	<td class='COLUMNHEADER' align="center"><a name='PROCESS_DATE_TIME' id='PROCESS_DATE_TIME' href="javascript:callSort('PROCESS_DATE_TIME');" ><font color=white><fmt:message key="Common.ActionDateTime.label" bundle="${common_labels}"/></font></td>
	<td class='COLUMNHEADER' align="center"><a name='PROCESSED_BY' id='PROCESSED_BY'  href="javascript:callSort('PROCESSED_BY');" ><font color=white><fmt:message key="eXH.ActionBy.Label" bundle="${xh_labels}"/></font></td>
	<td class='COLUMNHEADER' align="center"><a name='EVENT_TYPE' id='EVENT_TYPE'  href="javascript:callSort('EVENT_TYPE');" ><font color=white><fmt:message key="Common.Event.label" bundle="${common_labels}"/></font></td>		
	<td class='COLUMNHEADER' align="center"><a name='STATUS' id='STATUS'  href="javascript:callSort('STATUS');" ><font color=white><fmt:message key="eXH.OldMessageStatus.Label" bundle="${xh_labels}"/></font></td>
<%if(commMode != null && commMode.equals("O")){%>
	<td class='COLUMNHEADER' align="center"><a name='END_DATE_TIME' id='END_DATE_TIME'  href="javascript:callSort('END_DATE_TIME');" ><font color=white><fmt:message key="eXH.OldCommDateTime.Label" bundle="${xh_labels}"/></font></td>
	<td class='COLUMNHEADER' align="center"><a name='COMM_RETRIES' id='COMM_RETRIES'  href="javascript:callSort('COMM_RETRIES');" ><font color=white><fmt:message key="eXH.Retries.Label" bundle="${xh_labels}"/></font></td>
<%}%>
	<td class='COLUMNHEADER' align="center"><a id='PROCESS_ID' id='PROCESS_ID'  href="javascript:callSort('PROCESS_ID');" ><font color=white><fmt:message key="Common.ProcessID.label" bundle="${common_labels}"/></font></td>    
...
<td <%=strTDClass%>><font size=1><%=((String)arrCol.get(2)).equals("null")?"&nbsp;":arrCol.get(2)%></font></td>
<td <%=strTDClass%>><font size=1><%=""+arrCol.get(10)%></font></td>
<td <%=strTDClass%>><font size=1><%=""+strProcessDate%></font></td>
<td <%=strTDClass%>><font size=1><%=((String)arrCol.get(6)).equals("null")?"&nbsp;":arrCol.get(6)%></font></td>
<td <%=strTDClass%> align="center"><font size=1><%=((String)arrCol.get(4)).equals("null")?"&nbsp;":arrCol.get(4)%></font></td>
<td <%=strTDClass%>><font size=1><%=""+int_status%></font></td>
<%if(commMode != null && commMode.equals("O")){%>
...
<%}%>
<td <%=strTDClass%> align="center"><font size=1><%=((String)arrCol.get(5)).equals("null")?"&nbsp;":arrCol.get(5)%></font></td>
</tr>
<%
}
}
