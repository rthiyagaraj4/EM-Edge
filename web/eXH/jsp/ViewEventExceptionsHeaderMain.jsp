...
%>     
	<iframe name='f_query_header' id='f_query_header' src='../../eXH/jsp/ViewEventExceptionsHeader.jsp?<%=params%>' frameborder=0 noresize scrolling='no' style='height:100vh;width:12vw'></iframe>
		<iframe name='messageFrame' id='messageFrame'	 src='../../eXH/jsp/ViewSegmentsTreeMain.jsp?<%=params%>&img=Y' frameborder=0 noresize scrolling='auto' style='height:100vh;width:8vw'></iframe>
