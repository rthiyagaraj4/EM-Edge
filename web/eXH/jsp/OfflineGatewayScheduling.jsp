...
<tr>
<td class='COLUMNHEADER' align=center><fmt:message key="eXH.ProtocolLinkId.Label" bundle="${xh_labels}"/></td>
...
<td><input class=Button type='button' name='deltebutton' id='deltebutton' value='<fmt:message key="Common.delete.label" bundle="${common_labels}"/>' onClick="DeleteRecord('<%=arrCol.get(7)%>')" ></td>
</tr>
<%
}
if (boolToggle == true)
...
<td <%=strTDClass%> ><select name='month' id='month' id='month' >
...
<td <%=strTDClass%> ><select name='day' id='day' id='day' >
<option value=''>---<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>------</option>
...
<td <%=strTDClass%> ><select name='datenumber' id='datenumber' id='datenumber' >
<option value=''>-----<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>------</option>
...
<td <%=strTDClass%> ><!--<input type='text' size='15' name='to_sleep_time' id='to_sleep_time'  id='to_sleep_time' onblur='checkvalueFormat(this);checkFormat(this);' onkeypress='checkFormat(this);return CheckForSpecCharsforID(event);' onChange='checkFormat(this);checkvalueFormat(this);' maxlength=5  >--->
