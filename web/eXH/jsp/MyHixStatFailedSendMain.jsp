...
<title>Statistics of Failed Send Summary</title>
	...
	<iframe name='f_query_add_mod' id='f_query_add_mod' src="../../eXH/jsp/MyHixStatFailedSendMaster.jsp?<%=params%>" frameborder=0  scrolling='no' style='height:24.5vh;width:100vw'></iframe>
