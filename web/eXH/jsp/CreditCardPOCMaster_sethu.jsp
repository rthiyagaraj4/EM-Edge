...
<body onload = "loadPage()">
	...
	<table border="1" cellpadding="3" cellspacing="0" align = "center" width="800">	
		...
		<tr>	
			<td width="25%" align=left class="label">	Insurance ID &nbsp;		
				<input class="textbox" type="textbox" id="patientId" name="patientId" id="patientId" value="12345678" size="12"> 
			</td>
			<td width="25%" align=left class="label">	Amount &nbsp;		
				<input class="textbox" type="textbox" id="amount" name="amount" id="amount" value="150" size="10"> 
			</td>
			<td width="25%" align=left class="label">	Transaction ID &nbsp;			
				<input class="textbox" type="textbox" id="transactionId" name="transactionId" id="transactionId" value="101" size="10"> 
			</td>			
			<td width="25%" align=left>				
				<input class="button" type="button"  id="paysky" name="paysky" id="paysky" value="PaySky Payments"> 
			</td>
		</tr>
		<tr>	
			<td width="25%" align=left class="label">	EM Order ID &nbsp;		
				<input class="textbox" type="textbox" id="merchantId" name="merchantId" id="merchantId" size="12"> 
			</td>
			<td width="25%" align=left class="label">	PaySky ID &nbsp;		
				<input class="textbox" type="textbox" id="payskyId" name="payskyId" id="payskyId" size="10"> 
			</td>
			<td width="25%" align=left class="label" colspan="2">Date & Time&nbsp;			
				<input class="textbox" type="textbox" id="datetime" name="datetime" id="datetime" size="10"> 
			</td>			
		</tr>
	</table>
	...
	<table border="1" cellpadding="3" cellspacing="0" align = "center" width="800">	
		...
		<tr>	
			...
			<td width="13%" class="fields"><select id="Request_Type" name="Request_Type" id="Request_Type">
			...
			<td align=left width="13%">					
				<input class="textbox" type="textbox" id="Facility_Id"  name="Facility_Id" id="Facility_Id" value="A1"> &nbsp;&nbsp;&nbsp;&nbsp;
			</td>
		...
		<tr>	
			...
			<td width="13%" align=left >				
				<input class="textbox" type="textbox" id="Added_By_id" name="Added_By_id" id="Added_By_id" value="RAO"> 
			</td>
			<td width="12%" class="label">Workstation ID</td>			
			<td width="13%" align=left >					
				<input class="textbox" type="textbox" id="Workstation_id"  name="Workstation_id" id="Workstation_id" value="IN-PF2DPDB7a"> &nbsp;&nbsp;&nbsp;&nbsp;
			</td>				
