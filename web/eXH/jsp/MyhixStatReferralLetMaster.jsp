...
<tr>
	<td class=label width="15%"><fmt:message key="Common.fromdate.label" bundle="${common_labels}"/></td>
		...
		<td class='fields'>
			<input type=text name=P_FM_DATE id="trans_from_dt" value="<%=trans_from_dt %>" size=11  > <input type='image' id="trans_from_dt_img" src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('trans_from_dt','dd/mm/y');"  >
		</td>	
        
        <td class=label width="15%"><fmt:message key="Common.todate.label" bundle="${common_labels}"/></td>
	
		<td class='fields'>
			<input type=text name=P_TO_DATE id="trans_to_dt" value="<%=trans_to_dt %>" size=11  > <input type='image' id="trans_to_dt_img" src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('trans_to_dt','dd/mm/y');">
		</td>		
</tr>
<tr>
...
<input type="hidden" name="p_facility_id" id="p_facility_id"						    value="<%=p_facility_id%>">
	...
	<input type="hidden" name="p_report_id" id="p_report_id"		id="p_report_id"	value="XHREFLETT">	
	<input type="hidden" name="p_detail_rep" id="p_detail_rep"	id="p_detail_rep"   value="N">
    <input type="hidden" name="p_msg_status" id="p_msg_status"	id="p_msg_status"   value="N">
