	...
	<td class=label width="10%"><fmt:message key="Common.status.label" bundle="${common_labels}"/></td>
			<td class='fields'>
				<select id='p_msg_status' name="p_msg_status" id="p_msg_status" style="width:150px">
				   ...
				   <option value = ''><fmt:message key="Common.Success.label" bundle="${common_labels}"/></option>
				   <option value = ''><fmt:message key="Common.Failure.label" bundle="${common_labels}"/></option>
