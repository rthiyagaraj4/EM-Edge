...
<iframe name='f_query_add_mod' id='f_query_add_mod' src='../../eXH/jsp/XHMessageViewerSimulator.jsp?function_id=<%=function_id%>' frameborder=0 scrolling='no' style='height:75vh;width:100vw'></iframe>
