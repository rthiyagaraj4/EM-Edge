...
<script Language="JavaScript">
	...
	*/
	...
	function spectraWebPayments(){
		...
		+"&Request_type="+document.getElementById("sReqType").value+"&WaitTime=60&Ws_url="+document.getElementById("sWeburl").value
	...
	function checkAlert(){
		...
		PaymentResultCheck(alertMessage);
		
	}
	
	function PaymentResultCheck(pmtObj) {
		
		
		alert("Document Mode in Payment Page : "+document.documentMode);		
		
	    alert("Inside PaymentResultCheck - Payment Object JSON - " + pmtObj);
		

	    pmtObj = JSON.parse(pmtObj);
	    alert("Inside PaymentResultCheck - Payment Object - " + pmtObj);	
	    var jsonResult = JSON.parse(pmtObj.JsonResult);
	    
	   
	    alert("Inside PaymentResultCheck - Json Result - " + JSON.stringify(jsonResult));	
	    ...
	    */
	    ...
	    alert("Inside PaymentResultCheck - Response - " + returnStr);
...
<body onload = "loadPage()">
	...
	<table border="1" cellpadding="3" cellspacing="0" align = "center" width="800">	
		...
		<tr>			
			...
			<td width="25%" class="fields"><input type="text" name="wait_time" id="wait_time" id="wait_time" size="14" maxlength="10" value = "30"  style="text-align:left"> </td>		
		</tr>
		<tr>			
			<td align=left COLSPAN="2">				
				<!--<input class="button" type="button"  name="Eligibility Check" id="Eligibility Check" value="Eligibility Check" onClick="getEligibilityCheck();"> -->
				<!--<input class="button" type="button"  name="Show PDF File" id="Show PDF File" value="Show PDF File" onClick="showPDFFile();">-->
				<input class="button" type="button"  name="Nuhdeek" id="Nuhdeek" value="Nuhdeek" onClick="ShowURL();">
			</td>	
		...
		<tr>			
			<td align=left COLSPAN="2">				
				...
				<input class="button" type="button"  name="Generate OTP" id="Generate OTP" value="Generate OTP" onClick="validOTPTransaction("GENERATE_OTP");">
			</td>
			
			<td align=left COLSPAN="2">				
				<!--<input class="button" type="button"  name="Eligibility Check" id="Eligibility Check" value="Eligibility Check" onClick="getEligibilityCheck();"> -->
				<input class="textbox" type="textbox"  name="OTP" id="OTP" value=""> &nbsp;&nbsp;&nbsp;&nbsp;
				<input class="button" type="button"  name="Validate OTP" id="Validate OTP" value="Validate OTP" onClick="validOTPTransaction('VALIDATE_OTP');">
			</td>
	...
	<table border="1" cellpadding="3" cellspacing="0" align = "center" width="800">		
		<tr>	
			...
			<td align=left COLSPAN="2">				
				<!--<input class="button" type="button"  name="Eligibility Check" id="Eligibility Check" value="Eligibility Check" onClick="getEligibilityCheck();"> -->
				<input class="textbox" type="textbox" id="practitionerid" name="practitionerid" id="practitionerid" value=""> 
			</td>
			<td width="25%" class="label">Patient ID</td>			
			<td align=left COLSPAN="2">					
				<input class="textbox" type="textbox" id="patientid"  name="patientid" id="patientid" value=""> &nbsp;&nbsp;&nbsp;&nbsp;
			</td>	
			
			<td align=left COLSPAN="2">					
				<input class="button" type="button"  name="Malaffi Portal" id="Malaffi Portal" value="Malaffi Portal" onClick="MalaffiPortal('MALAFFI');">
			</td>	
		</tr>		
	</table>	
	...
	<table border="1" cellpadding="3" cellspacing="0" align = "center" width="800">		
		<tr>	
			...
			<td width="50%" align=left>				
				<input class="textbox" type="textbox" id="websocketuri" name="websocketuri"  value="" size="50"> 
			</td>
			<td width="25%" align=left>				
				<input class="button" type="button"  id="connect" name="connect"  value="Get Insurance IDs"> 
			</td>
		</tr>
		<tr>
	...
	<table border="1" cellpadding="3" cellspacing="0" align = "center" width="800">	
		<tr>	
			<td width="100%" align="Center" colSpan="4">	<p><b>PaySky Payments</b> </p></td>
		</tr>	
		<tr>	
			<td width="25%" align=left class="label">	Insurance ID &nbsp;		
				<input class="textbox" type="textbox" id="patientId" name="patientId"  value="12345678" size="12"> 
			</td>
			<td width="25%" align=left class="label">	Amount &nbsp;		
				<input class="textbox" type="textbox"  name="amount" id="amount" value="150" size="10"> 
			</td>
			<td width="25%" align=left class="label">	Transaction ID &nbsp;			
				<input class="textbox" type="textbox"  name="transactionId" id="transactionId" value="101" size="10"> 
			</td>			
			<td width="25%" align=left>				
				<input class="button" type="button"  id="paysky" name="paysky"  value="PaySky Payments"> 
			</td>
		</tr>
		<tr>	
			<td width="25%" align=left class="label">	EM Order ID &nbsp;		
				<input class="textbox" type="textbox" id="merchantId" name="merchantId"  size="12"> 
			</td>
			<td width="25%" align=left class="label">	PaySky ID &nbsp;		
				<input class="textbox" type="textbox" id="payskyId" name="payskyId"  size="10"> 
			</td>
			<td width="25%" align=left class="label" colspan="2">Date & Time&nbsp;			
				<input class="textbox" type="textbox" id="datetime" name="datetime"  size="10"> 
			</td>			
		</tr>
	</table>
	...
	<table border="1" cellpadding="3" cellspacing="0" align = "center" width="800">	
		...
		<tr>	
			...
			<td width="13%" class="fields"><select  name="Request_Type" id="Request_Type">
			...
			<td align=left width="13%">					
				<input class="textbox" type="textbox" id="Facility_Id"  name="Facility_Id"  value="A1"> &nbsp;&nbsp;&nbsp;&nbsp;
			</td>
			<td width="12%" class="label">Dispense Data</td>
			<td width="38%" align=left>				
				<textarea id="Disp_Data" name="Disp_Data" value="" size="100" width=80> </textarea>
			</td>
		</tr>
		<tr>	
			<td width="12%" class="label">Added By ID</td>
			<td width="13%" align=left >				
				<input class="textbox" type="textbox" id="Added_By_id" name="Added_By_id"  value="RAO"> 
			</td>
			<td width="12%" class="label">Workstation ID</td>			
			<td width="13%" align=left >					
				<input class="textbox" type="textbox"   name="Workstation_id" id="Workstation_id" value="IN-PF2DPDB7a"> &nbsp;&nbsp;&nbsp;&nbsp;
			</td>				
			<td width="50%" align=left colspan="2">				
				<input class="button" type="button"  id="PayerRequest" value="PayerRequest" onClick="PayerRequest()"> 
			</td>			
		</tr>
		<tr>
				<td width="50%" align=left colspan="2">
...
<div id="tobTableDiv" name="tobTableDiv"></div>
		...
		<table border="1" cellpadding="3" cellspacing="0" align="center"
			width="800">
			<tr>
				<td width="25%" align=left class="label">Alert Message &nbsp; <input class="textarea" type="textarea" id="alertMessage" name="alertMessage" id="alertMessage"
					>
				</td>
			</tr>			
			<tr>
				<td width="20%" align=left><input class="button" type="button"
					id="sAlertBtn" name="sAlertBtn" id="sAlertBtn" value="Alert Check" onClick="checkAlert()" >
				</td>
				<td width="80%" align="left" colSpan="3">
					Response Message: &nbsp;
					<p id="sResMsg" name="sResMsg"></p>
