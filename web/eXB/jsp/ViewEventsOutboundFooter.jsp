...
<tr><td>&nbsp;</td></tr>-->
<%//}%>
<th class='COLUMNHEADER' align=left COLSPAN=7><fmt:message key="eXH.MessageStatus.Label" bundle="${xh_labels}"/>(#)</th>
<tr>
<td align=left class=label width="15%">
<% if(commType != null && commType.equalsIgnoreCase("inbound")) { %>
...
<td align=left class=label width="15%"><img src='../../eXH/images/green_square.jpg' width=40 height=15> <fmt:message key="eXH.Sucessfull.Label" bundle="${xh_labels}"/>&nbsp;</td>
<!--<td align=left class=label width="20%"><img src='../../eXH/images/red_square.jpg' width=40 height=15> <fmt:message key="eXH.TransmissionError.Label" bundle="${xh_labels}"/>&nbsp;</td>-->
<td align=left class=label width="15%"><img src='../../eXH/images/yello_square.jpg' width=40 height=15> <fmt:message key="Common.Accept.label" bundle="${common_labels}"/>&nbsp;</td>
<td align=left class=label width="15%">
