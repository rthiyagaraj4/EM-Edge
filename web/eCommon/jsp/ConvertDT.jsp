			...
			if(mode.trim().equals("1")){
				...
				if(rset != null && rset.next()) {
				  ...
				  /*Below line added and modified for this CRF MMS-QH-CRF-0145.1 [IN:047497]*/
					...
					%>  	
					   <%if(birth_time!="") {%>
						if(document.getElementById('date_of_birth')!=null)document.getElementById('date_of_birth').value='<%=converted_date%> <%=birth_time%>';	
						<%}else{%>
						if(document.getElementById('date_of_birth')!=null)document.getElementById('date_of_birth').value='<%=converted_date%>';	
						<%}%>
						if(document.getElementById('birth_date')!=null)document.getElementById('birth_date').value='<%=converted_date%>';
					<%
				}
