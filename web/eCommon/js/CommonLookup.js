...
function formQueryString( pArgumentArray, callFrom ) {
	...
	*/
    ...
    if(callFrom != 0)
	{
    	// options removed by marwan to solve sc=undefined issue
    ...
    return url.replace(/<![^>]*>/g, ''); // removing <!DOCTYPE> 
}
...
function resetForm( formObj )
{
	...
	//var argArray = window.parent.dialogArguments ;
	var argArray = window.parent.dialogArguments || [];/*abv code cmt by vijayan for edge commonlookup reset issue*/
...
async function CommonLookup_servlet(title, pArgumentArray) {
