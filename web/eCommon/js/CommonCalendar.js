...
/*----------------Function showCalendar() displays the calendar in Modal Dialog Format/Div Format based on the position occupied in the GUI---------*/
		...
		/*	if (document.forms[0]){
				if (typeof(document.forms[0].getAttribute('action')) != 'undefined' && document.forms[0].getAttribute('action') != null && document.forms[0].getAttribute('action') != "")
				{
					if(!document.forms[0].getAttribute('action').includes("blank.html"))
					{
						
						originalFormAction = document.forms[0].getAttribute('action');
						originalFormTarget = document.forms[0].getAttribute('target');
					}
					
					document.forms[0].setAttribute("action","../../eCommon/html/blank.html");
				}
				document.forms[0].setAttribute("target","messageFrame");
			}*/
			
			/*if(document.forms[0]){
				var formAction = document.forms[0].getAttribute('action');
				var formTarget = document.forms[0].getAttribute('target');
				 if (typeof(formAction) != 'undefined' && formAction != null && formAction != "") {
					 if (!formAction.includes("blank.html")) {
				            originalFormAction = formAction;
				        }
					 document.forms[0].setAttribute("action", "../../eCommon/html/blank.html");
				 }
				 
				 if (typeof(formTarget) != 'undefined' && formTarget != null && formTarget != "") {
				        originalFormTarget = formTarget;
				    }
				 document.forms[0].setAttribute("target", "messageFrame");
			}*/
		if (document.forms[0]){
			if (!document.forms[0].action.includes("blank.html")) {
...
/*-----------------------------------------showInModal() Function displays the calendar in ModalDialog Format---------------------------------------------------*/
	...
	{       
			var dialogHeight= "237px" ;
			var dialogWidth	= "250px" ;
			var status = "no";
			//var arguments = "";
			var features	=  "dialogHeight:" + dialogHeight + "; dialogWidth:" + dialogWidth +" ; scroll:no; status:" + status;
			var  dateValue=await top.window.showModalDialog('../../eCommon/jsp/CommonStaticCalenderGlad.jsp?timeSet='+timeSet,args, features);
