...
function create() 
{
	f_query_add_mod.location.href	=	"../../eMM/jsp/AddItemAnalysis.jsp?function_id="+function_id+"&mode="+MODE_INSERT; 
}

function query() 
{
	f_query_add_mod.location.href	=	"../../eMM/jsp/ItemAnalysisQueryCriteria.jsp?function_id="+function_id ;
}
...
function apply() 
{
	...
	arrFieldName[0]			=	"item_anal_code";
	arrFieldName[1]			=	"long_desc";
	arrFieldName[2]			=	"short_desc";

	arrLegends[0]			=	getLabel("eMM.ItemAnalysisCode.label","MM");
...
{
	var fields	=	new Array	(	formObj.item_anal_code
									,formObj.long_desc
									,formObj.short_desc
								);


	var names	=	new Array	(	getLabel("eMM.ItemAnalysisCode.label","MM")
...
function Modify(obj)
{
	...
	document.location.href	=	"../../eMM/jsp/ModifyItemAnalysis.jsp?function_id="+parent.function_id+"&mode="+MODE_MODIFY+"&item_anal_code="+code1;//+"&long_desc="+code2+"&short_desc="+code3+"&eff_status="+eff_status;
}
