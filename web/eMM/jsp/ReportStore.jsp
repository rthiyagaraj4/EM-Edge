...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<body onLoad="FocusFirstElement();">
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align=center >
			...
			<td width='100%'  class="WHITE">
				...
				<tr>
					...
					<option value='3'><fmt:message key="Common.StoreCode.label" bundle="${common_labels}"/></option>
					<option value='5'><fmt:message key="Common.StoreDescription.label" bundle="${common_labels}"/></option>
					<option value='1'><fmt:message key="Common.DepartmentCode.label" bundle="${common_labels}"/></option>
					</select></td>
				</tr>
				<tr>
					<td >&nbsp;</td>
		...
		<input type="hidden" name="SQL_MM_STORE_LOOKUP" id="SQL_MM_STORE_LOOKUP" value="<%= eMM.Common.MmRepository.getMmKeyValue("SQL_MM_STORE_LOOKUP")%>">
		<input type="hidden" name="SQL_MM_DEPARTMENT_LOOKUP" id="SQL_MM_DEPARTMENT_LOOKUP" value="<%= eMM.Common.MmRepository.getMmKeyValue("SQL_MM_DEPARTMENT_LOOKUP")%>">
		<%
