...
%>
	<tr>
		...
		<td class="<%=classValue%>" class='UPPER'><input type="text" name="material_group_code<%=rowIndex%>" id="material_group_code<%=rowIndex%>"  size="10" maxlength="6" <%=codeReadOnly%> accesskey='C' onKeyPress="return CheckForSpecChars(event)" onBlur="parent.resetColorCode(this);convertToUpperCase(this);checkSpecialChars(this);"></td>
