...
//		String p_report_id = "MMBMTGRP";
	...
	<body onLoad="FocusFirstElement();">
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align=center  >
			...
			<td width='100%'  class="WHITE">
				...
				<tr>
					...
					<option value='1'><fmt:message key="eMM.MaterialCode.label" bundle="${mm_labels}"/></option>
					<option value='2'><fmt:message key="Common.description.label" bundle="${common_labels}"/></option>
					</select></td>
					<!--
		...
		<input type="hidden" name="SQL_AP_MATERAILS_SELECT_LOOKUP" id="SQL_AP_MATERAILS_SELECT_LOOKUP" value="<%= eMM.Common.MmRepository.getMmKeyValue("SQL_AP_MATERAILS_SELECT_LOOKUP")%>">
		<%
