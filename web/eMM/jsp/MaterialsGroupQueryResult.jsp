...
<%@page contentType="text/html;charset=UTF-8" import="java.util.*, eMM.Common.*, eMM.* " %>
...
try{
	...
	%>
		...
		<th><fmt:message key="eMM.MaterialGroupCode.label" bundle="${mm_labels}"/></th><th><fmt:message key="Common.longdescription.label" bundle="${common_labels}"/></th>
