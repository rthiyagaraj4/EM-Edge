...
//	alert("summary status : "+f_query_add_mod.document.forms[0].req_status.value);
//  alert("report_type : "+f_query_add_mod.document.forms[0].report_type.value);
	...
	if(rep_type=='S'){
		f_query_add_mod.document.forms[0].p_report_id.value = 'XIRETSUS';
	}
	else if(rep_type=='D'){
		f_query_add_mod.document.forms[0].p_report_id.value = 'XIRETSUD';
	}
	else{
		f_query_add_mod.document.forms[0].p_report_id.value = 'XIRETSUS';
	}
