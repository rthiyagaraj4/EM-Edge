...
//	alert("item_code : "+this.document.forms[0].item_code.value);
	...
	parent.f_query_add_mod_detail.location.href="../../eXI/jsp/QueryOrgwsItemStatusSearchResult.jsp?item_code="+item_code+"&item_catg="+item_catg+"&org_id="+org_id+"&status="+status;
...
//			sql="SELECT ITEM_CODE code,SHORT_DESC description FROM XI_ITEM WHERE UPPER(ITEM_CODE) LIKE UPPER(?) AND UPPER(SHORT_DESC) LIKE UPPER(?) ORDER BY 1 ";
