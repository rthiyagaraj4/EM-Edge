...
{
    44,
    "T:\\temp\\Bl\\ganapathy\\JDWORK\\PROC\\BLBARINV.PC"
};


static unsigned long sqlctx = 1267623605;
...
"select DOC_TYPE_CODE ,DOC_NUM  from BL_BILL_HDR where ((((((TRUNC(DOC_DATE) \
between NVL(TO_DATE(:b0,'DD/MM/YYYY'),to_date('01/01/1900','DD/MM/YYYY')) and \
NVL(TO_DATE(:b1,'DD/MM/YYYY'),to_date('01/01/3000','DD/MM/YYYY')) and (RPAD(DO\
C_TYPE_CODE,6,' ')||LPAD(DOC_NUM,8,'0')) between (RPAD(NVL(:b2,' '),6,' ')||LP\
AD(NVL(:b3,'0'),8,'0')) and (RPAD(NVL(:b4,'~~~~~~'),6,' ')||LPAD(NVL(:b5,'9999\
9999'),8,'0'))) and BILL_NATURE_CODE='A') and BILL_POSTED_FLAG='Y') and NVL(BI\
LL_TOT_OUTST_AMT,0)<>0) and BILL_STATUS is null ) and OPERATING_FACILITY_ID=:b\
6)           ";
...
"select BL_RECV_ACC_INT_CODE ,AR_RECV_ACC_INT_CODE ,SHORT_DESC  from BL_BILL_\
TYPE where (BILL_TYPE_CODE=:b0 and ACC_ENTITY_CODE in (select ACC_ENTITY_CODE \
 from SY_ACC_ENTITY where ACC_ENTITY_ID=:b1))           ";
...
STR(POLICY_NUMBER,1,25)  from BL_EPISODE_FIN_DTLS where ((EPISODE_TYPE=DECODE(\
:b0,'E','O','D','I','A','I') and EPISODE_ID=:b1) and OPERATING_FACILITY_ID=:b2\
)           ";

 static const char *sq0014 = 
"select NVL(SUBSTR(CREDIT_DOC_REF_DESC,1,15),SUBSTR(POLICY_NUMBER,1,15)) ,SUB\
STR(POLICY_NUMBER,1,15)  from BL_VISIT_FIN_DTLS where (((EPISODE_TYPE='O' and \
EPISODE_ID=:b0) and VISIT_ID=:b1) and OPERATING_FACILITY_ID=:b2)           ";
...
{10,4274,0,0,0,
5,0,0,1,75,0,4,231,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
28,0,0,2,0,0,29,274,0,0,0,0,0,1,0,
43,0,0,3,0,0,30,282,0,0,0,0,0,1,0,
58,0,0,4,328,0,4,329,0,0,20,4,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
153,0,0,5,116,0,2,372,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
184,0,0,6,117,0,4,394,0,0,3,1,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,
211,0,0,16,212,0,9,598,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
234,0,0,16,0,0,13,611,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
261,0,0,17,185,0,9,633,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
284,0,0,17,0,0,13,638,0,0,1,0,0,1,0,2,9,0,0,
303,0,0,7,557,0,9,651,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
346,0,0,7,0,0,13,665,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
369,0,0,8,1502,0,9,815,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
396,0,0,8,0,0,13,829,0,0,67,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
679,0,0,18,243,0,4,981,0,0,5,2,0,1,0,2,3,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
714,0,0,19,85,0,5,999,0,0,1,1,0,1,0,1,9,0,0,
733,0,0,9,210,0,9,1010,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
756,0,0,9,0,0,13,1028,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
783,0,0,10,278,0,9,1049,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
806,0,0,10,0,0,13,1070,0,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,
849,0,0,10,278,0,9,1098,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
872,0,0,10,0,0,13,1119,0,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,
915,0,0,11,71,0,9,1142,0,0,1,1,0,1,0,1,9,0,0,
934,0,0,11,0,0,13,1151,0,0,1,0,0,1,0,2,9,0,0,
953,0,0,12,217,0,9,1163,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
976,0,0,12,0,0,13,1176,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
1003,0,0,13,244,0,9,1195,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
1030,0,0,13,0,0,13,1207,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
1053,0,0,14,229,0,9,1225,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
1080,0,0,14,0,0,13,1236,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
1103,0,0,15,129,0,9,1254,0,0,1,1,0,1,0,1,9,0,0,
1122,0,0,15,0,0,13,1262,0,0,1,0,0,1,0,2,9,0,0,
1141,0,0,20,94,0,4,1283,0,0,3,1,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,
1168,0,0,21,1359,0,3,1325,0,0,52,52,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
...
1391,0,0,22,454,0,3,1452,0,0,19,19,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1482,0,0,23,332,0,3,1512,0,0,8,8,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,9,0,0,1,4,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
1529,0,0,24,827,0,3,1547,0,0,34,34,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,3,0,0,1,9,0,
...
1680,0,0,25,475,0,3,1635,0,0,20,20,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,3,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,4,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1775,0,0,26,338,0,5,1698,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1826,0,0,27,237,0,5,1719,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,
1865,0,0,28,254,0,5,1740,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,
1908,0,0,29,438,0,5,1771,0,0,11,11,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
...
/* OCS MEDICOM VER 1.0                                                  */
/************************************************************************/
/* PROGRAM NAME          : BLBARINV.PC                                  */
/* AUTHOR                : S. SRIRAM                                    */
/* DATE WRITTEN          : 04-AUG-1993                                  */
/*                                                                      */
/* CALLED FROM           :                                              */
/*                                                                      */
/*  FUNCTION             :                                              */ 
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/BLBARINV.C-arc   1.0   Apr 19 2007 17:04:10   vcm_th  $ sqlca.h 
 */
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/BLBARINV.C-arc   1.0   Apr 19 2007 17:04:10   vcm_th  $ sqlda.h 
 */
...
AM16 into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,:b13,:b14,:b1\
5  from SY_PROG_PARAM where (((PGM_ID=:b16 and SESSION_ID=:b17) and PGM_DATE=:\
b18) and OPERATING_FACILITY_ID=:b19)";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqhstv[16] = (         void  *)&d_curr_pgm_name;
...
declare_cur()
{
     /* EXEC SQL DECLARE BL_HDR_CUR CURSOR FOR
			...
			NVL(TO_DATE(:nd_to_doc_date,'DD/MM/YYYY'),
                     ...
                     AND RPAD(DOC_TYPE_CODE,6,' ')|| LPAD(DOC_NUM,8,'0')
		     BETWEEN
...

{
     ...
     if (bl_h_bill_trx_type_code.arr[0] == 'D' ||
...

{
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&bl_h_bill_trx_type_code;
  sqlstm.sqhstl[0] = (unsigned int  )4;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
...

{
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
    ...
    else if (bl_h_bill_trx_type_code.arr[0] == 'O')
    {
...

{
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&bl_h_episode_id;
  sqlstm.sqhstl[0] = (unsigned int  )11;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&bl_h_visit_id;
  sqlstm.sqhstl[1] = (unsigned int  )7;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         void  *)0;
  sqlstm.sqinds[1] = (         int  )0;
...

{
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
    ...
    else if (bl_h_bill_trx_type_code.arr[0] == 'R')
    {
...
//		 :bl_bill_type_short_desc,           /o NARRATION     o/
         ...
         /o:bl_par_post_month,
          :bl_par_post_year,          o/
		 /o TO_CHAR(TO_DATE(:nd_inv_date),'MM'),  POST MONTH   o/
		 /o TO_CHAR(TO_DATE(:nd_inv_date),'YY'),  POST YEAR    o/
		 NULL,                             /o ERROR FLAG     o/
		 'N',                              /o PRINT FLAG     o/
...
DULE_ID,CONSOLIDATED_INV_YN) values (:b0,:b1,1,:b2,TO_DATE(NVL(:b3,:b4),'DD/\
MM/YYYY'),:b5,TO_DATE(:b4,'DD/MM/YYYY'),(to_date(:b4,'DD/MM/YYYY')+:b8),(((T\
RUNC(:b9,2)+TRUNC(:b10,2))+TRUNC(:b11,2))+TRUNC(:b12,2)),TRUNC(:b9,2),((TRUN\
C(:b10,2)+TRUNC(:b11,2))+TRUNC(:b12,2)),:b17");
     sqlstm.stmt = ",(to_date(:b4,'DD/MM/YYYY')+:b19),:b20,:b21,:b22,:b23,:b\
24,:b25,:b26,:b27,:b28,TO_DATE(:b4,'DD/MM/YYYY'),:b30,:b31,:b32,:b33,:b34,:b35\
,:b36,:b37,to_char(to_date(:b4,'DD/MM/YYYY'),'MM'),to_char(to_date(:b4,'DD/MM/\
YYYY'),'YYYY'),null ,'N',null ,null ,:b31,:b32,:b33,:b34,:b35,:b36,:b37,:b47,U\
SER,USER,SYSDATE,SYSDATE,:b48,:b49,:b50,:b51)";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqadto[37] = (unsigned short )0;
     sqlstm.sqtdso[37] = (unsigned short )0;
     sqlstm.sqhstv[38] = (         void  *)&bl_h_doc_date;
     ...
     sqlstm.sqadto[38] = (unsigned short )0;
     sqlstm.sqtdso[38] = (unsigned short )0;
     sqlstm.sqhstv[39] = (         void  *)&bl_h_doc_date;
     ...
     sqlstm.sqadto[47] = (unsigned short )0;
     sqlstm.sqtdso[47] = (unsigned short )0;
     sqlstm.sqhstv[48] = (         void  *)&nd_operating_facility_id;
...
FIED_DATE,ACC_ENTITY_CODE) values (:b0,:b1,:b2,TO_DATE(:b3,'DD/MM/YYYY'),(:b4*\
 (-1)),to_char(to_date(:b3,'DD/MM/YYYY'),'MM'),to_char(to_date(:b3,'DD/MM/YYYY\
'),'YYYY'),USER,USER,SYSDATE,SYSDATE,:b7)";
    sqlstm.iters = (unsigned int  )1;
...
,:b9,:b10,:b11,:b12,:b13,to_char(to_date(:b14,'DD/MM/YYYY'),'MM'),to_char(to_d\
ate(:b14,'DD/MM/YYYY'),'YYYY'),:b7,:b8,:b9,:b10,:b11,:b12,:b13,:b23,:b24,:b25,\
:b26,TO_DATE(:b14,'DD/MM/YYYY'),(:b28* (-1)),:b29,:b30,:b31,:b32,:b33)";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqadto[13] = (unsigned short )0;
      sqlstm.sqtdso[13] = (unsigned short )0;
      sqlstm.sqhstv[14] = (         void  *)&bl_h_doc_date;
      ...
      sqlstm.sqadto[14] = (unsigned short )0;
      sqlstm.sqtdso[14] = (unsigned short )0;
      sqlstm.sqhstv[15] = (         void  *)&bl_h_doc_date;
...
ID=:b5) and OPERATING_FACILITY_ID=:b2)";
 sqlstm.iters = (unsigned int  )1;
...
*/
   ...
   /* EXEC SQL UPDATE BL_BILL_HDR
		   ...
		   BILL_DRFEE_TOT_OUTST_AMT = NVL(BILL_DRFEE_TOT_OUTST_AMT,0)-
                                               :bl_h_bill_drfee_tot_out_amt,
		   AMT_TRANSFERRED = :bl_h_bill_tot_outst_amt		,
	   	   MODIFIED_BY_ID        =  USER,         
		   MODIFIED_DATE         =  SYSDATE,       
		   MODIFIED_AT_WS_NO     =  :nd_ws_no,       
		   MODIFIED_FACILITY_ID  =  :nd_operating_facility_id     										
...
OT_OUTST_AMT,0)-:b6),AMT_TRANSFERRED=:b4,MODIFIED_BY_ID=USER,MODIFIED_DATE=SYS\
DATE,MODIFIED_AT_WS_NO=:b8,MODIFIED_FACILITY_ID=:b9 where ROWID=:b10";
   sqlstm.iters = (unsigned int  )1;
