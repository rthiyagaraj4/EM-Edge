...
{
    21,
    "C:\\10xdev\\BLRCVLST.pc"
};


static unsigned long sqlctx = 139598827;
...
"ere ((((((I.doc_type_code=A.doc_type\
_code and I.doc_number=A.doc_num) and J.operating_facility_id=:b0) and I.oper\
ating_facility_id=J.operating_facility_id) and nvl(I.cancelled_yn,'N')='N') a\
nd nvl(J.cancelled_yn,'N')='N') and I.doc_ref_num=J.doc_ref_num))))  order by\
 DECODE(:b19,'B',BLNG_GRP_ID,'C',CUST_CODE,'P',PATIENT_ID,'E',EPISODE)       \
     ";

 static const char *sq0005 = 
"doc_number=A.doc_num) and J.operatin\
g_facility_id=:b16) and I.operating_facility_id=J.operating_facility_id) and \
nvl(I.cancelled_yn,'N')='N') and nvl(J.cancelled_yn,'N')='N') and I.doc_ref_n\
um=J.doc_ref_num))) and  not exists (select I.DOC_TYPE_CODE ,I.DOC_NUMBER  fr\
om BL_COVERING_LET_DETAIL I ,BL_COVERING_LET_HEADER J where ((((((I.doc_type_\
code=A.bill_doc_type_code and I.doc_number=A.bill_num) and J.operating_facili\
ty_id=:b16) and I.operating_facility_id=J.operating_facility_id) and nvl(I.ca\
ncelled_yn,'N')='N') and nvl(J.cancelled_yn,'N')='N') and I.doc_ref_num=J.doc\
_ref_num))))  order by DECODE(:b19,'B',BLNG_GRP_ID,'C',CUST_CODE,'P',PATIENT_\
ID,'E',EPISODE)            ";

 static const char *sq0006 = 
"PE_CODE ,I.DOC_NUMBER  from BL_COVER\
ING_LET_DETAIL I ,BL_COVERING_LET_HEADER J where ((((((I.doc_type_code=A.doc_\
type_code and I.doc_number=A.doc_num) and J.operating_facility_id=:b0) and I.\
operating_facility_id=J.operating_facility_id) and nvl(I.cancelled_yn,'N')='N\
') and nvl(J.cancelled_yn,'N')='N') and I.doc_ref_num=J.doc_ref_num))) and  n\
ot exists (select I.DOC_TYPE_CODE ,I.DOC_NUMBER  from BL_COVERING_LET_DETAIL \
I ,BL_COVERING_LET_HEADER J where ((((((I.doc_type_code=A.bill_doc_type_code \
and I.doc_number=A.bill_num) and J.operating_facility_id=:b0) and I.operating\
_facility_id=J.operating_facility_id) and nvl(I.cancelled_yn,'N')='N') and nv\
l(J.cancelled_yn,'N')='N') and I.doc_ref_num=J.doc_ref_num))))  order by DECO\
DE(:b38,'B',BLNG_GRP_ID,'C',CUST_CODE,'P',PATIENT_ID,'E',EPISODE)            ";
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,159,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
...
ARAM7 ,PARAM8 ,PARAM9 ,PARAM10 ,PARAM11 ,PARAM12 ,PARAM13 ,PARAM14 ,PARAM15 ,\
PARAM16 ,PARAM17 ,PARAM18 into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:\
b11,:b12,:b13,:b14,:b15,:b16,:b17  from SY_PROG_PARAM where ((PGM_ID=:b18 and\
 SESSION_ID=:b19) and PGM_DATE=:b20)";
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select SHORT_DESC into :b0  from BL_BLNG_GRP_LANG_VW whe\
re (BLNG_GRP_ID=:b1 and LANGUAGE_ID=:b2)";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select SHORT_NAME into :b0  from AR_CUSTOMER_LANG_VW whe\
re (CUST_CODE=:b1 and LANGUAGE_ID=:b2)";
    sqlstm.iters = (unsigned int  )1;
...
,:b3,:b4  from SY_ACC_ENTITY_LANG_VW where (acc_entity_id=:b5 and LANGUAGE_ID\
=:b6)";
 sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRCVLST.LEGEND_'||LTRIM(RTRIM(TO_CHA\
