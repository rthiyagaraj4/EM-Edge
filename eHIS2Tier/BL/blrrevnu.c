...
{
    25,
    "T:\\BL\\Reports\\Blrrevnu.pc"
};


static unsigned long sqlctx = 1705848797;
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,433,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,30,463,0,0,0,0,0,1,0,
51,0,0,3,329,0,4,560,0,0,19,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
142,0,0,4,498,0,4,706,0,0,31,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
281,0,0,5,259,0,4,772,0,0,14,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
352,0,0,6,128,0,4,852,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
383,0,0,7,118,0,2,888,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
406,0,0,8,0,0,17,930,0,0,1,1,0,1,0,1,9,0,0,
425,0,0,8,0,0,45,942,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
456,0,0,8,0,0,13,1394,0,0,5,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
491,0,0,9,503,0,4,1500,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
542,0,0,10,438,0,4,1518,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
597,0,0,11,503,0,4,1569,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
648,0,0,12,532,0,4,1582,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
703,0,0,13,503,0,4,1621,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
754,0,0,14,532,0,4,1634,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
809,0,0,15,503,0,4,1673,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
860,0,0,16,532,0,4,1687,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
915,0,0,17,503,0,4,1729,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
966,0,0,18,532,0,4,1742,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1021,0,0,19,503,0,4,1781,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1072,0,0,20,532,0,4,1794,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1127,0,0,21,503,0,4,1834,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1178,0,0,22,532,0,4,1847,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1233,0,0,23,503,0,4,1886,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1284,0,0,24,532,0,4,1899,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1339,0,0,25,503,0,4,1939,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1390,0,0,26,532,0,4,1952,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1445,0,0,27,503,0,4,1992,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1496,0,0,28,532,0,4,2005,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1551,0,0,29,503,0,4,2044,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1602,0,0,30,532,0,4,2057,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1657,0,0,31,503,0,4,2097,0,0,9,6,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1708,0,0,32,532,0,4,2110,0,0,10,7,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1763,0,0,33,93,0,4,2163,0,0,2,1,0,1,0,1,9,0,0,2,9,0,0,
1786,0,0,34,436,0,4,2170,0,0,7,6,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,
1829,0,0,35,79,0,4,2182,0,0,2,1,0,1,0,1,9,0,0,2,9,0,0,
1852,0,0,36,93,0,4,2202,0,0,2,1,0,1,0,1,9,0,0,2,9,0,0,
1875,0,0,37,465,0,4,2209,0,0,8,7,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
1922,0,0,38,79,0,4,2225,0,0,2,1,0,1,0,1,9,0,0,2,9,0,0,
1945,0,0,39,471,0,4,2242,0,0,8,6,0,1,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
1992,0,0,40,500,0,4,2257,0,0,9,7,0,1,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
2043,0,0,41,96,0,4,4879,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
2066,0,0,42,165,0,6,4886,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[3]; } p_langugae_id;
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/blrrevnu.c-arc   1.0   Apr 19 2007 17:07:02   vcm_th  $ sqlca.h 
 */
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/blrrevnu.c-arc   1.0   Apr 19 2007 17:07:02   vcm_th  $ sqlda.h 
 */
...
char *argv[];
{
    ...
    if(argc < 8) 
	{
		disp_message(ERR_MESG,"BLRREVNU : Usage BLRREVNU userid/password session_id pgm_date facility_id");
		proc_exit();
    }
...

{
	...
	strcpy(p_langugae_id.arr,l_language_id.arr);
...

{
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (         void  *)&p_fm_cust_cd;
 ...
 sqlstm.sqadto[2] = (unsigned short )0;
 sqlstm.sqtdso[2] = (unsigned short )0;
 sqlstm.sqhstv[3] = (         void  *)&p_to_cust_cd;
...
fetch_period_values()
{
	...
	//sprintf(l_mesg,"1	NOM %f  P_NO_OF_MTH %f",nom,p_no_of_mth);
	//disp_message(ERR_MESG,l_mesg);
	...
	if (nom <= p_no_of_mth)
	{
		...
		//sprintf(l_mesg,"2	P_FM_DT1 %f",p_fm_dt_1.arr);
		//disp_message(ERR_MESG,l_mesg);

		if (p_fm_dt_1.arr[0] != '\0')
		{
			//sprintf(l_mesg,"3	SETT IND  %s",d_sett_ind.arr);
			//disp_message(ERR_MESG,l_mesg);

			if (d_sett_ind.arr[0] == 'C')
			{
				/* EXEC SQL SELECT SUM(BILL_AMT),
							...
							INTO :d_per_1,
								 ...
								 :d_per_1_2
							FROM BL_BILL_HDR
						   WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_1,'DD/MM/YYYY') 
							 AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_1,'DD/MM/YYYY') 
							 AND EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) 
							 AND NVL(BILL_STATUS,'X') NOT IN ('C','S') 
							 AND OPERATING_FACILITY_ID 
						 BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
							 AND nvl(ltrim(rtrim(:nd_to_facility)),'~~') 
							 AND BLNG_GRP_ID IN (SELECT BLNG_GRP_ID FROM BL_BLNG_GRP WHERE SETTLEMENT_IND = 'C'); */ 

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select sum(BILL_AMT) ,count(distinct PATIENT_ID) ,(sum(BI\
LL_AMT)/count(distinct PATIENT_ID)) into :b0,:b1,:b2  from BL_BILL_HDR where (\
((((trunc(DOC_DATE)>=to_date(:b3,'DD/MM/YYYY') and trunc(DOC_DATE)<=TO_DATE(:b\
4,'DD/MM/YYYY')) and EPISODE_TYPE=DECODE(:b5,'A',EPISODE_TYPE,:b5)) and NVL(BI\
LL_STATUS,'X') not  in ('C','S')) and OPERATING_FACILITY_ID between nvl(ltrim(\
rtrim(:b7)),'  ') and nvl(ltrim(rtrim(:b8)),'~~')) and BLNG_GRP_ID in (select \
    ...
    sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
			...
			else
			{
				/* EXEC SQL SELECT SUM(BILL_AMT),
						   ...
						   WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_1,'DD/MM/YYYY') 
							 AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_1,'DD/MM/YYYY') 
							 AND EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
				 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
				 OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
									  AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
				 //BLNG_GRP_ID = :d_blng_grp_id AND
				 //BLNG_GRP_ID IN (SELECT BLNG_GRP_ID FROM BL_BLNG_GRP WHERE NVL(SETTLEMENT_IND,'C') = 'X') AND
...
4,'DD/MM/YYYY')) and EPISODE_TYPE=DECODE(:b5,'A',EPISODE_TYPE,:b5)) and NVL(BI\
LL_STATUS,'X') not  in ('C','S')) and OPERATING_FACILITY_ID between nvl(ltrim(\
rtrim(:b7)),'  ') and nvl(ltrim(rtrim(:b8)),'~~')) and CUST_CODE=:b9)";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
				 ...
				 //Billing group is commented.  If billing group is introduced the query is repeated
				 //for distinct billing group, customer combination instead of only customer combination
				 //Corrected on 12/04/2004.
			}

			//sprintf(l_mesg,"Cust Code   %s     Blng Grp Id  %s  Bill Amt %f  Patient Count  %f  Avg. Bill %f",d_cust_code.arr, d_blng_grp_id.arr,d_per_1,d_per_1_1,d_per_1_2);
			//disp_message(ERR_MESG,l_mesg);
		}
		else
		{
	...
	if (nom <= p_no_of_mth)
	{
		if (p_fm_dt_2.arr[0] != '\0')
		{
			...
			/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
				 ...
				 FROM BL_BILL_HDR
				 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_2,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_2,'DD/MM/YYYY') AND
...
(((trunc(DOC_DATE)>=to_date(:b3,'DD/MM/YYYY') and trunc(DOC_DATE)<=TO_DATE(:b4\
,'DD/MM/YYYY')) and EPISODE_TYPE=DECODE(:b5,'A',EPISODE_TYPE,:b5)) and NVL(BIL\
L_STATUS,'X') not  in ('C','S')) and OPERATING_FACILITY_ID between nvl(ltrim(r\
trim(:b7)),'  ') and nvl(ltrim(rtrim(:b8)),'~~')) and BLNG_GRP_ID in (select B\
...
LL_STATUS,'X') not  in ('C','S')) and OPERATING_FACILITY_ID between nvl(ltrim(\
rtrim(:b7)),'  ') and nvl(ltrim(rtrim(:b8)),'~~')) and BLNG_GRP_ID in (select \
BLNG_GRP_ID  from BL_BLNG_GRP where NVL(SETTLEMENT_IND,'C')='X')) and CUST_COD\
E=:b9)";
   sqlstm.iters = (unsigned int  )1;
		...
		if (p_fm_dt_3.arr[0] != '\0')
		{
			if (d_sett_ind.arr[0] == 'C')
			{
				/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
					 ...
					 FROM BL_BILL_HDR
					 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_3,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_3,'DD/MM/YYYY') AND
					 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
					 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
					 OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
										  AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
...

{
    ...
    sqlstm.stmt = "select sum(BILL_AMT) ,count(distinct PATIENT_ID) ,(sum(BI\
LL_AMT)/count(distinct PATIENT_ID)) into :b0,:b1,:b2  from BL_BILL_HDR where (\
(((((trunc(DOC_DATE)>=to_date(:b3,'DD/MM/YYYY') and trunc(DOC_DATE)<=TO_DATE(:\
b4,'DD/MM/YYYY')) and EPISODE_TYPE=DECODE(:b5,'A',EPISODE_TYPE,:b5)) and NVL(B\
ILL_STATUS,'X') not  in ('C','S')) and BLNG_GRP_ID in (select BLNG_GRP_ID  fro\
m BL_BLNG_GRP where NVL(SETTLEMENT_IND,'C')='X')) and OPERATING_FACILITY_ID be\
tween nvl(ltrim(rtrim(:b7)),'  ') and nvl(ltrim(rtrim(:b8)),'~~')) and CUST_CO\
DE=:b9)";
    sqlstm.iters = (unsigned int  )1;
	...
	if (p_fm_dt_4.arr[0] != '\0')
	{
		...
		/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
			 ...
			 FROM BL_BILL_HDR
			 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_4,'DD/MM/YYYY') AND trunc(DOC_DATE) <=TO_DATE(:p_to_dt_4,'DD/MM/YYYY') AND
			 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
			 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
		     OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
		                          AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
...
((trunc(DOC_DATE)>=to_date(:b3,'DD/MM/YYYY') and trunc(DOC_DATE)<=TO_DATE(:b4,\
'DD/MM/YYYY')) and EPISODE_TYPE=DECODE(:b5,'A',EPISODE_TYPE,:b5)) and NVL(BILL\
_STATUS,'X') not  in ('C','S')) and OPERATING_FACILITY_ID between nvl(ltrim(rt\
rim(:b7)),'  ') and nvl(ltrim(rtrim(:b8)),'~~')) and BLNG_GRP_ID in (select BL\
NG_GRP_ID  from BL_BLNG_GRP where SETTLEMENT_IND='C'))";
  sqlstm.iters = (unsigned int  )1;
...
(((trunc(DOC_DATE)>=to_date(:b3,'DD/MM/YYYY') and trunc(DOC_DATE)<=TO_DATE(:b4\
,'DD/MM/YYYY')) and EPISODE_TYPE=DECODE(:b5,'A',EPISODE_TYPE,:b5)) and NVL(BIL\
L_STATUS,'X') not  in ('C','S')) and BLNG_GRP_ID in (select BLNG_GRP_ID  from \
BL_BLNG_GRP where NVL(SETTLEMENT_IND,'C')='X')) and OPERATING_FACILITY_ID betw\
een nvl(ltrim(rtrim(:b7)),'  ') and nvl(ltrim(rtrim(:b8)),'~~')) and CUST_CODE\
=:b9)";
  sqlstm.iters = (unsigned int  )1;
	...
	if (nom <= p_no_of_mth)
	{
		if (p_fm_dt_5.arr[0] != '\0')
		{
			...
			/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
				 ...
				 FROM BL_BILL_HDR
				 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_5,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_5,'DD/MM/YYYY') AND
				 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
				 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
				 OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
									  AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
...
((((trunc(DOC_DATE)>=to_date(:b3,'DD/MM/YYYY') and trunc(DOC_DATE)<=TO_DATE(:b\
4,'DD/MM/YYYY')) and EPISODE_TYPE=DECODE(:b5,'A',EPISODE_TYPE,:b5)) and NVL(BI\
LL_STATUS,'X') not  in ('C','S')) and BLNG_GRP_ID in (select BLNG_GRP_ID  from\
 BL_BLNG_GRP where NVL(SETTLEMENT_IND,'C')='X')) and OPERATING_FACILITY_ID bet\
ween nvl(ltrim(rtrim(:b7)),'  ') and nvl(ltrim(rtrim(:b8)),'~~')) and CUST_COD\
E=:b9)";
   sqlstm.iters = (unsigned int  )1;
	...
	if (nom <= p_no_of_mth)
	{
		if (p_fm_dt_6.arr[0] != '\0')
		{
			...
			/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
				 ...
				 FROM BL_BILL_HDR
				 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_6,'DD/MM/YYYY') AND trunc(DOC_DATE) <=TO_DATE(:p_to_dt_6,'DD/MM/YYYY') AND
				 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
				 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
				 OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
									  AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
   ...
   sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	if (p_fm_dt_7.arr[0] != '\0')
	{
		...
		/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
			 ...
			 FROM BL_BILL_HDR
			 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_7,'DD/MM/YYYY') AND trunc(DOC_DATE) <=TO_DATE(:p_to_dt_7,'DD/MM/YYYY') AND
			 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
			 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
		     OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
		                          AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	if (p_fm_dt_8.arr[0] != '\0')
	{
		...
		/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
			 ...
			 FROM BL_BILL_HDR
			 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_8,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_8,'DD/MM/YYYY') AND
			 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
			 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
		    OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
		                          AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	if (p_fm_dt_9.arr[0] != '\0')
	{
		...
		/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
			 ...
			 FROM BL_BILL_HDR
			 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_9,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_9,'DD/MM/YYYY') AND
			 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
			 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
		     OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
		                          AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	if (p_fm_dt_10.arr[0] != '\0')
	{
		...
		/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
			 ...
			 FROM BL_BILL_HDR
			 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_10,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_10,'DD/MM/YYYY') AND
			 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
			 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
		     OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
		                          AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
...
if (nom <= p_no_of_mth)
	...
	if (p_fm_dt_11.arr[0] != '\0')
	{
		...
		/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
			 ...
			 FROM BL_BILL_HDR
			 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_11,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_11,'DD/MM/YYYY') AND
			 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
			 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
			 OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
		                          AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
...
if (nom <= p_no_of_mth)
	...
	if (p_fm_dt_12.arr[0] != '\0')
	{
		...
		/* EXEC SQL SELECT SUM(BILL_AMT),COUNT(DISTINCT(PATIENT_ID)),
			 ...
			 FROM BL_BILL_HDR
			 WHERE trunc(DOC_DATE) >= to_date(:p_fm_dt_12,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_to_dt_12,'DD/MM/YYYY') AND
			 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
			 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
		     OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
		                          AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select TO_CHAR((ADD_MONTHS(TO_DATE(:b0,'DD/MM/YYYY'),1)-1)\
,'DD/MM/YYYY') into :b1  from DUAL ";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqlety = (unsigned short)256;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&p_prin_lst_fm_dt;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&p_prin_lst_to_dt;
   sqlstm.sqhstl[1] = (unsigned int  )13;
   sqlstm.sqhsts[1] = (         int  )0;
   sqlstm.sqindv[1] = (         void  *)0;
   sqlstm.sqinds[1] = (         int  )0;
   ...
   sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
			...
			/* EXEC SQL SELECT COUNT(DISTINCT(PATIENT_ID))
				 INTO :d_per_lst_sum1
				 FROM BL_BILL_HDR
				 WHERE trunc(DOC_DATE) >= TO_DATE(:p_prin_lst_fm_dt,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_prin_lst_to_dt,'DD/MM/YYYY') AND
				 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
				 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
				 OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
		                          AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select count(distinct PATIENT_ID) into :b0  from BL_BILL_H\
DR where (((((trunc(DOC_DATE)>=TO_DATE(:b1,'DD/MM/YYYY') and trunc(DOC_DATE)<=\
TO_DATE(:b2,'DD/MM/YYYY')) and EPISODE_TYPE=DECODE(:b3,'A',EPISODE_TYPE,:b3)) \
and NVL(BILL_STATUS,'X') not  in ('C','S')) and OPERATING_FACILITY_ID between \
nvl(ltrim(rtrim(:b5)),'  ') and nvl(ltrim(rtrim(:b6)),'~~')) and BLNG_GRP_ID i\
n (select BLNG_GRP_ID  from BL_BLNG_GRP where SETTLEMENT_IND='C'))";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqlety = (unsigned short)256;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&d_per_lst_sum1;
   sqlstm.sqhstl[0] = (unsigned int  )sizeof(double);
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         void  *)0;
   sqlstm.sqinds[0] = (         int  )0;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&p_prin_lst_fm_dt;
   sqlstm.sqhstl[1] = (unsigned int  )13;
   sqlstm.sqhsts[1] = (         int  )0;
   sqlstm.sqindv[1] = (         void  *)0;
   sqlstm.sqinds[1] = (         int  )0;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&p_prin_lst_to_dt;
   sqlstm.sqhstl[2] = (unsigned int  )13;
   sqlstm.sqhsts[2] = (         int  )0;
   sqlstm.sqindv[2] = (         void  *)0;
   sqlstm.sqinds[2] = (         int  )0;
...

{
 ...
 into :b1  from DUAL ";
   ...
   sqlstm.sqlety = (unsigned short)256;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&p_prin_lst_to_dt;
   sqlstm.sqhstl[0] = (unsigned int  )13;
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         void  *)0;
   sqlstm.sqinds[0] = (         int  )0;
...
DR where ((((((trunc(DOC_DATE)>=TO_DATE(:b1,'DD/MM/YYYY') and trunc(DOC_DATE)<\
=TO_DATE(:b2,'DD/MM/YYYY')) and EPISODE_TYPE=DECODE(:b3,'A',EPISODE_TYPE,:b3))\
 and NVL(BILL_STATUS,'X') not  in ('C','S')) and BLNG_GRP_ID in (select BLNG_G\
RP_ID  from BL_BLNG_GRP where NVL(SETTLEMENT_IND,'C')='X')) and OPERATING_FACI\
LITY_ID between nvl(ltrim(rtrim(:b5)),'  ') and nvl(ltrim(rtrim(:b6)),'~~')) a\
nd CUST_CODE=:b7)";
   sqlstm.iters = (unsigned int  )1;
...

{
 ...
 into :b1  from DUAL ";
   ...
   sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	/*Calculating the last periods SUM of AMOUNT and AVERAGE PER PERSON.*/
	...
	if (d_sett_ind.arr[0] == 'C')
	{
			...
			/* EXEC SQL SELECT SUM(BILL_AMT),
				 SUM(BILL_AMT)/COUNT(DISTINCT(PATIENT_ID))     
				 INTO :d_per_lst_sum,:d_per_lst_sum2
				 FROM BL_BILL_HDR
				 WHERE trunc(DOC_DATE) >= TO_DATE(:p_lst_fm_dt,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_lst_to_dt,'DD/MM/YYYY') AND
				 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
				 NVL(BILL_STATUS,'X') NOT IN ('C','S') AND
				 OPERATING_FACILITY_ID BETWEEN nvl(ltrim(rtrim(:nd_fr_facility)),'  ') 
		                          AND     nvl(ltrim(rtrim(:nd_to_facility)),'~~') AND 
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select sum(BILL_AMT) ,(sum(BILL_AMT)/count(distinct PATIEN\
T_ID)) into :b0,:b1  from BL_BILL_HDR where (((((trunc(DOC_DATE)>=TO_DATE(:b2,\
'DD/MM/YYYY') and trunc(DOC_DATE)<=TO_DATE(:b3,'DD/MM/YYYY')) and EPISODE_TYPE\
=DECODE(:b4,'A',EPISODE_TYPE,:b4)) and NVL(BILL_STATUS,'X') not  in ('C','S'))\
 and OPERATING_FACILITY_ID between nvl(ltrim(rtrim(:b6)),'  ') and nvl(ltrim(r\
trim(:b7)),'~~')) and BLNG_GRP_ID in (select BLNG_GRP_ID  from BL_BLNG_GRP whe\
re SETTLEMENT_IND='C'))";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&d_per_lst_sum2;
   sqlstm.sqhstl[1] = (unsigned int  )sizeof(double);
   sqlstm.sqhsts[1] = (         int  )0;
   sqlstm.sqindv[1] = (         void  *)0;
   sqlstm.sqinds[1] = (         int  )0;
   ...
   sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	else
	{
			...
			/* EXEC SQL SELECT SUM(BILL_AMT), SUM(BILL_AMT)/COUNT(DISTINCT(PATIENT_ID))     
				 INTO :d_per_lst_sum,:d_per_lst_sum2
				 FROM BL_BILL_HDR
				 WHERE trunc(DOC_DATE) >= TO_DATE(:p_lst_fm_dt,'DD/MM/YYYY') AND trunc(DOC_DATE) <= TO_DATE(:p_lst_to_dt,'DD/MM/YYYY') AND
				 EPISODE_TYPE = DECODE(:p_epsd_type,'A',EPISODE_TYPE,:p_epsd_type) AND 
...

{
   ...
   sqlstm.stmt = "select sum(BILL_AMT) ,(sum(BILL_AMT)/count(distinct PATIEN\
T_ID)) into :b0,:b1  from BL_BILL_HDR where ((((((trunc(DOC_DATE)>=TO_DATE(:b2\
,'DD/MM/YYYY') and trunc(DOC_DATE)<=TO_DATE(:b3,'DD/MM/YYYY')) and EPISODE_TYP\
E=DECODE(:b4,'A',EPISODE_TYPE,:b4)) and NVL(BILL_STATUS,'X') not  in ('C','S')\
) and BLNG_GRP_ID in (select BLNG_GRP_ID  from BL_BLNG_GRP where NVL(SETTLEMEN\
T_IND,'C')='X')) and OPERATING_FACILITY_ID between nvl(ltrim(rtrim(:b6)),'  ')\
 and nvl(ltrim(rtrim(:b7)),'~~')) and CUST_CODE=:b8)";
   sqlstm.iters = (unsigned int  )1;
...
//		fprintf(f1,"%c",0x12); /**** Set Printer to Normal Mode ****/
	...
	fprintf(f1,"OPR : %s                                    %23s \n",oper_id.arr,loc_legend[50]);
...
/*-- Heading Line 1 */
	...
	if (p_inc_no_pat.arr[0] == 'Y')
	{
	fprintf(f1,"               %6s			                     %11s           %13s     %15s\n",loc_legend[210],loc_legend[220],loc_legend[230],loc_legend[240]);
...
put_rec() 
{
	...
	//sprintf(l_mesg,"Sett Ind  %s    C D PER SUM  %f   C D PER LST SUM   %f",nd_sett_ind.arr,c_d_per_sum,c_d_per_lst_sum);
	//disp_message(ERR_MESG,l_mesg);
	if (nd_sett_ind.arr[0] != 'C')
	{
...
fetch_legend_value()
{
	for(i=1;i<=900;i++)
	{
		...
		/* EXEC SQL SELECT LTRIM(RTRIM('BLRREVNU.LEGEND_'||LTRIM(RTRIM(TO_CHAR(:i,'009')))))
		           INTO :l_pk_value
				   FROM dual; */ 

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRREVNU.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
...
e , :p_langugae_id ) ; END ;";
  ...
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (         void  *)&p_langugae_id;
  sqlstm.sqhstl[3] = (unsigned int  )5;
  sqlstm.sqhsts[3] = (         int  )0;
  sqlstm.sqindv[3] = (         void  *)0;
  sqlstm.sqinds[3] = (         int  )0;
