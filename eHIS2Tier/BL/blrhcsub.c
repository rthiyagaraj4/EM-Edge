...
static unsigned long sqlctx = 36416027;
...
"0) and b.acc_entity_code in (select acc_entity_code  from sy_acc_entity wher\
e acc_entity_id=:b0)) order by a.customer_code,a.hcare_appl_num            ";

 static const char *sq0007 = 
"cility_id=:b2) order by a.customer_code,a.hcare_appl_num            ";

 static const char *sq0008 = 
"ustomer_code is null ) and TRUNC(a.hcare_expiry_date)>=TRUNC(SYSDATE)) and a\
.operating_facility_id=:b0) order by 15,1,3            ";
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,140,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,65,0,4,162,0,0,1,0,0,1,0,2,9,0,0,
55,0,0,3,32,0,4,167,0,0,1,0,0,1,0,2,9,0,0,
74,0,0,4,94,0,4,172,0,0,3,1,0,1,0,2,9,0,0,2,3,0,0,1,9,0,0,
101,0,0,5,0,0,30,203,0,0,0,0,0,1,0,
116,0,0,6,1175,0,9,474,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
139,0,0,7,1092,0,9,484,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
166,0,0,8,2179,0,9,494,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
193,0,0,6,0,0,13,534,0,0,15,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,3,0,0,
268,0,0,7,0,0,13,607,0,0,15,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,3,0,0,
343,0,0,8,0,0,13,684,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,3,0,0,
2,9,0,0,
422,0,0,9,512,0,6,724,0,0,3,3,0,1,0,1,9,0,0,2,9,0,0,3,9,0,0,
449,0,0,6,0,0,15,758,0,0,0,0,0,1,0,
464,0,0,7,0,0,15,764,0,0,0,0,0,1,0,
479,0,0,8,0,0,15,769,0,0,0,0,0,1,0,
};
...
.patient_id patient_id ,SUBSTR(c.short_name,1,20) patinet_name ,SUBSTR(c.sho\
rt_name,21,60) patinet_nam1 ,d.short_desc hcare_scheme ,DECODE(a.payment_opt\
ion,'I','Immediate','R','Credit','S','Salary Ded','L','Instalment') payment \
,to_char(a.hcare_start_date,'dd/mm/yyyy') hcare_start_date ,to_char(a.hcare_\
expiry_date,'dd/mm/yyyy') hcare_expiry_date ,a.subscription_amt subscription\
_amt ,NVL(a.no_of_dependents,0) no_of_dependant  from bl_hcare_trn a ,ar_cus\
tomer b ,mp_patient_mast c ,bl_health_scheme d where (((((((((a.customer_cod\
e=b.cust_code and a.scheme_id=d.scheme_id) and a.patient_id=c.patient_id) an\
d a.emp_patient_id is null ) and a.customer_code is  not null ) and a.paymen\
t_option='R') and TRUNC(a.hcare_expiry_date)>=TRUNC(SYSDATE)) and a.hcare_st\
atus='A') and a.operating_facility_id=:b");
 sqlstm.stmt = sq0006;
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 appl_num ,TRUNC(a.hcare_appl_date) appl_date ,to_char(a.action_date,'dd/mm/\
yyyy') effective_date ,a.employee_id employee_id ,a.patient_id patient_id ,S\
UBSTR(c.short_name,1,20) patinet_name ,SUBSTR(c.short_name,21,60) patinet_na\
m1 ,d.short_desc hcare_scheme ,DECODE(a.payment_option,'I','Immediate','R','\
Credit','S','Salary Ded.','L','Instalment') payment ,to_char(a.hcare_start_d\
ate,'dd/mm/yyyy') hcare_start_date ,to_char(a.hcare_expiry_date,'dd/mm/yyyy'\
) hcare_expiry_date ,a.subscription_amt subscription_amt ,NVL(a.no_of_depend\
ents,0) no_of_dependant  from bl_hcare_trn a ,mp_patient_mast c ,bl_health_s\
cheme d where ((((((a.patient_id=c.patient_id and a.scheme_id=d.scheme_id) a\
nd a.emp_patient_id is null ) and a.hcare_status='A') and (((:b0='E' and a.e\
mployee_id is  not null ) and a.payment_option<>'R') or ((:b0='O' and a.empl\
oyee_id is null ) and a.customer_code is null ))) and TRUNC(a.hcare_expiry_d\
ate)>=TRUNC(SYSDATE)) and a.operating_fa");
 sqlstm.stmt = sq0007;
 sqlstm.iters = (unsigned int  )1;
...
e_appl_num appl_num ,to_char(a.hcare_appl_date,'dd/mm/yyyy') appl_date ,to_c\
har(a.action_date,'dd/mm/yyyy') effective_date ,a.employee_id employee_id ,a\
.patient_id patient_id ,SUBSTR(c.short_name,1,20) ent_name ,SUBSTR(c.short_n\
ame,21,60) ent_nam1 ,d.short_desc hcare_scheme ,DECODE(a.payment_option,'I',\
'Immediate','R','Credit','S','Salary Ded','L','Instalment') Payment ,to_char\
(a.hcare_start_date,'dd/mm/yyyy') hcare_start_date ,to_char(a.hcare_expiry_d\
ate,'dd/mm/yyyy') hcare_expiry_date ,a.subscription_amt subscription_amt ,NV\
L(a.no_of_dependents,0) no_of_dependant ,DECODE(a.customer_code,null ,'','C'\
) appl_type  from bl_hcare_trn a ,ar_customer b ,mp_patient_mast c ,bl_healt\
h_scheme d where (((((((((a.customer_code=b.cust_code and a.scheme_id=d.sche\
me_id) and a.patient_id=c.patient_id) and a.emp_patient_id is null ) and a.c\
ustomer_code is  not null ) and a.payment_option='R') and TRUNC(a.hcare_expi\
ry_date)>=TRUNC(SYSDATE)) and a.hcare_st");
 sqlbuft((void **)0, 
   "atus='A') and b.acc_entity_code in (select acc_entity_code  from sy_acc_\
entity where acc_entity_id=:b0)) and a.operating_facility_id=:b0) union sele\
ct a.customer_code customer_code ,'A' customer_name ,a.hcare_appl_num appl_n\
um ,to_char(a.hcare_appl_date,'dd/mm/yyyy') appl_date ,to_char(a.action_date\
,'dd/mm/yyyy') effective_date ,a.employee_id employee_id ,a.patient_id patie\
nt_id ,SUBSTR(c.short_name,1,20) patinet_name ,SUBSTR(c.short_name,21,60) pa\
tinet_nam1 ,d.short_desc hcare_scheme ,DECODE(a.payment_option,'I','Immediat\
e','R','Credit','S','Salary Ded.','L','Instalment') Payment ,to_char(a.hcare\
_start_date,'dd/mm/yyyy') hcare_start_date ,to_char(a.hcare_expiry_date,'dd/\
mm/yyyy') hcare_expiry_date ,a.subscription_amt subscription_amt ,NVL(a.no_o\
f_dependents,0) no_of_dependant ,DECODE(a.employee_id,null ,'O','E') appl_ty\
pe  from bl_hcare_trn a ,mp_patient_mast c ,bl_health_scheme d where ((((((a\
.patient_id=c.patient_id and a.scheme_id=d.scheme_id) and a.emp_patient_id i\
s null ) and a.hcare_status='A') and a.c");
 sqlstm.stmt = sq0008;
 sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqhstv[7] = (         void  *)&nd_patient_name;
  ...
  sqlstm.sqhstv[8] = (         void  *)&nd_patient_nam1;
  ...
  sqlstm.sqhstv[9] = (         void  *)&nd_hcare_scheme;
  ...
  sqlstm.sqhstv[10] = (         void  *)&nd_payment_option;
  ...
  sqlstm.sqhstv[11] = (         void  *)&nd_hcare_start_date;
  ...
  sqlstm.sqhstv[12] = (         void  *)&nd_hcare_expiry_date;
  ...
  sqlstm.sqhstv[13] = (         void  *)&nd_subscription_amt;
  ...
  sqlstm.sqhstv[14] = (         void  *)&nd_no_of_dependant;
...

{
  ...
  sqlstm.sqadto[14] = (unsigned short )0;
  sqlstm.sqtdso[14] = (unsigned short )0;
  sqlstm.sqhstv[15] = (         void  *)&nd_app_type;
...
OT NULL THEN :nd_patient_nam1 := str2 ; END IF ; blcommon . split_words ( :d_s\
hort_name_full , 30 , '*' , 3 , str1 , str2 ) ; IF str2 IS NOT NULL THEN :nd_p\
atient_nam1 := :nd_patient_nam1 || str2 ; end if ; END ; END ;";
 sqlstm.iters = (unsigned int  )1;
