...
{
    38,
    "D:\\BLTEST\\12X\\HSA-CRF-0093\\BLR00084.PC"
};


static unsigned long sqlctx = 603738811;
...
"SDATE,'YYYY') YER ,TO_CHAR(SYSDATE,'MON-YYYY') TRXMTH ,TO_CHAR(SYSDATE,'YYYY\
') TRXYER ,TO_CHAR(SYSDATE,'MON-YYYY') ORGMTH ,TO_CHAR(SYSDATE,'YYYY') ORGYER \
,'N'  from bl_blng_grp_catg a ,op_clinic_his_vw b where :b0='EM' order by 1,2,\
3,4,5,6,7,8            ";

 static const char *sq0011 = 
"A.DOC_TYPE_CODE) and B.DOC_NUM=A.DOC_NUM) and NVL(A.CANCELLED_YN,'N')='N') a\
nd B.ADJUST_EXEMPT_IND in ('E')))) or NVL(:b15,'Y')='N')) and ((NVL(:b18,'Y')=\
'Y' and NVL(BILL_TOT_WRITE_OFF_AMT,0)=0) or NVL(:b18,'Y')='N')) order by 1,2,3\
,4,5,6,7,8            ";
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,333,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,340,0,4,374,0,0,16,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,1,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,
115,0,0,3,91,0,2,418,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
138,0,0,4,81,0,4,2526,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
161,0,0,5,104,0,4,2531,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
188,0,0,6,204,0,3,2607,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
1,3,0,0,1,4,0,0,1,3,0,0,1,4,0,0,1,3,0,0,1,3,0,0,1,4,0,0,1,4,0,0,
255,0,0,7,0,0,29,2631,0,0,0,0,0,1,0,
270,0,0,8,338,0,3,2731,0,0,20,20,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,1,4,0,0,1,3,0,0,1,4,0,0,1,3,0,0,1,4,0,0,1,3,0,
0,1,4,0,0,1,3,0,0,1,4,0,0,1,3,0,0,1,4,0,0,
365,0,0,9,0,0,29,2771,0,0,0,0,0,1,0,
380,0,0,10,3327,0,9,3090,0,0,21,21,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
...
479,0,0,11,2302,0,9,3098,0,0,20,20,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
574,0,0,10,0,0,15,3106,0,0,0,0,0,1,0,
589,0,0,11,0,0,15,3112,0,0,0,0,0,1,0,
604,0,0,10,0,0,13,3161,0,0,23,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
...
711,0,0,11,0,0,13,3247,0,0,17,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,
0,2,9,0,0,2,9,0,0,
794,0,0,12,98,0,4,3295,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
817,0,0,13,98,0,4,3314,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
840,0,0,14,162,0,4,3337,0,0,5,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
875,0,0,15,0,0,32,3353,0,0,0,0,0,1,0,
890,0,0,16,96,0,4,3548,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
913,0,0,17,162,0,6,3555,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[3]; } l_language_id;
...
struct { unsigned short len; unsigned char arr[4]; } nd_sum_option;
...
/* VARCHAR		d_blng_grp_catg		[5],
			...
			d_org_mth			[9],
			d_episode_id		[9],
			d_doc_num		    [9],/oCRF-20405o/
			d_doc_type_code	    [9],/oCRF-20405o/
			d_valid_for_out		[2],
			nd1_episode_id		[9],
			nd1_doc_num		    [9],/oCRF-20405o/
			nd1_doc_type_code   [9],/oCRF-20405o/			
			nd2_episode_id		[9],
			nd2_doc_num  		[9],/oCRF-20405o/
			nd2_doc_type_code	[9],/oCRF-20405o/			
			nd_episode_id		[9],
			nd_doc_num  		[9],/oCRF-20405o/
			nd_doc_type_code	[9],/oCRF-20405o/			
			ndr_episode_id		[9],
			ndr_doc_num  		[9],/oCRF-20405o/
			ndr_doc_type_code	[9],/oCRF-20405o/
		    ndo_episode_id		[9],
			ndcly_episode_id	[9],
			ndcly_doc_num  		[9],/oCRF-20405o/
			ndcly_doc_type_code	[9],/oCRF-20405o/			
			ndcyr_episode_id	[9],
			ndcyr_doc_num  		[9],/oCRF-20405o/
			ndcyr_doc_type_code	[9],/oCRF-20405o/									
			ndrpc_episode_id	[9],
			ndrpc_doc_num  		[9],/oCRF-20405o/
			ndrpc_doc_type_code	[9],/oCRF-20405o/						
			ndadj_episode_id	[9],
			ndadj_doc_num  		[9],/oCRF-20405o/
			ndadj_doc_type_code	[9],/oCRF-20405o/
			ndbr_episode_id		[9],
			ndbr_doc_num  		[9],/oCRF-20405o/
			ndbr_doc_type_code	[9],/oCRF-20405o/			
			ndpm_episode_id		[9],
			ndpm_doc_num  		[9],/oCRF-20405o/
			ndpm_doc_type_code	[9],/oCRF-20405o/			
			ndlyr_episode_id	[9],
			ndlyr_doc_num  		[9],/oCRF-20405o/
			ndlyr_doc_type_code	[9],/oCRF-20405o/									
			ndawe_episode_id	[9],
			ndawe_doc_num  		[9],/oCRF-20405o/
			ndawe_doc_type_code	[9],/oCRF-20405o/						
			ndb_episode_id		[9],
			ndb_doc_num  		[9],/oCRF-20405o/
			ndb_doc_type_code	[9],/oCRF-20405o/
			ndc_episode_id		[9],
			ndlc_episode_id		[9],
			ndlc_doc_num		[9],
			ndlc_doc_type_code	[9],
			d_visit_id          [5],
			nd_visit_id         [5],
			ndr_visit_id        [5],
			ndcyr_visit_id      [5],
...
struct { unsigned short len; unsigned char arr[9]; } nd1_doc_num;

struct { unsigned short len; unsigned char arr[9]; } nd1_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } nd2_episode_id;

struct { unsigned short len; unsigned char arr[9]; } nd2_doc_num;

struct { unsigned short len; unsigned char arr[9]; } nd2_doc_type_code;
...
struct { unsigned short len; unsigned char arr[9]; } ndr_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndr_doc_type_code;
...
struct { unsigned short len; unsigned char arr[9]; } ndcly_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndcly_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } ndcyr_episode_id;

struct { unsigned short len; unsigned char arr[9]; } ndcyr_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndcyr_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } ndrpc_episode_id;

struct { unsigned short len; unsigned char arr[9]; } ndrpc_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndrpc_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } ndadj_episode_id;

struct { unsigned short len; unsigned char arr[9]; } ndadj_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndadj_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } ndbr_episode_id;

struct { unsigned short len; unsigned char arr[9]; } ndbr_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndbr_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } ndpm_episode_id;

struct { unsigned short len; unsigned char arr[9]; } ndpm_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndpm_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } ndlyr_episode_id;

struct { unsigned short len; unsigned char arr[9]; } ndlyr_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndlyr_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } ndawe_episode_id;

struct { unsigned short len; unsigned char arr[9]; } ndawe_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndawe_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } ndb_episode_id;

struct { unsigned short len; unsigned char arr[9]; } ndb_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndb_doc_type_code;
...
struct { unsigned short len; unsigned char arr[9]; } ndlc_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndlc_doc_type_code;
...
/* VARCHAR		d_sum_blng_grp_catg		[5],
			...
			ndo_doc_num     		[9],/oCRF-20405o/
			ndo_doc_type_code		[9],/oCRF-20405o/			
			ndc_sum_episode_id		[9],
			ndc_doc_num     		[9],/oCRF-20405o/
			ndc_doc_type_code		[9],/oCRF-20405o/
			d_sum_visit_id			[5],
...
struct { unsigned short len; unsigned char arr[9]; } ndo_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndo_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } ndc_sum_episode_id;

struct { unsigned short len; unsigned char arr[9]; } ndc_doc_num;

struct { unsigned short len; unsigned char arr[9]; } ndc_doc_type_code;
...

{
    ...
    if (sqlca.sqlcode < 0 )
	{
        ...
        /* EXEC SQL SELECT	PARAM1,PARAM2,PARAM3,to_char(to_date(PARAM1,'MON-YYYY'),'YYYY'),
				  ...
				  PARAM8,PARAM9,PARAM10,nvl(PARAM11,'R')
		              INTO 
					:nd_month_year,
				    :nd_det_option,
				    :nd_sum_option,
...
MON-YYYY'),'fmMonth YYYY') ,PARAM8 ,PARAM9 ,PARAM10 ,nvl(PARAM11,'R') into :b0\
...
while(fetch_bill_dtl_cur())
   {
     fetch_blng_grp_catg();
		if(strcmp(nd_sum_option.arr,"DI")==0 )
		   calc_summary_in();
        else if(strcmp(nd_sum_option.arr,"EM")==0 || strcmp(nd_sum_option.arr,"EMD")==0) /* SCR 5360 */
		       calc_summary_out();
		else
		   calc_summary_ref();
       if(cnt==0)
		...
		//	print_bed_clinic();
			  ...
			  brcnt=0;
			  adjcnt=0;
			  if(strcmp(nd_det_option.arr,"DI")==0 || strcmp(nd_det_option.arr,"I")==0) /* SCR 5360 */
			   calc_amount();
 ...
 //modified 03/12/2005 }
		...
		strcpy(nd_doc_type_code.arr,d_doc_num.arr);/*CRF-20405*/
		strcpy(nd_doc_num.arr,d_doc_type_code.arr);/*CRF-20405*/
		strcpy(nd1_episode_id.arr,d_episode_id.arr);
		strcpy(nd1_doc_type_code.arr,d_doc_num.arr);/*CRF-20405*/
		strcpy(nd1_doc_num.arr,d_doc_type_code.arr);/*CRF-20405*/
...
calc_summary_out()
  {
 if(strcmp(d_sum_episode_type.arr,"O")==0 || strcmp(d_sum_episode_type.arr,"E")==0 || strcmp(d_sum_episode_type.arr,"D")==0) /* SCR 5360 */
   {
    if(strcmp(d_sum_national.arr,"NATIONALS")==0)
	     {
		  /* Modified By Saif ,The condition Cancel Receipt and Refund is Added */ 
		  if(strcmp(d_sum_trx_type.arr,"RECEIPT")==0 || strcmp(d_sum_trx_type.arr,"REFUND")==0 || strcmp(d_sum_trx_type.arr,"CANC-RECEIPT")==0 || strcmp(d_sum_trx_type.arr,"CANC-REFUND")==0)
		{							
			sum_no_enctr_amt=sum_no_enctr_amt+d_sum_outst_amt;
		    /*CRF-20405*/
			//if(strcmp(d_sum_episode_id.arr,ndc_sum_episode_id.arr)!=0)			
			if(strcmp(d_doc_type_code.arr,ndc_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndc_doc_num.arr)==0)
			  {
				 ...
				 if (strcmp(d_sum_trx_type.arr,"CANC-RECEIPT")==0 || strcmp(d_sum_trx_type.arr,"CANC-REFUND")==0)				
					{
					sum_no_enctr_cnt=sum_no_enctr_cnt-1;
					}				
				//sum_no_enctr_cnt=sum_no_enctr_cnt+1;
	          //strcpy(ndc_sum_episode_id.arr,d_sum_episode_id.arr);
			   strcpy(ndc_doc_type_code.arr,d_doc_type_code.arr);  
			   strcpy(ndc_doc_num.arr,d_doc_num.arr); 			  
			  }
			  }
          }
			...
			if(strcmp(d_doc_type_code.arr,ndo_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndo_doc_num.arr)==0)
			   {
			   	 if(strcmp(d_sum_trx_type.arr,"RECEIPT")==0 || strcmp(d_sum_trx_type.arr,"REFUND")==0)
				   {
			   ...
			   strcpy(ndo_doc_type_code.arr,d_doc_type_code.arr);  
			   strcpy(ndo_doc_num.arr,d_doc_num.arr); 			  
			   }
			   }
			}  
    } 
...
calc_amount()
  {
   ...
   if(strcmp(d_episode_type.arr,"I")==0 || strcmp(d_episode_type.arr,"D")==0)
   {
				  ...
				  if(strcmp(d_valid_for_out.arr,"Y")==0)
				   {
					...
					if(strcmp(d_doc_type_code.arr,ndb_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndb_doc_num.arr)==0)					
					 cur_mth_bill_cntamt =  cur_mth_bill_cntamt+d_bill_tot_amt; 
				      ...
				      {	   			
					   ...
					   strcpy(ndb_doc_type_code.arr,d_doc_type_code.arr);  
					   strcpy(ndb_doc_num.arr,d_doc_num.arr);  
                    }
      ...
      if(strcmp(d_bill_mth.arr,nd_month_year.arr)!=0 && strcmp(d_trx_mth.arr,nd_month_year.arr)==0 && strcmp(d_trx_type.arr,"CANC-BILL")==0)
              {
	           cur_mth_bill_canc_amt=cur_mth_bill_canc_amt+d_bill_tot_amt;    
					...
					if(strcmp(d_doc_type_code.arr,ndlc_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndlc_doc_num.arr)==0) 
					 cur_mth_bill_canc_cntamt =  cur_mth_bill_canc_cntamt+d_bill_tot_amt; 
				      ...
				      {	   
					   ...
					   strcpy(ndlc_doc_type_code.arr,d_doc_type_code.arr);  
					   strcpy(ndlc_doc_num.arr,d_doc_num.arr);  
                   }
       ...
       if(strcmp(d_bill_mth.arr,nd_month_year.arr)==0 && strcmp(d_trx_mth.arr,nd_month_year.arr)==0 )                                                          
       {
			...
			{				  
				/* Modified By Saif */
				if(strcmp(d_trx_type.arr,"RECEIPT")==0 || strcmp(d_trx_type.arr,"REFUND")==0 || strcmp(d_trx_type.arr,"CANC-RECEIPT")==0 || strcmp(d_trx_type.arr,"CANC-REFUND")==0)
				{
	              cur_mth_bill_rec_amt=cur_mth_bill_rec_amt+d_outst_amt;    
	             /*CRF-20405*/   
			     //if(strcmp(d_episode_id.arr,ndr_episode_id.arr)==0)
				  if(strcmp(d_doc_type_code.arr,ndr_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndr_doc_num.arr)==0) 
				    ...
				    {				 						
	             	 ...
	             	 //strcpy(ndr_episode_id.arr,d_episode_id.arr);
					   strcpy(ndr_doc_type_code.arr,d_doc_type_code.arr);  
					   strcpy(ndr_doc_num.arr,d_doc_num.arr); 					
				 }
		...
		/*--------------OutStanding Amount condition moved by saurabh-----------*/		
		if(strcmp(d_trx_mth.arr,nd_month_year.arr)==0)
		{
		   ...
		   {				  
			  ...
			  /*CRF-20405*/   
			  //if(strcmp(d_episode_id.arr,ndbr_episode_id.arr)==0)
			  if(strcmp(d_doc_type_code.arr,ndbr_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndbr_doc_num.arr)==0) 
				  cur_mth_bill_out_cntamt =  cur_mth_bill_out_cntamt+d_outst_amt; 
     		  else
			  ...
			  {				
			   ...
			   //strcpy(ndbr_episode_id.arr,d_episode_id.arr); 
				 strcpy(ndbr_doc_type_code.arr,d_doc_type_code.arr);  
				 strcpy(ndbr_doc_num.arr,d_doc_num.arr); 			   
			}
		}				
		   ...
		   if(strcmp(d_valid_for_out.arr,"Y")==0)  
	         {
				...
				if(strcmp(d_doc_type_code.arr,ndawe_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndawe_doc_num.arr)==0)  
     			  ...
     			  else				  
				   {
                     ...
                     //strcpy(ndadj_episode_id.arr,d_episode_id.arr);
					   strcpy(ndawe_doc_type_code.arr,d_doc_type_code.arr);  
					   strcpy(ndawe_doc_num.arr,d_doc_num.arr); 			   
      ...
      /*---------------RECEIPT TILL PREVIOUS MONTH AND CANCELLED THIS MONTH--------------*/
         if(strcmp(d_trx_mth.arr,nd_month_year.arr)==0 &&  strcmp(d_org_mth.arr,nd_month_year.arr)!=0 && (strcmp(d_trx_type.arr,"CANC-RECEIPT")==0 || strcmp(d_trx_type.arr,"CANC-REFUND")==0) )                                                        
              {
	              prev_rec_cur_can_amt=prev_rec_cur_can_amt+d_bill_tot_amt;    
	           
				/*CRF-20405*/  
				//if(strcmp(d_episode_id.arr,ndrpc_episode_id.arr)==0 )
				if(strcmp(d_doc_type_code.arr,ndrpc_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndrpc_doc_num.arr)==0)  
                ...
                //strcpy(ndrpc_episode_id.arr,d_episode_id.arr);
			      strcpy(ndrpc_doc_type_code.arr,d_doc_type_code.arr);  
			      strcpy(ndrpc_doc_num.arr,d_doc_num.arr); 				
			      
		       }             
      /*---------------PREVIOUS MONTHS BILLS IN CURRENT YEAR--OUTSTANDING-----------------------*/\
	  //added and commented by saurabh. If condition changed. Trx Month and Current Month Checking commented.
		 ...
		 if(strcmp(d_trx_mth.arr,nd_month_year.arr)!=0 &&  strcmp(d_bill_year.arr,nd_year.arr)==0)
           {
		     if(strcmp(d_valid_for_out.arr,"Y")==0)
		       {
				...
				if(strcmp(d_doc_type_code.arr,nd2_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,nd2_doc_num.arr)==0)  				  
				   ...
				   //strcpy(nd2_episode_id.arr,d_episode_id.arr);
			         strcpy(nd2_doc_type_code.arr,d_doc_type_code.arr);  
			         strcpy(nd2_doc_num.arr,d_doc_num.arr); 							    
			  }  
		   }
        /*------------AMOUNT COLLECTED THIS MTH FOR BILLS TILL PREVIOUS MONTH OF CURR YEAR--------- */ 
		/* Modify by Saif that condition for cancel reciept and refund is added */                                           
         if(strcmp(d_trx_mth.arr,nd_month_year.arr)==0 &&  strcmp(d_bill_year.arr,nd_year.arr)==0 && strcmp(d_bill_mth.arr,nd_month_year.arr)!=0  && (strcmp(d_trx_type.arr,"RECEIPT")==0|| strcmp(d_trx_type.arr,"REFUND")==0 || strcmp(d_trx_type.arr,"CANC-RECEIPT")==0 || strcmp(d_trx_type.arr,"CANC-REFUND")==0))
             {
				...
				if(strcmp(d_doc_type_code.arr,ndpm_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndpm_doc_num.arr)==0)
				  ...
				  else
				   {
					...
					//strcpy(ndpm_episode_id.arr,d_episode_id.arr);    
			         strcpy(ndpm_doc_type_code.arr,d_doc_type_code.arr);  
			         strcpy(ndpm_doc_num.arr,d_doc_num.arr); 								
				  }    
             } 
        /*---------RECEIPT CANCELLED THIS MTH FOR RECEIPTS TILL LAST MTH OF CURR YEAR-------------*/
         if(strcmp(d_trx_mth.arr,nd_month_year.arr)==0 &&  strcmp(d_org_year.arr,nd_year.arr)==0 && strcmp(d_org_mth.arr,nd_month_year.arr)!=0 && (strcmp(d_trx_type.arr,"CANC-RECEIPT")==0 || strcmp(d_trx_type.arr,"CANC-REFUND")==0))
				...
				if(strcmp(d_doc_type_code.arr,ndcyr_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndcyr_doc_num.arr)==0)				  
				 ...
				 strcpy(ndcyr_doc_type_code.arr,d_doc_type_code.arr);  
				 strcpy(ndcyr_doc_num.arr,d_doc_num.arr); 													             
	         	}

       /*---------AMOUNT COLLECTED THIS MONTH FOR BILLS TILL LAST YEAR---------------------------*/
         /* Modify by Saif,the condition for cancel reciept and refund is added */                                                       
	     if(strcmp(d_trx_mth.arr,nd_month_year.arr)==0 && strcmp(d_bill_year.arr,nd_year.arr)!=0 && (strcmp(d_trx_type.arr,"RECEIPT")==0 || strcmp(d_trx_type.arr,"REFUND")==0 || strcmp(d_trx_type.arr,"CANC-RECEIPT")==0 || strcmp(d_trx_type.arr,"CANC-REFUND")==0))
           {
			  if(strcmp(d_valid_for_out.arr,"Y")==0)
			   {
				...
				if(strcmp(d_doc_type_code.arr,ndlyr_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndlyr_doc_num.arr)==0)
				...
				//strcpy(ndlyr_episode_id.arr,d_episode_id.arr); 
				 strcpy(ndlyr_doc_type_code.arr,d_doc_type_code.arr);  
				 strcpy(ndlyr_doc_num.arr,d_doc_num.arr); 				
				}
			}
        /*--------AMOUNT CANCELLED THIS MONTH FOR RECEIPT DATE LAST YEAR----------------------------*/
        if(strcmp(d_trx_mth.arr,nd_month_year.arr)==0 && strcmp(d_org_year.arr,nd_year.arr)!=0 && (strcmp(d_trx_type.arr,"CANC_RECEIPT")==0 || strcmp(d_trx_type.arr,"CANC_REFUND")==0 ))
           {
	         lastyr_rec_canc_curmth_amt=lastyr_rec_canc_curmth_amt+d_outst_amt;    
				...
				if(strcmp(d_doc_type_code.arr,ndcly_doc_type_code.arr)==0 && strcmp(d_doc_num.arr,ndcly_doc_num.arr)==0) 
				 ...
				 strcpy(ndcly_doc_type_code.arr,d_doc_type_code.arr);  
				 strcpy(ndcly_doc_num.arr,d_doc_num.arr);				
   ...
   if(strcmp(d_episode_type.arr,"O")==0 || strcmp(d_episode_type.arr,"E")==0)
    {
      ...
      if(strcmp(d_bill_mth.arr,nd_month_year.arr)!=0 && strcmp(d_trx_mth.arr,nd_month_year.arr)==0 && strcmp(d_trx_type.arr,"CANC-BILL")==0)
       ...
       if(strcmp(d_bill_mth.arr,nd_month_year.arr)==0 && strcmp(d_trx_mth.arr,nd_month_year.arr)==0 )                                                          
			...
			/*--------------OutStanding Amount added by saurabh-----------*/
       ...
       if(strcmp(d_bill_mth.arr,nd_month_year.arr)==0 && strcmp(d_trx_mth.arr,nd_month_year.arr)==0 )                                                          
              {
			   if(strcmp(d_valid_for_out.arr,"Y")==0)
				 {
				  //if(strcmp(d_trx_type.arr,"RECEIPT")==0 || strcmp(d_trx_type.arr,"REFUND")==0) //commented by saif
					/* Added By saif */
					if(strcmp(d_trx_type.arr,"RECEIPT")==0 || strcmp(d_trx_type.arr,"REFUND")==0 || strcmp(d_trx_type.arr,"CANC-RECEIPT")==0 || strcmp(d_trx_type.arr,"CANC-REFUND")==0)
					{
	                  cur_mth_bill_rec_amt=cur_mth_bill_rec_amt+d_outst_amt;   		  
...
ndpm_ind=0;
	...
	cur_mth_bill_rec_cntamt=0;
	cur_mth_bill_canc_cntamt=0;
	cur_mth_bill_cntamt=0;/*CRF-20405*/
	...
	strcpy(nd_doc_type_code.arr," ");/*CRF-20405*/				
	strcpy(nd_doc_num.arr," ");/*CRF-20405*/	
	strcpy(nd1_doc_type_code.arr," ");/*CRF-20405*/				
	strcpy(nd1_doc_num.arr," ");/*CRF-20405*/	
	strcpy(nd2_doc_num.arr," ");/*CRF-20405*/
	strcpy(nd2_doc_type_code.arr," ");/*CRF-20405*/						
	strcpy(ndr_episode_id.arr," ");			
	strcpy(ndr_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndr_doc_num.arr," ");/*CRF-20405*/		
	strcpy(ndcly_episode_id.arr," ");
	strcpy(ndcly_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndcly_doc_num.arr," ");/*CRF-20405*/					
	strcpy(ndcyr_episode_id.arr," ");
	strcpy(ndcyr_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndcyr_doc_num.arr," ");/*CRF-20405*/								
	strcpy(ndrpc_episode_id.arr," ");
	strcpy(ndrpc_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndrpc_doc_num.arr," ");/*CRF-20405*/							
	strcpy(ndadj_episode_id.arr," ");
	strcpy(ndadj_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndadj_doc_num.arr," ");/*CRF-20405*/							
	strcpy(ndbr_episode_id.arr," ");
	strcpy(ndbr_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndbr_doc_num.arr," ");/*CRF-20405*/										
	strcpy(ndpm_episode_id.arr," ");			
	strcpy(ndpm_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndpm_doc_num.arr," ");/*CRF-20405*/			
	strcpy(ndlyr_episode_id.arr," ");		
	strcpy(ndlyr_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndlyr_doc_num.arr," ");/*CRF-20405*/						
	strcpy(ndawe_episode_id.arr," ");
	strcpy(ndawe_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndawe_doc_num.arr," ");/*CRF-20405*/						
	strcpy(ndb_episode_id.arr," ");		
	strcpy(ndb_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndb_doc_num.arr," ");/*CRF-20405*/		
	strcpy(ndlc_episode_id.arr," ");
	strcpy(ndlc_doc_type_code.arr," ");/*CRF-20405*/		
	strcpy(ndlc_doc_num.arr," ");/*CRF-20405*/				
...
print_page_title();   
	...
	if(strcmp(nd_det_option.arr,"I")==0) /* SCR 5360 added by saurabh*/ 
	...
	if (strcmp(nd_sum_option.arr,"EMD")==0) /* SCR 5360 added by saurabh*/
...
declare_cursor()
 ...
 SELECT nvl(c.blng_grp_catg,'**'),
        DECODE(:nd_det_option,'DI',nvl(a.bed_class_code,'**'),
		'I',nvl(a.bed_class_code,'**'), /o SCR 5360 o/
		'EM',NVL(a.clinic_code,'**'),'**'),
        ...
        a.bill_amt,
		nvl(b.debit_amt,0)-nvl(b.credit_amt,0)outst_amt,      
	trx_nature_code,
 ...
 AND (A.EPISODE_TYPE =decode(:nd_det_option,'DI','I','I','I','EM','O','R') /o SCR 5360o/
     OR
      A.EPISODE_TYPE =decode(:nd_det_option,'DI','D','I','I','EM','E','R') /o SCR 5360o/
      )   
 ...
 AND B.TRX_TYPE NOT IN(DECODE(:nd_excl_ref,'Y','REFUND','XX'),DECODE(:nd_excl_ref,'Y','CANC-REFUND','XX')) 
    /oModified for ML-SD-CRF-20405o/
	/oAND (
   ...
   AND  (
	   ...
	   or 
      NVL(:nd_exc_exmp,'Y')='N')o/
 AND ( 
       (NVL(:nd_exc_adj,'Y')='Y' and (a.doc_type_code, a.doc_num) NOT IN 
																(select B.ADJ_DOC_TYPE_CODE, B.ADJ_DOC_NUM
																FROM bl_bill_adj_hdr A, bl_bill_adj_dtl B
																WHERE
																B.OPERATING_FACILITY_ID = :nd_facility AND
																A.OPERATING_FACILITY_ID = B.OPERATING_FACILITY_ID AND
																B.DOC_TYPE_CODE = A.DOC_TYPE_CODE AND
																B.DOC_NUM = A.DOC_NUM AND 
																NVL(A.CANCELLED_YN,'N') = 'N' AND
																B.ADJUST_EXEMPT_IND IN ('A','S')))
	   or 
      NVL(:nd_exc_adj,'Y')='N') 	 
 AND  (
       (NVL(:nd_exc_exmp,'Y')='Y' and  (a.doc_type_code, a.doc_num) NOT IN 
																(select B.ADJ_DOC_TYPE_CODE, B.ADJ_DOC_NUM
																FROM bl_bill_adj_hdr A, bl_bill_adj_dtl B
																WHERE
																B.OPERATING_FACILITY_ID = :nd_facility AND
...
WHERE :nd_det_option in ('DI','I') /o SCR 5360o/
...
/* EXEC SQL DECLARE BILL_DCP_DTL_SUM_CUR CURSOR FOR 
  SELECT nvl(c.blng_grp_catg,'**'),
		...
		'EMD',NVL(a.clinic_code,'**'), /oSCR 5360o/
		'**'),
	    a.episode_type, to_char(a.episode_id), 
	 to_char(a.visit_id),a.doc_type_code,a.doc_num,b.trx_type,b.doc_date trx_date,
        b.org_doc_date,A.DOC_DATE BILL_DATE,
...
//	b.VALID_FOR_OUTSTDG_YN
 ...
 WHERE b.operating_facility_id = :nd_facility
  //AND   b.doc_date <= TO_DATE(TO_CHAR(LAST_DAY(TO_DATE(:nd_month_year,'MON-YYYY')),'DD/MM/YYYY')||' 23:59:59','DD/MM/YYYY HH24:MI:SS')   ***Commented as request from Lahd datu site*****
   ...
   AND a.doc_num = nvl(b.adj_doc_num,b.doc_number)  
   AND a.blng_grp_id = c.blng_grp_id(+) 
   AND (A.EPISODE_TYPE =decode(:nd_sum_option,'DI','I','EM','O','EMD','O','R')
       OR
		A.EPISODE_TYPE =decode(:nd_sum_option,'DI','D','EM','E','EMD','E','R')
       OR
		A.EPISODE_TYPE =decode(:nd_sum_option,'DI','D','EM','E','EMD','D','R')
	   )  
   AND B.document_nature IN ('BI','DC')
   AND TRX_NATURE_CODE NOT IN (DECODE(:nd_excl_dep,'Y','AD','XX'),DECODE(:nd_excl_dep,'Y','PR','XX'))
   //and  DECODE(B.TRX_TYPE,'BILL',SIGN(NVL(b.debit_amt,0)-nvl(b.credit_amt,0)),0) >=0
...
**'),'I',nvl(a.bed_class_code,'**'),'EM',NVL(a.clinic_code,'**'),'**') ,a.ep\
isode_type ,to_char(a.episode_id) ,to_char(a.visit_id) ,a.doc_type_code ,a.d\
oc_num ,b.trx_type ,b.doc_date trx_date ,b.org_doc_date ,A.DOC_DATE BILL_DAT\
E ,a.patient_id ,blcommon.get_reln_code(a.patient_id) citizen ,a.bill_amt ,(\
nvl(b.debit_amt,0)-nvl(b.credit_amt,0)) outst_amt ,trx_nature_code ,to_char(\
a.doc_date,'MON-YYYY') MTH ,to_char(a.doc_date,'YYYY') YER ,to_char(B.doc_da\
te,'MON-YYYY') TRXMTH ,to_char(B.doc_date,'YYYY') TRXYER ,to_char(b.org_doc_\
date,'MON-YYYY') ORGMTH ,to_char(b.org_doc_date,'YYYY') ORGYER ,DECODE(A.BIL\
L_STATUS,'C','N','Y')  from bl_bill_dcp_dtl_temp a ,bl_patient_statement_tem\
p b ,bl_blng_grp_by_catg c where ((((((((((((((b.operating_facility_id=:b1 a\
nd b.doc_date<=TO_DATE((TO_CHAR(LAST_DAY(TO_DATE(:b2,'MON-YYYY')),'DD/MM/YYY\
Y')||' 23:59:59'),'DD/MM/YYYY HH24:MI:SS')) and a.doc_date<=TO_DATE((TO_CHAR\
(LAST_DAY(TO_DATE(:b2,'MON-YYYY')),'DD/M");
 sqlbuft((void **)0, 
   "M/YYYY')||' 23:59:59'),'DD/MM/YYYY HH24:MI:SS')) and a.operating_facilit\
y_id=:b1) and a.doc_type_code=nvl(b.adj_doc_type_code,b.doc_type_code)) and \
a.doc_num=nvl(b.adj_doc_num,b.doc_number)) and a.blng_grp_id=c.blng_grp_id(+\
)) and (A.EPISODE_TYPE=decode(:b0,'DI','I','I','I','EM','O','R') or A.EPISOD\
E_TYPE=decode(:b0,'DI','D','I','I','EM','E','R'))) and B.document_nature in \
('BI','DC')) and A.BILL_TOT_AMT>0) and TRX_NATURE_CODE not  in (DECODE(:b7,'\
Y','AD','XX'),DECODE(:b7,'Y','PR','XX'))) and B.TRX_TYPE not  in (DECODE(:b9\
,'Y','REFUND','XX'),DECODE(:b9,'Y','CANC-REFUND','XX'))) and ((NVL(:b11,'Y')\
='Y' and (a.doc_type_code,a.doc_num) not  in (select B.ADJ_DOC_TYPE_CODE ,B.\
ADJ_DOC_NUM  from bl_bill_adj_hdr A ,bl_bill_adj_dtl B where (((((B.OPERATIN\
G_FACILITY_ID=:b1 and A.OPERATING_FACILITY_ID=B.OPERATING_FACILITY_ID) and B\
.DOC_TYPE_CODE=A.DOC_TYPE_CODE) and B.DOC_NUM=A.DOC_NUM) and NVL(A.CANCELLED\
_YN,'N')='N') and B.ADJUST_EXEMPT_IND in ('A','S')))) or NVL(:b11,'Y')='N'))\
 and ((NVL(:b14,'Y')='Y' and (a.doc_type");
 sqlbuft((void **)0, 
   "_code,a.doc_num) not  in (select B.ADJ_DOC_TYPE_CODE ,B.ADJ_DOC_NUM  fro\
m bl_bill_adj_hdr A ,bl_bill_adj_dtl B where (((((B.OPERATING_FACILITY_ID=:b\
1 and A.OPERATING_FACILITY_ID=B.OPERATING_FACILITY_ID) and B.DOC_TYPE_CODE=A\
.DOC_TYPE_CODE) and B.DOC_NUM=A.DOC_NUM) and NVL(A.CANCELLED_YN,'N')='N') an\
d B.ADJUST_EXEMPT_IND in ('E')))) or NVL(:b14,'Y')='N')) and ((NVL(:b17,'Y')\
='Y' and NVL(BILL_TOT_WRITE_OFF_AMT,0)=0) or NVL(:b17,'Y')='N')) union all s\
elect a.blng_grp_catg ,b.bed_class_code ,'I' ,'0' ,'0' ,'~~~' ,0 ,'~~~' ,SYS\
DATE ,SYSDATE ,SYSDATE ,'~~~' ,'~~~' ,0 ,0 ,'~~~' ,TO_CHAR(SYSDATE,'MON-YYYY\
') MTH ,TO_CHAR(SYSDATE,'YYYY') YER ,TO_CHAR(SYSDATE,'MON-YYYY') TRXMTH ,TO_\
CHAR(SYSDATE,'YYYY') TRXYER ,TO_CHAR(SYSDATE,'MON-YYYY') ORGMTH ,TO_CHAR(SYS\
DATE,'YYYY') ORGYER ,'N'  from bl_blng_grp_catg a ,ip_bed_class b where :b0 \
in ('DI','I') union all select a.blng_grp_catg ,b.clinic_code ,'O' ,'0' ,'0'\
 ,'~~~' ,0 ,'~~~' ,SYSDATE ,SYSDATE ,SYSDATE ,'~~~' ,'~~~' ,0 ,0 ,'~~~' ,TO_\
CHAR(SYSDATE,'MON-YYYY') MTH ,TO_CHAR(SY");
 sqlstm.stmt = sq0010;
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqadto[12] = (unsigned short )0;
 sqlstm.sqtdso[12] = (unsigned short )0;
 sqlstm.sqhstv[13] = (         void  *)&nd_exc_adj;
 ...
 sqlstm.sqadto[14] = (unsigned short )0;
 sqlstm.sqtdso[14] = (unsigned short )0;
 sqlstm.sqhstv[15] = (         void  *)&nd_facility;
 ...
 sqlstm.sqadto[15] = (unsigned short )0;
 sqlstm.sqtdso[15] = (unsigned short )0;
 sqlstm.sqhstv[16] = (         void  *)&nd_exc_exmp;
 ...
 sqlstm.sqadto[16] = (unsigned short )0;
 sqlstm.sqtdso[16] = (unsigned short )0;
 sqlstm.sqhstv[17] = (         void  *)&nd_exc_writeoff;
 ...
 sqlstm.sqadto[17] = (unsigned short )0;
 sqlstm.sqtdso[17] = (unsigned short )0;
 sqlstm.sqhstv[18] = (         void  *)&nd_exc_writeoff;
 ...
 sqlstm.sqadto[18] = (unsigned short )0;
 sqlstm.sqtdso[18] = (unsigned short )0;
 sqlstm.sqhstv[19] = (         void  *)&nd_det_option;
 ...
 sqlstm.sqadto[19] = (unsigned short )0;
 sqlstm.sqtdso[19] = (unsigned short )0;
 sqlstm.sqhstv[20] = (         void  *)&nd_det_option;
...

{
 ...
 sqlbuft((void **)0, 
   "select nvl(c.blng_grp_catg,'**') ,DECODE(:b0,'DI',nvl(a.bed_class_code,'\
**'),'EM',NVL(a.clinic_code,'**'),'EMD',NVL(a.clinic_code,'**'),'**') ,a.epi\
sode_type ,to_char(a.episode_id) ,to_char(a.visit_id) ,a.doc_type_code ,a.do\
c_num ,b.trx_type ,b.doc_date trx_date ,b.org_doc_date ,A.DOC_DATE BILL_DATE\
 ,a.patient_id ,blcommon.get_reln_code(a.patient_id) citizen ,a.bill_amt ,(n\
vl(b.debit_amt,0)-nvl(b.credit_amt,0)) outst_amt ,trx_nature_code ,DECODE(A.\
BILL_STATUS,'C','N','Y')  from bl_bill_dcp_dtl_temp a ,bl_patient_statement_\
temp b ,bl_blng_grp_by_catg c where (((((((((((((b.operating_facility_id=:b1\
 and to_char(b.doc_date,'YYYYMM')=TO_CHAR(TO_DATE(:b2,'MON-YYYY'),'YYYYMM'))\
 and a.doc_date<=TO_DATE((TO_CHAR(LAST_DAY(TO_DATE(:b2,'MON-YYYY')),'DD/MM/Y\
YYY')||' 23:59:59'),'DD/MM/YYYY HH24:MI:SS')) and a.operating_facility_id=:b\
1) and a.doc_type_code=nvl(b.adj_doc_type_code,b.doc_type_code)) and a.doc_n\
um=nvl(b.adj_doc_num,b.doc_number)) and a.blng_grp_id=c.blng_grp_id(+)) and \
((A.EPISODE_TYPE=decode(:b0,'DI','I','EM");
 sqlbuft((void **)0, 
   "','O','EMD','O','R') or A.EPISODE_TYPE=decode(:b0,'DI','D','EM','E','EMD\
','E','R')) or A.EPISODE_TYPE=decode(:b0,'DI','D','EM','E','EMD','D','R'))) \
and B.document_nature in ('BI','DC')) and TRX_NATURE_CODE not  in (DECODE(:b\
8,'Y','AD','XX'),DECODE(:b8,'Y','PR','XX'))) and B.TRX_TYPE not  in (DECODE(\
:b10,'Y','REFUND','XX'),DECODE(:b10,'Y','CANC-REFUND','XX'))) and ((NVL(:b12\
,'Y')='Y' and (a.doc_type_code,a.doc_num) not  in (select B.ADJ_DOC_TYPE_COD\
E ,B.ADJ_DOC_NUM  from bl_bill_adj_hdr A ,bl_bill_adj_dtl B where (((((B.OPE\
RATING_FACILITY_ID=:b1 and A.OPERATING_FACILITY_ID=B.OPERATING_FACILITY_ID) \
and B.DOC_TYPE_CODE=A.DOC_TYPE_CODE) and B.DOC_NUM=A.DOC_NUM) and NVL(A.CANC\
ELLED_YN,'N')='N') and B.ADJUST_EXEMPT_IND in ('A','S')))) or NVL(:b12,'Y')=\
'N')) and ((NVL(:b15,'Y')='Y' and (a.doc_type_code,a.doc_num) not  in (selec\
t B.ADJ_DOC_TYPE_CODE ,B.ADJ_DOC_NUM  from bl_bill_adj_hdr A ,bl_bill_adj_dt\
l B where (((((B.OPERATING_FACILITY_ID=:b1 and A.OPERATING_FACILITY_ID=B.OPE\
RATING_FACILITY_ID) and B.DOC_TYPE_CODE=");
 sqlstm.stmt = sq0011;
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqadto[6] = (unsigned short )0;
 sqlstm.sqtdso[6] = (unsigned short )0;
 sqlstm.sqhstv[7] = (         void  *)&nd_sum_option;
 ...
 sqlstm.sqadto[8] = (unsigned short )0;
 sqlstm.sqtdso[8] = (unsigned short )0;
 sqlstm.sqhstv[9] = (         void  *)&nd_excl_dep;
 sqlstm.sqhstl[9] = (unsigned int  )4;
 sqlstm.sqhsts[9] = (         int  )0;
 sqlstm.sqindv[9] = (         void  *)0;
 sqlstm.sqinds[9] = (         int  )0;
 ...
 sqlstm.sqadto[10] = (unsigned short )0;
 sqlstm.sqtdso[10] = (unsigned short )0;
 sqlstm.sqhstv[11] = (         void  *)&nd_excl_ref;
 sqlstm.sqhstl[11] = (unsigned int  )4;
 sqlstm.sqhsts[11] = (         int  )0;
 sqlstm.sqindv[11] = (         void  *)0;
 sqlstm.sqinds[11] = (         int  )0;
 ...
 sqlstm.sqadto[13] = (unsigned short )0;
 sqlstm.sqtdso[13] = (unsigned short )0;
 sqlstm.sqhstv[14] = (         void  *)&nd_exc_adj;
 sqlstm.sqhstl[14] = (unsigned int  )4;
 sqlstm.sqhsts[14] = (         int  )0;
 sqlstm.sqindv[14] = (         void  *)0;
 sqlstm.sqinds[14] = (         int  )0;
 ...
 sqlstm.sqadto[14] = (unsigned short )0;
 sqlstm.sqtdso[14] = (unsigned short )0;
 sqlstm.sqhstv[15] = (         void  *)&nd_exc_exmp;
 ...
 sqlstm.sqadto[16] = (unsigned short )0;
 sqlstm.sqtdso[16] = (unsigned short )0;
 sqlstm.sqhstv[17] = (         void  *)&nd_exc_exmp;
 sqlstm.sqhstl[17] = (unsigned int  )4;
 sqlstm.sqhsts[17] = (         int  )0;
 sqlstm.sqindv[17] = (         void  *)0;
 sqlstm.sqinds[17] = (         int  )0;
 ...
 sqlstm.sqadto[18] = (unsigned short )0;
 sqlstm.sqtdso[18] = (unsigned short )0;
 sqlstm.sqhstv[19] = (         void  *)&nd_exc_writeoff;
...
fetch_bill_dtl_cur()
  {
	...
	d_doc_num.arr[0]		='\0';/*CRF-20405*/
	d_doc_type_code.arr[0]	='\0';/*CRF-20405*/
	...
	d_bill_date.len		=0;
	d_episode_id.len	=0;
	d_doc_num.len		=0;/*CRF-20405*/
	d_doc_type_code.len	=0;/*CRF-20405*/	
...

{
   ...
   sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	d_doc_num.arr[d_doc_num.len]				 ='\0';/*CRF-20405*/
	d_doc_type_code.arr[d_doc_type_code.len]	 ='\0';/*CRF-20405*/
...
// LINE-3
  ...
  if(strcmp(nd_det_option.arr,"DI")==0)
	...
	/* SCR 5360 Added By saurabh*/
	else if (strcmp(nd_det_option.arr,"I")==0) 
     {
        s1 = (REP_WIDTH-strlen(loc_legend[49]))/2;
		horz_skip(s1);		
      	fprintf(fp,"%s\n",loc_legend[49]);
      }
   else if(strcmp(nd_det_option.arr,"EM")==0)
