...
{
    28,
    "D:\\Issues\\screen\\Blrsrind.pc"
};


static unsigned long sqlctx = 1533927867;
...
"')) order by A.BLNG_GRP_ID,A.CUST_CO\
DE,B.BLNG_SERV_CODE,TRUNC(TRX_DATE),B.TRX_DOC_REF            ";

 static const char *sq0007 = 
"_ID,A.CUST_CODE,B.BLNG_SERV_CODE,TRU\
NC(TRX_DATE),B.TRX_DOC_REF            ";

 static const char *sq0008 = 
"cility_id,'X')=NVL(:b13,'X')) order \
by A.BLNG_GRP_ID,A.CUST_CODE,B.BLNG_SERV_CODE,TRUNC(TRX_DATE),B.TRX_DOC_REF  \
          ";

 static const char *sq0009 = 
",'X')) order by A.BLNG_GRP_ID,A.CUST\
_CODE,B.BLNG_SERV_CODE,TRUNC(TRX_DATE),B.TRX_DOC_REF            ";
...
{10,4274,0,0,0,
5,0,0,1,379,0,4,242,0,0,20,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
100,0,0,2,91,0,2,303,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
123,0,0,3,0,0,30,313,0,0,0,0,0,1,0,
138,0,0,4,0,0,27,319,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
169,0,0,5,0,0,17,370,0,0,1,1,0,1,0,1,9,0,0,
188,0,0,5,0,0,45,588,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
259,0,0,5,0,0,45,607,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
326,0,0,5,0,0,45,628,0,0,15,15,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
401,0,0,5,0,0,45,648,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
472,0,0,6,1121,0,9,731,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
543,0,0,7,1098,0,9,733,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
610,0,0,8,1147,0,9,738,0,0,15,15,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,
685,0,0,9,1124,0,9,740,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
756,0,0,6,0,0,15,814,0,0,0,0,0,1,0,
771,0,0,7,0,0,15,816,0,0,0,0,0,1,0,
786,0,0,8,0,0,15,821,0,0,0,0,0,1,0,
801,0,0,9,0,0,15,823,0,0,0,0,0,1,0,
816,0,0,5,0,0,13,859,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
843,0,0,6,0,0,13,920,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,
2,4,0,0,
922,0,0,7,0,0,13,940,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,
2,4,0,0,
1001,0,0,8,0,0,13,963,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,
2,4,0,0,
1080,0,0,9,0,0,13,983,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,
2,4,0,0,
1159,0,0,10,97,0,9,1033,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1182,0,0,10,0,0,13,1040,0,0,1,0,0,1,0,2,9,0,0,
1201,0,0,11,95,0,9,1055,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1224,0,0,11,0,0,13,1062,0,0,1,0,0,1,0,2,9,0,0,
1243,0,0,12,108,0,9,1076,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1266,0,0,12,0,0,13,1083,0,0,1,0,0,1,0,2,9,0,0,
1285,0,0,13,144,0,4,3378,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
1308,0,0,14,158,0,4,3449,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
1343,0,0,15,824,0,4,3473,0,0,15,14,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
1418,0,0,16,801,0,4,3501,0,0,14,13,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1489,0,0,17,850,0,4,3531,0,0,16,15,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,
1568,0,0,18,827,0,4,3560,0,0,15,14,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
1643,0,0,19,96,0,4,3597,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
1666,0,0,20,165,0,6,3604,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
1697,0,0,21,140,0,6,3626,0,0,3,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
1724,0,0,22,94,0,4,3729,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
1747,0,0,23,39,0,4,3760,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1770,0,0,24,35,0,4,3763,0,0,2,1,0,1,0,1,3,0,0,2,3,0,0,
1793,0,0,25,43,0,4,3780,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1816,0,0,26,49,0,4,3783,0,0,3,2,0,1,0,1,9,0,0,1,3,0,0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[23]; } d_patient_no;

struct { unsigned short len; unsigned char arr[61]; } d_patient_name;

struct { unsigned short len; unsigned char arr[60]; } d_patient_name_loc_lang;
...

{
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)&nd_fr_doc_number;
  ...
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (         void  *)&nd_to_doc_number;
  ...
  sqlstm.sqadto[3] = (unsigned short )0;
  sqlstm.sqtdso[3] = (unsigned short )0;
  sqlstm.sqhstv[4] = (         void  *)&nd_fr_bill_date;
  ...
  sqlstm.sqadto[4] = (unsigned short )0;
  sqlstm.sqtdso[4] = (unsigned short )0;
  sqlstm.sqhstv[5] = (         void  *)&nd_to_bill_date;
  ...
  sqlstm.sqadto[5] = (unsigned short )0;
  sqlstm.sqtdso[5] = (unsigned short )0;
  sqlstm.sqhstv[6] = (         void  *)&nd_fr_blng_grp;
  ...
  sqlstm.sqadto[6] = (unsigned short )0;
  sqlstm.sqtdso[6] = (unsigned short )0;
  sqlstm.sqhstv[7] = (         void  *)&nd_to_blng_grp;
...

{
    ...
    sqlstm.sqltdsp = &sqltds;
    sqlbuft((void **)0,
      "select A.CUST_CODE ,A.BLNG_GRP_ID ,B.TRX_DOC_REF ,TO_CHAR(B.TRX_DATE,\
'DD/MM/YYYY') ,B.PATIENT_ID ,B.EPISODE_TYPE ,B.EPISODE_ID ,B.VISIT_ID ,B.BIL\
L_DOC_TYPE_CODE ,B.BILL_DOC_NUM ,TO_CHAR(B.BILL_DOC_DATE,'DD/MM/YYYY') ,B.BL\
NG_SERV_CODE ,DECODE(B.PACKAGE_IND,'P',B.PACKAGE_SERVICE_CODE,'S','      ') \
,B.ORG_GROSS_CHARGE_AMT ,B.ORG_DISC_AMT ,B.ORG_NET_CHARGE_AMT  from BL_BILL_\
HDR A ,BL_PATIENT_CHARGES_FOLIO B where ((((((((((((((A.DOC_TYPE_CODE=B.BILL\
_DOC_TYPE_CODE and A.DOC_NUM=B.BILL_DOC_NUM) and A.BLNG_GRP_ID=:b0) and A.CU\
ST_CODE=:b1) and A.PATIENT_ID between :b2 and :b3) and A.DOC_TYPE_CODE betwe\
en :b4 and :b5) and A.DOC_NUM between :b6 and :b7) and TRUNC(A.DOC_DATE) bet\
ween to_date(:b8,'DD/MM/YYYY') and to_date(:b9,'DD/MM/YYYY')) and B.BLNG_SER\
V_CODE between :b10 and :b11) and NVL(B.PACKAGE_TRX_IND,'X')='N') and NVL(A.\
BILL_STATUS,'X')<>'C') and NVL(B.trx_status,'~')<>'C') and NVL(A.BILL_TRX_TY\
PE_CODE,'X')<>'I') and NVL(a.operating_facility_id,'X')=NVL(:b12,'X')) and N\
VL(b.operating_facility_id,'X')=NVL(:b12,'X");
    sqlstm.stmt = sq0006;
    sqlstm.iters = (unsigned int  )1;
...
NG_SERV_CODE ,DECODE(B.PACKAGE_IND,'P',B.PACKAGE_SERVICE_CODE,'S','      ') \
,B.ORG_GROSS_CHARGE_AMT ,B.ORG_DISC_AMT ,B.ORG_NET_CHARGE_AMT  from BL_BILL_\
HDR A ,BL_PATIENT_CHARGES_FOLIO B where (((((((((((((A.DOC_TYPE_CODE=B.BILL_\
DOC_TYPE_CODE and A.DOC_NUM=B.BILL_DOC_NUM) and A.BLNG_GRP_ID=:b0) and A.PAT\
IENT_ID between :b1 and :b2) and A.DOC_TYPE_CODE between :b3 and :b4) and A.\
DOC_NUM between :b5 and :b6) and TRUNC(A.DOC_DATE) between to_date(:b7,'DD/M\
M/YYYY') and to_date(:b8,'DD/MM/YYYY')) and B.BLNG_SERV_CODE between :b9 and\
 :b10) and NVL(B.PACKAGE_TRX_IND,'X')='N') and NVL(A.BILL_STATUS,'X')<>'C') \
and NVL(B.trx_status,'~')<>'C') and NVL(A.BILL_TRX_TYPE_CODE,'X')<>'I') and \
NVL(a.operating_facility_id,'X')=NVL(:b11,'X')) and NVL(b.operating_facility\
_id,'X')=NVL(:b11,'X')) order by A.BLNG_GRP");
    sqlstm.stmt = sq0007;
    sqlstm.iters = (unsigned int  )1;
...
NG_SERV_CODE ,DECODE(B.PACKAGE_IND,'P',B.PACKAGE_SERVICE_CODE,'S','      ') \
,B.ORG_GROSS_CHARGE_AMT ,B.ORG_DISC_AMT ,B.ORG_NET_CHARGE_AMT  from BL_BILL_\
HDR A ,BL_PATIENT_CHARGES_FOLIO B where (((((((((((((((A.DOC_TYPE_CODE=B.BIL\
L_DOC_TYPE_CODE and A.DOC_NUM=B.BILL_DOC_NUM) and A.BLNG_GRP_ID=:b0) and A.C\
UST_CODE=:b1) and A.EPISODE_TYPE=:b2) and A.PATIENT_ID between :b3 and :b4) \
and A.DOC_TYPE_CODE between :b5 and :b6) and A.DOC_NUM between :b7 and :b8) \
and TRUNC(A.DOC_DATE) between to_date(:b9,'DD/MM/YYYY') and to_date(:b10,'DD\
/MM/YYYY')) and B.BLNG_SERV_CODE between :b11 and :b12) and NVL(B.PACKAGE_TR\
X_IND,'X')='N') and NVL(A.BILL_STATUS,'X')<>'C') and NVL(B.trx_status,'~')<>\
'C') and NVL(A.BILL_TRX_TYPE_CODE,'X')<>'I') and NVL(a.operating_facility_id\
,'X')=NVL(:b13,'X')) and NVL(b.operating_fa");
    sqlstm.stmt = sq0008;
    sqlstm.iters = (unsigned int  )1;
...
,B.ORG_GROSS_CHARGE_AMT ,B.ORG_DISC_AMT ,B.ORG_NET_CHARGE_AMT  from BL_BILL_\
HDR A ,BL_PATIENT_CHARGES_FOLIO B where ((((((((((((((A.DOC_TYPE_CODE=B.BILL\
_DOC_TYPE_CODE and A.DOC_NUM=B.BILL_DOC_NUM) and A.BLNG_GRP_ID=:b0) and A.EP\
ISODE_TYPE=:b1) and A.PATIENT_ID between :b2 and :b3) and A.DOC_TYPE_CODE be\
tween :b4 and :b5) and A.DOC_NUM between :b6 and :b7) and TRUNC(A.DOC_DATE) \
between to_date(:b8,'DD/MM/YYYY') and to_date(:b9,'DD/MM/YYYY')) and B.BLNG_\
SERV_CODE between :b10 and :b11) and NVL(B.PACKAGE_TRX_IND,'X')='N') and NVL\
(A.BILL_STATUS,'X')<>'C') and NVL(B.trx_status,'~')<>'C') and NVL(A.BILL_TRX\
_TYPE_CODE,'X')<>'I') and NVL(a.operating_facility_id,'X')=NVL(:b12,'X')) an\
d NVL(b.operating_facility_id,'X')=NVL(:b12");
    sqlstm.stmt = sq0009;
    sqlstm.iters = (unsigned int  )1;
...
here acc_entity_id=(select acc_entity_code  from sy_acc_entity where acc_enti\
ty_id=:b1)";
   sqlstm.iters = (unsigned int  )1;
...
T_CHARGES_FOLIO B where ((((((((((((((((A.CUST_CODE=:b1 and A.BLNG_GRP_ID=:b2\
) and A.DOC_TYPE_CODE=B.BILL_DOC_TYPE_CODE) and A.DOC_NUM=B.BILL_DOC_NUM) and\
 B.BILL_DOC_TYPE_CODE is  not null ) and B.BILL_DOC_NUM is  not null ) and A.\
...
nd :b12) and NVL(B.PACKAGE_TRX_IND,'X')='N') and NVL(A.BILL_STATUS,'X')<>'C')\
 and NVL(B.trx_status,'~')<>'C') and NVL(A.BILL_TRX_TYPE_CODE,'X')<>'I') and \
NVL(a.operating_facility_id,'X')=NVL(:b13,'X')) and NVL(b.operating_facility_\
id,'X')=NVL(:b13,'X')) order by A.CUST_CODE,A.BLNG_GRP_ID,B.BLNG_SERV_CODE ";
    sqlstm.iters = (unsigned int  )1;
...
CHARGES_FOLIO B where (((((((((((((((A.BLNG_GRP_ID=:b1 and A.DOC_TYPE_CODE=B.\
BILL_DOC_TYPE_CODE) and A.DOC_NUM=B.BILL_DOC_NUM) and B.BILL_DOC_TYPE_CODE is\
  not null ) and B.BILL_DOC_NUM is  not null ) and A.PATIENT_ID between :b2 a\
...
der by A.CUST_CODE,A.BLNG_GRP_ID,B.BLNG_SERV_CODE ";
  sqlstm.iters = (unsigned int  )1;
...
ENT_CHARGES_FOLIO B where (((((((((((((((((A.CUST_CODE=:b1 and A.BLNG_GRP_ID=\
...
and B.BILL_DOC_TYPE_CODE is  not null ) and B.BILL_DOC_NUM is  not null ) and\
 A.EPISODE_TYPE=:b3) and A.PATIENT_ID between :b4 and :b5) and A.DOC_TYPE_COD\
E between :b6 and :b7) and A.DOC_NUM between :b8 and :b9) and TRUNC(A.DOC_DAT\
E) between to_date(:b10,'DD/MM/YYYY') and to_date(:b11,'DD/MM/YYYY')) and B.B\
LNG_SERV_CODE between :b12 and :b13) and NVL(B.PACKAGE_TRX_IND,'X')='N') and \
NVL(A.BILL_STATUS,'X')<>'C') and NVL(B.trx_status,'~')<>'C') and NVL(A.BILL_T\
RX_TYPE_CODE,'X')<>'I') and NVL(a.operating_facility_id,'X')=NVL(:b14,'X')) a\
nd NVL(b.operating_facility_id,'X')=NVL(:b14,'X')) order by A.CUST_CODE,A.BLN\
G_GRP_ID,B.BLNG_SERV_CODE ";
      sqlstm.iters = (unsigned int  )1;
...

{
      ...
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "select count(*)  into :b0  from BL_BILL_HDR A ,BL_PATI\
ENT_CHARGES_FOLIO B where ((((((((((((((((A.BLNG_GRP_ID=:b1 and A.DOC_TYPE_CO\
DE=B.BILL_DOC_TYPE_CODE) and A.DOC_NUM=B.BILL_DOC_NUM) and B.BILL_DOC_TYPE_CO\
DE is  not null ) and B.BILL_DOC_NUM is  not null ) and A.EPISODE_TYPE=:b2) a\
nd A.PATIENT_ID between :b3 and :b4) and A.DOC_TYPE_CODE between :b5 and :b6)\
 and A.DOC_NUM between :b7 and :b8) and TRUNC(A.DOC_DATE) between to_date(:b9\
,'DD/MM/YYYY') and to_date(:b10,'DD/MM/YYYY')) and B.BLNG_SERV_CODE between :\
...
>'C') and NVL(B.trx_status,'~')<>'C') and NVL(A.BILL_TRX_TYPE_CODE,'X')<>'I')\
 and NVL(a.operating_facility_id,'X')=NVL(:b13,'X')) and NVL(b.operating_faci\
lity_id,'X')=NVL(:b13,'X')) order by A.CUST_CODE,A.BLNG_GRP_ID,B.BLNG_SERV_CO\
DE ";
      sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRSRIND.LEGEND_'||LTRIM(RTRIM(TO_CHA\
...
m_report where report_id='BLRSRIND'";
 sqlstm.iters = (unsigned int  )1;
