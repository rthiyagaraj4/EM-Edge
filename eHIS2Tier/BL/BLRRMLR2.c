...
{
    33,
    "C:\\TEMP\\proc\\BLRRMLR2\\BLRRMLR2.PC"
};


static unsigned long sqlctx = 815661045;
...
"select REMINDER_FORMAT_ID ,DOC_TYPE_CODE ,DOC_NUM ,REMINDER_NO  from BL_BIL\
LS_FOR_REMINDER where (REMINDER_DISP_DOC_TYPE,REMINDER_DISP_DOC_NUMBER,REMIND\
ER_DISP_DOC_SLNO) in (select DOC_TYPE_CODE ,DOC_NUMBER ,DOC_SRL_NO  from BL_R\
EM_LET_PROCESS_TEMP where ((PROCESS_PGM_ID='BLRRMLR2' and PROCESS_SESSION_ID=\
:b0) and PROCESS_DATE_TIME=:b1)) for update of REMINDER_PRINTED_YN nowait ";
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from BL_REM_LET_PROCESS_TEMP  where ((PROCESS_PG\
M_ID='BLRRMLR2' and PROCESS_SESSION_ID=:b0) and PROCESS_DATE_TIME=:b1)";
    sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select A.PATIENT_ID ,A.CUST_CODE into :b0,:b1  from BL_BIL\
L_HDR A where (A.DOC_TYPE_CODE=:b2 and A.DOC_NUM=:b3)";
  sqlstm.iters = (unsigned int  )1;
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select REGION_CODE ,RES_AREA_CODE ,RES_TOWN_CODE int\
o :b0,:b1,:b2  from SM_FACILITY_PARAM where FACILITY_ID=:b3";
        sqlstm.iters = (unsigned int  )1;
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select REGION_CODE ,RES_AREA_CODE ,RES_TOWN_CODE ,NA\
TIONALITY_CODE into :b0,:b1,:b2,:b3  from MP_PATIENT where PATIENT_ID=:b4";
        sqlstm.iters = (unsigned int  )1;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "select REMINDER_FORMAT_ID ,REPORT_TITLE_TEXT ,HEADER_L\
INE_01 ,HEADER_LINE_02 ,HEADER_LINE_03 ,HEADER_LINE_04 ,HEADER_LINE_05 ,HEADE\
R_LINE_06 ,HEADER_LINE_07 ,HEADER_LINE_08 ,HEADER_LINE_09 ,HEADER_LINE_10 ,BO\
DY_LINE_01 ,BODY_LINE_02 ,BODY_LINE_03 ,BODY_LINE_04 ,BODY_LINE_05 ,BODY_LINE\
_06 ,BODY_LINE_07 ,BODY_LINE_08 ,BODY_LINE_09 ,BODY_LINE_10 ,BODY_LINE_11 ,BO\
DY_LINE_12 ,BODY_LINE_13 ,BODY_LINE_14 ,BODY_LINE_15 ,BODY_LINE_16 ,BODY_LINE\
_17 ,BODY_LINE_18 ,BODY_LINE_19 ,BODY_LINE_20 ,FOOTER_LINE_01 ,FOOTER_LINE_02\
 ,FOOTER_LINE_03 ,FOOTER_LINE_04 ,FOOTER_LINE_05 ,FOOTER_LINE_06 ,FOOTER_LINE\
_07 ,FOOTER_LINE_08 ,FOOTER_LINE_09 ,FOOTER_LINE_10 into :b0,:b1,:b2,:b3,:b4,\
...
,:b37,:b38,:b39,:b40,:b41  from BL_REM_LET_FORMAT where ((REMINDER_FORMAT_ID=\
:b42 and APPL_TRX_IND='B') and STATUS is null )";
      sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "update BL_BILLS_FOR_REMINDER  set REMINDER_PRINTED_YN='Y' w\
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select decode(:b0,0,(((('select to_char(ltrim('||LET_MAPP\
ED_COL_NAME)||')) from ')||LET_MAPPED_TABLE_NAME)||' WHERE '),(((('select to_\
char('||LET_MAPPED_COL_NAME)||',''DD/MM/YYYY'') from ')||LET_MAPPED_TABLE_NAM\
E)||' WHERE ')) ,LET_MAPPED_TABLE_NAME into :b1,:b2  from BL_REM_LET_MAPPING_\
COL where (LET_COLUMN_ID=:b3 and APPL_TRX_IND='B')";
   sqlstm.iters = (unsigned int  )1;
