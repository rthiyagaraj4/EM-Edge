...
{
    21,
    "E:\\MLVER2\\blrbdinm.pc"
};


static unsigned long sqlctx = 147109379;
...
"select BED_CLASS_CODE ,BLNG_SERV_CODE ,((LTRIM(TO_CHAR(SERV_MONTH,'09'))||'/\
')||LTRIM(TO_CHAR(SERV_YEAR,'0009'))) ,TO_CHAR(NVL(BASE_CHARGE,0),'999,999,990\
.99') ,TO_CHAR(NVL(GROSS_CHARGE,0),'999,999,990.99') ,TO_CHAR(NVL(DISC_AMT,0),\
'999,999,990.99') ,TO_CHAR((NVL(GROSS_CHARGE,0)-NVL(DISC_AMT,0)),'999,999,990.\
99') ,NVL(BASE_CHARGE,0) ,NVL(GROSS_CHARGE,0) ,NVL(DISC_AMT,0) ,(NVL(GROSS_CHA\
RGE,0)-NVL(DISC_AMT,0))  from BL_SRV_INC_SUM_MTH_DTL where ((((EPISODE_TYPE in\
 ('I','D') and BED_CLASS_CODE between NVL(:b0,' ') and NVL(:b1,'~~')) and BLNG\
_SERV_CODE between NVL(:b2,' ') and NVL(:b3,'~~~~~~~~~~')) and ((SERV_YEAR* 10\
0)+SERV_MONTH) between ((TO_NUMBER(NVL(:b4,'0000'))* 100)+TO_NUMBER(NVL(:b5,'0\
1'))) and ((TO_NUMBER(NVL(:b6,'9999'))* 100)+TO_NUMBER(NVL(:b7,'12')))) and OP\
ERATING_FACILITY_ID=:b8) order by SERV_YEAR,SERV_MONTH,BED_CLASS_CODE,BLNG_SER\
V_CODE            ";

 static const char *sq0006 = 
"select BED_CLASS_CODE ,PACKAGE_CODE ,((LTRIM(TO_CHAR(SERV_MONTH,'09'))||'/')\
||LTRIM(TO_CHAR(SERV_YEAR,'0009'))) ,TO_CHAR(NVL(BASE_CHARGE,0),'999,999,990.9\
9') ,TO_CHAR(NVL(GROSS_CHARGE,0),'999,999,990.99') ,TO_CHAR(NVL(DISC_AMT,0),'9\
99,999,990.99') ,TO_CHAR((NVL(GROSS_CHARGE,0)-NVL(DISC_AMT,0)),'999,999,990.99\
') ,NVL(BASE_CHARGE,0) ,NVL(GROSS_CHARGE,0) ,NVL(DISC_AMT,0) ,(NVL(GROSS_CHARG\
E,0)-NVL(DISC_AMT,0))  from BL_PKG_INC_SUM_MTH_DTL where ((((EPISODE_TYPE in (\
'I','D') and BED_CLASS_CODE between NVL(:b0,' ') and NVL(:b1,'~~')) and PACKAG\
E_CODE between NVL(:b2,' ') and NVL(:b3,'~~~~~~~~~~')) and (SERV_YEAR||SERV_MO\
NTH) between (LTRIM(:b4,'0009')||LTRIM(:b5,'09')) and (LTRIM(:b6,'0009')||LTRI\
M(:b7,'09'))) and OPERATING_FACILITY_ID=:b8) order by SERV_YEAR,SERV_MONTH,BED\
_CLASS_CODE,PACKAGE_CODE            ";
...
36,0,0,2,0,0,30,201,0,0,0,0,0,1,0,
51,0,0,3,293,0,4,243,0,0,18,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
138,0,0,4,84,0,2,292,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
165,0,0,5,874,0,9,394,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
216,0,0,6,814,0,9,401,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
267,0,0,5,0,0,13,433,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
326,0,0,6,0,0,13,455,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
385,0,0,9,71,0,9,489,0,0,1,1,0,1,0,1,9,0,0,
404,0,0,9,0,0,13,493,0,0,1,0,0,1,0,2,9,0,0,
423,0,0,7,71,0,9,510,0,0,1,1,0,1,0,1,9,0,0,
442,0,0,7,0,0,13,514,0,0,1,0,0,1,0,2,9,0,0,
461,0,0,8,71,0,9,522,0,0,1,1,0,1,0,1,9,0,0,
480,0,0,8,0,0,13,526,0,0,1,0,0,1,0,2,9,0,0,
499,0,0,10,128,0,4,769,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[7]; } bl_concat_month_yr;
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/BLRBDINM.C-arc   1.0   Apr 19 2007 17:05:30   vcm_th  $ sqlca.h 
 */
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/BLRBDINM.C-arc   1.0   Apr 19 2007 17:05:30   vcm_th  $ sqlda.h 
 */
...

{
     ...
     sqlstm.sqadto[3] = (unsigned short )0;
     sqlstm.sqtdso[3] = (unsigned short )0;
     sqlstm.sqhstv[4] = (         void  *)&nd_fm_year;
     ...
     sqlstm.sqadto[4] = (unsigned short )0;
     sqlstm.sqtdso[4] = (unsigned short )0;
     sqlstm.sqhstv[5] = (         void  *)&nd_fm_month;
     ...
     sqlstm.sqadto[5] = (unsigned short )0;
     sqlstm.sqtdso[5] = (unsigned short )0;
     sqlstm.sqhstv[6] = (         void  *)&nd_to_year;
     ...
     sqlstm.sqadto[6] = (unsigned short )0;
     sqlstm.sqtdso[6] = (unsigned short )0;
     sqlstm.sqhstv[7] = (         void  *)&nd_to_month;
...

{
     ...
     sqlstm.sqadto[1] = (unsigned short )0;
     sqlstm.sqtdso[1] = (unsigned short )0;
     sqlstm.sqhstv[2] = (         void  *)&bl_concat_month_yr;
