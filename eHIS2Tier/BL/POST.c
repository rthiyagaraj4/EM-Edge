...
static unsigned long sqlctx = 634699;
...
/* EXEC SQL BEGIN DECLARE SECTION; */ 
	...
	/* VARCHAR	sub_main_acc1_code[8],
			...
			sub_dept_code[12],
			sub_product_group_code[6],
			sub_product_line_code[6],
			sub_subledger_group_code[6],
...
struct { unsigned short len; unsigned char arr[12]; } sub_dept_code;

struct { unsigned short len; unsigned char arr[6]; } sub_product_group_code;

struct { unsigned short len; unsigned char arr[6]; } sub_product_line_code;

struct { unsigned short len; unsigned char arr[6]; } sub_subledger_group_code;
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/POST.c-arc   1.0   Sep 11 2007 14:48:28   vcm_th  $ sqlca.h 
 */
