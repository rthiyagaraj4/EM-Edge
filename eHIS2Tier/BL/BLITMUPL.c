...
{
    24,
    "C:\\ravi\\MAT2\\BLITMUPL.pc"
};


static unsigned long sqlctx = 1161263579;
...
"select ITEM_CODE ,TRADE_ID ,TO_CHAR(PUBLIC_PRICE) ,TO_CHAR(INPATIENT_PRICE) \
,TO_CHAR(OUTPATIENT_PRICE) ,TO_CHAR(EXTERNAL_PRICE) ,TO_CHAR(EMERGENCY_PRICE) \
,TO_CHAR(DAYCARE_PRICE) ,INP_REIMBURSABLE_YN ,INP_REIMBURSABLE_IND ,TO_CHAR(IN\
P_REIMBURSABLE_AMT) ,INP_OVERRIDE_REIMBURSABLE_YN ,OTH_REIMBURSABLE_YN ,OTH_RE\
IMBURSABLE_IND ,TO_CHAR(OTH_REIMBURSABLE_AMT) ,OTH_OVERRIDE_REIMBURSABLE_YN  f\
rom BL_UPLOAD_ITEM_TRADE_PRICE_EXT            ";

 static const char *sq0005 = 
"select ITEM_CODE  from MM_ITEM where ITEM_CODE=:b0           ";

 static const char *sq0006 = 
"select TRADE_ID  from BL_ST_ITEM_TRADE_NAME_VW where (TRADE_ID=:b0 and ITEM_\
CODE=:b1)           ";
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,102,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,164,0,4,159,0,0,7,4,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,
79,0,0,3,116,0,2,178,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
110,0,0,4,434,0,9,223,0,0,0,0,0,1,0,
125,0,0,5,61,0,9,230,0,0,1,1,0,1,0,1,9,0,0,
144,0,0,6,96,0,9,237,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
167,0,0,4,0,0,13,256,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,
246,0,0,5,0,0,13,301,0,0,1,0,0,1,0,2,9,0,0,
265,0,0,6,0,0,13,315,0,0,1,0,0,1,0,2,9,0,0,
284,0,0,4,0,0,15,323,0,0,0,0,0,1,0,
299,0,0,5,0,0,15,330,0,0,0,0,0,1,0,
314,0,0,6,0,0,15,337,0,0,0,0,0,1,0,
329,0,0,7,94,0,4,367,0,0,1,0,0,1,0,2,9,0,0,
348,0,0,8,123,0,4,369,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
371,0,0,9,144,0,4,424,0,0,4,3,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
402,0,0,10,196,0,6,759,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[1000]; } ERROR_MSG;
...
struct { unsigned short len; unsigned char arr[120]; } d_mi_trade;

struct { unsigned short len; unsigned char arr[61]; } d_item_code;

struct { unsigned short len; unsigned char arr[61]; } d_trade_id;
...
struct { unsigned short len; unsigned char arr[2000]; } nd_msg19;
...
G_PARAM where (((OPERATING_FACILITY_ID=:b3 and PGM_ID=:b4) and TO_CHAR(SESSION\
_ID)=:b5) and PGM_DATE=:b6)";
  ...
  sqlstm.sqhstv[2] = (         void  *)&nd_price_id;
...

{
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (         void  *)&d_trade_id;
 sqlstm.sqhstl[0] = (unsigned int  )63;
 sqlstm.sqhsts[0] = (         int  )0;
 sqlstm.sqindv[0] = (         void  *)0;
 sqlstm.sqinds[0] = (         int  )0;
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (         void  *)&d_item_code;
...

{
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (         void  *)&d_trade_id;
 sqlstm.sqhstl[1] = (unsigned int  )63;
 sqlstm.sqhsts[1] = (         int  )0;
 sqlstm.sqindv[1] = (         void  *)0;
 sqlstm.sqinds[1] = (         int  )0;
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (         void  *)&d_public_price;
 ...
 sqlstm.sqadto[2] = (unsigned short )0;
 sqlstm.sqtdso[2] = (unsigned short )0;
 sqlstm.sqhstv[3] = (         void  *)&d_inpatient_price;
 ...
 sqlstm.sqadto[3] = (unsigned short )0;
 sqlstm.sqtdso[3] = (unsigned short )0;
 sqlstm.sqhstv[4] = (         void  *)&d_outpatient_price;
 ...
 sqlstm.sqadto[4] = (unsigned short )0;
 sqlstm.sqtdso[4] = (unsigned short )0;
 sqlstm.sqhstv[5] = (         void  *)&d_external_price;
 ...
 sqlstm.sqadto[5] = (unsigned short )0;
 sqlstm.sqtdso[5] = (unsigned short )0;
 sqlstm.sqhstv[6] = (         void  *)&d_emergency_price;
 ...
 sqlstm.sqadto[6] = (unsigned short )0;
 sqlstm.sqtdso[6] = (unsigned short )0;
 sqlstm.sqhstv[7] = (         void  *)&d_daycare_price;
 ...
 sqlstm.sqhstv[8] = (         void  *)&d_inp_reimbursable_yn;
 ...
 sqlstm.sqhstv[9] = (         void  *)&d_inp_reimbursable_ind;
 ...
 sqlstm.sqhstv[10] = (         void  *)&d_inp_reimbursable_amt;
 ...
 sqlstm.sqhstv[11] = (         void  *)&d_inp_override_reimbursable_yn;
 ...
 sqlstm.sqhstv[12] = (         void  *)&d_oth_reimbursable_yn;
 ...
 sqlstm.sqhstv[13] = (         void  *)&d_oth_reimbursable_ind;
 ...
 sqlstm.sqhstv[14] = (         void  *)&d_oth_reimbursable_amt;
 ...
 sqlstm.sqhstv[15] = (         void  *)&d_oth_override_reimbursable_yn;
...

{
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (         void  *)&d_mi_trade;
 sqlstm.sqhstl[0] = (unsigned int  )122;
 sqlstm.sqhsts[0] = (         int  )0;
 sqlstm.sqindv[0] = (         void  *)0;
 sqlstm.sqinds[0] = (         int  )0;
...
:b0  from BL_ST_ITEM_BY_TRADENAME ";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select TO_CHAR(max(EFFECTIVE_FROM_DATE),'DD-MON-YYYY') into \
:b0  from BL_ST_ITEM_BY_TRADENAME where EFFECTIVE_FROM_DATE<:b1";
 sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select count(*)  into :b0  from BL_ST_ITEM_BY_TRADENAME w\
here ((OPERATING_FACILITY_ID=:b1 and ITEM_CODE=:b2) and TRUNC(EFFECTIVE_FROM_D\
ATE)=:b3)";
    sqlstm.iters = (unsigned int  )1;
