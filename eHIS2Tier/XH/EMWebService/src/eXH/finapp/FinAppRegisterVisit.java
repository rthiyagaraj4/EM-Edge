...
public class FinAppRegisterVisit {
	...
	public String processRequest(String actionKey) {
		...
		String l_request_date_time ="",   l_patient_id ="";
		String l_appointment_no ="",l_settlement_type="",l_slmt_doc_ref="",l_slmt_doc_ref_date="",l_bank_cc_code="",l_rcpt_rfnd_id_no="";
		String l_online_approvl_yn ="",l_batch_no="",l_sale_draft_no="",l_success_flag="",l_return_text="";
		...
		String l_visit_type ="",l_encounter_id="",l_bill_details="",l_receipt_details="",l_paid_amount="";
	...
	int validUHID = ValidateUHID(l_patient_id);
				...
				if(validUHID >= 1){
				   ...
				   l_error.append(" - patient id");
				    ...
				    params.put("FACILITY_ID", l_facility_id);
				    params.put("SETTLEMENT_TYPE", l_settlement_type);
				    params.put("SLMT_DOC_REF", l_slmt_doc_ref);
				    params.put("SLMT_DOC_REF_DATE", l_slmt_doc_ref_date);
				    params.put("BANK_CC_CODE", l_bank_cc_code);
				    params.put("RCPT_RFND_ID_NO", l_rcpt_rfnd_id_no);
				    params.put("ONLINE_APPROVL_YN", l_online_approvl_yn);
				    params.put("BATCH_NO", l_batch_no);
				    params.put("SALE_DRAFT_NO", l_sale_draft_no);
	...
	l_blng_grp_id = XHJSONUtil.getJsonRequestString(l_in_JSON, "blng_grp_id");
			...
			l_payment_details = getPaymentDetails(l_facility_id, l_patient_id, l_appointment_no,l_eventType,l_application_id,l_blng_grp_id,l_cust_group_code,l_cust_code,l_policy_type_code,l_policy_number,l_membership_no,l_policy_start_date,l_policy_expiry_date,l_non_ins_blng_grp_id,l_settlement_type,l_slmt_doc_ref,l_slmt_doc_ref_date,l_bank_cc_code,l_rcpt_rfnd_id_no,l_online_approvl_yn,l_batch_no,l_sale_draft_no);

			l_app_msg = " ::: Getting Appointment id from JSON :::"+l_payment_details;
         ...
         if(l_payment_details.isEmpty()){
				...
				l_encounter_id =l_payment_details.get("encounter_id");
				l_bill_details =l_payment_details.get("bill_details");
				l_receipt_details =l_payment_details.get("receipt_details");
				l_paid_amount =l_payment_details.get("paid_amount");
				}
             ...
             l_app_msg = " ::: Getting PaymentDetails  :::";								
				...
				l_response_json.put("patient_id", l_patient_id);
				l_response_json.put("appointment_no", l_appointment_no);
				l_response_json.put("settlement_type", l_settlement_type);
				l_response_json.put("slmt_doc_ref", l_slmt_doc_ref);
				l_response_json.put("slmt_doc_ref_date", l_slmt_doc_ref_date);
				l_response_json.put("bank_cc_code", l_bank_cc_code);
				l_response_json.put("rcpt_rfnd_id_no", l_rcpt_rfnd_id_no);
				l_response_json.put("online_approvl_yn", l_online_approvl_yn);
				l_response_json.put("batch_no", l_batch_no);
				l_response_json.put("sale_draft_no", l_sale_draft_no);
				l_response_json.put("return_text", l_return_text);
				...
				l_app_msg = " ************ FinApp get Payment Details From exception ************ ";
				if (l_debug_YN.equals("Y"))	System.out.println(l_app_msg);
			...
			if(l_success_flag.equals("S")){
				...
				l_status = "1";
				l_status_desc = "Visit Successfully Generated";
				l_response_json.put("request_ref_no", l_request_ref_no);
				l_response_json.put("status", l_status);
				l_response_json.put("status_desc", l_status_desc);
				l_response_json.put("facility_id", l_facility_id);
				...
				l_response_json.put("bill_details", l_bill_details);
				l_response_json.put("receipt_details", l_receipt_details);
				l_response_json.put("paid_amount", l_paid_amount);
			...
			l_app_msg = " ************ FINAPP Payment Traction request` Ended from Catch Block************ ";
			if (l_debug_YN.equals("Y"))	System.out.println(l_app_msg);
	...
	public static Map<String, String> getPaymentDetails(String facility_id,String patient_id,String appointment_no,String event_type,String application_id,String blng_grp_id,String cust_group_code,String cust_code,String policy_type_code,String policy_number,String membership_no,String policy_start_date,String policy_expiry_date,String non_ins_blng_grp_id,String settlement_type,String slmt_doc_ref,String slmt_doc_ref_date,String bank_cc_code,String rcpt_rfnd_id_no,String online_approvl_yn,String batch_no,String sale_draft_no)
	{
		...
		String visit_type ="",encounter_id ="", bill_details ="", receipt_details="", paid_amount ="",success_flag="",return_text="";
		...
		try
		{
			...
			System.out.println("visit_type==="+visit_type+"pay_amount=="+paid_amount+"encounter_id==="+encounter_id+"bill_details=="+bill_details+"receipt_details=="+receipt_details+"paid_amount=="+paid_amount);
			 paymentDetails.put("success_flag",success_flag);
			 paymentDetails.put("visit_type",visit_type);
			 paymentDetails.put("encounter_id",encounter_id);
			 paymentDetails.put("bill_details",bill_details);
			 paymentDetails.put("receipt_details",receipt_details);
			 paymentDetails.put("paid_amount",paid_amount);
			...
			l_app_msg = "Error in getPaymentDetails  Exception - "+ e.getMessage();
			paymentDetails.put("Error", l_app_msg);
		} finally {
