...
public class QueryApprovalServices {
	...
	public String processRequest(String actionKey) {
		...
		String l_request_date_time ="",   l_patient_id ="",l_encounter_id="",l_pre_app_status="";
		String l_success_flag="",l_return_text="",l_app_service_list="";
		
	
        l_in_JSON=XHJSONUtil.createJsonObject(actionKey);
		Map<String,String> l_approval_services = new HashMap<String, String>();
		...
		try
		{
			...
			l_app_msg = " ************ FinApp Query Approval Services Details Traction started ************ ";
			if (l_debug_YN.equals("Y"))	System.out.println(l_app_msg);
			
			l_error = new StringBuffer("Unable to Fetch Approval Services - Information Missing");
	
			l_app_msg = " ::: Inside Query Approval Services Details :::";
	...
	l_encounter_id = XHJSONUtil.getJsonRequestString(l_in_JSON, "encounter_id");
			...
			l_pre_app_status = XHJSONUtil.getJsonRequestString(l_in_JSON, "pre_app_status");
			l_req_params.put("pre_app_status", l_pre_app_status);	

			l_app_msg = " ::: pre_app_status : " + l_pre_app_status;
			if (l_debug_YN.equals("Y"))
				System.out.println(l_app_msg);

			
						
			l_approval_services = getApprovalServices(l_facility_id,l_application_id,l_eventType,l_patient_id,l_encounter_id,l_pre_app_status);

			l_app_msg = " ::: Getting Appointment id from JSON :::"+l_approval_services;

         if(l_approval_services.isEmpty()){
					l_success_flag = "E";
					l_errcd="E"; 
					l_app_msg = " ::: Search Approval Services not Found ::: "+l_approval_services;
					if (l_debug_YN.equals("Y"))
						System.out.println(l_app_msg);
				}else{

				l_success_flag =l_approval_services.get("success_flag");
				l_app_service_list =l_approval_services.get("app_service_list");
             ...
             l_app_msg = " ::: Getting PaymentDetails  :::";								
				...
				l_response_json.put("pre_app_status", l_pre_app_status);
				l_response_json.put("app_service_list", l_app_service_list);
				...
				params.put("FACILITY_ID", l_facility_id);
				params.put("PRE_APP_STATUS", l_pre_app_status);
				...
				l_app_msg = " ************ FinApp Query Approval Services  From exception ************ ";
				if (l_debug_YN.equals("Y"))	System.out.println(l_app_msg);
			...
			if(l_success_flag.equals("S")){
				...
				l_status = "1";
				l_status_desc = "Patient Approval Services list fetched Successfully";
				l_response_json.put("request_ref_no", l_request_ref_no);
				l_response_json.put("status", l_status);
				l_response_json.put("status_desc", l_status_desc);
				l_response_json.put("facility_id", l_facility_id);
				...
				l_app_msg = " ************ FinApp Query Approcal Services Traction Ended ************ ";
				if (l_debug_YN.equals("Y"))	System.out.println(l_app_msg);
			...
			l_response_err_json = " { " + " \"status\" : \"0\" , " + " \"message\" : \"Reference Number-validateAppt :" + l_app_msg + " Exception l_payment_details: " + l_approval_services + " \"  " + " } ";
			...
			l_app_msg = " ************ FINAPP Query Approval Services Traction request` Ended from Catch Block************ ";
			if (l_debug_YN.equals("Y"))	System.out.println(l_app_msg);
	...
	public static Map<String, String> getApprovalServices(String facility_id,String application_id,String event_type,String patient_id,String encounter_id,String pre_app_status)
	{
		Connection dbConn = null;
		ResultSet rs = null;
		CallableStatement cstmt = null ;
		Map<String, String> ApprovalServices = new HashMap<String, String>();
		...
		try
		{
			...
			cstmt.setString( 6, pre_app_status); 
			...
			System.out.println(" Query Approval Services in params facility_id==="+facility_id+"event_type=="+event_type+"patient_id=="+patient_id+"application_id=="+application_id+"encounter_id=="+encounter_id+"pre_app_status=="+pre_app_status);
			System.out.println("success_flag@@481 QueryApprovalServices==="+success_flag+"return_text=="+return_text);
				
			 ApprovalServices.put("success_flag",success_flag);
			 ApprovalServices.put("app_service_list",return_text);
			 
			
			l_app_msg = " ::: Approval List Details Fetch ::: "+ ApprovalServices;
			if (l_debug_YN.equals("Y"))
				System.out.println(l_app_msg);
			
		}catch (Exception e) {
			l_app_msg = "Error in getApprovalServices  Exception - "+ e.getMessage();
			ApprovalServices.put("Error", l_app_msg);
		} finally {
