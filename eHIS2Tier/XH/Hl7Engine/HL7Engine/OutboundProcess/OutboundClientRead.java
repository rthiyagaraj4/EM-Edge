		...
		{	
		    ...
		    try
		    {
	    		...
	    		if(createAckFile)
	    		{
	    		    ...
	    		    if(logToFile) common.fileOutput( strLogFile, "(OutboundClientRead:run)Acknowledge File Name "+ackLogFileName+"\n");
	    		    createAckFile = false;
	    		}
		    ...
		    {								
	    		...
	    		if (exceptionGeneral.getClass().isInstance(new ConnectException()) ||
	    				exceptionGeneral.getClass().isInstance(new SocketTimeoutException()) ||
