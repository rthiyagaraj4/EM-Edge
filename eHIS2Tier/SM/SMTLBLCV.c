...
{
    56,
    "c:\\rl\\dec15_scope\\ml-mmoh-crf-0324\\corrected\\smtlblcv.pc"
};


static unsigned long sqlctx = 1906426491;
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,396,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,169,0,4,461,0,0,6,5,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
75,0,0,3,74,0,4,565,0,0,3,2,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
102,0,0,4,97,0,4,580,0,0,3,2,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,
129,0,0,5,57,0,4,642,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
152,0,0,6,57,0,4,662,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
175,0,0,7,57,0,4,684,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
198,0,0,8,57,0,4,703,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
221,0,0,9,57,0,4,722,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
244,0,0,10,160,0,4,4620,0,0,6,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
1,9,0,0,
283,0,0,11,135,0,4,4710,0,0,5,3,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
318,0,0,12,58,0,4,6887,0,0,1,0,0,1,0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[132]; } BVUidPwd;
	...
	/* VARCHAR BVReportOutputDir[256]; */ 
struct { unsigned short len; unsigned char arr[256]; } BVReportOutputDir;
		// Report Output Directory					Mandatory
	/* VARCHAR BVLISFileName[128]; */ 
struct { unsigned short len; unsigned char arr[128]; } BVLISFileName;
			// LIS File Name							Mandatory
	/* VARCHAR BVPrinterID[128]; */ 
struct { unsigned short len; unsigned char arr[128]; } BVPrinterID;
			// Printer ID						Mandatory
	/* VARCHAR	BVNumberOfCopies[2]; */ 
struct { unsigned short len; unsigned char arr[2]; } BVNumberOfCopies;
		// Number of Copies
...
struct { unsigned short len; unsigned char arr[3]; } BVHdrStringDelim;

	/* varchar	 BVHdrInitString[64]; */ 
struct { unsigned short len; unsigned char arr[64]; } BVHdrInitString;

	/* varchar	 BVNoOfCopiesString[64]; */ 
struct { unsigned short len; unsigned char arr[64]; } BVNoOfCopiesString;

	/* varchar	 BVHdrTermString[32]; */ 
struct { unsigned short len; unsigned char arr[32]; } BVHdrTermString;

	int		 BVLineNo;
	/* varchar	 BVDtlInitString[128]; */ 
struct { unsigned short len; unsigned char arr[128]; } BVDtlInitString;

	/* varchar	 BVDtlTermString[32]; */ 
struct { unsigned short len; unsigned char arr[32]; } BVDtlTermString;

	/* varchar	 BVProgramLanguage[16]; */ 
struct { unsigned short len; unsigned char arr[16]; } BVProgramLanguage;

	/* Label Format Designer Variables - End */

	// Added for BDRUNIBP check
	/* varchar checkFileName[80]; */ 
struct { unsigned short len; unsigned char arr[80]; } checkFileName;


	/* VARCHAR l_customer_id [50]; */ 
struct { unsigned short len; unsigned char arr[50]; } l_customer_id;
	////added on 26.03.2014 against Bru-HIMS-CRF-389 and 420.
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select 1 into :b0  from dual where ((((UPPER(:b1) like 'ZPL%\
' or UPPER(:b1) like 'EPL%') or UPPER(:b1) like 'ZPX%') or UPPER(:b1) like 'IP\
L%') or UPPER(:b1) like 'APL%')";
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (         void  *)&BVValidPrinter;
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (         void  *)&BVPrinterID;
 ...
 sqlstm.sqhstv[2] = (         void  *)&BVPrinterID;
 ...
 sqlstm.sqhstv[4] = (         void  *)&BVPrinterID;
 ...
 sqlstm.sqhstv[5] = (         void  *)&BVPrinterID;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select substr(UPPER(:b0),1,(instr(UPPER(:b0),'_')-1)) into :\
b2  from dual ";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (         void  *)&BVPrinterID;
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (         void  *)&BVProgramLanguage;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select count(1) into :b0  from sm_label_format_hdr where (re\
port_id=:b1 and program_language=:b2)";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (         void  *)&BVFormatDefinedYN;
 sqlstm.sqhstl[0] = (unsigned int  )sizeof(int);
 sqlstm.sqhsts[0] = (         int  )0;
 sqlstm.sqindv[0] = (         void  *)0;
 sqlstm.sqinds[0] = (         int  )0;
...

{
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&BVLanguageIsZPL;
  sqlstm.sqhstl[0] = (unsigned int  )sizeof(int);
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
		...
		else
		{
			...
			/* EXEC SQL 
			SELECT	1
			INTO	:BVLanguageIsAPL /o BVLanguageIsEPL -- Changed the Variable to avoid the Blur Label Printing for EPL Printer for HSA-SCF-0170 o/
			FROM	dual
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select 1 into :b0  from dual where UPPER(:b1) like 'EPL%'";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqlety = (unsigned short)256;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&BVLanguageIsAPL;
   sqlstm.sqhstl[0] = (unsigned int  )sizeof(int);
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         void  *)0;
   sqlstm.sqinds[0] = (         int  )0;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select 1 into :b0  from dual where UPPER(:b1) like 'ZPX%'";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)256;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (         void  *)&BVLanguageIsZPX;
    sqlstm.sqhstl[0] = (unsigned int  )sizeof(int);
    sqlstm.sqhsts[0] = (         int  )0;
    sqlstm.sqindv[0] = (         void  *)0;
    sqlstm.sqinds[0] = (         int  )0;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "select 1 into :b0  from dual where UPPER(:b1) like 'IPL%\
'";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqlety = (unsigned short)256;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (         void  *)&BVLanguageIsIPL;
     sqlstm.sqhstl[0] = (unsigned int  )sizeof(int);
     sqlstm.sqhsts[0] = (         int  )0;
     sqlstm.sqindv[0] = (         void  *)0;
     sqlstm.sqinds[0] = (         int  )0;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "select 1 into :b0  from dual where UPPER(:b1) like 'APL\
%'";
      sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select string_delim ,init_string ,no_of_copies_string ,term_\
string into :b0,:b1,:b2,:b3  from sm_label_format_hdr where (report_id=:b4 and\
 program_language=:b5)";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (         void  *)&BVHdrStringDelim;
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (         void  *)&BVHdrInitString;
 sqlstm.sqhstl[1] = (unsigned int  )66;
 sqlstm.sqhsts[1] = (         int  )0;
 sqlstm.sqindv[1] = (         void  *)0;
 sqlstm.sqinds[1] = (         int  )0;
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (         void  *)&BVNoOfCopiesString;
 ...
 sqlstm.sqadto[2] = (unsigned short )0;
 sqlstm.sqtdso[2] = (unsigned short )0;
 sqlstm.sqhstv[3] = (         void  *)&BVHdrTermString;
 ...
 sqlstm.sqadto[3] = (unsigned short )0;
 sqlstm.sqtdso[3] = (unsigned short )0;
 sqlstm.sqhstv[4] = (         void  *)&BVDocumentID;
 ...
 sqlstm.sqadto[4] = (unsigned short )0;
 sqlstm.sqtdso[4] = (unsigned short )0;
 sqlstm.sqhstv[5] = (         void  *)&BVProgramLanguage;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select init_string ,term_string into :b0,:b1  from sm_label\
_format_dtl where ((report_id=:b2 and program_language=:b3) and line_no=:b4)";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&BVDtlInitString;
  sqlstm.sqhstl[0] = (unsigned int  )130;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&BVDtlTermString;
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)&BVDocumentID;
  sqlstm.sqhstl[2] = (unsigned int  )66;
  sqlstm.sqhsts[2] = (         int  )0;
  sqlstm.sqindv[2] = (         void  *)0;
  sqlstm.sqinds[2] = (         int  )0;
  ...
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (         void  *)&BVProgramLanguage;
