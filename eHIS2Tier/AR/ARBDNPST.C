...
{
    56,
    "C:\\Users\\nagarajand\\Desktop\\2716\\6i\\ARBDNPST\\ARBDNPST.PC"
};


static unsigned long sqlctx = 758664469;
...
"select DOC_TYPE_CODE ,DOC_NUM  from AR_DN_HDR where ((((((DOC_TYPE_CODE>=NVL\
...
AR_DN_INV_HDR where (DOC_TYPE_CODE=:b0 and DOC_NUM=:b1) for update of LAST_LIN\
E_NUM nowait ";
...
ARRATION ,ROWID  from AR_DN_LINE where (((DOC_TYPE_CODE=:b0 and DOC_NUM=:b1) a\
...
LAG ,PRINT_FLAG ,ROWID  from AR_DN_HDR where (DOC_TYPE_CODE=:b0 and DOC_NUM=:b\
...
{10,4274,0,0,0,
5,0,0,1,232,0,4,332,0,0,12,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,1,9,0,0,
68,0,0,2,0,0,29,466,0,0,0,0,0,1,0,
83,0,0,3,0,0,30,474,0,0,0,0,0,1,0,
98,0,0,4,0,0,30,491,0,0,0,0,0,1,0,
113,0,0,5,406,0,9,523,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
152,0,0,7,791,0,9,645,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
175,0,0,9,0,0,29,651,0,0,0,0,0,1,0,
190,0,0,8,387,0,9,669,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
221,0,0,10,0,0,29,675,0,0,0,0,0,1,0,
236,0,0,5,0,0,13,700,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
259,0,0,6,579,0,9,784,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
282,0,0,6,0,0,13,791,0,0,26,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,
401,0,0,11,104,0,4,921,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
428,0,0,12,89,0,4,935,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
455,0,0,7,0,0,13,1193,0,0,44,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
646,0,0,8,0,0,13,1361,0,0,17,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,
729,0,0,13,70,0,2,1462,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
752,0,0,14,71,0,2,1469,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
775,0,0,15,157,0,3,1586,0,0,8,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
822,0,0,16,157,0,3,1659,0,0,8,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
869,0,0,17,52,0,5,1694,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
892,0,0,18,60,0,2,1707,0,0,1,1,0,1,0,1,9,0,0,
911,0,0,19,0,0,29,1714,0,0,0,0,0,1,0,
926,0,0,20,0,0,27,1725,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
957,0,0,21,118,0,4,1743,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
988,0,0,22,62,0,6,1754,0,0,1,1,0,1,0,2,9,0,0,
1007,0,0,23,44,0,4,1760,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1030,0,0,24,44,0,4,1764,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1053,0,0,25,53,0,4,1803,0,0,1,0,0,1,0,2,9,0,0,
1072,0,0,26,140,0,4,1813,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
};
...
and PGM_DATE=:b11)";
   ...
   while (fetch_cur())
   {
    ...
    disp_message(INFO_MESG,"Not Online GL interface\n");
				  ...
				  ins_gl_distrbn(d_dn_hdr_doc_type_code.arr,d_dn_hdr_doc_num.arr,2);
...

{
       ...
       sqlstm.sqadto[1] = (unsigned short )0;
       sqlstm.sqtdso[1] = (unsigned short )0;
       sqlstm.sqhstv[2] = (         void  *)&d_dn_ihdr_org_doc_type_code;
       ...
       sqlstm.sqadto[2] = (unsigned short )0;
       sqlstm.sqtdso[2] = (unsigned short )0;
       sqlstm.sqhstv[3] = (         void  *)&d_dn_ihdr_org_doc_num;
