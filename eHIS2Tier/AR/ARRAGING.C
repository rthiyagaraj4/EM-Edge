...
{
    38,
    "T:\\BL\\CRF-0120\\AR\\WIP\\Proc\\Arraging.pc"
};


static unsigned long sqlctx = 1150833133;
...
ANALYSIS_1_CODE,'X') between NVL(:b7,NVL(ANALYSIS_1_CODE,'X')) and NVL(:b8,NVL\
(ANALYSIS_1_CODE,'X'))) and NVL(ANALYSIS_2_CODE,'X') between NVL(:b9,NVL(ANALY\
SIS_2_CODE,'X')) and NVL(:b10,NVL(ANALYSIS_2_CODE,'X'))) and NVL(ANALYSIS_3_CO\
DE,'X') between NVL(:b11,NVL(ANALYSIS_3_CODE,'X')) and NVL(:b12,NVL(ANALYSIS_3\
_CODE,'X'))) order by CUST_CODE            ";
...
d NVL(ANALYSIS_1_CODE,'X') between NVL(:b7,NVL(ANALYSIS_1_CODE,'X')) and NVL(:\
b8,NVL(ANALYSIS_1_CODE,'X'))) and NVL(ANALYSIS_2_CODE,'X') between NVL(:b9,NVL\
(ANALYSIS_2_CODE,'X')) and NVL(:b10,NVL(ANALYSIS_2_CODE,'X'))) and NVL(ANALYSI\
S_3_CODE,'X') between NVL(:b11,NVL(ANALYSIS_3_CODE,'X')) and NVL(:b12,NVL(ANAL\
YSIS_3_CODE,'X'))) order by CUST_ALPHA_CODE,CUST_CODE            ";
...
{10,4274,0,0,0,
5,0,0,1,91,0,2,252,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
28,0,0,2,0,0,30,261,0,0,0,0,0,1,0,
43,0,0,3,200,0,4,276,0,0,7,2,0,1,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,
0,0,1,9,0,0,
86,0,0,4,539,0,4,338,0,0,26,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,
0,1,9,0,0,
205,0,0,5,665,0,9,862,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
272,0,0,6,687,0,9,890,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
339,0,0,7,665,0,9,921,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
406,0,0,8,687,0,9,949,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
473,0,0,5,0,0,13,1024,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
500,0,0,6,0,0,13,1033,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
527,0,0,7,0,0,13,1044,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
554,0,0,8,0,0,13,1053,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
581,0,0,9,541,0,9,1076,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
612,0,0,10,530,0,9,1083,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
643,0,0,9,0,0,13,1115,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,
3,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,3,0,0,
702,0,0,10,0,0,13,1132,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,
2,3,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,3,0,0,
761,0,0,11,278,0,4,1185,0,0,7,4,0,1,0,2,4,0,0,2,3,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,
804,0,0,12,69,0,4,1326,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
827,0,0,13,0,0,27,1670,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
};
...
int argc;
{
 ...
 strcpy(filename,WORKING_DIR);
   ...
   if (nd_rep_type.arr[0] == 'P')
     ...
     strcpy(g_pgm_id,"ARRAGCUS");
   else
     strcpy(g_pgm_id,"ARRAGSUM");
...

{
    ...
    sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='ARRAGING' and\
...
BER(PARAM8),0) ,NVL(TO_NUMBER(PARAM9),0) ,NVL(TO_NUMBER(PARAM10),0) ,NVL(TO_NU\
MBER(PARAM11),0) ,PARAM12 ,PARAM13 ,PARAM14 ,PARAM15 ,PARAM16 ,PARAM17 ,PARAM1\
8 ,PARAM19 ,PARAM20 ,PARAM21 ,PARAM22 ,PARAM23 into :b0,:b1,:b2,:b3,:b4,:b5,:b\
6,:b7,:b8,:b9,:b10,:b11,:b12,:b13,:b14,:b15,:b16,:b17,:b18,:b19,:b20,:b21,:b22\
,:b23  from SY_PROG_PARAM where ((PGM_ID='ARRAGING' and SESSION_ID=:b24) and P\
GM_DATE=:b25)";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqhstv[10] = (         void  *)&nd_age_slot4;
   ...
   sqlstm.sqhstv[11] = (         void  *)&nd_age_slot5;
   ...
   sqlstm.sqhstv[12] = (         void  *)&nd_order;
   ...
   sqlstm.sqhstv[13] = (         void  *)&nd_pat_details;
   ...
   sqlstm.sqhstv[14] = (         void  *)&nd_fm_cust_type;
   ...
   sqlstm.sqhstv[15] = (         void  *)&nd_to_cust_type;
   ...
   sqlstm.sqhstv[16] = (         void  *)&nd_fm_cust_group;
   ...
   sqlstm.sqhstv[17] = (         void  *)&nd_to_cust_group;
   ...
   sqlstm.sqhstv[18] = (         void  *)&nd_fm_anal_cd1;
   ...
   sqlstm.sqhstv[19] = (         void  *)&nd_to_anal_cd1;
   ...
   sqlstm.sqhstv[20] = (         void  *)&nd_fm_anal_cd2;
   ...
   sqlstm.sqhstv[21] = (         void  *)&nd_to_anal_cd2;
   ...
   sqlstm.sqhstv[22] = (         void  *)&nd_fm_anal_cd3;
   ...
   sqlstm.sqhstv[23] = (         void  *)&nd_to_anal_cd3;
...
open_files()
{
  ...
  char err_stmt[70];
   ...
   if (nd_rep_type.arr[0] == 'P')
     {
     //strcpy(filename,"arragpat.lis");
	 //strcat(filename,"arragpat.lis");
     //strcpy(OUTPUT_FILE_NAME, "arragpat.lis");
     ...
     {
     //strcpy(filename,"arragsum.lis");
	 //strcat(filename,"arragsum.lis");
     //strcpy(OUTPUT_FILE_NAME, "arragsum.lis");
	   strcat(filename,OUTPUT_FILE_NAME); 
     }
...
if (nd_rep_type.arr[0] == 'S')
  ...
  {  
	fprintf(fp,"\n\n");
	print_hospital_name(174,"AR",hosp_name.arr,date_time.arr);
  }
}
     fprintf(fp,"OPR : %-17s                                                    %s\n",user_id.arr,(nd_rep_type.arr[0] == 'P')?"AGEING ANALYSIS REPORT":"");
// sri1 - 17/feb-98 -- "OPR : %-10s                                %s\n",
{
  if (nd_rep_type.arr[0] == 'S')
  { 
  fprintf(fp,
"REP : %-31s                                  %-28s                                                                       PAGE : %4d\n",
    ...
    g_pgm_id,
    (nd_rep_type.arr[0] == 'P')? "(FOR PATIENT LEVEL ANALYSIS)":
...
print_head()
{
 void print_hospital_name();
 {
  ...
  print_hospital_name(181,"AR",hosp_name.arr,date_time.arr);
     fprintf(fp,"OPR : %-17s                                   %s\n",user_id.arr,(nd_rep_type.arr[0] == 'P')?"AGEING ANALYSIS REPORT":"");
  fprintf(fp,"REP : %-31s                                  %-28s                                                                       PAGE : %4d\n",    g_pgm_id,
    (nd_rep_type.arr[0] == 'P')?"(FOR PATIENT LEVEL ANALYSIS)": 
                                "     AGEING ANALYSIS REPORT",
    ++pctr);
  }
...
fprintf(fp,
"DOC TYPE & NO   BASE DATE     OUTSTANDING    NOT YET DUE    OPEN CREDIT  REFERENCE        DUE DATE      AGE SLOT 1     AGE SLOT 2     AGE SLOT 3     AGE SLOT 4     AGE SLOT 5\n");
fprintf(fp,
"                                   AMOUNT         AMOUNT                                              %3d-%-3d DAYS    %3d-%-3d DAYS   %3d-%-3d DAYS   %3d-%-3d DAYS  %3d-%-3d DAYS\n",
     0, nd_age_slot1,
...
fprintf(fp,
"CUSTOMER CUSTOMER NAME                                           OUTSTANDING    NOT YET DUE           OPEN     AGE SLOT 1     AGE SLOT 2     AGE SLOT 3     AGE SLOT 4     AGE SLOT 5\n");

fprintf(fp,
"CODE                                                                  AMOUNT         AMOUNT         CREDIT   %3d-%-3d DAYS   %3d-%-3d DAYS   %3d-%-3d DAYS   %3d-%-3d DAYS   %3d-%-3d DAYS\n",
     0, nd_age_slot1,
     nd_age_slot1+1, nd_age_slot2,
     nd_age_slot2+1, nd_age_slot3,
     nd_age_slot3+1, nd_age_slot4,
...
fprintf(fp,
"DOC TYPE & NO   BASE DATE        OUTSTANDING    NOT YET DUE           OPEN     AGE SLOT 1     AGE SLOT 2     AGE SLOT 3     AGE SLOT 4     AGE SLOT 5\n");
fprintf(fp,
"REFERENCE        DUE DATE             AMOUNT         AMOUNT         CREDIT   %3d-%-3d DAYS   %3d-%-3d DAYS   %3d-%-3d DAYS   %3d-%-3d DAYS     > %-3d DAYS\n",
     0, nd_age_slot1,
     nd_age_slot1, nd_age_slot2,
     nd_age_slot2, nd_age_slot3,
     nd_age_slot3, nd_age_slot4,
     nd_age_slot4, nd_age_slot5);
...
fprintf(fp,
"CUSTOMER                                                         OUTSTANDING    NOT YET DUE           OPEN     AGE SLOT 1     AGE SLOT 2     AGE SLOT 3     AGE SLOT 4     AGE SLOT 5\n");
fprintf(fp,
"CODE                                                                  AMOUNT         AMOUNT         CREDIT   %3d-%-3d DAYS   %3d-%-3d DAYS   %3d-%-3d DAYS   %3d-%-3d DAYS     > %-3d DAYS\n",
     0, nd_age_slot1,
     nd_age_slot1, nd_age_slot2,
     nd_age_slot2, nd_age_slot3,
     nd_age_slot3, nd_age_slot4,
         ...
         /* EXEC SQL DECLARE AR_CUSTOMER_CUR CURSOR FOR
                   SELECT CUST_CODE, LONG_NAME, CUST_ALPHA_CODE
                    ...
                    WHERE CUST_CODE BETWEEN NVL(:nd_fm_cust_code,'        ')
                      ...
                      AND NVL(ANALYSIS_1_CODE,'X') BETWEEN NVL(:nd_fm_anal_cd1,NVL(ANALYSIS_1_CODE,'X'))
                          AND NVL(:nd_to_anal_cd1,NVL(ANALYSIS_1_CODE,'X'))
                      AND NVL(ANALYSIS_2_CODE,'X') BETWEEN NVL(:nd_fm_anal_cd2,NVL(ANALYSIS_2_CODE,'X'))
                          AND NVL(:nd_to_anal_cd2,NVL(ANALYSIS_2_CODE,'X'))
                      AND NVL(ANALYSIS_3_CODE,'X') BETWEEN NVL(:nd_fm_anal_cd3,NVL(ANALYSIS_3_CODE,'X'))
                            AND NVL(:nd_to_anal_cd3,NVL(ANALYSIS_3_CODE,'X'))
                    ORDER BY CUST_CODE; */ 
...
/******************************************************************/
   ...
   print_formated(pat_d_amt_slot5);   fprintf(fp,"\n");
  fprintf(fp,
"                          ----------------------------------------------------------------------------------------------------------------------------------------------------\n\n");
  lctr += 4;
...
/*****************************************************************/
       ...
       print_formated(bal_amt_slot5);   fprintf(fp,"\n");
	    fprintf(fp,"\n");
//   }             
   /*
   else {
