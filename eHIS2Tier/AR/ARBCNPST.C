...
{
    56,
    "C:\\Users\\nagarajand\\Desktop\\2716\\6i\\ARBCNPST\\Arbcnpst.pc"
};


static unsigned long sqlctx = 758730133;
...
"select DOC_TYPE_CODE ,DOC_NUM  from AR_CN_HDR where ((((((DOC_TYPE_CODE>=NVL\
(:b0,'      ') and DOC_TYPE_CODE<=NVL(:b1,'~~~~~~')) and DOC_NUM>=NVL(:b2,0)) \
and DOC_NUM<=NVL(:b3,99999999)) and NVL(DOC_DATE,SYSDATE)>=NVL(TO_DATE(:b4,'DD\
/MM/YYYY'),to_date('00010101','YYYYDDMM'))) and NVL(DOC_DATE,SYSDATE)<=NVL(TO_\
DATE(:b5,'DD/MM/YYYY'),to_date('47123112','YYYYDDMM'))) and NVL(POSTED_FLAG,'N\
')='N')           ";

 static const char *sq0007 = 
"select ACC_ENTITY_CODE ,DOC_TYPE_CODE ,DOC_NUM ,ORG_DOC_TYPE_CODE ,ORG_DOC_N\
UM ,NVL(LAST_LINE_NUM,0) ,NVL(CUST_CODE,' ') ,NVL(NARRATION,' ') ,BASE_DATE ,T\
O_CHAR(BASE_DATE,'YYYYMMDD') ,DUE_DATE ,TO_CHAR(DUE_DATE,'YYYYMMDD') ,NVL(GROS\
S_AMT,0) ,NVL(GROSS_AMT,0) ,NVL(PAYABLE_AMT,0) ,NVL(PAYABLE_AMT,0) ,NVL(DISCOU\
NT_AMT,0) ,NVL(DOC_AMT,0) ,NVL(DOC_AMT,0) ,NVL(CURRENCY_CODE,' ') ,NVL(EXCHG_R\
ATE,0) ,NVL(PMNT_TERMS_CODE,' ') ,SETTLEMENT_DATE ,TO_CHAR(SETTLEMENT_DATE,'YY\
YYMMDD') ,NVL(SETTLEMENT_PERC,0) ,NVL(CUST_REF,' ') ,NVL(PATIENT_ID,' ') ,NVL(\
BILLING_GROUP,' ') ,NVL(BILL_DOC_TYPE_CODE,' ') ,NVL(BILL_NUM,0) ,BILL_DATE ,T\
O_CHAR(BILL_DATE,'YYYYMMDD') ,NVL(DOCTOR_FEE_AMT,0) ,NVL(MAIN_ACC1_CODE,' ') ,\
NVL(MAIN_ACC2_CODE,' ') ,NVL(SUBLEDGER_GROUP_CODE,' ') ,NVL(SUBLEDGER_LINE_COD\
E,' ') ,NVL(DEPT_CODE,' ') ,NVL(PRODUCT_GROUP_CODE,' ') ,NVL(PRODUCT_LINE_CODE\
,' ') ,NVL(POST_MONTH,0) ,NVL(POST_YEAR,0) ,ROWID ,CONSOLIDATED_INV_YN  from A\
R_CN_INV_HDR where (DOC_TYPE_CODE=:b0 and DOC_NUM=:b1) for update of LAST_LINE\
_NUM nowait ";
...
ARRATION ,ROWID  from AR_CN_LINE where (((DOC_TYPE_CODE=:b0 and DOC_NUM=:b1) a\
nd ORG_DOC_TYPE_CODE=:b2) and ORG_DOC_NUM=:b3) for update of LINE_NUM nowait ";
...
LAG ,PRINT_FLAG ,ROWID  from AR_CN_HDR where (DOC_TYPE_CODE=:b0 and DOC_NUM=:b\
1) for update of ERROR_FLAG nowait ";
...
{10,4274,0,0,0,
5,0,0,1,232,0,4,333,0,0,12,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,1,9,0,0,
68,0,0,2,0,0,29,471,0,0,0,0,0,1,0,
83,0,0,3,0,0,30,480,0,0,0,0,0,1,0,
98,0,0,4,0,0,30,497,0,0,0,0,0,1,0,
113,0,0,5,406,0,9,526,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
152,0,0,7,1024,0,9,648,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
175,0,0,9,0,0,29,654,0,0,0,0,0,1,0,
190,0,0,8,387,0,9,672,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
221,0,0,10,0,0,29,678,0,0,0,0,0,1,0,
236,0,0,5,0,0,13,703,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
259,0,0,6,579,0,9,787,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
282,0,0,6,0,0,13,794,0,0,26,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,
401,0,0,11,104,0,4,925,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
428,0,0,12,89,0,4,939,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
455,0,0,7,0,0,13,1196,0,0,44,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
646,0,0,8,0,0,13,1373,0,0,17,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,
729,0,0,13,70,0,2,1459,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
752,0,0,14,71,0,2,1466,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
775,0,0,15,157,0,3,1565,0,0,8,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
822,0,0,16,157,0,3,1638,0,0,8,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
869,0,0,17,52,0,5,1673,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
892,0,0,18,60,0,2,1686,0,0,1,1,0,1,0,1,9,0,0,
911,0,0,19,0,0,29,1693,0,0,0,0,0,1,0,
926,0,0,20,0,0,27,1704,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
957,0,0,21,118,0,4,1721,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
988,0,0,22,62,0,6,1733,0,0,1,1,0,1,0,2,9,0,0,
1007,0,0,23,44,0,4,1739,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1030,0,0,24,44,0,4,1743,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1053,0,0,25,53,0,4,1781,0,0,1,0,0,1,0,2,9,0,0,
1072,0,0,26,140,0,4,1791,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
};
...
/o            d_cn_ihdr_gross_amt                  [19],o/
            d_chk_ihdr_gross_amt                 [19],
/o            d_cn_ihdr_payable_amt                [19],o/
            d_chk_ihdr_payable_amt                [19],
/o            d_cn_ihdr_discount_amt               [19],o/
/o            d_cn_ihdr_doc_amt                    [19],o/
...
/o            d_cn_ihdr_doctor_fee_amt             [19],o/
...
struct { unsigned short len; unsigned char arr[7]; } d_cn_hdr_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } d_cn_hdr_doc_num;

struct { unsigned short len; unsigned char arr[9]; } d_cn_hdr_cust_code;

struct { unsigned short len; unsigned char arr[12]; } d_cn_hdr_doc_date;

struct { unsigned short len; unsigned char arr[12]; } d_chk_hdr_doc_date;

struct { unsigned short len; unsigned char arr[12]; } d_cn_hdr_doc_date_chking;

struct { unsigned short len; unsigned char arr[5]; } d_cn_hdr_acc_entity_code;

struct { unsigned short len; unsigned char arr[17]; } d_cn_hdr_doc_amt_chk;

struct { unsigned short len; unsigned char arr[3]; } d_cn_hdr_post_month;

struct { unsigned short len; unsigned char arr[5]; } d_cn_hdr_post_year;

struct { unsigned short len; unsigned char arr[101]; } d_cn_hdr_misc_clong_name;

struct { unsigned short len; unsigned char arr[101]; } d_cn_hdr_misc_cshort_name;

struct { unsigned short len; unsigned char arr[61]; } d_cn_hdr_misc_cadd1_desc;

struct { unsigned short len; unsigned char arr[61]; } d_cn_hdr_misc_cadd2_desc;

struct { unsigned short len; unsigned char arr[61]; } d_cn_hdr_misc_cadd3_desc;

struct { unsigned short len; unsigned char arr[41]; } d_cn_hdr_misc_czip_desc;

struct { unsigned short len; unsigned char arr[101]; } d_cn_hdr_misc_long_chinese;

struct { unsigned short len; unsigned char arr[101]; } d_cn_hdr_misc_short_chinese;

struct { unsigned short len; unsigned char arr[61]; } d_cn_hdr_misc_add1_chinese;

struct { unsigned short len; unsigned char arr[61]; } d_cn_hdr_misc_add2_chinese;

struct { unsigned short len; unsigned char arr[61]; } d_cn_hdr_misc_add3_chinese;

struct { unsigned short len; unsigned char arr[31]; } d_cn_hdr_misc_zip_chinese;

struct { unsigned short len; unsigned char arr[31]; } d_cn_hdr_tel_num;

struct { unsigned short len; unsigned char arr[101]; } d_cn_hdr_contact_name;

struct { unsigned short len; unsigned char arr[61]; } d_cn_hdr_contact_name_title;

struct { unsigned short len; unsigned char arr[2]; } d_cn_hdr_error_flag;

struct { unsigned short len; unsigned char arr[2]; } d_cn_hdr_print_flag;

struct { unsigned short len; unsigned char arr[31]; } d_cn_hdr_rowid;
...
struct { unsigned short len; unsigned char arr[5]; } d_cn_ihdr_acc_entity_code;

struct { unsigned short len; unsigned char arr[7]; } d_cn_ihdr_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } d_cn_ihdr_doc_num;

struct { unsigned short len; unsigned char arr[7]; } d_cn_ihdr_org_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } d_cn_ihdr_org_doc_num;

struct { unsigned short len; unsigned char arr[5]; } d_cn_ihdr_last_line_num;

struct { unsigned short len; unsigned char arr[8]; } d_cn_ihdr_cust_code;

struct { unsigned short len; unsigned char arr[51]; } d_cn_ihdr_narration;

struct { unsigned short len; unsigned char arr[12]; } d_cn_ihdr_base_date;

struct { unsigned short len; unsigned char arr[12]; } d_chk_ihdr_base_date;

struct { unsigned short len; unsigned char arr[12]; } d_cn_ihdr_due_date;
...
struct { unsigned short len; unsigned char arr[19]; } d_cn_ihdr_doc_amt_chk;

struct { unsigned short len; unsigned char arr[19]; } d_cn_ihdr_currency_code;

struct { unsigned short len; unsigned char arr[20]; } d_cn_ihdr_exchg_rate;

struct { unsigned short len; unsigned char arr[3]; } d_cn_ihdr_pmnt_terms_code;

struct { unsigned short len; unsigned char arr[12]; } d_cn_ihdr_settlement_date;

struct { unsigned short len; unsigned char arr[12]; } d_chk_ihdr_settlement_date;

struct { unsigned short len; unsigned char arr[7]; } d_cn_ihdr_settlement_perc;

struct { unsigned short len; unsigned char arr[16]; } d_cn_ihdr_cust_ref;

struct { unsigned short len; unsigned char arr[21]; } d_cn_ihdr_patient_id;

struct { unsigned short len; unsigned char arr[5]; } d_cn_ihdr_billing_group;

struct { unsigned short len; unsigned char arr[7]; } d_cn_ihdr_bill_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } d_cn_ihdr_bill_num;

struct { unsigned short len; unsigned char arr[12]; } d_cn_ihdr_bill_date;

struct { unsigned short len; unsigned char arr[12]; } d_chk_ihdr_bill_date;

struct { unsigned short len; unsigned char arr[7]; } d_cn_ihdr_main_acc1_code;

struct { unsigned short len; unsigned char arr[5]; } d_cn_ihdr_main_acc2_code;

struct { unsigned short len; unsigned char arr[4]; } d_cn_ihdr_sub_group_code;

struct { unsigned short len; unsigned char arr[9]; } d_cn_ihdr_sub_line_code;

struct { unsigned short len; unsigned char arr[11]; } d_cn_ihdr_dept_code;

struct { unsigned short len; unsigned char arr[5]; } d_cn_ihdr_product_group_code;

struct { unsigned short len; unsigned char arr[5]; } d_cn_ihdr_product_line_code;

struct { unsigned short len; unsigned char arr[3]; } d_cn_ihdr_post_month;

struct { unsigned short len; unsigned char arr[5]; } d_cn_ihdr_post_year;

struct { unsigned short len; unsigned char arr[31]; } d_cn_ihdr_rowid;

struct { unsigned short len; unsigned char arr[5]; } d_cn_line_acc_entity_code;

struct { unsigned short len; unsigned char arr[7]; } d_cn_line_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } d_cn_line_doc_num;

struct { unsigned short len; unsigned char arr[7]; } d_cn_line_org_doc_type_code;

struct { unsigned short len; unsigned char arr[9]; } d_cn_line_org_doc_num;

struct { unsigned short len; unsigned char arr[5]; } d_cn_line_line_num;

struct { unsigned short len; unsigned char arr[7]; } d_cn_line_main_acc1_code;

struct { unsigned short len; unsigned char arr[5]; } d_cn_line_main_acc2_code;

struct { unsigned short len; unsigned char arr[4]; } d_cn_line_sub_group_code;

struct { unsigned short len; unsigned char arr[9]; } d_cn_line_sub_line_code;

struct { unsigned short len; unsigned char arr[11]; } d_cn_line_dept_code;

struct { unsigned short len; unsigned char arr[4]; } d_cn_line_product_group_code;

struct { unsigned short len; unsigned char arr[5]; } d_cn_line_product_line_code;

struct { unsigned short len; unsigned char arr[19]; } d_cn_line_amount_chk;

struct { unsigned short len; unsigned char arr[51]; } d_cn_line_narration;

struct { unsigned short len; unsigned char arr[31]; } d_cn_line_rowid;
...
b7,:b8,:b9  from SY_PROG_PARAM where ((PGM_ID='ARBCNPST' and SESSION_ID=:b10) \
and PGM_DATE=:b11)";
   ...
   disp_message(INFO_MESG,"Inside while...\n"); 
    ...
    disp_message(INFO_MESG,"Not Online GL interface\n");
			...
			ins_gl_distrbn(d_cn_hdr_doc_type_code.arr,d_cn_hdr_doc_num.arr,3);
...

{
      ...
      sqlstm.sqlety = (unsigned short)256;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&d_cn_hdr_doc_type_code;
      sqlstm.sqhstl[0] = (unsigned int  )9;
      sqlstm.sqhsts[0] = (         int  )0;
      sqlstm.sqindv[0] = (         void  *)0;
      sqlstm.sqinds[0] = (         int  )0;
      ...
      sqlstm.sqadto[0] = (unsigned short )0;
      sqlstm.sqtdso[0] = (unsigned short )0;
      sqlstm.sqhstv[1] = (         void  *)&d_cn_hdr_doc_num;
...

{
      ...
      sqlstm.sqadto[1] = (unsigned short )0;
      sqlstm.sqtdso[1] = (unsigned short )0;
      sqlstm.sqhstv[2] = (         void  *)&d_cn_ihdr_org_doc_type_code;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&d_cn_ihdr_org_doc_num;
...

{
   ...
   sqlstm.sqlety = (unsigned short)256;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&d_cn_hdr_acc_entity_code;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&d_cn_hdr_cust_code;
   sqlstm.sqhstl[1] = (unsigned int  )11;
   sqlstm.sqhsts[1] = (         int  )0;
   sqlstm.sqindv[1] = (         void  *)0;
   sqlstm.sqinds[1] = (         int  )0;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&d_cn_hdr_doc_date;
   ...
   sqlstm.sqadto[3] = (unsigned short )0;
   sqlstm.sqtdso[3] = (unsigned short )0;
   sqlstm.sqhstv[4] = (         void  *)&d_cn_hdr_doc_amt;
   ...
   sqlstm.sqadto[4] = (unsigned short )0;
   sqlstm.sqtdso[4] = (unsigned short )0;
   sqlstm.sqhstv[5] = (         void  *)&d_cn_hdr_doc_amt_chk;
   ...
   sqlstm.sqadto[5] = (unsigned short )0;
   sqlstm.sqtdso[5] = (unsigned short )0;
   sqlstm.sqhstv[6] = (         void  *)&d_cn_hdr_post_month;
   ...
   sqlstm.sqadto[6] = (unsigned short )0;
   sqlstm.sqtdso[6] = (unsigned short )0;
   sqlstm.sqhstv[7] = (         void  *)&d_cn_hdr_post_year;
   ...
   sqlstm.sqadto[7] = (unsigned short )0;
   sqlstm.sqtdso[7] = (unsigned short )0;
   sqlstm.sqhstv[8] = (         void  *)&d_cn_hdr_misc_clong_name;
   ...
   sqlstm.sqadto[8] = (unsigned short )0;
   sqlstm.sqtdso[8] = (unsigned short )0;
   sqlstm.sqhstv[9] = (         void  *)&d_cn_hdr_misc_cshort_name;
   ...
   sqlstm.sqadto[9] = (unsigned short )0;
   sqlstm.sqtdso[9] = (unsigned short )0;
   sqlstm.sqhstv[10] = (         void  *)&d_cn_hdr_misc_cadd1_desc;
   ...
   sqlstm.sqadto[10] = (unsigned short )0;
   sqlstm.sqtdso[10] = (unsigned short )0;
   sqlstm.sqhstv[11] = (         void  *)&d_cn_hdr_misc_cadd2_desc;
   ...
   sqlstm.sqadto[11] = (unsigned short )0;
   sqlstm.sqtdso[11] = (unsigned short )0;
   sqlstm.sqhstv[12] = (         void  *)&d_cn_hdr_misc_cadd3_desc;
   ...
   sqlstm.sqhstv[13] = (         void  *)&d_cn_hdr_misc_czip_desc;
   ...
   sqlstm.sqhstv[14] = (         void  *)&d_cn_hdr_misc_long_chinese;
   ...
   sqlstm.sqhstv[15] = (         void  *)&d_cn_hdr_misc_short_chinese;
   ...
   sqlstm.sqhstv[16] = (         void  *)&d_cn_hdr_misc_add1_chinese;
   ...
   sqlstm.sqhstv[17] = (         void  *)&d_cn_hdr_misc_add2_chinese;
   ...
   sqlstm.sqhstv[18] = (         void  *)&d_cn_hdr_misc_add3_chinese;
   ...
   sqlstm.sqhstv[19] = (         void  *)&d_cn_hdr_misc_zip_chinese;
   ...
   sqlstm.sqhstv[20] = (         void  *)&d_cn_hdr_tel_num;
   ...
   sqlstm.sqhstv[21] = (         void  *)&d_cn_hdr_contact_name;
   ...
   sqlstm.sqhstv[22] = (         void  *)&d_cn_hdr_contact_name_title;
   ...
   sqlstm.sqhstv[23] = (         void  *)&d_cn_hdr_error_flag;
   ...
   sqlstm.sqhstv[24] = (         void  *)&d_cn_hdr_print_flag;
   ...
   sqlstm.sqhstv[25] = (         void  *)&d_cn_hdr_rowid;
...

{
      ...
      sqlstm.sqlety = (unsigned short)256;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&d_cn_ihdr_acc_entity_code;
      sqlstm.sqhstl[0] = (unsigned int  )7;
      sqlstm.sqhsts[0] = (         int  )0;
      sqlstm.sqindv[0] = (         void  *)0;
      sqlstm.sqinds[0] = (         int  )0;
      ...
      sqlstm.sqadto[0] = (unsigned short )0;
      sqlstm.sqtdso[0] = (unsigned short )0;
      sqlstm.sqhstv[1] = (         void  *)&d_cn_ihdr_doc_type_code;
      sqlstm.sqhstl[1] = (unsigned int  )9;
      sqlstm.sqhsts[1] = (         int  )0;
      sqlstm.sqindv[1] = (         void  *)0;
      sqlstm.sqinds[1] = (         int  )0;
      ...
      sqlstm.sqadto[1] = (unsigned short )0;
      sqlstm.sqtdso[1] = (unsigned short )0;
      sqlstm.sqhstv[2] = (         void  *)&d_cn_ihdr_doc_num;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&d_cn_ihdr_org_doc_type_code;
      ...
      sqlstm.sqadto[3] = (unsigned short )0;
      sqlstm.sqtdso[3] = (unsigned short )0;
      sqlstm.sqhstv[4] = (         void  *)&d_cn_ihdr_org_doc_num;
      ...
      sqlstm.sqadto[4] = (unsigned short )0;
      sqlstm.sqtdso[4] = (unsigned short )0;
      sqlstm.sqhstv[5] = (         void  *)&d_cn_ihdr_last_line_num;
      ...
      sqlstm.sqadto[5] = (unsigned short )0;
      sqlstm.sqtdso[5] = (unsigned short )0;
      sqlstm.sqhstv[6] = (         void  *)&d_cn_ihdr_cust_code;
      ...
      sqlstm.sqadto[6] = (unsigned short )0;
      sqlstm.sqtdso[6] = (unsigned short )0;
      sqlstm.sqhstv[7] = (         void  *)&d_cn_ihdr_narration;
      ...
      sqlstm.sqadto[7] = (unsigned short )0;
      sqlstm.sqtdso[7] = (unsigned short )0;
      sqlstm.sqhstv[8] = (         void  *)&d_cn_ihdr_base_date;
      ...
      sqlstm.sqadto[9] = (unsigned short )0;
      sqlstm.sqtdso[9] = (unsigned short )0;
      sqlstm.sqhstv[10] = (         void  *)&d_cn_ihdr_due_date;
      ...
      sqlstm.sqadto[11] = (unsigned short )0;
      sqlstm.sqtdso[11] = (unsigned short )0;
      sqlstm.sqhstv[12] = (         void  *)&d_cn_ihdr_gross_amt;
      ...
      sqlstm.sqadto[13] = (unsigned short )0;
      sqlstm.sqtdso[13] = (unsigned short )0;
      sqlstm.sqhstv[14] = (         void  *)&d_cn_ihdr_payable_amt;
      ...
      sqlstm.sqadto[15] = (unsigned short )0;
      sqlstm.sqtdso[15] = (unsigned short )0;
      sqlstm.sqhstv[16] = (         void  *)&d_cn_ihdr_discount_amt;
      ...
      sqlstm.sqadto[16] = (unsigned short )0;
      sqlstm.sqtdso[16] = (unsigned short )0;
      sqlstm.sqhstv[17] = (         void  *)&d_cn_ihdr_doc_amt;
      ...
      sqlstm.sqadto[17] = (unsigned short )0;
      sqlstm.sqtdso[17] = (unsigned short )0;
      sqlstm.sqhstv[18] = (         void  *)&d_cn_ihdr_doc_amt_chk;
      ...
      sqlstm.sqadto[18] = (unsigned short )0;
      sqlstm.sqtdso[18] = (unsigned short )0;
      sqlstm.sqhstv[19] = (         void  *)&d_cn_ihdr_currency_code;
      ...
      sqlstm.sqadto[19] = (unsigned short )0;
      sqlstm.sqtdso[19] = (unsigned short )0;
      sqlstm.sqhstv[20] = (         void  *)&d_cn_ihdr_exchg_rate;
      ...
      sqlstm.sqadto[20] = (unsigned short )0;
      sqlstm.sqtdso[20] = (unsigned short )0;
      sqlstm.sqhstv[21] = (         void  *)&d_cn_ihdr_pmnt_terms_code;
      ...
      sqlstm.sqadto[21] = (unsigned short )0;
      sqlstm.sqtdso[21] = (unsigned short )0;
      sqlstm.sqhstv[22] = (         void  *)&d_cn_ihdr_settlement_date;
      ...
      sqlstm.sqadto[23] = (unsigned short )0;
      sqlstm.sqtdso[23] = (unsigned short )0;
      sqlstm.sqhstv[24] = (         void  *)&d_cn_ihdr_settlement_perc;
      ...
      sqlstm.sqadto[24] = (unsigned short )0;
      sqlstm.sqtdso[24] = (unsigned short )0;
      sqlstm.sqhstv[25] = (         void  *)&d_cn_ihdr_cust_ref;
      ...
      sqlstm.sqadto[25] = (unsigned short )0;
      sqlstm.sqtdso[25] = (unsigned short )0;
      sqlstm.sqhstv[26] = (         void  *)&d_cn_ihdr_patient_id;
      ...
      sqlstm.sqhstv[27] = (         void  *)&d_cn_ihdr_billing_group;
      ...
      sqlstm.sqhstv[28] = (         void  *)&d_cn_ihdr_bill_doc_type_code;
      ...
      sqlstm.sqhstv[29] = (         void  *)&d_cn_ihdr_bill_num;
      ...
      sqlstm.sqhstv[30] = (         void  *)&d_cn_ihdr_bill_date;
      ...
      sqlstm.sqhstv[32] = (         void  *)&d_cn_ihdr_doctor_fee_amt;
      ...
      sqlstm.sqhstv[33] = (         void  *)&d_cn_ihdr_main_acc1_code;
      ...
      sqlstm.sqhstv[34] = (         void  *)&d_cn_ihdr_main_acc2_code;
      ...
      sqlstm.sqhstv[35] = (         void  *)&d_cn_ihdr_sub_group_code;
      ...
      sqlstm.sqhstv[36] = (         void  *)&d_cn_ihdr_sub_line_code;
      ...
      sqlstm.sqhstv[37] = (         void  *)&d_cn_ihdr_dept_code;
      ...
      sqlstm.sqhstv[38] = (         void  *)&d_cn_ihdr_product_group_code;
      ...
      sqlstm.sqhstv[39] = (         void  *)&d_cn_ihdr_product_line_code;
      ...
      sqlstm.sqhstv[40] = (         void  *)&d_cn_ihdr_post_month;
      ...
      sqlstm.sqhstv[41] = (         void  *)&d_cn_ihdr_post_year;
      ...
      sqlstm.sqhstv[42] = (         void  *)&d_cn_ihdr_rowid;
...

{
      ...
      sqlstm.sqlety = (unsigned short)256;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&d_cn_line_acc_entity_code;
      sqlstm.sqhstl[0] = (unsigned int  )7;
      sqlstm.sqhsts[0] = (         int  )0;
      sqlstm.sqindv[0] = (         void  *)0;
      sqlstm.sqinds[0] = (         int  )0;
      ...
      sqlstm.sqadto[0] = (unsigned short )0;
      sqlstm.sqtdso[0] = (unsigned short )0;
      sqlstm.sqhstv[1] = (         void  *)&d_cn_line_doc_type_code;
      sqlstm.sqhstl[1] = (unsigned int  )9;
      sqlstm.sqhsts[1] = (         int  )0;
      sqlstm.sqindv[1] = (         void  *)0;
      sqlstm.sqinds[1] = (         int  )0;
      ...
      sqlstm.sqadto[1] = (unsigned short )0;
      sqlstm.sqtdso[1] = (unsigned short )0;
      sqlstm.sqhstv[2] = (         void  *)&d_cn_line_doc_num;
      sqlstm.sqhstl[2] = (unsigned int  )11;
      sqlstm.sqhsts[2] = (         int  )0;
      sqlstm.sqindv[2] = (         void  *)0;
      sqlstm.sqinds[2] = (         int  )0;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&d_cn_line_org_doc_type_code;
      sqlstm.sqhstl[3] = (unsigned int  )9;
      sqlstm.sqhsts[3] = (         int  )0;
      sqlstm.sqindv[3] = (         void  *)0;
      sqlstm.sqinds[3] = (         int  )0;
      ...
      sqlstm.sqadto[3] = (unsigned short )0;
      sqlstm.sqtdso[3] = (unsigned short )0;
      sqlstm.sqhstv[4] = (         void  *)&d_cn_line_org_doc_num;
      sqlstm.sqhstl[4] = (unsigned int  )11;
      sqlstm.sqhsts[4] = (         int  )0;
      sqlstm.sqindv[4] = (         void  *)0;
      sqlstm.sqinds[4] = (         int  )0;
      ...
      sqlstm.sqadto[4] = (unsigned short )0;
      sqlstm.sqtdso[4] = (unsigned short )0;
      sqlstm.sqhstv[5] = (         void  *)&d_cn_line_line_num;
      sqlstm.sqhstl[5] = (unsigned int  )7;
      sqlstm.sqhsts[5] = (         int  )0;
      sqlstm.sqindv[5] = (         void  *)0;
      sqlstm.sqinds[5] = (         int  )0;
      ...
      sqlstm.sqadto[5] = (unsigned short )0;
      sqlstm.sqtdso[5] = (unsigned short )0;
      sqlstm.sqhstv[6] = (         void  *)&d_cn_line_main_acc1_code;
      ...
      sqlstm.sqadto[6] = (unsigned short )0;
      sqlstm.sqtdso[6] = (unsigned short )0;
      sqlstm.sqhstv[7] = (         void  *)&d_cn_line_main_acc2_code;
      sqlstm.sqhstl[7] = (unsigned int  )7;
      sqlstm.sqhsts[7] = (         int  )0;
      sqlstm.sqindv[7] = (         void  *)0;
      sqlstm.sqinds[7] = (         int  )0;
      ...
      sqlstm.sqadto[7] = (unsigned short )0;
      sqlstm.sqtdso[7] = (unsigned short )0;
      sqlstm.sqhstv[8] = (         void  *)&d_cn_line_sub_group_code;
      ...
      sqlstm.sqadto[8] = (unsigned short )0;
      sqlstm.sqtdso[8] = (unsigned short )0;
      sqlstm.sqhstv[9] = (         void  *)&d_cn_line_sub_line_code;
      ...
      sqlstm.sqadto[9] = (unsigned short )0;
      sqlstm.sqtdso[9] = (unsigned short )0;
      sqlstm.sqhstv[10] = (         void  *)&d_cn_line_dept_code;
      ...
      sqlstm.sqadto[10] = (unsigned short )0;
      sqlstm.sqtdso[10] = (unsigned short )0;
      sqlstm.sqhstv[11] = (         void  *)&d_cn_line_product_group_code;
      ...
      sqlstm.sqadto[11] = (unsigned short )0;
      sqlstm.sqtdso[11] = (unsigned short )0;
      sqlstm.sqhstv[12] = (         void  *)&d_cn_line_product_line_code;
      ...
      sqlstm.sqadto[12] = (unsigned short )0;
      sqlstm.sqtdso[12] = (unsigned short )0;
      sqlstm.sqhstv[13] = (         void  *)&d_cn_line_amount;
      ...
      sqlstm.sqadto[13] = (unsigned short )0;
      sqlstm.sqtdso[13] = (unsigned short )0;
      sqlstm.sqhstv[14] = (         void  *)&d_cn_line_amount_chk;
      ...
      sqlstm.sqadto[14] = (unsigned short )0;
      sqlstm.sqtdso[14] = (unsigned short )0;
      sqlstm.sqhstv[15] = (         void  *)&d_cn_line_narration;
      ...
      sqlstm.sqadto[15] = (unsigned short )0;
      sqlstm.sqtdso[15] = (unsigned short )0;
      sqlstm.sqhstv[16] = (         void  *)&d_cn_line_rowid;
...
,:b3,:b4,:b5,:b6,:b7)";
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&d_cn_hdr_doc_type_code;
   sqlstm.sqhstl[1] = (unsigned int  )9;
   sqlstm.sqhsts[1] = (         int  )0;
   sqlstm.sqindv[1] = (         void  *)0;
   sqlstm.sqinds[1] = (         int  )0;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&d_cn_hdr_doc_num;
   sqlstm.sqhstl[2] = (unsigned int  )11;
   sqlstm.sqhsts[2] = (         int  )0;
   sqlstm.sqindv[2] = (         void  *)0;
   sqlstm.sqinds[2] = (         int  )0;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "update AR_CN_HDR  set ERROR_FLAG=:b0 where ROWID=:b1";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&d_cn_hdr_rowid;
