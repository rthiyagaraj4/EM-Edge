...
{
    44,
    "d:\\durai\\proc\\facility_corr_proc\\rlrhisst.pc"
};


static unsigned long sqlctx = 1033704437;
...
"select task_code ,count(1) task_count  from rl_sample_task_dtl where ((opera\
ting_facility_id=:b0 and task_ordered_at>=TO_DATE(:b1,'DD/MM/YYYY')) and task_\
ordered_at<(TO_DATE(:b2,'DD/MM/YYYY')+1)) group by task_code order by task_cod\
e            ";
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,103,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,32,129,0,0,0,0,0,1,0,
51,0,0,3,158,0,4,167,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
86,0,0,4,199,0,6,204,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
113,0,0,5,195,0,6,213,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
140,0,0,6,193,0,6,247,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
167,0,0,7,101,0,6,296,0,0,1,1,0,1,0,2,3,0,0,
186,0,0,8,49,0,4,309,0,0,1,0,0,1,0,2,9,0,0,
205,0,0,9,245,0,9,342,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
232,0,0,10,0,0,32,348,0,0,0,0,0,1,0,
247,0,0,9,0,0,13,361,0,0,2,0,0,1,0,2,9,0,0,2,3,0,0,
270,0,0,11,120,0,4,392,0,0,3,1,0,1,0,2,9,0,0,2,3,0,0,1,9,0,0,
297,0,0,9,0,0,15,419,0,0,0,0,0,1,0,
312,0,0,12,110,0,6,438,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
335,0,0,13,136,0,6,448,0,0,2,2,0,1,0,2,9,0,0,1,3,0,0,
};
...
struct { unsigned short len; unsigned char arr[6]; } nd_task_code;

struct { unsigned short len; unsigned char arr[31]; } nd_task_desc;
...
_TO_LOCALE_DATE ( to_date ( :nd_from_date , 'DD/MM/YYYY' ) , :language_id , t_\
date ) ; :nd_from_date1 := to_char ( t_date , 'DD/MM/YYYY' ) ; END ;";
        sqlstm.iters = (unsigned int  )1;
...

{
        ...
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "declare t_date date ; BEGIN GET_LOCALE_DATE . CONVERT\
_TO_LOCALE_DATE ( to_date ( :nd_to_date , 'DD/MM/YYYY' ) , :language_id , t_da\
te ) ; :nd_to_date1 := to_char ( t_date , 'DD/MM/YYYY' ) ; END ;";
        sqlstm.iters = (unsigned int  )1;
...

{
        ...
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "declare t_date date ; BEGIN GET_LOCALE_DATE . CONVERT\
_TO_LOCALE_DATE ( to_date ( :d_sysdate , 'DD/MM/YYYY' ) , :language_id , t_dat\
e ) ; :d_sysdate1 := to_char ( t_date , 'DD/MM/YYYY' ) ; END ;";
        sqlstm.iters = (unsigned int  )1;
        ...
        sqlstm.sqadto[1] = (unsigned short )0;
        sqlstm.sqtdso[1] = (unsigned short )0;
        sqlstm.sqhstv[2] = (         void  *)&d_sysdate1;
        sqlstm.sqhstl[2] = (unsigned int  )19;
        sqlstm.sqhsts[2] = (         int  )0;
        sqlstm.sqindv[2] = (         void  *)0;
        sqlstm.sqinds[2] = (         int  )0;
...

{
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&nd_task_code;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&nd_task_count;
  ...
  while (fetch_task_code())
   {
	 ...
	 /* EXEC SQL SELECT SUBSTR(long_desc,1,30) long_desc,
			    ...
			    INTO :nd_task_desc,
				     :nd_work_unit
			    FROM RL_TASK_MAST
			   WHERE /osection_code = :nd_section_code
			     AND o/task_code    = :nd_task_code; */ 

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select SUBSTR(long_desc,1,30) long_desc ,nvl(work_units,0) \
work_unit into :b0,:b1  from RL_TASK_MAST where task_code=:b2";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&nd_task_desc;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&nd_work_unit;
  sqlstm.sqhstl[1] = (unsigned int  )sizeof(int);
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         void  *)0;
  sqlstm.sqinds[1] = (         int  )0;
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)&nd_task_code;
...
y_id , :language_id , 'RLRHISST.LEGEND_' ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...
LRHISST.LEGEND_' || LTRIM ( RTRIM ( TO_CHAR ( :i , '009' ) ) ) ) ) ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
