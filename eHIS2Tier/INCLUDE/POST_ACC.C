...
{
    27,
    "T:\\TEMP\\Finance\\POST_ACC.PC"
};


static unsigned long sqlctx = 1862144707;
...
struct { unsigned short len; unsigned char arr[16]; } t_dept_desc;

struct { unsigned short len; unsigned char arr[16]; } t_prod_desc;

struct { unsigned short len; unsigned char arr[16]; } t_sleg_desc;

struct { unsigned short len; unsigned char arr[8]; } t_default_dept_code;
...
struct { unsigned short len; unsigned char arr[16]; } t_default_dept_desc;

struct { unsigned short len; unsigned char arr[16]; } t_default_prod_desc;

struct { unsigned short len; unsigned char arr[16]; } t_default_sleg_desc;
 ...
 */ 
/*
 * $Header:   E:/MEDICOM-MASTER/archives/MEDICOM-eHIS5/MEDSRC/AR/POST_ACC.C-arc   1.0   Nov 16 2005 16:13:32   Administrator  $ sqlca.h 
 */
