...
32,0,0,2,135,0,3,83,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
 ...
 sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	if(sqlca.sqlcode == 1403) 
	 { 
		 ...
		 VALUES
		 (:sub_facility_id,:sub_pgm_id,'Y',to_date(:sub_pgm_date,'DDMMYYHH24MI')); */ 
...
ACTIVE_FLAG,START_DATE_TIME) values (:b0,:b1,'Y',to_date(:b2,'DDMMYYHH24MI'))";
   sqlstm.iters = (unsigned int  )1;
