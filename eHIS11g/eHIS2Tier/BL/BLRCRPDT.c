...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/BLRCRPDT.PC"
};


static unsigned int sqlctx = 1288467067;
...
_SRNO) orig_doc_no ,orig_doc_amt ,approval_code ,ref_rcpt_type_code ,to_char(r\
ef_doc_date,'DD/MM/YYYY') ,((ref_doc_type_code||'/')||ref_doc_num) ,ref_slmt_a\
mt ,ref_instrmnt_num ,to_char(ref_instrmnt_date,'DD/MM/YYYY') ,ref_instrmnt_ba\
nk  from bl_credit_card_batch_dtl where ((((operating_facility_id=:b0 and ref_\
rcpt_type_code is  not null ) and cancel_reason_code is null ) and orig_doc_sl\
mt_type_code=nvl(:b1,orig_doc_slmt_type_code)) and trunc(doc_date) between to_\
date(nvl(:b2,'01/01/1401'),'DD/MM/YYYY') and nvl(to_date(:b3,'DD/MM/YYYY'),sys\
date)) order by orig_doc_slmt_type_code,ref_instrmnt_date,doc_date            ";
...
36,0,0,2,123,0,4,144,0,0,6,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
75,0,0,3,84,0,2,164,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
102,0,0,4,0,0,30,191,0,0,0,0,0,1,0,
117,0,0,5,856,0,9,227,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
148,0,0,5,856,0,9,235,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
179,0,0,5,0,0,15,242,0,0,0,0,0,1,0,
194,0,0,5,0,0,13,278,0,0,15,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
269,0,0,6,206,0,4,693,0,0,7,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,
9,0,0,1,9,0,0,
312,0,0,7,99,0,4,723,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
339,0,0,8,156,0,4,741,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
366,0,0,9,96,0,4,809,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
389,0,0,10,162,0,6,816,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
420,0,0,11,199,0,6,859,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[20]; } bl_org_doc_no;
...
struct { unsigned short len; unsigned char arr[3]; } bl_ref_rcpt_type_code;

struct { unsigned short len; unsigned char arr[11]; } bl_ref_doc_date;

struct { unsigned short len; unsigned char arr[16]; } bl_ref_doc_no;

struct { unsigned short len; unsigned char arr[31]; } bl_ref_instr_num;

struct { unsigned short len; unsigned char arr[31]; } old_ref_instr_num;

struct { unsigned short len; unsigned char arr[11]; } bl_ref_instr_date;

struct { unsigned short len; unsigned char arr[11]; } bl_ref_instr_date1;

struct { unsigned short len; unsigned char arr[102]; } bl_ref_instr_bank;
...
declare_cur()
{
    ...
    select  orig_doc_slmt_type_code,
    		...
    		/oorig_doc_type_code||'/'||orig_doc_num orig_doc_no,o/
			orig_doc_amt,
			approval_code,
			ref_rcpt_type_code,
...

{
      ...
      sqlstm.sqhstv[8] = (         void  *)&bl_ref_rcpt_type_code;
      ...
      sqlstm.sqhstv[9] = (         void  *)&bl_ref_doc_date;
      ...
      sqlstm.sqhstv[10] = (         void  *)&bl_ref_doc_no;
      ...
      sqlstm.sqhstv[11] = (         void  *)&bl_ref_slmt_amt;
      ...
      sqlstm.sqhstv[12] = (         void  *)&bl_ref_instr_num;
      ...
      sqlstm.sqhstv[13] = (         void  *)&bl_ref_instr_date;
      ...
      sqlstm.sqhstv[14] = (         void  *)&bl_ref_instr_bank;
      sqlstm.sqhstl[14] = (unsigned int  )104;
...
DTL where (OPERATING_FACILITY_ID=:b1 and ((((DOC_TYPE_CODE||'/')||DOC_NUMBER)|\
|'/')||DOC_SRNO)=:b2)";
    sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRCRPDT.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
