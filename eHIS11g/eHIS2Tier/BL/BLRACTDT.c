...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/BLRACTDT.PC"
};


static unsigned int sqlctx = 1288465979;
...
"folio b ,bl_blng_serv c ,bl_blng_serv_grp d where ((((((((((a.doc_type_code=\
b.bill_doc_type_code and a.doc_num=b.bill_doc_num) and b.blng_serv_code=c.blng\
_serv_code) and c.serv_grp_code=d.serv_grp_code) and NVL(bill_status,'~')<>'C'\
) and a.operating_facility_id=b.operating_facility_id) and TRUNC(a.doc_date) b\
etween to_date(:b0,'dd/mm/yyyy') and to_date(:b9,'dd/mm/yyyy')) and a.operatin\
g_facility_id between :b10 and :b11) and a.cash_counter_code between DECODE(:b\
12,'LOWEST','!!',:b12) and DECODE(:b14,'HIGHEST','~~',:b14)) and b.blng_serv_c\
ode between DECODE(:b16,'LOWEST','!!',:b16) and DECODE(:b18,'HIGHEST','~~',:b1\
8)) and a.blng_grp_id between DECODE(:b20,'LOWEST','!!',:b20) and DECODE(:b22,\
'HIGHEST','~~',:b22)) order by 1,2,3,4 )  group by facility_id,cash_cntr_code,\
blng_serv_desc           ";

 static const char *sq0009 = 
":b23,'HIGHEST','~~',:b23)) order by 1,2,3,4 )  group by facility_id,cash_cnt\
r_code,blng_serv_desc           ";
...
43,0,0,0,0,0,27,167,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
...

{
 ...
 sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='BLRACTDT' and SE\
...
:b19,:b20,:b21,:b22,:b23  from SY_PROG_PARAM where ((PGM_ID='BLRACTDT' and SES\
SION_ID=:b24) and PGM_DATE=:b25)";
    sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRACTDT.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
...
CALE_DATE ( to_date ( :nd_temp_date1 , 'MM/RRRR' ) , :p_language_id , t_date1 \
) ; :nd_loc_date1 := to_char ( t_date1 , 'MM/RRRR' ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
