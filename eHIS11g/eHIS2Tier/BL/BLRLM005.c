...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/BLRLM005.pc"
};


static unsigned int sqlctx = 1288466307;
...
"select A.PATIENT_ID ,TO_CHAR(A.REGN_DATE,'DD/MM/YYYY') ,decode(:b0,'en',subs\
tr(A.short_name,1,60),substr(A.SHORT_NAME_LOC_LANG,1,60)) ,A.SEX ,TO_CHAR(A.DA\
TE_OF_BIRTH,'DD/MM/YYYY') ,TO_CHAR(B.CLASSIFICATION_START_DATE,'DD/MM/YYYY') ,\
TO_CHAR(B.CLASSIFICATION_END_DATE,'DD/MM/YYYY')  from MP_PATIENT_MAST A ,BL_PA\
TIENT_FIN_DTLS B ,BL_CLASSFCTN_CODE C where (((((A.PATIENT_ID=B.PATIENT_ID and\
 B.CLASSIFICATION_CODE=C.CLASSIFICATION_CODE) and C.OPERATING_FACILITY_ID=:b1)\
 and C.CLASSIFICATION_TYPE='PV') and A.PATIENT_ID between :b2 and :b3) and TRU\
NC(A.REGN_DATE) between TO_DATE(NVL(:b4,'01/01/1800'),'DD/MM/YYYY') and TO_DAT\
E(NVL(:b5,'01/01/3000'),'DD/MM/YYYY')) order by 2,1            ";
...
{12,4274,178,0,0,
5,0,0,1,0,0,30,184,0,0,0,0,0,1,0,
20,0,0,2,167,0,4,204,0,0,8,4,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,
67,0,0,3,116,0,2,238,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
98,0,0,4,685,0,9,277,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
137,0,0,4,0,0,15,286,0,0,0,0,0,1,0,
152,0,0,4,0,0,13,319,0,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,
195,0,0,5,158,0,4,481,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
230,0,0,0,0,0,27,560,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
261,0,0,7,132,0,4,592,0,0,3,2,0,1,0,1,9,0,0,2,9,0,0,1,9,0,0,
288,0,0,8,96,0,4,688,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
311,0,0,9,165,0,6,695,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
342,0,0,10,207,0,6,717,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[61]; } nd_from_patient_id;

struct { unsigned short len; unsigned char arr[61]; } nd_to_patient_id;

struct { unsigned short len; unsigned char arr[11]; } nd_regn_from_date;

struct { unsigned short len; unsigned char arr[11]; } nd_regn_to_date;

struct { unsigned short len; unsigned char arr[11]; } nd_adm_date;

struct { unsigned short len; unsigned char arr[1]; } nd_sex;

struct { unsigned short len; unsigned char arr[11]; } nd_dob;
...

{
  ...
  from SY_PROG_PARAM where (((OPERATING_FACILITY_ID=:b4 and PGM_ID=:b5) and SE\
SSION_ID=:b6) and PGM_DATE=:b7)";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqhstv[2] = (         void  *)&nd_regn_from_date;
   ...
   sqlstm.sqhstv[3] = (         void  *)&nd_regn_to_date;
...

{
    ...
    sqlstm.sqadto[3] = (unsigned short )0;
    sqlstm.sqtdso[3] = (unsigned short )0;
    sqlstm.sqhstv[4] = (         void  *)&nd_regn_from_date;
    ...
    sqlstm.sqadto[4] = (unsigned short )0;
    sqlstm.sqtdso[4] = (unsigned short )0;
    sqlstm.sqhstv[5] = (         void  *)&nd_regn_to_date;
...

{
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (         void  *)&nd_patient_name;
    sqlstm.sqhstl[2] = (unsigned int  )63;
    sqlstm.sqhsts[2] = (         int  )0;
    sqlstm.sqindv[2] = (         void  *)0;
    sqlstm.sqinds[2] = (         int  )0;
    ...
    sqlstm.sqadto[4] = (unsigned short )0;
    sqlstm.sqtdso[4] = (unsigned short )0;
    sqlstm.sqhstv[5] = (         void  *)&nd_start_date;
    sqlstm.sqhstl[5] = (unsigned int  )13;
    sqlstm.sqhsts[5] = (         int  )0;
    sqlstm.sqindv[5] = (         void  *)0;
    sqlstm.sqinds[5] = (         int  )0;
    ...
    sqlstm.sqadto[5] = (unsigned short )0;
    sqlstm.sqtdso[5] = (unsigned short )0;
    sqlstm.sqhstv[6] = (         void  *)&nd_end_date;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "select ACC_ENTITY_NAME ,TO_CHAR(SYSDATE,'DD/MM/YYYY HH2\
4:MI') ,USER into :b0,:b1,:b2  from SY_ACC_ENTITY_LANG_VW where (ACC_ENTITY_ID\
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select LTRIM(RTRIM(('BLRLM005.LEGEND_'||LTRIM(RTRIM(TO_CHAR(\
