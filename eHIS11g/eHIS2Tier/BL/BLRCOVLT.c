...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/BLRCOVLT.PC"
};


static unsigned int sqlctx = 1288467195;
...
"M/YYYY'))) and DOC_REF_NUM between nvl(:b3,'!!!!!!!!!!!!!!!!!!!!') and nvl(:\
b4,'~~~~~~~~~~~~~~~~~~~~')) and nvl(FINALIZED_YN,'N')=Decode(:b5,'BLTCVFNL','N\
','Y')) and nvl(CANCELLED_YN,'N')<>'Y')           ";

 static const char *sq0021 = 
"select RMRK_SRNO ,REMARKS_TEXT  from BL_COVERING_LET_HEADER_RMRKS where ((OP\
ERATING_FACILITY_ID=:b0 and DOC_REF_NUM=:b1) and action_type='P')           ";

 static const char *sq0023 = 
"select B.PATIENT_ID ,DECODE(:b0,'en',SUBSTR(M.SHORT_NAME,1,30),SUBSTR(M.SHOR\
T_NAME_LOC_LANG,1,30)) ,B.DOC_TYPE_CODE ,B.DOC_NUMBER ,((B.DOC_TYPE_CODE||'/')\
||TO_CHAR(B.DOC_NUMBER)) ,to_char(B.DOC_DATE,'DD/MM/YYYY') ,B.BILL_AMT ,B.DOC_\
OUTST_AMT ,((B.POLICY_TYPE_CODE||'/')||B.POLICY_NUMBER) ,B.POLICY_TYPE_CODE ,B\
.POLICY_NUMBER ,substr(B.PRINT_TEXT,1,45)  from BL_COVERING_LET_DETAIL B ,MP_P\
ATIENT_MAST M where (((B.OPERATING_FACILITY_ID=:b1 and B.PATIENT_ID=M.PATIENT_\
ID) and DOC_REF_NUM=:b2) and NVL(CANCELLED_YN,'N')<>'Y') order by decode(:b3,'\
P',SUBSTR(M.SHORT_NAME,1,30),'D',to_char(B.DOC_DATE,'DD/MM/YYYY'),B.PATIENT_ID\
...
{12,4274,178,0,0,
5,0,0,0,0,0,27,224,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,30,282,0,0,0,0,0,1,0,
51,0,0,3,93,0,4,292,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
78,0,0,4,249,0,4,322,0,0,12,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
141,0,0,5,84,0,2,363,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
168,0,0,6,88,0,4,371,0,0,1,0,0,1,0,2,3,0,0,
187,0,0,7,226,0,4,399,0,0,8,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,
9,0,0,1,9,0,0,1,9,0,0,
234,0,0,8,1228,0,9,490,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
273,0,0,8,0,0,15,497,0,0,0,0,0,1,0,
288,0,0,8,0,0,13,611,0,0,44,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
479,0,0,9,96,0,4,766,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
506,0,0,10,185,0,4,787,0,0,5,3,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
541,0,0,11,189,0,4,793,0,0,5,4,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
576,0,0,12,188,0,4,803,0,0,4,2,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
607,0,0,13,192,0,4,810,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
638,0,0,14,135,0,4,822,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
673,0,0,15,120,0,4,846,0,0,4,2,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
704,0,0,16,160,0,4,859,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
735,0,0,17,93,0,4,868,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
762,0,0,18,303,0,4,1227,0,0,11,10,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
821,0,0,19,269,0,4,1236,0,0,7,6,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,
864,0,0,20,49,0,4,1711,0,0,1,0,0,1,0,2,3,0,0,
883,0,0,22,135,0,4,1737,0,0,3,2,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,
910,0,0,21,152,0,9,1749,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
933,0,0,21,0,0,15,1756,0,0,0,0,0,1,0,
948,0,0,21,0,0,13,1770,0,0,2,0,0,1,0,2,3,0,0,2,9,0,0,
971,0,0,23,697,0,9,1882,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1002,0,0,23,0,0,15,1889,0,0,0,0,0,1,0,
1017,0,0,24,132,0,4,1899,0,0,3,2,0,1,0,1,9,0,0,2,9,0,0,1,9,0,0,
1044,0,0,23,0,0,13,2005,0,0,12,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
2,9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1107,0,0,25,96,0,4,2261,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
1130,0,0,26,163,0,6,2268,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
1161,0,0,27,46,0,4,2387,0,0,4,3,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,3,0,0,
1192,0,0,28,47,0,4,2411,0,0,4,3,0,1,0,1,9,0,0,1,3,0,0,1,3,0,0,2,9,0,0,
1223,0,0,29,47,0,4,2583,0,0,3,2,0,1,0,1,9,0,0,1,3,0,0,2,3,0,0,
1250,0,0,30,47,0,4,2601,0,0,3,2,0,1,0,1,9,0,0,1,3,0,0,2,3,0,0,
1277,0,0,31,47,0,4,2619,0,0,3,2,0,1,0,1,9,0,0,1,3,0,0,2,3,0,0,
1304,0,0,32,47,0,4,2636,0,0,3,2,0,1,0,1,9,0,0,1,3,0,0,2,3,0,0,
1331,0,0,33,47,0,4,2653,0,0,3,2,0,1,0,1,9,0,0,1,3,0,0,2,3,0,0,
1358,0,0,34,46,0,4,2670,0,0,3,2,0,1,0,1,9,0,0,1,3,0,0,2,3,0,0,
1385,0,0,35,47,0,4,2687,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1408,0,0,36,658,0,6,2711,0,0,3,3,0,1,0,1,9,0,0,2,9,0,0,1,9,0,0,
1435,0,0,37,204,0,6,2895,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
1462,0,0,38,197,0,6,2919,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[5]; } d_country_code;

struct { unsigned short len; unsigned char arr[41]; } d_country;
...
struct { unsigned short len; unsigned char arr[101]; } d_cust_pat;

struct { unsigned short len; unsigned char arr[61]; } d_cust_pat_title;
...
struct { unsigned short len; unsigned char arr[61]; } d_contact_name_title;

struct { unsigned short len; unsigned char arr[41]; } d_comp_name;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select report_desc into :b0  from sm_report_lang_vw where (r\
eport_id=:b1 and language_id=:b2)";
 sqlstm.iters = (unsigned int  )1;
...
param6,'Z') ,Nvl(param7,'Y') ,nvl(param8,'N') ,nvl(param9,'BLRCOVLT') into :b0\
,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8  from sy_prog_param where ((pgm_id=:b9 and se\
ssion_id=:b10) and pgm_date=:b11)";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqhstv[6] = (         void  *)&p_print_opt;
 ...
 sqlstm.sqhstv[7] = (         void  *)&p_sort_order;
 ...
 sqlstm.sqhstv[8] = (         void  *)&p_calling_pgm_id;
 ...
 sqlstm.sqhstv[10] = (         void  *)&lv_session_id;
 ...
 sqlstm.sqhstv[11] = (         void  *)&lv_pgm_date;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select decode(outstd_doc_in_annex_only_yn,'Y',0,5) into :b0 \
 from bl_covering_let_param ";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqlety = (unsigned short)4352;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (         void  *)&no_of_docs_in_cl;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select acc_entity_name ,BASE_CURRENCY ,BASE_CURRENCY_DEC ,Nv\
l(NO_OF_DECIMAL,2) ,USER ,TO_CHAR(SYSDATE,'DD/MM/YYYY HH24:MI') into :b0,:b1,:\
b2,:b3,:b4,:b5  from sy_acc_entity_lang_vw where (acc_entity_id=:b6 and LANGUA\
GE_ID=:b7)";
 sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqltdsp = &sqltds;
  sqlbuft((void **)0, 
    "select TO_CHAR(DOC_REF_DATE,'dd/mm/yyyy') ,DOC_REF_NUM ,GROUP_CODE ,CUS\
T_CODE ,CONTACT_NAME ,CONTACT_NAME_TITLE ,MAIL_ADDR_LINE_1 ,MAIL_ADDR_LINE_2\
 ,MAIL_ADDR_LINE_3 ,MAIL_ADDR_LINE_4 ,POSTAL_CODE ,POST_BOX ,COUNTRY_CODE ,T\
EL_NUM ,FAX_NUM ,EMAIL_ID ,TOT_OUTST_AMT ,LET_BODY_HEADER_LN01 ,LET_BODY_HEA\
DER_LN02 ,LET_BODY_HEADER_LN03 ,LET_BODY_HEADER_LN04 ,LET_BODY_HEADER_LN05 ,\
LET_BODY_FOOTER_LN01 ,LET_BODY_FOOTER_LN02 ,LET_BODY_FOOTER_LN03 ,LET_BODY_F\
OOTER_LN04 ,LET_BODY_FOOTER_LN05 ,LET_FOOT_NOTE_LN01 ,LET_FOOT_NOTE_LN02 ,LE\
T_FOOT_NOTE_LN03 ,LET_FOOT_NOTE_LN04 ,LET_FOOT_NOTE_LN05 ,FOREIGN_CURRENCY_Y\
N ,FOREIGN_CURRENCY_DESC ,FOREIGN_SUBCURRENCY_DESC ,FOREIGN_CURRENCY_NOTE ,A\
UTHORIZED_SIGNATORY ,AUTHORIZED_SIGNATORY_DESG ,PRINT_TEXT_YN ,CANCELLED_YN \
,FINALIZED_YN ,PRINTED_YN ,nvl(PRINT_COUNT,0) ,Nvl(PRINT_INS_POLICY_YN,'Y') \
 from BL_COVERING_LET_HEADER where ((((OPERATING_FACILITY_ID=:b0 and TRUNC(D\
OC_REF_DATE) between trunc(to_date(NVL(:b1,'01/01/1000'),'DD/MM/YYYY')) and \
trunc(to_date(NVL(:b2,'31/12/4000'),'DD/M");
  sqlstm.stmt = sq0008;
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[4] = (unsigned short )0;
  sqlstm.sqtdso[4] = (unsigned short )0;
  sqlstm.sqhstv[5] = (         void  *)&p_calling_pgm_id;
...

{
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (         void  *)&d_group_code;
    sqlstm.sqhstl[2] = (unsigned int  )9;
    sqlstm.sqhsts[2] = (         int  )0;
    sqlstm.sqindv[2] = (         void  *)0;
    sqlstm.sqinds[2] = (         int  )0;
    ...
    sqlstm.sqadto[3] = (unsigned short )0;
    sqlstm.sqtdso[3] = (unsigned short )0;
    sqlstm.sqhstv[4] = (         void  *)&d_contact_name;
    ...
    sqlstm.sqadto[4] = (unsigned short )0;
    sqlstm.sqtdso[4] = (unsigned short )0;
    sqlstm.sqhstv[5] = (         void  *)&d_contact_name_title;
    ...
    sqlstm.sqadto[5] = (unsigned short )0;
    sqlstm.sqtdso[5] = (unsigned short )0;
    sqlstm.sqhstv[6] = (         void  *)&d_mail_addr1;
    ...
    sqlstm.sqadto[6] = (unsigned short )0;
    sqlstm.sqtdso[6] = (unsigned short )0;
    sqlstm.sqhstv[7] = (         void  *)&d_mail_addr2;
    ...
    sqlstm.sqadto[7] = (unsigned short )0;
    sqlstm.sqtdso[7] = (unsigned short )0;
    sqlstm.sqhstv[8] = (         void  *)&d_mail_addr3;
    ...
    sqlstm.sqadto[8] = (unsigned short )0;
    sqlstm.sqtdso[8] = (unsigned short )0;
    sqlstm.sqhstv[9] = (         void  *)&d_mail_addr4;
    ...
    sqlstm.sqadto[9] = (unsigned short )0;
    sqlstm.sqtdso[9] = (unsigned short )0;
    sqlstm.sqhstv[10] = (         void  *)&d_postal_code;
    ...
    sqlstm.sqadto[10] = (unsigned short )0;
    sqlstm.sqtdso[10] = (unsigned short )0;
    sqlstm.sqhstv[11] = (         void  *)&d_post_box;
    ...
    sqlstm.sqadto[11] = (unsigned short )0;
    sqlstm.sqtdso[11] = (unsigned short )0;
    sqlstm.sqhstv[12] = (         void  *)&d_country_code;
    ...
    sqlstm.sqhstv[13] = (         void  *)&d_tel_num;
    ...
    sqlstm.sqhstv[14] = (         void  *)&d_fax_num;
    ...
    sqlstm.sqhstv[15] = (         void  *)&d_email_id;
    ...
    sqlstm.sqhstv[16] = (         void  *)&d_tot_outst_amt;
    ...
    sqlstm.sqhstv[17] = (         void  *)&d_let_bd_hd_ln01;
    ...
    sqlstm.sqhstv[18] = (         void  *)&d_let_bd_hd_ln02;
    ...
    sqlstm.sqhstv[19] = (         void  *)&d_let_body_header_ln03;
    ...
    sqlstm.sqhstv[20] = (         void  *)&d_let_body_header_ln04;
    ...
    sqlstm.sqhstv[21] = (         void  *)&d_let_bd_hd_ln05;
    ...
    sqlstm.sqhstv[22] = (         void  *)&d_let_body_footer_ln01;
    ...
    sqlstm.sqhstv[23] = (         void  *)&d_let_body_footer_ln02;
    ...
    sqlstm.sqhstv[24] = (         void  *)&d_let_body_footer_ln03;
    ...
    sqlstm.sqhstv[25] = (         void  *)&d_let_body_footer_ln04;
    ...
    sqlstm.sqhstv[26] = (         void  *)&d_let_body_footer_ln05;
    ...
    sqlstm.sqhstv[27] = (         void  *)&d_let_foot_note_ln01;
    ...
    sqlstm.sqhstv[28] = (         void  *)&d_let_foot_note_ln02;
    ...
    sqlstm.sqhstv[29] = (         void  *)&d_let_foot_note_ln03;
    ...
    sqlstm.sqhstv[30] = (         void  *)&d_let_foot_note_ln04;
    ...
    sqlstm.sqhstv[31] = (         void  *)&d_let_foot_note_ln05;
    ...
    sqlstm.sqhstv[32] = (         void  *)&d_foreign_currency_yn;
    ...
    sqlstm.sqhstv[33] = (         void  *)&d_foreign_currency_desc;
    sqlstm.sqhstl[33] = (unsigned int  )18;
    ...
    sqlstm.sqhstv[34] = (         void  *)&d_foreign_sub_currency;
    ...
    sqlstm.sqhstv[35] = (         void  *)&d_foreign_currency_note;
    sqlstm.sqhstl[35] = (unsigned int  )303;
    ...
    sqlstm.sqhstv[36] = (         void  *)&d_authorized_signatory;
    ...
    sqlstm.sqhstv[37] = (         void  *)&d_authorized_signatory_desg;
    ...
    sqlstm.sqhstv[38] = (         void  *)&d_print_text_yn;
    ...
    sqlstm.sqhstv[39] = (         void  *)&d_cancelled_yn;
    ...
    sqlstm.sqhstv[40] = (         void  *)&d_finalized_yn;
    ...
    sqlstm.sqhstv[41] = (         void  *)&d_printed_yn;
    ...
    sqlstm.sqhstv[42] = (         void  *)&d_print_count;
    ...
    sqlstm.sqhstv[43] = (         void  *)&d_print_ins_yn;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select CONTACT_NAME ,CONTACT_NAME_TITLE into :b0,:b1  fro\
m BL_COVERING_LET_GROUP where ((OPERATING_FACILITY_ID=:b2 and nvl(CUST_CODE,'X\
XXXXXXX')=nvl(:b3,'XXXXXXXX')) and GROUP_CODE=:b4)";
    sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select GROUP_DESC into :b0  from BL_COVERING_LET_GROUP_LANG_\
VW where (((OPERATING_FACILITY_ID=:b1 and nvl(CUST_CODE,'XXXXXXXX')=nvl(:b2,'X\
XXXXXXX')) and GROUP_CODE=:b3) and LANGUAGE_ID=:b4)";
 sqlstm.iters = (unsigned int  )1;
...

{
          ...
          sqlstm.sqladtp = &sqladt;
          sqlstm.sqltdsp = &sqltds;
          sqlstm.stmt = "select CONTACT_NAME ,CONTACT_NAME_TITLE ,LONG_NAME \
into :b0,:b1,:b2  from AR_CUSTOMER_LANG_VW where (CUST_CODE=:b3 and LANGUAGE_I\
D=:b4)";
          sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select GROUP_DESC into :b0  from BL_COVERING_LET_GROUP_LANG\
_VW where (((OPERATING_FACILITY_ID=:b1 and CUST_CODE=:b2) and GROUP_CODE='*ALL\
') and LANGUAGE_ID=:b3)";
  sqlstm.iters = (unsigned int  )1;
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select LONG_NAME into :b0  from AR_CUSTOMER_LANG_VW w\
here (CUST_CODE=:b1 and LANGUAGE_ID=:b2)";
        sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select count(rowid) into :b0  from BL_COVERING_LET_DETAIL w\
here (((OPERATING_FACILITY_ID=:b1 and DOC_REF_NUM=:b2) and (:b3='N' or (:b3='Y\
' and print_text is null ))) and (((:b5='N' or (:b5='Y' and POLICY_NUMBER is n\
ull )) or (:b5='Z' and :b8='N')) or ((:b5='Z' and :b8='Y') and POLICY_NUMBER i\
s null )))";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[7] = (unsigned short )0;
  sqlstm.sqtdso[7] = (unsigned short )0;
  sqlstm.sqhstv[8] = (         void  *)&d_print_ins_yn;
  ...
  sqlstm.sqadto[9] = (unsigned short )0;
  sqlstm.sqtdso[9] = (unsigned short )0;
  sqlstm.sqhstv[10] = (         void  *)&d_print_ins_yn;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select (count(rowid)* 2) into :b0  from BL_COVERING_LET_DET\
AIL where ((OPERATING_FACILITY_ID=:b1 and DOC_REF_NUM=:b2) and (((:b3='Y' and \
print_text is  not null ) or (:b4='Y' and POLICY_NUMBER is  not null )) or ((:\
b4='Z' and :b6='Y') and POLICY_NUMBER is  not null )))";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[5] = (unsigned short )0;
  sqlstm.sqtdso[5] = (unsigned short )0;
  sqlstm.sqhstv[6] = (         void  *)&d_print_ins_yn;
  sqlstm.sqhstl[6] = (unsigned int  )4;
  sqlstm.sqhsts[6] = (         int  )0;
  sqlstm.sqindv[6] = (         void  *)0;
  sqlstm.sqinds[6] = (         int  )0;
...

{
   ...
   sqlstm.sqadto[2] = (unsigned short )0;
   sqlstm.sqtdso[2] = (unsigned short )0;
   sqlstm.sqhstv[3] = (         void  *)&p_sort_order;
   sqlstm.sqhstl[3] = (unsigned int  )4;
   sqlstm.sqhsts[3] = (         int  )0;
   sqlstm.sqindv[3] = (         void  *)0;
   sqlstm.sqinds[3] = (         int  )0;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select decode(:b0,'en',substr(short_name,1,30),substr(short_\
name_loc_lang,1,30)) into :b1  from MP_Patient_Mast where patient_id=:b2";
 sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)&d_doc_type;
  sqlstm.sqhstl[2] = (unsigned int  )9;
  sqlstm.sqhsts[2] = (         int  )0;
  sqlstm.sqindv[2] = (         void  *)0;
  sqlstm.sqinds[2] = (         int  )0;
  ...
  sqlstm.sqadto[6] = (unsigned short )0;
  sqlstm.sqtdso[6] = (unsigned short )0;
  sqlstm.sqhstv[7] = (         void  *)&d_outst_amt;
  ...
  sqlstm.sqadto[7] = (unsigned short )0;
  sqlstm.sqtdso[7] = (unsigned short )0;
  sqlstm.sqhstv[8] = (         void  *)&d_policy_type;
  ...
  sqlstm.sqadto[8] = (unsigned short )0;
  sqlstm.sqtdso[8] = (unsigned short )0;
  sqlstm.sqhstv[9] = (         void  *)&d_policy_code;
  ...
  sqlstm.sqadto[9] = (unsigned short )0;
  sqlstm.sqtdso[9] = (unsigned short )0;
  sqlstm.sqhstv[10] = (         void  *)&d_policy_num;
  ...
  sqlstm.sqadto[10] = (unsigned short )0;
  sqlstm.sqtdso[10] = (unsigned short )0;
  sqlstm.sqhstv[11] = (         void  *)&d_print_text;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRCOVLT.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
...
sqlstm.sqladtp = &sqladt;
sqlstm.sqltdsp = &sqltds;
sqlstm.stmt = "declare k number := 0 ; c1 number := 0 ; begin if substr ( :p\
_org_str , -length ( '\\n' ) ) = '\\n' then loop if instr ( :p_org_str , '\\n'\
 , 1 , c1 + 1 ) > 0 then c1 := c1 + 1 ; k := instr ( :p_org_str , '\\n' , 1 , \
c1 ) ; else exit ; end if ; end loop ; if nvl ( k , 0 ) = 0 then return ; end \
if ; loop if c1 > 1 and instr ( :p_org_str , '\\n' , 1 , c1 -1 ) = k -length (\
 '\\n' ) then k := instr ( :p_org_str , '\\n' , 1 , c1 -1 ) ; c1 := c1 -1 ; if\
 c1 <= 1 then exit ; end if ; else exit ; end if ; end loop ; :p_ret_str := su\
bstr ( :p_org_str , 1 , k -1 ) || :p_add_str || substr ( :p_org_str , k ) ; el\
se :p_ret_str := :p_org_str || :p_add_str ; end if ; end ;";
sqlstm.iters = (unsigned int  )1;
...
; :nd_loc_date := to_char ( t_date , 'ddth fmMonth YYYY' ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
