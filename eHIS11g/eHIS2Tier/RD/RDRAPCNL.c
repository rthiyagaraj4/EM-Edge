...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/RD/RDRAPCNL.PC"
};


static unsigned int sqlctx = 1288576955;
...
"select TO_CHAR(A.APPT_DATE,'DD/MM/YYYY') ,A.SECTION_CODE ,A.CLINIC_CODE ,A.E\
XAM_CODE ,A.REQ_PHYS_ID ,TO_CHAR(TO_DATE((TO_NUMBER(TO_CHAR(A.APPT_END_TIME,'S\
SSSS'))-TO_NUMBER(TO_CHAR(A.APPT_START_TIME,'SSSSS'))),'SSSSS'),'HH24:MI') ,TO\
_CHAR(A.APPT_START_TIME,'HH24:MI') ,TO_CHAR(A.APPT_END_TIME,'HH24:MI') ,A.APPT\
_REF_NUM ,A.PATIENT_ID ,A.RES_TELEPHONE_NUM ,A.OTHER_CONTACT_NUM ,SUBSTR(A.SHO\
RT_NAME_LOC_LANG,1,16) ,A.SHORT_NAME  from RD_APPT_DEL_TR A ,RD_CLINIC B where\
 (((((((((A.OPERATING_FACILITY_ID=B.OPERATING_FACILITY_ID and A.SECTION_CODE=B\
.SECTION_CODE) and A.CLINIC_CODE=B.CLINIC_CODE) and A.OPERATING_FACILITY_ID=:b\
0) and TRUNC(A.APPT_DATE) between TO_DATE(:b1,'DD/MM/YYYY') and TO_DATE(:b2,'D\
D/MM/YYYY')) and A.SECTION_CODE=:b3) and B.WING_CODE=:b4) and A.CLINIC_CODE be\
tween :b5 and :b6) and RTRIM(TO_CHAR(A.APPT_DATE,'DAY'))=RTRIM(:b7)) and APPT_\
STATUS=:b8) order by TRUNC(A.APPT_DATE),A.CLINIC_CODE,A.REQ_PHYS_ID,TO_CHAR(A.\
APPT_START_TIME,'HH24:MI'),A.APPT_REF_NUM            ";
...
{12,4274,178,0,0,
5,0,0,0,0,0,27,187,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,30,232,0,0,0,0,0,1,0,
51,0,0,3,221,0,4,272,0,0,10,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
106,0,0,4,134,0,2,318,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
133,0,0,5,165,0,4,354,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
168,0,0,6,1026,0,9,438,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
211,0,0,7,1027,0,9,503,0,0,8,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,
258,0,0,8,987,0,9,558,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
309,0,0,6,0,0,13,695,0,0,19,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
400,0,0,7,0,0,13,728,0,0,19,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
491,0,0,8,0,0,13,761,0,0,14,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
562,0,0,9,82,0,4,808,0,0,2,1,0,1,0,1,9,0,0,2,4,0,0,
585,0,0,10,63,0,4,834,0,0,2,1,0,1,0,1,9,0,0,2,4,0,0,
608,0,0,11,95,0,4,892,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
635,0,0,12,88,0,4,911,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
662,0,0,13,208,0,4,934,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
693,0,0,14,97,0,4,953,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
720,0,0,15,125,0,4,971,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
751,0,0,16,122,0,4,991,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
782,0,0,17,322,0,6,1290,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,3,3,0,0,2,9,0,0,
813,0,0,18,112,0,6,1327,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
836,0,0,19,136,0,6,1340,0,0,2,2,0,1,0,2,9,0,0,1,3,0,0,
};
...
#define REP_TITLE "LIST OF CANCELLED APPOINTMENTS"
#define VER  "VER : 10.2\n"
#define ESC     0x1B
...
/* VARCHAR nd_facility_id		   [3],  
        ...
        h_acc_entity_name      [301], /oLength changed from 61 to 301 for internationalisationo/	
		h_user                 [31],	
		h_sysdate              [17],
        ...
        h_physician_name       [31],   /o Desc for the Code access o/
		...
		h_exam_desc            [121], /o Length changed from 41 to 121 for internationalisationo/
		...
		h_bed_num              [9],
		h_ref_source_code      [5],
		h_ref_source_desc      [301],  /oLength changed from 31 to 301 for internationalisationo/
...
struct { unsigned short len; unsigned char arr[31]; } h_physician_name;
...
char *argv[];
{
	...
	/*  printf ( "RDRAPCNL : Program Started.\n\n" );     */
...

{
	...
	fprintf(f1,"%c&a5L",ESC);/*for landscape printing  */
	...
	if (strcmp(nd_sel_opt.arr,"S") == 0)
		dclr_canl_cur();

	if (strcmp(nd_sel_opt.arr,"D") == 0)
		dclr_del_cur();
...
PARAM7 into :b0,:b1,:b2,:b3,:b4,:b5,:b6  from SY_PROG_PARAM where (((OPERATING\
_FACILITY_ID=:b7 and PGM_ID='RDRAPCNL') and SESSION_ID=TO_NUMBER(:b8)) and PGM\
_DATE=:b9)";
      sqlstm.iters = (unsigned int  )1;
...
_ID=:b0 and PGM_ID='RDRAPCNL') and SESSION_ID=TO_NUMBER(:b1)) and PGM_DATE=:b2\
)";
      sqlstm.iters = (unsigned int  )1;
...
/*-------------- Check for any error and No data found ----------------------*/
     ...
     if (OERROR) 
       {
          disp_message (ERR_MESG, "Declaration failed on APPT_CUR\n" );
          proc_exit();
       }
...
UM ,SUBSTR(A.SHORT_NAME_LOC_LANG,1,16) ,A.SHORT_NAME ,A.SEX ,TO_CHAR(A.DATE_\
OF_BIRTH,'DD/MM/YYYY') ,A.WARD_CODE ,A.BED_NUM ,A.REF_SOURCE_CODE  from RD_A\
PPT_DEL_TR A ,RD_CLINIC B where ((((((((A.OPERATING_FACILITY_ID=B.OPERATING_\
FACILITY_ID and A.SECTION_CODE=B.SECTION_CODE) and A.CLINIC_CODE=B.CLINIC_CO\
DE) and A.OPERATING_FACILITY_ID=:b0) and A.SECTION_CODE=:b1) and B.WING_CODE\
=:b2) and TRUNC(A.APPT_DATE) between TO_DATE(:b3,'DD/MM/YYYY') and TO_DATE(:\
b4,'DD/MM/YYYY')) and A.CLINIC_CODE between :b5 and :b6) and A.APPT_STATUS i\
n ('C','D','S')) order by TRUNC(A.APPT_DATE),A.SECTION_CODE,A.CLINIC_CODE,TO\
_CHAR(A.APPT_START_TIME,'HH24:MI");
     ...
     sqlstm.sqadto[2] = (unsigned short )0;
     sqlstm.sqtdso[2] = (unsigned short )0;
     sqlstm.sqhstv[3] = (         void  *)&nd_fr_appt_date;
     ...
     sqlstm.sqadto[3] = (unsigned short )0;
     sqlstm.sqtdso[3] = (unsigned short )0;
     sqlstm.sqhstv[4] = (         void  *)&nd_to_appt_date;
     sqlstm.sqhstl[4] = (unsigned int  )13;
     sqlstm.sqhsts[4] = (         int  )0;
     sqlstm.sqindv[4] = (         void  *)0;
     sqlstm.sqinds[4] = (         int  )0;
...
void dclr_canl_cur()
  {
     /* EXEC SQL DECLARE  CANL_CUR CURSOR FOR
              SELECT TO_CHAR(A.APPT_DATE,'DD/MM/YYYY'),
				     A.SECTION_CODE,
		             A.CLINIC_CODE,
                     A.EXAM_CODE,
			  ...
			  AND    B.WING_CODE    = :nd_wing_code
			  AND    A.CLINIC_CODE BETWEEN :nd_fr_clinic_code AND :nd_to_clinic_code
			  AND    A.APPT_STATUS = :nd_sel_opt
              ORDER BY TRUNC(A.APPT_DATE), A.CLINIC_CODE,
		             A.REQ_PHYS_ID, TO_CHAR(A.APPT_START_TIME, 'HH24:MI'), A.APPT_REF_NUM; */ 
...
/*-------------- Check for any error and No data found ----------------------*/
     ...
     if (OERROR) 
       {
          disp_message (ERR_MESG, "Declaration failed on CANL_CUR\n" );
          proc_exit();
       }

/*------------------------- End of Error Check -------------------------------*/

     /* EXEC SQL OPEN CANL_CUR; */ 
...
PPT_DEL_TR A ,RD_CLINIC B where ((((((((A.OPERATING_FACILITY_ID=B.OPERATING_\
FACILITY_ID and A.SECTION_CODE=B.SECTION_CODE) and A.CLINIC_CODE=B.CLINIC_CO\
DE) and A.OPERATING_FACILITY_ID=:b0) and TRUNC(A.APPT_DATE) between TO_DATE(\
:b1,'DD/MM/YYYY') and TO_DATE(:b2,'DD/MM/YYYY')) and A.SECTION_CODE=:b3) and\
 B.WING_CODE=:b4) and A.CLINIC_CODE between :b5 and :b6) and A.APPT_STATUS=:\
b7) order by TRUNC(A.APPT_DATE),A.CLINIC_CODE,A.REQ_PHYS_ID,TO_CHAR(A.APPT_S\
TART_TIME,'HH24:MI'),A.APPT_REF_");
     sqlstm.stmt = sq0007;
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqadto[6] = (unsigned short )0;
     sqlstm.sqtdso[6] = (unsigned short )0;
     sqlstm.sqhstv[7] = (         void  *)&nd_sel_opt;
...
/*-------------- Check for any error and No data found ----------------------*/
     ...
     if (OERROR)
       {
          disp_message (ERR_MESG, "OPEN failed on CANL_CUR\n" );
          proc_exit();
       }
...
void dclr_del_cur()
  {
     /* EXEC SQL DECLARE  DEL_CUR CURSOR FOR
			SELECT TO_CHAR(A.APPT_DATE,'DD/MM/YYYY'),
				   A.SECTION_CODE, A.CLINIC_CODE, A.EXAM_CODE,
		           A.REQ_PHYS_ID,
                   TO_CHAR(TO_DATE(TO_NUMBER(TO_CHAR(A.APPT_END_TIME,'SSSSS')) -
                   TO_NUMBER(TO_CHAR(A.APPT_START_TIME,'SSSSS')),'SSSSS'),'HH24:MI'),
				   TO_CHAR(A.APPT_START_TIME,'HH24:MI'),
				   TO_CHAR(A.APPT_END_TIME,'HH24:MI'),
				   A.APPT_REF_NUM,A.PATIENT_ID,
				   A.RES_TELEPHONE_NUM,A.OTHER_CONTACT_NUM,
				   SUBSTR(A.SHORT_NAME_LOC_LANG,1,16),A.SHORT_NAME
              FROM RD_APPT_DEL_TR A , RD_CLINIC B
             WHERE A.OPERATING_FACILITY_ID = B.OPERATING_FACILITY_ID
			   AND A.SECTION_CODE = B.SECTION_CODE
			   AND A.CLINIC_CODE  = B.CLINIC_CODE
			   ...
			   AND B.WING_CODE    =	:nd_wing_code
               AND A.CLINIC_CODE BETWEEN :nd_fr_clinic_code AND :nd_to_clinic_code
	           AND RTRIM(TO_CHAR(A.APPT_DATE,'DAY'))= RTRIM(:nd_day_of_week)
	           AND APPT_STATUS = :nd_sel_opt
             ORDER BY TRUNC(A.APPT_DATE), 
					  A.CLINIC_CODE, A.REQ_PHYS_ID,
					  TO_CHAR(A.APPT_START_TIME, 'HH24:MI'), A.APPT_REF_NUM; */ 
...
/*-------------- Check for any error and No data found ----------------------*/
     ...
     if (OERROR) 
       {
          disp_message (ERR_MESG, "Declaration failed on DEL_CUR\n" );
          proc_exit();
       }
...
/*-------------- Check for any error and No data found ----------------------*/
     ...
     if (OERROR)
       {
          disp_message(ERR_MESG, "OPEN failed on DEL_CUR\n" );
          proc_exit();
       }
...

{
          ...
          sqlstm.sqhstv[16] = (         void  *)&h_ward_code;
          ...
          sqlstm.sqhstv[17] = (         void  *)&h_bed_num;
          ...
          sqlstm.sqhstv[18] = (         void  *)&h_ref_source_code;
...

{
          ...
          if (OERROR)
            {
               disp_message(ERR_MESG,"FETCH failed on Cursor CANL_CUR\n");
               proc_exit();
            }
...

{
          ...
          if (OERROR)
            {
               disp_message(ERR_MESG,"FETCH failed on Cursor DEL_CUR\n");
               proc_exit();
            }
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "select A.PRACTITIONER_NAME into :b0  from AM_PRACTITIONE\
R_LANG_VW A ,AM_PRACT_FOR_FACILITY B where (((B.FACILITY_ID=:b1 and A.PRACTITI\
ONER_ID=:b2) and A.PRACTITIONER_ID=B.PRACTITIONER_ID) and LANGUAGE_ID=:b3)";
     sqlstm.iters = (unsigned int  )1;
...
void print_rep_header()
  {
   ...
   //fprintf(f1,"APPOINTMENT DATE    FROM      : %s\n", fr_appt_date_desc);
     ...
     fprintf(f1,"                ");
   //fprintf(f1,"                    TO        : %s\n", to_appt_date_desc);
	 fprintf(f1,"%23s        : %s\n", loc_legend[9],to_appt_date_desc);
     fprintf(f1,"\n");
     fprintf(f1,"                ");
   //fprintf(f1,"WING CODE                     : %s\n\n", nd_wing_code.arr);
     fprintf(f1,"%-30s : %s\n\n", loc_legend[10],nd_wing_code.arr);
     fprintf(f1,"                ");
   //fprintf(f1,"SECTION CODE        FROM      : %s\n", fr_section_code_desc);
     fprintf(f1,"%-30s : %s\n", loc_legend[11],fr_section_code_desc);
     fprintf(f1,"                ");
     fprintf(f1,"\n");
     fprintf(f1,"                ");
   //fprintf(f1,"STUDY LOCATION CODE FROM      : %s\n", fr_clinic_code_desc);
     fprintf(f1,"%-30s : %s\n", loc_legend[12],fr_clinic_code_desc);
     fprintf(f1,"                ");
   //fprintf(f1,"                    TO        : %s\n", to_clinic_code_desc);
     fprintf(f1,"%                        23s        : %s\n", loc_legend[9],to_clinic_code_desc);
     fprintf(f1,"\f");
  }
...
void print_page_header()
{
    ...
    if (strcmp(nd_sel_opt.arr,"S") == 0)
       fprintf(f1,"     DUE TO CANCELLATION OF SCHEDULES     ");

    if (strcmp(nd_sel_opt.arr,"D") == 0)
       fprintf(f1,"       DUE TO DELETION OF TIME TABLE      ");
...
void print_hdr()
  {
   ...
   /*fprintf(f1,"Appointment Date : %s\n\n",h_appt_date.arr); 
     ...
     fprintf(f1,"Study Location   : %-4s   %-30s\n",h_clinic_code.arr,h_clinic_desc.arr);*/

	 fprintf(f1,"%-30s : %s\n\n",loc_legend[13],h_appt_date.arr); 
     fprintf(f1,"%-30s : %-30s\n\n",loc_legend[14],h_wing_desc.arr);
...
void print_col_heading()
{
  ...
  /*fprintf(f1, "Period      Ref. No. Patient No.          Name                                                          Sex/Age Contact Phone(s)\n");
	...
	fprintf(f1, "%-12s%-9s%-21s%-62s%-8s%-16s\n",loc_legend[17],loc_legend[18],loc_legend[19],loc_legend[20],loc_legend[21],loc_legend[22]);
...
fetch_legend_value()
{
	...
	/* EXEC SQL EXECUTE
	BEGIN	      
  	   sm_populate_report_legend.fetch_legend(:nd_facility_id,:p_language_id,'RDRAPCNL.LEGEND_');
	END;
	END-EXEC; */ 
...
y_id , :p_language_id , 'RDRAPCNL.LEGEND_' ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	/* EXEC SQL EXECUTE
	BEGIN
       :l_translated_value := GET_LEGEND(LTRIM(RTRIM('RDRAPCNL.LEGEND_'||LTRIM(RTRIM(TO_CHAR(:i,'009'))))));
	END;
	END-EXEC; */ 
...
DRAPCNL.LEGEND_' || LTRIM ( RTRIM ( TO_CHAR ( :i , '009' ) ) ) ) ) ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
