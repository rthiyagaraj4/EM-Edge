...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/RL/RLRDIFRS.PC"
};


static unsigned int sqlctx = 1288613971;
...
"select DISP_TEST_CODE  from RL_DIFF_DISP_RESULT where ((PATIENT_ID=:b0 and S\
PECIMEN_NO=:b1) and OPERATING_FACILITY_ID=:b2) for update of DISP_TEST_CODE ";

 static const char *sq0009 = 
"select FILM_TEST_CODE  from RL_DIFF_FILM_RESULT where ((PATIENT_ID=:b0 and S\
PECIMEN_NO=:b1) and OPERATING_FACILITY_ID=:b2) for update of FILM_TEST_CODE ";

 static const char *sq0013 = 
"select IND_TEST_CODE  from RL_DIFF_IND_RESULT where ((PATIENT_ID=:b0 and SPE\
CIMEN_NO=:b1) and OPERATING_FACILITY_ID=:b2) for update of IND_TEST_CODE ";

 static const char *sq0017 = 
"select A.IND_TEST_CODE ,A.SEQ_NO ,B.NUMERIC_RESULT  from RL_DIFF_IND_TESTS A\
 ,RL_TEST_RESULT B where (((B.PATIENT_ID=:b0 and B.SPECIMEN_NO=TO_NUMBER(:b1))\
 and B.OPERATING_FACILITY_ID=:b2) and B.TEST_CODE=A.IND_TEST_CODE) order by B.\
TEST_SEQ_NO            ";

 static const char *sq0019 = 
"select A.DISP_TEST_CODE ,A.SEQ_NO ,DECODE(NVL(A.DISP_RESULT_TYPE,'N'),'N',B.\
NUMERIC_RESULT,'R',B.RESULT_COMMENT_CODE1)  from RL_DIFF_DISP_TESTS A ,RL_TEST\
_RESULT B where (((B.PATIENT_ID=:b0 and B.SPECIMEN_NO=TO_NUMBER(:b1)) and B.OP\
ERATING_FACILITY_ID=:b2) and B.TEST_CODE=A.DISP_TEST_CODE) order by B.TEST_SEQ\
_NO            ";

 static const char *sq0021 = 
"select A.FILM_TEST_CODE ,A.SEQ_NO ,B.RESULT_COMMENT_CODE1 ,B.RESULT_COMMENT_\
DESC1 ,B.RESULT_COMMENT_CODE2 ,B.RESULT_COMMENT_DESC2 ,B.RESULT_COMMENT_CODE3 \
,B.RESULT_COMMENT_DESC3 ,B.RESULT_COMMENT_CODE4 ,B.RESULT_COMMENT_DESC4  from \
RL_DIFF_FILM_TESTS A ,RL_TEST_RESULT B where (((B.PATIENT_ID=:b0 and B.SPECIME\
N_NO=TO_NUMBER(:b1)) and B.OPERATING_FACILITY_ID=:b2) and B.TEST_CODE=A.FILM_T\
EST_CODE) order by B.TEST_SEQ_NO            ";
...
36,0,0,2,121,0,4,128,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
63,0,0,3,0,0,29,160,0,0,0,0,0,1,0,
78,0,0,4,0,0,32,165,0,0,0,0,0,1,0,
93,0,0,5,152,0,9,182,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
120,0,0,6,50,0,47,185,0,0,0,0,0,1,0,
135,0,0,5,0,0,15,188,0,0,0,0,0,1,0,
150,0,0,7,0,0,32,192,0,0,0,0,0,1,0,
165,0,0,5,0,0,13,201,0,0,1,0,0,1,0,2,9,0,0,
184,0,0,8,0,0,32,212,0,0,0,0,0,1,0,
199,0,0,9,152,0,9,229,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
226,0,0,10,50,0,47,232,0,0,0,0,0,1,0,
241,0,0,9,0,0,15,235,0,0,0,0,0,1,0,
256,0,0,11,0,0,32,239,0,0,0,0,0,1,0,
271,0,0,9,0,0,13,248,0,0,1,0,0,1,0,2,9,0,0,
290,0,0,12,0,0,32,259,0,0,0,0,0,1,0,
305,0,0,13,149,0,9,276,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
332,0,0,14,49,0,47,279,0,0,0,0,0,1,0,
347,0,0,13,0,0,15,282,0,0,0,0,0,1,0,
362,0,0,15,0,0,32,286,0,0,0,0,0,1,0,
377,0,0,13,0,0,13,295,0,0,1,0,0,1,0,2,9,0,0,
396,0,0,16,0,0,32,307,0,0,0,0,0,1,0,
411,0,0,17,255,0,9,326,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
438,0,0,18,0,0,32,332,0,0,0,0,0,1,0,
453,0,0,19,325,0,9,354,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
480,0,0,20,0,0,32,360,0,0,0,0,0,1,0,
495,0,0,21,432,0,9,384,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
522,0,0,22,0,0,32,389,0,0,0,0,0,1,0,
537,0,0,23,139,0,4,407,0,0,4,3,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
568,0,0,24,169,0,3,416,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
607,0,0,25,139,0,5,440,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
638,0,0,26,0,0,32,453,0,0,0,0,0,1,0,
653,0,0,17,0,0,13,462,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
680,0,0,27,0,0,32,481,0,0,0,0,0,1,0,
695,0,0,28,141,0,4,501,0,0,4,3,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
726,0,0,29,172,0,3,511,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
765,0,0,30,148,0,4,520,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
796,0,0,31,142,0,5,534,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
827,0,0,32,0,0,32,548,0,0,0,0,0,1,0,
842,0,0,19,0,0,13,557,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
869,0,0,33,0,0,32,576,0,0,0,0,0,1,0,
884,0,0,34,298,0,3,588,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
951,0,0,35,0,0,32,610,0,0,0,0,0,1,0,
966,0,0,21,0,0,13,619,0,0,10,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1021,0,0,36,0,0,32,655,0,0,0,0,0,1,0,
1036,0,0,37,64,0,4,669,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
1059,0,0,38,136,0,4,679,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1090,0,0,39,136,0,4,697,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1121,0,0,40,148,0,4,716,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1152,0,0,41,108,0,5,725,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1187,0,0,42,0,0,32,739,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[2]; } nd_flag;

struct { unsigned short len; unsigned char arr[31]; } d_rowid;

struct { unsigned short len; unsigned char arr[11]; } d_ind_test_code;

struct { unsigned short len; unsigned char arr[16]; } d_ind_test_rslt;

struct { unsigned short len; unsigned char arr[11]; } d_film_test_code;

struct { unsigned short len; unsigned char arr[6]; } d_comm_code1;

struct { unsigned short len; unsigned char arr[41]; } d_comm_desc1;

struct { unsigned short len; unsigned char arr[6]; } d_comm_code2;

struct { unsigned short len; unsigned char arr[41]; } d_comm_desc2;

struct { unsigned short len; unsigned char arr[6]; } d_comm_code3;

struct { unsigned short len; unsigned char arr[41]; } d_comm_desc3;

struct { unsigned short len; unsigned char arr[6]; } d_comm_code4;

struct { unsigned short len; unsigned char arr[41]; } d_comm_desc4;

struct { unsigned short len; unsigned char arr[11]; } d_disp_test_code;

struct { unsigned short len; unsigned char arr[16]; } d_disp_test_rslt;

struct { unsigned short len; unsigned char arr[11]; } d_nrbc_code;

struct { unsigned short len; unsigned char arr[11]; } d_nrbc_rslt;

struct { unsigned short len; unsigned char arr[11]; } d_toxin_code;

struct { unsigned short len; unsigned char arr[16]; } d_toxin_rslt;

struct { unsigned short len; unsigned char arr[6]; } d_ind_seq_no;

struct { unsigned short len; unsigned char arr[6]; } d_film_seq_no;

struct { unsigned short len; unsigned char arr[6]; } d_disp_seq_no;

struct { unsigned short len; unsigned char arr[11]; } m_ind_test_code;

struct { unsigned short len; unsigned char arr[11]; } m_disp_test_code;

struct { unsigned short len; unsigned char arr[11]; } m_film_test_code;

struct { unsigned short len; unsigned char arr[16]; } l_disp_test_result;

struct { unsigned short len; unsigned char arr[16]; } l_ind_test_result;

struct { unsigned short len; unsigned char arr[2]; } l_status;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select NVL(status,'O') into :b0  from RL_DIFF_RESULT_HDR w\
here (specimen_no=TO_NUMBER(:b1) and OPERATING_FACILITY_ID=:b2)";
...

{
       ...
       sqlstm.sqladtp = &sqladt;
       sqlstm.sqltdsp = &sqltds;
       sqlstm.stmt = "delete  from RL_DIFF_DISP_RESULT  where rowid = :x";
...

{
  ...
  sqlstm.sqhstv[0] = (         void  *)&m_disp_test_code;
...

{
       ...
       sqlstm.sqladtp = &sqladt;
       sqlstm.sqltdsp = &sqltds;
       sqlstm.stmt = "delete  from RL_DIFF_FILM_RESULT  where rowid = :x";
...

{
  ...
  sqlstm.sqfoff = (           int )0;
  sqlstm.sqfmod = (unsigned int )2;
  sqlstm.sqhstv[0] = (         void  *)&m_film_test_code;
  sqlstm.sqhstl[0] = (unsigned int  )13;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
...

{
       ...
       sqlstm.sqladtp = &sqladt;
       sqlstm.sqltdsp = &sqltds;
       sqlstm.stmt = "delete  from RL_DIFF_IND_RESULT  where rowid = :x";
...

{
  ...
  sqlstm.sqfoff = (           int )0;
  sqlstm.sqfmod = (unsigned int )2;
  sqlstm.sqhstv[0] = (         void  *)&m_ind_test_code;
  sqlstm.sqhstl[0] = (unsigned int  )13;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "select count(*)  into :b0  from RL_DIFF_IND_RESULT wher\
e ((specimen_no=TO_NUMBER(:b1) and ind_test_code=:b2) and OPERATING_FACILITY_I\
D=:b3)";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqadto[1] = (unsigned short )0;
      sqlstm.sqtdso[1] = (unsigned short )0;
      sqlstm.sqhstv[2] = (         void  *)&d_ind_test_code;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "insert into RL_DIFF_IND_RESULT (OPERATING_FACILITY_ID,PATI\
ENT_ID,SPECIMEN_NO,IND_TEST_CODE,IND_TEST_RESULT,SEQ_NO) values (:b0,:b1,TO_NU\
MBER(:b2),:b3,:b4,TO_NUMBER(:b5))";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&nd_specimen_no;
   ...
   sqlstm.sqadto[2] = (unsigned short )0;
   sqlstm.sqtdso[2] = (unsigned short )0;
   sqlstm.sqhstv[3] = (         void  *)&d_ind_test_code;
   ...
   sqlstm.sqadto[3] = (unsigned short )0;
   sqlstm.sqtdso[3] = (unsigned short )0;
   sqlstm.sqhstv[4] = (         void  *)&d_ind_test_rslt;
   ...
   sqlstm.sqhstv[5] = (         void  *)&d_ind_seq_no;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "update RL_DIFF_IND_RESULT  set ind_test_result=:b0 wher\
e ((specimen_no=TO_NUMBER(:b1) and ind_test_code=:b2) and OPERATING_FACILITY_I\
D=:b3)";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqlety = (unsigned short)4352;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&d_ind_test_rslt;
...

{
  ...
  sqlstm.sqfoff = (           int )0;
  sqlstm.sqfmod = (unsigned int )2;
  sqlstm.sqhstv[0] = (         void  *)&d_ind_test_code;
  sqlstm.sqhstl[0] = (unsigned int  )13;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&d_ind_seq_no;
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)&d_ind_test_rslt;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "select count(*)  into :b0  from RL_DIFF_DISP_RESULT whe\
re ((specimen_no=TO_NUMBER(:b1) and disp_test_code=:b2) and OPERATING_FACILITY\
_ID=:b3)";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqadto[1] = (unsigned short )0;
      sqlstm.sqtdso[1] = (unsigned short )0;
      sqlstm.sqhstv[2] = (         void  *)&d_disp_test_code;
      sqlstm.sqhstl[2] = (unsigned int  )13;
      sqlstm.sqhsts[2] = (         int  )0;
      sqlstm.sqindv[2] = (         void  *)0;
      sqlstm.sqinds[2] = (         int  )0;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "insert into RL_DIFF_DISP_RESULT (OPERATING_FACILITY_ID,PATI\
ENT_ID,SPECIMEN_NO,DISP_TEST_CODE,DISP_TEST_RESULT,SEQ_NO) values (:b0,:b1,TO_\
NUMBER(:b2),:b3,:b4,TO_NUMBER(:b5))";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (         void  *)&d_disp_test_code;
  sqlstm.sqhstl[3] = (unsigned int  )13;
  sqlstm.sqhsts[3] = (         int  )0;
  sqlstm.sqindv[3] = (         void  *)0;
  sqlstm.sqinds[3] = (         int  )0;
  ...
  sqlstm.sqadto[3] = (unsigned short )0;
  sqlstm.sqtdso[3] = (unsigned short )0;
  sqlstm.sqhstv[4] = (         void  *)&d_disp_test_rslt;
  sqlstm.sqhstl[4] = (unsigned int  )18;
  sqlstm.sqhsts[4] = (         int  )0;
  sqlstm.sqindv[4] = (         void  *)0;
  sqlstm.sqinds[4] = (         int  )0;
  ...
  sqlstm.sqadto[4] = (unsigned short )0;
  sqlstm.sqtdso[4] = (unsigned short )0;
  sqlstm.sqhstv[5] = (         void  *)&d_disp_seq_no;
  sqlstm.sqhstl[5] = (unsigned int  )8;
  sqlstm.sqhsts[5] = (         int  )0;
  sqlstm.sqindv[5] = (         void  *)0;
  sqlstm.sqinds[5] = (         int  )0;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select disp_test_result into :b0  from RL_DIFF_DISP_RESUL\
T where ((specimen_no=TO_NUMBER(:b1) and disp_test_code=:b2) and OPERATING_FAC\
ILITY_ID=:b3)";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (         void  *)&l_disp_test_result;
    sqlstm.sqhstl[0] = (unsigned int  )18;
    sqlstm.sqhsts[0] = (         int  )0;
    sqlstm.sqindv[0] = (         void  *)0;
    sqlstm.sqinds[0] = (         int  )0;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "update RL_DIFF_DISP_RESULT  set disp_test_result=:b0 wh\
ere ((specimen_no=TO_NUMBER(:b1) and disp_test_code=:b2) and OPERATING_FACILIT\
Y_ID=:b3)";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqlety = (unsigned short)4352;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&d_disp_test_rslt;
      sqlstm.sqhstl[0] = (unsigned int  )18;
      sqlstm.sqhsts[0] = (         int  )0;
      sqlstm.sqindv[0] = (         void  *)0;
      sqlstm.sqinds[0] = (         int  )0;
...

{
  ...
  sqlstm.sqfoff = (           int )0;
  sqlstm.sqfmod = (unsigned int )2;
  sqlstm.sqhstv[0] = (         void  *)&d_disp_test_code;
  sqlstm.sqhstl[0] = (unsigned int  )13;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&d_disp_seq_no;
  sqlstm.sqhstl[1] = (unsigned int  )8;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         void  *)0;
  sqlstm.sqinds[1] = (         int  )0;
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)&d_disp_test_rslt;
  sqlstm.sqhstl[2] = (unsigned int  )18;
  sqlstm.sqhsts[2] = (         int  )0;
  sqlstm.sqindv[2] = (         void  *)0;
  sqlstm.sqinds[2] = (         int  )0;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "insert into RL_DIFF_FILM_RESULT (OPERATING_FACILITY_ID,\
PATIENT_ID,SPECIMEN_NO,FILM_TEST_CODE,COMMENT_CODE1,COMMENT_DESC1,COMMENT_CODE\
2,COMMENT_DESC2,COMMENT_CODE3,COMMENT_DESC3,COMMENT_CODE4,COMMENT_DESC4,SEQ_NO\
) values (:b0,:b1,TO_NUMBER(:b2),:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,TO_NUMB\
ER(:b12))";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&d_film_test_code;
      sqlstm.sqhstl[3] = (unsigned int  )13;
      sqlstm.sqhsts[3] = (         int  )0;
      sqlstm.sqindv[3] = (         void  *)0;
      sqlstm.sqinds[3] = (         int  )0;
      ...
      sqlstm.sqadto[3] = (unsigned short )0;
      sqlstm.sqtdso[3] = (unsigned short )0;
      sqlstm.sqhstv[4] = (         void  *)&d_comm_code1;
      ...
      sqlstm.sqadto[4] = (unsigned short )0;
      sqlstm.sqtdso[4] = (unsigned short )0;
      sqlstm.sqhstv[5] = (         void  *)&d_comm_desc1;
      ...
      sqlstm.sqadto[5] = (unsigned short )0;
      sqlstm.sqtdso[5] = (unsigned short )0;
      sqlstm.sqhstv[6] = (         void  *)&d_comm_code2;
      ...
      sqlstm.sqhstv[7] = (         void  *)&d_comm_desc2;
      ...
      sqlstm.sqhstv[8] = (         void  *)&d_comm_code3;
      ...
      sqlstm.sqhstv[9] = (         void  *)&d_comm_desc3;
      ...
      sqlstm.sqhstv[10] = (         void  *)&d_comm_code4;
      ...
      sqlstm.sqhstv[11] = (         void  *)&d_comm_desc4;
      ...
      sqlstm.sqhstv[12] = (         void  *)&d_film_seq_no;
...

{
  ...
  sqlstm.sqfoff = (           int )0;
  sqlstm.sqfmod = (unsigned int )2;
  sqlstm.sqhstv[0] = (         void  *)&d_film_test_code;
  sqlstm.sqhstl[0] = (unsigned int  )13;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&d_film_seq_no;
  sqlstm.sqhstl[1] = (unsigned int  )8;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         void  *)0;
  sqlstm.sqinds[1] = (         int  )0;
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)&d_comm_code1;
  ...
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (         void  *)&d_comm_desc1;
  ...
  sqlstm.sqadto[3] = (unsigned short )0;
  sqlstm.sqtdso[3] = (unsigned short )0;
  sqlstm.sqhstv[4] = (         void  *)&d_comm_code2;
  sqlstm.sqhstl[4] = (unsigned int  )8;
  sqlstm.sqhsts[4] = (         int  )0;
  sqlstm.sqindv[4] = (         void  *)0;
  sqlstm.sqinds[4] = (         int  )0;
  ...
  sqlstm.sqadto[4] = (unsigned short )0;
  sqlstm.sqtdso[4] = (unsigned short )0;
  sqlstm.sqhstv[5] = (         void  *)&d_comm_desc2;
  sqlstm.sqhstl[5] = (unsigned int  )43;
  sqlstm.sqhsts[5] = (         int  )0;
  sqlstm.sqindv[5] = (         void  *)0;
  sqlstm.sqinds[5] = (         int  )0;
  ...
  sqlstm.sqadto[5] = (unsigned short )0;
  sqlstm.sqtdso[5] = (unsigned short )0;
  sqlstm.sqhstv[6] = (         void  *)&d_comm_code3;
  sqlstm.sqhstl[6] = (unsigned int  )8;
  sqlstm.sqhsts[6] = (         int  )0;
  sqlstm.sqindv[6] = (         void  *)0;
  sqlstm.sqinds[6] = (         int  )0;
  ...
  sqlstm.sqadto[6] = (unsigned short )0;
  sqlstm.sqtdso[6] = (unsigned short )0;
  sqlstm.sqhstv[7] = (         void  *)&d_comm_desc3;
  sqlstm.sqhstl[7] = (unsigned int  )43;
  sqlstm.sqhsts[7] = (         int  )0;
  sqlstm.sqindv[7] = (         void  *)0;
  sqlstm.sqinds[7] = (         int  )0;
  ...
  sqlstm.sqadto[7] = (unsigned short )0;
  sqlstm.sqtdso[7] = (unsigned short )0;
  sqlstm.sqhstv[8] = (         void  *)&d_comm_code4;
  sqlstm.sqhstl[8] = (unsigned int  )8;
  sqlstm.sqhsts[8] = (         int  )0;
  sqlstm.sqindv[8] = (         void  *)0;
  sqlstm.sqinds[8] = (         int  )0;
  ...
  sqlstm.sqadto[8] = (unsigned short )0;
  sqlstm.sqtdso[8] = (unsigned short )0;
  sqlstm.sqhstv[9] = (         void  *)&d_comm_desc4;
  sqlstm.sqhstl[9] = (unsigned int  )43;
  sqlstm.sqhsts[9] = (         int  )0;
  sqlstm.sqindv[9] = (         void  *)0;
  sqlstm.sqinds[9] = (         int  )0;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select NRBC_CODE ,TOXIN_CODE into :b0,:b1  from RL_DIFF_RE\
F_HDR ";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqlety = (unsigned short)4352;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&d_nrbc_code;
   sqlstm.sqhstl[0] = (unsigned int  )13;
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         void  *)0;
   sqlstm.sqinds[0] = (         int  )0;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&d_toxin_code;
...
((SPECIMEN_NO=TO_NUMBER(:b1) and TEST_CODE=:b2) and OPERATING_FACILITY_ID=:b3)";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqlety = (unsigned short)4352;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&d_nrbc_rslt;
   sqlstm.sqhstl[0] = (unsigned int  )13;
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         void  *)0;
   sqlstm.sqinds[0] = (         int  )0;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&d_nrbc_code;
   sqlstm.sqhstl[2] = (unsigned int  )13;
   sqlstm.sqhsts[2] = (         int  )0;
   sqlstm.sqindv[2] = (         void  *)0;
   sqlstm.sqinds[2] = (         int  )0;
...
((SPECIMEN_NO=TO_NUMBER(:b1) and TEST_CODE=:b2) and OPERATING_FACILITY_ID=:b3)";
   ...
   sqlstm.sqlety = (unsigned short)4352;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&d_toxin_rslt;
   sqlstm.sqhstl[0] = (unsigned int  )18;
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         void  *)0;
   sqlstm.sqinds[0] = (         int  )0;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&d_toxin_code;
   sqlstm.sqhstl[2] = (unsigned int  )13;
   sqlstm.sqhsts[2] = (         int  )0;
   sqlstm.sqindv[2] = (         void  *)0;
   sqlstm.sqinds[2] = (         int  )0;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select ROWID into :b0  from RL_DIFF_RESULT_HDR where ((PAT\
IENT_ID=:b1 and SPECIMEN_NO=:b2) and OPERATING_FACILITY_ID=:b3) for update of \
NRBC_RESULT ";
   sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "update RL_DIFF_RESULT_HDR  set NRBC_CODE=:b0,TOXIN_CODE=:b\
1,NRBC_RESULT=:b2,TOXIN_RESULT=:b3 where ROWID=:b4";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&d_nrbc_rslt;
   sqlstm.sqhstl[2] = (unsigned int  )13;
   sqlstm.sqhsts[2] = (         int  )0;
   sqlstm.sqindv[2] = (         void  *)0;
   sqlstm.sqinds[2] = (         int  )0;
   ...
   sqlstm.sqadto[2] = (unsigned short )0;
   sqlstm.sqtdso[2] = (unsigned short )0;
   sqlstm.sqhstv[3] = (         void  *)&d_toxin_rslt;
