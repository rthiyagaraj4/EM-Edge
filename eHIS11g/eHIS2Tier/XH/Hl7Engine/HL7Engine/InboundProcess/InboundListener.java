...
{	
	...
	public InboundListener(InboundServerParameters serv)
	{
		...
		{
			common.fileOutput( serverParameters.strExceptionLogFile, "(InboundListener:Constructor) Exception:"+exception+"\n" ) ;			
	...
	public void tcpCommunication()
	{
		...
		{			
			...
			*/
				...
				{
					common.fileOutput( serverParameters.strLogFile, "(InboundListener:run) Listener Started @ "+serverSocket.getLocalPort()+"\n" ) ;	
				}
				...
				common.fileOutput( serverParameters.strLogFile, 
					"(InboundListener:run) New Connection received from "+remoteAddress.getHostName()+" through "+socket.getPort()+" port\n" ) ;				
			...
			{
				common.fileOutput( serverParameters.strLogFile, "(InboundListener:run) IOException:"+exceptionFile+"\n" ) ;
