...
//	String eb8MDBFileFormat = null;
	...
	{						
		...
		common.fileOutput( strLogFile, "(OutboundClientWriteFile:writeMessage)strFileApi:"+strFileApi+"\n" );
		common.fileOutput( strLogFile, "(OutboundClientWriteFile:writeMessage)strDbfFileType:"+strDbfFileType+"\n" );
		try
		{
			if (!replay)
			{
	...
	*/	}
	...
	public void writeFooter()
	{
		if(strOutFileName != null && !strOutFileName.equalsIgnoreCase(""))
		{
			...
			//Moving old file to interface directory (parent directiry of eHIS) before writing to new File.
	...
	private void createNewFile()
	{
		...
		*/	if(fileCreationInterval != null && !fileCreationInterval.equals("0000"))
			{
				writeFooter();
				strFileApi = clientDB.fileNamingConvention(strFileNamingConvention);			
			}
			else
			{
