	...
	public String stopJavaService(String applicationid,String facilityid,String processid) throws Exception 
	{
		...
		try
		{
			...
			if(chkserviceflag == false)
			{
				...
				String stopMonitorCmd = "sc stop Hl7_"+applicationid+"_"+facilityid+"_"+processid+"_monitor";
				...
				if(statusflag)
				{
					...
					String uninstallMonitor = "javaservice -uninstall Hl7_"+applicationid+"_"+facilityid+"_"+processid+"_monitor";
