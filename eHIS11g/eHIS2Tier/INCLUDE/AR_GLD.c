...
{
    22,
    "D:\\test\\PROC\\AR_GLD.PC"
};


static unsigned long sqlctx = 293728027;
...
ABLE_AMT),PAYABLE_AMT)  from AR_INV_HDR where ((operating_facility_id=:b0 and \
...
INV_LINE where ((operating_facility_id=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=\
:b2)           ";

 static const char *sq0003 = 
"select DOC_TYPE_CODE ,DOC_NUM ,TO_CHAR(DOC_DATE,'DD/MM/YYYY')  from AR_DN_HD\
R where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2)   \
        ";
...
here ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2)      \
     ";
...
(((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2) and ORG_D\
OC_TYPE_CODE=:b3) and ORG_DOC_NUM=:b4)           ";
...
DR where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2)  \
         ";
...
J_INV_HDR where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM\
=:b2)           ";
...
((((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2) and ORG_\
DOC_TYPE_CODE=:b3) and ORG_DOC_NUM=:b4)           ";
...
ere ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2)       \
    ";
...
CODE ,DEPT_CODE ,PRODUCT_GROUP_CODE ,PRODUCT_LINE_CODE ,NARRATION ,AMT_LOCAL ,\
SIGN(AMT_LOCAL) ,DECODE(SIGN(AMT_LOCAL),(-1),(-AMT_LOCAL),AMT_LOCAL)  from AR_\
REC_LINE where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=\
:b2)           ";
...
CODE ,DEPT_CODE ,PRODUCT_GROUP_CODE ,PRODUCT_LINE_CODE ,NARRATION ,AMT_LOCAL ,\
SIGN(AMT_LOCAL) ,DECODE(SIGN(AMT_LOCAL),(-1),(-AMT_LOCAL),AMT_LOCAL)  from AR_\
PAY_LINE where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=\
:b2)           ";
...
{10,4274,0,0,0,
5,0,0,1,434,0,9,204,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
32,0,0,1,0,0,13,217,0,0,18,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,3,0,0,2,9,0,0,
119,0,0,2,325,0,9,255,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
146,0,0,2,0,0,13,268,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
205,0,0,3,162,0,9,359,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
232,0,0,3,0,0,13,372,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
259,0,0,4,393,0,9,395,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
286,0,0,4,0,0,13,413,0,0,17,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,
369,0,0,5,359,0,9,451,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
404,0,0,5,0,0,13,465,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
463,0,0,6,162,0,9,554,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
490,0,0,6,0,0,13,567,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
517,0,0,7,393,0,9,592,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
544,0,0,7,0,0,13,609,0,0,17,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,
627,0,0,8,359,0,9,646,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
662,0,0,8,0,0,13,659,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
721,0,0,9,163,0,9,750,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
748,0,0,9,0,0,13,763,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
775,0,0,10,404,0,9,786,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
802,0,0,10,0,0,13,801,0,0,18,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,
889,0,0,11,360,0,9,845,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
924,0,0,11,0,0,13,855,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
983,0,0,12,470,0,9,929,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
1010,0,0,12,0,0,13,939,0,0,20,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
1105,0,0,13,325,0,9,976,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
1132,0,0,13,0,0,13,986,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
1191,0,0,14,470,0,9,1060,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
1218,0,0,14,0,0,13,1070,0,0,20,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
1313,0,0,15,325,0,9,1114,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
1340,0,0,15,0,0,13,1124,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
1399,0,0,16,626,0,9,1191,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
1426,0,0,16,0,0,13,1201,0,0,27,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,3,0,0,2,9,0,0,
1549,0,0,17,474,0,3,1540,0,0,19,19,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1640,0,0,18,474,0,3,1596,0,0,19,19,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1731,0,0,19,509,0,3,1676,0,0,22,22,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1834,0,0,20,476,0,3,1733,0,0,21,21,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
...
struct { unsigned short len; unsigned char arr[2]; } nd_facility_id;
 ...
 /* VARCHAR    l_gd_doc_type_code         [7],
            ...
            l_gd_adj_type              [3],   /o For adjustments o/
            l_slmt_pmnt_entry_yn	   [2]; */ 
...
struct { unsigned short len; unsigned char arr[11]; } l_gd_dept_code;
...
struct { unsigned short len; unsigned char arr[11]; } l_gd_dept_code_susp;
...
struct { unsigned short len; unsigned char arr[2]; } l_slmt_pmnt_entry_yn;
   /* Added by Ravikiran on 09/04/2010*/	
...
ins_gl_distrbn(passed_doc_type,passed_doc_num,passed_trn_type,passed_facility_id)
...
int  passed_trn_type;
{
   ...
   strcpy(nd_facility_id.arr,passed_facility_id);
  ...
  disp_message(INFO_MESG,"Inside Decl inv cur\n");
       ...
       /* EXEC SQL DECLARE CUR_INV_HDR CURSOR FOR
                 SELECT DOC_TYPE_CODE,
				  ...
				  and DOC_TYPE_CODE = :nd_gd_doc_type_code
...

{
       ...
       sqlstm.sqhstv[1] = (         void  *)&nd_gd_doc_type_code;
       ...
       sqlstm.sqhstv[2] = (         void  *)&nd_gd_doc_num;
...

{
       ...
       sqlstm.sqadto[2] = (unsigned short )0;
       sqlstm.sqtdso[2] = (unsigned short )0;
       sqlstm.sqhstv[3] = (         void  *)&l_gd_org_doc_type_code;
       ...
       sqlstm.sqadto[3] = (unsigned short )0;
       sqlstm.sqtdso[3] = (unsigned short )0;
       sqlstm.sqhstv[4] = (         void  *)&l_gd_org_doc_num;
       sqlstm.sqhstl[4] = (unsigned int  )11;
       sqlstm.sqhsts[4] = (         int  )0;
       sqlstm.sqindv[4] = (         void  *)0;
       sqlstm.sqinds[4] = (         int  )0;
...
,NARRATION,POST_MONTH,POST_YEAR,CHEQUE_NUM,CHEQUE_DATE,TRN_TYPE_CODE,SLMT_PMNT\
_ENTRY_YN,OPERATING_FACILITY_ID) values (:b0,:b1,TO_DATE(:b2,'DD/MM/YYYY'),:b3\
,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,0,:b13,:b14,:b15,:b16,TO_DATE(:b17,'DD\
/MM/YYYY'),'REC','Y',:b18)";
   sqlstm.iters = (unsigned int  )1;
...
T,NARRATION,POST_MONTH,POST_YEAR,CHEQUE_NUM,CHEQUE_DATE,TRN_TYPE_CODE,SLMT_PMN\
T_ENTRY_YN,OPERATING_FACILITY_ID) values (:b0,:b1,TO_DATE(:b2,'DD/MM/YYYY'),:b\
3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,0,:b12,:b13,:b14,:b15,:b16,TO_DATE(:b17,'D\
D/MM/YYYY'),'REC','Y',:b18)";
    sqlstm.iters = (unsigned int  )1;
...
,NARRATION,POST_MONTH,POST_YEAR,CHEQUE_NUM,CHEQUE_DATE,TRN_TYPE_CODE,SLMT_PMNT\
_ENTRY_YN,OPERATING_FACILITY_ID) values (:b0,:b1,TO_DATE(:b2,'DD/MM/YYYY'),:b3\
,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,:b13,:b14,:b15,:b16,:b17,TO_DATE(:b18,\
'DD/MM/YYYY'),:b19,decode(:b19,'REC','Y','REF','Y','N'),:b21)";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[19] = (unsigned short )0;
   sqlstm.sqtdso[19] = (unsigned short )0;
   sqlstm.sqhstv[20] = (         void  *)&l_gd_trn_type_code;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "insert into AR_GL_DISTRBN (DOC_TYPE_CODE,DOC_NUM,DOC_DATE,DO\
C_REF,CUST_CODE,MAIN_ACC1_CODE,MAIN_ACC2_CODE,SUBLEDGER_GROUP_CODE,SUBLEDGER_L\
INE_CODE,DEPT_CODE,PRODUCT_GROUP_CODE,PRODUCT_LINE_CODE,DEBIT_AMT,CREDIT_AMT,N\
ARRATION,POST_MONTH,POST_YEAR,CHEQUE_NUM,CHEQUE_DATE,TRN_TYPE_CODE,SLMT_PMNT_E\
NTRY_YN,OPERATING_FACILITY_ID) values (:b0,:b1,TO_DATE(:b2,'DD/MM/YYYY'),:b3,:\
b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,:b13,:b14,:b15,:b16,:b17,TO_DATE(:b18,'D\
D/MM/YYYY'),:b19,'N',:b20)";
 sqlstm.iters = (unsigned int  )1;
