...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/DF/DFR00014.pc"
};
...
"der by ((((A.TRX_DOC_REF||'/')||A.TRX_DOC_REF_LINE_NUM)||'/')||A.TRX_DOC_REF\
_SEQ_NUM)            ";

 static const char *sq0005 = 
"select ((PROCESSING_MONTH||'/')||PROCESSING_YEAR) ,TRX_DOC_REF_SUBSEQ_NUM ,P\
HYSICIAN_ID ,GROSS_AMT ,DISCOUNT_AMT ,NET_REVENUE_AMT ,DR_REVENUE_AMT ,CONTRAC\
T_REF ,((to_char(CONTRACT_PERIOD_FROM,'DD/MM/YYYY')||' - ')||to_char(CONTRACT_\
PERIOD_TO,'DD/MM/YYYY')) contract_period ,SERV_QTY  from DF_REVENUE_CHARGES_FO\
LIO where (OPERATING_FACILITY_ID=:b0 and ((((TRX_DOC_REF||'/')||TRX_DOC_REF_LI\
NE_NUM)||'/')||TRX_DOC_REF_SEQ_NUM)=:b1) order by 1,2            ";
...
36,0,0,2,159,0,4,152,0,0,9,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,
87,0,0,3,84,0,2,184,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
114,0,0,4,1121,0,9,264,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
157,0,0,4,0,0,15,271,0,0,0,0,0,1,0,
172,0,0,4,0,0,13,304,0,0,13,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
239,0,0,5,453,0,9,357,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
262,0,0,5,0,0,15,364,0,0,0,0,0,1,0,
277,0,0,5,0,0,13,389,0,0,10,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,
4,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,4,0,0,
332,0,0,6,188,0,4,532,0,0,6,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,
9,0,0,
371,0,0,7,0,0,32,549,0,0,0,0,0,1,0,
386,0,0,8,96,0,4,725,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
409,0,0,9,162,0,6,732,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[15]; } nd_fm_trx_date;

struct { unsigned short len; unsigned char arr[15]; } nd_to_trx_date;

struct { unsigned short len; unsigned char arr[16]; } nd_fm_doctor;

struct { unsigned short len; unsigned char arr[16]; } nd_to_doctor;
...
struct { unsigned short len; unsigned char arr[35]; } d_trx_doc;

struct { unsigned short len; unsigned char arr[15]; } d_trx_date;
...
struct { unsigned short len; unsigned char arr[100]; } d_blng_serv_desc;
...
struct { unsigned short len; unsigned char arr[20]; } d_episode_details;
...
struct { unsigned short len; unsigned char arr[8]; } d_process_mth_yr;

struct { unsigned short len; unsigned char arr[5]; } d_subseq_num;

struct { unsigned short len; unsigned char arr[16]; } d_adj_physician_id;

struct { unsigned short len; unsigned char arr[21]; } d_contract_ref;

struct { unsigned short len; unsigned char arr[25]; } d_contract_period;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select PARAM1 ,PARAM2 ,PARAM3 ,PARAM4 ,PARAM5 ,PARAM6 int\
o :b0,:b1,:b2,:b3,:b4,:b5  from SY_PROG_PARAM where ((PGM_ID=:b6 and SESSION_I\
D=:b7) and PGM_DATE=:b8)";
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (         void  *)&nd_fm_trx_date;
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (         void  *)&nd_to_trx_date;
    ...
    sqlstm.sqhstv[2] = (         void  *)&nd_fm_doctor;
    ...
    sqlstm.sqhstv[3] = (         void  *)&nd_to_doctor;
    ...
    sqlstm.sqhstv[4] = (         void  *)&nd_fm_blng_serv;
    ...
    sqlstm.sqhstv[5] = (         void  *)&nd_to_blng_serv;
...

{
   ...
   sqlstm.sqltdsp = &sqltds;
   sqlbuft((void **)0, 
     "select ((((A.TRX_DOC_REF||'/')||A.TRX_DOC_REF_LINE_NUM)||'/')||A.TRX_D\
OC_REF_SEQ_NUM) TRX_DOC ,to_char(A.TRX_DATE,'DD/MM/YYYY') ,to_char(A.SERVICE\
_DATE,'DD/MM/YYYY HH24:MI') ,A.BLNG_SERV_CODE ,B.SHORT_DESC BLNG_SERV_DESC ,\
A.PHYSICIAN_ID ,C.SHORT_NAME PHY_NAME ,A.PATIENT_ID ,D.SHORT_NAME ,((((A.EPI\
SODE_TYPE||'/')||A.EPISODE_ID)||'/')||A.VISIT_ID) episode_details ,A.ORG_GRO\
SS_CHARGE_AMT ,A.ORG_DISC_AMT ,A.ORG_NET_CHARGE_AMT  from BL_PATIENT_CHARGES\
_FOLIO A ,BL_BLNG_SERV B ,SY_PHYSICIAN_MAST C ,MP_PATIENT_MAST D where (((((\
((((A.OPERATING_FACILITY_ID=:b0 and A.TRX_DATE between TO_DATE(:b1,'DD/MM/YY\
YY') and TO_DATE(:b2,'DD/MM/YYYY')) and A.BLNG_SERV_CODE between NVL(:b3,'!!\
!!!!!!!!') and NVL(:b4,'~~~~~~~~~~')) and A.PHYSICIAN_ID between NVL(:b5,'!!\
!!!!!!!!!!!!!') and NVL(:b6,'~~~~~~~~~~~~~~~')) and A.BLNG_SERV_CODE=B.BLNG_\
SERV_CODE) and B.RATE_ENTRY_BY_USER_FLAG='C') and NVL(A.DF_INTERFACED_YN,'N'\
)='Y') and A.OPERATING_FACILITY_ID=C.FACILITY_ID) and A.PHYSICIAN_ID=C.PHYSI\
CIAN_ID) and A.PATIENT_ID=D.PATIENT_ID) or");
   sqlstm.stmt = sq0004;
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[4] = (unsigned short )0;
   sqlstm.sqtdso[4] = (unsigned short )0;
   sqlstm.sqhstv[5] = (         void  *)&nd_fm_doctor;
   ...
   sqlstm.sqadto[5] = (unsigned short )0;
   sqlstm.sqtdso[5] = (unsigned short )0;
   sqlstm.sqhstv[6] = (         void  *)&nd_to_doctor;
...

{
 ...
 sqlstm.sqhstv[0] = (         void  *)&d_trx_doc;
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (         void  *)&d_trx_date;
 sqlstm.sqhstl[1] = (unsigned int  )17;
 sqlstm.sqhsts[1] = (         int  )0;
 sqlstm.sqindv[1] = (         void  *)0;
 sqlstm.sqinds[1] = (         int  )0;
 ...
 sqlstm.sqadto[3] = (unsigned short )0;
 sqlstm.sqtdso[3] = (unsigned short )0;
 sqlstm.sqhstv[4] = (         void  *)&d_blng_serv_desc;
 ...
 sqlstm.sqadto[4] = (unsigned short )0;
 sqlstm.sqtdso[4] = (unsigned short )0;
 sqlstm.sqhstv[5] = (         void  *)&d_physician_id;
 sqlstm.sqhstl[5] = (unsigned int  )18;
 sqlstm.sqhsts[5] = (         int  )0;
 sqlstm.sqindv[5] = (         void  *)0;
 sqlstm.sqinds[5] = (         int  )0;
 ...
 sqlstm.sqadto[5] = (unsigned short )0;
 sqlstm.sqtdso[5] = (unsigned short )0;
 sqlstm.sqhstv[6] = (         void  *)&d_physician_name;
 sqlstm.sqhstl[6] = (unsigned int  )18;
 sqlstm.sqhsts[6] = (         int  )0;
 sqlstm.sqindv[6] = (         void  *)0;
 sqlstm.sqinds[6] = (         int  )0;
 ...
 sqlstm.sqadto[7] = (unsigned short )0;
 sqlstm.sqtdso[7] = (unsigned short )0;
 sqlstm.sqhstv[8] = (         void  *)&d_patient_name;
 ...
 sqlstm.sqadto[8] = (unsigned short )0;
 sqlstm.sqtdso[8] = (unsigned short )0;
 sqlstm.sqhstv[9] = (         void  *)&d_episode_details;
 ...
 sqlstm.sqhstv[10] = (         void  *)&d_org_gross_charge_amt;
 ...
 sqlstm.sqhstv[11] = (         void  *)&d_org_disc_amt;
 ...
 sqlstm.sqhstv[12] = (         void  *)&d_org_net_charge_amt;
...

{
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&d_trx_doc;
...

{
 ...
 sqlstm.sqfoff = (           int )0;
 sqlstm.sqfmod = (unsigned int )2;
 sqlstm.sqhstv[0] = (         void  *)&d_process_mth_yr;
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (         void  *)&d_subseq_num;
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (         void  *)&d_adj_physician_id;
 sqlstm.sqhstl[2] = (unsigned int  )18;
 sqlstm.sqhsts[2] = (         int  )0;
 sqlstm.sqindv[2] = (         void  *)0;
 sqlstm.sqinds[2] = (         int  )0;
 ...
 sqlstm.sqadto[2] = (unsigned short )0;
 sqlstm.sqtdso[2] = (unsigned short )0;
 sqlstm.sqhstv[3] = (         void  *)&d_adj_gross_charge_amt;
 ...
 sqlstm.sqadto[3] = (unsigned short )0;
 sqlstm.sqtdso[3] = (unsigned short )0;
 sqlstm.sqhstv[4] = (         void  *)&d_adj_disc_amt;
 ...
 sqlstm.sqadto[4] = (unsigned short )0;
 sqlstm.sqtdso[4] = (unsigned short )0;
 sqlstm.sqhstv[5] = (         void  *)&d_adj_net_charge_amt;
 ...
 sqlstm.sqadto[5] = (unsigned short )0;
 sqlstm.sqtdso[5] = (unsigned short )0;
 sqlstm.sqhstv[6] = (         void  *)&d_dr_revenue_amt;
 ...
 sqlstm.sqadto[6] = (unsigned short )0;
 sqlstm.sqtdso[6] = (unsigned short )0;
 sqlstm.sqhstv[7] = (         void  *)&d_contract_ref;
 sqlstm.sqhstl[7] = (unsigned int  )23;
 sqlstm.sqhsts[7] = (         int  )0;
 sqlstm.sqindv[7] = (         void  *)0;
 sqlstm.sqinds[7] = (         int  )0;
 ...
 sqlstm.sqadto[7] = (unsigned short )0;
 sqlstm.sqtdso[7] = (unsigned short )0;
 sqlstm.sqhstv[8] = (         void  *)&d_contract_period;
 sqlstm.sqhstl[8] = (unsigned int  )27;
 sqlstm.sqhsts[8] = (         int  )0;
 sqlstm.sqindv[8] = (         void  *)0;
 sqlstm.sqinds[8] = (         int  )0;
 ...
 sqlstm.sqadto[8] = (unsigned short )0;
 sqlstm.sqtdso[8] = (unsigned short )0;
 sqlstm.sqhstv[9] = (         void  *)&d_serv_qty;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('DFR00014.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
