...
{
    24,
    "D:\\test\\PROC\\AR_VALID.PC"
};


static unsigned long sqlctx = 1174914059;
...
"select TRN_TYPE_CODE  from AR_TRN_DOC_TYPE where (OPERATING_FACILITY_ID=:b0 \
and DOC_TYPE_CODE=:b1)           ";
...
{10,4274,0,0,0,
5,0,0,6,138,0,9,248,0,0,1,1,0,1,0,1,9,0,0,
24,0,0,6,0,0,13,260,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
51,0,0,7,82,0,9,289,0,0,1,1,0,1,0,1,9,0,0,
70,0,0,7,0,0,13,297,0,0,1,0,0,1,0,2,9,0,0,
89,0,0,1,109,0,9,310,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
112,0,0,1,0,0,13,318,0,0,1,0,0,1,0,2,9,0,0,
131,0,0,2,84,0,9,333,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
154,0,0,2,0,0,13,338,0,0,1,0,0,1,0,2,9,0,0,
173,0,0,3,85,0,9,405,0,0,1,1,0,1,0,1,9,0,0,
192,0,0,3,0,0,13,416,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
215,0,0,10,0,0,13,465,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,
274,0,0,4,79,0,9,646,0,0,1,1,0,1,0,1,9,0,0,
293,0,0,4,0,0,13,654,0,0,1,0,0,1,0,2,9,0,0,
312,0,0,6,138,0,9,741,0,0,1,1,0,1,0,1,9,0,0,
331,0,0,6,0,0,13,754,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
358,0,0,7,82,0,9,775,0,0,1,1,0,1,0,1,9,0,0,
377,0,0,7,0,0,13,783,0,0,1,0,0,1,0,2,9,0,0,
396,0,0,8,73,0,9,807,0,0,1,1,0,1,0,1,9,0,0,
415,0,0,8,0,0,13,812,0,0,1,0,0,1,0,2,9,0,0,
434,0,0,5,151,0,9,858,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
465,0,0,5,0,0,13,863,0,0,1,0,0,1,0,2,4,0,0,
484,0,0,10,321,0,9,892,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
511,0,0,11,171,0,4,898,0,0,6,5,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
};
...
/* VARCHAR     l_ar_hdr_doc_type_code                [7], 
			...
			l_facility_id            [2],  /oAdded by madhusudhan for GDOH-CRF-0107o/
...
struct { unsigned short len; unsigned char arr[4]; } l_ar_ihdr_billing_group;
...
ENT_DTLS where ((((OPERATING_FACILITY_ID=:b1 and DOC_TYPE_CODE=:b2) and DOC_NU\
M=:b3) and BILL_DOC_TYPE_CODE=:b4) and BILL_NUM=:b5)";
                    sqlstm.iters = (unsigned int  )1;
