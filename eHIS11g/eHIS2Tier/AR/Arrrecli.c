...
{
    124,
    "C:\\Users\\mbothra\\Desktop\\abhinav_proc_wokr\\tocheck and change-pending for 107.6and 7\\11g_Regular_source\\Arrrecli\\Arrrecli.pc"
};


static unsigned long sqlctx = 1135375683;
...
"select ORG_DOC_TYPE_CODE ,ORG_DOC_NUM ,AMT_LOCAL  from AR_REC_LINE where ((o\
perating_facility_id=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2) order by ORG_\
DOC_TYPE_CODE,ORG_DOC_NUM            ";
...
{10,4274,0,0,0,
5,0,0,1,91,0,2,169,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
28,0,0,2,0,0,30,178,0,0,0,0,0,1,0,
43,0,0,3,147,0,4,191,0,0,5,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
78,0,0,4,295,0,4,224,0,0,13,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
145,0,0,5,0,0,17,326,0,0,1,1,0,1,0,1,9,0,0,
164,0,0,5,0,0,45,361,0,0,11,11,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
223,0,0,5,0,0,13,395,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,4,0,0,
270,0,0,6,191,0,9,448,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,
297,0,0,7,117,0,4,453,0,0,4,3,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
328,0,0,6,0,0,13,485,0,0,3,0,0,1,0,2,9,0,0,2,3,0,0,2,4,0,0,
355,0,0,6,0,0,13,493,0,0,3,0,0,1,0,2,9,0,0,2,3,0,0,2,4,0,0,
382,0,0,6,0,0,13,503,0,0,3,0,0,1,0,2,9,0,0,2,3,0,0,2,4,0,0,
409,0,0,6,0,0,13,513,0,0,3,0,0,1,0,2,9,0,0,2,3,0,0,2,4,0,0,
436,0,0,8,0,0,27,551,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
467,0,0,9,63,0,4,563,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[4]; } p_language_id;
   ...
   /* varchar mesg2                         [20] ; */ 
struct { unsigned short len; unsigned char arr[20]; } mesg2;
...
12)";
   ...
   nd_order.arr[nd_order.len]                      = '\0';
      disp_message(INFO_MESG," Facility ID : ",nd_facility_id.arr);
}
...
{  
   /* EXEC SQL OPEN AR_REC_HDR_CUR USING 
   				   :nd_facility_id,:nd_fm_doc_date, :nd_to_doc_date,
...
declare_line_cursors()
{
         /* EXEC SQL DECLARE AR_REC_LINE_CUR CURSOR FOR
                   SELECT ORG_DOC_TYPE_CODE, ORG_DOC_NUM, AMT_LOCAL
                     FROM AR_REC_LINE
                    WHERE operating_facility_id=:nd_facility_id 
					AND DOC_TYPE_CODE = :nd_doc_type_code
...

{
       ...
       sqlstm.sqladtp = &sqladt;
       sqlstm.sqltdsp = &sqltds;
       sqlstm.stmt = "select count(*)  into :b0  from AR_REC_LINE where ((op\
erating_facility_id=:b1 and DOC_TYPE_CODE=:b2) and DOC_NUM=:b3)";
 ...
 // sprintf(mesg2, "count value %d",nd_facility_id);
  //disp_message(ERR_MESG,mesg2);
