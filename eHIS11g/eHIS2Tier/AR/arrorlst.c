...
{
    53,
    "D:\\BLTEST\\12x\\GDOH_CRF\\Edit_official_Rcpt\\arrorlst.pc"
};


static unsigned long sqlctx = 882824981;
...
ATE,SYSDATE)>=NVL(TO_DATE(:b5,'YYYYDDMM'),to_date('00010101','YYYYDDMM'))) and\
 NVL(DOC_DATE,SYSDATE)<=NVL(TO_DATE(:b6,'YYYYDDMM'),to_date('47123112','YYYYDD\
MM'))) and NVL(POSTED_FLAG,'N')='N') order by DOC_TYPE_CODE,DOC_NUM           \
 ";

 static const char *sq0005 = 
"'      ')) and DOC_TYPE_CODE<=NVL(:b2,'~~~~~~')) and DOC_NUM>=NVL(:b3,0)) an\
d DOC_NUM<=NVL(:b4,99999999)) and NVL(DOC_DATE,SYSDATE)>=NVL(TO_DATE(:b5,'YYYY\
DDMM'),to_date('00010101','YYYYDDMM'))) and NVL(DOC_DATE,SYSDATE)<=NVL(TO_DATE\
(:b6,'YYYYDDMM'),to_date('47123112','YYYYDDMM'))) and NVL(POSTED_FLAG,'N')='N'\
) order by MAIN_ACC1_CODE_BANK,MAIN_ACC2_CODE_BANK,DEPT_CODE_BANK,PRODUCT_GROU\
P_CODE_BANK,PRODUCT_LINE_CODE_BANK,SUBLEDGER_GROUP_CODE_BANK,SUBLEDGER_LINE_CO\
DE_BANK,DOC_TYPE_CODE,DOC_NUM            ";
...
80,0,0,2,0,0,30,370,0,0,0,0,0,1,0,
95,0,0,3,467,0,9,392,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,
138,0,0,5,1531,0,9,531,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
181,0,0,4,1378,0,9,535,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
224,0,0,5,0,0,13,661,0,0,48,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
431,0,0,4,0,0,13,712,0,0,48,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
638,0,0,8,0,0,27,829,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
669,0,0,9,140,0,4,839,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
700,0,0,10,118,0,4,856,0,0,4,1,0,1,0,2,3,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
731,0,0,11,128,0,4,885,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
762,0,0,12,148,0,4,962,0,0,6,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,2,4,0,0,2,9,0,0,2,
9,0,0,
801,0,0,7,118,0,9,1055,0,0,1,1,0,1,0,1,9,0,0,
820,0,0,7,0,0,13,1063,0,0,1,0,0,1,0,2,9,0,0,
839,0,0,13,245,0,4,1079,0,0,8,7,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
886,0,0,14,245,0,4,1096,0,0,8,7,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
};
...
,CONTACT_NAME_TITLE ,PRINT_FLAG ,ROWID  from AR_CASHIER where (((((((OPERATI\
NG_FACILITY_ID=:b0 and DOC_TYPE_CODE>=NVL(:b1,");
       sqlstm.stmt = sq0005;
       sqlstm.iters = (unsigned int  )1;
...
fetch_detls()
{
    /* EXEC SQL SELECT ACC_ENTITY_NAME , /oACCOUNTING_NAME,o/
