...
{
    23,
    "d:\\test\\proc\\py_post.pc"
};


static unsigned long sqlctx = 587466699;
...
RG_DOC_TYPE_CODE ,ORG_DOC_NUM ,LINE_TYPE_CODE ,NARRATION ,CONSOLIDATED_INV_YN \
 from AR_PAY_LINE where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and\
 DOC_NUM=:b2)           ";
...
{10,4274,0,0,0,
5,0,0,1,179,0,5,345,0,0,6,6,0,1,0,1,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
44,0,0,2,324,0,4,384,0,0,12,4,0,1,0,2,3,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
107,0,0,3,244,0,5,428,0,0,7,7,0,1,0,1,9,0,0,1,4,0,0,1,3,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
150,0,0,4,1027,0,3,449,0,0,37,37,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
...
313,0,0,5,355,0,3,556,0,0,17,17,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,
396,0,0,6,293,0,3,607,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
439,0,0,7,112,0,5,649,0,0,2,2,0,1,0,1,4,0,0,1,9,0,0,
462,0,0,8,112,0,5,658,0,0,2,2,0,1,0,1,4,0,0,1,9,0,0,
485,0,0,9,131,0,5,674,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
508,0,0,10,278,0,9,818,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
535,0,0,10,0,0,13,845,0,0,9,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,
586,0,0,11,334,0,9,905,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
613,0,0,11,0,0,13,950,0,0,14,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
684,0,0,12,469,0,3,1006,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
735,0,0,13,358,0,3,1065,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
802,0,0,14,359,0,3,1122,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
...
ar_pay_posting(
            ...
            passed_last_pay_doc_dt,
            passed_cheque_num,
            passed_cheque_date,
			passed_bank_desc,
			passed_facility_id) /*added by madhusudhan for GDOH-CRF-0170*/
...
strcpy(l_facility_id.arr,passed_facility_id); /*added by madhusudhan for GDOH-CRF-0170*/
...
l_facility_id.len   = strlen(l_facility_id.arr); /*added by madhusudhan for GDOH-CRF-0170*/
...
#ifdef DEBUG
   sprintf(string_var," last pay dt -> <%ld>  doc date -> <%ld>\n",
	     passed_last_pay_doc_dt,passed_doc_date_chking);
	     disp_message(INFO_MESG,string_var);
#endif
 ...
 {
#ifdef DEBUG
   disp_message(INFO_MESG,"After pay from Rc line \n");
#endif
...
/**********************************************************/
 ...
 if (strcmp(l_consolidated_yn.arr , "Y") == 0)
 {
	...
	while(fetch_alloc_pat_dtls())
	{
	  ...
	  SET PEND_AMOUNT = PEND_AMOUNT + :d_pat_abs_amount
	  WHERE OPERATING_FACILITY_ID =:l_facility_id  /oadded by madhusudhan for GDOH-CRF-0170o/
...
0) where ((((OPERATING_FACILITY_ID=:b1 and DOC_TYPE_CODE=:b2) and DOC_NUM=:b3)\
 and BILL_DOC_TYPE_CODE=:b4) and BILL_NUM=:b5)";
      ...
      sqlstm.sqhstv[0] = (         void  *)&d_pat_abs_amount;
...
from AR_PENDING_DOC where (((OPERATING_FACILITY_ID=:b8 and CUST_CODE=:b9) and \
DOC_TYPE_CODE=:b10) and DOC_NUM=:b11)";
        sqlstm.iters = (unsigned int  )1;
        ...
        sqlstm.sqhstv[8] = (         void  *)&l_facility_id;
        ...
        sqlstm.sqhstv[9] = (         void  *)&l_hdr_cust_code;
        ...
        sqlstm.sqhstv[10] = (         void  *)&l_line_org_doc_type_code;
        ...
        sqlstm.sqhstv[11] = (         void  *)&l_line_org_doc_num;
...
AST_UPD_DATE=SYSDATE where (((OPERATING_FACILITY_ID=:b3 and CUST_CODE=:b4) and\
 DOC_TYPE_CODE=:b5) and DOC_NUM=:b6)";
         sqlstm.iters = (unsigned int  )1;
         ...
         sqlstm.sqadto[4] = (unsigned short )0;
         sqlstm.sqtdso[4] = (unsigned short )0;
         sqlstm.sqhstv[5] = (         void  *)&l_line_org_doc_type_code;
         ...
         sqlstm.sqadto[5] = (unsigned short )0;
         sqlstm.sqtdso[5] = (unsigned short )0;
         sqlstm.sqhstv[6] = (         void  *)&l_line_org_doc_num;
        ...
        /*  commned by madhusudhan for gdoh-crf-0107 */
    ...
    /* EXEC SQL INSERT INTO AR_PENDING_DOC
        (
		 ...
		 MODIFIED_BY_ID,
		 MODIFIED_DATE,
		 OPERATING_FACILITY_ID /oadded by madhusudhan for GDOH-CRF-0170o/
		)
    VALUES
       (
         ...
         '6',
		  ...
		  USER,
		  SYSDATE,
         :l_facility_id /oadded by madhusudhan for GDOH-CRF-0170o/		  
         ); */ 
...
T_DOC_LINE_NUM,CUST_CODE,DOC_DATE,NARRATION,GROSS_AMT,PAYABLE_AMT,DISCOUNT_A\
MT,PENDING_AMT,ALLOCATED_AMT,CURRENCY_CODE,EXCHG_RATE,CUST_REF,MAIN_ACC1_COD\
E,MAIN_ACC2_CODE,SUBLEDGER_GROUP_CODE,SUBLEDGER_LINE_CODE,DEPT_CODE,PRODUCT_\
GROUP_CODE,PRODUCT_LINE_CODE,POST_MONTH,POST_YEAR,MISC_CUST_LONG_NAME,MISC_C\
UST_SHORT_NAME,MISC_CUST_ADD1_DESC,MISC_CUST_ADD2_DESC,MISC_CUST_ADD3_DESC,M\
ISC_CUST_ZIP_DESC,MISC_CUST_LONG_NAME_CHINESE,MISC_CUST_SHORT_NAME_CHINESE,M\
ISC_CUST_ADD1_DESC_CHINESE,MISC_CUST_ADD2_DESC_CHINESE,MISC_CUST_ADD3_DESC_C\
HINESE,MISC_CUST_ZIP_DESC_CHINESE,TEL_NUM,CONTACT_NAME,CONTACT_NAME_TITLE,TR\
N_TYPE_CODE,LAST_UPD_DATE,ADDED_BY_ID,ADDED_DATE,MODIFIED_BY_ID,MODIFIED_DAT\
E,OPERATING_FACILITY_ID) values (:b0,:b1,:b2,1,:b3,to_date(:b4,'DD/MM/YYYY')\
,:b5,:b6,:b6,0,:b6,0,:b9,:b10,:b11,:b12,:b13,:b14,:b15,:b16,:b17,:b18,:b19,:\
b20,:b21,:b22,:b23,:b24,:b25,:b26,:b27,:b28,:b29,:b30,:b31,:b32,:b33,:b34,:b\
35,'6',SYSDATE,USER,SYSDATE,USE");
    sqlstm.stmt = "R,SYSDATE,:b36)";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqhstv[36] = (         void  *)&l_facility_id;
      ...
      /* EXEC SQL INSERT INTO AR_CUST_TRN
       ...
       VALUES
          (
             ...
             to_date(:l_hdr_doc_date,'DD/MM/YYYY'),
             :l_line_narration,
             (:l_line_amt_local * -1), /o--- Added -1 by Venkat ---o/
             :l_hdr_doc_ref,
            '6',
			:l_hdr_post_month,
            :l_hdr_post_year,
...
ATE,OPERATING_FACILITY_ID) values (:b0,:b1,:b2,:b3,:b4,:b5,:b6,to_date(:b7,'DD\
/MM/YYYY'),:b8,(:b9* (-1)),:b10,'6',:b11,:b12,:b13,:b14,:b15,:b16)";
      sqlstm.iters = (unsigned int  )1;
...
/*------- Added on 30-01-1999 to Insert into Sy_Doc_Control----*/
...
/*-------------------------------------------------------------*/
   ...
   if (atol(passed_last_pay_doc_dt) > atol(passed_doc_date_chking))
   {
      /* EXEC SQL UPDATE AR_CUSTOMER
                  SET OUTSTANDING_BALANCE_AMT = 
              /o----     NVL(OUTSTANDING_BALANCE_AMT,0) -  :l_line_amt_total -----o/
			  NVL(OUTSTANDING_BALANCE_AMT,0) -  (:l_line_amt_total * -1) /o-- Added -1 by Venkat ---o/
...
TSTANDING_BALANCE_AMT,0)-(:b0* (-1))) where CUST_CODE=:b1";
      sqlstm.iters = (unsigned int  )1;
      ...
      /* EXEC SQL UPDATE AR_CUSTOMER
                  SET OUTSTANDING_BALANCE_AMT = 
                   /o     NVL(OUTSTANDING_BALANCE_AMT,0) -  :l_line_amt_total o/
						  NVL(OUTSTANDING_BALANCE_AMT,0) -  (:l_line_amt_total * -1) /o--- Added -1 by Venkat ---o/
                      /o
					  LAST_PAY_DOC_TYPE  = :l_hdr_doc_type_code,
                      LAST_PAY_DOC_NUM   = :l_hdr_doc_num,
                      LAST_PAY_DOC_DATE  = to_date(:l_hdr_doc_date,'DD/MM/YYYY')
					  o/
                WHERE CUST_CODE = :l_hdr_cust_code; */ 
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "update AR_PAY_HDR  set POSTED_FLAG='Y',INTERFACE_FLAG=DECOD\
...
ins_df_cust_pmnt_int()
{
      ...
      EXEC SQL SELECT NVL(NEXT_REF_NUM,1)
                 INTO :df_param_ref_num
                 FROM DF_PARAMETER
                  FOR UPDATE OF NEXT_REF_NUM;
 
      if (OERROR)
         err_mesg("SELECT failed on table DF_PARAMETER",0,"");
      ...
      EXEC SQL INSERT INTO DF_CUST_PMNT_INTERFACE_HDR
		...
		:l_visit_id,
                :doctor_fees_to_be_paid,
                to_date(:l_hdr_doc_date,'DD/MM/YYYY'),
                DECODE(:l_hdr_doc_ref,'CASH','1','CHEQUE','2','CREDITCARD','3'),
                USER,
                SYSDATE,
                0,
                :l_hdr_doc_type_code,
                :l_hdr_doc_num,
                DECODE(:l_hdr_doc_ref,'CASH','N','H')
              );

      if (OERROR)
         err_mesg("INSERT failed on table DF_CUST_PMNT_INTERFACE_HDR",0,"");
      ...
      EXEC SQL INSERT INTO DF_CUST_PMNT_INTERFACE_LINE
               ...
               SELECT 'AR',
                ...
                WHERE DOC_TYPE_CODE = :l_line_org_doc_type_code
                  AND DOC_NUM       = :l_line_org_doc_num;
                      
       if (OERROR)
          err_mesg("INSERT failed on table DF_CUST_PMNT_INTERFACE_LINE",0,"");
       ...
       if (sqlca.sqlerrd[2] == 0)
       {
          ...
          if (OERROR)
             err_mesg("INSERT failed on table DF_CUST_PMNT_INTERFACE_LINE - 2",
                 0,"");
       }
      ...
      if (OERROR)
         err_mesg("UPDATE failed on table DF_PARAMETER",0,"");
}
*/
/****************************************************************/
...
l_alloc_pat_dtls()
{
   ...
   /* EXEC SQL DECLARE l_alloc_pat_cur CURSOR FOR		 
		  SELECT DOC_TYPE_CODE,
              ...
              WHERE OPERATING_FACILITY_ID =:l_facility_id  /oadded by madhusudhan for GDOH-CRF-0170o/
                AND	DOC_TYPE_CODE = :l_hdr_doc_type_code
...
l_decl_line()
{
   /* EXEC SQL DECLARE L_CUR_PAY_LINE CURSOR FOR
             SELECT AMT_LOCAL,
                    LINE_NUM,
                    MAIN_ACC1_CODE,
                    MAIN_ACC2_CODE,
...

{
    ...
    if (OERROR)
         err_mesg("OPEN failed on cursor L_CUR_PAY_LINE",0,"");
}
...
#ifdef DEBUG
      disp_message(INFO_MESG,"Before fetching pay from ar_inv_line\n");
#endif

      /* EXEC SQL FETCH L_CUR_PAY_LINE
...

{
      ...
      if (OERROR)
         err_mesg("FETCH failed on cursor CUR_PAY_LINE - rc_post",0,"");
...
3,:b4,:b5,:b6,:b7,:b8,:b9,null ,(:b10* (-1)),:b11,'0',null ,:b12)";
  sqlstm.iters = (unsigned int  )1;
  ...
  /* EXEC SQL INSERT INTO GL_TXN_DOC_LINE
     ...
     VALUES
         (
           ...
           :l_line_product_line_code,
           null,
           :l_line_amt_local * -1,  /o (* -1) introduced by VSK 11/09/1999 to setright debit and credit o/
           :l_line_narration,
           :l_line_line_num,
           null,
		   :l_hdr_cust_code 
