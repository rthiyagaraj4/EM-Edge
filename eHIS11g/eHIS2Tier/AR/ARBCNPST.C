...
{
    52,
    "d:\\madhu\\billing\\sargunan\\postcreditnote\\arbcnpst.pc"
};


static unsigned long sqlctx = 1351835029;
...
"select DOC_TYPE_CODE ,DOC_NUM  from AR_CN_HDR where (((((((OPERATING_FACILIT\
...
" update of LAST_LINE_NUM nowait ";
...
ARRATION ,ROWID  from AR_CN_LINE where ((((OPERATING_FACILITY_ID=:b0 and DOC_T\
...
LAG ,PRINT_FLAG ,ROWID  from AR_CN_HDR where ((OPERATING_FACILITY_ID=:b0 and D\
...
{10,4274,0,0,0,
5,0,0,1,232,0,4,336,0,0,12,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,1,9,0,0,
68,0,0,2,97,0,4,355,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
91,0,0,3,0,0,29,506,0,0,0,0,0,1,0,
106,0,0,4,0,0,30,515,0,0,0,0,0,1,0,
121,0,0,5,0,0,30,534,0,0,0,0,0,1,0,
136,0,0,6,438,0,9,569,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
179,0,0,8,1056,0,9,702,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
206,0,0,10,0,0,29,709,0,0,0,0,0,1,0,
221,0,0,9,419,0,9,727,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
256,0,0,11,0,0,29,734,0,0,0,0,0,1,0,
271,0,0,6,0,0,13,759,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
294,0,0,7,611,0,9,846,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
321,0,0,7,0,0,13,853,0,0,26,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,
440,0,0,12,104,0,4,984,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
467,0,0,13,89,0,4,1001,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
494,0,0,8,0,0,13,1272,0,0,44,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
685,0,0,9,0,0,13,1455,0,0,17,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,
768,0,0,14,70,0,2,1549,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
791,0,0,15,71,0,2,1556,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
814,0,0,16,183,0,3,1655,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
865,0,0,17,183,0,3,1730,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
916,0,0,18,52,0,5,1765,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
939,0,0,19,60,0,2,1778,0,0,1,1,0,1,0,1,9,0,0,
958,0,0,20,0,0,29,1785,0,0,0,0,0,1,0,
973,0,0,21,0,0,27,1796,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
1004,0,0,22,118,0,4,1813,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
1035,0,0,23,62,0,6,1825,0,0,1,1,0,1,0,2,9,0,0,
1054,0,0,24,44,0,4,1831,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1077,0,0,25,44,0,4,1835,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1100,0,0,26,84,0,4,1873,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
1123,0,0,27,140,0,4,1884,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
};
...

{
      ...
      sqlstm.sqltdsp = &sqltds;
      sqlbuft((void **)0, 
        "select ACC_ENTITY_CODE ,DOC_TYPE_CODE ,DOC_NUM ,ORG_DOC_TYPE_CODE ,\
ORG_DOC_NUM ,NVL(LAST_LINE_NUM,0) ,NVL(CUST_CODE,' ') ,NVL(NARRATION,' ') ,B\
ASE_DATE ,TO_CHAR(BASE_DATE,'YYYYMMDD') ,DUE_DATE ,TO_CHAR(DUE_DATE,'YYYYMMD\
D') ,NVL(GROSS_AMT,0) ,NVL(GROSS_AMT,0) ,NVL(PAYABLE_AMT,0) ,NVL(PAYABLE_AMT\
,0) ,NVL(DISCOUNT_AMT,0) ,NVL(DOC_AMT,0) ,NVL(DOC_AMT,0) ,NVL(CURRENCY_CODE,\
' ') ,NVL(EXCHG_RATE,0) ,NVL(PMNT_TERMS_CODE,' ') ,SETTLEMENT_DATE ,TO_CHAR(\
SETTLEMENT_DATE,'YYYYMMDD') ,NVL(SETTLEMENT_PERC,0) ,NVL(CUST_REF,' ') ,NVL(\
PATIENT_ID,' ') ,NVL(BILLING_GROUP,' ') ,NVL(BILL_DOC_TYPE_CODE,' ') ,NVL(BI\
LL_NUM,0) ,BILL_DATE ,TO_CHAR(BILL_DATE,'YYYYMMDD') ,NVL(DOCTOR_FEE_AMT,0) ,\
NVL(MAIN_ACC1_CODE,' ') ,NVL(MAIN_ACC2_CODE,' ') ,NVL(SUBLEDGER_GROUP_CODE,'\
 ') ,NVL(SUBLEDGER_LINE_CODE,' ') ,NVL(DEPT_CODE,' ') ,NVL(PRODUCT_GROUP_COD\
E,' ') ,NVL(PRODUCT_LINE_CODE,' ') ,NVL(POST_MONTH,0) ,NVL(POST_YEAR,0) ,ROW\
ID ,CONSOLIDATED_INV_YN  from AR_CN_INV_HDR where ((OPERATING_FACILITY_ID=:b\
0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2) for");
      sqlstm.stmt = sq0008;
      sqlstm.iters = (unsigned int  )1;
