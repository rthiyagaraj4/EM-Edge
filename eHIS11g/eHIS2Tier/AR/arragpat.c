...
{
    56,
    "D:\\BLTEST\\11g\\Sankara@08072015\\64bit\\SCF-116\\arragpat.pc"
};


static unsigned long sqlctx = 2012651893;
...
{10,4274,0,0,0,
5,0,0,1,69,0,4,224,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
28,0,0,2,91,0,2,336,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
51,0,0,3,0,0,30,345,0,0,0,0,0,1,0,
66,0,0,4,200,0,4,360,0,0,7,2,0,1,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,
0,0,1,9,0,0,
109,0,0,5,509,0,4,399,0,0,19,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
200,0,0,6,373,0,9,751,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
231,0,0,7,569,0,9,770,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
266,0,0,8,277,0,9,792,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
297,0,0,8,0,0,13,831,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
320,0,0,10,63,0,4,845,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
343,0,0,6,0,0,13,882,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
366,0,0,11,63,0,4,895,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
389,0,0,7,569,0,9,928,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
424,0,0,9,569,0,9,935,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
459,0,0,7,0,0,13,967,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,
3,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,3,0,0,
518,0,0,9,0,0,13,988,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,
3,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,3,0,0,
577,0,0,12,278,0,4,1039,0,0,7,4,0,1,0,2,4,0,0,2,3,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,
620,0,0,13,69,0,4,1170,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
643,0,0,14,0,0,27,1465,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
};
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='ARRAGSUP' and\
...
TO_NUMBER(PARAM7),0) ,NVL(TO_NUMBER(PARAM8),0) ,NVL(TO_NUMBER(PARAM9),0) ,NVL(\
TO_NUMBER(PARAM10),0) ,NVL(TO_NUMBER(PARAM11),0) ,PARAM12 ,PARAM13 ,NVL(PARAM1\
4,'!!!!!!!!!!') ,NVL(PARAM15,'~~~~~~~~~~') ,PARAM16 into :b0,:b1,:b2,:b3,:b4,:\
b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,:b13,:b14,:b15,:b16  from SY_PROG_PARAM wher\
e ((PGM_ID='ARRAGSUP' and SESSION_ID=:b17) and PGM_DATE=:b18)";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqhstv[14] = (         void  *)&nd_fm_pat_id;
   ...
   sqlstm.sqhstv[15] = (         void  *)&nd_to_pat_id;
   ...
   sqlstm.sqhstv[16] = (         void  *)&nd_overdue;
   ...
   sqlstm.sqhstl[18] = (unsigned int  )37;
