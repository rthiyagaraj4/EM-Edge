...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/AR/Arropdoc.pc"
};


static unsigned int sqlctx = 1288486563;
...
P_CODE ,PRODUCT_LINE_CODE ,SUBLEDGER_GROUP_CODE ,SUBLEDGER_LINE_CODE ,ROWID ,D\
OC_DATE ,NARRATION ,POST_MONTH ,POST_YEAR ,TRN_TYPE_CODE ,NVL(CONSOLIDATED_INV\
_YN,'N')  from AR_PENDING_DOC_TEMP where (CUST_CODE>=nvl(:b0,'        ') and C\
UST_CODE<=nvl(:b1,'~~~~~~~~')) order by DOC_TYPE_CODE,DOC_NUM            ";
...
_TRN_TEMP where (ORG_DOC_TYPE_CODE=:b0 and ORG_DOC_NUM=:b1) order by DOC_TYPE_\
CODE,DOC_NUM  for update of LINE_NUM nowait ";

 static const char *sq0018 = 
"select DOC_TYPE_CODE ,DOC_NUM ,PATIENT_ID ,BILL_DOC_TYPE_CODE ,BILL_NUM ,TO_\
CHAR(BILL_DATE,'YYYYMMDD') ,REMARKS ,NVL(AMOUNT,0) ,TO_CHAR(TO_DATE(:b0),'YYYY\
MMDD') ,ROWID  from AR_PATIENT_DTLS where (DOC_TYPE_CODE=:b1 and DOC_NUM=:b2) \
order by BILL_DATE,PATIENT_ID  for update of LINE_NUM nowait ";
...
{12,4274,178,0,0,
5,0,0,1,157,0,4,221,0,0,6,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,1,9,
0,0,
44,0,0,2,96,0,4,259,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
67,0,0,3,0,0,29,313,0,0,0,0,0,1,0,
82,0,0,4,0,0,30,320,0,0,0,0,0,1,0,
97,0,0,5,0,0,30,335,0,0,0,0,0,1,0,
112,0,0,6,118,0,4,350,0,0,4,1,0,1,0,2,3,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
143,0,0,7,62,0,6,361,0,0,1,1,0,1,0,2,9,0,0,
162,0,0,8,44,0,4,367,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
185,0,0,9,44,0,4,371,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
208,0,0,10,461,0,9,499,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
231,0,0,10,0,0,13,555,0,0,21,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
330,0,0,15,113,0,9,618,0,0,1,1,0,1,0,1,9,0,0,
349,0,0,15,0,0,13,628,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
372,0,0,17,101,0,9,653,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
395,0,0,17,0,0,13,658,0,0,1,0,0,1,0,2,9,0,0,
414,0,0,11,105,0,9,671,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
437,0,0,11,0,0,13,676,0,0,1,0,0,1,0,2,9,0,0,
456,0,0,12,85,0,9,687,0,0,1,1,0,1,0,1,9,0,0,
475,0,0,12,0,0,13,698,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
498,0,0,13,79,0,9,716,0,0,1,1,0,1,0,1,9,0,0,
517,0,0,13,0,0,13,723,0,0,1,0,0,1,0,2,9,0,0,
536,0,0,19,71,0,4,744,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
559,0,0,20,62,0,4,763,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
582,0,0,14,198,0,9,784,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
605,0,0,21,0,0,29,790,0,0,0,0,0,1,0,
620,0,0,14,0,0,13,812,0,0,5,0,0,1,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,9,0,0,
655,0,0,18,293,0,9,835,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
682,0,0,22,0,0,29,841,0,0,0,0,0,1,0,
697,0,0,18,0,0,13,873,0,0,10,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,4,0,0,2,3,0,0,2,9,0,0,
752,0,0,23,62,0,4,909,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
775,0,0,15,113,0,9,928,0,0,1,1,0,1,0,1,9,0,0,
794,0,0,15,0,0,13,938,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
817,0,0,24,56,0,5,969,0,0,2,2,0,1,0,1,3,0,0,1,9,0,0,
840,0,0,15,113,0,9,986,0,0,1,1,0,1,0,1,9,0,0,
859,0,0,15,0,0,13,996,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
882,0,0,17,101,0,9,1025,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
905,0,0,17,0,0,13,1030,0,0,1,0,0,1,0,2,9,0,0,
924,0,0,16,84,0,9,1043,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
947,0,0,16,0,0,13,1047,0,0,1,0,0,1,0,2,9,0,0,
966,0,0,25,126,0,3,1137,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1001,0,0,26,126,0,3,1208,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1036,0,0,27,62,0,5,1229,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1059,0,0,0,0,0,27,1241,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
1090,0,0,29,67,0,2,1301,0,0,0,0,0,1,0,
1105,0,0,30,0,0,29,1308,0,0,0,0,0,1,0,
};
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select ROWID into :b0  from AR_PENDING_DOC_TEMP where\
 ROWID=:b0 for update of ERROR_FLAG nowait ";
        sqlstm.iters = (unsigned int  )1;
...
//             if ((ar_pat_line_num != 1) &&
               if (doubcmp(ar_pat_tot_amt,d_pend_pending_amt) != 0)
...
declare_cursor()
{
   ...
   /* EXEC SQL DECLARE AR_PATIENT_DTLS_CUR CURSOR FOR
             SELECT DOC_TYPE_CODE,
                    ...
                    REMARKS,
                    NVL(AMOUNT,0),
                    TO_CHAR(TO_DATE(:d_pend_doc_date),'YYYYMMDD'),
                    ROWID
...

{
          ...
          sqlstm.sqladtp = &sqladt;
          sqlstm.sqltdsp = &sqltds;
          sqlstm.stmt = "select 'X' into :b0  from MP_PATIENT_MAST where PAT\
IENT_ID=:b1";
          sqlstm.iters = (unsigned int  )10;
...
struct { unsigned short len; unsigned char arr[71]; } l_ar_doc_error_text;
   ...
   if (strcmp(ar_err_code.arr,"AR1200") == 0)
   {
       ...
       //put_comma(l_ch_payable_amt);
       //put_comma(l_ch_tot_amt);
   ...
   /* EXEC SQL INSERT INTO AR_DOC_ERROR
                   (PGM_ID,
                    ...
                    LINE_NUM,         ERROR_CODE,
                    ERROR_TEXT)
            VALUES ('ARROPDOC',:d_pend_doc_type_code,   :d_pend_doc_num,
...
E_NUM,ERROR_CODE,ERROR_TEXT) values ('ARROPDOC',:b0,:b1,:b2,:b3,:b4)";
   sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "update AR_PENDING_DOC_TEMP  set ERROR_FLAG=:b0 where ROWID\
=:b1";
   sqlstm.iters = (unsigned int  )1;
   ...
   if (OERROR)
        err_mesg("UPDATE failed on table AR_INV_HDR...");
...
run_report()
{
  ...
  sprintf(l_run_string,"r25run32 %s %s no \
  batch=yes desname=arropdoc.lis session_id=%s pgm_date=%s PGM_ID=%s",
  "arropdoc",uid_pwd.arr,nd_session_id.arr,g_pgm_date,"ARROPDOC");
...

{
       ...
       sqlstm.sqladtp = &sqladt;
       sqlstm.sqltdsp = &sqltds;
       sqlstm.stmt = "delete  from AR_DOC_ERROR  where (PGM_ID='ARROPDOC' an\
d ROWNUM<500)";
       sqlstm.iters = (unsigned int  )1;
