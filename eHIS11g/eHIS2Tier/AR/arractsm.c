...
{
    125,
    "C:\\Users\\mbothra\\Desktop\\abhinav_proc_wokr\\tocheck and change-pending for 107.6and 7\\11g_Regular_source\\arracatsm\\arractsm.pc"
};


static unsigned long sqlctx = 2026451213;
...
m AR_CUSTOMER A ,AR_CUST_TRN B where ((((b.operating_facility_id=:b0 and A.CUS\
T_CODE=B.CUST_CODE(+)) and (LTRIM(TO_CHAR(B.POST_YEAR(+),'0009'))||LTRIM(TO_CH\
AR(B.POST_MONTH(+),'09'))) between (:b1||:b2) and (:b3||:b4)) and A.CUST_CODE(\
+) between :b5 and :b6) and B.DOC_DATE(+) between TO_DATE(:b7,'YYYYMMDD') and \
TO_DATE(:b8,'YYYYMMDD')) group by A.CUST_CODE,A.SHORT_NAME,B.TRN_TYPE_CODE ord\
er by A.CUST_CODE,B.TRN_TYPE_CODE            ";

 static const char *sq0006 = 
"select NVL(sum(AMOUNT),0)  from AR_CUST_TRN where ((operating_facility_id=:b\
0 and CUST_CODE=:b1) and (POST_YEAR<:b2 or (POST_YEAR=:b2 and POST_MONTH<:b4))\
)           ";
...
64,0,0,2,249,0,4,257,0,0,9,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,3,0,0,1,9,0,0,
115,0,0,3,91,0,2,334,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
138,0,0,4,0,0,30,346,0,0,0,0,0,1,0,
153,0,0,5,511,0,9,565,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
204,0,0,6,166,0,9,574,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
239,0,0,5,0,0,13,603,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,
270,0,0,6,0,0,13,638,0,0,1,0,0,1,0,2,4,0,0,
289,0,0,7,0,0,27,1233,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
320,0,0,5,0,0,15,1243,0,0,0,0,0,1,0,
};
...
declare_cursors()
{
   ...
   /* EXEC SQL DECLARE OPEN_BAL_CUR CURSOR FOR
	    ...
	    FROM    AR_CUST_TRN
	    WHERE operating_facility_id=:nd_facility_id /oadded for GDOH-CRF-107.7o/ 
...

{
    ...
    sqlstm.sqadto[4] = (unsigned short )0;
    sqlstm.sqtdso[4] = (unsigned short )0;
    sqlstm.sqhstv[5] = (         void  *)&nd_fm_cust_code;
    ...
    sqlstm.sqadto[6] = (unsigned short )0;
    sqlstm.sqtdso[6] = (unsigned short )0;
    sqlstm.sqhstv[7] = (         void  *)&nd_fm_doc_date;
    ...
    sqlstm.sqadto[7] = (unsigned short )0;
    sqlstm.sqtdso[7] = (unsigned short )0;
    sqlstm.sqhstv[8] = (         void  *)&nd_to_doc_date;
