...
{
    48,
    "E:\\Work Gdoh\\CRF-AR-Reports\\ARRSTMT2\\Arrstmt2.pc"
};


static unsigned long sqlctx = 1246295413;
...
{10,4130,0,0,0,
5,0,0,1,384,0,4,270,0,0,23,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
...
112,0,0,2,90,0,2,419,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
135,0,0,3,0,0,30,431,0,0,0,0,0,1,0,
150,0,0,4,249,0,4,448,0,0,9,2,0,1,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
201,0,0,5,166,0,4,469,0,0,6,1,0,1,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,1,
9,0,0,
240,0,0,6,1084,0,9,641,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
311,0,0,7,1110,0,9,647,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
382,0,0,6,0,0,13,683,0,0,12,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,1,0,0,2,1,0,0,2,9,0,0,
445,0,0,7,0,0,13,701,0,0,12,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,1,0,0,2,1,0,0,2,9,0,0,
508,0,0,8,1054,0,9,736,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
539,0,0,8,0,0,13,807,0,0,32,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
682,0,0,11,278,0,4,920,0,0,5,4,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
717,0,0,9,119,0,9,961,0,0,1,1,0,1,0,1,9,0,0,
736,0,0,9,0,0,13,966,0,0,1,0,0,1,0,2,9,0,0,
755,0,0,10,0,0,13,990,0,0,5,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,
790,0,0,10,327,0,9,1101,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
821,0,0,12,0,0,27,1368,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
};
...
struct { unsigned short len; unsigned char arr[35]; } nd_pgm_date;
   ...
   /* VARCHAR nd_facility_id                [3],
		   ...
		   d_misc_cust_short_name		 [101],    /o  CRF-0120  o/
...
struct { unsigned short len; unsigned char arr[9]; } d_ar_pend_tran_desc;
...
DAYS_AGE_SLOT_4 ,DAYS_AGE_SLOT_5 into :b0,:b1,:b2,:b3,:b4  from AR_PARAMETER w\
here OPERATING_FACILITY_ID=:b5";
   sqlstm.iters = (unsigned int  )1;
...
declare_cursors()
{
    ...
    /* EXEC SQL DECLARE AR_PENDING_DOC_CUR CURSOR FOR
			...
			decode(trn_type_code,'1','INVOICE','2','DEBIT  ','3','CREDIT ','4','ADJUST ','5','RECEIPT','6','REFUND ',' ')
                FROM AR_PENDING_DOC
               WHERE  OPERATING_FACILITY_ID = :nd_facility_id /oADDED FOR GDOH-CRF-0107o/
...

{
    ...
    sqlstm.sqltdsp = &sqltds;
    sqlbuft((void **)0, 
      "select DOC_TYPE_CODE ,DOC_NUM ,TO_CHAR(DOC_DATE,'DD/MM/YYYY') ,BILL_N\
UM ,BILL_DOC_TYPE_CODE ,PATIENT_ID ,CUST_REF ,NVL(CEIL((TO_DATE(:b0,'DD/MM/Y\
YYY')-NVL(BASE_DATE,DOC_DATE))),0) ,NVL(PENDING_AMT,0) ,NVL(PAYABLE_AMT,0) ,\
(NVL(PENDING_AMT,0)-NVL(PAYABLE_AMT,0)) ,SIGN(PENDING_AMT) ,DECODE(SIGN(NVL(\
PENDING_AMT,0)),(-1),(-NVL(PENDING_AMT,0)),NVL(PENDING_AMT,0)) ,MISC_CUST_LO\
NG_NAME ,MISC_CUST_SHORT_NAME ,MISC_CUST_ADD1_DESC ,MISC_CUST_ADD2_DESC ,MIS\
C_CUST_ADD3_DESC ,MISC_CUST_ZIP_DESC ,MISC_CUST_LONG_NAME_CHINESE ,MISC_CUST\
_SHORT_NAME_CHINESE ,MISC_CUST_ADD1_DESC_CHINESE ,MISC_CUST_ADD2_DESC_CHINES\
E ,MISC_CUST_ADD3_DESC_CHINESE ,MISC_CUST_ZIP_DESC_CHINESE ,CONTACT_NAME ,CO\
NTACT_NAME_TITLE ,TEL_NUM ,BILL_TYPE_CODE ,TO_CHAR(DUE_DATE,'DD/MM/YYYY') ,N\
ARRATION ,decode(trn_type_code,'1','INVOICE','2','DEBIT  ','3','CREDIT ','4'\
,'ADJUST ','5','RECEIPT','6','REFUND ',' ')  from AR_PENDING_DOC where ((OPE\
RATING_FACILITY_ID=:b1 and CUST_CODE=:b2) and NVL(DOC_DATE,BASE_DATE)<=TO_DA\
TE(:b0,'DD/MM/YYYY')) order by DOC_DATE,DOC");
    sqlstm.stmt = sq0008;
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (         void  *)&d_cust_cust_code;
...

{
    ...
    sqlstm.sqhstv[31] = (         void  *)&d_ar_pend_tran_desc;
