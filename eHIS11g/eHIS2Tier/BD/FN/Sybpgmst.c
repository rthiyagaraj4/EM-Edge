...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/FN/Sybpgmst.pc"
};


static unsigned int sqlctx = 1288529099;
...
"select DOC_TYPE_CODE ,ENTITY_OR_FACILITY_BASED  from SY_DOC_TYPE_MASTER wher\
e STATUS='S' for update of STATUS ";

 static const char *sq0007 = 
"select 'X'  from SY_ACC_ENTITY_DOC_TYPE where DOC_TYPE_CODE=:b0           ";

 static const char *sq0010 = 
"select DOC_TYPE_CODE  from SY_ACC_ENTITY_DOC_TYPE where (STATUS='S' and ACC_\
ENTITY_CODE=:b0)           ";

 static const char *sq0012 = 
"select 'X'  from AR_TRN_DOC_TYPE where DOC_TYPE_CODE=:b0           ";

 static const char *sq0013 = 
"select 'X'  from AP_TRN_DOC_TYPE where DOC_TYPE_CODE=:b0           ";

 static const char *sq0014 = 
"select 'X'  from BL_TRN_DOC_TYPE where DOC_TYPE_CODE=:b0           ";

 static const char *sq0015 = 
"select 'X'  from GL_TXN_DOC_HDR where DOC_TYPE_CODE=:b0           ";

 static const char *sq0016 = 
"select 'X'  from SY_DOC_CONTROL where DOC_TYPE_CODE=:b0           ";
...
{12,4274,178,0,0,
5,0,0,0,0,0,27,85,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,141,0,4,97,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
71,0,0,3,0,0,30,125,0,0,0,0,0,1,0,
86,0,0,4,54,0,1,133,0,0,0,0,0,1,0,
101,0,0,5,58,0,1,140,0,0,0,0,0,1,0,
116,0,0,6,110,0,9,158,0,0,0,0,0,1,0,
131,0,0,7,74,0,9,167,0,0,1,1,0,1,0,1,9,0,0,
150,0,0,7,0,0,13,171,0,0,1,0,0,1,0,2,1,0,0,
169,0,0,8,56,0,2,184,0,0,1,1,0,1,0,1,9,0,0,
188,0,0,9,58,0,1,200,0,0,0,0,0,1,0,
203,0,0,10,103,0,9,213,0,0,1,1,0,1,0,1,9,0,0,
222,0,0,11,103,0,2,222,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
245,0,0,6,0,0,13,237,0,0,2,0,0,1,0,2,9,0,0,2,1,0,0,
268,0,0,10,0,0,13,256,0,0,1,0,0,1,0,2,9,0,0,
287,0,0,12,67,0,9,280,0,0,1,1,0,1,0,1,9,0,0,
306,0,0,12,0,0,13,285,0,0,1,0,0,1,0,2,1,0,0,
325,0,0,13,67,0,9,307,0,0,1,1,0,1,0,1,9,0,0,
344,0,0,13,0,0,13,312,0,0,1,0,0,1,0,2,1,0,0,
363,0,0,14,67,0,9,335,0,0,1,1,0,1,0,1,9,0,0,
382,0,0,14,0,0,13,340,0,0,1,0,0,1,0,2,1,0,0,
401,0,0,15,66,0,9,363,0,0,1,1,0,1,0,1,9,0,0,
420,0,0,15,0,0,13,368,0,0,1,0,0,1,0,2,1,0,0,
439,0,0,16,66,0,9,392,0,0,1,1,0,1,0,1,9,0,0,
458,0,0,16,0,0,13,397,0,0,1,0,0,1,0,2,1,0,0,
477,0,0,17,54,0,3,458,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
512,0,0,18,91,0,2,475,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[8]; } d_dept_code;

struct { unsigned short len; unsigned char arr[42]; } d_master_code;

struct { unsigned short len; unsigned char arr[4]; } d_group_code;

struct { unsigned short len; unsigned char arr[4]; } d_oper_dept_group_code;
...
struct { unsigned short len; unsigned char arr[5]; } d_oper_dept_code;

struct { unsigned short len; unsigned char arr[60]; } d_table_name;

struct { unsigned short len; unsigned char arr[71]; } d_msg_text;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select PARAM1 ,PARAM2 ,PARAM3 into :b0,:b1,:b2  from SY_PROG\
_PARAM where ((PGM_ID='SYBPGMST' and PGM_DATE=:b3) and SESSION_ID=TO_NUMBER(:b\
4))";
 ...
 sqlstm.sqhstv[2] = (         void  *)&d_entity_code;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "lock TABLE SY_DOC_TYPE_MASTER IN EXCLUSIVE MODE NOWAIT";
   sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "lock TABLE SY_ACC_ENTITY_DOC_TYPE IN EXCLUSIVE MODE NOWAIT";
   sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "delete  from SY_DOC_TYPE_MASTER  where DOC_TYPE_CODE=:b0";
  sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqcmod = (unsigned int )0;
    sqlstm.sqhstv[0] = (         void  *)&d_entity_code;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "delete  from SY_ACC_ENTITY_DOC_TYPE  where ((DOC_TYPE_CODE\
=:b0 and ACC_ENTITY_CODE=:b1) and STATUS='S')";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&d_entity_code;
...

{
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (         void  *)&entity_facility_flag;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into SY_PURGE_MSG  values (:b0,:b1,:b2,:b3,:b4)";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (         void  *)&d_master_code;
    sqlstm.sqhstl[2] = (unsigned int  )44;
    sqlstm.sqhsts[2] = (         int  )0;
    sqlstm.sqindv[2] = (         void  *)0;
    sqlstm.sqinds[2] = (         int  )0;
    sqlstm.sqharm[2] = (unsigned int  )0;
    sqlstm.sqadto[2] = (unsigned short )0;
    sqlstm.sqtdso[2] = (unsigned short )0;
    sqlstm.sqhstv[3] = (         void  *)&d_msg_num;
    ...
    sqlstm.sqadto[3] = (unsigned short )0;
    sqlstm.sqtdso[3] = (unsigned short )0;
    sqlstm.sqhstv[4] = (         void  *)&d_msg_text;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='SYBPGMST' and PG\
