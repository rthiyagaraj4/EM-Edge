...
<table width='80%' align='center' valign='top'>
	...
	<tr>												   
		<td width="100%" class="Border" >
				...
				<tr>
						<td class="label"><fmt:message key="Common.RequestMode.label" bundle="${common_labels}"/></td>
			...
			<tr>
					...
					<td class='fields' ><select name='p_order_by' id='p_order_by' tabIndex='4'>
						<option value='1'><fmt:message key="Common.RequestMode.label" bundle="${common_labels}"/> </option>
						<option value='2'><fmt:message key="eFM.RequestModeDescription.label" bundle="${fm_labels}"/></option>
						</select>
					</td>
				</tr>
		</table>
