...
<body onMouseDown='CodeArrest()' onLoad='FocusFirstElement()' onKeyDown = 'lockKey();'>
	...
	<tr>
		...
		<td class='fields'><input type='text' id="fm_date" name='p_fm_date' id='p_fm_date' size='10' maxlength='10' onblur='validDateObj(this,"DMY","<%=localeName%>");'><input type="image" src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('fm_date');"></td>
		<td  class='label'>&nbsp;</td>
		<td class='fields'><input type='text' id="to_date" name='p_to_date' id='p_to_date' size='10' maxlength='10' onblur='validDateObj(this,"DMY","<%=localeName%>");'><input type="image" src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('to_date');"></td>
	</tr>
