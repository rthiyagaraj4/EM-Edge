	...
	<BODY onMouseDown="CodeArrest();" onKeyDown = 'lockKey();'>
		<FORM>
			<TABLE border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
				...
				<TR>
					<TD class='label' width='20%' ><fmt:message key="Common.documenttype.label" bundle="${common_labels}"/></TD>
			...
			<TABLE border='1' cellpadding='0' cellspacing='0' width='100%' align='center' id='tab1' style="visibility:hidden">
				<TR>
					...
					<Td class='columnheader' width='25%'><fmt:message key="eFM.FSLocation.label" bundle="${fm_labels}"/></Td>
