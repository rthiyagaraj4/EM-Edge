...
%>
	 <iframe name='commontoolbarFrame' id='commontoolbarFrame' src='<%=source%>' frameborder='0' scrolling=no noresize style='height:7vh;width:100vw'></iframe>
 		 <iframe name='autotracktoopd' id='autotracktoopd' src='../../eFM/jsp/FMAutoTrackOutToOPDMain.jsp?userSecurity=<%=userSecurity%>&access_all=<%=access_all%>' frameborder=0 scrolling='no' style="height: 84vh; width: 100vw; margin-left: 20px;"></iframe>
