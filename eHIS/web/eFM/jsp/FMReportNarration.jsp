...
<table width='80%' align='center' valign='top'>
	...
	<tr>
		...
		<td width="100%" class="Border" align='center'>
				...
				<tr>
						<td class="label"><fmt:message key="eFM.NarrationCode.label" bundle="${fm_labels}"/></td>
				...
				<tr>
					...
					<td  class='fields'><select name='p_order_by' id='p_order_by' tabIndex='4'>
						<option value='1'><fmt:message key="eFM.NarrationCode.label" bundle="${fm_labels}"/>
						<option value='2'><fmt:message key="eFM.NarrationDescription.label" bundle="${fm_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
