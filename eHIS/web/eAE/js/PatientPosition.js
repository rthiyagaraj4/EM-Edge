function onSuccess() 
 {
  	 if(f_query_add_mod.document.patient_position_form.mode.value=="INSERT")
	 {
		f_query_add_mod.document.patient_position_form.pat_position_code.value   = "";
		f_query_add_mod.document.patient_position_form.short_desc.value			= "";
		f_query_add_mod.document.patient_position_form.long_desc.value			= "";
		f_query_add_mod.document.patient_position_form.eff_status.checked			= true;
		f_query_add_mod.document.patient_position_form.pat_position_code.focus();
	 }
	 else
	 {
...
function create()
{
    f_query_add_mod.location.href ="../../eAE/jsp/addModifyPatientPosition.jsp" ;
}

function query()
 {
	f_query_add_mod.location.href ="../../eAE/jsp/PatientPositionQueryCriteria.jsp" ;
 }
function reset() 
  {
