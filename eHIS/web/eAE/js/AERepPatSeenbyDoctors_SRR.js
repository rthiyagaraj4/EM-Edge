...
var fields = new Array (f_query_add_mod.document.RepPatSeenbyDoctors.p_fm_pat_seen_date1,f_query_add_mod.document.RepPatSeenbyDoctors.p_to_pat_seen_date1);
...
var locale=f_query_add_mod.document.RepPatSeenbyDoctors.locale.value;
...
if(f_query_add_mod.document.RepPatSeenbyDoctors){
  if(f_query_add_mod.checkFields( fields, names, messageFrame)){
	  ...
	  if(f_query_add_mod.isBeforeNow(f_query_add_mod.document.RepPatSeenbyDoctors.p_fm_pat_seen_date1.value,"DMY",locale)){
			 if(f_query_add_mod.isBeforeNow(f_query_add_mod.document.RepPatSeenbyDoctors.p_to_pat_seen_date1.value,"DMY",locale)){
					if(f_query_add_mod.isBefore(f_query_add_mod.document.RepPatSeenbyDoctors.p_fm_pat_seen_date1.value,f_query_add_mod.document.RepPatSeenbyDoctors.p_to_pat_seen_date1.value,"DMY",locale)){
					
					f_query_add_mod.document.RepPatSeenbyDoctors.p_fm_pat_seen_date.value=convertDate(f_query_add_mod.document.RepPatSeenbyDoctors.p_fm_pat_seen_date1.value,"DMY",f_query_add_mod.document.RepPatSeenbyDoctors.locale.value,"en");
					f_query_add_mod.document.RepPatSeenbyDoctors.p_to_pat_seen_date.value=
					convertDate(f_query_add_mod.document.RepPatSeenbyDoctors.p_to_pat_seen_date1.value,"DMY",f_query_add_mod.document.RepPatSeenbyDoctors.locale.value,"en");
