...
function create() {
	f_query_add_mod.location.href = "../../eAE/jsp/AddModifyDisasterCategory.jsp";
}
...
function query() {
	f_query_add_mod.location.href = "../../eAE/jsp/QueryDisasterCategory.jsp";
}
...
function apply() {
	...
	var fields = new Array(
			f_query_add_mod.document.disaster_category_form.disaster_catg_code,
			f_query_add_mod.document.disaster_category_form.long_desc,
			f_query_add_mod.document.disaster_category_form.short_desc);
	...
	if (f_query_add_mod.SpecialCharCheck(splField, splFieldName, messageFrame,
		...
		if (f_query_add_mod.checkFieldsofMst(fields, names, messageFrame)) {
			var disaster_catg_param = f_query_add_mod.document.disaster_category_form.disaster_catg_param.value;
			if (disaster_catg_param == 'Y') {
				f_query_add_mod.document.disaster_category_form.submit();
			} else {
