...
%>
	<iframe name='commontoolbarFrame' id='commontoolbarFrame' src='<%=source%>' frameborder='0' scrolling='no' noresize style='height:8vh;width:100vw'></iframe>		
		<iframe name='AECancelCkoutTrans' id='AECancelCkoutTrans' src='../../eOP/jsp/OPCancelCheckoutSearchCriteria.jsp?module_id=<%=module_id%>&function_id=<%=function_id%>&oper_stn_id=<%=OsVal%>&patient_id_length=<%=patient_id_length%>' frameborder=0 scrolling='no' noresize style='height:25vh;width:100vw'></iframe>
