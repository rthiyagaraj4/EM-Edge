...
<%@ page import="java.sql.*, java.util.*, java.text.*,webbeans.eCommon.*,webbeans.op.CurrencyFormat,blopin.*,com.ehis.util.*,eCommon.Common.*,eOP.*,org.json.simple.parser.JSONParser,org.json.simple.*,eCommon.XSSRequestWrapper" contentType="text/html;charset=UTF-8"%>
	   ...
	   <table border="0" cellpadding="2" cellspacing="0" align='center' width='92%'>
		  <tr>
		   ...
		   %>
			<tr>
			  ...
			  <input type='hidden'  name="sysDateSer" id="sysDateSer"  value="<%=sysDateSer%>">
         ...
         <!--  added for PMG2014-HSA-CRF-0001 [IN:050020] --> 
		  ...
		  <tr>
			  ...
			  <input type='hidden'  name="blood_group" id="blood_group"  value="<%=blood_group_code%>">
              ...
              <input type='hidden'  name="rh_factor" id="rh_factor"  value="<%=rh_factor_code%>">
	      </tr>	
       
         <tr>
			 <td  class=label colspan='3'></td>
			 <td class='label' ><input type='button' class='button' name='contact_details' id='contact_details' value='<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ContactDetails.label","common_labels")%>'  onclick="Modal_Contact_Details(this);" id = '' ><input type="hidden" name='hdddob' id='hdddob' value =      '<%=date_of_birth%>'></td> 
		...
		<tr>
		  ...
		  <tr>
			  <input type='hidden' name='StartDate1' id='StartDate1' value="<%=StartDate1%>"></input>
              <input type='hidden' name='AllowedDate' id='AllowedDate' value="<%=AllowedDate%>"></input>
              <input type='hidden' name='to_service' id='to_service' value="<%=to_service_code%>"></input>
		      <td class='LABEL'  width='25%' ><fmt:message key="Common.VisitDateTime.label" bundle="${common_labels}"/></td>
				...
				<% if (visit_back_yn.equalsIgnoreCase("Y")) { %>
					 <input type='text'   name="visit_date_time" id="visit_date_time"  value="<%=sysdate%>" maxLength='19' size='19' onBlur='chkFromToTime2(this);' ><img src="../../eCommon/images/CommonCalendar.gif"  onClick="return showCalendar('regndatetime','dd/mm/yyyy' ,'hh:mm:ss',null );" style='cursor:pointer'></img>&nbsp;<img src='../../eCommon/images/mandatory.gif' ></img>
                <% } else { %><input type='text'  name="visit_date_time" id="visit_date_time"  value="<%=sysdate%>" maxLength='19' size='19' readonly ><%}%>
              </td>
			<!--Added by Kamatchi S for ML-MMOH-CRF-1609--> 
			  ...
			  <td class='fields' width='25%'><input type='text' size='15' name="followup_enc" id="followup_enc" value="<%=enc_id%>" disabled>&nbsp;<input type='button' name='followup_enc_add' id='followup_enc_add' value='+' class='button' onclick = "linkFollowUpEncounters('<%=patient_id%>')">&nbsp;<input type='button' name='followup_enc_remove' id='followup_enc_remove' value='X' class='button' onclick = "delinkFollowUpEncounters()"></td>
			 <!--ML-MMOH-CRF-0657-->
			  <%}%>
		  ...
		  <tr>
			  ...
			  <select name='location' id='location' onChange='remVal1(document.forms[0].service);remVal(document.forms[0].sub_service);remVal(document.forms[0].treat_area);setTreat();setVisit(this);'>
    			 <%
                   ...
                   <input type="hidden" name='hddgender' id='hddgender' value = '<%=sex%>'></td>
	  ...
	  <tr>	
		  ...
		  <!--Below line modified by Ashwini on 18-Jan-2017 for GDOH-CRF-0123--> 
		   <%if(!five_level_triage_appl_yn.equals("Y") && (isLabelChngAppl == false)){ %> 
			 ...
			 <%}else{ %>
			 	<td class='LABEL'  width='25%' ><fmt:message key="eAE.DeadOnArrival.label" bundle="${ae_labels}"/></td><!--bundle change for PAS-MP-PMG2020-TECH-CRF-0010/01-Label Name-->
			 <%} %>
			 <!-- below line(s) modified by VenkateshS against ML-MMOH-CRF-0354 [IN057191] -->
  		     <td class='fields' width='25%' ><input type='checkbox'  name="brought_dead_yn" id="brought_dead_yn"  onClick='broughtDead(this);'  <%=proBrought_dead%> >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%if(siteSpecific){%>
			<% if(!isMLCAppl){ %>
			 <fmt:message key="Common.MedicalLegalCase.label" bundle="${common_labels}"/>
			<%} %>
			<%}else{%>
			<% if(!isMLCAppl){ %>
			 <fmt:message key="Common.mlc.label" bundle="${common_labels}"/>&nbsp;&nbsp; <%} %> <%}%> <% if(!isMLCAppl){ %> <input type='checkbox'  name="mlc_case_yn" id="mlc_case_yn"  onClick='mlcCase(this);' ></td>
			 <!--end ML-MMOH-CRF-0354 [IN057191 -->
			<%} %>
			 ...
			 <!--Modified by Ashwini on 17-Aug-2017 for GDOH-CRF-0161-->
  		     <td class='fields' width='25%' ><input type='checkbox'  name="mv_accident_yn" id="mv_accident_yn"  onClick="mvAccident(this); <%if(isLabelChngAppl == true){%>placeOfAccidentMandatory(this);<%}%>" value='N'></td>
		 ...
		 <% } %>
			...
			<%if(isPlaceOfOccuurrence == false){ %>
			  <td class='fields' width='25%' >
                   <input type='text' name="place_of_accident" id="place_of_accident"  maxLength='30' size='25'  tabindex='' value="" onBlur="makeValidString(this)"> <%if(isLabelChngAppl == true){ %><img src='../../eCommon/images/mandatory.gif' id='poa_mand' style="visibility:hidden" align='center'></img> <%}%>
			  </td>
			<%}
			else
			{
			...
			<%}%>
	<!--	<input type="hidden" name='isPlaceOfOccuurrence' id='isPlaceOfOccuurrence' value="<%=isPlaceOfOccuurrence%>"> -->
	  ...
	  <% } %>
			<tr>
		      <td class='LABEL'  width='25%' ><fmt:message key="Common.VehiclesInvolved.label" bundle="${common_labels}"/></td>
  		      <td class='fields' width='25%' >
 				   <select name='vehicle_invol1' id='vehicle_invol1' ><option value='' >--------<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>-------
					   <%
	...
	<table border="0" align='center' width='92%'>
		...
		<!--Below line added for this CRF ML-MMOH-CRF-0629-->
		 <tr>
			...
			<input type="checkbox" name='priorityR' id='priorityR' onClick='remVal(document.forms[0].treat_area);setTreatment(this);enableBed(this);<%=enablePrac%><%=priorityRed%>'></td>
			 <td  align='center'  width='15%'>
			 <input type="checkbox" name='priorityY' id='priorityY' onClick='remVal(document.forms[0].treat_area);setTreatment(this);enableBed(this);<%=enablePrac%>'></td>
			 <td  align='center'  width='15%'>
			 <input type="checkbox" name='priorityG' id='priorityG' onClick='remVal(document.forms[0].treat_area);setTreatment(this);enableBed(this);<%=enablePrac%>' >
		...
		<%}%>
           ...
           <tr>
			...
			<td class='fields'  id="treat_area" width='25%'>
				    <select name='treat_area' id='treat_area' onChange='enableBed(this);<%=enablePrac%>'>
						<option value=''>----------<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>----------
					</select>
			</td>
...
if(isReferral){
	 ...
	 <%}else{%>
		...
		<tr>
		  <td  class=label width='25%'>&nbsp;</td>
	      <td class='BUTTON' width='25%'><input type="button" name="PrevEncounter" id="PrevEncounter" class="BUTTON" value='<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.PreviousEncounters.label","common_labels")%>'  onClick="showPrevEncounter();"  onblur='if(document.forms[0].visit_within_24hrs.disabled==true)document.forms[0].visit_date_time.focus();' <%=EncounterProp%>></td>
		  <td class='BUTTON' colspan='2'>
          <input type="button" name="visit_within_24hrs" id="visit_within_24hrs" class="BUTTON" value='<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eAE.LastVisitWithin24Hrs.label","ae_labels")%>'   onClick="showLastVisitDetails('LastVisit24');" onblur='document.forms[0].visit_date_time.focus();' disabled>&nbsp;&nbsp;</td>
          </tr>  
		       </table>
</div>
...
<input type='hidden' name='patient_valuables_remarks' id='patient_valuables_remarks' value=''> 
 ...
 <input type="hidden" name='upt_contact_dtls_oa_yn' id='upt_contact_dtls_oa_yn' value="<%=upt_contact_dtls_oa_yn%>"> <!--added changes for HSA-CRF-0226 [IN:050599]-->
...
<input type="hidden" name='isAutoPopulateNOKDOBAppl' id='isAutoPopulateNOKDOBAppl' value="<%=isAutoPopulateNOKDOBAppl%>"><!--Added by Thamizh selvi on 6th Aug 2018 against ML-MMOH-CRF-1177-->
...
<!--Added by Ashwini on 18-Dec-2017 for ML-MMOH-CRF-0657-->
<input type="hidden" name='invoke_recall' id='invoke_recall' value="<%=invoke_recall%>">
<script>
			...
			<td class='LABEL'  ><fmt:message key="Common.otheraltid.label" bundle="${common_labels}"/></td>
              ...
              <% }%>
               ...
               <tr>	
				...
				<td class='fields' ><input type='text'  name="nat_id_no" id="nat_id_no"  value="" maxlength='<%= nat_id_length%>' onblur="<%=nat_on_blurfn_st%>;document.forms[0].e_addr_line1.focus();" onkeypress='return <%=nat_id_onKeyPress%>'  size='20' >
		    	</td><%}else{%>
                <td class='label'  colspan='2'>&nbsp;</td> 
                <% } %>
				<td class='label'  colspan='2'>&nbsp;</td> 
...
<div id = 'NEXT_OF_KIN' style = 'display:none'>
  <table cellspacing='0' cellpadding='0' width='92%' border=0 align='center'>
			...
			<!-- added by mujafar for ML-MMOH-CRF-0632 START -->	
				...
				<tr>
				<td  class='label' width='25%' >
				<fmt:message key="Common.patientId.label" bundle="${common_labels}"/>&nbsp;&nbsp;<span class='field'><td class='fields' width='25%'><input type='text'  name="patient_id1" id="patient_id1"  value="" maxLength='<%=patient_id_length%>' size='20' onKeyPress="return(CheckForSpecChars(event))" 
             ...
             <input type='hidden' name='patient_id1_val' id='patient_id1_val' value=''>
				...
				<tr>
				 <% if (accept_national_id_no_yn.equals("Y")){%>  
		 		  <td  class='label' width='25%'><%=nat_id_prompt%>&nbsp;</td>
			      <td class='fields'  width='25%'>
				     <input type='text' name='contact1_new_nat_id_no' id='contact1_new_nat_id_no' maxlength='<%=nat_id_length%>' size='20'  onkeypress='return <%=nat_id_onKeyPress%>'  onblur="<%=nat_on_blurfn_st_nok%>" value="<%=contact1_nat_id_no%>" onkeypress="return allowValidNumber(this,event,20, 0);" ><!--Modified by Thamizh selvi on 6th Aug 2018 against ML-MMOH-CRF-1177-->
				  </td>  
			   <%}else {%>  
			...
			<!-- added by mujafar for ML-MMOH-CRF-0632 END -->	
				...
				<tr> <!--below length change CRF-0887 by mano -->
					...
					<%}else{%>					
					<input type="text" name="next_contact_name" id="next_contact_name"  maxlength='80' size='30'  value="<%=contact1_name%>">
					<%}%>
					</td>
				 </tr>
				 <tr>
	...
	if(Accept_oth_alt_id_yn.equals("Y")){%>
		  ...
		  <tr><td  class='label' width='25%'><fmt:message key="eMP.occupation.label" bundle="${mp_labels}"/></td>
              <td class='fields'  width='25%'>
                  <input type='text' name='next_job_title' id='next_job_title' maxlength='30' size='30' onblur='makeValidString(this);document.forms[0].next_addr_line1.focus();document.forms[0].n_next_addr_line1.focus();' value ="<%=job1_title%>">
              </td>
        ...
        // End of addition on 7/05/2004 for assigning values to dynamically generated address related fields..
          ...
          <tr>
              ...
              <td class='fields' width='25%'><input align='left' type='text' name='next_country_desc' id='next_country_desc' size='15' maxlength='15' onblur='if(this.value !="")searchCountry(contry_code[0],next_country_desc);' value = "<%=country1_code_desc%>" tabindex='51'><input type='button' name='contry_code' id='contry_code' value='?' class='button' onclick='searchCountry(this,next_country_desc)' tabindex='51'>
			  ...
			  <!--Below added by Suji Keerthi for ML-MMOH-CRF-1527 US008-->
				<% if(resiAddMailAdd){%>
					...
					<td class='fields'><input type='text' name='nk_ma_country_desc' id='nk_ma_country_desc' size='15' maxlength='15' value='<%=nk_mail_country_desc%>' onblur='if(this.value !="") searchCountry(nk_ma_country_code,nk_ma_country_desc);' tabindex='54'><input type='button' name='nk_ma_country_code' id='nk_ma_country_code' value='?' class='button' onclick='searchCountry(this,nk_ma_country_desc)' tabindex='54'>
					<input type='hidden' name='nkin_mail_country_code' id='nkin_mail_country_code' value="<%=nkin_m_country_desc%>">
                    <script>
				...
				<tr>
                    ...
                    <td class='fields'>
                    <input type='text' name='ra_contact_name' id='ra_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value= "<%=nk_res_contact_name%>" tabindex='52'>
                    </td>
                    <td class='fields'>
                    <input type='text' name='ma_contact_name' id='ma_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value="<%=nk_mail_contact_name%>" tabindex='55'>
                    </td></tr>
          ...
          <tr>
              ...
              <td class='fields' width='25%'><input type='text' name='next_res_tel_no' id='next_res_tel_no' maxlength='20' size='20' onblur='makeValidString(this);' value ='<%=res1_tel_no%>' tabindex='58'>
              </td>
		  </tr>
          <tr>
              <td class='label' width='25%' ><fmt:message key="Common.MobileNo.label" bundle="${common_labels}"/></td>
              <td class='fields' width='25%'><input type='text' name='contact1_mob_tel_no' id='contact1_mob_tel_no' maxlength='20' size='20' onblur='makeValidString(this);' value ="<%=res1_mbo_tel_no%>" tabindex='59'>
              </td>
		  <tr>
			  <td class='label' width='25%'><fmt:message key="Common.officephoneno.label" bundle="${common_labels}"/></td>
              <td class='fields' width='25%'><input type='text' name='next_off_tel_no' id='next_off_tel_no' maxlength='20' size='20'  onblur='makeValidString(this);' value ="<%=off1_tel_no%>" tabindex='60'>
              </td>
          </tr>
		  <tr>
		      <td class='label' width='25%'><fmt:message key="Common.email.label" bundle="${common_labels}"/></td>
              <td class='fields' width='25%'><input type='text' name='contact1_email_id' id='contact1_email_id' maxlength='50' size='42' onblur='makeValidString(this);document.forms[0].next_contact_name.focus();' value = "<%=contact1_email_id%>" tabindex='61'>
              </td>
          </tr>
		  ...
		  <table width="100%"><tr>
				...
				<tr>
                    ...
                    <input type='text' name='next_res_tel_no' id='next_res_tel_no' maxlength='20' size='20' onblur='makeValidString(this);' value ='<%=res1_tel_no%>' tabindex='58'>
                    </td>
				
                    <td class='label' width='25%' ><fmt:message key="Common.MobileNo.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type='text' name='contact1_mob_tel_no' id='contact1_mob_tel_no' maxlength='20' size='20' onblur='makeValidString(this);' value ="<%=res1_mbo_tel_no%>" tabindex='59'>
                    </td>
				
					<td class='label' width='25%'><fmt:message key="Common.email.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type='text' name='contact1_email_id' id='contact1_email_id' maxlength='50' size='42' onblur='makeValidString(this);' value = "<%=contact1_email_id%>" tabindex='61'>
                    </td>     
                </tr>
				...
				<tr>
						...
						<td class='fields'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name='nk_contact4_mode' id='nk_contact4_mode' <%=enabledisable%>  onchange='enableContactNo(this)'>
							<option value=''>----<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>----</option>
							<%
							for(int i=0;i<contactmode.length;i++)
						...
						<td class='fields'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name='nk_contact5_mode' id='nk_contact5_mode' <%=enabledisable%>  onchange='enableContactNo(this)'>
							<option value=''>----<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>----</option>
							<%
							for(int i=0;i<contactmode.length;i++)
							out.println("<option value='"+contactmode[i]+"'>"+contactdesc[i]+ "</option>");
       ...
       <tr >
        ...
        <%if(resiAddMailAdd){%>
            ...
            <tr>
				...
				<input type='text' name='first_contact_name' id='first_contact_name' value="<%=first_to_notify_name%>" onblur='makeValidString(this);' maxlength='80' size ='30'>
			    </td>
			...
			relcode = contact2_relation;
				 ...
				 <tr>
					  ...
					  <input type='text'  name="contact2_nat_id_no" id="contact2_nat_id_no"   value = "<%=contact2_nat_id%>" onkeypress='return <%=nat_id_onKeyPress%>'  maxlength='<%=nat_id_length%>' onblur="<%=nat_on_blurfn_st%>"  size='20'  ></td>
					  <td class='label'  colspan='2'>&nbsp;</td> 
	            </tr>	
                <% } %>
				...
				<%
					...
					<tr>
						<td class='label' width='25%'><fmt:message key="eMP.occupation.label" bundle="${mp_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <input type='text' name='first_job_title' id='first_job_title' maxlength='30' size='30'  onblur='makeValidString(this);document.forms[0].first_addr_line1.focus();' value="<%=job2_title%>">
                        </td> 
   					   <td colspan=2 class=label height=5>&nbsp;</td>
					 </tr>
					 </table></td>
		<%}else {%>
            <tr>
				<td  class='label' width='25%'><fmt:message key="Common.name.label" bundle="${common_labels}"/></td>
				<td class='fields' width='25%'><input type='text' name='first_contact_name' id='first_contact_name' value="<%=first_to_notify_name%>" onblur='makeValidString(this);' maxlength='80' size ='30'>
			    </td>
				<td colspan=2 class=label height=5>&nbsp;</td>
			</tr>
		    <tr>
				...
				<td class='fields' width='25%'><select name='first_contact_relation' id='first_contact_relation' >
				 ...
				 <tr>
					  <td class='LABEL' width='25%'><%=nat_id_prompt%>&nbsp;</td>
					  <td class='fields' width='25%'><input type='text'  name="contact2_nat_id_no" id="contact2_nat_id_no"   value = "<%=contact2_nat_id%>" onkeypress='return <%=nat_id_onKeyPress%>'  maxlength='<%=nat_id_length%>' onblur="<%=nat_on_blurfn_st%>"  size='20'  ></td>
					  <td class='label'  colspan='2'>&nbsp;</td> 
	            </tr>	
                <% } %>
                ...
                %> 
                  ...
                  <tr>
					   <td class='label' width='25%'><fmt:message key="Common.country.label" bundle="${common_labels}"/></td>
					   <td class='fields' width='25%'><input align='left' type='text' name='first_country_desc' id='first_country_desc'  size='15' maxlength='15' onblur='if(this.value !="")searchCountry(contry_code[0],first_country_desc);'  value ="<%=country2_code_desc%>" tabindex='61'><input type='button' name='contry_code' id='contry_code' value='?' class='button' onclick='searchCountry(this,first_country_desc)' tabindex='61'>
				...
				<% if(resiAddMailAdd){%>	
					...
					<td class='fields'><input type='text' name='first_mail_country_desc' id='first_mail_country_desc' size='15' maxlength='15' value='<%=fton_mail_country_desc%>' onblur='if(this.value !="") searchCountry(ma_country_code,first_mail_country_desc); ' tabindex='64'><input type='button' name='ma_country_code' id='ma_country_code' value='?' class='button' onclick='searchCountry(this,first_mail_country_desc)' tabindex='64'>
					<input type='hidden' name='first_mail_country_code' id='first_mail_country_code' value="<%=fton_m_country_desc%>">
					 <script>
				...
				<tr>
					<td class='label' nowrap ><fmt:message key="eMP.ContactPerson.label" bundle="${mp_labels}"/></td> 
                    <td class='fields'>
                    <input type='text' name='fton_ra_contact_name' id='fton_ra_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value= "<%=fton_res_contact_name%>" tabindex='62'>
                    </td>
                    <td class='fields'>
                    <input type='text' name='fton_ma_contact_name' id='fton_ma_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value= "<%=fton_mail_contact_name%>" tabindex='65'>
                    </td>
				</tr>
				...
				<tr>
					...
					<td class='label' width='25%' ><fmt:message key="Common.homephoneno.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type='text' name='first_res_tel_no' id='first_res_tel_no' maxlength='20' size='20'  onblur='makeValidString(this);' value ="<%=contact2_res_tel_no%>" tabindex='70'>
				    </td>

					<td class='label' width='25%' ><fmt:message key="Common.MobileNo.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type='text' name='contact2_mob_tel_no' id='contact2_mob_tel_no' maxlength='20' size='20'  onblur='makeValidString(this);' value = "<%=contact2_mob_tel_no%>" tabindex='71'>
				    </td>

					<td class='label' width='25%' ><fmt:message key="Common.email.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type='text' name='contact2_email_id' id='contact2_email_id' maxlength='50' size='45'  onblur='makeValidString(this);document.forms[0].first_contact_name.focus();' value = "<%=contact2_mail_id%>" tabindex='73'>
					</td></tr>
					...
					<tr>
						...
						<td class='fields'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name='fton_contact4_mode' id='fton_contact4_mode' <%=enabledisable%>  onchange='enableContactNo(this)'>
							<option value=''>----<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>----</option>
							<%
							for(int i=0;i<contactmode.length;i++)
							out.println("<option value='"+contactmode[i]+"'>"+contactdesc[i]+ "</option>");
						...
						<td class='fields'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name='fton_contact5_mode' id='fton_contact5_mode' <%=enabledisable%>  onchange='enableContactNo(this)'>
							<option value=''>----<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>----</option>
							<%
							for(int i=0;i<contactmode.length;i++)
							out.println("<option value='"+contactmode[i]+"'>"+contactdesc[i]+ "</option>");
                ...
                <tr>
					...
					<tr>
						<td class='label' width='25%'  ><fmt:message key="Common.officephoneno.label" bundle="${common_labels}"/></td>
						<td class='fields' width='25%'>
							<input type='text' name='first_off_tel_no' id='first_off_tel_no' maxlength='20' size='20'  onblur='makeValidString(this);' value = "<%=contact2_off_tel_no%>" tabindex='72'>
					    <td colspan=2 class=label>&nbsp;</td>
					</tr>
					<tr>
						<td class='label' width='25%' ><fmt:message key="Common.email.label" bundle="${common_labels}"/></td>
			...
			<table cellspacing='0' cellpadding='0' width='92%' border=0 align='center'>
				...
				<tr>
                     ...
                     <td class='fields' width='50%'>
                      <input type='text' name='organization_name' id='organization_name' maxlength='<%=maximumLength%>' size='<%=maxsize%>'  onblur="makeValidString(this);" value="<%=contact3_org_name%>"></input>
                    </td>		
			   </tr>
			   <!--End ML-MMOH-CRF-0860.2-->
			   <tr>
                    ...
                    <td class='fields' width='50%'>
                        <input type='text' name='empyr_contact_name' id='empyr_contact_name' maxlength='30' size='30' onblur='makeValidString(this);document.forms[0].employ_addr_line1.focus();'  value = "<%=employer_name%>" ></input>
                    </td>
                ...
                <tr>
                    ...
                    <td class='fields' width='50%'><input type='text' name='empyr_country_desc' id='empyr_country_desc'                       size='15' maxlength='15' onblur='if(this.value !="")searchCountry(contry_code[0],empyr_country_desc);' value = "<%=country3_code_desc%>" onblur='if(this.value !="")searchCountry(contry_code[0],empyr_country_desc);' tabindex='80'><input type='button' name='contry_code' id='contry_code' value='?' class='button'  onclick='searchCountry(this,empyr_country_desc)' tabindex='81'>
               ...
               <tr>
                   ...
                   <td class='fields' width='50%'>
                       <input type='text' name='res3_tel_no' id='res3_tel_no' size='20' maxlength='20'  onblur='makeValidString(this);' value ="<%=res3_tel_no%>" tabindex='82'>
                   </td>
                   ...
                   <td class='fields' width='50%'>
                        <input type='text' name='empyr_off_tel_no' id='empyr_off_tel_no' size='20' maxlength='20'  onblur='makeValidString(this);' value ="<%=off3_tel_no%>" tabindex='83'>
                   </td>
			   ...
			   <tr><td class='label' width='25%'><fmt:message key="Common.employmentid.label" bundle="${common_labels}"/></td>
                    <td class='fields' width='25%'>
                        <input type='text' name='empyr_eid' id='empyr_eid' maxlength='20' size='20' onfocus="" onblur='makeValidString(this);' value = "<%=patient_employee_id%>" tabindex='84'></input>
                    </td>
					</tr>
					<tr>
				...
				<tr>
                    ...
                    <td class='fields' colspan='2'>
					   ...
					   if((sqlOcc != null) && (sqlOcc.length() > 0))
						...
						%>
					</select>&nbsp;&nbsp;<input type='text' name='occu_of_per_desc' id='occu_of_per_desc' size='<%=maxsize%>' maxlength='<%=maximumLength%>' onblur=''  onblur='makeValidString(this);' value="<%=ocpn_desc%>" align='left' tabindex='87'></td> 		
					</tr>
...
<!-- Added for Billing Enhancements -->    
	...
	<input type='hidden' name='frameRef' id='frameRef' value="<%=frameRef%>">
	<!-- Added by Dharma on Aug 18th 2017 against ML-MMOH-CRF-0631 [IN:062148] End-->
...
StringBuffer  orgTypeSQL = new StringBuffer();
		...
		%>
		  ...
		  <input type='hidden' name='patFlag' id='patFlag' value="<%=patFlag%>"> 
		  ...
		  <input type='hidden' name='referral_id' id='referral_id' value="<%=referal_id%>">
   		  <input type='hidden' name='buildEpisodeRule' id='buildEpisodeRule' value="<%=buildEpisodeRule%>">
...
<!-- Addition ends-->
	...
	<!--Below line added for this CRF GDOH-CRF-0129-->
	<input type="hidden" name="assigncare_loctype_ind" id="assigncare_loctype_ind" id="assigncare_loctype_ind" value="<%=assigncareloctype%>">
	<input type="hidden" name="assigncare_locacode" id="assigncare_locacode" id="assigncare_locacode" value="<%=assigncare_location_code%>">
	...
	<input type="hidden" name="isLabelChngAppl" id="isLabelChngAppl" value="<%=isLabelChngAppl%>"> 
	...
	<!-- Below Added by Suji keerthi for ML-MMOH-CRF-1527 US008 -->
    <input type='hidden' name='resiAddMailAdd' id='resiAddMailAdd' value='<%=resiAddMailAdd%>'>
