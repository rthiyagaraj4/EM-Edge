   ...
   %>
	 ...
	 <table border="0" cellpadding="3" cellspacing="0" align='center' width='75%'>
	    ...
	    <tr>
		      ...
		      <td class='field'  width='50%'><input type='text' name='place_occurrence_type_code' id='place_occurrence_type_code' value='<%=place_occurrence_type_code%>' maxLength='4' size='4' <%=readOnlyAttribute1%> onBlur='changeCase(this);' onKeyPress="return CheckForSpecChars(event)">
