...
<script src="../js/AERepStatistics_SRR.js"></script>
		...
		<td width="80%" class="Border" align='center'>
				...
				<tr>
					...
					<tr> <!--Below line modified for this SCF [ SRR20056-SCF-9516] -->
						...
						<td width="25%"><input type=text id='hlyattnfrom' name='p_fm_visit_date1' id='p_fm_visit_date1' size="10" maxlength="10" onBlur="doDate(this);" ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('hlyattnfrom');" style='cursor:pointer'></img><img src='../../eCommon/images/mandatory.gif'></img>
						</td>
						<td width="25%"><input type=text id='hlyattnto' name='p_to_visit_date1' id='p_to_visit_date1' size="10" maxlength="10" onBlur="doDate(this);"><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('hlyattnto');" style='cursor:pointer'></img><img src='../../eCommon/images/mandatory.gif'></img>
						</td>
						</td width="25%"></td>
				</tr>
				<tr>
