...
//	String sourceDesc= (String) request.getParameter("sourceDesc");
	...
	<script type='text/javascript' src='<%=request.getContextPath()%>/dwrlc/interface/MendingReceipt.js'></script>
...
MendingReceipt.getSumIssuedQty("<%=facilityId%>",requestNo,setIssueQty);
}
...
facilityId=trimString(facilityId);
requestNo=trimString(requestNo);
MendingReceipt.getSumReceivedQty("<%=facilityId%>",requestNo,setRequestQty);
...
MendingReceipt.getReceivedQty("<%=facilityId%>",requestNo,linenItem,setReceivedQty);
...
var facilityId=document.getElementById("vo.issueOfLinenVO.operatingFacilityId").value;
var requestNo=document.getElementById("vo.issueOfLinenVO.requestNum").value;
MendingReceipt.getIssueNo('<%=facilityId%>',requestNo,setIssueNo);
}
...
<body onload="issueNo();" OnMouseDown="CodeArrest()" onKeyDown="lockKey()">
	...
	<ibaHTML:form action="/IssueLinenAfterMendingAction.do"	target="messageFrame">
		...
		<input type="text" name="vo.issueOfLinenVO.sentBy" id="vo.issueOfLinenVO.sentBy" readonly="true" />
			...
			<td class='label' nowrap="nowrap">
				  <input type="text"   readonly="true" name="vo.issueOfLinenVO.issueDate" id="vo.issueOfLinenVO.issueDate"  value="<%=cdate%>"/>
	...
	<table align="center" border='0' cellpadding='0' cellspacing='0' width='100%' align='center'>
			<tr>
				...
				<td class='label' align='right'>
					<ibaBean:message key="com.iba.ehis.lc.sentQty" bundle="lcLabels" />
				</td>
				<td>
				...
				<tr>
					<td class='label' align='right'>
						<ibaBean:message key="com.iba.ehis.lc.loanLinen.receivedQty" bundle="lcLabels" />
					</td>
					<td>
						<input type="text" readonly="true" name="iqty" id="iqty" onkeypress="checkNumber()"/>
					</td>
					<td class='label' align='right'>
						<ibaBean:message key="com.iba.ehis.lc.curReceivedQty" bundle="lcLabels" />
					</td>
					<td>
...
<table border='1' cellpadding='2' cellspacing='0' width='100%' id="tableid" align='center' >
		...
		<th align="center" width="20%">
			...
			<th align="center" width="20%">
				<ibaBean:message key="com.iba.ehis.lc.sentQty"
					bundle="lcLabels" />
			</th>
			<th align="center" width="20%">
				<ibaBean:message key="com.iba.ehis.lc.loanLinen.receivedQty"
					bundle="lcLabels" />
			</th>
			<th align="center" width="20%">
			
				<ibaBean:message key="com.iba.ehis.lc.curReceivedQty"
					bundle="lcLabels" />
			</th>
			<th align="center" width="20%">
		...
		<table align='center'>
						...
						<input type="button" class="BUTTON"  name="Submit" id="Submit" value="<ibaBean:message key='com.iba.ehis.lc.submit'
					bundle='lcLabels' />" onclick="issueNo();apply()" />
						</td>
						</tr>
		</table>
