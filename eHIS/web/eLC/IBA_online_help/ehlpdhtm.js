...
function insertAdjacentHTML(obj, where, htmlStr)
{
	...
	else if (gbBsNS6 || gbBsSafari)
	{
		...
		case 'beforeBegin':
			...
			break;
		case 'afterBegin':
			obj.insertBefore(parsedHTML,obj.firstElementChild);
			break;
		case 'beforeEnd':
...
function _PopupMenu_Invoke_2()
{
	...
	if ((!gbBsIE4 && !gbBsNS4 && !gbBsOpera7 && !gbBsKonqueror3 &&!gbBsSafari) || ((gbBsMac) && (gbBsIE4) && (window.event.target.tagName == "AREA"))) {
...
function BSSCPopupClicked(e)
{
	...
	if (gbBsIE4 && (!((popupIFrame.window.event != null) &&
		(popupIFrame.window.event.target != null) &&
		isInsideHyperLink(popupIFrame.window.event.target)))) {
		document.onmousedown = gbOrignalOnMouseDown;
