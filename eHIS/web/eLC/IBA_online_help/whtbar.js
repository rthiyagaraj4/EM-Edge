...
{
	var sSelect="<select id=\"avenue\" size=\"1\" name=\"avenue\" id=\"avenue\" onchange=\"updateAveButton();\">";
...
function addSearchForm()
{
	...
	if(gsSearchFormTitle)
		sPropmptString="";
	var sButton="<table id=\"searchInput\" CELLSPACING=0 CELLPADDING=1><tr><td valign=\"middle\" NOWRAP class=\"clsNotBtn\"><span class=\"btnsearchform\">"+_textToHtml(gsSearchFormTitle)+"</span></td><td NOWRAP valign=\"middle\"><input class=\"inputsearchform\" type=\"text\" onfocus=\"highLightIfNeeded();\" name=\"searchString\" id=\"searchString\" value=\""+sPropmptString+"\" size=\""+nWidth+"\"></td>";
	if(gbNav6)
		sButton="<form id=\"searchInput\" name=\"searchForm\" id=\"searchForm\" method=\"POST\" action=\"javascript:searchB()\">"+sButton;
	if("image"=="text")
	{
...
function writeToolBar()
{
	...
	if(gaButtons.length>0)
	{
		...
		if(gbNav6)
			...
			sHTML="<form name=\"searchForm\" id=\"searchForm\" method=\"POST\" action=\"javascript:searchB()\"><table class=\"clsToolbarBackground\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" height=\""+strHeight+"\" width=\""+strWidth+"\">";
