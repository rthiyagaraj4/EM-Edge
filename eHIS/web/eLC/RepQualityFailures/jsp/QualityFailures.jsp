...
<script type='text/javascript' src='<%=request.getContextPath()%>/dwr/interface/MessageReader.js'></script>
	...
	<Script Language="JavaScript" src="<%=request.getContextPath()%>/eLC/RepQualityFailures/js/QualityFailures.js"></Script>
...
<body OnMouseDown="CodeArrest()" onKeyDown="lockKey()" OnMouseDown="CodeArrest()" onKeyDown="lockKey()">
	<br>
		<ibaHTML:form action="/RepQualityFailuresAction.do" target="messageFrame" method="GET">
			...
			<tr>
				...
				<tr>
					<td align="right" class="label">
						<ibaBean:message key="com.iba.ehis.lc.cleaningdate" bundle="lcLabels" />
					</td>
						<td>
							<ibaHTML:IBACalendarInput property="vo.dateFrom" value="<%=conFromDate%>" format="<%=datepattrn%>" size="18" maxlength="18" />
								<img src='framework/images/mandatory.gif' />
							</td>	
								<td>
									<ibaHTML:IBACalendarInput property="vo.dateTo" value="<%=cdate%>" format="<%=datepattrn%>" size="18" maxlength="18"/> 
								</td>
							</tr>
						<tr>
					<td align="right" class="label">
						<ibaBean:message key="com.iba.ehis.lc.linenItem" bundle="lcLabels" />
								...
								<td>
									<ibaHTML:text property="vo.linenItem" size="30" maxlength="30" onblur="lookUpCommon('linenItem');"/>
						...
						<tr>		
							<td align="right" class="label">
								<ibaBean:message key="com.iba.ehis.lc.natureofdefect" bundle="lcLabels" />
									</td>
										<td>
											<ibaHTML:text property="vo.natureOfDefect" size="30" maxlength="30" onblur="lookUpCommon('natureOfDefect');"/>
								...
								<tr>		
							<td align="right" class="label">
								<ibaBean:message key="com.iba.ehis.lc.reasonfordefect" bundle="lcLabels" />
									</td>
										<td>
											<ibaHTML:text property="vo.reasonForDefect" size="30" maxlength="30" onblur="lookUpCommon('reasonForDefect');"/>
								...
								<ibaHTML:hidden property="method"/>
									...
									<input type='hidden' name='locale1' id='locale1' value='<%=language_Id%>'>
									<input type='hidden' name='p_language_id' id='p_language_id' value='<%=language_Id%>'>
									<input type='hidden' name='datFormate' id='datFormate' value='<%=datepattrn%>'>
