...
<body onLoad="disLaundry();>
		<br>
		<ibaHTML:form action="/RepWrittenoffLinenAction.do" target="messageFrame" method="GET">
			<table border='0' cellpadding='2' cellspacing='0' width='75%' align='center'>
				...
				<tr>
					...
					<ibaBean:message key="com.iba.ehis.lc.writeoffdate" bundle="lcLabels" />
					</td>
						<td>
							<ibaHTML:IBACalendarInput property="vo.fromDate" format="dd/MM/yyyy" size="10" maxlength="10" />
									<img src='framework/images/mandatory.gif' />
										</td>	
											<td>
												<ibaHTML:IBACalendarInput property="vo.toDate" format="dd/MM/yyyy" size="10" maxlength="10" /> 
											</td>
										</tr>
									<tr>
								<td align="right" class="label">
									<ibaBean:message key="com.iba.ehis.lc.source" bundle="lcLabels" />
											...
											<td>
												<ibaHTML:select property="vo.sourceType" onchange="disLaundry();">
				...
				<td align="right" class="label">
					...
					<tr>
						<td align="right" class="label">
							<ibaBean:message key="com.iba.ehis.lc.reasonforwriteoff" bundle="lcLabels" />
								</td>	
									<td>
										<ibaHTML:text property="vo.reasonforWriteOff" size="30" maxlength="30" onblur="showLookup('reasonforWriteOff');"/>
