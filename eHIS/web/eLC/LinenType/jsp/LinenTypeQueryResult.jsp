...
<body OnMouseDown="CodeArrest()" onKeyDown="lockKey()">
	<ibaHTMLEl:form action="/LinenTypePageAction">
<div id="listContentLayer" align="right">
			...
			<ibaLogic:equal name="PageForm" value="0"
				...
				<script> 
					...
					parent.content.location.href=contextPath+"/LinenTypeAction.do?method="+queryMethod+"&vo.functionId="+'<%=request.getParameter("vo.functionId")%>'
			</script>
			</ibaLogic:equal>
</div>
		...
		<table border="1" width="100%" cellspacing='0' cellpadding='0'>
			...
			<ibaLogic:iterate id="result" name="PageForm"
				...
				<tr >
					<td class="<%=style %>"> 
						<a
							href="javascript:parent.loadResult('<ibaBean:write name="result" property="linenTypeCode" />')"><ibaBean:write
								name="result" property="linenTypeCode" />
						</a>
					</td>
					<td class="<%=style %>">
						<ibaBean:write name="result" property="linenTypeDesc" />
					</td>
