...
<%@ page language="java" import="java.util.*,com.iba.framework.core.vo.UserPreferences,com.iba.framework.cache.pojo.business.Cache,com.iba.framework.cache.pojo.business.CacheManager,com.iba.framework.core.util.Constants,com.iba.framework.core.util.IBADateTime,com.iba.framework.core.util.IBADate,com.iba.framework.core.util.IBADateTime,com.iba.ehis.lc.core.util.LcDateFormat,com.iba.framework.core.util.IBADateValidation" pageEncoding="UTF-8"%>
...
<body onload="CurrDate('C');getLoginUserPlaceLinen()" OnMouseDown="CodeArrest()" onKeyDown="lockKey()">
	<ibaHTML:form action="/QueryAction.do"	target="requestForCleaningLinenResult">
<br>
	...
	<table border='0 ' cellpadding='2' cellspacing='0' width='80%'
			...
			<tr>
						...
						<ibaLogic:equal value="N" scope="request" parameter="userFlag"> 
							 <!--input type=text name="sourceType" maxlength="10" readonly="true" value="<%=srcType%>"/--> 
							 <input type=text name="sourceType" id="sourceType" maxlength="10" readonly="true" value="<%=sourceType1%>"/> 
					...
					<ibaLogic:equal value="N" scope="request" parameter="userFlag"> 
						<!--input type=text name="sourceCode" maxlength="10" readonly="true" value="<%=src%>"/-->
						<input type=text name="sourceCode" id="sourceCode" maxlength="10" readonly="true" value="<%=source1%>"/>
					...
					<ibaLogic:equal value="Y" scope="request" parameter="userFlag"> 
					 ...
					 <ibaHTML:hidden property="vo.criteriaItems[1].property" value="sourceCode" />
						...
						<td class='label'>
							 <ibaHTML:text property="vo.criteriaItems[4].itemValue" value="<%=loggedInUser%>" maxlength="30"/>
		...
		<ibaHTML:hidden property="vo.viewCode" value="cleaningRequestsListFrame"/>
