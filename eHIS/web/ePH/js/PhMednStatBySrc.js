...
function run() {
	...
	if(f_query_add_mod.document.formPhMednStatBySrcCriteria) {
		...
		if(checkFields(fields,names,messageFrame) ) {
			if( f_query_add_mod.doDateCheck( f_query_add_mod.document.formPhMednStatBySrcCriteria.p_dt_from, f_query_add_mod.document.formPhMednStatBySrcCriteria.p_dt_to, messageFrame ) ) {//dt_from to p_dt_from AND dt_to to p_dt_to Added for DateConversion identification
