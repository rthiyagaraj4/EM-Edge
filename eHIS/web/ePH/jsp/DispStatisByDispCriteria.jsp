...
%>
		...
		<script LANGUAGE="javascript" src="../../ePH/js/DispStatisByDisp.js"></script>
...
try{
	...
	String sql_ph_drg_stat_dispr_select1=PhRepository.getPhKeyValue("SQL_PH_DRG_STAT_DISPR_SELECT1");
	...
	ArrayList patientList          = bean.getPatientList();
...
%>
	<BODY onMouseDown="CodeArrest()" onKeyDown="lockKey()" onload="document.formPhDispStatisByDispCriteria.p_facility_code.focus();"> 
		<form name="formPhDispStatisByDispCriteria" id="formPhDispStatisByDispCriteria" ACTION="../../eCommon/jsp/report_options.jsp" TARGET="messageFrame" >
			...
			<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
				...
				<tr>
					...
					<SELECT name="p_facility_code" id="p_facility_code" >
...
%>
				...
				<tr>
					...
					<td COLSPAN="3" class="label"><select name="p_select_by" id="p_select_by">
				...
				<tr>
					...
					<td COLSPAN="3" class="label"><input type="text" size="10" maxlength=10 name="p_dt_from" id="p_dt_from" OnBlur='CheckDate(this)'><IMG SRC="../../eCommon/images/CommonCalendar.gif" id=Calendar onclick="return showCalendar('p_dt_from');" >&nbsp;<img src="../../eCommon/images/mandatory.gif"  align="center"> &nbsp;&nbsp;<label class="label"><fmt:message key="Common.to.label" bundle="${common_labels}"/></label> &nbsp;&nbsp;<input type="text" size="10" name="p_dt_to" id="p_dt_to"  maxlength=10 OnBlur='CheckDate(this)'><IMG SRC="../../eCommon/images/CommonCalendar.gif" id=Calendar onclick="return showCalendar('p_dt_to');" >&nbsp;<img src="../../eCommon/images/mandatory.gif" align="center"></td><!--dt_from to p_dt_from AND dt_to to p_dt_to Added for DateConversion identification -->
				</tr>
				<tr>
					<td class="label"><fmt:message key="ePH.DispenserIDFrom.label" bundle="${ph_labels}"/></td>
					<td class="label"><input type="text" name="pract_name" id="pract_name" maxlength="30" size="30" value=""><input type="button" class="button" value="?" name="pract_search" id="pract_search"
					onClick="parent.searchPractitionerName(formPhDispStatisByDispCriteria.pract_name, 1)"></td>
					...
					<td width="50%" class="label"><input type="text" name="tpract_name" id="tpract_name" maxlength="30" size="30" value=""><input type="button" class="button" value="?" name="tpract_search" id="tpract_search"
					onClick="parent.searchPractitionerName(formPhDispStatisByDispCriteria.tpract_name, 2)"></td>
				...
				<tr>
					...
					<td class="label" COLSPAN="2"><SELECT name="p_patient_code" id="p_patient_code" >
						<OPTION VALUE="">    <fmt:message key="Common.all.label" bundle="${common_labels}"/>   </OPTION>
<%
					if (patientList.size() > 0 ){
						for (int i=0; i<patientList.size(); i++) {
%>
							<OPTION VALUE="<%= patientList.get(i) %>"><%= patientList.get(i) %></OPTION>
<% 	
						}
					}
%>
					<td class="label"><input type="text" name="idd" id="idd" disabled maxlength="30" size="30" value="Include Direct Dispensing" >
					<input type="checkBox" disabled>
				</tr>
				<tr>
					<td class="label"><fmt:message key="Common.groupby.label" bundle="${common_labels}"/></td>
					<td COLSPAN="3" class="label"><select name="p_group_by" id="p_group_by">
					<option value="PD"><fmt:message key="Common.Period.label" bundle="${common_labels}"/></option>
					<option value="DS"><fmt:message key="ePH.Dispenser.label" bundle="${ph_labels}"/></option>
					</select>&nbsp;<img src="../../eCommon/images/mandatory.gif" align="center">
					</td>
				</tr>
				<tr>
					<td  class="label"><fmt:message key="Common.reporttype.label" bundle="${common_labels}"/></td>
					<td COLSPAN="3" class="label"><select name="p_report_by" id="p_report_by">
			...
			<INPUT TYPE="hidden" name="p_report_id" id="p_report_id" VALUE="PHWLSBYDI">
		...
		<INPUT TYPE="hidden" name="sql_ph_drg_stat_dispr_select1" id="sql_ph_drg_stat_dispr_select1" VALUE="<%=sql_ph_drg_stat_dispr_select1%>">
	</body>
<!--</html>--><!--moved to bottom for MOHE-CRF-0074-->
<%
