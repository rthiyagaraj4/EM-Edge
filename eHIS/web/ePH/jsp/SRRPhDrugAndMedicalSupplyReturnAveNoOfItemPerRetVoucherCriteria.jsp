<!DOCTYPE html>
	...
	<% 
		...
		<script LANGUAGE="javascript" src="../../ePH/js/SRRPhDrugAndMedicalSupplyReturnAveNoOfItemPerRetVoucher.js"></script>
...
%>
	...
	<form name="formReturnAveNoOfItemPerRetVoucherCriteria" id="formReturnAveNoOfItemPerRetVoucherCriteria" ACTION="../../eCommon/jsp/report_options.jsp" TARGET="messageFrame" >
	...
	<input type="hidden" name="p_report_id" id="p_report_id" value="PHAVGSUP">
	<input type="hidden" name="p_module_id" id="p_module_id" value="PH">
	<input type="hidden" name="p_fr_dt" id="p_fr_dt" value="">
	<input type="hidden" name="p_to_dt" id="p_to_dt" value="">
	<input type="hidden" name="p_fr_time" id="p_fr_time" value="">
