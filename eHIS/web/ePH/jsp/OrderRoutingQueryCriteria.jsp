...
%>
				...
				<tr>
					<td width='6'>&nbsp;</td>
					<td class='label' width='27%' ><div id="div3"><fmt:message key="Common.locationcode.label" bundle="${common_labels}"/></div><div id="div4">Location</div>
					</td>
					<td  class='label' width='15%' >&nbsp;&nbsp;
					...
					<td class='label' width='20%' ><div id="div1"><fmt:message key="Common.LocationDesc.label" bundle="${common_labels}"/></div>
					</td>
					<td  class='label' width='25%' >&nbsp;&nbsp;
					<div id="div2">
						...
						<tr>
							<td width='45%'  align='center'>
								<select name='orderbycols' id='orderbycols' size='5' >
									<option value='ordering_source_type'><fmt:message key="Common.locationtype.label" bundle="${common_labels}"/></option>
