...
<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0"  >
	...
	<td class="label" nowrap><fmt:message key="Common.encounterid.label" bundle="${common_labels}"/></td>
		...
		<td class="label" nowrap>&nbsp;<fmt:message key="Common.print.label" bundle="${common_labels}"/>&nbsp;<fmt:message key="Common.all.label" bundle="${common_labels}"/>
		...
		<input type="button" name="print" id="print" value=' <fmt:message key="Common.print.label" bundle="${common_labels}"/> ' class="button" onClick="Print_All(SRRPhDispLabelQueryCriteria,'<%=p_facility_id%>');">&nbsp;&nbsp;</td>
