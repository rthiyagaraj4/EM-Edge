...
<table  border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td align="left" nowrap><input type="button" align="left" name="Search" id="Search" value='<fmt:message key="Common.search.label" bundle="${common_labels}"/>' onClick="valtextNew(search_text); this.disabled=true;" class="button" >
