	...
	<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
		...
		<tr>
			...
			<td  align="left">
				...
				<td><label class="label">&nbsp;&nbsp;<fmt:message key="Common.to.label" bundle="${common_labels}"/></label>	</td>
		...
		<tr>
			...
			<td class="label" ><fmt:message key="Common.Location.label" bundle="${common_labels}"/></td><td class="label" ><input type="text" name="locn_text" id="locn_text" size="20" value="" > <INPUT TYPE="button" name="locn_lookup_btn" id="locn_lookup_btn" VALUE="?" CLASS="button"  onClick="callLocationLookup(locn_text);" >
		...
		<tr>
			...
			<td  class='label'><label><fmt:message key="Common.ReportOption.label" bundle="${common_labels}"/> </label></td>
