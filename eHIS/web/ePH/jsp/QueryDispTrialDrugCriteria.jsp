...
<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" topmargin="0">
	...
	onClick="DrugSearch(document.FormQueryDispTrialDrug.Drug_Name)">&nbsp;<img src="../../eCommon/images/mandatory.gif">
		...
		<td>&nbsp;&nbsp;
		<input type=text  name="Dispense_Date_From" id="Dispense_Date_From" size=8 maxlength="10" onBlur="CheckDateLeap(this,'DMY','<%= locale %>')" value="<%=com.ehis.util.DateUtils.convertDate(bean.getSysdate(),"DMY","en",locale)%>"><IMG SRC="../../eCommon/images/CommonCalendar.gif" id=Calendar onclick="return showCalendar('Dispense_Date_From');" >&nbsp;<img src="../../eCommon/images/mandatory.gif">		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <!-- 		Added CheckDateLeap funtion for  RollForward from SRR - SRR20056-SCF-9387 [IN:056582]   -->
		<fmt:message key="Common.to.label" bundle="${common_labels}"/>
		<input type=text  name="Dispense_Date_To" id="Dispense_Date_To" size=8 maxlength="10" onBlur="CheckDateLeap(this,'DMY','<%= locale %>')" value="<%=com.ehis.util.DateUtils.convertDate(bean.getSysdate(),"DMY","en",locale)%>"><IMG SRC="../../eCommon/images/CommonCalendar.gif" id=Calendar onclick="return showCalendar('Dispense_Date_To');" >&nbsp;<img src="../../eCommon/images/mandatory.gif"> <!-- 		Added CheckDateLeap funtion for  RollForward from SRR - SRR20056-SCF-9387 [IN:056582]   -->
		</td>
		</tr>
<tr>
