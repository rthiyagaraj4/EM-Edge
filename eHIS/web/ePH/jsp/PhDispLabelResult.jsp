...
<%
	...
	%>
		...
		<th ><fmt:message key="ePH.DispenseQuantity.label" bundle="${ph_labels}"/></th><th><fmt:message key="Common.patientId.label" bundle="${common_labels}"/></th><th><fmt:message key="ePH.DispDate/Time.label" bundle="${ph_labels}"/></th><th ><fmt:message key="ePH.DispenseLocation.label" bundle="${ph_labels}"/></th><th><fmt:message key="Common.Location.label" bundle="${common_labels}"/></th>
	<%
		String classvalue	= "";
	...
	%>
			<tr>
			<td class="<%=classvalue%>" style="font-size=9"><font class="hyperlink" style="cursor:pointer" onClick="showReportDispenseLabel('<%=(String)result.get(i)%>')"><%=(String)result.get(i)%></font></td>
