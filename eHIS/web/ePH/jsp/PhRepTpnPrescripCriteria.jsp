...
<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" id="prescriptionquerycriteriatable">
	...
	<tr>
		...
		<td align="right" class="label"><fmt:message key="ePH.TPNType.label" bundle="${ph_labels}"/></td>
		<td align="left">&nbsp;
			<select name="iv_type" id="iv_type" >
			    <option value="">----<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>----</option>
				<option value="7"><fmt:message key="Common.Standard.label" bundle="${common_labels}"/></option>
				<option value="8"><fmt:message key="ePH.NonStandard.label" bundle="${ph_labels}"/></option>
