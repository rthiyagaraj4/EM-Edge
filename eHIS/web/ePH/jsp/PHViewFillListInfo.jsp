...
<TABLE  CLASS="BOX" ALIGN="center" CELLPADDING="0" CELLSPACING="0" BORDER="0" width="100%">
	...
	<TR>										  
		<TD class="BODYCOLORFILLED"  width="15%" nowrap><font size="1"><b><fmt:message key="Common.nursingUnit.label" bundle="${common_labels}"/></b> &nbsp;</TD>
		<TD class="BODYCOLORFILLED" ALIGN="left"  width="20%" nowrap><font size="1"><%=Nursing_Unit_From_desc%> <B>TO</B> <%=Nursing_Unit_To_desc%></TD>
		<TD class="BODYCOLORFILLED"  width="25%" nowrap><font size="1"><b><fmt:message key="Common.ProcessType.label" bundle="${common_labels}"/></b> &nbsp;</TD>
	...
	<TR>															  
		<TD class="BODYCOLORFILLED"  ><font size="1"><b><fmt:message key="ePH.DispenseLocation.label" bundle="${ph_labels}"/></b> &nbsp;</TD>
		<TD class="BODYCOLORFILLED" ALIGN="left"   ><font size="1"><%=disp_locn_desc%></TD>
		<TD class="BODYCOLORFILLED"   ><font size="1"><b><fmt:message key="ePH.EffectiveStartTime.label" bundle="${ph_labels}"/></b> &nbsp;</TD>
		<TD class="BODYCOLORFILLED" ALIGN="left"   ><font size="1"><%=fill_int_start_date_time%></TD>
		<TD class="BODYCOLORFILLED"   ><font size="1"><b><fmt:message key="Common.EndTime.label" bundle="${common_labels}"/></b> &nbsp;</TD>
