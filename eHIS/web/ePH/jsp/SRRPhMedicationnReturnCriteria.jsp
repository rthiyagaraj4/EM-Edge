...
<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" id="prescriptionquerycriteriatable" >
	<tr>
       <td class="label"><fmt:message key="Common.patientId.label" bundle="${common_labels}"/></td>
			...
			<input align="center" type='text'  name='p_patient_id' id='p_patient_id' size=20 value=""  onKeyPress="return CheckForSpecChars(event)" maxlength="<%=bean1.getPatientIDLength()%>" ><input valign='top' type='button' name='patient_search' id='patient_search' value='?' class='button' onClick="callPatientLookup();"
	...
	<td class="label"><fmt:message key="ePH.PrescriptionID.label" bundle="${ph_labels}"/></td>
		...
		<td class="label"><fmt:message key="Common.documentno.label" bundle="${ph_labels}"/></td>
		<td>&nbsp;
