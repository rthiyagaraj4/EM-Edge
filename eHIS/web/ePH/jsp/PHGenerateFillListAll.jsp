...
<%
	...
	bean.getIPFillDefltValues();// added for MMS-DM-CRF-0011 [IN:055302]	
...
<INPUT TYPE="hidden" name="Building_Code_From_Code" id="Building_Code_From_Code">
<INPUT TYPE="hidden" name="Building_Code_To_Code" id="Building_Code_To_Code" >
...
<INPUT TYPE="hidden" name="p_language_id" id="p_language_id" VALUE="<%=locale%>"> <!-- Added Hidden Variable on 12/OCT/2010 regdng incident num:24346--By Sandhya -->
<TABLE name="FillTable" id="FillTable" ALIGN="center" CELLPADDING="0" CELLSPACING="0" BORDER="0" >
	...
	<TR>
		<TD  class="label"  ALIGN="right"><br><fmt:message key="Common.Orders.label" bundle="${common_labels}"/>&nbsp;</TD>
		<TD ALIGN="left"   >
			<br>
	...
	<TR>
		<TD ALIGN="right" class="label" colspan=4  style="display:inline"><fmt:message key="ePH.ExcludeDrugswhereFillQtyisnotbyFrequency&Duration.label" bundle="${ph_labels}"/>&nbsp;
		<input type="checkbox"  name="fillqtynotbyfreq" id="fillqtynotbyfreq" tabIndex="4"></TD>
	</TR>
	<TR>
		<TD ALIGN="right" class="label" colspan=4>
		<fmt:message key="ePH.INCLUDEPRNDRUGS.label" bundle="${ph_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="checkbox"  name="PrnDrugs" id="PrnDrugs"></TD>
	</TR>
	<TR>
		<TD ALIGN="right" class="label" colspan=4><fmt:message key="ePH.INCLUDEMEDICALITEMS.label" bundle="${ph_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<select name="MedicalItems" id="MedicalItems">
...
<%
	...
	<TR>
		<TD ALIGN="right" class="label" id="NursingUnitLocnFromTD" name="NursingUnitLocnFromTD"   >
			<label><fmt:message key="Common.from.label" bundle="${common_labels}"/>&nbsp;</label></td>
		<td>
			<input type=text STYLE='overflow:visible;' name="Nursing_Unit_From" id="Nursing_Unit_From" tabIndex="6" onblur="NursingUnitSearch(document.formPHGenerateFillList.Nursing_Unit_From)"><!--size="40" maxlength="50" removed and STYLE='overflow:visible;' added for ML-MMOH-CRF-0752-->
			<INPUT TYPE="button" name="Nursing_Unit_From_Button" id="Nursing_Unit_From_Button" VALUE="?" CLASS="button"  onClick="NursingUnitSearch(document.formPHGenerateFillList.Nursing_Unit_From)" tabIndex="7"><img name="PhysicalLocMandatory3" style="display:none;" src="../../eCommon/images/mandatory.gif">
		...
		<td ALIGN="right" class="label" id="NursingUnitLocnToTD"  name="NursingUnitLocnToTD"><fmt:message key="Common.to.label" bundle="${common_labels}"/>&nbsp;</td>
		<td>
			<input type=text STYLE='overflow:visible;' name="Nursing_Unit_To" id="Nursing_Unit_To" tabIndex="8" value="" onblur="NursingUnitSearch(document.formPHGenerateFillList.Nursing_Unit_To);EnablerFloor();"><!--size="40" maxlength="50" removed and STYLE='overflow:visible;' added for ML-MMOH-CRF-0752-->
			<INPUT TYPE="button" name="Nursing_Unit_To_Button" id="Nursing_Unit_To_Button" VALUE="?" CLASS="button" onClick="NursingUnitSearch(document.formPHGenerateFillList.Nursing_Unit_To);EnablerFloor();" tabIndex="9">
			
		</td>
	</TR>
	<TR>
	   <td ALIGN="right" class="label" id="Floor_Code_id"  name="Floor_Code_Td" style="display:none;"><fmt:message key="ePH.FloorName.label" bundle="${ph_labels}"/>&nbsp;</td>
		<TD colspan=5><select name="Floor_Code" id="Floor_Code" tabIndex="11" style="display:none;"><option>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>--</option></select>&nbsp;
			<img name="Floor_CodeMandatory" src="../../eCommon/images/mandatory.gif" style="display:none;"></TD>
	</TR>
	<TR>
	...
	<TR>
		<TD ALIGN="right" class="label" ><br><fmt:message key="Common.ProcessType.label" bundle="${common_labels}"/>&nbsp;</TD>
	...
	<TR>
		...
		<td>
			<input type="text" name="schedule_start" id="schedule_start" readonly onblur="CalculateEndTime(this.document,document.formPHGenerateFillList.Proc_Type.value);">
			<IMG SRC="../../eCommon/images/CommonCalendar.gif"  id="schedule_start_cal"  disabled onclick="return showCalendar('schedule_start',null,'hh:mm');" >
		</td>
		<td ALIGN="right" class="label" ><fmt:message key="ePH.FillPeriod.label" bundle="${ph_labels}"/>&nbsp;
		</td>
		<td>
			<select name="Ip_Fill_Prd_Ahead" id="Ip_Fill_Prd_Ahead" onChange="CalculateEndTime(this.document,'R');">
			<%
			...
			<b><label id="FillPeriodUnit" class="label"  name="FillPeriodUnit"><fmt:message key="Common.days.label" bundle="${common_labels}"/></label><img name="FillPeriodMand" src="../../eCommon/images/mandatory.gif" ></b>
		</td>
		</TD>
	</TR>
	<TR>
		<TD ALIGN="right" class="label" colspan=3 ><fmt:message key="ePH.ExcludeNewOrdersPlacedWithin.label" bundle="${ph_labels}"/>&nbsp; </td>
		<td >
	...
	<TR>
		...
		<td>
			<input type="text"   name="fill_int_start_date_time" id="fill_int_start_date_time" disabled onBlur="if(ValidateTime(this)) { Check_fill_int_start_date_time(this,'<%=locale%>');}else{this.focus();}">
	...
	<tD colspan=4 align="right">
		...
		<input type=hidden  name="fill_prd_ahead_val" id="fill_prd_ahead_val" value="">&nbsp;
	</td>
	</tr>
	</TABLE>
</FORM>
<script>disableAll(true)
formPHGenerateFillList.disp_locn_code.focus();
</script>
