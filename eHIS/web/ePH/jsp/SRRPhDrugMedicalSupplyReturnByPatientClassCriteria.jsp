	...
	<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
		...
		<tr>
			<td align="right" class="label">
				<fmt:message key="ePH.DispenseLocationType.label" bundle="${ph_labels}"/>
			</td>
			<td align="left">
		...
		<tr style="<%=visibility%>">
			<td  class='label'>
				<label><fmt:message key="ePH.BillingGroup.label" bundle="${ph_labels}"/></label>
			</td>
			<td>
		...
		<tr>
			...
			<td  class='label'>
				<label><fmt:message key="Common.ReportOption.label" bundle="${common_labels}"/> </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
