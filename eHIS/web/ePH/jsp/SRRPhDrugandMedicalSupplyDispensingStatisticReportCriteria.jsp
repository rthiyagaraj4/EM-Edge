...
%>
	...
	<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
		...
		<tr>
		<td align="right" class="label" ><fmt:message key="Common.month.label" bundle="${common_labels}"/></td>
		<td  align="left" >
		...
		<tr><td class='label' colspan='4' height='6'></td></tr>
		<tr>
		<td align="right" class="label" ><fmt:message key="Common.year.label" bundle="${common_labels}"/></td>
		<td  align="left" >
        ...
        <td align="right" class="label"><fmt:message key="ePH.TimeHH:MM.label" bundle="${ph_labels}"/></td>	
			<td  align="left">
				...
				<td><label class="label">&nbsp;&nbsp;<fmt:message key="Common.to.label" bundle="${common_labels}"/></label>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='p_time_to' id='p_time_to' size='15' maxlength='5' value=''  onkeypress='return allowPositiveNumber()'  onBlur='ChkSplChars_time(this);'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../eCommon/images/mandatory.gif"  align="center">
			</td>
		</tr>
		<tr><td class='label' colspan='4' height='6'></td></tr>
		<tr>
        <td align="right" class="label"><fmt:message key="ePH.DRUG/MEDICALSUPPLY.label" bundle="${ph_labels}"/></td>	
			<td  align="left">
		...
		<option value ="D"><fmt:message key="ePH.OnlyDischargeMedication.label" bundle="${ph_labels}"/></option>
		<option value ="E"><fmt:message key="ePH.ExcludeDischargeMedication.label" bundle="${ph_labels}"/></option>
