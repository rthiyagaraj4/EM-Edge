...
<%@page contentType="text/html;charset=UTF-8" import="java.util.*, ePH.*, ePH.Common.*, eCommon.Common.*, java.sql.*,  java.text.*,webbeans.eCommon.*,eCommon.XSSRequestWrapper"  %>
	...
	<BODY onMouseDown="CodeArrest()" onKeyDown="lockKey()" onload="document.formPhMednStatByPractCriteria.p_facility_code.focus();"> 
		<form name="formPhMednStatByPractCriteria" id="formPhMednStatByPractCriteria" ACTION="../../eCommon/jsp/report_options.jsp" TARGET="messageFrame" >
			...
			<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
				...
				<tr>
					<td align="left" class="label"><fmt:message key="Common.FacilityName.label" bundle="${common_labels}"/></td>
...
%>
				...
				<tr>
					<td align="left" class="label"><fmt:message key="ePH.SelectBy.label" bundle="${ph_labels}"/></td>
				...
				<tr>
					<td align="left" class="label" ><fmt:message key="Common.periodfrom.label" bundle="${common_labels}"/></td>
				...
				<tr>
					<td align="left" class="label"><fmt:message key="Common.JobTitle.label" bundle="${common_labels}"/></td>
...
%>
					...
					<td align="left" class="label" width='15%'><fmt:message key="Common.patientclass.label" bundle="${common_labels}"/></td> <!-- //added for MMS CRF-0107 start -->
				...
				<tr>
				<tr>
					<td align="left" class="label" nowrap><fmt:message key="ePH.CustomerGroup.label" bundle="${common_labels}"/></td>
					...
					<td align="left" class="label" nowrap><fmt:message key="Common.Customer.label" bundle="${common_labels}"/></td>
				...
				<tr>
					<td align="left" width="15%" class="label"><fmt:message key="Common.PractitionerFrom.label" bundle="${common_labels}"/></td>
					...
					<td align="left" width="5%" class="label"><fmt:message key="Common.to.label" bundle="${common_labels}"/></td>
				...
				<tr>
				<tr>
					<td align="left" class="label"><fmt:message key="Common.groupby.label" bundle="${common_labels}"/></td>
