...
%>
	...
	<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
		...
		<td COLSPAN="3" align="left"><SELECT name="p_rep_type" id="p_rep_type"  onChange="" style="width:155px">
			<option value ="D"><fmt:message key="ePH.ByDispenseLocation.label" bundle="${ph_labels}"/></option>
			<option value ="L"><fmt:message key="ePH.ByLocation.label" bundle="${ph_labels}"/></option>	
    	  </select>
        </td>
    </tr>
	<tr><td class='label' colspan='4' height='6'></td></tr>
