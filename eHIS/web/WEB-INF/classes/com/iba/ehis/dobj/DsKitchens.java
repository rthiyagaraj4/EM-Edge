...
/**
 * DsKitchens generated by MyEclipse - Hibernate Tools
 */

public class DsKitchens  implements java.io.Serializable {


    // Fields    

     private DsKitchensId id;
	...
	/** minimal constructor */
    public DsKitchens(DsKitchensId id, String longDesc, String shortDesc) {
        this.id = id;
    ...
    /** full constructor */
    public DsKitchens(DsKitchensId id, String longDesc, String shortDesc, String effStatus, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
        this.longDesc = longDesc;
        this.shortDesc = shortDesc;
    ...
    public DsKitchensId getId() {
        return this.id;
    }
    
    public void setId(DsKitchensId id) {
        this.id = id;
    }
