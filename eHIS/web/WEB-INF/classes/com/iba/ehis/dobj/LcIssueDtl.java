...
/**
 * LcIssueDtl generated by MyEclipse - Hibernate Tools
 */

public class LcIssueDtl  implements java.io.Serializable {


    // Fields    

     private LcIssueDtlId id;
	...
	/** minimal constructor */
    public LcIssueDtl(LcIssueDtlId id, String requestNum, Long issuedQty, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
    ...
    /** full constructor */
    public LcIssueDtl(LcIssueDtlId id, String requestNum, Long issuedQty, String remarks, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
        this.requestNum = requestNum;
        this.issuedQty = issuedQty;
    ...
    public LcIssueDtlId getId() {
        return this.id;
    }
    
    public void setId(LcIssueDtlId id) {
        this.id = id;
    }
