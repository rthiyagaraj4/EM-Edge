...
// Source File Name:   LcPendingIssueQtyVwId.java

package com.iba.ehis.dobj;

import java.io.Serializable;

public class LcPendingIssueQtyVwId
    implements Serializable
{

    public LcPendingIssueQtyVwId()
    {
    }

    public LcPendingIssueQtyVwId(String sourceType, String sourceCode, String linenItem, String languageId)
    {
    ...
    public LcPendingIssueQtyVwId(String sourceType, String sourceCode, String shortDesc, String linenItem, String languageId, Long pendingCleaningQty)
    {
        this.sourceType = sourceType;
        this.sourceCode = sourceCode;
    ...
    public boolean equals(Object other)
    {
        ...
        if(other == null)
            return false;
        if(!(other instanceof LcPendingIssueQtyVwId))
            return false;
        LcPendingIssueQtyVwId castOther = (LcPendingIssueQtyVwId)other;
