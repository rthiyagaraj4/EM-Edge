...
/**
 * DsFoodItemNutrients generated by MyEclipse - Hibernate Tools
 */

public class DsFoodItemNutrients  implements java.io.Serializable {


    // Fields    

     private DsFoodItemNutrientsId id;
    ...
    /** default constructor */
    public DsFoodItemNutrients() {
    }

	/** minimal constructor */
    public DsFoodItemNutrients(DsFoodItemNutrientsId id) {
        this.id = id;
    }
    
    /** full constructor */
    public DsFoodItemNutrients(DsFoodItemNutrientsId id, Double contentValue, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
    ...
    public DsFoodItemNutrientsId getId() {
        return this.id;
    }
    
    public void setId(DsFoodItemNutrientsId id) {
        this.id = id;
    }
