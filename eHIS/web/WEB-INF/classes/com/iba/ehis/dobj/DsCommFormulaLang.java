...
public class DsCommFormulaLang
    implements Serializable
{

    public DsCommFormulaLang()
    {
    }

    public DsCommFormulaLang(DsCommFormulaLangId id, String longDesc, String shortDesc)
    {
        this.id = id;
    ...
    public DsCommFormulaLang(DsCommFormulaLangId id, String longDesc, String shortDesc, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, 
    ...
    public DsCommFormulaLangId getId()
    {
        return id;
    }

    public void setId(DsCommFormulaLangId id)
    {
        this.id = id;
    }
    ...
    private DsCommFormulaLangId id;
