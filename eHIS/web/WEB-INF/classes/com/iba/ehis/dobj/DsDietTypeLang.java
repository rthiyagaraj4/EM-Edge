...
public class DsDietTypeLang implements Serializable
{

    public DsDietTypeLang(){
    }

    public DsDietTypeLang(DsDietTypeLangId id)
    {
        this.id = id;
    }

    public DsDietTypeLang(DsDietTypeLangId id, String longDesc, String shortDesc, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, 
    ...
    public DsDietTypeLangId getId()
    {
        return id;
    }

    public void setId(DsDietTypeLangId id)
    {
        this.id = id;
    }
