...
/**
 * DsWardsForKitchen generated by MyEclipse - Hibernate Tools
 */

public class DsWardsForKitchen  implements java.io.Serializable {


    // Fields    

     private DsWardsForKitchenId id;
    ...
    /** default constructor */
    public DsWardsForKitchen() {
    }

	/** minimal constructor */
    public DsWardsForKitchen(DsWardsForKitchenId id) {
        this.id = id;
    }
    
    /** full constructor */
    public DsWardsForKitchen(DsWardsForKitchenId id, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
    ...
    public DsWardsForKitchenId getId() {
        return this.id;
    }
    
    public void setId(DsWardsForKitchenId id) {
        this.id = id;
    }
