...
public class DsIngredientLang
    implements Serializable
{

    public DsIngredientLang()
    {
    }

    public DsIngredientLang(DsIngredientLangId id)
    {
        this.id = id;
    }

    public DsIngredientLang(DsIngredientLangId id, String longDesc, String shortDesc, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, 
    ...
    public DsIngredientLangId getId()
    {
        return id;
    }

    public void setId(DsIngredientLangId id)
    {
        this.id = id;
    }
