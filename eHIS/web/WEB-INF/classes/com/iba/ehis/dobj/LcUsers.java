...
/**
 * LcUsers generated by MyEclipse - Hibernate Tools
 */
...
public class LcUsers  implements java.io.Serializable {
	...
	/** minimal constructor */
    public LcUsers(LcUsersId id, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
    ...
    /** full constructor */
    public LcUsers(LcUsersId id, String overrideWardConf, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
    ...
    public LcUsersId getId() {
        return this.id;
    }
    
    public void setId(LcUsersId id) {
        this.id = id;
    }

    public String getOverrideWardConf() {
        return this.overrideWardConf;
    }
