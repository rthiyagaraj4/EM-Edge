    ...
    implements Serializable
{
    ...
    public DsMenuLang(DsMenuLangId id)
    {
        this.id = id;
    }

    public DsMenuLang(DsMenuLangId id, String longDesc, String shortDesc, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, 
    ...
    public DsMenuLangId getId()
    {
        return id;
    }

    public void setId(DsMenuLangId id)
    {
        this.id = id;
    }
