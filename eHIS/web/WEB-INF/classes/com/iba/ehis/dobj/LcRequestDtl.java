...
/**
 * LcRequestDtl generated by MyEclipse - Hibernate Tools
 */

public class LcRequestDtl  implements java.io.Serializable {


    // Fields    

     private LcRequestDtlId id;
	...
	/** minimal constructor */
    public LcRequestDtl(LcRequestDtlId id, Long requestedQty, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo) {
        this.id = id;
    ...
    /** full constructor */
    public LcRequestDtl(LcRequestDtlId id, Long requestedQty, String remarks, String addedById, Date addedDate, String addedFacilityId, String addedAtWsNo, String modifiedById, Date modifiedDate, String modifiedFacilityId, String modifiedAtWsNo, Set lcIssueDtls) {
        this.id = id;
        this.requestedQty = requestedQty;
    ...
    public LcRequestDtlId getId() {
        return this.id;
    }
    
    public void setId(LcRequestDtlId id) {
        this.id = id;
    }
