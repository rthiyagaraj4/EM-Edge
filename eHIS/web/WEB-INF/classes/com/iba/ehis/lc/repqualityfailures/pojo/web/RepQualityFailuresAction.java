 ...
 ******************************************************************************/
package com.iba.ehis.lc.repqualityfailures.pojo.web;
...
import com.iba.ehis.lc.repqualityfailures.vo.RepQualityFailuresVO;
...
public class RepQualityFailuresAction extends LcAction{
	...
	protected DTO doPrePopulate(BaseVO valueObject, HttpServletRequest request, HttpServletResponse response)throws ApplicationException {
		...
		IBALogger.getLogger().debug(this.getClass(), ("facilityId"+lookUpVo),null);		
