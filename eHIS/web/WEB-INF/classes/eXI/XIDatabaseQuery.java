...
/**
 * The XIDatabaseQuery  is used to get the Results of any Query.
...
public class XIDatabaseQuery
{
/**
 * The XIDatabaseQuery is used to get the Results of SQL Query.
...
public HashMap getResults(HttpServletRequest request,HttpSession session,Connection conn)
{
		...
		int intFetchedRecords = 0;
		 ...
		 XIQueryContext qryContext = (XIQueryContext) session.getAttribute(XIQueryRender.qryContxt);
...
//			System.out.println("XIDatabaseQuery 75 ");

		   while(rs.next())
      	   {
//			System.out.println("XIDatabaseQuery 79 ");
...
//					System.out.println("!Clob Val 103 : "+rs.getString(l+1));
      ...
      {
         System.out.println("Error(1) in getresults method of xidatabasequery :"+expSQL.toString());
    ...
    {
	  System.out.println("XIDatabaseQuery sql : "+sql);
      System.out.println("XIDatabaseQuery 56 Cols : "+byteColumns);
      System.out.println("Error(2) in getresults method of xidatabasequery :"+exp.toString());
