...
public class RequestorTypeServlet extends HttpServlet
{
    ...
    HttpSession session;
	String class_indicator;  // added by mujafar for ML-MMOH-CRF-0762 
        ...
        throws ServletException, IOException
    {
        ...
        {            
            ...
            if(s.equals("insert"))
                insertRequestorType(httpservletrequest, httpservletresponse);
            if(s.equals("modify"))
                modifyRequestorType(httpservletrequest, httpservletresponse);
        }
    ...
    private void modifyRequestorType(HttpServletRequest httpservletrequest, HttpServletResponse httpservletresponse)
    {
        try
        {
            requestor_type_code = httpservletrequest.getParameter("requestor_type_code");
			...
			class_indicator    = checkForNull(httpservletrequest.getParameter("class_indicator")); // added by mujafar for ML-MMOH-CRF-0762 
            ...
            hashmap.put("requestor_type_code", requestor_type_code);
			hashmap.put("CLASSIFICATION_IND",class_indicator); // added by mujafar for ML-MMOH-CRF-0762 
			HashMap condflds=new HashMap();
			condflds.put("requestor_type_code",requestor_type_code);
			String tableName = "MR_REQUESTOR_TYPE";
        ...
        catch(Exception exception)
        {
            ...
            out.println(requestor_type_code + " " + longDesc + " " + shortDesc + " " + effectiveStatus); */
			
			exception.printStackTrace();
        }
    }

    private void insertRequestorType(HttpServletRequest httpservletrequest, HttpServletResponse httpservletresponse)
    {
        try
        {
            requestor_type_code = httpservletrequest.getParameter("requestor_type_code");
            ...
            tabdata.put("requestor_type_code", requestor_type_code);
			...
			tabdata.put("CLASSIFICATION_IND",class_indicator); // added by mujafar for ML-MMOH-CRF-0762 
			String dupflds[]={"requestor_type_code"};
			String tableName = "MR_REQUESTOR_TYPE";
