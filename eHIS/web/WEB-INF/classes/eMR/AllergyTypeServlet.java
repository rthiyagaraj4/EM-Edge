...
public class AllergyTypeServlet extends javax.servlet.http.HttpServlet
{
	PrintWriter out;
	Properties p;
	String AllergyType;
	...
	public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if ( operation.equals("insert") )   insertAllergyType(req, res);
			if ( operation.equals("modify"))    modifyAllergyType(req, res);
		}
		catch(Exception e)
		{
	...
	private void modifyAllergyType(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			AllergyType =req.getParameter("allergy_type_code");
			allergyclass =req.getParameter("allergy_class");
			...
			tabdata.put("allergy_class",allergyclass);
			...
			condflds.put("allergy_type_code",AllergyType);

			String tableName = "MR_ALLERGY_TYPE";
	...
	private void insertAllergyType(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			AllergyType =req.getParameter("allergy_type_code");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("ALLERGY_TYPE_CODE",AllergyType);
			tabdata.put("ALLERGY_CLASS",allergyclass);
			tabdata.put("LONG_DESC",longDesc);
			tabdata.put("SHORT_DESC",shortDesc);
			tabdata.put("EFF_STATUS",effectiveStatus);
			...
			String dupflds[]={"ALLERGY_TYPE_CODE"};
