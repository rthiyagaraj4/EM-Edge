...
public class MedicalEventTypeServlet extends javax.servlet.http.HttpServlet
{
	PrintWriter out;
	Properties p;
	String event_type;
	...
	public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if ( operation.equals("insert") )   insertMedicalEventType(req, res);
			if ( operation.equals("modify"))    modifyMedicalEventType(req, res);
		}
		catch(Exception e)
		{
	...
	private void modifyMedicalEventType(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			event_type =req.getParameter("event_type");
			...
			condflds.put("med_event_type_code",event_type);

			String tableName = "MR_MED_EVENT_TYPE";
		...
		catch ( Exception e )
		{
			...
			out.println( event_type + " "+longDesc + " "+shortDesc + " "+ effectiveStatus ); */
			
			e.printStackTrace();
		}
	}

	private void insertMedicalEventType(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			event_type =req.getParameter("event_type");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("med_event_type_code",event_type);
			tabdata.put("long_desc",longDesc);
			tabdata.put("short_desc",shortDesc);
			tabdata.put("eff_status",effectiveStatus);
			...
			String dupflds[]={"med_event_type_code"};
