 ...
 ******************************************************************************/
/*
@Funciton name: Medical Board Type CodeSetup
@Parameter: From AddModifyMedicalBoardType.jsp
Insert/Modify into mr_medical_board_type Table
*/
package eMR;
...
public class MedicalBoardTypeServlet extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        {            
            ...
            if(s.equals("insert"))
                insertMedBrdType(httpservletrequest, httpservletresponse);
            if(s.equals("modify"))
                modifyMedBrdType(httpservletrequest, httpservletresponse);
        }
    ...
    private void modifyMedBrdType(HttpServletRequest httpservletrequest, HttpServletResponse httpservletresponse)
    {
        try
        {
            med_board_type_code = httpservletrequest.getParameter("med_board_typecode");
           ...
           // Hashtable hashtable1 = new Hashtable();
            hashmap.put("med_board_type_code", med_board_type_code);
			HashMap condflds=new HashMap();
			condflds.put("med_board_type_code",med_board_type_code);
			String tableName = "mr_medical_board_type";
        ...
        catch(Exception exception)
        {
            ...
            out.println(med_board_type_code + " " + longDesc + " " + shortDesc + " " + effectiveStatus); */
			
			exception.printStackTrace();
        }
    }

    private void insertMedBrdType(HttpServletRequest httpservletrequest, HttpServletResponse httpservletresponse)
    {
        try
        {
            med_board_type_code = httpservletrequest.getParameter("med_board_typecode");
            ...
            tabdata.put("med_board_type_code", med_board_type_code);
			...
			String dupflds[]={"med_board_type_code"};
			String tableName = "mr_medical_board_type";
