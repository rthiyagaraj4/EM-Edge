...
public class QAIndicatorGroupServlet extends HttpServlet implements SingleThreadModel{
	PrintWriter out;
	String facilityId;
	HttpSession session;
	Properties p;
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		try	{
				...
				qind_group_id		   = req.getParameter("QIND_GROUP_ID");
				if(qind_group_id==null || qind_group_id.equals("") ||qind_group_id=="")
				qind_group_id= "";
				qind_group_desc		=  req.getParameter("QIND_GROUP_DESC");
				if(qind_group_desc==null || qind_group_desc.equals("") || qind_group_desc=="")
				qind_group_desc= "";
 ...
 private void  insertParameter(HttpServletResponse res){
  try{
		...
		tabdata.put("QIND_GROUP_DESC",qind_group_desc);
		...
		String dupflds[]={"QIND_GROUP_ID"  };
		try{
				
			String tabname="QA_QIND_GROUP";
 ...
 private void  modifyParameter(HttpServletResponse res){
  try{
		...
		condflds.put("QIND_GROUP_ID",qind_group_id);
		try{
			String tabname="QA_QIND_GROUP";
			boolean local_ejbs = false;
			if ((getServletConfig().getServletContext().getInitParameter("LOCAL_EJBS") !=null) &&(getServletConfig().getServletContext().getInitParameter("LOCAL_EJBS").equalsIgnoreCase("TRUE"))) local_ejbs = true;
