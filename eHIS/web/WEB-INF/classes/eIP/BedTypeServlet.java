...
public class BedTypeServlet extends javax.servlet.http.HttpServlet implements SingleThreadModel
{
	PrintWriter out;
	Properties p;
	String bedclasscode;
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if (operation.equals("insert"))	insertBedType(req, res);
			if (operation.equals("modify"))	 modifyBedType(req, res);
		}
		catch(Exception e)
		{
			e.printStackTrace();
	...
	private void insertBedType(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			bedclasscode				 = checkForNull(req.getParameter("code"));
    	//	setup_bl_dtls_in_ip_yn		 = checkForNull(req.getParameter("setup_bl_dtls_in_ip_yn"));
			...
			tabdata.put("bed_type_code",bedclasscode);
			...
			tabdata.put("bed_class_code",checkForNull(req.getParameter("bedclass")));
			tabdata.put("special_bed_type_yn",checkForNull(req.getParameter("special_bed_type"),"N"));
			tabdata.put("eff_status",checkForNull(req.getParameter("eff_status"),"D"));
			tabdata.put("added_by_id",modifiedById);
			tabdata.put("added_date",added_date1);
			tabdata.put("added_facility_id", facilityId);
			tabdata.put("added_at_ws_no",addedAtWorkstation);
			tabdata.put("modified_by_id",modifiedById);
			tabdata.put("modified_date",added_date1);
			tabdata.put("modified_facility_id",modifiedFacilityId);
			tabdata.put("modified_at_ws_no",modifiedAtWorkstation );
			String dupflds[]={"bed_type_code"};

			table_name		   = "ip_bed_type";
			...
			if ( inserted )
			{
				...
				/*if(setup_bl_dtls_in_ip_yn.equals("Y"))
				{
					...
					tabdata_bl.put("bed_type_code",bedclasscode);
					tabdata_bl.put("dly_charge",checkForNull(req.getParameter("daily_charge")));
					tabdata_bl.put("blng_serv_code",checkForNull(req.getParameter("billingservice")));
					tabdata_bl.put("blng_class_code",checkForNull(req.getParameter("billingclass")));
					tabdata_bl.put("added_by_id",modifiedById);
					tabdata_bl.put("added_date",added_date1);
	...
	//////////////////////////// M O D I F Y ///////////////////////////////////
	private void modifyBedType(HttpServletRequest req, HttpServletResponse res)
	{
		Connection con = null;
		try
		{
...
//			setup_bl_dtls_in_ip_yn		 = checkForNull(req.getParameter("setup_bl_dtls_in_ip_yn"));
			...
			condflds.put("bed_type_code",bedclasscode);
			...
			if ( inserted )
			{
				...
				/*if(setup_bl_dtls_in_ip_yn.equals("Y"))
				{
					...
					try
					{
						String sql = "select * from bl_ip_bed_type where bed_type_code ='"+bedclasscode+"' ";
