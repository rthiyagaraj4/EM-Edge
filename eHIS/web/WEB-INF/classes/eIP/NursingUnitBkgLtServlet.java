...
import eIP.IPNursingUnitBkgLt.*;

public class NursingUnitBkgLtServlet extends javax.servlet.http.HttpServlet implements SingleThreadModel
{
	PrintWriter out;
	Properties p;
	String sStyle;
	...
	public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		NursingUnitBkgLtAddModify(req, res);
	...
	private void NursingUnitBkgLtAddModify(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			...
			{
				out.println("<hr>") ;
				out.println("00"+S.get(i)+"<br>") ;
				out.println("1"+F.get(i)+"<br>") ;
				out.println("2"+M.get(i)+"<br>") ;
				out.println("3"+U.get(i)+"<br>") ;
				out.println("3"+T.get(i)+"<br>") ;
				out.println("4"+B.get(i)+"<br>") ;
			}
				...
				Object home = com.ehis.eslp.ServiceLocator.getInstance().getHome("java:comp/env/IPNursingUnitBkgLt",IPNursingUnitBkgLtManagerHome.class,local_ejbs);
				...
				HashMap results = (HashMap)(busObj.getClass().getMethod("NursUnitAddModify",paramArray)).invoke(busObj,argArray);
