...
public class MOEmbalmNumControlServlet extends HttpServlet 
{
	PrintWriter out;
	String facilityId;
	HttpSession session;
    ...
    private void  insertMOEmbalm(HttpServletResponse res){
        try
			{
			...
			String tabname="MO_EMBALM_NUM_CONTROL";
    ...
    private void  modifyMOEmbalm(HttpServletResponse res){
        try{
