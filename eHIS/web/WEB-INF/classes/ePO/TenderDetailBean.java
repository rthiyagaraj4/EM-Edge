...
public class TenderDetailBean extends ePO.Common.PoTransaction implements java.io.Serializable { 
	...
	private String 	tender_uom_desc = "";
	private String 	tender_uom_code = "";
	private String 	tender_qty = "";
	...
	public TenderDetailBean() {
	}

	public TenderDetailBean(java.util.Hashtable detailRecord) {

		System.out.println("detailRecord in tndr detail bean = "+detailRecord);
		...
		this.tender_uom_code = (String)detailRecord.get("temp_delv_uom_code");
		this.tender_uom_desc = (String)detailRecord.get("temp_delv_uom_desc");
		this.tender_qty = (String)detailRecord.get("tender_qty");
		...
		this.tender_price=(String)detailRecord.get("tender_price");
	...
	public TenderDetailBean(java.util.HashMap detailRecord) {
	...
	public TenderDetailBean(java.sql.ResultSet resultSetRecord) {
		try {
			
			System.out.println("resultSetRecord in tender detail bean = "+resultSetRecord);
				
			setSrl_no(resultSetRecord.getInt("TENDER_SRL_NO"));//TENDER_SRL_NO
			setItem_code(resultSetRecord.getString("item_code"));//item_code
			setItem_desc(resultSetRecord.getString("item_desc"));//item_desc
			setTender_uom_code(resultSetRecord.getString("TENDER_UOM"));//uom
			setTender_uom_desc(resultSetRecord.getString("uom_desc"));//uom_desc
			setTender_qty((String)resultSetRecord.getString("TENDER_QTY"));
			setTender_price((String)resultSetRecord.getString("TENDER_PRICE"));
	...
	public void setTender_uom_code(String tender_uom_code) {
		this.tender_uom_code = tender_uom_code;
	}

	public String getTender_uom_code() {
		return this.tender_uom_code;
	}
	
	public void setTender_uom_desc(String tender_uom_desc) {
		this.tender_uom_desc = tender_uom_desc;
	}

	public String getTender_uom_desc() {
		return this.tender_uom_desc;
	}
	...
	public void setTender_qty(String tender_qty ){
		this.tender_qty =tender_qty ;
	}

	public String getTender_qty() {
		return this.tender_qty ;
	}
	...
	public void setAll(java.util.Hashtable detailRecord) {
		...
		setTender_uom_code((String)detailRecord.get("tender_uom_code"));
		setTender_uom_desc((String)detailRecord.get("tender_uom_desc"));
		setTender_qty((String)detailRecord.get("tender_qty"));
		...
		setTender_price((String)detailRecord.get("tender_price"));
	...
	public String toString() {
		return srl_no+" = "+item_code + " = " +item_desc + " = " + uom + " = " + po_no+ " = " +facility_code+" = "+store_code+" = "+req_qty+" = "+order_qty+" = "+check_box_status+"="+conv_fact+"="+item_remarks+"="+po_srl_no+"="+rejection_remarks+"="+tender_uom_code+"="+tender_uom_desc+"="+tender_qty+"="+sample_qty+"="+free_qty+"="+rejected_qty+"="+batch_id+"="+trade_id+"="+expiry_date+"="+delv_date+"="+tender_price+"="+dis_amt+"="+dis_type+"="+net_amount+"="+tot_value+"="+delv_srl_no+"="+request_no +"=" +replace_type +"="+ sample_type +"=" + item_status + "=" + manufactur_id +"="+ first_delv_date + "="+ delv_freq_type + "="+ catalogue_no + "="+eq_shipment + "="+ no_of_delv + "=" + origin_country + "="+ item_remarks + "=" + item_specification;
	}
}	
