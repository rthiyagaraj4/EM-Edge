...
public class MessageContainer {
	...
	public String getDisplayMessage(String moduleName,String code,Object[] parameterArray){
		...
		try {
			displayMessage = MessageFormat.format(displayMessage,
					parameterArray);
		} catch (Exception e) {
			e.printStackTrace();
			/**
	 ...
	 * @return
	 */
	public String getDisplayMessage(String moduleName,int code){
		String codeString = ""+code;
		return getDisplayMessage(moduleName, codeString);
	}
	 ...
	 * @return
	 */
	public String getDisplayMessage(String moduleName,int code,Object[] parameterArray){
		String codeString = ""+code;
		return getDisplayMessage(moduleName, codeString, parameterArray);
	}
	 ...
	 * @return
	 */
	public String getResourceMessage(String moduleName,int code){
		String codeString = ""+code;
		return getResourceMessage(moduleName, codeString);
	}
	 ...
	 * @return
	 */
	public String getResourceMessage(String moduleName,int code,Object[] parameterArray){
		String codeString = ""+code;
		return getResourceMessage(moduleName, codeString, parameterArray);
	}
