 ...
 ******************************************************************************/
/****** Created Date Time 02/01/20024 By Ajay Hatwate for ML-MMOH-CRF-1653 ******/
package eAE;
...
public void doGet(HttpServletRequest req, HttpServletResponse res)
	...
	out.println("<html><head><link rel='stylesheet' type ='text/css' href='../../eCommon/html/IeStyle.css'></link><script language='javascript' src='../../eMP/js/PatientSuspension.js'></script></head><frameset rows='42,*,50'><frame name='commontoolbarFrame' id='commontoolbarFrame'	src='"+source+"' frameborder=0 scrolling='no' noresize> <frame name='f_query_add_mod' id='f_query_add_mod' src='../../eCommon/html/blank.html' frameborder=0><frame name='messageFrame'	src='../eCommon/jsp/MstCodeError.jsp' frameborder=0 noresize scrolling='auto'></frameset></html> ");
	}
	catch(Exception e)	{	}
	}
private void modifyPatientSuspension(HttpServletRequest req, HttpServletResponse res)	{
	try {
	case_type_code=req.getParameter("case_type_code");
...
String modifiedAtWorkstation = addedAtWorkstation ;
			...
			condflds.put("case_type_code",case_type_code);
...
String modifiedAtWorkstation = addedAtWorkstation ;
			...
			String dupflds[]={"case_type_code"};
			
			Iterator hmIter = tabdata.entrySet().iterator();
			while(hmIter.hasNext()){
				Map.Entry ent = (Map.Entry)hmIter.next();				
