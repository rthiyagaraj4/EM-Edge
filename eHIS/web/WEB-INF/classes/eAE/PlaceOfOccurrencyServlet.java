...
public class PlaceOfOccurrencyServlet extends HttpServlet implements SingleThreadModel{
	PrintWriter out;
	String facilityId;
	HttpSession session; 
	Properties p;
	...
	String mode;
	String place_occurrence_type_code;     // place_occurrence_type_code        
	String long_desc;    
	String short_desc;   
	String eff_status;                                        
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		try	{
			...
			place_occurrence_type_code 	=  req.getParameter("place_occurrence_type_code");
			...
			{
			     insertDisasterType(res);
			}
            else 
			{
			     modifyDisasterType(res);
			}
		}catch(Exception e){
			e.printStackTrace();
		}
 ...
 private void  insertDisasterType( HttpServletResponse res){
  ...
  try{
	...
	tabdata.put("PLACE_OCCURRENCE_TYPE_CODE",place_occurrence_type_code);
	...
	String dupflds[]={"PLACE_OCCURRENCE_TYPE_CODE"};

	try{
		boolean local_ejbs = false;
		String tablename ="AE_PLACE_OF_OCCURRENCE";
 ...
 private void  modifyDisasterType(HttpServletResponse res){
 try{
	...
	condflds.put("PLACE_OCCURRENCE_TYPE_CODE",place_occurrence_type_code);
	try{
		boolean local_ejbs = false;
		String tablename ="AE_PLACE_OF_OCCURRENCE";
		if ((getServletConfig().getServletContext().getInitParameter("LOCAL_EJBS") !=null) &&(getServletConfig().getServletContext().getInitParameter("LOCAL_EJBS").equalsIgnoreCase("TRUE"))) local_ejbs = true;
