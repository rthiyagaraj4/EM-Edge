...
public class DisasterTypeServlet extends HttpServlet implements SingleThreadModel{
	PrintWriter out;
	String facilityId;
	HttpSession session; 
	Properties p;
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		try	{
			...
			disaster_type_code 	=  req.getParameter("disaster_type_code");
 ...
 private void  insertDisasterType( HttpServletResponse res){
  try{
	...
	tabdata.put("DISASTER_TYPE_CODE",disaster_type_code);
	...
	String dupflds[]={"DISASTER_TYPE_CODE"};

	try{
		boolean local_ejbs = false;
		String tablename ="AE_DISASTER_TYPE";
 ...
 try{
	...
	condflds.put("DISASTER_TYPE_CODE",disaster_type_code);
	try{
		boolean local_ejbs = false;
		String tablename ="AE_DISASTER_TYPE";
		if ((getServletConfig().getServletContext().getInitParameter("LOCAL_EJBS") !=null) &&(getServletConfig().getServletContext().getInitParameter("LOCAL_EJBS").equalsIgnoreCase("TRUE"))) local_ejbs = true;
