...
public class BedforTreatmentAreaServlet extends HttpServlet implements SingleThreadModel{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException{
		...
		try	{
			...
			eff_status						= "D";
			pseudo_bed 						=  req.getParameter("pseudo_bed_val");
			
			if(pseudo_bed==null || pseudo_bed.equals("") || pseudo_bed=="")
			pseudo_bed						= "N";
 ...
 private void  insertBedTreatmentArea(HttpServletRequest req, HttpServletResponse res){
  ...
  try{
		...
		java.util.HashMap tabdata=new HashMap();
				...
				tabdata.put("BED_NO",req.getParameter("bed_no_val")==null?"":req.getParameter("bed_no_val"));
				tabdata.put("BAY_TYPE_CODE",
req.getParameter("bay_type")==null?"":req.getParameter("bay_type"));
				tabdata.put("CURRENT_STATUS","A");
				tabdata.put("EFF_STATUS",eff_status);
				tabdata.put("PSEUDO_BED_YN",pseudo_bed);
   			...
   			String dupflds[]={"CLINIC_CODE","TREATMENT_AREA_CODE","BED_NO","FACILITY_ID"};
		try{ 
...
req.getParameter("bay_type")==null?"":req.getParameter("bay_type"));
		...
		java.util.HashMap condflds=new HashMap();
				...
				condflds.put("BED_NO",req.getParameter("bed_no_val")==null?"":req.getParameter("bed_no_val")); 
