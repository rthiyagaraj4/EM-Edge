package eBL.reprintreport.request;

import java.io.Serializable;
import java.util.List;

/**
 * Request Object create for inserting to SY Prog Param table.
 * Since it accepts 30 dynamic params , named the params as Param 1,2,3 ,...
...
public class ReprintRequest implements Serializable{
	...
	List<ReprintRequest> requestList = null;
	public List<ReprintRequest> getRequestList() {
		return requestList;
	}
	public void setRequestList(List<ReprintRequest> requestList) {
