...
public class AddModifyPatFinDetailsBean_APRER {
	...
	public JsonObject getRefSourceFlagsForP1(String priority_1_blng_grp_code,
		...
		try {
			...
			try {
				...
				System.err
						.println("Exception in getRefSourceFlagsForP1" + eInr);
				eInr.printStackTrace();
			}
	...
	public JsonObject getblngGrpDesc(String blng_grp_code, String locale,
		...
		try {
			String billing_grp_qry = "SELECT SHORT_DESC,CURRENCY_CODE,CURRENCY_DESC FROM BL_BLNG_GRP_LANG_VW WHERE BLNG_GRP_ID = '"
					+ blng_grp_code + "' AND LANGUAGE_ID = '" + locale + "'";
	...
	public HashMap<String, String> claimCreditMap(String rtn_ins_cust_priority,
		...
		try {
			...
			StringTokenizer tok_rtn_rtn_ins_policy_no = new StringTokenizer(
					rtn_ins_policy_no, "|");
			String claim_code_sql = " SELECT claim_code, credit_auth_by, membership_no "
			...
			while (tok_rtn_ins_cust_priority.hasMoreTokens()) {
				...
				String tmpPolEffFrom = tok_rtn_ins_policy_eff_from_date
						.nextToken();
				String tmpPolNum = tok_rtn_rtn_ins_policy_no.nextToken();
				...
				if (rs.next()) {
					...
					System.out
							.println("claim_code / credit_authorisation_by / membershipId "
									+ claim_code
									+ "/ "
									+ credit_authorisation_by
									+ "/ "
					...
					claimCreditMap.put(tmpPriority, claim_code + "~"
							+ credit_authorisation_by + "~" + membershipId);
		...
		System.out.println("claimCreditMap Bean " + claimCreditMap);
	...
	public JsonObject validPayerYN(String strModuleId,String custCode,String custGrpCode,Connection con)
	{
		...
		String validPayerYNSql="select DISTINCT 'Y',to_char(a.VALID_FROM,'dd/mm/yyyy') VALID_FROM,to_char(a.VALID_TO,'dd/mm/yyyy') VALID_TO,a.status status from ar_customer a, ar_cust_group b,sy_acc_entity c,bl_cust_by_cust_group e where a.acc_entity_code= b.acc_entity_code and a.acc_entity_code = c.acc_entity_code and a.patient_flag = 'Y' and NVL(a.pat_com_flag,'N') = 'N' and nvl(a.insurance_yn,'Y') = 'Y' /*and a.status is null*/ and (('"+strModuleId+"' in ('OP','AE') and nvl(a.op_yn,'N') = 'Y') or ('"+strModuleId+"' in ('IP','DC') and nvl(a.ip_yn,'N') = 'Y') or ('"+strModuleId+"' = 'MP' and nvl(ref_yn,'N') = 'Y')) and a.cust_code = e.cust_code and b.cust_group_code = e.cust_group_code AND a.CUST_CODE ='"+custCode+"' and b.cust_group_code='"+custGrpCode+"'";
	...
	public JsonObject getvalidPolicyTypeCodeYN(String empty_sql_check,String strModuleId,String custCode,String custGrpCode, String policyTypeCode,String locale,String facility_id ,Connection con)
	{
		...
		String valid_policy_type_code_YN = "";
			...
			String valid_policy_type_code_YN_sql="Select DISTINCT 'Y',a.status from bl_ins_policy_types_lang_vw a, bl_ins_policy_type_hdr b, bl_cust_by_cust_group c where a.language_id='"+locale+"'  and a.operating_facility_id='"+facility_id+"' /*and nvl(a.status,'N') <> 'S'*/ and a.operating_facility_id = b.operating_facility_id and a.policy_type_code = b.policy_type_code and b.cust_code='"+custCode+"' and b.cust_group_code='"+custGrpCode+"' and b.cust_group_code = c.cust_group_code and b.cust_code=c.cust_code and (('"+strModuleId+"' in ('OP','AE') and nvl(b.outpatient_cover,'N') = 'Y') or ('"+strModuleId+"' in ('IP','DC') and nvl(b.inpatient_covered,'N') = 'Y') or ('"+strModuleId+"' = 'MP' and nvl(b.external_covered,'N') = 'Y')) AND b.policy_type_code ='"+policyTypeCode+"'";
			...
			{ 
					valid_policy_type_code_YN_sql="Select DISTINCT 'Y',a.status from bl_ins_policy_types_lang_vw a, bl_ins_policy_type_hdr b, bl_cust_by_cust_group c where a.language_id='"+locale+"' and a.operating_facility_id='"+facility_id+"' /*and nvl(a.status,'N') <> 'S'*/ and a.operating_facility_id = b.operating_facility_id and a.policy_type_code = b.policy_type_code  and b.cust_group_code='"+custGrpCode+"' and b.cust_group_code = c.cust_group_code and b.cust_code = '**' and (('"+strModuleId+"' in ('OP','AE') and nvl(b.outpatient_cover,'N') = 'Y') or ('"+strModuleId+"' in ('IP','DC') and nvl(b.inpatient_covered,'N') = 'Y') or ('"+strModuleId+"' = 'MP' and nvl(b.external_covered,'N') = 'Y')) AND b.policy_type_code ='"+policyTypeCode+"'";
					pstmt = con.prepareStatement(valid_policy_type_code_YN_sql);
					rs=pstmt.executeQuery();
					if( rs != null ) 
					{	
	...
	public JsonObject getCustValidDates(String custCode,Connection con){
		...
		String cust_valid_to_date = "";
		try{
			String cust_valid_dates_qry = "select to_char(VALID_FROM,'dd/mm/yyyy') VALID_FROM,to_char(VALID_TO,'dd/mm/yyyy') VALID_TO from ar_customer where patient_flag = 'Y' and NVL(pat_com_flag,'N') = 'N'  and nvl(insurance_yn,'Y') = 'Y'   and status is null and cust_code='"+custCode+"'";
	...
	public JsonObject getCurrencyCode(String blngGrpId,String locale,Connection con){
		...
		String str_currency_desc_for_bg = "";
		try{
			String curr_code_qry = "select CURRENCY_CODE,CURRENCY_DESC from bl_blng_grp_lang_vw where blng_grp_id='"+blngGrpId+"' and language_id='"+locale+"'";
	...
	public String payerSuspendedYn(String strModuleId,String custCode, String custGroupCode, Connection con){
		...
		String payer_suspended_YN = "";
		try{
			String payer_suspended_YN_sql="select a.status status from ar_customer a, ar_cust_group b,sy_acc_entity c,bl_cust_by_cust_group e where a.acc_entity_code= b.acc_entity_code and a.acc_entity_code = c.acc_entity_code and a.patient_flag = 'Y' and NVL(a.pat_com_flag,'N') = 'N' and nvl(a.insurance_yn,'Y') = 'Y' /* and a.status is null */ and (('"+strModuleId+"' in ('OP','AE') and nvl(a.op_yn,'N') = 'Y') or ('"+strModuleId+"' in ('IP','DC') and nvl(a.ip_yn,'N') = 'Y') or ('"+strModuleId+"' = 'MP' and nvl(ref_yn,'N') = 'Y')) and a.cust_code = e.cust_code and b.cust_group_code = e.cust_group_code AND a.CUST_CODE ='"+custCode+"' and b.cust_group_code='"+custGroupCode+"'";
	...
	public JsonObject getpolicySuspendedYN(String empty_sql_check,String strModuleId,String custCode,String custGrpCode, String policyTypeCode,String locale,String facility_id ,Connection con)
	{
		...
		ResultSet rs = null;
		String policy_suspended_YN="";
		String policy_suspended_YN_sql="Select a.status from bl_ins_policy_types_lang_vw a, bl_ins_policy_type_hdr b, bl_cust_by_cust_group c where a.language_id='"+locale+"'  and a.operating_facility_id='"+facility_id+"' and a.operating_facility_id = b.operating_facility_id and a.policy_type_code = b.policy_type_code and b.cust_code='"+custCode+"' and b.cust_group_code='"+custGrpCode+"' and b.cust_group_code = c.cust_group_code and b.cust_code=c.cust_code and (('"+strModuleId+"' in ('OP','AE') and nvl(b.outpatient_cover,'N') = 'Y') or ('"+strModuleId+"' in ('IP','DC') and nvl(b.inpatient_covered,'N') = 'Y') or ('"+strModuleId+"' = 'MP' and nvl(b.external_covered,'N') = 'Y')) AND b.policy_type_code ='"+policyTypeCode+"'";
		...
		try{
			...
			if(empty_sql_check.equals("Y"))
			{
				policy_suspended_YN_sql="Select DISTINCT a.status from bl_ins_policy_types_lang_vw a, bl_ins_policy_type_hdr b, bl_cust_by_cust_group c where a.language_id='"+locale+"'  and a.operating_facility_id='"+facility_id+"' and a.operating_facility_id = b.operating_facility_id and a.policy_type_code = b.policy_type_code and b.cust_group_code='"+custGrpCode+"' and b.cust_group_code = c.cust_group_code and b.cust_code = '**' and (('"+strModuleId+"' in ('OP','AE') and nvl(b.outpatient_cover,'N') = 'Y') or ('"+strModuleId+"' in ('IP','DC') and nvl(b.inpatient_covered,'N') = 'Y') or ('"+strModuleId+"' = 'MP' and nvl(b.external_covered,'N') = 'Y')) AND b.policy_type_code ='"+policyTypeCode+"'";
