...
public class StockSummaryListBean extends StAdapter
    implements Serializable
{
//private String language;
    public StockSummaryListBean()
    {
        module_id = "ST";
    }
...
//        Object obj = null;
        try
        {
            ...
            preparedstatement = connection.prepareStatement(StRepository.getStKeyValue("SQL_SM_MASTER_CODE_SELECT_REPORTS"));
...
public String getLanguageId() {
    ...
    {
        return getStaticListOptionTag("A,Request;B,Issue;C,Manufacturing Receipts;D,Adjustment;E,Transfer;F,Issue Return;G,Goods Received Note;H,Goods Return to Vendor;J,Bonus;K,Product Transfer");//;I,Sales
    }
...
*/
	...
	public String getfrmdate() throws Exception
    {
         Connection connection = null;
         PreparedStatement preparedstatement = null;
		 ResultSet resultset = null;
        ...
        try
        {
		  String sql= "SELECT TO_CHAR(TRUNC(SYSDATE,'MM'),'DD/MM/YYYY') FirstDay  FROM DUAL";
             connection = getConnection();
             preparedstatement = connection.prepareStatement(sql);
             resultset=  preparedstatement.executeQuery(); 
                 if (resultset != null && resultset.next()) {
				first_day	 =  (String)resultset.getString("FirstDay");
        }
		}
        catch(Exception exception)
        {
