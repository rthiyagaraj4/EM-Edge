...
public class DrugStockStatusByStoreBean extends StTransaction implements Serializable{ 
	...
	public ArrayList getATCClassificationdesc(String generic_id,String language) throws Exception{
	ArrayList alAtcClassification =new ArrayList();
	String params[] = {generic_id,language};
	try{
		String stSQL = getStRepositoryValue("SQL_ST_DRUG_STOCK_STATUS_BY_STORE_ATC_DESC");
			alAtcClassification = fetchRecords(stSQL.toString(),params);
			
			return alAtcClassification;
	  }catch (Exception e){
			e.printStackTrace() ;
			throw e ;
	 } 
