...
public class CancelRequestRemarksBean implements Serializable {
	private String doc_type_code;
	private String doc_no;
	private String remarks;
	private String remarks_code; //17/08/12

	public CancelRequestRemarksBean() {
	}

	public CancelRequestRemarksBean(String doc_type_code, String doc_no, String remarks,String remarks_code) {
