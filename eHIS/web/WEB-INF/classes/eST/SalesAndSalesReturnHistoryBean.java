...
public class SalesAndSalesReturnHistoryBean extends StTransaction implements Serializable{
...
//added for IN069649 start
public String getAllDoc_type_code_ListOptions(String defaultDoc_type_code){
	ArrayList alParameters	=	new ArrayList();
	alParameters.add(getLoginFacilityId());
	return getListOptionTag( getListOptionArrayList(getStRepositoryValue("SQL_ST_TRN_DOC_TYPE_SELECT_LIST8"),alParameters), defaultDoc_type_code);
}//added for IN069649 end
...
public ArrayList queryResultDetails(String facility_id,String store_code2,String item_code2,String sal_trn_type2,String patient_id2,String from_date2 , String to_date2,String encounter_id2, String sal_doc_type2, String doc_no2) throws Exception
{
		...
		try {
			...
			pstmt.setString( 2, from_date2 ) ;
			pstmt.setString( 3, to_date2 ) ;
