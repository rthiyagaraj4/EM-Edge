...
public class POCancelRequestDetailBean implements Serializable {
	private int srl_no;
	private int doc_no;
	...
	public POCancelRequestDetailBean(java.sql.ResultSet resultSetRecord) {
		try {
			...
			setIssued_qty(resultSetRecord.getString("grn_qty"));
