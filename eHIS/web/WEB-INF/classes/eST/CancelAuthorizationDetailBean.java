...
public class CancelAuthorizationDetailBean implements Serializable {
	private int srl_no;
	private int doc_no;
	...
	private String comitted_qty;


	public CancelAuthorizationDetailBean(java.sql.ResultSet resultSetRecord) {
		try {
			...
			setComitted_item_qty(resultSetRecord.getString("committed_item_qty"));	
		}
	...
	public void setComitted_item_qty(String commit_item_qty) {	
		this.comitted_qty = commit_item_qty;
	}
	
	public String getComitted_item_qty() {
		return this.comitted_qty;
	}
