...
public class MSpecialityLinkServlet extends javax.servlet.http.HttpServlet {
	...
	throws javax.servlet.ServletException,IOException{
		...
		String speciality_module = checkForNull(req.getParameter("speciality_module"));
		PrintWriter out;
		...
		try{
				...
				String select_value = "";
				String msg="";
                String sqlDelete="DELETE FROM AM_SPLTY_FOR_SPLTY_MODULES WHERE MODULE_ID=? AND SPECIALITY_CODE=?";
				String sqlInsert="INSERT INTO AM_SPLTY_FOR_SPLTY_MODULES (MODULE_ID,SPECIALITY_CODE,ADDED_BY_ID,ADDED_DATE,ADDED_AT_WS_NO,ADDED_FACILITY_ID,MODIFIED_BY_ID,MODIFIED_DATE,MODIFIED_AT_WS_NO,MODIFIED_FACILITY_ID) VALUES (?,?,?,SYSDATE,?,?,?,SYSDATE,?,?)";
