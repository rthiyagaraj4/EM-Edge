...
package eAM;
/**
 *		FileName : SubserviceinfacilityServlet.java
 *		Version	 : 3
 *		Date	 : 14-2-05	
**/
import java.sql.*;
...
public class SubserviceinfacilityServlet extends javax.servlet.http.HttpServlet
{
	PrintWriter out;
	...
	public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			{
				insertSubService(req, res);
			}else if ( operation.equals("modify"))  
			{
				modifySubService(req, res);
			}
		}
		catch(Exception e)
		{
	...
	private void modifySubService(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			operatingfacilityid=req.getParameter("facility_id");
			servicecode  = req.getParameter("service_code");
			subservicecode = req.getParameter("subservice_code");
			deptcode = req.getParameter("dept_code");
			sectioncode = req.getParameter("section_code");
			//sectioncode="L";
			...
			HashMap tabdata=new HashMap();
				...
				HashMap condflds=new HashMap();
					condflds.put("operating_facility_id",operatingfacilityid);
			...
			final java.util.Hashtable results = singleTabHandlerManagerRemote.update(p,tabdata,condflds,"am_facility_subsrvc");*/
			...
			String table_name="am_facility_subsrvc";
	    ...
	    }catch ( Exception e )
		{
			...
			out.println( operatingfacilityid+ " "+servicecode + " "+subservicecode +" "+deptcode+" "+ sectioncode+" "+ effectiveStatus );
	...
	private void insertSubService(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			...
			java.sql.Date modified_date = java.sql.Date.valueOf( modifiedDate ) ;
				...
				HashMap tabdata=new HashMap();
				tabdata.put("operating_facility_id",operatingfacilityid);
				...
				String dupflds[]={"service_code","operating_facility_id","subservice_code"};
			...
			final SingleTabHandlerManagerHome singleTabHandlerManagerHome  = (SingleTabHandlerManagerHome) PortableRemoteObject.narrow(homeObject ,SingleTabHandlerManagerHome.class);
			final SingleTabHandlerManagerRemote singleTabHandlerManagerRemote = singleTabHandlerManagerHome.create();
			final java.util.Hashtable results = singleTabHandlerManagerRemote.insert(p,tabdata,dupflds,"am_facility_subsrvc");*/
