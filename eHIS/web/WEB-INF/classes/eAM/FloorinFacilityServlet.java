...
package eAM;
/**
 *		FileName : FloorinFacilityServlet.java
 *		Version	 : 3
 *		Date	 : 15-2-05	
**/
...
public class FloorinFacilityServlet extends javax.servlet.http.HttpServlet
{
	PrintWriter out;
	...
	public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if ( operation.equals("insert") )   insertFloorinFacility(req, res);
			if ( operation.equals("modify"))    modifyFloorinFacility(req, res);
		}
		catch(Exception e)
		{
	...
	private void modifyFloorinFacility(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			...
			HashMap condflds=new HashMap();
				condflds.put("floor_code",floorcode);
			...
			final java.util.Hashtable results = singleTabHandlerManagerRemote.update(p,tabdata,condflds,"am_bldng_floor");*/
		...
		/*	Object argArray[] = new Object[4];
			String table_name="am_bldng_floor";
		...
		catch ( Exception e )
		{
			...
			out.println( bldngcode+ " "+floorcode+""+longDesc + " "+shortDesc + " "+ effectiveStatus );
		}
	}

	private void insertFloorinFacility(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			...
			HashMap tabdata=new HashMap();
				...
				String dupflds[]={"floor_code","bldng_code","operating_facility_id"};

			/*InitialContext context = new InitialContext();
			Object homeObject = context.lookup("java:comp/env/SingleTabHandler");
			final SingleTabHandlerManagerHome singleTabHandlerManagerHome  = (SingleTabHandlerManagerHome) PortableRemoteObject.narrow(homeObject ,SingleTabHandlerManagerHome.class);
			final SingleTabHandlerManagerRemote singleTabHandlerManagerRemote = singleTabHandlerManagerHome.create();
			final java.util.Hashtable results = singleTabHandlerManagerRemote.insert(p,tabdata,dupflds,"am_bldng_floor");*/
