...
import java.util.*;
public class DiscrMsrCompParagraphDomParser implements java.io.Serializable 
{
	StringBuffer displayString=new StringBuffer();
	public DiscrMsrCompParagraphDomParser(){}	 
	public StringBuffer updateXMLParaCompNames(StringBuffer XMLContent,int srlNo,String compId,int paraNo) 
	{
		try
		{
			...
			NodeList nl=null;
			Node n = null,nodeName=null,nodeValue=null;
