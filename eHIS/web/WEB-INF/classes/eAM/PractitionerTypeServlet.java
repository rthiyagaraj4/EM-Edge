...
public class PractitionerTypeServlet extends javax.servlet.http.HttpServlet
{
	PrintWriter out;
	//String mysql;
	...
	private void modifyPractitioner(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			pract_type=req.getParameter("pract_type");
			desc_sysdef = req.getParameter("desc_sysdef");
			desc_userdef = req.getParameter("desc_userdef");
			seq_no=req.getParameter("seq_no");
			...
			java.sql.Date modified_date = java.sql.Date.valueOf( modifiedDate ) ;
				...
				tabdata.put("desc_sysdef",desc_sysdef);
				tabdata.put("desc_userdef",desc_userdef);
			...
			final java.util.Hashtable results = singleTabHandlerManagerRemote.update(p,tabdata,condflds,"am_pract_type");*/
			...
			hashmap.put("tabdata",tabdata);
				...
				String table_name="am_pract_type";
		...
		catch ( Exception e )
		{
			...
			out.println( pract_type+ " "+desc_sysdef + " "+desc_userdef + " "+ effectiveStatus );
		}
	}
}
