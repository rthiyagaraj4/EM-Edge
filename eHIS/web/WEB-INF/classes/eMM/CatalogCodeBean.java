...
public class CatalogCodeBean extends MmAdapter implements Serializable  
{	protected String catalog_code			= "";
...
//	protected String language_id;
	...
	public CatalogCodeBean()throws Exception
	{ 
		try
		{
			doCommon();
...
//********* * Set Methods Start **************************
	public void setMasterCode (String catalog_code)
	{
...
//*************************************************************************
	...
	{	
		...
		for(int i=0; i<10;i++)
		{
			String catalogCode = "catalog_code"  + i ;
			...
			if(!
				  (  (((String)hashMultiple.get(catalogCode))).trim().equals("")
										||
			  ...
			  )
			{
				...
				insertRow.add( (String)hashMultiple.get(  ("catalog_code" + i)    )  ) ;
				...
				whereRow.add( (String)hashMultiple.get(  ("catalog_code" + i) )  ) ; 
		...
		try
		{
			sqlMap.put( "SelectSQL", MmRepository.getMmKeyValue( "SQL_MM_CATALOG_CODE_EXISTS") ); 
			sqlMap.put( "InsertSQL", MmRepository.getMmKeyValue( "SQL_MM_CATALOG_CODE_INSERT") );  
			...
			//System.err.println("map---------------in item analysis------->"+map);
			//System.err.println("map--------getMM message------->"+getMMMessage(getLanguageId(),(String) map.get( "msgid" ),"ST") );
	...
	//	SingleTableHandlerHome home = null ;
		...
		try
			{
				sqlMap.put( "ModifySQL", MmRepository.getMmKeyValue( "SQL_MM_CATALOG_CODE_UPDATE") );   
...
public void loadData() throws Exception {
		...
		try {
			...
			pstmt = connection.prepareStatement(MmRepository.getMmKeyValue( "SQL_MM_CATALOG_CODE_MODIFY"));
			...
			if ((resultSet != null) && (resultSet.next())) {				
				setMasterCode(resultSet.getString("catalog_code")); 
