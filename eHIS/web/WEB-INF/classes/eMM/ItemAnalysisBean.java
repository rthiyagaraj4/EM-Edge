...
public class ItemAnalysisBean extends MmAdapter implements Serializable
{	protected String item_anal_code			= "";
...
//	protected String language_id;
	...
	public ItemAnalysisBean()throws Exception
	{ 
		try
		{
			doCommon();
...
//********* * Set Methods Start **************************
	public void setMasterCode (String item_anal_code)
	{
		this.item_anal_code = item_anal_code;
	}
...
//*************************************************************************
	...
	{	
		...
		for(int i=0; i<10;i++)
		{
			String itemAnalCode = "item_anal_code"  + i ;
			...
			if(!
				  (  (((String)hashMultiple.get(itemAnalCode))).trim().equals("")
										||
			  ...
			  )
			{
				...
				insertRow.add( (String)hashMultiple.get(  ("item_anal_code" + i)    )  ) ;
				...
				whereRow.add( (String)hashMultiple.get(  ("item_anal_code" + i) )  ) ;
...
public void loadData() throws Exception {
		...
		try {
			...
			pstmt.setString( 1, item_anal_code);
		

			resultSet = pstmt.executeQuery();

			if ((resultSet != null) && (resultSet.next())) {				
				setMasterCode(resultSet.getString("item_anal_code"));
