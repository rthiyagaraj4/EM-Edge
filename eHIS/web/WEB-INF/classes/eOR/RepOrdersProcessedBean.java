...
public class RepOrdersProcessedBean	 extends OrAdapter implements Serializable {
...
/*	public void getActivityType(String order_Category, String order_type_code) {
		...
		try
		  {
			con	  = getConnection();
			pstmt = con.prepareStatement(OrRepository.getOrKeyValue("SQL_ACTIVITY_TYPE_SELECT"));
			pstmt.setString( 1, order_Category);
	...
	public void getLocation() 
		...
		try
		  {
			con	  = getConnection();
			pstmt = con.prepareStatement(OrRepository.getOrKeyValue("SQL_OR_AUTHORISE_ORDER_SELECT_LOCN"));
			...
			while(rs != null && rs.next())
				{
					loc_tion = rs.getString("locn_code");
				}
