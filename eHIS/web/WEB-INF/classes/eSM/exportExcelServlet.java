...
public class exportExcelServlet extends javax.servlet.http.HttpServlet {
	...
	public synchronized void doPost(HttpServletRequest request,	HttpServletResponse response) 
		...
		ResultSet rset = null;
		Statement stmt =  null;
		String reportId 		= checkForNull(request.getParameter("p_report_id"));
		String moduleId 		= checkForNull(request.getParameter("p_module_id"));
		...
		response.setHeader("Content-Disposition","attachment;filename="+reportId+"-"+timestamp+".xls");
