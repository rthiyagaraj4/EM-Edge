...
public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException	
{
    ...
    try 
	{
		...
		if(operation.equals("insert")) insertContact(req, res);
		if(operation.equals("modify")) modifyContact(req, res);
	}
	catch (Exception e)	
	{
...
String modifiedAtWorkstation = addedAtWorkstation ;
			...
			tabdata.put("contact_mode",ContactCode);
			...
			condflds.put("contact_mode",ContactCode);
    	...
    	res.sendRedirect("../eCommon/jsp/MstCodeError.jsp?err_num=" + java.net.URLEncoder.encode( error, "UTF-8") + "&err_value=" + error_value );
			...
			out.println( ContactCode + " "+longDesc + " "+shortDesc +" "+ effectiveDateFrom+" "+ effectiveDateTo + " "+ effectiveStatus ); */
			e.printStackTrace();
		}
	}
private void insertContact(HttpServletRequest req, HttpServletResponse res)	{
	try {
	ContactCode = req.getParameter("contact_code");
	longDesc = req.getParameter("long_desc");
	shortDesc = req.getParameter("short_desc");
