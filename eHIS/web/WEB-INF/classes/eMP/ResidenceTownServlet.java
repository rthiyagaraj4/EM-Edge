 ...
 ******************************************************************************/
/*** 
 * Last Modified Date Time 9/22/2005 11:03 AM
...
public class ResidenceTownServlet extends HttpServlet	{
	PrintWriter out;
	...
	private void modifyTown(HttpServletRequest req, HttpServletResponse res){
		try {
			restowncode		= req.getParameter("res_town_code");
			resareacode		= req.getParameter("res_area_code");
			longDesc		= req.getParameter("long_desc");
			shortDesc		= req.getParameter("short_desc");
			if(resareacode.equals(null))
			{
          resareacode=" ";
				}
			...
			condflds.put("res_town_code",restowncode);
			...
			out.println( restowncode + " " + resareacode + " "  +longDesc + " "+shortDesc +" "+ effectiveDateFrom+" "+ effectiveDateTo + " "+ effectiveStatus ); */
			e.printStackTrace();
		}
	}

	private void insertTown(HttpServletRequest req, HttpServletResponse res){
		try{
			restowncode		= req.getParameter("res_town_code");
			resareacode		= req.getParameter("res_area_code");
			longDesc		= req.getParameter("long_desc");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("res_town_code",restowncode);
			tabdata.put("res_area_code",resareacode);
			tabdata.put("long_desc",longDesc);
			tabdata.put("short_desc",shortDesc);
			tabdata.put("eff_status",effectiveStatus);
