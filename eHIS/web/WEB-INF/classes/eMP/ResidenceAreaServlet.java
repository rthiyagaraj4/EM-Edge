 ...
 ******************************************************************************/
/****** Last Modified Date Time 9/22/2005 11:48 AM ******/
package eMP;
...
public class ResidenceAreaServlet extends javax.servlet.http.HttpServlet	
{
	PrintWriter out;
        ...
        throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if ( operation.equals("insert") )
				insertResidenceArea(req, res);
			if ( operation.equals("modify"))
				modifyResidenceArea(req, res);
		}
		catch (Exception e)
		{
	...
	private void modifyResidenceArea(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			resareacode			= req.getParameter("res_area_code");
			residenceAreacode	= req.getParameter("region_code");
			...
			tabdata.put("region_code",residenceAreacode);
			...
			condflds.put("res_area_code",resareacode);
		...
		{
			e.printStackTrace(); // Added by lakshmanan for security issue ID 174041131 on 15-09-2023
			// out.println("<h3> Exception raise by Servlet ...So Record Not Modified </h3> Foll: Error Received : "+e.toString());
			// out.println( "Values sent are : <br>" ) ;
			// out.println( residenceAreacode + " "+longDesc + " "+shortDesc +" "+ effectiveDateFrom+" "+ effectiveDateTo + " "+ effectiveStatus );
		}
	}

	private void insertResidenceArea(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			resareacode		  = req.getParameter("res_area_code");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("res_area_code",resareacode);
			tabdata.put("long_desc",longDesc);
			tabdata.put("region_code",residenceAreacode);
			tabdata.put("short_desc",shortDesc);
			tabdata.put("eff_status",effectiveStatus);
		...
		catch ( Exception e )
		{
			...
			e.printStackTrace(); // Added by lakshmanan for security issue ID 169513103 on 15-09-2023
		}
