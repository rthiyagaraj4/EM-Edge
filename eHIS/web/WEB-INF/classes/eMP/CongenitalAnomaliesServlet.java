...
public class CongenitalAnomaliesServlet extends javax.servlet.http.HttpServlet	
{
	PrintWriter out;
	java.util.Properties p;

	String conganomaliescode;
	String longDesc ;
	String shortDesc ;
        ...
        throws javax.servlet.ServletException,IOException
	{
		...
		try
		{
			...
			if ( operation.equals("insert") )
				insertCongenitalAnomalies(req, res);
			if ( operation.equals("modify"))
				modifyCongenitalAnomalies(req, res);
		}
		catch (Exception e)
		{
	...
	private void modifyCongenitalAnomalies(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			conganomaliescode			= req.getParameter("cong_anomalies_code");
			...
			condflds.put("cong_anomalies_code",conganomaliescode);
			...
			argArray[1] = tabdata;
			argArray[2] = condflds;
			argArray[3] = "MP_CONGENITAL_ANOMALIES";
	...
	private void insertCongenitalAnomalies(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
			conganomaliescode = req.getParameter("cong_anomalies_code");
			...
			HashMap tabdata=new HashMap();
			tabdata.put("cong_anomalies_code",conganomaliescode);
			tabdata.put("long_desc",longDesc);
			tabdata.put("short_desc",shortDesc);
			tabdata.put("eff_status",effectiveStatus);
			...
			String dupflds[]={"cong_anomalies_code"};
