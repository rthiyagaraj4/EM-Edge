...
public class EncounterSummaryXMLHTML_V3{
	...
	public static String tableDataStr = "<table class=\"breakTable\" align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"width: 850px\">";
	...
	public static String[][] returnGroupHead(Element Node){
		String[][] groupArray = new String[1][4];		
		...
		if (Node.getName().equalsIgnoreCase("group")){
			...
			groupArray[0][3] =  Node.getAttribute("date").getValue();
			...
			if (groupArray[0][3].equalsIgnoreCase(""))
				groupArray[0][3] = "";
				...
				else
				{
					if (Node.getParentElement().getParentElement().getName().equalsIgnoreCase("group")){
						if (!(Node.getParentElement().getParentElement().getAttributeValue("name").equalsIgnoreCase("empty")))
						{
							...
							dateStr = Node.getParentElement().getParentElement().getAttributeValue("date");
						}
			...
			*/
			...
			//--------------------------------------------
						...
						for (int i=0;i<1;i++){		
							...
							if (text[i].length == 4)
							{
								...
								if ((text[i].length == 4) && (text.length > 3))
								{
									for (int j=0;j<text[i].length-2;j++){		
									
										if (text[i][j].equalsIgnoreCase("p")){
											htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=120px height=30px>");
										}
										if (text[i][j].equalsIgnoreCase("u")){
											htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=50px height=30px>");
										}
										if (text[i][j].equalsIgnoreCase("v")){
											htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=130px height=30px>");
										}
										if (text[i][j].equalsIgnoreCase("y")){
											htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=85px height=30px>");
										}
										if (text[i][j].equalsIgnoreCase("r")){
											htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=65px height=30px>");
										}	
							...
							else
							{
								for (int j=0;j<text[i].length-2;j++){		
									...
									if (text[i][j].equalsIgnoreCase("p")){
										htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=220px height=30px>");
									}
									if (text[i][j].equalsIgnoreCase("u")){
										htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=125px height=30px>");
									}
									if (text[i][j].equalsIgnoreCase("v")){
										htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=170px height=30px>");
									}
									if (text[i][j].equalsIgnoreCase("y")){
										htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=180px height=30px>");
									}
									if (text[i][j].equalsIgnoreCase("r")){
										htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=155px height=30px>");
									}	
			...
			for (int i=0;i<text.length-2;i++){
				...
				if (text[i].length == 4)
				{
					...
					if ((text[i].length == 4) && (text.length < 4))
					{
						htmlData.append(trStr);	//Added here

						for (int j=0;j<text[i+2].length-2;j++){		
					
							if (text[0][j].equalsIgnoreCase("p")){
								htmlData.append("<td class=\"thickBorder\" style=\"text-align: left\" valign=\"center\" width=120px height=30px>");
							}
							...
							if (text[0][j].equalsIgnoreCase("v")){
								...
								htmlData.append("<td class=\"thickBorder\" style=\""+tdCellBBColorStr+"  text-align: center\"  valign=\"center\" width=130px height=30px>");
						...
						htmlData.append(ctrStr); //Added here
					}
					else
					{
				...
				else
				{
					...
					for (int j=0;j<text[i+2].length-2;j++){		
						...
						if (text[0][j].equalsIgnoreCase("p")){
							htmlData.append("<td class=\"thickBorder\" style=\"text-align: left\" valign=\"center\" width=220px height=30px>");
						}
						if (text[0][j].equalsIgnoreCase("u")){
							htmlData.append("<td class=\"thickBorder\" style=\"text-align: center\" valign=\"center\" width=125px height=30px>");
						}
						if (text[0][j].equalsIgnoreCase("v")){
							...
							htmlData.append("<td class=\"thickBorder\" style=\""+tdCellBBColorStr+"  text-align: center\"  valign=\"center\" width=170px height=30px>");
