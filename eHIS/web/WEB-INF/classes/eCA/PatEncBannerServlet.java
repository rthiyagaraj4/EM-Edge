...
//		String bannerRef = request.getParameter("bannerRef") == null ? "" : request.getParameter("bannerRef");
		...
		try
		{
					...
					else if(flag.equals("1"))
					{
						...
						if(updResult > 0)
						{
							...
							catch(Exception ee)
							{
								...
								//out.println("Exception in clob - update part of PatEncBannerServlet.java -"+ee.toString());//common-icn-0181
								ee.printStackTrace();
							}//end of catch
							finally
							{
			...
			catch(Exception e2)
			{
				...
				//out.println("Exception at try 2 of PatEncBannerServlet.java -"+e2.toString());//common-icn-0181
				e2.printStackTrace();
			}
			...
			if(error_value.equals("1"))
			{
				...
				tabdata.clear();			res.sendRedirect("../eCommon/jsp/MstCodeError.jsp?err_num="+java.net.URLEncoder.encode(errorMsg,"UTF-8")+"&err_value=1");
				con.commit();
			}
		}//end of try
		catch(Exception e)
		{
			...
			//out.println("Exception at try of PatEncBannerServlet.java -"+e.toString());//common-icn-0181
			e.printStackTrace();
		}
		finally
		{
