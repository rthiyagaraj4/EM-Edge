...
public class VaccineServlet extends javax.servlet.http.HttpServlet
{
...
private void extractData(HttpServletRequest req)
	{
			...
			{
				vaccine_id			= checkNull("vaccine_id_update",req);
				

			}
			else
			{
				vaccine_id			= checkNull("vaccine_id",req);
				...
				//adhoc_yn			        = checkNull("adhoc_yn",req);
				//check_dup_yn			    = checkNull("check_dup_yn",req);
				dup_chk_days			    = checkNull("dup_chk_days",req);
				dup_chk_action			    = checkNull("dup_chk_action",req);
				//adhoc_yn			        =(adhoc_yn.equals(""))?"N":adhoc_yn ;
				//check_dup_yn			    =(check_dup_yn.equals(""))?"N":check_dup_yn ;
				chk_yn					    = checkNull("chk_yn", req);
...
public HashMap populateHashMap(HttpServletRequest req)
	{
			...
			String modifiedAtWorkstation= "";
			 ...
			 beforeUpdateEff_status	= checkNull("beforeUpdateEff_status", req); 
				...
				{	
					tabdata.put("VACCINE_ID", vaccine_id);
			...
			tabdata.put("CHECK_DUPLICATE_YN",chk_yn);
			tabdata.put("DUPL_CHECK_DAYS",dup_chk_days);
			tabdata.put("DUPL_CHECK_ACTION",dup_chk_action);
...
/***************************************insert**********************************************/
	...
	private void insert(HttpServletRequest req, HttpServletResponse res, PrintWriter out)
	{
		...
		try
		{
			...
			String dupflds[]={"VACCINE_ID"};

			boolean local_ejbs = false;
			String tabname="CA_IM_VACCINE ";
	...
	private void modify(HttpServletRequest req, HttpServletResponse res, PrintWriter out)
	{
		...
		String vaccine_id = checkNull("vaccine_id_update",req);
		String facilityId ;
		String client_ip_address ;
		String modifiedById			= "";
		String modifiedAtWorkstation= "";
		...
		try
		{
			...
			condflds.put("VACCINE_ID",vaccine_id);
