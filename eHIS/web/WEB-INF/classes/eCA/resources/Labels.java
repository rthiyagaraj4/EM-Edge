...
03/12/2012   IN035928	  nijitha	  	New widget Refferal Summary.
...
03/07/2015	IN052940		Ramesh G									In Clinical note there should be an option to auto fetch/Copy data 	
													from same template if filled up earlier for same patient in template format.
...
08/1/2020	IN070610		Sivabagyam		08/1/2020     Ramesh Goli			AAKH-CRF-0079.10	
...
03/02/2022  27709     Suji Keerthi.G      03/02/2022      Ramesh G    GHL-CRF-0658
...
24/11/2022  28796           SREENADH M                              RAMESH              NMC-JD-CRF-0154
...
14/04/2023	37866		Ramesh G											MMS-DM-CRF-0226
...
public class  Labels  extends ListResourceBundle implements java.io.Serializable
{
	...
	{"eCA.PatientMarkers.label","Patient Markers"},
	{"eCA.Show.label","Show"},
	...
	{"eCA.ChangeIfPatIdGiven.label","Can change only if Patient ID is given or if within the range"},
	...
	{"eCA.DuplicateCheckRecquired.label","Duplicate Check Required?"},
	...
	{"eCA.CustomizeIcons.label","Customize Icons"},
...
{"eCA.MinDurationRecquired.label","Min Duration Required between consultation"},
{"eCA.Mins.label","Mins"},
...
{"eCA.CurrentLength.label","Current Length"},
{"eCA.MaxLengthAllowed.label","Max Length Allowed"},
{"eCA.MaxNoImgAllowed.label","Max no of Images allowed per note"},
{"eCA.Progression.label","Progression"},
{"eCA.ShowActive.label","Show Active"},
{"eCA.ShowClosed.label","Show Closed"},
{"eCA.AddNewP.label","Add New"},
{"eCA.RecordOutcome.label","Record Outcome"},
{"eCA.ProgressNotes.label","Progress Notes"},	
{"eCA.MedAdmindetails.label","Med Admin Details"},
{"eCA.SuggestedDiagnosis.label","Suggested Diagnosis"},
{"eCA.SuggestedDiagnosisForCurrentChiefComplaint.label","Suggested Diagnosis For Current Chief Complaint"},
{"eCA.MaxIPConsChargable.label","Maximum No of Consulataion Chargable for a given IP Encounter"},
{"eCA.PerDay.label","Per Day"},
{"eCA.RegularCons.label","Regular Consultation"},
{"eCA.ReferralCons.label","Referral Consultation"},
{"eCA.Target.label","Target"},
{"eCA.SourceEncounterClinicalEvents.label","Source Encounter's Clinical Events"},
{"eCA.ParameterDetails.label","Parameter Details"},
{"eCA.ConstructedParameterList.label","Constructed Parameter List"},
{"eCA.ParamName.label","Parameter Name"},
{"eCA.AccessRestriction.label","Access Restriction"},
{"eCA.SelfOrder.label","Self Orders"},
{"eCA.SelfSpltyOrders.label","Self Speciality Orders"},
{"eCA.ParamValue.label","Parameter Value"},
{"eCA.NotRecorded.label","Not Recorded"},
{"eCA.NotExist.label","Not Exist"},
{"eCA.NotIdentified.label","Not Identified"},
{"eCA.SpecimenCollectedAt.label","Specimen Collected At"},
{"eCA.AnalyticalGroupCode.label","Analytical Group Code"},
{"eCA.AnalyticalGroupName.label","Analytical Group Name"},
{"eCA.AvailableComponentList.label","Available Component List"},
{"eCA.GroupSection.label","Group (Section)"},
{"eCA.CompDetails.label","Comp Details"},
{"eCA.CompType.label","Comp Type"},
{"eCA.SelectedComponentList.label","Selected Component List"},
{"eCA.CustomComponentTitle.label","Custom Component Title"},
{"eCA.ComponentDetails.label","Component Details"},
{"eCA.SeqNo.label","Seq. No"},
{"eCA.DefineAnalyticalGroup.label","Define Analytical Group"},
...
{"eCA.PendingConsent.label","Pending Consent"},//Chowminya
...
{"eCA.LogoHeaderForAllPages.label"," Print Logo Header in All Pages"},//Menaka
{"eCA.ReportHeaderForAllPages.label","Print Report Header in All Pages"},//Menaka
...
{"eCA.SpellCheckerInLine.label"," Inline Spell Checker"},//IN029712//IN035950
...
{"eCA.ResearchCategoryFactorDescription.label","Research Category Factor Description"},//[IN030466]  IN035928
...
{"eCA.symbolgrpid.label","Symbol Group ID"},  // added for BRU-HIMS-CRF-221
...
{"eCA.ComponentStartsWith.label","Components Starts With"},// added for Encounter Summary By Sethu
{"eCA.AttachedComponents.label","Attached Components"},// added for Encounter Summary By Sethu
{"eCA.ColumnNumbers.label","No. of Columns"},// added for Encounter Summary By Sethu
{"eCA.AddSubGroup.label","Add Sub-Group"},// added for Encounter Summary By Sethu
{"eCA.AddComponent.label","Add Component"},// added for Encounter Summary By Sethu
{"eCA.AddedComponents.label","Added Components"},// added for Encounter Summary By Sethu
{"eCA.ComponentSubGroupCode.label","Component/Sub-Group Code"},// added for Encounter Summary By Sethu
{"eCA.ModifyComponents.label","Modify Components"},// added for Encounter Summary By Sethu
{"eCA.ComponentCode.label","Component Code"},// added for Encounter Summary By Sethu
{"eCA.ColumnDetails.label","Column Details"},// added for Encounter Summary By Sethu
{"eCA.LineChartdetails.label","Line Chart Details"},// added for Encounter Summary By Sethu
{"eCA.GroupsStartsWith.label","Groups Starts With"},// added for Encounter Summary By Sethu
{"eCA.SelectGroups.label","Select Groups"},// added for Encounter Summary By Sethu
{"eCA.SelectedGroups.label","Selected Groups"},// added for Encounter Summary By Sethu
{"eCA.SummaryCode.label","Summary Code"},	//added for Encounter Summary By Sethu
{"eCA.SummaryDescription.label","Summary Description"},	//added for Encounter Summary By Sethu
{"eCA.SummaryList.label","Summary List"},	//added for Encounter Summary By Sethu
{"eCA.SelectSummaryList.label","Select the Summary from the list"},	//added for Encounter Summary By Sethu
...
{"eCA.FinacialDetailsPopup.label","Pop up required to view patient financial details in view chart summary"}, //added for IN063285
...
{"eCA.ReportCriteria.label","Report Criteria"},//IN065254
{"eCA.NursingDiagnosis.label","Nursing Diagnosis"},//IN065254
{"eCA.GoalStmt.label","Goal Statement"},//IN065254
{"eCA.Interventions.label","Interventions"},//IN065254
...
{"eCA.RecordClinicalNotes.label","Record Clinical Notes"},
...
{"eCA.DisplayNoteDescription.label","To Display Note type title at the time of Notes view & Notes Print"},//Exception-PMG2020-COMN-CRF-008b5 7605
{"eCA.HideBed.label","Hide Bed No Search Option for Inpatients in List By Location"},//GH-CRF-0623
...
{"eCA.MicrosoftEdge.label","Microsoft Edge"},
{"eCA.SuspendedInactivepatient.label","Suspended/Inactive patient allowed to restrict in Patient Without Encounter"}, //31884
{"eCA.LocationID.label","Location ID"},
//27709
//34109
{"eCA.Encounterdaterang.label","Encounter date range"},
{"eCA.EncounterCodingstatus.label","Encounter Coding status"},
{"eCA.Policy.label","Policy"},
{"eCA.Period.label","Period"},
//34109
//37743
{"eCA.ChiefComplaintMandatory.label","Chief Complaint Field to be Mandatory"},
//37743
//28796-CRF-0154
{"eCA.FacilityBy.label","Facility By"},
{"eCA.FacilityName.label","Facility Name"},
{"eCA.LoggedAuthor.label","Logged By"},
{"eCA.Self.label","Self"},
{"eCA.All.label","All"},
//28796-CRF-0154
{"eCA.codername.label","CODER NAME"}, //TH-KW-CRF-0140
//40627
{"eCA.AssignedBy.label","Assigned By"},
{"eCA.CoderID.label","Coder ID"},
{"eCA.BillNumber.label","Bill Number"},
{"eCA.PtID.label","Pt ID"},
{"eCA.PtName.label","Pt Name"},
{"eCA.AttendingPractitonerName.label","Attending Practitoner Name"},
{"eCA.BillingType.label","Billing Type"},
{"eCA.DischargePeriod.label","Discharge Period"},
{"eCA.DoctorID.label","Doctor ID"},
{"eCA.QueryDate.label","Query Date"},
{"eCA.QueryTime.label","Query Time"},
{"eCA.CompletedDate.label","Comp.Date"},
{"eCA.CompletedTime.label","Comp.Time"},
{"eCA.TotalTime.label","Total Time"},
{"eCA.CoderStatusCheckReport.label","Coder Status Check Report"},
{"eCA.supervisorCleranceCompleted.label","Supervisor Clearance Completed"},//41064
{"eCA.DiagnosisRemarks.label","Diagnosis Remarks"} , // added 38981
{"eCA.includesupportdiagnosis.label","Include Supporting Diagnosis"},//38981
{"eCA.by.label","By"},//41064
{"eCA.Audited.label","Audited"},//41064
{"eCA.RemarksMandatoryRelationships.label","Remarks Mandatory to Establish Without Encounter Relationships"},//0605
{"eCA.ToAutoPopSchedImmunFunction.label","To Auto populate the Schedules In Manage Immunization Function"}, // 41650
{"eCA.viewAuditedTrail.label","View Audit Trail"},//41064
{"eCA.SupportingDiag.label","Supporting Diagnosis"},//38981
{"eCA.oldcoding.label","Old Coding Status"},//41064
{"eCA.newcoding.label","New Coding Status"},//41064
{"eCA.ActionDateTime.label","Action Date Time"},//41064
{"eCA.ReasonText.label","Reason Text"},
{"eCA.Reason.label","Reason"},
{"eCA.ConsultationType.label","Consultation Type"},//37866
{"eCA.DisplayVaccineSchedulesSorted.label","To Display Vaccine Schedules Sorted and Group By Vaccine Name While Confirming"}, // 41653
{"eCA.Enableprimaryandsecondaryprocedure.label","Enable Primary and Secondary Procedure Codes Classification in Record Procedures Function"},//36285 
{"eCA.ClassificationType.label","Classification Type"},//36285
{"eCA.Primaryppx.label","Primary(PPX)"},//36285
{"eCA.Secondaryppx.label","Secondary(SPX)"},//36285
{"eCA.DateTimeCreated.label","Date/Time Created"},//24094
{"eCA.DateTimeLastModified.label","Date/Time Last Modified"},//24094
{"eCA.DateTimewiseview.label","Date/Time Wise View"},//0165
{"eCA.Component.label","Component"},//0165
//start 32902
{"eCA.PatientStatus.label","Patient Status"}, 
{"eCA.AccessRightsclinicaldataRestrictedPatients .label","Access Rights to View Clinical Data for Restricted Patients"},
{"eCA.DateFrom.label","Date From"},
{"eCA.DateTo.label","Date To"},
{"eCA.RecordCreatedBy.label","Record Created By"},//32902
{"eCA.RecordDate.label","Record Date"},
{"eCA.RecordStatus.label","Record Status"},
{"eCA.AccessRightsHistoryNotavailable.label","Access Rights History Not available."},
{"eCA.AccessHistViewClinicalRestrictedPatients.label","Access History to View Clinical Data for Restricted Patients"},
{"eCA.HidePatientsForUnauthorizedPractitioners.label","Hide Patients Who are Marked as Restricted for Unauthorized Practitioners"},//32902 
//end 32902
{"eCA.virtualConsultation.label","Virtual Consultation Visit"}
	};

}

/*	  eCA.NoOfTransactionsAllowed.label eCA.SpecialtyTaskStartsWith	eCA.SpecialtyTaskDescription   eCA.SpecialtyTaskHeaderCode.label

	   eCA.AttachedTasks.label




Lables to be moved to Common Area
{"Common.SectionDescription.label","Section Description"},	eCA.SpecialityEvent.label
{"Common.Test.label","Test :"},
{"Common.ClinicalComments.label","Clinical Comments"},
{"eCA.Abnormalonly.label","Abnormal only"},
{"eCA.ActionDateTime.label","Action Date/Time"},
{"eCA.Allergies.label","Allergies"},
{"eCA.Applicability.label","Applicability"},
{"eCA.Applicable.label","Applicable"},
{"eCA.AppointmentRef.label","Appointment Ref.no :"},
{"eCA.Ason.label","As on:"},
{"eCA.Authorize.label","Authorize"},
{"eCA.NoteType.label","Note Type"},
{"eCA.CurrentDateTime.label","Current Date / Time"},
{"eCA.DateofBirth.label","Date of Birth"},
{"eCA.Default.label","Default"},
{"eCA.Authorized.label","Authorized"},
{"eCA.AllEncounters.label","All Encounters"},
{"eCA.DayAfterDischarge.label","Day After Discharge"},
{"eCA.Overdue.label","Overdue"},
{"eCA.SequenceNumber.label","Sequence No"},
{"eCA.Procedure.label","Procedure"},
{"eCA.DefaultValue.label","Default Value"},
{"eCA.DiscreteMeasure.label","Discrete Measure"},
{"eCA.AvailableImages.label","Available Images"},
{"eCA.Calendar.label","Calendar"},
{"eCA.CHARTING.label","CHARTING"},
{"eCA.ClinicalEvent.label","Clinical Event"},
{"eCA.ColumnPosition.label","Column Position"},
{"eCA.ColumnSpan.label","Column Span"},
{"eCA.Component.label","Component"},
{"eCA.Critical.label","Critical"},
{"eCA.CriticalHighValue.label","Critical High Value"},
{"eCA.CriticalLowValue.label","Critical Low Value"},
{"eCA.CurrentEncounter.label","Current Encounter"},
{"eCA.DateFrom.label","Date From"},
{"eCA.DecimalNumeric.label","Decimal Numeric"},
{"eCA.DiagnosisCode.label","Diagnosis Code"},
{"eCA.DiagnosisDescription.label","Diagnosis Description"},
{"eCA.Disabled.label","Disabled"},
{"eCA.DiscreteMeasureCode.label","Discrete Measure Code"},
{"eCA.DiscreteMeasureDescription.label","Discrete Measure Description"},
{"eCA.DisplayOnly.label","Display Only"},
{"eCA.Elapsed.label","Elapsed"},
{"eCA.Event.label","Event"},
{"eCA.EventClass.label","Event Class"},
{"eCA.EventDescription.label","Event Description"},
{"eCA.ExpiryPeriod.label","Expiry Period"},
{"eCA.ExpiryRule.label","Expiry Rule"},
{"eCA.FacilityName.label","Facility Name"},
{"eCA.Format.label","Format"},
{"eCA.Future.label","Future"},
{"eCA.FutureOrders.label","Future Orders"},
{"eCA.Group.label","Group"},
{"eCA.HighValue.label","High Value"},
{"eCA.ImageDescription.label","Image Description"},
{"eCA.InProgress.label","In Progress"},
{"eCA.Individual.label","Individual"},
{"eCA.IntegerNumeric.label","Integer Numeric"},
{"eCA.Left.label","Left"},
{"eCA.LowValue.label","Low Value"},
{"eCA.Mandatory.label","Mandatory"},
{"eCA.Message.label","Message"},
{"eCA.ModuleId.label","Module Id"},
{"eCA.Nature.label","Nature"},
{"eCA.New.label","New"},
{"eCA.NewProcedure.label","New Procedure"},
{"eCA.Nursing.label","Nursing"},
{"eCA.OrderStatus.label","Order Status"},
{"eCA.OrderType.label","Order Type"},
{"eCA.OrderingPract.label","Ordering Pract"},
{"eCA.Orders.label","Orders"},
{"eCA.ProcedureDescription.label","Procedure Description"},
{"eCA.SemiCritical.label","Semi Critical"},
{"eCA.SrlNo.label","SrlNo"},
{"eCA.EmergencyUnits.label","Emergency Units"},
{"eCA.DayCareUnits.label","Day Care Units"},
{"eCA.List.label","List"},
{"eCA.LabelPosition.label","Label Position"},
{"eCA.Comments.label","Comments"},
{"eCA.AnaesthesiaDetails.label","Anaesthesia Details"},
{"eCA.Anaesthetist.label","Anaesthetist"},

April 2008
==========
{"eCA.Abnormal.label","Abnormal"},
{"eCA.AcceptOption.label","Accept Option"},
{"eCA.ActionDescription.label","Action Description"},
{"eCA.ActionRemarks.label","Action Remarks"},
{"eCA.ActionType.label","Action Type"},
