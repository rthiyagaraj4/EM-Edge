...
class PayTMWithdrawTransaction implements XHTransactionInterface 
{
	...
	public String TransRequestMethod(String profileId, String applicationId, String actionKey){
		...
		String l_request = "", l_order_id = "", l_patient_id = "", l_encounter_id = "", l_facility_id = "", l_episode_type = "", l_session_id = "", l_user_id = "", l_request_msg = "", l_aes_key = "", l_check_sum = "", l_response_msg = "", l_response_str = "";
	...
	public String MessageLoadMethod(String actionKey, String message){
		...
		String l_txnGuid = "", l_message = "", l_ssoId = "", l_txnType = "", l_merchantOrderId = "", l_txn_status ="";
		...
		if (l_request.equals("CHECK_STATUS"))
		{
			...
			if (l_status_code.equals("SS_001"))
			{
				...
				l_ssoId = XHJSONUtil.getJsonArrayObjString(l_response_str, "txnList", "ssoId");
				l_txnType = XHJSONUtil.getJsonArrayObjString(l_response_str, "txnList", "txnType");
	...
	public String TransCommunicationMethod(String protocolLinkID, String actionKey, String checkSum, String message){
		...
		String l_profile_id = "", l_default_value = "", l_standard_code = "HTTPCC";
