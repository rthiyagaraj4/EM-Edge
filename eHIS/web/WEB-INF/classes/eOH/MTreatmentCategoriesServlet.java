...
public class MTreatmentCategoriesServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	String table_name="OH_TREATMENT_CATEGORY";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			...
			String trmt_category_desc=checkForNull(req.getParameter("trmt_category_desc"));
			String splty_module_id=checkForNull(req.getParameter("splty_module_id"));
			String trmt_category_type=checkForNull(req.getParameter("trmt_category_type"));
			String denture_removable=checkForNull(req.getParameter("denture_removable"),"N"); //Added by Sridevi Joshi on 2/8/2010 for IN010871(SRR20056-CRF-0478)
			String eff_status = checkForNull(req.getParameter("eff_status"),"D");
			tabdata.put("trmt_category_code",trmt_category_code);
			tabdata.put("trmt_category_desc",trmt_category_desc);
			tabdata.put("splty_module_id",splty_module_id);
			tabdata.put("trmt_category_type",trmt_category_type);
			tabdata.put("denture_removable",denture_removable);
			...
			String trmt_category_desc=checkForNull(req.getParameter("trmt_category_desc"),req.getParameter("trmt_category_desc1") );
			String splty_module_id=checkForNull(req.getParameter("splty_module_id"),req.getParameter("splty_module_id1"));
			String trmt_category_type=checkForNull(req.getParameter("trmt_category_type"),req.getParameter("trmt_category_type1"));
			String eff_status = checkForNull(req.getParameter("eff_status"),"D");
			String denture_removable=checkForNull(req.getParameter("denture_removable"),req.getParameter("denture_removable1"));//Added by Sridevi Joshi on 2/8/2010 for IN010871(SRR20056-CRF-0478)
			//String denture_removable=checkForNull(req.getParameter("denture_removable"),"N");//Added by Sridevi Joshi on 2/26/2010 for IN010871(SRR20056-CRF-0478)
			if(eff_status.equals("D")){
				 denture_removable=checkForNull(req.getParameter("denture_removable1"),req.getParameter("denture_removable"));//Added by Sridevi Joshi on 2/8/2010 for IN010871(SRR20056-CRF-0478)
			}
			else{
				denture_removable=checkForNull(req.getParameter("denture_removable"),req.getParameter("denture_removable1"));//Added by Sridevi Joshi on 2/8/2010 for IN010871(SRR20056-CRF-0478)
			}
			tabdata.put("trmt_category_desc",trmt_category_desc);
			tabdata.put("splty_module_id",splty_module_id);
			tabdata.put("trmt_category_type",trmt_category_type);
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"trmt_category_code"};
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String trmt_category_code=checkForNull(req.getParameter("trmt_category_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("trmt_category_code",trmt_category_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
