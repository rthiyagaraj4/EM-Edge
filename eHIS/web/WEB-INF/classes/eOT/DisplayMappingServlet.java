...
public class DisplayMappingServlet extends javax.servlet.http.HttpServlet {
	...
	private void populateDetails(HttpServletRequest req)
	{
		...
		DisplayMappingBean displayMappingBean = (DisplayMappingBean)PersistenceHelper.getBeanObject( bean_id, bean_name, req ) ;
		tabdata.put("DISPLAY_MAPPING_BEAN", displayMappingBean);
	}
	...
	private void callEJB(HttpServletRequest req,HttpServletResponse res)
	{
		...
		{	
			...
			Object home =ServiceLocator.getInstance().getHome("java:comp/env/DisplayMapping",eOT.DisplayMapping.DisplayMappingHome.class, local_ejbs);
			...
			String errText = (String) (busObj.getClass().getMethod("save", paramArray)).invoke(busObj, argArray);	
