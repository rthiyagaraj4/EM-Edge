...
public class SurgeryTypeServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	//String table_name="OT_NATURE_OF_SURGERY";
	String table_name="OT_NATURE_OF_SURGERY";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String surgery_type=checkForNull(req.getParameter("surgery_type"));
			...
			tabdata.put("nature_code",surgery_type);
			tabdata.put("nature_type",type);
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String surgery_type=checkForNull(req.getParameter("surgery_type1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("nature_code",surgery_type);
			Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
