...
public class EquipmentServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String table_name="OT_EQUIPMENT";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String equipment_code=checkForNull(req.getParameter("equipment_code"));
...
//Added by Muthu for RUT-CRF-0057
			...
			tabdata.put("equipment_code",equipment_code);
...
//Added by Muthu for RUT-CRF-0057
			...
			String location=checkForNull(req.getParameter("location"));//Added by Muthu against CRF-0091
//Added by Muthu for RUT-CRF-0057
...
//Added by Muthu for RUT-CRF-0057
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String equipment_code=checkForNull(req.getParameter("equipment_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("equipment_code",equipment_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
