...
public class PreMorbidStatusServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String locale="";
	String table_name="AT_PREMORBID_MAST";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String premorbid_code=checkForNull(req.getParameter("premorbid_code"));
			...
			tabdata.put("premorbid_code",premorbid_code);
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String premorbid_code=checkForNull(req.getParameter("premorbid_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("premorbid_code",premorbid_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
