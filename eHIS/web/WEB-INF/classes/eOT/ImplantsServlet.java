...
public class ImplantsServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String table_name="OT_PROSTHESIS";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String prosthesis_code=checkForNull(req.getParameter("prosthesis_code"));
			...
			String prosthesis_cat_code=checkForNull(req.getParameter("prosthesis_cat_code"));
			String prosthesis_type_code=checkForNull(req.getParameter("prosthesis_type_code"));
			String consignment_item_yn=checkForNull(req.getParameter("consignment_item_yn"),"N");
			String deposit_reqd_yn=checkForNull(req.getParameter("deposit_reqd_yn"),"N");
			String mm_item_code=checkForNull(req.getParameter("mm_item_code"));
			String status = checkForNull(req.getParameter("status"),"D");
			tabdata.put("prosthesis_code",prosthesis_code);
			tabdata.put("long_desc",long_desc);
			tabdata.put("short_desc",short_desc);
			tabdata.put("mm_item_code",mm_item_code);
			tabdata.put("consignment_item_yn",consignment_item_yn);
			tabdata.put("speciality_code",speciality_code);
			tabdata.put("deposit_reqd_yn",deposit_reqd_yn);
			tabdata.put("prosthesis_cat_code",prosthesis_cat_code);
			tabdata.put("prosthesis_type",prosthesis_type_code);
			...
			String long_desc=checkForNull(req.getParameter("long_desc"),checkForNull(req.getParameter("long_desc1")));
			String short_desc=checkForNull(req.getParameter("short_desc"),checkForNull(req.getParameter("short_desc1")));
			String speciality_code=checkForNull(req.getParameter("speciality_code"));
			String prosthesis_cat_code=checkForNull(req.getParameter("prosthesis_cat_code"));
			String prosthesis_type_code=checkForNull(req.getParameter("prosthesis_type_code"));
			String consignment_item_yn=checkForNull(req.getParameter("consignment_item_yn"),"N");
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"prosthesis_code"};
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		String prosthesis_code=checkForNull(req.getParameter("prosthesis_code1"));
		HashMap tabData = populateTabData(req,res);
		HashMap condflds=new HashMap();
		condflds.put("prosthesis_code",prosthesis_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
