...
public class SpecialitySubCatServlet extends javax.servlet.http.HttpServlet
{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String table_name="OT_OPER_SUB_CATEGORY";
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		if("insert".equals(mode)){
			String oper_group_code=checkForNull(req.getParameter("speciality_desc"));
			...
			tabdata.put("oper_group_code",oper_group_code);
			tabdata.put("oper_cat_code",oper_cat_code);
			tabdata.put("oper_sub_cat_code",oper_sub_cat_code);
	...
	private void insert(HttpServletRequest req, HttpServletResponse res){
		...
		String dupflds[]={"oper_group_code","oper_cat_code","oper_sub_cat_code"};
	...
	private void modify(HttpServletRequest req, HttpServletResponse res){
		...
		condflds.put("oper_group_code",oper_group_code);
        condflds.put("oper_cat_code",oper_cat_code);
        condflds.put("oper_sub_cat_code",oper_sub_cat_code);
		Object argArray[]  = new Object[4];
		argArray[0] = p;
		argArray[1] = tabData;				   
		argArray[2] = condflds;
