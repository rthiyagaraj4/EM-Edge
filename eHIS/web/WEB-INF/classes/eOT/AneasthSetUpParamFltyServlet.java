...
public class AneasthSetUpParamFltyServlet extends javax.servlet.http.HttpServlet{
	PrintWriter out;
	HttpSession session;
	...
	String login_user="";
	String table_name="AT_PARAM_FOR_FACILITY";
	...
	public synchronized void doPost(HttpServletRequest req, HttpServletResponse res) throws javax.servlet.ServletException,IOException
	{
		...
		//String locale = this.p.getProperty("LOCALE") ; //Commented Against Common-ICN-0031
		try
		{
	...
	private HashMap populateTabData(HttpServletRequest req, HttpServletResponse res){
		...
		String next_anaesthesia_serial_num=checkForNull(req.getParameter("next_anaesthesia_serial_num"));
		String next_preop_asses_num=checkForNull(req.getParameter("next_preop_asses_num"));
		if("insert".equals(mode)){
			tabdata.put("operating_facility_id",facility_id);
			tabdata.put("next_anaesthesia_serial_num",next_anaesthesia_serial_num);
			tabdata.put("next_preop_asses_num",next_preop_asses_num);
