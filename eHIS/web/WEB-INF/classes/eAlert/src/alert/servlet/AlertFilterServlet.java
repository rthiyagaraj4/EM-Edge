...
/**
 * Servlet implementation class AlertFilterServlet  
 */
public class AlertFilterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AlertFilterServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AlertsByFilterRequest filterRequest = new AlertsByFilterRequest();
		AlertsByFilterResponse alertFilterResponse = null;
		
		filterRequest.setUserId(userId);
		filterRequest.setFiltered(filter);
		alertFilterResponse = alertBC.getAlertsByFilter(filterRequest);
		request.setAttribute("AlertsByFilterResponse", alertFilterResponse);
		
		//response.sendRedirect("eAlert/jsp/UserAlert.jsp");
		//RequestDispatcher rd = session.getServletContext().getRequestDispatcher("eAlert/jsp/UserAlert.jsp");
		RequestDispatcher rd = request.getRequestDispatcher("eAlert/jsp/UserAlertFilter.jsp");
