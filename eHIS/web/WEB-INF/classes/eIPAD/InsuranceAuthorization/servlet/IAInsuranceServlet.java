...
public class IAInsuranceServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String approval_num = (String)hash.get("approval_num");
		...
		try {
			con = ConnectionManager.getConnection();
				...
				pstmt.executeBatch();
					...
					pstmt.setString(12, approval_num);
					pstmt.addBatch();
					pstmt.executeBatch();
				}
				int row  = 1;
