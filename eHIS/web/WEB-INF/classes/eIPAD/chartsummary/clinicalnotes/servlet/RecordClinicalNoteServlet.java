 ...
 */
public class RecordClinicalNoteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecordClinicalNoteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(patientContext!=null){
			...
			//secResponse = cnBC.getSecNoteListName( patientContext,  noteTypeId);
			//request.setAttribute("SfsResponse",secResponse);
			}
		
		rd = getServletContext().getRequestDispatcher("/eIPAD/jsp/chartwidgets/ClinicalNotes/RecordClinicalNotes.jsp");
