 ...
 * 
 */
package eIPAD.chartsummary.CLEventHistory.servlet;
 ...
 *
 */
public class ClinicalEventsSFSServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClinicalEventsSFSServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
		...
		rd = getServletContext().getRequestDispatcher("/eIPAD/jsp/chartwidgets/clinicalevents/ClinicalEventsSFS.jsp");
