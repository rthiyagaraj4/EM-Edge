...
/**
 * Servlet implementation class MOrderEntryTransaction
 */
public class MOrderEntryTransaction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MOrderEntryTransaction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ConsentOrders bean1		= (ConsentOrders)PersistenceHelper.getBeanObject( bean_id1, bean_name1, request ) ;
