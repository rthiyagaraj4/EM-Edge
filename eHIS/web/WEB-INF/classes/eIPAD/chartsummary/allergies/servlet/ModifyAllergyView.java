...
/**
 * Servlet implementation class ModifyAllergyView 
 */
public class ModifyAllergyView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String allergenCode = request.getParameter("allergencode");
		String eventCode = request.getParameter("eventcode");
		String eventInd = request.getParameter("eventind");
		...
		if(eventCode!=null){
			allergyRequest.setEventTypeCode(eventCode);
		}
		if(eventInd!=null){
			allergyRequest.setEventTypeInd(eventInd);
		}
		...
		RequestDispatcher rd = session.getServletContext().getRequestDispatcher("/eIPAD/jsp/chartwidgets/ModifyAllergy.jsp");
