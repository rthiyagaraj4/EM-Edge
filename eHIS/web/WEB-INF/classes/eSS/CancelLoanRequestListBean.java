...
import java.util.*;
import java.io.*;
public class CancelLoanRequestListBean extends eSS.Common.SsTransaction implements Serializable {  
	...
	public void setReject_qty(String reject_qty) {
		 this.reject_qty =  checkForNull(reject_qty);
	}
	...
	public HashMap toHashMap(){
		...
		hmReturn.put("blocked_qty",		getBlocked_qty   ());
		hmReturn.put("reject_qty",		getReject_qty   ());
		return hmReturn;
	}
	...
	public void initialize(HashMap hmRequestGroupItem){
		...
		setBlocked_qty	 (checkForNull(hmRequestGroupItem.get("blocked_qty").toString())	);
		setReject_qty	 (checkForNull(hmRequestGroupItem.get("reject_qty").toString())	);
