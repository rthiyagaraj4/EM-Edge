...
import eCP.PositionForIntervention.*;

public class PositionForInterventionServlet extends javax.servlet.http.HttpServlet 
{
	PrintWriter out;
   ...
   public void doGet(HttpServletResponse res) throws javax.servlet.ServletException,IOException
	...
	private void SpecialityAddModify(HttpServletRequest req, HttpServletResponse res)
	{
		try
		{
            ...
            String	from	=	"",	to		=	"";
            String position_code = req.getParameter("position_code")==null ? "":req.getParameter("position_code");
			String role_type = req.getParameter("role_type")==null ? "":req.getParameter("role_type");
			String staff_type = req.getParameter("staff_type")==null ? "":req.getParameter("staff_type").trim();
			...
			for(int i=0;i<PositionForIntervention.getSize();i++)
			{
				tabdata.put( ("chk"+i), (String)PositionForIntervention.getObject(i) );
				
			}
			String slCount	=	""+PositionForIntervention.getSize();
			...
			tabdata.put("locale",locale);
				...
				local_ejbs = true;
				Object obj = com.ehis.eslp.ServiceLocator.getInstance().getHome("java:comp/env/PositionForIntervention", eCP.PositionForIntervention.PositionForInterventionHome.class, local_ejbs);
		...
		{
			session.removeAttribute("PositionForIntervention");
		}
	}//E.O.Method
} 
