...
import eCommon.SingleTabHandler.*;
 ...
 public class VarianceReasonServlet extends HttpServlet  
 {
	...
	String jv_variancereason_code="";
	String jv_variancereason_desc="";
	String jv_variancecause_code="";
 ...
 public void insertOperation(HttpServletRequest req,HttpServletResponse res)
     throws Exception
	{
	 //System.err.println("inside insert");
		...
		jv_variancereason_code=req.getParameter("varianceCode")==null ? "":req.getParameter("varianceCode");
		jv_variancereason_desc=req.getParameter("varianceDesc")==null ? "":req.getParameter("varianceDesc");
		jv_variancecause_code=req.getParameter("varianceCause")==null ? "":req.getParameter("varianceCause");
		jv_eff_status=(req.getParameter("eff_status")==null || req.getParameter("eff_status")=="")? "D" : req.getParameter("eff_status");

		HashMap tabData=new HashMap();

		tabData.put("VAR_REASON_CODE",jv_variancereason_code);
		tabData.put("VAR_REASON_DESC",jv_variancereason_desc);
		tabData.put("VAR_CAUSE_CODE",jv_variancecause_code);
		...
		String dupflds[]={"VAR_REASON_CODE"};
	...
	try{
			...
			//	if ((context.getInitParameter("LOCAL_EJBS") !=null) && (context.getInitParameter("LOCAL_EJBS").equalsIgnoreCase("TRUE"))) 
				...
				String table_name="CP_VARIANCE_REASON";
				argArray[0] =p;
				argArray[1] =tabData;
				argArray[2] =dupflds;
...
public void modifyOperation(HttpServletRequest req,HttpServletResponse res)throws Exception{
	//System.err.println("inside modify");
       try{	
		...
		//System.err.println("jv_variancereason_code  "+jv_variancereason_code);
		//System.err.println("jv_variancereason_desc  "+jv_variancereason_desc);
		...
		condflds.put("VAR_REASON_CODE",jv_variancereason_code);
