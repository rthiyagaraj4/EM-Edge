...
<td  align="left" class=Day width="13%" nowrap><b><fmt:message key="eRS.WorkPlace.label" bundle="${rs_labels}"/>/<fmt:message key="Common.Position.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><input type='hidden' name='u1' id='u1' value='u1'>
</td>
<%
...
<td class='Total'  nowrap><b><fmt:message key="eRS.TotalByWorkPlace.label" bundle="${rs_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
		...
		%>
		<td class="<%=classval1%>"  width='3%' align='center'>&nbsp;<%=aa[kkk1]%>/<%=rr[kkk1]%>&nbsp;</td>
		<% 
		}
		else
		{
