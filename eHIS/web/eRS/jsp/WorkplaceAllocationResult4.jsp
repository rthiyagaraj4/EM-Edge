...
<td  align="left" class=Day width="13%" nowrap><b><fmt:message key="eRS.WorkPlace.label" bundle="${rs_labels}"/>/<fmt:message key="Common.SHIFT.label" bundle="${common_labels}"/>/<fmt:message key="Common.Position.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;</b><input type='hidden' name='u1' id='u1' value='u1'>
</td>
<%
...
<tr >
		<td class='EmptyEven' width='3%' nowrap><b><%=pos_temp%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
		<%
...
%>
		...
		%>
		<td class="<%=classval1%>"  width='3%' align='center'>&nbsp;<%=aa_sh[kkk1]%>/<%=rr_sh[kkk1]%>&nbsp;</td>
		<% 
			if(aa_wp[kkk1]==0)
			{
