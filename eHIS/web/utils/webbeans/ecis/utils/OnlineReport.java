...
public class OnlineReport implements java.io.Serializable {
    ...
    String locationCode ;
    String languageID ;
	String workStationID ; //added for SCF-16960 on 28/6/2016
    ...
    public OnlineReport() {
        ...
        setLocationCode( "" ) ;
		setLanguageID(""); 
		setWorkStationID(""); //added for SCF-16960 on 28/6/2016
    } 
...
//added for SCF-16960 on 28/6/2016
	public OnlineReport( String facilityId, String moduleId, String reportId, String locationType, String locationCode,String languageID, String workStationID ) {
        setFacilityId( facilityId ) ;
        setModuleId( moduleId ) ;
        setReportId( reportId ) ;
        setLocationType( locationType ) ;
