...
function create()
{
	...
	f_query_add_mod.location.href = "../../eSM/jsp/CreateUserDesktopFrame.jsp" ;
...
/**************/		
	...
	/*	var headercount = 0;
		...
		HTMLVal+="<input type='hidden' name=option_id"+i+" id=option_id"+i+" value='"+splitval[0]+"'>";
		HTMLVal+="<input type='hidden' name=option_occurance"+i+" id=option_occurance"+i+" value='"+splitval[3]+"'>";
		HTMLVal+="<input type='hidden' name=header_option_id"+i+" id=header_option_id"+i+" value='"+splitval[1]+"'>";
		HTMLVal+="<input type='hidden' name=header_option_occurance"+i+" id=header_option_occurance"+i+" value='"+splitval[4]+"'>";
		HTMLVal+="<input type='hidden' name=order_seq_no"+i+" id=order_seq_no"+i+" value='"+splitval[2]+"'>";
   ...
   if(obj.value=="C")
	{
	   ...
	   removeitems(document.forms[0].Function_id);
	   var mode='CA_summary';	   
	   HTMLVal = "<html><head><link rel='stylesheet' type='text/css' href='../../eCommon/html/IeStyle.css'><script src='../../eCommon/js/ValidateControl.js' language='javascript'></script><script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script></head><BODY onKeyDown='lockKey()' class='message'><form name='form1' id='form1' method='post' action='../../eSM/jsp/GetUserDesktopValue.jsp'><input type='hidden' name='module_id' id='module_id' value='"+module_id+"'><input type='hidden' name='mode' id='mode' value='"+mode+"'></form></BODY></HTML>";
      parent.parent.messageFrame.document.body.insertAdjacentHTML('afterbegin',HTMLVal);
      parent.parent.messageFrame.document.form1.submit();
	  document.forms[0].module_id.disabled=true;
	  

	   parent.frames[1].location.href = "../../eSM/jsp/ConstructUserDesktop.jsp";
	}
   else
	{
...
/*?Desktop_code="+Desktop_code+"&Desktop_name="+Desktop_name+"&eff_status="+eff_status+"&module_id="+module_id+"&Function_id="+Function_id+"&desktop_summary_type="+desktop_summary_type+"&summ_show_by="+summ_show_by;
   ...
   HTMLVal = "<html><head><link rel='stylesheet' type='text/css' href='../../eCommon/html/IeStyle.css'><script src='../../eCommon/js/ValidateControl.js' language='javascript'></script><script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script></head><BODY onKeyDown='lockKey()' class='message'><form name='form1' id='form1' method='post' action='../../eSM/jsp/GetUserDesktopValue.jsp'><input type='hidden' name='module_id' id='module_id' value='"+module_id+"'><input type='hidden' name='appl_scope' id='appl_scope' value='"+appl_scope+"'><input type='hidden' name='mode' id='mode' value='summary'></form></BODY></HTML>";
   parent.parent.messageFrame.document.body.insertAdjacentHTML('afterbegin',HTMLVal);
   parent.parent.messageFrame.document.form1.submit();*/
...
function frameLoad()
{
	if(document.getElementById("desktop_summary_type").value=="C")
    {
		 ...
		 parent.frames[1].location.href = "../../eSM/jsp/ConstructUserDesktop.jsp?Desktop_code="+ Desktop_code +"&Desktop_name="+Desktop_name+"&eff_status="+eff_status+"&operation=modify";
	}
	else
	{
		parent.frames[1].location.href = "../../eCommon/html/blank.html";
