...
<iframe name="placeMealOrderOPSearch" id="placeMealOrderOPSearch" frameborder="0" scrolling="no" noresize src="../../eDS/jsp/PlaceMealOrderOPSearch.jsp?<%=request.getQueryString()%>" style="height:40vh;width:100vw"></iframe>
