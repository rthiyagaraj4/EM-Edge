...
<fmt:setLocale value="<%=locale %>"/>
	...
	<THEAD>
		<tr>
			...
			<th align="center">
				<fmt:message key="eDS.RejectionDateAndTime.Label" bundle="${ds_labels}" />
			</th>
			<th align="center">
...
%>			
			<tr>
			<td><%=RejectionListobject.get("serving_date")%>&nbsp;</td>
			<td><%=RejectionListobject.get("patient_id")%>&nbsp;</td>
			<td><%=RejectionListobject.get("patient_name")%>&nbsp;</td>
			<td><%=RejectionListobject.get("patient_class")%>&nbsp;</td>
			<td><%=RejectionListobject.get("location")%>&nbsp;</td>
			<td><%=RejectionListobject.get("meal_type")%>&nbsp;</td>
			<td><%=RejectionListobject.get("complaints")%>&nbsp;</td>
			<td><%=RejectionListobject.get("rejection_date_time")%>&nbsp;</td>
			<td><%=RejectionListobject.get("food_replacement")%>&nbsp;</td>
			<td><%=RejectionListobject.get("acknowledged_by")%>&nbsp;</td>
			<td><%=RejectionListobject.get("acknowledged_date_time")%>&nbsp;</td>
			<td>
...
%>
			...
			<%=RejectionListobject.get("acknowledge")%>&nbsp;
			</option>
			<option  value="Yes">
			Yes
			</option>
...
%>						
		...
		<input type="hidden" value='<%=RejectionListobject.get("serving_date")%>'  id="serving_date<%=i%>"/>
		<input type="hidden" value='<%=RejectionListobject.get("app_no")%>' id="app_no<%=i%>"/>
		<input type="hidden" value='<%=RejectionListobject.get("encounter_id")%>'  id="encounter_id<%=i%>"/>
		<input type="hidden" value='<%=RejectionListobject.get("mealtype_code")%>'  id="mealtype_code<%=i%>"/>
		<input type="hidden" value='<%=RejectionListobject.get("status")%>'  id="status<%=i%>"/>
		<input type="hidden" value='<%=RejectionListobject.get("acknowledged_by")%>'  id="acknowledged_by<%=i%>"/>
		<input type="hidden" value='<%=RejectionListobject.get("acknowledged_date_time")%>'  id="acknowledged_date_time<%=i%>"/>
<%
			i++;
		}
	}catch(Exception e){
...
%>			
	<input type="hidden" value="<%=i%>"  id="RejectionListcount"/>
