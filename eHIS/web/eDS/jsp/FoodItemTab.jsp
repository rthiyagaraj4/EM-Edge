...
<tr>
					...
					<ul id='tablist' class='tablist' style="padding:0px;">
						<li class='tablistitem' title='<fmt:message key="eOT.FoodItem.Label" bundle="${ot_labels}"/>'>
						<a onclick="changeTab('FoodItem')" class="tabclicked" id="FoodItemTab">
						<span class="tabSpanclicked" id="FoodItemTabspan">
						<fmt:message key="eOT.FoodItem.Label" bundle="${ot_labels}"/></span></a>
						</li>
						<li class="tablistitem" title='<fmt:message key="eOT.NutrientsFoodItem.Label" bundle="${ot_labels}"/>' >
						<a onclick="changeTab('Nutrients')" class="tabA" id="NutrientsTab">
						<span class="tabAspan" id="NutrientsTabspan">
						<fmt:message key="eOT.NutrientsFoodItem.Label" bundle="${ot_labels}"/>
						</span>
						</a>
						</li>
						</ul>
