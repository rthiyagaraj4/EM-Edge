...
Date			: Aug-2013
-->
<%@ page import="webbeans.eCommon.ConnectionManager,java.sql.Connection,java.sql.ResultSet,java.sql.PreparedStatement,java.net.URLEncoder"%>
...
<body>
	...
	<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
		<TR >
			<TD>
				<INPUT type="button" name="submit" id="submit" value="<fmt:message key="Common.apply.label" bundle="${common_labels}" />" onClick='parent.placeMealOrderOPMain.apply()' class="Button">
