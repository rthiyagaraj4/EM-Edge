			...
			<table border='0' cellpadding='2' cellspacing='0' width='75%' align='center'>
				<tr>
					<td class='label' align="right">
						<fmt:message key="eDS.CommercialFoodItem.Label" bundle="${ds_labels}"/>&nbsp;<fmt:message key="Common.code.label" bundle="${common_labels}"/>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<select name="item_Type" id="item_Type" <%=disabled_flag%>>
							<option value="">
				...
				<tr>
					...
					<td>
						<input type="text" name="item_Code" id="item_Code" value="<%=itemCode %>"  size="10" maxlength="10" />
					</td>
				</tr>
				<%}catch(Exception e){
					System.err.println("Exception in COM Food Item:"+e);
