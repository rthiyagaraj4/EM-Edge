...
try{
	...
	//ML-MMOH-CRF-0687
%>
	<form name="NonFreqBasedHeaderForm" id="NonFreqBasedHeaderForm" action="/MealPreparedServedComplaintsAction" method="post">
		<table border='0' cellpadding='0' cellspacing='0' align='center' width="100%">
			<tr>
				<td colspan="1" class="label">
					<fmt:message key="Common.date.label" bundle="${common_labels}" />
					<input type="text" name="date_nonFreqBased" id="date_nonFreqBased" size="10" maxlength="10"  value="<%=SystemDate_display%>" onblur="isValidDate(this);" >
					<img src='../../eCommon/images/CommonCalendar.gif'onClick="return showCalendar('date_nonFreqBased');">
	...
	<td colspan="1" class="label">
		...
		<input type="text" onblur="" value="" name="patientId" id="patientId" size='12' maxlength="<%=pat_id_length%>" onKeypress='return CheckForSpecChars(event);' onBlur="makeValidString(this);ChangeUpperCase(this);" />
...
%>
			...
			<tr align="right">
				<td align="right" colspan="3">
					<input type="button" value="Search" property="Select" onclick="getNonFreqBasedDetails()" class="BUTTON" />
