...
function apply()
{
	...
	var i=obj.document.getElementById("ComplaintListcount").value;
	...
	{	
		...
		//jsonDataObject.status=statusForJSON;
	...
	xmlHttp.open("POST", "../../servlet/eDS.MealComplaintServlet?mode=insertMealComplaint"+"&jsonData="+jsonData+"&ComplaintListcount="+i,false);	
	xmlHttp.send(xmlDoc);
...
function submitForm() {
	...
	{	
		parent.parent.messageFrame.document.location.href="../../eCommon/jsp/MstCodeError.jsp?err_num=";
		parent.query_result.location.href="../../eDS/jsp/DSMealComplaintsQueryResult.jsp?patient_Class="+patient_Class+"&ward_Clinic_code="+ward_Clinic_code+"&ward_Clinic_Desc="+ward_Clinic_Desc+"&serv_Date="+servDate;
	}
	else
		parent.query_result.location.href="../../eCommon/html/blank.html";
	}
...
function reset(){
	f_query_add_mod.location.href="../../eDS/jsp/DSMealComplaintsQuery.jsp";
}
	...
	if(servingDate!="" && servingDateTo!="")
		{
			...
			var retVal = trimString(xmlHttp.responseText);
				if(retVal > 90){
					...
					parent.query_result.location.href="../../eDS/jsp/DSMealComplaintsQueryResult.jsp?oncall="+oncall+"&servingDate="+servingDate+"&servingDateTo="+servingDateTo+"&Patient_Class="+Patient_Class+"&AcknowledgeStatus="+AcknowledgeStatus+"&patient_id="+patient_id+"&PatientStatus="+PatientStatus;
				}		 
		}else{
			parent.query_result.location.href="../../eDS/jsp/DSMealComplaintsQueryResult.jsp?oncall="+oncall+"&servingDate="+servingDate+"&servingDateTo="+servingDateTo+"&Patient_Class="+Patient_Class+"&AcknowledgeStatus="+AcknowledgeStatus+"&patient_id="+patient_id+"&PatientStatus="+PatientStatus;
		}
