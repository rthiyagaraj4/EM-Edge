...
%>			</select>
		...
		<%if(isSpltyNurUnitToEnableYNAppl.equals("N")){%>
					...
					<jsp:param name="nursing_unit_code_Appl" value="p_fr_nur_unit_code"/>
					</jsp:include>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					</tr>
		...
		<tr>
			...
			<td align="left" class="querydata" style="font-weight: bold;"><fmt:message key="Common.to.label" bundle="${common_labels}"/></td>
			<td>&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td class="fields" align='left'><input type=text id="p_date_from"  name='p_fr_date' id='p_fr_date' size="10" maxlength="10" align="center" onblur='validDateObj(this,"DMY",localeName);'><input type="image" src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('p_date_from');"></td>
			<td class="fields" align='left'><input type=text id="p_date_to"  name='p_to_date' id='p_to_date' size="10" maxlength="10" align="center" onblur='validDateObj(this,"DMY",localeName);'><input type="image" src='../../eCommon/images/CommonCalendar.gif' onClick="return showCalendar('p_date_to');"></td>
		</tr>
		<tr>
			<td class="label" >&nbsp;</td>
			<td class="label">&nbsp;</td>
