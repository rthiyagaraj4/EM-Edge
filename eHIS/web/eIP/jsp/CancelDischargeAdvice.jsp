...
<%
	...
	%>
				...
				<iframe name='f_query_add_mod' id='f_query_add_mod' 	 src='../jsp/InpatientLookupCriteria.jsp?function_id=<%=function_id%>&jsp_name=CancelDischargeAdviceMain.jsp&win_height=33.4&dialogTop=65&win_width=49.6&call_function=CancelDischargeAdvice&wherecondn=DISCHARGE_PAT_YN&oper_stn_id=<%=retVal%>' frameborder=0 scrolling='no' noresize style='height:24vh;width:100vw'></iframe>
