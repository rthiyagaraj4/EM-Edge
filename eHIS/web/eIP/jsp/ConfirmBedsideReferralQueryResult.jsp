...
<%@ page contentType="text/html;charset=UTF-8" import= "java.sql.Connection,java.sql.Statement,java.sql.ResultSet,java.sql.PreparedStatement,java.sql.SQLException,java.net.URLEncoder,webbeans.eCommon.ConnectionManager,eCommon.Common.*" %>
 ...
 <!--Added for this CRF ML-MMOH-CRF-0566-->
	...
	{	
		...
		{	
			...
			var arguments	= "" ;
			retVal = 	await window.showModalDialog("../../eIP/jsp/PaintReferralPatientDetails.jsp?function_id="+function_id+"&location_code="+IPval+"&encounterId="+enc+"&referralID="+refid+"&patientId="+patid+"&Practitioner_Id="+escape(practid)+"&callfrom=IP&call_function=<%=call_function%>&Sex="+sex+"&mode=modal&bl_instal="+instl_yn+"&p_service_type=<%=p_service_type%>&oper_stn_id=<%=oper_stn_id%>",arguments,features);
