	...
	<tr>
		...
		<td width="100%" class="Border" align='center'>
			...
			<table width='80%' cellPadding="0" cellSpacing="0"  align='center' >
                ...
                <tr>
                    <td align='right' width='30%' class="label" nowrap><fmt:message key="Common.practitionertype.label" bundle="${common_labels}"/>&nbsp;&nbsp;</td>
				...
				<tr>
					...
					<td  width='40%' align="left">
						...
						<option value='6'><fmt:message key="Common.AdmissionDateTime.label" bundle="${common_labels}"/>
				...
				<tr>
					...
					<td  width='40%' align="left">
						...
						<option value='1'><fmt:message key="eMP.RaceGroup.label" bundle="${mp_labels}"/>
