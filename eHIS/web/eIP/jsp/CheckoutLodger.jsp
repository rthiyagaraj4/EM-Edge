		...
		/*	Monday, June 14, 2010 PE_EXE venkat s pstmt = con.prepareStatement("SELECT AM_OPER_STN_ACCESS_CHECK(?,?,'N','','CHECK_LODGER_YN') from dual");
		    ...
		    {		
		 			%>
						...
						<iframe name='commontoolbarFrame' src=<%= source %> frameborder=0 scrolling='no' noresize style='height:9vh;width:100vw'></iframe>
						
							<iframe name="ReleaseBed_details" src="../jsp/ReleaseLodgerLookupCriteria.jsp?wherecondn=CHECK_LODGER_YN&function_id=<%=function_id%>&oper_stn_id=<%=retVal%>&patIDLength=<%=patient_id_length%>" frameborder=0 noresize scrolling='no' style='height:15vh;width:100vw'></iframe>
