...
async function searchCode(obj,target)
	{
			...
			if(obj.name=="age_grp_code")
			{
				...
				sql="select distinct age_group_code, age_group_short_desc from ip_book_limit_by_age_grp_vw where facility_id =`<%=p_facility_id%>` ";
	...
	<tr>
		...
		<td width="100%" class="Border" align='center'>
			...
			<table width='80%' cellPadding="0" cellSpacing="0"  align='center' >
				...
				<tr>
						<td align='left' width='30%' class="label"><fmt:message key="Common.agegroupcode.label" bundle="${common_labels}"/>&nbsp;</td>
						<td width='20%'  >
				...
				<tr>
					...
					<td class="fields" width='20%' align="left">
						...
						<option value='1'><fmt:message key="Common.agegroup.label" bundle="${common_labels}"/> 
