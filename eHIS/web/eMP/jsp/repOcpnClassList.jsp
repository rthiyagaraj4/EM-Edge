				...
				<table width='80%' cellPadding="3" cellSpacing="0" align='center'>
					...
					<tr>
						...
						<tr>
							...
							<option value="1"><fmt:message key="eMP.OccupationClassCode.label" bundle="${mp_labels}"/>
							<option value="2"><fmt:message key="eMP.OccupationClassDesc.label" bundle="${mp_labels}"/>
							</select>
							</td>
						</tr>
						<tr>
