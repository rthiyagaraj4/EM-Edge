<!DOCTYPE html>
<%@ page contentType="text/html;charset=UTF-8" import="java.io.*,java.sql.*,java.util.*,java.net.*,java.text.*,eMP.PatSearch.*,webbeans.eCommon.*, javax.naming.*,javax.ejb.*,java.rmi.*,javax.rmi.*,eCommon.XSSRequestWrapper" %>
...
<Script src="../../eCommon/js/showModalDialog.js" language="JavaScript"></Script>
		...
		<script>
			...
			{           
				var hit="<%=Hit%>";
				/*
			    parent.parent.Pat_Search_Criteria_Frame.document.forms[0].ORDERBY.value="<%=order_by%>";
				...
				*/
				...
				parent.Pat_Search_Criteria_Frame.document.getElementById("ORDERBY").value="<%=order_by%>";
...
<BODY class='CONTENT' onLoad="SearchLimit('<%=Hit%>')" onKeyDown = 'lockKey()'>
...
catch(Exception e)
{
	...
	if ( !(start <= 1) ) 
    {
        ...
        <Script language="JavaScript">
			...
			var str = '';
			if("<%=Hit%>")
			maxrec = "<%=Hit%>";//parent.parent.Pat_Results_Frame.document.getElementById("Hit_Limit").value;
    ...
    else 
    {
		...
		if (parent.parent.Pat_Search_Toolbar_Frame.document.forms[0].register)
            ...
            if('<%=maxRecord%>'<=11)parent.Pat_Search_Toolbar_Frame.defaultSetting(); //this line added for this incident [046134]
			}
		</Script>
<Script src="../../eCommon/js/showModalDialog.js" language="JavaScript"></Script>
...
<%}
			...
			%>
				<script>
				 ...
				 var chkPatDispArch	= "<%=chkPatDispArch%>";
...
<input type="hidden" name="MRN" id="MRN" value="<%=file_no%>">
<input type="hidden" name="OldFileNo" id="OldFileNo" value="<%=old_file_no%>">
...
<input type="hidden" name="final_sql" id="final_sql" value="<%=finalQuery.toString()%>">
<input type="hidden" name="final_whereClause1" id="final_whereClause1" value="">
<input type="hidden" name="final_whereClause" id="final_whereClause" value="<%=whereClause.toString()%>">
<input type="hidden" name="selectClause" id="selectClause" value="<%=selectClause.toString()%>">
<input type="hidden" name="addl_field1" id="addl_field1" value="<%=addl_field1%>">
<input type="hidden" name="addl_field2" id="addl_field2" value="<%=addl_field2%>">
<input type="hidden" name="addl_field3" id="addl_field3" value="<%=addl_field3%>">
<input type="hidden" name="addl_field4" id="addl_field4" value="<%=addl_field4%>">
<input type="hidden" name="addl_field5" id="addl_field5" value="<%=addl_field5%>">
...
<script>
//if ( ('<%=func_act%>'=="NEWBORN_REG") || ('<%=func_idpassed%>'=="MP_MAIN_NB_REG") )
if ('<%=enablegenderyn%>'=='N')
{
