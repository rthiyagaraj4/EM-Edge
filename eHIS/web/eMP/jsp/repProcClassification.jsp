	...
	<tr>
		<td width="50%" class="Border" >
				<table width='80%' cellPadding="3" cellSpacing="0" align='center'>
					...
					<tr>
						<td class='label' nowrap><fmt:message key="eMP.ProcedureClassificationCode.label" bundle="${mp_labels}"/></td>
					...
					<tr>
						...
						<td class='fields'><select name='p_order_by' id='p_order_by'>
								<option value="1"><fmt:message key="eMP.ProcedureClassificationCode.label" bundle="${mp_labels}"/>
								<option value="2"><fmt:message key="eMP.ProcedureClassificationDesc.label" bundle="${mp_labels}"/>
							</select>
						</td>
					</tr>
					<tr>
