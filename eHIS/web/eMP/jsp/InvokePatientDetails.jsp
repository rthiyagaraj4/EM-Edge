...
<script>		
		//window.open('../../eMP/jsp/ViewPatDetailsMain.jsp?menu_id=MP&module_id=MP&function_name=Change Patient Details&function_type=F&access=NYNNN&function_id=<%=function_id%>&home_required_yn=N&Patient_ID=<%=patient_id%>','eHIS','location=0,height=700,width=1050,top=0,left=0,resizable=yes');
		location.href ='../../eMP/jsp/ViewPatDetailsMain.jsp?menu_id=MP&module_id=MP&function_name=Change Patient Details&function_type=F&access=NYNNN&function_id=<%=function_id%>&home_required_yn=N&Patient_ID=<%=patient_id%>','eHIS','location=0,height=700,width=1050,top=0,left=0,resizable=yes';	
</script>
