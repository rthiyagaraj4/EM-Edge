...
<table width='80%' align='center' valign='top'>
	...
	<tr>
		<td width="80%" class="Border" >
				...
				<tr>
					<td class='label' width="20%"><fmt:message key="Common.Nature.label" bundle="${common_labels}"/></td>
				...
				<tr>
					...
					<td class='fields'><select name='p_order_by' id='p_order_by'>
						<option value='1'><fmt:message key="Common.ReasonCode.label" bundle="${common_labels}"/>
						<option value='2'><fmt:message key="Common.ReasonDescription.label" bundle="${common_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
