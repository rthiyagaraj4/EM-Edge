...
function print() 
{
    ...
    var arguments   = "" ;
    retVal = window.showModalDialog("../../eCommon/jsp/InternalReportsReprint.jsp?module_id=MP&step=0&target=step4",arguments,features);
...
function clearrace() {
	...
	if(  document.getElementById("dflt_nationality_code") && (document.getElementById("dflt_nationality_code").value != '')  
