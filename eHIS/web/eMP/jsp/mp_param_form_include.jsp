...
<% }%>
		...
		<tr><TD class='label' height='30'><fmt:message key="Common.ValidateAlphanumeric.label" bundle="${common_labels}"/></TD></tr>
		<%if(isStartWith){%>
		<tr><TD class='label' height='30'><fmt:message key="eMP.StartWith.label" bundle="${mp_labels}"/></TD></tr>
		<%}%>
...
<%
	...
	%>
	  ...
	  <TR>
		...
		<!-- Added By Dharma against GHL-CRF-0524.1 [IN:068022] on 25th July 2108 Start -->
	  <TR>
		<TD class='fields' height='30'><input type='checkbox' name='alt_id1_alphanum_validate_yn' id='alt_id1_alphanum_validate_yn' value='Y' <%=alt_id1_alphanum_validate_dis_chk%>></TD>
		<TD class='fields' height='30'><input type='checkbox' name='alt_id2_alphanum_validate_yn' id='alt_id2_alphanum_validate_yn' value='Y' <%=alt_id2_alphanum_validate_dis_chk%>></TD>
		<TD class='fields' height='30'><input type='checkbox' name='alt_id3_alphanum_validate_yn' id='alt_id3_alphanum_validate_yn' value='Y' <%=alt_id3_alphanum_validate_dis_chk%>></TD>
		<TD class='fields' height='30'><input type='checkbox' name='alt_id4_alphanum_validate_yn' id='alt_id4_alphanum_validate_yn' value='Y' <%=alt_id4_alphanum_validate_dis_chk%>></TD>
	  </TR>
...
<table border='0' cellpadding='0' cellspacing='0' width='100%'>
	...
	<tr>
				...
				<jsp:include page="../../eMP/jsp/mp_param_form_include_ext_newborn.jsp" >
...
//				 out.println("valu==in=out Side=>" +box_valu);
			...
			<td class='label'  nowrap ><fmt:message key="eMP.Lengthofbaby.label" bundle="${mp_labels}"/> </td>
						<td class='fields'><input type='checkbox' name='length_of_baby_yn' id='length_of_baby_yn' value='Y' <%=length_of_baby_chked%>></td>
			</tr>
			<tr>
						...
						<td class='label'  nowrap ><fmt:message key="eMP.Headcircumferenceofbaby.label" bundle="${mp_labels}"/> </td>
						<td class='fields'><input type='checkbox' name='head_circumference_of_baby_yn' id='head_circumference_of_baby_yn' value='Y' <%=head_circumference_of_baby_chked%>></td>
		</tr>
				...
				<tr>
						...
						<%if(isNationalIdValidationAppl){%>
							<td class='label' nowrap><fmt:message key="eMP.AgeWiseNotConsidrNatID.label" bundle="${mp_labels}"/></td>
							<td class='fields'><input type='text' name='age_not_consider_natid' id='age_not_consider_natid' value="<%=age_not_consider_natid%>" maxlength=3 size=3 onKeyPress='return allowNumOnly(event);' onBlur='chkValue(this);'> <fmt:message key="Common.days.label" bundle="${common_labels}"/> </td>
						<%}%>
						<!--End MO-CRF-20148-->
		</tr>		
	...
	<tr>
						 <td class='label'  nowrap ><fmt:message key="eMP.DeliveryTypeBirthReg.label" bundle="${mp_labels}"/></td>
						<td class='fields'><input type='checkbox' name='mod_birth_reg_appl_yn' id='mod_birth_reg_appl_yn' value='Y'<%=mod_birth_reg_appl_yn%>></td>
		</tr>    
	...
	<jsp:include page="../../eMP/jsp/mp_param_form_include_father.jsp" ><jsp:param name="flush" value="true" />	
	<jsp:param name="nb_father_name_mandatory_yn"  value='<%=nb_father_name_mandatory_yn%>'/> 
	<jsp:param name="first_name_accept_yn"  value='<%=checkForNull(request.getParameter("first_name_accept_yn") )%>'/> 
	<jsp:param name="first_name_reqd_yn"  value='<%=checkForNull(request.getParameter("first_name_reqd_yn") )%>'/> 
	<jsp:param name="first_name_order"  value='<%=checkForNull(request.getParameter("first_name_order") )%>'/> 
	<jsp:param name="first_name_prompt"  value='<%=checkForNull(request.getParameter("first_name_prompt") )%>'/> 
	<jsp:param name="second_name_accept_yn"  value='<%=checkForNull(request.getParameter("second_name_accept_yn") )%>'/> 
	<jsp:param name="second_name_reqd_yn"  value='<%=checkForNull(request.getParameter("second_name_reqd_yn") )%>'/> 
	<jsp:param name="second_name_order"  value='<%=checkForNull(request.getParameter("second_name_order") )%>'/> 
	<jsp:param name="second_name_prompt"  value='<%=checkForNull(request.getParameter("second_name_prompt") )%>'/> 
	<jsp:param name="third_name_accept_yn"  value='<%=checkForNull(request.getParameter("third_name_accept_yn") )%>'/> 
	<jsp:param name="third_name_reqd_yn"  value='<%=checkForNull(request.getParameter("third_name_reqd_yn") )%>'/> 
	<jsp:param name="third_name_order"  value='<%=checkForNull(request.getParameter("third_name_order") )%>'/> 
	<jsp:param name="third_name_prompt"  value='<%=checkForNull(request.getParameter("third_name_prompt") )%>'/> 
	<jsp:param name="family_name_accept_yn"  value='<%=checkForNull(request.getParameter("family_name_accept_yn") )%>'/> 
	<jsp:param name="family_name_reqd_yn"  value='<%=checkForNull(request.getParameter("family_name_reqd_yn") )%>'/> 
	<jsp:param name="family_name_order"  value='<%=checkForNull(request.getParameter("family_name_order") )%>'/> 
	<jsp:param name="family_name_prompt"  value='<%=checkForNull(request.getParameter("family_name_prompt") )%>'/> 
	<jsp:param name="enable_marital_status"  value='<%=checkForNull(request.getParameter("enable_marital_status") )%>'/> 
	<jsp:param name="dflt_father_first_name_prompt"  value='<%=checkForNull(request.getParameter("dflt_father_first_name_prompt") )%>'/> 
	<jsp:param name="dflt_father_Second_name_prompt"  value='<%=checkForNull(request.getParameter("dflt_father_Second_name_prompt") )%>'/> 
	<jsp:param name="dflt_father_third_name_prompt"  value='<%=checkForNull(request.getParameter("dflt_father_third_name_prompt") )%>'/> 
	<jsp:param name="dflt_father_family_name_prompt"  value='<%=checkForNull(request.getParameter("dflt_father_family_name_prompt") )%>'/> 	
				</jsp:include>
		<tr>
		...
		<jsp:include page="../../eMP/jsp/mp_param_form_include_newborn.jsp" ><jsp:param name="flush" value="true" />
		...
		<tr>
			...
			<tr>
					...
					<%if(isInvokeChngPatDtls){%>
						<fmt:message key="eMP.AgeDefNotConsideredNatIDIqmaID.label" bundle="${mp_labels}"/>
					<%}
					else if(isNatIdAltIdMandVisaType) {%>
						<fmt:message key="eMP.AgeDefNotConsideredEmrIDMOHId.label" bundle="${mp_labels}"/>
						<%}
					else{%>
						<fmt:message key="eMP.AgeDefNotConsideredNatIDAltId.label" bundle="${mp_labels}"/>
					<%}%>
					</td>
					
					<td  class='fields' nowrap ><input type='text' name='age_not_consider_natid_altid' id='age_not_consider_natid_altid' value='<%=age_not_consider_natid_altid%>' maxlength=3 size = 3 onKeyPress='return allowValidNumber(this,event,3, 0);' onBlur='CheckNum(this);checkDecimal(this);'>&nbsp;<fmt:message key="Common.days.label" bundle="${common_labels}"/></td>
			</tr>
			</table>
			</td>
		</tr>
    ...
    <table border='0' cellpadding='3' cellspacing='0' width='100%'>
		...
		<tr>
			...
			<td class='fields'>
			<input type='text' name='min_gestation' id='min_gestation' maxLength=3 size=5 onKeyPress="return allowValidNumber(this,event,3,0);" value="<%=min_gestation%>" onblur='CheckPositiveNumber(this)' <%= invk_menst_history_disabled %>>&nbsp;&nbsp;
			<input type='text' name='max_gestation' id='max_gestation' maxLength=3 size=5 onKeyPress="return allowValidNumber(this,event,3,0);" value="<%=max_gestation%>" onblur='CheckPositiveNumber(this)' <%= invk_menst_history_disabled %>></td>
		...
		<input type='radio' value='W' name='unit_of_gest_nb' id='unit_of_gest_nb' onclick='uomcheck(this)' <%= invk_menst_history_disabled %>><fmt:message key="Common.weeks.label" bundle="${common_labels}"/></td><td class='fields'>
		<input type='radio' value='D' name='unit_of_gest_nb' id='unit_of_gest_nb' onclick='uomcheck(this)' <%= invk_menst_history_disabled %>>&nbsp;<fmt:message key="Common.days.label" bundle="${common_labels}"/></td> 
		</tr><%}%>
...
<!--        <tr>
 ...
 <tr>
 <td class='label' ><fmt:message key="Common.unknown.label" bundle="${common_labels}"/>&nbsp;<fmt:message key="eMP.prefix.label" bundle="${mp_labels}"/></td>
            <td class='fields'>
...
<!-- 					Added by Ajay Hatwate for AAKH-CRF-0179  -->
				...
				<tr>
				<td class="label" colspan='4'><fmt:message key="Common.race.label" bundle="${common_labels}"/>
						<%                
						...
						%><!--Below Field Added against AMRI-CRF-0388  By shagar -->
				...
				<tr>
					...
					<td class="fields" width='10%' colspan='4'><input type='text' name='no_days_before_deceased' id='no_days_before_deceased' maxLength='3' size='3' onblur='makemand(this);' onKeyPress='return chkForNumeric(event);'  value="<%=no_days_before_deceased%>" nowrap><fmt:message key="Common.days.label" bundle="${common_labels}"/>
					</td>
					<%
 ...
 <table border='0' cellpadding='3' cellspacing='0' width='100%'>
				...
				<tr><td colspan='1' class='label' ><fmt:message key="eMP.PatientSearchTab.label" bundle="${mp_labels}"/></td><td class='fields' colspan='3'>
