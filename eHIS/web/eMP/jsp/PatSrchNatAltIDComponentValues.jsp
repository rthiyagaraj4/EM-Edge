					...
					//	String doc1_exp_date=rset3.getString("DOC1_EXP_DATE")==null?"":rset3.getString("DOC1_EXP_DATE");
						...
						if('<%=deceased_yn%>'=='N'){
							...
							if(document.getElementById("Dob"))
								document.getElementById("Dob").value='<%=date_of_birth%>';
							...
							if(document.getElementById("nationality_desc_hid"))
								document.getElementById("nationality_desc_hid").value='<%=nationality_desc%>';							
							if(document.getElementById("Nationality_hid"))
								document.getElementById("Nationality_hid").value='<%=nationality_code%>';
							if(document.getElementById("ethnic_group_hid"))
								document.getElementById("ethnic_group_hid").value='<%=race_code%>';
							if(document.getElementById("ethnic_group_desc"))
								document.getElementById("ethnic_group_desc").value='<%=race_desc%>';
							if(document.getElementById("ethnic_group_desc_hid"))
								document.getElementById("ethnic_group_desc_hid").value='<%=race_desc%>';
