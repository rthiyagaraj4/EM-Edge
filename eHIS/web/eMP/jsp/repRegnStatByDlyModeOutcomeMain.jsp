...
<tr>
	   ...
	   <tr>
		...
		<td class="fields"><SELECT name="p_type" id="p_type" onChange="mychangerepMPRegnStat()">	 <option value="A"><fmt:message key="Common.AgeRange.label" bundle="${common_labels}"/></option>
