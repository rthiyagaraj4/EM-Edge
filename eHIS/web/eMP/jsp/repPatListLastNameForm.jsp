...
<%@ page import ="java.sql.*,webbeans.eCommon.*, java.util.*, eCommon.Common.*" contentType="text/html;charset=UTF-8"  %>
...
<center>
	...
	<BR>
		...
		<tr>
			...
			<td >&nbsp;</td><td class="querydata" ><b><fmt:message key="Common.to.label" bundle="${common_labels}"/></b></td>
		</tr>
			<tr>
