<!DOCTYPE html>
<%@ page import="java.sql.*,eCommon.Common.*,webbeans.eCommon.*" contentType="text/html;charset=UTF-8" %>
...
<tr>	
	<%
	 ...
	 if(delivery_date_label)
		{
		%>
		<td class="label"><fmt:message key="eMP.DeliveryDate.label" bundle="${mp_labels}"/>&nbsp;<fmt:message key="Common.from.label" bundle="${common_labels}"/></td>
		<%
		}
		else{
	%>
...
%>
	...
	<input type="hidden" name="delivery_date_label" id="delivery_date_label"	value="<%=delivery_date_label%>"> <!-- -->
