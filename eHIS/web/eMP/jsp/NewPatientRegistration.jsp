...
<%@ page contentType="text/html;charset=UTF-8" import="java.sql.Connection, java.sql.PreparedStatement, java.sql.ResultSet, java.util.ArrayList, java.util.HashMap, java.util.StringTokenizer, webbeans.eCommon.ConnectionManager,java.util.*,eBL.Common.*,eCommon.XSSRequestWrapper,eCommon.Common.*, eBL.*,eMP.*,java.io.*" %>
...
// This array building is now handled in PatNamesComp.jsp
    ...
    <body onSelect="codeArrestThruSelect()" onload='<%if(isVirtualConsultation){%>telephone();<%}%>displayScanner();chkNatlIdMandatory("onload");' onKeyPress='return ChkKey(event);'OnMouseDown="CodeArrest()"  onKeyDown='lockKey()'>
		...
		try
		{
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<jsp:include page="../../eMP/jsp/ChangePatientSubNames.jsp" ><jsp:param name="flush" value="true" />
					...
					<jsp:param name='blood_group' value="<%=blood_group%>"/>
					<jsp:param name='nat_id_exp_date' value="<%=nat_id_exp_date%>"/>
                ...
                <tr>
                    ...
                    <table cellpadding='2' cellspacing='0' border='0' height='100%' width='99.5%'>
						...
						// below New Iamge  is added against GHL-CRF-0312 [IN:039856] by Saanthaakumar%>   
                         ...
                         <td colspan='2' class='fields'><input type='text' name='r_country_desc' id='r_country_desc' value="<%=a_res_country_desc%>" size='15' maxlength='15' onblur='if(this.value != "") {searchCountry(contry_code[0],r_country_desc)} else{clearCountryFields(this);}' tabIndex='61'><input type='button' name='contry_code' id='contry_code' value='?' class='button' onclick='searchCountry(this,r_country_desc)' tabIndex='61'><img id='id2' src='../images/mandatory.gif' style='<%=country_visibility%>'></img><input type='hidden' name='r_country_code' id='r_country_code' value="<%=a_country_code%>">
                         </td> 
						...
						<td class='fields' colspan='<%=col_span_td%>'>
							<input type='text' name='a_country_desc' id='a_country_desc' size='15' maxlength='15' value="<%=alt_country_desc%>" onblur='if(this.value !="") {searchCountry(contry_code[0],a_country_desc); } else {clearCountryFields(this);}' tabIndex='76' ><input type='button' name='contry_code' id='contry_code' value='?' class='button' onclick='searchCountry(this,a_country_desc)' tabIndex='76'>
							<input type='hidden' name='a_country_code' id='a_country_code' value="<%=alt_country_code%>">							
						<%}%>
						   <td class='fields' colspan='<%=col_span_td%>'>
							<input type='text' name='m_country_desc' id='m_country_desc' size='15' maxlength='15' value="<%=a_mail_country_desc%>" onblur='if(this.value !="") {searchCountry(contry_code[0],m_country_desc); } else {clearCountryFields(this);}' tabIndex='79'><input type='button' name='contry_code' id='contry_code' value='?' class='button' onclick='searchCountry(this,m_country_desc)' tabIndex='79'>
                        ...
                        <tr>
                            ...
                            <td colspan='2' class='fields'>
                                <input type='text' name='r_contact_name' id='r_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value= "<%=res_contact_name%>" tabIndex='63'>
                            </td>
							...
							%>
							<td class='fields' colspan='<%=col_span_td%>'>
                                <input type='text' name='a_contact_name' id='a_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value="<%=mail_contact_name%>" tabIndex='77'>
                            </td >
							<%
							}
							%>									
                            <td class='fields' colspan='<%=col_span_td%>'>
                                <input type='text' name='m_contact_name' id='m_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value="<%=mail_contact_name%>" tabIndex='80'>
                            </td>							
                        </tr>
						<%if(alterAddressApplicable){%>
						<tr>
...
<%
            ...
            <tr>
				...
				<td  class='fields'>
				<input type='text' name='rel_alias_name' id='rel_alias_name' maxlength='30' size='20' value='<%=nkin_alias_name%>'></td>
				</tr>
				<%} %>
				...
				<tr><td  class='label'><fmt:message key="Common.birthDate.label" bundle="${common_labels}"/></td>
                    <td class='fields'>
                        <input type='text' name='contact1_birth_date' id='birthdate1' maxlength='10' size='10' onblur='makeValidString(this);gotoNext(this)' value='<%=contact1_birth_date%>' ><img src='../../eCommon/images/CommonCalendar.gif' id="birthdate"  onClick="document.forms[0].contact1_birth_date.select();return showCalendar('birthdate1');" >
                    </td></tr>	
                <!-- Below added by Suji Keerthi for ML-MMOH-CRF-1527 US007 -->
                <%if(aliasnameNationalityRace){%>
			    ...
			    <td class='fields'>
					<input type='text' name='rel_nationality_desc' id='rel_nationality_desc' size='20' maxlength='20'  onblur='if(this.value !="") {searchCountry(rel_contry_code, rel_nationality_desc);}' value="<%=checkForNull((String)hash_Map3.get("country_long_desc"))%>" ><input type='button' name='rel_contry_code' id='rel_contry_code' value='?' class='button' onclick='searchCountry(this,rel_nationality_desc)' >
					<input type='hidden' name='rel_nationality_code' id='rel_nationality_code' value="<%=checkForNull((String)hash_Map3.get("country_code"))%>">
			    ...
			    %>
				<tr><td  class="label" ><fmt:message key="Common.race.label" bundle="${common_labels}"/>
				<td  class='fields'> <input type='text' name='rel_race_desc' id='rel_race_desc' size='20' maxlength='20' onblur='if(this.value !="") {searchRace(rel_race_code,rel_race_desc);}' value="<%=checkForNull((String)hash_Map6.get("race_desc"))%>"><input type='button' name='rel_race_desc_id' id='rel_race_desc_id' value='?' class='button' onclick='searchRace(this,rel_race_desc)' >
				<input type='hidden' name='rel_race_code' id='rel_race_code' value="<%=checkForNull((String)hash_Map6.get("race_code"))%>">
				</td>
				</tr>
				<%} %>
			    <!-- Ended for ML-MMOH-CRF-1527 -->
			   ...
			   %>
				...
				<tr>
					<td  class='label' ><fmt:message key="Common.country.label" bundle="${common_labels}"/></td>
					<td class='fields'><input type='text' name='next_country_desc' id='next_country_desc' size='15' maxlength='15' value='<%=nkin_country_name%>' onblur='if(this.value !="") {searchCountry(contry_code[0],next_country_desc);}else{clearCountryFields(this);}' tabindex='65'><input type='button' name='contry_code' id='contry_code' value='?' class='button' onclick='searchCountry(this,next_country_desc)' tabindex='65'>
					<input type='hidden' name='next_country_code' id='next_country_code' value=''>
					</td>
				<!--Below added by Suji Keerthi for ML-MMOH-CRF-1527 US008-->
				<% if(resiAddMailAdd){%>
					
					<td class='fields'><input type='text' name='nk_ma_country_desc' id='nk_ma_country_desc' size='15' maxlength='15' value='<%=nk_mail_country_desc%>' onblur='if(this.value !="") {searchCountry(nk_ma_country_code,nk_ma_country_desc);}else{clearCountryFields(this);} ' tabindex='68'><input type='button' name='nk_ma_country_code' id='nk_ma_country_code' value='?' class='button' onclick='searchCountry(this,nk_ma_country_desc)' tabindex='68'>
				...
				<tr>
                    ...
                    <td class='fields'>
                    <input type='text' name='ra_contact_name' id='ra_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value= "<%=resadd_contact_name%>" tabindex='66'>
                    </td>
                    <td class='fields'>
                    <input type='text' name='ma_contact_name' id='ma_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value="<%=mailadd_contact_name%>" tabindex='69'>
                    </td></tr>
			...
			<table width="100%"><tr>
				...
				<tr>
					...
					<input type='text' name='next_res_tel_no' id='next_res_tel_no' maxlength='20' size='20'  onblur='makeValidString(this);return isValidCharacter(this);' onKeyPress='return SpecialCharsChk(event);' value = '<%=nkin_res_tel_no%>'></td>
				
                    <td  class='label' ><fmt:message key="Common.MobileNo.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type='text' name='contact1_mob_tel_no' id='contact1_mob_tel_no' maxlength='20' size='20'  onblur='makeValidString(this);return isValidCharacter(this);' onKeyPress='return SpecialCharsChk(event);' value='<%=nkin_mob_tel_no%>'></td>
				
					<td  class='label'><fmt:message key="Common.email.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type='text' name='contact1_email_id' id='contact1_email_id' maxlength='50' size='42'  onblur='makeValidString(this);' value = '<%=nkin_email_id%>'></td>
         ...
         <tr>
				...
				<td valign=top>
					<table cellspacing='1' cellpadding='3' width='100%' border='0'>
							...
							<input type='text' name='first_contact_name' id='first_contact_name' maxlength='80' value="" value='<%=fton_contact_name%>'>
							</td>
					</td>
		 </tr>
		 <tr>
					   <td class='label'><fmt:message key="Common.relationship.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					%>
					<tr>
						<td  class='label'><%=rset.getString("nat_id_prompt")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type='text' name='contact2_nat_id_no' id='contact2_nat_id_no' value=""  maxlength='<%= rset.getString("nat_id_length") %>' size='<%= rset.getString("nat_id_length") %>'  onblur="<%=nat_on_blurfn_st%>" onkeypress='return <%=nat_id_onKeyPress%>'   value='<%=fton_nat_id_no%>' >
						</td>
					</tr>
					...
					//added by gomathi.
				 	if(Accept_oth_alt_id_yn.equals("Y")) 
					{ %>
					<tr><td  class='label' nowrap><fmt:message key="Common.otheraltid.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<%}%>
				<tr>
					<td  class='label'><fmt:message key="eMP.occupation.label" bundle="${mp_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<%}
                ...
                <tr>
				  <td  class='label'><fmt:message key="Common.country.label" bundle="${common_labels}"/></td>
                  <td class='fields'><input  type='text' value='<%=fton_country_name%>' name='first_country_desc'  size='15' maxlength='15' onblur='if(this.value !=""){searchCountry(contry_code[0],first_country_desc);}else{clearCountryFields(this);}' tabindex='65'><input type='button' name='contry_code' id='contry_code' value='?' class='button' onclick='searchCountry(this,first_country_desc)' tabindex='65'></td>
				  <input type='hidden' name='first_country_code' id='first_country_code' value=''>
				  <!--Below added by Suji Keerthi for ML-MMOH-CRF-1527 US008-->
				<% if(resiAddMailAdd){%>	

					<td class='fields'><input type='text' name='first_mail_country_desc' id='first_mail_country_desc' size='15' maxlength='15' value='<%=fton_mail_country_desc%>' onblur='if(this.value !="") {searchCountry(ma_country_code,first_mail_country_desc);}else{clearCountryFields(this);} ' tabindex='68'><input type='button' name='ma_country_code' id='ma_country_code' value='?' class='button' onclick='searchCountry(this,first_mail_country_desc)' tabindex='68'>
				...
				<tr>
					<td class='label' nowrap ><fmt:message key="eMP.ContactPerson.label" bundle="${mp_labels}"/></td> 
                    <td class='fields'>
                    <input type='text' name='fton_ra_contact_name' id='fton_ra_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value= "<%=fton_resadd_contact_name%>" tabindex='66'>
                    </td>
                    <td class='fields'>
                    <input type='text' name='fton_ma_contact_name' id='fton_ma_contact_name' size='30' maxlength='30'  onblur='makeValidString(this);' value= "<%=fton_mailadd_contact_name%>" tabindex='69'>
                    </td>
				</tr>
			...
			<table width="100%"><tr>
				...
				<tr>
                    ...
                    <input type='text' name='first_res_tel_no' id='first_res_tel_no' maxlength='20' size='20'  onblur='makeValidString(this);return isValidCharacter(this);' onKeyPress='return SpecialCharsChk(event);' value = '<%=fton_res_tel_no%>'></td>
				    
						
				    <td  class='label' nowrap ><fmt:message key="Common.MobileNo.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type='text' name='contact2_mob_tel_no' id='contact2_mob_tel_no' maxlength='20' size='20'  onblur='makeValidString(this);return isValidCharacter(this);' onKeyPress='return SpecialCharsChk(event);' value = '<%=fton_mob_tel_no%>'></td>
				    

				    <td  class='label' nowrap ><fmt:message key="Common.email.label" bundle="${common_labels}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type='text' name='contact2_email_id' id='contact2_email_id' maxlength='50' size='45'  onblur='makeValidString(this);' value = '<%=fton_email_id%>'></td>
            ...
            <table width='100%' cellpadding='2' cellspacing='0'>
                ...
                <tr>
                    ...
                    <td class='fields'>
						...
						<input type='text' name='doc_exp_dt1' id='doc_exp_dt1' size=10 maxlength=10  onblur = 'validDateObj(this,"DMY","<%=localeName%>");return ChkForIssueDate(this,document.forms[0].issue_date1);' disabled  onblur='makeValidString(this);' value ='<%=doc1_exp_date%>'><img src='../../eCommon/images/CommonCalendar.gif' id="docexpdate1" disabled onClick="document.forms[0].doc_exp_dt1.select();return showCalendar('doc_exp_dt1');" >
                    </td>											  
                    ...
                    <td class='fields'>
						...
						<input type='text' name='issue_date1' id="issue_date1" value='<%=doc1_iss_date%>' size=10 maxlength=10  onblur='validDateObj(this,"DMY","<%=localeName%>");return ChkForIssueDate(this,document.forms[0].issue_date1);' disabled  onblur='makeValidString(this);' value=''><img src='../../eCommon/images/CommonCalendar.gif' id="issuedt1" disabled onClick="document.forms[0].issue_date1.select();return showCalendar('issue_date1');" >
                    </td>
					<!-- Below line was added by Venkatesh.S on  Feb/2013  against PMG2012-CRF-0006 [IN034693]  -->
...
{  
    ...
    if(txtObj.value.length>txtObj.maxLength)
    {
        ...
        <input type='hidden' name='isVirtualConsultation' id='isVirtualConsultation' value='<%=isVirtualConsultation%>'></input><!--Added by Arthi for ML-MMOH-CRF-1930 US004-->
