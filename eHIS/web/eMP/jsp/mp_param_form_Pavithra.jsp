...
<td width="75%" colspan='3'>
				   ...
				   <tr>
					...
					<tr>
						<td class='label' width='25%'><fmt:message key="eMP.AcceptAlphanumeric.label" bundle="${common_labels}"/></td>
...
<input type="hidden" name="nb_use_mother_ser1" id="nb_use_mother_ser1" value="<%=nb_use_mother_ser%>">
   ...
   <jsp:param name="operation" 	value="<%=operation%>" />
		...
		<jsp:param name="aadhar_config_enabled_yn"		value="<%=aadhar_config_enabled_yn%>" />
		<jsp:param name="aadhar_option_value"		value="<%=aadhar_option_value%>" />
</jsp:include>
<%-- This param is removed as it is not required for That
