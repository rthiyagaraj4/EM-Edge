...
<form name="Procedure_Classification" id="Procedure_Classification" action="../../servlet/eMP.ProcedureClassificationServlet" method="post" target="messageFrame">
		...
		<tr class='label'><td class='label' colspan='2'>&nbsp;</td></tr>
      		...
      		<tr>
      		    ...
      		    <td class="fields" width='50%'><input type='text' name='proc_class_code' id='proc_class_code' value="<%=procclass%>" <%=rd%> size='10' maxlength='10' onKeyPress="return CheckSpecChars(event)"><img src='../images/mandatory.gif' align='center'></img></td>
