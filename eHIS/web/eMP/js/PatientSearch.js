...
function reset(){
   ...
   parent.Pat_Search_Toolbar_Frame.location.href = "../../eMP/jsp/SearchToolbar.jsp?register_button_yn="+register_button_yn+"&func_act="+func_act+"";
   parent.Pat_Results_Frame.location.href = '../../eCommon/html/blank.html';
   parent.Pat_Search_Criteria_Frame.document.getElementById('Soundex').value = soundex;
...
{
	if(sndx=="") parent.Pat_Search_Criteria_Frame.document.getElementById('Soundex').value="";
	if(sndx=="E") parent.Pat_Search_Criteria_Frame.document.getElementById('Soundex').value="E";
	if(sndx=="G") parent.Pat_Search_Criteria_Frame.document.getElementById('Soundex').value="G";
}
...
var suspend_inactive_pat_yn	=parent.Pat_Search_Toolbar_Frame.document.getElementById('suspend_inactive_pat_yn').value;//Maheshwaran K added for MMS-DM-CRF-0208.1
/*************Basic Search Tab*****************/
...
var alt_id1_pat_sch_exact_yn="";
var alt_id2_pat_sch_exact_yn="";
var alt_id3_pat_sch_exact_yn="";
var alt_id4_pat_sch_exact_yn="";

if (document.forms[0].name=="Basic_Patient_Search_Form"){
	

   var pat_id1=trimString(document.getElementById('Patient_Id1').value);
   var isInsuranceCardReader = Basic_Patient_Search_Form.isInsuranceCardReader.value;/* Added by KAMATCHI S ON 27-AUG-2020 */
	var gender="";
	if (Basic_Patient_Search_Form.Gender){
	gender=Basic_Patient_Search_Form.Gender.value;
	}
	var fieldsFlag=false;
	var national_id_no1="";
	var order_by1="";
	if(document.getElementById('National_Id_No1')){
		national_id_no1=trimString(document.getElementById('National_Id_No1').value);
	}
	var alt_id1_no1="";
	if(document.getElementById('Alt_Id1_No1')){
		alt_id1_no1=trimString(document.getElementById('Alt_Id1_No1').value);
	}
	
	var alt_id2_no1="";
	if(document.getElementById('Alt_Id2_No1')){
		alt_id2_no1=trimString(document.getElementById('Alt_Id2_No1').value);
	}
	var alt_id3_no1="";
	if(document.getElementById('Alt_Id3_No1')){
		alt_id3_no1=trimString(document.getElementById('Alt_Id3_No1').value);
	}
	var alt_id4_no1="";
	if(document.getElementById('Alt_Id4_No1')){
		alt_id4_no1=trimString(document.getElementById('Alt_Id4_No1').value);
	}
	var dft_national_id="";
	if(document.getElementById('dft_national_id')){
		dft_national_id=trimString(document.getElementById('dft_national_id').value);
	}
	/*var pat_name1="";
	...
	if(document.getElementById('First_Name1')){
		//First_Name1=trimString(document.getElementById('First_Name1').value);
		First_Name1=document.getElementById('First_Name1').value;
		First_Name1=makeValidQueryString(First_Name1);//Modified on 8-3-2012 by Shanthi for IN031010
	}
	
	var Second_Name1=""; 
	if(document.getElementById('Second_Name1')){
		//Second_Name1=trimString(document.getElementById('Second_Name1').value);
		Second_Name1= document.getElementById('Second_Name1').value;
		Second_Name1=makeValidQueryString(Second_Name1);
	}
	var Third_Name1=""; 
	if(document.getElementById('Third_Name1')){
		//Third_Name1=trimString(document.getElementById('Third_Name1').value);
		Third_Name1=document.getElementById('Third_Name1').value;
		Third_Name1=makeValidQueryString(Third_Name1);
	}
	var Family_Name1=""; 
	if(document.getElementById('Family_Name1')){
		//Family_Name1=trimString(document.getElementById('Family_Name1').value);
		Family_Name1=document.getElementById('Family_Name1').value;
		Family_Name1=makeValidQueryString(Family_Name1);
	}
	var first_name_loc_lang1=""; 
	if(document.getElementById('first_name_loc_lang1')){
		//first_name_loc_lang1=trimString(document.getElementById('first_name_loc_lang1').value);
		first_name_loc_lang1=document.getElementById('first_name_loc_lang1').value;
		first_name_loc_lang1=makeValidQueryString(first_name_loc_lang1);
	}
	var second_name_loc_lang1=""; 
	if(document.getElementById('second_name_loc_lang1')){
		//second_name_loc_lang1=trimString(document.getElementById('second_name_loc_lang1').value);
		second_name_loc_lang1=document.getElementById('second_name_loc_lang1').value;
		second_name_loc_lang1=makeValidQueryString(second_name_loc_lang1);
	}
	var third_name_loc_lang1=""; 
	if(document.getElementById('third_name_loc_lang1')){
		//third_name_loc_lang1=trimString(document.getElementById('third_name_loc_lang1').value);
		third_name_loc_lang1=document.getElementById('third_name_loc_lang1').value;
		third_name_loc_lang1=makeValidQueryString(third_name_loc_lang1);
	}
	var family_name_loc_lang1=""; 
	if(document.getElementById('family_name_loc_lang1')){
		//family_name_loc_lang1=trimString(document.getElementById('family_name_loc_lang1').value);
		family_name_loc_lang1=document.getElementById('family_name_loc_lang1').value;
		family_name_loc_lang1=makeValidQueryString(family_name_loc_lang1);
	}
	var pr_resNo1="";
	if(document.getElementById('pr_resNo1')){
		pr_resNo1=trimString(document.getElementById('pr_resNo1').value);
	}
	var oth_no1="";
	if(document.getElementById('oth_no1').value){
		oth_no1=trimString(document.getElementById('oth_no1').value);
	}

	/* Added by KAMATCHI S ON 27-AUG-2020 */
	if(isInsuranceCardReader=="true"){
	var car_reader  = [] ;
	car_reader=document.getElementById('insurance_id').value;
	}
	/* Added by KAMATCHI S ON 27-AUG-2020 */
		...
		var Search_By="";
		var Search_By_Lang="";
	 pat_name_as_multipart_yn	 =	trimString(document.getElementById('pat_name_as_multipart_yn_hd').value);
	if(document.getElementById('Search_By') && document.getElementById('Search_By').value!=null){
		Search_By =	trimString(document.getElementById('Search_By').value);
	}
	if(document.getElementById('Search_By_Lang') && document.getElementById('Search_By_Lang').value!=null){
		Search_By_Lang  =	trimString(document.getElementById('Search_By_Lang').value);
		}
		// Suresh M on 13.12.2010
		var language_direction = "";
	language_direction = document.getElementById('language_direction').value;	
		// Ends Suresh M
		var search_in ="P";
	...
	if(isInsuranceCardReader=="true")
		{
		//Added by KAMATCHI S FOR MOHE-CRF-0016.1
		if(!fieldsFlag && car_reader!="")
			fieldsFlag=true;
		}
		else
	    {
		...
		/*Below Added by Rameswar on 3rd July 2015 for MO-CRF-20099 [IN054280]*/
	alt_id1_pat_sch_exact_yn=document.getElementById('alt_id1_pat_sch_exact_yn').value;
	alt_id2_pat_sch_exact_yn=document.getElementById('alt_id2_pat_sch_exact_yn').value;
	alt_id3_pat_sch_exact_yn=document.getElementById('alt_id3_pat_sch_exact_yn').value;
	alt_id4_pat_sch_exact_yn=document.getElementById('alt_id4_pat_sch_exact_yn').value;
	
					if(fieldsFlag){
					//HTMLVal = "<html><BODY onKeyDown='lockKey()'><form id='Dummy' name='Dummy' method='post' action='../../eMP/jsp/BasicPatientSearchResult.jsp'><input id='pat_id1'  name='pat_id1' type='hidden' value='"+pat_id1+"'><input id='national_id_no1'  name='national_id_no1' type='hidden' value='"+national_id_no1+"'><input id='alt_id1_no1'  name='alt_id1_no1' type='hidden' value='"+alt_id1_no1+"'><input id='alt_id2_no1'  name='alt_id2_no1' type='hidden' value='"+alt_id2_no1+"'><input id='alt_id3_no1'  name='alt_id3_no1' type='hidden' value='"+alt_id3_no1+"'><input id='alt_id4_no1'  name='alt_id4_no1' type='hidden' value='"+alt_id4_no1+"'><input id='First_Name1'  name='First_Name1' type='hidden' value='"+First_Name1+"'><input id='Second_Name1'  name='Second_Name1' type='hidden' value='"+Second_Name1+"'><input id='Third_Name1'  name='Third_Name1' type='hidden' value='"+Third_Name1+"'><input id='Family_Name1'  name='Family_Name1' type='hidden' value='"+Family_Name1+"'><input id='first_name_loc_lang1'  name='first_name_loc_lang1' type='hidden' value='"+first_name_loc_lang1+"'><input id='second_name_loc_lang1'  name='second_name_loc_lang1' type='hidden' value='"+second_name_loc_lang1+"'><input id='third_name_loc_lang1'  name='third_name_loc_lang1' type='hidden' value='"+third_name_loc_lang1+"'><input id='family_name_loc_lang1'  name='family_name_loc_lang1' type='hidden' value='"+family_name_loc_lang1+"'><input id='pr_resNo1'  name='pr_resNo1' type='hidden' value='"+pr_resNo1+"'><input id='oth_no1'  name='oth_no1' type='hidden' value='"+oth_no1+"'><input id='search_in'  name='search_in' type='hidden' value='"+search_in+"'><input id='func_act'  type='hidden' name='func_act' value='"+func_act+"' ><input id='act_yn'  type='hidden' name='act_yn' value='"+act_yn+"' ><input id='function_id'  type='hidden' name='function_id' value='"+function_id+"'><input id='order_by1'  name='order_by1' type='hidden' value='"+order_by1+"'><input id='gender'  name='gender' type='hidden' value='"+gender+"'><input id='Search_By'  name='Search_By' type='hidden' value='"+Search_By+"'><input id='Search_By_Lang'  name='Search_By_Lang' type='hidden' value='"+Search_By_Lang+"'><input id='pat_name_as_multipart_yn'  name='pat_name_as_multipart_yn' type='hidden' value='"+pat_name_as_multipart_yn+"'><input id='language_direction'  name='language_direction' type='hidden' value='"+language_direction+"'></form></BODY></HTML>";
				//	HTMLVal = "<html><BODY onKeyDown=\"lockKey()\"><form id=\"Dummy\" name=\"Dummy\" method=\"post\" action=\"../../eMP/jsp/BasicPatientSearchResult.jsp\"><input id=\"pat_id1\"  name=\"pat_id1\" type=\"hidden\" value=\""+pat_id1+"\"><input id=\"national_id_no1\"  name=\"national_id_no1\" type=\"hidden\" value=\""+national_id_no1+"\"><input id=\"alt_id1_no1\"  name=\"alt_id1_no1\" type=\"hidden\" value=\""+alt_id1_no1+"\"><input id=\"alt_id2_no1\"  name=\"alt_id2_no1\" type=\"hidden\" value=\""+alt_id2_no1+"\"><input id=\"alt_id3_no1\"  name=\"alt_id3_no1\" type=\"hidden\" value=\""+alt_id3_no1+"\"><input id=\"alt_id4_no1\"  name=\"alt_id4_no1\" type=\"hidden\" value=\""+alt_id4_no1+"\"><input id=\"First_Name1\"  name=\"First_Name1\" type=\"hidden\" value=\""+First_Name1+"\"><input id=\"Second_Name1\"  name=\"Second_Name1\" type=\"hidden\" value=\""+Second_Name1+"\"><input id=\"Third_Name1\"  name=\"Third_Name1\" type=\"hidden\" value=\""+Third_Name1+"\"><input id=\"Family_Name1\"  name=\"Family_Name1\" type=\"hidden\" value=\""+Family_Name1+"\"><input id=\"first_name_loc_lang1\"  name=\"first_name_loc_lang1\" type=\"hidden\" value=\""+first_name_loc_lang1+"\"><input id=\"second_name_loc_lang1\"  name=\"second_name_loc_lang1\" type=\"hidden\" value=\""+second_name_loc_lang1+"\"><input id=\"third_name_loc_lang1\"  name=\"third_name_loc_lang1\" type=\"hidden\" value=\""+third_name_loc_lang1+"\"><input id=\"family_name_loc_lang1\"  name=\"family_name_loc_lang1\" type=\"hidden\" value=\""+family_name_loc_lang1+"\"><input id=\"pr_resNo1\"  name=\"pr_resNo1\" type=\"hidden\" value=\""+pr_resNo1+"\"><input id=\"oth_no1\"  name=\"oth_no1\" type=\"hidden\" value=\""+oth_no1+"\"><input id=\"search_in\"  name=\"search_in\" type=\"hidden\" value=\""+search_in+"\"><input id=\"func_act\"  type=\"hidden\" name=\"func_act\" value=\""+func_act+"\" ><input id=\"act_yn\"  type=\"hidden\" name=\"act_yn\" value=\""+act_yn+"\" ><input id=\"function_id\"  type=\"hidden\" name=\"function_id\" value=\""+function_id+"\"><input id=\"order_by1\"  name=\"order_by1\" type=\"hidden\" value=\""+order_by1+"\"><input id=\"gender\"  name=\"gender\" type=\"hidden\" value=\""+gender+"\"><input id=\"Search_By\"  name=\"Search_By\" type=\"hidden\" value=\""+Search_By+"\"><input id=\"Search_By_Lang\"  name=\"Search_By_Lang\" type=\"hidden\" value=\""+Search_By_Lang+"\"><input id=\"pat_name_as_multipart_yn\"  name=\"pat_name_as_multipart_yn\" type=\"hidden\" value=\""+pat_name_as_multipart_yn+"\"><input id=\"language_direction\"  name=\"language_direction\" type=\"hidden\" value=\""+language_direction+"\"></form></BODY></HTML>";
					
					//Maheshwaran K added for MMS-DM-CRF-0208.1 - suspend_inactive_pat_yn
					HTMLVal = "<html><BODY onKeyDown=\"lockKey()\"><form id=\"Dummy\" name=\"Dummy\" method=\"post\" action=\"../../eMP/jsp/BasicPatientSearchResult.jsp\"><input id=\"pat_id1\"  name=\"pat_id1\" type=\"hidden\" value=\""+pat_id1+"\"><input id=\"national_id_no1\"  name=\"national_id_no1\" type=\"hidden\" value=\""+national_id_no1+"\"><input id=\"alt_id1_no1\"  name=\"alt_id1_no1\" type=\"hidden\" value=\""+alt_id1_no1+"\"><input id=\"alt_id2_no1\"  name=\"alt_id2_no1\" type=\"hidden\" value=\""+alt_id2_no1+"\"><input id=\"alt_id3_no1\"  name=\"alt_id3_no1\" type=\"hidden\" value=\""+alt_id3_no1+"\"><input id=\"alt_id4_no1\"  name=\"alt_id4_no1\" type=\"hidden\" value=\""+alt_id4_no1+"\"><input id=\"First_Name1\"  name=\"First_Name1\" type=\"hidden\" value=\""+First_Name1+"\"><input id=\"Second_Name1\"  name=\"Second_Name1\" type=\"hidden\" value=\""+Second_Name1+"\"><input id=\"Third_Name1\"  name=\"Third_Name1\" type=\"hidden\" value=\""+Third_Name1+"\"><input id=\"Family_Name1\"  name=\"Family_Name1\" type=\"hidden\" value=\""+Family_Name1+"\"><input id=\"first_name_loc_lang1\"  name=\"first_name_loc_lang1\" type=\"hidden\" value=\""+first_name_loc_lang1+"\"><input id=\"second_name_loc_lang1\"  name=\"second_name_loc_lang1\" type=\"hidden\" value=\""+second_name_loc_lang1+"\"><input id=\"third_name_loc_lang1\"  name=\"third_name_loc_lang1\" type=\"hidden\" value=\""+third_name_loc_lang1+"\"><input id=\"family_name_loc_lang1\"  name=\"family_name_loc_lang1\" type=\"hidden\" value=\""+family_name_loc_lang1+"\"><input id=\"pr_resNo1\"  name=\"pr_resNo1\" type=\"hidden\" value=\""+pr_resNo1+"\"><input id=\"oth_no1\"  name=\"oth_no1\" type=\"hidden\" value=\""+oth_no1+"\"><input id=\"search_in\"  name=\"search_in\" type=\"hidden\" value=\""+search_in+"\"><input id=\"func_act\"  type=\"hidden\" name=\"func_act\" value=\""+func_act+"\" ><input id=\"act_yn\"  type=\"hidden\" name=\"act_yn\" value=\""+act_yn+"\" ><input id=\"function_id\"  type=\"hidden\" name=\"function_id\" value=\""+function_id+"\"><input id=\"order_by1\"  name=\"order_by1\" type=\"hidden\" value=\""+order_by1+"\"><input id=\"gender\"  name=\"gender\" type=\"hidden\" value=\""+gender+"\"><input id=\"Search_By\"  name=\"Search_By\" type=\"hidden\" value=\""+Search_By+"\"><input id=\"Search_By_Lang\"  name=\"Search_By_Lang\" type=\"hidden\" value=\""+Search_By_Lang+"\"><input id=\"pat_name_as_multipart_yn\"  name=\"pat_name_as_multipart_yn\" type=\"hidden\" value=\""+pat_name_as_multipart_yn+"\"><input id=\"language_direction\"  name=\"language_direction\" type=\"hidden\" value=\""+language_direction+"\"><input id=\"alt_  name=\"alt_ id1_pat_sch_exact_yn\" type=\"hidden\" value=\""+alt_id1_pat_sch_exact_yn+"\"><input id=\"alt_id2_pat_sch_exact_yn\"  name=\"alt_id2_pat_sch_exact_yn\" type=\"hidden\" value=\""+alt_id2_pat_sch_exact_yn+"\"><input id=\"alt_id3_pat_sch_exact_yn\"  name=\"alt_id3_pat_sch_exact_yn\" type=\"hidden\" value=\""+alt_id3_pat_sch_exact_yn+"\"><input id=\"alt_id4_pat_sch_exact_yn\"  name=\"alt_id4_pat_sch_exact_yn\" type=\"hidden\" value=\""+alt_id4_pat_sch_exact_yn+"\"><input id=\"fam_name_ind\"  name=\"fam_name_ind\" type=\"hidden\" value=\""+document.getElementById("fam_name_ind").value+"\"> <input id=\"patient_id_search_by\"  name=\"patient_id_search_by\" type=\"hidden\" value=\""+document.getElementById("patient_id_search_by").value+"\">  <input id=\"ins_car_id\"  name=\"ins_car_id\" type=\"hidden\" value=\""+car_reader+"\"> <input id=\"suspend_inactive_pat_yn\"  name=\"suspend_inactive_pat_yn\" type=\"hidden\" value=\""+suspend_inactive_pat_yn+"\"><input id=\"dft_national_id\"  name=\"dft_national_id\" type=\"hidden\" value=\""+dft_national_id+"\"></form></BODY></HTML>";//Modified by Rameswar on 3rd July 2015 for MO-CRF-20099 [IN054280]//Modified by KAMATCHI S ON 28-AUG-2020 for MOHE-CRF-0016.1
					...
					parent.colurFrame.document.location.href = '../../eMP/jsp/patientsearchcolur.jsp';
	                    ...
	                    alert(getMessage("ANY_ONE_CRITERIA",'Common'));  
							if(parent.frames[3].document.forms[0].register){
								if(parent.frames[3].document.forms[0].register.disabled==false)
									parent.frames[3].document.forms[0].register.disabled=true;							
							}
	...
	if (document.forms[0].name=="Advnc_Patient_Search_Form"){  
		...
		var newBorn_sfx=Advnc_Patient_Search_Form.newborn_suffix;
		 ...
		 var isInsuranceCardReader = Advnc_Patient_Search_Form.isInsuranceCardReader.value;/* Added by KAMATCHI S ON 27-AUG-2020 */
		 
var fields=new Array();
//Maheshwaran K added abha_pat_id for GHL-CRF-0657.2 as 06-09-2923	
if(Advnc_Patient_Search_Form.ndhm_appl_YN.value=="Y")
	{
	fields = new Array( Advnc_Patient_Search_Form.Patient_Id,
	...
	Advnc_Patient_Search_Form.insurance_id,
	Advnc_Patient_Search_Form.abha_pat_id);/* Added by KAMATCHI S ON 27-AUG-2020 */	
	} //Ends
else {		
	fields = new Array( Advnc_Patient_Search_Form.Patient_Id,
	Advnc_Patient_Search_Form.Alt_Id1_No,
	...
	Advnc_Patient_Search_Form.EM_yn,
	Advnc_Patient_Search_Form.patient_series,
	Advnc_Patient_Search_Form.insurance_id);/* Added by KAMATCHI S ON 27-AUG-2020 */
	}
	...
	for(var i=0;i<fields.length;i++) {
		if (i==10 || i==15){
			...
			}else if (trimCheck(trimString(fields[i].value))){
				empty++;				 
			}
			
		}
	}
//	alert(Advnc_Patient_Search_Form.Search_By.value)
	/*if ( Advnc_Patient_Search_Form.Search_By.value != null && Advnc_Patient_Search_Form.Search_By != "" &&Advnc_Patient_Search_Form.Family_Name.value=="" ){
		empty=0;
	}*/
	...
	/*The below code is added for Performance Tuning-Mp_patient [IN:024738] on 12.11.2010 by Suresh M*/
	var Sex =Advnc_Patient_Search_Form.Sex.value;
	var checkSex = new Boolean(true);	
	if(empty == 1 && Sex == "A")
		checkSex = false;
	// Code Ends IN024738
	...
	if(empty != 0 && checkSex){
		...
		var dateFrom;
		var dateTo;		 
		  if( fields[10] &&  trimCheck(fields[10].value)) {
...
//			var function_id			= Advnc_Patient_Search_Form.cr_function_id.value;
			...
			var dft_national_id	= Advnc_Patient_Search_Form.dft_national_id.value;
			//Below Added by Rameswar on 3rd July 2015 for MO-CRF-20099 [IN054280]
			alt_id1_pat_sch_exact_yn=Advnc_Patient_Search_Form.alt_id1_pat_sch_exact_yn.value;
			alt_id2_pat_sch_exact_yn=Advnc_Patient_Search_Form.alt_id2_pat_sch_exact_yn.value;
			alt_id3_pat_sch_exact_yn=Advnc_Patient_Search_Form.alt_id3_pat_sch_exact_yn.value;
			alt_id4_pat_sch_exact_yn=Advnc_Patient_Search_Form.alt_id4_pat_sch_exact_yn.value;

				hiddenVals   += " <body onKeyDown='lockKey()'> <form name='tempform' id='tempform' method='post' action='../../eMP/jsp/PatientIDDisplay.jsp'> \n" ; 
				...
				hiddenVals   += " <input type='hidden' name='dft_national_id' id='dft_national_id' value=\""+dft_national_id+"\" > \n" ; ////Added by Maheshwaran K for AAKH-CRF-0168
...
//										hiddenVals   += " <input type='hidden' name='na_no' id='na_no' value=\""+na_no+"\" > \n" ; 
				...
				hiddenVals   += " <input type='hidden' name='suspend_inactive_pat_yn' id='suspend_inactive_pat_yn' value=\""+suspend_inactive_pat_yn+"\" > \n" ; //Maheshwaran K added for MMS-DM-CRF-0208.1 - suspend_inactive_pat_yn
				...
				{
					var AltId1=fields[1].value;
					AltId1=makeValidQueryString(AltId1);
					hiddenVals   += " <input type='hidden' name='Alt_Id1_No' id='Alt_Id1_No' value=\""+AltId1+"\" > \n" ; 
				}
				if( fields[2] && fields[2].value != null && fields[2].value != "")
				{
					fields[2].value=makeValidQueryString(fields[2].value);
				...
				{
					fields[3].value=makeValidQueryString(fields[3].value);
				...
				{
					fields[4].value=makeValidQueryString(fields[4].value);
					hiddenVals   += " <input type='hidden' name='MRN' id='MRN' value=\""+fields[4].value+"\" > \n" ; 
				}
				if( fields[5] && fields[5].value != null && fields[5].value != "")
				{
					var First_Name=fields[5].value;
					First_Name=makeValidQueryString(First_Name);
					hiddenVals   += " <input type='hidden' name='First_Name' id='First_Name' value=\""+First_Name+"\" > \n" ; 
				}
				if( fields[6] && fields[6].value != null && fields[6].value != "")
				{
					var Second_Name=fields[6].value;
					Second_Name=makeValidQueryString(Second_Name);
					hiddenVals   += " <input type='hidden' name='Second_Name' id='Second_Name' value=\""+Second_Name+"\" > \n" ; 
				}
				if( fields[7] && fields[7].value != null && fields[7].value != "")
				{
					var Third_Name=fields[7].value;
					Third_Name=makeValidQueryString(Third_Name);
					hiddenVals   += " <input type='hidden' name='Third_Name' id='Third_Name' value=\""+Third_Name+"\" > \n" ; 
				}
				if( fields[8] && fields[8].value != null && fields[8].value != "")
				{
					var Family_Name=fields[8].value;
					
					Family_Name=makeValidQueryString(Family_Name);
					hiddenVals   += " <input type='hidden' name='Family_Name' id='Family_Name' value=\""+Family_Name+"\" > \n" ;
				}
				if( Advnc_Patient_Search_Form.Search_By&& Advnc_Patient_Search_Form.Search_By.value!= null ){
				hiddenVals   += " <input type='hidden' name='Search_By' id='Search_By' value=\""+Advnc_Patient_Search_Form.Search_By.value+"\" > \n" ; 
				}
				hiddenVals   += " <input type='hidden' name='pat_name_as_multipart_yn' id='pat_name_as_multipart_yn' value=\""+document.forms[0].pat_name_as_multipart_yn_hd.value+"\" > \n" ; 
				...
				if (dob_field!=null && dob_field!="" && dateFrom!="" && dateTo!=""){
			...
			if(isInsuranceCardReader=="true")
			{
				if(fields[48] && fields[48].value != null && fields[48].value != "")
				{
					hiddenVals   +=	" <input type='hidden' name='ins_car_id' id='ins_car_id'  value=\""+car_reader+"\" > \n" ;//Added by KAMATCHI S for MOHE-CRF-0016.1 on 27-AUG-2020
				}
			}
			else
			{
				...
				{
					var addl_field1=fields[21].value;
					addl_field1=makeValidQueryString(addl_field1);
					hiddenVals   += " <input type='hidden' name='addl_field1' id='addl_field1' value=\""+addl_field1+"\" > \n" ; 
				}

				if(fields[22] && fields[22].value != null && fields[22].value != "")
				{
					var addl_field2=fields[22].value;
					addl_field2=makeValidQueryString(addl_field2);
					hiddenVals   += " <input type='hidden' name='addl_field2' id='addl_field2' value=\""+addl_field2+"\" > \n" ; 
				}
				if(fields[23] && fields[23].value != null && fields[23].value != "")
				{
					var addl_field3=fields[23].value;
					addl_field3=makeValidQueryString(addl_field3);
					hiddenVals   += " <input type='hidden' name='addl_field3' id='addl_field3' value=\""+addl_field3+"\" > \n" ; 
				}

				if(fields[24] && fields[24].value != null && fields[24].value != "")
				{
					var addl_field4=fields[24].value;
					addl_field4=makeValidQueryString(addl_field4);
					hiddenVals   += " <input type='hidden' name='addl_field4' id='addl_field4' value=\""+addl_field4+"\" > \n" ; 
				}
				if(fields[25] && fields[25].value != null && fields[25].value != "")
				{
					var addl_field5=fields[25].value;
					addl_field5=makeValidQueryString(addl_field5);
					hiddenVals   += " <input type='hidden' name='addl_field5' id='addl_field5' value=\""+addl_field5+"\" > \n" ; 
				}
				...
				{
					var mother_maiden_name=fields[34].value;
					mother_maiden_name=makeValidQueryString(mother_maiden_name);
					hiddenVals   += " <input type='hidden' name='mother_maiden_name' id='mother_maiden_name' value=\""+mother_maiden_name+"\" > \n" ; 
				}
				if(fields[35] && fields[35].value != null && fields[35].value != "")
				{
					var first_name_loc_lang = fields[35].value;
					first_name_loc_lang=makeValidQueryString(first_name_loc_lang);
					hiddenVals   += " <input type='hidden' name='first_name_loc_lang' id='first_name_loc_lang' value=\""+first_name_loc_lang+"\" > \n" ; 
				}

				if(fields[36] && fields[36].value != null && fields[36].value != "")
				{
					var second_name_loc_lang=fields[36].value;
					second_name_loc_lang=makeValidQueryString(second_name_loc_lang);
					hiddenVals   += " <input type='hidden' name='second_name_loc_lang' id='second_name_loc_lang' value=\""+second_name_loc_lang+"\" > \n" ; 
				}
				if(fields[37] && fields[37].value != null && fields[37].value != "")
				{
					var third_name_loc_lang=fields[37].value;
					third_name_loc_lang=makeValidQueryString(third_name_loc_lang);
					hiddenVals   += " <input type='hidden' name='third_name_loc_lang' id='third_name_loc_lang' value=\""+third_name_loc_lang+"\" > \n" ; 
				}
				if(fields[38] && fields[38].value != null && fields[38].value != "")
				{
					var family_name_loc_lang=fields[38].value;
					family_name_loc_lang=makeValidQueryString(family_name_loc_lang);
					hiddenVals   += " <input type='hidden' name='family_name_loc_lang' id='family_name_loc_lang' value=\""+family_name_loc_lang+"\" > \n" ; 
				}

				if(Advnc_Patient_Search_Form.Search_By_Lang && Advnc_Patient_Search_Form.Search_By_Lang.value!=null){
				hiddenVals   += " <input type='hidden' name='Search_By_Lang' id='Search_By_Lang' value=\""+Advnc_Patient_Search_Form.Search_By_Lang.value+"\" > \n" ; 
				}
				...
				if(Advnc_Patient_Search_Form.ndhm_appl_YN.value=="Y"){
				if(fields[49] && fields[49].value != null && fields[49].value != "")
				hiddenVals   += " <input type='hidden' name='abha_pat_id' id='abha_pat_id' value=\""+fields[49].value+"\" > \n" ; 
				hiddenVals   += " <input type='hidden' name='ndhm_appl_YN' id='ndhm_appl_YN' value=\""+Advnc_Patient_Search_Form.ndhm_appl_YN.value+"\" > \n" ; 
				}
				//Ends
				...
				/*Below Added by Rameswar on 3rd July 2015 for MO-CRF-20099 [IN054280]*/
				hiddenVals   += " <input type='hidden' name='alt_id1_pat_sch_exact_yn' id='alt_id1_pat_sch_exact_yn' value=\""+alt_id1_pat_sch_exact_yn+"\" > \n" ; 
				hiddenVals   += " <input type='hidden' name='alt_id2_pat_sch_exact_yn' id='alt_id2_pat_sch_exact_yn' value=\""+alt_id2_pat_sch_exact_yn+"\" > \n" ;
				hiddenVals   += " <input type='hidden' name='alt_id3_pat_sch_exact_yn' id='alt_id3_pat_sch_exact_yn' value=\""+alt_id3_pat_sch_exact_yn+"\" > \n" ;
				hiddenVals   += " <input type='hidden' name='alt_id4_pat_sch_exact_yn' id='alt_id4_pat_sch_exact_yn' value=\""+alt_id4_pat_sch_exact_yn+"\" > \n" ;
				
				hiddenVals   += " <input type='hidden' name='fam_name_ind' id='fam_name_ind' value=\""+document.getElementById('fam_name_ind').value+"\" > \n" ;
				 /*Added by Rameswar on  19-04-2016 for HSA-CRF-0299*/
				hiddenVals   += " <input type='hidden' name='patient_id_search_by' id='patient_id_search_by' value=\""+document.getElementById('patient_id_search_by').value+"\" > \n" ;
				
				 /*Added by Ashwin K  for AAHK-CRF-0150*/ /*Or condition txtSmart_fn_name Added by Santhosh  for TH-KW-CRF-0019.1*/
				 if(document.forms[0].EmiratesID_edit || document.forms[0].txtSmart_fn_name.value == '05')
				{
				hiddenVals   += " <input type='hidden' name='contact_search_by' id='contact_search_by' value=\""+document.getElementById('contact_search_by').value+"\" > \n" ;
				}
				...
				if (document.forms[0].dobCal){
					document.forms[0].dobCal.disabled = true;
				}
...
//				parent.frames[0].location.href='../../eCommon/html/process.html';
	//						parent.commontoolbar.location.href='../jsp/PatientSearchToolBar.jsp'						
	//						parent.Pat_Search_Toolbar_Frame.defaultSetting();
	//						parent.commontoolbar.location.href='../jsp/PatientSearchToolBar.jsp'						

				morelessHidden();
				//parent.patsearch.document.getElementById("pat_search").rows="20,25,330,20,*"; cmt by vijayan
				//in advanced search
				...
				parent.document.getElementById("Pat_Search_Criteria_Frame").style.height="40.5vh";
				parent.document.getElementById("Pat_Search_Criteria_Frame").scrolling="yes";
				parent.document.getElementById("Pat_Search_Toolbar_Frame").style.height="4vh";
				parent.document.getElementById("Pat_Results_Frame").style.height="38vh";
		...
		else 
		{
			...
			alert(getMessage("ANY_ONE_CRITERIA",'Common'));
				...
				alert(getMessage("SPECIFY_ADD_CRITERIA",'MP'));
...
//	alert(parent.Pat_Search_Criteria_Frame.document.forms[0].name)
	...
	//parent.patsearch.document.getElementById("pat_search").rows="20,25,50,20,*"; cmt by vijayan
	    parent.document.getElementById("commontoolbar").style.height="4vh";
		parent.document.getElementById("Pat_Search_Tabs_Frame").style.height="3vh";
		parent.document.getElementById("Pat_Search_Criteria_Frame").height > 50 ? parent.document.getElementById("Pat_Search_Criteria_Frame").style.height="85vh" : "";
		//parent.document.getElementById("Pat_Search_Criteria_Frame").style.height="85vh";
		parent.document.getElementById("Pat_Search_Toolbar_Frame").style.height="4vh";
		parent.document.getElementById("Pat_Search_Criteria_Frame").height > 50 ? parent.document.getElementById("Pat_Results_Frame").style.height="28vh" : parent.document.getElementById("Pat_Results_Frame").style.height="38vh";
		// parent.document.getElementById("Pat_Results_Frame").style.height="28vh";
	...
	parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.morelessexpand.value="N";
		...
		parent.document.getElementById("commontoolbar").style.height="4vh";
		parent.document.getElementById("Pat_Search_Tabs_Frame").style.height="3vh";
		parent.document.getElementById("Pat_Search_Criteria_Frame").height > 50 ? parent.document.getElementById("Pat_Search_Criteria_Frame").style.height="72vh" : "";
		//parent.document.getElementById("Pat_Search_Criteria_Frame").style.height="72vh";
		parent.document.getElementById("Pat_Search_Toolbar_Frame").style.height="4vh";
		parent.document.getElementById("Pat_Search_Criteria_Frame").height > 50 ? parent.document.getElementById("Pat_Results_Frame").style.height="28vh" : parent.document.getElementById("Pat_Results_Frame").style.height="38vh";
		//parent.document.getElementById("Pat_Results_Frame").style.height="28vh";
		morelessHidden();
...
parent.Pat_Search_Criteria_Frame.document.getElementById("rowExpansion").style.display="contents";
}
...
//				parent.Pat_Results_Frame.Pat_Search_Criteria_Frame.location.href="../../eCommon/html/blank.html";
				...
				parent.Pat_Search_Toolbar_Frame.document.forms[0].prev.style.visibility = 'hidden';
                parent.Pat_Search_Toolbar_Frame.document.forms[0].next.style.visibility = 'hidden';
				if (parent.Pat_Results_Frame.document.forms[0])
				{
					...
					var replace_url1     =   "%";
					var whereClause=encodeURIComponent(parent.Pat_Results_Frame.document.forms[0].final_whereClause.value);
					...
					var na_no = "";
					if(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.ndhm_appl_YN.value!='Y'){ //Added by Lakshmanan P for GHL-CRF-0657.2
				  ...
				  var Contact_No=parent.Pat_Results_Frame.document.forms[0].Contact_No.value; 
...
//						parent.Pat_Results_Frame.PatIdResult.document.forms[0].final_whereClause.value = whereClause;
						...
						parent.Pat_Results_Frame.document.forms[0].action = "../../eMP/jsp/PatientIDDisplay.jsp?PagewhereClause="+whereClause+"&Pageflag=Y&Contact_No="+Contact_No;
...
async function getRace(obj){
	if(obj.value!=""){
		...
		if (retVal=='' || retVal==null){
			...
			desc.value=retVal[1];
			code.value=retVal[0];*/
			ethnic_group.value = arr[0]; 
		    ethnic_group_desc.value = arr[1]; 
			desc.value=arr[1];
			code.value=arr[0];
		}
	}else{
...
function get_org_sub_org_blur(organization,sub_organization,obj){
	if(organization.value!=""){
		get_org_sub_org(organization,sub_organization,obj);
	}else{
		parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.org_id.value = '';
...
async function get_org_sub_org(organization,sub_organization,obj){
	...
	if(!(retVal== null && retVal== "" )){
		...
		HTMLVal = "<html><BODY onKeyDown='lockKey()'><form name='form1' id='form1' method='post' action='../../eMP/jsp/PatCatOrgMbspValidation.jsp'><input type='hidden' name='organization' id='organization' value='"+org_id+"'><input type='hidden' name='param' id='param' value='PATSEARCH'></form></BODY></HTML>";
...
function passValues(func_act){  
	...
	desc='../../eMP/jsp/PaintEmergRegn.jsp?';
		...
		//desc="../../eMP/jsp/PatRegLoad.jsp?func_act="+func_act+"&";  //Added for this ML-MOH-SCF-0719                            
...
async function callRegVisitModal(){
	...
	var isAlternateAddressAppl = "";
	var isAddressLengthIncAppl = "";
	if(parent.Pat_Search_Criteria_Frame.document.Basic_Patient_Search_Form){
		isAlternateAddressAppl = parent.Pat_Search_Criteria_Frame.document.Basic_Patient_Search_Form.isAlternateAddressAppl.value;
		isAddressLengthIncAppl = parent.Pat_Search_Criteria_Frame.document.Basic_Patient_Search_Form.isAddressLengthIncAppl.value;
	}else if(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form){
		isAlternateAddressAppl = parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.isAlternateAddressAppl.value;
		isAddressLengthIncAppl = parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.isAddressLengthIncAppl.value;
	}
	...
	var OldFileNo = '';
	var FamilyNo = '';
	var first_name_loc_lang = '';
	var second_name_loc_lang = '';
	var third_name_loc_lang = '';
	var family_name_loc_lang = '';	
var a_race_code='';//Added By Dharma on 20th Aug 2020 against ML-MMOH-SCF-1384
	...
	if (parent.frames[2].document.forms[0].apply_oth_name)
		if (parent.frames[2].document.forms[0].apply_oth_name.checked)
			...
			apply_oth_name="N";
	if(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form){//advanced tab
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].First_Name){
			FirstName=parent.Pat_Search_Criteria_Frame.document.forms[0].First_Name.value;
		}   
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].Second_Name){
			SecondName=parent.Pat_Search_Criteria_Frame.document.forms[0].Second_Name.value;   
		}                              
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].Third_Name){
			ThirdName=parent.Pat_Search_Criteria_Frame.document.forms[0].Third_Name.value; 		
		 }
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].Family_Name) {
			 FamilyName=parent.Pat_Search_Criteria_Frame.document.forms[0].Family_Name.value;  
			
		 }
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id1_No){
			  AltIdNo=parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id1_No.value; 
			
		 }
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id2_No){
			  AltId2No=parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id2_No.value; 
			
		 }
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id3_No){
			  AltId3No=parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id3_No.value; 
			
		 }
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id4_No){
			  AltId4No=parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id4_No.value; 
			
		 }

		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].National_Id_No) {
			   NationalIdNo=parent.Pat_Search_Criteria_Frame.document.forms[0].National_Id_No.value;   
			
		 }
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].MRN){
			MRN=parent.Pat_Search_Criteria_Frame.document.forms[0].MRN.value;  
		 }
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].Dob){
			Dob=parent.Pat_Search_Criteria_Frame.document.forms[0].Dob.value;  
			
		 }
		  if(parent.Pat_Search_Criteria_Frame.document.forms[0].Sex){
			Sex=parent.Pat_Search_Criteria_Frame.document.forms[0].Sex.value;  
		 }
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].Area){
			Area =parent.Pat_Search_Criteria_Frame.document.forms[0].Area.value;    
		 }
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].OldFileNo){
			OldFileNo=parent.Pat_Search_Criteria_Frame.document.forms[0].OldFileNo.value;  
		 }
		 if(parent.Pat_Search_Criteria_Frame.document.forms[0].Family_No){
			FamilyNo=parent.Pat_Search_Criteria_Frame.document.forms[0].Family_No.value;   
		 }
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].first_name_loc_lang){
			first_name_loc_lang=parent.Pat_Search_Criteria_Frame.document.forms[0].first_name_loc_lang.value;
		}   
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].second_name_loc_lang){
			second_name_loc_lang=parent.Pat_Search_Criteria_Frame.document.forms[0].second_name_loc_lang.value;   							
		}                              
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].third_name_loc_lang){
			third_name_loc_lang=parent.Pat_Search_Criteria_Frame.document.forms[0].third_name_loc_lang.value; 							
		}
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].family_name_loc_lang){
			family_name_loc_lang=parent.Pat_Search_Criteria_Frame.document.forms[0].family_name_loc_lang.value; 							
		}
		//Added By Dharma on 20th Aug 2020 against ML-MMOH-SCF-1384
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].ethnic_group){
			a_race_code=parent.Pat_Search_Criteria_Frame.document.forms[0].ethnic_group.value; 							
		}
		
	}else{//basic tab
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].First_Name1){

				FirstName=parent.Pat_Search_Criteria_Frame.document.forms[0].First_Name1.value;
				
		}   
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].Second_Name1){
			SecondName=parent.Pat_Search_Criteria_Frame.document.forms[0].Second_Name1.value;   
		}                              
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].Third_Name1){
			ThirdName=parent.Pat_Search_Criteria_Frame.document.forms[0].Third_Name1.value; 		
		}
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].Family_Name1) {
			FamilyName=parent.Pat_Search_Criteria_Frame.document.forms[0].Family_Name1.value;  					
		}
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id1_No1){
			AltIdNo=parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id1_No1.value; 					
		}
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id2_No1){
			AltId2No=parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id2_No1.value; 					
		}
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id3_No1){
			AltId3No=parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id3_No1.value; 					
		}
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id4_No1){
			AltId4No=parent.Pat_Search_Criteria_Frame.document.forms[0].Alt_Id4_No1.value; 					
		}

		if(parent.Pat_Search_Criteria_Frame.document.forms[0].National_Id_No1) {
			NationalIdNo=parent.Pat_Search_Criteria_Frame.document.forms[0].National_Id_No1.value;					
		}
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].first_name_loc_lang1){
			first_name_loc_lang=parent.Pat_Search_Criteria_Frame.document.forms[0].first_name_loc_lang1.value;
		}   
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].second_name_loc_lang1){
			second_name_loc_lang=parent.Pat_Search_Criteria_Frame.document.forms[0].second_name_loc_lang1.value;   							
		}                              
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].third_name_loc_lang1){
			third_name_loc_lang=parent.Pat_Search_Criteria_Frame.document.forms[0].third_name_loc_lang1.value; 							
		}
		if(parent.Pat_Search_Criteria_Frame.document.forms[0].family_name_loc_lang1){
			family_name_loc_lang=parent.Pat_Search_Criteria_Frame.document.forms[0].family_name_loc_lang1.value; 							
		}			
	}
	
	if(func_act=="DuplicateRegistration"){
		retVal = await top.window.showModalDialog("../../eMP/jsp/PatientRegistrationMain.jsp?apply_oth_name="+apply_oth_name+"&module_id=MP&function_id="+function_id+"&function_type=F&access=YYYNN&func_act="+func_act+"&First_Name="+encodeURIComponent(FirstName)+"&Second_Name="+encodeURIComponent(SecondName)+"&Third_Name="+encodeURIComponent(ThirdName)+"&Family_Name="+encodeURIComponent(FamilyName)+"&Alt_Id_No="+escape(AltIdNo)+"&National_Id_No="+escape(NationalIdNo)+"&MRN="+escape(MRN)+"&Dob="+Dob+"&Sex="+Sex+"&Area="+escape(Area)+"&dr_function_id="+dr_function_id+"&Family_No="+escape(FamilyNo)+"&OldFileNo="+escape(OldFileNo)+"&a_first_name_loc_lang="+encodeURIComponent(first_name_loc_lang)+"&a_second_name_loc_lang="+encodeURIComponent(second_name_loc_lang)+"&a_third_name_loc_lang="+encodeURIComponent(third_name_loc_lang)+"&a_family_name_loc_lang="+encodeURIComponent(family_name_loc_lang)+"&race_code="+a_race_code,arguments,features);
		//retVal = window.showModalDialog("../../eMP/jsp/PatientRegistrationMain.jsp?apply_oth_name="+apply_oth_name+"&module_id=MP&function_id="+function_id+"&function_type=F&access=YYYNN&func_act="+func_act+"&First="+encodeURIComponent(FirstName)+"&Second="+encodeURIComponent(SecondName)+"&Third="+encodeURIComponent(ThirdName)+"&Family="+encodeURIComponent(FamilyName)+"&Alt_Id_No="+escape(AltIdNo)+"&National_Id_No="+escape(NationalIdNo)+"&MRN="+escape(MRN)+"&Dob="+Dob+"&Sex="+Sex+"&Area="+escape(Area)+"&dr_function_id="+dr_function_id+"&Family_No="+escape(FamilyNo)+"&OldFileNo="+escape(OldFileNo)+"&a_first_loc_lang="+encodeURIComponent(first_name_loc_lang)+"&a_second_loc_lang="+encodeURIComponent(second_name_loc_lang)+"&a_third_loc_lang="+encodeURIComponent(third_name_loc_lang)+"&a_family_loc_lang="+encodeURIComponent(family_name_loc_lang),arguments,features);
	}else{

		//var url="../../eMP/jsp/PatientRegistrationMain.jsp?apply_oth_name="+apply_oth_name+"&module_id=MP&function_id="+function_id+"&function_type=F&access=YYYNN&func_act=Visitreg&First_Name="+encodeURIComponent(FirstName)+"&Second_Name="+encodeURIComponent(SecondName)+"&Third_Name="+encodeURIComponent(ThirdName)+"&Family_Name="+encodeURIComponent(FamilyName)+"&Alt_Id_No="+escape(AltIdNo)+"&Alt_Id2_No="+escape(AltId2No)+"&Alt_Id3_No="+escape(AltId3No)+"&Alt_Id4_No="+escape(AltId4No)+"&National_Id_No="+escape(NationalIdNo)+"&MRN="+escape(MRN)+"&Dob="+Dob+"&Sex="+Sex+"&Area="+escape(Area)+"&Family_No="+escape(FamilyNo)+"&OldFileNo="+escape(OldFileNo)+"&a_first_name_loc_lang="+encodeURIComponent(first_name_loc_lang)+"&a_second_name_loc_lang="+encodeURIComponent(second_name_loc_lang)+"&a_third_name_loc_lang="+encodeURIComponent(third_name_loc_lang)+"&a_family_name_loc_lang="+encodeURIComponent(family_name_loc_lang);
		var url="../../eMP/jsp/PatientRegistrationMain.jsp?apply_oth_name="+apply_oth_name+"&module_id=MP&function_id="+function_id+"&function_type=F&access=YYYNN&func_act=Visitreg&Alt_Id_No="+escape(AltIdNo)+"&Alt_Id2_No="+escape(AltId2No)+"&Alt_Id3_No="+escape(AltId3No)+"&Alt_Id4_No="+escape(AltId4No)+"&National_Id_No="+escape(NationalIdNo)+"&MRN="+escape(MRN)+"&Dob="+Dob+"&Sex="+Sex+"&Area="+escape(Area)+"&Family_No="+escape(FamilyNo)+"&OldFileNo="+escape(OldFileNo)+"&a_first_name_loc_lang="+encodeURIComponent(first_name_loc_lang)+"&a_second_name_loc_lang="+encodeURIComponent(second_name_loc_lang)+"&a_third_name_loc_lang="+encodeURIComponent(third_name_loc_lang)+"&a_family_name_loc_lang="+encodeURIComponent(family_name_loc_lang)+"&First_Name="+encodeURIComponent(FirstName)+"&Second_Name="+encodeURIComponent(SecondName)+"&Third_Name="+encodeURIComponent(ThirdName)+"&Family_Name="+encodeURIComponent(FamilyName)+"&race_code="+a_race_code;
		//var url="../../eMP/jsp/PatientRegistrationMain.jsp?apply_oth_name="+apply_oth_name+"&module_id=MP&function_id="+function_id+"&function_type=F&access=YYYNN&func_act=Visitreg&First="+encodeURIComponent(FirstName)+"&Second="+encodeURIComponent(SecondName)+"&Third="+encodeURIComponent(ThirdName)+"&Family="+encodeURIComponent(FamilyName)+"&Alt_Id_No="+escape(AltIdNo)+"&Alt_Id2_No="+escape(AltId2No)+"&Alt_Id3_No="+escape(AltId3No)+"&Alt_Id4_No="+escape(AltId4No)+"&National_Id_No="+escape(NationalIdNo)+"&MRN="+escape(MRN)+"&Dob="+Dob+"&Sex="+Sex+"&Area="+escape(Area)+"&Family_No="+escape(FamilyNo)+"&OldFileNo="+escape(OldFileNo)+"&a_first_loc_lang="+encodeURIComponent(first_name_loc_lang)+"&a_second_loc_lang="+encodeURIComponent(second_name_loc_lang)+"&a_third_loc_lang="+encodeURIComponent(third_name_loc_lang)+"&a_family_loc_lang="+encodeURIComponent(family_name_loc_lang);
...
var formName	=parent.Pat_Search_Criteria_Frame.document.forms[0]
var First_Name;
var Second_Name;
var Third_Name;
var Family_Name;
...
var a_race_code;//Added By Dharma on 20th Aug 2020 against ML-MMOH-SCF-1384
	...
	if (parent.frames[2].document.forms[0].apply_oth_name)
		if (parent.frames[2].document.forms[0].apply_oth_name.checked)
			...
			apply_oth_name="N"; 
		if(formName.name=="Advnc_Patient_Search_Form"){
			...
			second_name_loc_lang="second_name_loc_lang";
			third_name_loc_lang="third_name_loc_lang";
			family_name_loc_lang="family_name_loc_lang";
			a_alt_id1_no="Alt_Id_No";
			a_alt_id2_no="Alt_Id2_No";
			a_alt_id3_no="Alt_Id3_No";
			a_alt_id4_no="Alt_Id4_No";
			a_race_code="ethnic_group";//Added By Dharma on 20th Aug 2020 against ML-MMOH-SCF-1384
		}else if(formName.name=="Basic_Patient_Search_Form"){
			First_Name="First_Name1";
			Second_Name="Second_Name1";
			Third_Name="Third_Name1";
			Family_Name="Family_Name1";
			Alt_Id1_No="Alt_Id1_No1";
			National_Id_No="National_Id_No1";
			Dob="Dob1";
			Sex="Sex1";
			Family_No="Family_No1";
			first_name_loc_lang="first_name_loc_lang1";
			second_name_loc_lang="second_name_loc_lang1";
			third_name_loc_lang="third_name_loc_lang1";
			family_name_loc_lang="family_name_loc_lang1";
			a_alt_id1_no="Alt_Id_No1";
			a_alt_id2_no="Alt_Id2_No1";
			a_alt_id3_no="Alt_Id3_No1";
			a_alt_id4_no="Alt_Id4_No1";
			a_race_code="ethnic_group";//Added By Dharma on 20th Aug 2020 against ML-MMOH-SCF-1384


		}

	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+First_Name+"")){
		var FirstName=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+First_Name+".value");
	}   
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Second_Name+"")){
		var SecondName=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Second_Name+".value");  							
	}                              
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Third_Name+"")){
		var ThirdName=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Third_Name+".value");				
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Family_Name+"")){
		var FamilyName=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Family_Name+".value");
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Alt_Id1_No+"")){
		var AltIdNo=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Alt_Id1_No+".value");					
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+National_Id_No+"")){
		var NationalIdNo=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+National_Id_No+".value");   								
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Dob+"")){
		var Dob=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Dob+".value");
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Sex+"")){
		var Sex=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Sex+".value");
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Family_No+"")){
		var FamilyNo=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+Family_No+".value");
	}

	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+first_name_loc_lang+"")){
		var first_name_loc_lang=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+first_name_loc_lang+".value");
	}   
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+second_name_loc_lang+"")){
		var second_name_loc_lang=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+second_name_loc_lang+".value");   							
	}                              
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+third_name_loc_lang+"")){
		//var third_name_loc_lang=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+third_name_loc_lang+".value");						
		var third_name_loc_lang=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+third_name_loc_lang+".value");		
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+family_name_loc_lang+"")){
		var family_name_loc_lang=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+family_name_loc_lang+".value");				
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_alt_id1_no+"")){
		var AltIdNo=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_alt_id1_no+".value");				
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_alt_id2_no+"")){
		var AltId2No=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_alt_id2_no+".value");				
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_alt_id3_no+"")){
		var AltId3No=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_alt_id3_no+".value");				
	}
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_alt_id4_no+"")){
		var AltId4No=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_alt_id4_no+".value");				
	}
	//Added By Dharma on 20th Aug 2020 against ML-MMOH-SCF-1384
	if(eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_race_code+"")){
		var race_code=eval("parent.Pat_Search_Criteria_Frame.document.forms[0]."+a_race_code+".value");				
	}
	

	var flag="Y";	
	
	var url="../../eMP/jsp/EmergRegn.jsp?emerg_reg="+flag+"&apply_oth_name="+apply_oth_name+"&module_id=MP&function_id=EM_PAT_REG&function_name=Emergency%20Patient&function_type=F&access=YYYNN&func_act=Visitreg&Alt_Id_No="+escape(AltIdNo)+"&National_Id_No="+escape(NationalIdNo)+"&Dob="+Dob+"&Sex="+Sex+"&Family_No="+escape(FamilyNo)+"&a_first_name_loc_lang="+encodeURIComponent(first_name_loc_lang)+"&a_second_name_loc_lang="+encodeURIComponent(second_name_loc_lang)+"&a_third_name_loc_lang="+encodeURIComponent(third_name_loc_lang)+"&a_family_name_loc_lang="+encodeURIComponent(family_name_loc_lang)+"&a_alt_id1_no="+encodeURIComponent(AltIdNo)+"&a_alt_id2_no="+encodeURIComponent(AltId2No)+"&a_alt_id3_no="+encodeURIComponent(AltId3No)+"&a_alt_id4_no="+encodeURIComponent(AltId4No)+"&First_Name="+encodeURIComponent(FirstName)+"&Second_Name="+encodeURIComponent(SecondName)+"&Third_Name="+encodeURIComponent(ThirdName)+"&Family_Name="+encodeURIComponent(FamilyName)+"&race_code="+race_code;
...
function ChangeTabs(TabName){
	...
	var suspend_inactive_pat_yn			= document.forms[0].suspend_inactive_pat_yn.value;//Maheshwaran K added for MMS-DM-CRF-0208.1 - suspend_inactive_pat_yn
	
	//Added for this CRF HSA-CRF-0289
	var alterIdSearch= document.forms[0].alterIdSearch.value;
	var isAlternateId= document.forms[0].isAlternateId.value;
	var alternate_no= document.forms[0].alternate_no.value;


	var smart_contact_no = document.forms[0].smart_contact_no.value;//Added by Ashwin K for AAKH-CRF-0150

		if (TabName=='BasicTab'){
			
			parent.Pat_Search_Tabs_Frame.document.getElementById("tab_id_clicked").value = "BasicTab";

			//parent.patsearch.document.getElementById("pat_search").rows="20,25,245,20,*";  cmt by vijayan for ieToEdge testing
				parent.document.getElementById("commontoolbar").style.height="4vh";
				parent.document.getElementById("Pat_Search_Tabs_Frame").style.height="3vh";
			...
			//Maheshwaran K added for MMS-DM-CRF-0208.1 - suspend_inactive_pat_yn
			parent.Pat_Search_Criteria_Frame.location.href='../../eMP/jsp/BasicPatientSearchCriteria.jsp?suspend_inactive_pat_yn='+suspend_inactive_pat_yn+"&func_act="+func_act+"&jsp_name="+jsp_name+"&window_styl="+window_styl+"&close_yn="+close_yn+"&win_height="+win_height+"&win_width="+win_width+"&win_top="+win_top+"&act_yn="+act_yn+"&srr="+srr+"&register_button_yn="+register_button_yn+"&default_gender="+default_gender+"&enable_gender_yn="+enable_gender_yn+"&dr_function_id="+dr_function_id+"&func_idpassed="+func_idpassed+"&alterIdSearch="+alterIdSearch+"&isAlternateId="+isAlternateId+"&alternate_no="+alternate_no;
		...
		if(parent.Pat_Search_Toolbar_Frame.document.getElementById('disprec').style.visibility=='visible')
		  parent.Pat_Search_Toolbar_Frame.document.getElementById('disprec').style.visibility = 'hidden'
		if(parent.Pat_Search_Toolbar_Frame.document.getElementById('display').style.visibility=='visible')
		  parent.Pat_Search_Toolbar_Frame.document.getElementById('display').style.visibility = 'hidden'
		if(parent.Pat_Search_Toolbar_Frame.document.getElementById('next').style.visibility=='visible')
		  parent.Pat_Search_Toolbar_Frame.document.getElementById('next').style.visibility = 'hidden'
		if(parent.Pat_Search_Toolbar_Frame.document.getElementById('prev').style.visibility=='visible')
		  parent.Pat_Search_Toolbar_Frame.document.getElementById('prev').style.visibility = 'hidden'
		  
	
		parent.Pat_Results_Frame.location.href="../../eCommon/html/blank.html";
		}
		 if (TabName=="AdvanceTab"){
			 parent.Pat_Search_Tabs_Frame.document.getElementById("tab_id_clicked").value = "AdvanceTab";
		//parent.patsearch.document.getElementById("pat_search").rows="20,25,330,20,*";
				parent.document.getElementById("commontoolbar").style.height="4vh";
				parent.document.getElementById("Pat_Search_Tabs_Frame").style.height="3vh";
				parent.document.getElementById("Pat_Search_Criteria_Frame").style.height="70vh";
				parent.document.getElementById("Pat_Search_Criteria_Frame").scrolling="auto";
				parent.document.getElementById("Pat_Search_Toolbar_Frame").style.height="4vh";
				parent.document.getElementById("Pat_Results_Frame").style.height="30vh";
	//	parent.Pat_Search_Toolbar_Frame.defaultSetting();

		//Added smart_contact_no by Ashwin K for AAKH-CRF-0150
		//Maheshwaran K added for MMS-DM-CRF-0208.1 - suspend_inactive_pat_yn
		parent.Pat_Search_Criteria_Frame.location.href='../../eMP/jsp/PatientSearchCriteria.jsp?suspend_inactive_pat_yn='+suspend_inactive_pat_yn+"&func_act="+func_act+"&jsp_name="+jsp_name+"&window_styl="+window_styl+"&close_yn="+close_yn+"&win_height="+win_height+"&win_width="+win_width+"&win_top="+win_top+"&act_yn="+act_yn+"&srr="+srr+"&register_button_yn="+register_button_yn+"&default_gender="+default_gender+"&enable_gender_yn="+enable_gender_yn+"&dr_function_id="+dr_function_id+"&func_idpassed="+func_idpassed+"&patient_class="+patient_class+"&alterIdSearch="+alterIdSearch+"&isAlternateId="+isAlternateId+"&alternate_no="+alternate_no+"&smart_contact_no="+smart_contact_no;
...
function MoveFocus(num) {
	...
	if( trimCheck(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.Alt_Id1_No.value)==false) parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.National_Id_No.focus();
		...
		if( trimCheck(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.Contact_No.value)==false ) {
			var modeSelect = parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.Mode;
			if (modeSelect.options.length > 0) {
				modeSelect.options[0].selected = true;
			}
			//parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.Mode.options[0].selected = true;
			...
			//above line commented and below line added for this incident [45682] 
			 parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.Mode.disabled=false;			
			 parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.Mode.value=parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.Mode.value;
...
function MoveFocusSimple(num) 
{
	if(num == 1) {
		...
		if( trimCheck(parent.Pat_Search_Criteria_Frame.document.Basic_Patient_Search_Form.Contact_No1.value)==false ) {
			parent.Pat_Search_Criteria_Frame.document.Basic_Patient_Search_Form.Mode.options[0].selected = true;
...
/******Functions For Display ToolTip ***********/
	...
	async function displayToolTip(patient_id){
	var patient_id = unescape(patient_id);
 ...
 /*   if (func=="EMERG" || func=="RPDRG")
    ...
    {*/
        if (func=="NEWBORN_REG")
        {
        	...
        	parent.Pat_Results_Frame.checkExpiry(patient_id, '','',"NEWBORN_REG");
        }
        else
        {
        	//parent.parent.Pat_Results_Frame.checkExpiry(patient_id,'','','');
        	parent.Pat_Results_Frame.checkExpiry(patient_id,'','','');
       	}
...
async function callMenuFunctions(s,patientid){    
	if (s=="RegisterNewBorn")
	{
		parent.Pat_Results_Frame.checkExpiry(patientid, '','',"NEWBORN_REG",s);
	}			
	else if(s=="ChangeDemographics")
    {
        parent.Pat_Results_Frame.checkExpiry(patientid,'','','',s);
    }
    else
    {
        await callMenu(s,patientid);
    }
}
   ...
   async function showChangeDemographics(patientid){
	...
	function EnableSearchBy(obj){
		var formName	=	document.forms[0].name
			if(formName=="Basic_Patient_Search_Form"){
				if(obj.name=="Family_Name1"){
						if(obj.value==""){
							document.forms[0].Search_By.options[0].selected=true;
						}
				}else if(obj.name=="family_name_loc_lang1"){
			if(obj.value==""){
				document.forms[0].Search_By_Lang.options[0].selected=true;
			}
		}
	}else if(formName=="Advnc_Patient_Search_Form"){
		if(obj.name=="Family_Name"){
			if(obj.value==""){
				document.forms[0].Search_By.options[0].selected=true;
			}
		}
	else if(obj.name=="family_name_loc_lang"){
			if(obj.value==""){
				document.forms[0].Search_By_Lang.options[0].selected=true;
			}
		}
...
//Added new function for IN0 by suresh M on 20.12.2010

function dfltPatClass(obj){ 
	if(obj!=""){
		parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.Moreless.click();
		if (obj=="IP")
		{
			if(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.IP_yn)
				parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.IP_yn.checked = true;
		} else if (obj=="OP")
		{
			if(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.OP_yn)
				parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.OP_yn.checked= true;
		} else if (obj=="DC")
		{
			if(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.DC_yn)
				parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.DC_yn.checked= true;
		} else if (obj=="EM")
		{
			if(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.EM_yn)
				parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.EM_yn.checked= true;
		}
	}
}

/*Function included to replace one single quote by two single quotes*/
//Added on 8-3-2012 by Shanthi for 31010
function makeValidQueryString(txtObj)
{
    var text_value  =   new String(txtObj);
...
{ 
	...
	if (obj.name=="National_Id_No")
		...
		step ="A4";
	else if (obj.name=="other_alt_Id_no") 
		step ="A5";
	...
	if(id.length != 0)
	{
		...
		xmlHttp.open("POST","../../eMP/jsp/PatSrchNatAltIDComponentValues.jsp",false)
		xmlHttp.send(xmlDoc)
		...
		if (arr[0]=="NAT_ID_VALUES")
		  ...
		  else
		  {
				...
				if(document.forms[0].Sex)
				  {
					document.forms[0].Sex.value = arr[13];
				...
				document.forms[0].Dob.value = arr[14];
				...
				if(document.forms[0].Nationality_hid)
				document.forms[0].Nationality_hid.value = arr[18];

				if(document.forms[0].nationality_desc)
				document.forms[0].nationality_desc.value = arr[19];

				if(document.forms[0].nationality_desc_hid)
				document.forms[0].nationality_desc_hid.value = arr[19];

				if(document.getElementById('ethnic_group_hid'))
				document.getElementById('ethnic_group_hid').value=arr[20];

				if(document.getElementById('ethnic_group_desc'))
				document.getElementById('ethnic_group_desc').value=arr[21];

				if(document.getElementById('ethnic_group_desc_hid'))
				document.getElementById('ethnic_group_desc_hid').value=arr[21];

				//other_alt_id  to do in values.jsp
				//other_alt_Id_no
			}
		}
	}
...
// for smart card
/*Added for this CRF HSA-CRF-0289*/
function AlternateIdFocus(alterIdSerch,isAlternate,alternate_no){   
   if(alterIdSerch=="search"&&document.getElementById('Patient_Id1')){ 
   document.getElementById('Patient_Id1').value=alternate_no;
   if(document.getElementById('Patient_Id1').value=="")document.getElementById('Patient_Id1').focus();
   }else if(alterIdSerch=="search1"&&document.getElementById('Alt_Id1_No1')){ 
    document.getElementById('Alt_Id1_No1').value=alternate_no;
    if(document.getElementById('Alt_Id1_No1').value=="")document.getElementById('Alt_Id1_No1').focus();
   }else if(alterIdSerch=="search2"&&document.getElementById('Alt_Id2_No1')){ 
   document.getElementById('Alt_Id2_No1').value=alternate_no;
   if(document.getElementById('Alt_Id2_No1').value=="")document.getElementById('Alt_Id2_No1').focus();
   }else if(alterIdSerch=="search3"&&document.getElementById('Alt_Id3_No1')){ 
   document.getElementById('Alt_Id3_No1').value=alternate_no;
   if(document.getElementById('Alt_Id3_No1').value=="")document.getElementById('Alt_Id3_No1').focus();
   }else if(alterIdSerch=="search4"&&document.getElementById('Alt_Id4_No1')){ 
    document.getElementById('Alt_Id4_No1').value=alternate_no;
    if(document.getElementById('Alt_Id4_No1').value=="")document.getElementById('Alt_Id4_No1').focus();
   }else if(alterIdSerch=="search"&&document.getElementById("PATIENT_ID")){ 
   document.getElementById("PATIENT_ID").value=alternate_no;
   if(document.getElementById("PATIENT_ID").value)document.getElementById("PATIENT_ID").focus();
   }else if(alterIdSerch=="search1"&&document.getElementById('Alt_Id1_No')){ 
   document.getElementById('Alt_Id1_No').value=alternate_no;
   if(document.getElementById('Alt_Id1_No').value=="")document.getElementById('Alt_Id1_No').focus();
   }else if(alterIdSerch=="search2"&&document.getElementById('Alt_Id2_No')){ 
   document.getElementById('Alt_Id2_No').value=alternate_no;
   if(document.getElementById('Alt_Id2_No').value=="")document.getElementById('Alt_Id2_No').focus();
   }else if(alterIdSerch=="search3"&&document.getElementById('Alt_Id3_No')){ 
   document.getElementById('Alt_Id3_No').value=alternate_no;
   if(document.getElementById('Alt_Id3_No').value=="")document.getElementById('Alt_Id3_No').focus();
   }else if(alterIdSerch=="search4"&&document.getElementById('Alt_Id4_No')){ 
   document.getElementById('Alt_Id4_No').value=alternate_no;
   if(document.getElementById('Alt_Id4_No').value=="")document.getElementById('Alt_Id4_No').focus();
   }   
   if((document.forms[0].name=="Basic_Patient_Search_Form"&&alternate_no!="") || (document.forms[0].name=="Advnc_Patient_Search_Form"&&alternate_no!="")){
   parent.Pat_Search_Criteria_Frame.searchForRslt();
   }
}
/*function AltIdFocusAdvanceSearch(alterIdSerch,isAlternate){
  if(alterIdSerch=="search"&&document.getElementById("PATIENT_ID")){ 
   document.getElementById("PATIENT_ID").focus();
   }else if(alterIdSerch=="search1"&&document.getElementById("Alt_Id1_No")){ 
   document.getElementById("Alt_Id1_No").focus();
   }else if(alterIdSerch=="search2"&&document.getElementById("Alt_Id2_No")){ 
   document.getElementById("Alt_Id2_No").focus();
   }else if(alterIdSerch=="search3"&&document.getElementById("Alt_Id3_No")){ 
   document.getElementById("Alt_Id3_No").focus();
   }else if(alterIdSerch=="search4"&&document.getElementById("Alt_Id4_No")){ 
   document.getElementById("Alt_Id4_No").focus();
   }
 }*/
//End HSA-CRF-0289

//Added by kamatchi S for MOHE-CRF-0016.1 on 25-AUG-2020
function insCardReader(insurance_id,insurance_div)
{
	var response=invokeCardReader(insurance_id,insurance_div);
if (document.forms[0].name=="Basic_Patient_Search_Form")
	{
	document.getElementById('insurance_id').value = response;
	}
	else if (document.forms[0].name=="Advnc_Patient_Search_Form")
	{
       document.getElementById('insurance_id').value = response;
	}
...
function NationalID_Search(sessionID,facility,loginUser,p_ws_no){
	var nationalId="";
	var Pyshicalcard="";
	if (document.forms[0].name=="Basic_Patient_Search_Form"){
		nationalId=document.forms[0].National_Id_No1.value;
		}
		else if (document.forms[0].name=="Advnc_Patient_Search_Form"){
			nationalId=document.forms[0].National_Id_No.value;
		} 
	...
	// Calling this function to ExternalApplication.js
	var resdata = validateNationalID(nationalId,sessionID,facility,loginUser,p_ws_no);
	var rescode = "";
	var natid = "";
	var resmsg = "";
	var CardIssued="";
	...
	if(resdata!=null && resdata!=""){
	 ...
	 if (rescode=="S") {
	if ((Pyshicalcard=="N" && CardIssued=="N") || Pyshicalcard=="Y" ) {
		
		if (document.forms[0].name=="Basic_Patient_Search_Form" && natid!=""){
			document.forms[0].National_Id_No1.value=natid;
			alert(resmsg);
			parent.Pat_Search_Criteria_Frame.searchForRslt();
			}
			else if (document.forms[0].name=="Advnc_Patient_Search_Form"  && natid!=""){
				document.forms[0].National_Id_No.value=natid;
				alert(resmsg);
				parent.Pat_Search_Criteria_Frame.searchForRslt();
				} 
	} else if (Pyshicalcard=="N" && CardIssued=="Y") {
			alert(resmsg);
			window.close();
	}
	 } else { 
