...
function query() {
//	f_query_add_mod.location.href ="../../eMP/jsp/queryContact.jsp?function=contact" ;
	f_query_add_mod.location.href ="../../eMP/jsp/ContactQueryPage.jsp?function=contact" ;
}
...
function apply() {
   ...
   var names = new Array ( f_query_add_mod.getLabel('Common.mode.label','common'), f_query_add_mod.getLabel('Common.longdescription.label','common'),f_query_add_mod.getLabel('Common.shortdescription.label','common') );	
   ...
   var transform = new Array ( f_query_add_mod.document.contact_form,
	...
	var splField = new Array (f_query_add_mod.document.contact_form.contact_code);
	var splFieldName = new Array (f_query_add_mod.getLabel('Common.mode.label','common'));

	if(f_query_add_mod.SpecialCharCheck(splField, splFieldName, messageFrame,"M","../../eCommon/jsp/MstCodeError.jsp")){	
		if(f_query_add_mod.checkFieldsofMst( fields, names, messageFrame)) 
			{  
				if(f_query_add_mod.document.contact_form.eff_status.disabled == true)
					f_query_add_mod.document.contact_form.eff_status.disabled = false;
...
function reset() {
       ...
       if(f_query_add_mod.document.forms[0].name == "contact_form") 
