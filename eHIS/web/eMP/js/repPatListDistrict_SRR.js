...
function run() {
	...
	{
		if(doDateChkWithLabel( f_query_add_mod.document.repPatListDistrict.p_from_regn_date, f_query_add_mod.document.repPatListDistrict.p_to_regn_date, messageFrame,'DMY',getLabel('Common.Registration.label','common')+ " " + getLabel('Common.date.label','common') ) ) 
		{			
				...
				{
					if( f_query_add_mod.CheckString( getLabel('Common.category.label','common'), f_query_add_mod.document.repPatListDistrict.p_from_category_code, f_query_add_mod.document.repPatListDistrict.p_to_category_code, messageFrame ) )  
				    {
						if( doDateChkWithLabel( f_query_add_mod.document.repPatListDistrict.p_from_birth_date, f_query_add_mod.document.repPatListDistrict.p_to_birth_date, messageFrame,'DMY',getLabel('Common.birthDate.label','common') ) ) 
						{
							if( f_query_add_mod.CheckString( getLabel('eMP.Province.label','MP'), f_query_add_mod.document.repPatListDistrict.p_from_res_area_code, f_query_add_mod.document.repPatListDistrict.p_to_res_area_code, messageFrame ) )  
							{
