...
function moveToTab(TabIndex)
{
    ...
    if ( TabIndex == 1 )
	{        alert("1");
alert("2"+document.getElementById("demo"));
	...
	{
		alert("inside tabindex "+ document.getElementById('addr') );
...
function clearMembership()
{
  if ((document.forms[0].family_org_membership) && (document.forms[0].CalledFromFunction.value!='ChangePatDtls')) 	{	
		...
		{	        
			...
			document.getElementById('relationship_to_head_desc').disabled=true;			
		    document.getElementById('relationship_to_head_id').disabled=true;			
		    document.getElementById('rel').style.visibility='hidden';
...
if(document.getElementById('pat_cat_desc'))
	...
	{	
		  ...
		  if(document.getElementById('alt_id1_reqd_yn').value == 'Y')
			  document.getElementById('all.alt1_gif').style.visibility='visible';
		  else
  		      document.getElementById('alt1_gif').style.visibility='hidden';
...
function getVisibleMandNatAltIds() {
		...
		var altId1ReqYN		= "Y";
		//var altId2ReqYN		= document.forms[0].all.alt_id2_reqd_yn.value;
		var altId2ReqYN		= document.getElementById('alt_id2_reqd_yn').value; //cmd by vijayan	
			...
			if(document.getElementById('visa_type')){
				...
				if (isNatIdAltIdMandVisaType=="true")
					...
					isAltId1MandVisible	= "hidden";
						...
						isNatVisible	= "hidden";
						natIdReqYN		= "N";						
						document.forms[0].visa_type.value="";
					}
					else{
					...
					//document.getElementById('madimg').style.visibility ='visible';//Added by Kamatchi S for AAKH-CRF-0145
						...
						{
						document.getElementById('madimg').style.visibility ='visible';	
					//	document.forms[0].all.alt_id1_no.disabled=true;	//Maheshwaran K commented for AAKH-CRF-0168 as on 22-10-2022
						document.forms[0].alt_id2_no.disabled=false;	
						if(document.getElementById('visa_type').value=="V"){
						isAltId1MandVisible	= "visible";
						altId1ReqYN		= "Y";
						isAltId2MandVisible	= "visible";
						...
						document.forms[0].alt_id1_no.disabled=false;	//Maheshwaran K added for AAKH-CRF-0168 as on 22-10-2022
						document.forms[0].alt_id2_no.disabled=false;	
						document.getElementById("gcc").style.visibility = 'visible'; 
							document.forms[0].alt_id2_reqd_yn.value="Y"; 
					document.forms[0].alt2_gif.style.visibility="visible";
						}else{
					...
					//	altId1ReqYN		= "N";
						...
						document.forms[0].alt_id1_no.disabled=false;	//Maheshwaran K commented for AAKH-CRF-0168 as on 22-10-2022
						document.forms[0].alt_id2_no.disabled=false;	
						document.getElementById("gcc").style.visibility = 'hidden'; 
						document.getElementById("gccId").value='N'
						}	
