...
function ReadSmartCard_07(Calledfrom,inst,theLocation,subFrame,opCall,myKadPath){
	smartCardPath=myKadPath;
	...
	//if(Calledfrom=='P' || Calledfrom=='OAAP' || Calledfrom=='PS' ||Calledfrom=='VSTREG' || Calledfrom =='REGREF' || Calledfrom =='REFQUR' || Calledfrom =='AE'|| Calledfrom=='CP' ){
		if(inst=='NC'){
			clear_smart_card_values_07(Calledfrom,inst);
		}
		if(inst=='PS' ){
			clear_smart_card_values_ps_07(Calledfrom,inst);
		}
...
var myWindow;
async function callIrisMykadReader(Calledfrom)
	{
 //alert('callIrisMykadReader');
...
//	myWindow.blur();
	...
	// myWindow = window.open("../../eMP/jsp/IRISMyKad.jsp", "", "width=10,height=10");
		//var fDel = new ActiveXObject("Scripting.FileSystemObject"); 
		var fDel = ""; 
		if (fDel.FileExists("C:\\IRISMYKAD.txt")) {
			fDel.DeleteFile("C:\\IRISMYKAD.txt", true);
		}
		var dialogUrl1 = smartCardPath+"/IRISMyKad/IRISMyKad.jsp";
		var dialogArguments = "";
		var dialogFeatures = "dialogHeight:15;dialogWidth:30;status:no;scroll:yes";			
		myWindow =await window.showModalDialog(dialogUrl1, dialogArguments ,dialogFeatures);
		
		//var fso = new ActiveXObject("Scripting.FileSystemObject"); 
		var fso = ""; 
		var s = fso.OpenTextFile("C:\\IRISMYKAD.txt", 1, true);
		var row = s.ReadLine();
		getMyKadValue(JSON.parse(row));
	}
	function closeit() {
    myWindow.close();
}
...
function IrisMykadReader(jsonVal){
	...
	try{
		...
		//	city_desc=trimString(jsonVal.Locality);
			...
			populate_Sekure_new_07(p_Calledfrom,p_inst,p_theLocation,p_subFrame,p_opCall,pat_name,nric_no,oth_alt_no,alt_id_type_desc,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,'','','','','','',photo,'','');
			...
			populate_Sekure_new_07(p_Calledfrom,p_inst,p_theLocation,p_subFrame,p_opCall,pat_name,nric_no,oth_alt_no,alt_id_type_desc,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,b_birth_time,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,photo,father_doc_no,father_doc_type);
        }else{			
            alert(jsonVal.Msg);
        }
...
function populate_Sekure_new_07(Calledfrom,inst,theLocation,subFrame,opCall,pat_name,nric_no,oth_alt_no,alt_id_type_desc,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,time_of_birth,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,photo,father_doc_no,father_doc_type){
			if(inst=='NC'){
				clear_smart_card_values_07(Calledfrom,inst);
			}
			if(inst=='PS' ){
		...
		//	} 
			setTimeout("populate_smart_crd_data_07('"+pat_name+"','"+nric_no+"','"+oth_alt_no+"','"+alt_id_type_desc+"','"+addr_1+"','"+addr_2+"','"+addr_3+"','"+city_desc+"','"+state_desc+"','"+post_code+"','"+b_date+"','"+b_place+"','"+citizen_yn+"','"+race_desc+"','"+religion_desc+"','"+gender+"','"+time_of_birth+"','"+birth_cert_no+"','"+father_name+"','"+father_ic_no+"','"+mother_name+"','"+mother_ic_no+"','"+flg_pop_dat+"','"+Calledfrom+"','"+inst+"','"+photo+"','"+father_doc_no+"','"+father_doc_type+"')",1000);
			}
			...
			if(inst=='PS' || inst=='AE'){ 
				...
				setTimeout("populate_smart_crd_data_ps_07('"+pat_name+"','"+nric_no+"','"+oth_alt_no+"','"+alt_id_type_desc+"','"+addr_1+"','"+addr_2+"','"+addr_3+"','"+city_desc+"','"+state_desc+"','"+post_code+"','"+b_date+"','"+b_place+"','"+citizen_yn+"','"+race_desc+"','"+religion_desc+"','"+gender+"','"+time_of_birth+"','"+birth_cert_no+"','"+father_name+"','"+father_ic_no+"','"+mother_name+"','"+mother_ic_no+"','"+flg_pop_dat+"','"+Calledfrom+"','"+inst+"','"+photo+"','"+father_doc_no+"','"+father_doc_type+"')",2000);
...
function populate_smart_crd_data_07(pat_name,nric_no,oth_alt_no,alt_id_type_desc,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,time_of_birth,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,flg_pop_dat,Calledfrom,inst,photo,father_doc_no,father_doc_type)
{ 
...
function set_values_07(pat_name,nric_no,oth_alt_no,alt_id_type_desc,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,time_of_birth,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,flg_pop_dat,Calledfrom,inst,photo,father_doc_no,father_doc_type){
...
function clear_smart_card_values_07(Calledfrom,inst){
...
function populate_smart_crd_data_ps_07(pat_name,nric_no,oth_alt_no,alt_id_type_desc,addr_1,addr_2,addr_3,city_desc,state_desc,post_code,b_date,b_place,citizen_yn,race_desc,religion_desc,gender,time_of_birth,birth_cert_no,father_name,father_ic_no,mother_name,mother_ic_no,flg_pop_dat,Calledfrom,inst,photo){
...
function clear_smart_card_values_ps_07(Calledfrom,inst){
