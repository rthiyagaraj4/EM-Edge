	...
	if(f_query_add_mod.DetailsFrame!=null)
	{
		...
		{	
			...
			{	
				...
				var docSharedPath = f_query_add_mod.DetailsFrame.document.DocMgmtConfigForm.doc_shared_path.value;
				
				var errors = "";
				
				if (docPathOptionValue == 2)
				{
					if (docSharedPath == "")
					{
				...
				f_query_add_mod.DetailsFrame.document.DocMgmtConfigForm.DocSharedPath.value = f_query_add_mod.DetailsFrame.document.DocMgmtConfigForm.doc_shared_path.value;
...
function onSuccess() 
{
	if(f_query_add_mod.DetailsFrame.document.forms[0].mode.value=="insert")
		f_query_add_mod.location.href='../../eMP/jsp/DocMgmtConfigMain.jsp?mode=insert&facilityId='+f_query_add_mod.document.forms[0].facilityId.value;
	else if(f_query_add_mod.DetailsFrame.document.forms[0].mode.value=="update")
	{			
		f_query_add_mod.location.href='../../eMP/jsp/DocMgmtConfigMain.jsp?mode=update&facilityId='+f_query_add_mod.document.forms[0].facilityId.value;
	}
	else     
