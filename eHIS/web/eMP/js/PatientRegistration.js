...
async function query() {
 var url = await PatientSearch('','','','','','','','N','Y','Patreg');

    if(url)
    {
           //parent.document.f_query_add_mod.location.href=url;
...
{	
	...
	{		
		...
		document.getElementById('phimg').style.visibility='visible'; //Added by S.Sathish for IN020269 on Thursday, March 25, 2010
		if(document.getElementById('refIDValue')!=null && document.getElementById('patient_id'))
	...
	{		
		...
		document.forms[0].refIDValue.disabled		= true;
		document.forms[0].refIDValueButton.disabled	= true;
		document.getElementById('phimg').style.visibility='hidden';  //Added by S.Sathish for IN020269 on Thursday, March 25, 2010
		document.forms[0].patient_id.value			= '';
	}
}
...
{ 
	...
	var prev_mem_type = document.getElementById('prev_mem_type').value; // Previous selected option  
	var mem_type_db = document.getElementById('mem_type_db').value;	   // Membership type From DB
	...
	{	
		...
		HTMLVal = "<html><BODY onKeyDown='lockKey()'><form name='form1' id='form1' method='post' action='../../eMP/jsp/PatCatOrgMbspValidation.jsp'><input type='hidden' name='alt_id1_no' id='alt_id1_no' value='"+document.getElementById('alt_id1_no').value+"'><input type='hidden' name='param' id='param' value='CHK_RELATED_MEM'><input type='hidden' name='alt_id1_db' id='alt_id1_db' value='"+alt_id1_db+"'></form></BODY></HTML>";
...
function clearMembership()
{
  if ((document.forms[0].family_org_membership) && (document.forms[0].CalledFromFunction.value!='ChangePatDtls')) 	{	
		...
		document.getElementById('org_sub_org').style.visibility='hidden';
		document.getElementById('organization').value='';
		document.getElementById('org_id').value='';
		document.getElementById('sub_org_desc').value='';
		document.getElementById('sub_organization').value='';
		document.getElementById('org_id_btn').disabled=true;
		document.getElementById('organization').disabled=true;
		
		document.getElementById('sub_org_desc').disabled=true;
		document.getElementById('sub_org_id_btn').disabled=true;
		if(document.forms[0].family_link_no)	
			document.getElementById('family_link_no').value='';		
		
		if(document.getElementById('head_pat_name'))
		document.getElementById('head_pat_name').innerText='';		  
...
function makeOrgMandate(obj)
{
	...
	if(document.getElementById("alt_id1_no.readOnly"))
		document.getElementById('alt_id1_no').readOnly = false;

if(document.getElementById('pat_cat_desc'))
	document.getElementById('pat_cat_desc').value="";
	...
	if ( (document.getElementById('alt_id1_no').value=='') && (obj.value!='4') && (obj.value!=''))
	{
		...
		if (document.getElementById('alt_id1_no').disabled==true)
		...
		alert(msg);
		document.getElementById('family_org_membership').value='';
	...
	{	
		  ...
		  if(document.getElementById('name_prefix_reqd_yn')) {
			  if(document.getElementById('name_prefix_reqd_yn').value == 'Y') {
				  if(document.getElementById('name_prefix_img'))
		  ...
		  document.getElementById('imgCatExpDateMan').style.visibility='hidden';
  		  document.getElementById('alt_id1_no').disabled=false;
		  return false;
	}
	/*
	...
	*/
	...
	{
		chkMembershipID(document.getElementById('alt_id1_no'));
	...
	if  (obj.value != '1') 
	{
		...
		if(document.getElementById('family_link_no'))
		document.getElementById('family_link_no').value='';
		if(document.getElementById('head_pat_name'))
		document.getElementById('head_pat_name').innerText='';
		document.getElementById('organization').value='';
		document.getElementById('org_id').value='';
		if(document.getElementById('relationship_to_head'))
		document.getElementById('relationship_to_head').value='';
		if(document.getElementById('relationship_to_head_desc'))
		document.getElementById('relationship_to_head_desc').value='';
	...
	else
	{
		...
		document.getElementById('org_id_btn').disabled=false;
		
		document.getElementById('sub_org_desc').disabled=false;
		document.getElementById('sub_org_id_btn').disabled=false;
		document.getElementById('alt_id1_no').disabled=false;
	}
	...
	{  
	  ...
	  document.getElementById('org_sub_org').style.visibility='visible';
	  document.getElementById('alt1_gif').style.visibility='visible';
	  if (obj.value != '1')
	  {
	...
	{		
		 if(document.getElementById('name_prefix_img') && name_pfx_reqd_for_org_mem_yn == 'Y' )
			document.getElementById('name_prefix_img').style.visibility='visible';
		...
		{ 
			...
			document.getElementById('relationship_to_head').value=document.getElementById('org_member_relationship_code').value;	
			if(document.getElementById('org_member_relationship_desc'))
			document.getElementById('relationship_to_head_desc').value=document.getElementById('org_member_relationship_desc').value;	
			document.getElementById('relationship_to_head_desc').disabled=true;
			if(document.forms[0].family_link_no)
			document.getElementById('family_link_no').value=''
  ...
  else
  {
	...
	if(document.getElementById('name_prefix_oth') && document.getElementById('name_prefix_reqd_yn').value == 'Y' ) {  
...
/*The previous membership option*/
	document.getElementById('prev_mem_type').value = obj.value;
...
async function get_org_sub_org(organization,sub_organization)
{
	/*
...
{   
	...
	{ 
		...
		{	
			...
			parent.frames[1].document.getElementById('imgCatExpDate').disabled=true;
			parent.frames[1].document.getElementById('imgCatExpDateMan').style.visibility='hidden';
		}
	}
 }
...
{	
	 ...
	 if ( (document.forms[0].entitlement_by_pat_cat_yn != null) && (document.forms[0].entitlement_by_pat_cat_yn.value=='Y') )
	{
	 ...
	 if(document.getElementById('family_org_membership')){
		 family_org_membership = document.getElementById('family_org_membership').value;
	 }
	 var name_prefix = '';
	 var org_id = '';
	 ...
	 */
	 ...
	 if (document.getElementById('sub_organization'))
		sub_organization = document.getElementById('sub_organization').value;
	 if (document.getElementById('selected_sub'))
		selected_sub = document.getElementById('selected_sub').value;
	 if (document.getElementById('relationship_to_head'))
		relationship_to_head = document.getElementById('relationship_to_head').value;
	 var patCatDB = '';
	 if (patCatVal != null)																						
		 patCatDB = patCatVal;
	 var xmlDoc = ""
	 ...
	 if(document.getElementById('Select1')){
		 responseText = responseText.replace("Select",document.getElementById('Select1').value);
	 }
	 eval(responseText)		 
	}
}
...
/*Added by Dharma on 25th Jan 2019 MMS-DM-CRF-0152 [IN:069128] Start*/
	...
	if(isNatIdOrAltId1MandRes=="true" || isNatIdOrAltIdMandVisaType=="true" || isNatIdAltIdMandVisaType=="true"){
...
function getVisibleMandNatAltIds() {
		...
		var altId1ReqYN		= "Y";
		var altId2ReqYN		= document.getElementById('alt_id2_reqd_yn').value;	
		var isAltId2MandVisible	= "hidden";
		if(altId2ReqYN=="Y"){
	...
	//	if(isNatIdOrAltIdMandVisaType=="true" || isNatIdAltIdMandVisaType=="true"){
				...
				if (isNatIdAltIdMandVisaType=="true")
					{
						...
						document.getElementById('madimg').style.visibility ='hidden';//Added by Kamatchi S for AAKH-CRF-0145
						if(document.getElementById('CalledFromFunction').value=='ChangePatDtls')
							{
							document.getElementById('alt_id1_no').disabled=false;	//Maheshwaran K added for AAKH-CRF-0168 as on 22-10-2022
							document.getElementById('alt_id2_no').disabled=false;	
							}
						else if(document.getElementById('CalledFromFunction').value=='EmergencyReg')
						{	
 				
						document.getElementById('nat_gif').style.visibility='hidden';
						document.getElementById("gcc").style.visibility = 'hidden'; 
						document.getElementById("gccchk").checked = false; 
					...
					{
					document.getElementById('visa_type').value="W";	
					
					}
				
				document.getElementById('visa_type').disabled=true;
			}
		//	if(document.getElementById('details_unknown').checked == false) {
	...
	//	} 
		...
		//	altId1ReqYN		= "N";
			if(isNatIdOrAltIdMandVisaType=="true" ){
				isAltId2MandVisible	= "hidden";
				altId2ReqYN		= "N";
				//this is added to handle NMC SCF 306
				isAltId1MandVisible	= "hidden";
				altId1ReqYN		= "N";
			
			}
			//Added for AAKH-CRF-145
			if(isNatIdAltIdMandVisaType=="true")
				{
				//Maheshwaran K added for AAKH-CRF-0168 as on 22-10-2022
				isAltId1MandVisible	= "visible";
			...
			if(document.getElementById('visa_type')){
				document.getElementById('visa_type').disabled=false;

				if (isNatIdAltIdMandVisaType=="true")
					{
					if(document.getElementById('CalledFromFunction').value=='EmergencyReg')
						{
					if(document.getElementById('details_unknown').checked == true)
					{				
					...
					document.getElementById('madimg').style.visibility ='visible';	
					document.getElementById('visa_type').disabled=false;
					...
					document.getElementById("gcc").style.visibility = 'visible'; 
					document.getElementById("gccchk").checked=false;
					document.getElementById("gccId").value='N'
					}else{
						isNatVisible	= "visible";
					...
					//document.getElementById('madimg').style.visibility ='visible';//Added by Kamatchi S for AAKH-CRF-0145
					
	
					}
					else if(document.getElementById('CalledFromFunction').value=='ChangePatDtls')
						{
						document.getElementById('madimg').style.visibility ='visible';	
					//	document.getElementById('alt_id1_no').disabled=true;	//Maheshwaran K commented for AAKH-CRF-0168 as on 22-10-2022
						document.getElementById('alt_id2_no').disabled=false;	
						if(document.getElementById('visa_type').value=="V"){
						isAltId1MandVisible	= "visible";
						altId1ReqYN		= "Y";
						...
						isNatVisible	= "hidden";
						natIdReqYN		= "N";
						document.getElementById('national_id_no').disabled=true;	
						document.getElementById('alt_id1_no').disabled=false;	//Maheshwaran K added for AAKH-CRF-0168 as on 22-10-2022
						document.getElementById('alt_id2_no').disabled=false;	
						document.getElementById("gcc").style.visibility = 'visible'; 
					...
					document.getElementById('alt2_gif').style.visibility="visible";
						...
						//Maheshwaran K commented for AAKH-CRF-0168 as on 22-10-2022
					//	isAltId1MandVisible	= "hidden";
					//	altId1ReqYN		= "N";
						isAltId2MandVisible	= "hidden";
						altId2ReqYN		= "N";
						...
						natIdReqYN		= "Y";
						document.getElementById('national_id_no').disabled=false;	
						document.getElementById('alt_id1_no').disabled=false;	//Maheshwaran K commented for AAKH-CRF-0168 as on 22-10-2022
						document.getElementById('alt_id2_no').disabled=false;	
						document.getElementById("gcc").style.visibility = 'hidden'; 
						document.getElementById("gccId").value='N'
						}	
				...
				//	altId2ReqYN		= "Y";
				 ...
				 //		alert('2636');
					...
					if(isNatIdAltIdMandVisaType=="true")
						{
						validateDftNationalId(trimString(document.getElementById('national_id_no').value));
						}
					////Maheshwaran K added for AAKH-CRF-0168 as on 22-10-2022
					isAltId1MandVisible	= "visible";
					altId1ReqYN		= "Y";
	...
	if( isNatIdAltIdMandVisaType=="true" && trimString(document.getElementById('dftNationalId').value)==trimString(document.getElementById('national_id_no').value)) 
			{	
			isAltId2MandVisible	= "visible";
			altId2ReqYN		= "Y";	
			}
		...
		if(document.getElementById('alt1_gif')){
			document.getElementById('alt_id1_reqd_yn').value=altId1ReqYN; 
			document.getElementById('alt1_gif').style.visibility=isAltId1MandVisible;
		}
		//Added for AAKH CRF 168
		if(document.getElementById('alt2_gif')){
			document.getElementById('alt_id2_reqd_yn').value=altId2ReqYN; 
			document.getElementById('alt2_gif').style.visibility=isAltId2MandVisible;
		}
if(isNatIdOrAltIdMandVisaType=="true" ){
	//	if(isNatIdOrAltIdMandVisaType=="true" || isNatIdAltIdMandVisaType=="true"){
			if(document.getElementById('alt2_gif')){
...
{
	var countryCode = "";
	countryCode = document.PatRegForm.countryC.value;
	
	var xmlDoc = "";
	var xmlHttp = new XMLHttpRequest();
	xmlStr ='<root><SEARCH /></root>';
	xmlDoc = new DOMParser().parseFromString(xmlStr, "text/xml");
	xmlHttp.open('POST','../../eMP/jsp/MPIntermediate.jsp?action=Country&countryCode='+countryCode,false);
	xmlHttp.send(xmlDoc);
	responseText=xmlHttp.responseText;
	var telephoneCode	= TrimStr(responseText);
	document.PatRegForm.telephone.value = telephoneCode;
	document.PatRegForm.countryC.value = countryCode;
}

function telephoneCode(obj)
{
	var xmlDoc = "";
	var xmlHttp = new XMLHttpRequest();
	xmlStr ='<root><SEARCH /></root>';
	xmlDoc = new DOMParser().parseFromString(xmlStr, "text/xml");
	xmlHttp.open('POST','../../eMP/jsp/MPIntermediate.jsp?action=Country&countryCode='+obj.value,false);
	xmlHttp.send(xmlDoc);
	responseText=xmlHttp.responseText;
	var telephoneCode	= TrimStr(responseText);
	document.PatRegForm.telephone.value = telephoneCode;
	document.PatRegForm.countryC.value = obj.value;
}

function telephone1()
{
	var countryCode = "";
	countryCode = document.ChangePatDtlForm.countryC.value;
	var xmlDoc = "";
	var xmlHttp = new XMLHttpRequest();
	xmlStr ='<root><SEARCH /></root>';
	xmlDoc = new DOMParser().parseFromString(xmlStr, "text/xml");
	...
	responseText=xmlHttp.responseText;
	var telephoneCode	= TrimStr(responseText);
	document.forms[0].telephone.value = telephoneCode;
	document.forms[0].countryC.value = countryCode;
}

function telephoneCode1(obj)
{
	var xmlDoc = "";
	var xmlHttp = new XMLHttpRequest();
	xmlStr ='<root><SEARCH /></root>';
	...
	responseText=xmlHttp.responseText;
	var telephoneCode	= TrimStr(responseText);
	document.ChangePatDtlForm.telephone.value = telephoneCode;
	document.ChangePatDtlForm.countryC.value = obj.value;
...
{
	var countryCode = "";
	countryCode = document.Contact_Details_form.countryC.value;
	...
	responseText=xmlHttp.responseText;
	var telephoneCode	= TrimStr(responseText);
	document.Contact_Details_form.telephone.value = telephoneCode;
	document.Contact_Details_form.countryC.value = countryCode;
}

function telephoneCode2(obj)
{
	var xmlDoc = "";
	var xmlHttp = new XMLHttpRequest();
	xmlStr ='<root><SEARCH /></root>';
	...
	var telephoneCode	= TrimStr(responseText);
	document.Contact_Details_form.telephone.value = telephoneCode;
	document.Contact_Details_form.countryC.value = obj.value;
}
//Added by Arthi for ML-MMOH-CRF-1930 US004 end
function updateTelCode(obj){
	var xmlDoc = "";
	var xmlHttp = new XMLHttpRequest();
	xmlStr ='<root><SEARCH /></root>';
	xmlDoc = new DOMParser().parseFromString(xmlStr, "text/xml");
	...
	responseText=xmlHttp.responseText;
	var telephoneCode	= TrimStr(responseText);
	document.Contact_Details_form.teleCodeHidden.value = telephoneCode;
	document.Contact_Details_form.countryC12.value  = obj.value;
}
function updateTeleCodeOnLoad(){
	var countryCode = "";
	countryCode = document.Contact_Details_form.countryC.value;
	var xmlDoc = "";
	var xmlHttp = new XMLHttpRequest();
