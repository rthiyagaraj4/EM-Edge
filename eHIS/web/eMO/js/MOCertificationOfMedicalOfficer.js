function reset() 
{
	if(f_query_add_mod.document.repCertificateOfMediOfficer)
	{
	   f_query_add_mod.location.href = '../../eMO/jsp/MORepCertificationOfMedicalOfficer.jsp?param=';
	}
}
/*function run() 
{ 	
...
/*function calljsp1(obj)
{
	...
	if(az!='')
	{
		f_query_add_mod.location.href = '../../eMO/jsp/MORepCertificationOfMedicalOfficer.jsp?param='+az+'&first=N';
	}
}*/
async function searchCode(obj,target)
{
	...
	if(retVal != null && retVal != "" )
	{
		...
		var arr=ret1.split(",");
			...
			target.value= arr[0];
			//parent.f_query_add_mod.location.href = '../../eMO/jsp/MORepCertificationOfMedicalOfficer.jsp?param='+arr[0];
	}
	/*else
	{	
...
/*function calljsp(obj)
{
	...
	if(az!='')
	{
		parent.f_query_add_mod.location.href = '../../eMO/jsp/MORepCertificationOfMedicalOfficer.jsp?param='+az+'&first=N';
	}
}*/
