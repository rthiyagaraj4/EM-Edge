...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<title><fmt:message key="ePO.RecommendedRemarks.label" bundle="${po_labels}"/></title>
</head>
<%
...
<body onload='FocusFirstElement();'>
	...
	<table border="0" cellspacing="0" width="100%" align=center>
	  ...
	  <tr>
		<td  class="label" nowrap><fmt:message key="ePO.RecommendedRemarks.label" bundle="${po_labels}"/></td>
		<td class='fields'>&nbsp;&nbsp;<textarea name="remarks" rows="3" cols="40"  onKeyPress="checkMaxLimit(this,400);" onPaste="checkMaxLengthPaste(this,400);" onBlur="SPCheckMaxLen('Remarks',this,400);"><%=remarks%></textarea>&nbsp;<input type="hidden" name="remarks_code_1" id="remarks_code_1" value = "<%=remarks_code%>" >
	  ...
	  <tr>
	     ...
	     <tr>
		 <td  colspan="2" align="right"><input type="button" class="button" name="close" id="close" value='<fmt:message key="Common.close.label" bundle="${common_labels}"/>' onClick="updateRecomRemarks();"></td>
	     </tr>
