<!DOCTYPE html>
<%@ page import=" ePO.PurchaseOrderDetailBean,ePO.PurchaseOrderBean, ePO.Common.* , eCommon.Common.*,  java.util.*,java.sql.*,webbeans.eCommon.*,java.io.UnsupportedEncodingException,
...
%>
	<body onLoad="onLoadCurrCode('<%=dflt_currency%>');calculateDisAmount();">
<%
	}
%>
	...
	<form name="formPurchaseOrderDetail" id="formPurchaseOrderDetail">
		<table border="0" cellspacing="0" cellpadding="0" width="100%" >
			<tr>
				<th colspan=2><fmt:message key="ePO.EnterItemDetails.label" bundle="${st_labels}"/></th>
			</tr>
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="label" colspan=2><fmt:message key="ePO.Item.label" bundle="${po_labels}"/>&nbsp;&nbsp;
					<input type="text" name="item_desc" id="item_desc" size="30" maxlength="30"  value="<%=item_desc%>" <%=item_disabled%>>
			...
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="label" >	<fmt:message key="ePO.OrderQty.label" bundle="${st_labels}"/></td>
				<td class="field" >	<input type="text" name="order_qty" id="order_qty" class=NUMBER size="10" maxlength="8"  value="<%=order_qty%>" onKeyPress="return isValidInteger();" onBlur="checkIntegerFormat(this);calculateValue();calculateDiscount();calculatePrice();checkUOMConvFactor();"><%=bean.getImage("M")%>
				</td>
			</tr>
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="label" ><fmt:message key="ePO.OrderUOM.label" bundle="${st_labels}"/></td>
				<td class="field" >	
					<select name='uom' id='uom' onchange="getUOMDesc(this);" onBlur="getUOMDesc(this); checkUOMConvFactor();" ><%//bean.getUom_code(uom_code) Modified by suresh.r on 04-12-2014 against ML-BRU-SCF-1457 %><%=bean.getPur_uom_code_List(uom_code,item_code)%></select><%=bean.getImage("M")%>
				</td>
		
			</tr>
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				<td class="label" >	<fmt:message key="ePO.ListPrice.label" bundle="${st_labels}"/></td>
				<% if(list_price == "") {%>
			...
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				<td class=label align=right> <fmt:message key="ePO.CommitmentCode.label" bundle="${st_labels}"/></td>
				<td class="field" > <select name="commit_code" id="commit_code" onchange="loadDeptId(this);getCOMMNTDesc(this);" onBlur="getCOMMNTDesc(this);"><%=bean.getComm_code(commit_code)%></select><span style='visibility:<%=budget_check_mandatory%>'><%=bean.getImage("M")%></span></td>
			</tr>
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>

				<td class=label align=right> <fmt:message key="ePO.DeptId/Acc.label" bundle="${st_labels}"/></td>
			...
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				<td class=label align=right><fmt:message key="ePO.AcctNumber.label" bundle="${st_labels}"/></td>
			...
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				<td class=label align=right> <fmt:message key="ePO.AccNoDesc.label" bundle="${st_labels}"/></td>
				<td class="field" > 
					<label id='acc_desc_label'  class="label"><%=acc_desc%></label>
					<input type="hidden" name="acc_desc" id="acc_desc" value="<%=acc_desc%>">
				</td>
			</tr>
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				...
				<% } else  if(bean.checkForNull(bean.getExp_date()) != "" && bean.checkForNull(bean.getExp_date()) != null){ %>	
					<input type="text" value="<%=bean.checkForNull(bean.getExp_date())%>" name="del_date"  maxLength="10" size="10"  onBlur="CheckDate(this);" >&nbsp;
				<% } else { %>		
			...
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
				<td class=label align=right><fmt:message key="ePO.ApprovalReference.label" bundle="${st_labels}"/></td>
				<td class="field" > <input type="checkbox" value="Y" name="app_ref" id="app_ref" onclick="checkAppvlRef(this)" <%=appRefChecked%>>
					<input type="text" name="ref_value" id="ref_value" size="15" maxlength="20"  value="<%=ref_value%>" <%=appRefDisabled%>>
					<span id="manditHidden" style=visibility:hidden> <%=bean.getImage("M")%> </span>	
				</td>
			</tr>
			<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr>
