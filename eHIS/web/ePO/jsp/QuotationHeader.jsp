	...
	<form name="formQuotationHeader" id="formQuotationHeader">
		...
		<table border='0' cellpadding='0' cellspacing='0' width='100%' align=center>
			<tr>
				...
				<td class='fields'>&nbsp;&nbsp;
					<select name='supplier_code' id='supplier_code' onChange="loadCurrency(this);" value="" <%=codeDisabled%>>
						<%=bean.getSupp_code_List()%>
					</select><%=bean.getImage("M")%>
				</td>
				
				<td  class="label"><fmt:message key="ePO.QuotNo.label" bundle="${po_labels}"/></td>
				...
				<td  class="label"><fmt:message key="ePO.QuotDate.label" bundle="${po_labels}"/></td>
				...
				<td  class="label"><fmt:message key="ePO.QuotRef.label" bundle="${po_labels}"/></td>
			...
			<tr>
				...
				<td  class="label"><fmt:message key="ePO.QuotType.label" bundle="${po_labels}"/></td>													
				<td class="fields">&nbsp;&nbsp;
					<select name="quotation_type" id="quotation_type" <%=codeDisabled%>>
					<%=bean.getQuotation_type_List(bean.getQuotation_type())%>
					</select>
					<%=bean.getImage("M")%> 
				</td>
				
				<td  class="label" >
				<fmt:message key="ePO.ValidUpto.label" bundle="${po_labels}"/>
				</td>
				<td class="fields">&nbsp;	
				<%if(bean.getValid_upto() != ""){%>
					<input type="text" value="<%=bean.getValid_upto()%>" name="valid_upto"  maxLength="10" size="10"  onBlur="CheckDate(this);checkValidateUpto(this);" <%=codeDisabled%> >&nbsp;
				<img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('valid_upto');" name='val_img' ></img>
				<% } else {%>
				
					<input type="text" value="<%=postdate%>" name="valid_upto"  maxLength="10" size="10"  onBlur="CheckDate(this);checkValidateUpto(this);" <%=codeDisabled%> >&nbsp;
				<img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('valid_upto');" name='val_img' ></img>
				...
				<td  class='fields' nowrap>&nbsp;&nbsp;
					<select name="currency_code" id="currency_code" onchange="setCurrCode(this);loadExRateHdr();" <%=codeDisabled%> ><%=bean.loadCurrencyList(bean.checkForNull(bean.getCurrency_code()))%> 
					</select>  
					<%=bean.getImage("M")%>
				</td>
