...
<html>
<head>
	<title><fmt:message key="Common.ConfirmFinalize.label" bundle="${common_labels}"/></title>
	<%
...
<form name='ConfirmTransactionForm' id='ConfirmTransactionForm' method='post'>
	...
	<tr>
		<td  colspan=2>
			<center> <h5> <fmt:message key="Common.Finalize.label" bundle="${common_labels}"/>? </h5> </center>
		</td>
	</tr>
	<tr>
		<td colspan=2> 
