<!DOCTYPE html>
<%@ page import=" ePO.PurchaseOrderDetailBean,ePO.PurchaseOrderBean, ePO.Common.* , eCommon.Common.*,  java.util.*,java.sql.*,webbeans.eCommon.*" contentType="text/html;charset=UTF-8"%>
