			...
			<table border="0" cellpadding="1" cellspacing="0" width='100%' height='100%' align='center'>
				...
				<tr>
					...
					<td class="label">&nbsp;<select name="rec_store_code" id="rec_store_code" >
							<%=bean.getRec_store_code_List()%></select>
							</td>
					...
					<%=bean.getRet_store_code_List()%>
					</select></td>
					<td class="label"><fmt:message key="Common.patientId.label" bundle="${common_labels}"/></td>
					<td class="label">&nbsp;<input type="text" value="<%=bean.getPatient_id()%>" name="patient_id"  maxLength="20" size="20"><input type="button" class='BUTTON' value="?" name="patient_search" id="patient_search" onclick="searchPatientInQuery();"></td>
				</tr>
				<tr>
