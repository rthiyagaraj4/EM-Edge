...
%>
	<table cellpadding=0 cellspacing=0 width="100%" align=center>
		...
		<th><fmt:message key="eSS.Acknowledge.label" bundle="${ss_labels}"/><input type="checkbox" value="Y" name="selectAll" id="selectAll"   onClick="return toggleCheck(formDetail);" ></th></tr>
		<%
