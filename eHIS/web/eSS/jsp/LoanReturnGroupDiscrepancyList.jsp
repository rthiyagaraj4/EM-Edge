...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<body  onMouseDown="CodeArrest()">
	 ...
	 <tr width='365'>
				...
				<td class="<%=className%>"  width='140' onClick="displayDiscrepancyDtls(this,<%=i%>);" onMouseOver="changeCursor(this);"><font class="HYPERLINK"><%=LoanReturnGroupBean.checkForNull(instrument_desc,"&nbsp;")%></font></td>
				<td class="<%=className%>"  width='140'><%=LoanReturnGroupBean.checkForNull(discrepancy_desc,"&nbsp;")%></td>
				<td class="<%=className%>"  width='73'><%=LoanReturnGroupBean.checkForNull(instrument_qty,"&nbsp;")%></td>
				<td class="<%=className%>"  width='72'><%=LoanReturnGroupBean.checkForNull(discrepancy_qty,"&nbsp;")%></td>
