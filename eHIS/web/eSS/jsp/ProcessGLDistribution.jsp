...
<%@ include file="../../eSS/jsp/SsCheckGLParameter.jsp" %>
<html>
<head>
<%
...
<iframe name='commontoolbarFrame' id='commontoolbarFrame'	src="<%= source %>" frameborder=0 scrolling='no' noresize style='height:8vh;width:100vw'></iframe>
	<iframe name='f_query_add_mod' id='f_query_add_mod' src="../../eSS/jsp/ProcessGLDistributionProcess.jsp?mode=<%=eCommon.Common.CommonRepository.getCommonKeyValue("MODE_MODIFY")%>&function_id=<%=request.getParameter( "function_id" ) %>" frameborder=0 scrolling='no' style='height:84vh;width:100vw'></iframe>
