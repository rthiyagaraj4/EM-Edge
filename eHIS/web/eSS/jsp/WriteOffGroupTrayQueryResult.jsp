	...
	try{
		...
		*/
		...
		%>
						...
						<td class="<%=classvalue%>" align="left" onclick="disableClick(event);"><%=records.get(1)%></td>
						<td class="<%=classvalue%>" align="left" onclick="disableClick(event);"><%=records.get(2)%></td>
						<td class="<%=classvalue%>" align="left" onclick="disableClick(event);"><%=records.get(3)%></td>
						<td class="<%=classvalue%>" onclick="disableClick(event);" align="center"><%=doc_date_disp%></td>
		<%
						}
					}
		%>
