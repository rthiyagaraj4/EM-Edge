...
--%>
<%@ page import ="eSS.VendorLoanRequestBean,eCommon.Common.*,eSS.*,java.util.*,java.util.HashMap,java.util.ArrayList,java.lang.*,webbeans.eCommon.*" contentType="text/html;charset=UTF8"%>
...
%>
			...
			<input type=hidden name="total_qty<%=index%>" id="total_qty<%=index%>"				value="<%=CommonBean.checkForNull((String)records.get(3),"0")%>">
