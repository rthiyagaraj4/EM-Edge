...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	%>
	<iframe name='qryCriteriaReturnGroup' id='qryCriteriaReturnGroup' src="../../eSS/jsp/ReturnGroupQueryCriteria.jsp?<%=params%>" frameborder=0  scrolling='no' style='height:90%;width:100vw'></iframe><iframe name='qryResultReturnGroup' id='qryResultReturnGroup' src='../../eCommon/html/blank.html' frameborder=0 noresize scrolling='no' style='height:100vh;width:100vw'></iframe>
</html>
