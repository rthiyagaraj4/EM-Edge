		...
		<tr>
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<%=bean.getOrderByAutoclaveWashingTest()%>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
			...
			<input type="hidden" name="SQL_SS_AUTOCLAVE_WASH_TEST_LOOKUP" id="SQL_SS_AUTOCLAVE_WASH_TEST_LOOKUP" value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_AUTOCLAVE_WASH_TEST_LOOKUP")%>">
		</form>
		<%
