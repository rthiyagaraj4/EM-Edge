...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	%>
	<iframe name='frameWriteOffGroupQueryCriteria' id='frameWriteOffGroupQueryCriteria' src="../../eSS/jsp/WriteoffGroupQueryCriteria.jsp?<%=source%>" frameborder=0  scrolling='no' style='height:75%;width:100vw'></iframe><iframe name='frameWriteOffGroupQueryResult' id='frameWriteOffGroupQueryResult' src='../../eCommon/html/blank.html' frameborder=0 noresize scrolling='no' style='height:100vh;width:100vw'></iframe>
</html>
