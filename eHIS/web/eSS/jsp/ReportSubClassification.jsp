		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<%=bean.getOrderBySubClassification()%>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
			...
			<input type="hidden" name="SQL_SS_SUB_CLASSIFICATION_LOOKUP" id="SQL_SS_SUB_CLASSIFICATION_LOOKUP" value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_SUB_CLASSIFICATION_LOOKUP")%>">
		</form>
	</body>
</html>
