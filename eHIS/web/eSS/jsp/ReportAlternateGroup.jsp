...
//		String p_report_id		=		null;
	...
	<body onLoad="FocusFirstElement();" onMouseDown='CodeArrest();'>
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<input type="hidden" name="SQL_SS_ALTERNATE_GROUP_LOOKUP" id="SQL_SS_ALTERNATE_GROUP_LOOKUP" value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_ALTERNATE_GROUP_LOOKUP")%>">
		</form>
		<%
