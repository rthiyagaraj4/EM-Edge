	...
	<body onLoad="FocusFirstElement();"onMouseDown='CodeArrest();'>
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					<td align="left" class="label" ><fmt:message key="eSS.EntryStatus.label" bundle="${ss_labels}"/></td>
					<td class=label colspan='3'>&nbsp;&nbsp;<select name="p_entry_status" id="p_entry_status"><%=bean.getWrite_off_Entry_StatusList()%></select></td>
				...
				<tr>
					<td align="left" class="label" ><fmt:message key="eSS.FinalizedStatus.label" bundle="${ss_labels}"/></td>
					<td class=label colspan='3'>&nbsp;&nbsp;<select name="p_finalize_status" id="p_finalize_status" ><%=bean.getWrite_off_finalized_StatusList()%></select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
					<td align="right">&nbsp;</td>
				...
				<tr>
					<td align="left" class="label" nowrap><fmt:message key="Common.Group.label" bundle="${common_labels}"/></td>
			...
			<input type="hidden" name="SQL_SS_DOC_TYPE_ADJ_LIST_LOOKUP" id="SQL_SS_DOC_TYPE_ADJ_LIST_LOOKUP"			  value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_DOC_TYPE_ADJ_LIST_LOOKUP")%>">
			<input type="hidden" name="SQL_SS_STORE_WRITE_OFF_SELECT_LIST_LOOKUP" id="SQL_SS_STORE_WRITE_OFF_SELECT_LIST_LOOKUP" value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_STORE_WRITE_OFF_SELECT_LIST_LOOKUP")%>">
