...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<body onLoad="getPatientName(document.forms[0].patient_id,document.forms[0].patient_name,document.forms[0]);"onMouseDown="CodeArrest()">
		<form name="formLoanReturnGroupDetail" id="formLoanReturnGroupDetail" action="../../eSS/jsp/LoanReturnGroupList.jsp" method="post" target="frameLoanReturnGroupList">
			...
			<td width='100%' height='100%' align='center' valign='top'>
				<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center'>
					...
					<tr>
						<td  class="label"><fmt:message key="Common.patientId.label" bundle="${common_labels}"/></td><td class="label" >&nbsp;&nbsp;<input type="text" name="patient_id" id="patient_id" size=20 maxlength=20 onBlur= "return getPatientName(patient_id,patient_name,formLoanReturnGroupDetail);" disabled><input class="button" onClick="return callPatientSearch(patient_id,patient_name,formLoanReturnGroupDetail);" type="button" name="cmdPatientSearch" id="cmdPatientSearch" value="?" disabled></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="label" colspan='3'>
							...
							<input type="button" value="Cancel" name="cancel" id="cancel" class="BUTTON" disabled onClick="disableAndResetForm(formLoanReturnGroupDetail);">
