...
--%>
<%@ page import="eSS.ReturnGroupBean,eSS.*, eSS.Common.* , eCommon.Common.*, java.text.*, java.util.*,java.sql.*,webbeans.eCommon.*" contentType="text/html;charset=UTF-8"%>
<%@	include file="../../eCommon/jsp/GetPersistenceBean.jsp" %> 
<%@	include file="../../eCommon/jsp/CommonInclude.jsp" %> 
<jsp:useBean id="we" class="eSS.ReturnGroupBean"/>
<html>
	<head>
...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<%
		...
		String doc_type_code ="", docTypeOption="";
		...
		if (mode.equals(CommonRepository.getCommonKeyValue("MODE_INSERT"))) {
			 ...
			 docTypeOption = bean.getDocTypes();
		}
		if (mode.equals(CommonRepository.getCommonKeyValue("MODE_MODIFY"))) {
			disabled			=		"disabled";
			doc_type_code = request.getParameter("doc_type_code")==null?"":request.getParameter("doc_type_code");
			docTypeOption = bean.getDoc_type_code_ListOptions("RTG", doc_type_code);
		}
	...
	<body onLoad="FocusFirstElement();isUpdationAllowed();" onMouseDown="CodeArrest()">
		<form name="formReturnGroupHeader" id="formReturnGroupHeader" onReset='FocusFirstElement();'>
			<table border="0" cellpadding="0" cellspacing="0" width='100%' height='100%' align='center'><tr><td>
				...
				<tr>
					...
					<td class="label">&nbsp;&nbsp;<select name="doc_type_code" id="doc_type_code" onBlur="validateDocAutoNo(doc_type_code);" <%=disabled%>><%=docTypeOption%></select>&nbsp;<img src="../../eCommon/images/mandatory.gif" align=center></td>
					...
					<td class="label">&nbsp;&nbsp;<input type="text" name="doc_date" id="doc_date" maxLength="10" size="10" value="<%=com.ehis.util.DateUtils.convertDate(bean.getDoc_date(),"DMY","en",locale)%>" onBlur="CheckDate(this,'<%=locale%>');">&nbsp;
					<!-- <img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('doc_date');"></img> -->
					<img src="../../eCommon/images/CommonCalendar.gif" onclick="if (!document.getElementById('doc_date').disabled) { document.getElementById('doc_date').focus(); return showCalendar('doc_date'); }">
			...
			<input type='hidden' name="trn_type" id="trn_type"				value="RTG">
