	...
	%>
			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%" align="center">
				<tr>
					...
					<th width='260'><fmt:message key="Common.Store.label" bundle="${common_labels}"/></th>
					<!-- <th width='260'><fmt:message key="Common.Group.label" bundle="${common_labels}"/></th>-->
				</tr>		
		<%
		...
		%>
					...
					<td class='NODISPLAY'><%=CommonBean.checkForNull((String)records.get(4))%></td>
