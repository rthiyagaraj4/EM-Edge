...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	%>
	<iframe name='framePackingQueryCriteria' id='framePackingQueryCriteria' src="../../eSS/jsp/PackingQueryCriteria.jsp?<%=source%>" frameborder=0  scrolling='no' style='height:75%;width:100vw'></iframe><iframe name='framePackingQueryResult' id='framePackingQueryResult' src='../../eCommon/html/blank.html' frameborder=0 noresize scrolling='no' style='height:100vh;width:100vw'></iframe>
</html>
