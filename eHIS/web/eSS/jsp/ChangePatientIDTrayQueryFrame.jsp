...
%>
	...
	<iframe name='frameChangePatientIDTrayQueryCriteria' id='frameChangePatientIDTrayQueryCriteria' src="../../eSS/jsp/ChangePatientIDTrayQueryCriteria.jsp?<%=request.getQueryString()%>" frameborder=0  scrolling='no' style='height:75%;width:100vw'></iframe><iframe name='frameChangePatientIDTrayQueryResult' id='frameChangePatientIDTrayQueryResult' src='../../eCommon/html/blank.html' frameborder=0 noresize scrolling='no' style='height:100vh;width:100vw'></iframe>
</html>
