...
--%>
<%@ page import ="eSS.*, eSS.Common.* ,java.util.*,java.sql.*, eCommon.Common.*,java.util.ArrayList,java.util.Hashtable,webbeans.eCommon.*" contentType="text/html;charset=UTF-8"%>
			...
			<table border="0" cellpadding="0" cellspacing="0" width='98%'>
				 <tr>
				  ...
				  <tr>
					...
					<td class=label >&nbsp;&nbsp;<select name="curr_store_code" id="curr_store_code" > <%=bean.getAllStores()%></select>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
