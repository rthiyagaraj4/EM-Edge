...
<form name="formRequestSummaryReport" id="formRequestSummaryReport" onReset="FocusFirstElement();" action="../../eCommon/jsp/report_options.jsp"  target="messageFrame">
	...
	<tr>
		<td class='LABEL' align='right'><fmt:message key="Common.RequestedBy.label" bundle="${common_labels}"/></td>
	...
	<tr>
		<td class='LABEL' align='right'><fmt:message key="eSS.RequestedOn.label" bundle="${ss_labels}"/></td>
	...
	<tr>
		<td class='LABEL' align='right'><fmt:message key="Common.RequestStatus.label" bundle="${common_labels}"/></td>
		<td>&nbsp;<select name=p_req_status>
		<option value='A'><fmt:message key="Common.all.label" bundle="${common_labels}"/></option>
		<option value='1'><fmt:message key="eSS.NotIssued.label" bundle="${ss_labels}"/></option>
		<option value='2'><fmt:message key="eSS.FullyIssued.label" bundle="${ss_labels}"/></option>
		<option value='3'><fmt:message key="eSS.PartiallyIssued.label" bundle="${ss_labels}"/></option>
		</select></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td colspan='3'>&nbsp;</td></tr>
