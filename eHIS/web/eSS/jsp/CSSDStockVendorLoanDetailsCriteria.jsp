	...
	<body onLoad="FocusFirstElement();">
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					<td align="right" class="label"><fmt:message key="eSS.VendorLoanRequestDocNo.label" bundle="${ss_labels}"/></td>
					...
					<td align="right" class="label"><fmt:message key="eSS.DocReferenceNo.label" bundle="${ss_labels}"/>&nbsp;</td>
				...
				<tr>
					...
					<td align="right" class="label"><fmt:message key="eSS.Acknowledged.label" bundle="${common_labels}"/></td>
