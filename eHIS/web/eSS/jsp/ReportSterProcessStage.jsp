	...
	<body onLoad="FocusFirstElement();" onMouseDown='CodeArrest();'>
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					<td align="right" class="label"><fmt:message key="eSS.SterilizationProcessStage.label" bundle="${ss_labels}"/></td>
				...
				<tr>
					...
					<%=bean.getOrderBySterProcessStage()%>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
			...
			<input type="hidden" name="SQL_SS_STER_PROCESS_STAGE_LOOKUP" id="SQL_SS_STER_PROCESS_STAGE_LOOKUP" value="<%= eSS.Common.SsRepository.getSsKeyValue("SQL_SS_STER_PROCESS_STAGE_LOOKUP")%>">
		</form>
	</body>
</html>
