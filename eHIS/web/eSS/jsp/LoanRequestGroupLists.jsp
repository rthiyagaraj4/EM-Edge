...
--%>
<%@ page import="eSS.LoanRequestGroupBean, eSS.Common.*,java.util.HashMap,java.util.ArrayList,java.lang.*,java.sql.*,java.text.*,webbeans.eCommon.* " contentType="text/html;charset=UTF-8"%>
...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<body onMouseDown="CodeArrest();" >
		<form name='formLoanRequestGroupList' id='formLoanRequestGroupList'>
...
%>
<script>
	formObj = document.formLoanRequestGroupList
	...
	for(var i =0 ;i<total_rec;i++){ 
		...
		var auth_group = eval("document.formLoanRequestGroupList.auth_group_"+i);
