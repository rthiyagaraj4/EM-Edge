...
<%
	...
	try{
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_TRAY_DTLS_TRAY_QUERY_RESULT") );
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/PhyInvEntryTrayQueryResult.jsp", searched) );
	}
	catch(Exception e) {
