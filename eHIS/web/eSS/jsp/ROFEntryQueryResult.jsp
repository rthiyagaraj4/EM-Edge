...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	%>
			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%" align="center">
				<tr>
					<th width="100"><fmt:message key="Common.DocType.label" bundle="${common_labels}"/></th>
					<th width="100"><fmt:message key="eSS.DocNo.label" bundle="${ss_labels}"/></th>
					<th width="100">Prepare Doc No</th>
					<th width="100"><fmt:message key="eSS.DocDate.label" bundle="${ss_labels}"/></th>
					<th width="175"><fmt:message key="Common.Store.label" bundle="${common_labels}"/></th>
					<th width="175"><fmt:message key="eSS.ServiceLocation.label" bundle="${ss_labels}"/></th>
				</tr>		
		<%
		...
		%>
			...
			<td class='NODISPLAY'><%=CommonBean.checkForNull((String)records.get(5))%></td>
