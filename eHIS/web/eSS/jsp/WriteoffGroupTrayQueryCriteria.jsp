		...
		<form name="formWriteOffGroupTrayQueryCriteria" id="formWriteOffGroupTrayQueryCriteria" action="../../eSS/jsp/WriteOffGroupTrayQueryResult.jsp" method="post" target="frameWriteOffGroupTrayQueryResult" onreset="FocusFirstElement();">
			<table border="0" cellpadding="1" cellspacing="0" width='100%' height='100%' align='center'>
				<tr>
					...
					<td class="label">&nbsp;<input type='text' name="tray_no" id="tray_no" value="" size='<%=bean.getSsRepositoryValue("INTEGER_PRECISION")%>' maxLength='<%=bean.getSsRepositoryValue("INTEGER_PRECISION")%>' class="NUMBER" onKeyPress="return isValidInteger();"></td>
					<td class="label"><fmt:message key="eSS.OwnerStore.label" bundle="${ss_labels}"/></td>
					<td class="label">&nbsp;<select name="store_code<%=(store_code==null)?"":"_disabled"%>" id="store_code<%=(store_code==null)?"":"_disabled"%>" <%=(store_code==null)?"":"disabled"%>>
