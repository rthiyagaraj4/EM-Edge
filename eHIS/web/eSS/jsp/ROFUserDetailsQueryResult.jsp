...
%>
			<tr onClick="changeRowColor(this,8);Modify('<%=records.get(0)%>','<%=records.get(10)%>',this);" id="<%=i%>">
				<td class="<%=classvalue%>" onmouseover="changeCursor(this);"><font class='HYPERLINK'><%=records.get(1)%></font></td>
				...
				<td class="<%=classvalue%>" onclick="disableClick(event);"><%=CommonBean.checkForNull((String)records.get(8),"&nbsp;")%></td>
			</tr> 
	<%
