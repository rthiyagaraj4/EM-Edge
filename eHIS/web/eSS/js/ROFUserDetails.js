...
function query(){
	f_query_add_mod.location.href = "../../eSS/jsp/ROFUserDetailsMain.jsp?function_id="+function_id;
}
	   ...
	   if(from_date==""){
		   ...
		   return ;
			   ...
			   if (to_date=="")
			   {
				   ...
				   document.ROFDetailsQuery.action = "../../eSS/jsp/ROFUserDetailsQueryResult.jsp";
...
function Modify(doc_code,rof_status,obj)
{
	var doc_type_code		=	doc_code;
	var rof_status			=	rof_status;
	var doc_no				=	obj.cells[1].innerText;
	var tray_no				=	obj.cells[5].innerText;
	...
	var arguments = "" ;
	var title="Sterilization Request User Detail";
	var params = "doc_type_code="+doc_type_code+"&rof_status="+rof_status+"&doc_no="+doc_no+"&tray_no="+tray_no;
	retVal = window.showModalDialog("../../eSS/jsp/ROFUserDetailsQueryDetailFrame.jsp?"+params,arguments,features);
