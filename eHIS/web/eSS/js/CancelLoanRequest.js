...
var xmlHttp;
function query(){
	f_query_add_mod.location.href = "../../eSS/jsp/CancelLoanRequestQueryFrame.jsp?function_id="+function_id ; 
}
...
function apply(){
	...
	if (chkdValue<=0) {
		...
		var confirmation = confirmCancel();
		if(confirmation=="Yes"){
...
function Modify(obj){
	...
	top.content.f_query_add_mod.document.location.href="../../eSS/jsp/CancelLoanRequestFrame.jsp?mode="+MODE_MODIFY+"&function_id="+parent.parent.function_id+"&doc_type_code="+doc_type_code+"&doc_no="+doc_no;
