...
reports["SS_AUTOCL_LOAD_FAIL_STAT_LIST"]='../../eSS/jsp/AutoclaveLoadFailureStatisticsReport.jsp?module_id=SS&function_id=SS_AUTOCL_LOAD_FAIL_STAT_LIST&function_name=Autoclave Load Failure Statistics&function_type=R&access=NNNNN';
...
reports["SS_GROUP_MOVE_STAT_LIST"]='../../eSS/jsp/GroupMovementStatisticsReport.jsp?module_id=SS&function_id=SS_GROUP_MOVE_STAT_LIST&function_name=Group Movement Statistics&function_type=R&access=NNNNN';
...
reports["SS_MONTHLY_SERVICE_STAT_LIST"]='../../eSS/jsp/MonthlyServiceStatisticsReport.jsp?module_id=SS&function_id=SS_MONTHLY_SERVICE_STAT_LIST&function_name=Monthly Service Statistics&function_type=R&access=NNNNN';
reports["SS_MTH_SERV_STAT_BY_GRP_LIST"]='../../eSS/jsp/MonthlyServiceStatisticsByGroupsReport.jsp?module_id=SS&function_id=SS_MTH_SERV_STAT_BY_GRP_LIST&function_name=Monthly Service Statistics By Groups&function_type=R&access=NNNNN';
reports["SS_MTH_SERV_STAT_BY_STORE_LIST"]='../../eSS/jsp/MonthlyServiceStatisticsByStoresReport.jsp?module_id=SS&function_id=SS_MTH_SERV_STAT_BY_STORE_LIST&function_name=Monthly Service Statistics By Stores&function_type=R&access=NNNNN';
...
reports["SS_TRAY_USAGE_STAT_LIST"]='../../eSS/jsp/TraysUsageStatisticsReport.jsp?module_id=SS&function_id=SS_TRAY_USAGE_STAT_LIST&function_name=Trays Usage Statistics&function_type=R&access=NNNNN';
...
reports["SS_PACK_LABEL_6X9"]='../../eSS/jsp/ReportPackLabel.jsp?module_id=SS&function_id=SS_PACK_LABEL&function_name=Pack Label&report=SS_PACK_LABEL_6X9&function_type=R&access=NNNNN'; //ML-MMOH-CRF-1821
reports["SS_PACK_LABEL_3X5"]='../../eSS/jsp/ReportPackLabel.jsp?module_id=SS&function_id=SS_PACK_LABEL&function_name=Pack Label&report=SS_PACK_LABEL_3X5&function_type=R&access=NNNNN'; //ML-MMOH-CRF-1821
