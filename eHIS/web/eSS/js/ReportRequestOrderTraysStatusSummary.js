...
function run()
{
  ...
  var formObj=parent.f_query_add_mod.document.formRequestOrderStatusSummary;
	...
	if (isValidFromToField(formObj.p_fm_doc_type_code, formObj.p_to_doc_type_code, STRING, "Document Type", messageFrame)) 
		if (isValidFromToField(formObj.p_fm_doc_no, formObj.p_to_doc_no, LONG, "Document No", messageFrame))
...
async function searchCodeDocumentType(obj) {
	...
	dataValueArray [0]=document.formRequestOrderStatusSummary.p_facility_id.value;
	dataTypeArray  [0]=STRING

	argumentArray[0] = document.formRequestOrderStatusSummary.SQL_SS_DOC_TYPE_ROF_LIST_LOOKUP.value;
	dataNameArray  [1]="LANGUAGE_ID"
	dataValueArray [1]=document.formRequestOrderStatusSummary.locale.value;
...
async function searchCodeStoreMaster(obj) {
	...
	argumentArray[0] = document.formRequestOrderStatusSummary.SQL_SS_STORE_LOOKUP.value;
	dataNameArray  [1]="LANGUAGE_ID"
	dataValueArray [1]=document.formRequestOrderStatusSummary.locale.value;
	dataTypeArray  [1]=STRING;
