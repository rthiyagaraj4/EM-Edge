...
reports["SS_USER_STORE_LIST"]='../../eSS/jsp/ReportUserAccessForStore.jsp?module_id=SS&function_id=SS_USER_STORE_LIST&function_name=User Access for Store List&function_type=R&access=NNNNN';
reports["SS_TRAY_DETAILS_LIST"]='../../eSS/jsp/ReportTrayDetails.jsp?module_id=SS&function_id=SS_TRAY_DETAILS_LIST&function_name=Tray Details&function_type=R&access=NNNNN';
reports["SS_PATIENT_ITEM_LIST"]='../../eSS/jsp/ReportInstrumentsUsedForPatients.jsp?module_id=SS&function_id=SS_PATIENT_ITEM_LIST&function_name=Instruments used for Patients List&function_type=R&access=NNNNN';
reports["SS_TRAY_VALUE_LIST"]='../../eSS/jsp/ReportTrayValueReport.jsp?module_id=SS&function_id=SS_TRAY_VALUE_LIST&function_name=Tray Values&function_type=R&access=NNNNN';
reports["SS_DEPT_CHARGES_LIST"]='../../eSS/jsp/ReportDepartmentChargeDetails.jsp?module_id=SS&function_id=SS_DEPT_CHARGES_LIST&function_name=Department Charge Details&function_type=R&access=NNNNN';
reports["SS_CHARGES_SUMMARY_LIST"]='../../eSS/jsp/ChargesSummaryReportCriteria.jsp?module_id=SS&function_id=SS_CHARGES_SUMMARY_LIST&function_name=Charges Summary&function_type=R&access=NNNNN';
reports["SS_AGEING_ANALYSIS_LIST"]='../../eSS/jsp/AgeingAnalysisReportCriteria.jsp?module_id=SS&function_id=SS_AGEING_ANALYSIS_LIST&function_name=Ageing Analysis&function_type=R&access=NNNNN';
