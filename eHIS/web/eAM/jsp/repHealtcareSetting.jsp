	...
	<tr>
		...
		<td width="100%" class="Border" align='center'>
				...
				<table width='80%' cellPadding="0" cellSpacing="0"  align='center' >
					...
					<tr>
						<td align='right' width='30%' class="label"><fmt:message key="Common.HealthcareSettingType.label" bundle="${common_labels}"/>&nbsp;</td>
...
<tr>
				...
				<tr>
					...
					<td  width='20%' align="left">
						...
						<option value='1'><fmt:message key="Common.HealthcareSettingType.label" bundle="${common_labels}"/>
