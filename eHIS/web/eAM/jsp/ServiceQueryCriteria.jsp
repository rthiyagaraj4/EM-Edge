...
<%
	...
	{	
		...
		firstItem.add("Text");  					
		firstItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ServiceCode.label","common_labels"));		firstItem.add("service_code");				
		firstItem.add("4");							
		firstItem.add("4");							
		finAr.add(firstItem);						
		secondItem = new ArrayList();
		secondItem.add("Text");  					
		secondItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ServiceDescription.label","common_labels"));	secondItem.add("long_desc");				
		secondItem.add("30");						
		secondItem.add("30");						
		...
		thirdItem.add("List");						
		thirdItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.MedicalService.label","common_labels"));	thirdItem.add("medical_yn");				
		...
		fourthItem.add("List");						
		fourthItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eAM.AncillaryMedicalService.label","am_labels")); 	fourthItem.add("ancillary_yn");				
		...
		fifthItem.add("List");						
		fifthItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Nature.label","common_labels"));			fifthItem.add("eff_status");				
