...
<tr>
				...
				<tr>
					...
					<td  width='20%' align="left" colspan='2'>
						...
						<option value='1,3'><fmt:message key="Common.FloorCode.label" bundle="${common_labels}"/>
						<option value='1,4'><fmt:message key="eAM.FloorDescription.label" bundle="${am_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
