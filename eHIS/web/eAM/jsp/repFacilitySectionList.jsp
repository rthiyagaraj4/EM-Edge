...
<tr>
				...
				<tr>
					...
					<td  width='20%' align="left" colspan='2'>
						...
						<option value='1,2,3'><fmt:message key="Common.SectionCode.label" bundle="${common_labels}"/>
						<option value='1,2,4'><fmt:message key="Common.SectionDescription.label" bundle="${common_labels}"/>
						</select>
					</td>
				</tr>
				<tr>
