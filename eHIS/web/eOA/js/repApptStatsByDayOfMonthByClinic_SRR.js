...
/*function searchCode(obj,target)
{
	...
	if(obj.name=="locn")
	{
		...
		sql="select clinic_code, long_desc, facility_id from op_clinic_lang_vw where facility_id=`"+facilityid+"` and language_id=`"+locale+"` and CARE_LOCN_TYPE_IND=nvl(`"+p_location_type1+"`,CARE_LOCN_TYPE_IND)";
