...
function create(){
	f_query_add_mod.location.href="../../eCP/jsp/AssessmentCategoryAddModify.jsp?mode=1";
}
/*************************************************/
function apply(){	
	...
	if(mode=="2"){
		...
		qry_str="&assess_catg_code="+frmobj.assess_catg_code.value+"&long_desc="+frmobj.assessment_long_desc.value+"&short_desc="+frmobj.assessment_short_desc.value+"&eff_status="+frmobj.eff_status.value;
	}

	var error_page = "../../eCommon/jsp/MstCodeError.jsp";
	var fields = new Array (frmobj.assess_catg_code,frmobj.assessment_long_desc,frmobj.assessment_short_desc);			    
	...
	var fields1 = new Array (frmobj.assess_catg_code);			    
...
function onSuccess(){	 
	...
	if(mode == "1")
	{
		...
		f_query_add_mod.location.href='../../eCP/jsp/AssessmentCategoryAddModify.jsp?mode=2'+qry_str;
}
/*************************************************/
...
function query()
{
	f_query_add_mod.location.href="../../eCP/jsp/AssessmentCategoryQueryCriteria.jsp";
}
/********************************************/
