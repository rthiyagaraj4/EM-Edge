...
function create()
{
	f_query_add_mod.location.href="../../eCP/jsp/AgeGroupForInterventionFrameSet.jsp";
}
//*******************************************************************************************************
function query()
{
	f_query_add_mod.location.href="../../eCP/jsp/AgeGroupForInterventionQueryCriteria.jsp";
}
//*************

function searchDetails()
  {
	  parent.frames[2].location.href='../../eCP/jsp/AgeGroupForInterventionDynamicValues.jsp';
	  var frmobj=parent.f_query_header.document.form_add_mod ;
	  var fields = new Array (frmobj.age_group_code);			    
	  var names = new Array (getLabel("Common.agegroupcode.label","Common"));	
	  var	msgFrame=parent.parent.messageFrame;
	
	  if(parent.f_query_header.checkFieldsofMst( fields, names, msgFrame))
		{	
		    parent.frames[1].location.href='../../eCP/jsp/AgeGroupForInterventionDetail.jsp?age_group_code='+frmobj.age_group_code.value+'&fromSearch=true';
...
if (! checkIsValidForProceed() ) {
	...
	parent.frames[2].frames[1].frames[1].document.forms[0].action="../../servlet/eCP.AgeGroupForInterventionServlet";
