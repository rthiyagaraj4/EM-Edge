...
%>
	<form name="TaskStatusReportPrint" id="TaskStatusReportPrint" target="messageFrame">
		...
		<tr>
			<td colspan=4 align='right'><INPUT TYPE="button" name="printRep" id="printRep" class="button" value='<fmt:message key="Common.print.label" bundle="${common_labels}"/>' onclick="printFun();"></td><!-- IN067699 controlling print button -->
		</tr>
		</table>
