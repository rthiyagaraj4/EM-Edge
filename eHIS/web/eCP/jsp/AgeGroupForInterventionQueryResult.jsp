...
<%@ page import ="java.sql.*,java.util.*,webbeans.eCommon.*, eCP.*,eCommon.XSSRequestWrapper" contentType="text/html;charset=UTF-8" %>
...
<tr>
	...
	<th width="10%" align='left'><fmt:message key="Common.agegroupcode.label" bundle="${common_labels}"/></th>
	<th width="20%" align='left'><fmt:message key="Common.agegroupdesc.label" bundle="${common_labels}"/></th>
