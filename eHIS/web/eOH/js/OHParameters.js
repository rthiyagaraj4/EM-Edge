...
/*	var formObj = document.OHSetupParameterForm;
	var params = "";
	if(formObj!=null) params = formObj.params.value;
	messageFrame.location.href = "../../eCommon/jsp/error.jsp?err_num=";
	f_query_add_mod.document.location.href="../../eOH/jsp/OHParameters.jsp?"+params;*/

	function reset(){  
	var formObj = document.OHSetupParameterForm;
	var params = "";
		if(f_query_add_mod.document.OHSetupParameterForm.chart_level1.value=="F" || f_query_add_mod.document.OHSetupParameterForm.chart_level1.value=="" || f_query_add_mod.document.OHSetupParameterForm.chart_level1.value=="null"|| f_query_add_mod.document.OHSetupParameterForm.chart_level1.value==null){
			if(formObj!=null) params = formObj.params.value;
		
			messageFrame.location.href = "../../eCommon/jsp/error.jsp?err_num=";
			f_query_add_mod.document.location.href="../../eOH/jsp/OHParameters.jsp?"+params;
			
		 }else if(f_query_add_mod.document.OHSetupParameterForm.chart_level1.value=="E"){
...
function apply(){
	...
	if (formObj.chart_level1.value=="F" || (formObj.chart_level1.value=="" || formObj.chart_level1.value==null || formObj.chart_level1.value=="null") ){
			var tooth_numbering_system = formObj.tooth_numbering_system.value;
			if (formObj.chart_level1.value=="F"){
				formObj.dflt_chart.value="";
				formObj.dflt_mixed_dentition_chart.value="";
			}
			
			var fields = new Array (formObj.chart_level1);
			var names = new Array (chart_level_label);

			var fields_1=new Array (formObj.chart_level1.value,formObj.res_rep2.value);
			var names_1=new Array (formObj.chart_level1.DB_VALUE,formObj.res_rep1.value);

			var chk_null=checkNullFieldGingival(fields_1,names_1);

			if (chk_null==false){
				formObj.chk_recorded.value="N";
			}else if(chk_null == true){
				formObj.chk_recorded.value="Y";
			}
			
			if(checkFieldsofMst( fields, names, messageFrame)){
			formObj.action="../../servlet/eOH.OHParameters";
		...
		var gingival_recording_by=formObj.gigival_recorded.value;
...
function AssignParamDBValue(gingival_recording_by,record_gingival_status_yn){
	//alert("AssignParamDBValue")
	/*var obj = document.forms[0];
	var mode = document.forms[0].mode.value;
	
	if(mode == "modify"){
		if(obj.chart_level1.DB_VALUE == "" ){
			obj.chart_level1.value = "";
			obj.chart_level1.disabled = false;
		}
		else{
			obj.chart_level1.value = obj.chart_level1.DB_VALUE;
			obj.chart_level1.disabled = false;
		}
	}*/
    ...
    var gingival_recording_by=gingival_recording_by;
	   if (record_gingival_status_yn=="" || record_gingival_status_yn==null || record_gingival_status_yn=="null") { 
		   obj.gingival[0].disabled=true;
		   obj.gingival[1].disabled=true;
		
	   }
	   if (chrt_level=="E"){
		   document.getElementById("ohparam").style.visibility = 'visible';
		   document.getElementById("ohparam").style.display = 'block';
	   }
	  // alert("AssignParamDBValue chrt_level=="+chrt_level)
	  // alert("AssignParamDBValue gingival_recording_by=="+gingival_recording_by)
		if(mode == "modify"){
			...
			if(obj.chart_level1.DB_VALUE == "" ){
				...
				obj.chart_level1.value = obj.chart_level1.DB_VALUE;
				obj.chart_level1.disabled = true;
			}
...
function populateChart(){
		var obj = document.forms[0];
		chart_level=obj.chart_level1.value;
		var gingival_recording_by=obj.gingival_recording_by.value;
		if (chart_level=="E"){
			document.getElementById("ohparam").style.visibility = 'visible';
			document.getElementById("ohparam").style.display = 'block';
		//	messageFrame.location.href = "../../eCommon/jsp/error.jsp?err_num=";
			if (gingival_recording_by=="Q"){
			    parent.f_query_add_mod_gs.document.location.href="../../eOH/jsp/OHParamForFacilityAddModifyQuadrant.jsp";
			}else if (gingival_recording_by=="S" || gingival_recording_by==""){
				parent.f_query_add_mod_gs.document.location.href="../../eOH/jsp/OHParamForFacilityAddModifySextant.jsp";
				obj.gigival_recorded.value="S";
				top.content.messageFrame.location.href = "../../eCommon/jsp/MstCodeError.jsp?err_num=" ;

			}
		}else if (chart_level=="F" || chart_level=="" || chart_level=="null" || chart_level==null){
				document.getElementById("ohparam").style.visibility = 'hidden';
				document.getElementById("ohparam").style.display = 'block';
			if (gingival_recording_by=="Q"){
				 parent.f_query_add_mod_gs.document.location.href='../../eCommon/html/blank.html'
			}else if (gingival_recording_by=="S"){
			   	parent.f_query_add_mod_gs.document.location.href='../../eCommon/html/blank.html'
			}else if (gingival_recording_by=="" || gingival_recording_by=="null" || gingival_recording_by==null){
			 	parent.f_query_add_mod_gs.document.location.href='../../eCommon/html/blank.html'
				top.content.messageFrame.location.href = "../../eCommon/jsp/MstCodeError.jsp?err_num=" ;
			}
		}
	}
function setParamCheckValue(){
	//alert("setParamCheckValue")
	var obj = document.forms[0];
	var frmObj = parent.f_query_add_mod_gs.document.forms[0];
	...
	if(obj.record_gingival_status_yn.checked==true){
		...
		if (gingival_recording_by=="Q"){
			parent.f_query_add_mod_gs.document.location.href="../../eOH/jsp/OHParamForFacilityAddModifyQuadrant.jsp?record_gingival_status_yn=Y&callFrom=T&tooth_numbering_system="+tooth_numbering_system+"&from_mixed_dentition="+from_mixed_dentition;
			...
			frmObj.md_gs_dflt_tooth_no_Q4.value = "";
			 top.content.messageFrame.location.href = "../../eCommon/jsp/MstCodeError.jsp?err_num=" ;
				...
				parent.f_query_add_mod_gs.document.location.href="../../eOH/jsp/OHParamForFacilityAddModifySextant.jsp?record_gingival_status_yn=Y&callFrom=T&tooth_numbering_system="+tooth_numbering_system+"&from_mixed_dentition="+from_mixed_dentition;
		...
		if(window.confirm(getMessage("APP-OH00092","OH")) == true)
		{
         ...
         //   tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
          ...
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
		   ...
		   /* parent.f_query_add_mod_gs.document.getElementById("gs_for_Q1").innerHTML = '<input type="text" name="gs_no_of_tooth_for_Q1" id="gs_no_of_tooth_for_Q1" value="" size="1" maxlength="1" onBlur="validateNumOfTooth(this)">';
			...
			var tab="";
			tab+='<select name="gs_dflt_tooth_no_Q1" id="gs_dflt_tooth_no_Q1" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("gs_dflt_for_Q1").innerHTML=tab;
			var tab="";
			tab+='<select name="gs_dflt_tooth_no_Q2" id="gs_dflt_tooth_no_Q2" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("gs_dflt_for_Q2").innerHTML=tab;
			var tab="";
			tab+='<select name="gs_dflt_tooth_no_Q3" id="gs_dflt_tooth_no_Q3" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("gs_dflt_for_Q3").innerHTML=tab;
			var tab="";
			tab+='<select name="gs_dflt_tooth_no_Q4" id="gs_dflt_tooth_no_Q4" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
           // tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
          ...
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			...
			var tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_Q1" id="dec_gs_dflt_tooth_no_Q1" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
           // tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("dec_gs_dflt_for_Q1").innerHTML=tab;
			var tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_Q2" id="dec_gs_dflt_tooth_no_Q2" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("dec_gs_dflt_for_Q2").innerHTML=tab;
			var tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_Q3" id="dec_gs_dflt_tooth_no_Q3" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
           // tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("dec_gs_dflt_for_Q3").innerHTML=tab;
			var tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_Q4" id="dec_gs_dflt_tooth_no_Q4" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
           // tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
         ...
         //   tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			...
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_Q1").innerHTML ='<select name="md_gs_dflt_tooth_no_Q1" id="md_gs_dflt_tooth_no_Q1" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_Q2").innerHTML = '<select name="md_gs_dflt_tooth_no_Q2" id="md_gs_dflt_tooth_no_Q2" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_Q3").innerHTML = '<select name="md_gs_dflt_tooth_no_Q3" id="md_gs_dflt_tooth_no_Q3" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_Q4").innerHTML = '<select name="md_gs_dflt_tooth_no_Q4" id="md_gs_dflt_tooth_no_Q4" value= "" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
         ...
         //   tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			...
			tab="";
			tab+='<select name="gs_dflt_tooth_no_S1" id="gs_dflt_tooth_no_S1" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("gs_dflt_for_S1").innerHTML=tab;
			tab="";
			tab+='<select name="gs_dflt_tooth_no_S2" id="gs_dflt_tooth_no_S2" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("gs_dflt_for_S2").innerHTML=tab;
			tab="";
			tab+='<select name="gs_dflt_tooth_no_S3" id="gs_dflt_tooth_no_S3" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("gs_dflt_for_S3").innerHTML=tab;
			tab="";
			tab+='<select name="gs_dflt_tooth_no_S4" id="gs_dflt_tooth_no_S4" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
         //   tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("gs_dflt_for_S4").innerHTML=tab;
			tab="";
			tab+='<select name="gs_dflt_tooth_no_S5" id="gs_dflt_tooth_no_S5" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
         //   tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("gs_dflt_for_S5").innerHTML=tab;
			tab="";
			tab+='<select name="gs_dflt_tooth_no_S6" id="gs_dflt_tooth_no_S6" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
        //    tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
       ...
       //     tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			...
			tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_S1" id="dec_gs_dflt_tooth_no_S1" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
         //   tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("dec_gs_dflt_for_S1").innerHTML=tab;
			tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_S2" id="dec_gs_dflt_tooth_no_S2" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
        //    tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("dec_gs_dflt_for_S2").innerHTML=tab;
			tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_S3" id="dec_gs_dflt_tooth_no_S3" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("dec_gs_dflt_for_S3").innerHTML=tab;
            tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_S4" id="dec_gs_dflt_tooth_no_S4" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("dec_gs_dflt_for_S4").innerHTML=tab;
			tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_S5" id="dec_gs_dflt_tooth_no_S5" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			parent.f_query_add_mod_gs.document.getElementById("dec_gs_dflt_for_S5").innerHTML=tab;
			tab="";
			tab+='<select name="dec_gs_dflt_tooth_no_S6" id="dec_gs_dflt_tooth_no_S6" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
         //   tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
          ...
          //  tab+="<img src='../../eCommon/images/mandatory.gif'></img>";
			...
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_S1").innerHTML ='<select name="md_gs_dflt_tooth_no_S1" id="md_gs_dflt_tooth_no_S1" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_S2").innerHTML ='<select name="md_gs_dflt_tooth_no_S2" id="md_gs_dflt_tooth_no_S2" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_S3").innerHTML ='<select name="md_gs_dflt_tooth_no_S3" id="md_gs_dflt_tooth_no_S3" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_S4").innerHTML ='<select name="md_gs_dflt_tooth_no_S4" id="md_gs_dflt_tooth_no_S4" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_S5").innerHTML ='<select name="md_gs_dflt_tooth_no_S5" id="md_gs_dflt_tooth_no_S5" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
			parent.f_query_add_mod_gs.document.getElementById("md_gs_dflt_for_S6").innerHTML ='<select name="md_gs_dflt_tooth_no_S6" id="md_gs_dflt_tooth_no_S6" value="" onChange="populateParamToothNo(this)"><option value="">'+default_select_lable+'</option></select>';
...
function populateParamToothNo(obj,mixed_val,from_mixed){
	var frmObj = parent.f_query_add_mod_gs.document.forms[0];
	var formObj = document.forms[0];
    var gingival_recording_by=frmObj.gigival_recorded.value;
	...
	//alert("populateParamToothNo==="+gingival_recording_by)
...
function loadParamQuadDtls(){
	//alert("loadParamQuadDtls")
	var formObj = document.forms[0];
	var record_gingival_status_yn = formObj.record_gingival_status_yn.value;
	var tooth_numbering_system = formObj.tooth_numbering_system.value;
	if(formObj.record_gingival_status_yn.checked == true){
...
function loadParamSextantDtls(){
		var formObj = document.forms[0];

	//alert("loadParamSextantDtls=="+formObj.gigival_recorded.value)
	var record_gingival_status_yn = formObj.record_gingival_status_yn.value;
	var tooth_numbering_system = formObj.tooth_numbering_system.value;
	var tooth_numbering_system = formObj.tooth_numbering_system.value;
...
function AssignParamSextantValue(tooth_numbering_system,record_gingival_status_yn){
	//alert("AssignParamSextantValue")
	var obj = document.forms[0];
	...
	//alert("AssignParamSextantValue::mode====="+mode)
	if(mode == "modify"){
	...
	populateParamToothNo(formObj.tooth_numbering_system,mixed_val,from_mixed);	
...
function AssignParamQuadrantValue(){
//	alert("AssignParamQuadrantValue")
	var obj = document.forms[0];
	var mode ="";
	if(document.forms[0].mode == null || document.forms[0].mode == "null"){
		mode = "";
...
function checkParamRadio(){
	...
	var dflt_mixed_dentition_chart=formObj.dflt_mixed_dentition_chart.value;
	var chart_level1=formObj.chart_level1.value;
	var from_mixed_dentition="";
	if (dflt_mixed_dentition_chart=="P"){
		from_mixed_dentition="P";
	}else if (dflt_mixed_dentition_chart=="D"){
	 ...
	 if(formObj.record_gingival_status_yn.checked==true){
			...
			var msg="";
			var msg_arr="";
			var validate_gingival = checkForGingival();
			 if(validate_gingival==true){
				...
				if (gingival_recording=="Q"){
					 final_msg=msg_arr[0]+getLabel("eOH.Quadrant.Label","OH")+msg_arr[1];
				}else{
					final_msg=msg_arr[0]+getLabel("eOH.Sextant.Label","OH")+msg_arr[1];
				}
			// }
		var chk_msg="";
		...
		if(chk_msg=="Y"){
			...
			if(window.confirm(final_msg) == true){
				...
				if (gingival_recording=="S"){
						...
						parent.f_query_add_mod_gs.document.location.href="../../eOH/jsp/OHParamForFacilityAddModifyQuadrant.jsp?record_gingival_status_yn=Y&tooth_numbering_system="+tooth_numbering_system+"&from_mixed_dentition="+from_mixed_dentition+"&chart_level="+chart_level1;
				}
				else{
						formObj.gigival_recorded.value="S";
						parent.f_query_add_mod_gs.document.location.href="../../eOH/jsp/OHParamForFacilityAddModifySextant.jsp?record_gingival_status_yn=Y&tooth_numbering_system="+tooth_numbering_system+"&from_mixed_dentition="+from_mixed_dentition+"&chart_level="+chart_level1;
				}
			...
			if (gingival_recording=="S"){
				...
				//var params= "record_gingival_status_yn=Y&tooth_numbering_system="+tooth_numbering_system+"&gs_no_of_tooth_for_S1_hidden="+gs_no_of_tooth_for_S1_hidden+"&gs_no_of_tooth_for_S2_hidden="+gs_no_of_tooth_for_S2_hidden+"&gs_no_of_tooth_for_S3_hidden="+gs_no_of_tooth_for_S3_hidden+"&gs_no_of_tooth_for_S4_hidden="+gs_no_of_tooth_for_S4_hidden+"&gs_no_of_tooth_for_S5_hidden="+gs_no_of_tooth_for_S5_hidden+"&gs_no_of_tooth_for_S6_hidden="+gs_no_of_tooth_for_S6_hidden+"&gs_dflt_tooth_no_S1_hidden="+gs_dflt_tooth_no_S1_hidden+"&gs_dflt_tooth_no_S2_hidden="+gs_dflt_tooth_no_S2_hidden+"&gs_dflt_tooth_no_S3_hidden="+gs_dflt_tooth_no_S3_hidden+"&gs_dflt_tooth_no_S4_hidden="+gs_dflt_tooth_no_S4_hidden+"&gs_dflt_tooth_no_S5_hidden="+gs_dflt_tooth_no_S5_hidden+"&gs_dflt_tooth_no_S6_hidden="+gs_dflt_tooth_no_S6_hidden+"&callFrom=S";
				var params= "record_gingival_status_yn=Y&tooth_numbering_system="+tooth_numbering_system+"&gs_no_of_tooth_for_S1_hidden="+gs_no_of_tooth_for_S1_hidden+"&gs_no_of_tooth_for_S2_hidden="+gs_no_of_tooth_for_S2_hidden+"&gs_no_of_tooth_for_S3_hidden="+gs_no_of_tooth_for_S3_hidden+"&gs_no_of_tooth_for_S4_hidden="+gs_no_of_tooth_for_S4_hidden+"&gs_no_of_tooth_for_S5_hidden="+gs_no_of_tooth_for_S5_hidden+"&gs_no_of_tooth_for_S6_hidden="+gs_no_of_tooth_for_S6_hidden+"&gs_dflt_tooth_no_S1_hidden="+gs_dflt_tooth_no_S1_hidden+"&gs_dflt_tooth_no_S2_hidden="+gs_dflt_tooth_no_S2_hidden+"&gs_dflt_tooth_no_S3_hidden="+gs_dflt_tooth_no_S3_hidden+"&gs_dflt_tooth_no_S4_hidden="+gs_dflt_tooth_no_S4_hidden+"&gs_dflt_tooth_no_S5_hidden="+gs_dflt_tooth_no_S5_hidden+"&gs_dflt_tooth_no_S6_hidden="+gs_dflt_tooth_no_S6_hidden+"&dec_gs_no_of_tooth_for_S1_hidden="+dec_gs_no_of_tooth_for_S1_hidden+"&dec_gs_no_of_tooth_for_S2_hidden="+dec_gs_no_of_tooth_for_S2_hidden+"&dec_gs_no_of_tooth_for_S3_hidden="+dec_gs_no_of_tooth_for_S3_hidden+"&dec_gs_no_of_tooth_for_S4_hidden="+dec_gs_no_of_tooth_for_S4_hidden+"&dec_gs_no_of_tooth_for_S5_hidden="+dec_gs_no_of_tooth_for_S5_hidden+"&dec_gs_no_of_tooth_for_S6_hidden="+dec_gs_no_of_tooth_for_S6_hidden+"&dec_gs_dflt_tooth_no_S1_hidden="+dec_gs_dflt_tooth_no_S1_hidden+"&dec_gs_dflt_tooth_no_S2_hidden="+dec_gs_dflt_tooth_no_S2_hidden+"&dec_gs_dflt_tooth_no_S3_hidden="+dec_gs_dflt_tooth_no_S3_hidden+"&dec_gs_dflt_tooth_no_S4_hidden="+dec_gs_dflt_tooth_no_S4_hidden+"&dec_gs_dflt_tooth_no_S5_hidden="+dec_gs_dflt_tooth_no_S5_hidden+"&dec_gs_dflt_tooth_no_S6_hidden="+dec_gs_dflt_tooth_no_S6_hidden+"&md_gs_no_of_tooth_for_S1_hidden="+md_gs_no_of_tooth_for_S1_hidden+"&md_gs_no_of_tooth_for_S2_hidden="+md_gs_no_of_tooth_for_S2_hidden+"&md_gs_no_of_tooth_for_S3_hidden="+md_gs_no_of_tooth_for_S3_hidden+"&md_gs_no_of_tooth_for_S4_hidden="+md_gs_no_of_tooth_for_S4_hidden+"&md_gs_no_of_tooth_for_S5_hidden="+md_gs_no_of_tooth_for_S5_hidden+"&md_gs_no_of_tooth_for_S6_hidden="+md_gs_no_of_tooth_for_S6_hidden+"&md_gs_dflt_tooth_no_S1_hidden="+md_gs_dflt_tooth_no_S1_hidden+"&md_gs_dflt_tooth_no_S2_hidden="+md_gs_dflt_tooth_no_S2_hidden+"&md_gs_dflt_tooth_no_S3_hidden="+md_gs_dflt_tooth_no_S3_hidden+"&md_gs_dflt_tooth_no_S4_hidden="+md_gs_dflt_tooth_no_S4_hidden+"&md_gs_dflt_tooth_no_S5_hidden="+md_gs_dflt_tooth_no_S5_hidden+"&md_gs_dflt_tooth_no_S6_hidden="+md_gs_dflt_tooth_no_S6_hidden+"&from_mixed_dentition="+from_mixed_dentition+"&chart_level="+chart_level1+"&callFrom=S";
			...
			params="record_gingival_status_yn=Y&tooth_numbering_system="+tooth_numbering_system+"&gs_no_of_tooth_for_Q1_hidden="+gs_no_of_tooth_for_Q1_hidden+"&gs_no_of_tooth_for_Q2_hidden="+gs_no_of_tooth_for_Q2_hidden+"&gs_no_of_tooth_for_Q3_hidden="+gs_no_of_tooth_for_Q3_hidden+"&gs_no_of_tooth_for_Q4_hidden="+gs_no_of_tooth_for_Q4_hidden+"&gs_dflt_tooth_no_Q1_hidden="+gs_dflt_tooth_no_Q1_hidden+"&gs_dflt_tooth_no_Q2_hidden="+gs_dflt_tooth_no_Q2_hidden+"&gs_dflt_tooth_no_Q3_hidden="+gs_dflt_tooth_no_Q3_hidden+"&gs_dflt_tooth_no_Q4_hidden="+gs_dflt_tooth_no_Q4_hidden+"&dec_gs_no_of_tooth_for_Q1_hidden="+dec_gs_no_of_tooth_for_Q1_hidden+"&dec_gs_no_of_tooth_for_Q2_hidden="+dec_gs_no_of_tooth_for_Q2_hidden+"&dec_gs_no_of_tooth_for_Q3_hidden="+dec_gs_no_of_tooth_for_Q3_hidden+"&dec_gs_no_of_tooth_for_Q4_hidden="+dec_gs_no_of_tooth_for_Q4_hidden+"&dec_gs_dflt_tooth_no_Q1_hidden="+dec_gs_dflt_tooth_no_Q1_hidden+"&dec_gs_dflt_tooth_no_Q2_hidden="+dec_gs_dflt_tooth_no_Q2_hidden+"&dec_gs_dflt_tooth_no_Q3_hidden="+dec_gs_dflt_tooth_no_Q3_hidden+"&dec_gs_dflt_tooth_no_Q4_hidden="+dec_gs_dflt_tooth_no_Q4_hidden+"&md_gs_no_of_tooth_for_Q1_hidden="+md_gs_no_of_tooth_for_Q1_hidden+"&md_gs_no_of_tooth_for_Q2_hidden="+md_gs_no_of_tooth_for_Q2_hidden+"&md_gs_no_of_tooth_for_Q3_hidden="+md_gs_no_of_tooth_for_Q3_hidden+"&md_gs_no_of_tooth_for_Q4_hidden="+md_gs_no_of_tooth_for_Q4_hidden+"&md_gs_dflt_tooth_no_Q1_hidden="+md_gs_dflt_tooth_no_Q1_hidden+"&md_gs_dflt_tooth_no_Q2_hidden="+md_gs_dflt_tooth_no_Q2_hidden+"&md_gs_dflt_tooth_no_Q3_hidden="+md_gs_dflt_tooth_no_Q3_hidden+"&md_gs_dflt_tooth_no_Q4_hidden="+md_gs_dflt_tooth_no_Q4_hidden+"&from_mixed_dentition="+from_mixed_dentition+"&chart_level="+chart_level1+"&callFrom=Q";
...
function populateParamMixedDentition(){
//	alert("populateMixedDentition")
	var obj = document.forms[0];
	var frmObj = parent.f_query_add_mod_gs.document.forms[0];
	var dflt_mixed_dentition_chart = document.forms[0].dflt_mixed_dentition_chart.value;
...
function loadParamGingivalStatus(){
	//alert("loadParamGingivalStatus")
		var obj = document.forms[0];
        var chrt_level=obj.chrt_level.value;
		if ((chrt_level=="" || chrt_level=="null"|| chrt_level==null) && obj.gigival_recorded.value==""){
			parent.f_query_add_mod_gs.document.location.href='../../eCommon/html/blank.html'
			//messageFrame.location.href = "../../eCommon/jsp/error.jsp?err_num=";
		...
		}else if (chrt_level=="E" && obj.gigival_recorded.value=="S"){
		  parent.f_query_add_mod_gs.document.location.href="../../eOH/jsp/OHParamForFacilityAddModifySextant.jsp??chrt_level="+chrt_level;
		//  parent.messageFrame.location.href = "../../eCommon/jsp/error.jsp?err_num=";

		}
}

function checkForGingival(){
//	alert("checkForGingival")
		...
		var gingval_chk=checkFieldsofMstGingival(fields,names);
			return gingval_chk;
	}	
	function checkFieldsofMstGingival( fields,names){
...
function checkNullFieldGingival(fields_1,names_1){
	
	if (fields_1[0]==names_1[0] && fields_1[1]==names_1[1]){
		return false;
	}else{
		return true;
	}
...
//	alert("checkRecorded")
	...
	if (formObj.res_rep1.value==formObj.res_rep2.value){
		errors=0;
	}else{
		errors=1;
		return;
	...
	if(frm.gigival_recorded.value=="S"){
...
function setCheckValue(val){
	var obj = document.forms[0];
	if(obj.res_rep.checked==true){
		obj.res_rep.value="Y";
		obj.res_rep2.value="Y";
	}else{
		obj.res_rep.value="N";
		obj.res_rep2.value="N";
	}
}

//Added by Sharon Crasta on 11/17/2009 for IN016376
//Added to disable the backspace key.
function checkBackspaceKey(){
