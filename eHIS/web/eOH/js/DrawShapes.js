...
text both horizontally (e.g. right) and vertically within that rectangle */
	...
	this.htm = "";
	//this.wnd = wnd || window;
	//this.wnd = wnd || parent.parent.conditionDentalChartDetails || parent.conditionDentalChartDetails||window;
	//this.wnd = wnd || parent.parent.conditionDentalChartDetails || parent.conditionDentalChartDetails || parent.trmtDentalChartDetails || top.content.workAreaFrame.frames[1].frames[2].frames[1] || window;
	//this.wnd = wnd || parent.parent.parent.conditionDentalChartDetails || parent.parent.conditionDentalChartDetails || parent.conditionDentalChartDetails || parent.trmtDentalChartDetails || top.content.workAreaFrame.frames[1].frames[2].frames[1] || window;
	if(top.content!=null){
	this.wnd = wnd || parent.parent.parent.conditionDentalChartDetails || parent.parent.conditionDentalChartDetails || parent.conditionDentalChartDetails || parent.trmtDentalChartDetails  || top.content.workAreaFrame.frames[2].frames[1].frames[1] || top.content.workAreaFrame.frames[1].frames[2].frames[1] || window;}
	else
	{
	this.wnd = wnd || parent.parent.parent.conditionDentalChartDetails || parent.parent.conditionDentalChartDetails || parent.conditionDentalChartDetails || parent.trmtDentalChartDetails  || parent.parent.frames[2].frames[1].frames[1] || parent.parent.frames[1].frames[2].frames[1] || window;
	}
