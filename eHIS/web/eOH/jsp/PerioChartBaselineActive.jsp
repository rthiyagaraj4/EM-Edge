					...
					<td valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="1">
						<tr>
							<td><table width="100%" border="0" >
								<tr>
								<!-- <th align="left"><fmt:message key='eOH.BaselineCharts.Label' bundle='${oh_labels}'/>(Active)</th> -->
								<th align="left"><fmt:message key='eOH.BaselineCharts.Label' bundle='${oh_labels}'/></th>
								<th align="right" width="10%"><img name="BCA_arrow" src="../../eOH/images/arrow-down.gif" alt="Arrow" height="20" align="middle" onclick="expandMenu('menuBCA',this);" <%=disabled%>/></th>
								</tr>
							</table></td>
						</tr>
						<tr>
