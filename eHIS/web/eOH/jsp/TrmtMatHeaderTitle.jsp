...
%>
		...
		<table align='center' cellpadding='4' cellspacing='' border='0' width='98%'>
			...
			%>		<tr>
						<!-- <td  width='45%' ><A onclick = "populateCompositionDetails('<%=task_code_req%>','<%=task_desc%>','<%=status_disabled%>','<%=seq_no%>');" onmouseover="this.style.color='blue'" onmouseout = "this.style.color=''" style='cursor:pointer'><%=task_desc%></A></td> -->
						<!-- <td  width='45%' ><font color='blue'><A onclick = "populateCompositionDetails('<%=task_code_req%>','<%=task_desc%>','<%=status_disabled%>','<%=seq_no%>');" onmouseover="this.style.color='blue'" onmouseout = "this.style.color=''" style='cursor:pointer'><%=task_desc%></A></font></td> -->
						<td  width='45%' ><font color='blue'><A onclick = "populateCompositionDetails('<%=task_code_req%>','<%=java.net.URLEncoder.encode(task_desc)%>','<%=status_disabled%>','<%=seq_no%>');" onmouseover="this.style.color='blue'" onmouseout = "this.style.color=''" style='cursor:pointer'><%=task_desc%></A></font></td>
			<%	 
						if(trmt_dtls_entry_cmpl_yn.equals("N") || trmt_dtls_entry_cmpl_yn.equals("")){
			%>
							<td width="25%">
								<input type="checkbox" name="completed<%=count%>" id="completed<%=count%>" onClick="setCheckValue(count);updatetrmtdtlsentry(this,'<%=task_code_req%>','<%=java.net.URLEncoder.encode(task_desc)%>','<%=seq_no%>','<%=count%>');" value='' <%=status_disabled%> >
							</td>
			...
			%>
							<td width="25%">
								<input type="checkbox" name="completed<%=count%>" id="completed<%=count%>" onClick="setCheckValue(count);updatetrmtdtlsentry(this,'<%=task_code_req%>','<%=java.net.URLEncoder.encode(task_desc)%>','<%=seq_no%>','<%=count%>');" value='' checked disabled <%=status_disabled%>>
			...
			%>		
						<tr>
							<!-- <td  width='45%' ><font color='blue'><A onclick = "populateCompositionDetails('<%=DB_task_code%>','<%=DB_task_desc%>','<%=status_disabled%>','<%=DB_task_seq%>');" onmouseover="this.style.color='blue'" onmouseout = "this.style.color=''" style='cursor:pointer'><%=DB_task_desc%></A></font></td> -->
							<td  width='45%' ><font color='blue'><A onclick = "populateCompositionDetails('<%=DB_task_code%>','<%=DB_task_desc%>','<%=status_disabled%>','<%=DB_task_seq%>');" style='cursor:pointer'><%=DB_task_desc%></A></font></td>
			<%	 
							if(trmt_dtls_entry_cmpl_yn.equals("N") || trmt_dtls_entry_cmpl_yn.equals("")){
			%>
								<td width="25%">
									<input type="checkbox" name="completed<%=count%>" id="completed<%=count%>" onClick="setCheckValue(count);updatetrmtdtlsentry(this,'<%=DB_task_code%>','<%=DB_task_desc%>','<%=DB_task_seq%>','<%=count%>');" value='' <%=status_disabled%> > 
								</td>
			...
			%>
								<td width="25%">
									<input type="checkbox" name="completed<%=count%>" id="completed<%=count%>" onClick="setCheckValue(count);updatetrmtdtlsentry(this,'<%=DB_task_code%>','<%=DB_task_desc%>','<%=DB_task_seq%>','<%=count%>');" value='' checked disabled <%=status_disabled%>>
								</td>
			<%	
							}
			%>
		...
		<input type="hidden" name= "trmt_dtls_entry_cmpl_yn" value = "<%=trmt_dtls_entry_cmpl_yn%>">
