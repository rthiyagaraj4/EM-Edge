...
<tr>	
	   <td class='label' width='25%' >
			<fmt:message key="eOH.Complication.Label" bundle="${oh_labels}"/>
		</td>
		<td  class="fields"  width='35%'>
			<input type="text"  name="complication_desc" id="complication_desc" size='30' maxlength='40' value="<%=desc%>" <%=task_code_disable%> onBlur="if(this.value!='') getComplicationLookUp(complication_code,complication_desc);getTreatment(this);">
			<input type="hidden" name="complication_code" id="complication_code" value="<%=complication_code%>">
			<input type="button" class="button" name="Complication_lookup" id="Complication_lookup" value="?" onclick="getComplicationLookUp(complication_code,complication_desc);getTreatment(this);" <%=task_code_disable%>>
		<% 
