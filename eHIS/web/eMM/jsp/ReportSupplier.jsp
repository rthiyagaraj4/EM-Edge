...
//		String p_report_id = null;
	...
	<body onLoad="FocusFirstElement();">
			...
			<td width='100%'  class="WHITE">
				...
				<tr>
					...
					<td class=fields colspan='3'>&nbsp;&nbsp;<select name="p_order_by" id="p_order_by" >
 					<option value='1'><fmt:message key="Common.SupplierCode.label" bundle="${common_labels}"/></option>
					<option value='2'><fmt:message key="eMM.SupplierDescription.label" bundle="${mm_labels}"/></option>
					</select></td>
				</tr>
				<tr>
					<td >&nbsp;</td>
		...
		<input type="hidden" name="SQL_AP_SUPPLIER_SELECT_LOOKUP" id="SQL_AP_SUPPLIER_SELECT_LOOKUP" value="<%= eMM.Common.MmRepository.getMmKeyValue("SQL_AP_SUPPLIER_SELECT_LOOKUP")%>">
		<%
