...
//		String p_report_id = null;
	...
	<body onLoad="FocusFirstElement();">
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align=center >
			...
			<td width='100%'  class="WHITE">
				...
				<tr>
					...
					<option value='3'><fmt:message key="eMM.BinLocationCode.label" bundle="${mm_labels}"/></option>
 				    <option value='4'><fmt:message key="eMM.BinDesciption.label" bundle="${mm_labels}"/></option>
					</select></td>
				</tr>
				<tr>
					<td >&nbsp;</td>
		...
		<input type="hidden" name="SQL_MM_BINLOCATION_LOOKUP" id="SQL_MM_BINLOCATION_LOOKUP" value="<%= eMM.Common.MmRepository.getMmKeyValue("SQL_MM_BINLOCATION_LOOKUP")%>">
		<%
