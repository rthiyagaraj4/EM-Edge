...
<option value='B'><fmt:message key="Common.Both.label" bundle="${common_labels}"/></option>
				...
				<tr>
					...
					<option value='1'><fmt:message key="Common.ItemClassCode.label" bundle="${common_labels}"/></option>
					<option value='3'><fmt:message key="Common.ItemClassDescription.label" bundle="${common_labels}"/></option>
					</select></td>
				</tr>
				<tr>
					<td >&nbsp;</td>
		...
		<input type="hidden" name="SQL_MM_ITEM_CLASS_LOOKUP" id="SQL_MM_ITEM_CLASS_LOOKUP" value="<%= eMM.Common.MmRepository.getMmKeyValue("SQL_MM_ITEM_CLASS_LOOKUP")%>">
		<%
