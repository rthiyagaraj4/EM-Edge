...
<tr>
	<td  class="label"><fmt:message key="eMM.ItemAnalysisCode.label" bundle="${mm_labels}"/></td>
	<td   class=fields colspan="2">&nbsp;&nbsp;<input type="text" name="item_anal_code" id="item_anal_code" value="<%=bean.getMasterCode()%>" size="4" maxlength="4" <%=codeReadOnly%> <%=disabled%> onKeyPress="return changeCase()">
