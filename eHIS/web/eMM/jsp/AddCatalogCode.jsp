...
%>
	<tr>
		...
		<td class="<%=classValue%>" class='UPPER'><input type="text" name="catalog_code<%=rowIndex%>" id="catalog_code<%=rowIndex%>"  size="10" maxlength="4" <%=codeReadOnly%> accesskey='C' onKeyPress="return CheckForSpecChars(event)" onBlur="parent.resetColorCode(this);convertToUpperCase(this);checkSpecialChars(this);"></td>
