...
function Modify(obj)
{
	...
	var view_cost_details_yn			=	obj.cells[2].textContent//obj.cells[2].innerText;
...
async function searchCode(obj,index) 
{
	//alert("2");
	...
	if(returnedValues != null && returnedValues != "" )  {
		...
		eval("document.forms[0].user_name"+index).value=arr[1];
