...
function create() 
{
	f_query_add_mod.location.href	=	"../../eMM/jsp/AddCatalogCode.jsp?function_id="+function_id+"&mode="+MODE_INSERT;  
}

function query() 
{
	f_query_add_mod.location.href	=	"../../eMM/jsp/CatalogCodeQueryCriteria.jsp?function_id="+function_id ; 
}
...
{
	var fields	=	new Array	(	formObj.catalog_code
									,formObj.long_desc
									,formObj.short_desc
								);

	var names	=	new Array	(	getLabel("eMM.CatalogCode.label","MM") 
...
function Modify(obj)
{
	...
	document.location.href	=	"../../eMM/jsp/ModifyCatalogCode.jsp?function_id="+parent.function_id+"&mode="+MODE_MODIFY+"&item_catalog_code="+code1;//+"&long_desc="+code2+"&short_desc="+code3+"&eff_status="+eff_status;
}
