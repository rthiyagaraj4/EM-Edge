...
<tr> 
	<!--57885 starts-->
	  <td class='label' width='25%'><fmt:message key="eOT.FromBookingDate.Label" bundle="${ot_labels}"/> </td>
	  ...
	  <td class='label' width='25%'><fmt:message key="eOT.ToBookingDate.Label" bundle="${ot_labels}"/> </td>
	  <td class='fields' width='25%'>
...
<tr>
	<td class='label' width='25%'><fmt:message key="Common.OperatingRoom.label" bundle="${common_labels}"/></td>
     <td class='fields' width='25%'>
		...
		<input type='text' name='oper_room_desc' id='oper_room_desc' size='20' title='<%=operationRoom_title%>' param1 = 'param3'  param2 = 'param4' key ='OPER_ROOM' onBlur="if(this.value!='')callCommonLookup(this); else callClearParam(param3,param4); " maxlength='70' onkeypress="return CheckForSpecChars_local(event);"> 
    ...
    <td class='fields' width='25%'>
		...
		<input type='text' name='speciality_desc' id='speciality_desc' size='20' title='<%=speciality_title%>' param1 = 'param5'  param2 = 'param6' key ='SPECIALITY' onBlur="if(this.value!='')callCommonLookup(this); else callClearParam(param5,param6);"  maxlength='70' onkeypress="return CheckForSpecChars_local(event);"> 
