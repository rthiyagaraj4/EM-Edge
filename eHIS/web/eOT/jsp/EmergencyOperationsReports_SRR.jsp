...
<tr>
	<td class='label' width='25%'><fmt:message key="Common.Surgeon.label" bundle="${common_labels}"/> </td>
     <td class='fields' width='25%'>
		...
		<!--<input type='text' name='param7_desc' id='param7_desc' value='' size='20'title='<%=speciality_title%>' param1 = 'param7'  param2 = 'param8' key ='SURGEON' onBlur="if(this.value!='')callCommonLookup(this); else param7.value='',param8.value=''" maxlength='70' onkeypress="return CheckForSpecChars_local(event);"> --> <!-- Commented by MuthuN against IN033101 -->
