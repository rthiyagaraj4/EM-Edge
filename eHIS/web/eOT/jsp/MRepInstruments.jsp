	...
	<FORM name="MRepInstrumentsForm" id="MRepInstrumentsForm" ACTION="../../eCommon/jsp/report_options.jsp" TARGET="messageFrame">
		...
		<TR>
			...
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE=text name="param1" id="param1" SIZE="10" maxlength="8" onBlur="if(this.value!='')searchCode(document.all, 'INSTRUMENTS','<%=instruments_title%>', document.forms[0].param1); else this.value='' " onKeyPress="return CheckForSpecChars(event)" tabIndex="1" >
				<INPUT TYPE="button" name="instrumentsFrom" id="instrumentsFrom" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'INSTRUMENTS','<%=instruments_title%>', document.forms[0].param1)">
			</TD>
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE=text name="param2" id="param2" SIZE="10" maxlength="8" onBlur="if(this.value!='')searchCode(document.all, 'INSTRUMENTS','<%=instruments_title%>', document.forms[0].param2); else this.value='' " onKeyPress="return CheckForSpecChars(event)" tabIndex="2" >
				<INPUT TYPE="button" name="instrumentsTo" id="instrumentsTo" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'INSTRUMENTS','<%=instruments_title%>', document.forms[0].param2)">
			</TD>
			<TD WIDTH="25%">&nbsp;</TD>
		</TR>
		<TR>
