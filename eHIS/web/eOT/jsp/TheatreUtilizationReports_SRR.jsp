...
<td class='fields' width='25%'>
		...
		<input type='text' name='param5_desc' id='param5_desc' size='20' title='<%=operationRoom_title%>' param1 = 'param5'  param2 = 'param6' key ='OPER_ROOM' onBlur="if(this.value!='')callCommonLookup(this); else param5.value='',param6.value='' " maxlength='70' onkeypress="return CheckForSpecChars_local(event);"> 
...
<tr>
    ...
    <td class='fields' width='25%'>
		...
		<input type='text' name='param8_desc' id='param8_desc' size='20' title='<%=speciality_title%>' param1 = 'param7'  param2 = 'param8' key ='SPECIALITY' onBlur="if(this.value!='')callCommonLookup(this); else param7.value='',param8.value='' " maxlength='70' onkeypress="return CheckForSpecChars_local(event);"> 
