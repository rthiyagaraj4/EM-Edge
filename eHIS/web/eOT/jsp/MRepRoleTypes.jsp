	...
	<FORM name="MRepRoleTypesForm" id="MRepRoleTypesForm" ACTION="../../eCommon/jsp/report_options.jsp" TARGET="messageFrame">
		...
		<TR>
			...
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE='text' name="param1" id="param1" SIZE="8" maxlength="8" onKeyPress="return CheckForSpecChars(event)" tabIndex="1" onblur="if(this.value!='')searchCode(document.all, 'ROLETYPES','<%=roleType_title%>', document.forms[0].param1);else this.value='' " >
				<INPUT TYPE="button" name="roleTypeFrom" id="roleTypeFrom" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'ROLETYPES','<%=roleType_title%>', document.forms[0].param1)">
			</TD>
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE='text' name="param2" id="param2" SIZE="8" maxlength="8" onKeyPress="return CheckForSpecChars(event)" tabIndex="2" onblur="if(this.value!='')searchCode(document.all, 'ROLETYPES','<%=roleType_title%>', document.forms[0].param2); else this.value='' ">
				<INPUT TYPE="button" name="roleTypeTo" id="roleTypeTo" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'ROLETYPES','<%=roleType_title%>', document.forms[0].param2)">
			</TD>
			<TD WIDTH="25%">&nbsp;</TD>
		</TR>
		<TR>
