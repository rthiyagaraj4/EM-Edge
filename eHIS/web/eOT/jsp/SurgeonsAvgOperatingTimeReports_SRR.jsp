...
<!-- <form name='OtReportOptionsForm' id='OtReportOptionsForm' action="../../eCommon/jsp/report_options.jsp" target="messageFrame">
 -->
 	<!--commented above line on 2/22/2011 by Anitha  -->
...
<tr>
    ...
    <input type="hidden" name="compare_fm_1" id="compare_fm_1" value="param3##Surgeon" disabled>
    <input type="hidden" name="compare_to_1" id="compare_to_1" value="param4" disabled>
    
    <input type="hidden" name="compare_fm_2" id="compare_fm_2" value="param5##Procedure" disabled>
	...
	<!--Added reportParams on 2/22/2011 by Anitha  -->
	<input type='hidden' name='reportParams' id='reportParams' value="param1#param2#param4#param3#param5#param6#param7#param8#P_VIEW_BY#param9#param10#p_facility_id#p_user_id#p_user_name#p_module_id#p_report_id#pgm_id#user_id#p_language_id">
