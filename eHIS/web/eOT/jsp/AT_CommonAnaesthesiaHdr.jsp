...
<tr>
		...
		<td  class='fields' width="25%" >
			<input type="text" name="anaes_srl_no" id="anaes_srl_no" size='10'  value="<%=strAnesthesiaSrlNo%>" readonly>
		</td>	
		<input type="hidden"  name="source_id" id="source_id" size='17' value="<%=strSourceOrderId%>" readonly>	
		<input type='hidden' name='encounter_id' id='encounter_id' size='10' value= "<%=strEncounterId%>" readonly>
		<input type='hidden' name='patient_class_desc' id='patient_class_desc' size='10' value= "<%=strPatientClassDesc%>" readonly>
		  
		<td  class='label' width="25%" >
			<fmt:message key="eOT.AccessionNum.Label" bundle="${ot_labels}"/>
		</td>			
		<td class='fields' width="25%" >
			<input type="text"  name="accession_num" id="accession_num" size='18' value="<%=strAccessionNum%>" readonly <%=post_disable_flag%>>
		</td>
...
<tr>
		...
		<td class='fields' width="25%" >
			<input type="text" name="weight" id="weight" size='4'  maxlength='6'  onKeyPress="return allowValidNumber(this,event,'3','2');" onBlur="if(this.value !=''){SPCheckPositiveNumber(this);CheckBmiPositiveNumber(this);}" value="<%=strWeight%>" <%=post_disable_flag%>>(<fmt:message key="Common.Kgs.label" bundle="${common_labels}"/>)
		</td>
		...
		<td  class='fields' width="25%" >
			<input type="text" name="height" id="height" size='4' maxlength='6'   onKeyPress="return allowValidNumber(this,event,'3','2');"  onBlur="if(this.value !=''){SPCheckPositiveNumber(this);CheckBmiPositiveNumber(this);}"  value="<%=strHeight%>" <%=post_disable_flag%>>(<fmt:message key="Common.Cms.label" bundle="${common_labels}"/>)
		</td>		
</tr>
		<input type="hidden" name="surgeon_name" id="surgeon_name" size='27' value="<%=strSurgeonName%>" readonly>
<tr>
		...
		<%if(!strBSA.equals("")){%>
		<input type="text"  name="bsaDisp" id="bsaDisp" size='5' value="<%=bsaDisp%>" readonly>
		...
		<td class='fields' width="25%" >
			<input type="text"  name="bmi" id="bmi"  size='5' value="<%=strBMI%>" readonly>
			<input type="text"  name="status_desc" id="status_desc" size='18' value="<%=strBMIDesc%>" readonly>
		</td>
</tr> 
<tr>
<!-- crf - 0021 -->
...
<td  class='label' width="25%" ></td> -->
	...
	<td >
		<a class='gridLink' href="javascript:callPostAnesthesiaNotes();"><fmt:message key="eOT.PostAnaesthesiaNotes.Label"  bundle="${ot_labels}"/></a>
	</td>			
	<td >
