...
<tr>
	...
	<td class="fields">
		<input type="text" name="user_description" id="user_description" value="<%=user_desc%>" size=20 maxlength=20 onBlur="if(this.value!='')callUser(user_id, user_description, user_name); else user_id.value='' ">
