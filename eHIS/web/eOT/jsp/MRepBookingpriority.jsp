	...
	<FORM name="MRepBookingpriorityForm" id="MRepBookingpriorityForm" ACTION="../../eCommon/jsp/report_options.jsp" TARGET="messageFrame">
		...
		<TR>
			...
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE=text name="param1" id="param1" SIZE="8" maxlength="8" onKeyPress="return CheckForSpecChars(event)" tabIndex="1" onBlur="if(this.value!='')searchCode(document.all, 'BOOKINGPRIORITIES','<%=bookingpriority_title%>', document.forms[0].param1); else this.value='' ">
				<INPUT TYPE="button" name="bookingpriorityFrom" id="bookingpriorityFrom" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'BOOKINGPRIORITIES','<%=bookingpriority_title%>', document.forms[0].param1)">
			</TD>
			<TD ALIGN="left" WIDTH="25%">
				<INPUT TYPE=text name="param2" id="param2" SIZE="8" maxlength="8" onKeyPress="return CheckForSpecChars(event)" tabIndex="2" onBlur="if(this.value!='')searchCode(document.all, 'BOOKINGPRIORITIES','<%=bookingpriority_title%>', document.forms[0].param2); else this.value='' ">
				<INPUT TYPE="button" name="bookingpriorityTo" id="bookingpriorityTo" VALUE="?" CLASS="button" onclick="searchCode(document.all, 'BOOKINGPRIORITIES','<%=bookingpriority_title%>', document.forms[0].param2)">
			</TD>
			<TD WIDTH="25%">&nbsp;</TD>
		</TR>
		<TR>
