...
<tr>
	...
	<td class="fields">
		<input type="text" name="speciality_desc" id="speciality_desc" value="<%=speciality_desc%>" size=30 maxlength=30 <%=read_only%> onBlur="if(this.value!='')callCodeSearch('S','Speciality Search',speciality_code,speciality_desc);" >
