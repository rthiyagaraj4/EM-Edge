...
<tr>
    ...
    <td class='fields'>
		...
		<input type='text' name='param10_desc' id='param10_desc' size='20'   onBlur="if(this.value!='')srchCommonCode(param10,param10_desc,param11,'<%=speciality_title%>',document.forms[0].sql_text_2.value)"> 
...
<tr>
    ...
    <td class='fields' width ="25%">
		...
		<input type='text' name='param12_desc' id='param12_desc' size='15' onBlur="if(this.value!='')searchCode(param12,param12_desc,'<%=anaesthetist_title%>',document.forms[0].sql_text_1.value)">  
