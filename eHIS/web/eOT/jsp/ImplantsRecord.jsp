...
<tr> -->
     ...
     <td class="fields" width='25%'>
		<input type='text' name='manufacturer' id='manufacturer' maxlength='30' size='20' <%=disable_flag%> > 
	</td>
</tr>
<tr>
	 <td class="label" width='25%'><fmt:message key="Common.Batch.label" bundle="${common_labels}"/> </td>
     <td class="fields" width='25%'>
		<input type='text' name='batch' id='batch' maxlength='30' size='20'  <%=disable_flag%> > 
