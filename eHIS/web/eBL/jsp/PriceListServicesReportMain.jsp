...
%>
	<iframe name='commontoolbarFrame' id='commontoolbarFrame' src='<%= source %>' frameborder=0 scrolling='no' noresize style='height:10vh;width:100vw'></iframe>
		<iframe name='pricelistservicesreport' id='pricelistservicesreport' id='pricelistservicesreport' src='PriceListServicesReport.jsp?<%=params%>'  frameborder=0 style='height:80vh;width:100vw'></iframe>
