...
%>		
	<iframe name='commontoolbarFrame' id='commontoolbarFrame'	src='<%=source%>'  frameborder=0 scrolling='no' noresize style='height:7vh;width:100vw'></iframe>
		<iframe name='PkgUtilizationDetailsFrame' id='PkgUtilizationDetailsFrame' src='PkgUtilizationDetailsFrame.jsp?<%=params%>' frameborder=0 scrolling='no' noresize style='height:83vh;width:100vw'></iframe>
