...
<!--
	...
	-->
		...
		System.out.println("siteSpecf PKGDEFblnggrpRATEBSED.JSP" + ss);
...
<form>
	...
	<tr>
	<%if(ss){%>
	<td class='COLUMNHEADER'  colspan='22'><fmt:message key="eBL.BillingGroup.label" bundle="${bl_labels}"/>&nbsp;: &nbsp;<%=blng_grp_desc%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="Common.fromdate.label" bundle="${common_labels}"/>&nbsp;: &nbsp;<%=fromDate%>&nbsp;&nbsp;&nbsp;</td>
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<%}else{ %>
	<td class='COLUMNHEADER'  colspan='21'><fmt:message key="eBL.BillingGroup.label" bundle="${bl_labels}"/>&nbsp;: &nbsp;<%=blng_grp_desc%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<fmt:message key="Common.fromdate.label" bundle="${common_labels}"/>&nbsp;: &nbsp;<%=fromDate%>&nbsp;&nbsp;&nbsp;</td>
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<%} %>
	</tr>
	<tr>
