...
%>
	  ...
	  <iframe name='' id=''	src='../../eBL/jsp/BLViewEncounterUnBillChrDet.jsp?<%=params%>'  frameborder=0 noresize scrolling='no'  style='height:90vh;width:100vw'></iframe><iframe SRC="../../eBL/jsp/BLViewEncounterUnBillChrDetBtn.jsp"	  name="" id="" frameborder=0 noresize scrolling='no' style='height:10vh;width:100vw'></iframe>	
</HTML>
