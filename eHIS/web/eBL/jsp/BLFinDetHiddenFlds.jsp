...
%>
<jsp:include page="../../eBL/jsp/BLClearBeanForInsurance.jsp" >
</jsp:include>
<%
...
<input type='hidden' name='billing_mode' id='billing_mode' value='<%=billing_mode%>'></input>
<input type='hidden' name='bl_operation' id='bl_operation' value='<%=operation%>'></input>
<input type='hidden' name='bl_future_admn_YN' id='bl_future_admn_YN' value='<%=bl_future_admn_YN%>'></input>
<!--
...
%>
				...
				if(confirm_flag)
				{
					...
					var arguments	= "" ;
					var url="../../eBL/jsp/BLFutureAdmnValuesLoad.jsp?patient_id="+"<%=patient_id%>"+"&episode_type="+"<%=episode_type%>"+"&record="+"<%=record%>"+"&episode="+"<%=episode%>";
