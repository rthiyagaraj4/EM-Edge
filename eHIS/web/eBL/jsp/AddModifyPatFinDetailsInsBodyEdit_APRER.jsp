<!DOCTYPE html>
<%@ page import="org.apache.commons.lang.*,java.sql.*, java.util.*, java.text.*,webbeans.eCommon.*,webbeans.op.CurrencyFormat,com.ehis.util.*,eBL.Common.*, eBL.*" contentType="text/html;charset=UTF-8" %>
...
-->
	<td class='label' width='25%'><fmt:message key="eBL.POLICY_NO.label" bundle="${bl_labels}"/></td>
	<td class='fields' width='25%'><input type="text" maxlength='30' size="23" name='policy_no' id='policy_no'   value="<%=policy_no%>" onKeyPress='return CheckForSpecCharsAllNotAlwSpc_local(event)' onBlur='dflt_pol_no_2_credit_auth(document.forms[0].policy_no);'><img src='../../eCommon/images/mandatory.gif'></td>
</tr>
<%
...
%>
	...
	<td class='label' width='25%'>&nbsp;</td>
	<td class='label' width='25%'>
		<input type="button" name="accept_button" id="accept_button" value="<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Accept.label","common_labels")%>" class="button" onClick='checkValues()' >&nbsp;
...
-->
		<input type="button" name="accept_button" id="accept_button" value="<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Accept.label","common_labels")%>" class="button" onClick='return checkValues()' >&nbsp;
