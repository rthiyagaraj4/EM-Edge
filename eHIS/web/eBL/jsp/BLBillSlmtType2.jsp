...
//				return (event.keyCode -= 32);
		...
		{	
			...
			if(document.forms[0].application_id.value=="PAYSKY")
			{
				...
				if(document.forms[0].str_credit_card_machine_int_yn.value=="Y")
				{
					document.getElementById("show_paysky_button1").style.display='inline';
				}
...
%>
			...
			<td class="fields" width="25%" ><input type='text' name='instref' id='instref' id='instref' size='15' maxlength='20' value="<%=instref%>" onKeyPress='return CheckForSpecChars_local(event)' <%=readonly_fld%> >
	  ...
	  <%
		...
		<%} %>
			...
			<td width="25%" class="fields"><input type='text'  name="instremark" id="instremark" maxlength='100' size='15'  tabindex='0' value='<%=temp_bank_credit%>' onBlur="return bankcardlkup('B')" <%=readonly_fld%>><input type='button' class='button' name="bankcardbut" id="bankcardbut" value='?' onClick="return bankcardlkup('C')" tabindex='0' <%=disabled_fld%>>
			<img src='../../eCommon/images/mandatory.gif'>
...
<!--		<td width="" align="right" class="label" colspan = '2'>Payer's Name</td>	-->
			...
			<td width="25%" class="fields"><input type='text' name='payername' id='payername' size='15' maxlength='100' value="<%=strslmtpayername%>" onKeyPress='return CheckForSpecChars_local(event)'></td>
...
<!--		<td width="" align="right" class="label">Payer's Ref ID</td>	-->
			...
			<td width="25%" class="fields"><input type='text' name='recrefidno' id='recrefidno' size='15' maxlength='30' value="<%=strslmtidno%>" onKeyPress='return CheckForSpecChars(event)'> </td>
			</tr>
			<% //V210113 start
				if(siteCouponInSlmt && cash_slmt_flag.equals("D") && strcoupon_yn.equals("Y")) {					
			%>
			...
			<td width="25%" class="fields"><input type='text' readonly name='membershipID' id='membershipID' size='15' maxlength='100' value="<%=patMembershipID%>" onKeyPress='return CheckForSpecChars_local(event)'>
...
<!--	<td align="right" class="label">Instrument Ref</td>		 -->
		<td id='tdChqCarfBankNo' class="label" width="25%"><fmt:message key="eBL.CHQ_CARD_BANK_NO.label" bundle="${bl_labels}"/></td>		 
		<td class="fields" width="25%" ><input type='text' name='instref' id='instref' id='instref' size='15' maxlength='20' value="<%=instref%>" onKeyPress='return CheckForSpecChars(event)' <%=readonly_fld%> onblur="callCardNoValidation(this)">
		<%if("Y".equals(credit_card_num_yn)){ %>
		<img src='../../eCommon/images/mandatory.gif'>
		<%} %>
		</td>		
...
%>
				<input type='text'  name="instremark" id="instremark" maxlength='100' size='15'  tabindex='0' value='<%=temp_bank_credit%>' onBlur="return bankcardlkup('B')" ><input type='button' class='button' name="bankcardbut" id="bankcardbut" value='?' onClick="return bankcardlkup('C')" tabindex='0' >
<% 
			} else {
%>				
				<input type='text'  name="instremark" id="instremark" maxlength='100' size='15'  tabindex='0' value='<%=temp_bank_credit%>' onBlur="return bankcardlkup('B')" <%=readonly_fld%>><input type='button' class='button' name="bankcardbut" id="bankcardbut" value='?' onClick="return bankcardlkup('C')" tabindex='0' <%=disabled_fld%>>
<%			
			}
			//Added by Gopinath for ML-MMOH-CRF-1928.2 on 28/06/2023 - Credit Card Company Enale Checking
...
<!-- 	<td width="" align="right" class="label">Approval Code</td>	 -->
	    ...
	    <td width="25%" class="fields"><input type='text' name='apprrefno' id='apprrefno' size='15' maxlength='100' value="<%=apprrefno%>" onKeyPress='return CheckForSpecChars(event)' <%=readonly_fld%>>
<% 
		  }
		else		 
		{	
...
<!--	<td width="" align="right" class="label">Approval Code</td>	-->
	...
	<% } else {
	%>
	<td width="25%" class="fields"><input type='text' name='apprrefno' id='apprrefno' size='15' maxlength='100' DISABLED value="<%=apprrefno%>" onKeyPress='return CheckForSpecChars(event)'>
	<%
	}
	%>	
<%
...
<% 
		...
		{
%>	
			<td width="25%" class="fields"><input type='text' name='saledraftno' id='saledraftno' size='15' maxlength='20' value="<%=saledraftno%>" onKeyPress='return CheckForSpecChars(event)' <%=readonly_fld%>>
<%
		}
		else
		{
%>
			<td width="25%" class="fields"><input type='text' name='saledraftno' id='saledraftno' size='15' maxlength='20' value="<%=saledraftno%>" DISABLED onKeyPress='return CheckForSpecChars(event)'>
<% 
		}	
...
%>
		...
		<!--	<td width="" align="right" class="label">Payer's Name</td>	-->
				<td width="25%" class="label"><fmt:message key="eBL.PAYER_NAME.label" bundle="${bl_labels}"/></td>	
				<td width="25%" class="fields"><input type='text' name='payername' id='payername' size='15' maxlength='100' value="<%=strslmtpayername%>" onKeyPress='return CheckForSpecChars_local(event)'>
<% 
...
%>					
		...
		<!--	<td width="" align="right" class="label">Payer's Ref ID</td>	-->
				...
				<td width="25%" class="fields"><input type='text' name='recrefidno' id='recrefidno' size='15' maxlength='30' value="<%=strslmtidno%>" onKeyPress='return CheckForSpecChars(event)'>
...
%>
			<input type='text' name='payername' id='payername' size='15' maxlength='100' value="<%=strslmtpayername%>" onKeyPress='return CheckForSpecChars_local(event)' >
<% 
		} else {
%>			
			<input type='text' name='payername' id='payername' size='15' maxlength='100' value="<%=strslmtpayername%>" onKeyPress='return CheckForSpecChars_local(event)' <%=readonly_fld%>>
<%
		}
		//Added by Gopinath for ML-MMOH-CRF-1928.2 on 28/06/2023 - Payer Name Enable Checking
...
%>
			<input type='text' name='recrefidno' id='recrefidno' size='15' maxlength='30' value="<%=strslmtidno%>" onKeyPress='return CheckForSpecChars(event)' >
<% 
		} else {
%>			
			<input type='text' name='recrefidno' id='recrefidno' size='15' maxlength='30' value="<%=strslmtidno%>" onKeyPress='return CheckForSpecChars(event)' <%=readonly_fld%>>
<%
		}
		//Added by Gopinath for ML-MMOH-SCF-2508 on 09/08/2023 - Payer Ref ID Enable Checking
...
<!-- Added by Monika for NMC-JD-CRF-0199 -->
	<% if ( cash_slmt_flag.equals("A") && cc_terminal_id_enable){ %>
		<tr>
				<td width="25%" class="label"><fmt:message key="eBL.TID_NO.label" bundle="${bl_labels}"/></td>
				<%		if(action_ind.equals("modify"))
						{
				%>
							<td width="25%" class="fields"><input type='text' name='cc_term_id_num' id='cc_term_id_num' size='15' maxlength='30' value="<%=cc_term_id_num%>" onKeyPress='return CheckForSpecChars_tid(event)' <%=readonly_fld%>>
				<% 		}else { %>
							<td width="25%" class="fields"><input type='text' name='cc_term_id_num' id='cc_term_id_num' size='15' maxlength='30' value="<%=strTermIdentNo%>" onKeyPress='return CheckForSpecChars_tid(event)' <%=readonly_fld%>>
...
%>
			...
			<table border='0' cellpadding='2' cellspacing='0' align = 'center' width='100%'>
				...
				<tr>	
					...
					<!-- Changed by Subha V20180814/GHL-CRF-0544 apprrefno maxlength has been changed from 30 - 100-->
					<td width="32%" class="fields"><input type='text' name='apprrefno' id='apprrefno' size='15' maxlength='100' value="<%=apprrefno%>" onKeyPress='return CheckForSpecChars(event)' <%=readonly_fld%>>
			...
			<% 
					...
					{
			%>	
						<td width="32%" class="fields"><input type='text' name='saledraftno' id='saledraftno' size='15' maxlength='20' value="<%=saledraftno%>" onKeyPress='return CheckForSpecChars(event)'>
			<%
					}
					else
					{
			%>
						<td width="30%" class="fields"><input type='text' name='saledraftno' id='saledraftno' size='15' maxlength='20' value="<%=saledraftno%>" onKeyPress='return CheckForSpecChars(event)'>
			<% 
					}					
			%>				
					</td>
		...
		<table border='0' cellpadding='2' cellspacing='0' align = 'center' width='100%'>
			...
			%>	
				...
				<td class="fields" width="15%" align="left">
					...
					<input type='button' name='validate_paysky_pay' id='validate_paysky_pay' value="<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eBL.PAYSKY_PAY.label","bl_labels")%>" class='button' onClick='validate_ps_tranx("PAY")' <%=readonly1%>>
					</div>
				</td>		
				<td width="10%">&nbsp;</td>								
				<td width="10%">&nbsp;</td>
			...
			<tr>	
				...
				if ( strslmtidno.length() > 0 )
					...
					readonly_fld="";
				%>	
				<td width="18%"class="label"><fmt:message key="eBL.PAYSKY_TXN_NO.label" bundle="${bl_labels}"/></td>	
				<td width="32%" class="fields"><input type='text' name='apprrefno' id='apprrefno' size='15' maxlength='100' value="<%=apprrefno%>" onKeyPress='return CheckForSpecChars(event)' <%=readonly_fld%>>
					<% 
					if ( "Y".equals(payer_ref_reqd_yn)==true )
					{
...
%> 
	...
	<input type=hidden name='terminal_id_reqd_yn' id='terminal_id_reqd_yn' value="<%=terminal_id_reqd_yn%>">					<!--Added by Monika for NMC-JD-CRF-0199 on 07/07/203-->	
	<input type=hidden name='cc_terminal_id_enable' id='cc_terminal_id_enable' value="<%=cc_terminal_id_enable%>">
	...
	<input type='hidden' name='segment_id' id='segment_id' value='<%=segment_id%>'>
