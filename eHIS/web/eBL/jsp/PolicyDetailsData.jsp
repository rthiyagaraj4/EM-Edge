	...
	%>
      	...
      	<thead>  
      		<tr>
      			...
      			<td class='COLUMNHEADER' colspan="12" align="center"><fmt:message key="eBL.CoverageDetails.label" bundle="${bl_labels}"/></td>
      		</tr>
      		<tr>
			...
			%>	
			 ...
			 "<%=policyBean1.getClinicNursCode()%>","<%=policyBean1.getSpecCode()%>","<%=policyBean1.getInclExclCriteria()%>","<%=policyBean1.getBillServCode()%>","<%=policyBean1.getStartDate()%>","inclExclCoverage")'>
