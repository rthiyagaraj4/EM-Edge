...
%>
	<form  id="frmServiceTabDetails">	
      	<table width='100%' cellpadding='3'  cellspacing=0 align="center">  
      		<tr>
      			...
      			%>
      			<input type="checkbox" <%=totalDisabled %> id='defaultCreditAuth' name='defaultCreditAuth' <%=checked %>><fmt:message key="eBL.CreditAuthrefNo.label" bundle="${bl_labels}"/>
      			</td>
		...
		<table width='100%' cellpadding='3'  cellspacing=0 align="center">  
      		...
      		<tr>
				...
				%>
				<td width='15%' class='label' nowrap><fmt:message key="eBL.LimitAmt.label" bundle="${bl_labels}"/>
			...
			<tr>
				...
				%>	
				<a disabled><fmt:message key="eBL.MultiFactorDeductibleRule.label" bundle="${bl_labels}"/></a>
				<%
				}
				else{
				%>			
					
				<a href="javascript:encounterSpecMFDRDtls();" ><fmt:message key="eBL.MultiFactorDeductibleRule.label" bundle="${bl_labels}"/></a>
				...
				%>
				<input type='hidden' name='mfdrLink' id='mfdrLink' value='<%=mfdrYN%>'>
	...
	<input type='hidden' name='encounterId' id='encounterId' value='<%=encounterId%>'>  <!-- V230228 -->
     </form>
     <%!
