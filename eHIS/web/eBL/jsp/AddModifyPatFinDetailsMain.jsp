...
//		if(fin_class_flag_YN.equals("Y") && (strModuleId.equals("MP") || strModuleId.equals("IP")))
		...
		{
%>
			<iframe name='tab_frames' id='tab_frames' SRC="AddModifyPatFinDetailsMainTabs.jsp?<%=strAllParam%>"  frameborder=0 scrolling='no' noresize style='height:3vh;width:100vw'></iframe>
			...
			<!--
			<frame name='MainFrame2'		src='AddModifyPatFinClassDetailsMain.jsp?<%=strAllParam%>' frameborder=0 noresize scrolling='no' noresize>
			-->
...
%>
			 <iframe SRC="AddModifyPatFinDetails.jsp?<%= strAllParam%>" name='MainFrame1' id='MainFrame1' frameborder=0 scrolling='no' noresize style='height:21vh;width:100vw'></iframe>
<%
...
%>
<!--
	<iframe SRC="AddModifyPatFinDetails6.jsp?<%=strAllParam%>" frameborder=0 name='MainFrame2' scrolling='no' noresize></iframe> 
-->
