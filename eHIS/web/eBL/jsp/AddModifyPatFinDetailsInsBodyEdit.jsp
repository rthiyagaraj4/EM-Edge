...
<tr>
	...
	<td class='fields' width='35%' ><input maxlength='40' size='30' type=text name='payer_desc' id='payer_desc'  value="<%=payer_desc%>"   onBlur="return payerlkup('B');" onChange='' onBlur=""><input type='button' class='button' name="payerbut" id="payerbut" value='?'  tabindex='0' onClick="return payerlkup('C')" onBlur=''><img src='../../eCommon/images/mandatory.gif'>
	...
	<td class='fields' width='20%'><input type="text" maxlength='2' size="3" name='priority' id='priority' style='text-align:right'  value='<%=priority%>' onBlur='priority_checks(this);' onKeyPress='return(ChkNumberInput(this,event,0))'><img src='../../eCommon/images/mandatory.gif'></td>
</tr>
...
<tr>
	...
	<td class='fields' width='25%'>
	<input type='text'  name='mcn_for_policy' id='mcn_for_policy' id='mcn_for_policy'  size='30' maxlength='50' onkeypress='return CheckForSpecChars_loc(event,this)' onBlur='CheckForSpecChar(event,this)' value='<%=mcn_for_policy%>'>
...
%>
    <input type='hidden' name='claim_MCN_YN' id='claim_MCN_YN' value="<%=claim_MCN_YN%>">
	<!-- V220908 -->
<%
...
<tr>
	...
	<td class='fields' width='25%'>
	<input type='text'  name='reg_ref_id' id='reg_ref_id' id='reg_ref_id'  size='30' maxlength='50' onkeypress='return CheckForSpecChars_loc(event,this)' onBlur='CheckForSpecChar(event,this)' value='<%=reg_ref_id_val%>'>
	</td>
</tr>
<%
}
...
-->
	...
	<input type=hidden name="siteSpecBLPolEffTODateMandYN" id="siteSpecBLPolEffTODateMandYN" id="siteSpecBLPolEffTODateMandYN" value="<%=siteSpecBLPolEffTODateMandYN %>" /> <!-- Added V201008 -->	
	<!-- Added By Niveditha for NMC-JD-CRF-054.1 -->
	...
	<input type=hidden name="cg_det_citizen_altid1" id="cg_det_citizen_altid1" id="cg_det_citizen_altid1" value="<%=cg_det_citizen_altid1 %>" /> 
	<input type=hidden name="cg_det_citizen_altid2" id="cg_det_citizen_altid2" id="cg_det_citizen_altid2" value="<%=cg_det_citizen_altid2 %>" /> 
	<input type=hidden name="cg_det_citizen_altid3" id="cg_det_citizen_altid3" id="cg_det_citizen_altid3" value="<%=cg_det_citizen_altid3 %>" /> 
	<input type=hidden name="cg_det_citizen_altid4" id="cg_det_citizen_altid4" id="cg_det_citizen_altid4" value="<%=cg_det_citizen_altid4 %>" /> 
	<input type=hidden name="cg_det_citizen_altid5" id="cg_det_citizen_altid5" id="cg_det_citizen_altid5" value="<%=cg_det_citizen_altid5 %>" /> 
	...
	<input type=hidden name="responsibility_id" id="responsibility_id"  value='<%=responsibility_id%>'>   <!-- V230707  -->
	<input type=hidden name="userId_for_priv" id="userId_for_priv" id="userId_for_priv" value="<%=userId_for_priv %>" />  <!-- V230707 -->
	<input type=hidden name="reasonCode_for_priv" id="reasonCode_for_priv" id="reasonCode_for_priv" value="<%=reasonCode_for_priv %>" />  <!-- V230707 -->
	<input type=hidden name="profile_id_exists" id="profile_id_exists" id="profile_id_exists" value="<%=profile_id_exists %>" />  <!-- V230707 -->
	</form>
	</body>
	<%if(action.equals("add") && location.equals("outside"))  { %>
