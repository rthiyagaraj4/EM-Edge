...
<INPUT type="button" class='button'	name='pkgDefAddBtn' id='pkgDefAddBtn' <%=modifyStatus%> value="<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Add.label","common_labels")%>" onclick="addRow('<%=table_name%>','<%=func_mode%>');" /></td>
