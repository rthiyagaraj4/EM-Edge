	...
	<table width="100%">
		<tr>
			<td class="COLUMNHEADER">
				<fmt:message key="eBL.claims_by_payer_enc_level.label" bundle="${bl_labels}"/>
			</td>
		</tr>
	</table>  <div>
	<%} %>		
			<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span class="a" id ="payer" onclick="onClickPayer('<%=payer%>','<%=payerCode%>');return false">
					<div class="box_title2" ><%=payer%></div>
