...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<%
		...
		System.out.println("Subha ->BLReprintAuditTrailReportMain.jsp: " + source);
	%>
</head>
<iframe name='commontoolbarFrame' id='commontoolbarFrame'	src='<%= source%>' frameborder=0 scrolling='no' style='height:6vh;width:100vw'></iframe><iframe name="reprintaudittrail" id="reprintaudittrail" SRC="../../eBL/jsp/BLReprintAuditTrailReport.jsp" frameborder=0 noresize style="height:90vh;width:100vw"></iframe>
