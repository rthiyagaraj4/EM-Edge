...
//				vectorHtmlData.add("</table>");
		...
		<tr> 
		<td class="button" align='right' ><input type='button' name='close_butt' id='close_butt' value="<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.close.label","common_labels")%>" class='button' onClick='closew()'>
		</td>
		</tr>
		<tr>
		<td align='right'>
	...
	%>
		...
		<input type='hidden' name='sql' id='sql' value="<%=URLEncoder.encode(sql)%>">
