...
<input type=hidden  name='SQL_OR_REPORTS_ORDER_ENTRY_FORMAT_ITEM_LOOKUP' id='SQL_OR_REPORTS_ORDER_ENTRY_FORMAT_ITEM_LOOKUP'     value='<%=OrRepository.getOrKeyValue("SQL_OR_REPORTS_ORDER_ENTRY_FORMAT_ITEM_LOOKUP")%>' >
