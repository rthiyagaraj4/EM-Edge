...
%>
<form name='PatOrderByPrivReln_btn' id='PatOrderByPrivReln_btn' target='messageFrame' >
<table cellpadding=0 cellspacing=0 border=1 width="100%" align=center>
<tr>
		<td  class='label' class='button'  width='100%' >
		<INPUT TYPE="button" value='Record' class='button'  onClick='insert()'>	 
