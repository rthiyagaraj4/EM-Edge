...
<input type=hidden  name='SQL_OR_REPORTS_ORDER_CATALOG_LOOKUP' id='SQL_OR_REPORTS_ORDER_CATALOG_LOOKUP'     value='<%=OrRepository.getOrKeyValue("SQL_OR_REPORTS_ORDER_CATALOG_LOOKUP")%>' >
