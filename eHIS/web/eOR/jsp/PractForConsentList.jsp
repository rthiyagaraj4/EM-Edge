...
//	if ( !( (start+row_disp) > row_count ) ){
	...
	<th width='25%'><fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/></th>
	<%
	try{
		if(tabVal.equals("S")){		
	...
	<input type="hidden" name="pract_consent_code" id="pract_consent_code" value="<%=pract_consent_code%>">
	</form>
</body>
</html>
<%
