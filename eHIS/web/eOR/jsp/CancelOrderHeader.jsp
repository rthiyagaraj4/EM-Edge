...
<table cellpadding=3 cellspacing=0 border=1  id='titleTab'>
	<tr>
		...
		<td class='columnheader' width=''><a  class='gridLink' id='hdr' ><font color='yellow'><fmt:message key="Common.reason.label" bundle="${common_labels}"/></a><BR><input type=checkbox name='select_all' id='select_all' onClick='clickAll()'></td>
	</tr>
...
<script>
parent.CancelOrderDtl.location.href="CancelOrderDetail.jsp?<%=request.getQueryString()%>"
</script>
