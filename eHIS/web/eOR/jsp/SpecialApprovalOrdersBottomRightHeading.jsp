...
%>
	<tr >
		<td class='columnheader' width='' nowrap><input type=checkbox name='select_all' id='select_all' onClick='clickAll()' disabled><fmt:message key="Common.Approve.label" bundle="${common_labels}"/></td>
	<%if((order_by.equals(" ")||(order_by.equals("P"))) && ord_cat_desc.equals("")){%>
		<td class='columnheader' width='' nowrap><fmt:message key="Common.category1.label" bundle="${common_labels}"/></td>
	<%}%>
