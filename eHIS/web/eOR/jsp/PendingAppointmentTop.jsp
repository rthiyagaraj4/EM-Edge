...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085	
	...
	String filter=request.getParameter("filter")==null?"":request.getParameter("filter");	
			...
			String defaultSelect1="";
			String defaultSelect2="";
			String defaultSelect3="";
			String defaultSelect4="";

			if(filter.equals("MP"))
					defaultSelect1="selected";
			else if(filter.equals("OP"))
					defaultSelect2="selected";
			else if(filter.equals("RP"))
					defaultSelect3="selected";
			else if(filter.equals("AL") || filter.equals("") )
			{
					defaultSelect4="selected";
			}
	/* end Here */ 
...
<table cellpadding=3 cellspacing=0 border=0 width="100%"  align=center>
	...
	<!-- Added By : Arvind
							  Date : 09/01/2010
							  CRF  : PMG20089-CRF-829
							  Discription : Below code added to Introduce new label and fields for filter. 
						 -->
		...
		<td  class="fields">
			<select name="filter_name" id="filter_name" id="filter_name_id">				
					<option value="MP" <%=defaultSelect1%>><fmt:message key="eOR.MyPatients.label" bundle="${or_labels}"/></option>
					<option value="RP"  <%=defaultSelect3%>><fmt:message key="eOR.MyRelatedPatients.label" bundle="${or_labels}"/></option>
					<option value="OP" <%=defaultSelect2%>><fmt:message key="eOR.OrderedPatients.label" bundle="${or_labels}"/></option>
					<option value="AL" <%=defaultSelect4%>><fmt:message key="Common.all.label" bundle="${common_labels}"/></option>
			</SELECT>
		</td>
...
<!-- Added By : Arvind
							  Date : 09/01/2010
							  CRF  : PMG20089-CRF-829
							  Discription : Below code added to pass filter as parameter. 
						 -->
