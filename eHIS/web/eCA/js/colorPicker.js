...
Control.ColorPicker.prototype = {
    ...
    if (!Control.ColorPicker.CONTROL) {
      ...
      if (!$("colorpicker")) {
        ...
        control.innerHTML = 
          ...
          '<div id="colorpicker-selector"><img src="' + this.options.IMAGE_BASE + 'selectcolor.gif" width="11" height="11" alt="" /></div></div>' +
          ...
          '<div id="colorpicker-footer"><span id="colorpicker-value">#<input type="text" onclick="this.select()" id="colorpicker-value-input" name="colorpicker-value" id="colorpicker-value" value=""></input></span><button id="colorpicker-okbutton">OK</button></div>'
  ...
  close : function(event) {
	...
	copyBackgroundAndFontColor(this.options);
  },
