...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="MATRIX-TH">
        <tr>
            <td colspan="6" style="border-style:dashed">
    ...
    <xsl:template match="MATRIX-ROW">
        <tr>
            <td align="left" style='color:NAVY;font-size:9pt;font-weight:normal;border-style:dashed;width:250px;'>
...
<xsl:template match="GRID-TH">
    <tr>
        <td align="left" colspan="100" style="border-style:dashed">        
    ...
    <tr>
        ...
        <xsl:for-each select ="TH">
        <th style='color:white;font-size:9pt;font-weight:bold;border-style:dashed;'>
            <xsl:attribute name="colspan"><xsl:value-of select="@COLSPAN"></xsl:value-of></xsl:attribute>
            <xsl:value-of select=".">
            </xsl:value-of>
        </th>
    ...
    <xsl:template match="MULTI-LIST">        
        <tr>
            <td colspan="1" align="right">
				<font style="COLOR:black;FONT-SIZE:9pt;font-weight:bold;"><xsl:value-of select="@HEADER"/>
					&#160;&#160;
				</font>
  ...
  <!--Multi choice Component ends-->
    ...
    <xsl:template match="PARAGRAPH" >
        <td align="left" class="QRYEVEN" style="font:size:9pt;font-face:verdana;font-style:normal;"  >
...
<!--       <xsl:call-template name="TEXT-DISP"/> -->
   ...
   <xsl:template match="FORMULA-COMP" >
	...
	<td width="3%">
        ...
        <td align="left" nowrap="true" width="20%">
            <!--<xsl:attribute name="colspan"><xsl:value-of select="@COLSPAN"/></xsl:attribute>-->
  ...
  <xsl:template match="SHORT-TEXT">
    <xsl:if test = "not(@GRID-COMP|@MATRIX-COMP)">
       <td align="right" colspan="1" nowrap="true" valign="top" width="13%">
            <xsl:attribute name="class"><xsl:value-of select="@CLASS"/></xsl:attribute>
            <font style="COLOR:NAVY;FONT-SIZE:9pt;font-weight:bold;">
				<xsl:value-of select="@PROMPT"/>&#160;&#160;
			</font>
...
-->
  ...
  <xsl:template match="USER-TEMPLATE-ADDENDUM">
    ...
    <tr>
        ...
        <i>Addendum Created By: <xsl:value-of select="@CREATED-BY"/>, Date/Time: <xsl:value-of select="@DATE"/></i>
        </td>
    </tr>
    <tr>
