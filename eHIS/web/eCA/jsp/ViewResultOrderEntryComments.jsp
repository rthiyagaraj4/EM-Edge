...
<table width="100%" border="0" cellspacing="0" cellpadding="3" align=center>
	...
	<tr>
		<td width="90%" class="label"><textarea name="comments" rows="5" class='<%=slClassName%>'cols="60" <%=read_only%> onBlur="makeValidString(this);" <% if(!hdg_name.equalsIgnoreCase("CLINICAL")) { %> onkeyPress='return checkMaxLimit(this,500)' <% } %>></textarea></td>
	</tr>
