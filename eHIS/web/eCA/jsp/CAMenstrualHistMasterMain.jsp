...
<iframe name='commontoolbarFrame' id='commontoolbarFrame'	src=<%=source%> frameborder=0 scrolling='no' noresize frameborder='0' style='height:42%;width:100vw'></iframe>
	<iframe name='f_query_add_mod' id='f_query_add_mod' src='CAMenstrualHistMasterDtl.jsp?mode=update&facility_id=<%=facility_id%>' frameborder=0 frameborder='0' style='height:100vh;width:100vw'></iframe><iframe name='messageFrame' id='messageFrame'	src='../../eCommon/jsp/MstCodeError.jsp' frameborder=0 noresize scrolling='auto' frameborder='0' style='height:50%;width:100vw'></iframe>
</html>
