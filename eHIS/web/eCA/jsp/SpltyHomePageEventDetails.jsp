			...
			<table border='1' width='100%' id='dataTitleTable' cellpadding='3' cellspacing='0' align='center' >
				<TR>
					...
					for(int i=0;i<dateListSize;i++)
						...
						%>
					<TH nowrap id='visID<%=i%>'><img src='../../eCA/images/graph.gif' style='visibility:hidden' ></img><a href="javascript:collapseColumn('<%=i%>')" title='Click here to collapse the column'><%=strConvDt%>&nbsp;</a><br></TH>
					<%}%>
				</TR>
			</table>
		</div>
...
%>		
				...
				<%
					...
					<TH nowrap style='visibility:hidden' id='visIDup<%=i%>'><%=dateList.get(i)%>&nbsp;<!--<input type='image' src='../../eCA/images/page_old.gif' onclick='fnEnterQuickNotes()'>--></TH>
					<%}
