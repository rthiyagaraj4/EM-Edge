...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<iframe name="viewsFrame" id="viewsFrame" src="ChartSummaryResultsD.jsp?<%=queryString%>" scrolling="auto" noresize marginheight=0 marginwidth=0 frameborder='0' style='height:100vh;width:100vw'></iframe>
