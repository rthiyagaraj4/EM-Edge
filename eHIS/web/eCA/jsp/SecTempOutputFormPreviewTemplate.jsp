...
<tr align="left">
 	<th class='columnheader' width="25%"><fmt:message key="Common.patient.label" bundle="${common_labels}"/></th>
	<th class='columnheader' width="25%"><fmt:message key="Common.encounter.label" bundle="${common_labels}"/></th>
	</tr>
<tr VALIGN="top">
<%	
...
%>
			<tr><td class="gridData"><A class='gridLink'  href="javascript:setPrevTemplate('<%=record[1]%>')"><%=record[0]%></a></td></tr>
