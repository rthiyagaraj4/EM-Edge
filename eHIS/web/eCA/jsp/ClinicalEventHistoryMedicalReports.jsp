	...
	<BODY class='CONTENT' onMouseDown="CodeArrest()" onKeyDown="lockKey()">
		<FORM name="" id="">
				...
				<table class='grid' cellspacing=0 cellpadding=0 width='100%'>
					...
					<input type='hidden' name='hist_data_type<%=count%>' id='hist_data_type<%=count%>' value=''/>
					...
					<input type='hidden' name='contr_sys_event_code<%=count%>' id='contr_sys_event_code<%=count%>' value=''/> 
