...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	%>		
		<script>
			parent.patEncBannerDetailsFrame.location.href = '../../eCA/jsp/PatEncBannerDetails.jsp?loadFirstTime=No&oldDispLine=<%=dispLine%>&bannerCateg=<%=bannerCateg%>&bannerRef=<%=bannerRef%>';
		</script>
<%
	...
	%>
		<script>
			parent.patEncBannerDetailsFrame.location.href = '../../eCA/jsp/PatEncBannerDetails.jsp?loadFirstTime=No&bannerRef=<%=bannerRef%>&bannerCateg=<%=bannerCateg%>';
		</script>
	<%
