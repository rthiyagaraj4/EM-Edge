...
<body onMouseDown='CodeArrest()'; onKeyDown='lockKey()'>
	...
	<th class='columnheader' align="left" width='75%'><fmt:message key="<%=display_hdr%>" bundle="${common_labels}"/></th>
	<th class='columnheader' align="left" width='25%'><fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/></th>
	<%
	try{
		if(tabVal.equals("S")){		
