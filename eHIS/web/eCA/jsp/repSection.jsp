...
<br>
<br>
<form name="repSection" id="repSection" action="../../eCommon/jsp/report_options.jsp" target="messageFrame">
	...
	<tr>
		...
		<td width="100%" class="Border" align='center'>
			...
			<table width='80%' cellPadding="3" cellSpacing="0"  align='center' >
					...
					<tr>
						<td  width='30%' class="label"><fmt:message key="Common.Section.label" bundle="${common_labels}"/></td>
						<td class='fields' width='20%' ><input type=text  name='p_fr_sec_hdg_code1' id='p_fr_sec_hdg_code1' size="15" onblur='search_Code(this, p_fr_sec_hdg_code1)' maxlength="30" align="center"><input type='hidden'  name='p_fr_sec_hdg_code' id='p_fr_sec_hdg_code' value=''><input type='button' name='locn' id='locn' value='?' class='button' onclick='search_Code(this, p_fr_sec_hdg_code1)'>
						</td>
						<td class='fields' width='40%'><input type=text  name='p_to_sec_hdg_code1' id='p_to_sec_hdg_code1' size="15" maxlength="30" onblur='search_Code(this, p_to_sec_hdg_code1)' align="center"><input type='hidden'  name='p_to_sec_hdg_code' id='p_to_sec_hdg_code' value=''><input type='button' name='locn1' id='locn1' value='?' class='button' onclick='search_Code(this, p_to_sec_hdg_code1)'>
						</td>
				</tr>
