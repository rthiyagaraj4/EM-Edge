...
<%
	...
	<tr id="divTitleTable">
		...
		<%if("CA_SPC".equals(p_called_from)){%>
		<th width='15%'><div  id='head2' class='columnHeadercenter' nowrap width='24%'><fmt:message key="eMR.reactiondesc.label" bundle="${mr_labels}"/></div></th>
		<th width='15%'><div  id='head3' class='columnHeadercenter' nowrap width='25%'><fmt:message key="Common.Severity.label" bundle="${common_labels}"/></div></th>
		<th width='15%'><div  id='head4' class='columnHeadercenter' nowrap width='25%'><fmt:message key="eMR.SiteOfReaction.label" bundle="${mr_labels}"/></div></th>
		<th width='15%'><div  id='head5' class='columnHeadercenter' nowrap width='23%'><fmt:message key="Common.ReactionDate.label" bundle="${common_labels}"/></div></th>
		<%}%>
		...
		<td width='15%' class='columnHeadercentericons<%=content_ID%>'><div  id='head3' nowrap width='5%'><fmt:message key="eMR.Allergen.label" bundle="${mr_labels}"/></div></th>
		<td width='15%' class='columnHeadercentericons<%=content_ID%>'><div  id='head4' nowrap width='5%'><fmt:message key="Common.onsetdate.label" bundle="${common_labels}"/></div></th>
	...
	<%
		...
		%>
			...
			<%if(cnt_recurring.equals("0")||causative_code.equals("Oth")){%><!-- added for IN066228 -->
