...
*/ %>
<%@page import="java.sql.*,java.util.*,webbeans.eCommon.*, eCA.*, eOR.Common.*, eOR.*,java.util.*,eCA.CAOpenChartServlet,eCommon.XSSRequestWrapper" contentType="text/html;charset=UTF-8"%>
...
try
{
	...
	<tr>
		...
		<th class='columnHeadercenter' nowrap  >
			<a  id='a001' name='a001' style='color:white' href="javascript:callForOrderBy('AAT');" onclick='changeColor(this);' ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eCA.AccessedAt.label","ca_labels")%></a>
		</th>		
		<th class='columnHeadercenter' nowrap>
			<a id='a01'  name='a01' style='color:white'    href="javascript:callForOrderBy('PC');" onclick='changeColor(this);' ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.patientclass.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a1' name='a1' style='color:white'  href="javascript:callForOrderBy('LOC');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Location.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'   nowrap>
			<a id='a2' name='a2'  style='color:white'   href="javascript:callForOrderBy('PN');" onclick='changeColor(this);' ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.PatientName.label","common_labels")%></a>
		</th>
		<%
		//37866 Start.
		if(isVirtualConsSiteSpec){%>		
		<th class='columnHeadercenter'   nowrap>
			<a id='a12' name='a12'  style='color:white'   ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eCA.ConsultationType.label","ca_labels")%></a>
		</th>	
		<%}
		//37866 End.
		%>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a3' name='a3' style='color:white'     href="javascript:callForOrderBy('DOB');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.birthDate.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a4' name='a4' style='color:white'     href="javascript:callForOrderBy('AGE');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.age.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a5' name='a5' style='color:white'    href="javascript:callForOrderBy('SEX');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.gender.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a6' name='a6'  style='color:white'   href="javascript:callForOrderBy('PID');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.patientId.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a72' name='a72'  style='color:white'   href="javascript:callForOrderBy('VT');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.visittype.label","common_labels")%></a>
		</th>
		<th class='columnHeadercenter'  nowrap  >
			<a id='a7' name='a7'  style='color:white'   href="javascript:callForOrderBy('VD');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.VisitAdmDate.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a71'  name='a71' style='color:white'   href="javascript:callForOrderBy('DD');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eCA.VisitAdmEndDate.label","ca_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a8' name='a8'  style='color:white'   href="javascript:callForOrderBy('RN');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.roomno.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a9' name='a9'  style='color:white'   href="javascript:callForOrderBy('BN');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.bedno.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a10' name='a10' style='color:white' href="javascript:callForOrderBy('AP');" onclick='changeColor(this);'  ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.AttendingPractitioner.label","common_labels")%></a>
		</th>		
		<th class='columnHeadercenter'  nowrap  >
			<a id='a11' name='a11' style='color:white'   href="javascript:callForOrderBy('MS');" onclick='changeColor(this);' ><%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.MedicalService.label","common_labels")%></a>
		</th>
	</tr>
