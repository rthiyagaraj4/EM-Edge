...
-----------------------------------------------------------------------------------------------
?             100         ?           created
18/11/2011    IN027700    Dinesh T    Changed Abnormal only checkbox to be unchecked by default
...
<table  border=0 cellpadding=3 cellspacing=0 width='100%' style='display:none' id='moreCriteria'  bordercolor=white>
	...
	<tr>
	    ...
	    <td class="LABEL"  width='25%'>
			<fmt:message key="eCA.EventGroup.label" bundle="${ca_labels}"/>
		</td>
		<td class='fields' width='25%'>
	...
	<tr>
    	<td class="LABEL" width='25%' >
			<fmt:message key="Common.Class.label" bundle="${common_labels}"/>
		</td>
		<td class='fields' width='25%'>
		...
		<td class="LABEL" width='25%' >
			<fmt:message key="Common.Abnormalonly.label" bundle="${common_labels}"/>
		</td>
		<td class='fields' width='25%'>
	...
	<td colspan=2 width='15%'>&nbsp;</td> -->
		...
		<td class='fields' width='25%'>
			<select name="order_by1" id="order_by1" >
				...
				<option value='N'><fmt:message key="Common.Event.label" bundle="${common_labels}"/></option>
			</select>
		</td>
			<!--<td>&nbsp;</td>
			<td>&nbsp;</td>
	 ...
	 <tr>
		...
		<td width='25%' colspan=2 align=right > 
			...
			<input type="button" class='button' value="<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.morecriteria.label","common_labels")+">>"%>" name='more' onClick="makeVisible(this);"></input>
		</td>
    </tr>
</table>
<!-- added by kishore kumar n on 10/12/2008  -->
...
<input type="hidden" name="return_format_HTML" id="return_format_HTML" value="<%=return_format%>"><!--  IN041284 -->
