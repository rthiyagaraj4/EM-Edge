...
<body OnMouseDown="CodeArrest()" onKeyDown="lockKey()">
	 ...
	 <table  align='center' cellpadding='3' cellspacing=0 border=0 width='100%'>
		<tr><th class='columnheader' width='100%'  colspan='3' align="left"><fmt:message key="eCA.SelectVaccine.label" bundle="${ca_labels}"/></th></tr>
		<tr>
				<td class='gridData' width="25%"><fmt:message key="Common.Vaccine.label" bundle="${common_labels}"/></td>
