	...
	<body onKeyDown='lockKey()'>
		<form name='ViewMotherLinkedNotesToolbarForm' id='ViewMotherLinkedNotesToolbarForm'>
			<table border='0' cellpadding='3' cellspacing='0' width='100%' align='center'>
				<tr>
					<td align='right'>
						<input type="button" class="BUTTON" id = "ok" name="ok" id="ok" disabled onclick='movePreviousNotes()' value='<%=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ok.label","common_labels")%>'>
