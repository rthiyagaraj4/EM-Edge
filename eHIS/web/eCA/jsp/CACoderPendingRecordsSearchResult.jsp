...
<% 
	...
	String pract_name  ="";
	String classvalue			=	"";
	ArrayList result =bean.getCoderPendingRecordsResult(patient_id,from_date,to_date,Clin_id);
...
%>
						...
						<table id="coderPendingResult" width='auto' class='grid' border="1" cellpadding="0" cellspacing="0" width="100%"  >
							<tr >
