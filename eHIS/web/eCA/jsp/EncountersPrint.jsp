...
<html>
	<head>
<%@ page import="java.sql.*,java.util.*,java.math.*,eCA.*,webbeans.eCommon.*,org.jsoup.Jsoup,org.jsoup.nodes.Document,org.jsoup.nodes.Element,java.util.Date,java.text.SimpleDateFormat,java.util.zip.*,java.io.*,eCommon.XSSRequestWrapper" contentType="text/html;charset=UTF-8"%><!-- Added Date and SimpleDateFormat for IN042733 --><!--IN063813 Added  math.*-->
...
%>
		...
		<title> <fmt:message key="Common.print.label" bundle="${common_labels}"/></title>
