function create() {
	f_query_add_mod.location.href = "../../eMR/jsp/addModifyHighRisk.jsp" ;
}
...
function query() {
	...
	f_query_add_mod.location.href ="../../eMR/jsp/HighRiskQueryCriteria.jsp";
}
...
/*			if(f_query_add_mod.document.forms[0].name == "HighRisk_form") 
				f_query_add_mod.document.HighRisk_form.reset() ;
