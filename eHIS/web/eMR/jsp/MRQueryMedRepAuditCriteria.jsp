<!DOCTYPE html>
<!--Created by Thamizh selvi on 28th Jan 2019 against ML-MMOH-CRF-1233-->
...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
 ...
 <form name='MedRepAuditCritForm' id='MedRepAuditCritForm' action='' target='result' >
	<table cellspacing=0 cellpadding=0 width='80%' border='0' align='center'>
		...
		<tr>
			<td width="10%">&nbsp;</td>
			<td class='label' width="20%"><fmt:message key="Common.Modified.label" bundle="${common_labels}"/>&nbsp;<fmt:message key="Common.date.label" bundle="${common_labels}"/></td>
			<td class="fields" width="20%"><input type='text' name='mod_from_date' id='mod_from_date' maxlength='10' size='12' onblur="doDateValidations(this);"><img src="../../eCommon/images/CommonCalendar.gif"  id='modFrmDateCalImg' onClick="document.forms[0].mod_from_date.select();return showCalendar('mod_from_date', 'dd/mm/y',null);" style="cursor='hand'">&nbsp;<img src='../../eCommon/images/mandatory.gif' ></img></td>
			<td class="fields" width="20%"><input type='text' name='mod_to_date' id='mod_to_date' maxlength='10' size='12' onblur="doDateValidations(this);"><img src="../../eCommon/images/CommonCalendar.gif"  id='modToDateCalImg' onClick="document.forms[0].mod_to_date.select();return showCalendar('mod_to_date', 'dd/mm/y',null);" style="cursor='hand'">&nbsp;<img src='../../eCommon/images/mandatory.gif' ></img></td>
		</tr>
		<tr>
		  <td COLSPAN="4"> &nbsp;</td>
		</tr>
