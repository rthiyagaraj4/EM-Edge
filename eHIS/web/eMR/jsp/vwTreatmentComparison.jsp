...
<iframe name='commontoolbarFrame' id='commontoolbarFrame'      src='<%=source%>' scrolling='NO' frameborder=0  noresize style='height:17%;width:100vw'></iframe>
	<iframe name='f_query_add_mod' id='f_query_add_mod' 	src='../jsp/vwTreatmentComparisonFrame.jsp?<%=params%>' frameborder=0 scrolling='no' noresize style='height:85%;width:100vw'></iframe>
