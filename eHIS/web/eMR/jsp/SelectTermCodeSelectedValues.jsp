...
<%@ page contentType="text/html;charset=UTF-8" import ="java.sql.*,java.lang.*, java.text.*,webbeans.eCommon.*,eCommon.XSSRequestWrapper"%>
...
<tr><th><fmt:message key="eMR.SelectedClassificationLevels.label" bundle="${mr_labels}"/></th><tr>
</table>
