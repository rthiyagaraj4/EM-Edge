...
function mychange()
 {
	 if (document.getElementById("report_type").value=='M')
	 {
		 ...
		 document.getElementById("MY1").innerHTML=getLabel("Common.month.label","Common")+"&nbsp;"
		  document.getElementById("MY").innerHTML = "<input type='text' name='p_fm_Date' id='p_fm_Date'  maxlength='7' onblur='ChkDateFormat(this)'  onKeypress='return allowPositiveNumberm();'size='7' ><input type='image'  src='../../eCommon/images/CommonCalendar.gif' onClick=\"document.forms[0].p_fm_Date.select();return showCalendar('p_fm_Date','mm/y',null)\">&nbsp;<img align='center' src='../../eCommon/images/mandatory.gif'></img>"
	 }
	 else  if (document.getElementById("report_type").value=='Y')
	 {
	    if (document.getElementById("function_id").value=='excepRep')
		 ...
		 document.getElementById("MY").innerHTML = "<input type='text' name='p_fm_Date' id='p_fm_Date'  maxlength='4' size='4' onkeypress='return allowPositiveNumbermy()' ><input type='image'  src='../../eCommon/images/CommonCalendar.gif' onClick=\"document.forms[0].p_fm_Date.select();return showCalendar('p_fm_Date','y',null)\">&nbsp;<img align='center' src='../../eCommon/images/mandatory.gif'></img>"
	 }
	  else  if (document.getElementById("report_type").value=='D')
	 {
	    if (document.getElementById("function_id").value=='excepRep')
		 {
		     document.forms[0].p_report_id.value="MRBRADEX";
		 }else{
		     document.forms[0].p_report_id.value="MRBRADEX";
		 }
	  ...
	  if (document.getElementById("report_type").value=='M')
	 {
		   if (document.getElementById("function_id").value=='excepRep')
		 {
		  ...
		  document.getElementById("MY3").innerHTML = "<input type='text' name='p_to_Date' id='p_to_Date' maxlength='7' size='7' onblur='ChkDateFormat(this)' onKeypress=' return allowPositiveNumberm();' ><input type='image'  src='../../eCommon/images/CommonCalendar.gif' onClick=\"document.forms[0].p_to_Date.select();return showCalendar('p_to_Date','mm/y',null)\">&nbsp;<img align='center' src='../../eCommon/images/mandatory.gif'></img>"
	 }
	 else  if (document.getElementById("report_type").value=='Y')
	 {
		 ...
		 document.getElementById("MY3").innerHTML = "<input type='text' name='p_to_Date' id='p_to_Date'  maxlength='4' size='4' onkeypress='return allowPositiveNumbermy()'><input type='image'  src='../../eCommon/images/CommonCalendar.gif' onClick=\"document.forms[0].p_to_Date.select();return showCalendar('p_to_Date','y',null)\">&nbsp;<img align='center' src='../../eCommon/images/mandatory.gif'></img>"
	 }
	  else  if (document.getElementById("report_type").value=='D')
	 {
		  if (document.getElementById("function_id").value=='excepRep')
...
<form name="MRBRADEX" id="MRBRADEX" action="../../eCommon/jsp/report_options.jsp" target="messageFrame">
<BR><BR><BR><BR>
...
<tr>
	...
	<td>
		<SELECT name="p_patient_class" id="p_patient_class"><option value='' style='align:center'>----- <fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/> -----</option>
		<%
...
<%if(function_id.equals("excepRep")){%>
  <input type="hidden" name="p_report_id" id="p_report_id" 		value="MRBRADEX">
<%}else{%>
  <input type="hidden" name="p_report_id" id="p_report_id" 		value="MRBRADEX">
<%}%>
