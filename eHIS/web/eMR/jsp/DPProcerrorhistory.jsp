							...
							<table  align='center' width='100%' cellpadding='1' cellspacing='0'>
								<tr>
									<td colspan="6"  class='PANELTOOLBAR' align='left'>
										<fmt:message key="eMR.ProcedureErrorHistory.label" bundle="${mr_labels}"/>
									</td>
								</tr>
								<tr></tr>
								<tr>
									...
									<th style="width:19%" align='left' nowrap><fmt:message key="eMR.NextCode.label" bundle="${mr_labels}"/>&nbsp;/&nbsp;<fmt:message key="Common.description.label" bundle="${common_labels}"/></th>
									...
									%>
										...
										<%if(!error_dtl.equals("N")){%>
											...
											<td class="gridData"><%=recorded_date_time%></td>
										</tr>
						<% }%>
							</table>
						<%}catch(Exception ex){
