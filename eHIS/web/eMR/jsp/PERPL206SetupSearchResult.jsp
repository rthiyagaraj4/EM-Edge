...
<head>
	    ...
	    <script src='../js/PERPL206Setup.js' language='javascript'></script>
...
<body onMouseDown='CodeArrest()' onKeyDown='lockKey()'>
	...
	<form name='PERPL206SetupResultForm' id='PERPL206SetupResultForm' action="../../servlet/eMR.PERPL206SetupServlet" method='post' target='messageFrame'>

<%
		JSONObject json = new JSONObject();
		JSONArray clinicListjsonArr = new JSONArray();
		json = eMR.MRCommonBean.getOPClinicList(con, service_list, facility_id);
		int noOfRecords	= 0;
...
<%
				clinicListjsonArr = (JSONArray)json.get("OPClinicListArray");
