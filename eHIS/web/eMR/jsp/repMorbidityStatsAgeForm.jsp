...
/*function CheckFromDate(obj)
{
	...
	var todate=document.forms[0].morbstatageto.value;
	if(obj.value.length > 0 && todate.length > 0 ) 
	{
		if(!doDateCheck(obj,document.forms[0].morbstatageto))
			flag1=false;
	}
	return flag1;
}
...
function CheckToDate(obj)
{
				...
				{
					CheckDate(obj);
					if(!doDateCheck(document.forms[0].morbstatagefrom,obj))
					{
						flag= false;
					}
...
<form name="morbiditystat" id="morbiditystat" action="../../eCommon/jsp/report_options.jsp" target="messageFrame">
<BR><BR><BR><BR>
...
<tr>
			...
			<td class='fields'><input type='text' id='morbstatagefrom' name='pref_month_from' id='pref_month_from' size='8' onBlur='validDateObj(this,"MY",localeName);'
			 maxLength='7'><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('morbstatagefrom', 'mm/y', null);"/></td>

			<td class='fields'><input type='text' id='morbstatageto'  name='pref_month_to' id='pref_month_to' size='8' onBlur='validDateObj(this,"MY",localeName);_GRDate(this);' maxLength='7'><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('morbstatageto', 'mm/y', null);"/></td>
</tr>
<tr>
	...
	<td class='fields' colspan='2'><input type="checkbox" name="p_include_free_text_yn_val" id="p_include_free_text_yn_val" value='' onclick='chkValmorbiditystat(this);'></td>
	</tr>
