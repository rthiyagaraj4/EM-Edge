	...
	function openHistory(){	
	     ...
	     if (ie7) {			  
			   ...
			   self.close();
				...
				var features	= "" ;			 
				var url='../../eMR/jsp/vwPatFileDetailmain.jsp?Patient_Id=<%=patient_id%>&function_id=<%=function_id%>&p_user_password=<%=p_user_password%>&login_user=<%=login_user%>'			 				
				*/
				window.open('../../eMR/jsp/vwPatFileDetailmain.jsp?Patient_Id=<%=patient_id%>&function_id=<%=function_id%>&p_user_password=<%=p_user_password%>&login_user=<%=login_user%>','eHIS','location=0,height=700,width=1015,top=0,left=0,resizable=yes');	
			}
</script>
