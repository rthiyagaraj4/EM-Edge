...
%>
	...
	<tr >
		<td></td> 
		<td class="label" width='20%'  colspan="2" ><b><center><fmt:message key="Common.medical.label" bundle="${common_labels}"/>&nbsp;<fmt:message key="Common.record.label" bundle="${common_labels}"/></center></b></td>
		<td></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td class='fields' width='25%'><input type='button' class='BUTTON' name='Search' id='Search' title= 'Search' align='right' value='<fmt:message key="Common.Select.label" bundle="${common_labels}"/>' onClick="holidayResultForMrd()"><td>      
	</tr>
	...
	<tr>
		<td></td> 
		<td class="label" width='20%'  colspan="2" ><b><fmt:message key="Common.medical.label" bundle="${common_labels}"/>&nbsp;<fmt:message key="Common.record.label" bundle="${common_labels}"/></b></td>
		<td></td>
		<tr></tr>
		<tr></tr>
		<tr></tr>
