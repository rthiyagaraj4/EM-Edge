...
function Menu(label) {
        ...
        this.fontColorHilite = "black";
        this.bgColor = "black";
        this.menuBorder = 1;
        this.menuItemBorder = 1;
        this.menuItemBgColor = "#B2B6D7";		 //background
        this.menuLiteBgColor = "black";
        this.menuBorderBgColor = "black";
        this.menuHiliteBgColor = "white";			//highlight
        this.menuContainerBgColor = "black";
        this.childMenuIcon = "/eCIS/common/images/arrows.gif";
        this.childMenuIconHilite = "/eCIS/common/images/arrows2.gif";
...
function writeMenus(container) {
    ...
    for (var i=0; i<container.menus.length; i++, countMenus++) {
        ...
        var item = menu.items[i];
			...
			var sstr='';
			if(item.length > 32){
				var sstr2 = (item.substring(0,32)).substring(0,((item.substring(0,32)).lastIndexOf(' ')));
				sstr = item.substring(0,sstr2.length)+'<br>'+item.substring(sstr2.length,60);
				count[cnt1] = 15;
			}
			else{
				sstr = item;
            ...
            var dText   = '<DIV ID="menuItemText'+ countItems +'" STYLE="position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColor +';">'+ sstr +'</DIV>\n<DIV ID="menuItemHilite'+ countItems +'" STYLE="position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColorHilite +';visibility:hidden;">'+ sstr +'</DIV>';
            if (item == "separator") {
    ...
    if (container.document.layers) {
        ...
        for (var x=0; x<container.menus.length; x++) {
            ...
            proto.menuItemWidth = proto.menuItemWidth || 210;
            ...
            for (var i=0; i<container.menus[x].items.length; i++) {
                ...
                l.style.pixelHeight = proto.menuItemHeight+count[cnt];
...
function onMenuItemOver(e, l, a) {
    ...
    if (document.layers) {
        ...
        document.onmousedown=l.Menu.onMenuItemDown; // modified by cn
        if (a) {
