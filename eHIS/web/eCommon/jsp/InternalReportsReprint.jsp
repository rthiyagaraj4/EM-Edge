...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
			...
			<%				
				...
				<center style="margin-top: 25px;"><input type='button' name='ok' id='ok' value='<fmt:message key="Common.ok.label" bundle="${common_labels}"/>   ' class='Button' onclick='toSubmit();' >&nbsp;&nbsp;&nbsp;<input type='Button' name='cancel' id='cancel' value='<fmt:message key="Common.cancel.label" bundle="${common_labels}"/>' class='Button' onclick='if("<%=rep_id%>"=="IPBWBLBW"){parent.parent.frames[1].location.href="../../eIP/jsp/IPPrintPatientWristbandCriteria.jsp";parent.parent.frames[2].location.href="../../eCommon/html/blank.html";}else{
							//parent.window.close()
							//const dialogTag = parent.parent.document.getElementById("dialog_tag");    
							//dialogTag.close();
