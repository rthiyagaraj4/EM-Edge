				...
				<tr class="COMMON_TOOLBAR">
					<td class="COMMON_TOOLBAR" align="left" width="50%">
						<table cellspacing='0' cellpading='0'>
							...
							%>
								<td class="COMMON_TOOLBAR">
									<input type='button' onclick="onApply();" value='<%=common_labels.getString("Common.apply.label")%>' id='apply' name='apply' class='BUTTON' ACCESSKEY='A'></input>
							...
							%>
								<td class="COMMON_TOOLBAR">
									<input type='button' onclick="parent.run();" value='<%=common_labels.getString("Common.run.label")%>'id='run' name='run'  class='BUTTON' ACCESSKEY='R'></input>
								</td>
							<%
								}
							%>
								...
								<td class="COMMON_TOOLBAR">
									<input type='button' onclick="reset_page();" value='<%=common_labels.getString("Common.reset.label")%>' id='reset' name='reset' class='BUTTON' ACCESSKEY='R'></input>
								</td>
								<%
								...
								<td class="COMMON_TOOLBAR">
									...
									<input type='button' onClick='parent.parent.parent.frames[1].expand(this);menuHide()' onclick="'" value='<%=common_labels.getString("Common.menu.label")%>' id='home' name='home' class='BUTTON'></input>
									<%}%>
								</td>
								<%}else{%>
									<td class="COMMON_TOOLBAR">
									<td class="COMMON_TOOLBAR">
									<%if (!home_required_yn.equals("N")) {%>
									<input type='button' onClick='parent.parent.parent.frames[1].expand(this);menuHide()' onclick="'" value='<%=common_labels.getString("Common.hideMenu.label")%>' id='home' name='home' class='BUTTON'></input>
									<%}%>
								</td>
								<%}
								}%>
