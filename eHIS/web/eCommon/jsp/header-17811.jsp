...
&nbsp;<font size="2"><%= session.getAttribute("product_description") %> <label class="version">(Version <%= session.getAttribute("version_no") %>) </label></font>
</td>
</tr>
</table>
<%}%>
...
<tr class="HEADER">
    ...
    <b><font size="-1"><%= facility_name %><BR>
	<%=site%>
    </font></b>
    </td>
    ...
    <%if(masterConfigCode.equalsIgnoreCase("USEALERT") && masterConfigValue.equalsIgnoreCase("Y")){ %>
	    <td class="HEADER" align = "left" widht="5%" nowrap>
		    <jsp:include page="AlertHeader.jsp"/>
	    </td>
    <% }%> 
