...
<script src="../../eOP/js/repVisitByStatus_SRR.js"></script>
...
<tr>
	...
	<td class='fields'><input type="text" id='mdsfrom' name="p_fm_visit_date" id="p_fm_visit_date" size="10" maxlength="10" onBlur="if(validDateObj(this,'DMY',localeName)){setDate(this)};"><img  src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('mdsfrom');" style="cursor='hand'"></img><img src='../../eCommon/images/mandatory.gif'></img>
	</td>
	<td>&nbsp;</td>
	<td class='fields'>
	    <input type="text" id='mdsto' name="p_to_visit_date" id="p_to_visit_date" size="10" maxlength="10" onBlur="if(validDateObj(this,'DMY',localeName)){setDate(this)};"><img  src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('mdsto');" style="cursor='hand'"></img><img src='../../eCommon/images/mandatory.gif'></img>
	</td>	
</tr>
<tr>
