...
<%-- Code added by Sarita on 10-Aug-10 for AK-CRF-20 --%>
...
<script src="../../eOP/js/OPDailyVisitStatsByClinic.js" language="javascript"></script>
...
<tr>
	<td class="label"><fmt:message key="eOP.TimePeriod.label" bundle="${op_labels}"/></td>
	<td class='fields'><input type="text" name="p_frm_time_period" id="p_frm_time_period" size="5" maxlength="5" value="00:00" onBlur='ChkSplChars_time(this);checkTo(this,p_to_time_period)' onkeypress='return allowPositiveNumber()'>
	</td>
	<td class='fields'><input type="text" name="p_to_time_period" id="p_to_time_period" size="5"  maxlength="5" value="23:59" onBlur='ChkSplChars_time(this);checkTo(p_frm_time_period,this)' onkeypress='return allowPositiveNumber()'>
	</td>	
</tr>
