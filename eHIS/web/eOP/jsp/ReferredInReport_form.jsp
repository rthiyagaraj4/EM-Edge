...
<script src="../../eOP/js/ReferredInRep.js" language="javascript"></script>
...
<tr>
	...
	<td class='fields' width="25%">
	<select name='p_location_type_reffto' id='p_location_type_reffto' onchange="document.forms[0].p_fm_locn_code.value='';document.forms[0].p_to_locn_code.value='';">
	<option value="">--------<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>---------</option> 
