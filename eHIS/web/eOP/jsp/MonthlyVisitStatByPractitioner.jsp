...
<%--
Filename		: MonthlyVisitStatByPractitioner.jsp
...
<tr>
	...
	<td class='fields'><input type="text" name="p_fm_pract_id" id="p_fm_pract_id" size="15" maxlength="15" onBlur='searchCode(pract_id1,this)'><input type='button' name='pract_id1' id='pract_id1' value='?' class='button' onclick='searchCode(this,p_fm_pract_id,"<%=p_facility_id%>","",document.forms[0].fm_pract_type.value)'>
	</td>	
