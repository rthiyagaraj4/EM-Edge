...
function run() 
{
	var fields = new Array ( f_query_add_mod.document.repOPRefStatDaywiseform.p_p_month,
		f_query_add_mod.document.repOPRefStatDaywiseform.p_p_year);
...
<iframe name='f_query_add_mod' id='f_query_add_mod'  noresize  frameborder=no marginheight=0 marginwidth=0 scrolling='no' src='../../eOP/jsp/repOPRefStatDaywiseform.jsp' style='height:80vh;width:100vw'></iframe>
