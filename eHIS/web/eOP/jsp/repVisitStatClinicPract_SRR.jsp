...
<td class='columnheader' align='left' width='100%'><fmt:message key="Common.reportcritera.label" bundle="${common_labels}"/></th>
</table>
...
<tr>
	...
	<br>
		...
		<input type="hidden" name="p_locale" id="p_locale"			value="<%= locale %>">
