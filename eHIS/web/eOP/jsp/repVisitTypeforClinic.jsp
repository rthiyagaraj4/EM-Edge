...
async function searchCode(obj,target)
	{					
			...
			else if(obj.name=="fm_visitTypeCode" || obj.name=="to_visitTypeCode")
            {
...
<br>
<br>
<form name="repVisitTypeforClinic" id="repVisitTypeforClinic" action="../../eCommon/jsp/report_options.jsp" target="messageFrame">
			...
			<table width='80%' cellPadding="2" cellSpacing="0"  align='center'>
				...
				<tr>
					...
					<td class='fields' colspan='2'>
						...
						<option value='3'><fmt:message key="Common.VisitTypeCode.label" bundle="${common_labels}"/>
						<option value='4'><fmt:message key="Common.VisitTypeDescription.label" bundle="${common_labels}"/>
						</select>
					</td>
				</tr>				
			</table>		
