function run() {
 ...
 else if(f_query_add_mod.document.forms[0].statistics.checked == false)
 {
	...
	if(f_query_add_mod.checkFields( fields, names, messageFrame)) 
	{
		...
		f_query_add_mod.document.forms[0].p_frm_time_period.value = f_query_add_mod.document.forms[0].p_frm_time_period.value;	
		f_query_add_mod.document.forms[0].p_to_time_period.value = f_query_add_mod.document.forms[0].p_to_time_period.value;
