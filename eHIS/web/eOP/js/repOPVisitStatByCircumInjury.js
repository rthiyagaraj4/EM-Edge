  ...
  function run() 
{
	...
	if(f_query_add_mod.CheckString(getLabel("Common.ReasonforVisit.label","Common"), f_query_add_mod.document.forms[0].p_fm_circum_inj,f_query_add_mod.document.forms[0].p_to_circum_inj, messageFrame )  )
