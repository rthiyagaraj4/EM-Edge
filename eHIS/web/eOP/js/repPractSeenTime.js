...
function run() 
{
	//var fields = new Array (f_query_add_mod.document.forms[0].p_duration);
	//var names  = new Array ( "Duration");
	...
	var fields1 = new Array( f_query_add_mod.document.forms[0].p_fm_date,
		                     f_query_add_mod.document.forms[0].p_to_date,
		                     f_query_add_mod.document.forms[0].p_duration );
    var names1 = new Array(getLabel("eOP.StatisticsDateFrom.label","Op"), getLabel("eOP.StatisticsDateTo.label","Op"),getLabel("Common.duration.label","Common"));
	...
	if(chkGrtr( f_query_add_mod.document.forms[0].p_fm_date, f_query_add_mod.document.forms[0].p_to_date) == true)
	       //if(f_query_add_mod.document.practseentime)
