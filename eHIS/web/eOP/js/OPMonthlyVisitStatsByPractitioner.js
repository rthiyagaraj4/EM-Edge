...
function run() {
 ...
 else if(f_query_add_mod.document.forms[0].statistics.checked == false)
 {
	...
	if(f_query_add_mod.checkFields( fields, names, messageFrame)) 
	{
		...
		if(CheckString1( getLabel("Common.locationcode.label","Common"),f_query_add_mod.document.forms[0].p_fm_locn_code,f_query_add_mod.document.forms[0].p_to_locn_code,messageFrame))
		if(CheckString1( getLabel("Common.practitionerid.label","Common"),f_query_add_mod.document.forms[0].p_fm_pract_id,f_query_add_mod.document.forms[0].p_to_pract_id,messageFrame))
