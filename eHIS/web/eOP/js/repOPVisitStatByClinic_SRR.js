 ...
 function run() 
{
	...
	var names1 = new Array(getLabel("Common.nationality.label","Common"),(getLabel("Common.Period.label","Common")+" "+getLabel("Common.from.label","Common")),(getLabel("Common.Period.label","Common")+" "+getLabel("Common.to.label","Common")));
