...
function getval3(obj)
{
	...
	var hcareType=document.forms[0].p_hcare_type.value;		
		...
		HTMLVal = "<HTML><BODY onKeyDown='lockKey()'><form name='form1' id='form1' method='post' action='../../eOP/jsp/RegPatRefValidation.jsp'><input type='hidden' name='process_id' id='process_id' value='9'><input name='ref_type' id='ref_type' type='hidden' value='"+ref_type + "'><input name='hcare_type' id='hcare_type' type='hidden' value='"+hcare_type + "'><input name='function_name' id='function_name' type='hidden' value='ReferredInPatientStatistics'></form></BODY></HTML>";		
