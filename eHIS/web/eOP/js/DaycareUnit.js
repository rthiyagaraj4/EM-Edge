...
var fn_status="";
function create() {
    f_query_add_mod.location.href = "../../eOP/jsp/AddClinicResource.jsp?function_id="+document.forms[0].function_id.value+"&call_func=DaycareUnit" ;
}
...
function query() {
    f_query_add_mod.location.href ="../../eOP/jsp/queryProcUnitPage.jsp?function_id="+document.forms[0].function_id.value+"&function=DaycareUnit" ;
}
...
f_query_add_mod.clinic_sub.document.clinic_resource_form.open_to_all_pract_yn.disabled=false;
...
if(f_query_add_mod.clinic_sub.checkFields( fields, names, messageFrame)) 
	{
		...
		//Added for the CRF - Bru-HIMS-CRF-0198 -- End
				 ...
				 HTMLVal = "<HTML><HEAD><link rel='stylesheet' type='text/css' href='../../eCommon/html/IeStyle.css'></link></HEAD><BODY CLASS='MESSAGE' onKeyDown='lockKey();'><form name='formloc' id='formloc' method='post' action='../../eOP/jsp/CheckFSLocationResource.jsp'><input name='mr_location_code' id='mr_location_code' type='hidden' value='"+f_query_add_mod.clinic_sub.document.getElementById("mr_location_code").value + "'><input name='mr_section_type' id='mr_section_type' type='hidden' value='"+f_query_add_mod.clinic_sub.document.getElementById("mr_section_type").value + "'><input name='centralValue' id='centralValue' type='hidden' value='"+centralValue + "'></form></BODY></HTML>";
...
function moveToTab(TabIndex) {
	...
	{     		
		...
		parent.parent.frames[1].document.getElementById("clinic_main").style.height="18vh";
		parent.parent.frames[1].document.getElementById("clinic_sub").style.height="80vh";
	...
	{
		//parent.parent.frames[1].pat_frame.rows="18%,30%,*";
		
		 //parent.parent.frames[1].pat_frame.rows="21%,10%,*"; // above line commented and this line Modified for this incident  [IN:038056]
		 parent.parent.frames[1].document.getElementById("clinic_main").style.height="18vh";
		  parent.parent.frames[1].document.getElementById("clinic_sub").style.height="80vh";
		  parent.parent.frames[1].document.getElementById("dummyframe").style.height="0vh";
...
function GetValues(obj)
	...
	var clinic_code=parent.frames[0].document.forms[0].clinic_code.value;
		/*
		alert(parent.frames[0].document.location.href)
		var specialitycode=parent.frames[1].document.forms[0].specialitycode.value;
		*/
		var HTMLVal = "<html><body onKeyDown='lockKey();'><form name='polsecserv' id='polsecserv' method='post' action='../../eOP/jsp/GetValResource.jsp'>";
		if(obj.name == "department")
		{	
			//alert("day care"+obj.name)
			clearlist(obj);
		...
		{
			clearlist(obj);
			HTMLVal+= "<input name='speciality' id='speciality' type='hidden' value='"+obj.value + "'><input name='clinic_code' id='clinic_code' type='hidden' value='"+clinic_code+ "'><input name='toPopulatefs' id='toPopulatefs' type='hidden' value='populatevs'>";
		}
		else if(obj.name == "primary_res_class")
		{
		    clearlist(obj);
...
function vitalenable()
		{
		   ...
		   var callfunc=parent.frames[1].document.forms[0].call_function.value;
			...
			{
				parent.frames[1].document.forms[0].vitalsignsb.disabled=false;		   parent.frames[1].document.forms[0].disp_in_ca_queue_after.disabled=false;
				if(parent.frames[1].document.forms[0].function_name.value=="modify")
				{
