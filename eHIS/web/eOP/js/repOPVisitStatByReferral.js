...
function run() 
{
	...
	f_query_add_mod.document.forms[0].p_fm_ref_type.value = f_query_add_mod.document.forms[0].fm_ref_type.value;	
	//f_query_add_mod.document.forms[0].p_to_ref_type.value = f_query_add_mod.document.forms[0].to_ref_type.value;	
	f_query_add_mod.document.forms[0].p_fm_ref_source.value = f_query_add_mod.document.forms[0].fm_ref_source.value;	
	//f_query_add_mod.document.forms[0].p_to_ref_source.value = f_query_add_mod.document.forms[0].to_ref_source.value;	
	if (f_query_add_mod.document.forms[0].p_fm_ref_type.value=="L"){
		f_query_add_mod.document.forms[0].p_fm_ref_source.value = f_query_add_mod.document.forms[0].p_facility_id.value;	
	//	f_query_add_mod.document.forms[0].p_fm_ref_type.value="E";
	    }
	if (f_query_add_mod.document.forms[0].p_to_ref_type.value=="L"){
		f_query_add_mod.document.forms[0].p_to_ref_source.value = f_query_add_mod.document.forms[0].p_facility_id.value;	
	//	f_query_add_mod.document.forms[0].p_to_ref_type.value="E";
	}
	...
	if(f_query_add_mod.CheckString( getLabel("Common.referraltype.label","Common"),f_query_add_mod.document.forms[0].p_fm_ref_type,f_query_add_mod.document.forms[0].p_to_ref_type,messageFrame))
	if(f_query_add_mod.CheckString( getLabel("eOP.ReferralSourceCode.label","Op"),f_query_add_mod.document.forms[0].p_fm_ref_source,f_query_add_mod.document.forms[0].p_to_ref_source,messageFrame))
