...
if(nListSize > 0)
{
  ...
  %>
			       <tr class="trWidgetRows<%=nCssCount %>">
			          ...
			          <td style ="width:93%"  align ="left" style="word-break:break-all"> <div><span  class = "spanWidRows"><b><%=oCurrentMedications.getsDrugDesc()%></b><%=oCurrentMedications.getsOrderCatalog()%></span></div></td>
			      </tr>	      
