...
<script type="text/javascript">
	...
	function openCreateCNFrame(){
		window.parent.document.getElementById('ChartSummaryIframe').src ='${path}/mobile/charts/notes/MRecClinicalNotesInit';
	}
	...
	<div class="widgetTable" data-role="none">
						...
						<div class="clinicalNotesFilterCol" data-role="none" >
							<table style="height: 100%; width: 100%" cellpadding="0" cellspacing="0" border="0">
								<tr style="height: 100%; width: 100%">
									...
									<%-- <td style = "width:50px; padding-left:5px;padding-right:5px;text-align:right" onclick=""> 
									
									
					        	<div class = "WidgetButtonTheme" id="btnsfs" ><img src = "${path}/eIPAD/images/Search.png" width="16px"; height="16px"; style="padding-top:5px;"/></div>
		...
		<div id="CNdivcnt" class="widgetContentRow" data-role="none"><!-- content row starts -->
			...
			<%
			 ...
			 %> 
				<div class="AllergyContentTable WidgetContentStripTheme clinicalNotesContent" data-notetype="<%=oCnGrp.getGroupDescription().getGroupByValue()%>" data-role="none" id="cTable"><!-- content strip starts -->
					<div class="AllergyContentRow AllergyContentRowTheme" data-role="none">
										...
										<div data-role="none" class="swipeWrapper" id="wrapper<%=nLoopCount%>" data-IdCount = "<%=nLoopCount%>" data-noteType = "<%= oCnGrp.getGroupDescription().getGroupByValue()%>"> <!-- wrapper starts -->
											...
											<%
											  ...
											  %>
															...
															data-noteTypeValue = "<%= oCnGrp.getGroupDescription().getGroupByValue()%>" 
															data-accNumber = "<%=oNoteDetailsTimeRange.getAccessionNum()%>" 
															data-notetype="<%=oNoteDetailsTimeRange.getNoteType()%>"
															data-serv="<%=oNoteDetailsTimeRange.getServiceCode()%>"
															data-perform="<%=oNoteDetailsTimeRange.getPerformedBy()%>"
															data-status="<%=oNoteDetailsTimeRange.getStatus()%>"
															data-showNote="<%=oNoteDetailsTimeRange.getActionType()%>"
																	...
																	<div data-role="none" style="display: table-row; width: 100%; height: 100%">
																		...
																		<div data-role="none" style="display: table-cell; width: 99%; height: 100%; border-radius: 30px; vertical-align: middle">
																			<div data-role="none" class="dateContainer">
																				<div data-role="none" class="notesDate"><%=oNoteDetailsTimeRange.getDescription().getDescription() %> <%=oNoteDetailsTimeRange.getDescription().getEventTime() %></div>
																			</div>
																		</div>
																	</div>
																</div>
						...
						<div class="notesContentCol3" data-role="none">
							<div class="notesExpandCollapse" data-role="none" data-expandNoteType = "<%= oCnGrp.getGroupDescription().getGroupByValue()%>" onclick = "showFullViewNotes(this ,'timeRangeView')">
				...
				%>
				<input type = "hidden" name ="hdnCNCount" id ="hdnCNCount" value = '<%=count%>'/>
				<%
				...
				<input type = "hidden" name ="hdnAccessionNum" id ="hdnAccessionNum" value = '<%=jsonFieldRes%>'/>
