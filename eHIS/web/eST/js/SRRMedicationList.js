...
{ 
	...
	if(!isBefore(document.forms[0].p_disp_date_from.value,document.forms[0].p_disp_date_to.value,"DMY",document.forms[0].p_language_id.value)) {
			...
			alert(errors);
			document.forms[0].p_disp_date_from.select();
			return false;
...
{
  	document.forms[0].doc_date.value=obj.getAttribute("doc_date");  
	document.forms[0].doc_no.value=obj.getAttribute("doc_no");   
