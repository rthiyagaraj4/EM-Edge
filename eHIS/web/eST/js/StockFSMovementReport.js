...
async function searchCodeStore(obj) {
	...
	var retValueToCommaSeperate=unescape(returnedValues);
...
function run() {
	...
	if(formObj.p_sort_order.value == "A"){
		formObj.p_sort.value == "Ascending";
	}
	else{
		if(formObj.p_sort_order.value == "D"){
			formObj.p_sort.value == "Descending";
		}
	}
