var sort_by = "";
function reset() {
	f_query_add_mod.location.href = "../../eST/jsp/DrugStockStatusByStoreFrameset.jsp";
} 
function query() {
	f_query_add_mod.location.href = "../../eST/jsp/DrugStockStatusByStoreFrameset.jsp";
}
function searchStoreCode(objCode, objDesc, user, language_id) {
	...
	dataValueArray[1] = parent.criteria.DrugStockStatusByStoreCriteria_form.p_facility_id.value;
...
function searchItemCode(objCode, objDesc) {
	...
	dataTypeArray[0] = STRING;
	argumentArray[0] = parent.criteria.DrugStockStatusByStoreCriteria_form.SQL_ST_ITEM_LOOKUP.value;
	argumentArray[1] = dataNameArray;
	argumentArray[2] = dataValueArray;
	argumentArray[3] = dataTypeArray;
	argumentArray[4] = "2,3";
...
function searchResults(frmObj) {
	...
	var fields = new Array(frmObj.from_store_code,frmObj.to_store_code);
...
/*function displayPending(trObj) {
	...
	retVal = window.showModalDialog("../../eST/jsp/DrugStockStatusByStoreFrameList.jsp?function_id=" + parent.parent.function_id + "&store_code=" + store_code + "&item_code=" + item_code, "", "dialogHeight:15; dialogWidth:40; center:0; status: no; dialogLeft :75; dialogTop :250;");
} */
...
function sortOrder(obj,image1,image2)
{
 ...
 searchResults(parent.parent.f_query_add_mod.criteria.document.DrugStockStatusByStoreCriteria_form);
}

//Added by Rabbani #RUT-CRF-0068.1[Inc no:36976] on 22-July-2013
async function callATCdesc(generic_id) {
	var retVal =await window.showModalDialog("../../eST/jsp/DrugAtcClassificationLev.jsp?generic_id="+generic_id, "", "dialogHeight:20vh; dialogWidth:25vw; center:1; status: no;  dialogTop :100;");
}
//ends
