...
var formObj = "";
function reset() {
	var formObj = f_query_add_mod.document.formStockBalanceReport;
...
function run() {
	if (f_query_add_mod.document.formStockBalanceReport) {
		formObj = f_query_add_mod.document.formStockBalanceReport;
