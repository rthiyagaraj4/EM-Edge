	...
	<body onLoad="FocusFirstElement();">
		...
		<table cellpadding="0" cellspacing="0" width="75%" align="center" border="0">
				...
				<tr>
					...
					<td class=fields>&nbsp;&nbsp;<input maxLength=20 size=20 name="p_fm_store_code" id="p_fm_store_code" value="" ><input class="button" name="p_fm_sr2" id="p_fm_sr2" onClick="return searchCodeStore(p_fm_store_code);" type="button" value="?"><%=bean.getImage("M")%></td>
					<td class="label">&nbsp;</td>
					<td class=fields colspan=5>&nbsp;&nbsp;<input maxLength=20 size=20 name="p_to_store_code" id="p_to_store_code" value="" ><input class="button" name="p_to_sr2" id="p_to_sr2" onClick="return searchCodeStore(p_to_store_code);" type="button" value="?"><%=bean.getImage("M")%></td>
				</tr> 
               <tr>
