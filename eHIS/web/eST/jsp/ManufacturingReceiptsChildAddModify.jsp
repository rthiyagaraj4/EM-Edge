	...
	<body onMouseDown="CodeArrest()">
		...
		<center>
			...
			<tr>
				...
				<td class="label"  width="15%">&nbsp;<input type="tex"  value="<%=bean.checkForNull(bean.getComponent_qty())%>"   name="component_qty" class="NUMBER" maxlength=11 size=12 onKeyPress="return allow_restrict_decimals2(this,event);"  onBlur="checkDoubleFormat(this,true); "  <%=disablefieldMod%>   >&nbsp;<img src='../../eCommon/images/mandatory.gif' ></td>
		...
		<input type='hidden' name='item_last_unit_cost' id='item_last_unit_cost'	 >
