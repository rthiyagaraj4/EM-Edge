	...
	<body onLoad="FocusFirstElement();">
		...
		<table cellpadding="0" cellspacing="0" width="75%" align="center" border="0">
				...
				<tr>
					...
					<td class="label">&nbsp;</td><td class=fields colspan=5>&nbsp;&nbsp;<input type=text name="dt_to_1" id="dt_to_1" size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this);checkDocDate(document.forms[0]);" ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dt_to_1');" ></img><%=bean.getImage("M")%>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
