...
%>
	<tr>
		...
		<td class="<%=classValue%>" class='UPPER'><input type="text" name="assm_instrn_code<%=rowIndex%>" id="assm_instrn_code<%=rowIndex%>"  size="10" maxlength="4" <%=codeReadOnly%> accesskey='C' onKeyPress="return CheckForSpecChars(event)" onBlur="parent.resetColorCode(this);convertToUpperCase(this);checkSpecialChars(this);"></td>
		<td class="<%=classValue%>"><input type="text" name="description<%=rowIndex%>" id="description<%=rowIndex%>"  size="40" maxlength="40" <%=readOnly%>  onBlur="parent.resetColorCode(this);makeValidString(this);" accesskey='L'></td>
