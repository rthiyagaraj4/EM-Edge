	...
	<body onLoad="FocusFirstElement();">
		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					<td  class="label"><fmt:message key="Common.RepackingGroup.label" bundle="${common_labels}"/></td>
				...
				<option value='1'><fmt:message key="eST.RepackingGroupCode.label" bundle="${st_labels}"/></option>
				<option value='2'><fmt:message key="eST.RepackingGroupDescription.label" bundle="${st_labels}"/></option>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
			...
			<input type="hidden" name="SQL_ST_REPACK_LOCATION_LOOKUP" id="SQL_ST_REPACK_LOCATION_LOOKUP" value="<%= eST.Common.StRepository.getStKeyValue("SQL_ST_REPACK_LOCATION_LOOKUP")%>">
