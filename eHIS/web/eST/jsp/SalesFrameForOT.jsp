...
%>
	<frameset rows='105,*'>
		<frame name='frameSalesHeader'				src="../../eST/jsp/SalesHeader.jsp?<%=request.getQueryString()%>" frameborder=0 scrolling='no'   noresize>
		<frameset cols="32%,*" >
			<frame name='frameSalesDetail'			src="../../eST/jsp/SalesDetail.jsp?<%=request.getQueryString()%>"					frameborder=0 scrolling='auto'   noresize>
			<frame name='frameSalesList'			src="../../eST/jsp/SalesListFrame.jsp?<%=request.getQueryString()%>" frameborder=0 scrolling='no' noresize>
			</frameset>
		</frameset>
	</frameset>
<%
