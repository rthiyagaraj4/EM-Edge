<!DOCTYPE html>
 <%@ page import=" eST.*, eST.Common.* , eCommon.Common.*,java.lang.*,java.util.*"
...
<body onload='FocusFirstElement();document.formGoodsReceivedNoteQueryCriteria.submit();'>
	...
	<table border="0" cellspacing="0" width="100%" align=center>
	  ...
	  <tr>
		...
		<option value="N" selected><fmt:message key="Common.NotCompleted.label" bundle="${common_labels}"/></option><!--   modified by sakti-->
		<option value="Y" ><fmt:message key="Common.completed.label" bundle="${common_labels}"/></option>
	  ...
	  <tr>
		...
		<td >&nbsp;&nbsp;</td>
		<td >&nbsp;&nbsp;</td>
		<td  class='fields' colspan="5"><input type="button" class="button" name="search" id="search" value='<fmt:message key="Common.search.label" bundle="${common_labels}"/>' onClick="return checkSysdateTo(to_doc_date,from_doc_date);"></td>
