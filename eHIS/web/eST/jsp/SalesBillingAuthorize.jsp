...
<html>
<head>
	<title><fmt:message key="eST.BillingConfirmationAlert.label" bundle="${st_labels}"/></title>
	<%
...
<form name='ConfirmTransactionForm' id='ConfirmTransactionForm' method='post'>
	...
	<tr>
		<td  colspan=2 class='fields'>
			<center> <h5> <fmt:message key="eST.InsurancePolicyIsExpiredProceed.label" bundle="${st_labels}"/>? </h5> </center>
		</td>
	</tr>
	<tr>
		<td colspan=2 class='fields'> 
