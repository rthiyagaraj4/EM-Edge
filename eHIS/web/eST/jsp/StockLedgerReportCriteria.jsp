		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<OPTION VALUE="STBSTLED1"> <fmt:message key="eST.ByItemDatewiseDetail.label" bundle="${st_labels}"/> </OPTION>
					<OPTION VALUE="STBSTLED2"> <fmt:message key="eST.ByItemDatewiseSummary.label" bundle="${st_labels}"/> </OPTION>
					</select>
					<!--&nbsp;&nbsp;<font style="visibility:visible" id = 'p_summary_style'><fmt:message key="eST.Summary.label" bundle="${common_labels}"/></font>&nbsp;<span id='p_sum'style="visibility:visible"><input type='radio' name="p_summary" id="p_summary"  value="S" onclick="assign();"  style="visibility:visible" id="p_count_style" ></span>&nbsp;&nbsp;<font style="visibility:visible" id = 'p_detail_style'><fmt:message key="eST.Detail.label" bundle="${common_labels}"/></font>&nbsp;<span id='p_det'style="visibility:visible"><input type='radio' name="p_detail" id="p_detail" value="D" onclick="assign1();" style="visibility:visible" id="p_item_style"></span></td> -->
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
				...
				<tr>
					...
					<td class=fields>&nbsp;&nbsp;<input maxLength=6 size=6 name="p_fr_str_code" id="p_fr_str_code"  value="" ><input class="button" name="p_fm_stc" id="p_fm_stc" onClick="return searchCodeStore(p_fr_str_code);"  type="button" value="?"><%=bean.getImage("M")%></td>
					<td class="label">&nbsp;</td>
					<td class=fields colspan=5>&nbsp;&nbsp;<input maxLength=6 size=6 name="p_to_str_code" id="p_to_str_code" value="" ><input class="button" name="p_to_stc" id="p_to_stc" onClick="return searchCodeStore(p_to_str_code);"  type="button" value="?" ><%=bean.getImage("M")%></td>
				</tr>
				...
				<tr>	
					...
					<class=text> / 	<class=text> <input maxLength=4 size=4 name="p_fm_year" id="p_fm_year" value="<%=curr_proc_year%>" onKeyPress="return isValidInteger();"  class="NUMBER"> <%=bean.getImage("M")%>  </td> 
					...
					<class=text> / 	<class=text> <input maxLength=4 size=4 name="p_to_year" id="p_to_year" value="<%=curr_proc_year%>" onKeyPress="return isValidInteger();"  class="NUMBER"> <%=bean.getImage("M")%>  </td> 
				</tr>
				<tr>
			...
			<!--		
					...
					<input type=text name="fm_date_1" id="fm_date_1" size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this);"  ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('fm_date_1');" ></img><%=bean.getImage("M")%>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td class="label">&nbsp;</td><td class=fields >&nbsp;&nbsp;<input type=text name="to_date_1" id="to_date_1" size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this);" ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('to_date_1');" ></img><%=bean.getImage("M")%>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
