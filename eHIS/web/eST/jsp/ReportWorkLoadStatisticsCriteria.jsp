...
<script src='../../eCommon/js/showModalDialog.js' language='JavaScript'></script>
	...
	<body onLoad="FocusFirstElement();">
		...
		<table border="0" cellpadding="0" cellspacing="0" width='75%' align='center' >
			...
			<tr>
				<td  class="label"><fmt:message key="eST.RepackGroup.label" bundle="${st_labels}"/></td>
				<td class="fields">&nbsp;&nbsp;<SELECT name="p_repacked_uom" id="p_repacked_uom"><%=bean.getRepackGroup()%>
						</select></td>
						<td class="label">&nbsp;</td>
					<td class=label>&nbsp;&nbsp;</td>
						</tr>
				...
				<tr>
					...
					<td class="label">&nbsp;</td>
					<td class=fields>&nbsp;&nbsp;<input type=text name=dt_to_1 size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this,'<%=locale%>');" ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dt_to_1');" ></img>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
				<tr>
