		...
		<table border="0" cellpadding="0" cellspacing="0" width='100%' align='center' >
			...
			<td width='100%' align='center' class="WHITE">
				...
				<tr>
					...
					<option value='p_all'><fmt:message key="Common.all.label" bundle="${common_labels}"/></option>
					<option  value='p_yes'><fmt:message key="Common.yes.label" bundle="${common_labels}"/></option>
					<option  value='p_no'><fmt:message key="Common.no.label" bundle="${common_labels}"/></option>
					</select></td>
				</tr>
				<tr>
					<td align="right">&nbsp;</td>
				...
				<tr>
					<td class="label" ><fmt:message key="eST.ItemNature.label" bundle="${st_labels}"/></td>
