...
<!-- 					<option value="NS">By Item </option> -->
					<option value="STBISSS1"><fmt:message key="eST.ByIssuingStore.label" bundle="${st_labels}"/></option> 	
					<option value="STBISSS2"><fmt:message key="eST.ByReceivingStore.label" bundle="${st_labels}"/></option> 	
					</select></td>
				...
				<tr>
					...
					<% if(restrict_stores_user_access_yn){%> <!-- added for 19789 -->
				...
				<tr>
					...
					<td class="fields">&nbsp;</td><td class=fields colspan=5>&nbsp;&nbsp;<input type=text name="dt_to_1" id="dt_to_1"  size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this,'<%=locale%>');" ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dt_to_1');" ></img>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td  class="label" ><fmt:message key="eST.IssueType.label" bundle="${st_labels}"/></td>
					...
					<option value="IS"><fmt:message key="eST.StockIssues.label" bundle="${st_labels}"/></option> 	
