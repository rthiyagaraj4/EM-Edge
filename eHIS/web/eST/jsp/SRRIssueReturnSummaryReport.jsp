	...
	<body onLoad="FocusFirstElement();">
		...
		<table cellpadding="0" cellspacing="0" width="75%" align="center" border="0">
				...
				<tr>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td class="fields">&nbsp;&nbsp;<fmt:message key="Common.to.label" bundle="${common_labels}"/></td><td class=fields colspan=5>&nbsp;&nbsp;<input type=text name=p_dt_to_1 size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this);"  >
