...
<!-- 			 	<tr>
 ...
 -->				<tr>
				...
				<tr>
					<td class=label align=left><fmt:message key="Common.RequestDate.label" bundle="${common_labels}"/></td>
				...
				<tr>
					<td  class="label"><fmt:message key="eST.RequestByStoreCode.label" bundle="${st_labels}"/></td>
					<td class=fields>&nbsp;&nbsp;<select name="p_req_by_str_code" id="p_req_by_str_code" ><%=bean.getStore_code_List()%>
					</select></td>		
					<td class="label">&nbsp;</td>
					<td class=label>&nbsp;&nbsp;</td>
				</tr>
