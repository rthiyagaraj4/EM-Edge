	...
	<body onLoad="FocusFirstElement();">
		...
		<table cellpadding="0" cellspacing="0" width="75%" align="center" border="0">
				...
				<!-- <tr>
					...
					<input type=text name=dt_from_1 size=10 maxlength=10 class="DATE" value="" onBlur="CheckDate(this);fromdate();" ><img src="../../eCommon/images/CommonCalendar.gif" onClick="return showCalendar('dt_from_1');" ></img><%=bean.getImage("M")%>&nbsp;</td>
				...
				<tr>
					<td class=label align="left"><fmt:message key="Common.ReportOrder.label" bundle="${common_labels}"/></td>
