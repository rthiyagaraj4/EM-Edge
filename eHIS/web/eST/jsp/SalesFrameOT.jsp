...
<html>
<title><fmt:message key="eST.Sales.label" bundle="${st_labels}"/></title>
<head>
<%
...
%>
	<iframe name='frameSalesForOT' id='frameSalesForOT'	src="../../eST/jsp/SalesFrameForOT.jsp?<%=request.getQueryString()%>" frameborder=0 scrolling='no'   noresize style='height:100vh;width:100vw'></iframe>
 		<iframe name='frameSalesOTFooter' id='frameSalesOTFooter'				src="../../eST/jsp/SalesOTFooter.jsp?<%=request.getQueryString()%>" frameborder=0 scrolling='no'   noresize style='height:20%;width:100vw'></iframe>
