...
<!-- 					<option value="NS">By Item </option> -->
				...
				<tr>
					...
					<td class=fields >&nbsp;&nbsp;<input maxLength=20 size=20 name="p_fm_doc_ref" id="p_fm_doc_ref" value="" ></td><td class="fields" > &nbsp;&nbsp;<fmt:message key="Common.to.label" bundle="${common_labels}"/> </td>
