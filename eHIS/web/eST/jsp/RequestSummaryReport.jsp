		...
		<table cellpadding="0" cellspacing="0" width="75%" align="center" border="0">
				...
				<tr>
					<td  class="label"><fmt:message key="Common.ReqByStore.label" bundle="${common_labels}"/></td>
						<% if(restrict_stores_user_access_yn){ %> <!-- added for 20203 -->
				...
				<tr>
					<td class="label"><fmt:message key="Common.RequestStatus.label" 
					...
					<option value="L" ><fmt:message key="eST.Closed/Cancelled.label" bundle="${st_labels}"/> </option> </select></td>
				</tr>
				<tr>
					...
					<td class=fields colspan=8>&nbsp;&nbsp;<select name="p_item_sel" id="p_item_sel">
						...
						<option value="P" ><fmt:message key="Common.PartiallyIssued.label" bundle="${common_labels}"/></option>
						<option value="F" ><fmt:message key="Common.FullyIssued.label" bundle="${common_labels}"/></option>
						<option value="N" ><fmt:message key="Common.NotIssued.label" bundle="${common_labels}"/></option>
					</select></td>
