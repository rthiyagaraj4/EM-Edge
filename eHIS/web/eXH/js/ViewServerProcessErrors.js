...
function validDateCheck()
{
	...
	var date1=this.document.forms[0].smsg_dt1.value;
	var d2Array=new Array();
	var date2=this.document.forms[0].smsg_dt2.value;
	var d1object;
	var d2object;
	if((date1!="")&&(date2!=""))
	{
...
function goSearch()
{
		...
		if(validDateCheck()&&(Checkcurrdate(this.document.forms[0].smsg_dt1))&&(Checkcurrdate(this.document.forms[0].smsg_dt2)))
	    {	 	
