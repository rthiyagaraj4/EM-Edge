...
{
	document.forms[0].action = "../servlet/eXH.QMSRDCounterSetupServlet?requestType=COUNTER_INFO&sectionCode="+obj.sectionCode+"&studyLocation="+obj.studyLocation+"&facilityID="+obj.facilityID;	
