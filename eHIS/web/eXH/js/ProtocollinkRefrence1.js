...
if(document.forms[0].expectedvalue2.value=='Y')
 ...
 names = new Array (getLabel("eXH.ExpectedValue.Label","XH"),getLabel("eXH.ExpectedValue2.Label","XH"),getLabel("eXH.Position.Label","XH"),getLabel("eXH.DerivationType.Label","XH"));
