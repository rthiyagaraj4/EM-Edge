...
<option value='IF' ><fmt:message key="eXH.IF.Label" bundle="${xh_labels}"/></option>
 ...
 <option value='GR'><fmt:message key="eXH.GlobalReferences.Label" bundle="${xh_labels}"/></option>
...
<select class='select' name=derivation_type onchange='changeTexts("myImage","myImage1","table1");'  >
	<option value=''>----------<fmt:message key="Common.defaultSelect.label" bundle="${common_labels}"/>--------</option>
<option value='ENCOD_DECOD_ALGORITH' ><fmt:message key="eXH.EncodingAlgorithm.Label" bundle="${xh_labels}"/></option>
</select>	
...
<td align=left><input type=text name=expected_value2 size=10 value='' >	<img name="myImage1" src='../../eCommon/images/empty.gif'  align=middle><input type='hidden' name='expectedvalue2' id='expectedvalue2' value=''></td>
	<td class=label  width='10%'><fmt:message key="Common.Position.label" bundle="${common_labels}"/></td><td align=left><input type=text name=Position_value size=10 value='<%=element_id%>' readonly="true"><img src='../../eCommon/images/mandatory.gif' align='middle'>
</td>
</tr>
</table>
