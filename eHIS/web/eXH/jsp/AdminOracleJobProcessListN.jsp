...
<tr>
	<td class='COLUMNHEADER'  width='30%'><fmt:message key="eXH.SerialNo.Label" bundle="${xh_labels}"/></td>
	<td class='COLUMNHEADER'  width='30%'><fmt:message key="eXH.ProtocolName.Label" bundle="${xh_labels}"/></td>
	<td class='COLUMNHEADER'  width='60%'><fmt:message key="eXH.FileCtrlType.Label" bundle="${xh_labels}"/></td>
