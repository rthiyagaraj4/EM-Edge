...
<title>Patient Membership Check</title>
	...
	<iframe name='f_query_add_mod' id='f_query_add_mod' src="../../eXH/jsp/MediExceptionalReportMaster.jsp?<%=params%>" frameborder=0  scrolling='no' style='height:23vh;width:100vw'></iframe>
