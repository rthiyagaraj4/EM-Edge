...
<td align=left><input type=text name=expected_value2 size=10 value='' >	<img name="myImage1" id="myImage1" src='../../eCommon/images/empty.gif'  align=middle><input type='hidden' name='expectedvalue2' id='expectedvalue2' value=''></td>
	<td class=label  width='10%'><fmt:message key="Common.Position.label" bundle="${common_labels}"/></td><td align=left><input type=text name=Position_value size=10 value=''> <img name="myImage3" id="myImage3" src='../../eCommon/images/mandatory.gif'  align=middle >
</td>
</tr>
</table>
