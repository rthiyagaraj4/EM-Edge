...
<!-- <td align=left class=label width="15%"><img src='../../eXH/images/yello_square.jpg' width=40 height=15> <fmt:message key="eXH.Sucessfull.Label" bundle="${xh_labels}"/>&nbsp;</td> -->
<td align=left class=label width="15%"><img src='../../eXH/images/red_square.jpg' width=40 height=15> <fmt:message key="Common.Error.label" bundle="${common_labels}"/>&nbsp;</td>
