...
<tr>
	...
	<a href='#' onClick='funModify(this)' standard_code='<%=XHDBAdapter.checkNull((String)arrCol.get(0))+""%>'
	standard_desc='<%=arrCol.get(1)+""%>' standard_type='<%=XHDBAdapter.checkNull((String)arrCol.get(2))+""%>'
	msg_start='<%=XHDBAdapter.checkNull((String)arrCol.get(3))+""%>' msg_end='<%=XHDBAdapter.checkNull((String)arrCol.get(4))+""%>'
	seg_start='<%=XHDBAdapter.checkNull((String)arrCol.get(5))+""%>' seg_end='<%=XHDBAdapter.checkNull((String)arrCol.get(6))+""%>'
	fld_separator='<%=XHDBAdapter.checkNull((String)arrCol.get(7))+""%>' elmnt_separator='<%=XHDBAdapter.checkNull((String)arrCol.get(8))+""%>'
	>
	<%=arrCol.get(0)+""%>
	</a>
	</b>
