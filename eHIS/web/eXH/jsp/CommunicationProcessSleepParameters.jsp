...
<td><input class=Button type='button' name='deltebutton' id='deltebutton' value='<fmt:message key="Common.delete.label" bundle="${common_labels}"/>' onClick="DeleteRecord('<%=arrCol.get(6)%>')" ></td>
</tr>
<%
}
if (boolToggle == true)
