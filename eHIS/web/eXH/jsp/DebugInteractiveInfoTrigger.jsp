...
<tr>
	...
	<A class='label' style='cursor:pointer' onClick="funAction1('P')"><%= strPrevious %></A>
	<A class='label'  onClick="funAction1('N')" style='cursor:pointer' ><%= strNext %></A>
	</td>
</tr>


<tr>
	<td class='COLUMNHEADER' width='25%'><a name='OPERATED_DATE_TIME' id='OPERATED_DATE_TIME' href="javascript:callSort1('OPERATED_DATE_TIME');" ><font color=white><fmt:message key="eXH.OperatedDate.Label" bundle="${xh_labels}"/></font></td> 
	<td class='COLUMNHEADER' width='15%'><a name='OPERATED_BY' id='OPERATED_BY'  href="javascript:callSort1('OPERATED_BY');" ><font color=white><fmt:message key="eXH.OperatedBy.Label" bundle="${xh_labels}"/></font></td>
   	<td class='COLUMNHEADER' width='10%'><a name='INVOKE_PRODUCT_NAME' id='INVOKE_PRODUCT_NAME' href="javascript:callSort1('INVOKE_PRODUCT_NAME');" ><font color=white><fmt:message key="Common.ProductName.label" bundle="${common_labels}"/></font></td>
	<td class='COLUMNHEADER' width='10%'><a name='TRIGGERING_EVENT' id='TRIGGERING_EVENT'  href="javascript:callSort1('TRIGGERING_EVENT');" ><font color=white><fmt:message key="eXH.TriggerEvent.Label" bundle="${xh_labels}"/></font></td>
	<td class='COLUMNHEADER' width='25%'><a id='TRIGGERING_TABLE' id='TRIGGERING_TABLE'  href="javascript:callSort1('TRIGGERING_TABLE');" ><font color=white><fmt:message key="eXH.TriggeringTable.Label" bundle="${xh_labels}"/></font></td>
...
<a href='#' onClick='funShow1(this)' OPERATEDDATETIME='<%=arrCol.get(0)+""%>' OPERATEDBY='<%=arrCol.get(1)+""%>' INVOKEPRODUCTNAME='<%=arrCol.get(2)+""%>' TRIGGERINGEVENT='<%=arrCol.get(3)+""%>' TRIGGERINGTABLE='<%=arrCol.get(4)+""%>' TRIGGERINGCONDITION='<%=arrCol.get(5)+""%>'>
&nbsp;<%=stropertedDate+""%>
</a>
</b>
</td>
