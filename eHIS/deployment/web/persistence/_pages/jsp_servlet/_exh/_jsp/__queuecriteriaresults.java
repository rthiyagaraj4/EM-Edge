...
public final class __queuecriteriaresults extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/QueueCriteriaResults.jsp", 1733051660783L ,"10.3.6.0","Asia/Calcutta")) return true;
...
finally
{
	ConnectionManager.returnConnection(dbConn);
            ...
            out.print( String.valueOf( QueueManager.BRUNEI_SITE_ID ));
