...
public final class __datcrosselementstanderdselectmaster extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/datcrossElementstanderdSelectMaster.jsp", 1709122322226L ,"10.3.6.0","Asia/Calcutta")) return true;
...
{
	System.out.println("(datcrossElementstanderdSelectMaster.jsp:error):"+e1.toString());
}
