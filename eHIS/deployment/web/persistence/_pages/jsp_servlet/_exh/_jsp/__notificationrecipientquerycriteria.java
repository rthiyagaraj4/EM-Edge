...
public final class __notificationrecipientquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/NotificationRecipientQueryCriteria.jsp", 1709117583345L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
firstItem.add("Recipient ID");     // label
firstItem.add("recipientID");  //name of field
...
strbuff = qrypg.getQueryPage(con, finAr, "NotificationRecipient", 
	"../../servlet/eXH.NotificationRecipientServlet?requestType=QUERY",
