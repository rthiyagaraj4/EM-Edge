...
public final class __gatewayserverlist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/GatewayServerList.jsp", 1731386297190L ,"10.3.6.0","Asia/Calcutta")) return true;
...
HashMap<String,String> gatewayServers = GatewayServiceBean.getConfGatewayServers(protocolLinkID);
            ...
            out.print( String.valueOf( gatewayServer.getKey() ));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf( gatewayServer.getValue() ));
            _bw.write(_wl_block10Bytes, _wl_block10);

					}
				
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf( gatewayServers.size() ));
