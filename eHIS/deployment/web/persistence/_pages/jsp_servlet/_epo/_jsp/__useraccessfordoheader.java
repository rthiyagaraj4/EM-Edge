...
public final class __useraccessfordoheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/UserAccessForDOHeader.jsp", 1709121603856L ,"10.3.6.0","Asia/Calcutta")) return true;
...
if( mode.equals( eCommon.Common.CommonRepository.getCommonKeyValue("MODE_MODIFY") )) {
            ...
            out.print( String.valueOf(PoRepository.getPoKeyValue("SQL_ST_PO_USER_LOOKUP_USERACCESS")));
