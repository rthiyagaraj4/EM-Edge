...
public final class __stporequest extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/STPORequest.jsp", 1709529206953L ,"10.3.6.0","Asia/Calcutta")) return true;
...
("PREFERRED_STYLE"):"IeStyle.css";
	...
	STPORequestBean bean = (STPORequestBean) getBeanObject("stporequestBean","ePO.STPORequestBean", request );  
	bean.initialize();
...
putObjectInBean("stporequestBean",bean,request);
