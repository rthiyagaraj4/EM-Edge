...
public final class __facilityforpurchaseunit extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/FacilityForPurchaseUnit.jsp", 1709527082330L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	String source = url + params ;
	 ...
	 FacilityForPurchaseUnitBean bean = (FacilityForPurchaseUnitBean) getBeanObject("facilityForPurchaseUnitBean","ePO.FacilityForPurchaseUnitBean", request );  
	 bean.initialize();
	...
	putObjectInBean("facilityForPurchaseUnitBean",bean,request);
