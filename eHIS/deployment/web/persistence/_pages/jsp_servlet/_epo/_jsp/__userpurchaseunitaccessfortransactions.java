...
public final class __userpurchaseunitaccessfortransactions extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/UserPurchaseUnitAccessForTransactions.jsp", 1709530108528L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	UserPurchaseUnitAccessForTransactionsBean bean = (UserPurchaseUnitAccessForTransactionsBean) getBeanObject("userPurchaseUnitAccessForTransactionsBean","ePO.UserPurchaseUnitAccessForTransactionsBean", request );  
	bean.initialize();
	...
	putObjectInBean("userPurchaseUnitAccessForTransactionsBean",bean,request);
