...
public final class __deliveryorder extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/DeliveryOrder.jsp", 1709526388782L ,"10.3.6.0","Asia/Calcutta")) return true;
...
("PREFERRED_STYLE"):"IeStyle.css";
	...
	DeliveryOrderBean bean = (DeliveryOrderBean) getBeanObject("deliveryOrderBean","ePO.DeliveryOrderBean", request );  
	bean.initialize();
	...
	if(!bean.checkForNull((String)bean.fetchRecord("select  DO_ALLOWED_YN  from  PO_USER_FOR_DELVORD where USER_ID=?",new String[]{(String) session.getValue( "login_user" )}).get("DO_ALLOWED_YN"),"N").equals("Y")){
  
            _bw.write(_wl_block12Bytes, _wl_block12);

	} 
	putObjectInBean("deliveryOrderBean",bean,request);
