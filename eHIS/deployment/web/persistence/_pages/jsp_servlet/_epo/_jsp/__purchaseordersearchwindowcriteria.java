...
public final class __purchaseordersearchwindowcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/PurchaseOrderSearchWindowCriteria.jsp", 1709121594778L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 if(global_unit_yn.equals("Y")) { 
            ...
            out.print( String.valueOf(bean.getFacilityList(po_purchase_unit)));
            _bw.write(_wl_block12Bytes, _wl_block12);
 } else { 
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(facility_disable));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(bean.getFacilityList(po_purchase_unit,bean.getLoginFacilityId())));
            _bw.write(_wl_block12Bytes, _wl_block12);
 } 
            ...
            out.print( String.valueOf(po_purchase_unit));
