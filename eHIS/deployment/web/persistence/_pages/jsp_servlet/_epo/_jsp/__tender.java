...
public final class __tender extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/Tender.jsp", 1709529428450L ,"10.3.6.0","Asia/Calcutta")) return true;
...
("PREFERRED_STYLE"):"IeStyle.css";
	...
	TenderBean bean = (TenderBean) getBeanObject("tenderBean","ePO.TenderBean", request );  
	bean.initialize();
	...
	putObjectInBean("tenderBean",bean,request);
