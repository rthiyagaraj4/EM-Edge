...
public final class __purchaseordersearchwindowresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/PurchaseOrderSearchWindowResult.jsp", 1709121595028L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block33 ="\"   width=\'20%\' >\n\t\t\t\t\t<label style=\"font-family:verdana;font-size:10\">";
    ...
    private final static java.lang.String  _wl_block53 ="\"  width=\'10%\' align=\'right\'>\n\t\t\t\t\t<input type=\"text\"  id=\'order_qty_";
    private final static byte[]  _wl_block53Bytes = _getBytes( _wl_block53 );

    private final static java.lang.String  _wl_block54 ="\' name=\'order_qty_";
    private final static byte[]  _wl_block54Bytes = _getBytes( _wl_block54 );

    private final static java.lang.String  _wl_block55 ="\'  value=\"\" disabled>\n\t\t\t\t</td>\n\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block55Bytes = _getBytes( _wl_block55 );

    private final static java.lang.String  _wl_block56 =" </label>\n\t\t\t\t</td>\n\t\t\t\t\n\t\t\t\t<input type=\"hidden\" name=\'doc_type_code_";
    private final static byte[]  _wl_block56Bytes = _getBytes( _wl_block56 );

    private final static java.lang.String  _wl_block57 ="\' id=\'doc_type_code_";
    private final static byte[]  _wl_block57Bytes = _getBytes( _wl_block57 );

    private final static java.lang.String  _wl_block58 ="\">\t\n\t\t\t\t<input type=\"hidden\" name=\'item_code_";
    private final static byte[]  _wl_block58Bytes = _getBytes( _wl_block58 );

    private final static java.lang.String  _wl_block59 ="\' id=\'item_code_";
    ...
    private final static java.lang.String  _wl_block62 ="\' id=\'item_name_";
    private final static byte[]  _wl_block62Bytes = _getBytes( _wl_block62 );

    private final static java.lang.String  _wl_block63 ="\">\t\t\t\t\t\t\n\t\t\t\t<input type=\"hidden\" name=\'store_code_";
    private final static byte[]  _wl_block63Bytes = _getBytes( _wl_block63 );

    private final static java.lang.String  _wl_block64 ="\' id=\'store_code_";
    ...
    private final static java.lang.String  _wl_block67 ="\' id=\'doc_srl_no_";
    private final static byte[]  _wl_block67Bytes = _getBytes( _wl_block67 );

    private final static java.lang.String  _wl_block68 ="\">\n\t\t\t\t<input type=\"hidden\" name=\'facility_id_";
    private final static byte[]  _wl_block68Bytes = _getBytes( _wl_block68 );

    private final static java.lang.String  _wl_block69 ="\' id=\'facility_id_";
    ...
    private final static java.lang.String  _wl_block72 ="\' id=\'order_uom_";
