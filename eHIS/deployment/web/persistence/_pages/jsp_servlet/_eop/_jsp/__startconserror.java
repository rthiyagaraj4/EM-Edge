...
public final class __startconserror extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eop/jsp/StartConserror.jsp", 1739188208899L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\").replace(/\\+/g, \' \'));//Modified by Thamizh selvi on 5th Dec 2017\n\t\tvar r1 = r;\n\t\tif(r == getMessage(\"RECORD_MODIFIED\",\"SM\")){\n\t\t\tr = r.substr(0,r.length-5);\n\t\t}\n\t\talert(r);\n\t\tvar moduleId = \"";
