...
public final class __fetchvalforopparameter extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eop/jsp/FetchValForOPParameter.jsp", 1731310160299L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\'==temp)\n\t\t\t\t\topt.selected=true\n\t\t\t\t\t\n\t\t\t\tcomp.add(opt)\n\t\t</script>\n\t";
