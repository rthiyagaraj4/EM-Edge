...
public final class __visitregistrationlastvisitdetails1 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eop/jsp/VisitRegistrationLastVisitDetails1.jsp", 1709119506334L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\'></link>\n\t\t<script language=\'javascript\'>\n\t\t\tfunction ButtonClick(flag)\n\t\t\t{\n\t\t\t\twindow.returnValue=\"Y\";\n\t\t\t\twindow.close();\n\t\t\t}\n\t\t\tfunction show_detail(obj)\n\t\t\t{\n\t\t\t\tif (obj.value == \"Y\")\n\t\t\t\t{\n\t\t\t\t\tobj.value = \"N\";\n\t\t\t\t\tparent.frames[1].location.href = \"../../eOP/jsp/VisitRegistrationLastVisitDetails2.jsp?encounter_id=";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOP.ForSpecifiedService.label", java.lang.String .class,"key"));
