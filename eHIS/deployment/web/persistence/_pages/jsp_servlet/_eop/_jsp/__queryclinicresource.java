...
public final class __queryclinicresource extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eop/jsp/QueryClinicResource.jsp", 1720585982468L ,"10.3.6.0","Asia/Calcutta")) return true;
...
try{
	...
	String res_class=request.getParameter("res_class");
	    res_class=(res_class==null)?"":res_class;
     
		 
	 if(res_class.equals("A"))res_class="";
    ...
    if ( !(clinic_type == null || clinic_type.equals("")) )
        {

              sql.append( " and upper(a.clinic_type) like  upper('"+clinic_type+"%')" );
	...
	if(!(res_class.equals("")))
		{
		  sql.append(" and primary_resource_class='"+res_class+"' ");
		}
...
if ( !(start <= 1) )
    out.println("<A HREF='../../eOP/jsp/QueryClinicResource.jsp?function="+function+"&function_id="+function_id+"&from="+(start-14)+"&to="+(end-14)+"&whereclause="+URLEncoder.encode(sql.toString())+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.previous.label","common_labels")+"</A>");

if ( endOfRes.equals("1") )

    out.println("<A id='nextval' HREF='../../eOP/jsp/QueryClinicResource.jsp?function="+function+"&function_id="+function_id+"&from="+(start+14)+"&to="+(end+14)+"&whereclause="+URLEncoder.encode(sql.toString())+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.next.label","common_labels")+"</A>");
