...
public final class __transactionsofmergeprocessheader1 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/edr/jsp/TransactionsOfMergeProcessHeader1.jsp", 1709116660245L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\' onClick=\'changeRowColor(this,3)\' href=\'javascript:callDupGroupDetails(\"";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\",\"S\")\' id=\'_a";
	...
	try
	{
		...
		if(to == null) end = 5;
            ...
            _bw.write(_wl_block9Bytes, _wl_block9);
				...
				{
					str = "SELECT count(*) total FROM dr_dup_group_vw2 " + sql + " AND dup_group_id LIKE '%%'";
