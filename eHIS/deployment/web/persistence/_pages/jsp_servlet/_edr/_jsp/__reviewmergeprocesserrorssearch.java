...
public final class __reviewmergeprocesserrorssearch extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/edr/jsp/ReviewMergeProcessErrorsSearch.jsp", 1742360198737L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\' name=\'patient_id\' value=\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' onBlur=\"touppercase(this)\"><input type=\'button\' name=\'patient_search_button\' id=\'patient_search_button\' value=\'?\' class=\'button\' onClick=\"callPatientSearch()\">\n\t\t\t\t\t</td>\n\t\t\t\t\t<td class=\'button\'><input type=button class=button name=\'search\' id=\'search\' value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' onClick=\"callDuplicatesGroups()\"></td>\n\t\t\t\t</tr>\n\t\t\t\t<tr><td class=\'label\' colspan=\'3\'>&nbsp;</td></tr>\n\t \t\t</table>\n\t\t</form>\n\t\t";
