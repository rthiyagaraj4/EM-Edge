...
public final class __stockstatusframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/elc/QueryStockStatus/jsp/StockStatusFrame.jsp", 1709118354448L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	radioFrame=request.getContextPath()+"/eLC/QueryStockStatus/jsp/RadioButtons.jsp";
            ...
            out.print( String.valueOf(radioFrame));
