...
public final class __workplaceallocationresult2 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ers/jsp/WorkplaceAllocationResult2.jsp", 1709121669261L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block39 ="\" id=\"";
    private final static byte[]  _wl_block39Bytes = _getBytes( _wl_block39 );

    private final static java.lang.String  _wl_block40 ="\" width=\'3%\'>&nbsp;&nbsp;\n";
    ...
    private final static java.lang.String  _wl_block46 ="\" width=\'3%\'>&nbsp;&nbsp;</td>\n\t\t";
...
try{
		...
		statement.execute() ;
			...
			//sql_wp_allocation_det="select b.workplace_desc,c.position_desc, trunc(a.schedule_date) sch_date, (trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace b, am_position c, am_shift d where a.facility_id = ? and (? is null or a.workplace_code = ?) and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.position_code = a.position_code and d.shift_code = a.shift_code and d.shift_indicator = 'P' group by b.workplace_desc, c.position_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') order by b.workplace_desc,c.position_desc, sch_date";
			//sql_wp_allocation_det="select b.workplace_desc,c.position_desc, trunc(a.schedule_date) sch_date, (trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace_lang_vw b, am_position_lang_vw c, am_shift d where a.facility_id = ? and (? is null or a.workplace_code = ?) and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.position_code = a.position_code and d.shift_code = a.shift_code and d.shift_indicator = 'P' group by b.workplace_desc, c.position_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') and b.language_id = ? and c.language_id = b.language_id order by b.workplace_desc,c.position_desc, sch_date";
			sql_wp_allocation_det="select b.workplace_desc,c.position_desc, trunc(a.schedule_date) sch_date, (trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace_lang_vw b, am_position_lang_vw c, am_shift d where a.facility_id = ? and (? is null or a.workplace_code = ?) and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.position_code = a.position_code and d.shift_code = a.shift_code and d.shift_indicator = 'P' and b.language_id = ? and c.language_id = b.language_id group by b.workplace_desc, c.position_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') order by b.workplace_desc,c.position_desc, sch_date";
...
if((aa[kkk]==0) && (rr[kkk]==0))
{
	aa[kkk]=Integer.parseInt(a[kkk]);
	rr[kkk]=Integer.parseInt(r[kkk]);
}
else
{
	aa[kkk]=aa[kkk]+Integer.parseInt(a[kkk]);
	rr[kkk]=rr[kkk]+Integer.parseInt(r[kkk]);
}
borderc = "";				
}
else
{
	...
	hh++;	
		...
		if((a[kkk1]!=null) && (r[kkk1]!=null)){
            ...
            out.print( String.valueOf(aa[kkk1]));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(rr[kkk1]));
            _bw.write(_wl_block12Bytes, _wl_block12);
...
finally
{
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eRS.TotalByWorkPlace.label", java.lang.String .class,"key"));
