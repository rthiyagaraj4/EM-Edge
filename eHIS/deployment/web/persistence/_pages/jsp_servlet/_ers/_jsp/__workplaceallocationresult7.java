...
public final class __workplaceallocationresult7 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ers/jsp/WorkplaceAllocationResult7.jsp", 1709121670261L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block37 =" width=\'3%\' align=\'center\' id=";
    ...
    private final static java.lang.String  _wl_block43 =" width=\'3%\'>&nbsp;&nbsp;\n\t\t\t";
    ...
    private final static java.lang.String  _wl_block49 ="  width=\'3%\'>&nbsp;";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		statement2.execute() ;
			...
			//sql_wp_allocation_det="select d.position_desc, b.workplace_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no,sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace b, am_shift c, am_position d where a.facility_id = ? and (? is null or a.workplace_code = ?) and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')+1) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and d.position_code = a.position_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' group by d.position_desc, b.workplace_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')order by d.position_desc, b.workplace_desc, sch_date";
			sql_wp_allocation_det="select d.position_desc, b.workplace_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no,sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace_lang_vw b, am_shift c, am_position_lang_vw d where a.facility_id = ? and (? is null or a.workplace_code = ?) and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')+1) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and d.position_code = a.position_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' and b.language_id = ? and d.language_id = b.language_id group by d.position_desc, b.workplace_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')order by d.position_desc, b.workplace_desc, sch_date";
...
sh = rs_wp_allocation_det.getString("workplace_desc");
wp_temp = wp;
sh_temp = sh;
...
{		
	...
	{ 
				...
				{ 
					...
					cell_no1[cell]=cell;
					m[cell] = rs_wp_allocation_det.getString("allocated");
					n[cell] = rs_wp_allocation_det.getString("required");
			...
			sh_temp=sh;
				...
				if(cell_no1[kkk]==kkk )
				{ 
					int all=Integer.parseInt(m[kkk]);
	    			int req=Integer.parseInt(n[kkk]);
            ...
            _bw.write(_wl_block40Bytes, _wl_block40);
						...
						if(total[kkk]==0){
							total[kkk]=Integer.parseInt(m[kkk]);
							total11[kkk]=total11[kkk]+Integer.parseInt(n[kkk]);
				}
				else
				{
					total[kkk]=total[kkk]+Integer.parseInt(m[kkk]);
					total11[kkk]=total[kkk]+Integer.parseInt(n[kkk]);
				}
				borderc = "";				
				}
				else
	...
	wp_temp = wp;
		...
		else if(total[kkk1]==0 && total11[kkk1]!=0)
		{
						if(total[kkk1] == total11[kkk1])
						{
							classval	=	"OPTIMAL";
...
finally
{
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eRS.TotalByPosition.label", java.lang.String .class,"key"));
