...
public final class __workplaceallocationresult9 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ers/jsp/WorkplaceAllocationResult9.jsp", 1709121670636L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block38 ="\n<tr>\n\t\t<td class=\'Total\' width=\'3%\' nowrap><b>";
    ...
    private final static java.lang.String  _wl_block41 ="\" width=\'3%\' align=\'center\' id=";
    ...
    private final static java.lang.String  _wl_block46 =" width=\'3%\'>&nbsp;&nbsp; \n\t\t\t\t\t";
    private final static byte[]  _wl_block46Bytes = _getBytes( _wl_block46 );

    private final static java.lang.String  _wl_block47 ="\n\t\t<tr >\n\t\t<td class=\'Total\'  nowrap><b>";
    ...
    private final static java.lang.String  _wl_block50 ="\"  width=\'3%\' align=\'center\' ";
    private final static byte[]  _wl_block50Bytes = _getBytes( _wl_block50 );

    private final static java.lang.String  _wl_block51 ="\n\t\t<td  class=\"";
    private final static byte[]  _wl_block51Bytes = _getBytes( _wl_block51 );

    private final static java.lang.String  _wl_block52 ="\" width=\'3%\'>&nbsp;";
    ...
    private final static java.lang.String  _wl_block55 =" width=\'3%\'>&nbsp;";
    ...
    private final static java.lang.String  _wl_block58 ="\n\t<tr >\n\t\t<td class=\'Total_POS\'  nowrap><b>";
    private final static byte[]  _wl_block58Bytes = _getBytes( _wl_block58 );

    private final static java.lang.String  _wl_block59 ="\n\t\t<td class=";
    private final static byte[]  _wl_block59Bytes = _getBytes( _wl_block59 );

    private final static java.lang.String  _wl_block60 ="  width=\'3%\' align=\'center\' ";
    private final static byte[]  _wl_block60Bytes = _getBytes( _wl_block60 );

    private final static java.lang.String  _wl_block61 ="\"  width=\'3%\'>&nbsp;";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		statement2.execute() ;
			...
			//sql_wp_allocation_det="select d.position_desc, c.short_desc shift_desc, b.workplace_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no,sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace b, am_shift c, am_position d where a.facility_id = ? and (? is null or a.workplace_code = ?)and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' and d.position_code = a.position_code group by d.position_desc, c.short_desc, b.workplace_desc,  trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') order by d.position_desc, shift_desc, b.workplace_desc, sch_date ";
			sql_wp_allocation_det="select d.position_desc, c.short_desc shift_desc, b.workplace_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no,sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace_lang_vw b, am_shift_lang_vw c, am_position_lang_vw d where a.facility_id = ? and (? is null or a.workplace_code = ?)and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' and d.position_code = a.position_code and b.language_id = ? and c.language_id = b.language_id and d.language_id = b.language_id group by d.position_desc, c.short_desc, b.workplace_desc,  trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') order by d.position_desc, shift_desc, b.workplace_desc, sch_date ";
...
int total_sh[]=new int[15];
int total_sh11[]=new int[15];
int total_pos[]=new int[15];
int total_pos11[]=new int[15];
int hh=0;
...
{		
	for(int q = 0; q<14; q++)
		cell_no1[q] = -1;
            ...
            out.print( String.valueOf(pos_temp));
            _bw.write(_wl_block34Bytes, _wl_block34);

	while (pos_temp.equals(pos) && flag.equals("1"))
	{ 
			
            _bw.write(_wl_block35Bytes, _wl_block35);
            out.print( String.valueOf(sh_temp));
            _bw.write(_wl_block36Bytes, _wl_block36);

				while (pos_temp.equals(pos) && sh_temp.equals(sh)&& flag.equals("1"))
				{ 
            ...
            out.print( String.valueOf(wp_temp));
            _bw.write(_wl_block39Bytes, _wl_block39);

			    classval="EmptyCell";
				while (pos_temp.equals(pos) && sh_temp.equals(sh) && wp_temp.equals(wp)&& flag.equals("1"))
				{ 
					...
					p[cell] = Integer.parseInt(rs_wp_allocation_det.getString("required"));
            ...
            out.print( String.valueOf(wp_disp));
            _bw.write(_wl_block44Bytes, _wl_block44);

					if(total_sh[kkk]==0)
					{
					total_sh[kkk]=m[kkk];
					total_sh11[kkk]=total_sh11[kkk]+p[kkk];
					}
     				else
					{
					total_sh[kkk]=total_sh[kkk]+m[kkk];
					total_sh11[kkk]=total_sh11[kkk]+p[kkk];
					}
					borderc = "";				
					}else{
		...
		{
			String disp=total_sh[kkk1]+"/"+total_sh11[kkk1];
		if(total_sh[kkk1]!=0 && total_sh11[kkk1]!=0){
			if(total_sh[kkk1] == total_sh11[kkk1])
			{
				classval	=	"OPTIMAL";
			}
			if(total_sh[kkk1] >total_sh11[kkk1])
			...
			if(total_pos[kkk1]==0){
					total_pos[kkk1]=total_sh[kkk1];
					total_pos11[kkk1]=total_pos11[kkk1]+total_sh11[kkk1];
				}
				else
					{
					total_pos[kkk1]=total_pos[kkk1]+total_sh[kkk1];
					total_pos11[kkk1]=total_pos11[kkk1]+total_sh11[kkk1];
					}	
					
		}
		else if(total_sh[kkk1]==0 && total_sh11[kkk1]!=0)
		{
			if(total_sh[kkk1] == total_sh11[kkk1])
			{
				classval	=	"OPTIMAL";
	...
	pos_temp = pos;
		...
		for(int kkk1=0;kkk1<14;kkk1++){
			String disp=total_pos[kkk1]+"/"+total_pos11[kkk1];
		if(total_pos[kkk1]!=0 && total_pos11[kkk1]!=0 ){
		if(total_pos[kkk1] == total_pos11[kkk1])
			{
				classval	=	"OPTIMAL";
			}
			if(total_pos[kkk1] > total_pos11[kkk1])
		...
		else if(total_pos[kkk1]==0 && total_pos11[kkk1]!=0)
		{
			if(total_pos[kkk1] == total_pos11[kkk1])
			{
				classval	=	"OPTIMAL";
...
finally
{
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eRS.TotalByShift.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eRS.TotalByPosition.label", java.lang.String .class,"key"));
