...
public final class __blreprintpopuppage extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLReprintPopupPage.jsp", 1709724066798L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String genlater	= request.getParameter("billgenlater");
            ...
            out.print( String.valueOf(genlater));
