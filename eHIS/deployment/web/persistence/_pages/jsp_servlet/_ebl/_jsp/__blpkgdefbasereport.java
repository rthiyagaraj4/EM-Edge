...
public final class __blpkgdefbasereport extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLPkgDefBaseReport.jsp", 1709114570899L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
 ...
 request.setCharacterEncoding("UTF-8");	
	...
	//String p_facility_id = (String)session.getValue("facilityId");
	//System.out.println("p_facility_id in PACKAGE "+p_facility_id);
	String facilityId	= request.getParameter("facilityId");
	System.out.println("facilityId in PACKAGE "+facilityId);
	...
	System.out.println("packageCode in PACKAGE "+packageCode);
	System.out.println("fromDate in PACKAGE "+fromDate);
	System.out.println("blgClsCode in PACKAGE "+blgClsCode);
	System.out.println("p_facility_id in PACKAGE "+facilityId);
