...
public final class __bleclaimspayerwisedashboard extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLEClaimsPayerWiseDashboard.jsp", 1709114488117L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block14 ="\n\n<BODY onKeyDown=\"lockKey();\" onMouseDown=\"CodeArrest();\" onSelect=\"codeArrestThruSelect();\" >\n<form id = \"payerWiseDashboard\" name = \"payerWiseDashboard\">\n";
...
if(sStyle.equals("IeStyle.css")){
	...
	System.err.println("login_user in BLEClaimsPayerWiseDashboard.jsp:"+login_user);
	...
	System.err.println("URL Parameters :- Patient_id= "+qry_patient_id+", Episode_type="+qry_episode_type+" , Encounter_id="+qry_encounter_id+", Statement_duration_from_date="+qry_State_dur_from_date+", Statement_duration_to_date="+qry_State_dur_to_date+", Insurance_Status="+qry_insurance_Status+", Payer_grp_code="+qry_payer_grp_code+", Payer_code="+qry_payer_code+", Policy_type_code="+qry_policy_type_code+", Approval_doc_ref_no="+qry_approval_doc_ref_no+", Claim_id="+qry_claim_id+", Claims_services_level= "+qry_claims_services_level);

            _bw.write(_wl_block14Bytes, _wl_block14);

	try{
		con	=	ConnectionManager.getConnection(request);
		sql = "select payer_code,payer,sum(cnt) from (SELECT b.cust_code payer_code,decode(b.cust_code,'**','All Payer',(select cust.long_name from ar_customer cust where  cust.cust_code  = b.cust_code)) payer,b.encounter_id,b.patient_id,COUNT (1) cnt FROM BL_CLAIM_BILL_DTL b WHERE b.operating_facility_id = ? ";
		...
		sql = sql + "AND ? = 'C' GROUP BY b.cust_code, b.encounter_id, b.patient_id ";
		sql = sql + "union ";
		sql = sql + "SELECT  b.cust_code payer_code,decode(b.cust_code,'**','All Payer',(select cust.long_name from ar_customer cust where  cust.cust_code  = b.cust_code)) payer, b.encounter_id, b.patient_id, COUNT (distinct b.bill_doc_type_code) FROM bl_claim_service_dtl a, (select operating_facility_id,bill_doc_type_code,bill_doc_num,patient_id,encounter_id,cust_code,claim_status from BL_CLAIM_BILL_DTL where operating_facility_id = ? ";
		if(!"".equals(qry_patient_id)){
		...
		sql = sql + "AND ? = 'S' GROUP BY b.cust_code, b.encounter_id, b.patient_id) group by payer_code,payer ";
		...
		while ( rst.next() ){
			...
			String payerCode = checkForNull(rst.getString("payer_code"));
			String payer = checkForNull(rst.getString("payer"));
			int count = rst.getInt(3);
			row_count++;
			System.out.println("Payer code : "+payerCode+", Payer : "+payer+", Count : "+count);
			if(row_count == 1)
			{
		...
		System.err.println("Result count : "+row_count); 
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eBL.claims_by_payer_enc_level.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eBL.ClickDetails.label", java.lang.String .class,"key"));
