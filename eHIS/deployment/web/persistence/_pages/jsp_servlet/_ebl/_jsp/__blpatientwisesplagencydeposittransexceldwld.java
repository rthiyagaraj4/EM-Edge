...
public final class __blpatientwisesplagencydeposittransexceldwld extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLPatientWiseSplAgencyDepositTransExcelDwld.jsp", 1709114109709L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
	...
	public void createExcelFile(Connection con, String facilityId,
		...
		try {
			...
			BLPatientWiseSplAgencyDepositTrans splTrans = new BLPatientWiseSplAgencyDepositTrans();
			...
			LinkedHashMap<String, List<BLPatientWiseSplAgencyTransModel>> transMap = splTrans.getTransMap();
			...
			cell.setCellValue(nulltoStr(legendMap.get("BLRPSAD.LEGEND_010")));
			...
			cell = row.createCell(colId);
			cell.setCellValue(nulltoStr(legendMap.get("BLRPSAD.LEGEND_050")));
			cell.setCellStyle(styleBold);
			colId++;
			...
			cell = row.createCell(colId);
			cell.setCellValue(nulltoStr(legendMap.get("BLRPSAD.LEGEND_020")));
			cell.setCellStyle(styleBold);
			colId++;
			...
			cell = row.createCell(colId);
			cell.setCellValue(nulltoStr(legendMap.get("BLRPSAD.LEGEND_060")));
			cell.setCellStyle(styleBold);
			colId++;
			...
			cell = row.createCell(colId);
			cell.setCellValue(nulltoStr(legendMap.get("BLRPSAD.LEGEND_040")));
			cell.setCellStyle(styleBold);
			colId++;
			...
			cell = row.createCell(colId);
			cell.setCellValue("BLRPSAD");
			colId++;

			cell = row.createCell(colId);
			cell.setCellValue(nulltoStr(legendMap.get("BLRPSAD.LEGEND_210"))+
			...
			cell = row.createCell(colId);
			cell.setCellValue(nulltoStr(legendMap.get("BLRPSAD.LEGEND_080")));
			...
			for (String itr : patIdList) {
				...
				List<BLPatientWiseSplAgencyTransModel> recordList = transMap.get(itr);
				...
				cell = row.createCell(colId);
				cell.setCellValue(nulltoStr(legendMap
						.get("BLRPSAD.LEGEND_090")));
				cell.setCellStyle(styleBoldAllBorder);
				colId++;

				cell = row.createCell(colId);
				cell.setCellValue(nulltoStr(legendMap
						.get("BLRPSAD.LEGEND_100")));
				cell.setCellStyle(styleBoldAllBorder);
				colId++;

				cell = row.createCell(colId);
				cell.setCellValue(nulltoStr(legendMap
						.get("BLRPSAD.LEGEND_110")));
				cell.setCellStyle(styleBoldAllBorder);
				colId++;

				cell = row.createCell(colId);
				cell.setCellValue(nulltoStr(legendMap
						.get("BLRPSAD.LEGEND_120")));
				cell.setCellStyle(styleBoldAllBorder);
				colId++;

				cell = row.createCell(colId);
				cell.setCellValue(nulltoStr(legendMap
						.get("BLRPSAD.LEGEND_130")));
				cell.setCellStyle(styleBoldAllBorder);
				colId++;

				cell = row.createCell(colId);
				cell.setCellValue(nulltoStr(legendMap
						.get("BLRPSAD.LEGEND_140")));
				cell.setCellStyle(styleBoldAllBorder);
				colId++;

				cell = row.createCell(colId);
				cell.setCellValue(nulltoStr(legendMap
						.get("BLRPSAD.LEGEND_150")));
				cell.setCellStyle(styleBoldAllBorder);
				colId++;

				cell = row.createCell(colId);
				cell.setCellValue(nulltoStr(legendMap
						.get("BLRPSAD.LEGEND_160")));
				cell.setCellStyle(styleBoldAllBorder);
				colId++;

				for (int j = 0; j < recordList.size(); j++) {
					
					BLPatientWiseSplAgencyTransModel model = recordList.get(j);
					...
					cell = row.createCell(colId);
					cell.setCellValue(nulltoStr(model.getEncounterType()));
					cell.setCellStyle(styleAllBorder);
					colId++;
				...
				//creating new row
				colId = 4;//resetting colId to 4
				rowId++;
				row = sheet.createRow(rowId);

				cell = row.createCell(colId);
				cell.setCellValue(nulltoStr(legendMap
						.get("BLRPSAD.LEGEND_170"))+":");
