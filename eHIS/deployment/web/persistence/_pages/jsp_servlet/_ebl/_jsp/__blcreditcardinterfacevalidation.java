...
public final class __blcreditcardinterfacevalidation extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLCreditCardInterfaceValidation.jsp", 1742750333510L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 */ 
	...
	try {
		...
		//conn = ConnectionManager.getConnection();//V211020
	...
	//Added by Gopinath for ML-MMOH-SCF-2469 on 20/07/2023 Fetching Customer ID
	String strCustomerId = "";
	try {		
		sqlStatement = "SELECT CUSTOMER_ID FROM SM_SITE_PARAM";
		...
		if(isDebugYN)
			System.out.println("***Inside Credit Card Interface Validation - Cutomer ID query... "+sqlStatement+" ***CUSTOMER_ID... "+strCustomerId);
	}
	catch (Exception e){
		System.out.println("***Inside Credit Card Interface Validation - Exception in Fetching CUSTOMER_ID... "+e);
	}
	finally 
	{
		if (rs != null)   rs.close();
