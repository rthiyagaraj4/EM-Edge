...
public final class __commontoolbarintrime extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/CommonToolBarIntrime.jsp", 1716357016314L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block8 ="\' name=\'create\'  id=\'create\' class=\'BUTTON\' ACCESSKEY=\'C\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block11 ="\' name=\'query\'  id=\'query\' class=\'BUTTON\' ACCESSKEY=\'Q\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\n\t\t\t\t\t\t\t\t<td class=\"COMMON_TOOLBAR\">\n\t\t\t\t\t\t\t\t\t<input type=\'button\' onclick=\"onDelete();\" value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' class=\'BUTTON\' ACCESSKEY=\'D\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\n\t\t\t\t\t\t\t\t<td class=\"COMMON_TOOLBAR\">\n\t\t\t\t\t\t\t\t\t<input type=\'button\' onclick=\"onApply();\" value=\'";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\' name=\'apply\' id=\'apply\' class=\'BUTTON\' ACCESSKEY=\'A\'></input>\n\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\n\t\t\t\t\t\t\t\t<td class=\"COMMON_TOOLBAR\">\n\t\t\t\t\t\t\t\t\t<input type=\'button\' onclick=\"parent.run();\" value=\'";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\' name=\'run\' id=\'run\' class=\'BUTTON\' ACCESSKEY=\'R\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\n\n\t\t\t\t\t\t\t\t<td class=\"COMMON_TOOLBAR\">\n\t\t\t\t\t\t\t\t\t<input type=\'button\' onclick=\"reset_page();\" value=\'";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\' name=\'reset\' id=\'reset\' class=\'BUTTON\' ACCESSKEY=\'R\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block22 ="\' name=\'home\' id=\'home\' class=\'BUTTON\'></input>\n\t\t\t\t\t\t\t\t\t";
