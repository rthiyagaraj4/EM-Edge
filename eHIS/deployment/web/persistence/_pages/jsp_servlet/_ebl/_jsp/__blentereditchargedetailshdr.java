...
public final class __blentereditchargedetailshdr extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLEnterEditChargeDetailsHdr.jsp", 1709114493852L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="</b></td>\n\t\t\t<td  class=\"fields\"><input type=\'text\' name=\'order_catalog_desc\' id=\'order_catalog_desc\' size=\'40\' readonly maxlength=\'30\'  value=\'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\'></td>\t\t\t\t\t\t\n\t\t\t<td  class=\'label\'><b>";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="</b></td>\n\t\t\t<td  class=\"fields\"><input type=\'text\' name=\'panel_desc\' id=\'panel_desc\' size=\'40\' readonly maxlength=\'30\'  value=\'";
...
try{	
	if(!p_order_catalog_code.equals(""))
	{
		...
		String sStyle =		(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
            ...
            out.print( String.valueOf(strorder_short_desc));
            _bw.write(_wl_block11Bytes, _wl_block11);

            if (_jsp__tag1(request, response, pageContext, _activeTag, null))
             return;
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(strpanel_short_desc));
