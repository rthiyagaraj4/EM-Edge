...
public final class __blpolicyvalidacrossencounters extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLPolicyValidAcrossEncounters.jsp", 1709114578415L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t\t\t<tr>\n\t\t\t<td class=\'fields\'><a href=\'#\' onClick=\"selectEncounter(\'";
	...
	try
	{
		...
		{			
            ...
            out.print( String.valueOf(acrossEncGrpID));
            ...
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(custDesc ));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(policyTypeDesc ));
