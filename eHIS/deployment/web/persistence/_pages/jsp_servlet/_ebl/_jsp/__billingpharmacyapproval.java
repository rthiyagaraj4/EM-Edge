...
public final class __billingpharmacyapproval extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eBL/jsp/BillingPharmacyapproval.jsp", 1725509317913L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    throws javax.servlet.ServletException, java.io.IOException {
		...
		String sStyle =		(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
			...
			//String calledForm = "PharmacyApproval";
