...
public final class __rcrdapprovalpolicydetailspreapproval extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/RcrdApprovalPolicyDetailsPreApproval.jsp", 1724146825319L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block21 =">Episode</option>\n\t\t\t\t\t\t<option value=\'N\' ";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 =">Encounter</option>\n\t\t\t\t\t\t<option value=\'A\' ";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 =">All</option>\t\t\t\t\t</select>\n\t\t\t\t</td>\n\t\t\t\t<td nowrap>\n\t\t\t\t\t<select id=\'ptClassFilter\' name=\'ptClassFilter\' id=\'ptClassFilter\'>\n\t\t\t\t\t\t<option value=\'\'>";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="</option>\n\t\t\t\t\t\t<option value=\'OP\' ";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 =">OP</option>\n\t\t\t\t\t\t<option value=\'IP\' ";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 =">IP</option>\n\t\t\t\t\t\t<option value=\'DC\' ";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 =">DC</option>\n\t\t\t\t\t\t<option value=\'XT\' ";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 =">EX</option>\n\t\t\t\t\t\t<option value=\'EM\' ";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 =">EM</option>\n\t\t\t\t\t\t<option value=\'**\' ";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 =">All</option>\n\t\t\t\t\t</select>\n\t\t\t\t</td>\n\t\t\t\t<td nowrap>\n\t\t\t\t\t<input type=\'text\' name=\'age_groupFilter\' id=\'age_groupFilter\' id=\'age_groupFilter\' value=\'";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 ="\' length=\'15\' onblur=\'if(this.value.length>0){ callCommonValidation(5,this,hdn_age_groupFilter); } else{ fnClearCode(hdn_age_groupFilter); }\'>\n\t\t\t\t\t<input type=\'hidden\' name=\'hdn_age_groupFilter\' id=\'hdn_age_groupFilter\' id=\'hdn_age_groupFilter\' value=\'";
    ...
    private final static java.lang.String  _wl_block34 =">Male</option>\n\t\t\t\t\t\t<option value=\'F\' ";
    private final static byte[]  _wl_block34Bytes = _getBytes( _wl_block34 );

    private final static java.lang.String  _wl_block35 =">Female</option>\n\t\t\t\t\t\t<option value=\'A\' ";
    private final static byte[]  _wl_block35Bytes = _getBytes( _wl_block35 );

    private final static java.lang.String  _wl_block36 =">Both</option>\t\t\t\t</td>\n\t\t\t\t<td nowrap>\n\t\t\t\t\t<select id=\'clinicFilter\' name=\'clinicFilter\' id=\'clinicFilter\' >\n\t\t\t\t\t<option value=\'\'>";
    private final static byte[]  _wl_block36Bytes = _getBytes( _wl_block36 );

    private final static java.lang.String  _wl_block37 ="</option>\n\t\t\t\t\t\t<option value=\'C\' ";
    private final static byte[]  _wl_block37Bytes = _getBytes( _wl_block37 );

    private final static java.lang.String  _wl_block38 =">Clinic</option>\n\t\t\t\t\t\t<option value=\'N\' ";
    private final static byte[]  _wl_block38Bytes = _getBytes( _wl_block38 );

    private final static java.lang.String  _wl_block39 =">Nursing Unit</option>\n\t\t\t\t\t\t<option value=\'A\' ";
    private final static byte[]  _wl_block39Bytes = _getBytes( _wl_block39 );

    private final static java.lang.String  _wl_block40 =">All</option>\t\t\t\t\t</select>\n\t\t\t\t</td>\n\t\t\t\t<td nowrap>\n\t\t\t\t\t<input type=\'text\' id=\'clinic_codeFilter\' name=\'clinic_codeFilter\' id=\'clinic_codeFilter\' value=\'";
    private final static byte[]  _wl_block40Bytes = _getBytes( _wl_block40 );

    private final static java.lang.String  _wl_block41 ="\' size=\'4\' onblur=\'if(this.value.length>0){ callBGDescCode(1,clinicFilter,clinic_descFilter,clinic_codeFilter); } else{ fnClearCode(clinic_descFilter); }\'> \n\t\t\t\t\t<input type=\'text\' id=\'clinic_descFilter\' name=\'clinic_descFilter\' id=\'clinic_descFilter\' value=\'";
    private final static byte[]  _wl_block41Bytes = _getBytes( _wl_block41 );

    private final static java.lang.String  _wl_block42 ="\' size=\'20\' onblur=\'if(this.value.length>0){ callBGDesc(1,clinicFilter,clinic_descFilter,clinic_codeFilter); } else{ fnClearCode(clinic_codeFilter); }\'>\n\t\t\t\t\t<input type=\'button\' id=\'clinic_butFilter\' value=\'?\' onclick=\'callBGDesc(1,clinicFilter,clinic_descFilter,clinic_codeFilter)\'>\n\t\t\t\t</td> \n\t\t\t\t<td nowrap>\n\t\t\t\t\t<input type=\'text\' id=\'spec_codeFilter\' name=\'spec_codeFilter\' id=\'spec_codeFilter\' size=\'5\' value=\'";
    private final static byte[]  _wl_block42Bytes = _getBytes( _wl_block42 );

    private final static java.lang.String  _wl_block43 ="\' onblur=\'if(this.value.length>0){ callCommonValidationSpecCode(spec_descFilter,spec_codeFilter,clinicFilter,clinic_codeFilter); } else{ fnClearCode(spec_descFilter); }\'>\n\t\t\t\t\t<input type=\'text\' id=\'spec_descFilter\' name=\'spec_descFilter\' id=\'spec_descFilter\' size=\'20\' value=\'";
    private final static byte[]  _wl_block43Bytes = _getBytes( _wl_block43 );

    private final static java.lang.String  _wl_block44 ="\' onblur=\'if(this.value.length>0){ callCommonValidationSpec(spec_descFilter,spec_codeFilter,clinicFilter,clinic_codeFilter); } else{ fnClearCode(spec_codeFilter); }\'>\n\t\t\t\t\t<input type=\'button\' id=\'spec_butFilter\' value=\'?\' onclick=\'callCommonValidationSpec(spec_descFilter,spec_codeFilter,clinicFilter,clinic_codeFilter)\'>\t\t\t\t\t\n\t\t\t\t</td>\n\t\t\t\t<td nowrap>\n\t\t\t\t\t<select name=\'criteriaFilter\' id=\'criteriaFilter\'>\t\t\n\t\t\t\t\t<option value=\'\'>";
    ...
    private final static java.lang.String  _wl_block47 ="\' selected=\"selected\">";
    ...
    private final static java.lang.String  _wl_block53 ="\' onblur=\"if(this.value!=\'\'){ if(criteriaFilter.value!=\'\'){ callBGDescCode(2,criteriaFilter,bg_desc_filter,bg_code_filter); } else{ alert(\'Please select Type\'); } } else{ fnClearCode(bg_desc_filter); } \" >\n\t\t\t\t\t<input type=\'text\' id=\'bg_desc_filter\' name=\'bg_desc_filter\' id=\'bg_desc_filter\'  size=\'20\'  value=\'";
    private final static byte[]  _wl_block53Bytes = _getBytes( _wl_block53 );

    private final static java.lang.String  _wl_block54 ="\' onblur=\"if(this.value!=\'\'){ if(criteriaFilter.value!=\'\'){ callBGDesc(2,criteriaFilter,bg_desc_filter,bg_code_filter); } else{ alert(\'Please select Type\'); } } else{ fnClearCode(bg_code_filter); }\">\n\t\t\t\t\t<input type=\'button\' id=\'bg_but_filter\' value=\'?\'  onclick=\"if(criteriaFilter.value!=\'\'){ callBGDesc(2,criteriaFilter,bg_desc_filter,bg_code_filter); } else{ alert(\'Please select Type\'); }\" >\t\t\t\t\t\n\t\t\t\t</td>\n\t\t\t\t<td  nowrap colspan=\'4\'>&nbsp;</td>\n\t\t\t\t";
	...
	con = ConnectionManager.getConnection(request);
		...
		if(policyList == null || policyList.isEmpty())
		{
			if(patientId == null || "".equals(patientId)){
				//String sqlCoverage = BlRepository.getBlKeyValue("POLICY_DEF_PREAPPROVAL_DTL");//V211026
				String sqlCoverage = BlRepository.getBlKeyValue("POLICY_DEFN_PREAPPROVAL_DTL");//V211026
				...
				if(rst!=null){
					...
					while (rst.next()) {
						...
						fmtDtlsBean.setPreacrossenc(rst.getString("ACROSS_ENC_PREAPP_YN")); //Added V190225 - dhananjay
...
if("Y".equals(policyBean1.getDelFlag())){ 
    ...
    private boolean _jsp__tag13(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag13.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eBL.Preacrossenc.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag14(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag14.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eBL.EffFromDate.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag15(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag15.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eBL.EffToDate.label", java.lang.String .class,"key"));
