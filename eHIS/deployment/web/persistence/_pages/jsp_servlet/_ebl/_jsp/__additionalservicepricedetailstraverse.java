...
public final class __additionalservicepricedetailstraverse extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/AdditionalServicePriceDetailsTraverse.jsp", 1725343951562L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\")\'>Previous</a>\n\t\t\t\t";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\n\t\t\t</td>\n\t\t\t<td  width=\'7%\' align=\"right\">\n\t\t\t\t";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\")\'>Next</a>\n\t\t\t\t";
...
private String decodeParam(String input){
 ...
 if("Y".equals(previous)){
            ...
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(service_description ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(price_ind ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(price_code ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(price_description ));
            ...
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(charge_type ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(disc_applicability ));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(Desc ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf((fromRcrd-constcnt) ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf((toRcrd-constcnt) ));
