...
public final class __pkgdefservice extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/PkgDefService.jsp", 1709114727413L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	//	String bean_name	= "eBL.PkgDefBean";
		...
		if(mode == "modify")
		{
            ...
            out.print( String.valueOf(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Add/New.label","common_labels")));
