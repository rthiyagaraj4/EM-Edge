...
public final class __blbillinggrpdet extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLBillingGrpDet.jsp", 1742746698880L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block6 ="\n\n<html>\n\t<head>\n\t<script>\t\n\t\t function showblnggrpdesc()\n\t\t\t\t{\n\t\t\t\tdocument.getElementById(\'blnggrpdesc\').innerText = \'";
...
//Added by Manivel Natarajan on 10/Aug/2006
	...
	if (nd_detail_desc == null) nd_detail_desc = "";
            ...
            out.print( String.valueOf(encode(nd_detail_desc)));
		...
		String sStyle =		(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
            ...
            out.print( String.valueOf(nd_detail_desc));
