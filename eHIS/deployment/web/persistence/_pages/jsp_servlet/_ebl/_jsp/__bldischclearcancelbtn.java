...
public final class __bldischclearcancelbtn extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLDischClearCancelBtn.jsp", 1709114482446L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block5 ="\" class=\'button\' onclick=\'cancel_disch_clearance()\' >\n\t</td>\n\t\n</tr>\n</table>\n\t\t<input type=\"hidden\" name=\"episodeType\" id=\"episodeType\" id=\"episodeType\" value=\"";
    ...
    throws javax.servlet.ServletException, java.io.IOException {
		...
		String sStyle =		(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
            ...
            out.print( String.valueOf(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eBL.CAN_DISC_CLEARANCE.label","bl_labels")));
