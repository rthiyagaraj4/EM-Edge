...
public final class __fmdocumenttypeinfolder extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/FMDocumentTypeInFolder.jsp", 1709116837731L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	try
	{
		...
		if(maintain_doc_or_file.equals("D"))
		{
			...
			sqlBuffer.append("' And fs_locn_code = '*ALL' AND appl_user_id = '");
			sqlBuffer.append(user_id);
			sqlBuffer.append("' UNION SELECT 1 FROM fm_user_access_rights WHERE appl_user_id = '");
			sqlBuffer.append(user_id);
			sqlBuffer.append("' AND facility_id = '");
			sqlBuffer.append(facility_id);
			sqlBuffer.append("' ");
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eFM.DocumentTypeinFolder.label", java.lang.String .class,"key"));
