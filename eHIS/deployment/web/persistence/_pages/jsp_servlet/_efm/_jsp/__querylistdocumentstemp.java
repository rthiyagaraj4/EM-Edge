...
public final class __querylistdocumentstemp extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/QueryListDocumentsTemp.jsp", 1709116888328L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block5 ="\n\t<script>\n\t\t\tparent.frames[1].document.forms[0].doc_folder_id.value=\'";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="\';\n\t\t\tparent.frames[1].document.forms[0].doc_folder_name.value=\'";
