...
public final class __fmchangefilestoragelocation extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/FMChangeFileStorageLocation.jsp", 1726736198726L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\' frameborder=\'0\' scrolling=no noresize style=\'height:8vh;width:100vw\'></iframe>\n\t\t<iframe name=\'f_query_add_mod\' id=\'f_query_add_m</iframe>od\' src=\'../../eFM/jsp/FMChangeStorageLocnMain.jsp?user_security_yn=";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="&p_access_all=";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' frameborder=\'0\' scrolling=\'no\' style=\'width:100%;height:86vh\'></iframe>\n\t\t<iframe name=\'messageFrame\' id=\'messageFrame\' src=\'../../eCommon/jsp/error.jsp\' scrolling=\'no\' frameborder=\'0\' noresize style=\'height:8vh;width:100vw\'></iframe>\n\t\n</html>\n\n";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		try
		{
			...
			{
				sql1 = "select 1 accessAll from fm_user_access_rights where facility_id = ? and appl_user_id = ? and change_fs_locn_yn = 'Y' ";
				...
				if(rs != null && rs.next())
				{
					p_access_all = rs.getString("accessAll");
				}
				else
				{
