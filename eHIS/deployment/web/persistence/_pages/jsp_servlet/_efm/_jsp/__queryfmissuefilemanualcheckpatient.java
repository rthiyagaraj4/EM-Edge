...
public final class __queryfmissuefilemanualcheckpatient extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/QueryFMIssueFileManualCheckPatient.jsp", 1709116886468L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\n\t\t\t\t<script>\t\t\t\t\n\t\t\t\tparent.frames[1].currFileStatus1[";
    ...
    private final static java.lang.String  _wl_block12 ="\t\t\t<script>\n\n\t\t\t\tparent.frames[1].document.getElementById(\"fileid\").innerHTML=\"<select name=fileno tabIndex=\'2\'>";
    ...
    private final static java.lang.String  _wl_block20 ="\';\t\n\t\t\t\tparent.frames[1].document.forms[0].CURR_FACILITY_NAME.value = \'";
...
currStatDesc = (rs.getString("FILE_STATUS_DESC")==null)?"":rs.getString("FILE_STATUS_DESC"); 
		...
		else
		{
            ...
            out.print( String.valueOf(java.net.URLEncoder.encode(CURR_FACILITY_NAME)));
