...
public final class __fmfiledeficiencyspeciality extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/FMFileDeficiencySpeciality.jsp", 1709116842466L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\");\'><input type=\"image\" src=\'../../eCommon/images/CommonCalendar.gif\' onClick=\"return showCalendar(\'date_from\');\">\n\t\t\t\t\t\t<td class=\'label\'>&nbsp;</td>\n\t\t\t\t\t\t<td class=\'fields\'><input type=\'text\' id=\"date_to\" \n\t\t\t\t\t\tname=\'p_to_date\' id=\'p_to_date\' value=\'\'  size=\"10\"\tmaxlength=\"10\" onBlur=\'validDateObj(this,\"DMY\",\"";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\");\'><input type=\"image\" src=\'../../eCommon/images/CommonCalendar.gif\' onClick=\"return showCalendar(\'date_to\');\"></td>\n\t\t\t</tr>\t\t\t\n\t\t\t\n\t\t\t<tr><td class=\'label\' width=\'20%\' >";
