...
public final class __fmlostfoundcheckpatientexists extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/FMLostFoundCheckPatientExists.jsp", 1709116863672L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	try
	{
		...
		if(p_count > 0)
		{
            ...
            out.print( String.valueOf(p_curr_file_status));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(p_new_string));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(p_first_file_no));
