...
public final class __placemealorderemmain extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/PlaceMealOrderEMMain.jsp", 1745232116836L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block0 ="<!DOCTYPE html>\n<!--\nFile Name\t\t: PlaceMealOrderEMMain.jsp\nFile Description:  Result Frame : This file is for Placing EM Meal Order.\nCRF#\t\t\t: Bru-HIMS-CRF-230\nAuthor\t\t\t: Abirami\nDate\t\t\t: Aug-2013\n-->\n";
    ...
    private final static java.lang.String  _wl_block34 ="\t\t\t\t\t\t\n\t\t\t\t\t   for (var j=0; j < mealTypeList.length;j++) {\n\t\t\t\t\t\tvar newCellDesc2 = newRow3.insertCell(newRow3.cells.length);\n\t\t\t\t\t\tnewCellDesc2.align = \"center\";\t\t\t\t\t\t\n\t\t\t\t\t\tvar tmpMealtype = mealTypeList[j].mealType;\t\t\t\t\t\t\n\t\t\t\t\t\tvar varMealName = mealTypeList[j].mealType + \"\" + row_ind1;\n\t\t\t\t\t\t//Added Against ML-MMOH-CRF-0825 Starts Here\t\t\t\t\t\t\n\t\t\t\t\t\tvar ServingStartTimeEM = mealTypeList[j].ServingStartTimeEM;\n\t\t\t\t\t\tif (ServingStartTimeEM == \"undefined\" || ServingStartTimeEM== null){\n\t\t\t\t\t\t\tServingStartTimeEM = \"\";\n\t\t\t\t\t\t}\n\t\t\t\t\t\tvar ServingEndTimeEM = mealTypeList[j].ServingEndTimeEM;\n\t\t\t\t\t\tif (ServingEndTimeEM == \"undefined\" || ServingEndTimeEM== null){\n\t\t\t\t\t\t\tServingEndTimeEM = \"\";\n\t\t\t\t\t\t}\n\t\t\t\t\t\tvar IrregularStartTimeEM = mealTypeList[j].IrregularStartTimeEM;\n\t\t\t\t\t\tif (IrregularStartTimeEM == \"undefined\" || IrregularStartTimeEM== null){\n\t\t\t\t\t\t\tIrregularStartTimeEM = \"\";\n\t\t\t\t\t\t}\n\t\t\t\t\t\tvar IrregularEndTimeEM = mealTypeList[j].IrregularEndTimeEM;\n\t\t\t\t\t\tif (IrregularEndTimeEM == \"undefined\" || IrregularEndTimeEM== null){\n\t\t\t\t\t\t\tIrregularEndTimeEM = \"\";\n\t\t\t\t\t\t}\t\t\t\t\t\t\n\t\t\t\t\t\tvar nextServingStartTimeEM = mealTypeList[j].nextServingStartTimeEM;\n\t\t\t\t\t\tif(ServingStartTimeEM==\"\" && ServingEndTimeEM==\"\" && IrregularStartTimeEM==\"\" && IrregularEndTimeEM==\"\" ){\n\t\t\t\t\t\t\tIrregularEndTimeEM = nextServingStartTimeEM;\n\t\t\t\t\t\t}\n\t\t\t\t\t\tvar today = new Date();\n\t\t\t\t\t\tvar hour=today.getHours();\n\t\t\t\t\t\tif(hour<=9){\n\t\t\t\t\t\t\thour=\"0\"+\"\"+hour;\n\t\t\t\t\t\t}\n\t\t\t\t\t\tvar minute=today.getMinutes();\n\t\t\t\t\t\tif(minute<=9){\n\t\t\t\t\t\t\tminute=\"0\"+\"\"+minute;\n\t\t\t\t\t\t}\n\t\t\t\t\t\tvar Sys_time = hour+\":\"+minute;\n\t\t\t\t\t\tvar lateIrregularDietOrderEM = document.getElementById(\"LATE_IRREGULAR_DIET_ORD_FOR_EM\").value;\n\t\t\t\t\t\t//Added Against ML-MMOH-CRF-0825 Ends Here \n\t\t\t\t\t\tif(objMealTypes != \"undefined\" && objMealTypes.contains(tmpMealtype))\n\t\t\t\t\t\t{\t\n\t\t\t\t\t\t//Modified Against ML-MMOH-CRF-0825 Starts Here\n\t\t\t\t\t\t\tif(lateIrregularDietOrderEM == \"Y\" && IrregularEndTimeEM == \"\" && ServingEndTimeEM != \"\" && ServingEndTimeEM < Sys_time ){\n\t\t\t\t\t\t\t\tsel = \"<input type=\'checkbox\' class=\'mealTypes\'  align = \'center\' disabled onchange=\\\"setFlag(\'\"+row_ind1+\"\');\\\"  name=\'\"+ varMealName +\"\' id=\'\"+ varMealName +\"\' checked value=\'N\'>\";\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\telse if(lateIrregularDietOrderEM == \"Y\" && IrregularEndTimeEM != \"\" && IrregularEndTimeEM < Sys_time){\n\t\t\t\t\t\t\t\tsel = \"<input type=\'checkbox\' class=\'mealTypes\' align = \'center\' disabled onchange=\\\"setFlag(\'\"+row_ind1+\"\');\\\" name=\'\"+ varMealName +\"\' id=\'\"+ varMealName +\"\' checked value=\'N\'  >\"; \n\t\t\t\t\t\t\t}else{\n\t\t\t\t\t\t\t\tsel = \"<input type=\'checkbox\' class=\'mealTypes\'  align = \'center\' onchange=\\\"setFlag(\'\"+row_ind1+\"\');\\\" onclick =\\\"checkTheBox1(this.ClassName,\'\"+checkBoxCount+\"\',\'\"+encounterCount+\"\',\'\"+row_ind1+\"\',\'\"+secondCount+\"\',this);\\\" name=\'\"+ varMealName +\"\' id=\'\"+ varMealName +\"\' checked value=\'\"+ varMealName +\"\'>\"; \n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t\telse\n\t\t\t\t\t\t{\n\t\t\t\t\t\t\tif(lateIrregularDietOrderEM == \"Y\" && IrregularEndTimeEM == \"\" && ServingEndTimeEM != \"\" && ServingEndTimeEM < Sys_time){\n\t\t\t\t\t\t\t\tsel = \"<input type=\'checkbox\' class=\'mealTypes\'  align = \'center\' disabled onchange=\\\"setFlag(\'\"+row_ind1+\"\');\\\" name=\'\"+ varMealName +\"\' id=\'\"+ varMealName +\"\' value=\'N\'>\"; \n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\telse if(lateIrregularDietOrderEM == \"Y\" && IrregularEndTimeEM != \"\" && IrregularEndTimeEM < Sys_time){\n\t\t\t\t\t\t\t\tsel = \"<input type=\'checkbox\' class=\'mealTypes\' align = \'center\' disabled onchange=\\\"setFlag(\'\"+row_ind1+\"\');\\\" name=\'\"+ varMealName +\"\' id=\'\"+ varMealName +\"\' value=\'N\'>\"; \n\t\t\t\t\t\t\t}else{\n\t\t\t\t\t\t\t\tsel = \"<input type=\'checkbox\' class=\'mealTypes\'  align = \'center\' onchange=\\\"setFlag(\'\"+row_ind1+\"\');\\\" onclick =\\\"checkTheBox1(this.ClassName,\'\"+checkBoxCount+\"\',\'\"+encounterCount+\"\',\'\"+row_ind1+\"\',\'\"+secondCount+\"\',this);\\\" name=\'\"+ varMealName +\"\' id=\'\"+ varMealName +\"\' value=\'\"+ varMealName +\"\'>\"; \n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t}\n\t\t\t\t\t\t\n\t\t\t\t\t\t//Modified Against ML-MMOH-CRF-0825 Ends Here\n\t\t\t\t\t\tnewCellDesc2.innerHTML = sel;\n\t\t\t\t\t    }\n\t\t\t\t\t   ";
...
public HashMap CToHashMap( Hashtable table ) {
 ...
 request.setCharacterEncoding("UTF-8");
	...
	System.err.println("92 SystemDate_display===>"+SystemDate_display);
	 ...
	 ResultSet rs=null;	
	  String LATE_IRREGULAR_DIET_ORD_FOR_EM = "";
	  //Added Against ML-MMOH-CRF-0825 Ends Here  
	...
	//Added Against ML-MMOH-CRF-0825 Starts Here
	String Late_Irr_EM_Query = "select LATE_IRREGULAR_DIET_ORD_FOR_EM from DS_PARAM_FOR_FACILITY where OPERATING_FACILITY_ID = ? "; 
	pstmt = conn.prepareStatement(Late_Irr_EM_Query);	
	pstmt.setString(1,facility_Id);	
	rs	= pstmt.executeQuery();
	if(rs != null && rs.next()){
		LATE_IRREGULAR_DIET_ORD_FOR_EM=rs.getString("LATE_IRREGULAR_DIET_ORD_FOR_EM");
	}
	 //Added Against ML-MMOH-CRF-0825 Ends Here	
...
if(isMenuType){
    ...
    private boolean _jsp__tag9(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag9.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.ApptDate/Time.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag10(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag10.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eDS.VisitDateTime.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag11(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag11.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.apptno.label", java.lang.String .class,"key"));
