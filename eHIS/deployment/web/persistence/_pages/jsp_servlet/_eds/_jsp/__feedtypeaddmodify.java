...
public final class __feedtypeaddmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/FeedTypeAddModify.jsp", 1709116728000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t\t<form name=\"mealClass_form\" id=\"mealClass_form\"  onload=\'FocusFirstElement()\'  action=\"../../servlet/eDS.FeedTypeServlet\" method=\"post\" target=\"messageFrame\">\n\t\t\t<table border=\'0\' cellpadding=\'2\' cellspacing=\'0\' width=\'75%\' align=\'center\'>\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\'label\' align=\"right\">\n\t\t\t\t\t\t";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\n\t\t\t\t\t</td>\n\t\t\t\t\t<td>\n\t\t\t\t\t\t<input type=\"text\" name=\"feed_Type\" id=\"feed_Type\" value=\"";
    ...
    private final static java.lang.String  _wl_block23 ="\'>\n\t\t\t<input type=\'hidden\' name=\'updFeedType\' id=\'updFeedType\' value=\'";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
 ...
 String feedType = "";
   ...
   String feedTypeCode = request.getParameter("feedType");
   ...
   if("modify".equals(mode)){
   		try{
	   		...
	   		pstmt = con.prepareStatement(DlQuery.DL_GET_FEED_TYPE);
	   		pstmt.setString(1,feedTypeCode);
	   		rst = pstmt.executeQuery();
	   		while(rst.next()){
	   			feedType = rst.getString("feed_type");
	   		...
	   		System.err.println("Error in Feed Type->"+e);
   		}
   		finally{
   			try{
