...
public final class __feedtypequerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/FeedTypeQueryCriteria.jsp", 1709116728000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String feedType =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOT.FeedType.Label","ot_labels") ;
...
try {
   ...
   con  =  ConnectionManager.getConnection(request);
	...
	firstItem.add("Text");
	firstItem.add(feedType);
	firstItem.add("feed_Type");
	firstItem.add("4");
	firstItem.add("4");
	finAr.add(firstItem);
	...
	orderByCols[0] = feedType;
	orderByCols[1] = longDesc;
	orderByCols[2] = shortDesc;
    orderByCols[3] = nature;

	orderByColVals[0] = "feed_type";
	orderByColVals[1] = "long_desc";
	orderByColVals[2] = "short_desc";
	orderByColVals[3] = "eff_status";

	strbuff = qrypg.getQueryPage( con,finAr,"Instruments ","../../eDS/jsp/FeedTypeQueryResult.jsp?ph_module_yn="+ph_module_yn,sortorder,queryCriteria,comSelect ,orderby,orderByCols, orderByColVals,"Execute Query");
