...
public final class __deliveryinstructionsqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/DeliveryInstructionsQueryResult.jsp", 1724667104000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
try{
    ...
    String sql = " ";
    String delInstr = request.getParameter("del_Instr")==null?"":request.getParameter( "del_Instr" ).trim().toUpperCase();
	...
	int cnt=0;
		...
		if ( !(delInstr == null || delInstr.equals("")) ){
	        sql = sql + " where upper(instr_code) like upper('"+delInstr +"%')";
			cnt++;
        }
...
ResultSet rs = null;
	...
	try{
		...
		String strsql="select count(*) as total from ds_delivery_instr "+sql;
		String strsql1="select instr_code,long_desc,eff_status from ds_delivery_instr "+sql;
...
if ( !(start <= 1) )
    out.println("<A HREF='../../eDS/jsp/DeliveryInstructionsQueryResult.jsp?from="+(start-14)+"&ph_module_yn="+ph_module_yn+"&to="+(end-14)+"&whereclause=" + URLEncoder.encode(sql) + "'" + " text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.previous.label","common_labels")+"</A>");

if ( !( (start+14) > maxRecord ) )
    out.println("<A HREF='../../eDS/jsp/DeliveryInstructionsQueryResult.jsp?from="+(start+14)+"&ph_module_yn="+ph_module_yn+"&to="+(end+14)+"&whereclause="+URLEncoder.encode(sql)+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.next.label","common_labels")+"</A>");
      ...
      while ( rset.next() && i<=end  )
{
    ...
    delInstr = rset.getString(1);
    longDesc=rset.getString(2);
    enabledYn = rset.getString(3);


	String mode="modify";
	out.println("<a href='../../eDS/jsp/DeliveryInstructionsAddModify.jsp?mode="+mode+"&delInstr="+ delInstr+"' target='f_query_add_mod' >");
    out.println(delInstr+"</a></td>");
...
catch(Exception e)
{
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOT.InstructionCode.Label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOT.Description.Label", java.lang.String .class,"key"));
