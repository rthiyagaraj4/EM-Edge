...
public final class __spfooditemsforbulkorder extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/SpFoodItemsForBulkOrder.jsp", 1738425546000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="\');\" align=\"left\" class=\"label\" colspan=\"2\">\n\t\t\t\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block33 ="\" onClick=\"top.close();\" class=\"Button\">\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t</TABLE>\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t</TABLE>\n\n\t\t<input type=\"hidden\" name=\"patientId\" id=\"patientId\" />\n\t\t<input type=\"hidden\" name=\"encounterId\" id=\"encounterId\" value=\"";
