...
public final class __kitchenqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/KitchenQueryResult.jsp", 1729743096000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\n<table  width=\"98%\" cellspacing=\'0\' cellpadding=\'0\' align=\'center\' style=\"border: 1px solid black; border-collapse: collapse;\">\n<td class=\"COLUMNHEADERCENTER\" nowrap>\n\t";
...
try{
    ...
    String sql = " ";
    String kitchen = request.getParameter("kitchen_Code")==null?"":request.getParameter( "kitchen_Code" ).trim().toUpperCase();
	...
	int cnt=0;
		...
		if ( !(kitchen == null || kitchen.equals("")) ){
	        sql = sql + " where upper(kitchen_code) like upper('"+kitchen +"%')";
			cnt++;
        }
...
ResultSet rs = null;
	...
	try{
		...
		String strsql="select count(*) as total from ds_kitchens "+sql;
		String strsql1="select kitchen_code,long_desc,short_desc,eff_status from ds_kitchens "+sql;
...
if ( !(start <= 1) )
    out.println("<A HREF='../../eDS/jsp/KitchenQueryResult.jsp?from="+(start-14)+"&ph_module_yn="+ph_module_yn+"&to="+(end-14)+"&whereclause=" + URLEncoder.encode(sql) + "'" + " text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.previous.label","common_labels")+"</A>");

if ( !( (start+14) > maxRecord ) )
    out.println("<A HREF='../../eDS/jsp/KitchenQueryResult.jsp?from="+(start+14)+"&ph_module_yn="+ph_module_yn+"&to="+(end+14)+"&whereclause="+URLEncoder.encode(sql)+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.next.label","common_labels")+"</A>");
      ...
      while ( rset.next() && i<=end  )
{
    if ( i % 2 == 0 )
            ...
            classValue = "gridData" ;  // changed by yadav
    out.println("<tr><td align=='left' class='" + classValue + "' nowrap style='border-bottom: 1px solid #e0e0e0;'>");

    kitchen = rset.getString(1);
	...
	String mode="modify";
	out.println("<a href='../../eDS/jsp/KitchenAddModify.jsp?mode="+mode+"&kitchen="+ kitchen+"' target='f_query_add_mod' >");
    out.println(kitchen+"</a></td>");
    out.println("<td class='" + classValue+"' nowrap style='border-bottom: 1px solid #e0e0e0;'>"+longDesc+"</td>");
    out.println("<td class='" + classValue+"' nowrap style='border-bottom: 1px solid #e0e0e0;'>"+shortDesc+"</td>");

    out.println("<td class='" + classValue + "' align='center' style='border-bottom: 1px solid #e0e0e0;'>");
...
catch(Exception e)
{
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOT.KitchenCode.Label", java.lang.String .class,"key"));
