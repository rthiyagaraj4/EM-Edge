...
public final class __kitchenquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/KitchenQueryCriteria.jsp", 1709116734000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String kitchen =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOT.KitchenCode.Label","ot_labels") ;
...
try {
   ...
   con  =  ConnectionManager.getConnection(request);
	...
	strbuff = qrypg.getQueryPage( con,finAr,"Instruments ","../../eDS/jsp/KitchenQueryResult.jsp?ph_module_yn="+ph_module_yn,sortorder,queryCriteria,comSelect ,orderby,orderByCols, orderByColVals,"Execute Query");
