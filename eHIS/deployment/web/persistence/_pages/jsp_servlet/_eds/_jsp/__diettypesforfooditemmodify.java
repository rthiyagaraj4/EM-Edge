...
public final class __diettypesforfooditemmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/DietTypesForFoodItemModify.jsp", 1724247136000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\n\t\t\t\t\t\t<span class=\"label\">Select All</span>\n\t\t\t\t\t\t<input type=\"checkbox\" onclick=\"getdietTypeSelectAll(this,";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 =")\" name=\"dietTypeSelectAll\" id=\"dietTypeSelectAll\" ></input>\n\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block12 ="\" onClick=\"getDietTypesFoodItems()\" class=\"Button\">\n\t\t\t\t\t";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\n\t\t\t\t</td>\n\t\t\t</tr>\n\t</table>\n\t\t\n\t\t<input type=\"hidden\" name=\"fetchedDietTypes\" id=\"fetchedDietTypes\" value=\"";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\" />\n\t\t<input type=\"hidden\" name=\"diettype\" id=\"diettype\" value=\"";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\" />\n\t\t<input type=\"hidden\" name=\"Existingcode\" id=\"Existingcode\" value=\"";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\" />\n\t\t<input type=\"hidden\" name=\"dietmaxRecord\" id=\"dietmaxRecord\" value=\"";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\" /><!--ICN-064175-->\n\t\t\n\t\n\t";
...
public HashMap CToHashMap( Hashtable table ) {
 ...
 if(diettype.equals("")){
            ...
            out.print( String.valueOf(fetchedDietTypes.toString()));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(diettype));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(Existingcode));
