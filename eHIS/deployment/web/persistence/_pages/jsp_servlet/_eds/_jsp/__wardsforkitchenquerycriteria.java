...
public final class __wardsforkitchenquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/WardsForKitchenQueryCriteria.jsp", 1709116764000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String wardCode =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOT.Ward.Label","ot_labels") ;
...
try {
   ...
   con  =  ConnectionManager.getConnection(request);
	...
	secondItem.add("List");
	secondItem.add(wardCode);
	secondItem.add("ward_Code");
	...
	strBuff.append(","+" "+","+select);
	while(rst.next()){
		strBuff.append(","+rst.getString("nursing_unit_code")+","+rst.getString("short_desc"));
	}
    if(rst !=null) rst.close();
    if(pstmt !=null) pstmt.close();
	String str3 = "";
	...
	orderByCols[1] = wardCode;


	orderByColVals[0] = "kitchen_code";
	orderByColVals[1] = "nursing_unit_code";


	strbuff = qrypg.getQueryPage( con,finAr,"Menu Time Table ","../../eDS/jsp/WardsForKitchenQueryResult.jsp?ph_module_yn="+ph_module_yn,sortorder,queryCriteria,comSelect ,orderby,orderByCols, orderByColVals,"Execute Query");
