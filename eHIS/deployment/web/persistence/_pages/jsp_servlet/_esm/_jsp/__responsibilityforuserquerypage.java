...
public final class __responsibilityforuserquerypage extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/esm/jsp/ResponsibilityforUserQueryPage.jsp", 1709117463650L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block3 ="\'></link></head><body onKeyDown = \'lockKey()\'></body></html>\n";
...
fourthItem.add(resp_name);	  // label
...
orderByCols[2] = resp_id;
orderByCols[3] = resp_name;

orderByColVals[0] = "C.appl_user_id";
orderByColVals[1] = "A.appl_user_name";
orderByColVals[2] = "C.resp_id";
orderByColVals[3] = "B.resp_name";


strbuff = qrypg.getQueryPage(con,finAr,"Find Responsibility For User","../jsp/ResponsibilityforUserQuery.jsp",com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.SortOrder.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.QueryCriteria.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.defaultSelect.label","common_labels") ,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.orderBy.label","common_labels"),orderByCols, orderByColVals,"Execute Query");

//strbuff = qrypg.getQueryPage(columnLabel,columnSize,columnLength,columnName,enabledListLabel,"Find Master Code","../eSM/jsp/queryMasterCode.jsp","Sort Order","Query Criteria","Select" ,"Order by",orderByCols, orderByColVals,"Execute Query");
