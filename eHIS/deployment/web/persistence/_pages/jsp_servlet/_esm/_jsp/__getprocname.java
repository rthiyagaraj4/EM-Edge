...
public final class __getprocname extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/esm/jsp/GetProcName.jsp", 1709121704057L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block6 ="\";\n\t\t\tparent.frames[1].frames[2].document.forms[0].proc_name.disabled=false;\n\t\t\tparent.frames[1].frames[2].document.forms[0].proc_name.value=\'";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="\';\n\t\t\tparent.frames[1].frames[2].document.forms[0].proc_srt_cmd.value=\'";
