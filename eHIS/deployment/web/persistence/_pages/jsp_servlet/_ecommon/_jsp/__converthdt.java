...
public final class __converthdt extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecommon/jsp/ConvertHDT.jsp", 1721870859919L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block2 =" \t\t\t\t\t\n\t\t\t\t\t\tif(document.getElementById(\"date_of_birth_hj\")!=null)document.getElementById(\"date_of_birth_hj\").value=\'";
