...
public final class __home extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecommon/jsp/home.jsp", 1709116506654L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
session.putValue("Login","N");
            ...
            out.print( String.valueOf(validLogin));
