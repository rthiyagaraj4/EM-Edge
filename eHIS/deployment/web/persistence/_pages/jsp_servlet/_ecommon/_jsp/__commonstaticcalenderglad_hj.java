...
public final class __commonstaticcalenderglad_hj extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecommon/jsp/CommonStaticCalenderGlad_hj.jsp", 1714133380270L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block5 ="\n        <Script src=\"../../eCommon/js/showModalDialog.js\" language=\"JavaScript\"></Script>\n\t\t<script type=\"text/javascript\" src=\"../../eCommon/js/calScript/";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="/calendar.js\"></script>\n\t\t<script type=\"text/javascript\" src=\"../../eCommon/js/common.js\"></script>\n\t\t<script>\n\t\tbasicTheme = \'";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="\';\n\t\tgenerateCalendar(\"\",\"\",\"\",\"\",\"isModal\",\"\",\"\",\"";
    ...
    throws javax.servlet.ServletException, java.io.IOException {
		...
		if (localeName.equals("th"))
            ...
            out.print( String.valueOf(time_format));
            _bw.write(_wl_block8Bytes, _wl_block8);
            out.print( String.valueOf(diff_Yr));
