...
public final class __mstcodetoolbar extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecommon/jsp/MstCodeToolbar.jsp", 1735800629047L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\' name=\'create\' id=\'create\' class=\'BUTTON\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block12 ="\' name=\'query\' id=\'query\' class=\'BUTTON\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block15 ="\' class=\'BUTTON\' id=\'Delete\' name=\'Delete\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block18 ="\' name=\'apply\' id=\'apply\' class=\'BUTTON\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block20 ="\' id=\'run\' name=\'run\'  class=\'BUTTON\'></input>\n\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\n\t\t\t\t\t\t\t\n\n\t\t\t\t\t\t\t\t<td class=\"COMMON_TOOLBAR\">\n\t\t\t\t\t\t\t\t\t<input type=\'button\' onclick=\"parent.reset();parent.messageFrame.location.href=\'MstCodeError.jsp\'\" value=\'";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\' id=\'reset\' name=\'reset\' class=\'BUTTON\'></input>\n\t\t\t\t\t\t\t\t</td>\n\n\t\t\t\t\t\t\t\t<td class=\"COMMON_TOOLBAR\">\n\t\t\t\t\t\t\t\t\t<td class=\"COMMON_TOOLBAR\">\n\t\t\t\t\t\t\t\t\t";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="\n\t\t\t\t\t\t\t\t\t<input type=\'button\' onClick=\'parent.parent.parent.frames[1].expand(this)\'\n\t\t\t\t\t\t\t\t\tvalue=\'";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\' id=\'home\' name=\'home\' class=\'BUTTON\'></input>\n\t\t\t\t\t\t\t\t\t";
