...
public final class __niphesapicallpage extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecommon/jsp/NiphesAPICallPage.jsp", 1742809658646L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block1 ="\n<body onload = \"parent.window.close();document.NphiesApi.submit();\">\n<form name=\'NphiesApi\' id=\'NphiesApi\' action=\"";
    private final static byte[]  _wl_block1Bytes = _getBytes( _wl_block1 );

    private final static java.lang.String  _wl_block2 ="\" method=\"post\" target=\"_blank\"\nenctype=\"application/x-www-form-urlencoded\" > \n<input type=\"hidden\" name=\"FacilityId\" id=\"FacilityId\" value=\"";
