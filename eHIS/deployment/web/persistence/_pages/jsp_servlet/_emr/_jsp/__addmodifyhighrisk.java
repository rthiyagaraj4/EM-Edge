...
public final class __addmodifyhighrisk extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/addModifyHighRisk.jsp", 1709118865641L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="</td>\n      \t\t    <td width=\'50%\' class=\'fields\'>\n      \t\t    <input type=\'text\' name=\'high_risk_code\' id=\'high_risk_code\' value=\"";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\" size=\'7\' maxlength=\'6\' onKeyPress=\"return CheckForSpecChars(event)\"  ";
	...
	//	   Connection conn = (Connection) session.getValue( "connection" );
     ...
     try{
		...
		eventFunctionForCase="";
            ...
            out.print( String.valueOf(High_Risk));
