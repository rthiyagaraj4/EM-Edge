...
public final class __termcodesearchscreen2 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/TermCodeSearchScreen2.jsp", 1709119108988L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block12 ="<a><br>\n\t\t\t\t\t</td>\n\t\t\t\t\t</tr>\n\t\t\t";
...
*/				
            ...
            out.print( String.valueOf(rs.getString("from_diag_code")));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(rs.getString("to_diag_code")));
