...
public final class __rep2movementhistory extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/Rep2MovementHistory.jsp", 1721287182938L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 =" &nbsp;</td>\n\t\t\t\t\t<td><input type=text  name=\'p_patient_id\' id=\'p_patient_id\' size=";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 =" maxlength=";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 =" onBlur=\"ChangeUpperCase(this);disbutt(this);PatientValidation();\" align=\"center\"><input type=\'button\' name=\'patient_id\' id=\'patient_id\' value=\'?\' class=\'button\' onclick=\'callSearchScreen()\'></td>\n\t\t\t\t\t<td align=\'right\' width=\'30%\' class=\"label\">";
