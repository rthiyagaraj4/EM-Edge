...
public final class __terminologysetforfacilitydetail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/TerminologySetForFacilityDetail.jsp", 1722864619559L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\'>\n\t<input type=hidden name=\'facility_desc_text\' id=\'facility_desc_text\' value=\'";
    ...
    private final static java.lang.String  _wl_block26 =" onClick=\'selectAll(this,";
    ...
    private final static java.lang.String  _wl_block37 ="\' value=\"\"><input type=\'hidden\' name=\'facilityCode";
    private final static byte[]  _wl_block37Bytes = _getBytes( _wl_block37 );

    private final static java.lang.String  _wl_block38 ="\' id=\'facilityCode";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
            ...
            _bw.write(_wl_block2Bytes, _wl_block2);
            webbeans.eCommon.RecordSet TerminologyForFacility= null;synchronized(session){
                TerminologyForFacility=(webbeans.eCommon.RecordSet)pageContext.getAttribute("TerminologyForFacility",javax.servlet.jsp.PageContext.SESSION_SCOPE);
                if(TerminologyForFacility==null){
                    TerminologyForFacility=new webbeans.eCommon.RecordSet();
                    pageContext.setAttribute("TerminologyForFacility",TerminologyForFacility,javax.servlet.jsp.PageContext.SESSION_SCOPE);
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	while( i<=end  && rs.next() )
		{
            ...
            out.print( String.valueOf(facility_desc_text));
    ...
    //}
            ...
            out.print( String.valueOf(selectChkecked));
