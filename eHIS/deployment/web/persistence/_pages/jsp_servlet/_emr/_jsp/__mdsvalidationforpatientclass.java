...
public final class __mdsvalidationforpatientclass extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/MDSValidationForPatientClass.jsp", 1709117055233L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
try {
	...
	if(rset.next())
		...
		mds_sql=mds_sql.replace("##@@##",locale);
            ...
            out.print( String.valueOf(mds_sql));
