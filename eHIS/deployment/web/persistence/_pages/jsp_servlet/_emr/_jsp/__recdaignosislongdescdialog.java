...
public final class __recdaignosislongdescdialog extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/RecDaignosisLongDescDialog.jsp", 1729067905257L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="</U></B><br><br>\n\t\t\t\t\t<textarea name=\"longDescription\" rows=14 cols=40 readonly>";
