...
public final class __mrupdateencounterdtlscriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/MRUpdateEncounterDtlsCriteria.jsp", 1709118982782L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\' onBlur=\"ChangeUpperCase(this);\" onkeypress=\"return CheckForSpecChars(event);\"><input type=\"button\" value=\"?\" class=\"button\" name=\'pat_search\' id=\'pat_search\' onClick=\"getPatID()\">\n\t\t\t\t\t</td>\t\n\t\t\t\t\t<td class=\'label\' >";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="</td>\n\t\t\t\t\t<td class=\'fields\'>\n\t\t\t\t\t<select name=\'patient_class\' id=\'patient_class\'><option>---";
    ...
    private final static java.lang.String  _wl_block20 ="\' onClick=\'SearchResult()\' class=\'button\'><input type=\"button\" name=\"Clear\" id=\"Clear\" value=\'";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\'  class=\'button\' onClick=\'ClearFrame()\'></td>\n\t\t\t\t</tr>\n\t\t\t<table>\n\t\t</form>\n\t</body>\n\t";
