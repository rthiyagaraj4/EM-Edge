...
public final class __mrsearchscreen3 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/MRSearchScreen3.jsp", 1722321763603L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\';\n\t\t\t\n\t\t\t\tif(defn_levels==oldstep)\n\t\t\t\t{\n\t\t\t\t}\n\t\t\t\telse\n\t\t\t\t{\n\t\t\t\t\tparent.frames[3].location.href=\'MRSearchScreen4.jsp?term_set_id=\'+term_set_id+\'&defn_levels=\'+defn_levels+\'&term_code=\'+code+\'&step=\'+step+\'&p_auth_yn=";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="&Sex=";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\';\n\t\t\t\t}\n\t\t\t\t\t\n\t\t\t\tif(select_yn==\'Y\')\n\t\t\t\t\tparent.parent.frames[1].document.forms[0].elements[1].disabled=false;\n\t\t\t\telse\n\t\t\t\t\tparent.parent.frames[1].document.forms[0].elements[1].disabled=true;\n\t\t\t}\n\n\t\t\tfunction loadOtherFramesICD10(scheme,code,desc,term_set_id)\n\t\t\t{\n\t\t\t\t//parent.parent.frames[1].document.forms[0].elements(1).disabled=true\n\t\t\t\tparent.parent.frames[1].document.forms[0].elements[1].disabled=false;\n\t\t\t\twhile(desc.indexOf(\";\")!=-1)\n\t\t\t\t\tdesc=desc.replace(\";\" ,\' \');\n\t\t\t\tparent.parent.frames[1].document.forms[0].elements[0].value=desc+\", \"+code;\n\t\t\t\tparent.parent.frames[1].document.forms[0].elements[2].value=code;\n\t\t\t\tparent.parent.frames[1].document.f.diag_scheme.value=scheme;\n\t\t\t\tparent.parent.frames[1].document.forms[0].term_set_id.value=term_set_id;\n\t\t\t\tparent.frames[3].location.href=\'MRSearchScreen4.jsp?term_set_id=";
