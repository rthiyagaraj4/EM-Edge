...
public final class __equivalenttermcodedynamicvalues extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/EquivalentTermCodeDynamicValues.jsp", 1709118918063L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block7 ="\n\t\t\t<script>\n\t\t\tparent.f_term_result_header.document.getElementById(\"dynlevel\").innerText=\"Classification Levels  \"+\"";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\";\n\t\t\tparent.f_term_result_header.document.term_code_result_header.class_lvl.value=\"";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\";\n\t\t\tparent.f_term_code_set.document.frm_terminology_code.dyanmic_level.value=\"";
