...
public final class __materialsgroupqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emm/jsp/MaterialsGroupQueryResult.jsp", 1709118374000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//		String primary_lang		= (String)session.getAttribute("PRIMARY_LANG");
	...
	String material_group_code	= request.getParameter( "material_group_code" ) ;
...
try{
	String classvalue			= "";
	material_group_code = CommonBean.checkForNull( material_group_code )+'%';
	...
	sqlMap.put( "sqlData", MmRepository.getMmKeyValue("SQL_MM_MATRIALS_GROUP_QUERYCRIT"));
	...
	displayFields.add( "material_group_code" );
	...
	chkFields.add( material_group_code);
	...
	out.println(CommonBean.setForm ( request ,"../../eMM/jsp/MaterialsGroupQueryResult.jsp", searched) );
} catch(Exception e) {
