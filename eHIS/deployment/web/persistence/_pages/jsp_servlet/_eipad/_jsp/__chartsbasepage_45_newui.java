...
public final class __chartsbasepage_45_newui extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/ChartsBasePage-newUI.jsp", 1738426010164L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block7 ="/eIPAD/jquery.mobile-1.0.1.min.js\"></script>\n<script src=\'../../eCommon/js/showModalDialog.js\' language=\'JavaScript\'></script>\n\n<link rel=\"stylesheet\" href=\"";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="/eIPAD/jquery.mobile-1.0.1.min.css\" /> \n\n\n<link rel=\"stylesheet\" href=\"";
    ...
    private final static java.lang.String  _wl_block38 ="</div><!-- TODO replace with message bundle text --> \n\t\t\t\t\t\t    \t\t\t<div class = \"PatientBannerTextCol PatientBannerTextColTheme\" data-role = \"none\">";
    ...
    private final static java.lang.String  _wl_block44 ="/eIPAD/images/VIP.png\"></div>\n\t\t\t\t\t\t    \t\t";
    private final static byte[]  _wl_block44Bytes = _getBytes( _wl_block44 );

    private final static java.lang.String  _wl_block45 ="\n\t\t\t\t\t\t    \t\t</div>\n\t\t\t\t\t\t    \t\t<div class = \"PatientBannerIconRow\" data-role = \"none\">\n\t\t\t\t\t\t    \t\t\t<div class = \"PatientBannerIcons\" data-role = \"none\"><img class=\"PatientBannerIconImg\" src=\"";
    private final static byte[]  _wl_block45Bytes = _getBytes( _wl_block45 );

    private final static java.lang.String  _wl_block46 ="/eIPAD/images/Down Arrow.png\" style=\"display:none\"></div>\n\t\t\t\t\t\t    \t\t</div>\n\t\t\t\t\t    \t\t</div>\n\t\t\t\t\t    \t</div>\n\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t\t\t     \n\t\t\t       \t</div>\n\t\t   \t\t</div><!-- div first row header ends  -->\n\t\t   \t\t\n\t\t   \t\t<!-- Page content starts -->\n\t\t   \t\t<div data-role = \"none\" class = \"secondRow secondRowTheme\">\n\t\t   \t\t";
    private final static byte[]  _wl_block46Bytes = _getBytes( _wl_block46 );

    private final static java.lang.String  _wl_block47 ="\n\t\t   \t\t<div class=\"ChartsContent\">\n\t\t   \t\t\t\t<div class=\"ChartsIframeContainer\" id = \"dvChartSummaryFrame\">\n\t\t   \t\t\t\t\t<iframe id=\"ChartSummaryIframe\" class=\"ChartSummaryIframe\" scrolling=\"no\" frameborder=\"0\" src=\"";
    private final static byte[]  _wl_block47Bytes = _getBytes( _wl_block47 );

    private final static java.lang.String  _wl_block48 ="/mobile/charts/notes/OpenClinicalNoteServlet\"> </iframe>\n\t\t   \t\t\t\t</div> \n\t\t   \t\t\t\t <div class=\"ChartsIframeContainer\" id = \"dvNotesFrame\" style = \"display:none; text-align: -webkit-center;\">\n\t\t   \t\t\t\t\t<iframe id=\"ChartSummaryNotesIframe\" class=\"ChartSummaryIframe\" scrolling=\"no\" frameborder=\"0\" style=\"width: 98%;height: 98%;margin-top: 5px;\"> </iframe>\n\t\t   \t\t\t\t</div> \n\t\t   \t\t\t</div> \n\t\t   \t\t";
    private final static byte[]  _wl_block48Bytes = _getBytes( _wl_block48 );

    private final static java.lang.String  _wl_block49 ="\n\t\t   \t\t\t<div class=\"ChartsContent\">\n\t\t   \t\t\t\t<div class=\"ChartsIframeContainer\" id = \"dvChartSummaryFrame\">\n\t\t   \t\t\t\t\t<iframe id=\"ChartSummaryIframe\" class=\"ChartSummaryIframe\" scrolling=\"no\" frameborder=\"0\" src=\"";
    private final static byte[]  _wl_block49Bytes = _getBytes( _wl_block49 );

    private final static java.lang.String  _wl_block50 ="/mobile/charts/orders/MNewOrderServlet\"> </iframe>\n\t\t   \t\t\t\t</div> \n\t\t   \t\t\t\t<div class=\"ChartsIframeContainer\" id = \"dvNotesFrame\" style = \"display:none; text-align: -webkit-center;\">\n\t\t   \t\t\t\t\t<iframe id=\"ChartSummaryNotesIframe\" class=\"ChartSummaryIframe\" scrolling=\"no\" frameborder=\"0\" style=\"width: 98%;height: 98%;margin-top: 5px;\"> </iframe>\n\t\t   \t\t\t\t</div>\n\t\t   \t\t\t</div> \n\t\t\t\t";
    private final static byte[]  _wl_block50Bytes = _getBytes( _wl_block50 );

    private final static java.lang.String  _wl_block51 ="/eIPAD/jsp/chartwidgets/clinicalevents/ClinicalEventsBasePage.jsp\"> </iframe>\n\t\t   \t\t\t\t</div> \n\t\t   \t\t\t\t<div class=\"ChartsIframeContainer\" id = \"dvNotesFrame\" style = \"display:none; text-align: -webkit-center;\">\n\t\t   \t\t\t\t\t<iframe id=\"ChartSummaryNotesIframe\" class=\"ChartSummaryIframe\" scrolling=\"no\" frameborder=\"0\" style=\"width: 98%;height: 98%;margin-top: 5px;\"> </iframe>\n\t\t   \t\t\t\t</div>\n\t\t   \t\t\t</div> \n\t\t   \t  ";
    private final static byte[]  _wl_block51Bytes = _getBytes( _wl_block51 );

    private final static java.lang.String  _wl_block52 ="/mobile/charts/pharmacy/PharmInitServlet\"> </iframe>\n\t\t   \t\t\t\t</div> \n\t\t   \t\t\t\t<div class=\"ChartsIframeContainer\" id = \"dvNotesFrame\" style = \"display:none; text-align: -webkit-center;\">\n\t\t   \t\t\t\t\t<iframe id=\"ChartSummaryNotesIframe\" class=\"ChartSummaryIframe\" scrolling=\"no\" frameborder=\"0\" style=\"width: 98%;height: 98%;margin-top: 5px;\"> </iframe>\n\t\t   \t\t\t\t</div>\n\t\t   \t\t\t</div> \t\t\t\t\t\n\t\t\t\t";
    private final static byte[]  _wl_block52Bytes = _getBytes( _wl_block52 );

    private final static java.lang.String  _wl_block53 ="\n\t\t\t\t<div class=\"ChartsContent\">\n\t\t   \t\t\t\t<div class=\"ChartsIframeContainer\" id = \"dvChartSummaryFrame\">\n\t\t   \t\t\t\t\t<iframe id=\"ChartSummaryIframe\" class=\"ChartSummaryIframe\" scrolling=\"no\" frameborder=\"0\" src=\"";
    private final static byte[]  _wl_block53Bytes = _getBytes( _wl_block53 );

    private final static java.lang.String  _wl_block54 ="/mobile/chartsummary/ChartWidgetsView?scrollToWidget=";
    private final static byte[]  _wl_block54Bytes = _getBytes( _wl_block54 );

    private final static java.lang.String  _wl_block55 ="\"> </iframe>\n\t\t   \t\t\t\t</div> \n\t\t   \t\t\t\t<div class=\"ChartsIframeContainer\" id = \"dvNotesFrame\" style = \"display:none; text-align: -webkit-center;\">\n\t\t   \t\t\t\t\t<iframe id=\"ChartSummaryNotesIframe\" class=\"ChartSummaryIframe\" scrolling=\"no\" frameborder=\"0\" style=\"width: 98%;height: 98%;margin-top: 5px;\"> </iframe>\n\t\t   \t\t\t\t</div>\n\t\t   \t\t\t</div> \n\t\t   \t\t";
