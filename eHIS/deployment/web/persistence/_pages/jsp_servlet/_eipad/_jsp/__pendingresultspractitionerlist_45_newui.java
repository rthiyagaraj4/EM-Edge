...
public final class __pendingresultspractitionerlist_45_newui extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/PendingResultsPractitionerList-newUI.jsp", 1738426127653L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block4 ="\n\t\t\t\t <tr class=\"prPracSearchResultsBody prPracSearchResultsBodyTheme\" id=\"prPractionerSelect";
    private final static byte[]  _wl_block4Bytes = _getBytes( _wl_block4 );

    private final static java.lang.String  _wl_block5 ="\" onclick=\"selectSpeciality(\'";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="\',\'";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="\')\">\n\t\t\t\t\t<td><span class=\"prPracSearchResultsBodyText\">";
