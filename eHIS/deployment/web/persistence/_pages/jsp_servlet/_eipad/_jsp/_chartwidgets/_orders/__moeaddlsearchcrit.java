...
public final class __moeaddlsearchcrit extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/chartwidgets/orders/MoeAddlSearchCrit.jsp", 1738426300384L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block10 ="\" readonly />\n\t\t\t\t</div>\t\t\n\t\t\t</div>\n\t\t\t<div class=\"ipSearchSfsItem ipSearchSfsItemTheme\" id=\"SearchTextContainer\" style=\"opacity:0.5\">\n\t\t\t\t<div class=\"ipSearchItemHeading ipSearchItemHeadingTheme\">Search Text</div>\n\t\t\t\t<div style=\"padding-left:7px\">\n\t\t\t\t\t<input type=\"text\" class=\"ipSearchSfsItemTextBoxTheme \" style=\"width:200px\" name=\"OrdSearchText\" id=\"OrdSearchText\" id=\"OrdSearchText\" placeholder=\"Enter Search Text...\" value=\"\" disabled=\"disabled\"/>\n\t\t\t\t</div>\t\t\n\t\t\t</div>\n\n\t\t</div>\n\t\t\n\t\t<input type = \"hidden\" name =\"hdnOrderCategory\" id =\"hdnOrderCategory\" value =\"";
