...
public final class __widgetactiveproblems extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/WidgetActiveProblems.jsp", 1709118033833L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
if(oProblem.getsEncounterID().equals(strEncounterId)){
            ...
            out.print( String.valueOf(oProblem.getsEncounterID()));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(oProblem.getsDiagnosisProblem()));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(oProblem.getsProblemDesc()));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(oProblem.getsPracName()));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(oProblem.getsOnsetDate()));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(oProblem.getsDateTime()));
            _bw.write(_wl_block16Bytes, _wl_block16);
            out.print( String.valueOf(oProblem.getsProblemSevereity()));
            _bw.write(_wl_block16Bytes, _wl_block16);
            out.print( String.valueOf(oProblem.getsProblemAccuracy()));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(oProblem.getsStatus()));
