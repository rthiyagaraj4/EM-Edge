...
public final class __pendingschedules extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/PendingSchedules.jsp", 1709118030318L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block6 ="</div></td>\n\t\t\t      </tr>\t      \n\t\t\t      \n\t\t ";
...
try {
objPendingSchedules = bean.getPendingSchedules(oPatientContext);
...
if(nListSize > 0)
{
	  for(nLoopCount = 0 ; nLoopCount < nListSize;nLoopCount ++)
	  {
		  ...
		  if(oPendingSchedules != null && nRowCount < 7)
		  {
			  if( nRowCount == 1)
				{
					strRowCount = oPendingSchedules.getsPendingScheduleCount();
				}
			  if(nRowCount == 7)
			  {
				  break;
            ...
            out.print( String.valueOf(oPendingSchedules.getsApptDate()));
            _bw.write(_wl_block4Bytes, _wl_block4);
            out.print( String.valueOf(oPendingSchedules.getsFromTime()));
            _bw.write(_wl_block5Bytes, _wl_block5);
            out.print( String.valueOf(oPendingSchedules.getsToTime() ));
            _bw.write(_wl_block5Bytes, _wl_block5);
            out.print( String.valueOf(oPendingSchedules.getsLocationDesc()));
            _bw.write(_wl_block5Bytes, _wl_block5);
            out.print( String.valueOf(oPendingSchedules.getsResourceName()));
