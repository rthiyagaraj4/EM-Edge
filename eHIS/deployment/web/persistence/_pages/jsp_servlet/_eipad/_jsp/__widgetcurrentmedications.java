...
public final class __widgetcurrentmedications extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/WidgetCurrentMedications.jsp", 1709118034162L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
	...
	if (session.getValue("EpisodeId") != null) {
		...
		if(nListSize > 0)
		{
            ...
            out.print( String.valueOf(oCurrentMedications.getsOrderID()));
            _bw.write(_wl_block5Bytes, _wl_block5);
            out.print( String.valueOf(oCurrentMedications.getsCatalogDesc()));
            _bw.write(_wl_block6Bytes, _wl_block6);
            out.print( String.valueOf(oCurrentMedications.getsOrderCatalog()));
            _bw.write(_wl_block7Bytes, _wl_block7);
            out.print( String.valueOf(oCurrentMedications.getsQuantity()));
            _bw.write(_wl_block8Bytes, _wl_block8);
            out.print( String.valueOf(oCurrentMedications.getsOrderedBy()));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(oCurrentMedications.getsPriority()));
