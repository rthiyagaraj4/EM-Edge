...
public final class __practitioner extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/Practitioner.jsp", 1709118030427L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
	...
	if (request.getParameter("txtSrchCriteria") != null
   	...
   	try {
   		...
   		if (nListSize > 0) {
            ...
            out.print( String.valueOf(oPractitioner.getsCode()));
            _bw.write(_wl_block4Bytes, _wl_block4);
            out.print( String.valueOf(oPractitioner.getsDescription()));
