...
public final class __currentmedications extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/CurrentMedications.jsp", 1709118025802L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
try {
objCurrentMedications = bean.getCurrentMedications(oPatientContext);
...
if(nListSize > 0)
{
	  for(nLoopCount = 0 ; nLoopCount < nListSize;nLoopCount ++)
	  {
		  ...
		  if(oCurrentMedications != null && nRowCount < 7)
		  {
			  if( nRowCount == 1)
				{
					strRowCount = oCurrentMedications.getsCurrentMedCount();
				}
			  if(nRowCount == 7)
			  {
				  break;
            ...
            out.print( String.valueOf(oCurrentMedications.getsDrugDesc()));
            _bw.write(_wl_block4Bytes, _wl_block4);
            out.print( String.valueOf(oCurrentMedications.getsOrderCatalog()));
