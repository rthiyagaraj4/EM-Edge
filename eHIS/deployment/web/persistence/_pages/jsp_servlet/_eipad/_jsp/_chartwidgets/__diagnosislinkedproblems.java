...
public final class __diagnosislinkedproblems extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/chartwidgets/DiagnosisLinkedProblems.jsp", 1709116944301L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
 ...
 if(isSuccessResponse && !isEmptyResponse) {
	for(int i=0;i<lpList.size();i++){
		ProblemsDiagnosisHO currentLP = lpList.get(i);
            ...
            out.print( String.valueOf(currentLP.getDiagProbDesc() ));
            _bw.write(_wl_block4Bytes, _wl_block4);
            out.print( String.valueOf(currentLP.getOnsetDate()));
