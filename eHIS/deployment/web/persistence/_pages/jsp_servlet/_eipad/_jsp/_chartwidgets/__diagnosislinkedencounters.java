...
public final class __diagnosislinkedencounters extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/chartwidgets/DiagnosisLinkedEncounters.jsp", 1709116944254L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block6 ="/eIPAD/images/inPatient32x32.png\">\n\t\t\t\t";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="/eIPAD/images/OutPatient32x32.png\">\n\t\t\t\t";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\n\t\t\t</div>\n\t\t\t<div class=\"\" style=\"display:table-cell;vertical-align:middle\">\n\t\t\t\t<div class=\"LinkPopupText1Theme\" style=\"padding-left:4px\">";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="</div>\n\t\t\t\t<div class=\"LinkPopupText2Theme\" style=\"padding-left:4px\">";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="</div>\n\t\t\t</div>\n\t\t\t<div class=\"\" style=\"display:table-cell;vertical-align:bottom;text-align:right\">\n\t\t\t\t<div class=\"LinkPopupText2Theme\" style=\"padding-right:4px;padding-bottom:4px;\">";
 ...
 if(isSuccessResponse && !isEmptyResponse) {
	for(int i=0;i<leList.size();i++){
		EncounterHO currentLE = leList.get(i);
            ...
            out.print( String.valueOf(currentLE.getEncounterId()));
...
if(currentLE.getPatientClass().equals("IP")){ 
            ...
            out.print( String.valueOf(currentLE.getPractShortName() ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(currentLE.getEncounterId()));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(currentLE.getVisitDate()));
