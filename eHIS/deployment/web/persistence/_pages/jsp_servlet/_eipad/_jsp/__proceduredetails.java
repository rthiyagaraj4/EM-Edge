...
public final class __proceduredetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/ProcedureDetails.jsp", 1709118031037L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
if(nListSize > 0)
{
	  for(nLoopCount = 0 ; nLoopCount < nListSize;nLoopCount ++)
	  {
		  ...
		  if(oProcedureDet != null && nRowCount < 7)
		  {
            ...
            out.print( String.valueOf(oProcedureDet.getsProcNarration()));
