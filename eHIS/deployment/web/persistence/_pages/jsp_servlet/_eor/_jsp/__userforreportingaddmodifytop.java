...
public final class __userforreportingaddmodifytop extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/UserForReportingAddModifyTop.jsp", 1721727402000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n<form name=\'user_for_reporting_top\' id=\'user_for_reporting_top\' target=\'messageFrame\' >\n<input type=\"hidden\" name=\"mode\" id=\"mode\" value=\"";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\">\n<table cellpadding=3 cellspacing=0 border=0 width=\"100%\" height=\'100%\' align=center>\n\t\n\t<tr>\n\t\t<td class=fields>\n\t\t\n\t\t<input type=radio name=radio_but value=\'practioner\' onclick=\'loadPage(this)\' >";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\n\t\t</td>\n\t\t<td class=fields>\n\t\t<input type=radio name=radio_but value=\'responsibility\' onclick=\'loadPage(this)\'>";
