...
public final class __practforconsentlist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/PractForConsentList.jsp", 1721627324000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\n\n<body onMouseDown=\'CodeArrest()\'; onKeyDown=\'lockKey()\'>\n\t<form name=\"formPractForConsentList\" id=\"formPractForConsentList\">\n\t<table cellpadding=\'3\' cellspacing=\'0\' border=\'0\' width=\'100%\' align=\'center\'>\n\t<tr width=\'10%\'>\n\t<td class=\'WHITE\' align=\"right\">\n\t";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	String from= "", to ="" ;
	String long_desc="", dispMode="", tabVal="",label = "";
	String group_by, pract_consent_code ="", code="";
	String mode="1";
	...
	pract_consent_code  =   request.getParameter("pract_consent_code");
...
//		end = row_disp;
	...
	if(pract_consent_code == null || pract_consent_code.equals("null"))pract_consent_code="";	
	...
	{
		label = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ConsentForm.label","common_labels");
		//label = "Consent Form";
	}
...
//	 label = "None";
	...
	bean.setPract_consent_code(pract_consent_code);
...
if(valid.equals("Y")){
            ...
            out.print( String.valueOf(pract_consent_code));
