...
import java.lang.*;
import java.util.*;
import eOR.OrReportsBean;

public final class __ormasterreportcodelist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ORMasterReportCodeList.jsp", 1741325456000L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	/* Initialize Function specific end*/
		...
		for (int i=0; i<masterList.size(); i+=2) {
            ...
            out.print( String.valueOf( masterList.get(i) ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf( masterList.get(i+1)+":"+masterList.get(i) ));
