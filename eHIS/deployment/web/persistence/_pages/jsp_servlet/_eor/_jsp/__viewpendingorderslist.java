...
public final class __viewpendingorderslist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ViewPendingOrdersList.jsp", 1735876636000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block24 ="</TD>\n\t\t\t\t<TD  class=\'gridData\' width=\'\' nowrap><font size=1 color=black><b>";
	...
	if((Integer.parseInt(total_query_records)>0) || (start>1))
		{
            ...
            {java.lang.String __page ="ResultScrollingPendingOrders.jsp";
                java.lang.String[][] __queryParams = {{ weblogic.utils.StringUtils.valueOf("flush"), weblogic.utils.StringUtils.valueOf("true")},{ weblogic.utils.StringUtils.valueOf("from"), weblogic.utils.StringUtils.valueOf(start
                        ...
                        )},{ weblogic.utils.StringUtils.valueOf("check_box_name"), weblogic.utils.StringUtils.valueOf("chk")},{ weblogic.utils.StringUtils.valueOf("form_name"), weblogic.utils.StringUtils.valueOf("view_pend_ord_list")},};
