...
public final class __ormasterreportimagehotspot extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ORMasterReportImageHotspot.jsp", 1741325476000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block7 ="\n<input type=hidden  name=\'SQL_OR_REPORTS_IMAGE_HOTSPOT_LOOKUP\' id=\'SQL_OR_REPORTS_IMAGE_HOTSPOT_LOOKUP\'     value=\'";
...
try{
            ...
            out.print( String.valueOf(OrRepository.getOrKeyValue("SQL_OR_REPORTS_IMAGE_HOTSPOT_LOOKUP")));
