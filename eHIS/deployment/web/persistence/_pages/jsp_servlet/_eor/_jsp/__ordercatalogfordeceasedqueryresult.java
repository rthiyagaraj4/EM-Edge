...
public final class __ordercatalogfordeceasedqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderCatalogForDeceasedQueryResult.jsp", 1721727518000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
		...
		if((result.size()>=2) && ( !( ((String) result.get(0)).equals("0")) ))
		{
            ...
            out.print( String.valueOf(order_type_code_return));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(order_catalog_code_return));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(post_mortem_appl));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(post_mortem_type));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(allow_for_deceased));
            _bw.write(_wl_block21Bytes, _wl_block21);
