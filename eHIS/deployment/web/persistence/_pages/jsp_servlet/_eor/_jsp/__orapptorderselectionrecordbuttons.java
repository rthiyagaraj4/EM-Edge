...
public final class __orapptorderselectionrecordbuttons extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ORApptOrderSelectionRecordButtons.jsp", 1709119754000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\' onClick=\'Add();\'>&nbsp;\n\t\t\t<input type=\'BUTTON\' class=\'BUTTON\' name=\'cancel\' id=\'cancel\' value=\'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\' onClick=\'Cancel();\'>&nbsp;&nbsp;\n\t\t<input type=hidden name=\'facilityid\' id=\'facilityid\' value=\'";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085	
		...
		if(!"Record".equals(Mode))
            ...
            out.print( String.valueOf(recordyn));
