...
public final class __userforreviewaddmodifytop2 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/UserForReviewAddModifyTop2.jsp", 1721206984000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 =" </td>\n\t\t<td ><input type=text name=resp_disp value=\"";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\" readonly><input type=hidden name=responsibility value=\'";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\' ><img src=\"../../eCommon/images/mandatory.gif\"></td></tr>\n\t\t\n\t\t\n\t\t";
    ...
    private final static java.lang.String  _wl_block23 ="</td>\n\t\t<td ><input type=text name=pract_disp value=\"";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\" readonly><input type=hidden name=practitioner value=\'";
...
if ( mode.equals( CommonRepository.getCommonKeyValue("MODE_INSERT") )&& type.equals("responsibility")){
 ...
 if ( mode.equals( CommonRepository.getCommonKeyValue("MODE_INSERT") )&& type.equals("practitioner")){
            ...
            out.print( String.valueOf(OrRepositoryExt.getOrKeyValue("SQL_OR_PRACTITIONER_LOOKUP_SQL2_ADMIN")));
            _bw.write(_wl_block27Bytes, _wl_block27);
            out.print( String.valueOf(OrRepositoryExt.getOrKeyValue("SQL_OR_PRACTITIONER_LOOKUP_ADMIN")));
