...
public final class __orderentryagesexinstrnviewframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderEntryAgeSexInstrnViewFrame.jsp", 1709117188000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
*/
	...
	String textComments = tableValues[8];
		...
		else
		{
            ...
            out.print( String.valueOf(textComments));
