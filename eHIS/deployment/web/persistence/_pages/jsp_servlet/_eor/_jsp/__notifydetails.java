...
public final class __notifydetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/NotifyDetails.jsp", 1709119752000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n<textarea rows=\"30\" cols=\"127\"  style=\"font-family:Courier New;white-space:pre-wrap\" readonly >";
...
*/
	...
	allValues		= bean.notificationDetails(orderId,facility_id);
            ...
            out.print( String.valueOf(allValues ));
