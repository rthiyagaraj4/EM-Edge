...
public final class __reviewresultsforwardpract extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ReviewResultsForwardPract.jsp", 1709120004000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\'><input type=checkbox name=\'chk";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' id=\'chk";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\' value=\'Y\' onclick=\"chk(this);\"></td>\n            <td width=\'30%\' class=\'";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\'><font size=1>";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="</font><Input name=\'pract_id";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\' id=\'pract_id";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\' type=\'hidden\' value=\'";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="\'></td>\n\t\t\t<td width=\'65%\' class=\'";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="</font><Input name=\'pract_name";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\' id=\'pract_name";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="\'></td>\n\t\t</TR>\n\t\t<script>\nparent.ReviewResultsForwardPractHeader.location.href = \"../../eOR/jsp/ReviewResultsForwardPractHeader.jsp\"\t\t\t\nparent.ReviewResultsForwardPractBtn.location.href = \"../../eOR/jsp/ReviewResultsForwardPractBtn.jsp\" \n\t</script>\n";
	...
	//out.println("<script>alert('kkk="+practitioner_id+"');</script>");
	...
	//out.println("search_by => "+search_by+" search_criteria => "+search_criteria);
...
//	out.println(">"+resp_id+"<");
	...
	//String normal_ind 			= CommonBean.checkForNull(request.getParameter("normalcy_ind"));
	//String result_type			= CommonBean.checkForNull(request.getParameter("result_type"));

	//String patientId			= CommonBean.checkForNull(request.getParameter("patientId"));
	//String event_class			= CommonBean.checkForNull(request.getParameter("event_class"));

	//String group_by				= CommonBean.checkForNull(request.getParameter("groupby"));

	//String patient_class		= CommonBean.checkForNull(request.getParameter("patient_class"));
	//String ca_normalcy_ind		= CommonBean.checkForNull(request.getParameter("ca_normalcy_ind"));

	//String modal                = CommonBean.checkForNull(request.getParameter("modal"));
	String practitioner_name    = CommonBean.checkForNull(request.getParameter("practitioner_name"));

	//out.println("searchArray[0] = > "+searchArray[0]+" searchArray[1] = > "+searchArray[1]+" search_by = > "+search_by+" search_criteria = > "+search_criteria+" practitioner_name = > "+practitioner_name);
...
/* Mandatory checks end */
	...
	//String tooltip			= "";
	//out.println("practitioner_name => "+practitioner_name+" ca_practitioner_id=> "+ca_practitioner_id);
...
putObjectInBean(bean_id,bean,request);
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.practitionerid.label", java.lang.String .class,"key"));
