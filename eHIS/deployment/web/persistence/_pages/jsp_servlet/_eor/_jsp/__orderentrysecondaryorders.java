...
public final class __orderentrysecondaryorders extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderEntrySecondaryOrders.jsp", 1709119832000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\'  nowrap><font size=\'1\'>";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="</font></td>\n\t<td class=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' nowrap> <font size=\'1\'>";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' nowrap><font size=\'1\'>";
...
if(called_from.equalsIgnoreCase("existing_order"))
{
	...
	//if ((beanQueryObj.checkForNull(record[2],"")).equals("Order")) {
		...
		else
		{
            ...
            out.print( String.valueOf(com.ehis.util.DateUtils.convertDate(record[0],"DMYHM","en",localeName)));
