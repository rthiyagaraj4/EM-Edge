...
public final class __orderentryorderformatline extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderEntryOrderFormatLine.jsp", 1735551668000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block14 ="\">\n\t\t<input type=\"hidden\" name=\"chk_mand\" id=\"chk_mand\" value=\"";
...
if(chk_mand.equals("RECORD"))  { 
	    ...
	    //	}
            ...
            out.print( String.valueOf(chk_mand));
