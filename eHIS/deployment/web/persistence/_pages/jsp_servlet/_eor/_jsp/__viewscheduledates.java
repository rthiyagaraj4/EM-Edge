...
import eOR.SceduleFreqeuncyInterface;

public final class __viewscheduledates extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ViewScheduleDates.jsp", 1731409780000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 =" <br/>\n\t\t\t\t\t\t\t<font weight=\'bold\' color=\'#990000\'><Strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="</Strong></font>\n\t\t\t\t\t</td>\t\t\n\t\t\t\t\t\n\t";
	...
	if(schdMap != null)
	{
		...
		if(dateList != null && dateList.size() > 0){
            ...
            out.print( String.valueOf((String)dateList.get(i)));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf((String)dayList.get(i)));
