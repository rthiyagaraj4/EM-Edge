...
public final class __patientinstructionsbutton extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/PatientInstructionsButton.jsp", 1736486346000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block3 =" <!-- IN036453 -->\n";
    ...
    private final static java.lang.String  _wl_block10 ="\" onClick=\'printit();\'>&nbsp;\n\t\t\t\t\t\t<input type=\'button\' class=\'button\' name=\'close\' id=\'close\'  value=\"";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\" onClick=\'toCloseTopShowModal();\'>\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t</form>\n\t</body>\n</html>\n\n";
