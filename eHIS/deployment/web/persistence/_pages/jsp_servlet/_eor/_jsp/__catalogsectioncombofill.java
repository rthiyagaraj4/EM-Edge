...
public final class __catalogsectioncombofill extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/CatalogSectionComboFill.jsp", 1721800228000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block4 ="\n\t<script>alert(\"Exception thrown ...Chk in CataLogSectionFill.jsp\" + \"";
    ...
    private final static java.lang.String  _wl_block12 ="\n\t\t\n\t\tf_query_add_mod.f_query_add_mod_header.document.forms[0].fpp_yn.value=\"";
...
if("Y".equals(ts_fpp_yn)){ 
            ...
            out.print( String.valueOf(ts_fpp_yn ));
