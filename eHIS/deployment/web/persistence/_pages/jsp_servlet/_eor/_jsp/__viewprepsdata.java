...
public final class __viewprepsdata extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ViewPrepsData.jsp", 1709120070000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="</TEXTAREA></td></tr>\t\n\t";
    ...
    private final static java.lang.String  _wl_block30 ="\" onClick=\'window.close()\'></td></tr>\n</table>\n</FORM>\n</BODY>\n</HTML>\n\n";
...
String audit_reqd_yn = bean1.getOrderFormatAuditTrailYN();//IN049419
...
try{
	if(audit_reqd_yn.equalsIgnoreCase("Y")) {
		...
		if(curr_sequ_num.equals("") || modified_max_sequ.equals(curr_sequ_num) ) {
			preps_data = bean.getPrepsData(Integer.parseInt(line));
			//IN051106 - Start
			...
			if(max_num != null && max_num != "") { 
				...
				if(orderLineMap != null){
					preps_data = (String)orderLineMap.get("ORDER_LINE_FIELD_VALUE");
					amend_by = (String)orderLineMap.get("ADDED_NAME")==null?"":(String)orderLineMap.get("ADDED_NAME");
					amend_date = (String)orderLineMap.get("ADDED_DATE")==null?"":(String)orderLineMap.get("ADDED_DATE");
	...
	// IN049419 - End	
		preps_data = bean.getPrepsData(Integer.parseInt(line));
		//preps_data = java.net.URLDecoder.decode(preps_data,"UTF-8");
	// IN049419 - Start
	}
} 
catch(Exception ex){
	System.err.println("105. ViewPrepsData.jsp " + ex.getMessage());
	ex.printStackTrace();
}
//IN049419 - End
if(preps_data == null || preps_data.equals("null"))
	preps_data = "";
	...
	if("T".equals(instrn_type))//IN64543
	{
            ...
            out.print( String.valueOf(preps_data));
...
if(max_seq_int>1){ 
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOR.PrepsInstructions.label", java.lang.String .class,"key"));
