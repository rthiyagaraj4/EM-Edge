...
public final class __orderentrypreviewframes extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderEntryPreviewFrames.jsp", 1730972066000L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	windowTitle 		= (windowTitle  == null)?"":windowTitle ;
            ...
            out.print( String.valueOf(windowTitle));
