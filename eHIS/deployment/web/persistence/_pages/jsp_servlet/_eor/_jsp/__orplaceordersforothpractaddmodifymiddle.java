...
public final class __orplaceordersforothpractaddmodifymiddle extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ORPlaceOrdersForOthPractAddModifyMiddle.jsp", 1728469562000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block24 ="\n\t\t\t\t\t<input type=checkbox name=\"pract_type";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 ="\" id=\"pract_type";
...
/* Mandatory checks end */
	...
	else
	{
		...
		for(int i=0; i<practTypes.size(); i++)
		{
            ...
            out.print( String.valueOf(practRecords[1]));
            ...
            out.print( String.valueOf(practRecords[0]));
            ...
            out.print( String.valueOf(practTypes.size()));
