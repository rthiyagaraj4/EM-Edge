...
public final class __orfacilitieslookup extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrFacilitiesLookup.jsp", 1709119870000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 =" <input type=\'checkbox\' name=\'includeAll\' id=\'includeAll\' ";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 =" onclick=\'includeAllFacilities(this)\'/></td>\n\t\t\t</tr>\n\t\t</table>\n\t\t<div style=\'width:640px;height:400px\'>\n\t\t\t<div style=\'width:640px;height:400px;overflow:auto\'>\n\t\t\t\t<table width=\'100%\' align=\'center width=\'100%\' class=\'grid\'\'>\n\t\t\t\t\n";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"gridData\">";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="</td>\n\t\t\t\t\t<td class=\"gridData\"><input type=\'checkbox\' ";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 =" onclick= \'includeIndividualFac(this)\' name=\'facility";
    ...
    private final static java.lang.String  _wl_block21 ="\'/>\n\t \t<input type=\'hidden\' name=\'noOfMappedFac\' id=\'noOfMappedFac\' value =\'";
    ...
    private final static java.lang.String  _wl_block26 ="\' onClick=\'includeFacilites()\' class=\'button\'> &nbsp; <input type=\'button\' name=\'close\' id=\'close\' value=\'";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="\' onClick=\'window.close()\' class=\'button\'>\t\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t</table>\t\n\t\t</div>\n\t\t<script>\n\t\tdefaultSelectAll();\n\t\t</script>\n\t </body>\n</html>\n\n";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	//if(Integer.parseInt(l_mode) == 2 && ("OR_ORDER_MASTER".equals(l_func_id)||"OR_ORDER_SET".equals(l_func_id)))
		//l_disable = "disabled";
            ...
            out.print( String.valueOf(l_disable));
	...
	try 
	{
		if (facSize > 0) 
		{
            ...
            out.print( String.valueOf((bean.getMappedFacilities().contains(records[1]))?"checked":""));
	...
	catch (Exception e) 
	{
		e.printStackTrace();
            ...
            out.print( String.valueOf(facSize));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(bean.getMappedFacilities().size()));
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOR.Facilities.label", java.lang.String .class,"key"));
