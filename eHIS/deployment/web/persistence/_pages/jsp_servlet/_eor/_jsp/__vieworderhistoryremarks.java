...
public final class __vieworderhistoryremarks extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ViewOrderHistoryRemarks.jsp", 1732247574000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="\" onClick=\"toClose();\"></td></tr>\n\t</table>\n</FORM>\n</BODY>\n</HTML>\n\n\n";
...
else if(remarksHash.containsKey("Specimen Dispatched By "))
{
	...
	String sStyle	= ((session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!=""))?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
            ...
            out.print( String.valueOf(remarksText));
