...
public final class __orderformatpopulatetissuefields extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderFormatPopulateTissueFields.jsp", 1709117200000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {;
            ...
            _bw.write(_wl_block1Bytes, _wl_block1);
            eOR.OrderEntryFormatBean beanQueryObj= null;{
                beanQueryObj=(eOR.OrderEntryFormatBean)pageContext.getAttribute("beanQueryObj");
                if(beanQueryObj==null){
                    beanQueryObj=new eOR.OrderEntryFormatBean();
