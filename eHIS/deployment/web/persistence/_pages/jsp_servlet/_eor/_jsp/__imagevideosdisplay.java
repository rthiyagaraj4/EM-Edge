...
public final class __imagevideosdisplay extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ImageVideosDisplay.jsp", 1709119716000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
try{
	...
	int i = 0;
            ...
            out.print( String.valueOf(fileChoosePath));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(i));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(aFile));
