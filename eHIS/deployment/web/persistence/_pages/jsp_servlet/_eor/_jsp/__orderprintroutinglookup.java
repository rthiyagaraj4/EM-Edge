...
public final class __orderprintroutinglookup extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderPrintRoutingLookUp.jsp", 1719922268000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\n\t<FORM name=\"formInstruction\" id=\"formInstruction\" >\n\t\t<TABLE CELLPADDING=\"3\" CELLSPACING=\"0\" WIDTH=\"100%\" ALIGN=\"center\" >\n\t\t<!--size=500 maxlength=500  -->\n\t\t<TR>\n\t\t\t<TD COLSPAN=\"2\" class=label>\n\t\t\t<textarea name=\'instruction\'   cols=54 rows=14 title=\"Fill Instruction\"  onBlur=\"SPCheckMaxLen(\'Instruction\',this,500,\'\');\" value=\"\" onkeyPress=\'return checkMaxLimit(this,500)\'>";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 =" </textarea>\n\t\t\t\n\t\t\t</TD>\n\t\t</TR>\n\t\t<TR>\n\t\t\t<TD WIDTH=\"60%\" CLASS=\"label\" COLSPAN=\"100%\"><B></B></TD>\n\t\t</TR>\n\t\t\n\t\t<TR>\n\t\t\t<TD class=\'button\' COLSPAN=\"2\" ALIGN=\"center\" >\n\t\t\t<INPUT TYPE=\"button\" CLASS=\"button\" name=\"closebtn\" id=\"closebtn\" VALUE=\'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\' onClick=\"closeWindow();\" title=\"Close Window\">\n\t\t\t</TD>\n\t\t</TR>\n\t\t</TABLE>\n\t</FORM>\n</BODY>\n</HTML>\n\n\n";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	String sStyle	= ((session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!=""))?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	  ...
	  if(textVal==null||textVal.equals(""))textVal="";
            ...
            out.print( String.valueOf(textVal));
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOR.InstructionDetails.label", java.lang.String .class,"key"));
