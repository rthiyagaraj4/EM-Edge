...
public final class __moembalmcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emo/jsp/MOEmbalmCriteria.jsp", 1709118406556L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="</td><!--bundle change for PAS-MO-PMG2020-TECH-CRF-0010/02-Label Name-->\n\t\t <td class=\'field\' ><input type=\'text\'  name=\'patient_id\' id=\'patient_id\'  value=\'";
    ...
    private final static java.lang.String  _wl_block12 ="\' onBlur=\'ChangeCase(this);if(this.value!=\"\"){submitPage(this.value);}\' onKeyPress=\"return CheckForSpecChars(event);\" ><input type=\"button\" name=\"patient_search\" id=\"patient_search\" class=BUTTON  value=\"?\" onClick=\"callpatientsearch(this,\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\',patient_id)\" ><img name=\'mandatory\' src=\'../../eCommon/images/mandatory.gif\'></td>\n        <td width=\'25%\'>&nbsp;</td>\n        <td width=\'25%\'>&nbsp;</td>\n  \n\t\t <td class=\'button\' colspan=4>\n\t\t <input type=\'button\' name=\'search\' id=\'search\' value=\'";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' class=\'button\' onClick=\'submitPage(patient_id.value);\'>\n\t\t <input type=\'button\' name=\'clear\' id=\'clear\' value=\'";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\' class=\'button\' onclick=\'clearData()\'>\n\t\t </td> \n\t</tr>\n\t<input type=\'hidden\' name = \'srl_no\' value = ";
