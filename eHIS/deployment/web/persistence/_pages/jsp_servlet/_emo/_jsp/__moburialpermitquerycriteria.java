...
public final class __moburialpermitquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emo/jsp/MOBurialPermitQueryCriteria.jsp", 1724678068924L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block25 ="\' class=\'button\' onclick=\'clearData()\'>\n\t\t </td>\n\t</tr>\n  \n  </table>\n\t\n<input type=\'hidden\' name=\'facility_id\' id=\'facility_id\' value=\'";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
	 ...
	 try 
		...
		if (st!=null) st.close();
            ...
            out.print( String.valueOf(DateUtils.convertDate(defaultdate1,"DMY","en",locale)));
