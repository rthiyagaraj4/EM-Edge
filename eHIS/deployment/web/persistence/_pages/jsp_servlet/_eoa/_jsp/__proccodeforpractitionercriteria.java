...
public final class __proccodeforpractitionercriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoa/jsp/ProcCodeforPractitionerCriteria.jsp", 1709119255568L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t</select><img src=\'../../eCommon/images/mandatory.gif\'/>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td  class=\"label\"><label id=\"linking_splty\">";
    ...
    private final static java.lang.String  _wl_block21 ="\' onclick=\'displayResults()\'>&nbsp;<input type=\'button\' name=\'clear\' id=\'clear\' value=\'";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\' onclick=\"clearAll();\">\n\t\t\t\t\t\t</td>\n\t\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\t<input type=\'hidden\' name=\'locale\' id=\'locale\' value=\'";
	...
	try{
		...
		ConnectionManager.returnConnection(con,request);	
            ...
            if (_jsp__tag5(request, response, pageContext, _activeTag, null))
             return;
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(splty_list_values.toString()));
...
clearBuffers(termset_list_values,splty_list_values );
    ...
    private boolean _jsp__tag6(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag6.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.ProcedureCode.label", java.lang.String .class,"key"));
