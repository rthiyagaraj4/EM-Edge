...
public final class __invokepatientdetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoa/jsp/InvokePatientDetails.jsp", 1709119240162L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block4 ="\n<body >\n</body>\n<script>\t\t\n\t\t//window.open(\'../../eMP/jsp/ViewPatDetailsMain.jsp?menu_id=MP&module_id=MP&function_name=Change Patient Details&function_type=F&access=NYNNN&function_id=";
    private final static byte[]  _wl_block4Bytes = _getBytes( _wl_block4 );

    private final static java.lang.String  _wl_block5 ="&home_required_yn=N&Patient_ID=";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="\',\'eHIS\',\'location=0,height=700,width=1050,top=0,left=0,resizable=yes\');\n\t\tlocation.href =\'../../eMP/jsp/ViewPatDetailsMain.jsp?menu_id=MP&module_id=MP&function_name=Change Patient Details&function_type=F&access=NYNNN&function_id=";
