...
public final class __oapatientinstructionstabs extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoa/jsp/OAPatientInstructionsTabs.jsp", 1709119248444L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block7 ="\n<body onKeyDown=\'lockKey()\'>\n\t<div id=\'patinsdivtab\' style=\"visibility:";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	if(patInsTabYN.equals("Y") && procInsTabYN.equals("Y")){
		...
		displayTab="";
            ...
            out.print( String.valueOf(visibilityTab));
            _bw.write(_wl_block8Bytes, _wl_block8);
            out.print( String.valueOf(displayTab));
