...
public final class __waitlistcategoryforspltyresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoa/jsp/WaitlistCategoryForSpltyResult.jsp", 1724738358659L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\"  width=\'75%\' nowrap >&nbsp;";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="&nbsp;</td>\n\t\t\t<td class=\"";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\" nowrap align=center>\n\t\t\t<input type=checkbox   name=\'strKey";
	 ...
	 ConnectionManager.returnConnection(con,request);
		...
		if(pstmt!=null) pstmt.close();
		 if(rset!=null)  rset.close();
            ...
            out.print( String.valueOf(waitlist_category_code));
