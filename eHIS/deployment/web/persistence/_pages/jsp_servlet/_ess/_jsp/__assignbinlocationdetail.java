...
public final class __assignbinlocationdetail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/AssignBinLocationDetail.jsp", 1709121766728L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="</td><td class=\"label\">&nbsp;&nbsp;<input type=\"text\" name=\"tray_no\" id=\"tray_no\" size=\"12\" maxlength =  \"12\" class=\"NUMBER\" value=\"";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\" disabled ></td>\n\t\t\t\t\t</tr>\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<td align=\"right\" class=\"label\">";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="</td><td class=\"label\" >&nbsp;&nbsp;<select name=\"bin_location_code\" id=\"bin_location_code\" \t\t\t\t";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 =">";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="</select>&nbsp;<IMG src=\"../../eCommon/images/mandatory.gif\" align=center></td>\n\t\t\t\t\t</tr>\n\t\t\t\t\t\t<td>&nbsp;</td><td>&nbsp;</td>\n\t\t\t\t\t</tr>\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<td align=\"center\" class=\"label\" colspan=\'2\'>\n\t\t\t\t\t\t\t<input type=\"button\" value=\"Modify\" name=\"modify\" id=\"modify\" class=\"BUTTON\" ";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 =" onClick=\"updateTrayNo();\">\n\t\t\t\t\t\t\t<input type=\"button\" value=\"Cancel\" name=\"cancel\" id=\"cancel\" class=\"BUTTON\" ";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 =" onClick=\"disableAll();\">\n\t\t\t\t\t\t</td>\n\t\t\t\t\t</tr>\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<td>&nbsp;</td><td>&nbsp;</td>\n\t\t\t\t\t</tr>\n\t\t\t\t</table>\n\t\t\t</td>\n\t\t\t</tr>\n\t\t\t</table>\n\t\t\t<input type=\'hidden\' name=\"description\" id=\"description\" value=\"\">\n\t\t\t<input type=\'hidden\' name=\"mode\" id=\"mode\" value=\"";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\">\n\t\t\t<input type=\'hidden\' name=\"table_index\" id=\"table_index\" value=\"";
...
request.setCharacterEncoding("UTF-8");
		...
		if (tray_no == null) {
            ...
            out.print( String.valueOf(bean.getBinLocations(store_code)));
            ...
            out.print( String.valueOf(table_index));
