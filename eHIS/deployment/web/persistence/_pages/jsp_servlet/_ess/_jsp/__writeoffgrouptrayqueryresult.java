...
public final class __writeoffgrouptrayqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/WriteOffGroupTrayQueryResult.jsp", 1709121915008L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\" onmouseover=\"changeCursor(this);\" >\n\t\t\t\t\t\t<font class=\'HYPERLINK\'>";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="</font></td>\n\t\t\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\" align=\"left\" onclick=\"disableClick(event);\">";
    ...
    String owner_store_code	= request.getParameter("store_code");
	...
	try{
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_TRAY_DTLS_QUERY_RESULT_FOR_WRITE_OFF") );
		...
		*/
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/WriteOffGroupTrayQueryResult.jsp", searched) );
	}
	catch(Exception e) {
