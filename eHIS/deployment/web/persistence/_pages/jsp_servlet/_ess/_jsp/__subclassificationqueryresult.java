...
public final class __subclassificationqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/SubClassificationQueryResult.jsp", 1709121888836L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	String sub_classification_code		=		request.getParameter("sub_classification_code");
	...
	try{
		sub_classification_code			=		CommonBean.checkForNull(sub_classification_code)+"%";
		long_desc						=		CommonBean.checkForNull(long_desc)+"%";
		eff_status						=		CommonBean.checkForNull(eff_status);

		HashMap sqlMap					=		new HashMap();
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_SUB_CLASSIFICATION_QUERY_RESULT"));

		HashMap funcMap					=		new HashMap();

		ArrayList displayFields			=		new ArrayList();

		displayFields.add("sub_classification_code");
		displayFields.add("long_desc");
		displayFields.add("short_desc");
		displayFields.add("eff_status");

		ArrayList chkFields				=		new ArrayList();
		chkFields.add( sub_classification_code);
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/SubClassificationQueryResult.jsp", searched) );
	}
	catch(Exception e) {
