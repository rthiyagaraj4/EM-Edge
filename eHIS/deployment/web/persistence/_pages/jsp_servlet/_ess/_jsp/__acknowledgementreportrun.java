...
public final class __acknowledgementreportrun extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/AcknowledgementReportRun.jsp", 1709121763650L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block14 ="</td>\n\t\t\t\t\t<td class=label >&nbsp;&nbsp;<input class=\"NUMBER\" maxLength=8 size=8 name=\"p_fm_document_no\" id=\"p_fm_document_no\" value=\"\" onkeypress=\"return isValidNumber(this,event,";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 =",0);\" onBlur=\"checkIntegerFormat(this);\" ></td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input class=\"NUMBER\" maxLength=8 size=8 name=\"p_to_document_no\" id=\"p_to_document_no\" value=\"\" onBlur=\"checkIntegerFormat(this);\" onkeypress=\"return isValidNumber(this,event,";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 =",0);\" ></td>\n\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t<tr>  \n\t\t\t\t\t<td align=\"right\" class=\"label\">";
