...
public final class __issuegrouprequestqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/IssueGroupRequestQueryResult.jsp", 1739528751786L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block21 ="\"  onmouseover = \"showToolTip(this,\'";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\')\" ><font class=\'HYPERLINK\'>";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="</font></td><!-- ML-MMOH-CRF-1829 -->\n\t\t";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\" onclick=\"disableClick(event);\" align=\"";
...
*/ 
	...
	try{
		...
		if((result.size()>=3) && (!(((String) result.get(0)).equals("0")))){
            ...
            out.print( String.valueOf(strGroupType));
