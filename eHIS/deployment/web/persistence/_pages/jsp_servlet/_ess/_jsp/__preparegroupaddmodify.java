...
public final class __preparegroupaddmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/PrepareGroupAddModify.jsp", 1741326135526L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\n<body onMouseDown=\"CodeArrest();\"  onload=\'validateStoreCode(document.formPrepareGroup.store_code,\"";
    ...
    private final static java.lang.String  _wl_block10 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;<select name=\"doc_type_code\" id=\"doc_type_code\" onBlur=\"validateDocNo(this);\" ";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 =">";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="</select>&nbsp;<IMG src=\"../../eCommon/images/mandatory.gif\" align=center></td>\n\t\t\t\t\t  <!-- On Selection of Doc Type, Check needs to be made  for Document No Enable/Disable -->\n\t\t\t\t\t<td class=label >";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;<input CLASS=\"NUMBER\" maxLength=8 size=8 name=\"doc_no\" id=\"doc_no\" onKeyPress=\"return isValidInteger();\"  disabled value=\"";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\" onBlur=\"return checkIntegerFormat(this);\">&nbsp;<IMG src=\"../../eCommon/images/mandatory.gif\" align=center ></td>\n\t\t\t\t\t</tr>\n\t\t\t\t  <tr>\n\t\t\t\t\t<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>\n\t\t\t\t  </tr>\n\t\t\t\t  <tr>\n\t\t\t\t\t<td class=label >";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="</td>\n\t\t\t\t\t\n\t\t\t\t\t<td class=label>&nbsp;<input type=\"text\" maxLength=10 size=10 name=\"doc_date\" id=\"doc_date\" value=\"";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\"  onBlur=\"CheckDate(this,\'";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\');\" >&nbsp;<input type=\'image\' src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'doc_date\');\"><IMG src=\"../../eCommon/images/mandatory.gif\" align=center></td>\n\t\t\t\t\t<td class=label >";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;<input maxLength=15 size=15 name=\"doc_ref\" id=\"doc_ref\" value=\"";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\"> </td></TR>\n\t\t\t\t  <tr>\n\t\t\t\t\t<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>\n\t\t\t\t </tr>\n\t\t\t\t  <tr>\n\t\t\t\t\t<td class=label >";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;<select name=\"store_code\" id=\"store_code\" onChange=\"validateStoreCode(this);\" ";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="> ";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 =" </select>&nbsp;<IMG src=\"../../eCommon/images/mandatory.gif\" align=center></td>\n\t\t\t\t\t<td class=label >";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;<input maxLength=15 size=15 name=\"group_desc\" id=\"group_desc\" value=\"";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\" ";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 ="><input class=\"button\" onClick=\"return searchCode(group_code,group_desc);\" type=\"button\" value=\"?\">&nbsp;<IMG src=\"../../eCommon/images/mandatory.gif\" align=center><a style = \"CURSOR:DEFAULT\" href=\'javascript:details();\'  ";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 =" id=\'details\'>";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="&nbsp&nbsp</a></td>\n\t\t\t\t\t\n\t\t\t\t  </tr>\n\t\t\t\t  <tr>\n\t\t\t\t\t<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>\n\t\t\t\t  </tr>\n\t\t\t\t  <tr>\n\t\t\t\t\t<td class=label >";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;<input name=\"prepare_qty\" id=\"prepare_qty\" onkeypress=\"return isValidNumber(this,event,";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 =",0);\" class=\"NUMBER\" maxLength=\"";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 ="\" size=\"";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 ="\" value=\"";
    private final static byte[]  _wl_block31Bytes = _getBytes( _wl_block31 );

    private final static java.lang.String  _wl_block32 ="\" onFocus = \"return validateGroupCode();\" onBlur=\"calculateTotalCost();\">&nbsp;<IMG src=\"../../eCommon/images/mandatory.gif\" align=center></td>\n\t\t\t\t\t<td class=label >";
    private final static byte[]  _wl_block32Bytes = _getBytes( _wl_block32 );

    private final static java.lang.String  _wl_block33 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;<input class=\"NUMBER\" maxLength=15 size=15 name=\"total_cost\" id=\"total_cost\" readOnly value=\"";
    ...
    private final static java.lang.String  _wl_block43 ="\">\n\t\t\t<input type=\"hidden\" name=\"SQL_SS_PREPARE_GROUP_LOOKUP\" id=\"SQL_SS_PREPARE_GROUP_LOOKUP\"\t\tvalue=\"";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
            ...
            _bw.write(_wl_block1Bytes, _wl_block1);
            _bw.write(_wl_block2Bytes, _wl_block2);
            eSS.PrepareGroupBean aaa= null;{
                aaa=(eSS.PrepareGroupBean)pageContext.getAttribute("aaa");
                if(aaa==null){
                    aaa=new eSS.PrepareGroupBean();
	...
	bean.setLanguageId(locale);
            ...
            out.print( String.valueOf(bean.getBin_location_code()));
            _bw.write(_wl_block9Bytes, _wl_block9);

            if (_jsp__tag0(request, response, pageContext, _activeTag, null))
             return;
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(editMode?disabled:""));
            ...
            out.print( String.valueOf(bean.checkForNull(bean.getDoc_ref())));
            ...
            out.print( String.valueOf(bean.getGroup_desc()));
            _bw.write(_wl_block24Bytes, _wl_block24);
            out.print( String.valueOf(readonly));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf(disabled_mod));
            ...
            out.print( String.valueOf(bean.getPrepare_qty()));
            _bw.write(_wl_block32Bytes, _wl_block32);

            if (_jsp__tag8(request, response, pageContext, _activeTag, null))
             return;
            _bw.write(_wl_block33Bytes, _wl_block33);
            out.print( String.valueOf(bean.getTotal_cost()));
            _bw.write(_wl_block34Bytes, _wl_block34);

            if (_jsp__tag9(request, response, pageContext, _activeTag, null))
             return;
            _bw.write(_wl_block35Bytes, _wl_block35);
            out.print( String.valueOf(bean.getSsRepositoryValue("DEFAULT_LIST_OPTION")));
            _bw.write(_wl_block36Bytes, _wl_block36);
            out.print( String.valueOf(bean.getLoginFacilityId() ));
            _bw.write(_wl_block37Bytes, _wl_block37);
            out.print( String.valueOf(bean.getGroup_code()));
            ...
            out.print( String.valueOf( eSS.Common.SsRepository.getSsKeyValue("SQL_SS_PREPARE_GROUP_LOOKUP")));
	...
	try{
            ...
            out.print( String.valueOf((String)hmRequestGroupSubFunc.get("SUBFUNCTION_ID")));
            _bw.write(_wl_block46Bytes, _wl_block46);
            out.print( String.valueOf((String)hmRequestGroupSubFunc.get("SUBFUNCTION_ID")));
            _bw.write(_wl_block47Bytes, _wl_block47);
            out.print( String.valueOf((String)hmRequestGroupSubFunc.get("INCL_YN")));
...
putObjectInBean(bean_id,bean,request);
    ...
    private boolean _jsp__tag5(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag5.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.Group.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag8(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag8.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.TotalValue.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag9(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag9.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.BinLocation.label", java.lang.String .class,"key"));
