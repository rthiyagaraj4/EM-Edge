...
public final class __receiptaddmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ReceiptAddModify.jsp", 1739791845317L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="</td>\n\t\t\t\t<td >&nbsp;&nbsp;<input type=\'text\' name=\"rof_doc_no\" id=\"rof_doc_no\"  class=\"NUMBER\" maxLength=\'8\' size=\'8\' onKeyPress=\"return isValidInteger();\" onBlur=\"return checkIntegerFormat(this);\" value=\'";
    ...
    private final static java.lang.String  _wl_block19 ="</td>\n\t\t\t\t<td class=\"label\">&nbsp;&nbsp;<input type=\'text\' name=\"doc_date\" id=\"doc_date\"  maxLength=\'10\' size=\'10\'   onBlur=\"return checkValDate(doc_date);\" value=\'";
    ...
    private final static java.lang.String  _wl_block29 =" onClick=\"searchRofDtls();\"  name=\"Alternategroup_search\">\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t\t</table>\n\t\t\t<input type=\'hidden\' name=\"sysdate\" id=\"sysdate\"\t\t\t\tvalue=\"";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		String sStyle =(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
            ...
            eSS.ReceiptBean bean= null;{
                bean=(eSS.ReceiptBean)pageContext.getAttribute("bean");
                if(bean==null){
                    bean=new eSS.ReceiptBean();
