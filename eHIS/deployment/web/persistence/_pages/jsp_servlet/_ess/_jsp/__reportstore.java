...
public final class __reportstore extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ReportStore.jsp", 1734899388730L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//		String p_report_id = null;
	...
	//	ReportsMasterCodeBean bean = (ReportsMasterCodeBean) mh.getBeanObject( bean_id, request,  bean_name);
		...
		bean.clear();
            ...
            out.print( String.valueOf(bean.getStoreType()));
            _bw.write(_wl_block20Bytes, _wl_block20);

            if (_jsp__tag7(request, response, pageContext, _activeTag, null))
             return;
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(bean.getOrderByStore()));
            _bw.write(_wl_block20Bytes, _wl_block20);
            ...
            out.print( String.valueOf( eSS.Common.SsRepository.getSsKeyValue("SQL_SS_DEPT_FACILITY_LOOKUP")));
    ...
    private boolean _jsp__tag6(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag6.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.StoreType.label", java.lang.String .class,"key"));
