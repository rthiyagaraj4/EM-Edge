...
public final class __washertosiandsonichecklogcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/WasherTosiAndSoniCheckLogCriteria.jsp", 1741326145934L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\"/></td>\n\t\t\t\t\t\n\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\" class=\"label\" nowrap><fmt:message key=\"Common.DocumentDate.label\" bundle=\"";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\"/></td>\n\t\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input maxLength=10 size=10 name=\"p_fm_date1\" id=\"p_fm_date1\" value=\"";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\" type=text class=\"DATE\" onBlur=\"CheckDate(this,\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\');\">&nbsp;<img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'p_fm_date1\');\">";
    ...
    private final static java.lang.String  _wl_block23 ="\">\n            \n            \n\t\t\t<input type=\"hidden\" name=\"SQL_SS_AUTO_WASH_UNIT_LOOK_WASHTYPE\" id=\"SQL_SS_AUTO_WASH_UNIT_LOOK_WASHTYPE\" value=\"";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\"> \n\t\t\t<input type=\"hidden\" name=\"SQL_SS_AUTO_WASH_UNIT_LOOK_TESTTYPE\" id=\"SQL_SS_AUTO_WASH_UNIT_LOOK_TESTTYPE\" value=\"";
...
//		ReportsMasterCodeBean bean		= (ReportsMasterCodeBean) mh.getBeanObject( bean_id, request,  bean_name);
		...
		bean.setLanguageId(locale);
            ...
            out.print( String.valueOf( eSS.Common.SsRepository.getSsKeyValue("SQL_SS_AUTO_WASH_UNIT_LOOK_WASHTYPE")));
            _bw.write(_wl_block24Bytes, _wl_block24);
            out.print( String.valueOf( eSS.Common.SsRepository.getSsKeyValue("SQL_SS_AUTO_WASH_UNIT_LOOK_TESTTYPE")));
