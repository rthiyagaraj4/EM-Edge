...
public final class __servicelocationaddmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ServiceLocationAddModify.jsp", 1733735910713L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	String sStyle = (session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
            ...
            eSS.ServiceLocationBean bean= null;{
                bean=(eSS.ServiceLocationBean)pageContext.getAttribute("bean");
                if(bean==null){
                    bean=new eSS.ServiceLocationBean();
