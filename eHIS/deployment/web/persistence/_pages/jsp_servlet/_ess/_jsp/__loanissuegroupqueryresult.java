...
public final class __loanissuegroupqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/LoanIssueGroupQueryResult.jsp", 1709121815649L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		try{
			...
			sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_ISSUE_HDR_QUERY_RESULT"));
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/LoanIssueGroupQueryResult.jsp", searched) );
	}
	catch(Exception e) {
