...
public final class __phyinventrytrayquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/PhyInvEntryTrayQueryCriteria.jsp", 1709121837602L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block24 ="\">\n\t\t\t<input type=\"hidden\" name=\"current_store_code\" id=\"current_store_code\" value=\"";
	...
	String sStyle =(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		if(store_code!=null){
            ...
            out.print( String.valueOf(bean.getStore_codes()));
            ...
            out.print( String.valueOf(current_store_code));
