...
public final class __collectionanddeliveryrecordcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/CollectionAndDeliveryRecordCriteria.jsp", 1727685144051L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t<body onLoad=\"FocusFirstElement();\"onMouseDown=\'CodeArrest();\'>\n\t\t<form name=\"formCollectionAndDeliveryRecord\" id=\"formCollectionAndDeliveryRecord\" action=\"../../eCommon/jsp/report_options.jsp\"  target=\"messageFrame\" >\n\t\t<br><br>\n\t\t<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\'100%\' align=\'center\' >\n\t\t\t<tr>\n\t\t\t<td width=\'100%\' align=\'center\' class=\"WHITE\">\n\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" width=\"80%\" align=\"center\" border=\"0\">\t\n\t\t\t\t<th align=\"left\" colspan=\"4\">";
    ...
    private final static java.lang.String  _wl_block13 ="</td>\n\t\t\t\t\t\t<td class=label> &nbsp; <input maxLength=10 size=12 name=\"p_fm_date\" id=\"p_fm_date\" value=\"";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\" type=text class=\"DATE\" onBlur=\"CheckDate(this,\'";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\');\"> <img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'p_fm_date\');\">";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="</img></td>\n\t\t\t\t\t<td class=\"label\"> </td>\n\t\t\t\t\t\t<td class=label> &nbsp; <input maxLength=10 size=12 name=\"p_to_date\" id=\"p_to_date\" value=\"";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\');\"> <img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'p_to_date\');\">";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="</img></td>\n\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\'label\' align=\'right\'>";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input onBlur=\"checkSpecialChars(this);\" class=\'UPPER\' type=\'text\' maxLength=\'10\' size=\'12\' name=\"p_fm_group_code\" id=\"p_fm_group_code\"><input type=\'button\' class=\'BUTTON\' value=\"?\" onClick=\"searchGroup(p_fm_group_code)\"></td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input onBlur=\"checkSpecialChars(this);\" class=\'UPPER\' type=\'text\' maxLength=\'10\' size=\'12\' name=\"p_to_group_code\" id=\"p_to_group_code\"><input type=\'button\' class=\'BUTTON\' value=\"?\" onClick=\"searchGroup(p_to_group_code)\"></td>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td  class=\"label\" align=\"right\">";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input maxLength=10 size=12          name=\"p_fm_store_code\" id=\"p_fm_store_code\" value=\"\" ><input class=\"button\" onClick=\"return searchCodeStore(p_fm_store_code);\" type=\"button\" value=\"?\">\n\t\t\t\t\t</td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input maxLength=10 size=12 name=\"p_to_store_code\" id=\"p_to_store_code\" value=\"\"    ><input class=\"button\" onClick=\"return searchCodeStore(p_to_store_code);\" type=\"button\" value=\"?\"></td>\n                    \n\n\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\t</td>\n\t\t\t</tr>\n\t\t\t</table>\n\t\t\t<input type=\"hidden\" name=\"bean_id\" id=\"bean_id\"\t\t\t\t\t\t\t\t\tvalue=\"";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\">\n\t\t\t<input type=\"hidden\" name=\"bean_name\" id=\"bean_name\"\t\t\t\t\t\t\t\tvalue=\"";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\">\n\t\t\t<input type=\"hidden\" name=\"p_module_id\" id=\"p_module_id\" \t\t\t\t\t\t\tvalue=\"SS\">\n\t\t\t\n\t\t\t<input type=\"hidden\" name=\"p_report_id\" id=\"p_report_id\" \t\t\t\t\t\t\tvalue=\"SSCOLLANDDEL\">\n\t\t\t<input type=\"hidden\" name=\"p_user_name\" id=\"p_user_name\"\t\t\t\t\t\t\t\tvalue=\"";
...
//		ReportsMasterCodeBean bean		= (ReportsMasterCodeBean) getBeanObject( bean_id, bean_name, request);
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.SterileGroup.label", java.lang.String .class,"key"));
