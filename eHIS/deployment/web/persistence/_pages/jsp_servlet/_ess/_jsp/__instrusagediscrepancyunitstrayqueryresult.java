...
public final class __instrusagediscrepancyunitstrayqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/InstrUsageDiscrepancyUnitsTrayQueryResult.jsp", 1709121803946L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block15 ="\" onmouseover=\"changeCursor(this);\" align=\"right\" ><font class=\'HYPERLINK\'>";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="</font></td>\n\t\t";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\" onclick=\"disableClick(event);\" align=\"";
	...
	try{
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_TRAY_DTLS_INSTR_DISCREPANCY_TRAY_SELECT_DETAIL") );
		...
		System.out.println(store_code+group_code+tray_no+bin_location_code+expiry_date+CommonBean.getLoginById());
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/InstrUsageDiscrepancyUnitsTrayQueryResult.jsp", searched) );
	}
	catch(Exception e) {
