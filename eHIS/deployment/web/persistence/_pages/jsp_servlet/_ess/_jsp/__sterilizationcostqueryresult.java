...
public final class __sterilizationcostqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/SterilizationCostQueryResult.jsp", 1709121882570L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String locale = (String)session.getAttribute("LOCALE");
	...
	String sterile_type		= request.getParameter("sterile_type");
	String sterile_type_desc= request.getParameter("sterile_type_desc");
	...
	try{
		...
		sterile_type	 = CommonBean.checkForNull(sterile_type		)+"%";
		sterile_type_desc= CommonBean.checkForNull(sterile_type_desc)+"%";

		HashMap sqlMap = new HashMap();
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_STERILIZATION_COST_QUERY_RESULT") );
		...
		displayFields.add("sterile_type");
		displayFields.add("sterile_type_desc");
		displayFields.add("sterile_cost");

		//The fields are going to be in where condition * should match with the query
		ArrayList chkFields = new ArrayList();
		chkFields.add(group_code);
		chkFields.add(group_desc);
		chkFields.add(sterile_type);
		chkFields.add(sterile_type_desc);
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/SterilizationCostQueryResult.jsp", searched) );
	}
	catch(Exception e) {
// 		out.print("Exception @ Result JSP :"+e.toString());
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.SterilizationTypeDescription.label", java.lang.String .class,"key"));
