...
public final class __reportsurgerytype extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ReportSurgeryType.jsp", 1734899054554L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\n\t<body onLoad=\"FocusFirstElement();\" onMouseDown=\'CodeArrest();\'>\n\t\t<form name=\"formReportSurgeryType\" id=\"formReportSurgeryType\" action=\"../../eCommon/jsp/report_options.jsp\" target=\"messageFrame\" >\n\t\t<br><br>\n\t\t<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\'100%\' align=\'center\' >\n\t\t\t<tr>\n\t\t\t<td width=\'100%\' align=\'center\' class=\"WHITE\">\n\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" width=\"70%\" align=\"center\" border=\"0\">\n\t\t\t\t<th colspan=4 align=left>";
    ...
    private final static java.lang.String  _wl_block15 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input maxLength=8 size=8 name=\"p_from_code\" id=\"p_from_code\" value=\"\"  ><input class=\"button\" onClick=\"return searchCodeSurgeryType(p_from_code);\" type=\"button\" value=\"?\"></td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input maxLength=8 size=8 name=\"p_to_code\" id=\"p_to_code\" value=\"\"  ><input class=\"button\" onClick=\"return searchCodeSurgeryType(p_to_code);\" type=\"button\" value=\"?\"></td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\" class=\"label\" >";
...
//		ReportsMasterCodeBean bean = (ReportsMasterCodeBean) mh.getBeanObject( bean_id, request,  bean_name);
		...
		bean.clear();
            ...
            out.print( String.valueOf(bean.getOrderBySurgeryType()));
