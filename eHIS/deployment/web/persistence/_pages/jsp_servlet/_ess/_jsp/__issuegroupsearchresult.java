...
public final class __issuegroupsearchresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/IssueGroupSearchResult.jsp", 1709121807493L ,"10.3.6.0","Asia/Calcutta")) return true;
...
if(surg_nature_link_to_OT_yn.equals("Y")){ 
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/IssueGroupSearchResult.jsp", searched) );
		} catch(Exception e) {
