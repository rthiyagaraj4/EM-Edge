...
public final class __sstransactionremarksvalidate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/SsTransactionRemarksValidate.jsp", 1732511043744L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {;
            ...
            _bw.write(_wl_block0Bytes, _wl_block0);
            java.util.ArrayList alSelectedRemarks= null;synchronized(session){
                alSelectedRemarks=(java.util.ArrayList)pageContext.getAttribute("alSelectedRemarks",javax.servlet.jsp.PageContext.SESSION_SCOPE);
                if(alSelectedRemarks==null){
                    alSelectedRemarks=new java.util.ArrayList();
                    pageContext.setAttribute("alSelectedRemarks",alSelectedRemarks,javax.servlet.jsp.PageContext.SESSION_SCOPE);
