...
import java.lang.*;
import java.util.*;
import eSS.AutoclavingBean;

public final class __logsheetfortestperformedcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/LogSheetForTestPerformedCriteria.jsp", 1741326124977L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block6 ="\"/></th>\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\n\t\t\t\t<tr>\n\t\t        \t  \t\n\t\t        \t  \n\t\t        \t <td  class=\"label\"><fmt:message key=\"eSS.AutoclaveUnit.label\" bundle=\"";
    ...
    private final static java.lang.String  _wl_block9 ="</td>\n\t\t\t\t\t\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t        \t  \t\n\t\t        \t  <td  class=\"label\"><fmt:message key=\"eSS.AutoclaveTest.label\" bundle=\"";
    ...
    private final static java.lang.String  _wl_block14 ="\"/></td>\n\t\t\t\t\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\" class=\"label\" nowrap><fmt:message key=\"eSS.TestDate.label\" bundle=\"";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\"/></td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input maxLength=10 size=10 name=\"p_fm_date1\" id=\"p_fm_date1\" value=\"";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\" type=text class=\"DATE\" onBlur=\"CheckDate(this,\'";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\');\">&nbsp;<img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'p_fm_date1\');\">";
    ...
    private final static java.lang.String  _wl_block19 ="\" class=\"DATE\" type=text onBlur=\"CheckDate(this,\'";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="\');\">&nbsp;<img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'p_to_date1\');\">";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="</img></td>\n\t\t\t\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\t</td>\n\t\t\t</tr>\n\t\t\t</table>\n\t\t\t<input type=\"hidden\" name=\"bean_id\" id=\"bean_id\"\t\t\t\t\t\t\t\t\tvalue=\"";
	...
	String locale= (String)session.getAttribute("LOCALE");
		...
		bean.setLanguageId(locale);
            ...
            out.print( String.valueOf(bean.getAutoclave_wash_unit_code_List1()));
            ...
            out.print( String.valueOf(bean.getTest_code_List()));
