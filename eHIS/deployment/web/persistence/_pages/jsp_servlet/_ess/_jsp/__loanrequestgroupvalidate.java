...
public final class __loanrequestgroupvalidate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/LoanRequestGroupValidate.jsp", 1729860185964L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {;
            ...
            java.util.ArrayList alLoanRequestGroupList= null;synchronized(session){
                alLoanRequestGroupList=(java.util.ArrayList)pageContext.getAttribute("alLoanRequestGroupList",javax.servlet.jsp.PageContext.SESSION_SCOPE);
                if(alLoanRequestGroupList==null){
                    alLoanRequestGroupList=new java.util.ArrayList();
                    pageContext.setAttribute("alLoanRequestGroupList",alLoanRequestGroupList,javax.servlet.jsp.PageContext.SESSION_SCOPE);
