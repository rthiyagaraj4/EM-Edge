...
public final class __autoclavingqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/AutoclavingQueryResult.jsp", 1709121776243L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block22 ="\" onclick=\"disableClick(event);\" align=\"";
	...
	String load_no					=	request.getParameter("load_no");
	String autoclave_date			=	request.getParameter("autoclave_date");
	...
	try{
		...
		load_no						=	CommonBean.checkForNull(load_no,"%"			);
		autoclave_date				=	CommonBean.checkForNull(autoclave_date,"");
		if(!(locale.equals("en")))
		{
					 autoclave_date=com.ehis.util.DateUtils.convertDate(autoclave_date,"DMY",locale,"en");
		}
		store_code					=	CommonBean.checkForNull(store_code,"%"	);

		HashMap sqlMap				=	 new HashMap();
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_AUTOCLAVE_HDR_QUERY_RESULT") );
		...
		displayFields.add("load_no");
		displayFields.add("autoclave_date");
		...
		chkFields.add(load_no			);
		chkFields.add(autoclave_date			);
		...
		if((result.size()>=3) && (!(((String) result.get(0)).equals("0")))){
            ...
            out.print( String.valueOf((colCount==1)?"right":(((colCount==2)||(colCount==4))?"center":"")));
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/AutoclavingQueryResult.jsp", searched) );
	}
	catch(Exception e) {
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.LoadNo.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.AutoclavingDate.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.EntryCompleted.label", java.lang.String .class,"key"));
