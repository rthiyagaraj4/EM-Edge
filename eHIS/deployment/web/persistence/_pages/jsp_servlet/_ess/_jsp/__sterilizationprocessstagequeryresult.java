...
public final class __sterilizationprocessstagequeryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/SterilizationProcessStageQueryResult.jsp", 1709121884852L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="<td class=\"";
	...
	String process_stage_code = request.getParameter("process_stage_code");
	...
	try{
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_STER_PROCESS_STAGE_QUERY_RESULT"));
		HashMap funcMap = new HashMap();

		//The fields are going to be display
		ArrayList displayFields = new ArrayList();

		displayFields.add("process_stage_code");
		displayFields.add("long_desc");
		displayFields.add("short_desc");
		displayFields.add("eff_status");
		displayFields.add("sys_usr_def_ind");
            ...
            _bw.write(_wl_block13Bytes, _wl_block13);
				...
				for(int colCount=0; colCount<records.size(); colCount++){
					if( link_columns.indexOf(String.valueOf(colCount+1)) != -1 ){
						...
						if(records.get(4).equals("User Defined")){
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/SterilizationProcessStageQueryResult.jsp", searched) );
	}
	catch(Exception e) {
// 		out.print("Exception @ Result JSP :"+e.toString());
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.CodeType.label", java.lang.String .class,"key"));
