...
public final class __loanissuegrouptrayqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/LoanIssueGroupTrayQueryResult.jsp", 1709121817008L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block18 ="\" onmouseover=\"changeCursor(this);\" align=\"right\" ><font class=\'HYPERLINK\'>";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		String owner_store_code			=		 request.getParameter("store_code1");
		String bin_location_code		=		"";
		String expiry_date				=		request.getParameter("expiry_date");
		String mode					=		request.getParameter("mode");
		System.out.println("mode in tray search result"+mode);
	...
	try{
		...
		if((!(locale.equals("en")))&&(!(expiry_date.equals("%"))))
		{
					 expiry_date		=		com.ehis.util.DateUtils.convertDate(expiry_date,"DMY",locale,"en");
								 
		}
		String sql = eSS.Common.SsRepository.getSsKeyValue("SQL_SS_TRAY_DTLS_QUERY_RESULT_FOR_ISSUE");
		/*if(mode.equals( eCommon.Common.CommonRepository.getCommonKeyValue("MODE_MODIFY") )) {
			sql = sql+"AND TD.BLOCKED_BY IS NULL";//Added the already issued tray not to come for re-issue
			}*/
		...
		if((result.size()>=3) && (!(((String) result.get(0)).equals("0")))){
            ...
            _bw.write(_wl_block14Bytes, _wl_block14);
				...
				String exp_date_disp	=	(String)records.get(4);
            ...
            out.print( String.valueOf(exp_date_disp));
            ...
            out.print( String.valueOf((colCount==4)?"center":"left"));
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/LoanIssueGroupTrayQueryResult.jsp", searched) );
	}
	catch(Exception e) {
