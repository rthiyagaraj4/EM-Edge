...
public final class __returninstrumentsqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ReturnInstrumentsQueryResult.jsp", 1709121865070L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block21 ="\" onclick=\"disableClick(event);\" align=\"";
	...
	try{
		...
		rec_store_code			=		CommonBean.checkForNull(rec_store_code,"%"	);
		ret_store_code			=		CommonBean.checkForNull(ret_store_code,"%"	);
		patient_id				=		CommonBean.checkForNull(patient_id,"%"	);

		HashMap sqlMap			=		new HashMap();
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_RET_ITEM_HDR_QUERY_RESULT") );
		...
		chkFields.add(rec_store_code	);
		chkFields.add(ret_store_code	);
		...
		if((result.size()>=3) && (!(((String) result.get(0)).equals("0")))){
            ...
            out.print( String.valueOf((colCount==1)?"right":(((colCount==2)||(colCount==5))?"center":"")));
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/ReturnInstrumentsQueryResult.jsp", searched) );
	}
	catch(Exception e) {
