...
public final class __verifysignreportscriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/VerifySignReportsCriteria.jsp", 1709116422901L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\n\t\t\t\t\t</td>\n\t\t\t\t\t<td class=\'label\' width=\'15%\'>\n\t\t\t\t\t\t<input type=\'textbox\' id=\'fromDt\' name=\'fromDt\' id=\'fromDt\' value=\'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\' size=10 maxlength=10 onblur=\'CheckWithSysDate(this);\'></input><input type=\'image\' src=\"../../eCommon/images/CommonCalendar.gif\" onclick=\"return showCalendarValidate(\'fromDt\')\"><img src=\'../../eCommon/images/mandatory.gif\'></img>\n\t\t\t\t\t</td>\n\t\t\t\t\t<td width=\'25%\'>\n\t\t\t\t\t<input type=\'textbox\' id=\'toDt\' name=\'toDt\' id=\'toDt\' value=\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' size=10 maxlength=10 onblur=\'CheckWithSysDate(this);\'></input><input type=\'image\' src=\"../../eCommon/images/CommonCalendar.gif\" onclick=\"return showCalendarValidate(\'toDt\')\"></input><img src=\'../../eCommon/images/mandatory.gif\'></img>\n\t\t\t\t\t</td>\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\'label\' width=\'25%\'>\n\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block14 ="\' onClick=\"searchForDetails()\">\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\n\t\t\t\t<!-- added by kishore kumar n on 27/11/2009  -->\n\t\t\t\t";
