...
public final class __patproblemdialoglongdesc extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/PatProblemDialogLongDesc.jsp", 1709116011404L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="</textarea><br>\n\t\t\t\t\t<input type=\"button\" name=\"closeWindow\" id=\"closeWindow\" class=\"button\" onclick=\"javascript:window.close();\" value=\'";
