...
public final class __clinicaleventgrouprelinksearchresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ClinicalEventGroupRelinkSearchResult.jsp", 1709115738386L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\" onClick=\"Reassaignrelink(this);chkunchkrelink(this)\" value=\"";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
            ...
            _bw.write(_wl_block1Bytes, _wl_block1);
            webbeans.eCommon.RecordSet RelinkBean= null;synchronized(session){
                RelinkBean=(webbeans.eCommon.RecordSet)pageContext.getAttribute("RelinkBean",javax.servlet.jsp.PageContext.SESSION_SCOPE);
                if(RelinkBean==null){
                    RelinkBean=new webbeans.eCommon.RecordSet();
                    pageContext.setAttribute("RelinkBean",RelinkBean,javax.servlet.jsp.PageContext.SESSION_SCOPE);
	...
	//out.println("<script>alert('rs.next()="+rs.next()+"')</script>");
	 ...
	 while(rs!=null && rs.next() && i<=end)
		...
		for(int m=0;m<RelinkBean.getSize();m+=2)
            ...
            out.print( String.valueOf(description));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf(eventgrouptype));
...
{
	e.printStackTrace();
	//out.println("Exception cauight in ClinicalEventGroupRelinkSearchResult.jsp" + e);//COMMON-ICN-0181
}
finally 
{
