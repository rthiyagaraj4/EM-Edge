...
public final class __patencbannerintermediate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/PatEncBannerIntermediate.jsp", 1709115213577L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block5 ="\t\t\n\t\t<script>\n\t\t\tparent.patEncBannerDetailsFrame.location.href = \'../../eCA/jsp/PatEncBannerDetails.jsp?loadFirstTime=No&oldDispLine=";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="&bannerCateg=";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="&bannerRef=";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\';\n\t\t</script>\n";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\n\t\t<script>\n\t\t\tparent.patEncBannerDetailsFrame.location.href = \'../../eCA/jsp/PatEncBannerDetails.jsp?loadFirstTime=No&bannerRef=";
