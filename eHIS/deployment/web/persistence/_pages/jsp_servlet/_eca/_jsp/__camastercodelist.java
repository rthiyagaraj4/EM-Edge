...
public final class __camastercodelist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CAMasterCodeList.jsp", 1719556167204L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	source.append(params) ;
            ...
            out.print( String.valueOf( url+source.toString() ));
