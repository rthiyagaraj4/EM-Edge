...
public final class __practspecialitysearch extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/PractSpecialitySearch.jsp", 1709116061028L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\' class=\"button\" onClick=\"getValue()\">\n\t\t\t\t</td>\n\t\t</tr>\n\t\t</table>\n\t\t\t<!-- added by kishore kumar n on 08/12/2009  -->\n\t\t\t";
