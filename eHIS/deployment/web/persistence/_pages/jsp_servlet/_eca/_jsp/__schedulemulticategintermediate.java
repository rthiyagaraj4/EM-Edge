...
public final class __schedulemulticategintermediate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ScheduleMultiCategIntermediate.jsp", 1709116272417L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//	String locale = (String) p.getProperty("LOCALE");
	...
	//	out.println("alert('Val'+top.content.workAreaFrame.frames[0].document.forms[0].allow_multiple_yn.value);");
		...
		if(pstmt!=null)pstmt.close();
            ...
            out.print( String.valueOf(multi_sch_yn));
