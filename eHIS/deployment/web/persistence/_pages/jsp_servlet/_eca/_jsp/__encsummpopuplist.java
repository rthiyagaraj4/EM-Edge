...
public final class __encsummpopuplist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/EncSummPopUpList.jsp", 1709115862747L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block21 =" </a> </td>\n\t\t\t\t\t\t\t\t -->\n\t\t\t\t\t\t\t\t<td class=\'gridData\'> <a href=\"javascript:setEncounterValue(\'";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\'); javascript:checkForSummary(this);\">";
    ...
    private final static java.lang.String  _wl_block25 =" </td>\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t<td class=\'gridData\'   align=\'center\'> \n\t\t\t\t\t\t\t\t\t<input type=\'radio\' name=\'encSel\' id=\'encSel\' onclick=\"setEncounterValue(\'";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.PreviousEncounters.label", java.lang.String .class,"key"));
