...
public final class __chartsummarycareflowsheet extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ChartSummaryCareFlowsheet.jsp", 1743490885659L ,"10.3.6.0","Asia/Calcutta")) return true;
...
/*else{
	...
	//IN065341 ends		
		...
		//query_current_medications.append(" select EVENT_DATE dummydate,(SELECT SHORT_DESC FROM CR_EVENT_CLASS_LANG_VW WHERE hist_rec_type  = a.hist_rec_type and event_class = a.event_class and language_id = ?) event_class,(SELECT short_desc FROM CR_CLN_EVT_MST_LANG_VW WHERE hist_rec_type  = a.hist_rec_type and event_code = a.event_code AND   EVENT_CODE_TYPE =a.EVENT_CODE_TYPE and language_id = ?) event_desc,(SELECT short_desc FROM CR_CLN_EVT_GRP_LANG_VW WHERE hist_rec_type(+)=A.hist_rec_type AND  event_group(+)=A.event_group and EVENT_GROUP_TYPE(+)=a.EVENT_GROUP_TYPE and language_id(+) = ?) event_group_desc, to_char(EVENT_DATE, 'dd/mm/yyyy hh24:mi') event_date, RESULT_NUM,  nvl(RESULT_NUM_PREFIX,'')||nvl(RESULT_NUM,'')||nvl(RESULT_STR,'')||' '||nvl(RESULT_NUM_UOM,'') care_flow_detail, NORMAL_LOW, NORMAL_HIGH, a.EXT_IMAGE_APPL_ID,a.EXT_IMAGE_OBJ_ID,a.CONTR_SYS_ID,a.ACCESSION_NUM,a.CONTR_SYS_EVENT_CODE,NVL((SELECT 'Y' FROM CR_ENCOUNTER_DETAIL_TXT WHERE HIST_REC_TYPE  = A.hist_rec_type AND CONTR_SYS_ID=A.contr_sys_id AND ACCESSION_NUM = a.accession_num	AND CONTR_SYS_EVENT_CODE = A.contr_sys_event_code and dbms_lob.getlength(hist_data)>0) ,'N') text_exisits, a.normalcy_ind, (SELECT DECODE(a.normalcy_ind,HIGH_STR,high_color_code,LOW_STR,low_color_code,CRIT_STR,crit_color_code,ABN_STR,abn_color_code,CRIT_HIGH_STR,crit_high_color_code,CRIT_LOW_STR  ,crit_low_color_code,'NONE')FROM CR_CLIN_EVENT_PARAM) COLOR_CELL_IND,(SELECT DECODE(a.normalcy_ind,HIGH_STR,high_str_desc,LOW_STR,low_str_desc,CRIT_STR,crit_str_desc,ABN_STR,abn_str_desc,CRIT_HIGH_STR,crit_high_str_desc,CRIT_LOW_STR  ,crit_low_str_desc) DESC_CELL_IND FROM CR_CLIN_EVENT_PARAM) DESC_CELL_IND, (select DECODE(a.normalcy_ind,HIGH_STR,HIGH_SYMBOL_ICON,LOW_STR,LOW_SYMBOL_ICON,CRIT_STR,CRIT_SYMBOL_ICON,ABN_STR,ABN_SYMBOL_ICON,CRIT_HIGH_STR,CRIT_HIGH_SYMBOL_ICON,CRIT_LOW_STR,CRIT_LOW_SYMBOL_ICON,'NONE') FROM CR_CLIN_EVENT_PARAM)  normal_range_symbol, a.hist_data_type, a.NORMALCY_STR, a.encounter_ID, a.FACILITY_ID  from cr_encounter_detail a where a.hist_rec_type = 'PTCR' and patient_id = ? and (FACILITY_ID,ENCOUNTER_ID) in (select FACILITY_ID,ENCOUNTER_ID from (select FACILITY_ID,ENCOUNTER_ID, ROW_NUMBER() OVER (ORDER BY VISIT_ADM_DATE_TIME DESC) RANK_NO  from  PR_ENCOUNTER where patient_id= ? ) where RANK_NO	< 5	) AND A.HIST_REC_TYPE='PTCR'" );commented for IN065341
		//IN069978 starts
		//query_current_medications.append(" select EVENT_DATE dummydate,(SELECT SHORT_DESC FROM CR_EVENT_CLASS_LANG_VW ##REPDB## WHERE hist_rec_type  = a.hist_rec_type and event_class = a.event_class and language_id = ?) event_class,(SELECT short_desc FROM CR_CLN_EVT_MST_LANG_VW ##REPDB## WHERE hist_rec_type  = a.hist_rec_type and event_code = a.event_code AND   EVENT_CODE_TYPE =a.EVENT_CODE_TYPE and language_id = ?) event_desc,(SELECT short_desc FROM CR_CLN_EVT_GRP_LANG_VW ##REPDB## WHERE hist_rec_type(+)=A.hist_rec_type AND  event_group(+)=A.event_group and EVENT_GROUP_TYPE(+)=a.EVENT_GROUP_TYPE and language_id(+) = ?) event_group_desc, to_char(EVENT_DATE, 'dd/mm/yyyy hh24:mi') event_date, RESULT_NUM,  nvl(RESULT_NUM_PREFIX,'')||nvl(RESULT_NUM,'')||nvl(RESULT_STR,'')||' '||nvl(RESULT_NUM_UOM,'') care_flow_detail, NORMAL_LOW, NORMAL_HIGH, a.EXT_IMAGE_APPL_ID,a.EXT_IMAGE_OBJ_ID,a.CONTR_SYS_ID,a.ACCESSION_NUM,a.CONTR_SYS_EVENT_CODE,NVL((SELECT 'Y' FROM CR_ENCOUNTER_DETAIL_TXT##CLOB## WHERE HIST_REC_TYPE  = A.hist_rec_type AND CONTR_SYS_ID=A.contr_sys_id AND ACCESSION_NUM = a.accession_num	AND CONTR_SYS_EVENT_CODE = A.contr_sys_event_code and dbms_lob.getlength(hist_data)>0) ,'N') text_exisits, a.normalcy_ind, (SELECT DECODE(a.normalcy_ind,HIGH_STR,high_color_code,LOW_STR,low_color_code,CRIT_STR,crit_color_code,ABN_STR,abn_color_code,CRIT_HIGH_STR,crit_high_color_code,CRIT_LOW_STR  ,crit_low_color_code,'NONE')FROM CR_CLIN_EVENT_PARAM ##REPDB##) COLOR_CELL_IND,(SELECT DECODE(a.normalcy_ind,HIGH_STR,high_str_desc,LOW_STR,low_str_desc,CRIT_STR,crit_str_desc,ABN_STR,abn_str_desc,CRIT_HIGH_STR,crit_high_str_desc,CRIT_LOW_STR  ,crit_low_str_desc) DESC_CELL_IND FROM CR_CLIN_EVENT_PARAM ##REPDB##) DESC_CELL_IND, (select DECODE(a.normalcy_ind,HIGH_STR,HIGH_SYMBOL_ICON,LOW_STR,LOW_SYMBOL_ICON,CRIT_STR,CRIT_SYMBOL_ICON,ABN_STR,ABN_SYMBOL_ICON,CRIT_HIGH_STR,CRIT_HIGH_SYMBOL_ICON,CRIT_LOW_STR,CRIT_LOW_SYMBOL_ICON,'NONE') FROM CR_CLIN_EVENT_PARAM ##REPDB##)  normal_range_symbol, a.hist_data_type, a.NORMALCY_STR, a.encounter_ID, a.FACILITY_ID  from cr_encounter_detail ##REPDB## a where a.hist_rec_type = 'PTCR' and patient_id = ? and (FACILITY_ID,ENCOUNTER_ID) in (select FACILITY_ID,ENCOUNTER_ID from (select FACILITY_ID,ENCOUNTER_ID, ROW_NUMBER() OVER (ORDER BY VISIT_ADM_DATE_TIME DESC) RANK_NO  from  PR_ENCOUNTER ##REPDB## where patient_id= ? ) where RANK_NO	< 5	) AND A.HIST_REC_TYPE='PTCR'" );//IN065341
		//6484 Start.
		//query_current_medications.append(" select EVENT_DATE dummydate,(SELECT SHORT_DESC FROM CR_EVENT_CLASS_LANG_VW ##REPDB## WHERE hist_rec_type  = a.hist_rec_type and event_class = a.event_class and language_id = ?) event_class,(SELECT short_desc FROM CR_CLN_EVT_MST_LANG_VW ##REPDB## WHERE hist_rec_type  = a.hist_rec_type and event_code = a.event_code AND   EVENT_CODE_TYPE =a.EVENT_CODE_TYPE and language_id = ?) event_desc,(SELECT short_desc FROM CR_CLN_EVT_GRP_LANG_VW ##REPDB## WHERE hist_rec_type(+)=A.hist_rec_type AND  event_group(+)=A.event_group and EVENT_GROUP_TYPE(+)=a.EVENT_GROUP_TYPE and language_id(+) = ?) event_group_desc, to_char(EVENT_DATE, 'dd/mm/yyyy hh24:mi') event_date, RESULT_NUM,  nvl(RESULT_NUM_PREFIX,'')||nvl(RESULT_NUM,'')||nvl(RESULT_STR,'')||' '||nvl(RESULT_NUM_UOM,'') care_flow_detail, NORMAL_LOW, NORMAL_HIGH, a.EXT_IMAGE_APPL_ID,a.EXT_IMAGE_OBJ_ID,a.CONTR_SYS_ID,a.ACCESSION_NUM,a.CONTR_SYS_EVENT_CODE,NVL((SELECT 'Y' FROM CR_ENCOUNTER_DETAIL_TXT##CLOB## WHERE HIST_REC_TYPE  = A.hist_rec_type AND CONTR_SYS_ID=A.contr_sys_id AND ACCESSION_NUM = a.accession_num	AND CONTR_SYS_EVENT_CODE = A.contr_sys_event_code and dbms_lob.getlength(hist_data)>0) ,'N') text_exisits, a.normalcy_ind, (SELECT DECODE(a.normalcy_ind,HIGH_STR,high_color_code,LOW_STR,low_color_code,CRIT_STR,crit_color_code,ABN_STR,abn_color_code,CRIT_HIGH_STR,crit_high_color_code,CRIT_LOW_STR  ,crit_low_color_code,'NONE')FROM CR_CLIN_EVENT_PARAM ##REPDB##) COLOR_CELL_IND,(SELECT DECODE(a.normalcy_ind,HIGH_STR,high_str_desc,LOW_STR,low_str_desc,CRIT_STR,crit_str_desc,ABN_STR,abn_str_desc,CRIT_HIGH_STR,crit_high_str_desc,CRIT_LOW_STR  ,crit_low_str_desc) DESC_CELL_IND FROM CR_CLIN_EVENT_PARAM ##REPDB##) DESC_CELL_IND, (select DECODE(a.normalcy_ind,HIGH_STR,HIGH_SYMBOL_ICON,LOW_STR,LOW_SYMBOL_ICON,CRIT_STR,CRIT_SYMBOL_ICON,ABN_STR,ABN_SYMBOL_ICON,CRIT_HIGH_STR,CRIT_HIGH_SYMBOL_ICON,CRIT_LOW_STR,CRIT_LOW_SYMBOL_ICON,'NONE') FROM CR_CLIN_EVENT_PARAM ##REPDB##)  normal_range_symbol, a.hist_data_type, a.NORMALCY_STR, a.encounter_ID, a.FACILITY_ID  from cr_encounter_detail ##REPDB## a where a.hist_rec_type = 'PTCR' and patient_id = ?") ;
		...
		//6484 end.		
		if("".equals(RepDb)){
			query_current_medications.append(" and (FACILITY_ID,ENCOUNTER_ID) in (select FACILITY_ID,ENCOUNTER_ID from (select FACILITY_ID,ENCOUNTER_ID, ROW_NUMBER() OVER (ORDER BY VISIT_ADM_DATE_TIME DESC) RANK_NO  from  PR_ENCOUNTER ##REPDB## where patient_id= ? ) where RANK_NO	< 5	) ");//IN065341
		}else{
		...
		query_current_medications.append(" AND A.HIST_REC_TYPE='PTCR'");
	...
	//IN069978 ends						
		...
		//query_current_medications.append(" and nvl(ca_view_confidnt_event (a.facility_id,a.ENCOUNTER_ID,a.PATIENT_ID,a.accession_num,A.CONTR_SYS_ID,a.event_code,a.hist_rec_type,?,?,a.performed_by_id,a.AUTHORIZED_BY_ID,DECODE(a.hist_rec_type,'CLNT',null,a.event_group)),'N')='Y' ");//PER100914
		query_current_medications.append(" and nvl(ca_view_confidnt_event ##REPDB##(a.facility_id,a.ENCOUNTER_ID,a.PATIENT_ID,a.accession_num,A.CONTR_SYS_ID,a.event_code,a.hist_rec_type,?,?,a.performed_by_id,a.AUTHORIZED_BY_ID,DECODE(a.hist_rec_type,'CLNT',null,a.event_group)),'N')='Y' ");//IN065341
	...
	if("".equals(RepDb)){//IN069978 
		...
		//query_current_medications.append("  and nvl(a.STATUS,'`') not in('S','E')  order by dummydate desc,c.SHORT_DESC,request_num_seq,e.short_desc,a.event_group,b.short_desc,a.event_code ");
		//query_current_medications.append("  and nvl(a.STATUS,'`') not in('S','E')  order by dummydate desc,event_class,request_num_seq,event_group_desc,a.event_group,event_desc,a.event_code ");//PER100914  - commented for IN050649
	}else{//IN069978 starts				
						
		query_current_medications.append(" AND exists (select 1 from (SELECT HIST_REC_TYPE, CONTR_SYS_ID,ACCESSION_NUM,CONTR_SYS_EVENT_CODE, dense_rank() over (order by event_date desc) drank FROM CR_ENCOUNTER_DETAIL ##REPDB## WHERE  PATIENT_ID=? and encounter_id=? and HIST_REC_TYPE='PTCR' ) WHERE ");//IN065341
		if (modal_yn.equals("N"))
			query_current_medications.append(" drank<3");
		else
				query_current_medications.append(" drank<10000");
						
		query_current_medications.append(" AND HIST_REC_TYPE=A.HIST_REC_TYPE 	AND CONTR_SYS_ID=A.CONTR_SYS_ID AND ACCESSION_NUM=A.ACCESSION_NUM AND CONTR_SYS_EVENT_CODE=A.CONTR_SYS_EVENT_CODE)");
	}//IN069978 ends
		query_current_medications.append("  and nvl(a.STATUS,'`') not in('S','E')  order by dummydate desc,event_class,event_group_desc,a.event_group,request_num_seq,event_desc,a.event_code "); // - modified for IN050649
		...
		pstmt.setString(index++,patient_id);
	if(!"".equals(RepDb)){//IN069978 starts				
		pstmt.setString(index++, enc_id);	
	}//IN069978 ends
		pstmt.setString(index++,clinician_id);//PER100914
		pstmt.setString(index++,resp_id);//PER100914
	...
	if(!"".equals(RepDb)){//IN069978 starts				
		...
		while(rs.next())
		{
			...
			{
				out.println("<tr><td class='gridData' colspan=3 ><b>"+event_date+"</b></td></tr>");
				out.println("<tr><td class='gridData' colspan=3>&nbsp;&nbsp;<b>"+eventclass+"</b></td></tr>");
