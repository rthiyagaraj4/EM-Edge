...
public final class __researchpatientremarksdialog extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ResearchPatientRemarksDialog.jsp", 1709116261418L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t\t\t</head>\n\t\t\t<BODY  class=\'CONTENT\' OnMouseDown=\'CodeArrest()\'  onKeyDown = \'lockKey()\'>\n\t\t\t\t<form>\n\t\t\t\t\t<br>\n\t\t\t\t\t<table border=0 cellpadding=3 cellspacing=0 align=center>\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t<td><textarea name=\'remarks\' value=\"\" rows=5 cols=90 value=\'\'  readonly >";
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eCA.ResearchRemarks.label", java.lang.String .class,"key"));
