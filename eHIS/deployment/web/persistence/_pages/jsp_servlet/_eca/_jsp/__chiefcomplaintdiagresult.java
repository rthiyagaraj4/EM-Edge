...
public final class __chiefcomplaintdiagresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ChiefComplaintDiagResult.jsp", 1709115721558L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="<!--( uncheck to exclude )--></td></tr>\n\t<tr >\n\t<td  class=\'COLUMNHEADERCENTER\' width=\'30%\'>";
...
for(int i=0;i<record.size();i++)
{
	...
	while(st.hasMoreTokens())
	{
		...
		chkCounter++;
            ...
            out.print( String.valueOf(openmode));
