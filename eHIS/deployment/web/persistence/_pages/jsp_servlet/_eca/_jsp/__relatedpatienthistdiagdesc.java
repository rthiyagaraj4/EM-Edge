...
public final class __relatedpatienthistdiagdesc extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/RelatedPatientHistDiagDesc.jsp", 1709116241918L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\n       \n        <script language=\'javascript\'>setValue(\"";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	try{
				...
				if(!(shortdesc.equals("")))
		{
            ...
            out.print( String.valueOf(concat));
