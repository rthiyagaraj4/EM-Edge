...
public final class __catabinsuranceauthorizationformcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CATAbInsuranceAuthorizationFormCriteria.jsp", 1709115628278L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\' onclick=\"getResultForTab()\" />\n\t\t\t\t\t\t\t</TD>\n\t\t\t\t\t\t</tr>\n\t\t\t</table>\n\t\t</form>\n\t</BODY>\n</html>\n\n";
