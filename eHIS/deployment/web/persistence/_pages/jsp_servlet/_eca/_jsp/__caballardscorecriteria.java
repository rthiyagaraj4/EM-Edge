...
public final class __caballardscorecriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CABallardScoreCriteria.jsp", 1743571462795L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\' name=\"date_from\"  id=\"date_from\" onBlur=\'chkDateTime(this,\"DMYHM\",\"";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\");\'><img src=\"../../eCommon/images/CommonCalendar.gif\"  onclick=\"return showCalendarValidate(\'date_from\');\" /> &nbsp;\n\t\t\n\t\t\t\t<input type=\"text\" maxlength=16 size=\"16\" value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' name=\"date_to\"  id=\"date_to\" onBlur=\'chkDateTime(this,\"DMYHM\",\"";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\");\'><img src=\"../../eCommon/images/CommonCalendar.gif\"  onclick=\"return showCalendarValidate(\'date_to\');\" >  </td>\n\t\t\t\t<td class=\"label\" id=\"encid\" style=\"\" width=\'15%\'>\n\t\t\t\t";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="</td>\n\t\t\t\t<td>\n\t\t\t\t<input type=\"text\" name=\"encounter_id\" id=\"encounter_id\" value=\"";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\" maxlength=12 size=13 onKeyPress = \'return allowValidNumber(this,event,12,0)\' onblur = \'isNumeric(this)\'>\n\t\t\t\t</td>\n\t\t\t\t<td>\n\t\t\t\t<input type=\"button\" class=button name=\'search\' id=\'search\' value=\'";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\'  onClick=\"populateControl()\">&nbsp;\n\t\t\t\t</td>\n\t\t</tr>\n\t\t\n\t\t</table>\n\t\n\t\t<input type=\"hidden\" name=\"enc_id\" id=\"enc_id\" value=\"";
