...
public final class __cadocmgmtconfigheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CADocMgmtConfigHeader.jsp", 1728124172364L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block15 ="\' onclick=\"getSearchDetails();\">\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\t\t\t\t\n\t\t\t</table>\n\t\t\t<input type=\'hidden\' name=\'mode\' id=\'mode\' value=\'";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
            ...
            out.print( String.valueOf(facilityDetailsBean.getsFacilityId()));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(facilityDetailsBean.getsFacilityName()));
