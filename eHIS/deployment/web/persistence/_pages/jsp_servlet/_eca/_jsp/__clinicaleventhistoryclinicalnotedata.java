...
public final class __clinicaleventhistoryclinicalnotedata extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ClinicalEventHistoryClinicalNoteData.jsp", 1742381567231L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\' id=\'collapseButton";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' id=\"collapseButton";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\" value=\' + \' onclick=\"collapseExpandNew(this,\'";
    ...
    private final static java.lang.String  _wl_block17 =" <!-- 24094 ends -->\t\n\t\t\t\t\t</font>&nbsp;&nbsp; (";
    ...
    private final static java.lang.String  _wl_block22 ="\' id=\'hist_data_type";
    ...
    private final static java.lang.String  _wl_block25 ="\' id=\'accessionNum";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 ="\'/>\n\t\t\t<input type=\'hidden\' name=\'event_date_time";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="\' id=\'event_date_time";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="\'/>\n\t\t\t";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 ="\t\n\t\t\t<input type=\'hidden\' name=\'modifiedyn";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 ="\' id=\'modifiedyn";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 ="\'/><!-- 24094 starts -->\t\n\t\t\t<input type=\'hidden\' name=\'contr_sys_event_code";
    private final static byte[]  _wl_block31Bytes = _getBytes( _wl_block31 );

    private final static java.lang.String  _wl_block32 ="\' id=\'contr_sys_event_code";
    private final static byte[]  _wl_block32Bytes = _getBytes( _wl_block32 );

    private final static java.lang.String  _wl_block33 ="\'/> \n\t\t\t<input type=\'hidden\' name=\'encounterId";
    private final static byte[]  _wl_block33Bytes = _getBytes( _wl_block33 );

    private final static java.lang.String  _wl_block34 ="\' id=\'encounterId";
    private final static byte[]  _wl_block34Bytes = _getBytes( _wl_block34 );

    private final static java.lang.String  _wl_block35 ="\'/>\n\t\t\t<input type=\'hidden\' name=\'facility_id";
    private final static byte[]  _wl_block35Bytes = _getBytes( _wl_block35 );

    private final static java.lang.String  _wl_block36 ="\' id=\'facility_id";
    ...
    private final static java.lang.String  _wl_block44 ="\'/>\n\t\t<input type=\'hidden\' name=\'currentSelectRecorde\' id=\'currentSelectRecorde\' value=\'\'/>\n\t</FORM>\n\t<script>\n\t\tmoveScroll(\'1\',\'CLNT\');\n\t\t\t\t// JavaScript to dynamically replace columnHeadercenter with COLUMNHEADERCENTER\n\t\tdocument.querySelectorAll(\'.columnHeadercenter\').forEach(function(element) {\n\t\t\telement.classList.replace(\'columnHeadercenter\', \'COLUMNHEADERCENTER\');\n\t\t});\n\t</script>\n</BODY>\n</HTML>\n\n";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	String selHistType = request.getParameter("selHistType")==null	?"":request.getParameter("selHistType");//IN072759
	...
	searchData = bean.getSelectedClinicalNotesDetails(locale,patient_id,facility_id,clinician_id,resp_id,fromDate,toDate,login_user_id,url,selTab,encounterId,date_Ordr,eventCls,eventGrp,eventItem,selHistType,patient_class);//IN071596
            ...
            out.print( String.valueOf((String)resultMap.get("Note_Group_Desc")));
