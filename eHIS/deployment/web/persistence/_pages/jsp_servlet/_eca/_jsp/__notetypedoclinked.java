...
public final class __notetypedoclinked extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/NoteTypeDocLinked.jsp", 1709115964998L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\' == \'CLINICAL_NOTES\' || \'";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\' == \'DISCHARGE_SUMMARY\' || \'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\' == \'REFERRAL_LETTER\' || \'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' == \'RESULT_REPORTING\' || \'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' == \'OT_NOTES\') <!-- IN028710--><!-- 37958  added OT_NOTES-->\n\t\t{\n\t\t\tparent.f_query_add_mod.document.forms[0].doc_link_note.disabled = false;\n\t\t}\n\t\telse\n\t\t{\n\t\t\tparent.f_query_add_mod.document.forms[0].doc_link_note.checked = false;\n\t\t\tparent.f_query_add_mod.document.forms[0].doc_link_note.disabled = true;\n\t\t}\n\n\t</script>\n</HTML>\n\n";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		finally
		{
            ...
            out.print( String.valueOf(applTaskId));
