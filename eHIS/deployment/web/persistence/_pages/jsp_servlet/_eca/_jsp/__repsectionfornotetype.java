...
public final class __repsectionfornotetype extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eCA/jsp/repSectionForNoteType.jsp", 1653382701627L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="&nbsp;</td>\r\n\t\t\t\t\t\t<td width=\'20%\'  class=\'fields\'><input type=text  name=\'p_fr_note_type1\' onblur=\'search_Codeforsectionnotetype(this, p_fr_note_type1)\' size=\"30\" maxlength=\"30\" align=\"center\"><input type=\'hidden\' name=\'p_fr_note_type\' value=\'\'><input type=\'button\' name=\'note_type\' value=\'?\' class=\'button\' onclick=\'search_Codeforsectionnotetype(this, p_fr_note_type1)\'>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td width=\'40%\'  class=\'fields\'><input type=text  name=\'p_to_note_type1\' onblur=\'search_Codeforsectionnotetype(this, p_to_note_type1)\' size=\"30\" maxlength=\"30\" align=\"center\"><input type=\'hidden\' name=\'p_to_note_type\' value=\'\'><input type=\'button\' name=\'note_type1\' value=\'?\' class=\'button\' onclick=\'search_Codeforsectionnotetype(this, p_to_note_type1)\'>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\r\n\t\t\t\t<!-- <tr>\r\n\t\t\t\t\t<td>&nbsp;</td>\r\n\t\t\t\t\t<Td>&nbsp;</td>\r\n\t\t\t\t</tr> -->\r\n\r\n\t\t\t\t\t<!-- <tr>\r\n\t\t\t\t\t\t<td align=\'right\' width=\'30%\' class=\"label\">Section&nbsp;</td>\r\n\t\t\t\t\t\t<td width=\'20%\'  ><input type=text  name=\'section_from\' size=\"4\" maxlength=\"4\" align=\"center\"><input type=\'button\' name=\'section\' value=\'?\' class=\'button\' onclick=\'searchCode(this, section_from)\'>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td width=\'40%\'><input type=text  name=\'section_to\' size=\"4\" maxlength=\"4\" align=\"center\"><input type=\'button\' name=\'section1\' value=\'?\' class=\'button\' onclick=\'searchCode(this, section_to)\'>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td>&nbsp;</td>\r\n\t\t\t\t\t<Td>&nbsp;</td>\r\n\t\t\t\t</tr> -->\r\n<!-- \r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td align=\'right\' width=\'30%\' class=\"label\">Nature &nbsp;</td>\r\n\t\t\t\t\t<td  width=\'20%\' align=\"left\">\r\n\t\t\t\t\t\t<select name=\'p_nature\'>\r\n\t\t\t\t\t\t<option value=\"B\">Both\r\n\t\t\t\t\t\t<option value=\"E\">Enabled\r\n\t\t\t\t\t\t<option value=\"D\">Disabled\r\n\t\t\t\t\t\t</select>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\r\n<tr>\r\n\t\t\t\t\t<td>&nbsp;</td>\r\n\t\t\t\t\t<Td>&nbsp;</td>\r\n\t\t\t\t</tr> -->\r\n<!-- \t\t\t\t<tr>\r\n\t\t\t\t\t<td align=\'right\' width=\'30%\' class=\"label\">\r\n\t\t\t\t\t\tOrder By &nbsp;\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td  width=\'20%\' align=\"left\">\r\n\t\t\t\t\t\t<select name=\'p_order_by\'>\r\n\t\t\t\t\t\t<option value=\'1\'>Code\r\n\t\t\t\t\t\t<option value=\'2\'>Description\r\n\t\t\t\t\t\t</select>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n<tr>\r\n\t\t\t\t\t<td>&nbsp;</td>\r\n\t\t\t\t\t<Td>&nbsp;</td>\r\n\t\t\t\t</tr>\r\n\t\t\t\t -->\t\t\t\t\r\n\t\t</table>\r\n\t</td>\r\n</tr>\r\n</table>\r\n<input type=\"hidden\" name=\"p_facility_id\"\t\tvalue=\"";
