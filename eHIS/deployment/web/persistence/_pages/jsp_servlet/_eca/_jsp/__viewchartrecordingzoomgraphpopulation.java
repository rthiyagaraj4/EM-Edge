...
public final class __viewchartrecordingzoomgraphpopulation extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ViewChartRecordingZoomGraphPopulation.jsp", 1709116433401L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\" usemap=\"#";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\"  border=0 width=\'100%\' height=\'100%\'/>\n\t\t</TD>\n\t</TR>\n\t<TR height=\'10%\'>\n\t\t<TD align=\'right\' style=\'padding-right:10px;\' bgcolor=\'#FFFFFF\'>\t\t\t\n\t\t\t<INPUT TYPE=\"button\" VALUE=\"Close\" ONCLICK=\"javascript:winClose();\">\n\t\t</TD>\n\t</TR>\n\t</TABLE>\n</form>\n\n</body>\n</html>\n\n";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	graphURL = request.getContextPath()+"/eCA/MediPainter/images/"+filename;
            ...
            out.print( String.valueOf(graphTitle ));
