...
public final class __patlistbymedservicepopulateservice extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/PatListByMedServicePopulateService.jsp", 1709116004123L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	shortdesc=rset.getString("SHORT_DESC");
            ...
            out.print( String.valueOf(splty));
