...
public final class __encsummlayouthdr extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/EncSummLayoutHdr.jsp", 1709115860685L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\' ><input type=\'text\' name =\'summaryCode\' onBlur=\'getSummaryCode(this)\' OnChange=\'resetValues();setValue()\' value=\'";
    ...
    private final static java.lang.String  _wl_block11 ="\" onClick=\"fetchRecords();\"  class=\"button\">\n\t\t\t\t\t</td>\n\t\t\t</tr>\n\t\t\t</center>\n\t\t</table>\n\t\t";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	if(sStyle.equals("IeStyle.css"))
	{
	 ...
	 //end
            ...
            out.print( String.valueOf(summaryCode ));
