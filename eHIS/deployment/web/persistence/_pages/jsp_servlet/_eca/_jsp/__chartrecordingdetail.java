...
public final class __chartrecordingdetail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ChartRecordingDetail.jsp", 1740639195044L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="</td>\n\t\t<td class=\'COLUMNHEADERCENTER\'  border=\'0\' title=\'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\'>Rem</td> <!--IN00000 moved tag into if condition -->\n";
    ...
    private final static java.lang.String  _wl_block51 ="&modifyYN=";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
...

	{
		...
		finally
		{
            ...
            out.print( String.valueOf(numdec));
