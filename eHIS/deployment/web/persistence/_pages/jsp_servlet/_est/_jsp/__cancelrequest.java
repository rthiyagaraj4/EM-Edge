...
public final class __cancelrequest extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/CancelRequest.jsp", 1710495543753L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	CancelRequestBean bean = (CancelRequestBean) getBeanObject("cancelRequestBean","eST.CancelRequestBean",request);  
...
putObjectInBean("cancelRequestBean",bean,request);
