...
public final class __itemclassforstoreheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/ItemClassForStoreHeader.jsp", 1709122064449L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="</td>\n\t\t\t\t<td class=fields><input type=\"button\" name=\"search\" id=\"search\" class=\'button\' value=\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' onClick=\'displayDetail();\'></td>\n\t\t</tr>\n\t</table>\n\t<input type=\"hidden\" name=\"mode\" id=\"mode\" value=\"";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	if ( !(mode.equals( eCommon.Common.CommonRepository.getCommonKeyValue("MODE_MODIFY") ) || mode.equals( eCommon.Common.CommonRepository.getCommonKeyValue("MODE_INSERT") )) )
		return ;
	eST.ItemClassForStoreBean bean = (eST.ItemClassForStoreBean)getBeanObject(bean_id,bean_name,request) ;  
	...
	int i=0;
            ...
            out.print( String.valueOf(stores));
