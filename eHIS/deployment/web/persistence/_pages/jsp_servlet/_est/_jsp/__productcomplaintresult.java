...
public final class __productcomplaintresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/ProductComplaintResult.jsp", 1720592987978L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block18 ="\" style=\"cursor:pointer\" onclick = \"PrintWorkSheet(\'";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\',\'";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="\');changeRowColor(tr_";
    ...
    private final static java.lang.String  _wl_block26 ="\"> <div  align=\"right\">&nbsp; ";
	...
	for(int recCount=2; recCount<result.size(); recCount++) {
		...
		records=(ArrayList) result.get( recCount );
            ...
            out.print( String.valueOf(printTitle));
		...
		out.println(CommonBean.setForm ( request ,"../../eST/jsp/ProductComplaintResult.jsp", searched) );
            ...
            out.print( String.valueOf(p_item_code));
