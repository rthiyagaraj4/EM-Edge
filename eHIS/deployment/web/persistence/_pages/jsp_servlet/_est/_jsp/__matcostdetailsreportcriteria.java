...
public final class __matcostdetailsreportcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/MatCostDetailsReportCriteria.jsp", 1728292256500L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t<body onLoad=\"FocusFirstElement()\">\n<!-- \tSQL_ST_TRN_TYPE_SELECT_LIST -->\n\t\t<form name=\"MatCostDetailsReportCriteria\" id=\"MatCostDetailsReportCriteria\" action=\"../../eCommon/jsp/report_options.jsp\"  target=\"messageFrame\" >\n\t\t<br><br>\n\t\t<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\'100%\' align=\'center\' >\n\t\t\t<tr>\n\t\t\t<td width=\'100%\' align=\'center\' class=\"WHITE\">\n\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" width=\"98%\" align=\"center\" border=\"0\">\n\t\t\t\t<th colspan=8 align=left>";
    ...
    private final static java.lang.String  _wl_block15 ="</td>\n\t\t\t\t\t<td class=fields>&nbsp;&nbsp;<input maxLength=20 size=20  name=\"p_fm_item_code\" id=\"p_fm_item_code\" value=\"\" ><input class=\"button\" name=\"p_fm_sr2\" id=\"p_fm_sr2\" onClick=\"return searchCodeItem(p_fm_item_code);\" type=\"button\" value=\"?\"></td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=fields >&nbsp;&nbsp;<input maxLength=20 size=8 name=\"p_to_item_code\" id=\"p_to_item_code\" value=\"\" ><input class=\"button\" name=\"p_to_sr2\" id=\"p_to_sr2\" onClick=\"return searchCodeItem(p_to_item_code);\" type=\"button\" value=\"?\"  ></td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"label\">";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="</td>\n\t\t\t\t\t<td class=fields colspan=\"3\">&nbsp;&nbsp;<input maxLength=20 size=20  name=\"p_trade_code\" id=\"p_trade_code\" value=\"\" ><input class=\"button\" name=\"p_trade_code1\" id=\"p_trade_code1\" onClick=\"return searchCodeTrade(p_trade_code);\" type=\"button\" value=\"?\"></td>\n\t\t\t\t\n\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t</table>\n\t\t\t\t</td>  \n\n\t\t\t\t</tr>\n\n\t\t\t\t\n\t\t\t</table>\n\n\t\t\t\n\t\t\t<input type=\"hidden\" name=\"bean_id\" id=\"bean_id\"\t\t\t\t\t\t\t\tvalue=\"";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		bean.setAcc_entity_id((String)session.getAttribute("ACC_ENTITY_ID"));
            ...
            out.print( String.valueOf(  eMM.Common.MmRepository.getMmKeyValue("SQL_AM_TRADE_NAME_LOOKUP")));
