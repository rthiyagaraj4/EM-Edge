...
public final class __transactionremarksdetail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/TransactionRemarksDetail.jsp", 1718609274803L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="<input type=checkbox name=\'selectAll\' id=\'selectAll\' onClick=\"changeStatusCheckBox(this);\" value=\"N\"></th>\n\t\t\t";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\t<!-- MO-CRF-20174 -->\n\t\t\t\t<th >";
    ...
    private final static java.lang.String  _wl_block19 ="\"><font class=\'";
    ...
    private final static java.lang.String  _wl_block22 ="\"><font  class=\'";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="\"><input type=\"checkbox\" name=\"remarks_code_";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\" id=\"remarks_code_";
    ...
    private final static java.lang.String  _wl_block28 ="\' onClick=\'alterBean(this,\"";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 ="\")\'> </td>\n\t\t\t\t";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 =" <!-- MO-CRF-20174 -->\n\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 ="\"><input type=\"checkbox\" name=\"reject_status_";
    private final static byte[]  _wl_block31Bytes = _getBytes( _wl_block31 );

    private final static java.lang.String  _wl_block32 ="\" id=\"reject_status_";
    private final static byte[]  _wl_block32Bytes = _getBytes( _wl_block32 );

    private final static java.lang.String  _wl_block33 ="\" value=\"Y\" ";
    private final static byte[]  _wl_block33Bytes = _getBytes( _wl_block33 );

    private final static java.lang.String  _wl_block34 ="\' onClick=\'alterBean1(this,\"";
    private final static byte[]  _wl_block34Bytes = _getBytes( _wl_block34 );

    private final static java.lang.String  _wl_block35 ="\n\t\t\t</tr>\n\t\t\t\t<input type=\"hidden\"\tname=\"remove_remarks_code_";
    private final static byte[]  _wl_block35Bytes = _getBytes( _wl_block35 );

    private final static java.lang.String  _wl_block36 ="\" id=\"remove_remarks_code_";
    private final static byte[]  _wl_block36Bytes = _getBytes( _wl_block36 );

    private final static java.lang.String  _wl_block37 ="\"\t\tvalue=\"";
    private final static byte[]  _wl_block37Bytes = _getBytes( _wl_block37 );

    private final static java.lang.String  _wl_block38 ="\">\n\t\t\t\t<input type=\"hidden\"\tname=\"eff_status_";
    private final static byte[]  _wl_block38Bytes = _getBytes( _wl_block38 );

    private final static java.lang.String  _wl_block39 ="\" id=\"eff_status_";
    private final static byte[]  _wl_block39Bytes = _getBytes( _wl_block39 );

    private final static java.lang.String  _wl_block40 ="\"\t\t\t\tvalue=\"\">\n\t\t\t\t<input type=\"hidden\"\tname=\"highlight_";
    private final static byte[]  _wl_block40Bytes = _getBytes( _wl_block40 );

    private final static java.lang.String  _wl_block41 ="\" id=\"highlight_";
    private final static byte[]  _wl_block41Bytes = _getBytes( _wl_block41 );

    private final static java.lang.String  _wl_block42 ="\"\t\t\t\t\tvalue=\"";
    private final static byte[]  _wl_block42Bytes = _getBytes( _wl_block42 );

    private final static java.lang.String  _wl_block43 ="\">\n\t\t\t\t<input type=\"hidden\"\tname=\"db_action_";
    private final static byte[]  _wl_block43Bytes = _getBytes( _wl_block43 );

    private final static java.lang.String  _wl_block44 ="\" id=\"db_action_";
    ...
    private final static java.lang.String  _wl_block47 ="\">\n\t\t\t\t<input type=\"hidden\"\tname=\"total_remarks\" id=\"total_remarks\"\t\t\tvalue=\"";
    ...
    private final static java.lang.String  _wl_block52 ="\">\n\t\t\t\t<input type=\"hidden\"\tname=\"PreviousListValueExit\" id=\"PreviousListValueExit\"\tvalue=\"";
    ...
    private final static java.lang.String  _wl_block61 ="\n</center>\n\t\t\t\n<script>\ngettotalcheckBoxes(document.frmTransactionRemarksDetail.total_remarks);\n</script>\n<script>\n\t\tvar selectall=0,i=0,cnt=0,loop=14;\n\t\t\tcnt\t\t=\t\tdocument.frmTransactionRemarksDetail.end.value;\n\t\t//if(document.frmTransactionRemarksDetail.end.value>document.frmTransactionRemarksDetail.total_records.value)\n\t     if(parseInt(document.frmTransactionRemarksDetail.end.value)>parseInt(document.frmTransactionRemarksDetail.total_records.value))\n\t\t{\t\t\n\t\tcnt\t\t=\t\tdocument.frmTransactionRemarksDetail.total_records.value;\n\t\t}\n\t\t\n\t\tfor (i = document.frmTransactionRemarksDetail.start.value;i<cnt;i++) {\n\t\tif(eval(\"document.frmTransactionRemarksDetail.remarks_code_\"+i+\".checked\"))selectall++;\n\t\t\tif(cnt==document.frmTransactionRemarksDetail.total_records.value)count++;\n\t\t\n\t\t}\n\t\t\t\n\t\tif(selectall==loop){\n\t\t\tdocument.frmTransactionRemarksDetail.selectAll.value\t\t=\t\"Y\";\n\t\t\tdocument.frmTransactionRemarksDetail.selectAll.checked\t\t=\ttrue;\n\t\t}\n\t\t\n\t\telse {\n\t\t\tvar count=0;\n\t\t\tif(cnt==document.frmTransactionRemarksDetail.total_records.value)\n\t\t\t{for (i = document.frmTransactionRemarksDetail.start.value;i<cnt;i++) {\n\t\t\t\tif(cnt==document.frmTransactionRemarksDetail.total_records.value){\n\t\t\t\t\n\t\t\t\t\tcount++;\n\t\t\t\t}\n\t\t\t}\n\t\t\tif(selectall==count){\n\t\t\t\tdocument.frmTransactionRemarksDetail.selectAll.value\t=\t\"Y\";\n\t\t\t\tdocument.frmTransactionRemarksDetail.selectAll.checked\t=\ttrue;}\n\t\t\t}\n\t\telse{\n\t\t\tdocument.frmTransactionRemarksDetail.selectAll.value\t\t=\t\"N\";\n\t\t\tdocument.frmTransactionRemarksDetail.selectAll.checked\t\t=\tfalse;}\n\t\t}\n\t\t</script>\n</body>\n</html>\n\n";
...
*/
	...
	try{
		...
		String highlight					=		"";
		String Color						=		"";
		String reject_status_checked						=		"";//MO-CRF-20174
		...
		ArrayList reject_status_result					=		bean.getRejectReqRemarks();//MO-CRF-20174
  ...
  if(bean.getTransaction_Type().equalsIgnoreCase("ISS")){ 
            ...
            _bw.write(_wl_block17Bytes, _wl_block17);
				...
				if(reject_status_result.contains(remarks_code)){
					reject_status_checked = "checked";
				}else{
					reject_status_checked = "";  
				}
				...
				if(key_value.equals(bean.getTransaction_Type()))
				{
					...
					String hmRecord_reject_status		=		(String)hmRecord.get("REJECT_STATUS"+i);//MO-CRF-20174  
					...
					if(hmRecord_remarks_code!=null){
						if(hmRecord_remarks_code.equals(remarks_code)){
							...
							//MO-CRF-20174
							if(hmRecord_reject_status!=null){
								if(hmRecord_reject_status.equals("E"))
									reject_status_checked						=		"checked";
								else
									reject_status_checked						=		"";
							}
            ...
            out.print( String.valueOf(noDisplay));
 ...
 if(bean.getTransaction_Type().equalsIgnoreCase("ISS")) {  
            ...
            out.print( String.valueOf(reject_status_checked));
            _bw.write(_wl_block27Bytes, _wl_block27);
            out.print( String.valueOf(noDisplay));
            ...
            out.print( String.valueOf(highlight));
...
i++;
            ...
            out.print( String.valueOf(result.size()/2));
            ...
            out.print( String.valueOf(bean.hasRecords()));
            _bw.write(_wl_block52Bytes, _wl_block52);
            out.print( String.valueOf(PreviousListValueExit));
...
if(dispMode.equals("")){
    ...
    private boolean _jsp__tag7(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag7.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.ForRejectOrCancel.label", java.lang.String .class,"key"));
