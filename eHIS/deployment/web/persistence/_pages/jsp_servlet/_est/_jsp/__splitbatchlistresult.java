...
public final class __splitbatchlistresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/SplitBatchListResult.jsp", 1732998344415L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block19 ="\" id=\'a_";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="\'  href=\"javascript:populateData(\'";
    ...
    private final static java.lang.String  _wl_block26 ="&nbsp;&nbsp;<span style=";
    ...
    private final static java.lang.String  _wl_block29 ="</span></font></a></td>\n\t</tr>\n\t";
    ...
    private final static java.lang.String  _wl_block38 =".scrollIntoView();\n\tchangeRowColor(document.getElementById(\"tr_\")";
		...
		/**
			...
			*/
            ...
            if (_jsp__tag3(request, response, pageContext, _activeTag, null))
             return;
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf(bean.checkForNull((bean.checkForNull((String)ht.get("item_cost_value")).trim()),"0")));
            _bw.write(_wl_block28Bytes, _wl_block28);

            if (_jsp__tag4(request, response, pageContext, _activeTag, null))
             return;
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf(bean.checkForNull((bean.checkForNull((String)ht.get("item_unit_cost")).trim()),"0")));
