...
public final class __workloadstatisticsreportcrieteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/WorkLoadStatisticsReportCrieteria.jsp", 1717573541952L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block15 ="</td>\n\t\t\t\t\t<td class=fields>&nbsp;&nbsp;<input type=text name=\"P_FM_DATE_1\" id=\"P_FM_DATE_1\" size=10 maxlength=10 class=\"DATE\" value=\"\" onBlur=\"CheckDate(this,\'";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\');\"  ><img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'P_FM_DATE_1\');\" ></img>&nbsp;&nbsp;&nbsp;&nbsp;</td>\n\t\t\t\t\t<td class=fields >&nbsp;&nbsp;<input type=text name=\"P_TO_DATE_1\" id=\"P_TO_DATE_1\" size=10 maxlength=10 class=\"DATE\" value=\"\" onBlur=\"CheckDate(this,\'";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\');\"  ><img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'P_TO_DATE_1\');\" ></img>&nbsp;&nbsp;&nbsp;&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t</tr>\n\n\t\t\t<!--\t<tr>\n\t\t\t\t\t<td class=\"label\" align=\"right\">Transaction</td>\t<td align=\'left\' class=label id=td5>&nbsp;&nbsp;<select name=\"P_FINALIZED_YN\" id=\"P_FINALIZED_YN\" >\n\t\t\t\t\t\t<option value= \"\" >All</option>\n\t\t\t\t\t\t<option value=\"Y\">Finalized</option>\n\t\t\t\t\t\t<option value=\"N\">Unfinalized</option>\n\t\t\t\t\t</select></td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t-->\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t\n\t\t\t\t</tr>\n\t\t\t\t</table>\n\t\t\t\t</td>  \n\t\t\t\t</tr>\n\t\t\t</table>\n\n\t\t\t\n\t\t\t<input type=\"hidden\" name=\"bean_id\" id=\"bean_id\"\t\t\t\t\t\t\tvalue=\"";
