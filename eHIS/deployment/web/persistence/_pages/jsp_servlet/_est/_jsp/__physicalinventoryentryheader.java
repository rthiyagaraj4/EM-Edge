...
public final class __physicalinventoryentryheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/PhysicalInventoryEntryHeader.jsp", 1720689672764L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="&nbsp;<input type=\"checkbox\" value=\"\" name=\"entry_completed_yn\" id=\"entry_completed_yn\"></td>\n\t\t\t\t<td class=\"fields\">\n\t\t\t\t\t&nbsp;&nbsp;</td>\n\t\t\t\t";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\n\t\t\t\t<td  class=\"label\">\n\t\t\t\t\t";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="<!-- Modified for TFS id:6938 -->\n\t\t\t\t</td>\n\t\t\t\t<td class=fields>\n\t\t\t\t\t&nbsp;\n\t\t\t\t\t<input  name=barcode size=80 maxlength=100 value = \"\" onkeypress=\"searchBarcode(event,barcode,\'";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\',\'";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\')\" disabled ><!--Modified for IN:073577 increased size from 70 to 80 -->\n\t\t\t\t</td>\n\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block19 ="\'onclick=\"fun_submit();\"  </td>\n\t\t\t\t\t</td>\n\t\t\t\t\t<input type=\"hidden\" name=\"language_id\" id=\"language_id\" value=\"";
    ...
    private final static java.lang.String  _wl_block25 ="\"><!--Added for GHL-CRF-0413.7 -->\n\t\t</form>\n";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		//Added for GHL-CRF-0413.7 starts
	   	...
	   	//Added for GHL-CRF-0413.7 ends
            ...
            out.print( String.valueOf(bean.getTempphyid()));
...
if(site){ //Added for GHL-CRF-0413.7 starts
            ...
            out.print( String.valueOf(bean.getStRepositoryValue("SQL_ST_ITEM_LOOKUP_LANG")));
...
//Added for GHL-CRF-0413.7 ends
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.EntryCompleted.label", java.lang.String .class,"key"));
