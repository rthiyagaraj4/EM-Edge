...
public final class __phyinvforspecificitemaddingremarks extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/PhyInvForSpecificItemAddingRemarks.jsp", 1718197417472L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="</td>\n\t\t<td   class=\"fields\"><input type=\"text\" size=50 name=\"remarks\" id=\"remarks\" value=\"";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\" onKeyPress=\"return false;\"><input type=\"hidden\" name=\"remarks_code_1\" id=\"remarks_code_1\" value = \"\" >\n\t\t<input type=\'button\' class=\'BUTTON\' name=\'remark\' id=\'remark\' value=\'?\' onClick=\"searchRemarks(remarks_code_1,remarks);\"></td>\n\t\t<td   class=\"label\" width=200></td>\n</table>\n</div>\n\t\t<input type=\"hidden\"\tname=\"lang_id\" id=\"lang_id\"\t\t\t\t\t\t\t\tvalue=\"";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		if ( request.getParameter("show").equals("yes"))
		{
            ...
            out.print( String.valueOf(rem_val));
