...
public final class __preparelocationqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/PrepareLocationQueryResult.jsp", 1718793134737L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block14 ="\" onmouseover=\"this.style.cursor=\'pointer\';\" ><font class=\'HYPERLINK\'>  ";
	...
	String prepare_location_code = request.getParameter("prepare_location_code");
	...
	try{
		prepare_location_code = CommonBean.checkForNull(prepare_location_code)+"%";
		long_desc = CommonBean.checkForNull(long_desc)+"%";
		eff_status = CommonBean.checkForNull(eff_status);
		sqlMap.put("sqlData", eST.Common.StRepository.getStKeyValue("SQL_ST_PREPARE_LOCATION_QUERY_RESULT"));

		displayFields.add("prepare_location_code");
		...
		chkFields.add( prepare_location_code);
	...
	out.println(CommonBean.setForm ( request ,"../../eST/jsp/PrepareLocationQueryResult.jsp", searched) );
	}
	catch(Exception e) {
