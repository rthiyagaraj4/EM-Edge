...
public final class __adjuststockdetail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/AdjustStockDetail.jsp", 1727325376327L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block18 ="\" height=12 >&nbsp;\n\t\t\t\t\t\t\t";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\n\t\t<font size=1> <a href=\"javascript:populateData(\'";
	...
	*/
	...
	if(((String)ht.get("dec_allowed_yn")).equals("Y")){
		no_of_decimals_temp = no_of_decimals;
            ...
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(ht.get("mode")));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(ht.get("itemlastcost")));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(ht.get("storecost")));
            ...
            out.print( String.valueOf(bean.setNumber(bean.checkForNull((String)adj_item_qty,"0"),no_of_decimals_temp).replace(".", "")));
