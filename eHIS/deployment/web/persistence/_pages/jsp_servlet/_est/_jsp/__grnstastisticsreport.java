...
public final class __grnstastisticsreport extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/GRNStastisticsReport.jsp", 1709122051980L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\');\"  ><img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'dt_from_1\');\" ></img>&nbsp;&nbsp;&nbsp;&nbsp;</td>\n\t\t\t\t\t<td class=\"fields\">&nbsp;</td><td class=fields colspan=5>&nbsp;&nbsp;<input type=text name=dt_to_1 size=10 maxlength=10 class=\"DATE\" value=\"\" onBlur=\"CheckDate(this,\'";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\');\"  ><img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'dt_to_1\');\" ></img>&nbsp;&nbsp;&nbsp;&nbsp;</td>\n\t\t\t\t</tr> \n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\" class=\"label\" colspan = 8>&nbsp;</td>\n\t\t\t\t</table>\n\t\t\t\t</td>  \n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\t<input type=\"hidden\" name=\"bean_id\" id=\"bean_id\"\t\t\t\t\t\t\t\tvalue=\"";
