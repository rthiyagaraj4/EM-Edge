...
public final class __goodsreturntovendorframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/GoodsReturnToVendorFrame.jsp", 1732110112277L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block6 ="\n\t<!--<frameset rows=\'40,*\'>-->\n\t\t<iframe name=\'frameGoodsReturnToVendorHeader\'\t\tsrc=\"../../eST/jsp/GoodsReturnToVendorHeader.jsp?";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="\" frameborder=0 scrolling=\'no\'   noresize style=\'height:20vh;width:100vw\'></iframe>\n\t\t<!--<frameset cols=\"30%,*\" >-->\n\t\t\t<iframe name=\'frameGoodsReturnToVendorDetail\'\tsrc=\"../../eST/jsp/GoodsReturnToVendorDetail.jsp?";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\"\t\t\t\t\tframeborder=0 scrolling=\'auto\'   noresize style=\'height:74vh;width:24vw\'></iframe>\n\t\t\t<iframe name=\'frameGoodsReturnToVendorList\'\tsrc=\"../../eST/jsp/GoodsReturnToVendorListFrame.jsp?";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\"\t\t\t\t\tframeborder=0 scrolling=\'no\' noresize style=\'height:74vh;width:74vw\'></iframe>\n\t\t<!--</frameset>-->\n\t<!--</frameset>-->\n\t\t<!--\n\t\t* @Name - Priya\n\t\t* @Date - 21/12/2009\n\t\t* @Inc# - IN017084\n\t\t* @Desc - To avoid the duplication records display in Modify mode\n\t\t -->\n\t\t<script>\n\t\tclearMessageFrame();\n\t\t</script>\n</html>\n \n";
