...
public final class __producttransferheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/ProductTransferHeader.jsp", 1720156442594L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="\n\n<!-- <script language=\"JavaScript\">\n  parent.frameProductTransferAddModify.location.href=\"../../eST/jsp/ProductTransferAddModify.jsp?function_id=ST_PRODUCT_TRANSFER\";\n</script>   -->\n\n<table  border=0 cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" border =\"0\" align=center>\n\t<tr>\n\t\t\t<td class=\"label\" >&nbsp;</td>\n\n\t\t\t<td class=\'fields\'><input type=button name=\"request\" id=\"request\" value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' class=button style=\'width:70\' style=\'height:16pt\'    onclick=\"callRequestSearch()\" ";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 =" >&nbsp;&nbsp;&nbsp;</td><!--Modified for ML-MMOH-CRF-0448 B.Badmavathi -->\n\n\t\t\t<td  class=label >&nbsp;</td>\n\t\t\t<td  class=label >&nbsp;</td>\n\t\t<!--Added for ML-MMOH-CRF-0448 B.Badmavathi starts -->\t\n\t\t\t";
    ...
    private final static java.lang.String  _wl_block22 ="&nbsp;<select name=\'prep_loc\' id=\'prep_loc\' >";
	 ...
	 //Added for ML-MMOH-CRF-0448 B.Badmavathi ends	
            ...
            {java.lang.String __page ="../../eST/jsp/StHeader.jsp";
                java.lang.String[][] __queryParams = {{ weblogic.utils.StringUtils.valueOf("mode"), weblogic.utils.StringUtils.valueOf(mode
                        ...
                        )},{ weblogic.utils.StringUtils.valueOf("default_doc"), weblogic.utils.StringUtils.valueOf("PRT")},{ weblogic.utils.StringUtils.valueOf("storeSQLID"), weblogic.utils.StringUtils.valueOf(sql_id
                        )},};
            ...
            out.print( String.valueOf( mode.equals(CommonRepository.getCommonKeyValue("MODE_MODIFY"))?request_vis:""));
...
if(site && prep_loc!="") {
            ...
            out.print( String.valueOf(bean.getPrepLoc1(prep_loc)));
