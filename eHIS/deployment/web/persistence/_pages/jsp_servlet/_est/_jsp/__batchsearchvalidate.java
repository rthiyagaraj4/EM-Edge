...
public final class __batchsearchvalidate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/BatchSearchValidate.jsp", 1732511557857L ,"10.3.6.0","Asia/Calcutta")) return true;
...
*/
	...
	case 1:
		...
		{//Adding start for TH-KW-CRF-0043
			String sel_key					=		request.getParameter( "sel_key" )==null?"":request.getParameter( "sel_key" ) ;
			String sel_value		=		request.getParameter( "sel_value" )==null?"":request.getParameter( "sel_value" ) ;
			String item_code        =       request.getParameter( "item_code" )==null?"":request.getParameter( "item_code" ) ;
			String row_no  = request.getParameter( "i" )==null?"0":request.getParameter( "i" ) ;
			//Build an AL of selected batches
			bean.selectedQuantity(sel_key,sel_value,row_no,item_code);
		...
		{//Adding start for TH-KW-CRF-0043
			String sel_key					=		request.getParameter( "sel_key" )==null?"":request.getParameter( "sel_key" ) ;
			HashMap selectedQty  =bean.getSelectedQTY();
			System.err.println("selectedQty@@@ remove=="+selectedQty+"sel_key=="+sel_key);
                if(selectedQty.containsKey(sel_key))
					selectedQty.remove(sel_key);
