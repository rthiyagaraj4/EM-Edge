...
public final class __generaterequestframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/GenerateRequestFrame.jsp", 1719407396269L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block7 ="\n <!--\n * @Name - Priya\n * @Date - 13/07/2010\n * @Inc# - 22634\n * @Desc - To freeze the header row & to adjust the column width, the header row is moved under detail page \n*/-->\n\n\t<iframe name=\"GenerateRequestHeaderFrame\" id=\"GenerateRequestHeaderFrame\" frameborder=\"0\" scrolling=\"no\" noresize src=\"../../eST/jsp/GenerateRequestHeader.jsp?mode=1&";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\" style=\"height:40vh;width:100vw\"></iframe>\n\t<!--<frame name=\"GenerateRequestHtml\" id=\"GenerateRequestHtml\" src=\"../../eST/jsp/GenerateRequestHtml.jsp?";
