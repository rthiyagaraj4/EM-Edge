...
public final class __drugregisterreportcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/DrugRegisterReportCriteria.jsp", 1709122035652L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="&nbsp;&nbsp;</td>\n\t\t\t\t<td class=fields>\n\t\t\t\t\t<input type=text name=\"p_store_desc\" id=\"p_store_desc\" maxlength=15 size =15 value=\"\" onKeyPress=\"return CheckForSpecChars(event);\"><input type=button value=\'?\' class=button onClick=\"return searchCodeStore(p_store_desc);\" >";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="&nbsp;&nbsp;\n\t\t\t\t<input type=\"hidden\" name=\"p_str_code\" id=\"p_str_code\"\tvalue=\"\">\n\t\t\t\t</td>\n\t\t\t\t\t<td align=\"right\" class=\"label\">";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 =" </td>\n\t\t\t\t\t<td class=fields>&nbsp;&nbsp;<input maxLength=20  size=20   name=\"p_item_code\" id=\"p_item_code\"  value=\"\"><input class=\"button\" onClick=\"return searchCodeItem(p_item_code);\" type=\"button\" value=\"?\">";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		bean.setLanguageId(locale);
            ...
            out.print( String.valueOf((String)bean.getSystemDate()));
