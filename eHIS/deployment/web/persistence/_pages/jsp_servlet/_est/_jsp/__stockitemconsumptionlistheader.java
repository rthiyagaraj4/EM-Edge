...
public final class __stockitemconsumptionlistheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/StockItemConsumptionListHeader.jsp", 1729677659603L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="</td>\n\t\t\t<td colspan=3  class=\'fields\' nowrap>&nbsp;<input type=\'text\' name=\'barcode\' id=\'barcode\'  size=80 maxLength=100 value=\"\" onkeypress=\"callBarCodeBatchSearchforBarcode1(event,barcode,trn_type,parent.parent.frameStockItemConsumptionHeader.document.formStockItemConsumptionHeader.store_code,\'\',this.form,\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\',\'";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\',\'StockItemConsumptionListHeader\',\'StockItemConsumptionListDetail\',\'StockItemConsumptionDetail\');\" ";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 =" ></td><!--Modified for IN:073577 increased size from 70 to 80 -->\t\t\t\n\t\t</tr>\n\t\t";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\n\t\t<tr>\n\t\t\t<td class=label >";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="</td>\n\t\t\t<td colspan=2  class=\'fields\' nowrap>&nbsp;<input type=text name=item_desc size=70 maxlength=60 value=\"\" ";
    ...
    private final static java.lang.String  _wl_block26 ="</span></b></td>\n\t\t\t</tr>\n\t\t\t</table>\n\t\t\t</td>\n\t\t</tr>\n\t\t<tr>\n\t\t\t<td class=label >";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="</td>\n\t\t";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="\n\t\t\t<td  class=\'fields\' width=\'20%\'>&nbsp;<input type=text name=item_qty id=item_qty size=10 maxlength=12 class=\"NUMBER\" onKeyPress=\"return isValidNumber(this,event,7,";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 =");\" onblur=\"return CheckQuantity();\"  value=\"";
    ...
    private final static java.lang.String  _wl_block32 =");\" onblur=\"return CheckQuantity();\" onChange=\"javascript:if(stock_item_yn.value==\'Y\')edit.disabled=false;\" value=\"";
    private final static byte[]  _wl_block32Bytes = _getBytes( _wl_block32 );

    private final static java.lang.String  _wl_block33 ="\n\t\t\t<td class=label >";
    private final static byte[]  _wl_block33Bytes = _getBytes( _wl_block33 );

    private final static java.lang.String  _wl_block34 =":&nbsp;<b><span id=\"id_stock_available\">";
    private final static byte[]  _wl_block34Bytes = _getBytes( _wl_block34 );

    private final static java.lang.String  _wl_block35 ="</span></b></td>\n\t\t\t<td  width=\'35%\'  class=\'label\'><label id=\"id_item_sal_value_label\" style=";
    private final static byte[]  _wl_block35Bytes = _getBytes( _wl_block35 );

    private final static java.lang.String  _wl_block36 =">";
    private final static byte[]  _wl_block36Bytes = _getBytes( _wl_block36 );

    private final static java.lang.String  _wl_block37 =":&nbsp;<b></label><label id=\"id_item_sal_value\" style=";
    ...
    private final static java.lang.String  _wl_block40 ="</td>\n\t\t\t<td  class=\'fields\' width=\'20%\'>&nbsp;<input type=text name=tot_item_qty id=tot_item_qty size=10 maxlength=10 class=\"NUMBER\"  value=\"";
    private final static byte[]  _wl_block40Bytes = _getBytes( _wl_block40 );

    private final static java.lang.String  _wl_block41 ="\" disabled></td>\n\t\t\t\n\t\t\t<td class = \"label\">&nbsp;</td>\n\t\t\t<td class = \"label\">&nbsp;</td>\n\n\t\t</tr>\n\t\t<tr>\n\t\t\t<td class=label >";
    private final static byte[]  _wl_block41Bytes = _getBytes( _wl_block41 );

    private final static java.lang.String  _wl_block42 ="</td>\n\t\t\t<td colspan=5 class=\'fields\'>&nbsp;<textarea rows=2 cols=50 name=remarks onKeyPress=\"return false;\" onBlur=\"checkRemarksLength(this);\">";
    private final static byte[]  _wl_block42Bytes = _getBytes( _wl_block42 );

    private final static java.lang.String  _wl_block43 ="</textarea><input type=\"hidden\" name=\"remarks_code_1\" id=\"remarks_code_1\" value = \"";
    ...
    private final static java.lang.String  _wl_block45 ="\' class=button onclick=\"editViewBatch();\" ";
    private final static byte[]  _wl_block45Bytes = _getBytes( _wl_block45 );

    private final static java.lang.String  _wl_block46 =">\n\t\t\t\t<input type=button name=batchsearch value=\'";
    private final static byte[]  _wl_block46Bytes = _getBytes( _wl_block46 );

    private final static java.lang.String  _wl_block47 ="\' class=button onclick=\"callBatchSearch();\" ";
    ...
    private final static java.lang.String  _wl_block50 ="\" class=button onclick=\"addToListforBarcode();\">\n\t\t\t\t";
    private final static byte[]  _wl_block50Bytes = _getBytes( _wl_block50 );

    private final static java.lang.String  _wl_block51 ="\" class=button onclick=\"addToList();\">\n\t\t\t\t";
    private final static byte[]  _wl_block51Bytes = _getBytes( _wl_block51 );

    private final static java.lang.String  _wl_block52 ="\n\t\t\t\t<input type=button name=Cancel value=\'";
    private final static byte[]  _wl_block52Bytes = _getBytes( _wl_block52 );

    private final static java.lang.String  _wl_block53 ="\' class=button onclick=\"cancel_me();\">\n\t\t\t</td>\n\t\t</tr>\n\t\t</table>\n\t\t<input type=\"hidden\"\tname=\"stock_item_yn\" id=\"stock_item_yn\"\tvalue=\"";
...
if(site){
            ...
            out.print( String.valueOf(bean.setNumber(tot_item_qty,no_of_decimals)));
...
if(site){ //Added for GHL-CRF-0413 starts
            ...
            out.print( String.valueOf(allow_decimals));
...
putObjectInBean("stockItemConsumptionBean",bean,request);
    ...
    private boolean _jsp__tag10(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag10.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.Edit/View.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag11(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag11.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.BatchSearch.label", java.lang.String .class,"key"));
