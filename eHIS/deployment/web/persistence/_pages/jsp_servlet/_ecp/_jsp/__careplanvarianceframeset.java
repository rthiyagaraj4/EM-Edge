...
public final class __careplanvarianceframeset extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/CarePlanVarianceFrameset.jsp", 1709116573965L ,"10.3.6.0","Asia/Calcutta")) return true;
...
else
{
  action_plan=request.getParameter("actionplan")==null?"":request.getParameter("actionplan");
            ...
            out.print( String.valueOf(action_plan));
            _bw.write(_wl_block11Bytes, _wl_block11);
