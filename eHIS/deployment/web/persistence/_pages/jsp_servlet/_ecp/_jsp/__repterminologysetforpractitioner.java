...
public final class __repterminologysetforpractitioner extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/repTerminologySetForPractitioner.jsp", 1709116614918L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block5 ="\n<BODY  OnMouseDown=\"CodeArrest()\"  onKeyDown = \'lockKey()\'>\n\t<FORM name=\"repTerminologySetForPractitionerForm\" id=\"repTerminologySetForPractitionerForm\" action=\"../../eCommon/jsp/report_options.jsp\" target=\"messageFrame\">\n\t<BR>\n\t<TABLE width=\'80%\' align=\'center\' valign=\'top\'>\n\t\t<TH align=\'left\'> <fmt:message key=\"Common.reportcritera.label\" bundle=\"";
    ...
    private final static java.lang.String  _wl_block8 ="\"/></TD>\n\t\t\t\t\t    </TR>\n\t\t\t\t\t <TR>\n\t\t\t\t\t\t<TD class=\"label\" align=\"right\" nowrap><fmt:message key=\"Common.practitioner.label\" bundle=\"";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\"/>&nbsp;</TD>\n\t\t\t\t\t\t <TD>\n\t\t\t\t\t\t\t<input type=text  name=\'p_Practitioner_code_from\' id=\'p_Practitioner_code_from\' size=\"10\" maxlength=\"10\" align=\"center\">\n\t\t\t\t\t\t\t<input type=\'button\' name=\'Practitionertype\' id=\'Practitionertype\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_Practitioner_code_from)\'>\n\t\t\t\t\t\t </TD>\n\t\t\t\t\t\t<TD>\n\t\t\t\t\t\t\t<input type=text  name=\'p_Practitioner_code_to\' id=\'p_Practitioner_code_to\' size=\"10\" maxlength=\"10\" align=\"center\">\n\t\t\t\t\t\t\t<input type=\'button\' name=\'Practitionertype1\' id=\'Practitionertype1\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_Practitioner_code_to)\'>\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t</TR>\n\t\t\t\n\t\t                <TR>\n\t\t\t\t\t\t<TD align=\"center\" width=\"20\">&nbsp;</TD>\n\t\t\t\t\t\t<TD class=\"label\" width=\"20%\"><fmt:message key=\"Common.from.label\" bundle=\"";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\"/></TD>\n\t\t\t\t\t\t<TD class=\"label\" width=\"47%\">&nbsp;&nbsp;<fmt:message key=\"Common.to.label\" bundle=\"";
