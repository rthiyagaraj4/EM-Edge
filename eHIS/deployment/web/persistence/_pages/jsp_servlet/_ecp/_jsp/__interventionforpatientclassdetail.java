...
public final class __interventionforpatientclassdetail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/InterventionForPatientClassDetail.jsp", 1709116591403L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block30 ="\'onClick=\'unCheckSelectAll(this)\'> </td>\n\t\t\t</tr>\n\t\t\t";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
            ...
            _bw.write(_wl_block1Bytes, _wl_block1);
            webbeans.eCommon.RecordSet InterventionPatient= null;synchronized(session){
                InterventionPatient=(webbeans.eCommon.RecordSet)pageContext.getAttribute("InterventionPatient",javax.servlet.jsp.PageContext.SESSION_SCOPE);
                if(InterventionPatient==null){
                    InterventionPatient=new webbeans.eCommon.RecordSet();
                    pageContext.setAttribute("InterventionPatient",InterventionPatient,javax.servlet.jsp.PageContext.SESSION_SCOPE);
