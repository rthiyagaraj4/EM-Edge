...
public final class __repassessmentbaseddepclassficationlist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/repAssessmentBasedDepClassficationList.jsp", 1709116611199L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block7 ="\"/></TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD class=\"label\" align=\"right\">Accuracy&nbsp;</TD>\n\t\t\t\t\t\t<TD>\n\t\t\t\t\t\t\t<input type=text  name=\'p_Accuracy_code_from\' id=\'p_Accuracy_code_from\' size=\"10\" maxlength=\"10\" align=\"center\">\n\t\t\t\t\t\t\t<input type=\'button\' name=\'Accuracytype\' id=\'Accuracytype\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_Accuracy_code_from)\'>\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t\t<TD>\n\t\t\t\t\t\t\t<input type=text  name=\'p_Accuracy_code_to\' id=\'p_Accuracy_code_to\' size=\"10\" maxlength=\"10\" align=\"center\">\n\t\t\t\t\t\t\t<input type=\'button\' name=\'Accuracytype1\' id=\'Accuracytype1\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_Accuracy_code_to)\'>\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD colspan=\"3\">&nbsp;</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD align=\'right\' width=\'30%\' class=\"label\"><fmt:message key=\"Common.Nature.label\" bundle=\"";
