...
public final class __levelofcarefordependencyheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/LevelOfCareForDependencyHeader.jsp", 1709116594934L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block8 ="\n\t\t\t\t</select>&nbsp;<img src=\'../../eCommon/images/mandatory.gif\'align=\'center\'></img>\n\t\t\t\t</td>\n\t\t\t\t<td colspan=\"2\" align=\"right\"><input type=button class=button value=\'<fmt:message key=\"Common.search.label\" bundle=\"";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\"/>\' onclick=\'searchDetails()\'>&nbsp;&nbsp;&nbsp;</td>\n\t\t\t  </tr>\n\t\t\t <tr><td colspan=\"4\">&nbsp</td></tr>\n\t\t  </table>\t\n\t  </form>\n ";
