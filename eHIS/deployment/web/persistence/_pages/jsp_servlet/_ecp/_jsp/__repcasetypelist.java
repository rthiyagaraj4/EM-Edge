...
public final class __repcasetypelist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/repCaseTypeList.jsp", 1709116611918L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block7 ="\"/></TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD class=\"label\" align=\"right\">Case Type&nbsp;</TD>\n\t\t\t\t\t\t<TD>\n\t\t\t\t\t\t\t<input type=text  name=\'p_case_type_from\' id=\'p_case_type_from\' size=\"10\" maxlength=\"10\" align=\"center\">\n\t\t\t\t\t\t\t<input type=\'button\' name=\'Casetype\' id=\'Casetype\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_case_type_from)\'>\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t\t<TD>\n\t\t\t\t\t\t\t<input type=text  name=\'p_case_type_to\' id=\'p_case_type_to\' size=\"10\" maxlength=\"10\" align=\"center\">\n\t\t\t\t\t\t\t<input type=\'button\' name=\'Casetype1\' id=\'Casetype1\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_case_type_to)\'>\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD colspan=\"3\">&nbsp;</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD align=\'right\' width=\'30%\' class=\"label\">Case Type Nature &nbsp;</TD>\n\t\t\t\t\t\t<TD  width=\'20%\' align=\"left\">\n\t\t\t\t\t\t\t<select name=\'p_casetype_nature\' id=\'p_casetype_nature\'>\n\t\t\t\t\t\t\t\t<option value=\"\"><fmt:message key=\"Common.Both.label\" bundle=\"";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\"/>\n\t\t\t\t\t\t\t\t<option value=\"I\">lllness\n\t\t\t\t\t\t\t\t<option value=\"w\">Wellness\n\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD colspan=\"3\">&nbsp;</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD align=\'right\' width=\'30%\' class=\"label\"><fmt:message key=\"Common.Nature.label\" bundle=\"";
