...
public final class __gcpgeneratecareplantypeframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/GCPGenerateCarePlanTypeFrame.jsp", 1739428023458L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
String queryStr = request.getQueryString();
            ...
            out.print( String.valueOf(queryStr+"&link=Links"));
