...
public final class __genericnameforservicevalidationag extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/GenericNameForServiceValidationAG.jsp", 1709117339492L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	for( int i=0;i<DataList.size();i++ ){
		...
		String dbcode    = (String)dataMap.get( "SERVICE_CODE" ) ;
		String dbeffstat = (String)dataMap.get( "EFF_STATUS" ) ;
			if(hash.containsValue(dbcode)){
				for( int j=0;j<displaySize;j++ ){
					String value =(String)hash.get( "SERVICE_CODE"+j ) ;
					if(value!=null){
