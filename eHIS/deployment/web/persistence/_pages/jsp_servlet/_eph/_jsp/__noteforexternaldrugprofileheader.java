...
public final class __noteforexternaldrugprofileheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/NoteForExternalDrugProfileHeader.jsp", 1709120972769L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\'  onClick=\"popNoteTypeforGroup(document.NoteForExternalDrugheaderform.note_group_code);\"  name=\"notefor_group_search\">\n\t\t\t\t    </td>\n\t\t\t\t\t</tr>\t\t\n\t\t\t</table>\n\t\t\t<input type=\"hidden\" name=\"locale\" id=\"locale\" value=\"";
