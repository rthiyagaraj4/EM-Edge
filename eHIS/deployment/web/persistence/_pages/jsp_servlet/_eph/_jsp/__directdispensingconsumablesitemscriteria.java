...
public final class __directdispensingconsumablesitemscriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/DirectDispensingConsumablesItemsCriteria.jsp", 1709120669454L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="</td>\n\t\t\t\t\t<td class=\"label\"  width=\"50%\"><input type=\'text\' name=\'txt_item_desc\' id=\'txt_item_desc\' size=\'50\' maxlength=\'180\' value=\'\' onblur=\"ConsumableitemSearch();\" ";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 =">\n\t\t\t\t\t<input type=\"button\" name=\"btn_item_search\" id=\"btn_item_search\" value=\"?\" class=\"button\" ";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 =" onClick=\"ConsumableitemSearch();\" ><img  src=\"../../eCommon/images/mandatory.gif\">\n\t\t\t\t\t<input type=\'hidden\' name=\'hdn_item_code\' id=\'hdn_item_code\' value=\'\'>\n\t\t\t\t\t</td>\t\n\t\t\t\t\t<td class=\"label\"  width=\"35%\">&nbsp;</td> \n\t\t\t\t</tr>\t\t\t\t\t\t\n\t\t\t\t<tr> <td colspan=\'3\'>&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\n\t\t\t<input type=\'hidden\' name=\'bean_id\' id=\'bean_id\'           value=\'";
    ...
    private final static java.lang.String  _wl_block20 ="\'>\n\n\t\t\t\n\t\t</form>\n        <SCRIPT>\n           parent.Disp_cons_item_result.document.location.href=\"../../ePH/jsp/DirectDispensingConsumablesItemsDetails.jsp?\"+\'";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		String but_disabled="";
            ...
            out.print( String.valueOf(but_disabled));
            ...
            out.print( String.valueOf((String)param_vals.get(0)));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf((String)param_vals.get(1)));
