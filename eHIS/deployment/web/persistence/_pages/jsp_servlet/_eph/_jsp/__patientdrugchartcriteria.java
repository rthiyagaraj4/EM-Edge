...
public final class __patientdrugchartcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/PatientDrugChartCriteria.jsp", 1721019534060L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block24 ="\" size=\"20\" onKeyPress=\"changeToUpper()\" onblur=\"Duplicatecheck();\"><input type=\"button\" value=\"?\" class=\"button\" name=\"btnPatientID\" id=\"btnPatientID\" onClick=\"callPatientSearch()\"  ";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 =">&nbsp;<img id=\"mandatory\"src=\"../../eCommon/images/mandatory.gif\" ></img> <!--  onfocus=\"callPatientSearch()\" --><!-- Commenting onfocus for ML-BRU-SCF-2218 --><!-- code \'chkPatientID();\'  is replaced by \'Duplicatecheck()\'  for ML-BRU-SCF-0621[IN036565]-->\n\t\t\t\t\t</td>\n\t\t\t\t\t<td width=\"8%\">&nbsp;</td><!-- chagned width for ML-MMOH-SCF-1171-->\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td colspan=\"8\" align=\"right\"> \n\t\t\t\t\t\t<input type=\"button\" name=\"btnSearch\" id=\"btnSearch\" value=\'";
    ...
    private final static java.lang.String  _wl_block34 ="\"><!-- addingfor scf ML-BRU-SCF-0498 [IN:035593] End-->\n\t\t</form>\n\t</body>\n\t<script>\n ";
...
//Added by Himanshu for COMMON-ICN-0182 on 17-10-2023
 ...
 ArrayList nursing_units=bean.getNursingUnit();
            ...
            out.print( String.valueOf(nursing_units.get(i)));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(nursing_units.get(i+1)));
