...
public final class __medicalitemframes extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/MedicalItemFrames.jsp", 1709120929720L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String sStyle=(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	String source_1 = url_1 + params ;
            ...
            out.print( String.valueOf(source_1));
