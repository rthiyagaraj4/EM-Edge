...
public final class __viewdailysequencenumberranges extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/ViewDailySequenceNumberRanges.jsp", 1709121550576L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String sStyle=(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	for(int i=0;i<view_ranges.size();i+=4)
	{
            ...
            out.print( String.valueOf(view_ranges.get(i)));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(view_ranges.get(i+1)));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(view_ranges.get(i+2)));
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("ePH.VIEWRANGES.label", java.lang.String .class,"key"));
