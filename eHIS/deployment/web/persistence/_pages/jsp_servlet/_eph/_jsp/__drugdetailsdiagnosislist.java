...
public final class __drugdetailsdiagnosislist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/DrugDetailsDiagnosisList.jsp", 1709120771300L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//bean.getDrugDetails();
            ...
            out.print( String.valueOf((String)hmRecord.get("TERM_SET")));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf((String)hmRecord.get("DIAG_DESC")));
