...
public final class __batchdetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/BatchDetails.jsp", 1709120621734L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block18 ="</td><!-- \'temp.get(j)\' is replaced with trade_name for ML-BRU-SCF-0883[IN040662] -->\n\t\t\t\t\t\t\t   <!-- below alloc_qty is added instead of temp.get(j+2) sureshkumar T for the Inc:26328[SRR20056-SCF-6782] -->\n\t\t\t\t\t\t\t\t<td class=\"label\" align=\"center\">";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="</td>\n\t\t\t\t\t\t\t\t<td class=\"label\" align=\"center\">";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="&nbsp";
    ...
    private final static java.lang.String  _wl_block26 ="</td><!--\'temp.get(j)\' is replaced with trade_name for ML-BRU-SCF-0883[IN040662] -->\n\t\t\t\t\t\t\t\t<td class=\"label\" align=\"center\">";
...
try{	
	...
	if(tpn_mf_label && batch_data.size()== 0){// if Added for ML-MMOH-CRF-0468
	   ...
	   String temp1="", alloc_qty="", trade_name="";
            ...
            out.print( String.valueOf(temp.get(j+1)));
            _bw.write(_wl_block19Bytes, _wl_block19);
            out.print( String.valueOf(alloc_qty));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(bean.getUomDisplay(facility_id,(String)temp.get(j+3))));
            ...
            out.print( String.valueOf((String)multi_drugs.get(n+1)));
            ...
            out.print( String.valueOf(temp.get(j+2)));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(bean.getUomDisplay(facility_id,(String)temp.get(j+3))));
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("ePH.AllocatedtradeBatchdet.label", java.lang.String .class,"key"));
