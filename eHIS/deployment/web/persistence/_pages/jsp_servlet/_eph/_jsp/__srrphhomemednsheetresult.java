...
public final class __srrphhomemednsheetresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/SRRPhHomeMednSheetResult.jsp", 1722318102164L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//com.ehis.util.DateUtils.convertDate(record[5],"DMY","en",locale)
            ...
            out.print( String.valueOf(com.ehis.util.DateUtils.convertDate(record[5],"DMY","en",locale)));
