...
public final class __oncologyprescriptionmfrview extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/OncologyPrescriptionMFRView.jsp", 1709120983290L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block1 ="\t\t\t<!-- newly added for CRF-673.2 -->\n";
    ...
    private final static java.lang.String  _wl_block36 ="\' id=\'InfOverInHrs";
    ...
    private final static java.lang.String  _wl_block42 ="\' id=\'InfGapInHrs";
    ...
    private final static java.lang.String  _wl_block49 ="\'>\t\n\t\t<script>\n\t\t\tcalculateViewValues(document.formOncoPrescriptionMFR,\'";
...
System.err.println("OncologyPrescriptionMFRView.jsp=====gapInHr====197======>"+gapInHr);
            ...
            out.print( String.valueOf(bean.getUomDisplay((String)session.getValue("facility_id"),volumeUom)));
...
if(drug_code.equals(ext_drug_code) && srlNo.equals(ocurrance_num)){ //if condition added on 10/7/2014
	if(mfr_remarks!=null && !mfr_remarks.equals("")){
            ...
            out.print( String.valueOf(tot_flow_durn));
            _bw.write(_wl_block50Bytes, _wl_block50);
            out.print( String.valueOf(volumeUom));
