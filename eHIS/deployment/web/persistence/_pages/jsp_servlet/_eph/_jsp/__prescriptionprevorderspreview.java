...
public final class __prescriptionprevorderspreview extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/PrescriptionPrevOrdersPreview.jsp", 1709121246567L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	String classValue	=	"";
            ...
            out.print( String.valueOf(preview.get(i+4)));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(preview.get(i+5)+" "+preview.get(i+6)+"&nbsp;-&nbsp;"+preview.get(i+8)+"&nbsp;for&nbsp;"+preview.get(i+9)+" "+preview.get(i+11)));
 ...
 putObjectInBean(bean_id,bean,request); 
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("ePH.PreviewofSelectedOrders.label", java.lang.String .class,"key"));
