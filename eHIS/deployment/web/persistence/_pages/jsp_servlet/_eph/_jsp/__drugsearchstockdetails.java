...
public final class __drugsearchstockdetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/DrugSearchStockDetails.jsp", 1709120820893L ,"10.3.6.0","Asia/Calcutta")) return true;
...
if(stock_values.size()==0) { 
	...
	currentMedicationQuantity = stock_values.get(i+2).toString();
            ...
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block16Bytes, _wl_block16);
            out.print( String.valueOf(currentMedicationQuantity));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(qty_uom));
