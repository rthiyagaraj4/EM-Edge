...
public final class __rerouteprescriptionscireria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/ReRoutePrescriptionsCireria.jsp", 1723782081198L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="</label>&nbsp;&nbsp;&nbsp;<input type=\"text\" maxlength=\"16\" size=\"16\" name=\"dt_to\" id=\"dt_to\" OnBlur=\'ValidateToDate(this)\'><INPUT TYPE=\"image\" SRC=\"../../eCommon/images/CommonCalendar.gif\"\n\t\t\t\t\tid=Calendar onclick=\"showCalendar(\'dt_to\');document.formReRoutePrescriptions.dt_to.focus();\n\t\t\t\t\treturn false;\"><img src=\"../../eCommon/images/mandatory.gif\" align=\"center\"></td>\n\t\t\t\t\t<td class=\"label\"></td>\n\t\t\t\t\t<td class=\"label\"></td>\n\t\t\t\t\t\n\t\t\t\t</tr> -->\n\t\t\t\t<tr>\n";
    ...
    private final static java.lang.String  _wl_block21 ="\"  onBlur=\'callPatientLin(patient_id);checkValue(this);chkPatientID()\'  onKeyPress=\"return CheckForSpecChars(event);changeToUpper()\" value=\"";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\"><input valign=\'top\' type=\'button\' name=\'patient_search\' id=\'patient_search\' value=\'?\' class=\'button\'onClick=\"callPatientLookup();\">&nbsp;<img src=\"../../eCommon/images/mandatory.gif\">\n\t\t\t\t\t\t<input type=\"text\" size =\"30\" name=\"patient_name\" id=\"patient_name\"  id=\"patient_detail\" readonly>\n\t\t\t\t\t</td>\n\t\t\t\t\t<td  class=\"label\"></td>\t\n\t\t\t\t\t<td  class=\"label\"></td>\t\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t <td  class=\"label\"  >";
    ...
    private final static java.lang.String  _wl_block24 ="\' class=\"button\" onClick=\"callResultPage()\">\n\t\t\t\t\t</td>\n\t\t\t\t\t<td  class=\"label\"></td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\t<input type=\"hidden\" name=\"language_id\" id=\"language_id\" value=\"";
    ...
    private final static java.lang.String  _wl_block30 ="\"> <!-- added for Bru-HIMS-CRF-090 [IN:029956] -->\n\t\t\t<input type=\"hidden\" name=\"disp_locn_code\" id=\"disp_locn_code\" value=\"";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 ="\"> <!-- added for Bru-HIMS-CRF-090 [IN:029956] -->\n\t\t</form>\n\t</BODY>\n";
...
//ends
 ...
 for(int i=0; i<disp_locn.size();  i+=2) { 
            ...
            out.print( String.valueOf((String)disp_locn.get(i)));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf((String)disp_locn.get(i+1)));
    ...
    private boolean _jsp__tag5(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag5.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.OrderID.label", java.lang.String .class,"key"));
