...
public final class __srrnarcotictypeapprovalformquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/SRRNarcoticTypeApprovalFormQueryCriteria.jsp", 1722318097997L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\" ><input valign=\'top\' type=\'button\' name=\'patient_search\' id=\'patient_search\' value=\'?\' class=\'button\'\n\t\tonfocus=\"callPatientLookup();\" onClick=\"callPatientLookup();\"></td>\n\n\t\n\n\t\t<td  class=\"label\" nowrap>";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="&nbsp;&nbsp;</td>\n\t\t<td nowrap>&nbsp;<input type=\"text\" name=\"p_disp_date_from\" id=\"p_disp_date_from\" value=\"";
    ...
    private final static java.lang.String  _wl_block14 ="</label></td>\n\t\t<td nowrap>&nbsp;<input type=\"text\" name=\"p_disp_date_to\" id=\"p_disp_date_to\" value=\"";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	String SQL_PH_DRUG_SEARCH_DRUG	=	"SELECT DRUG_CODE code, DRUG_DESC description FROM PH_DRUG_LANG_VW PH_DRUG WHERE  DISCONTINUED_YN='N' AND UPPER(DRUG_CODE) LIKE UPPER(?) AND UPPER(DRUG_DESC) LIKE UPPER(?) and drug_yn='Y' AND LANGUAGE_ID =";
            ...
            out.print( String.valueOf(SQL_PH_DRUG_SEARCH_DRUG));
 ...
 putObjectInBean(bean_id,bean,request); 
    ...
    private boolean _jsp__tag5(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag5.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("ePH.NarcoticNo.label", java.lang.String .class,"key"));
