...
public final class __querymednadminchartcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/QueryMednadminChartCriteria.jsp", 1709121343987L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="\" onKeyPress=\"uppercase()\" onBlur=\"Duplicatecheck();defaultEncounter(this.value,\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\')\"> <!-- bean.getPatientIDLength() added ML-BRU-SCF-0499[IN035594] and SKR-SCF-0721[IN036365] --><!--  Duplicatecheck(); added for ML-BRU-SCF-0621[IN036565]-->\n\t\t\t\t\t<INPUT TYPE=\"button\" name=\"Patient_Button\" id=\"Patient_Button\" VALUE=\"?\" CLASS=\"button\" \n\t\t\t\t\tonClick=\"callPatientSearch(document.FormQueryMednAdminChart.Patient_Id)\" >&nbsp;<img src=\"../../eCommon/images/mandatory.gif\">\n\t\t\t\t</td>\n\t\t\t\t<td class=\"label\" >";
