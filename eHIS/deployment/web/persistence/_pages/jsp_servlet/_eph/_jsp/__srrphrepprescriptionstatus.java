...
public final class __srrphrepprescriptionstatus extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/SRRPhRepPrescriptionStatus.jsp", 1709121478656L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	Hashtable result = bean.getStatusDesc();
            ...
            out.print( String.valueOf(result.get("OS")));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(result.get("RG")));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(result.get("DP")));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(result.get("DF")));
