...
public final class __querypatientdrugprofilepatientline extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/QueryPatientDrugProfilePatientLine.jsp", 1709121352846L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\n\t\t\t\t\t\t\t<img src=\'../../ePH/images/stop.gif\'  height=\'15\'  width=\'15\' title=\'";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0086
		...
		if(sex.equalsIgnoreCase("female"))
            ...
            out.print( String.valueOf(deceased_dtl));
