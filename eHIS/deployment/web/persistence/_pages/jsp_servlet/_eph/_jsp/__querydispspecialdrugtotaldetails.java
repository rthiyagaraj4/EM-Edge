...
public final class __querydispspecialdrugtotaldetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/QueryDispSpecialDrugTotalDetails.jsp", 1709121326003L ,"10.3.6.0","Asia/Calcutta")) return true;
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0086
	...
	String sql=PhRepository.getPhKeyValue("SQL_QUERY_DISP_SPECIAL_DRUG_SELECT3");
