...
public final class __editdisplabelsearchresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/EditDispLabelSearchResult.jsp", 1709120829799L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="</td>\n\t\t\t\t\t\t<!--disp_details.get(i+1) is encoded for SRR20056-SCF-6260[Incident No.25586] -->\n\t\t\t\t\t\t<td  onClick=\"loadEditLabelDialog(\'";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\',\'";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\')\"><a href=\"#\">";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="</a></td> <!-- patient_class -- disp_details.get(i+8) added for Added for Bru-HIMS-CRF-414 [IN045554]-->\n\t\t\t\t\t</tr>\n";
	...
	ArrayList disp_details  = (ArrayList) bean.getDispenseDetails(patient_id, dispense_no, dispense_date, facility_id);
		...
		if(disp_details.size() > 0){
            ...
            out.print( String.valueOf(disp_details.get(i)));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(disp_details.get(i+1)));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(disp_details.get(i+2)));
            _bw.write(_wl_block16Bytes, _wl_block16);
            out.print( String.valueOf(com.ehis.util.DateUtils.convertDate((String) disp_details.get(i+3),"DMYHM","en",locale)));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(disp_details.get(i)));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(java.net.URLEncoder.encode((String)disp_details.get(i+1),"UTF-8")));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(disp_details.get(i+2)));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(disp_date));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(disp_details.get(i+4)));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(java.net.URLEncoder.encode(Practitioner,"UTF-8")));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(disp_details.get(i+6)));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(disp_details.get(i+7)));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(disp_details.get(i+8)));
...
putObjectInBean(bean_id,bean,request);
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("ePH.EditLabel.label", java.lang.String .class,"key"));
