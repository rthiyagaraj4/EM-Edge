...
public final class __genericnameforservicedtlsasscbygen extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/GenericNameForServiceDtlsAsscbyGen.jsp", 1709120859173L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\n\t<table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'90%\' align=\'center\'>\n\t<tr  width=\'10%\'>\n\t\t<td class=\'WHITE\'>\n\t\t  <p>\n\t\t\t<a href=\"javascript:goPrevbyGeneric(\'association\');\" id=\"prev\"  style=\"visibility:hidden\" >";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="</a>&nbsp;&nbsp;<a href=\"javascript:goNextbyGeneric(\'association\');\" id=\"next\" style=\"visibility:hidden\" >";
    ...
    private final static java.lang.String  _wl_block28 ="\"  width=\"10%\"><input type=\"checkbox\" ";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 ="  name=\"eff_status";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 ="\" onclick=\"assignEffStatusAssociation(this);\" ";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 =" ></input></td>\n\t\t\t<td class=\"";
    private final static byte[]  _wl_block31Bytes = _getBytes( _wl_block31 );

    private final static java.lang.String  _wl_block32 ="\"  width=\"10%\">\n\t\t\t";
    private final static byte[]  _wl_block32Bytes = _getBytes( _wl_block32 );

    private final static java.lang.String  _wl_block33 ="\n\t\t\t<input type=\"hidden\"  name=\"oper_mode";
    private final static byte[]  _wl_block33Bytes = _getBytes( _wl_block33 );

    private final static java.lang.String  _wl_block34 ="\" id=\"oper_mode";
    private final static byte[]  _wl_block34Bytes = _getBytes( _wl_block34 );

    private final static java.lang.String  _wl_block35 ="\" ></input>\n\t";
    private final static byte[]  _wl_block35Bytes = _getBytes( _wl_block35 );

    private final static java.lang.String  _wl_block36 ="\n\t\t\t<input type=\"checkbox\"  name=\"oper_mode";
    private final static byte[]  _wl_block36Bytes = _getBytes( _wl_block36 );

    private final static java.lang.String  _wl_block37 ="\" onclick=\"assignValueAssociation(this);\"  ";
    ...
    private final static java.lang.String  _wl_block52 ="\" name=\"end\">\n<input type=\"hidden\" value=\"";
    private final static byte[]  _wl_block52Bytes = _getBytes( _wl_block52 );

    private final static java.lang.String  _wl_block53 ="\" name=\"start\">\n<input type=\"hidden\" value=\"";
    private final static byte[]  _wl_block53Bytes = _getBytes( _wl_block53 );

    private final static java.lang.String  _wl_block54 ="\" name=\"count\">\n<input type=\"hidden\" value=\"association\" name=\"choosen_link\" id=\"choosen_link\">\n<input type=\"hidden\" name=\"bean_id\" id=\"bean_id\" value=\"";
...
//		initString="";
		...
		if ( count % 2 == 0 )
				...
				classvalue = "QRYODD" ;
	if(chkCount==0){
	//initString=((String)dataList.get("EFF_STATUS"))+"|"+((String)dataList.get("OPER_MODE"))+"|"+(String)dataList.get("SERVICE_CODE")+"|"+(String)dataList.get("SHORT_DESC");
	initString=initString.append(((String)dataList.get("EFF_STATUS"))).append("|").append(((String)dataList.get("OPER_MODE"))).append("|").append((String)dataList.get("SERVICE_CODE")).append("|").append((String)dataList.get("SHORT_DESC"));
	}
	else{
	//initString+="~"+((String)dataList.get("EFF_STATUS"))+"|"+((String)dataList.get("OPER_MODE"))+"|"+(String)dataList.get("SERVICE_CODE")+"|"+(String)dataList.get("SHORT_DESC");
	initString=initString.append("~").append(((String)dataList.get("EFF_STATUS"))).append("|").append(((String)dataList.get("OPER_MODE"))).append("|").append((String)dataList.get("SERVICE_CODE")).append("|").append((String)dataList.get("SHORT_DESC"));
	}
	...
	if( ((String)dataList.get("SOURCE")).equals("FB") ){
		...
		if(((String)dataList.get("EFF_STATUS")).equals("E")){
            ...
            out.print( String.valueOf(count));
            _bw.write(_wl_block24Bytes, _wl_block24);
            out.print( String.valueOf( (String)dataList.get("SERVICE_CODE") ));
