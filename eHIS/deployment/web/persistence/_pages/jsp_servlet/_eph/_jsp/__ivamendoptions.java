...
public final class __ivamendoptions extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/IVAmendOptions.jsp", 1709120884919L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block20 ="\');\"></td>\n\t\t\t\t<td class=\"CURRTEXT\" align=\"left\" width=\"70%\"><!--  -->\n\t\t\t\t<!-- <marquee scrollamount=\"3\" title=\"Click Current Rx button to View Current Medication\"><font  style=\"font-weight:bold;color:black\" size=1></font></marquee> -->\n\t\t\t\t</td>\t\t\t\n\t\t\t<td class=\"label\" align=\"center\" width=\"15%\"><input type=\'button\' class=\'button\' onClick=\"showDrugProfile(\'";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\')\" value=\'Drug Profile\'></a></td>\n\t\t\t\n\t\t</tr>\n\t\t</table>\n\t\t<!--CurrentRx table ends-->\n";
