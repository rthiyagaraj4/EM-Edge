...
public final class __mrepcompositionclass extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoh/jsp/MRepCompositionClass.jsp", 1742903081968L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 =" &nbsp;</td>\n\t\t\t<td width=\"25%\" class=\"label\">\n\t\t\t<select name=\"p_composition_class_code_from\" id=\"p_composition_class_code_from\">\n\t\t\t\t<option value=\"\">";
    ...
    private final static java.lang.String  _wl_block17 =" &nbsp;</td>\n\t\t\t<td width=\"25%\" class=\"label\">\n\t\t\t<select name=\"p_composition_class_code_to\" id=\"p_composition_class_code_to\">\n\t\t\t\t<option value=\"\">";
...
try{
	...
	con=ConnectionManager.getConnection(request);
            ...
            _bw.write(_wl_block12Bytes, _wl_block12);
				...
				try{
					pstmt=con.prepareStatement("SELECT COMPOSITION_CLASS_CODE, COMPOSITION_CLASS_DESC FROM OH_COMPOSITION_CLASS_LANG_VW WHERE LANGUAGE_ID=? ORDER BY COMPOSITION_CLASS_DESC");
					pstmt.setString(1,locale);
					rs=pstmt.executeQuery();
					while(rs.next()){
						composition_class_code=rs.getString(1);
						composition_class_desc=rs.getString(2);
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOH.CompositionClassCodeFrom.Label", java.lang.String .class,"key"));
