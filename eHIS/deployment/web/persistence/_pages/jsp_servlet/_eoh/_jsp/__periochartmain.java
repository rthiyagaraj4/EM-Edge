...
public final class __periochartmain extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoh/jsp/PerioChartMain.jsp", 1709119355051L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 request.setCharacterEncoding("UTF-8"); 
	...
	try{
		con=ConnectionManager.getConnection(request);
            ...
            out.print( String.valueOf(ca_params));
