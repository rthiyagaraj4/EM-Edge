...
public final class __printchart extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoh/jsp/PrintChart.jsp", 1709119365036L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 request.setCharacterEncoding("UTF-8");
	...
	try{
		...
		if(con!=null) 
            ...
            out.print( String.valueOf(flag_print));
            ...
            out.print( String.valueOf(count_charts));
