...
public final class __perioevalchartrecord extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoh/jsp/PerioEvalChartRecord.jsp", 1709119360739L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block21 ="\' onclick =\"actionToServlet()\">&nbsp;\n\t\t\t\t\t<input type=\"button\" class=\"button\" name=\"reset\" id=\"reset\" value=\'";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\' onclick=\"reset_record()\">\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t</table>\n\t\t\n\t\t<input type = \"hidden\" name= \"patient_id\" value = \"";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
 request.setCharacterEncoding("UTF-8"); 
	...
	if(eval_active_yn.equals("N")||other_facilitychart_yn.equals("Y")){
		disabled = "disabled";
	}
...
try{
	...
	while(rs!= null && rs.next()){
		facility_name = checkForNull(rs.getString("FACILITY_NAME"));
            ...
            _bw.write(_wl_block11Bytes, _wl_block11);
							...
							if(rs != null) rs.close();
							if(pstmt != null) pstmt.close();
							if(!perio_chart.equals("")){//Added by SRidevi Joshi on 4/29/2010 for PE
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOH.ToothNo.Label", java.lang.String .class,"key"));
