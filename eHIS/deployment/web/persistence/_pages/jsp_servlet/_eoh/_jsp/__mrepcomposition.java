...
public final class __mrepcomposition extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoh/jsp/MRepComposition.jsp", 1742903061922L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 =" &nbsp;</td>\n\t\t\t<td width=\"25%\" class=\"label\">\n\t\t\t<select name=\"p_composition_code_from\" id=\"p_composition_code_from\">\n\t\t\t\t<option value=\"\">";
    ...
    private final static java.lang.String  _wl_block17 =" &nbsp;</td>\n\t\t\t<td width=\"25%\" class=\"label\">\n\t\t\t<select name=\"p_composition_code_to\" id=\"p_composition_code_to\">\n\t\t\t\t<option value=\"\">";
...
try{
	...
	con=ConnectionManager.getConnection(request);
            ...
            _bw.write(_wl_block12Bytes, _wl_block12);
				...
				try{
					pstmt=con.prepareStatement("SELECT COMPOSITION_CODE, COMPOSITION_DESC FROM OH_COMPOSITION_LANG_VW WHERE LANGUAGE_ID=? ORDER BY COMPOSITION_DESC");
					pstmt.setString(1,locale);
					rs=pstmt.executeQuery();
					while(rs.next()){
						composition_code=rs.getString(1);
						composition_desc=rs.getString(2);
				
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(composition_code));
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOH.CompositionFrom.Label", java.lang.String .class,"key"));
