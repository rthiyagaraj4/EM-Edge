...
public final class __repdeptroomlist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/repDeptRoomList.jsp", 1710449938326L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block14 ="&nbsp;</td>\n\t\t\t\t\t\t<td width=\'20%\'  ><input type=text  name=\'p_fm_dept_code\' id=\'p_fm_dept_code\' size=\"10\" maxlength=\"10\" align=\"center\" onblur=\'if(this.value !=\"\") open_lookup(department_fm, p_fm_dept_code,p_fm_dept)\'><input type=\"hidden\" name=\"p_fm_dept\" id=\"p_fm_dept\"><input type=\'button\' name=\'department_fm\' id=\'department_fm\' value=\'?\' class=\'button\' onclick=\'open_lookup(this, p_fm_dept_code,p_fm_dept)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td width=\'40%\'> <input type=text  name=\'p_to_dept_code\' id=\'p_to_dept_code\' size=\"10\" maxlength=\"10\" align=\"center\" onblur=\'if(this.value !=\"\") open_lookup(department_to, p_to_dept_code,p_to_dept)\'><input type=\"hidden\" name=\"p_to_dept\" id=\"p_to_dept\"><input type=\'button\' name=\'department_to\' id=\'department_to\' value=\'?\' class=\'button\' onclick=\'open_lookup(this, p_to_dept_code,p_to_dept)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t<Td>&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\'right\' width=\'30%\' class=\"label\">";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="&nbsp;</td>\n\t\t\t\t\t<td width=\'20%\'  ><input type=text  name=\'p_fm_service_code\' id=\'p_fm_service_code\' size=\"4\" maxlength=\"4\" align=\"center\" onblur=\'if(this.value !=\"\") searchCode(service_fm, p_fm_service_code,p_fm_service)\'><input type=\"hidden\" name=\"p_fm_service\" id=\"p_fm_service\"><input type=\'button\' name=\'service_fm\' id=\'service_fm\' value=\'?\' class=\'button\' onclick=\'open_lookup(this, p_fm_service_code,p_fm_service)\'>\n\t\t\t\t\t</td>\n\t\t\t\t\t<td width=\'40%\'> <input type=text  name=\'p_to_service_code\' id=\'p_to_service_code\' size=\"4\" maxlength=\"4\" align=\"center\" onblur=\'if(this.value !=\"\") searchCode(service_to, p_to_service_code,p_to_service)\'><input type=\"hidden\" name=\"p_to_service\" id=\"p_to_service\" ><input type=\'button\' name=\'service_to\' id=\'service_to\' value=\'?\' class=\'button\' onclick=\'open_lookup(this, p_to_service_code,p_to_service)\'>\n\t\t\t\t\t</td>\n\t\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t\t\t\t\t<Td>&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t\t\t<td align=\'right\' width=\'30%\' class=\"label\">";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="&nbsp;</td>\n\t\t\t\t\t\t\t\t\t<td width=\'20%\'  ><input type=text  name=\'p_fm_room_num\' id=\'p_fm_room_num\' size=\"10\" maxlength=\"10\" align=\"center\" onblur=\'if(this.value !=\"\") open_lookup(this,p_fm_room_num,p_fm_room)\'><input type=\"hidden\" name=\"p_fm_room\" id=\"p_fm_room\"><input type=\'button\' name=\'room_fm\' id=\'room_fm\' value=\'?\' class=\'button\' onclick=\'open_lookup(this,p_fm_room_num,p_fm_room)\'>\n\t\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t\t\t<td width=\'40%\'> <input type=text  name=\'p_to_room_num\' id=\'p_to_room_num\' size=\"10\" maxlength=\"10\" align=\"center\"  onblur=\'if(this.value !=\"\") open_lookup(this,p_to_room_num,p_to_room)\'><input type=\"hidden\" name=\"p_to_room\" id=\"p_to_room\"><input type=\'button\' name=\'room_to\' id=\'room_to\' value=\'?\' class=\'button\' onclick=\'open_lookup(this,p_to_room_num,p_to_room)\'>\n\t\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t\t\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t\t\t\t\t\t\t\t\t<Td>&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\'right\' width=\'30%\' class=\"label\">\n\t\t\t\t\t\t";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
    ...
    private boolean _jsp__tag6(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag6.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.ServiceCode.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag7(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag7.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.roomno.label", java.lang.String .class,"key"));
