...
public final class __discrmsrcompgridpreview extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/DiscrMsrCompGridPreview.jsp", 1732528105005L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block5 ="  <!-- Display the cleaned grid component XML -->\n        </COL>\n    </ROW>\n</USER-TEMPLATE>\n\n</DOCUMENT>\n";
    ...
    String gridComponentXMLString = gridComponentXML.toString().replace("<style>", "<style>textarea {resize: none;}</style>");
            ...
            out.print( String.valueOf( gridComponentXMLString ));
