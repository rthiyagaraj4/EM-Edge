...
public final class __servervalidation extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/ServerValidation.jsp", 1718010173499L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block4 ="\n<script>\n\t\t/*\t\n\t\tvar maxAge = parent.f_query_add_mod.document.OtherStaff_sub.document.OtherStaff1_form.max_pa_age.value;\n\t\tvar actAge =parent.f_query_add_mod.document.OtherStaff_sub.document.getElementById(\'b_age\').value;\n\t\tvar actMonth =parent.f_query_add_mod.document.OtherStaff_sub.document.getElementById(\'b_months\').value;\n\t\tvar actDay =parent.f_query_add_mod.document.OtherStaff_sub.document.getElementById(\'b_days\').value; \n\t\tif (maxAge != \'\')\n\t\t{\n\t\t\tif (parseInt(actAge) > parseInt(maxAge))\n\t\t\t{\n\t\t\t\tvar msg= getMessage(\"MAX_PATIENT_AGE\",\'MP\')+\" \"+maxAge+\" \"+ getLabel(\"Common.Years.label\",\"common\");\n\t\t\t\talert(msg);\n\t\t\t\tparent.f_query_add_mod.document.OtherStaff_sub.document.getElementById(\'b_age\').focus();\n\t\t\t}\n\t\t}\n\t\t*/\n\t\t\n\t\tvar maxAge = parent.f_query_add_mod.document.practitioner_sub.document.practitioner1_form.max_pa_age.value;\n\t\t//var maxAge = \"120\";\n\t\tvar actAge =parent.f_query_add_mod.document.practitioner_sub.document.getElementById(\'b_age\').value;\n\t\tvar actMonth =parent.f_query_add_mod.document.practitioner_sub.document.getElementById(\'b_months\').value;\n\t\tvar actDay =parent.f_query_add_mod.document.practitioner_sub.document.getElementById(\'b_days\').value; \n\t\tif (maxAge != \'\')\n\t\t{\n\t\t\tif (parseInt(actAge) > parseInt(maxAge))\n\t\t\t{\n\t\t\t\tvar msg= getMessage(\"MAX_PATIENT_AGE\",\'MP\')+\" \"+maxAge+\" \"+ getLabel(\"Common.Years.label\",\"common\");\n\t\t\t\talert(msg);\n\t\t\t\tparent.f_query_add_mod.document.practitioner_sub.document.getElementById(\'b_age\').focus();\n\t\t\t}\n\t\t}\n\t\t\n\t\t\n\t\t\n\t\t\n\t\t\n\t\t\n\t\n</script>\n\n\t\t";
