...
public final class __serviceforspecialityquery extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/ServiceforSpecialityQuery.jsp", 1741246402065L ,"10.3.6.0","Asia/Calcutta")) return true;
...
secondItem.add("service_name"); //name of field
...
orderByColVals[2] = "am_service_for_speciality.speciality_code";
orderByColVals[3] = "am_speciality.short_desc";
orderByColVals[4] = "am_service_for_speciality.service_code";
orderByColVals[5] = "am_service.short_desc";

strbuff = qrypg.getQueryPage(con,finAr,"Find Service For Speciality","../../eAM/jsp/ServiceforSpecialityQueryResult.jsp",com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.SortOrder.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.QueryCriteria.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.defaultSelect.label","common_labels") ,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.orderBy.label","common_labels"),orderByCols, orderByColVals,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ExecuteQuery.label","common_labels"));
