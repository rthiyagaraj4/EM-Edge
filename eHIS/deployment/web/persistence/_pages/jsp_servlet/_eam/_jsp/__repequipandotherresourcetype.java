...
public final class __repequipandotherresourcetype extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/repEquipandOtherResourceType.jsp", 1710449896592L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block7 ="\'></link>\n<script src=\"../../eCommon/js/ValidateControl.js\"></script>\n<script src=\'../../eCommon/js/common.js\' language=\'javascript\'></script>\n<script src=\"../../eCommon/js/CommonLookup.js\" language=\"JavaScript\"></Script>\n<script src=\'../../eCommon/js/showModalDialog.js\' language=\'JavaScript\'></script>\n\n\n\n<script>\n/*function searchCode(obj,target)\n\t{\n\t\t\tvar retVal = \tnew String();\n\t\t\tvar dialogHeight= \"28\" ;\n\t\t\tvar dialogWidth\t= \"43\" ;\n\t\t\tvar status = \"no\";\n\t\t\tvar arguments\t= \"\" ;\n\t\t\tvar sql=\"\";\n\t\t\tvar search_code=\"\";\n\t\t\tvar search_desc=\"\";\n\t\t\tvar tit=\"\";\n\t\t\tvar locale=document.forms[0].locale.value;\n\t\t\t\n\t\t\tif(obj.name==\"resourcetypecode\")\n\t\t\t{\n\t\t\t\ttit=encodeURIComponent(getLabel(\"Common.resourcetype.label\",\"Common\"));\n\t\t\t\tsql=\"select resource_type,long_desc from am_resource_type_lang_vw where language_id=`\"+locale+\"` \";\n\t\t\t\tsearch_code=\"resource_type\";\n\t\t\t\tsearch_desc= \"long_desc\";\n\t\t\t}\n\t\t\t\n\t\t\tvar features\t= \"dialogHeight:\" + dialogHeight + \"; dialogWidth:\" + dialogWidth +\" ; scroll=no; status:\" + status;\n\t\t\tretVal = window.showModalDialog(\"../../eCommon/jsp/GeneralSearch.jsp?SQL=\"+sql+\"&search_code=\"+search_code+\"&search_desc=\"+search_desc+\"&title=\"+tit,arguments,features);\n\n\t\t\tif (!(retVal == null))\n\t\t\t{\n\t\t\t\ttarget.value=retVal;\n\t\t\t}\n\t\t\telse\n\t\t\t\ttarget.focus();\n\t}*/\n\n\tasync function searchCode_fm()\n\t\t\t\t{\n\n\n\t\t\t\tvar retVal =    new String();\n\t\t\t\tvar argumentArray  = new Array() ;\n\t\t\t\tvar dataNameArray  = new Array() ;\n\t\t\t\tvar dataValueArray = new Array() ;\n\t\t\t\tvar dataTypeArray  = new Array() ;\n\t\t\t\tvar locale=document.forms[0].locale.value;\n\t\t\t\tvar tit=getLabel(\"Common.resourcetype.label\",\"Common\");\n\n\t\t\t\tsql=\"select resource_type code,long_desc description from am_resource_type where upper(resource_type) like upper(?) and upper(long_desc) like upper(?) order by 2\";\n\t\t\t\n\t\t\t\t\t\n\t\t\t\targumentArray[0] = sql;\n\t\t\t\targumentArray[1] = dataNameArray ;\n\t\t\t\targumentArray[2] = dataValueArray ;\n\t\t\t\targumentArray[3] = dataTypeArray ;\n\t\t\t\targumentArray[4] = \"1,2\";\n\t\t\t\targumentArray[5] = document.forms[0].p_fm_resource_code.value;\n\t\t\t\targumentArray[6] = CODE_LINK ;\n\t\t\t\targumentArray[7] = CODE_DESC ;\n\t\t\t\t\n\t\t\t\tretVal = await CommonLookup( tit, argumentArray );\n\t\t\t\tif (retVal !=null && retVal !=\"\")\n\t\t\t\t{\n\t\t\t\t\tvar ret1=unescape(retVal);\n\t\t\t\t\tarr=ret1.split(\",\");\n\t\t\t\t\tdocument.forms[0].p_fm_resource.value=arr[1];\n\t\t\t\t\tdocument.forms[0].p_fm_resource_code.value=arr[0];\n\t\t\t\t}else\n\t\t\t\t{\n\t\t\t\tdocument.forms[0].p_fm_resource.value=\"\";\n\t\t\t\tdocument.forms[0].p_fm_resource_code.value=\"\";\n\t\t\t\t}\n\t\t\t\n\t\t\t}\n\n\n\t\t\tasync function searchCode_to()\n\t\t\t\t{\n\n\n\t\t\t\tvar retVal =    new String();\n\t\t\t\tvar argumentArray  = new Array() ;\n\t\t\t\tvar dataNameArray  = new Array() ;\n\t\t\t\tvar dataValueArray = new Array() ;\n\t\t\t\tvar dataTypeArray  = new Array() ;\n\t\t\t\tvar locale=document.forms[0].locale.value;\n\t\t\t\tvar tit=getLabel(\"Common.resourcetype.label\",\"Common\");\n\n\t\t\t\tsql=\"select resource_type code,long_desc description from am_resource_type where upper(resource_type) like upper(?) and upper(long_desc) like upper(?) order by 2\";\n\t\t\t\t\n\t\t\t\t\n\t\t\t\t\t\n\t\t\t\targumentArray[0] = sql;\n\t\t\t\targumentArray[1] = dataNameArray ;\n\t\t\t\targumentArray[2] = dataValueArray ;\n\t\t\t\targumentArray[3] = dataTypeArray ;\n\t\t\t\targumentArray[4] = \"1,2\";\n\t\t\t\targumentArray[5] = document.forms[0].p_to_resource_code.value;\n\t\t\t\targumentArray[6] = CODE_LINK ;\n\t\t\t\targumentArray[7] = CODE_DESC ;\n\t\t\t\t\n\t\t\t\tretVal = await CommonLookup( tit, argumentArray );\n\t\t\t\tif (retVal !=null && retVal !=\"\")\n\t\t\t\t{\n\t\t\t\t\tvar ret1=unescape(retVal);\n\t\t\t\t\tarr=ret1.split(\",\");\n\t\t\t\t\tdocument.forms[0].p_to_resource.value=arr[1];\n\t\t\t\t\tdocument.forms[0].p_to_resource_code.value=arr[0];\n\t\t\t\t}else\n\t\t\t\t{\n\t\t\t\tdocument.forms[0].p_to_resource.value=\"\";\n\t\t\t\tdocument.forms[0].p_to_resource_code.value=\"\";\n\t\t\t\t}\n\t\t\t\n\t\t\t}\n\n</script>\n</HEAD>\n\n<BODY onLoad=\"Focusing(\'p_fm_resource_code\')\" onMouseDown=\"CodeArrest();\" onKeyDown = \"lockKey();\">\n<br>\n<br>\n<form name=\"repResourceType\" id=\"repResourceType\" action=\"../../eCommon/jsp/report_options.jsp\" target=\"messageFrame\">\n<table width=\'80%\' align=\'center\' valign=\'top\'>\n\n\t\t<th align=\'left\'> ";
    ...
    private final static java.lang.String  _wl_block19 ="&nbsp;</td>\n\t\t\t\t\t\t<td width=\'20%\'  ><input type=text  name=\'p_fm_resource_code\' id=\'p_fm_resource_code\' size=\"2\" maxlength=\"2\" align=\"center\" onblur=\'if(this.value !=\"\") searchCode_fm()\'><input type=\"hidden\" name=\"p_fm_resource\" id=\"p_fm_resource\"><input type=\'button\' name=\'resourcetypecode\' id=\'resourcetypecode\' value=\'?\' class=\'button\' onclick=\'searchCode_fm()\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td width=\'40%\'> <input type=text  name=\'p_to_resource_code\' id=\'p_to_resource_code\' size=\"2\" maxlength=\"2\" align=\"center\" onblur=\'if(this.value !=\"\") searchCode_to()\'><input type=\"hidden\" name=\"p_to_resource\" id=\"p_to_resource\"><input type=\'button\' name=\'resourcetypecode\' id=\'resourcetypecode\' value=\'?\' class=\'button\' onclick=\'searchCode_to()\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t\t<Td>&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\'right\' width=\'30%\' class=\"label\">";
...
Statement stmt =null;
	ResultSet rs =null;
            ...
            _bw.write(_wl_block12Bytes, _wl_block12);
					...
					try {
							  ...
							  String sql = "select distinct resource_class from AM_RESOURCE_TYPE";
    ...
    private boolean _jsp__tag6(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag6.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eAM.ResourceTypecode.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag10(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag10.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.Disabled.label", java.lang.String .class,"key"));
