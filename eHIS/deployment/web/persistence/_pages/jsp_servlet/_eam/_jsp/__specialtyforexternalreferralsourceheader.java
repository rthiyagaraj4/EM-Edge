...
public final class __specialtyforexternalreferralsourceheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/SpecialtyForExternalReferralSourceHeader.jsp", 1744281408445L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\' onClick=\'searchValues()\'></td> -->\n    \t\t\t\t</tr>\n    \t\t\t\t<tr><td colspan=\'4\'>&nbsp;</td></tr>\n\n\t\t\t\t\t<tr>\n\n\t\t\t\t\t<td colspan=\'1\'>&nbsp;</td>\n\t\t\t\t\n\t\t\t\t\t<td class=\'label\'  id = lab1 >";
