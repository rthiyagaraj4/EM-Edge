...
public final class __functionsforstatusmain extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/FunctionsForStatusMain.jsp", 1709120220000L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	//	sql="SELECT STATUS_DESC, STATUS_CODE FROM OT_STATUS ORDER BY 1 ";
		...
		if(rs!=null)
		{
		   while(rs.next())
            ...
            out.print( String.valueOf(status_code));
