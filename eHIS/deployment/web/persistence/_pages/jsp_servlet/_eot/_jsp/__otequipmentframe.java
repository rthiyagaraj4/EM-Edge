...
public final class __otequipmentframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/OTEquipmentFrame.jsp", 1709120286000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\' width=\"400\" height=\"400\" align=\"middle\">\n\t\t\t<!-- img src =\' \' width=\"350\" height=\"350\" align=\"middle\"> -->\t\t\t\n\t\t</td>\t\t\n\t</tr>\n\t<tr>\n<!-- RUT-CRF-0091 by MuthuN Starts Here-->\n\t<td><br><br><center>\n\t";
...
try{ 
	sql_image_flag = imageUrl+(char)92+eq_image;	
}
catch(Exception e){
	System.err.println("Err Msg Copying File "+e.getMessage());
            ...
            out.print( String.valueOf(eq_location));
