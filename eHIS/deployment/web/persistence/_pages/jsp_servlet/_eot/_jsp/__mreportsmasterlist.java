...
public final class __mreportsmasterlist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/MReportsMasterList.jsp", 1709120250000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\' onClick=\"callDetailForm();\"  ></td>\n\t<td align=\"right\" class=\"label\">\n\t\t<input type=\"button\" class=\"button\" name=\"clear\" id=\"clear\" value=\'";
 ...
 try
      {
		...
		if(rs!=null)
		{
		   while(rs.next())
            ...
            out.print( String.valueOf(master_code_desc));
