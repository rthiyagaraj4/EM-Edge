...
public final class __premorbidstatusquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/PreMorbidStatusQueryCriteria.jsp", 1709120316000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String preMorbidCode =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOT.PreMorbidCode.Label","ot_labels")  ;
...
String preMorbidStatus =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOT.PreMorbidStatus.Label","ot_labels")  ;
String sortorder =
...
firstItem.add(preMorbidCode);     // label
firstItem.add("premorbid_code");   //name of field
...
String[] orderByColVals=null;
	...
	orderByCols[0] = preMorbidCode;
	orderByCols[1] = longdescription;
	orderByCols[2] = shortdescription;
   

	orderByColVals[0] = "premorbid_code";
	orderByColVals[1] = "long_desc";
	orderByColVals[2] = "short_desc";
	


strbuff = qrypg.getQueryPage( con,finAr,preMorbidStatus,"../../eOT/jsp/PreMorbidStatusQueryResult.jsp",sortorder,QueryCriteria,select,orderby,orderByCols, orderByColVals,executequery);
