...
public final class __patientpositionquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/PatientPositionQueryCriteria.jsp", 1709120300000L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
String positionCode =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.PositionCode.label","common_labels");
String position =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Position.label","common_labels");
...
/*strbuff = qrypg.getQueryPage( con,finAr,"Position ","../../eOT/jsp/PatientPositionQueryResult.jsp","Sort Order","Query Criteria","Select" ,"Order by",orderByCols, orderByColVals,"Execute Query");*/

strbuff = qrypg.getQueryPage( con,finAr,position,"../../eOT/jsp/PatientPositionQueryResult.jsp",sortorder,queryCriteria,select,orderby,orderByCols, orderByColVals,executequery);
