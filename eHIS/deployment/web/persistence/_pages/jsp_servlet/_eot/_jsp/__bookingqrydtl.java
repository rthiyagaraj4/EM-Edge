...
public final class __bookingqrydtl extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/BookingQryDtl.jsp", 1724068358000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\" id=\"mail_booking_num_";
    ...
    private final static java.lang.String  _wl_block16 ="\" id=\"mail_";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\" value=\"\" onclick=\"sendMail(\'";
    ...
    private final static java.lang.String  _wl_block21 ="\" id=\"preOperDiag_";
...
String strStageCode=checkForNull(request.getParameter("stage_code"));
	...
	//System.out.println("eOT status "+strStatus);
...
qry_criteria.setLength(0);
 if(strStatus.equals("B"))
	...
	//	if(strStatusDesc.equals("Rescheduled")) {
		...
		strParameter=strBookingNo+","+strFacilityId+","+strPatientId+","+strWaitListNo;
		...
		out.println("<td width='' nowrap id='orderctl"+fetchCount+"' style='cursor:pointer' class='gridDataBlue' onClick=\"commonDisplayTooltip('"+strMenuItem+"','"+strMenu+"','"+strParameter+"',this,'imgArrow"+fetchCount+"');\"  onMouseOver='hideToolTip();'><a class='gridDataBlue' href=\"javascript:commonDisplayTooltip('"+strMenuItem+"','"+strMenu+"','"+strParameter+"',this,'imgArrow"+fetchCount+"');\">"+strPatientName+"<img align='right' src='../../eCommon/images/inactiveArrow.gif' name='imgArrow"+fetchCount+"' id='imgArrow"+fetchCount+"'></td>");
		...
		out.println("<td class="+strQuery+"  nowrap>&nbsp;"+strWaitListNo+"</td>");
