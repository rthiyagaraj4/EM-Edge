...
public final class __holdingareasquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/HoldingAreasQueryCriteria.jsp", 1709120226000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String holdingArea =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOT.HoldingArea.Label","ot_labels");
...
firstItem.add("holding_area_code");   //name of field
...
secondItem.add("holding_area_desc");  //name of field
...
String[] orderByColVals=null;
	...
	orderByColVals[0] = "holding_area_code";
	orderByColVals[1] = "holding_area_desc";
	
	


strbuff = qrypg.getQueryPage( con,finAr,holdingArea,"../../eOT/jsp/HoldingAreasQueryResult.jsp",sortorder,queryCriteria,select,orderby,orderByCols, orderByColVals,executequery);
