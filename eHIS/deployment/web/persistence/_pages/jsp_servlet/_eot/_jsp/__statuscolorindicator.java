...
public final class __statuscolorindicator extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/StatusColorIndicator.jsp", 1733402310000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block14 ="\' style=\"background-color: ";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 =";\" width=\'2%\'>&nbsp;</td>\n\t\t\t\t<td class=\'white\' nowrap>&nbsp;\n\t\t\t\t<label nowrap \t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t\t\tstyle=\"font-size:9;font-weight:bold\">";
