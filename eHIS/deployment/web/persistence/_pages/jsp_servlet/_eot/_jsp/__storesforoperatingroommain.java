...
public final class __storesforoperatingroommain extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/StoresforOperatingRoomMain.jsp", 1709120368000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t</td>\n\t<td class=\'fields\'>\n\t\t\n\t\t<input type=\'text\' class=\"fields\" name=\'theatre_desc\' id=\'theatre_desc\' size=\'15\' onBlur=\"if(this.value!=\'\')searchTheatre(oper_room_code,theatre_desc);else loadDtlForm();\" ><input type=\"hidden\" name=\"oper_room_code\" id=\"oper_room_code\" value=\"";
...
con=ConnectionManager.getConnection(request);
	...
	try{
		...
		while(rs!=null && rs.next()){
            ...
            out.print( String.valueOf(str_code));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(default_select));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(str_desc));
