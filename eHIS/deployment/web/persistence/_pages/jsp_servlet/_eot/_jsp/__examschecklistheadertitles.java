...
public final class __examschecklistheadertitles extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/ExamsCheckListHeaderTitles.jsp", 1709120214000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	String patient_disply_title = patient_id+", "+patient_name+", "+sex+", "+dob+", "+encounter_id;
            ...
            out.print( String.valueOf(patient_disply_title));
