...
public final class __qaindicatorsfordiscipline extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eqa/jsp/QAIndicatorsForDiscipline.jsp", 1742817544779L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	{
		out.println("Exception in File QAIndicatorsForDiscipline"+e.toString());
	}
