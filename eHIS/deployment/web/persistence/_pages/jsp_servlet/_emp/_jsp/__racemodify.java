...
public final class __racemodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/RaceModify.jsp", 1709118707230L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="</td>\n\t\t\t\t<td width=\'60%\' align=\'left\' colspan=\'2\'>&nbsp;&nbsp;\n\t\t\t\t\t<input type=\'text\' size=\'10\' maxlength=\'10\' name=\'RACE_CODE\' id=\'RACE_CODE\' readonly value=\'";
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	try{
		...
		if ( rset != null ) {
            ...
            out.print( String.valueOf(rset.getString("RACE_CODE")));
