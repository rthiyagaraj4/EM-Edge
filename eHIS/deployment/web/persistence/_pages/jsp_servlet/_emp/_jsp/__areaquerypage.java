...
public final class __areaquerypage extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/AreaQueryPage.jsp", 1709116986658L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//	con = (Connection) session.getValue( "connection" );
	...
	firstItem.add("res_area_code");	//name of field
	...
	thirdItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.Regioncode.label","mp_labels"));  // label
	thirdItem.add("a.region_code");   //name of field
	...
	fourthItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.RegionDesc.label","mp_labels"));  // label
	fourthItem.add("region_long_desc");   //name of field
	...
	orderByCols[2] = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.Regioncode.label","mp_labels");
	orderByCols[3] = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.RegionDesc.label","mp_labels");

	orderByColVals[0] = "res_area_code";
	orderByColVals[1] = "a.long_desc";
	orderByColVals[2] = "a.region_code";
	orderByColVals[3] = "region_short_desc";//modified for incident 40320

	strbuff = qrypg.getQueryPage(con,finAr,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.ResidenceArea.label","mp_labels"),"../jsp/queryArea.jsp",com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.SortOrder.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.QueryCriteria.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.defaultSelect.label","common_labels") ,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.orderBy.label","common_labels"),orderByCols, orderByColVals,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ExecuteQuery.label","common_labels"));
