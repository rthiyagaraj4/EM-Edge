...
public final class __addethnicsubgroup extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/addEthnicSubGroup.jsp", 1709118582948L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="</td>\n      <td width=\"60%\" colspan=\"2\" class=\'fields\'><select name=\"RACE_CODE\" id=\"RACE_CODE\">\n\t\t\t<option value=\"\">-------------";
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
			...
			try
			{
			    ...
			    pstmt = con.prepareStatement("select RACE_CODE, LONG_DESC from MP_RACE_LANG_VW where EFF_STATUS='E' AND language_id='"+localeName+"' order by LONG_DESC ");
