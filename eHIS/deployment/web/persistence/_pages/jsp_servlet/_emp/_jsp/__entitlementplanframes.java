...
public final class __entitlementplanframes extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/EntitlementPlanFrames.jsp", 1709622743752L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	try
	{
		...
		if(entitlement_by_pat_cat_yn.equals("N"))
	...
	else
		 {
            ...
            out.print( String.valueOf(toolBar));
