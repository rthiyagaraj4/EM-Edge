...
public final class __patnamescomp extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/PatNamesComp.jsp", 1743485080855L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block67 ="\')\" name=\'bf\' id=\'bf\'></td><td class=\'label\' ></td> ";
    ...
    private final static java.lang.String  _wl_block69 ="\')\" name=\'bs\' id=\'bs\'></td><td class=\'label\' >&nbsp;</td>";
    ...
    private final static java.lang.String  _wl_block72 ="\')\" name=\'bt\' id=\'bt\'></td><td class=\'label\' >&nbsp;</td> ";
    ...
    private final static java.lang.String  _wl_block74 ="\')\" name=\'bfam\' id=\'bfam\'> \n\t\t\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block147 ="\')\" name=\'bfo\' id=\'bfo\'>\n\t\t\t\t\t\t</td><td class=\'label\' >&nbsp;</td>\n\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block149 ="\')\" name=\'bso\' id=\'bso\'> \n\t\t\t\t\t\t</td><td class=\'label\' >&nbsp;</td>\n\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block151 ="\')\" name=\'bto\' id=\'bto\'>\n\t\t\t\t\t\t</td><td class=\'label\' >&nbsp;</td>\n\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block153 ="\')\" id=\'bfamo\' name=\'bfamo\'>\n\t\t\t\t\t\t</td><td class=\'label\' >&nbsp;</td>\n\t\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block197 ="\')\" name=\'bso\'id=\'bso\'> \n\t\t\t\t\t\t</td><td class=\'label\' >&nbsp;</td>\n\t\t\t\t\t\t";
    private final static byte[]  _wl_block197Bytes = _getBytes( _wl_block197 );

    private final static java.lang.String  _wl_block198 ="\' onclick=\"callSearch(first_name_oth_lang,first_name,\'Others\',\'";
    ...
    private final static java.lang.String  _wl_block200 ="\");if (document.forms[0].entitlement_by_pat_cat_yn && document.forms[0].entitlement_by_pat_cat_yn.value==\"Y\"){getPatCategory();}\' dir=\'RTL\'  >\n\t\t\t\t\t";
    private final static byte[]  _wl_block200Bytes = _getBytes( _wl_block200 );

    private final static java.lang.String  _wl_block201 ="\n\t\t\t\t\t<td class=\'arabic\'  ><Select name=\'name_prefix_oth_lang\' id=\'name_prefix_oth_lang\' onchange=\'sel_prefix_gen(this,\"";
    private final static byte[]  _wl_block201Bytes = _getBytes( _wl_block201 );

    private final static java.lang.String  _wl_block202 ="\");if ( document.forms[0].entitlement_by_pat_cat_yn && document.forms[0].entitlement_by_pat_cat_yn.value==\"Y\"){getPatCategory();}\' dir=\'RTL\' > \n\t\t\t\t\t";
    private final static byte[]  _wl_block202Bytes = _getBytes( _wl_block202 );

    private final static java.lang.String  _wl_block203 ="------</option>\n\n\t\t\t\t\t<script>\n\t\t\t\t\t\tprefix_loc_length = NamePrefixLocArrayTemp.length;//added By Sudhakar during UAT-3\n\t\t\t\t\t\t\tfor(i = 0; i < prefix_loc_length; i++) {\n\t\t\t\t\t\t\t\tloc_name_pfx = unescape(NamePrefixLocArrayTemp[i]);//added By Sudhakar during UAT-3\n\t\t\t\t\t\t\t\tif(loc_name_pfx!=\'\') {\n\n\t\t\t\t\t\t\t\t\topt = document.createElement(\"OPTION\");\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\topt.text = loc_name_pfx;\n\t\t\t\t\t\t\t\t\topt.value = loc_name_pfx;\n\t\t\t\t\t\t\t\t\tif(\'";
    private final static byte[]  _wl_block203Bytes = _getBytes( _wl_block203 );

    private final static java.lang.String  _wl_block204 ="\" == \"IP\"){\n\t\t\t\t\t\t\t\t\t\tif(\'";
    private final static byte[]  _wl_block204Bytes = _getBytes( _wl_block204 );

    private final static java.lang.String  _wl_block205 ="\'==\'NewbornDtls\') {\n\t\t\t\t\t\t\t\t\t\t\tif(document.getElementById(\'name_prefix_oth_lang\')) \n\t\t\t\t\t\t\t\t\t\t\t\tdocument.getElementById(\'name_prefix_oth_lang\').options.add(opt);\t\n\t\t\t\t\t\t\t\t\t\t} else { \n\t\t\t\t\t\t\t\t\t\t\tif(document.getElementById(\"name_prefix_oth_lang\") && document.getElementById(\"name_prefix_oth_lang\"+[1])) { \n\t\t\t\t\t\t\t\t\t\t\t\tdocument.getElementById(\"name_prefix_oth_lang\"+[1]).options.add(opt);\n\t\t\t\t\t\t\t\t\t\t\t} \n\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t}else{\n\t\t\t\t\t\t\t\t\tif(\'";
    private final static byte[]  _wl_block205Bytes = _getBytes( _wl_block205 );

    private final static java.lang.String  _wl_block206 ="\'==\'NewbornDtls\') {\n\t\t\t\t\t\t\t\t\t\tif(document.getElementById(\"name_prefix_oth_lang\") && document.getElementById(\"name_prefix_oth_lang\"+[1])) { \n\t\t\t\t\t\t\t\t\t\t\tdocument.getElementById(\"name_prefix_oth_lang\"+[1]).options.add(opt);\n\t\t\t\t\t\t\t\t\t\t} \t\t\t\t\n\t\t\t\t\t\t\t\t\t} else { \n\t\t\t\t\t\t\t\t\t\tif(document.getElementById(\"name_prefix_oth_lang\")) \n\t\t\t\t\t\t\t\t\t\t\tdocument.getElementById(\"name_prefix_oth_lang\").options.add(opt);\t\t\t\n\t\t\t\t\t\t\t\t\t} \n\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t\t//document.forms[0].name_prefix_oth_lang.add(opt);\n\n\t\t\t\t\t\t\t\t\tif(\'";
    private final static byte[]  _wl_block206Bytes = _getBytes( _wl_block206 );

    private final static java.lang.String  _wl_block207 ="\") {\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\topt.selected=true;\n\t\t\t\t\t\t\t\t\t\t} \n\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t</script>\n\n\t\t\t\t\t";
    private final static byte[]  _wl_block207Bytes = _getBytes( _wl_block207 );

    private final static java.lang.String  _wl_block208 ="</Select></td>\t<!-- <td class=\'label\'>&nbsp;</td> -->\n\t\t\t";
