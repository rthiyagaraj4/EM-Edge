...
public final class __form60criteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/Form60Criteria.jsp", 1709118619338L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block19 =" \"  onClick=\'callSearch()\' class=\'BUTTON\'>\n\t\t\t\t\t</td>\n\n\t\t\t\t\t</tr>\n\t\t\t\t</table>\n\t\t\t\t<input type=\'hidden\' name=\'isPanCardAvailableYN\' id=\'isPanCardAvailableYN\' value=\"\" />\n\t\t\t</form>\n\t\t</body>\n\t";
