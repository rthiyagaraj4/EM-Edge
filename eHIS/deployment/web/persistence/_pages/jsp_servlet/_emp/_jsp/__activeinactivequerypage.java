...
public final class __activeinactivequerypage extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/ActiveInactiveQueryPage.jsp", 1742360291571L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	//	con = (Connection) session.getValue( "connection" );
		...
		fifthItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.ReasonforActive.label","mp_labels"));  // label
		fifthItem.add("reason_for_active_yn");//name
		...
		strbuff = qrypg.getQueryPage(con,finAr,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.ReasonforActiveInactive.label","mp_labels"),"../jsp/queryActiveInactive.jsp",com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.SortOrder.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.QueryCriteria.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.defaultSelect.label","common_labels") ,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.orderBy.label","common_labels"),orderByCols, orderByColVals,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ExecuteQuery.label","common_labels"));
