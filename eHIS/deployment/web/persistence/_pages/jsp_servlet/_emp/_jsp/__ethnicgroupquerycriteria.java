...
public final class __ethnicgroupquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/EthnicGroupQueryCriteria.jsp", 1709116996080L ,"10.3.6.0","Asia/Calcutta")) return true;
...
firstItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.RaceCode.label","mp_labels"));	  // label
firstItem.add("RACE_CODE");	//name of field
...
secondItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.RaceDesc.label","mp_labels"));  // label
...
orderByCols[0] = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.RaceCode.label","mp_labels");
orderByCols[1] = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.RaceDesc.label","mp_labels");

orderByColVals[0] = "RACE_CODE";
orderByColVals[1] = "LONG_DESC";



strbuff = qrypg.getQueryPage(con,finAr,"Find EthnicGroup","../jsp/EthnicGroupQueryResult.jsp",com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.SortOrder.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.QueryCriteria.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.defaultSelect.label","common_labels") ,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.orderBy.label","common_labels"),orderByCols, orderByColVals,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ExecuteQuery.label","common_labels"));

out.println(strbuff.toString());
} catch (Exception e) { 
	// out.println(e.toString());
	e.printStackTrace(); // Added by lakshmanan for security issue ID 174047266 on 05-09-2023
	}
finally{
