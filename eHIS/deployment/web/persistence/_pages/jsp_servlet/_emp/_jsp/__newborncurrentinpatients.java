...
public final class __newborncurrentinpatients extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/NewbornCurrentInpatients.jsp", 1729673447362L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 =" frameborder=0 scrolling=\'no\' noresize style=\'height:8vh;width:100vw\'></iframe>\n\t\t\t\t<!--frame name=\'f_query_add_mod\' \tsrc=\'../../eIP/jsp/InpatientLookupCriteria.jsp?functionid=";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="&jsp_name=NewbornRegistrationFirst.jsp&win_height=33.4&win_width=49.6&call_function=NEWBORN_REG&wherecondn=EMERGENCY_TFR_YN&targetURL=";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\' frameborder=0 scrolling=\'no\' noresize-->\n\t\t\t\t<!--Thursday, March 11, 2010 , IN019962 , EMERGENCY_TFR_YN is for Intraward Transfer in Operator Station set up -->\n\t\t\t\t<iframe name=\'f_query_add_mod\' id=\'f_query_add_mod\' \tsrc=\'../../eIP/jsp/InpatientLookupCriteria.jsp?functionid=";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="&jsp_name=NewbornRegistrationFirst.jsp&win_height=33.4&win_width=49.6&call_function=NEWBORN_REG&wherecondn=reg_newborn_for_ip_yn&targetURL=";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' frameborder=0 scrolling=\'no\' noresize style=\'height:24vh;width:100vw\'></iframe>\n\t\t\t\t<iframe name=\'f_query_add_mod1\' id=\'f_query_add_mod1\' \tsrc=\'../../eCommon/html/blank.html\' frameborder=0 scrolling=\'auto\' noresize style=\'height:60vh;width:100vw\'></iframe>\n\t\t\t\t<iframe name=\'messageFrame\' id=\'messageFrame\'\t\tsrc=\'../../eCommon/jsp/error.jsp\' frameborder=0 noresize scrolling=\'auto\' noresize style=\'height:12vh;width:100vw\'></iframe>\n\n\n";
...
String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	try{
		...
		if(rs.next())
		{
            ...
            out.print( String.valueOf(URLEncoder.encode(targetURL.toString())));
