...
public final class __patidvalidations extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/PatIdValidations.jsp", 1723459052683L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block26 ="\";\n\t\t\t\teval(varBodyFrame).document.getElementById(\"surgery_order_desc_hid\").value=\"";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="\";//Maheshwaran K added for the CRF : RUT-CRF-0012 (23395\t) as on 28/01/2013\n\t\t\t\t//eval(varBodyFrame).document.getElementById(\"surgery_order_name\").disabled=true;//Maheshwaran K commented for the Inci No : RUT-SCF-0258 [IN:039356] as on 15/04/2013\n\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block56 ="\" == \'W\')\n\t\t\t{\n\t\t\t";
    ...
    private final static java.lang.String  _wl_block59 ="\" == \"1\")\n\t\t\t\t\t\t\teval(varBodyFrame).document.getElementById(\"alt_id1_no\").value = \"";
    private final static byte[]  _wl_block59Bytes = _getBytes( _wl_block59 );

    private final static java.lang.String  _wl_block60 ="\"\n\t\t\t\t\t\telse if(\"";
    private final static byte[]  _wl_block60Bytes = _getBytes( _wl_block60 );

    private final static java.lang.String  _wl_block61 ="\" == \"2\")\n\t\t\t\t\t\t\teval(varBodyFrame).document.getElementById(\"alt_id1_no\").value = \"";
    private final static byte[]  _wl_block61Bytes = _getBytes( _wl_block61 );

    private final static java.lang.String  _wl_block62 ="\" == \"3\")\n\t\t\t\t\t\t\teval(varBodyFrame).document.getElementById(\"alt_id1_no\").value = \"";
    private final static byte[]  _wl_block62Bytes = _getBytes( _wl_block62 );

    private final static java.lang.String  _wl_block63 ="\" == \"4\")\n\t\t\t\t\t\t\teval(varBodyFrame).document.getElementById(\"alt_id1_no\").value = \"";
    private final static byte[]  _wl_block63Bytes = _getBytes( _wl_block63 );

    private final static java.lang.String  _wl_block64 ="\"\n\t\t\t\t\t}\n\t\t\t}else if(\"";
    private final static byte[]  _wl_block64Bytes = _getBytes( _wl_block64 );

    private final static java.lang.String  _wl_block65 ="\" ==\'C\')\n\t\t\t{";
    ...
    private final static java.lang.String  _wl_block75 ="\t/*\t\tCommented the below code against IN017676 by Suresh M on 29/12/2009\n\t\t\t\t\n\t\t\t\tif(eval(varBodyFrame).document.getElementById(\"eth_gif\")!=null)\n\t\t\t\teval(varBodyFrame).document.getElementById(\"eth_gif\").style.visibility=\'hidden\'\t\n\t\t\t\teval(varBodyFrame).document.getElementById(\"race_yn\").value = \'N\';\t\n\t\t*/\n\t\t\tif(eval(varBodyFrame).document.getElementById(\"citizen_yn\")!=null)\n\t\t\t{\n\t\t\teval(varBodyFrame).document.getElementById(\"citizen_yn\").checked = true;\n";
    ...
    private final static java.lang.String  _wl_block112 ="\"\n\t\t/*Added by Thamizh selvi on 30th Jan 2018 against ML-MMOH-CRF-0601 Start*/\n\t\teval(varBodyFrame).document.getElementById(\"alt_addr_line1\").value = \"";
    private final static byte[]  _wl_block112Bytes = _getBytes( _wl_block112 );

    private final static java.lang.String  _wl_block113 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_addr_line2\").value = \"";
    private final static byte[]  _wl_block113Bytes = _getBytes( _wl_block113 );

    private final static java.lang.String  _wl_block114 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_addr_line3\").value = \"";
    private final static byte[]  _wl_block114Bytes = _getBytes( _wl_block114 );

    private final static java.lang.String  _wl_block115 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_addr_line4\").value = \"";
    private final static byte[]  _wl_block115Bytes = _getBytes( _wl_block115 );

    private final static java.lang.String  _wl_block116 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_town_code\").value = \"";
    private final static byte[]  _wl_block116Bytes = _getBytes( _wl_block116 );

    private final static java.lang.String  _wl_block117 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_town_desc\").value = \"";
    private final static byte[]  _wl_block117Bytes = _getBytes( _wl_block117 );

    private final static java.lang.String  _wl_block118 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_area_code\").value = \"";
    private final static byte[]  _wl_block118Bytes = _getBytes( _wl_block118 );

    private final static java.lang.String  _wl_block119 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_area_desc\").value = \"";
    private final static byte[]  _wl_block119Bytes = _getBytes( _wl_block119 );

    private final static java.lang.String  _wl_block120 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_postal_desc\").value = \"";
    private final static byte[]  _wl_block120Bytes = _getBytes( _wl_block120 );

    private final static java.lang.String  _wl_block121 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_postal_code\").value = \"";
    private final static byte[]  _wl_block121Bytes = _getBytes( _wl_block121 );

    private final static java.lang.String  _wl_block122 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_region_code\").value = \"";
    private final static byte[]  _wl_block122Bytes = _getBytes( _wl_block122 );

    private final static java.lang.String  _wl_block123 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_region_desc\").value = \"";
    private final static byte[]  _wl_block123Bytes = _getBytes( _wl_block123 );

    private final static java.lang.String  _wl_block124 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_country_code\").value = \"";
    private final static byte[]  _wl_block124Bytes = _getBytes( _wl_block124 );

    private final static java.lang.String  _wl_block125 ="\"\n\t\teval(varBodyFrame).document.getElementById(\"alt_country_desc\").value = \"";
    ...
    private final static java.lang.String  _wl_block145 ="</b>\"\n\t\teval(varBodyFrame).document.getElementById(\"patient_name_local_lang\").value = \"";
    ...
    private final static java.lang.String  _wl_block164 ="\'!=\"\" && eval(varBodyFrame).document.getElementById(\"language_desc\")){\n\t\t\teval(varBodyFrame).document.getElementById(\"language_desc\").value = \"";
    private final static byte[]  _wl_block164Bytes = _getBytes( _wl_block164 );

    private final static java.lang.String  _wl_block165 ="\"\n\t\t\teval(varBodyFrame).document.getElementById(\"language_id\").value = \"";
...
/*String sql = "SELECT  "+
	...
	try
		...
		if(rset!=null)
            ...
            out.print( String.valueOf(rset.getString("order_id")));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(rset.getString("order_line_no")));
            _bw.write(_wl_block22Bytes, _wl_block22);
            out.print( String.valueOf(rset.getString("oper_desc")));
            _bw.write(_wl_block23Bytes, _wl_block23);
            out.print( String.valueOf(rset.getString("oper_code")));
            _bw.write(_wl_block24Bytes, _wl_block24);
            out.print( String.valueOf(com.ehis.util.DateUtils.convertDate(rset.getString("pref_surg_date"),"DMY","en",locale)));
  ...
  if (!alternateIdStatus.equals("")) 
	{
		...
		else
		{
            ...
            out.print( String.valueOf(strRaceDesc));
            ...
            out.print( String.valueOf(patient_long_name==null?"":patient_long_name));
            _bw.write(_wl_block149Bytes, _wl_block149);
            out.print( String.valueOf(patient_long_name_loc_lang==null?"":patient_long_name_loc_lang));
            ...
            out.print( String.valueOf(patcat_desc));
