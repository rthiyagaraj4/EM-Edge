...
public final class __patientiddisplay extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/PatientIDDisplay.jsp", 1739862853747L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\'>\";\n\t\t\t\t HTMLVal = HTMLVal +\"</form></BODY></HTML>\";\n\t\t\t\t parent.frames[5].document.write(HTMLVal);\n\t\t\t\t parent.frames[5].document.form1.submit(); \n\t\t\t}\n\t\t</script>\n\t\t<style type=\"text/css\">\n\n#patDtl {width: 86vw;height:300;overflow-y:no;overflow-x: scroll;}\n\n#patId {width: 130px; margin-top: -14px;}\n</style>\n\t</head>\n<BODY class=\'CONTENT\' onLoad=\"SearchLimit(\'";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\')\" onKeyDown = \'lockKey()\'>\n<form name=\'result_form\' id=\'result_form\' action = \"../../eMP/jsp/PatientIDDisplay.jsp\" >\n";
    ...
    private final static java.lang.String  _wl_block20 ="\',\'retback\', \'NEWBORN_REG\');\n\t\t\t\t\t\t\t\telse checkExpiry(\'";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\',\'retback\',\'\');\n\t\t\t\t\t\t\t\t*/\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\tif ( (parent.Pat_Search_Criteria_Frame.document.getElementById(\"Sex\").disabled==true) && (parent.Pat_Search_Criteria_Frame.document.getElementById(\"func_idpassed\").value!=\'MP_MAIN_NB_REG\') )\n\t\t\t\t\t\t\t\t\tcheckExpiry(\'";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\',\'retback\',\'\');\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t</script>\n                \t\t";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="\n\t                <script>\n\t\t                setTimeout(\'aa()\',70);\n\t\t\t            function aa(){\n\t\t\t\t\t        var flag=\'retback\';\n\t\t\t\t\t        /*\n\t\t\t\t\t\t  \tif ( (parent.parent.Pat_Search_Criteria_Frame.document.forms[0].Sex.disabled==true) && (parent.parent.Pat_Search_Criteria_Frame.document.forms[0].func_idpassed.value!=\'MP_MAIN_NB_REG\') )\n\t\t                        checkExpiry(\'";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\',\'retback\', \'NEWBORN_REG\');\n\t\t\t                else checkExpiry(\'";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 ="\',\'retback\',\'\');\n\t\t\t\t\t        */\n\t\t\t\t\t        \n\t\t\t\t\t        if ( (parent.Pat_Search_Criteria_Frame.document.getElementById(\"Sex\").disabled==true) && (parent.Pat_Search_Criteria_Frame.document.getElementById(\"func_idpassed\").value!=\'MP_MAIN_NB_REG\') )\n\t\t                        checkExpiry(\'";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 ="\',\'retback\',\'\');\n\t\t\t\t\t    }\n\t\t\t\t\t</script>\n                \t";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="\n\n\t<table border=\'1\' cellpadding=\'0\' cellspacing=\'0\' width=\'75%\' align=\'center\'>\n\t";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="\n        <Script language=\"JavaScript\">\n\t\t\tparent.Pat_Search_Toolbar_Frame.document.getElementById(\"disprec\").style.visibility=\'visible\' ; \n\t\t\tvar maxrec = \'\';\n\t\t\tvar str = \'\';\n\t\t\tif(\"";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 ="\")\n\t\t\tmaxrec = \"";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 ="\";//parent.parent.Pat_Results_Frame.document.getElementById(\"Hit_Limit\").value;\n\t\t\tif(parent.Pat_Results_Frame.document.getElementById(\"To\"))\n\t\t\tstr=parent.Pat_Results_Frame.document.getElementById(\"To\").value;\n\t\t\tif (eval(maxrec) > 50)\n\t\t\t{\n\t\t\t\tparent.Pat_Search_Toolbar_Frame.document.getElementById(\"prev\").style.visibility = \'visible\';\n\t\t        parent.Pat_Search_Toolbar_Frame.document.getElementById(\"next\").style.visibility = \'visible\';\n\t\t\t}\n\t\t\tif (parent.Pat_Search_Toolbar_Frame.document.getElementById(\"register\"))\n\t\t\t\tparent.Pat_Search_Toolbar_Frame.document.getElementById(\"register\").disabled = false;\n\t\t\tif (parent.Pat_Search_Toolbar_Frame.document.getElementById(\"register1\"))\n\t\t\t\tparent.Pat_Search_Toolbar_Frame.document.getElementById(\"register1\").disabled = false;\n\t\t\t/*\n\t\t\tif (parent.parent.Pat_Search_Toolbar_Frame.document.forms[0].register)\n\t\t\t\tparent.parent.Pat_Search_Toolbar_Frame.document.forms[0].register.disabled = false;\n\t\t\tif (parent.parent.Pat_Search_Toolbar_Frame.document.forms[0].register1)\n\t\t\t\tparent.parent.Pat_Search_Toolbar_Frame.document.forms[0].register1.disabled = false;\n\t\t\t*/\n\t\t</Script>\n        ";
    ...
    private final static java.lang.String  _wl_block73 ="\">\n<input type=\"hidden\" name=\"addl_field1\" id=\"addl_field1\" value=\"";
    private final static byte[]  _wl_block73Bytes = _getBytes( _wl_block73 );

    private final static java.lang.String  _wl_block74 ="\">\n<input type=\"hidden\" name=\"addl_field2\" id=\"addl_field2\" value=\"";
    private final static byte[]  _wl_block74Bytes = _getBytes( _wl_block74 );

    private final static java.lang.String  _wl_block75 ="\">\n<input type=\"hidden\" name=\"addl_field3\" id=\"addl_field3\" value=\"";
    private final static byte[]  _wl_block75Bytes = _getBytes( _wl_block75 );

    private final static java.lang.String  _wl_block76 ="\">\n<input type=\"hidden\" name=\"addl_field4\" id=\"addl_field4\" value=\"";
    private final static byte[]  _wl_block76Bytes = _getBytes( _wl_block76 );

    private final static java.lang.String  _wl_block77 ="\">\n<input type=\"hidden\" name=\"addl_field5\" id=\"addl_field5\" value=\"";
    private final static byte[]  _wl_block77Bytes = _getBytes( _wl_block77 );

    private final static java.lang.String  _wl_block78 ="\">\n\n<!--hidden added by senthil -->\n<input type=\"hidden\" name=\"Contact_No\" id=\"Contact_No\" value=\"";
    ...
    private final static java.lang.String  _wl_block82 ="\'==\"NEWBORN_REG\") || (\'";
    private final static byte[]  _wl_block82Bytes = _getBytes( _wl_block82 );

    private final static java.lang.String  _wl_block83 ="\'==\"MP_MAIN_NB_REG\") )\nif (\'";
    private final static byte[]  _wl_block83Bytes = _getBytes( _wl_block83 );

    private final static java.lang.String  _wl_block84 ="\'==\'N\')\n{\n\t//parent.parent.Pat_Search_Criteria_Frame.document.forms[0].Sex.disabled = true;\n\tparent.Pat_Search_Criteria_Frame.document.forms[0].Sex.disabled = true;\n}\n</script>\n";
...
boolean single_rcd_flag=true;
String Smartcard_path = "";
String function_name = "";
//String p_name_exist_yn="N";        
...
//String sql;
	...
	//Added by Ashwin K for AAKH-CRF-0150
	Select_pstmt = conn.prepareStatement("select VALUE_1,nvl(VALUE_2,'00') VALUE_2 from sm_function_control a,SM_SITE_PARAM b  where module_id='MP' and FUNCTIONALITY_ID='SMART_CARD_INTG' and a.SITE_ID=B.CUSTOMER_ID");
	rs7 = Select_pstmt.executeQuery();	
	if(rs7!=null && rs7.next())
	{
		Smartcard_path=rs7.getString("VALUE_1");
		function_name=rs7.getString("VALUE_2");   // alkhaleej smart card
	}		
...
String  contact_search_by	=  checkForNull(request.getParameter("contact_search_by")); //Added by Ashwin K for AAKH-CRF-0150
...
String Search_By_Lang				= checkForNull(request.getParameter("Search_By_Lang"));
...
String suspend_inactive_pat_yn						=	checkForNull(request.getParameter("suspend_inactive_pat_yn"));
String dft_national_id						=	checkForNull(request.getParameter("dft_national_id"));//Added by Maheshwaran K for AAKH-CRF-0168
...
String abha_pat_id	="";
String ndhm_appl_YN			=	checkForNull(request.getParameter ("ndhm_appl_YN"),"N"); //Maheshwaran K added for GHL-CRF-0657.2 as 06-09-2923

if(ndhm_appl_YN.equals("Y")) {	
 abha_pat_id			=	checkForNull(request.getParameter ("abha_pat_id"),""); //Maheshwaran K added for GHL-CRF-0657.2 as 06-09-2923
}
...
/* Added by Kamatchi S on 28-AUG-2020 for MOHE-CRF-0016.1 */
	String insurance_id = checkForNull(request.getParameter("ins_car_id")); 
	String[] ins_card_reader;
...
String alt_id1_pat_sch_exact_yn=request.getParameter("alt_id1_pat_sch_exact_yn")==null?"N":request.getParameter("alt_id1_pat_sch_exact_yn");
String alt_id2_pat_sch_exact_yn=request.getParameter("alt_id2_pat_sch_exact_yn")==null?"N":request.getParameter("alt_id2_pat_sch_exact_yn");
String alt_id3_pat_sch_exact_yn=request.getParameter("alt_id3_pat_sch_exact_yn")==null?"N":request.getParameter("alt_id3_pat_sch_exact_yn");
String alt_id4_pat_sch_exact_yn=request.getParameter("alt_id4_pat_sch_exact_yn")==null?"N":request.getParameter("alt_id4_pat_sch_exact_yn");
...
//StringBuffer Single_Rcrd_WhrCrt		=	new StringBuffer();
//StringBuffer Single_Rcrd_Query		=	new StringBuffer();
...
if (!search_in.equals("D")&&(function_id.equals("") || function_id.equals("PAT_REG") ||func_act.equals("DuplicateRegistration") || 	function_id.equals("NEWBORN_REG"))){
	...
	if (search_in.equals("P") && !valid_patient_id.equals("")){
			...
			out.println("if(parent.Pat_Search_Criteria_Frame.document.forms[0].dobCal){parent.Pat_Search_Criteria_Frame.document.forms[0].dobCal.disabled = false;}");
...
/*			if (Select_rSet.getString("field_name").equals("Facility_Id")){
			Dyn_selectClause.append("c.Facility_Id,");
			}*/


		if (Select_rSet.getString("field_name").equals("File_No")){
				Dyn_selectClause.append("case when (select count(1) from mr_pat_file_index where facility_id='"+logged_facility+"' and patient_id=a.patient_id ) < 2 then (select file_no from mr_pat_file_index e where e.facility_id='"+logged_facility+"' and e.patient_id = A.patient_id ) else '' end File_No,");
				fileFlag_yn=true;
		}
	if ((Select_rSet.getString("field_name").equals("Old_File_No"))){
				Dyn_selectClause.append("case when (select count(1) from mr_pat_file_index where facility_id='"+logged_facility+"' and patient_id=a.patient_id ) < 2 then (select old_file_no from mr_pat_file_index e where e.facility_id='"+logged_facility+"' and e.patient_id = A.patient_id ) else '' end Old_File_No,");
				oldfileFlag_yn=true;
		}
	...
	if (Select_rSet.getString("field_name").equals("MOTHER_PATIENT_NAME")){
			Dyn_selectClause.append("case when a.mother_patient_id is not null then (select patient_name from mp_patient where patient_id=a.mother_patient_id) else '' end  mother_patient_name,");
		}
	...
	if (Select_rSet.getString("field_name").equals("OTH_ALT_ID_TYPE")){
			//Dyn_selectClause.append("a.oth_alt_id_type,");Removed against ml-mmoh-scf-1173
		Dyn_selectClause.append("(mp_get_desc.mp_alternate_id_type(a.oth_alt_id_type,'"+locale+"',1)) oth_alt_id_type,");//Added by Shagar against ml-mmoh-scf-1173
		}
	...
	if (Select_rSet.getString("field_name").equals("RELATIONSHIP_TO_HEAD")){
			...
			Dyn_selectClause.append("mp_get_desc.mp_relationship(a.relationship_to_head,'"+locale+"',2),");
		}
...
final_selectCaluse.append("select a.patient_id,"+Dyn_selectClause.toString()+"a.mother_patient_id,a.Pref_Facility_Id,a.enc_facility_id,a.curr_encounter_id,a.deceased_yn,a.suspend_yn,a.active_yn,a.curr_patient_class, a.restrict_reinstate_yn ");//column restrict_reinstate_yn added by Ajay for MMS-DM-CRF-0210.1
if( fileFlag_yn){
...
if(addl_field_Flag && !(file_no_Flag) && addl_field_cnt==0 && File_No_field_cnt==0){	
	...
	if(!Contact_No.equals("")){
	    fromClause.append(" ,mp_pat_rel_contacts m");
		sub_Whr=sub_Whr+" a.patient_id = m.patient_id  and ";
	}
	...
	//End PMG2013-MMS-CRF-0004 [IN:045277]	
	...
	/*above line modified for this CRF PMG2013-MMS-CRF-0004 [IN:045277]*/		
...
if (!pat_id.equals("")){
		...
		if(patient_id_search_by.equals("S")){
			whereClause.append(" "+strAND+" UPPER(a.Patient_id) like UPPER('"+pat_id+"%')");
...
strAND="AND";
//Single_Rcrd_WhrCrt.append(" "+strAND+ " Patient_id like trim('"+pat_id+"')||'%' ");
}	

if(ndhm_appl_YN.equals("Y") && !abha_pat_id.equals(""))
	{
	whereClause.append(" "+strAND+"  UPPER(a.myhix_id) like UPPER('"+abha_pat_id+"') || '%'"); 	
	}

 if (!National_Id_No.equals("")){
	 //Added by Maheshwaran K for AAKH-CRF-0168
	if(dft_national_id.equals(National_Id_No) && isNatIdAltIdMandVisaType)
		{
		whereClause.append(" "+strAND+"  UPPER(a.national_id_no_dft) like UPPER('"+National_Id_No+"') || '%'"); 
		}
	else
		{
		whereClause.append(" "+strAND+"  UPPER(a.National_Id_No) like UPPER('"+National_Id_No+"') || '%'"); 
		}
strAND="AND";
//Single_Rcrd_WhrCrt.append(" "+strAND+ " National_Id_No like trim('"+National_Id_No+ "') ||'%' ");
...
whereClause.append(" "+strAND+" a.patient_id =  (select patient_id from mr_pat_file_index where facility_id='"+logged_facility+"' and file_no = '"+file_no+"')");
strAND="AND";
}																														
if (!old_file_no.equals("")){
//whereClause.append(""+strAND+" c.old_file_no = '"+old_file_no+"'  ");
whereClause.append(" "+strAND+" a.patient_id in (select patient_id from mr_pat_file_index where facility_id='"+logged_facility+"' and old_file_no like trim('"+old_file_no+"')||'%')");
strAND="AND";
}																												
...
if (!Alt_Id1_No.equals("")){
	...
	if(alt_id1_pat_sch_exact_yn.equals("Y")){
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id1_No) = UPPER('"+Alt_Id1_No+"')");
	}else{
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id1_No) like UPPER('"+Alt_Id1_No+"') || '%'");
	}
	strAND="AND";
}
...
if (!Alt_Id2_No.equals("")){
	if(alt_id2_pat_sch_exact_yn.equals("Y")){
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id2_No) = UPPER('"+Alt_Id2_No+"')");
	}else{
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id2_No) like UPPER('"+Alt_Id2_No+"') || '%'");
	}
strAND="AND";
}
}
...
if (!insurance_id.equals("")){
	if(alt_id2_pat_sch_exact_yn.equals("Y")){
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id2_No) IN ("+insurance_id_1+")");
	}else{
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id2_No) IN ("+insurance_id_1+")");
	}
strAND="AND";
...
if (!Alt_Id3_No.equals("")){
	if(alt_id3_pat_sch_exact_yn.equals("Y")){
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id3_No) = UPPER('"+Alt_Id3_No+"')");
	}else{
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id3_No) like UPPER('"+Alt_Id3_No+"') || '%'");
	}
strAND="AND";
}																														
...
if (!Alt_Id4_No.equals("")){
	if(alt_id4_pat_sch_exact_yn.equals("Y")){
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id4_No) = UPPER('"+Alt_Id4_No+"')");
	}else{
		whereClause.append(" "+strAND+"  UPPER(a.Alt_Id4_No) like UPPER('"+Alt_Id4_No+"') || '%'");
	}
strAND="AND";
}	
/*End*/
...
if(PAT_NAME_AS_MULTIPART_YN.equals("Y")){
	if (!First_Name.equals("") && Soundex.equals("")){
	whereClause.append(" "+strAND+" UPPER(a.First_Name) like UPPER('"+First_Name+"%') ");
	strAND="AND";

	}

	if (!Second_Name.equals("") && Soundex.equals("")){
	whereClause.append(" "+strAND+" upper(a.second_name) like upper('"+Second_Name+"%')");
	strAND="AND";

	}																														

	if (!Third_Name.equals("")&& Soundex.equals("")){
	whereClause.append(" "+strAND+" UPPER(a.Third_Name) like UPPER('"+Third_Name+"%') ");
	strAND="AND";

	}																														

	if (!Family_Name.equals("") && Soundex.equals("")){
...
/***Ends**/
/**Where Clause Constructed Based Upon PAT_NAME_AS_MULTIPART_YN**/
...
//	strOR="OR";
	...
	if(!family_name_loc_lang.equals("")) {
		if(Search_By_Lang.equals("S")){
				whereClause.append(" "+strAND+" upper(a.family_name_loc_lang) like upper('"+family_name_loc_lang+"%')");
		}else if(Search_By_Lang.equals("C")){
				whereClause.append(" "+strAND+" upper(a.family_name_loc_lang) like upper('%"+family_name_loc_lang+"%')");
		}else if(Search_By_Lang.equals("E")){
				whereClause.append(" "+strAND+" upper(a.family_name_loc_lang) like upper('%"+family_name_loc_lang+"')");
		}
		strAND="AND";
	}	
...
/* Commented by Ashwin K for AAKH-CRF-0150			
if (!Mode.equals("")&&!Contact_No.equals("")){
	if(Mode.equals("PRN")){
		whereClause.append(" "+strAND+" upper(a.Contact1_Mode)=upper(trim('" + Mode+ "')) and upper(a.Contact1_No)=upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("ORN")){
		whereClause.append(" "+strAND+" upper(a.Contact2_Mode)=upper(trim('" + Mode+ "')) and upper(a.Contact2_No)=upper(trim('" + Contact_No  + "'))");
		
		/*Below line modified for this CRF PMG2013-MMS-CRF-0004 [IN:045277]
	}else if(Mode.equals("NHPN")){
		whereClause.append(" "+strAND+" upper(m.RES1_TEL_NO)=upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("NMPN")){
		whereClause.append(" "+strAND+" upper(m.CONTACT1_MOB_TEL_NO)=upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("NOPN")){
		whereClause.append(" "+strAND+" upper(m.OFF1_TEL_NO)=upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("FHPN")){
		whereClause.append(" "+strAND+" upper(m.RES2_TEL_NO)=upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("FMPN")){
		whereClause.append(" "+strAND+" upper(m.CONTACT2_MOB_TEL_NO)=upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("FOPN")){
		whereClause.append(" "+strAND+" upper(m.OFF2_TEL_NO)=upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("EHPN")){
		whereClause.append(" "+strAND+" upper(m.RES3_TEL_NO)=upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("EOPN")){
		whereClause.append(" "+strAND+" upper(m.OFF3_TEL_NO)=upper(trim('" + Contact_No  + "'))");
		//end this CRF PMG2013-MMS-CRF-0004 [IN:045277]
	}else{
		whereClause.append(" "+strAND+" (upper(a.Contact3_No)=upper(trim('" + Contact_No  + "')) or upper(a.Contact4_No)=upper(trim('" + Contact_No  + "')) or upper(a.Contact5_No)=upper(trim('" + Contact_No  + "')))");
	}
*/
...
if(function_name.equals("01") || function_name.equals("05") )
	...
	if(!Contact_No.equals(""))
		{
		if(contact_search_by.equals("S")){			
			Contact_No = Contact_No+"%";
		}else if(contact_search_by.equals("C")){			
			Contact_No = "%"+Contact_No+"%";
		}else if(contact_search_by.equals("E")){			
			Contact_No = "%"+Contact_No;
		}
	}
//Ended by Ashwin K for AAKH-CRF-0150
//Added by Ashwin K for AAKH-CRF-0150 -- replaced all '=' with 'like' for Contact_No columns
if (!Mode.equals("")&&!Contact_No.equals("")){	
	if(Mode.equals("PRN")){
		whereClause.append(" "+strAND+" upper(a.Contact1_Mode)=upper(trim('" + Mode+ "')) and upper(a.Contact1_No) like upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("ORN")){
		whereClause.append(" "+strAND+" upper(a.Contact2_Mode)=upper(trim('" + Mode+ "')) and upper(a.Contact2_No) like upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("NHPN")){
		whereClause.append(" "+strAND+" upper(m.RES1_TEL_NO) like upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("NMPN")){
		whereClause.append(" "+strAND+" upper(m.CONTACT1_MOB_TEL_NO) like upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("NOPN")){
		whereClause.append(" "+strAND+" upper(m.OFF1_TEL_NO) like upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("FHPN")){
		whereClause.append(" "+strAND+" upper(m.RES2_TEL_NO) like upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("FMPN")){
		whereClause.append(" "+strAND+" upper(m.CONTACT2_MOB_TEL_NO)like upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("FOPN")){
		whereClause.append(" "+strAND+" upper(m.OFF2_TEL_NO) like upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("EHPN")){
		whereClause.append(" "+strAND+" upper(m.RES3_TEL_NO) like upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("EOPN")){
		whereClause.append(" "+strAND+" upper(m.OFF3_TEL_NO) like upper(trim('" + Contact_No  + "'))");
		//end this CRF PMG2013-MMS-CRF-0004 [IN:045277]
	}else{
		whereClause.append(" "+strAND+" (upper(a.Contact3_No) like upper(trim('" + Contact_No  + "')) or upper(a.Contact4_No) like upper(trim('" + Contact_No  + "')) or upper(a.Contact5_No) like upper(trim('" + Contact_No  + "')))");
	}
strAND="AND";
}
else if(Mode.equals("")&&!Contact_No.equals("")){
	
	whereClause.append(" "+strAND+" (upper(a.Contact1_No) like upper(trim('" + Contact_No + "')) or upper(a.Contact2_No) like upper(trim('" + Contact_No  + "')) or upper(a.Contact3_No) like upper(trim('" + Contact_No  + "')) or upper(a.Contact4_No) like upper(trim('" + Contact_No  + "')) or upper(a.Contact5_No) like upper(trim('" + Contact_No  + "')) or upper(m.RES1_TEL_NO) like upper(trim('" + Contact_No + "')) or upper(m.CONTACT1_MOB_TEL_NO) like upper(trim('" + Contact_No  + "')) or upper(m.OFF1_TEL_NO) like upper(trim('" + Contact_No  + "')) or upper(m.RES2_TEL_NO) like upper(trim('" + Contact_No  + "'))   or upper(m.CONTACT2_MOB_TEL_NO) like upper(trim('" + Contact_No  + "'))  or upper(m.OFF2_TEL_NO) like upper(trim('" + Contact_No  + "'))  or upper(m.RES3_TEL_NO) like upper(trim('" + Contact_No  + "')) or upper(m.OFF3_TEL_NO) like upper(trim('" + Contact_No  + "')))");
	strAND="AND";
} 
}//Ended by Ashwin K for AAKH-CRF-0150 
else 
	{
	//Added the existing code in the below else condition for AAKH-CRF-0150
	if (!Mode.equals("")&&!Contact_No.equals("")){
	if(Mode.equals("PRN")){
		whereClause.append(" "+strAND+" upper(a.Contact1_Mode)=upper(trim('" + Mode+ "')) and upper(a.Contact1_No)=upper(trim('" + Contact_No  + "'))");
	}else if(Mode.equals("ORN")){
...
strAND="AND";
	...
	/*whereClause.append(" "+strAND+" (a.Contact1_No=trim('" + Contact_No + "') or a.Contact2_No=trim('" + Contact_No  + "') or a.Contact3_No=trim('" + Contact_No  + "') or a.Contact4_No=trim('" + Contact_No  + "') or a.Contact5_No=trim('" + Contact_No  + "'))");
	strAND="AND";*/	
	
	/*above line commented and below line added for this CRF PMG2013-MMS-CRF-0004 [IN:045277]*/
	
	whereClause.append(" "+strAND+" (upper(a.Contact1_No)=upper(trim('" + Contact_No + "')) or upper(a.Contact2_No)=upper(trim('" + Contact_No  + "')) or upper(a.Contact3_No)=upper(trim('" + Contact_No  + "')) or upper(a.Contact4_No)=upper(trim('" + Contact_No  + "')) or upper(a.Contact5_No)=upper(trim('" + Contact_No  + "')) or upper(m.RES1_TEL_NO)=upper(trim('" + Contact_No + "')) or upper(m.CONTACT1_MOB_TEL_NO)=upper(trim('" + Contact_No  + "')) or upper(m.OFF1_TEL_NO)=upper(trim('" + Contact_No  + "')) or upper(m.RES2_TEL_NO)=upper(trim('" + Contact_No  + "'))   or upper(m.CONTACT2_MOB_TEL_NO)=upper(trim('" + Contact_No  + "'))  or upper(m.OFF2_TEL_NO)=upper(trim('" + Contact_No  + "'))  or upper(m.RES3_TEL_NO)=upper(trim('" + Contact_No  + "')) or upper(m.OFF3_TEL_NO)=upper(trim('" + Contact_No  + "')))");
	strAND="AND";
	}
	}
...
strAND="AND";
 ...
 if (!First_Name.equals("") && !Second_Name.equals("")){
	String cmpltName=First_Name+Second_Name;
	      if (Soundex.equals("E")){
				whereClause.append(" "+strAND+" a.ethnic_sndx_first_second=ethnic_soundex('" +cmpltName+ "')");
		  }
		  else if (Soundex.equals("G")){
			  whereClause.append(" "+strAND+" a.generic_sndx_first_second=soundex('"+cmpltName+"')");
		  }																														 
	strAND="AND";
}
if (!First_Name.equals("") && !Family_Name.equals("")){
		String cmpltName=First_Name+Family_Name;
	      if (Soundex.equals("E")){
				whereClause.append(" "+strAND+" a.ethnic_sndx_first_family=ethnic_soundex('" +cmpltName+ "')");
		  }
		  else if (Soundex.equals("G")){
			  whereClause.append(" "+strAND+" a.generic_sndx_first_family=soundex('"+cmpltName+"')");
		  }																														 
	strAND="AND";
}

if (!First_Name.equals("") && (Second_Name.equals("") && Family_Name.equals(""))){
	if (Soundex.equals("E")){
				whereClause.append(" "+strAND+" a.ethnic_sndx_first=ethnic_soundex('" +First_Name+ "')");
		  }
		  else if (Soundex.equals("G")){
			  whereClause.append(" "+strAND+" a.generic_sndx_first=soundex('"+First_Name+"')");
		  }																														 
	strAND="AND";
}
if (!Second_Name.equals("") && First_Name.equals("")){
	if (Soundex.equals("E")){
				whereClause.append(" "+strAND+" a.ethnic_sndx_second=ethnic_soundex('" +Second_Name+ "')");
		  }
		  else if (Soundex.equals("G")){
			  whereClause.append(" "+strAND+" a.generic_sndx_second=soundex('"+Second_Name+"')");
		  }																														 
	strAND="AND";
}
...
if (!Third_Name.equals("")){
	if (Soundex.equals("E")){
				whereClause.append(" "+strAND+" a.ethnic_sndx_third=ethnic_soundex('" +Third_Name+ "')");
		  }
		  else if (Soundex.equals("G")){
			  whereClause.append(" "+strAND+" a.generic_sndx_third=soundex('"+Third_Name+"')");
		  }																														 
	strAND="AND";
}
if (!Family_Name.equals("") && First_Name.equals("")){
	if (Soundex.equals("E")){
				whereClause.append(" "+strAND+" a.ethnic_sndx_family=ethnic_soundex('" +Family_Name+ "')");
		  }
		  else if (Soundex.equals("G")){
			  whereClause.append(" "+strAND+" a.generic_sndx_family=soundex('"+Family_Name+"')");
		  }																														 
	strAND="AND";
}
...
whereClause.append(" "+strAND+"  UPPER(a.oth_alt_Id_no) like UPPER('"+other_alt_Id_no+"') || '%'");	
strAND="AND";
}																														
/*******Ends*******/
...
whereClause.append( "  "+strAND+"  a.family_org_sub_id='"+sub_Organisation+"' ");
}	
/*******Ends********/
// naren - check and remove the below SQL
...
if(deceased_yn.equals("Y")&&suspend_yn.equals("Y")&& active_yn.equals("Y")){
	whereClause.append(" "+strAND+" (deceased_yn = 'Y' OR  suspend_yn = 'Y' and deceased_yn = 'N' and active_yn = 'Y' OR  active_yn = 'N' and Deceased_Yn='N' and suspend_yn = 'N' ) ");
	strAND="AND";
}else if(deceased_yn.equals("Y")&&suspend_yn.equals("Y")){
	whereClause.append(" "+strAND+" (deceased_yn = 'Y' OR  suspend_yn = 'Y' and deceased_yn = 'N' and active_yn = 'Y') ");
	strAND="AND";

}else if(suspend_yn.equals("Y") && active_yn.equals("Y") ){
	whereClause.append(" "+strAND+" (suspend_yn = 'Y' and deceased_yn = 'N' and  active_yn = 'Y' or  suspend_yn = 'N' and deceased_yn = 'N' and  active_yn = 'N') ");
	strAND="AND";
}else if(active_yn.equals("Y") && deceased_yn.equals("Y") ){
	whereClause.append(" "+strAND+" (deceased_yn = 'Y' OR  active_yn = 'N' and deceased_yn = 'N' and suspend_yn = 'N') ");
	strAND="AND";
}else if(deceased_yn.equals("Y")){
	whereClause.append(" "+strAND+" (deceased_yn = 'Y') ");
	strAND="AND";
}else if(suspend_yn.equals("Y")){
	whereClause.append(" "+strAND+" (suspend_yn = 'Y' and deceased_yn = 'N' and  active_yn = 'Y')  ");
	strAND="AND";
}else if(active_yn.equals("Y")){
	whereClause.append(" "+strAND+" (suspend_yn = 'N' and deceased_yn = 'N' and  active_yn = 'N')  ");
	strAND="AND";
}
...
final_sql=selectClause.toString();
    ...
    //Below line added Query tuning for full table scan [IN:051268] 
     finalQuery.append(" AND  A.PATIENT_ID BETWEEN NVL ('%%','%%')  AND NVL ('',A.PATIENT_ID)  AND A.PATIENT_ID LIKE '%%' ");//this line added for SQL Query tuning
...
//	int totalpercent = Integer.parseInt(totalpercentage);
  ...
  String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	//p_name_exist_yn
      ...
      if ((maxRecord == 1) && (srr.equals("Y") && multiRec.equals("N"))){ 
		 out.println("<script>parent.commontoolbar.location.href='../jsp/PatientSearchToolBar.jsp'</script>");
		...
		//String w_flag="N";
					...
					String suspend	=	"N";
					String active		=	"N";
					//Single_Rcrd_Query.append("Select a.patient_id  patient_id, Deceased_Yn, Suspend_Yn, Active_Yn from mp_patient a "+whereClause.toString()+"");
					
                //Check_pstmt =conn.prepareStatement(Single_Rcrd_Query.toString()); 
				
                Check_pstmt =conn.prepareStatement(final_sql.toString()); 
//				Check_pstmt.setString(1,pat_id);
            ...
            _bw.write(_wl_block22Bytes, _wl_block22);
					...
					if (func_act.equals("NEWBORN_REG")){
//					if ((func_act.equals("NEWBORN_REG")||func_act.equals("ACTV")||func_act.equals("SUSP")) && deceased.equals("Y") ){
						single_rcd_flag=true;}else{ 
							single_rcd_flag=false;
            ...
            _bw.write(_wl_block26Bytes, _wl_block26);
							...
							out.println("if(parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.dobCal){parent.Pat_Search_Criteria_Frame.document.Advnc_Patient_Search_Form.dobCal.disabled = false;}");
...
catch(Exception e)
{
	...
	if (strMap !=null)
	{
		...
		strDtl = (String)strMap.get("PAT_DTLS");
	      ...
	      out.println("<Table border='0' cellpadding='1' width='100%'><tr><td class='WHITE'><div id='patId' >");
    ...
    else 
    {
			...
			String chkPatDispArch=patdata.checkPatientDisposeArchive(conn,pat_id);
			/*Added By Dharma on 14th Nov 2018 against ML-MMOH-CRF-0735 [IN:062857] End*/
			
            _bw.write(_wl_block38Bytes, _wl_block38);
            out.print( String.valueOf(chkPatDispArch));
            ...
            out.print( String.valueOf(addl_field1));
            _bw.write(_wl_block74Bytes, _wl_block74);
            out.print( String.valueOf(addl_field2));
            _bw.write(_wl_block75Bytes, _wl_block75);
            out.print( String.valueOf(addl_field3));
            _bw.write(_wl_block76Bytes, _wl_block76);
            out.print( String.valueOf(addl_field4));
            _bw.write(_wl_block77Bytes, _wl_block77);
            out.print( String.valueOf(addl_field5));
            ...
            _bw.write(_wl_block84Bytes, _wl_block84);
				...
				out.println("Exception In PatientIDDisplay.jsp Main Catch");
				e.printStackTrace();
	}//End OF Catch
		finally{
