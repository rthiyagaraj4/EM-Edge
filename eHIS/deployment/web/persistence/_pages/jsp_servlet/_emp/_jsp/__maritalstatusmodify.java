...
public final class __maritalstatusmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/maritalStatusModify.jsp", 1709118628572L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="</td>\n\t\t\t\t\t\t<td class=\'fields\' width=\'60%\' colspan=\'2\'>&nbsp;&nbsp;\n\n\t\t\t<input type=\'text\' name=\'mar_status_code\' id=\'mar_status_code\' value=\"";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\" size=\'1\' readonly>\n\t\t\t<img src=\'../images/mandatory.gif\'></img>\n";
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	try{
		...
		//out.println("<script>alert('"+mod_prop+"');</script>");
            ...
            out.print( String.valueOf(rset.getString("mar_status_code")));
