...
public final class __canceldischarge extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/CancelDischarge.jsp", 1729516918756L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 =" frameborder=0 scrolling=\'no\' noresize style=\'height:7vh;width:100vw\'></iframe>\n\t\t\t\t\t<iframe name=\'f_query_add_mod\' id=\'f_query_add_mod\' \t src=\'../jsp/InpatientLookupCriteria.jsp?function_id=";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="&jsp_name=PaintCancelDischargePatient.jsp&win_height=33.4&dialogTop=65&win_width=49.6&call_function=CANCEL_DISCHARGE_PATIENT&wherecondn=CANCEL_DISCHARGE_YN&oper_stn_id=";
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	try
	{
		...
		{	
            ...
            pstmt = con.prepareStatement("SELECT AM_OPER_STN_ACCESS_CHECK(?,?,'N','','CANCEL_DISCHARGE_YN') from dual");
