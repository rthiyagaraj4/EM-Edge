...
public final class __transfervalidation extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/TransferValidation.jsp", 1725254353106L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	/*if(from.equals("getBedClass_trnsOut"))
		...
		else if(from.equals("Transfer_form"))
		{
            ...
            out.print( String.valueOf(fr_bed_class_code));
