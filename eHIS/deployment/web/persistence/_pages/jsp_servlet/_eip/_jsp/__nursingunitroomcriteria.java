...
public final class __nursingunitroomcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/NursingUnitRoomCriteria.jsp", 1709116919890L ,"10.3.6.0","Asia/Calcutta")) return true;
...
firstItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eIP.NursingUnitType.label","ip_labels"));	// label
firstItem.add("nursing_unit_type_code");//name of field
...
thirdItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eIP.DepositApplicable.label","ip_labels"));     // label
thirdItem.add("deposit_appl_yn");   	 //name
...
fourthItem.add("Additional Deposit Required"); // label
fourthItem.add("addl_dep_yn");		       //name
...
orderByCols[0] = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eIP.NursingUnitType.label","ip_labels");
...
strbuff = qrypg.getQueryPage(con,finAr,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.service.label","common_labels"),"../../eAM/jsp/NursingUnitTypeQueryResult.jsp",com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.SortOrder.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.QueryCriteria.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.defaultSelect.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.orderBy.label","common_labels"),orderByCols,orderByColVals,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ExecuteQuery.label","common_labels"));
