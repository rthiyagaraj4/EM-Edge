...
public final class __rep2dlyadmntype extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/Rep2DlyAdmnType.jsp", 1724244110917L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\"\n\t\t\tvar dialogHeight= \"400px\" ;\n\t\t\tvar dialogWidth\t= \"700px\" ;\n\t\t\tvar status = \"no\";\n\t\t\tvar arguments\t= \"\" ;\n\t\t\tvar sql=\"\";\n\t\t\tvar search_code=\"\";\n\t\t\tvar search_desc=\"\";\n\t\t\tvar tit=\"\";\n\t\t\tvar allfacilityid\t=\tdocument.Rep2DlyAdmnTypeForm.p_all_facility_id.value;\n\n\t\t\tif(obj.name==\"nursing_unit_code_fm\" || obj.name==\"nursing_unit_code_to\")\n\t\t\t{\n\t\t\t\ttit=getLabel(\'Common.nursingUnit.label\',\'Common\');\n\n\t\t\t\t//sql=\"select nursing_unit_code, short_desc from ip_nursing_unit where facility_id=`\"+allfacilityid+\"`\t\";\n\t\t\t\t\n\t\t\t\tsql=\"\tselect nursing_unit_code, short_desc from ip_nursing_unit_lang_vw where facility_id=`\"+allfacilityid+\"` and language_id=`\"+locale+\"`\";\n\t\t\t\tsearch_code=\"nursing_unit_code\";\n\t\t\t\tsearch_desc= \"short_desc\";\n\t\t\t}\n\n\t\t\tif(obj.name==\"admission_type\")\n\t\t\t{\n\t\t\t\ttit=getLabel(\'Common.admissiontype.label\',\'Common\');\n\t\t\t\t//sql=\" select admission_type_code, short_desc from ip_admission_type \";\n\n\t\t\t\tsql=\" select admission_type_code, short_desc from ip_admission_type_lang_vw where language_id=`\"+locale+\"`\";\n\t\t\t\tsearch_code=\"admission_type_code\";\n\t\t\t\tsearch_desc= \"short_desc\";\n\t\t\t}\n\n\t\t\tvar features\t= \"dialogHeight:\" + dialogHeight + \"; dialogWidth:\" + dialogWidth +\" ; scroll=no; status:\" + status;\n\t\t\tretVal = await window.showModalDialog(\"../../eCommon/jsp/GeneralSearch.jsp?SQL=\"+sql+\"&search_code=\"+search_code+\"&search_desc=\"+search_desc+\"&title=\"+encodeURIComponent(tit),arguments,features);\n\n\t\t\tif (!(retVal == null))\n\t\t\t{\n\t\t\t\ttarget.value=retVal;\n\t\t\t}\n\t\t\telse\n\t\t\t\ttarget.focus();\n\t}\n\n\tfunction chkVal(obj)\n\t{\n\n\t\tif ( obj.value == \"All\" )\n\t\t{\t\tif(document.Rep2DlyAdmnTypeForm.isSpltyNurUnitToEnableYNAppl.value==\"N\"){\n\t\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_fm_nursing_unit.disabled = true\n\t\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_to_nursing_unit.disabled = true\n\t\t\t\t\tdocument.Rep2DlyAdmnTypeForm.nursing_unit_desc.disabled = true\n\t\t\t\t\tdocument.Rep2DlyAdmnTypeForm.nursing_unit.disabled = true\n\t\t\t\t}else{\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_fm_nursing_unit.disabled = true\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_to_nursing_unit.disabled = true\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.nursing_unit_code_fm.disabled = true\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.nursing_unit_code_to.disabled = true\n\t\t\t\t}\n\t\t}\n\t\telse\n\t\t{\t\tif(document.Rep2DlyAdmnTypeForm.isSpltyNurUnitToEnableYNAppl.value==\"N\"){\n\t\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_fm_nursing_unit.disabled = false\n\t\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_to_nursing_unit.disabled = false\n\t\t\t\t\tdocument.Rep2DlyAdmnTypeForm.nursing_unit_desc.disabled = false\n\t\t\t\t\tdocument.Rep2DlyAdmnTypeForm.nursing_unit.disabled = false\n\t\t\t\t\t}else{\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_fm_nursing_unit.disabled = false\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_to_nursing_unit.disabled = false\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.nursing_unit_code_fm.disabled = false\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.nursing_unit_code_to.disabled = false\n\t\t\t\t\t}\n\t\t}\n\t\t\t\tif(document.Rep2DlyAdmnTypeForm.isSpltyNurUnitToEnableYNAppl.value==\"N\"){\n\t\t\t\t\tdocument.Rep2DlyAdmnTypeForm.nursing_unit_desc.value = \"\"}\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_fm_nursing_unit.value = \"\"\n\t\t\t\tdocument.Rep2DlyAdmnTypeForm.p_to_nursing_unit.value = \"\"\n\n\t}\n\n</script>\n</HEAD>\n\n<BODY onMouseDown=\'CodeArrest()\' onKeyDown=\'lockKey()\'>\n<br>\n<br>\n<form name=\"Rep2DlyAdmnTypeForm\" id=\"Rep2DlyAdmnTypeForm\" action=\"../../eCommon/jsp/report_options.jsp\" target=\"messageFrame\">\n<table width=\'80%\' align=\'center\' valign=\'top\'>\n\n\t\t<th align=\'left\'> ";
    ...
    private final static java.lang.String  _wl_block22 =" &nbsp;</td>\n\t\t\t\t\t<td class=\"fields\" width=\'20%\'  >\n\t\t\t\t\t\t<input type=text  name=\'p_fm_admission_type_code\' id=\'p_fm_admission_type_code\' size=\"2\" maxlength=\"2\" align=\"center\" ><input type=\'button\' name=\'admission_type\' id=\'admission_type\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_fm_admission_type_code)\'>\n\t\t\t\t\t</td>\n\t\t\t\t\t<td class=\"fields\" width=\'40%\'> \n\t\t\t\t\t\t<input type=text  name=\'p_to_admission_type_code\' id=\'p_to_admission_type_code\' size=\"2\" maxlength=\"2\" align=\"center\"><input type=\'button\' name=\'admission_type\' id=\'admission_type\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_to_admission_type_code)\'>\n\t\t\t\t\t</td>\n\t\t\t</tr>\n\t\t\t\n\t\t\t<tr>\n\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t<Td class=\"label\">&nbsp;</td>\n\t\t\t</tr>\n\n\t\t\t<tr>\n\t\t\t\t<td  width=\'30%\' class=\"label\">";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 =" &nbsp;</td>\n\t\t\t\t<td class=\"fields\" width=\'20%\'  >\t\t\t\n\t\t\t\t\t<input type=text   name=\'p_fm_admission_date\' id=\'p_fm_admission_date\' size=\"10\" maxlength=\"10\" align=\"center\" onblur=\'validDateObj(this,\"DMY\",localeName);\'><input type=\"image\" src=\'../../eCommon/images/CommonCalendar.gif\' onClick=\"return showCalendar(\'p_fm_admission_date\');\">\n\t\t\t\t</td>\n\t\t\t\t<td class=\"fields\" width=\'40%\'>\t\t\t\n\t\t\t\t\t<input type=text name=\'p_to_admission_date\' id=\'p_to_admission_date\' size=\"10\" maxlength=\"10\" align=\"center\" onblur=\'validDateObj(this,\"DMY\",localeName);\'><input type=\"image\" src=\'../../eCommon/images/CommonCalendar.gif\' onClick=\"return showCalendar(\'p_to_admission_date\');\">\n\t\t\t\t</td>\n\t\t\t</tr>\n\n\t\t\t<tr>\n\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t<Td class=\"label\">&nbsp;</td>\n\t\t\t</tr>\n\t\t</table>\n\t</td>\n</tr>\n</table>\n\n\t<input type=\"hidden\" name=\"p_facility_id\" id=\"p_facility_id\"\t\tvalue=\"";
...
if(localeName.equals("en"))
    ...
    private boolean _jsp__tag7(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag7.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.admissiondate.label", java.lang.String .class,"key"));
