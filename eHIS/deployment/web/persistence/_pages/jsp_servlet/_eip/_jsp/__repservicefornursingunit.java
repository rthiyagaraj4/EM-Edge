...
public final class __repservicefornursingunit extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/RepServiceForNursingUnit.jsp", 1720629121960L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="&nbsp;&nbsp;</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'20%\'  >\n\t\t\t\t\t\t\t<input type=text  name=\'p_fm_service\' id=\'p_fm_service\' size=\"4\" maxlength=\"4\" align=\"center\"><input type=\'button\' name=\'service_code\' id=\'service_code\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_fm_service)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'40%\'> \n\t\t\t\t\t\t\t<input type=text  name=\'p_to_service\' id=\'p_to_service\' size=\"4\" maxlength=\"4\" align=\"center\"><input type=\'button\' name=\'service_code\' id=\'service_code\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_to_service)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<Td class=\"label\">&nbsp;</td>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t\t<td align=\'left\' width=\'30%\' class=\"label\">";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="&nbsp;&nbsp;</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'20%\'  >\n\t\t\t\t\t\t\t<input type=text  name=\'p_fm_dept\' id=\'p_fm_dept\' size=\"6\" maxlength=\"6\" align=\"center\"><input type=\'button\' name=\'dept_code\' id=\'dept_code\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_fm_dept)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'40%\'> \n\t\t\t\t\t\t\t<input type=text  name=\'p_to_dept\' id=\'p_to_dept\' size=\"6\" maxlength=\"6\" align=\"center\"><input type=\'button\' name=\'dept_code\' id=\'dept_code\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_to_dept)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<Td class=\"label\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t\t<td align=\'left\' width=\'30%\' class=\"label\">";
