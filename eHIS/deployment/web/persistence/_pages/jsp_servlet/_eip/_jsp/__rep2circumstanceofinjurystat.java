...
public final class __rep2circumstanceofinjurystat extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/Rep2CircumstanceofInjuryStat.jsp", 1720629120630L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\"\n\t\t\tvar dialogHeight= \"28\" ;\n\t\t\tvar dialogWidth\t= \"43\" ;\n\t\t\tvar status = \"no\";\n\t\t\tvar arguments\t= \"\" ;\n\t\t\tvar sql=\"\";\n\t\t\tvar search_code=\"\";\n\t\t\tvar search_desc=\"\";\n\t\t\tvar tit=\"\";\n\t\t\t\n\t\t\tvar allfacilityid\t=\tdocument.Rep2CircumstanceofInjuryStatForm.p_all_facility_id.value;\n\n\n\t\t\t\n\t\t\tif(obj.name==\"nursing_unit_code_fm\" || obj.name==\"nursing_unit_code_to\")\n\t\t\t{\n\t\t\t\ttit=getLabel(\'Common.nursingUnit.label\',\'common\');\n\t\t\t\t//sql=\"select nursing_unit_code, short_desc from ip_nursing_unit where facility_id=`\"+allfacilityid+\"` and eff_status = `E` \";\n\t\t\t\t\n\t\t\t\tsql=\"select nursing_unit_code, short_desc from ip_nursing_unit_lang_vw where facility_id=`\"+allfacilityid+\"` and language_id=`\"+locale+\"` and eff_status = `E` \";\n\t\t\t\tsearch_code=\"nursing_unit_code\";\n\t\t\t\tsearch_desc= \"short_desc\";\n\t\t\t}\n\n\t\t\tif(obj.name==\"circumstance_of_injury\")\n\t\t\t{\n\t\t\t\ttit=getLabel(\'Common.CircumstanceofInjury.label\',\'common\');\n\t\t\t\t//sql=\"select circumstance_of_injury_code, short_desc from am_circumstance_of_injury where eff_status=`E` \";\n\t\t\t\tsql=\"select circumstance_of_injury_code, short_desc from AM_CIRCUM_OF_INJURY_LANG_VW where eff_status=`E` and language_id=`\"+locale+\"` \";\n\t\t\t\t\n\t\t\t\tsearch_code=\"circumstance_of_injury_code\";\n\t\t\t\tsearch_desc= \"short_desc\";\n\t\t\t}\n\n\t\t\tvar features\t= \"dialogHeight:\" + dialogHeight + \"; dialogWidth:\" + dialogWidth +\" ; scroll=no; status:\" + status;\n\t\t\tretVal = await window.showModalDialog(\"../../eCommon/jsp/GeneralSearch.jsp?SQL=\"+sql+\"&search_code=\"+search_code+\"&search_desc=\"+search_desc+\"&title=\"+encodeURIComponent(tit),arguments,features);\n\n\t\t\tif (!(retVal == null))\n\t\t\t{\n\t\t\t\ttarget.value=retVal;\n\t\t\t}\n\t\t\telse\n\t\t\t\ttarget.focus();\n\t}\n\n\n\t/*function dateVal( obj )\n\t{\n\t\tif(obj.value !=\"\")\n\t\t{\n\t\t\tif(!doDateTimeChk(obj))\n\t\t\t{\n\t\t\t\tobj.focus()\n\t\t\t\talert( parent.parent.parent.frames[0].getMessage(\"INVALID_DATE_TIME\",\"SM\") )\n\t\t\t}\n\t\t}\n\t}*/\n\n\tfunction chkVal(obj)\n\t{\n\t\tif ( obj.value == \"All\" )\n\t\t{\n\t\t\t\tdocument.forms[0].p_fm_assign_care_locn_code.disabled = true\n\t\t\t\tdocument.forms[0].p_to_assign_care_locn_code.disabled = true\n\t\t\t\tdocument.forms[0].nursing_unit_code_fm.disabled = true\n\t\t\t\tdocument.forms[0].nursing_unit_code_to.disabled = true\n\t\t}\n\t\telse\n\t\t{\n\t\t\t\tdocument.forms[0].p_fm_assign_care_locn_code.disabled = false\n\t\t\t\tdocument.forms[0].p_to_assign_care_locn_code.disabled = false\n\t\t\t\tdocument.forms[0].nursing_unit_code_fm.disabled = false\n\t\t\t\tdocument.forms[0].nursing_unit_code_to.disabled = false\n\t\t}\n\t\t\t\tdocument.forms[0].p_fm_assign_care_locn_code.value = \"\"\n\t\t\t\tdocument.forms[0].p_to_assign_care_locn_code.value = \"\"\n\t}\n</script>\n</HEAD>\n\n<BODY onMouseDown=\'CodeArrest()\' onKeyDown=\'lockKey()\'>\n<br>\n<br>\n<form name=\"Rep2CircumstanceofInjuryStatForm\" id=\"Rep2CircumstanceofInjuryStatForm\" action=\"../../eCommon/jsp/report_options.jsp\" target=\"messageFrame\">\n<table width=\'80%\' align=\'center\' valign=\'top\'>\n\t\t<th align=\'left\'> ";
    ...
    private final static java.lang.String  _wl_block14 =" &nbsp;</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'20%\'  >\n\t\t\t\t\t\t\t<input type=text disabled name=\'p_fm_assign_care_locn_code\' id=\'p_fm_assign_care_locn_code\' size=\"4\" maxlength=\"4\" align=\"center\"><input type=\'button\' disabled  name=\'nursing_unit_code_fm\' id=\'nursing_unit_code_fm\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_fm_assign_care_locn_code)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'40%\'> \n\t\t\t\t\t\t\t<input type=text  disabled name=\'p_to_assign_care_locn_code\' id=\'p_to_assign_care_locn_code\' size=\"4\" maxlength=\"4\" align=\"center\"><input type=\'button\' disabled name=\'nursing_unit_code_to\' id=\'nursing_unit_code_to\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_to_assign_care_locn_code )\'>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t\t<td  width=\'30%\' class=\"label\">";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 =" &nbsp;</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'20%\' >\n\t\t\t\t\t\t\t<input type=text id=\"adm_date_from\" name=\'p_fm_visit_admn_date_time\' id=\'p_fm_visit_admn_date_time\' size=\"10\" maxlength=\"10\" align=\"center\" onblur=\'validDateObj(this,\"DMY\",localeName);\'><input type=\"image\" src=\'../../eCommon/images/CommonCalendar.gif\' onClick=\"return showCalendar(\'adm_date_from\');\">\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'40%\'> \n\t\t\t\t\t\t\t<input type=text id=\"adm_date_to\" name=\'p_to_visit_admn_date_time\' id=\'p_to_visit_admn_date_time\' size=\"10\" maxlength=\"10\" align=\"center\" onblur=\'validDateObj(this,\"DMY\",localeName);\'><input type=\"image\" src=\'../../eCommon/images/CommonCalendar.gif\' onClick=\"return showCalendar(\'adm_date_to\');\">\n\t\t\t\t\t\t</td>\n\t\t\t\t</tr>\t\t\t\t\n\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t\t<td  width=\'30%\' class=\"label\">";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 =" &nbsp;</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'20%\'  >\n\t\t\t\t\t\t\t<input type=text  name=\'p_fm_circ_of_injury_code\' id=\'p_fm_circ_of_injury_code\' size=\"4\" maxlength=\"4\" align=\"center\"><input type=\'button\' name=\'circumstance_of_injury\' id=\'circumstance_of_injury\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_fm_circ_of_injury_code)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'40%\'> \n\t\t\t\t\t\t\t<input type=text  name=\'p_to_circ_of_injury_code\' id=\'p_to_circ_of_injury_code\' size=\"4\" maxlength=\"4\" align=\"center\"><input type=\'button\' name=\'circumstance_of_injury\' id=\'circumstance_of_injury\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_to_circ_of_injury_code )\'>\n\t\t\t\t</tr>\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t</tr>\t\n\n\t\t</table>\n\n\t</td>\n\n</tr>\n\n</table>\n\n\t<input type=\"hidden\" name=\"p_facility_id\" id=\"p_facility_id\"\t\tvalue=\"";
...
if(localeName.equals("en"))
    ...
    private boolean _jsp__tag6(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag6.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.CircumstanceofInjuryCode.label", java.lang.String .class,"key"));
