...
public final class __repreasonforlodgersstay extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/RepReasonForLodgersStay.jsp", 1720629121948L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block7 ="\"></link>\n<script src=\"../../eCommon/js/ValidateControl.js\" language=\'JavaScript\'></script>\n<script language=\"JavaScript\" src=\"../../eCommon/js/common.js\"></script>\n<script src=\'../../eCommon/js/showModalDialog.js\' language=\'JavaScript\'></script>\n\n<script>\nasync function searchCode(obj,target)\n{\n\tvar retVal = \tnew String();\n\tvar dialogHeight= \"400px\" ;\n\tvar dialogWidth=\"900px\";\n\t/* var dialogHeight= \"28\" ;\n\tvar dialogWidth\t= \"43\" ; */\n\tvar status = \"no\";\n\tvar arguments\t= \"\" ;\n\tvar sql=\"\";\n\tvar search_code=\"\";\n\tvar search_desc=\"\";\n\tvar tit=\"\";\n\t\n\tif(obj.name==\"reason_for_stay_type\")\n\t{\n\t\ttit=getLabel(\'eIP.ReasonforLodgerStay.label\',\'IP\');\n\t\tsql=\"select reason_for_stay_code, short_desc from ip_reason_for_lodger_stay \";\n\t\tsearch_code=\"reason_for_stay_code\";\n\t\tsearch_desc= \"short_desc\";\n\t}\n\tvar features\t= \"dialogHeight:\" + dialogHeight + \"; dialogWidth:\" + dialogWidth +\" ; scroll=no; status:\" + status;\n\tretVal = await window.showModalDialog(\"../../eCommon/jsp/GeneralSearch.jsp?SQL=\"+sql+\"&search_code=\"+search_code+\"&search_desc=\"+search_desc+\"&title=\"+encodeURIComponent(tit),arguments,features);\n\n\tif (!(retVal == null))\n\t{\n\t\ttarget.value=retVal;\n\t}\n\telse\n\t\ttarget.focus();\n}\n</script>\n</HEAD>\n\n<BODY onMouseDown=\'CodeArrest()\' onKeyDown=\'lockKey()\'>\n<br>\n<br>\n<form name=\"RepReasonForStayForm\" id=\"RepReasonForStayForm\" action=\"../../eCommon/jsp/report_options.jsp\" target=\"messageFrame\">\n<table width=\'80%\' align=\'center\' valign=\'top\'>\n\n\t\t<th align=\'left\'> ";
    ...
    private final static java.lang.String  _wl_block12 ="</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'20%\'  >\n\t\t\t\t\t\t\t<input type=text  name=\'p_fr_lodger_stay\' id=\'p_fr_lodger_stay\' size=\"2\" maxlength=\"2\" align=\"center\"><input type=\'button\' name=\'reason_for_stay_type\' id=\'reason_for_stay_type\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_fr_lodger_stay)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td  class=\"fields\" width=\'40%\'> \n\t\t\t\t\t\t\t<input type=text  name=\'p_to_lodger_stay\' id=\'p_to_lodger_stay\' size=\"2\" maxlength=\"2\" align=\"center\"><input type=\'button\' name=\'reason_for_stay_type\' id=\'reason_for_stay_type\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_to_lodger_stay)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<Td class=\"label\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\'left\' width=\'30%\' class=\"label\">";
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eIP.ReasonforLodgerStay.label", java.lang.String .class,"key"));
