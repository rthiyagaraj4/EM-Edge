...
public final class __ipinternlreportreprintframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/IpinternlReportReprintFrame.jsp", 1710252272112L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="</title>\n\t<iframe name=\'comps\' id=\'comps\' src=\'../../eCommon/jsp/InternalReportsPrint.jsp?step=1&sqlString=";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="&EncounterId=";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="&dest_locn_type=";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="&dest_locn_code=";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="&reportParamNames=";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="&reportParamValues=";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' frameborder=no noresize></iframe>\n<head>\n<html>\n\n";
	...
	String reportParamValues = ""+encounterid+","+nursing_unit_code+","+location_type+","+patientid+","+gen_file_no+"";
            ...
            out.print( String.valueOf(java.net.URLEncoder.encode(sqlString)));
