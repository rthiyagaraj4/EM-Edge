...
public final class __rep2dailyipcensusspeciality extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/Rep2DailyIPCensusSpeciality.jsp", 1742454485501L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 =" &nbsp;</td>\n\t\t\t\t\t<td class=\"fields\" width=\'25%\'  >\n\t\t\t\t\t\t<input type=text id=\"census_date\"  name=\'p_trn_date\' id=\'p_trn_date\' size=\"10\" maxlength=\"10\" align=\"center\" onblur=\'validDateObj(this,\"DMY\",localeName);\'><input type=\"image\" src=\'../../eCommon/images/CommonCalendar.gif\' onClick=\"return showCalendar(\'census_date\');\">\n\t\t\t\t\t\t<img align=\'center\' src=\'../../eMP/images/mandatory.gif\'>\n\t\t\t\t\t</td>\n\t\t\t\t\t<td colspan =\'2\'>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<Td class=\"label\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t<!-- Added by shanmukh on 3rd-OCT-2018 for ML-MMOH-CRF-1115.1 -->\n\t\t\t\t";
