...
public final class __nursingunitbkgltquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/NursingUnitBkgLtQueryCriteria.jsp", 1709116919452L ,"10.3.6.0","Asia/Calcutta")) return true;
...
secondItem.add("nursing_unit_short_desc");   //name of field
