...
public final class __ambresequforvehicleremoverecord extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/AMBResEquForVehicleRemoveRecord.jsp", 1709113868631L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block4 ="\n\t\t\t<script>\n\t\t\t\tparent.sectionsFrame.location.href = \'../../eAE/jsp/AMBResEquForVehicleAMB.jsp?mode=modify&flag_for_list=false\';\n\t\t\t\tparent.addSectionsFrame.location.href = \"../../eAE/jsp/AMBResEquForVehicleSearchAddSections.jsp?mode=&searchText=";
    private final static byte[]  _wl_block4Bytes = _getBytes( _wl_block4 );

    private final static java.lang.String  _wl_block5 ="&start=";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="&end=";
