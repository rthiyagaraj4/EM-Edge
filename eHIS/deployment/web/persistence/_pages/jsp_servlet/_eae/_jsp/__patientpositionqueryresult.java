...
public final class __patientpositionqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/PatientPositionQueryResult.jsp", 1709113878318L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	{
		// sql						= "";
		 String pat_position_code	= request.getParameter("pat_position_code");
		 ...
		 pat_position_code			= pat_position_code.toUpperCase();
	
	 if ( !(pat_position_code== null || pat_position_code.equals("")) )
	 {
	  sql.append(" where PAT_POSITION_CODE like '"+pat_position_code+"%'");
	  andCheck 	= 1;
	 }
	...
	try
	{
	  ...
	  strsql2.append("select * from AE_PAT_POSITION ");
...
if ( !(start <= 1) )
	out.println("<A HREF='../../eAE/jsp/PatientPositionQueryResult.jsp?from="+(start-14)+"&to="+(end-14)+"&whereclause="+URLEncoder.encode(sql.toString())+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.previous.label","common_labels")+"</A>");

  if (endOfRes.equals("1"))
	out.println("<A id='nextvalue' HREF='../../eAE/jsp/PatientPositionQueryResult.jsp?from="+(start+14)+"&to="+(end+14)+"&whereclause="+URLEncoder.encode(sql.toString())+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.next.label","common_labels")+"</A>"); 
	...
	String pat_position_code_disp = rs.getString("pat_position_code");
	
	out.println("<a href='../../eAE/jsp/addModifyPatientPosition.jsp?pat_position_code="+pat_position_code_disp+"' target='f_query_add_mod' >");
	out.println(pat_position_code_disp+"</a></td><td class='" + classValue + "'>");
