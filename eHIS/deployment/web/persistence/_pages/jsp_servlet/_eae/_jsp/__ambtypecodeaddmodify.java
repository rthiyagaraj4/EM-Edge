...
public final class __ambtypecodeaddmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/AMBTypeCodeAddModify.jsp", 1709113869584L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="</td>\n\t\t      <td class=\'label\' align=\'left\' width=\'40%\'>&nbsp;&nbsp;<input type=\"text\" name=\"amb_service_type\" id=\"amb_service_type\" value=\"";
	 ...
	 while(rset!=null && rset.next())
	  ...
	  if(mode.equalsIgnoreCase("insert")){
		  ...
		  eff_status="E";
            ...
            out.print( String.valueOf(amb_service_type));
