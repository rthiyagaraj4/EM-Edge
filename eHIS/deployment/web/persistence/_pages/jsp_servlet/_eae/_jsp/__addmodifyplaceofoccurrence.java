...
public final class __addmodifyplaceofoccurrence extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/AddModifyPlaceOfOccurrence.jsp", 1709113825178L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block7 ="\'></link>\n  <script language=\'javascript\' src=\'../../eAE/js/AEPlaceOfOccurrence.js\'></script>\n  <script language=\'javascript\' src=\'../../eCommon/js/common.js\'></script>\n  <script language=\'javascript\' src=\'../../eCommon/js/ValidateControl.js\'></script>\n<script src=\'../../eCommon/js/showModalDialog.js\' language=\'JavaScript\'></script>\n\n</head>\n  ";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\n\n\t <body OnMouseDown=\'CodeArrest()\' onKeyDown = \'lockKey()\'>\n\t <form name=\"place_of_occurrence_form\" id=\"place_of_occurrence_form\" action=\"../../servlet/eAE.PlaceOfOccurrencyServlet\" method=\"post\" target=\"messageFrame\">\n\t <table border=\"0\" cellpadding=\"3\" cellspacing=\"0\" align=\'center\' width=\'75%\'>\n\t\t <br><br><br>\n\t    <tr>\n\t\t   <td colspan=\'2\' height=\'5\'></td>\n\t\t</tr>\n\t    <tr>\n\t\t      <td class=\'label\'  width=\'50%\'>";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="</td>\n\t\t      <td class=\'field\'  width=\'50%\'><input type=\'text\' name=\'place_occurrence_type_code\' id=\'place_occurrence_type_code\' value=\'";
    ...
    private final static java.lang.String  _wl_block18 ="</td>\n\t\t      <td   width=\'50%\'><input type=\'checkbox\' name=\'eff_status\' id=\'eff_status\' value=\'";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
     ...
     String place_occurrence_type_code_result	= request.getParameter("place_occurrence_type_code");
	 place_occurrence_type_code_result  = (place_occurrence_type_code_result == null)?"":place_occurrence_type_code_result;
	 
  try
  {
     con								= ConnectionManager.getConnection(request);
	 String place_occurrence_type_code			= "";
	 String long_desc					= "";
	 String short_desc					= "";
	 String eff_status					= "";
	...
	StringBuffer sql = new StringBuffer("select * from AE_PLACE_OF_OCCURRENCE  where PLACE_OCCURRENCE_TYPE_CODE= ?");
 if(!(place_occurrence_type_code_result.equals("")))
  {
	pstmt   = con.prepareStatement(sql.toString());
	pstmt.setString(1,place_occurrence_type_code_result) ;
 	rset = pstmt.executeQuery();
	
	 while(rset!=null && rset.next())
	  {
	 		place_occurrence_type_code			= rset.getString("PLACE_OCCURRENCE_TYPE_CODE");    
			place_occurrence_type_code 			= (place_occurrence_type_code == null)?"":place_occurrence_type_code;
	  ...
	  if(mode.equalsIgnoreCase("INSERT"))
		  checkBoxAttribute = "CHECKED";
            ...
            out.print( String.valueOf(place_occurrence_type_code));
            ...
            _bw.write(_wl_block21Bytes, _wl_block21);
                ...
                if(mode.equals("INSERT"))
					out.println("<script>document.forms[0].eff_status.value='E';document.forms[0].place_occurrence_type_code.focus();</script>");
				 else
