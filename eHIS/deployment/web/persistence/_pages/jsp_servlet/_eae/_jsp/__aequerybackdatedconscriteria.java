...
public final class __aequerybackdatedconscriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/AEQueryBackdatedConsCriteria.jsp", 1709113847241L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\' size=\'12\' name=\'patient_id\' onKeyPress=\'return(CheckForSpecChars(event))\' onBlur=\'ChangeUpperCase(this);if(validSplchars(this)) validatePatientId(this);\'><input type=\"button\" class=BUTTON name=\"patient_search\" id=\"patient_search\" value=\"?\" onClick=\"javascript:showLookUp(\'P\')\"></td>\n\t\t</tr>\n\t\t<tr>\n\t\t  <td COLSPAN=\"4\"> &nbsp;</td>\n\t\t</tr>\n\t\t<tr>\n\t\t\t<td width=\"10%\">&nbsp;</td>\n\t\t\t<td width=\"20%\">&nbsp;</td>\n\t\t\t<td width=\"20%\">&nbsp;</td>\n\t\t\t<td width=\"20%\">&nbsp;</td>\n\t\t\t<td class=\'fields\'><input type=\'button\' class=\'button\' name=\'search\' id=\'search\' style=\"height:20px; width:60px\" value=\'";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' onclick=\'dispResult()\'>&nbsp;<input type=\'button\' class=\'button\' name=\'clear\' id=\'clear\' style=\"height:20px; width:60px\" value=\'";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\' onclick=\'clearResult()\'>\n\t\t\t</td>\n\t\t</tr>\n\t\t<tr>\n\t\t  <td COLSPAN=\"4\"> &nbsp;</td>\n\t\t</tr>\n </form>\n </body>\n";
...
finally
{
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.TransactionDate.label", java.lang.String .class,"key"));
