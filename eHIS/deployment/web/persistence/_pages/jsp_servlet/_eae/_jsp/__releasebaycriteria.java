...
public final class __releasebaycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/ReleaseBayCriteria.jsp", 1709113881490L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block20 ="\' onClick=\"javascript:showresult();\" >\n\t\t\t\t\t\t\t\t<input type=\"button\" class=\"button\"  name=\"clear\" id=\"clear\" value=\'";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\' onClick=\"javascript:clearValues();\">\n\t\t\t\t\t\t\t</td>\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</table>\n\t</td>\n\t\t\t</tr>\n\t\t\t\t\t\t\t\t\t<tr><td  class=\'label\' height=\'5\'></td></tr>\n\t\t</table>\n\t\t\n\t\t</form>\n";
...
finally
{
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eAE.ReserveUntil.label", java.lang.String .class,"key"));
