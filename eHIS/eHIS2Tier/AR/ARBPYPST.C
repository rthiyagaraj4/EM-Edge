...
{
    38,
    "T:\\BL\\CRF-0120\\AR\\WIP\\Proc\\Arbpypst.pc"
};


static unsigned long sqlctx = 1150833749;
...
"select DOC_TYPE_CODE ,DOC_NUM  from AR_PAY_HDR where ((((((DOC_TYPE_CODE>=NV\
...
ME_TITLE ,PRINT_FLAG ,ROWID  from AR_PAY_HDR where (DOC_TYPE_CODE=:b0 and DOC_\
...
Y_LINE where (DOC_TYPE_CODE=:b0 and DOC_NUM=:b1) for update of LINE_NUM nowait\
 ";
...
{10,4274,0,0,0,
5,0,0,1,243,0,4,296,0,0,12,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,1,9,0,0,
68,0,0,2,0,0,29,457,0,0,0,0,0,1,0,
83,0,0,3,0,0,30,465,0,0,0,0,0,1,0,
98,0,0,4,0,0,30,482,0,0,0,0,0,1,0,
113,0,0,5,407,0,9,512,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
152,0,0,14,0,0,13,673,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,
211,0,0,5,0,0,13,729,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
234,0,0,6,819,0,9,840,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
257,0,0,6,0,0,13,847,0,0,40,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
432,0,0,11,138,0,9,945,0,0,1,1,0,1,0,1,9,0,0,
451,0,0,11,0,0,13,957,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
478,0,0,12,82,0,9,985,0,0,1,1,0,1,0,1,9,0,0,
497,0,0,12,0,0,13,993,0,0,1,0,0,1,0,2,9,0,0,
516,0,0,8,91,0,9,1006,0,0,1,1,0,1,0,1,9,0,0,
535,0,0,8,0,0,13,1011,0,0,1,0,0,1,0,2,9,0,0,
554,0,0,9,84,0,9,1022,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
577,0,0,9,0,0,13,1027,0,0,1,0,0,1,0,2,9,0,0,
596,0,0,10,133,0,9,1040,0,0,1,1,0,1,0,1,9,0,0,
615,0,0,10,0,0,13,1053,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
642,0,0,15,104,0,4,1154,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
669,0,0,16,89,0,4,1168,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
696,0,0,7,311,0,9,1261,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
719,0,0,17,0,0,29,1267,0,0,0,0,0,1,0,
734,0,0,13,119,0,9,1279,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
761,0,0,13,0,0,13,1286,0,0,1,0,0,1,0,2,4,0,0,
780,0,0,14,289,0,9,1338,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
803,0,0,18,139,0,4,1346,0,0,5,4,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
838,0,0,7,0,0,13,1423,0,0,13,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
905,0,0,19,471,0,3,1489,0,0,8,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,
952,0,0,20,331,0,3,1547,0,0,11,11,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1011,0,0,21,523,0,3,1589,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1034,0,0,22,70,0,2,1663,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1057,0,0,23,71,0,2,1670,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1080,0,0,24,167,0,4,1754,0,0,3,2,0,1,0,1,4,0,0,1,4,0,0,2,9,0,0,
1107,0,0,25,165,0,4,1763,0,0,3,2,0,1,0,1,4,0,0,1,4,0,0,2,9,0,0,
1134,0,0,26,119,0,3,1780,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,
1173,0,0,27,119,0,3,1835,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,
1212,0,0,28,53,0,5,1868,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1235,0,0,29,60,0,2,1882,0,0,1,1,0,1,0,1,9,0,0,
1254,0,0,30,0,0,29,1889,0,0,0,0,0,1,0,
1269,0,0,31,0,0,27,1900,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
1300,0,0,32,118,0,4,1916,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
1331,0,0,33,62,0,6,1929,0,0,1,1,0,1,0,2,9,0,0,
1350,0,0,34,44,0,4,1936,0,0,2,1,0,1,0,1,9,0,0,2,9,0,0,
1373,0,0,35,44,0,4,1940,0,0,2,1,0,1,0,1,9,0,0,2,9,0,0,
1396,0,0,36,84,0,4,1960,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
1419,0,0,37,140,0,4,1970,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
};
		...
		sprintf(string_var," doc_date_chking is <%ld> last pay doc <%ld>\n",
			...
			d_py_hdr_bank_desc.arr);
             ...
             if (ar_interface_code.arr[0] == 'O')
             {
				  ...
				  ins_gl_distrbn(d_py_hdr_doc_type_code.arr,d_py_hdr_doc_num.arr,6);
...
S where (((DOC_TYPE_CODE=:b1 and DOC_NUM=:b2) and BILL_DOC_TYPE_CODE=:b3) and \
BILL_NUM=:b4)";
             sqlstm.iters = (unsigned int  )1;
...
INE_NUM ,null   from AR_PAY_LINE where (DOC_TYPE_CODE=:b0 and DOC_NUM=:b1)";
  sqlstm.iters = (unsigned int  )1;
