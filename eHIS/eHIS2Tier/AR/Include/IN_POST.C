...
{
    54,
    "C:\\Users\\RajeshK\\Desktop\\Proc_file\\Arbinpst\\IN_POST.PC"
};


static unsigned long sqlctx = 114919733;
...
{10,4130,0,0,0,
5,0,0,1,1430,0,3,283,0,0,56,56,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
...
1,9,0,0,1,9,0,0,
244,0,0,2,269,0,3,424,0,0,12,12,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
307,0,0,3,293,0,3,462,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
350,0,0,4,241,0,5,502,0,0,5,5,0,1,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,9,0,0,
385,0,0,5,328,0,5,515,0,0,8,8,0,1,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,
432,0,0,6,131,0,5,547,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
455,0,0,7,1776,0,4,686,0,0,58,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
...
sqlbuft((void **)0, 
  "insert into AR_PENDING_DOC (ACC_ENTITY_CODE,DOC_TYPE_CODE,DOC_NUM,LAST_DO\
C_LINE_NUM,CUST_CODE,DOC_DATE,NARRATION,BASE_DATE,DUE_DATE,GROSS_AMT,PAYABLE\
_AMT,DISCOUNT_AMT,PENDING_AMT,ALLOCATED_AMT,CURRENCY_CODE,EXCHG_RATE,PMNT_TE\
RMS_CODE,SETTLEMENT_DATE,SETTLEMENT_PERC,CUST_REF,EPISODE_TYPE,EPISODE_ID,VI\
SIT_ID,PATIENT_ID,BILLING_GROUP,BILL_NUM,BILL_DATE,DOCTOR_FEE_AMT,MAIN_ACC1_\
CODE,MAIN_ACC2_CODE,SUBLEDGER_GROUP_CODE,SUBLEDGER_LINE_CODE,DEPT_CODE,PRODU\
CT_GROUP_CODE,PRODUCT_LINE_CODE,POST_MONTH,POST_YEAR,MISC_CUST_LONG_NAME,MIS\
C_CUST_SHORT_NAME,MISC_CUST_ADD1_DESC,MISC_CUST_ADD2_DESC,MISC_CUST_ADD3_DES\
C,MISC_CUST_ZIP_DESC,MISC_CUST_LONG_NAME_CHINESE,MISC_CUST_SHORT_NAME_CHINES\
E,MISC_CUST_ADD1_DESC_CHINESE,MISC_CUST_ADD2_DESC_CHINESE,MISC_CUST_ADD3_DES\
C_CHINESE,MISC_CUST_ZIP_DESC_CHINESE,TEL_NUM,CONTACT_NAME,CONTACT_NAME_TITLE\
,ERROR_FLAG,BILL_DOC_TYPE_CODE,BILL_TYPE_CODE,TRN_TYPE_CODE,LAST_UPD_DATE,MO\
DULE_ID,CONSOLIDATED_INV_YN,MARKUP_AMT,ADDED_BY_ID,MODIFIED_BY_ID,ADDED_DATE\
,MODIFIED_DATE) values (:b0,:b1,:b2,1,:");
sqlstm.stmt = "b3,TO_DATE(:b4,'DD/MM/YYYY'),:b5,TO_DATE(:b6,'DD/MM/YYYY'),TO\
_DATE(:b7,'DD/MM/YYYY'),:b8,:b9,:b10,:b9,0,:b12,:b13,:b14,TO_DATE(:b15,'DD/MM/\
YYYY'),:b16,:b17,:b18,:b19,:b20,:b21,:b22,:b23,TO_DATE(:b24,'DD/MM/YYYY'),:b25\
,:b26,:b27,:b28,:b29,:b30,:b31,:b32,:b33,:b34,:b35,:b36,:b37,:b38,:b39,:b40,:b\
41,:b42,:b43,:b44,:b45,:b46,:b47,:b48,:b49,:b50,:b51,:b52,'1',SYSDATE,:b53,:b5\
4,:b55,USER,USER,SYSDATE,SYSDATE)";
