...
{
    43,
    "T:\\BL\\MEDICITY_POSTING\\SOURCES\\AR\\AR_GLD.PC"
};


static unsigned long sqlctx = 1850246373;
...
0,0,2,3,0,0,2,9,0,0,
1485,0,0,17,447,0,3,1521,0,0,18,18,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1572,0,0,18,447,0,3,1575,0,0,18,18,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1659,0,0,19,482,0,3,1653,0,0,21,21,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1758,0,0,20,449,0,3,1708,0,0,20,20,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
...
_ENTRY_YN) values (:b0,:b1,TO_DATE(:b2,'DD/MM/YYYY'),:b3,:b4,:b5,:b6,:b7,:b8,:\
b9,:b10,:b11,:b12,0,:b13,:b14,:b15,:b16,TO_DATE(:b17,'DD/MM/YYYY'),'REC','Y')";
   sqlstm.iters = (unsigned int  )1;
...
T_ENTRY_YN) values (:b0,:b1,TO_DATE(:b2,'DD/MM/YYYY'),:b3,:b4,:b5,:b6,:b7,:b8,\
:b9,:b10,:b11,0,:b12,:b13,:b14,:b15,:b16,TO_DATE(:b17,'DD/MM/YYYY'),'REC','Y')";
    sqlstm.iters = (unsigned int  )1;
...
,NARRATION,POST_MONTH,POST_YEAR,CHEQUE_NUM,CHEQUE_DATE,TRN_TYPE_CODE,SLMT_PMNT\
_ENTRY_YN) values (:b0,:b1,TO_DATE(:b2,'DD/MM/YYYY'),:b3,:b4,:b5,:b6,:b7,:b8,:\
b9,:b10,:b11,:b12,:b13,:b14,:b15,:b16,:b17,TO_DATE(:b18,'DD/MM/YYYY'),:b19,dec\
ode(:b19,'REC','Y','REF','Y','N'))";
   sqlstm.iters = (unsigned int  )1;
...
NTRY_YN) values (:b0,:b1,TO_DATE(:b2,'DD/MM/YYYY'),:b3,:b4,:b5,:b6,:b7,:b8,:b9\
,:b10,:b11,:b12,:b13,:b14,:b15,:b16,:b17,TO_DATE(:b18,'DD/MM/YYYY'),:b19,'N')";
 sqlstm.iters = (unsigned int  )1;
