...
{
    25,
    "d:\\share\\proc\\arbinpst.pc"
};


static unsigned long sqlctx = 1956272789;
...
"select DOC_TYPE_CODE ,DOC_NUM  from AR_INV_HDR where ((((((DOC_TYPE_CODE>=NV\
...
",ERROR_FLAG ,CONSOLIDATED_INV_YN ,MODULE_ID ,NVL(PB_INVOICE_YN,'N')  from AR\
_INV_HDR where (DOC_TYPE_CODE=:b0 and DOC_NUM=:b1) for update of ERROR_FLAG no\
wait ";
...
"select NVL(AMT_LOCAL,0) ,LINE_NUM ,MAIN_ACC1_CODE ,MAIN_ACC2_CODE ,DEPT_CODE\
 ,PRODUCT_GROUP_CODE ,PRODUCT_LINE_CODE ,SUBLEDGER_GROUP_CODE ,SUBLEDGER_LINE_\
CODE ,AMT_LOCAL  from AR_INV_LINE where (DOC_TYPE_CODE=:b0 and DOC_NUM=:b1) fo\
r update of LINE_NUM nowait ";
...
{10,4274,0,0,0,
5,0,0,1,232,0,4,304,0,0,12,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,1,9,0,0,
68,0,0,2,0,0,29,331,0,0,0,0,0,1,0,
83,0,0,3,0,0,29,428,0,0,0,0,0,1,0,
98,0,0,4,0,0,30,436,0,0,0,0,0,1,0,
113,0,0,5,0,0,30,452,0,0,0,0,0,1,0,
128,0,0,6,407,0,9,473,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
167,0,0,15,0,0,17,649,0,0,1,1,0,1,0,1,97,0,0,
186,0,0,6,0,0,13,671,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
209,0,0,7,1183,0,9,820,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
232,0,0,7,0,0,13,827,0,0,59,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
483,0,0,13,162,0,9,973,0,0,1,1,0,1,0,1,9,0,0,
502,0,0,13,0,0,13,988,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
533,0,0,14,82,0,9,1018,0,0,1,1,0,1,0,1,9,0,0,
552,0,0,14,0,0,13,1026,0,0,1,0,0,1,0,2,9,0,0,
571,0,0,9,91,0,9,1039,0,0,1,1,0,1,0,1,9,0,0,
590,0,0,9,0,0,13,1044,0,0,1,0,0,1,0,2,9,0,0,
609,0,0,10,84,0,9,1053,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
632,0,0,10,0,0,13,1058,0,0,1,0,0,1,0,2,9,0,0,
651,0,0,11,131,0,9,1069,0,0,1,1,0,1,0,1,9,0,0,
670,0,0,11,0,0,13,1082,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
697,0,0,12,79,0,9,1102,0,0,1,1,0,1,0,1,9,0,0,
716,0,0,12,0,0,13,1110,0,0,1,0,0,1,0,2,9,0,0,
735,0,0,16,71,0,4,1134,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
758,0,0,13,162,0,9,1244,0,0,1,1,0,1,0,1,9,0,0,
777,0,0,13,0,0,13,1258,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
804,0,0,15,0,0,45,1321,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
827,0,0,17,0,0,29,1327,0,0,0,0,0,1,0,
842,0,0,15,0,0,13,1358,0,0,9,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,
893,0,0,18,62,0,4,1393,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
916,0,0,13,162,0,9,1412,0,0,1,1,0,1,0,1,9,0,0,
935,0,0,13,0,0,13,1425,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
962,0,0,19,56,0,5,1458,0,0,2,2,0,1,0,1,3,0,0,1,9,0,0,
985,0,0,8,260,0,9,1532,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1008,0,0,20,0,0,29,1538,0,0,0,0,0,1,0,
1023,0,0,8,0,0,13,1568,0,0,10,0,0,1,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1078,0,0,21,492,0,3,1652,0,0,11,11,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,4,0,0,1,4,0,0,1,9,0,0,
1137,0,0,22,348,0,3,1711,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,4,0,0,1,9,0,0,1,9,0,0,
1204,0,0,23,549,0,3,1757,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1235,0,0,24,483,0,3,1818,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1258,0,0,25,70,0,2,1858,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1281,0,0,26,71,0,2,1865,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1304,0,0,27,63,0,4,1899,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
1327,0,0,28,119,0,3,1933,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,
1366,0,0,29,119,0,3,2012,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,
1405,0,0,30,53,0,5,2032,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1428,0,0,31,60,0,2,2046,0,0,1,1,0,1,0,1,9,0,0,
1447,0,0,32,0,0,29,2053,0,0,0,0,0,1,0,
1462,0,0,33,0,0,27,2064,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
1493,0,0,34,118,0,4,2073,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
1524,0,0,35,62,0,6,2084,0,0,1,1,0,1,0,2,9,0,0,
1543,0,0,36,44,0,4,2090,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1566,0,0,37,44,0,4,2094,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1589,0,0,38,53,0,4,2115,0,0,1,0,0,1,0,2,9,0,0,
1608,0,0,39,140,0,4,2125,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
};
       ...
       if (nd_error_flag.arr[0] == 'N')
          {
             ...
             else
             {
                  ...
                  if (!gl_posting())
				  {
				    ...
				    ins_gl_distrbn(doc_type_code.arr,doc_num.arr,1);
...

{
   ...
   /* EXEC SQL DECLARE CUR_INV_LINE CURSOR FOR
             SELECT NVL(AMT_LOCAL,0), LINE_NUM,
                    MAIN_ACC1_CODE,
                    MAIN_ACC2_CODE,
                    DEPT_CODE,
                    PRODUCT_GROUP_CODE,
	...
	/* Added on 2/12/2003 to accomodate temporary adhoc function*/	
		...
		if (strcmp(d_pb_invoice_yn.arr,"Y") == 0)
		{
	           strcpy(l_sql_stmt," SELECT AR_INVOICE_DOC_TYPE_CODE DOC_TYPE_CODE, \
                                    ...
                                    WHERE AR_INVOICE_DOC_TYPE_CODE = :doc_type_code \
...
D ,ACC_ENTITY_CODE ,LAST_LINE_NUM ,NARRATION ,BASE_DATE ,TO_CHAR(BASE_DATE,'\
YYYYMMDD') ,DUE_DATE ,TO_CHAR(DUE_DATE,'YYYYMMDD') ,GROSS_AMT ,DISCOUNT_AMT \
,MARKUP_AMT ,CURRENCY_CODE ,EXCHG_RATE ,SETTLEMENT_DATE ,TO_CHAR(SETTLEMENT_\
DATE,'YYYYMMDD') ,SETTLEMENT_PERC ,CUST_REF ,BILL_DOC_TYPE_CODE ,BILL_NUM ,B\
ILL_DATE ,TO_CHAR(BILL_DATE,'YYYYMMDD') ,DOCTOR_FEE_AMT ,POST_MONTH ,POST_YE\
AR ,MISC_CUST_LONG_NAME ,MISC_CUST_SHORT_NAME ,MISC_CUST_ADD1_DESC ,MISC_CUS\
T_ADD2_DESC ,MISC_CUST_ADD3_DESC ,MISC_CUST_ZIP_DESC ,MISC_CUST_LONG_NAME_CH\
INESE ,MISC_CUST_SHORT_NAME_CHINESE ,MISC_CUST_ADD1_DESC_CHINESE ,MISC_CUST_\
ADD2_DESC_CHINESE ,MISC_CUST_ADD3_DESC_CHINESE ,MISC_CUST_ZIP_DESC_CHINESE ,\
TEL_NUM ,CONTACT_NAME ,CONTACT_NAME_TITLE ");
   sqlstm.stmt = sq0007;
   sqlstm.iters = (unsigned int  )1;
...
open_patient_dtls()
{
   /* EXEC SQL OPEN AR_PATIENT_DTLS_CUR USING :doc_type_code,:doc_num; */ 
...
TYPE_CODE,DOC_NUM,MAIN_ACC1_CODE,MAIN_ACC2_CODE,SUBLEDGER_GROUP_CODE,SUBLEDGER\
_LINE_CODE,DEPT_CODE,PRODUCT_GROUP_CODE,PRODUCT_LINE_CODE,FOREIGN_AMT,LOCAL_AM\
T,NARRATION,LINE_NUM,INTER_ACC_ENTITY,CUST_SUPP_CODE)select :b0 ,0 ,DOC_TYPE_C\
ODE ,DOC_NUM ,MAIN_ACC1_CODE ,MAIN_ACC2_CODE ,SUBLEDGER_GROUP_CODE ,SUBLEDGER_\
LINE_CODE ,DEPT_CODE ,PRODUCT_GROUP_CODE ,PRODUCT_LINE_CODE ,null  ,(AMT_LOCAL\
* (-1)) ,NARRATION ,LINE_NUM ,null  ,:b1  from AR_INV_LINE where (DOC_TYPE_COD\
E=:b2 and DOC_NUM=:b3)";
  sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "insert into AR_PATIENT_DTLS (DOC_TYPE_CODE,DOC_NUM,PATIENT\
_ID,PATIENT_NAME,BILL_DOC_TYPE_CODE,BILL_NUM,BILL_DATE,BILLING_GROUP,AMOUNT,PE\
ND_AMOUNT,LINE_NUM)select A.AR_INVOICE_DOC_TYPE_CODE ,A.AR_INVOICE_DOC_NUM ,A.\
PATIENT_ID ,SUBSTR(B.SHORT_NAME,1,30) ,A.DOC_TYPE_CODE ,A.DOC_NUM ,A.DOC_DATE \
,A.BILLING_GROUP ,A.DOC_AMT ,A.DOC_AMT ,ROWNUM  from AR_PAT_BILLS_TEMP A ,MP_P\
ATIENT_MAST B where ((A.PATIENT_ID=B.PATIENT_ID and A.AR_INVOICE_DOC_TYPE_CODE\
=:b0) and A.AR_INVOICE_DOC_NUM=:b1)";
   sqlstm.iters = (unsigned int  )1;
...
*/ 
   ...
   /* EXEC SQL INSERT INTO AR_DOC_ERROR
                   (PGM_ID,
                    ...
                    LINE_NUM,         ERROR_CODE,
                    ERROR_TEXT)
            VALUES (:d_curr_pgm_name,:doc_type_code,   :doc_num,
