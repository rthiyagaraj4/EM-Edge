...
{
    23,
    "D:\\BLRLM006\\BLRLM006.PC"
};


static unsigned long sqlctx = 577828747;
...
"VL(:b2,'01/01/1000'),'DD/MM/YYYY') a\
nd TO_DATE(NVL(:b3,'01/01/3000'),'DD/MM/YYYY')) and NVL(RECALCULATED_YN,'N')=\
'Y') and :b4 in ('O','E')) and A.episode_type=:b4) order by 1,2,3,4          \
  ";
...
293,0,0,7,0,0,27,644,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
...
RAM7 ,operating_facility_id into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7  from SY_PRO\
...
') ,USER into :b0,:b1,:b2  from SY_ACC_ENTITY_LANG_VW where (ACC_ENTITY_ID=:b\
