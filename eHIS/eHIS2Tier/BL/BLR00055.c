...
{
    24,
    "C:\\TEMP\\proc\\BLR00055.PC"
};


static unsigned long sqlctx = 1164415635;
...
"AR(A.DOC_DATE,'DD/MM/YYYY HH24:MI:SS\
') ,b.DOC_TYPE_CODE ,b.DOC_NUMBER ,a.cancelled_ind ,b.cancelled_date ,(A.DOC_\
AMT* (-1)) ,a.ext_acct_code ,a.EXT_ACCT_DEPT_CODE ,A.SLMT_TYPE_CODE ,A.CASH_S\
LMT_FLAG ,A.SLMT_DOC_REF_DESC ,A.SLMT_DOC_REF_DATE ,substr(A.NARRATION,1,35) \
,A.BANK_IN_BATCH_DOC_TYPE ,A.BANK_IN_BATCH_DOC_NO ,TO_CHAR(A.DOC_DATE,'DD/MM/\
YYYY') ,a.doc_date  from BL_RECEIPT_REFUND_DTL_VW A ,BL_CANCELLED_BOUNCED_TRX\
 b where ((((((a.DOC_TYPE_CODE=b.DOC_TYPE_CODE and a.DOC_NUMBER=b.DOC_NUMBER)\
 and (a.cancelled_ind='Y' or a.bounced_yn='Y')) and TO_DATE(TO_CHAR(b.CANCELL\
ED_DATE,'dd/mm/yyyy'),'dd/mm/yyyy') between TO_DATE(:b0,'DD/MM/YYYY') and TO_\
DATE(:b1,'DD/MM/YYYY')) and A.SLMT_TYPE_CODE in (select SLMT_TYPE_CODE  from \
BL_SLMT_TYPE where CASH_SLMT_FLAG<>DECODE(:b2,'Y','A','~'))) and (((A.BANK_IN\
_BATCH_DOC_NO=A.BANK_IN_BATCH_DOC_NO and :b3='1') or (A.BANK_IN_BATCH_DOC_NO \
is null  and :b3='2')) or :b3='3')) and A.RECPT_REFUND_IND='R') order by slmt\
_type_code,ext_acct_code,doc_date            ";
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,203,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
...
4 into :b0,:b1,:b2,:b3,:b4  from SY_PROG_PARAM where ((PGM_ID='BLR00055' and \
PGM_DATE=:b5) and SESSION_ID=:b6)";
...
:MI') ,USER ,BASE_CURRENCY into :b0,:b1,:b2,:b3  from SY_ACC_ENTITY where ACC\
_ENTITY_ID=:b4";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='BLR00055' an\
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select sign((to_date(:b0,'dd/mm/yyyy')-to_date(:b1,'dd/mm/y\
...
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_00\
10' , :loc_legend1 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_00\
20' , :loc_legend2 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_00\
30' , :loc_legend3 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
50' , :loc_legend4 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_00\
60' , :loc_legend5 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_00\
70' , :loc_legend6 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_00\
80' , :loc_legend7 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_00\
90' , :loc_legend8 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
00' , :loc_legend9 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
10' , :loc_legend10 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
20' , :loc_legend11 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
30' , :loc_legend12 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
40' , :loc_legend13 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
60' , :loc_legend16 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
70' , :loc_legend17 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
80' , :loc_legend18 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_01\
90' , :loc_legend19 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_02\
00' , :loc_legend20 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_02\
10' , :loc_legend21 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_02\
20' , :loc_legend22 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_02\
30' , :loc_legend23 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.stmt = "begin blcommon . get_local_lang_desc ( :nd_operating_facili\
ty_id , 'SM' , 'SM_LANG_LEGEND' , 'DFLT_LEGEND_VALUE' , 'MLBLR00055.LEGEND_02\
40' , :loc_legend24 , :p_language_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
