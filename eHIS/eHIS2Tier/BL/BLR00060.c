...
{
    21,
    "C:\\10xdev\\BLR00060.PC"
};


static unsigned long sqlctx = 139592315;
...
"select cc_sale_draft_no ,slmt_doc_ref_desc ,b.cancelled_date ,to_char(b.can\
celled_date,'DD/MM/YYYY') ,to_char(a.doc_date,'DD/MM/YYYY') ,a.doc_amt ,b.cas\
h_counter_code ,b.added_by_id ,substr(c.action_reason_desc,1,30)  from BL_REC\
EIPT_REFUND_HDRDTL_VW a ,bl_cancelled_bounced_trx b ,bl_action_reason c ,bl_s\
lmt_type d where (((((((((b.cash_counter_facility_id=:b0 and a.doc_type_code=\
b.doc_type_code) and a.doc_number=b.doc_number) and a.recpt_refund_ind='R') a\
nd trunc(b.cancelled_date) between to_date(nvl(:b1,'01/01/1401'),'DD/MM/YYYY'\
) and nvl(to_date(:b2,'DD/MM/YYYY'),sysdate)) and a.slmt_type_code=d.slmt_typ\
e_code) and d.cash_slmt_flag='A') and b.cash_counter_code between nvl(:b3,'!!\
') and nvl(:b4,'~~')) and b.added_by_id between nvl(:b5,'!!!!!!!!!!!!!!!!!!!!\
!!!!!!!!!!') and nvl(:b6,'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')) and b.reason_code\
(+)=c.action_reason_code) order by 3            ";
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,98,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,159,0,4,141,0,0,9,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,
87,0,0,3,84,0,2,173,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
114,0,0,4,0,0,30,201,0,0,0,0,0,1,0,
129,0,0,5,893,0,9,242,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
172,0,0,5,0,0,13,267,0,0,9,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,
223,0,0,6,155,0,4,514,0,0,5,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
258,0,0,7,96,0,4,589,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
281,0,0,8,162,0,6,596,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[16]; } bl_draft_no;

struct { unsigned short len; unsigned char arr[21]; } bl_card_code;
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select PARAM1 ,PARAM2 ,PARAM3 ,PARAM4 ,PARAM5 ,PARAM\
6 into :b0,:b1,:b2,:b3,:b4,:b5  from SY_PROG_PARAM where ((PGM_ID=:b6 and SES\
SION_ID=:b7) and PGM_DATE=:b8)";
...

{
      ...
      sqlstm.sqlety = (unsigned short)256;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&bl_draft_no;
      ...
      sqlstm.sqadto[0] = (unsigned short )0;
      sqlstm.sqtdso[0] = (unsigned short )0;
      sqlstm.sqhstv[1] = (         void  *)&bl_card_code;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&bl_cancel_date;
      ...
      sqlstm.sqadto[3] = (unsigned short )0;
      sqlstm.sqtdso[3] = (unsigned short )0;
      sqlstm.sqhstv[4] = (         void  *)&bl_recpt_date;
      sqlstm.sqhstl[4] = (unsigned int  )13;
      sqlstm.sqhsts[4] = (         int  )0;
      sqlstm.sqindv[4] = (         void  *)0;
      sqlstm.sqinds[4] = (         int  )0;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLR00060.LEGEND_'||LTRIM(RTRIM(TO_CHA\
