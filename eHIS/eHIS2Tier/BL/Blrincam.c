...
{
    26,
    "T:\\BL\\Reports\\BLRINCAM.PC "
};


static unsigned long sqlctx = 883266822;
...
{10,4274,0,0,0,
5,0,0,1,0,0,30,244,0,0,0,0,0,1,0,
20,0,0,2,128,0,4,259,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
51,0,0,3,371,0,4,312,0,0,22,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
154,0,0,4,91,0,2,370,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
177,0,0,5,0,0,17,432,0,0,1,1,0,1,0,1,97,0,0,
196,0,0,5,0,0,45,444,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
267,0,0,5,0,0,45,454,0,0,12,12,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
330,0,0,5,0,0,13,520,0,0,13,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,9,0,0,
397,0,0,10,74,0,9,796,0,0,1,1,0,1,0,1,9,0,0,
416,0,0,10,0,0,13,797,0,0,1,0,0,1,0,2,9,0,0,
435,0,0,9,93,0,9,805,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
458,0,0,9,0,0,13,806,0,0,1,0,0,1,0,2,9,0,0,
477,0,0,8,93,0,9,817,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
500,0,0,8,0,0,13,818,0,0,1,0,0,1,0,2,9,0,0,
519,0,0,6,71,0,9,831,0,0,1,1,0,1,0,1,9,0,0,
538,0,0,6,0,0,13,832,0,0,1,0,0,1,0,2,9,0,0,
557,0,0,7,71,0,9,836,0,0,1,1,0,1,0,1,9,0,0,
576,0,0,7,0,0,13,837,0,0,1,0,0,1,0,2,9,0,0,
595,0,0,11,0,0,27,920,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
626,0,0,12,96,0,4,1018,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
649,0,0,13,165,0,6,1025,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[16]; } nd_fm_dr;

struct { unsigned short len; unsigned char arr[16]; } nd_to_dr;
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/Blrincam.c-arc   1.0   Apr 19 2007 17:06:22   vcm_th  $ sqlca.h 
 */
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/Blrincam.c-arc   1.0   Apr 19 2007 17:06:22   vcm_th  $ sqlda.h 
 */
...
SY_PROG_PARAM where ((PGM_ID='BLRINCAM' and SESSION_ID=:b20) and PGM_DATE=:b21\
)";
   sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='BLRINCAM' and\
...

{
       ...
       sqlstm.sqlety = (unsigned short)256;
       sqlstm.occurs = (unsigned int  )0;
       sqlstm.sqhstv[0] = (         void  *)&nd_fm_year;
       ...
       sqlstm.sqadto[1] = (unsigned short )0;
       sqlstm.sqtdso[1] = (unsigned short )0;
       sqlstm.sqhstv[2] = (         void  *)&nd_to_year;
       ...
       sqlstm.sqadto[2] = (unsigned short )0;
       sqlstm.sqtdso[2] = (unsigned short )0;
       sqlstm.sqhstv[3] = (         void  *)&nd_to_month;
       sqlstm.sqhstl[3] = (unsigned int  )5;
       sqlstm.sqhsts[3] = (         int  )0;
       sqlstm.sqindv[3] = (         void  *)0;
       sqlstm.sqinds[3] = (         int  )0;
       ...
       sqlstm.sqadto[5] = (unsigned short )0;
       sqlstm.sqtdso[5] = (unsigned short )0;
       sqlstm.sqhstv[6] = (         void  *)&nd_fm_ac_dept;
       sqlstm.sqhstl[6] = (unsigned int  )9;
       sqlstm.sqhsts[6] = (         int  )0;
       sqlstm.sqindv[6] = (         void  *)0;
       sqlstm.sqinds[6] = (         int  )0;
       ...
       sqlstm.sqadto[6] = (unsigned short )0;
       sqlstm.sqtdso[6] = (unsigned short )0;
       sqlstm.sqhstv[7] = (         void  *)&nd_to_ac_dept;
       sqlstm.sqhstl[7] = (unsigned int  )9;
       sqlstm.sqhsts[7] = (         int  )0;
       sqlstm.sqindv[7] = (         void  *)0;
       sqlstm.sqinds[7] = (         int  )0;
       ...
       sqlstm.sqadto[7] = (unsigned short )0;
       sqlstm.sqtdso[7] = (unsigned short )0;
       sqlstm.sqhstv[8] = (         void  *)&nd_fm_or_dept;
       sqlstm.sqhstl[8] = (unsigned int  )9;
       sqlstm.sqhsts[8] = (         int  )0;
       sqlstm.sqindv[8] = (         void  *)0;
       sqlstm.sqinds[8] = (         int  )0;
       ...
       sqlstm.sqadto[8] = (unsigned short )0;
       sqlstm.sqtdso[8] = (unsigned short )0;
       sqlstm.sqhstv[9] = (         void  *)&nd_to_or_dept;
       ...
       sqlstm.sqadto[9] = (unsigned short )0;
       sqlstm.sqtdso[9] = (unsigned short )0;
       sqlstm.sqhstv[10] = (         void  *)&nd_fm_dr;
       sqlstm.sqhstl[10] = (unsigned int  )18;
       sqlstm.sqhsts[10] = (         int  )0;
       sqlstm.sqindv[10] = (         void  *)0;
       sqlstm.sqinds[10] = (         int  )0;
       ...
       sqlstm.sqadto[10] = (unsigned short )0;
       sqlstm.sqtdso[10] = (unsigned short )0;
       sqlstm.sqhstv[11] = (         void  *)&nd_to_dr;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRINCAM.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
