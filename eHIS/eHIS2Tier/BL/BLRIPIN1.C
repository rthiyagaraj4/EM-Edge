...
{
    44,
    "T:\\temp\\Bl\\ganapathy\\JDWORK\\PROC\\Blripin1.pc"
};


static unsigned long sqlctx = 1267618909;
...
{10,4274,0,0,0,
5,0,0,1,179,0,4,115,0,0,9,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,1,9,0,0,1,9,0,0,
56,0,0,2,91,0,2,144,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
79,0,0,3,0,0,30,153,0,0,0,0,0,1,0,
94,0,0,4,0,0,27,159,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
};
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/BLRIPIN1.C-arc   1.0   Apr 19 2007 17:06:30   vcm_th  $ sqlca.h 
 */
 ...
 */ 
/*
 * $Header:   T:/eHIS-102/archives/eHIS2Tier/BL/BLRIPIN1.C-arc   1.0   Apr 19 2007 17:06:30   vcm_th  $ sqlda.h 
 */
...
AM20 into :b0,:b1,:b2,:b3,:b4,:b5,:b6  from SY_PROG_PARAM where ((PGM_ID='BLRI\
PIN1' and SESSION_ID=:b7) and PGM_DATE=:b8)";
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='BLRIPIN1' and \
