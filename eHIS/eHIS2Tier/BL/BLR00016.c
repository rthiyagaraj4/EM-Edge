...
,a.slmt_doc_ref_desc Cheque_no ,TO_CHAR(a.slmt_doc_ref_date,'DD/MM/YYYY') che\
que_date ,((((a.doc_type_code||'/')||A.doc_numBER)||'/')||A.DOC_SRNO) Receipt\
_no ,a.slmt_doc_remarks ,a.payer_name ,c.ln1_mail_add ,c.ln2_mail_add ,c.ln3_\
mail_add ,c.ln4_res_add ,c.res_postal_code postal_code ,a.doc_amt ,b.reason_c\
ode ,d.ACTION_REASON_DESC ,a.ext_acct_code  from Bl_receipt_refund_dtl_vw a ,\
BL_CANCELLED_BOUNCED_TRX b ,MP_PAT_OTHER_DTLS c ,bl_action_reason_lang_vw D w\
here (((((((a.doc_type_code=b.doc_type_code and a.DOC_NUMBER=b.DOC_NUMBER) an\
d a.patient_id=c.patient_id(+)) and b.reason_code=d.ACTION_REASON_CODE) and a\
.bounced_yn='Y') and to_char(a.bounced_date,'MM/YYYY')=:b0) and ((((:b1='1' a\
nd a.REPL_CHQ_YN='Y') and to_char(REPL_CHQ_DOC_DATE,'MM/YYYY')<>:b0) or NVL(a\
.REPL_CHQ_YN,'N')='N') or (:b1='2' and nvl(a.REPL_CHQ_YN,'N')='N'))) and lang\
uage_id=:b4)           ";
...
_no ,a.slmt_doc_remarks ,a.payer_name ,c.ln1_mail_add ,c.ln2_mail_add ,c.ln3_\
mail_add ,c.ln4_res_add ,c.res_postal_code postal_code ,a.doc_amt ,b.reason_c\
ode ,d.action_reason_desc ,a.ext_acct_code ,a.repl_chq_doc_type_code ,a.repl_\
chq_doc_num ,a.repl_chq_doc_date  from Bl_receipt_refund_dtl_vw a ,BL_CANCELL\
ED_BOUNCED_TRX b ,mp_pat_other_dtls c ,bl_action_reason_lang_vw D where (((((\
(((a.doc_type_code=b.doc_type_code and a.doc_number=b.doc_number) and a.patie\
nt_id=c.patient_id(+)) and b.reason_code=d.action_reason_code) and a.bounced_\
yn='Y') and a.REPL_CHQ_YN='Y') and to_char(a.bounced_date,'MM/YYYY')=:b0) and\
 (((:b1='1' and a.REPL_CHQ_YN='Y') and to_char(REPL_CHQ_DOC_DATE,'MM/YYYY')=:\
b0) or (:b1='2' and a.REPL_CHQ_YN='Y'))) and language_id=:b4)           ";
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select PARAM1 ,PARAM2 into :b0,:b1  from SY_PROG_PARAM wh\
ere ((PGM_ID=:b2 and SESSION_ID=:b3) and PGM_DATE=:b4)";
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select count(1) into :b0  from bl_submodule where (S\
UBMODULE_ID='EX' and INSTALL_YN='Y')";
        sqlstm.iters = (unsigned int  )1;
...
'DD/MM/YYYY') ,((a.doc_type_code||'/')||a.doc_number) ,a.slmt_doc_remarks ,a.\
doc_amt ,a.narration ,a.payer_name ,c.ln1_mail_add ,c.ln2_mail_add ,c.ln3_mai\
l_add ,c.ln4_res_add ,c.res_postal_code postal_code into :b0,:b1,:b2,:b3,:b4,\
:b5,:b6,:b7,:b8,:b9,:b10,:b11  from Bl_receipt_refund_dtl_vw a ,MP_PAT_OTHER_\
DTLS c where ((a.patient_id=c.patient_id(+) and a.doc_type_code=:b12) and a.d\
oc_number=:b13)";
    sqlstm.iters = (unsigned int  )1;
...
,'DD/MM/RRRR') ,TO_CHAR(SYSDATE,'HH24:MI:SS') ,USER into :b0,:b1,:b2,:b3,:b4 \
 from SY_ACC_ENTITY_LANG_VW where (ACC_ENTITY_ID=:b5 and LANGUAGE_ID=:b6)";
    sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLR00016.LEGEND_'||LTRIM(RTRIM(TO_CHA\
...

{
 ...
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "declare t_date date ; BEGIN get_locale_date . convert_to_lo\
cale_date ( to_date ( :nd_temp_date , 'mm/yyyy' ) , :p_language_id , t_date )\
