...
{
    56,
    "D:\\Other Development\\Pro C\\RLTANLRQ\\RLTANLRQ\\Rltanlrq.pc"
};


static unsigned long sqlctx = 794274499;
...
{10,4274,0,0,0,
5,0,0,1,0,0,30,106,0,0,0,0,0,1,0,
20,0,0,2,64,0,6,128,0,0,1,1,0,1,0,1,9,0,0,
39,0,0,3,76,0,4,151,0,0,1,0,0,1,0,2,9,0,0,
58,0,0,4,145,0,4,158,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
81,0,0,5,0,0,27,199,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
112,0,0,6,211,0,3,219,0,0,3,3,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,
139,0,0,7,118,0,4,236,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
162,0,0,8,287,0,3,242,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
193,0,0,9,136,0,5,259,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
216,0,0,10,0,0,29,267,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[31]; } prg_start_date;
...
struct { unsigned short len; unsigned char arr[150]; } d_machine_name;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "begin RL_ANALYZER_IDENTIFY ( :nd_operating_facility_id ) ; \
END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select processing_interval into :b0  from SY_PROG_ID whe\
re PGM_ID='RLTANLRQ'";
    sqlstm.iters = (unsigned int  )1;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select machine_name into :b0  from SY_BG_PROCESS_CONTROL\
 where ((OPERATING_FACILITY_ID=:b1 and PGM_ID='RLTANLRQ') and STARTED_DATE is\
  not null )";
    sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "insert into SY_PROG_MSG (OPERATING_FACILITY_ID,PGM_ID,MSG\
_TYPE,MSG_NUM,MSG_DESC,MSG_DATE_TIME,SESSION_ID,PGM_DATE) values (:b0,'RLTANL\
RQ',:b1,null ,:b2,SYSDATE,USERENV('sessionid'),TO_CHAR(SYSDATE,'DD/MM/YYYY'))";
   sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select count(1) into :b0  from RL_ANALYZER_PROGRAMS_LOG whe\
re (OPERATING_FACILITY_ID=:b1 and analyzer_name='RLTANLRQ')";
 sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "insert into RL_ANALYZER_PROGRAMS_LOG (OPERATING_FACILITY_I\
D,analyzer_name,machine_name,last_run_at,ADDED_AT_WS_NO,ADDED_FACILITY_ID,MOD\
IFIED_AT_WS_NO,MODIFIED_FACILITY_ID) values (:b0,'RLTANLRQ',:b1,SYSDATE,sys_c\
ontext('USERENV','IP_ADDRESS'),:b0,sys_context('USERENV','IP_ADDRESS'),:b0)";
  sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "update RL_ANALYZER_PROGRAMS_LOG  set last_run_at=SYSDATE,m\
achine_name=:b0 where (OPERATING_FACILITY_ID=:b1 and analyzer_name='RLTANLRQ'\
)";
  sqlstm.iters = (unsigned int  )1;
