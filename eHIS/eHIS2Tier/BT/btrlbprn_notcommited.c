...
{
    23,
    "d:\\btrlbprn\\btrlbprn.pc"
};


static unsigned long sqlctx = 580471723;
...
"L(b.blood_group,a.blood_group) blood_group ,NVL(b.blood_grp_for_disp,a.blood\
_group) blood_grp_for_disp ,NVL(b.disp_long_desc,a.long_desc) blood_group_desc\
  from BT_BLOOD_GROUP_MAST_LANG_VW a ,BD_BLOOD_GRP_DESC_MAST_LANG_VW b where (\
(a.blood_group=b.blood_group(+) and a.language_id=b.language_id(+)) and a.lang\
uage_id=:b5)) d where ((a.rhesus_code=b.rhesus_code and a.volume_units=c.uom_c\
ode(+)) and a.blood_group=d.blood_group(+)) order by a_unit_no,a_product_code \
           ";
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,383,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,170,0,6,392,0,0,2,2,0,1,0,1,9,0,0,2,9,0,0,
59,0,0,3,0,0,30,584,0,0,0,0,0,1,0,
74,0,0,4,0,0,30,592,0,0,0,0,0,1,0,
89,0,0,5,86,0,4,630,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
112,0,0,6,109,0,6,708,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
135,0,0,7,136,0,6,717,0,0,2,2,0,1,0,2,9,0,0,1,3,0,0,
158,0,0,8,1292,0,9,789,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
197,0,0,9,1501,0,9,855,0,0,8,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,
244,0,0,10,1522,0,9,928,0,0,10,10,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
299,0,0,10,0,0,13,1007,0,0,17,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,
382,0,0,11,267,0,6,1100,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,
413,0,0,12,369,0,6,1182,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
448,0,0,9,0,0,13,1294,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,
527,0,0,13,266,0,6,1384,0,0,3,3,0,1,0,3,9,0,0,1,9,0,0,2,9,0,0,
554,0,0,14,369,0,6,1442,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
589,0,0,8,0,0,13,1555,0,0,15,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
664,0,0,15,266,0,6,1643,0,0,3,3,0,1,0,3,9,0,0,1,9,0,0,2,9,0,0,
691,0,0,16,369,0,6,1700,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
726,0,0,17,105,0,4,1745,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
753,0,0,18,1264,0,6,1795,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
824,0,0,19,115,0,4,1906,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
851,0,0,20,116,0,4,1937,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
878,0,0,21,106,0,4,1963,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
901,0,0,22,98,0,4,1971,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
924,0,0,23,351,0,4,2017,0,0,11,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
983,0,0,24,155,0,4,2027,0,0,10,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1038,0,0,25,504,0,4,2038,0,0,15,11,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
1113,0,0,26,167,0,4,2052,0,0,11,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1172,0,0,27,351,0,4,2063,0,0,11,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
1231,0,0,28,155,0,4,2075,0,0,10,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1286,0,0,29,464,0,4,2088,0,0,13,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1353,0,0,30,155,0,4,2103,0,0,10,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1408,0,0,31,387,0,4,2117,0,0,13,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
1475,0,0,32,171,0,4,2128,0,0,11,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1534,0,0,33,347,0,4,2140,0,0,11,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
1593,0,0,34,155,0,4,2151,0,0,10,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1648,0,0,35,270,0,4,2162,0,0,11,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
1707,0,0,36,155,0,4,2173,0,0,10,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1762,0,0,37,195,0,4,2189,0,0,12,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1825,0,0,38,155,0,4,2201,0,0,10,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1880,0,0,39,155,0,4,2212,0,0,10,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1935,0,0,40,124,0,4,2259,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
1962,0,0,41,187,0,4,2302,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
1997,0,0,42,178,0,4,2310,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
2032,0,0,43,141,0,4,2317,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
2067,0,0,44,178,0,4,2324,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
2102,0,0,45,211,0,6,2341,0,0,2,2,0,1,0,3,9,0,0,1,9,0,0,
2125,0,0,46,245,0,4,2602,0,0,8,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,1,9,0,0,1,9,0,0,
2172,0,0,47,111,0,4,2663,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
2199,0,0,48,1006,0,6,2693,0,0,8,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,2,9,0,0,
2246,0,0,49,119,0,4,2759,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
2269,0,0,50,111,0,4,2939,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
2292,0,0,51,224,0,3,3320,0,0,3,3,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,
2319,0,0,52,154,0,4,3699,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
};
...

{
	...
	BEGIN
		...
		t_date := NVL(GET_LOCALE_DATE.GET_CURRENT_DATE (:language_id ),SYSDATE);
 	:nd_sys_date := to_char(t_date,'MONTH DD YYYY');
	END;
    END-EXEC; */ 

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "declare t_date date ; BEGIN t_date := NVL ( GET_LOCALE_DATE \
. GET_CURRENT_DATE ( :language_id ) , SYSDATE ) ; :nd_sys_date := to_char ( t_\
date , 'MONTH DD YYYY' ) ; END ;";
...
dclr_un_screenedali_cur()
{
		/* EXEC SQL DECLARE c_scr_ali CURSOR FOR
			...
			AND  ((:a_pgm_id = 'BTRALILB') AND A.seq_no = NVL(TO_NUMBER(:d_sequence_no), 0))
...
ode=:b1) and A.operating_facility_id=:b2) and (:b3='BTRALILB' and A.seq_no=N\
VL(TO_NUMBER(:b4),0))) and A.Product_code=B.Product_code) and A.Unit_no=B.un\
it_no)) a ,(select rhesus_code ,long_desc  from BT_RHESUS_CODE_MAST_LANG_VW \
where language_id=:b5) b ,(select uom_code ,short_desc  from BT_UOM_MAST_LAN\
G_VW where language_id=:b5) c ,(select NV");
  sqlstm.stmt = sq0009;
  sqlstm.iters = (unsigned int  )1;
...
/* EXEC SQL EXECUTE
	...
	t_date   date;
	BEGIN
	GET_LOCALE_DATE.CONVERT_TO_LOCALE_DATE (to_date(:nd_donation_date,'DD/MM/YYYY'), :language_id , t_date);
	:nd_donation_date1 := to_char(t_date,'DD/MM/YYYY');
	:nd_collection_date := to_char(t_date,'DD Mon YYYY');
	END;
END-EXEC; */ 
...
sqlstm.sqladtp = &sqladt;
sqlstm.sqltdsp = &sqltds;
sqlstm.stmt = "declare t_date date ; BEGIN GET_LOCALE_DATE . CONVERT_TO_LOCA\
LE_DATE ( to_date ( :nd_donation_date , 'DD/MM/YYYY' ) , :language_id , t_date\
 ) ; :nd_donation_date1 := to_char ( t_date , 'DD/MM/YYYY' ) ; :nd_collection_\
date := to_char ( t_date , 'DD Mon YYYY' ) ; END ;";
sqlstm.iters = (unsigned int  )1;
...
/* EXEC SQL EXECUTE
	...
	GET_LOCALE_DATE.CONVERT_TO_LOCALE_DATE (l_date, :language_id , s_date);
	:nd_expiry_date1 := to_char(s_date,'DD/MM/YYYY');
	:nd_expiry_date2 := to_char(s_date,'DDMMYYYYHH24MI');
	:nd_expiry_date3 := to_char(s_date,'DD Mon YYYY HH24:MI');
...
sqlstm.sqladtp = &sqladt;
sqlstm.sqltdsp = &sqltds;
sqlstm.stmt = "declare s_date date ; l_date date ; BEGIN l_date := to_date (\
 :nd_expiry_date , 'DD/MM/YYYY HH24:MI' ) ; GET_LOCALE_DATE . CONVERT_TO_LOCAL\
E_DATE ( l_date , :language_id , s_date ) ; :nd_expiry_date1 := to_char ( s_da\
te , 'DD/MM/YYYY' ) ; :nd_expiry_date2 := to_char ( s_date , 'DDMMYYYYHH24MI' \
) ; :nd_expiry_date3 := to_char ( s_date , 'DD Mon YYYY HH24:MI' ) ; END ;";
sqlstm.iters = (unsigned int  )1;
  ...
  if (strlen(nd_donation_date.arr) >0)
  {
	/* EXEC SQL EXECUTE
		DECLARE
			t_date   date;
		BEGIN
			GET_LOCALE_DATE.CONVERT_TO_LOCALE_DATE 
					(to_date(:nd_donation_date,'DD/MM/YYYY'), :language_id , t_date);
			:nd_donation_date := to_char(t_date,'DD/MM/YYYY');
			:nd_collection_date := to_char(t_date,'DD Mon YYYY');
		END;
	END-EXEC; */ 
...
ALE_DATE ( to_date ( :nd_donation_date , 'DD/MM/YYYY' ) , :language_id , t_dat\
e ) ; :nd_donation_date := to_char ( t_date , 'DD/MM/YYYY' ) ; :nd_collection_\
date := to_char ( t_date , 'DD Mon YYYY' ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "declare s_date date ; l_date date ; BEGIN l_date := to_date \
( :nd_expiry_date , 'DD/MM/YYYY HH24:MI' ) ; GET_LOCALE_DATE . CONVERT_TO_LOCA\
LE_DATE ( l_date , :language_id , s_date ) ; :nd_expiry_date1 := to_char ( s_d\
ate , 'DD/MM/YYYY' ) ; :nd_expiry_date2 := to_char ( s_date , 'DDMMYYYYHH24MI'\
 ) ; :nd_expiry_date3 := to_char ( s_date , 'DD Mon YYYY HH24:MI' ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...
sqlstm.stmt = "declare t_date date ; BEGIN GET_LOCALE_DATE . CONVERT_TO_LOCA\
LE_DATE ( to_date ( :nd_donation_date , 'DD/MM/YYYY' ) , :language_id , t_date\
 ) ; :nd_donation_date := to_char ( t_date , 'DD/MM/YYYY' ) ; :nd_collection_d\
ate := to_char ( t_date , 'DD Mon YYYY' ) ; END ;";
sqlstm.iters = (unsigned int  )1;
...
/* EXEC SQL EXECUTE
	...
	s_date   date;
	BEGIN
	GET_LOCALE_DATE.CONVERT_TO_LOCALE_DATE (to_date(:nd_collection_date,'DD/MM/YYYY'), :language_id , s_date);
	:nd_collection_date := to_char(s_date,'DD Mon YYYY');
	END;
END-EXEC; */ 
...
sqlstm.sqladtp = &sqladt;
sqlstm.sqltdsp = &sqltds;
sqlstm.stmt = "declare s_date date ; BEGIN GET_LOCALE_DATE . CONVERT_TO_LOCA\
LE_DATE ( to_date ( :nd_collection_date , 'DD/MM/YYYY' ) , :language_id , s_da\
te ) ; :nd_collection_date := to_char ( s_date , 'DD Mon YYYY' ) ; END ;";
sqlstm.iters = (unsigned int  )1;
