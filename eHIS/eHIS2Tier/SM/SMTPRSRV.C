...
{
    34,
    "d:\\ravis\\rl10x\\--62208\\smtprsrv.pc"
};


static unsigned long sqlctx = 535270837;
...
' or (:b4='RLRRSENQ' and online_print_name like 'RLR%')) or (:b4='BLRRSENQ' an\
d online_print_name like 'BL%')) or (:b4='O' and WS_NO in (select WS_NO  from \
RL_RESULT_PRINT_OP_WSNO where OPERATING_FACILITY_ID=DECODE(:b0,'*A',OPERATING_\
FACILITY_ID,:b0)))) or (:b4='N' and WS_NO not  in (select WS_NO  from RL_RESUL\
T_PRINT_OP_WSNO where OPERATING_FACILITY_ID=DECODE(:b0,'*A',OPERATING_FACILITY\
_ID,:b0))))) and PRINT_IMMEDIATE_YN='Y') and PRINT_SUCCESS_YN is null ) order \
by REQUEST_DATE            ";
...
364,0,0,16,883,0,9,910,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
431,0,0,16,0,0,13,973,0,0,12,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
494,0,0,16,0,0,15,1003,0,0,0,0,0,1,0,
509,0,0,17,124,0,6,1076,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,3,9,0,0,3,9,0,0,
540,0,0,18,93,0,5,1257,0,0,1,1,0,1,0,1,9,0,0,
559,0,0,19,91,0,5,1269,0,0,1,1,0,1,0,1,9,0,0,
578,0,0,20,72,0,5,1279,0,0,1,1,0,1,0,1,9,0,0,
597,0,0,21,0,0,29,1294,0,0,0,0,0,1,0,
};
