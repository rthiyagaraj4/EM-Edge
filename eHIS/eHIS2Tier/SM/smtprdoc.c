...
{
    40,
    "D:\\WORK\\ML-MMOH-CRF-0578\\DGB\\SMTPRDOC.pc"
};


static unsigned long sqlctx = 1780783197;
...
{10,4274,0,0,0,
5,0,0,1,0,0,27,430,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,109,0,6,526,0,0,1,1,0,1,0,2,9,0,0,
55,0,0,3,83,0,6,562,0,0,2,2,0,1,0,1,9,0,0,2,9,0,0,
78,0,0,4,121,0,6,690,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,3,9,0,0,3,9,0,0,
109,0,0,5,121,0,6,878,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,2,
3,0,0,
148,0,0,6,129,0,6,904,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,2,
3,0,0,
187,0,0,7,129,0,6,928,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,2,
3,0,0,
226,0,0,8,121,0,6,956,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,2,
3,0,0,
265,0,0,9,129,0,6,984,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,2,
3,0,0,
304,0,0,10,129,0,6,1008,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,
2,3,0,0,
343,0,0,11,91,0,6,1077,0,0,3,3,0,1,0,1,9,0,0,3,9,0,0,3,9,0,0,
370,0,0,12,247,0,6,1276,0,0,12,12,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
433,0,0,13,119,0,4,1337,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
464,0,0,14,96,0,4,1368,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
487,0,0,15,127,0,6,1445,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,
2,3,0,0,
526,0,0,16,123,0,6,1482,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,
2,3,0,0,
565,0,0,17,127,0,6,1505,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,
2,3,0,0,
604,0,0,18,123,0,6,1529,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,
2,3,0,0,
643,0,0,19,122,0,6,1552,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,
2,3,0,0,
682,0,0,20,63,0,4,1593,0,0,1,0,0,1,0,2,9,0,0,
701,0,0,21,142,0,3,1612,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
736,0,0,22,0,0,29,1632,0,0,0,0,0,1,0,
751,0,0,23,75,0,2,1665,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
774,0,0,24,137,0,6,1836,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,
2,3,0,0,
813,0,0,25,132,0,6,1872,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,3,0,0,2,9,0,0,2,3,0,0,
2,3,0,0,
};
...
struct { unsigned short len; unsigned char arr[3]; } BVDelimiter;

 	/* VARCHAR BVPrinterIDs[1024]; */ 
struct { unsigned short len; unsigned char arr[1024]; } BVPrinterIDs;
  		// APPPRINT.Get_Routing_Printers Database Procedure
 	/* VARCHAR BVPrinterNames[1024]; */ 
struct { unsigned short len; unsigned char arr[1024]; } BVPrinterNames;
  		// APPPRINT.Get_Routing_Printers Database Procedure
	/* VARCHAR BVPrinterTypes[1024]; */ 
struct { unsigned short len; unsigned char arr[1024]; } BVPrinterTypes;
  		// APPPRINT.Get_Routing_Printers Database Procedure
 	/* VARCHAR BVQueueNames[1024]; */ 
struct { unsigned short len; unsigned char arr[1024]; } BVQueueNames;
  		// APPPRINT.Get_Routing_Printers Database Procedure
 	/* VARCHAR BVNoOfCopies[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } BVNoOfCopies;
  		// APPPRINT.Get_Routing_Printers Database Procedure
...
struct { unsigned short len; unsigned char arr[64]; } BVPrinterName;
  		// Printer validation
	/* VARCHAR BVPrinterType[2]; */ 
struct { unsigned short len; unsigned char arr[2]; } BVPrinterType;
  			// Printer validation
...
struct { unsigned short len; unsigned char arr[200]; } BVerror_text;
...
struct { unsigned short len; unsigned char arr[64]; } BVSessionID;

	/* VARCHAR BVPGMDateTime[64]; */ 
struct { unsigned short len; unsigned char arr[64]; } BVPGMDateTime;
...
struct { unsigned short len; unsigned char arr[64]; } BVOutputFileNames;
 
 	/* VARCHAR BVLocationTypes[64]; */ 
struct { unsigned short len; unsigned char arr[64]; } BVLocationTypes;
 
 	/* VARCHAR BVLocationCodes[64]; */ 
struct { unsigned short len; unsigned char arr[64]; } BVLocationCodes;
 

 	/* VARCHAR BVFileName[64]; */ 
struct { unsigned short len; unsigned char arr[64]; } BVFileName;
...
struct { unsigned short len; unsigned char arr[4]; } BVPNoOfCopies;

	/* VARCHAR BVPageFrom[4]; */ 
struct { unsigned short len; unsigned char arr[4]; } BVPageFrom;

	/* VARCHAR BVPageTo[4]; */ 
struct { unsigned short len; unsigned char arr[4]; } BVPageTo;


	/* VARCHAR BVValidNoOfCopies[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } BVValidNoOfCopies;

	/* VARCHAR BVNoOfCopy[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } BVNoOfCopy;
				// Printer validation
	/* VARCHAR BVValidNoOfCopy[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } BVValidNoOfCopy;


 	/* VARCHAR BVValidPrinterNames[1024]; */ 
struct { unsigned short len; unsigned char arr[1024]; } BVValidPrinterNames;
 
 	/* VARCHAR BVValidPrinterName[64]; */ 
struct { unsigned short len; unsigned char arr[64]; } BVValidPrinterName;
 

 	/* VARCHAR BVFileNames[1024]; */ 
struct { unsigned short len; unsigned char arr[1024]; } BVFileNames;
		// For GetToken Database Procedure
 	/* VARCHAR BVDelimeter[2]; */ 
struct { unsigned short len; unsigned char arr[2]; } BVDelimeter;
   		// For GetToken Database Procedure
 	int		BVTokenNumber;   		// For GetToken Database Procedure
 	/* VARCHAR BVToken[256]; */ 
struct { unsigned short len; unsigned char arr[256]; } BVToken;
   		// For GetToken Database Procedure
...
struct { unsigned short len; unsigned char arr[2]; } BVNewVersionYN;
	...
	/* VARCHAR BVReportOutputDir[120]; */ 
struct { unsigned short len; unsigned char arr[120]; } BVReportOutputDir;
 // To generate the report file(ZPL)
	/* VARCHAR BVReportClass[2]; */ 
struct { unsigned short len; unsigned char arr[2]; } BVReportClass;
		// Either Label 'L' or Report 'R'
 	/* VARCHAR msg_id[7]; */ 
struct { unsigned short len; unsigned char arr[7]; } msg_id;

 	/* VARCHAR msg_text[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } msg_text;

    /* VARCHAR sm_domain_name[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } sm_domain_name;

	/* VARCHAR v_client_name[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } v_client_name;
 
	/* VARCHAR cur_domain_name[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } cur_domain_name;

	
	/* VARCHAR BVndprinterid[120]; */ 
struct { unsigned short len; unsigned char arr[120]; } BVndprinterid;
   //added for ML-MMOH-CRF-0578
	/* VARCHAR BVndprintername[120]; */ 
struct { unsigned short len; unsigned char arr[120]; } BVndprintername;
//added for ML-MMOH-CRF-0578
	/* VARCHAR BVndqueuename[120]; */ 
struct { unsigned short len; unsigned char arr[120]; } BVndqueuename;
//added for ML-MMOH-CRF-0578
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "begin WORKSTATION . get_workstation_id ( :BVFacilityID , :\
BVWorkstationID ) ; END ;";
   sqlstm.iters = (unsigned int  )1;
...

{
 ...
 :BVWorkstationID , :BVReportOutputDir , :BVErrorText ) ; END ;";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&BVReportOutputDir;
   ...
   sqlstm.sqhstv[3] = (         void  *)&BVErrorText;
   sqlstm.sqhstl[3] = (unsigned int  )1026;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "begin GetToken ( :BVFileNames , :BVDelimiter , :BVToken\
Number , :BVFileName , :BVTokenStartPos , :BVTokenEndPos ) ; END ;";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqlety = (unsigned short)256;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&BVFileNames;
      sqlstm.sqhstl[0] = (unsigned int  )1026;
      sqlstm.sqhsts[0] = (         int  )0;
      sqlstm.sqindv[0] = (         void  *)0;
      sqlstm.sqinds[0] = (         int  )0;
      sqlstm.sqharm[0] = (unsigned int  )0;
      sqlstm.sqadto[0] = (unsigned short )0;
      sqlstm.sqtdso[0] = (unsigned short )0;
      sqlstm.sqhstv[1] = (         void  *)&BVDelimiter;
      ...
      sqlstm.sqadto[1] = (unsigned short )0;
      sqlstm.sqtdso[1] = (unsigned short )0;
      sqlstm.sqhstv[2] = (         void  *)&BVTokenNumber;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&BVFileName;
      ...
      sqlstm.sqadto[3] = (unsigned short )0;
      sqlstm.sqtdso[3] = (unsigned short )0;
      sqlstm.sqhstv[4] = (         void  *)&BVTokenStartPos;
      ...
      sqlstm.sqhstv[5] = (         void  *)&BVTokenEndPos;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "begin GetToken ( :BVLocationTypes , :BVDelimiter , :BVT\
okenNumber , :BVLocationType , :BVTokenStartPos , :BVTokenEndPos ) ; END ;";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqlety = (unsigned short)256;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&BVLocationTypes;
      sqlstm.sqhstl[0] = (unsigned int  )66;
      sqlstm.sqhsts[0] = (         int  )0;
      sqlstm.sqindv[0] = (         void  *)0;
      sqlstm.sqinds[0] = (         int  )0;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&BVLocationType;
      sqlstm.sqhstl[3] = (unsigned int  )66;
      sqlstm.sqhsts[3] = (         int  )0;
      sqlstm.sqindv[3] = (         void  *)0;
      sqlstm.sqinds[3] = (         int  )0;
...

{
      ...
      sqlstm.sqladtp = &sqladt;
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "begin GetToken ( :BVLocationCodes , :BVDelimiter , :BVT\
okenNumber , :BVLocationCode , :BVTokenStartPos , :BVTokenEndPos ) ; END ;";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqlety = (unsigned short)256;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&BVLocationCodes;
      sqlstm.sqhstl[0] = (unsigned int  )66;
      sqlstm.sqhsts[0] = (         int  )0;
      sqlstm.sqindv[0] = (         void  *)0;
      sqlstm.sqinds[0] = (         int  )0;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&BVLocationCode;
      sqlstm.sqhstl[3] = (unsigned int  )66;
      sqlstm.sqhsts[3] = (         int  )0;
      sqlstm.sqindv[3] = (         void  *)0;
      sqlstm.sqinds[3] = (         int  )0;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "begin APPPRINT . get_report_class ( :BVDocumentID , :BVR\
eportClass , :BVErrorText ) ; END ;";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqadto[0] = (unsigned short )0;
     sqlstm.sqtdso[0] = (unsigned short )0;
     sqlstm.sqhstv[1] = (         void  *)&BVReportClass;
     ...
     sqlstm.sqadto[1] = (unsigned short )0;
     sqlstm.sqtdso[1] = (unsigned short )0;
     sqlstm.sqhstv[2] = (         void  *)&BVErrorText;
     sqlstm.sqhstl[2] = (unsigned int  )1026;
     sqlstm.sqhsts[2] = (         int  )0;
     sqlstm.sqindv[2] = (         void  *)0;
     sqlstm.sqinds[2] = (         int  )0;
     sqlstm.sqharm[2] = (unsigned int  )0;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "begin APPPRINT . get_routing_printers ( :BVWorkstationID ,\
 :BVFacilityID , :BVModuleID , :BVDocumentID , :BVLocationType , :BVLocationCo\
de , :BVPrinterIDs , :BVPrinterNames , :BVPrinterTypes , :BVQueueNames , :BVNo\
OfCopies , :BVErrorText ) ; END ;";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqlety = (unsigned short)256;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&BVWorkstationID;
   sqlstm.sqhstl[0] = (unsigned int  )66;
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         void  *)0;
   sqlstm.sqinds[0] = (         int  )0;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&BVModuleID;
   ...
   sqlstm.sqhstl[4] = (unsigned int  )66;
   sqlstm.sqhsts[4] = (         int  )0;
   sqlstm.sqindv[4] = (         void  *)0;
   sqlstm.sqinds[4] = (         int  )0;
   sqlstm.sqharm[4] = (unsigned int  )0;
   ...
   sqlstm.sqadto[5] = (unsigned short )0;
   sqlstm.sqtdso[5] = (unsigned short )0;
   sqlstm.sqhstv[6] = (         void  *)&BVPrinterIDs;
   sqlstm.sqhstl[6] = (unsigned int  )1026;
   ...
   sqlstm.sqhstv[7] = (         void  *)&BVPrinterNames;
   sqlstm.sqhstl[7] = (unsigned int  )1026;
   ...
   sqlstm.sqhstv[8] = (         void  *)&BVPrinterTypes;
   sqlstm.sqhstl[8] = (unsigned int  )1026;
   ...
   sqlstm.sqhstv[9] = (         void  *)&BVQueueNames;
   sqlstm.sqhstl[9] = (unsigned int  )1026;
   ...
   sqlstm.sqhstv[10] = (         void  *)&BVNoOfCopies;
   ...
   sqlstm.sqhstv[11] = (         void  *)&BVErrorText;
   sqlstm.sqhstl[11] = (unsigned int  )1026;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select (PRINTER_ID||',') ,(PRINTER_NAME||',') ,(QUEUE_NAME|\
|',') into :b0,:b1,:b2  from SM_PRINTER where PRINTER_ID=:b3";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&BVPrinterIDs;
  sqlstm.sqhstl[0] = (unsigned int  )1026;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&BVPrinterNames;
  sqlstm.sqhstl[1] = (unsigned int  )1026;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         void  *)0;
  sqlstm.sqinds[1] = (         int  )0;
  sqlstm.sqharm[1] = (unsigned int  )0;
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)&BVQueueNames;
  sqlstm.sqhstl[2] = (unsigned int  )1026;
  sqlstm.sqhsts[2] = (         int  )0;
  sqlstm.sqindv[2] = (         void  *)0;
  sqlstm.sqinds[2] = (         int  )0;
  ...
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (         void  *)&BVndprinterid;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select NVL(print_immediate_yn,'N') into :b0  from sy_online\
_print_id where online_print_name=:b1";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&BVDocumentID;
  sqlstm.sqhstl[1] = (unsigned int  )66;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         void  *)0;
  sqlstm.sqinds[1] = (         int  )0;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "begin GetToken ( :BVPrinterNames , :BVDelimiter , :BVTok\
enNumber , :BVPrinterName , :BVTokenStartPos , :BVTokenEndPos ) ; END ;";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqlety = (unsigned short)256;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (         void  *)&BVPrinterNames;
     sqlstm.sqhstl[0] = (unsigned int  )1026;
     sqlstm.sqhsts[0] = (         int  )0;
     sqlstm.sqindv[0] = (         void  *)0;
     sqlstm.sqinds[0] = (         int  )0;
     ...
     sqlstm.sqadto[2] = (unsigned short )0;
     sqlstm.sqtdso[2] = (unsigned short )0;
     sqlstm.sqhstv[3] = (         void  *)&BVPrinterName;
     sqlstm.sqhstl[3] = (unsigned int  )66;
     sqlstm.sqhsts[3] = (         int  )0;
     sqlstm.sqindv[3] = (         void  *)0;
     sqlstm.sqinds[3] = (         int  )0;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "begin GetToken ( :BVPrinterIDs , :BVDelimiter , :BVToken\
Number , :BVPrinterID , :BVTokenStartPos , :BVTokenEndPos ) ; END ;";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqadto[2] = (unsigned short )0;
     sqlstm.sqtdso[2] = (unsigned short )0;
     sqlstm.sqhstv[3] = (         void  *)&BVPrinterID;
     sqlstm.sqhstl[3] = (unsigned int  )66;
     sqlstm.sqhsts[3] = (         int  )0;
     sqlstm.sqindv[3] = (         void  *)0;
     sqlstm.sqinds[3] = (         int  )0;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "begin GetToken ( :BVPrinterTypes , :BVDelimiter , :BVTok\
enNumber , :BVPrinterType , :BVTokenStartPos , :BVTokenEndPos ) ; END ;";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqlety = (unsigned short)256;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (         void  *)&BVPrinterTypes;
     sqlstm.sqhstl[0] = (unsigned int  )1026;
     sqlstm.sqhsts[0] = (         int  )0;
     sqlstm.sqindv[0] = (         void  *)0;
     sqlstm.sqinds[0] = (         int  )0;
     ...
     sqlstm.sqadto[2] = (unsigned short )0;
     sqlstm.sqtdso[2] = (unsigned short )0;
     sqlstm.sqhstv[3] = (         void  *)&BVPrinterType;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "begin GetToken ( :BVQueueNames , :BVDelimiter , :BVToken\
Number , :BVQueueName , :BVTokenStartPos , :BVTokenEndPos ) ; END ;";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqlety = (unsigned short)256;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (         void  *)&BVQueueNames;
     sqlstm.sqhstl[0] = (unsigned int  )1026;
     sqlstm.sqhsts[0] = (         int  )0;
     sqlstm.sqindv[0] = (         void  *)0;
     sqlstm.sqinds[0] = (         int  )0;
     ...
     sqlstm.sqadto[2] = (unsigned short )0;
     sqlstm.sqtdso[2] = (unsigned short )0;
     sqlstm.sqhstv[3] = (         void  *)&BVQueueName;
     sqlstm.sqhstl[3] = (unsigned int  )66;
     sqlstm.sqhsts[3] = (         int  )0;
     sqlstm.sqindv[3] = (         void  *)0;
     sqlstm.sqinds[3] = (         int  )0;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "begin GetToken ( :BVNoOfCopies , :BVDelimiter , :BVToken\
Number , :BVNoOfCopy , :BVTokenStartPos , :BVTokenEndPos ) ; END ;";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqlety = (unsigned short)256;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (         void  *)&BVNoOfCopies;
     ...
     sqlstm.sqadto[2] = (unsigned short )0;
     sqlstm.sqtdso[2] = (unsigned short )0;
     sqlstm.sqhstv[3] = (         void  *)&BVNoOfCopy;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select to_char(sysdate,'ddmmyyyyhh24miss') into :b0  from d\
ual ";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&BVPGMDateTime;
  sqlstm.sqhstl[0] = (unsigned int  )66;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "insert into sy_print_drivers (SESSION_ID,ADD_DATE_TIME,P\
RINTER_NAME,DEST_PORT_NAME,NUM_OF_PAGES,ERROR_TEXT) values (:b0,:b1,:b2,:b3,:b\
4,null )";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqlety = (unsigned short)256;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (         void  *)&BVSessionID;
     sqlstm.sqhstl[0] = (unsigned int  )66;
     sqlstm.sqhsts[0] = (         int  )0;
     sqlstm.sqindv[0] = (         void  *)0;
     sqlstm.sqinds[0] = (         int  )0;
     ...
     sqlstm.sqadto[0] = (unsigned short )0;
     sqlstm.sqtdso[0] = (unsigned short )0;
     sqlstm.sqhstv[1] = (         void  *)&BVPGMDateTime;
     sqlstm.sqhstl[1] = (unsigned int  )66;
     sqlstm.sqhsts[1] = (         int  )0;
     sqlstm.sqindv[1] = (         void  *)0;
     sqlstm.sqinds[1] = (         int  )0;
     ...
     sqlstm.sqadto[1] = (unsigned short )0;
     sqlstm.sqtdso[1] = (unsigned short )0;
     sqlstm.sqhstv[2] = (         void  *)&BVPrinterName;
     sqlstm.sqhstl[2] = (unsigned int  )66;
     sqlstm.sqhsts[2] = (         int  )0;
     sqlstm.sqindv[2] = (         void  *)0;
     sqlstm.sqinds[2] = (         int  )0;
     ...
     sqlstm.sqadto[3] = (unsigned short )0;
     sqlstm.sqtdso[3] = (unsigned short )0;
     sqlstm.sqhstv[4] = (         void  *)&BVNumOfPages;
     sqlstm.sqhstl[4] = (unsigned int  )sizeof(int);
     sqlstm.sqhsts[4] = (         int  )0;
     sqlstm.sqindv[4] = (         void  *)0;
     sqlstm.sqinds[4] = (         int  )0;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "begin GetToken ( :BVValidPrinterNames , :BVDelimiter , :\
BVTokenNumber , :BVValidPrinterName , :BVTokenStartPos , :BVTokenEndPos ) ; EN\
D ;";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqlety = (unsigned short)256;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (         void  *)&BVValidPrinterNames;
     sqlstm.sqhstl[0] = (unsigned int  )1026;
     sqlstm.sqhsts[0] = (         int  )0;
     sqlstm.sqindv[0] = (         void  *)0;
     sqlstm.sqinds[0] = (         int  )0;
     ...
     sqlstm.sqadto[2] = (unsigned short )0;
     sqlstm.sqtdso[2] = (unsigned short )0;
     sqlstm.sqhstv[3] = (         void  *)&BVValidPrinterName;
     sqlstm.sqhstl[3] = (unsigned int  )66;
     sqlstm.sqhsts[3] = (         int  )0;
     sqlstm.sqindv[3] = (         void  *)0;
     sqlstm.sqinds[3] = (         int  )0;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "begin GetToken ( :BVValidNoOfCopies , :BVDelimiter , :BVTok\
enNumber , :BVValidNoOfCopy , :BVTokenStartPos , :BVTokenEndPos ) ; END ;";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&BVValidNoOfCopies;
  sqlstm.sqhstl[0] = (unsigned int  )102;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (         void  *)&BVValidNoOfCopy;
  sqlstm.sqhstl[3] = (unsigned int  )102;
  sqlstm.sqhsts[3] = (         int  )0;
  sqlstm.sqindv[3] = (         void  *)0;
  sqlstm.sqinds[3] = (         int  )0;
