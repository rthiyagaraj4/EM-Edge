...
{
  private String[] columnNames = {"Select", "Status", "Comm Status", "Process", "Gateway Server", "Application","Gateway","Retries","Last Comm Time","Last Msg ID","Total Messages","Communication Type","Start Date Time","Started By","End Date Time"};
