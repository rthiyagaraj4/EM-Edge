...
public class ServiceLocator implements ServiceVerifiable {
	...
	private static String jdbc_lookup = "jdbc/EMWebServiceDS";
    ...
    /**
     * Private Constructor to facilitate the use of a Singleton Pattern
    ...
    public DataSource getDataSource(String jndiHomeName)  throws ServiceLocatorException {
        ...
        try {
            if (cache.containsKey(jndiHomeName)) {
                ...
                ds = (DataSource)envContext.lookup(jndiHomeName);
  ...
  //Removed Synchronization on the method -- by Chandra 11/04/2003
    public Connection getConnection(String facilityId){
        Connection connection = null;
        try{
        	if (facilityId.equalsIgnoreCase("RP"))
        		jdbc_lookup = "jdbc/EMWebServiceDSRP";
        	if (facilityId.equalsIgnoreCase("KH"))
        		jdbc_lookup = "jdbc/EMWebServiceDSKH";
        	
        	System.out.println(" *************************** "+jdbc_lookup+" *************************** ");
