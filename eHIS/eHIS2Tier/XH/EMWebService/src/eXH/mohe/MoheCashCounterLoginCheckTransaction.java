...
public class MoheCashCounterLoginCheckTransaction {
	...
	public String l_eventType = "BL08";
	...
	public String TransRequestMethod(String actionKey) {
		...
		try{
			...
			l_app_msg = " ::: Inside MoheCashCounterLoginCheckTransaction TransRequestMethod ::: ";
			...
			String l_cash_counter_code = XHJSONUtil.getJsonRequestString(l_in_JSON, "cash_counter_code");
			
			if (l_cash_counter_code.indexOf("Error") >= 0) {
				l_errcd = "E";
				l_errmsg = "cash counter code not available in request parameter -"+l_cash_counter_code;
				l_response_err_json = " { " + " \"status\" : \"0\" , " + " \"message\" : \" " + l_errmsg + " \"  "+ " } ";	
			...
			try{
				...
				cstmt = dbConn.prepareCall(CahsCounterLoginCheckQuery);
				...
				l_user_id = cstmt.getString(3);
				String p_msg = cstmt.getString(4);
				String p_status = cstmt.getString(5);
			...
			{
				l_status = "1";
				l_status_desc = "Cash Counter Login Check details successfully retrieved";
				...
				l_response_json.put("user_id", l_user_id);
