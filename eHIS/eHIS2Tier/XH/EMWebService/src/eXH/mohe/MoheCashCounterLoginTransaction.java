...
public class MoheCashCounterLoginTransaction {
	...
	public String l_eventType = "BL06";
	...
	public String TransRequestMethod(String actionKey) {
		...
		String l_workstation_id = "", l_cash_counter_code = "";
		String p_msg = "", p_status = "";
		...
		try{
			...
			l_app_msg = " ::: Inside MoheCashCounterLoginTransaction TransRequestMethod ::: ";
			...
			String l_opening_balance = "", l_language_id = "";
			
			l_app_msg = " ::: Getting Opening Balance from JSON :::";
			if (l_debug_YN.equals("Y"))		System.out.println(l_app_msg);
			
			l_opening_balance = XHJSONUtil.getJsonRequestString(l_in_JSON, "opening_balance");			
			if (l_opening_balance.indexOf("Error") >= 0) {
				l_errcd = "E";
				l_errmsg = "opening_balance cannot be empty - "+l_opening_balance;
				l_response_err_json = " { " + " \"status\" : \"0\" , " + " \"message\" : \" " + l_errmsg + " \"  "+ " } ";	
			...
			l_app_msg = " ::: Opening Balance : " + l_opening_balance;
			if (l_debug_YN.equals("Y"))	System.out.println(l_app_msg);
			
			l_app_msg = " ::: User ID : " + l_user_id;
			if (l_debug_YN.equals("Y"))	System.out.println(l_app_msg);
			
			l_app_msg = " ::: Getting Language ID from JSON :::";
			if (l_debug_YN.equals("Y"))		System.out.println(l_app_msg);
			
			l_language_id = XHJSONUtil.getJsonRequestString(l_in_JSON, "language_id");			
			if (l_language_id.indexOf("Error") >= 0) {
				l_errcd = "E";
				l_errmsg = "language_id cannot be empty - "+l_language_id;
				l_response_err_json = " { " + " \"status\" : \"0\" , " + " \"message\" : \" " + l_errmsg + " \"  "+ " } ";	
			...
			l_app_msg = " ::: Language ID : " + l_language_id;
			if (l_debug_YN.equals("Y"))	System.out.println(l_app_msg);
			
			
			try{
				l_app_msg = " ::: Calling Cash Counter Login ::: ";
				if (l_debug_YN.equals("Y")) System.out.println(l_app_msg);
				
				String PatientVisitBillQuery = "{call XB_API_CASH_COUNTER_LOGIN.CASH_COUNTER_LOGIN(?,?,?,?,?,?,?,?)}";
				dbConn = EMDataSource.getConnection();
				cstmt = dbConn.prepareCall(PatientVisitBillQuery);
				
				cstmt.setString(1, l_facility_id);
				cstmt.setString(2, l_cash_counter_code);
				cstmt.setString(3, l_user_id);
				cstmt.setInt(4, Integer.parseInt(l_opening_balance));
				cstmt.setString(5, l_language_id);
				cstmt.setString(6, l_workstation_id);
				...
				p_msg = cstmt.getString(7);
				p_status = cstmt.getString(8);
				...
				l_app_msg = " ::: msg : "+p_msg+" : status : "+p_status;
				if (l_debug_YN.equals("Y")) System.out.println(l_app_msg);
				
				
			}catch (Exception e) {
				e.printStackTrace();
				l_app_msg = " ::: Exception while calling Cash Counter Login - "+ e.getMessage();
			    if (l_debug_YN.equals("Y")) System.out.println(l_app_msg);
			...
			{
				l_status = "1";
				l_status_desc = "Cash Counter Login successfully";
