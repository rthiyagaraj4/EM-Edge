...
{
    73,
    "d:\\dhana\\thai_internl_convertion\\proc_file_internationlization\\winproc.pc"
};
...
static unsigned long sqlctx1 = 778351843;
...
/* EXEC SQL BEGIN DECLARE SECTION; */ 
	...
	/* VARCHAR l_uid_pwd[122],
		  ...
		  l_temp[50],
		  dup_l_uid_pwd[122]; */ 
struct { unsigned short len; unsigned char arr[122]; } l_uid_pwd;

struct { unsigned short len; unsigned char arr[91]; } l_user_id;
...
struct { unsigned short len; unsigned char arr[50]; } l_temp;

struct { unsigned short len; unsigned char arr[122]; } dup_l_uid_pwd;
...

{
 ...
 sqlstm.sqladtp = &sqladt1;
 sqlstm.sqltdsp = &sqltds1;
 sqlstm.stmt = "begin IF sm_installation_tab_check THEN :newversion := 1 ; \
ELSE :newversion := 0 ; END IF ; END ;";
...

{
 ...
 sqlstm.sqladtp = &sqladt1;
 sqlstm.sqltdsp = &sqltds1;
 sqlstm.stmt = "begin workstation . get_workstation_id ( :l_facility_id , :\
l_workstation_id ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
...
/********************************************************************/
	...
	//MessageBox (hWnd, dup_user, "error", MB_OK);
...

{
 ...
 sqlstm.sqladtp = &sqladt1;
 sqlstm.sqltdsp = &sqltds1;
 sqlstm.stmt = "begin workstation . get_ws_param ( :l_workstation_id , :l_p\
aram_id , :l_proc_viewer , :l_error_text ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
