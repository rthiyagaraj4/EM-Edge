...
{
    34,
    "D:\\BLTEST\\11g\\BLR00098\\BLR00098.PC"
};


static unsigned long sqlctx = 274226453;
...
"catg=nvl(:b10,blng_grp_catg)) and ((((:b6='P' and nvl(req_reason_code,'!!!!'\
) between nvl(:b12,'!!!!') and nvl(:b13,'~~~~')) and TRUNC(a.WO_PROCESS_DATE) \
between to_date(:b14,'dd/mm/yyyy') and to_date(:b15,'dd/mm/yyyy')) or ((:b6 in\
 ('A','R') and nvl(APPR_REJN_REASON_CODE,'!!!!') between nvl(:b12,'!!!!') and \
nvl(:b13,'~~~~')) and TRUNC(a.WO_APPR_REJN_DATE) between to_date(:b14,'dd/mm/y\
yyy') and to_date(:b15,'dd/mm/yyyy'))) or ((:b6 in ('C') and nvl(b.REASON_CODE\
,'!!!!') between nvl(:b12,'!!!!') and nvl(:b13,'~~~~')) and TRUNC(b.CANCELLED_\
DATE) between to_date(:b14,'dd/mm/yyyy') and to_date(:b15,'dd/mm/yyyy')))) and\
 to_char(a.org_doc_date,'YYYY') between :b26 and :b27)           ";

 static const char *sq0008 = 
"!') between nvl(:b12,'!!!!') and nvl(:b13,'~~~~')) and TRUNC(a.WO_APPR_REJN_\
DATE) between to_date(:b14,'dd/mm/yyyy') and to_date(:b15,'dd/mm/yyyy'))) or (\
(:b6 in ('C') and nvl(b.REASON_CODE,'!!!!') between nvl(:b12,'!!!!') and nvl(:\
b13,'~~~~')) and TRUNC(b.CANCELLED_DATE) between to_date(:b14,'dd/mm/yyyy') an\
d to_date(:b15,'dd/mm/yyyy')))) and to_char(a.org_doc_date,'YYYY') between :b2\
6 and :b27)           ";
...
36,0,0,2,247,0,4,190,0,0,14,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
107,0,0,3,84,0,2,225,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
134,0,0,4,73,0,4,233,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
157,0,0,5,0,0,30,276,0,0,0,0,0,1,0,
172,0,0,6,1711,0,9,391,0,0,28,28,0,1,0,1,9,0,0,1,4,0,0,1,4,0,0,1,9,0,0,1,9,0,0,
...
299,0,0,6,0,0,15,399,0,0,0,0,0,1,0,
314,0,0,8,1434,0,9,407,0,0,28,28,0,1,0,1,9,0,0,1,4,0,0,1,4,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,
441,0,0,8,0,0,15,415,0,0,0,0,0,1,0,
456,0,0,7,289,0,9,422,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
483,0,0,7,0,0,15,430,0,0,0,0,0,1,0,
498,0,0,7,0,0,13,451,0,0,6,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,
537,0,0,6,0,0,13,502,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
596,0,0,8,0,0,13,547,0,0,1,0,0,1,0,2,4,0,0,
615,0,0,9,206,0,4,1161,0,0,7,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,
9,0,0,1,9,0,0,
658,0,0,10,395,0,4,1208,0,0,12,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
721,0,0,11,259,0,4,1266,0,0,8,2,0,1,0,1,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,1,9,0,0,
768,0,0,12,100,0,4,1299,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
791,0,0,13,102,0,4,1316,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
818,0,0,14,96,0,4,1383,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
841,0,0,15,162,0,6,1390,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
872,0,0,16,199,0,6,1534,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[11]; } nd_fm_year;

struct { unsigned short len; unsigned char arr[11]; } nd_to_year;
...
double  bl_wo_request_amt,bl_wo_request_tot_amt,nd_bl_wo_tot_amt,nd_fr_wo_amt=0,nd_to_wo_amt=0,get_amount;			
int i,sl_no=1;
char filename[150];
char x_msg[200];
...

{
	...
	//	nd_to_wo_amt.arr[0]			= '\0';	
        ...
        /* EXEC SQL SELECT	PARAM1,PARAM2,PARAM3,PARAM4,PARAM5,PARAM6,PARAM7,to_number(PARAM8),to_number(PARAM9),PARAM10,PARAM11
				INTO	:nd_fm_date,
						:nd_to_date,
						:nd_fm_reason_code,
						:nd_to_reason_code,
...

{
 ...
 ,PARAM7 ,to_number(PARAM8) ,to_number(PARAM9) ,PARAM10 ,PARAM11 into :b0,:b1,\
:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10  from SY_PROG_PARAM where ((PGM_ID=:b11 a\
nd SESSION_ID=:b12) and PGM_DATE=:b13)";
        ...
        sqlstm.sqhstv[9] = (         void  *)&nd_fm_year;
        ...
        sqlstm.sqhstv[10] = (         void  *)&nd_to_year;
...
c_entity_id=:b1";
   ...
   sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	 ...
	 open_wo_tot_dtl() ;
	   ...
	   nd_bl_wo_tot_amt = bl_wo_request_tot_amt;	     
       
	   close_wo_tot_dtl();
	   
	   
		put_val(g_amt,nd_bl_wo_tot_amt); 
		format_amt(g_amt); 
		 sprintf(gstr_amt,"%-11s",g_amt);
         fprintf(fp,"                                                                           	Grand Total :             %-11s  ",gstr_amt);
	     //fprintf (fp,"                                                                           	Grand Total :             %10.2f \n",gstr_amt);  
...
declare_cur()
{
  ...
  b.REASON_CODE  Canc_reason_code,
   ...
   and to_char(a.org_doc_date,'YYYY') between :nd_fm_year and :nd_to_year ; */ 
   ...
   /* EXEC SQL DECLARE WO_DTL_CUR_TOT CURSOR FOR 
				select  sum(a.wo_request_amt)
                from bl_wo_request_dtl a,bl_wo_request_canc_dtl b,bl_bill_dcp_dtl_vw d,bl_blng_grp_by_catg e
                where a.operating_facility_id=:nd_facility
				and   a.operating_facility_id = d.operating_facility_id
				and   a.org_doc_type_code = d.doc_type_code
...
w d ,bl_blng_grp_by_catg e where ((((((((((((a.operating_facility_id=:b0 and\
 a.operating_facility_id=d.operating_facility_id) and a.org_doc_type_code=d.\
doc_type_code) and a.org_doc_num=d.doc_num) and a.doc_type_code=b.doc_type_c\
ode(+)) and a.doc_num=b.doc_num(+)) and d.blng_grp_id=e.blng_grp_id) and nvl\
(a.wo_approved_amt,0) between :b1 and :b2) and ((:b3='A' or (:b3='C' and REL\
N_CODE='NATIONALS')) or (:b3='O' and RELN_CODE='OTHERS'))) and ((nvl(cancell\
ed_yn,'N')='N' and (((:b6='P' and WO_APPROVED_YN is null ) or (:b6='A' and W\
O_APPROVED_YN='Y')) or (:b6='R' and WO_APPROVED_YN='N'))) or (:b6='C' and nv\
l(cancelled_yn,'N')='Y'))) and blng_grp_");
 sqlstm.stmt = sq0006;
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqhstv[26] = (         void  *)&nd_fm_year;
...

{
 ...
 sqlstm.sqltdsp = &sqltds;
 sqlbuft((void **)0, 
   "select sum(a.wo_request_amt)  from bl_wo_request_dtl a ,bl_wo_request_ca\
nc_dtl b ,bl_bill_dcp_dtl_vw d ,bl_blng_grp_by_catg e where ((((((((((((a.op\
erating_facility_id=:b0 and a.operating_facility_id=d.operating_facility_id)\
 and a.org_doc_type_code=d.doc_type_code) and a.org_doc_num=d.doc_num) and a\
.doc_type_code=b.doc_type_code(+)) and a.doc_num=b.doc_num(+)) and d.blng_gr\
p_id=e.blng_grp_id) and nvl(a.wo_approved_amt,0) between :b1 and :b2) and ((\
:b3='A' or (:b3='C' and RELN_CODE='NATIONALS')) or (:b3='O' and RELN_CODE='O\
THERS'))) and ((nvl(cancelled_yn,'N')='N' and (((:b6='P' and WO_APPROVED_YN \
is null ) or (:b6='A' and WO_APPROVED_YN='Y')) or (:b6='R' and WO_APPROVED_Y\
N='N'))) or (:b6='C' and nvl(cancelled_yn,'N')='Y'))) and blng_grp_catg=nvl(\
:b10,blng_grp_catg)) and ((((:b6='P' and nvl(req_reason_code,'!!!!') between\
 nvl(:b12,'!!!!') and nvl(:b13,'~~~~')) and TRUNC(a.WO_PROCESS_DATE) between\
 to_date(:b14,'dd/mm/yyyy') and to_date(:b15,'dd/mm/yyyy')) or ((:b6 in ('A'\
,'R') and nvl(APPR_REJN_REASON_CODE,'!!!");
 sqlstm.stmt = sq0008;
 sqlstm.iters = (unsigned int  )1;
...
bl_wo_request_tot_amt           = 0;


      /* EXEC SQL FETCH WO_DTL_CUR_TOT
               INTO :bl_wo_request_tot_amt; */ 

{
      ...
      sqlstm.sqlety = (unsigned short)256;
      sqlstm.occurs = (unsigned int  )0;
      sqlstm.sqhstv[0] = (         void  *)&bl_wo_request_tot_amt;
      ...
      sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
       ...
       if (OERROR)
            err_mesg("FETCH failed on cursor WO_DTL_TOT_CUR",0,"");
...
end_of_rep()
{
	...
	fprintf(fp,"   ...........................   ...................  ............................\n");
	fprintf(fp,"%20s",loc_legend[61]);
	fprintf(fp,"%20s",loc_legend[62]);
	fprintf(fp,"%20s",loc_legend[63]);
	fprintf(fp,"\n\n\n\n"); 
...
/*fprintf(fp," 1. Condition under which write-off are recommended:\n\n");

fprintf(fp,"    ADMINISTRATIVE PROCEDURE MANUAL PART III paragraph 3.11 states Due to the cost and time in the follow up of \n");
fprintf(fp,"    patient debts,only debts above the amount payable by the category H3 outpatient at a level 3 hospital,must be\n");
fprintf(fp,"    followed up.\n\n");

fprintf(fp,"    Paragraph 3.1.2.3 states the following :Debts which are not settled within 3 months of the date of treatment,\n");
fprintf(fp,"    must be written off.\n\n");

fprintf(fp," 2. Recommended write-off according to the above mentioned reasons:\n\n");

fprintf(fp,"    That approval be granted for the write off in terms of section 76(1)(E) and 76(4)(A) of the P.F.M.A and treasury\n");
fprintf(fp,"    regulations for departments and constitutional institutions(part 11.4) of the hospital account amounting to\n");
fprintf(fp,"    R...........(grand total of report.)\n\n");

fprintf(fp,"    Issued in terms of the P.F.M.A No.1 of 1998/No.29 of 1998,Administrative Procedure manual part III and treasury regulations.\n\n\n\n\n");

fprintf(fp,"    ...............       ................             ..............\n");
fprintf(fp,"      Signature                Rank                          Date    \n\n\n");
fprintf(fp,"    ...............       ................             ..............\n");
fprintf(fp,"      Signature                Rank                          Date    \n\n\n");
fprintf(fp,"    ...............       ................             ..............\n");
fprintf(fp,"      Signature                Rank                          Date    \n\n\n");
...
fprintf(fp,"                               APPROVAL FOR WRITING OFF:\n");
fprintf(fp,"                               -------------------------\n\n");
fprintf(fp,"   I, the undersigned declare:\n");
fprintf(fp,"         A. All prescribed instructions regarding the collection of debts have been properly executed and the origin and\n");
fprintf(fp,"            failure to recover the debt is not related to any fraud,theft,negligence of delay caused by an official.\n");
fprintf(fp,"         B. The government or provincial administration does not employ the debtor.\n\n");
fprintf(fp,"                               APPROVED for accounts written off:\n");
fprintf(fp,"                               ---------------------------------\n\n\n");

fprintf(fp,"     ...............       ................             ..............\n");
fprintf(fp,"       Signature                Rank                          Date    \n\n");
fprintf(fp," Delegations:\n");
fprintf(fp," Chief Accounting clerk/Admin officer               up to R  2000.00\n");
fprintf(fp," Senior Admin officer                               up to R  5000.00\n");
fprintf(fp," Assistant Director                                 up to R 10000.00\n");
fprintf(fp," Deputy Director                                    up to R 15000.00\n");
fprintf(fp," Director                                           up to R 20000.00\n");
fprintf(fp," Chief Director                                     up to R 30000.00\n");
fprintf(fp," Chief Financial officer/Chief Operations Officer   up to R 10000.00\n");*/
fprintf(fp,"\n");
	fprintf(fp,"\n\n %80s\n\f",loc_legend[60]);
	fflush(fp);
}
