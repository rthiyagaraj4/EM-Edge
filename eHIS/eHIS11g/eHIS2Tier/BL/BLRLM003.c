...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/BLRLM003.PC"
};


static unsigned int sqlctx = 1288466291;
...
SSIFICATION_TYPE='SC') and NVL(B.CLASSIFICATION_CODE,'!!!!!!') between NVL(:b3\
...
{12,4274,178,0,0,
5,0,0,1,0,0,30,203,0,0,0,0,0,1,0,
20,0,0,2,204,0,4,229,0,0,11,4,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
79,0,0,3,116,0,2,268,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
110,0,0,4,1676,0,9,360,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
181,0,0,4,0,0,15,368,0,0,0,0,0,1,0,
196,0,0,4,0,0,13,393,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,
243,0,0,5,165,0,4,568,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
278,0,0,0,0,0,27,633,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
309,0,0,7,132,0,4,686,0,0,3,2,0,1,0,1,9,0,0,2,9,0,0,1,9,0,0,
336,0,0,8,78,0,4,710,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
363,0,0,9,96,0,4,733,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
390,0,0,10,142,0,4,756,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
421,0,0,11,96,0,4,891,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
444,0,0,12,165,0,6,898,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
475,0,0,13,207,0,6,920,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[16]; } nd_exemp_desc;
...
_ID) and C.CLASSIFICATION_TYPE='SC') and NVL(B.CLASSIFICATION_CODE,'!!!!!!')\
...
char filename[30];
	...
	strcat(filename,"BLRLM003.lis");

    if ((f2 = fopen(filename,"w")) == NULL) 
     {
       disp_message(ERR_MESG,"Error in opening file BLRLM003.lis");
       proc_exit();
      }
 }
...
int **page_no;
{
    ...
    //strncpy(hdr_line3,"REP : BLRLM003",14);
...
here ((OPERATING_FACILITY_ID=:b1 and CLASSIFICATION_CODE=:b2) and language_id=\
:b3)";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (         void  *)&nd_exemp_code;
...
fetch_legend_value()
{
	...
	/* EXEC SQL SELECT LTRIM(RTRIM('BLRLM003.LEGEND_'||LTRIM(RTRIM(TO_CHAR(:i,'009')))))
		        INTO :l_pk_value
			   FROM dual; */ 

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select LTRIM(RTRIM(('BLRLM003.LEGEND_'||LTRIM(RTRIM(TO_CHAR(\
