...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/BLRACTBG.PC"
};


static unsigned int sqlctx = 1288465843;
...
"ty_id between :b8 and :b9) and a.cash_counter_code between DECODE(:b10,'LOWE\
ST','!!',:b10) and DECODE(:b12,'HIGHEST','~~',:b12)) and b.blng_serv_code betw\
een DECODE(:b14,'LOWEST','!!',:b14) and DECODE(:b16,'HIGHEST','~~',:b16)) orde\
r by 1,2,3 )  group by facility_id,cash_cntr_code,blng_serv_desc           ";
...
43,0,0,0,0,0,27,163,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
...

{
 ...
 sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='BLRACTBG' and SE\
...
,NVL(PARAM6,'HIGHEST') ,NVL(PARAM7,'LOWEST') ,NVL(PARAM8,'HIGHEST') ,PARAM9 ,P\
ARAM10 ,PARAM11 ,PARAM12 ,PARAM13 ,PARAM14 into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b\
7,:b8,:b9,:b10,:b11,:b12,:b13  from SY_PROG_PARAM where ((PGM_ID='BLRACTBG' an\
d SESSION_ID=:b14) and PGM_DATE=:b15)";
 sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRACTBG.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
