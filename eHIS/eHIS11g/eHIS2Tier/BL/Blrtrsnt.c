...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/Blrtrsnt.pc"
};


static unsigned int sqlctx = 1288469499;
...
"select distinct a.facility_id ,NVL(b.acc_entity_name,'NO NAME')  from sy_use\
r_lang_vw a ,sy_acc_entity_lang_vw b where ((((user_id=USER and trunc(SYSDATE)\
 between NVL(a.eff_date_from,to_date('01011900','DDMMYYYY')) and NVL(a.eff_dat\
e_to,to_date('01014713','DDMMYYYY'))) and NVL(b.acc_entity_id,'X')=NVL(a.facil\
ity_id,'X')) and a.facility_id between NVL(:b0,'!!') and NVL(:b1,'~~')) and B.\
language_id=:b2)           ";

 static const char *sq0006 = 
"ting_facility_id,b.PRT_GRP_HDR_CODE,b.PRT_GRP_LINE_CODE order by a.EPISODE_T\
YPE,a.operating_facility_id,b.PRT_GRP_HDR_CODE,b.PRT_GRP_LINE_CODE            ";
...
36,0,0,2,284,0,4,190,0,0,15,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,1,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
111,0,0,3,158,0,4,246,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
146,0,0,4,0,0,30,279,0,0,0,0,0,1,0,
161,0,0,5,91,0,2,287,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
184,0,0,8,415,0,9,372,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
211,0,0,6,0,0,15,479,0,0,0,0,0,1,0,
226,0,0,8,0,0,15,488,0,0,0,0,0,1,0,
241,0,0,6,1178,0,9,536,0,0,12,12,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
304,0,0,8,0,0,13,611,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
327,0,0,6,0,0,13,651,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,4,
0,0,2,4,0,0,2,4,0,0,
374,0,0,7,139,0,9,688,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
401,0,0,7,0,0,13,693,0,0,1,0,0,1,0,2,9,0,0,
420,0,0,9,144,0,4,879,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
443,0,0,10,96,0,4,1065,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
466,0,0,11,165,0,6,1072,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
497,0,0,12,140,0,6,1093,0,0,3,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
524,0,0,13,147,0,6,1170,0,0,3,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[20]; } nd_fm_trans_date;

struct { unsigned short len; unsigned char arr[20]; } nd_to_trans_date;

struct { unsigned short len; unsigned char arr[20]; } nd_fm_t_dt;

struct { unsigned short len; unsigned char arr[20]; } nd_to_t_dt;

struct { unsigned short len; unsigned char arr[5]; } nd_fm_blng_grp;
...
struct { unsigned short len; unsigned char arr[11]; } nd_fm_package_code;

struct { unsigned short len; unsigned char arr[100]; } l_pk_value;

struct { unsigned short len; unsigned char arr[201]; } l_translated_value;

struct { unsigned short len; unsigned char arr[11]; } nd_to_package_code;
...
struct { unsigned short len; unsigned char arr[4]; } l_fm_facility_id;

struct { unsigned short len; unsigned char arr[4]; } l_to_facility_id;

struct { unsigned short len; unsigned char arr[4]; } l_report_option;

struct { unsigned short len; unsigned char arr[4]; } d_facility_id;

struct { unsigned short len; unsigned char arr[4]; } l_sm_facility_id;

struct { unsigned short len; unsigned char arr[35]; } l_sm_facility_name;

struct { unsigned short len; unsigned char arr[4]; } l_folio_facility_id;
...
7 ,PARAM8 ,PARAM9 ,param10 ,param11 ,param12 ,operating_facility_id into :b0,:\
b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12  from SY_PROG_PARAM where ((\
PGM_ID='BLRTRSNT' and PGM_DATE=:b13) and SESSION_ID=TO_NUMBER(:b14))";
 ...
 sqlstm.sqhstv[9] = (         void  *)&l_fm_facility_id;
 ...
 sqlstm.sqhstv[10] = (         void  *)&l_to_facility_id;
 ...
 sqlstm.sqhstv[11] = (         void  *)&l_report_option;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='BLRTRSNT' and\
...

{
   ...
   sqlstm.sqhstv[0] = (         void  *)&l_fm_facility_id;
...

{
 ...
 sqlstm.sqltdsp = &sqltds;
 sqlbuft((void **)0, 
   "select a.EPISODE_TYPE ,a.operating_facility_id ,b.PRT_GRP_HDR_CODE ,b.PR\
T_GRP_LINE_CODE ,count(*)  ,sum(NVL(a.UPD_NET_CHARGE_AMT,0)) ,sum(NVL(a.UPD_\
GROSS_CHARGE_AMT,0)) ,sum(NVL(a.UPD_DISC_AMT,0))  from BL_PATIENT_CHARGES_FO\
LIO a ,BL_BLNG_SERV b ,BL_BLNG_PRT_GRP_HDR c where ((((((((((A.BLNG_SERV_COD\
E between :b0 and :b1 and A.BLNG_GRP_ID between :b2 and :b3) and A.BLNG_SERV\
_CODE=B.BLNG_SERV_CODE) and B.PRT_GRP_HDR_CODE=C.PRT_GRP_HDR_CODE) and A.TRX\
_DATE between TO_DATE(:b4,'DD/MM/YYYY HH24:MI') and TO_DATE(:b5,'DD/MM/YYYY \
HH24:MI')) and NVL(operating_facility_id,'X') between DECODE(:b6,'F',NVL(:b7\
,'X'),'C',NVL(:b8,'X')) and DECODE(:b6,'F',NVL(:b7,'X'),'C',NVL(:b11,'X'))) \
and ((NVL(PACKAGE_IND,'X')='S' or (NVL(PACKAGE_TRX_IND,'X')='Y' and NVL(PACK\
AGE_IND,'X')='P')) or AVAILED_IND in ('U','Y','C'))) and A.TRX_FINALIZE_IND=\
'Y') and NVL(C.INCOME_YN,'Y')='Y') and NVL(a.confirmed_yn,'N')='Y') and NVL(\
operating_facility_id,'X') in (select facility_id  from sy_user where user_i\
d=USER)) group by a.EPISODE_TYPE,a.opera");
 sqlstm.stmt = sq0006;
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqadto[5] = (unsigned short )0;
 sqlstm.sqtdso[5] = (unsigned short )0;
 sqlstm.sqhstv[6] = (         void  *)&l_report_option;
 ...
 sqlstm.sqadto[6] = (unsigned short )0;
 sqlstm.sqtdso[6] = (unsigned short )0;
 sqlstm.sqhstv[7] = (         void  *)&l_sm_facility_id;
 ...
 sqlstm.sqadto[7] = (unsigned short )0;
 sqlstm.sqtdso[7] = (unsigned short )0;
 sqlstm.sqhstv[8] = (         void  *)&l_fm_facility_id;
 ...
 sqlstm.sqadto[8] = (unsigned short )0;
 sqlstm.sqtdso[8] = (unsigned short )0;
 sqlstm.sqhstv[9] = (         void  *)&l_report_option;
 sqlstm.sqhstl[9] = (unsigned int  )6;
 sqlstm.sqhsts[9] = (         int  )0;
 sqlstm.sqindv[9] = (         void  *)0;
 sqlstm.sqinds[9] = (         int  )0;
 ...
 sqlstm.sqadto[9] = (unsigned short )0;
 sqlstm.sqtdso[9] = (unsigned short )0;
 sqlstm.sqhstv[10] = (         void  *)&l_sm_facility_id;
 sqlstm.sqhstl[10] = (unsigned int  )6;
 sqlstm.sqhsts[10] = (         int  )0;
 sqlstm.sqindv[10] = (         void  *)0;
 sqlstm.sqinds[10] = (         int  )0;
 ...
 sqlstm.sqadto[10] = (unsigned short )0;
 sqlstm.sqtdso[10] = (unsigned short )0;
 sqlstm.sqhstv[11] = (         void  *)&l_to_facility_id;
 sqlstm.sqhstl[11] = (unsigned int  )6;
 sqlstm.sqhsts[11] = (         int  )0;
 sqlstm.sqindv[11] = (         void  *)0;
 sqlstm.sqinds[11] = (         int  )0;
...

{
  ...
  sqlstm.sqhstv[0] = (         void  *)&l_sm_facility_id;
  sqlstm.sqhstl[0] = (unsigned int  )6;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&l_sm_facility_name;
...

{
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (         void  *)&l_folio_facility_id;
    sqlstm.sqhstl[1] = (unsigned int  )6;
    sqlstm.sqhsts[1] = (         int  )0;
    sqlstm.sqindv[1] = (         void  *)0;
    sqlstm.sqinds[1] = (         int  )0;
    ...
    sqlstm.sqadto[2] = (unsigned short )0;
    sqlstm.sqtdso[2] = (unsigned short )0;
    sqlstm.sqhstv[3] = (         void  *)&d_prt_grp_line_code;
    sqlstm.sqhstl[3] = (unsigned int  )6;
    sqlstm.sqhsts[3] = (         int  )0;
    sqlstm.sqindv[3] = (         void  *)0;
    sqlstm.sqinds[3] = (         int  )0;
    ...
    sqlstm.sqadto[3] = (unsigned short )0;
    sqlstm.sqtdso[3] = (unsigned short )0;
    sqlstm.sqhstv[4] = (         void  *)&d_no_of_trans;
    ...
    sqlstm.sqadto[4] = (unsigned short )0;
    sqlstm.sqtdso[4] = (unsigned short )0;
    sqlstm.sqhstv[5] = (         void  *)&d_upd_net_charge_amt;
    ...
    sqlstm.sqadto[5] = (unsigned short )0;
    sqlstm.sqtdso[5] = (unsigned short )0;
    sqlstm.sqhstv[6] = (         void  *)&d_upd_gross_charge_amt;
    ...
    sqlstm.sqadto[6] = (unsigned short )0;
    sqlstm.sqtdso[6] = (unsigned short )0;
    sqlstm.sqhstv[7] = (         void  *)&d_upd_disc_amt;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRTRSNT.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
