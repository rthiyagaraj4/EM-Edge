...
{
    42,
    "D:\\BLTEST\\12x\\ML-MMOH-SCF-0416\\BLR00011.PC"
};


static unsigned long sqlctx = 1235255859;
...
"select ((((doc_type_code||'/')||to_char(doc_number))||'/')||a.doc_srno) rece\
ipt_no ,doc_date ,to_char(doc_date,'DD/MM/YYYY') Receipt_date ,payer_name ,sho\
rt_desc Payment_mode ,slmt_doc_ref_desc ,to_char(slmt_doc_ref_date,'DD/MM/YYYY\
') ,doc_amt  from bl_receipt_refund_HDRdtl_VW a ,bl_slmt_type b ,sy_acc_entity\
 c where ((((((((a.operating_facility_id in (select operating_facility_id  fro\
m bl_parameters ) and trunc(doc_date) between to_date(nvl(:b0,'01/01/1401'),'D\
D/MM/YYYY') and nvl(to_date(:b1,'DD/MM/YYYY'),sysdate)) and a.cash_counter_fac\
ility_id=:b2) and a.slmt_type_code=b.slmt_type_code) and b.acc_entity_code=c.a\
cc_entity_code) and nvl(pmnt_thru_mail,'N')='Y') and nvl(cancelled_ind,'N')='N\
') and recpt_refund_ind=:b3) and a.cash_counter_facility_id=c.acc_entity_id) o\
rder by 2,1            ";
...
36,0,0,2,123,0,4,133,0,0,6,3,0,1,0,2,9,0,0,2,9,0,0,2,1,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
75,0,0,3,84,0,2,149,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
102,0,0,4,0,0,30,177,0,0,0,0,0,1,0,
117,0,0,5,801,0,9,216,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,1,0,0,
148,0,0,5,0,0,13,239,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,4,0,0,
195,0,0,6,155,0,4,492,0,0,5,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
230,0,0,7,96,0,4,570,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
253,0,0,8,162,0,6,577,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[19]; } bl_recpt_no;
...
struct { unsigned short len; unsigned char arr[61]; } bl_slmt_doc_ref;

struct { unsigned short len; unsigned char arr[11]; } bl_slmt_doc_date;

struct { unsigned short len; unsigned char arr[11]; } nd_fm_date;

struct { unsigned short len; unsigned char arr[11]; } nd_to_date;

struct { unsigned short len; unsigned char arr[11]; } old_recpt_date;

struct { unsigned short len; unsigned char arr[201]; } l_translated_value;

struct { unsigned short len; unsigned char arr[50]; } l_cash_book_acc_desc;

struct { unsigned short len; unsigned char arr[100]; } l_pk_value;

struct { unsigned short len; unsigned char arr[3]; } p_language_id;

struct { unsigned short len; unsigned char arr[31]; } nd_temp_date1;

struct { unsigned short len; unsigned char arr[31]; } nd_loc_date1;

struct { unsigned short len; unsigned char arr[31]; } nd_temp_date;

struct { unsigned short len; unsigned char arr[31]; } date_convert;

struct { unsigned short len; unsigned char arr[31]; } date_convert1;

struct { unsigned short len; unsigned char arr[31]; } nd_loc_date;

struct { unsigned short len; unsigned char arr[31]; } date_convert2;
...
SY_PROG_PARAM where ((PGM_ID=:b3 and SESSION_ID=:b4) and PGM_DATE=:b5)";
        ...
        sqlstm.sqhstv[2] = (         void  *)&nd_trn_type;
...

{
    ...
    sqlstm.sqadto[2] = (unsigned short )0;
    sqlstm.sqtdso[2] = (unsigned short )0;
    sqlstm.sqhstv[3] = (         void  *)&nd_trn_type;
...

{
      ...
      sqlstm.sqadto[1] = (unsigned short )0;
      sqlstm.sqtdso[1] = (unsigned short )0;
      sqlstm.sqhstv[2] = (         void  *)&bl_recpt_date;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&bl_payer_name;
      ...
      sqlstm.sqadto[4] = (unsigned short )0;
      sqlstm.sqtdso[4] = (unsigned short )0;
      sqlstm.sqhstv[5] = (         void  *)&bl_slmt_doc_ref;
      ...
      sqlstm.sqadto[5] = (unsigned short )0;
      sqlstm.sqtdso[5] = (unsigned short )0;
      sqlstm.sqhstv[6] = (         void  *)&bl_slmt_doc_date;
      ...
      sqlstm.sqhstv[7] = (         void  *)&bl_doc_amt;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLR00011.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
