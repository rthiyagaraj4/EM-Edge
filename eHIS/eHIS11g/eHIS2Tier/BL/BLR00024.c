...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/BLR00024.PC"
};
...
"and c.cash_slmt_flag=decode(:b5,'**',c.cash_slmt_flag,:b5)) order by a.doc_d\
ate,a.ext_acct_code            ";

 static const char *sq0005 = 
"and c.cash_slmt_flag=decode(:b5,'**',c.cash_slmt_flag,:b5)) order by a.ext_a\
cct_code,a.doc_date            ";

 static const char *sq0006 = 
"select ((org_doc_type_code||'/')||to_char(org_doc_num)) ,to_char(org_doc_dat\
e,'dd/mm/yyyy') ,abs(doc_amt)  from bl_patient_ledger where ((((ad_pr_adj_bill\
_doc_type=:b0 and ad_pr_adj_bill_doc_num=:b1) or (org_doc_type_code=:b0 and or\
g_doc_num=:b1)) and nvl(trx_status,'X')<>'C') and recpt_nature_code in ('AD','\
PR','RD'))           ";
...
{12,4274,178,0,0,
5,0,0,1,91,0,2,187,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
28,0,0,2,0,0,30,196,0,0,0,0,0,1,0,
43,0,0,0,0,0,27,204,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
74,0,0,4,0,0,13,352,0,0,15,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
149,0,0,5,0,0,13,371,0,0,15,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
224,0,0,6,0,0,13,428,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,4,0,0,
251,0,0,7,166,0,4,463,0,0,8,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,1,9,0,0,1,9,0,0,
298,0,0,4,1131,0,9,512,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
341,0,0,5,1131,0,9,518,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
384,0,0,8,90,0,4,548,0,0,3,1,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,
411,0,0,6,331,0,9,580,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
442,0,0,9,161,0,4,708,0,0,5,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
477,0,0,10,96,0,4,774,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
500,0,0,11,165,0,6,781,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
531,0,0,12,73,0,4,827,0,0,5,4,0,1,0,1,97,0,0,1,9,0,0,1,97,0,0,1,9,0,0,2,9,0,0,
566,0,0,13,198,0,4,930,0,0,6,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,
9,0,0,
605,0,0,14,0,0,32,953,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='BLR00024' and SE\
...
o :b0,:b1,:b2,:b3,:b4,:b5  from SY_PROG_PARAM where ((PGM_ID='BLR00024' and SE\
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select short_name ,national_id_num into :b0,:b1  from mp_p\
atient_mast where patient_id=:b2";
   sqlstm.iters = (unsigned int  )1;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLR00024.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
