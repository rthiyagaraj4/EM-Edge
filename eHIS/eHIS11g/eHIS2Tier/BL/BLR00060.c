...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/BLR00060.PC"
};
...
"select cc_sale_draft_no ,slmt_doc_ref_desc ,b.cancelled_date ,to_char(b.canc\
elled_date,'DD/MM/YYYY') ,to_char(a.doc_date,'DD/MM/YYYY') ,a.doc_amt ,b.cash_\
counter_code ,b.added_by_id ,substr(c.action_reason_desc,1,30)  from BL_RECEIP\
T_REFUND_HDRDTL_VW a ,bl_cancelled_bounced_trx b ,bl_action_reason c ,bl_slmt_\
type d where (((((((((b.cash_counter_facility_id=:b0 and a.doc_type_code=b.doc\
_type_code) and a.doc_number=b.doc_number) and a.recpt_refund_ind='R') and tru\
nc(b.cancelled_date) between to_date(nvl(:b1,'01/01/1401'),'DD/MM/YYYY') and n\
vl(to_date(:b2,'DD/MM/YYYY'),sysdate)) and a.slmt_type_code=d.slmt_type_code) \
and d.cash_slmt_flag='A') and b.cash_counter_code between nvl(:b3,'!!') and nv\
l(:b4,'~~')) and b.added_by_id between nvl(:b5,'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\
') and nvl(:b6,'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')) and b.reason_code(+)=c.actio\
n_reason_code) order by 3            ";
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLR00060.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
