...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/BLRCVCAN.pc"
};


static unsigned int sqlctx = 1288466811;
...
"DD/MM/YYYY'),'31/12/5000')) and A.BLNG_GRP_ID between NVL(:b4,'!!') and NVL(\
:b5,'~~')) and nvl(A.CUST_CODE,'!!!!!!!!') between NVL(:b6,'!!!!!!!!') and NVL\
(:b7,'~~~~~~~~')) and A.EPISODE_TYPE=DECODE(:b8,'I','I','D','D','O','O','E','E\
','R','R','A',EPISODE_TYPE)) and A.PATIENT_ID between NVL(:b9,'!!!!!!!!!!!!!!!\
!!!!!') and NVL(:b10,'~~~~~~~~~~~~~~~~~~~~')) and (A.EPISODE_TYPE='R' or (A.EP\
ISODE_TYPE in ('I','D','O','E') and to_char(A.EPISODE_ID) between NVL(:b11,'!!\
!!!!!!') and NVL(:b12,'~~~~~~~~')))) and (A.EPISODE_TYPE in ('R','I','D') or (\
A.EPISODE_TYPE in ('O','E') and to_char(A.VISIT_ID) between NVL(:b13,'!!!!') a\
nd NVL(:b14,'~~~~')))) and (RPAD(A.DOC_TYPE_CODE,6,' ')||LPAD(A.DOC_NUMBER,8,'\
0')) between (RPAD(NVL(:b15,' '),6,' ')||LPAD(NVL(:b16,0),8,'0')) and (RPAD(NV\
L(:b17,'~~~~~~'),6,' ')||LPAD(NVL(:b18,99999999),8,'0'))) and (NVL(A.CANCELLED\
_YN,'N')='Y' or NVL(B.CANCELLED_YN,'N')='Y')) order by DECODE(:b19,'B',A.BLNG_\
GRP_ID,'C',A.CUST_CODE,'P',A.PATIENT_ID,'E',A.EPISODE_ID)            ";

 static const char *sq0005 = 
"select ADDED_BY_ID ,to_char(ADDED_DATE,'DD/MM/YYYY HH24:MI')  from BL_COVERI\
NG_LET_DETAIL_LOG where ((OPERATING_FACILITY_ID=:b0 and ((DOC_REF_NUM||'/')||t\
o_char(DOC_REF_SLNO))=:b1) and NVL(AUDIT_IND,'X')='C') order by ADDED_DATE    \
        ";

 static const char *sq0006 = 
"select ADDED_BY_ID ,to_char(ADDED_DATE,'DD/MM/YYYY HH24:MI')  from BL_COVERI\
NG_LET_HEADER_LOG where ((OPERATING_FACILITY_ID=:b0 and DOC_REF_NUM=:b1) and N\
VL(AUDIT_IND,'X')='C') order by ADDED_DATE            ";
...
{12,4274,178,0,0,
5,0,0,0,0,0,27,155,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,337,0,4,205,0,0,22,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
139,0,0,3,84,0,2,263,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
166,0,0,4,2027,0,9,372,0,0,20,20,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
261,0,0,4,0,0,15,379,0,0,0,0,0,1,0,
276,0,0,4,0,0,13,411,0,0,12,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
339,0,0,5,240,0,9,458,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
362,0,0,5,0,0,15,465,0,0,0,0,0,1,0,
377,0,0,5,0,0,13,478,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
400,0,0,6,208,0,9,507,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
423,0,0,6,0,0,15,514,0,0,0,0,0,1,0,
438,0,0,6,0,0,13,527,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
461,0,0,7,218,0,4,654,0,0,7,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,
9,0,0,1,9,0,0,
504,0,0,8,0,0,32,678,0,0,0,0,0,1,0,
519,0,0,9,96,0,4,1061,0,0,2,1,0,1,0,1,3,0,0,2,9,0,0,
542,0,0,10,162,0,6,1068,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,1,9,0,0,
573,0,0,11,199,0,6,1110,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
600,0,0,12,215,0,6,1146,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[15]; } nd_cov_date_from;

struct { unsigned short len; unsigned char arr[15]; } nd_cov_date_to;

struct { unsigned short len; unsigned char arr[5]; } nd_blng_grp_from;

struct { unsigned short len; unsigned char arr[5]; } nd_blng_grp_to;
...
struct { unsigned short len; unsigned char arr[21]; } d_rcpt_date;

struct { unsigned short len; unsigned char arr[17]; } d_bill_no;

struct { unsigned short len; unsigned char arr[17]; } d_refund_no;

struct { unsigned short len; unsigned char arr[21]; } d_bill_date;
...
struct { unsigned short len; unsigned char arr[40]; } d_doc_ref_num;
...
struct { unsigned short len; unsigned char arr[2]; } d_detail_canc;

struct { unsigned short len; unsigned char arr[2]; } d_header_canc;

struct { unsigned short len; unsigned char arr[31]; } d_head_doc_ref;
...
struct { unsigned short len; unsigned char arr[7]; } nd_cov_date_from1;

struct { unsigned short len; unsigned char arr[7]; } nd_cov_date_to1;
...
RAM16 ,PARAM17 ,PARAM18 ,PARAM19 into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,\
:b10,:b11,:b12,:b13,:b14,:b15,:b16,:b17,:b18  from SY_PROG_PARAM where ((PGM_I\
D=:b19 and SESSION_ID=:b20) and PGM_DATE=:b21)";
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (         void  *)&nd_cov_date_from;
    ...
    sqlstm.sqhstv[2] = (         void  *)&nd_cov_date_to;
    ...
    sqlstm.sqhstv[3] = (         void  *)&nd_blng_grp_from;
    ...
    sqlstm.sqhstv[4] = (         void  *)&nd_blng_grp_to;
    ...
    sqlstm.sqhstv[5] = (         void  *)&nd_cust_from;
    ...
    sqlstm.sqhstv[6] = (         void  *)&nd_cust_to;
    ...
    sqlstm.sqhstv[9] = (         void  *)&nd_doc_type_from;
    ...
    sqlstm.sqhstv[10] = (         void  *)&nd_doc_num_from;
    ...
    sqlstm.sqhstv[11] = (         void  *)&nd_doc_type_to;
    ...
    sqlstm.sqhstv[12] = (         void  *)&nd_doc_num_to;
    ...
    sqlstm.sqhstv[13] = (         void  *)&nd_episode_from;
    ...
    sqlstm.sqhstv[14] = (         void  *)&nd_episode_to;
    ...
    sqlstm.sqhstv[15] = (         void  *)&nd_visit_from;
    ...
    sqlstm.sqhstv[16] = (         void  *)&nd_visit_to;
    ...
    sqlstm.sqhstv[17] = (         void  *)&nd_episode_type;
    ...
    sqlstm.sqhstv[18] = (         void  *)&nd_sort_order;
...

{
   ...
   sqlstm.sqltdsp = &sqltds;
   sqlbuft((void **)0, 
     "select A.BLNG_GRP_ID ,A.CUST_CODE ,A.PATIENT_ID ,DECODE(A.EPISODE_TYPE\
,'I',((A.EPISODE_TYPE||'/')||to_char(A.EPISODE_ID)),'D',((A.EPISODE_TYPE||'/\
')||to_char(A.EPISODE_ID)),'E',((((A.EPISODE_TYPE||'/')||to_char(A.EPISODE_I\
D))||'/')||to_char(A.VISIT_ID)),'O',((((A.EPISODE_TYPE||'/')||to_char(A.EPIS\
ODE_ID))||'/')||to_char(A.VISIT_ID)),'R',A.EPISODE_TYPE) EPISODE ,((A.DOC_TY\
PE_CODE||'-')||to_char(A.DOC_NUMBER)) ,to_char(A.DOC_DATE,'DD/MM/YYYY') ,A.B\
ILL_AMT ,A.DOC_OUTST_AMT ,((A.DOC_REF_NUM||'/')||to_char(A.DOC_REF_SLNO)) ,n\
vl(A.CANCELLED_YN,'N') detail_canc ,NVL(B.CANCELLED_YN,'N') header_canc ,A.D\
OC_REF_NUM  from BL_COVERING_LET_DETAIL A ,BL_COVERING_LET_HEADER B where ((\
((((((((((A.OPERATING_FACILITY_ID=B.OPERATING_FACILITY_ID and A.DOC_REF_NUM=\
B.DOC_REF_NUM) and A.OPERATING_FACILITY_ID=:b0) and A.MODULE_ID=DECODE(:b1,'\
BL','BL','AR','AR','**',MODULE_ID)) and to_char(A.DOC_REF_DATE,'DD/MM/YYYY')\
 between NVL(to_char(TO_DATE(:b2,'DD/MM/YYYY'),'DD/MM/YYYY'),'01/01/1000') a\
nd NVL(to_char(TO_DATE(:b3,'DD/MM/YYYY'),'");
   sqlstm.stmt = sq0004;
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&nd_module_id;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (         void  *)&nd_cov_date_from;
   sqlstm.sqhstl[2] = (unsigned int  )17;
   sqlstm.sqhsts[2] = (         int  )0;
   sqlstm.sqindv[2] = (         void  *)0;
   sqlstm.sqinds[2] = (         int  )0;
   ...
   sqlstm.sqadto[2] = (unsigned short )0;
   sqlstm.sqtdso[2] = (unsigned short )0;
   sqlstm.sqhstv[3] = (         void  *)&nd_cov_date_to;
   ...
   sqlstm.sqadto[3] = (unsigned short )0;
   sqlstm.sqtdso[3] = (unsigned short )0;
   sqlstm.sqhstv[4] = (         void  *)&nd_blng_grp_from;
   sqlstm.sqhstl[4] = (unsigned int  )7;
   sqlstm.sqhsts[4] = (         int  )0;
   sqlstm.sqindv[4] = (         void  *)0;
   sqlstm.sqinds[4] = (         int  )0;
   ...
   sqlstm.sqadto[4] = (unsigned short )0;
   sqlstm.sqtdso[4] = (unsigned short )0;
   sqlstm.sqhstv[5] = (         void  *)&nd_blng_grp_to;
   ...
   sqlstm.sqadto[5] = (unsigned short )0;
   sqlstm.sqtdso[5] = (unsigned short )0;
   sqlstm.sqhstv[6] = (         void  *)&nd_cust_from;
   sqlstm.sqhstl[6] = (unsigned int  )11;
   sqlstm.sqhsts[6] = (         int  )0;
   sqlstm.sqindv[6] = (         void  *)0;
   sqlstm.sqinds[6] = (         int  )0;
   ...
   sqlstm.sqadto[6] = (unsigned short )0;
   sqlstm.sqtdso[6] = (unsigned short )0;
   sqlstm.sqhstv[7] = (         void  *)&nd_cust_to;
   ...
   sqlstm.sqadto[10] = (unsigned short )0;
   sqlstm.sqtdso[10] = (unsigned short )0;
   sqlstm.sqhstv[11] = (         void  *)&nd_episode_from;
   ...
   sqlstm.sqadto[11] = (unsigned short )0;
   sqlstm.sqtdso[11] = (unsigned short )0;
   sqlstm.sqhstv[12] = (         void  *)&nd_episode_to;
   sqlstm.sqhstl[12] = (unsigned int  )11;
   sqlstm.sqhsts[12] = (         int  )0;
   sqlstm.sqindv[12] = (         void  *)0;
   sqlstm.sqinds[12] = (         int  )0;
   ...
   sqlstm.sqadto[12] = (unsigned short )0;
   sqlstm.sqtdso[12] = (unsigned short )0;
   sqlstm.sqhstv[13] = (         void  *)&nd_visit_from;
   ...
   sqlstm.sqadto[13] = (unsigned short )0;
   sqlstm.sqtdso[13] = (unsigned short )0;
   sqlstm.sqhstv[14] = (         void  *)&nd_visit_to;
   ...
   sqlstm.sqadto[14] = (unsigned short )0;
   sqlstm.sqtdso[14] = (unsigned short )0;
   sqlstm.sqhstv[15] = (         void  *)&nd_doc_type_from;
   ...
   sqlstm.sqadto[15] = (unsigned short )0;
   sqlstm.sqtdso[15] = (unsigned short )0;
   sqlstm.sqhstv[16] = (         void  *)&nd_doc_num_from;
   ...
   sqlstm.sqadto[16] = (unsigned short )0;
   sqlstm.sqtdso[16] = (unsigned short )0;
   sqlstm.sqhstv[17] = (         void  *)&nd_doc_type_to;
   ...
   sqlstm.sqadto[17] = (unsigned short )0;
   sqlstm.sqtdso[17] = (unsigned short )0;
   sqlstm.sqhstv[18] = (         void  *)&nd_doc_num_to;
...

{
 ...
 sqlstm.sqadto[4] = (unsigned short )0;
 sqlstm.sqtdso[4] = (unsigned short )0;
 sqlstm.sqhstv[5] = (         void  *)&d_bill_date;
 ...
 sqlstm.sqadto[6] = (unsigned short )0;
 sqlstm.sqtdso[6] = (unsigned short )0;
 sqlstm.sqhstv[7] = (         void  *)&d_bill_outst_amt;
 ...
 sqlstm.sqadto[7] = (unsigned short )0;
 sqlstm.sqtdso[7] = (unsigned short )0;
 sqlstm.sqhstv[8] = (         void  *)&d_doc_ref_num;
 ...
 sqlstm.sqadto[8] = (unsigned short )0;
 sqlstm.sqtdso[8] = (unsigned short )0;
 sqlstm.sqhstv[9] = (         void  *)&d_detail_canc;
 ...
 sqlstm.sqadto[9] = (unsigned short )0;
 sqlstm.sqtdso[9] = (unsigned short )0;
 sqlstm.sqhstv[10] = (         void  *)&d_header_canc;
 ...
 sqlstm.sqadto[10] = (unsigned short )0;
 sqlstm.sqtdso[10] = (unsigned short )0;
 sqlstm.sqhstv[11] = (         void  *)&d_head_doc_ref;
...

{
 ...
 sqlstm.sqfoff = (           int )0;
 sqlstm.sqfmod = (unsigned int )2;
 sqlstm.sqhstv[0] = (         void  *)&d_cancelled_by;
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (         void  *)&d_cancelled_date;
...

{
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&d_head_doc_ref;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select LTRIM(RTRIM(('BLRCVCAN.LEGEND_'||LTRIM(RTRIM(TO_CHAR\
