...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/BL/blrhibps.pc"
};
...
"al='T' and a.hcard_status='T') and :b5='Y'))) and c.patient_id=b.patient_id)\
 and nvl(c.active_yn,'N')='Y') and d.country_code=c.nationality_code) and b.op\
erating_facility_id=e.acc_entity_id) and b.operating_facility_id=:b6) order by\
 a.hcard_status desc ,a.hcard_expiry_date            ";
...
{12,4274,178,0,0,
5,0,0,0,0,0,27,134,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,65,0,4,156,0,0,1,0,0,1,0,2,9,0,0,
55,0,0,3,32,0,4,161,0,0,1,0,0,1,0,2,9,0,0,
74,0,0,4,75,0,4,166,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
97,0,0,5,0,0,30,178,0,0,0,0,0,1,0,
112,0,0,6,1309,0,9,351,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
155,0,0,6,0,0,13,391,0,0,14,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,3,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,
226,0,0,6,0,0,15,428,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[11]; } nd_to_tran_date;

struct { unsigned short len; unsigned char arr[11]; } nd_from_tran_date;
...
bstr(c.patient_name,26,60) patient_name1 ,d.short_desc nationality ,c.pat_se\
r_grp_code blng_group ,e.no_of_decimal fmt_string  from bl_patient_fin_dtls \
a ,bl_health_card_trn b ,mp_patient c ,mp_country d ,sy_acc_entity e where (\
((((((((((a.patient_id=b.patient_id and a.hcard_doc_type=b.doc_type_code) an\
d a.hcard_doc_num=b.doc_number) and trunc(a.hcard_doc_date)=trunc(b.doc_date\
)) and a.hcard_expiry_date between TO_DATE(:b0,'DD/MM/YYYY') and TO_DATE(:b1\
,'DD/MM/YYYY')) and b.doc_date between TO_DATE(:b2,'DD/MM/YYYY') and TO_DATE\
(:b3,'DD/MM/YYYY')) and (((b.hcard_status_initial='T' and a.hcard_status='P'\
) and :b4='Y') or ((b.hcard_status_initi");
 sqlstm.stmt = sq0006;
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (         void  *)&nd_from_tran_date;
 ...
 sqlstm.sqhstv[3] = (         void  *)&nd_to_tran_date;
 ...
 sqlstm.sqhstv[4] = (         void  *)&nd_conv_stat;
 ...
 sqlstm.sqhstv[5] = (         void  *)&nd_not_conv_stat;
...

{
  ...
  sqlstm.sqhstv[11] = (         void  *)&nd_nationality;
  ...
  sqlstm.sqhstv[12] = (         void  *)&nd_blng_group;
  ...
  sqlstm.sqhstv[13] = (         void  *)&nd_fmt_string;
