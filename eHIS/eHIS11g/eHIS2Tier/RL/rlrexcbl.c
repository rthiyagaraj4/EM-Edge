...
{
    58,
    "D:\\WORK\\ML-MMOH-CRF-0752.6-US001\\Proc\\rlrexcbl\\rlrexcbl.pc"
};
...
e_code,:b6)) and A.spec_regd_date_time>=TO_DATE(:b8,'DD/MM/YYYY hh24:mi:ss')) \
and A.spec_regd_date_time<TO_DATE(:b9,'DD/MM/YYYY hh24:mi:ss')) and A.specimen\
_no=B.specimen_no) and NVL(A.cancelled_yn,'N')<>'Y') and NVL(B.cancelled_yn,'N\
')<>'Y') order by A.specimen_no,A.section_code,A.source_type,A.source_code,B.t\
est_code            ";
...
ce_code,:b6)) and A.spec_regd_date_time>=TO_DATE(:b8,'DD/MM/YYYY hh24:mi:ss'))\
 and A.spec_regd_date_time<TO_DATE(:b9,'DD/MM/YYYY hh24:mi:ss')) and A.specime\
n_no=B.specimen_no) and NVL(A.cancelled_yn,'N')<>'Y') and NVL(B.cancelled_yn,'\
N')<>'Y') and B.REFLEX_TYPE is null ) order by A.specimen_no,A.section_code,A.\
source_type,A.source_code,B.test_code            ";
...
{10,4274,0,0,0,
5,0,0,1,0,0,539,228,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,544,261,0,0,0,0,0,1,0,
51,0,0,3,40,0,516,352,0,0,2,1,0,1,0,1,4,0,0,2,4,0,0,
74,0,0,4,876,0,521,416,0,0,10,10,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
129,0,0,5,0,0,544,425,0,0,0,0,0,1,0,
144,0,0,6,905,0,521,460,0,0,10,10,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
199,0,0,7,0,0,544,469,0,0,0,0,0,1,0,
214,0,0,4,0,0,527,478,0,0,0,0,0,1,0,
229,0,0,8,0,0,544,486,0,0,0,0,0,1,0,
244,0,0,6,0,0,527,495,0,0,0,0,0,1,0,
259,0,0,9,0,0,544,503,0,0,0,0,0,1,0,
274,0,0,4,0,0,525,542,0,0,13,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,3,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
341,0,0,6,0,0,525,551,0,0,13,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,3,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
408,0,0,10,0,0,544,591,0,0,0,0,0,1,0,
423,0,0,11,115,0,516,607,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
454,0,0,12,127,0,516,619,0,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
485,0,0,13,97,0,516,637,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
512,0,0,14,0,0,544,656,0,0,0,0,0,1,0,
527,0,0,15,100,0,516,670,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
554,0,0,16,0,0,544,686,0,0,0,0,0,1,0,
569,0,0,17,95,0,516,700,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
596,0,0,18,0,0,544,716,0,0,0,0,0,1,0,
611,0,0,19,81,0,516,740,0,0,3,2,0,1,0,1,9,0,0,1,9,0,0,2,3,0,0,
638,0,0,20,72,0,516,748,0,0,2,1,0,1,0,1,9,0,0,2,9,0,0,
661,0,0,21,89,0,516,756,0,0,2,1,0,1,0,1,9,0,0,2,9,0,0,
684,0,0,22,81,0,516,761,0,0,3,2,0,1,0,1,9,0,0,1,9,0,0,2,3,0,0,
711,0,0,23,225,0,516,839,0,0,9,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
762,0,0,24,109,0,514,886,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
785,0,0,25,0,0,544,894,0,0,0,0,0,1,0,
800,0,0,26,158,0,516,923,0,0,5,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
835,0,0,27,0,0,544,947,0,0,0,0,0,1,0,
850,0,0,28,209,0,518,1031,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
877,0,0,29,209,0,518,1046,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
904,0,0,30,156,0,518,1103,0,0,2,2,0,1,0,1,9,0,0,2,9,0,0,
927,0,0,31,78,0,516,1245,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
950,0,0,32,80,0,516,1248,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
973,0,0,33,81,0,516,1251,0,0,3,2,0,1,0,1,9,0,0,1,9,0,0,2,3,0,0,
1000,0,0,34,89,0,516,1265,0,0,2,1,0,1,0,1,9,0,0,2,9,0,0,
1023,0,0,35,78,0,516,1270,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1046,0,0,36,80,0,516,1273,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1069,0,0,37,81,0,516,1277,0,0,3,2,0,1,0,1,9,0,0,1,9,0,0,2,3,0,0,
1096,0,0,38,101,0,518,1309,0,0,1,1,0,1,0,2,3,0,0,
1115,0,0,39,122,0,516,1449,0,0,3,2,0,1,0,1,9,0,0,2,9,0,0,1,9,0,0,
1142,0,0,40,122,0,516,1457,0,0,3,2,0,1,0,1,9,0,0,2,9,0,0,1,9,0,0,
1169,0,0,41,120,0,518,1508,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1192,0,0,42,136,0,518,1518,0,0,2,2,0,1,0,2,9,0,0,1,3,0,0,
};
...
*  Purpose : To generate a report for Printing Exception For Test Ordered But Not Yet Billed
...
struct { unsigned short len; unsigned char arr[16]; } d_test_name;
...
/* FIELDS from DECLARING VARIABLES(COLUMN HEADINGS) IN DCLR_MONTH_VARIABLES()*/
	/* varchar x_date		[11] ,
			...
			w_date1		[20],
			q_date		[11]; */ 
struct { unsigned short len; unsigned char arr[11]; } x_date;

struct { unsigned short len; unsigned char arr[20]; } v_date;

struct { unsigned short len; unsigned char arr[20]; } v_date1;

struct { unsigned short len; unsigned char arr[20]; } w_date;

struct { unsigned short len; unsigned char arr[20]; } w_date1;

struct { unsigned short len; unsigned char arr[11]; } q_date;
...
struct { unsigned short len; unsigned char arr[12]; } d_spec_date;
	...
	/* varchar billed_flag [2]; */ 
struct { unsigned short len; unsigned char arr[2]; } billed_flag;
...
char hdr_line1[REP_WIDTH+1],
     ...
     hdr_line5[REP_WIDTH+1]; //added for globalisation
...
char *argv[];
{
   ...
   if(argc < 4) {
     disp_message(ORA_MESG,"Usage rlrexcbl uid/passwd session_id pgm_date\n");
     proc_exit();
   }
...
void do_report()
{
   ...
   status = get_bill_details();	      
   if (status == 0)
     {
       continue;
     }

   if (p_charged_yn.arr[0] != 'Y')
      {
         continue;
	  }
	  ...
	  /* EXEC SQL SELECT ROUND(:p_charged_net_amt,2) 
				INTO :p_charged_net_amt
				FROM DUAL; */ 

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select ROUND(:b0,2) into :b0  from DUAL ";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqlety = (unsigned short)256;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&p_charged_net_amt;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&p_charged_net_amt;
   ...
   sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	  ...
	  tot_bill = tot_bill + p_charged_net_amt;
	  						  		  	
      fprintf(f1,"%-20s%-60s \n",d_patient_id.arr,patient_name.arr);			  	  	  
	  fprintf(f1,"%-20s%-5s %-20.20s%17s%14s\n",temp_episode_name,d_source_code.arr,d_source_name.arr,txt_specimen_no.arr,d_spec_date.arr);			  	  	  

	  if ( strcmp(d_reflex_type.arr,"X") != 0)
	  	  
		  fprintf(f1,"%-11s%-4s %-16s %-24s %1s           %7.2f %\n",
		  d_test_code.arr,"[R]",d_test_name.arr,d_added_by_id.arr,temp_qty,p_charged_net_amt);

	  else
  		  fprintf(f1,"%-15s %-16s %-24s %1s           %7.2f %\n",
		  d_test_code.arr,d_test_name.arr,d_added_by_id.arr,temp_qty,p_charged_net_amt);
...
void dclr_test_cur()
 {
	...
	/* EXEC SQL DECLARE TEST_CURSOR CURSOR FOR
			...
			AND A.spec_regd_date_time >= TO_DATE(:v_date, 'DD/MM/YYYY hh24:mi:ss')			
			AND A.spec_regd_date_time < TO_DATE(:w_date,'DD/MM/YYYY hh24:mi:ss')
...

{
   ...
   disp_message(ORA_MESG,"Oracle error at dclr_test_cur_reflex() occured....\n");
   proc_exit();	
 }
...
print_month_col_heading()
{
	...
	fprintf(f1, "%-8.8s    %-16.16s", local_legend[1], local_legend[2]); //added for globalisation
...
void print_source_col_heading()
{
 ...
 fprintf(f1,"%-6.6s : %s", local_legend[5], d_source_name.arr );//added for globalisation
 fprintf(f1,"\n");
 fprintf(f1,"-----------------------------------");
 fprintf(f1,"\n");
 line_no +=3 ;
...
G_PARAM where ((UPPER(PGM_ID)='RLREXCBL' and SESSION_ID=TO_NUMBER(:b7)) and PG\
M_DATE=:b8)";
   sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((UPPER(PGM_ID)='RLREXCB\
L' and SESSION_ID=TO_NUMBER(:b0)) and PGM_DATE=:b1)";
   sqlstm.iters = (unsigned int  )1;
...
void print_rep_header()
{
  ...
  print_space(43, rec_len,1);//added for globalisation
  if (strcmp(nd_type.arr,"A") == 0 )
  { 
    //fprintf(f1,"SOURCE TYPE    : ALL\n");
    fprintf(f1,"%s: %s\n", local_legend[7], local_legend[8]); //added for globalisation
  }
  else
  { 
...
//  fprintf(f1,"FROM SOURCE    : %s\n",nd_fm_source_type.arr);
  ...
  print_space(43, rec_len,1);//added for globalisation
  fprintf(f1,"%s: %s\n", local_legend[9], nd_fm_source_type.arr); //added for globalisation
//  fprintf(f1,"                          ");
//  fprintf(f1,"TO SOURCE      : %s\n",nd_to_source_type.arr);
  rec_len = strlen(local_legend[10]);//added for globalisation
  print_space(43, rec_len,1);//added for globalisation
  fprintf(f1,"%s: %s\n", local_legend[10], nd_to_source_type.arr); //added for globalisation
//  fprintf(f1,"                          ");
...
_TO_LOCALE_DATE ( to_date ( :v_date , 'DD/MM/YYYY hh24:mi:ss' ) , :language_id\
 , t_date ) ; :v_date1 := to_char ( t_date , 'DD/MM/YYYY hh24:mi:ss' ) ; END ;";
  ...
  print_space(43, rec_len,1);//added for globalisation
  fprintf(f1,"%s: %s\n", local_legend[11], v_date1.arr); //added for globalisation
//  fprintf(f1,"                          ");
...
_TO_LOCALE_DATE ( to_date ( :w_date , 'DD/MM/YYYY hh24:mi:ss' ) , :language_id\
 , t_date ) ; :w_date1 := to_char ( t_date , 'DD/MM/YYYY hh24:mi:ss' ) ; END ;";
  ...
  print_space(43, rec_len,1);//added for globalisation
  fprintf(f1,"%s: %s\n", local_legend[12], w_date1.arr); //added for globalisation
//  fprintf(f1,"                          ");
//  fprintf(f1,"INCLUDE REFLEX : %s\n",nd_incl_reflex_yn.arr);
  rec_len = strlen(local_legend[13]);//added for globalisation
  print_space(43, rec_len,1);//added for globalisation
  fprintf(f1,"%s: %s\n", local_legend[13], nd_incl_reflex_yn.arr); //added for globalisation
  fprintf(f1,"\n\n\n");
  fprintf(f1,"                ");
//  fprintf(f1,"[R] - Reflex Test");
  fprintf(f1,"[R] - %s", local_legend[14]);//added for globalisation
  fprintf(f1,"\n\n\n\n\n");      
  fprintf(f1,"\f");      
}
...
// fprintf(f1,"                     List of Tests Charged but not Billed  \n");
  memset(hdr_line2,' ',REP_WIDTH+1);
  col = (int)(REP_WIDTH - strlen(local_legend[15]))/2;
  strncpy(hdr_line2+ col -1,local_legend[15],strlen(local_legend[15]));
  fprintf(f1,hdr_line2);
  fprintf(f1,"\n");	



 fprintf(f1,"REP : RLREXCBL");
 fprintf(f1,"                                        ") ;
// fprintf(f1,"            Page : %4d", page_no);
 fprintf(f1,"            %-4.4s : %4d", local_legend[16], page_no); //added for globalisation
 fprintf(f1,"\n");
 fill_dash(78);
 fprintf(f1,"\n");
 line_no = line_no + 8;
...
void print_cont_header()
{
 ...
 char loc_legend13[41];

 int spc_len;

// strcpy(loc_legend1,"Patient ID");
 strcpy(loc_legend1,local_legend[17]); //added for globalisation
 loc_legend1[10] = '\0';

// strcpy(loc_legend2,"Name");
 strcpy(loc_legend2,local_legend[18]); //added for globalisation
 loc_legend2[5] = '\0';

// strcpy(loc_legend3,"Episode     /Visit");
 strcpy(loc_legend3,local_legend[19]); //added for globalisation
 loc_legend3[19] = '\0';

// strcpy(loc_legend4,"Visit");
 strcpy(loc_legend4,local_legend[20]); //added for globalisation
 loc_legend4[6] = '\0';
...
// strcpy(loc_legend6,"Name");
 strcpy(loc_legend6,local_legend[18]); //added for globalisation
 loc_legend6[5] = '\0';

// strcpy(loc_legend7,"Spec No");
 strcpy(loc_legend7,local_legend[21]); //added for globalisation
 loc_legend7[8] = '\0';

// strcpy(loc_legend8,"Test Code");
 strcpy(loc_legend8,local_legend[22]); //added for globalisation
 loc_legend8[10] = '\0';

// strcpy(loc_legend9,"Name");
 strcpy(loc_legend9,local_legend[18]); //added for globalisation
 loc_legend9[5] = '\0';

 strcpy(loc_legend10,"Test Date");
 strcpy(loc_legend10,local_legend[23]); //added for globalisation
 loc_legend10[9] = '\0';

// strcpy(loc_legend11,"Added By ID");
 strcpy(loc_legend11,local_legend[24]); //added for globalisation
 loc_legend11[12] = '\0';

// strcpy(loc_legend12,"QTY");
 strcpy(loc_legend12,local_legend[25]); //added for globalisation
 loc_legend12[4] = '\0';

 strcpy(loc_legend13,"Unbilled Amount");
 strcpy(loc_legend11,local_legend[26]); //added for globalisation
 loc_legend13[16] = '\0';
...
fprintf(f1,"%-20s%-6s %-15s   %15s     %12s\n",loc_legend3,loc_legend5,loc_legend6,loc_legend7,loc_legend10);
fprintf(f1,"%-15s %-16s %-17s      %3s  %16s%\n",loc_legend8,loc_legend9,loc_legend11,loc_legend12,loc_legend13);
line_no = line_no + 4;
fill_dash(78);  
line_no = line_no + 1;
}
...
/******
 commented as this procedure is not available in srdv, needs to be reviewed later
		...
		EXEC SQL SELECT BL_PROC_FOR_EXT_SERVICE_MP.GET_SERVICE_ITEM_BILLED_YN
					(
					  :nd_operating_facility_id,                  	
					  :nd_patient_id,                  	
				      :nd_episode_type,
		...
		if (NODATAFOUND)
        ...
        else
		   {
			  if (sqlca.sqlcode == -1405)
				 {
					sprintf(string_var,"%s for Spec:%sTCode:%s\n",sqlca.sqlerrm.sqlerrmc,txt_specimen_no.arr,d_test_code.arr);
					disp_message(ERR_MESG,string_var);
					return 1;			  			  			  			  			  			  			  			  			  			   
				 }
		   }
...
void print_total(double tot_bill)
{
	char loc_legend1[41];
    int spc_len=0,rl_i=0;

//    strcpy(loc_legend1,"Total Unbilled Amount");
    strcpy(loc_legend1,local_legend[28]); //added for globalisation
    loc_legend1[22]='\0';
    ...
    spc_len = 39;
	for(rl_i=1;rl_i<=spc_len;rl_i++)
		fprintf(f1," ");

	fprintf(f1,"%22s       %9.2f\n",loc_legend1,tot_bill);		
	fprintf(f1,"\n");
	fill_dash(78);	
	line_no = line_no + 4; 	
}   
...
get_legend_value(int cou)
 {
	/* EXEC SQL EXECUTE
	BEGIN
	  SM_POPULATE_REPORT_LEGEND.FETCH_LEGEND (:nd_operating_facility_id,:language_id,'RLREXCBL.LEGEND_');
	END;
	END-EXEC; */ 
...
ng_facility_id , :language_id , 'RLREXCBL.LEGEND_' ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	/* EXEC SQL EXECUTE
	BEGIN
               :l_translated_value :=    GET_LEGEND(LTRIM(RTRIM('RLREXCBL.LEGEND_'||LTRIM(RTRIM(TO_CHAR(:i,'009'))))));
	END;
	END-EXEC; */ 
...
LREXCBL.LEGEND_' || LTRIM ( RTRIM ( TO_CHAR ( :i , '009' ) ) ) ) ) ) ; END ;";
 sqlstm.iters = (unsigned int  )1;
