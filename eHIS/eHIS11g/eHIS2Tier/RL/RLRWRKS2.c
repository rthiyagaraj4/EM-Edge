...
{
    30,
    "D:\\WORK\\PROCOTHERS\\RLRWRKS2.pc"
};


static unsigned long sqlctx = 1671425093;
...
",RL_RES_ACT_WORKLOAD_DAILY B ,RL_TEST_CODE_LANG_VW Z ,RL_PARAM_FOR_FACILITY \
D where ((((((((((((A.TEST_CODE=B.TEST_CODE and A.TEST_CODE=Z.TEST_CODE) and B\
.RESULT_DATE>=TO_DATE(:b0,'DD/MM/YYYY')) and B.RESULT_DATE<(TO_DATE(:b1,'DD/MM\
/YYYY')+1)) and B.OPERATING_FACILITY_ID=:b2) and NVL(A.STATISTICS_YN,'N')='Y')\
 and NVL(d.dept_restr_qure,'N')='Y') and b.operating_facility_id=d.operating_f\
acility_id) and a.section_code in (select section_code  from rl_user_dept wher\
e ((user_id=:b14 and operating_facility_id=:b2) and section_code between :b3 a\
nd :b4))) and Z.LANGUAGE_ID=:b5) and nvl(B.SOURCE_TYPE,'!')=nvl(:b6,nvl(B.SOUR\
CE_TYPE,'!'))) and nvl(B.SOURCE_CODE,'!') between :b7 and :b8) and A.TEST_CODE\
 in (select C.TEST_CODE  from RL_OUTST_WORK_GROUP_DTL C where (C.OPERATING_FAC\
ILITY_ID=:b2 and C.OUTST_WORK_GROUP_CODE=nvl(:b10,C.OUTST_WORK_GROUP_CODE)))))\
  group by SECTION_CODE,TEST_CODE,LONG_DESC,RESULT_DATE,WORK_UNITS,WORK_UNIT_A\
DD_FACTOR order by 1,2,6            ";

 static const char *sq0012 = 
"TE(:b0,'DD/MM/YYYY')) and B.RESULT_DATE<(TO_DATE(:b1,'DD/MM/YYYY')+1)) and B\
.OPERATING_FACILITY_ID=:b2) and NVL(A.STATISTICS_YN,'N')='Y') and NVL(d.dept_r\
estr_qure,'N')='Y') and b.operating_facility_id=d.operating_facility_id) and Z\
.LANGUAGE_ID=:b5) and a.section_code in (select section_code  from rl_user_dep\
t where ((user_id=:b13 and operating_facility_id=:b2) and section_code between\
 :b3 and :b4))) and nvl(B.SOURCE_TYPE,'!')=nvl(:b6,nvl(B.SOURCE_TYPE,'!'))) an\
d nvl(B.SOURCE_CODE,'!') between :b7 and :b8))  group by SECTION_CODE,TEST_COD\
E,LONG_DESC,RESULT_DATE,WORK_UNITS,WORK_UNIT_ADD_FACTOR order by 1,2,6        \
    ";

 static const char *sq0013 = 
"ST_CODE where (OPERATING_FACILITY_ID=:b2 and TEST_CODE=A.TEST_CODE) union se\
lect TEST_CODE  from RL_GROUP_TEST_DETAIL where GROUP_TEST_CODE in (select dis\
tinct P.TEST_CODE  from RL_REFERRED_TEST_CODE P ,RL_TEST_CODE Q where ((P.OPER\
ATING_FACILITY_ID=:b2 and P.TEST_CODE=Q.TEST_CODE) and NVL(Q.GROUP_TEST_YN,'N'\
)='Y')))) and A.TEST_CODE in (select C.TEST_CODE  from RL_OUTST_WORK_GROUP_DTL\
 C where (C.OPERATING_FACILITY_ID=:b2 and C.OUTST_WORK_GROUP_CODE=nvl(:b11,C.O\
UTST_WORK_GROUP_CODE)))))  group by SECTION_CODE,TEST_CODE,LONG_DESC,RESULT_DA\
TE,WORK_UNITS,WORK_UNIT_ADD_FACTOR order by 1,2,6            ";

 static const char *sq0014 = 
") and NVL(Q.GROUP_TEST_YN,'N')='Y')))) and nvl(B.SOURCE_TYPE,'!')=nvl(:b7,nv\
l(B.SOURCE_TYPE,'!'))) and nvl(B.SOURCE_CODE,'!') between :b8 and :b9))  group\
 by SECTION_CODE,TEST_CODE,LONG_DESC,RESULT_DATE,WORK_UNITS,WORK_UNIT_ADD_FACT\
OR order by 1,2,6            ";
...
267,0,0,11,4042,0,9,452,0,0,24,24,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
...
378,0,0,12,3698,0,9,528,0,0,20,20,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
473,0,0,13,4701,0,9,654,0,0,28,28,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
600,0,0,14,4357,0,9,765,0,0,24,24,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
711,0,0,15,0,0,32,775,0,0,0,0,0,1,0,
726,0,0,16,706,0,4,935,0,0,7,5,0,1,0,2,3,0,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
769,0,0,17,651,0,4,962,0,0,7,6,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
812,0,0,18,651,0,4,986,0,0,7,6,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
855,0,0,19,689,0,4,1008,0,0,7,6,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,
898,0,0,20,128,0,4,1035,0,0,4,2,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
929,0,0,21,0,0,32,1049,0,0,0,0,0,1,0,
944,0,0,11,0,0,13,1099,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,
991,0,0,12,0,0,13,1109,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,
1038,0,0,13,0,0,13,1122,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,
1085,0,0,14,0,0,13,1132,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,
1132,0,0,22,0,0,32,1161,0,0,0,0,0,1,0,
1147,0,0,23,135,0,6,1203,0,0,3,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
1174,0,0,24,44,0,4,1287,0,0,3,2,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
1201,0,0,25,44,0,4,1312,0,0,3,2,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
1228,0,0,26,135,0,6,1378,0,0,3,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
1255,0,0,27,135,0,6,1417,0,0,3,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
1282,0,0,28,44,0,4,1502,0,0,3,2,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
1309,0,0,29,44,0,4,1527,0,0,3,2,0,1,0,1,9,0,0,1,9,0,0,2,9,0,0,
1336,0,0,30,0,0,32,1565,0,0,0,0,0,1,0,
1351,0,0,31,100,0,6,1781,0,0,2,2,0,1,0,2,9,0,0,1,9,0,0,
1374,0,0,32,129,0,6,1807,0,0,3,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
1401,0,0,33,127,0,6,1817,0,0,3,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
1428,0,0,34,101,0,6,1937,0,0,1,1,0,1,0,2,3,0,0,
1447,0,0,35,49,0,4,1950,0,0,1,0,0,1,0,2,9,0,0,
};
 ...
 if (strcmp(d_option.arr,"R") != 0)		/*	Added by Durai Rajkumar against ML-SD-SCF-20239	*/
 {
  if (d_workgroup.arr[0] != '\0')
  {
   /* EXEC SQL DECLARE RESULT_WORKLOAD CURSOR FOR
     ...
     FROM   RL_TEST_CODE A, RL_RES_ACT_WORKLOAD_DAILY B, RL_TEST_CODE_LANG_VW Z,RL_PARAM_FOR_FACILITY D
     ...
     /o --  Added by Ooha 27/11/2020  as per ML-MMOH-CRF-1497 -- o/
     AND NVL (d.dept_restr_qure, 'N') = 'N'
     AND b.operating_facility_id = d.operating_facility_id
	 /o -- UPTO here added by Ooha on 27/11/2020 as per ML-MMOH-CRF-1497 --- o/	
...
/o -- upto here added by sunil on 12/10/2007 as per SD-CRF-20071 --- o/
	 ...
	 /o -- FROM here added by Ooha on 27/11/2020 as per ML-MMOH-CRF-1497 --- o/	
     UNION
     SELECT SECTION_CODE, TEST_CODE, LONG_DESC, WORK_UNITS, WORK_UNIT_ADD_FACTOR, RESULT_DATE,
     SUM(DAILY_TOTAL) DAILY_TOTAL, SUM(ADD_TOTAL) ADD_TOTAL
     FROM
     ...
     AND B.OPERATING_FACILITY_ID = :nd_operating_facility_id
     AND  NVL(A.STATISTICS_YN,'N') = 'Y'
     AND NVL (d.dept_restr_qure, 'N') = 'Y'
     AND b.operating_facility_id = d.operating_facility_id
     AND a.section_code IN (
            SELECT section_code
              FROM rl_user_dept
             WHERE user_id = :d_user
               AND operating_facility_id = :nd_operating_facility_id
               AND section_code BETWEEN :d_section_code_fm AND :d_section_code_to)
     AND Z.LANGUAGE_ID = :language_id
     AND nvl(B.SOURCE_TYPE,'!') = nvl(:d_source_type,nvl(B.SOURCE_TYPE,'!')) 
	 ...
	 /* -- UPTO here added by Ooha on 27/11/2020 as per ML-MMOH-CRF-1497 --- */	
...
L  from RL_TEST_CODE A ,RL_RES_ACT_WORKLOAD_DAILY B ,RL_TEST_CODE_LANG_VW Z \
,RL_PARAM_FOR_FACILITY D where ((((((((((((A.TEST_CODE=B.TEST_CODE and A.TES\
T_CODE=Z.TEST_CODE) and B.RESULT_DATE>=TO_DATE(:b0,'DD/MM/YYYY')) and B.RESU\
LT_DATE<(TO_DATE(:b1,'DD/MM/YYYY')+1)) and B.OPERATING_FACILITY_ID=:b2) and \
A.SECTION_CODE between :b3 and :b4) and NVL(A.STATISTICS_YN,'N')='Y') and NV\
L(d.dept_restr_qure,'N')='N') and b.operating_facility_id=d.operating_facili\
ty_id) and Z.LANGUAGE_ID=:b5) and nvl(B.SOURCE_TYPE,'!')=nvl(:b6,nvl(B.SOURC\
E_TYPE,'!'))) and nvl(B.SOURCE_CODE,'!') between :b7 and :b8) and A.TEST_COD\
E in (select C.TEST_CODE  from RL_OUTST_WORK_GROUP_DTL C where (C.OPERATING_\
FACILITY_ID=:b2 and C.OUTST_WORK_GROUP_CODE=nvl(:b10,C.OUTST_WORK_GROUP_CODE\
)))))  group by SECTION_CODE,TEST_CODE,LONG_DESC,RESULT_DATE,WORK_UNITS,WORK\
_UNIT_ADD_FACTOR union select SECTION_CODE ,TEST_CODE ,LONG_DESC ,WORK_UNITS\
 ,WORK_UNIT_ADD_FACTOR ,RESULT_DATE ,sum(");
  sqlbuft((void **)0, 
    "DAILY_TOTAL) DAILY_TOTAL ,sum(ADD_TOTAL) ADD_TOTAL  from (select A.SECT\
ION_CODE ,A.TEST_CODE ,Z.LONG_DESC ,NVL(A.WORK_UNITS,0) WORK_UNITS ,nvl(a.WO\
RK_UNIT_ADD_FACTOR,0) WORK_UNIT_ADD_FACTOR ,TO_CHAR(B.RESULT_DATE,'DD/MM/YYY\
Y') RESULT_DATE ,TO_CHAR((((((((((((((((((((((((NVL(B.H1,0)+NVL(B.H2,0))+NVL\
(B.H3,0))+NVL(B.H4,0))+NVL(B.H5,0))+NVL(B.H6,0))+NVL(B.H7,0))+NVL(B.H8,0))+N\
VL(B.H9,0))+NVL(B.H10,0))+NVL(B.H11,0))+NVL(B.H12,0))+NVL(B.H13,0))+NVL(B.H1\
4,0))+NVL(B.H15,0))+NVL(B.H16,0))+NVL(B.H17,0))+NVL(B.H18,0))+NVL(B.H19,0))+\
NVL(B.H20,0))+NVL(B.H21,0))+NVL(B.H22,0))+NVL(B.H23,0))+NVL(B.H24,0))) DAILY\
_TOTAL ,TO_CHAR((((((((((((((((((((((((NVL(B.AH1,0)+NVL(B.AH2,0))+NVL(B.AH3,\
0))+NVL(B.AH4,0))+NVL(B.AH5,0))+NVL(B.AH6,0))+NVL(B.AH7,0))+NVL(B.AH8,0))+NV\
L(B.AH9,0))+NVL(B.AH10,0))+NVL(B.AH11,0))+NVL(B.AH12,0))+NVL(B.AH13,0))+NVL(\
B.AH14,0))+NVL(B.AH15,0))+NVL(B.AH16,0))+NVL(B.AH17,0))+NVL(B.AH18,0))+NVL(B\
.AH19,0))+NVL(B.AH20,0))+NVL(B.AH21,0))+NVL(B.AH22,0))+NVL(B.AH23,0))+NVL(B.\
AH24,0))) ADD_TOTAL  from RL_TEST_CODE A ");
  sqlstm.stmt = sq0011;
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[10] = (unsigned short )0;
  sqlstm.sqtdso[10] = (unsigned short )0;
  sqlstm.sqhstv[11] = (         void  *)&d_date_from;
  ...
  sqlstm.sqadto[11] = (unsigned short )0;
  sqlstm.sqtdso[11] = (unsigned short )0;
  sqlstm.sqhstv[12] = (         void  *)&d_date_to;
  ...
  sqlstm.sqhstv[16] = (         void  *)&d_section_code_fm;
  ...
  sqlstm.sqhstv[17] = (         void  *)&d_section_code_to;
  ...
  sqlstm.sqhstv[18] = (         void  *)&language_id;
  ...
  sqlstm.sqhstv[19] = (         void  *)&d_source_type;
  sqlstm.sqhstl[19] = (unsigned int  )35;
  ...
  sqlstm.sqhstv[20] = (         void  *)&d_source_fm;
  ...
  sqlstm.sqhstv[21] = (         void  *)&d_source_to;
  ...
  sqlstm.sqhstv[23] = (         void  *)&d_workgroup;
  ...
  else
  {
   /* EXEC SQL DECLARE RESULT_WORKLOAD1 CURSOR FOR
     ...
     AND B.RESULT_DATE  < TO_DATE(:d_date_to,'DD/MM/YYYY') + 1
     AND B.OPERATING_FACILITY_ID =:nd_operating_facility_id
	 AND A.SECTION_CODE BETWEEN :d_section_code_fm AND :d_section_code_to
     AND  NVL(A.STATISTICS_YN,'N') = 'Y' 
	 /o -- from here added by Ooha on 27/11/2020 as per ML-MMOH-CRF-1497 --- o/	
     AND NVL (d.dept_restr_qure, 'N') = 'N'
     AND b.operating_facility_id = d.operating_facility_id
...
L(B.AH18,0))+NVL(B.AH19,0))+NVL(B.AH20,0)");
  sqlbuft((void **)0, 
    ")+NVL(B.AH21,0))+NVL(B.AH22,0))+NVL(B.AH23,0))+NVL(B.AH24,0))) ADD_TOTA\
L  from RL_TEST_CODE A ,RL_RES_ACT_WORKLOAD_DAILY B ,RL_TEST_CODE_LANG_VW Z \
,RL_PARAM_FOR_FACILITY D where (((((((((((A.TEST_CODE=B.TEST_CODE and A.TEST\
_CODE=Z.TEST_CODE) and B.RESULT_DATE>=TO_DATE(:b0,'DD/MM/YYYY')) and B.RESUL\
T_DATE<(TO_DATE(:b1,'DD/MM/YYYY')+1)) and B.OPERATING_FACILITY_ID=:b2) and A\
.SECTION_CODE between :b3 and :b4) and NVL(A.STATISTICS_YN,'N')='Y') and NVL\
(d.dept_restr_qure,'N')='N') and b.operating_facility_id=d.operating_facilit\
y_id) and Z.LANGUAGE_ID=:b5) and nvl(B.SOURCE_TYPE,'!')=nvl(:b6,nvl(B.SOURCE\
_TYPE,'!'))) and nvl(B.SOURCE_CODE,'!') between :b7 and :b8))  group by SECT\
ION_CODE,TEST_CODE,LONG_DESC,RESULT_DATE,WORK_UNITS,WORK_UNIT_ADD_FACTOR uni\
on select SECTION_CODE ,TEST_CODE ,LONG_DESC ,WORK_UNITS ,WORK_UNIT_ADD_FACT\
OR ,RESULT_DATE ,sum(DAILY_TOTAL) DAILY_TOTAL ,sum(ADD_TOTAL) ADD_TOTAL  fro\
m (select A.SECTION_CODE ,A.TEST_CODE ,Z.LONG_DESC ,NVL(A.WORK_UNITS,0) WORK\
_UNITS ,nvl(a.WORK_UNIT_ADD_FACTOR,0) WOR");
  sqlbuft((void **)0, 
    "K_UNIT_ADD_FACTOR ,TO_CHAR(B.RESULT_DATE,'DD/MM/YYYY') RESULT_DATE ,TO_\
CHAR((((((((((((((((((((((((NVL(B.H1,0)+NVL(B.H2,0))+NVL(B.H3,0))+NVL(B.H4,0\
))+NVL(B.H5,0))+NVL(B.H6,0))+NVL(B.H7,0))+NVL(B.H8,0))+NVL(B.H9,0))+NVL(B.H1\
0,0))+NVL(B.H11,0))+NVL(B.H12,0))+NVL(B.H13,0))+NVL(B.H14,0))+NVL(B.H15,0))+\
NVL(B.H16,0))+NVL(B.H17,0))+NVL(B.H18,0))+NVL(B.H19,0))+NVL(B.H20,0))+NVL(B.\
H21,0))+NVL(B.H22,0))+NVL(B.H23,0))+NVL(B.H24,0))) DAILY_TOTAL ,TO_CHAR(((((\
(((((((((((((((((((NVL(B.AH1,0)+NVL(B.AH2,0))+NVL(B.AH3,0))+NVL(B.AH4,0))+NV\
L(B.AH5,0))+NVL(B.AH6,0))+NVL(B.AH7,0))+NVL(B.AH8,0))+NVL(B.AH9,0))+NVL(B.AH\
10,0))+NVL(B.AH11,0))+NVL(B.AH12,0))+NVL(B.AH13,0))+NVL(B.AH14,0))+NVL(B.AH1\
5,0))+NVL(B.AH16,0))+NVL(B.AH17,0))+NVL(B.AH18,0))+NVL(B.AH19,0))+NVL(B.AH20\
,0))+NVL(B.AH21,0))+NVL(B.AH22,0))+NVL(B.AH23,0))+NVL(B.AH24,0))) ADD_TOTAL \
 from RL_TEST_CODE A ,RL_RES_ACT_WORKLOAD_DAILY B ,RL_TEST_CODE_LANG_VW Z ,R\
L_PARAM_FOR_FACILITY D where (((((((((((A.TEST_CODE=B.TEST_CODE and A.TEST_C\
ODE=Z.TEST_CODE) and B.RESULT_DATE>=TO_DA");
  sqlstm.stmt = sq0012;
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[8] = (unsigned short )0;
  sqlstm.sqtdso[8] = (unsigned short )0;
  sqlstm.sqhstv[9] = (         void  *)&d_date_from;
  ...
  sqlstm.sqadto[9] = (unsigned short )0;
  sqlstm.sqtdso[9] = (unsigned short )0;
  sqlstm.sqhstv[10] = (         void  *)&d_date_to;
  ...
  sqlstm.sqadto[14] = (unsigned short )0;
  sqlstm.sqtdso[14] = (unsigned short )0;
  sqlstm.sqhstv[15] = (         void  *)&d_section_code_fm;
  ...
  sqlstm.sqadto[15] = (unsigned short )0;
  sqlstm.sqtdso[15] = (unsigned short )0;
  sqlstm.sqhstv[16] = (         void  *)&d_section_code_to;
  sqlstm.sqhstl[16] = (unsigned int  )22;
  sqlstm.sqhsts[16] = (         int  )0;
  sqlstm.sqindv[16] = (         void  *)0;
  sqlstm.sqinds[16] = (         int  )0;
  ...
  sqlstm.sqadto[16] = (unsigned short )0;
  sqlstm.sqtdso[16] = (unsigned short )0;
  sqlstm.sqhstv[17] = (         void  *)&d_source_type;
  sqlstm.sqhstl[17] = (unsigned int  )35;
  sqlstm.sqhsts[17] = (         int  )0;
  sqlstm.sqindv[17] = (         void  *)0;
  sqlstm.sqinds[17] = (         int  )0;
  sqlstm.sqharm[17] = (unsigned int  )0;
  sqlstm.sqadto[17] = (unsigned short )0;
  sqlstm.sqtdso[17] = (unsigned short )0;
  sqlstm.sqhstv[18] = (         void  *)&d_source_fm;
  ...
  sqlstm.sqadto[18] = (unsigned short )0;
  sqlstm.sqtdso[18] = (unsigned short )0;
  sqlstm.sqhstv[19] = (         void  *)&d_source_to;
 ...
 if (d_workgroup.arr[0] != '\0')
  {
   /* EXEC SQL DECLARE RESULT_WORKLOAD3 CURSOR FOR
     ...
     NVL(B.AH13,0) + NVL(B.AH14,0) + NVL(B.AH15,0) + NVL(B.AH16,0)+ NVL(B.AH17,0) + NVL(B.AH18,0)+
     NVL(B.AH19,0) + NVL(B.AH20,0) + NVL(B.AH21,0) + NVL(B.AH22,0)+ NVL(B.AH23,0) + NVL(B.AH24,0))) ADD_TOTAL
     FROM   RL_TEST_CODE A, RL_RES_ACT_WORKLOAD_DAILY B,RL_PARAM_FOR_FACILITY D
     WHERE  A.TEST_CODE = B.TEST_CODE
	 AND B.RESULT_DATE  >= TO_DATE(:d_date_from,'DD/MM/YYYY')
     AND B.RESULT_DATE  < TO_DATE(:d_date_to,'DD/MM/YYYY') + 1
     AND B.OPERATING_FACILITY_ID = :nd_operating_facility_id
...
L(B.AH18,0))+NVL(B.AH19,0))+NVL(B.AH20,0)");
  sqlbuft((void **)0, 
    ")+NVL(B.AH21,0))+NVL(B.AH22,0))+NVL(B.AH23,0))+NVL(B.AH24,0))) ADD_TOTA\
L  from RL_TEST_CODE A ,RL_RES_ACT_WORKLOAD_DAILY B ,RL_PARAM_FOR_FACILITY D\
 where (((((((((((A.TEST_CODE=B.TEST_CODE and B.RESULT_DATE>=TO_DATE(:b0,'DD\
/MM/YYYY')) and B.RESULT_DATE<(TO_DATE(:b1,'DD/MM/YYYY')+1)) and B.OPERATING\
_FACILITY_ID=:b2) and A.SECTION_CODE between :b3 and :b4) and NVL(A.STATISTI\
CS_YN,'N')='Y') and NVL(d.dept_restr_qure,'N')='N') and b.operating_facility\
_id=d.operating_facility_id) and nvl(B.SOURCE_TYPE,'!')=nvl(:b5,nvl(B.SOURCE\
_TYPE,'!'))) and nvl(B.SOURCE_CODE,'!') between :b6 and :b7) and A.TEST_CODE\
 in (select distinct TEST_CODE  from RL_REFERRED_TEST_CODE where (OPERATING_\
FACILITY_ID=:b2 and TEST_CODE=A.TEST_CODE) union select TEST_CODE  from RL_G\
ROUP_TEST_DETAIL where GROUP_TEST_CODE in (select distinct P.TEST_CODE  from\
 RL_REFERRED_TEST_CODE P ,RL_TEST_CODE Q where ((P.OPERATING_FACILITY_ID=:b2\
 and P.TEST_CODE=Q.TEST_CODE) and NVL(Q.GROUP_TEST_YN,'N')='Y')))) and A.TES\
T_CODE in (select C.TEST_CODE  from RL_OU");
  sqlbuft((void **)0, 
    "TST_WORK_GROUP_DTL C where (C.OPERATING_FACILITY_ID=:b2 and C.OUTST_WOR\
K_GROUP_CODE=nvl(:b11,C.OUTST_WORK_GROUP_CODE)))))  group by SECTION_CODE,TE\
ST_CODE,LONG_DESC,RESULT_DATE,WORK_UNITS,WORK_UNIT_ADD_FACTOR union select S\
ECTION_CODE ,TEST_CODE ,LONG_DESC ,WORK_UNITS ,WORK_UNIT_ADD_FACTOR ,RESULT_\
DATE ,sum(DAILY_TOTAL) DAILY_TOTAL ,sum(ADD_TOTAL) ADD_TOTAL  from (select A\
.SECTION_CODE ,A.TEST_CODE ,A.LONG_DESC ,NVL(A.WORK_UNITS,0) WORK_UNITS ,nvl\
(a.WORK_UNIT_ADD_FACTOR,0) WORK_UNIT_ADD_FACTOR ,TO_CHAR(B.RESULT_DATE,'DD/M\
M/YYYY') RESULT_DATE ,TO_CHAR((((((((((((((((((((((((NVL(B.H1,0)+NVL(B.H2,0)\
)+NVL(B.H3,0))+NVL(B.H4,0))+NVL(B.H5,0))+NVL(B.H6,0))+NVL(B.H7,0))+NVL(B.H8,\
0))+NVL(B.H9,0))+NVL(B.H10,0))+NVL(B.H11,0))+NVL(B.H12,0))+NVL(B.H13,0))+NVL\
(B.H14,0))+NVL(B.H15,0))+NVL(B.H16,0))+NVL(B.H17,0))+NVL(B.H18,0))+NVL(B.H19\
,0))+NVL(B.H20,0))+NVL(B.H21,0))+NVL(B.H22,0))+NVL(B.H23,0))+NVL(B.H24,0))) \
DAILY_TOTAL ,TO_CHAR((((((((((((((((((((((((NVL(B.AH1,0)+NVL(B.AH2,0))+NVL(B\
.AH3,0))+NVL(B.AH4,0))+NVL(B.AH5,0))+NVL(");
  sqlbuft((void **)0, 
    "B.AH6,0))+NVL(B.AH7,0))+NVL(B.AH8,0))+NVL(B.AH9,0))+NVL(B.AH10,0))+NVL(\
B.AH11,0))+NVL(B.AH12,0))+NVL(B.AH13,0))+NVL(B.AH14,0))+NVL(B.AH15,0))+NVL(B\
.AH16,0))+NVL(B.AH17,0))+NVL(B.AH18,0))+NVL(B.AH19,0))+NVL(B.AH20,0))+NVL(B.\
AH21,0))+NVL(B.AH22,0))+NVL(B.AH23,0))+NVL(B.AH24,0))) ADD_TOTAL  from RL_TE\
ST_CODE A ,RL_RES_ACT_WORKLOAD_DAILY B ,RL_PARAM_FOR_FACILITY D where ((((((\
((((((A.TEST_CODE=B.TEST_CODE and B.RESULT_DATE>=TO_DATE(:b0,'DD/MM/YYYY')) \
and B.RESULT_DATE<(TO_DATE(:b1,'DD/MM/YYYY')+1)) and B.OPERATING_FACILITY_ID\
=:b2) and A.SECTION_CODE between :b3 and :b4) and NVL(A.STATISTICS_YN,'N')='\
Y') and NVL(d.dept_restr_qure,'N')='Y') and b.operating_facility_id=d.operat\
ing_facility_id) and a.section_code in (select section_code  from rl_user_de\
pt where ((user_id=:b17 and operating_facility_id=:b2) and section_code betw\
een :b3 and :b4))) and nvl(B.SOURCE_TYPE,'!')=nvl(:b5,nvl(B.SOURCE_TYPE,'!')\
)) and nvl(B.SOURCE_CODE,'!') between :b6 and :b7) and A.TEST_CODE in (selec\
t distinct TEST_CODE  from RL_REFERRED_TE");
  sqlstm.stmt = sq0013;
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[11] = (unsigned short )0;
  sqlstm.sqtdso[11] = (unsigned short )0;
  sqlstm.sqhstv[12] = (         void  *)&d_date_from;
  sqlstm.sqhstl[12] = (unsigned int  )23;
  sqlstm.sqhsts[12] = (         int  )0;
  sqlstm.sqindv[12] = (         void  *)0;
  sqlstm.sqinds[12] = (         int  )0;
  ...
  sqlstm.sqadto[12] = (unsigned short )0;
  sqlstm.sqtdso[12] = (unsigned short )0;
  sqlstm.sqhstv[13] = (         void  *)&d_date_to;
  ...
  sqlstm.sqadto[18] = (unsigned short )0;
  sqlstm.sqtdso[18] = (unsigned short )0;
  sqlstm.sqhstv[19] = (         void  *)&d_section_code_fm;
  ...
  sqlstm.sqadto[19] = (unsigned short )0;
  sqlstm.sqtdso[19] = (unsigned short )0;
  sqlstm.sqhstv[20] = (         void  *)&d_section_code_to;
  ...
  sqlstm.sqadto[20] = (unsigned short )0;
  sqlstm.sqtdso[20] = (unsigned short )0;
  sqlstm.sqhstv[21] = (         void  *)&d_source_type;
  sqlstm.sqhstl[21] = (unsigned int  )35;
  sqlstm.sqhsts[21] = (         int  )0;
  sqlstm.sqindv[21] = (         void  *)0;
  sqlstm.sqinds[21] = (         int  )0;
  sqlstm.sqharm[21] = (unsigned int  )0;
  sqlstm.sqadto[21] = (unsigned short )0;
  sqlstm.sqtdso[21] = (unsigned short )0;
  sqlstm.sqhstv[22] = (         void  *)&d_source_fm;
  sqlstm.sqhstl[22] = (unsigned int  )32;
  sqlstm.sqhsts[22] = (         int  )0;
  sqlstm.sqindv[22] = (         void  *)0;
  sqlstm.sqinds[22] = (         int  )0;
  ...
  sqlstm.sqadto[22] = (unsigned short )0;
  sqlstm.sqtdso[22] = (unsigned short )0;
  sqlstm.sqhstv[23] = (         void  *)&d_source_to;
  ...
  sqlstm.sqhstv[27] = (         void  *)&d_workgroup;
  sqlstm.sqhstl[27] = (unsigned int  )52;
...
L  from RL_TEST_CODE A ,RL_RES_ACT_WORKLOAD_DAILY B ,RL_PARAM_FOR_FACILITY D\
 where ((((((((((A.TEST_CODE=B.TEST_CODE and B.RESULT_DATE>=TO_DATE(:b0,'DD/\
MM/YYYY')) and B.RESULT_DATE<(TO_DATE(:b1,'DD/MM/YYYY')+1)) and B.OPERATING_\
FACILITY_ID=:b2) and A.SECTION_CODE between :b3 and :b4) and NVL(A.STATISTIC\
S_YN,'N')='Y') and NVL(d.dept_restr_qure,'N')='N') and b.operating_facility_\
id=d.operating_facility_id) and A.TEST_CODE in (select distinct TEST_CODE  f\
rom RL_REFERRED_TEST_CODE where (OPERATING_FACILITY_ID=:b2 and TEST_CODE=A.T\
EST_CODE) union select TEST_CODE  from RL_GROUP_TEST_DETAIL where GROUP_TEST\
_CODE in (select distinct P.TEST_CODE  from RL_REFERRED_TEST_CODE P ,RL_TEST\
_CODE Q where ((P.OPERATING_FACILITY_ID=:b2 and P.TEST_CODE=Q.TEST_CODE) and\
 NVL(Q.GROUP_TEST_YN,'N')='Y')))) and nvl(B.SOURCE_TYPE,'!')=nvl(:b7,nvl(B.S\
OURCE_TYPE,'!'))) and nvl(B.SOURCE_CODE,'!') between :b8 and :b9))  group by\
 SECTION_CODE,TEST_CODE,LONG_DESC,RESULT_");
  sqlbuft((void **)0, 
    "DATE,WORK_UNITS,WORK_UNIT_ADD_FACTOR union select SECTION_CODE ,TEST_CO\
DE ,LONG_DESC ,WORK_UNITS ,WORK_UNIT_ADD_FACTOR ,RESULT_DATE ,sum(DAILY_TOTA\
L) DAILY_TOTAL ,sum(ADD_TOTAL) ADD_TOTAL  from (select A.SECTION_CODE ,A.TES\
T_CODE ,A.LONG_DESC ,NVL(A.WORK_UNITS,0) WORK_UNITS ,nvl(a.WORK_UNIT_ADD_FAC\
TOR,0) WORK_UNIT_ADD_FACTOR ,TO_CHAR(B.RESULT_DATE,'DD/MM/YYYY') RESULT_DATE\
 ,TO_CHAR((((((((((((((((((((((((NVL(B.H1,0)+NVL(B.H2,0))+NVL(B.H3,0))+NVL(B\
.H4,0))+NVL(B.H5,0))+NVL(B.H6,0))+NVL(B.H7,0))+NVL(B.H8,0))+NVL(B.H9,0))+NVL\
(B.H10,0))+NVL(B.H11,0))+NVL(B.H12,0))+NVL(B.H13,0))+NVL(B.H14,0))+NVL(B.H15\
,0))+NVL(B.H16,0))+NVL(B.H17,0))+NVL(B.H18,0))+NVL(B.H19,0))+NVL(B.H20,0))+N\
VL(B.H21,0))+NVL(B.H22,0))+NVL(B.H23,0))+NVL(B.H24,0))) DAILY_TOTAL ,TO_CHAR\
((((((((((((((((((((((((NVL(B.AH1,0)+NVL(B.AH2,0))+NVL(B.AH3,0))+NVL(B.AH4,0\
))+NVL(B.AH5,0))+NVL(B.AH6,0))+NVL(B.AH7,0))+NVL(B.AH8,0))+NVL(B.AH9,0))+NVL\
(B.AH10,0))+NVL(B.AH11,0))+NVL(B.AH12,0))+NVL(B.AH13,0))+NVL(B.AH14,0))+NVL(\
B.AH15,0))+NVL(B.AH16,0))+NVL(B.AH17,0))+");
  sqlbuft((void **)0, 
    "NVL(B.AH18,0))+NVL(B.AH19,0))+NVL(B.AH20,0))+NVL(B.AH21,0))+NVL(B.AH22,\
0))+NVL(B.AH23,0))+NVL(B.AH24,0))) ADD_TOTAL  from RL_TEST_CODE A ,RL_RES_AC\
T_WORKLOAD_DAILY B ,RL_PARAM_FOR_FACILITY D where (((((((((((A.TEST_CODE=B.T\
EST_CODE and B.RESULT_DATE>=TO_DATE(:b0,'DD/MM/YYYY')) and B.RESULT_DATE<(TO\
_DATE(:b1,'DD/MM/YYYY')+1)) and B.OPERATING_FACILITY_ID=:b2) and A.SECTION_C\
ODE between :b3 and :b4) and NVL(A.STATISTICS_YN,'N')='Y') and NVL(d.dept_re\
str_qure,'N')='Y') and b.operating_facility_id=d.operating_facility_id) and \
a.section_code in (select section_code  from rl_user_dept where ((user_id=:b\
15 and operating_facility_id=:b2) and section_code between :b3 and :b4))) an\
d A.TEST_CODE in (select distinct TEST_CODE  from RL_REFERRED_TEST_CODE wher\
e (OPERATING_FACILITY_ID=:b2 and TEST_CODE=A.TEST_CODE) union select TEST_CO\
DE  from RL_GROUP_TEST_DETAIL where GROUP_TEST_CODE in (select distinct P.TE\
ST_CODE  from RL_REFERRED_TEST_CODE P ,RL_TEST_CODE Q where ((P.OPERATING_FA\
CILITY_ID=:b2 and P.TEST_CODE=Q.TEST_CODE");
  sqlstm.stmt = sq0014;
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[9] = (unsigned short )0;
  sqlstm.sqtdso[9] = (unsigned short )0;
  sqlstm.sqhstv[10] = (         void  *)&d_date_from;
  sqlstm.sqhstl[10] = (unsigned int  )23;
  sqlstm.sqhsts[10] = (         int  )0;
  sqlstm.sqindv[10] = (         void  *)0;
  sqlstm.sqinds[10] = (         int  )0;
  ...
  sqlstm.sqadto[10] = (unsigned short )0;
  sqlstm.sqtdso[10] = (unsigned short )0;
  sqlstm.sqhstv[11] = (         void  *)&d_date_to;
  sqlstm.sqhstl[11] = (unsigned int  )23;
  sqlstm.sqhsts[11] = (         int  )0;
  sqlstm.sqindv[11] = (         void  *)0;
  sqlstm.sqinds[11] = (         int  )0;
  ...
  sqlstm.sqadto[12] = (unsigned short )0;
  sqlstm.sqtdso[12] = (unsigned short )0;
  sqlstm.sqhstv[13] = (         void  *)&d_section_code_fm;
  ...
  sqlstm.sqadto[13] = (unsigned short )0;
  sqlstm.sqtdso[13] = (unsigned short )0;
  sqlstm.sqhstv[14] = (         void  *)&d_section_code_to;
  ...
  sqlstm.sqadto[16] = (unsigned short )0;
  sqlstm.sqtdso[16] = (unsigned short )0;
  sqlstm.sqhstv[17] = (         void  *)&d_section_code_fm;
  sqlstm.sqhstl[17] = (unsigned int  )22;
  sqlstm.sqhsts[17] = (         int  )0;
  sqlstm.sqindv[17] = (         void  *)0;
  sqlstm.sqinds[17] = (         int  )0;
  ...
  sqlstm.sqadto[17] = (unsigned short )0;
  sqlstm.sqtdso[17] = (unsigned short )0;
  sqlstm.sqhstv[18] = (         void  *)&d_section_code_to;
