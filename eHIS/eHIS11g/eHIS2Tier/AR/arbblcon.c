...
{
    56,
    "d:\\madhu\\billing\\madhu\\generate_invoice_post\\arbblcon.pc"
};


static unsigned long sqlctx = 1295871835;
...
"select 'X'  from AR_TRN_DOC_TYPE where (((OPERATING_FACILITY_ID=:b0 and DOC_\
TYPE_CODE=:b1) and TRN_TYPE_CODE='1') and ACC_ENTITY_CODE in (select ACC_ENTIT\
Y_CODE  from SY_ACC_ENTITY where ACC_ENTITY_ID=:b0))           ";
...
"select 'X'  from AR_TRN_DOC_TYPE where (((OPERATING_FACILITY_ID=:b0 and DOC_\
TYPE_CODE=:b1) and TRN_TYPE_CODE='3') and ACC_ENTITY_CODE in (select ACC_ENTIT\
Y_CODE  from SY_ACC_ENTITY where ACC_ENTITY_ID=:b0))           ";
...
NC(DOC_DATE)) and NVL(TO_DATE(:b3,'DD/MM/YYYY'),TRUNC(DOC_DATE))) and ((((DOC_\
TYPE_CODE||LPAD(DOC_NUM,8,0)) between (NVL(:b4,DOC_TYPE_CODE)||LPAD(NVL(:b5,DO\
C_NUM),8,'0')) and (NVL(:b6,DOC_TYPE_CODE)||LPAD(NVL(:b7,DOC_NUM),8,'0')) and \
(:b8='A' or OPERATING_FACILITY_ID=:b8)) and :b10='ARBBLCON') or ((DOC_TYPE_COD\
E,DOC_NUM) in (select DOC_TYPE_CODE ,doc_number  from AR_INV_PROCESS_TEMP wher\
e ((PROCESS_PGM_ID='ARTGNINV' and PROCESS_SESSION_ID=:b11) and PROCESS_DATE_TI\
ME=:b12)) and :b10='ARTGNINV'))) and BILL_NATURE_CODE='A') and BILL_STATUS is \
null ) and ((:b14='Y' and BILL_POSTED_FLAG='Y') or :b14='N')) and CUST_CODE is\
  not null ) and NVL(BILL_TOT_OUTST_AMT,0)<>0) order by CUST_CODE            ";
...
_AMT ,BILL_POSTED_FLAG ,ADDED_BY_ID ,MODIFIED_BY_ID ,ADDED_DATE ,MODIFIED_DATE\
 ,ROWID  from BL_BILL_HDR where ((DOC_TYPE_CODE=:b0 and DOC_NUM=:b1) and OPERA\
TING_FACILITY_ID=:b2) for update of DOC_TYPE_CODE nowait ";
...
"select BL_RECV_ACC_INT_CODE ,AR_RECV_ACC_INT_CODE  from BL_BILL_TYPE_INT whe\
re ((BILL_TYPE_CODE=:b0 and ACC_ENTITY_CODE in (select ACC_ENTITY_CODE  from S\
Y_ACC_ENTITY where ACC_ENTITY_ID=:b1)) and TO_DATE(:b2,'DD/MM/YYYY') between n\
vl(EFF_FROM_DATE,sysdate) and nvl(EFF_TO_DATE,sysdate))           ";
...
"select PMNT_TERMS_CODE ,GL_MAIN_ACC1_CODE ,GL_MAIN_ACC2_CODE ,NVL(CREDIT_LIM\
IT_AMT,0)  from AR_CUSTOMER where (CUST_CODE=:b0 and ACC_ENTITY_CODE in (selec\
t ACC_ENTITY_CODE  from SY_ACC_ENTITY where ACC_ENTITY_ID=:b1))           ";
...
{10,4274,0,0,0,
5,0,0,1,94,0,4,275,0,0,1,0,0,1,0,2,9,0,0,
24,0,0,2,31,0,4,282,0,0,1,0,0,1,0,2,9,0,0,
43,0,0,3,31,0,4,284,0,0,1,0,0,1,0,2,9,0,0,
62,0,0,4,31,0,4,287,0,0,1,0,0,1,0,2,9,0,0,
81,0,0,5,97,0,4,296,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
104,0,0,6,75,0,4,334,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
127,0,0,7,0,0,29,381,0,0,0,0,0,1,0,
142,0,0,8,0,0,29,449,0,0,0,0,0,1,0,
157,0,0,9,0,0,30,456,0,0,0,0,0,1,0,
172,0,0,10,463,0,4,519,0,0,29,4,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
303,0,0,11,116,0,2,581,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
334,0,0,21,212,0,9,841,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
357,0,0,21,0,0,13,854,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
384,0,0,23,217,0,9,876,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
411,0,0,23,0,0,13,881,0,0,1,0,0,1,0,2,9,0,0,
430,0,0,22,212,0,9,894,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
453,0,0,22,0,0,13,907,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
480,0,0,24,217,0,9,929,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
507,0,0,24,0,0,13,934,0,0,1,0,0,1,0,2,9,0,0,
526,0,0,12,933,0,9,948,0,0,16,16,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,
605,0,0,12,0,0,13,966,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
632,0,0,13,1391,0,9,1120,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
659,0,0,13,0,0,13,1134,0,0,65,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
...
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,
934,0,0,25,219,0,4,1286,0,0,4,2,0,1,0,2,3,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
965,0,0,26,127,0,5,1302,0,0,1,1,0,1,0,1,9,0,0,
984,0,0,27,219,0,4,1319,0,0,4,2,0,1,0,2,3,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
1015,0,0,28,127,0,5,1335,0,0,1,1,0,1,0,1,9,0,0,
1034,0,0,14,166,0,9,1351,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1057,0,0,14,0,0,13,1360,0,0,1,0,0,1,0,2,9,0,0,
1076,0,0,15,298,0,9,1375,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
1103,0,0,15,0,0,13,1386,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
1126,0,0,16,278,0,9,1401,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1149,0,0,16,0,0,13,1422,0,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,
1192,0,0,16,278,0,9,1447,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1215,0,0,16,0,0,13,1470,0,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,
1258,0,0,17,228,0,9,1493,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1281,0,0,17,0,0,13,1505,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,
1312,0,0,18,217,0,9,1530,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
1335,0,0,18,0,0,13,1543,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
1362,0,0,29,304,0,3,1566,0,0,13,13,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1429,0,0,30,69,0,4,1609,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
1452,0,0,31,190,0,5,1635,0,0,4,4,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,9,0,0,
1483,0,0,32,1120,0,3,1652,0,0,42,42,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,9,0,0,1,9,
...
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1666,0,0,33,479,0,3,1762,0,0,20,20,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1761,0,0,34,74,0,4,1817,0,0,2,1,0,1,0,2,4,0,0,1,9,0,0,
1784,0,0,35,190,0,5,1842,0,0,4,4,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,9,0,0,
1815,0,0,36,298,0,3,1858,0,0,10,10,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,9,0,0,1,4,0,
0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1870,0,0,37,772,0,3,1900,0,0,35,35,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,3,0,0,1,9,0,
...
1,9,0,0,
2025,0,0,38,502,0,3,1986,0,0,21,21,0,1,0,1,9,0,0,1,3,0,0,1,9,0,0,1,3,0,0,1,9,0,
...
2124,0,0,39,338,0,5,2047,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
2175,0,0,40,237,0,5,2065,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,
2214,0,0,41,254,0,5,2080,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,
2257,0,0,42,493,0,5,2096,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
2308,0,0,43,165,0,5,2120,0,0,0,0,0,1,0,
2323,0,0,44,0,0,27,2139,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
};
...
/* OCS MEDICOM VER 1.0                                                   */
/************************************************************************/
/* PROGRAM NAME          : ARBBLCON.PC                                  */
/* AUTHOR                : K.S.MUTHU                                    */
/* DATE WRITTEN          : 24-MAR-2004                                  */
/*                                                                      */  
/* CALLED FROM           :                                              */
/*                                                                      */
/*  FUNCTION             :                                              */
...
struct { unsigned short len; unsigned char arr[12]; } nd_cn_date;
...
struct { unsigned short len; unsigned char arr[3]; } nd_input_facility;
...
struct { unsigned short len; unsigned char arr[12]; } nd_new_doc_type_code;
...
struct { unsigned short len; unsigned char arr[12]; } ar_rec_main_acc2_code;
...
int argc;
{
    ...
    {
     int i = 0; 
       disp_message(ERR_MESG,"USAGE : ARBBLCON USER/PWD@DB SESSION PGM_DATE FACILITY PGM_ID");
       proc_exit();
    }
...

{
 ...
 sqlstm.stmt = "select install_yn into :b0  from sm_module where (module_id \
in ('GL','XF') and install_yn='Y')";
    ...
    nd_acc_entity_code.len = strlen(nd_acc_entity_code.arr);
       ...
       if(strcmp(bl_h_prev_cust_code.arr, bl_h_cust_code.arr)) 
	   {
			...
			if (nd_doc_num_gen_flag.arr[0] == 'Y')
			  {
				if (nd_sum_outst_amt > 0)			   
			   		gen_doc_num();
                if (nd_sum_outst_amt < 0) 
					if (strcmp(d_curr_pgm_id.arr,"ARTGNINV") != 0)
						gen_cn_doc_num();
			  }
...
{    
   ...
   /* EXEC SQL SELECT PARAM1, PARAM2, 
	      ...
	      INTO :nd_billing_grp,      :nd_cust_code,
		   ...
		   :nd_to_cust,          :nd_input_facility ,
		   :nd_cn_doc_type_code, :nd_cn_start_doc_num,:nd_cn_date
	     FROM SY_PROG_PARAM
...
AM7 ,PARAM8 ,PARAM9 ,PARAM10 ,PARAM11 ,PARAM12 ,PARAM13 ,PARAM14 ,PARAM15 ,NVL\
(PARAM16,'N') ,PARAM17 ,PARAM18 ,PARAM19 ,PARAM20 ,PARAM21 ,PARAM22 ,PARAM23 ,\
PARAM24 ,PARAM25 into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,:\
b13,:b14,:b15,:b16,:b17,:b18,:b19,:b20,:b21,:b22,:b23,:b24  from SY_PROG_PARAM\
 where (((PGM_ID=:b25 and SESSION_ID=:b26) and PGM_DATE=:b27) and OPERATING_FA\
CILITY_ID=:b28)";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqhstv[21] = (         void  *)&nd_input_facility;
   ...
   sqlstm.sqhstv[22] = (         void  *)&nd_cn_doc_type_code;
   ...
   sqlstm.sqhstv[23] = (         void  *)&nd_cn_start_doc_num;
   ...
   sqlstm.sqhstv[24] = (         void  *)&nd_cn_date;
   ...
   sqlstm.sqhstv[25] = (         void  *)&d_curr_pgm_id;
   ...
   sqlstm.sqhstv[28] = (         void  *)&nd_facility_id;
   ...
   nd_cn_date.arr[nd_cn_date.len]                     = '\0';
   ...
   nd_input_facility.arr[nd_input_facility.len]		  = '\0';
...
declare_cur() 
{
     /* EXEC SQL DECLARE BL_HDR_CUR CURSOR FOR
		...
		WHERE 
			  ...
			  AND ( ((
			         (DOC_TYPE_CODE||LPAD(DOC_NUM,8,0))  BETWEEN
			  ...
			  AND (:nd_input_facility = 'A' OR
			       OPERATING_FACILITY_ID = :nd_input_facility)
		      AND :d_curr_pgm_id = 'ARBBLCON')
		      OR		   
		      ((DOC_TYPE_CODE,DOC_NUM) IN 
				(SELECT DOC_TYPE_CODE,doc_number FROM AR_INV_PROCESS_TEMP
...
*/
     ...
     /* EXEC SQL DECLARE BL_BILL_TYPE_CUR CURSOR FOR       
	   SELECT BL_RECV_ACC_INT_CODE, 
		...
		WHERE BILL_TYPE_CODE = :nd_bill_type
		  AND ACC_ENTITY_CODE IN ( SELECT ACC_ENTITY_CODE FROM SY_ACC_ENTITY
			                        WHERE ACC_ENTITY_ID = :nd_facility_id )
          And TO_DATE(:nd_inv_date,'DD/MM/YYYY') between nvl(EFF_FROM_DATE,sysdate)  and nvl(EFF_TO_DATE,sysdate) ; */ 
     ...
     /* EXEC SQL DECLARE AR_CUSTOMER_CUR CURSOR FOR
	       SELECT PMNT_TERMS_CODE, GL_MAIN_ACC1_CODE,
	       		  GL_MAIN_ACC2_CODE,NVL(CREDIT_LIMIT_AMT,0)
		 FROM AR_CUSTOMER
   ...
   /* EXEC SQL DECLARE SY_ACC_ENTITY_CN_DOC_TYPE_CUR CURSOR FOR
	     SELECT NVL(STATUS,'X'),
		    'Y',  --NVL(AR_VALID_FLAG,'X'),
		    NVL(DOC_NUM_GEN_FLAG,'X')
	       FROM SY_ACC_ENTITY_DOC_TYPE
	      WHERE DOC_TYPE_CODE   = :nd_cn_doc_type_code
		AND ACC_ENTITY_CODE IN ( SELECT ACC_ENTITY_CODE FROM SY_ACC_ENTITY
					   WHERE ACC_ENTITY_ID = :nd_facility_id ); */ 
   ...
   /* EXEC SQL DECLARE AR_TRN_DOC_TYPE_CUR CURSOR FOR
	     SELECT 'X'
	      ...
	      WHERE OPERATING_FACILITY_ID = :nd_facility_id /oSATHISH ADDED FOR GDOH-CRF-0107 ON 02-02-2017o/
		AND DOC_TYPE_CODE = :nd_inv_doc_type_code
		AND TRN_TYPE_CODE = '1'
		AND ACC_ENTITY_CODE IN ( SELECT ACC_ENTITY_CODE FROM SY_ACC_ENTITY
					   WHERE ACC_ENTITY_ID = :nd_facility_id ); */ 


   /* EXEC SQL DECLARE AR_CN_TRN_DOC_TYPE_CUR CURSOR FOR
	     SELECT 'X'
	       FROM AR_TRN_DOC_TYPE
	      WHERE OPERATING_FACILITY_ID = :nd_facility_id /oSATHISH ADDED FOR GDOH-CRF-0107 ON 02-02-2017o/
		AND DOC_TYPE_CODE = :nd_cn_doc_type_code
		AND TRN_TYPE_CODE = '3'
		AND ACC_ENTITY_CODE IN ( SELECT ACC_ENTITY_CODE FROM SY_ACC_ENTITY
					   WHERE ACC_ENTITY_ID = :nd_facility_id ); */ 
...
val_doc_type()
{
     //Invoice document type validation
...

{
   ...
   else
   {
      if (d_acc_valid_flag.arr[0] != 'Y') /* Doc Not valid for AP    */
	    err_mesg("Document Type not valid for AR - INV module",0,"");
...

{
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (         void  *)&nd_inv_doc_type_code;
...

{
   ...
   if (strcmp(d_curr_pgm_id.arr,"ARTGNINV") != 0)
    {  
		// Credit Note Doc Type Validation   		

		/* EXEC SQL OPEN SY_ACC_ENTITY_CN_DOC_TYPE_CUR; */ 

{
  ...
  sqlstm.sqlety = (unsigned short)256;
  sqlstm.occurs = (unsigned int  )0;
  sqlstm.sqhstv[0] = (         void  *)&nd_cn_doc_type_code;
  sqlstm.sqhstl[0] = (unsigned int  )9;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)0;
  sqlstm.sqinds[0] = (         int  )0;
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
		...
		if (OERROR)
			err_mesg("OPEN failed on cursor SY_ACC_ENTITY_CN_DOC_TYPE_CUR",0,"");
		...
		/* EXEC SQL FETCH SY_ACC_ENTITY_CN_DOC_TYPE_CUR
				 INTO :d_acc_status,
				  :d_acc_valid_flag,
				  :nd_doc_num_gen_flag; */ 

{
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
		...
		if (OERROR)
			err_mesg("FETCH failed on cursor SY_ACC_ENTITY_CN_DOC_TYPE_CUR",0,""); 

		d_acc_status.arr[d_acc_status.len]				  = '\0';
		d_acc_valid_flag.arr[d_acc_valid_flag.len]		  = '\0';
		nd_doc_num_gen_flag.arr[nd_doc_num_gen_flag.len]   = '\0';

		if (NOT_FOUND)      /* Doc type not existing in SY_ACC_ENTITY_CN_DOC_TYPE */
			err_mesg("",1,"SY2200");
		else
		 {
			if (d_acc_valid_flag.arr[0] != 'Y') /* Doc Not valid for AR    */
				err_mesg("Document Type not valid for AR - CN module",0,"");
			if (d_acc_status.arr[0] == 'S')     /* Doc is suspended        */
				err_mesg("",1,"SY2190");
		 }    

		/* EXEC SQL OPEN AR_CN_TRN_DOC_TYPE_CUR; */ 

{
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)&nd_cn_doc_type_code;
  sqlstm.sqhstl[1] = (unsigned int  )9;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         void  *)0;
  sqlstm.sqinds[1] = (         int  )0;
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
		...
		if (OERROR)
			err_mesg("OPEN failed on cursor AR_CN_TRN_DOC_TYPE_CUR",0,"");

		/* EXEC SQL FETCH AR_CN_TRN_DOC_TYPE_CUR
				  INTO :l_dummy; */ 

{
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
		...
		if (OERROR)
			err_mesg("FETCH failed on cursor AR_CN_TRN_DOC_TYPE_CUR",0,"");
...

{
     ...
     sqlstm.sqadto[7] = (unsigned short )0;
     sqlstm.sqtdso[7] = (unsigned short )0;
     sqlstm.sqhstv[8] = (         void  *)&nd_input_facility;
     ...
     sqlstm.sqadto[8] = (unsigned short )0;
     sqlstm.sqtdso[8] = (unsigned short )0;
     sqlstm.sqhstv[9] = (         void  *)&nd_input_facility;
     ...
     sqlstm.sqadto[12] = (unsigned short )0;
     sqlstm.sqtdso[12] = (unsigned short )0;
     sqlstm.sqhstv[13] = (         void  *)&d_curr_pgm_id;
...
gen_cn_doc_num()
{
     ...
     nd_cn_start_doc_num = 0;

     /* EXEC SQL SELECT NVL(NEXT_DOC_NO,0), ROWID
				INTO :nd_cn_start_doc_num, :d_sy_acc_rowid
				FROM SY_ACC_ENTITY_DOC_TYPE
			   WHERE DOC_TYPE_CODE = :nd_cn_doc_type_code
				 AND ACC_ENTITY_CODE IN ( SELECT ACC_ENTITY_CODE FROM SY_ACC_ENTITY
		     							   WHERE ACC_ENTITY_ID = :nd_facility_id)
...
DOC_NO ";
     ...
     sqlstm.sqlety = (unsigned short)256;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (         void  *)&nd_cn_start_doc_num;
     sqlstm.sqhstl[0] = (unsigned int  )sizeof(long);
     sqlstm.sqhsts[0] = (         int  )0;
     sqlstm.sqindv[0] = (         void  *)0;
     sqlstm.sqinds[0] = (         int  )0;
     ...
     sqlstm.sqadto[1] = (unsigned short )0;
     sqlstm.sqtdso[1] = (unsigned short )0;
     sqlstm.sqhstv[2] = (         void  *)&nd_cn_doc_type_code;
     sqlstm.sqhstl[2] = (unsigned int  )9;
     sqlstm.sqhsts[2] = (         int  )0;
     sqlstm.sqindv[2] = (         void  *)0;
     sqlstm.sqinds[2] = (         int  )0;
...

{
     ...
     /* EXEC SQL FETCH AR_CUSTOMER_CUR
	       INTO :bl_cust_pmnt_terms_code, 
                    :p_gl_acc1_code,
		    :p_gl_acc2_code,:bl_cust_credit_limit; */ 

{
     ...
     sqlstm.sqadto[2] = (unsigned short )0;
     sqlstm.sqtdso[2] = (unsigned short )0;
     sqlstm.sqhstv[3] = (         void  *)&bl_cust_credit_limit;
...
insert_ar_patient()
{
     ...
     /* EXEC SQL INSERT INTO AR_PATIENT_DTLS
		 ...
		 AMOUNT,
		 PEND_AMOUNT,
		 OPERATING_FACILITY_ID /oSATHISH ADDED FOR GDOH-CRF-0107 ON 02-02-2017o/
	       )
	     VALUES
	       (
		 ...
		 :nd_facility_id /oSATHISH ADDED FOR GDOH-CRF-0107 ON 02-02-2017o/
	       ); */ 
...
G_GROUP,REMARKS,AMOUNT,PEND_AMOUNT,OPERATING_FACILITY_ID) values (:b0,:b1,:b2,\
SUBSTR(:b3,1,30),:b4,:b5,TO_DATE(:b6,'DD/MM/YYYY'),:b7,:b8,:b9,NVL(:b10,0),NVL\
(:b10,0),:b12)";
     sqlstm.iters = (unsigned int  )1;
...
*/
     ...
     /* EXEC SQL UPDATE BL_BILL_HDR
	               SET AR_INV_DOC_TYPE_CODE = :nd_new_doc_type_code,
		               AR_INV_DOC_NUMBER    = :nd_inv_start_doc_num,
		               AR_INV_DOC_DATE      = TO_DATE(NVL(:nd_inv_date,:bl_h_doc_date),'DD/MM/YYYY')
                 WHERE AR_INV_DOC_TYPE_CODE = 'XXXXXX'
				   AND AR_INV_DOC_NUMBER    = 99999999 ; */ 

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "update BL_BILL_HDR  set AR_INV_DOC_TYPE_CODE=:b0,AR_INV_\
DOC_NUMBER=:b1,AR_INV_DOC_DATE=TO_DATE(NVL(:b2,:b3),'DD/MM/YYYY') where (AR_IN\
V_DOC_TYPE_CODE='XXXXXX' and AR_INV_DOC_NUMBER=99999999)";
     sqlstm.iters = (unsigned int  )1;
	...
	disp_message(ORA_MESG,"Check The doc num - (Max is 8 digits)");
     ...
     if (OERROR)
	 err_mesg("UPDATE failed on table BL_BILL_HDR - UPDATE",0,"");
...
SER,SYSDATE,SYSDATE,:b38,:b39,:b40,:b41)";
     ...
     sqlstm.sqhstl[34] = (unsigned int  )14;
     sqlstm.sqhsts[34] = (         int  )0;
     sqlstm.sqindv[34] = (         void  *)0;
     sqlstm.sqinds[34] = (         int  )0;
     sqlstm.sqharm[34] = (unsigned int  )0;
...
_NEW,PRODUCT_GROUP_CODE_NEW,PRODUCT_LINE_CODE_NEW,ACC_ENTITY_CODE,OPERATING_FA\
CILITY_ID) values (:b0,:b1,1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,NVL(:b9,0),:b10,:b2,:\
b3,:b4,:b5,:b6,:b7,:b8,:b18,:b19)";
     sqlstm.iters = (unsigned int  )1;
...

{
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (         void  *)&bl_h_prev_cust_code;
 sqlstm.sqhstl[1] = (unsigned int  )11;
 sqlstm.sqhsts[1] = (         int  )0;
 sqlstm.sqindv[1] = (         void  *)0;
 sqlstm.sqinds[1] = (         int  )0;
 ...
 sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
    ...
    if ((nd_ar_outstand_amt > bl_cust_credit_limit ) && (bl_cust_credit_limit > 0))
	   {
	   sprintf(credit_warn,"%s %s","Outstanding Amount exceeding the Credit Limit for" ,bl_h_prev_cust_code.arr);
...
insert_cn_rec() 
{
    strcpy(nd_new_doc_type_code.arr,nd_cn_doc_type_code.arr);
    nd_new_doc_type_code.len  = strlen(nd_new_doc_type_code.arr);

     
    /* EXEC SQL UPDATE BL_BILL_HDR
	            SET AR_INV_DOC_TYPE_CODE = :nd_new_doc_type_code,
	                AR_INV_DOC_NUMBER    = :nd_cn_start_doc_num,
		            AR_INV_DOC_DATE      = TO_DATE(NVL(:nd_cn_date,:bl_h_doc_date),'DD/MM/YYYY')
              WHERE AR_INV_DOC_TYPE_CODE = 'XXXXXX'
			    AND AR_INV_DOC_NUMBER    = 99999999 ; */ 

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update BL_BILL_HDR  set AR_INV_DOC_TYPE_CODE=:b0,AR_INV_D\
OC_NUMBER=:b1,AR_INV_DOC_DATE=TO_DATE(NVL(:b2,:b3),'DD/MM/YYYY') where (AR_INV\
_DOC_TYPE_CODE='XXXXXX' and AR_INV_DOC_NUMBER=99999999)";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (         void  *)&nd_cn_start_doc_num;
    sqlstm.sqhstl[1] = (unsigned int  )sizeof(long);
    sqlstm.sqhsts[1] = (         int  )0;
    sqlstm.sqindv[1] = (         void  *)0;
    sqlstm.sqinds[1] = (         int  )0;
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (         void  *)&nd_cn_date;
    sqlstm.sqhstl[2] = (unsigned int  )14;
    sqlstm.sqhsts[2] = (         int  )0;
    sqlstm.sqindv[2] = (         void  *)0;
    sqlstm.sqinds[2] = (         int  )0;
...
C_DATE,DOC_AMT,POST_MONTH,POST_YEAR,MODULE_ID,ADDED_BY_ID,MODIFIED_BY_ID,ADDED\
_DATE,MODIFIED_DATE,ACC_ENTITY_CODE,OPERATING_FACILITY_ID) values (:b0,:b1,:b2\
,TO_DATE(:b3,'DD/MM/YYYY'),(:b4* (-1)),:b5,:b6,:b7,USER,USER,SYSDATE,SYSDATE,:\
b8,:b9)";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqadto[2] = (unsigned short )0;
    sqlstm.sqtdso[2] = (unsigned short )0;
    sqlstm.sqhstv[3] = (         void  *)&nd_cn_date;
    sqlstm.sqhstl[3] = (unsigned int  )14;
    sqlstm.sqhsts[3] = (         int  )0;
    sqlstm.sqindv[3] = (         void  *)0;
    sqlstm.sqinds[3] = (         int  )0;
    ...
    sqlstm.sqadto[3] = (unsigned short )0;
    sqlstm.sqtdso[3] = (unsigned short )0;
    sqlstm.sqhstv[4] = (         void  *)&nd_sum_outst_amt;
    ...
    sqlstm.sqadto[6] = (unsigned short )0;
    sqlstm.sqtdso[6] = (unsigned short )0;
    sqlstm.sqhstv[7] = (         void  *)&nd_module_id;
    sqlstm.sqhstl[7] = (unsigned int  )5;
    sqlstm.sqhsts[7] = (         int  )0;
    sqlstm.sqindv[7] = (         void  *)0;
    sqlstm.sqinds[7] = (         int  )0;
...
ISIT_ID,ACC_ENTITY_CODE,OPERATING_FACILITY_ID) values (:b0,:b1,:b0,:b1,1,:b4,(\
:b5* (-1)),:b6,:b7,:b8,:b9,:b10,:b11,:b12,:b13,:b14,:b15,:b7,:b8,:b9,:b10,:b11\
,:b12,:b13,:b23,:b24,:b25,:b26,TO_DATE(:b27,'DD/MM/YYYY'),:b28,:b29,:b30,:b31,\
:b32,:b33,:b34)";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqadto[2] = (unsigned short )0;
      sqlstm.sqtdso[2] = (unsigned short )0;
      sqlstm.sqhstv[3] = (         void  *)&nd_cn_start_doc_num;
      ...
      sqlstm.sqadto[3] = (unsigned short )0;
      sqlstm.sqtdso[3] = (unsigned short )0;
      sqlstm.sqhstv[4] = (         void  *)&bl_h_prev_cust_code;
      sqlstm.sqhstl[4] = (unsigned int  )11;
      sqlstm.sqhsts[4] = (         int  )0;
      sqlstm.sqindv[4] = (         void  *)0;
      sqlstm.sqinds[4] = (         int  )0;
      ...
      sqlstm.sqadto[4] = (unsigned short )0;
      sqlstm.sqtdso[4] = (unsigned short )0;
      sqlstm.sqhstv[5] = (         void  *)&nd_sum_outst_amt;
      ...
      sqlstm.sqadto[5] = (unsigned short )0;
      sqlstm.sqtdso[5] = (unsigned short )0;
      sqlstm.sqhstv[6] = (         void  *)&nd_credit_ref;
      ...
      sqlstm.sqadto[22] = (unsigned short )0;
      sqlstm.sqtdso[22] = (unsigned short )0;
      sqlstm.sqhstv[23] = (         void  *)&nd_st_patient_id;
      ...
      sqlstm.sqadto[24] = (unsigned short )0;
      sqlstm.sqtdso[24] = (unsigned short )0;
      sqlstm.sqhstv[25] = (         void  *)&nd_st_doc_type_code;
      ...
      sqlstm.sqadto[25] = (unsigned short )0;
      sqlstm.sqtdso[25] = (unsigned short )0;
      sqlstm.sqhstv[26] = (         void  *)&nd_st_doc_num;
      ...
      sqlstm.sqadto[26] = (unsigned short )0;
      sqlstm.sqtdso[26] = (unsigned short )0;
      sqlstm.sqhstv[27] = (         void  *)&nd_cn_date;
      sqlstm.sqhstl[27] = (unsigned int  )14;
      sqlstm.sqhsts[27] = (         int  )0;
      sqlstm.sqindv[27] = (         void  *)0;
      sqlstm.sqinds[27] = (         int  )0;
      sqlstm.sqharm[27] = (unsigned int  )0;
      sqlstm.sqadto[27] = (unsigned short )0;
      sqlstm.sqtdso[27] = (unsigned short )0;
      sqlstm.sqhstv[28] = (         void  *)&nd_sum_drfee_amt;
      ...
      sqlstm.sqadto[28] = (unsigned short )0;
      sqlstm.sqtdso[28] = (unsigned short )0;
      sqlstm.sqhstv[29] = (         void  *)&nd_bill_type;
...
CODE,OPERATING_FACILITY_ID) values (:b0,:b1,:b0,:b1,1,:b4,:b5,:b6,:b7,:b8,:b9,\
:b10,(:b11* (-1)),:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b19,:b20)";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqadto[10] = (unsigned short )0;
      sqlstm.sqtdso[10] = (unsigned short )0;
      sqlstm.sqhstv[11] = (         void  *)&nd_sum_outst_amt;
      ...
      sqlstm.sqhstl[16] = (unsigned int  )14;
      sqlstm.sqhsts[16] = (         int  )0;
      sqlstm.sqindv[16] = (         void  *)0;
      sqlstm.sqinds[16] = (         int  )0;
      sqlstm.sqharm[16] = (unsigned int  )0;
...
:b1,MODIFIED_FACILITY_ID=:b2 where ((EPISODE_TYPE=:b3 and EPISODE_ID=:b4) and \
OPERATING_FACILITY_ID=:b5)";
      sqlstm.iters = (unsigned int  )1;
...
,MODIFIED_FACILITY_ID=:b2 where (((EPISODE_TYPE=:b3 and EPISODE_ID=:b4) and VI\
SIT_ID=:b5) and OPERATING_FACILITY_ID=:b6)";
     sqlstm.iters = (unsigned int  )1;
   ...
   /* EXEC SQL UPDATE BL_BILL_HDR
	       SET BILL_STATUS = 'A',
		   AR_INV_DOC_TYPE_CODE = 'XXXXXX',
		   AR_INV_DOC_NUMBER    =  99999999,
		   AR_INV_DOC_DATE      = TO_DATE(NVL(:nd_inv_date,:bl_h_doc_date),'DD/MM/YYYY'),
...
DE='XXXXXX',AR_INV_DOC_NUMBER=99999999,AR_INV_DOC_DATE=TO_DATE(NVL(:b0,:b1),'D\
D/MM/YYYY'),BILL_TOT_OUTST_AMT=(NVL(BILL_TOT_OUTST_AMT,0)-:b2),AMT_TRANSFERRED\
=(nvl(AMT_TRANSFERRED,0)+:b2),CONS_INVOICE_IND='Y',BILL_HOSP_TOT_OUTST_AMT=(NV\
L(BILL_HOSP_TOT_OUTST_AMT,0)-:b4),BILL_DRFEE_TOT_OUTST_AMT=(NVL(BILL_DRFEE_TOT\
_OUTST_AMT,0)-:b5),MODIFIED_BY_ID=USER,MODIFIED_DATE=SYSDATE,MODIFIED_AT_WS_NO\
=:b6,MODIFIED_FACILITY_ID=:b7 where ROWID=:b8";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqlety = (unsigned short)256;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (         void  *)&nd_inv_date;
   sqlstm.sqhstl[0] = (unsigned int  )14;
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         void  *)0;
   sqlstm.sqinds[0] = (         int  )0;
   ...
   sqlstm.sqadto[3] = (unsigned short )0;
   sqlstm.sqtdso[3] = (unsigned short )0;
   sqlstm.sqhstv[4] = (         void  *)&bl_h_bill_hosp_tot_outst_amt;
   ...
   sqlstm.sqadto[4] = (unsigned short )0;
   sqlstm.sqtdso[4] = (unsigned short )0;
   sqlstm.sqhstv[5] = (         void  *)&bl_h_bill_drfee_tot_os_amt;
   sqlstm.sqhstl[5] = (unsigned int  )25;
   sqlstm.sqhsts[5] = (         int  )0;
   sqlstm.sqindv[5] = (         void  *)0;
   sqlstm.sqinds[5] = (         int  )0;
   ...
   sqlstm.sqadto[7] = (unsigned short )0;
   sqlstm.sqtdso[7] = (unsigned short )0;
   sqlstm.sqhstv[8] = (         void  *)&bl_h_rowid;
...
{
     /* EXEC SQL UPDATE BL_BILL_HDR
	               SET AR_INV_DOC_TYPE_CODE = null,
		               AR_INV_DOC_NUMBER    = null,
		               AR_INV_DOC_DATE      = null 
                 WHERE AR_INV_DOC_TYPE_CODE = 'XXXXXX'
				   AND AR_INV_DOC_NUMBER    = 99999999 ; */ 

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "update BL_BILL_HDR  set AR_INV_DOC_TYPE_CODE=null ,AR_IN\
V_DOC_NUMBER=null ,AR_INV_DOC_DATE=null  where (AR_INV_DOC_TYPE_CODE='XXXXXX' \
and AR_INV_DOC_NUMBER=99999999)";
     sqlstm.iters = (unsigned int  )1;
