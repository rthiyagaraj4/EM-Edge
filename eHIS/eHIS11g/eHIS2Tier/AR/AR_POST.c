...
{
    23,
    "D:\\test\\PROC\\AR_POST.PC"
};


static unsigned long sqlctx = 587457227;
...
OC_DTLS where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:\
b2) order by DOC_TYPE_CODE,DOC_NUM            ";
...
ED_INV_YN  from AR_DN_INV_HDR where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_C\
ODE=:b1) and DOC_NUM=:b2)           ";
...
NVL(DEPT_CODE,' ') ,NVL(PRODUCT_GROUP_CODE,' ') ,NVL(PRODUCT_LINE_CODE,' ') ,N\
VL(POST_MONTH,0) ,NVL(POST_YEAR,0) ,NVL(BILL_TYPE_CODE,' ') ,ROWID ,CONSOLIDAT\
ED_INV_YN  from AR_CN_INV_HDR where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_C\
ODE=:b1) and DOC_NUM=:b2)           ";
...
DE,' ') ,CONSOLIDATED_INV_YN  from AR_ADJ_INV_HDR where ((OPERATING_FACILITY_I\
D=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2)           ";
...
ATION,' ') ,ROWID  from AR_DN_LINE where ((((OPERATING_FACILITY_ID=:b0 and DOC\
_TYPE_CODE=:b1) and DOC_NUM=:b2) and ORG_DOC_TYPE_CODE=:b3) and ORG_DOC_NUM=:b\
4)           ";
...
UBLEDGER_GROUP_CODE,' ') ,NVL(SUBLEDGER_LINE_CODE,' ') ,NVL(DEPT_CODE,' ') ,NV\
L(PRODUCT_GROUP_CODE,' ') ,NVL(PRODUCT_LINE_CODE,' ') ,NVL(AMOUNT,0) ,NVL(NARR\
ATION,' ') ,ROWID  from AR_CN_LINE where ((((OPERATING_FACILITY_ID=:b0 and DOC\
_TYPE_CODE=:b1) and DOC_NUM=:b2) and ORG_DOC_TYPE_CODE=:b3) and ORG_DOC_NUM=:b\
4)           ";
...
UBLEDGER_GROUP_CODE,' ') ,NVL(SUBLEDGER_LINE_CODE,' ') ,NVL(DEPT_CODE,' ') ,NV\
L(PRODUCT_GROUP_CODE,' ') ,NVL(PRODUCT_LINE_CODE,' ') ,NVL(AMOUNT,0) ,NVL(NARR\
ATION,' ') ,ROWID  from AR_ADJ_LINE where ((((OPERATING_FACILITY_ID=:b0 and DO\
C_TYPE_CODE=:b1) and DOC_NUM=:b2) and ORG_DOC_TYPE_CODE=:b3) and ORG_DOC_NUM=:\
b4)           ";
...
{10,4274,0,0,0,
5,0,0,1,381,0,3,195,0,0,16,16,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,1,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
1,9,0,0,
84,0,0,2,381,0,3,250,0,0,16,16,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,1,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
1,9,0,0,
163,0,0,3,469,0,3,301,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
214,0,0,4,130,0,5,369,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
237,0,0,5,130,0,5,382,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
260,0,0,6,131,0,5,395,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
283,0,0,13,278,0,9,668,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
310,0,0,13,0,0,13,695,0,0,9,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,
361,0,0,14,1493,0,3,747,0,0,59,59,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
...
0,0,1,9,0,0,1,9,0,0,1,1,0,0,1,9,0,0,1,9,0,0,
612,0,0,15,234,0,5,885,0,0,6,6,0,1,0,1,1,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
651,0,0,16,155,0,4,898,0,0,5,4,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
686,0,0,17,179,0,5,921,0,0,6,6,0,1,0,1,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
725,0,0,18,362,0,3,944,0,0,17,17,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,1,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,1,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,
808,0,0,19,132,0,5,990,0,0,4,4,0,1,0,1,1,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
839,0,0,20,293,0,3,1013,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,
882,0,0,21,132,0,5,1053,0,0,4,4,0,1,0,1,1,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
913,0,0,7,970,0,9,1072,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
940,0,0,9,970,0,9,1079,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
967,0,0,11,1468,0,9,1086,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
994,0,0,8,479,0,9,1099,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1029,0,0,10,479,0,9,1106,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1064,0,0,12,480,0,9,1113,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1099,0,0,22,870,0,4,1184,0,0,27,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
...
1222,0,0,23,870,0,4,1252,0,0,27,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,1,9,0,0,
1345,0,0,24,284,0,4,1317,0,0,11,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
1404,0,0,7,0,0,13,1466,0,0,38,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1571,0,0,9,0,0,13,1511,0,0,38,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1738,0,0,11,0,0,13,1589,0,0,54,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,
1969,0,0,8,0,0,13,1752,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,
2048,0,0,10,0,0,13,1775,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,
2127,0,0,12,0,0,13,1798,0,0,16,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[11]; } l_ar_ihdr_dept_code;
...
struct { unsigned short len; unsigned char arr[11]; } l_ar_line_dept_code;
...
dn_post_declare_curs()
{
   /* EXEC SQL DECLARE DN_POST_INV_HDR CURSOR FOR
             SELECT NVL(ACC_ENTITY_CODE,' '),
					...
					CONSOLIDATED_INV_YN
              FROM  AR_DN_INV_HDR
              WHERE  OPERATING_FACILITY_ID=:l_facility_id   /oAdded by madhusudhan for GDOH-CRF-0107o/
     ...
     l_trn_type;
{
 ...
 /* EXEC SQL INSERT INTO AR_PENDING_DOC
        (
		 ...
		 MODIFIED_BY_ID,
		 MODIFIED_DATE,
		 OPERATING_FACILITY_ID   /oAdded by madhusudhan for GDOH-CRF-0107o/
...
RN_TYPE_CODE,LAST_UPD_DATE,BILL_TYPE_CODE,ADDED_BY_ID,ADDED_DATE,MODIFIED_BY\
_ID,MODIFIED_DATE,OPERATING_FACILITY_ID) values (:b0,:b1,:b2,1,:b3,TO_DATE(:\
b4,'DD/MM/YYYY'),:b5,TO_DATE(:b6,'DD/MM/");
 sqlstm.stmt = "YYYY'),TO_DATE(:b7,'DD/MM/YYYY'),decode(:b8,'D',:b9,((-1)* :\
b10)),decode(:b8,'D',:b12,((-1)* :b10)),decode(:b8,'D',:b15,0),decode(:b8,'D',\
:b10,((-1)* :b10)),0,:b19,:b20,:b21,TO_DATE(:b22,'DD/MM/YYYY'),:b23,:b24,:b25,\
:b26,:b27,TO_DATE(:b28,'DD/MM/YYYY'),:b29,:b30,:b31,:b32,:b33,:b34,:b35,:b36,:\
b37,:b38,:b39,:b40,:b41,:b42,:b43,:b44,:b45,:b46,:b47,:b48,:b49,:b50,:b51,:b52\
,:b53,:b54,:b55,decode(:b56,'D','2','C','3','A','4'),SYSDATE,:b57,USER,SYSDATE\
,USER,SYSDATE,:b58)";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqhstv[58] = (         void  *)&l_facility_id;
 sqlstm.sqhstl[58] = (unsigned int  )5;
...
M,0)+1),LAST_UPD_DATE=SYSDATE where ((OPERATING_FACILITY_ID=:b3 and DOC_TYPE_C\
ODE=:b4) and DOC_NUM=:b5)";
        sqlstm.iters = (unsigned int  )1;
        ...
        sqlstm.sqadto[2] = (unsigned short )0;
        sqlstm.sqtdso[2] = (unsigned short )0;
        sqlstm.sqhstv[3] = (         void  *)&l_facility_id;
        ...
        sqlstm.sqadto[3] = (unsigned short )0;
        sqlstm.sqtdso[3] = (unsigned short )0;
        sqlstm.sqhstv[4] = (         void  *)&l_ar_ihdr_org_doc_type_code;
        sqlstm.sqhstl[4] = (unsigned int  )9;
        sqlstm.sqhsts[4] = (         int  )0;
        sqlstm.sqindv[4] = (         void  *)0;
        sqlstm.sqinds[4] = (         int  )0;
        ...
        sqlstm.sqadto[4] = (unsigned short )0;
        sqlstm.sqtdso[4] = (unsigned short )0;
        sqlstm.sqhstv[5] = (         void  *)&l_ar_ihdr_org_doc_num;
        sqlstm.sqhstl[5] = (unsigned int  )11;
        sqlstm.sqhsts[5] = (         int  )0;
        sqlstm.sqindv[5] = (         void  *)0;
        sqlstm.sqinds[5] = (         int  )0;
...
DING_DOC where (((OPERATING_FACILITY_ID=:b1 and CUST_CODE=:b2) and DOC_TYPE_CO\
DE=:b3) and DOC_NUM=:b4)";
        sqlstm.iters = (unsigned int  )1;
        ...
        sqlstm.sqadto[1] = (unsigned short )0;
        sqlstm.sqtdso[1] = (unsigned short )0;
        sqlstm.sqhstv[2] = (         void  *)&l_ar_ihdr_cust_code;
 ...
 /************************************************************************/
    if (strcmp(l_consolidated_yn.arr , "Y") == 0)
   {
	...
	while(fetch_alloc_pat_dtls())
	{
	  ...
	  WHERE OPERATING_FACILITY_ID=:l_facility_id   /oAdded by madhusudhan for GDOH-CRF-0107o/
      AND	DOC_TYPE_CODE      = :d_pat_inv_doc_type_code 
...
0) where ((((OPERATING_FACILITY_ID=:b1 and DOC_TYPE_CODE=:b2) and DOC_NUM=:b3)\
...
T,CUST_REF,TRN_TYPE_CODE,POST_MONTH,POST_YEAR,OPERATING_FACILITY_ID) values (:\
b0,:b1,:b2,:b3,:b4,:b5,:b6,to_date(:b7,'DD/MM/YYYY'),:b8,decode(:b9,'D',:b10,(\
(-1)* :b10)),:b12,decode(:b13,'D','2','C','3','A','4'),:b14,:b15,:b16)";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[15] = (unsigned short )0;
   sqlstm.sqtdso[15] = (unsigned short )0;
   sqlstm.sqhstv[16] = (         void  *)&l_facility_id;
...
{        
   ...
   /* EXEC SQL SELECT  DOC_TYPE_CODE,
                    ...
                    NVL(ERROR_FLAG,' '),
                    NVL(PRINT_FLAG,' '),
					nvl(OPERATING_FACILITY_ID,' ')   /oAdded by madhusudhan for GDOH-CRF-0107o/
             INTO   
                    :l_ar_hdr_doc_type_code,
                    :l_ar_hdr_doc_num,
                    :l_ar_hdr_acc_entity_code,
...
SE,' ') ,NVL(MISC_CUST_ADD2_DESC_CHINESE,' ') ,NVL(MISC_CUST_ADD3_DESC_CHINESE\
,' ') ,NVL(MISC_CUST_ZIP_DESC_CHINESE,' ') ,NVL(TEL_NUM,' ') ,NVL(CONTACT_NAME\
,' ') ,NVL(CONTACT_NAME_TITLE,' ') ,NVL(ERROR_FLAG,' ') ,NVL(PRINT_FLAG,' ') ,\
nvl(OPERATING_FACILITY_ID,' ') into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b\
10,:b11,:b12,:b13,:b14,:b15,:b16,:b17,:b18,:b19,:b20,:b21,:b22,:b23,:b24,:b25 \
 from AR_DN_HDR where ROWID=:b26";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[24] = (unsigned short )0;
   sqlstm.sqtdso[24] = (unsigned short )0;
   sqlstm.sqhstv[25] = (         void  *)&l_facility_id;
   ...
   sqlstm.sqadto[25] = (unsigned short )0;
   sqlstm.sqtdso[25] = (unsigned short )0;
   sqlstm.sqhstv[26] = (         void  *)&hdr_rowid_passed;
...
nvl(OPERATING_FACILITY_ID,' ') into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b\
10,:b11,:b12,:b13,:b14,:b15,:b16,:b17,:b18,:b19,:b20,:b21,:b22,:b23,:b24,:b25 \
 from AR_CN_HDR where ROWID=:b26";
   sqlstm.iters = (unsigned int  )1;
...
(ERROR_FLAG,' ') ,NVL(PRINT_FLAG,' ') ,nvl(OPERATING_FACILITY_ID,' ') into :b0\
,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9  from AR_ADJ_HDR where ROWID=:b10";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[8] = (unsigned short )0;
   sqlstm.sqtdso[8] = (unsigned short )0;
   sqlstm.sqhstv[9] = (         void  *)&l_facility_id;
   ...
   sqlstm.sqadto[9] = (unsigned short )0;
   sqlstm.sqtdso[9] = (unsigned short )0;
   sqlstm.sqhstv[10] = (         void  *)&hdr_rowid_passed;
   sqlstm.sqhstl[10] = (unsigned int  )33;
   sqlstm.sqhsts[10] = (         int  )0;
   sqlstm.sqindv[10] = (         void  *)0;
   sqlstm.sqinds[10] = (         int  )0;
...

{
      ...
      if (OERROR)
         err_mesg("FETCH failed on cursor CUR_CN_INV_HDR-AR POST",0,"");
  }
  else
  {
l_ar_hdr_misc_clong_name.arr[0]            = '\0';
