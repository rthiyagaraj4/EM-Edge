...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/AR/Arrconin.pc"
};


static unsigned int sqlctx = 1288485275;
...
{12,4274,178,0,0,
5,0,0,1,245,0,4,248,0,0,13,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
72,0,0,2,91,0,2,312,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
95,0,0,3,0,0,30,325,0,0,0,0,0,1,0,
110,0,0,4,181,0,4,344,0,0,7,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
3,0,0,1,9,0,0,
153,0,0,5,1039,0,9,441,0,0,8,8,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,
200,0,0,5,0,0,13,508,0,0,28,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,
327,0,0,6,516,0,9,574,0,0,1,1,0,1,0,1,9,0,0,
346,0,0,6,0,0,13,599,0,0,10,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,1,0,0,2,1,0,0,
401,0,0,7,71,0,9,662,0,0,1,1,0,1,0,1,9,0,0,
420,0,0,7,0,0,13,667,0,0,1,0,0,1,0,2,9,0,0,
439,0,0,0,0,0,27,894,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
470,0,0,9,118,0,4,985,0,0,3,1,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,
497,0,0,10,70,0,5,996,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[3]; } p_language_id;
   ...
   /* VARCHAR nd_facility_id   [3],
	   ...
	   d_misc_cust_zip_desc_chi    [31],
           ...
           /o Variables for Next Number Generation for the given doc type o/
           nd_acc_rowid                [31],
	   nd_next_num                 [9]; */ 
...
struct { unsigned short len; unsigned char arr[7]; } nd_cust_code;
...
struct { unsigned short len; unsigned char arr[7]; } nd_con_doc_type;

struct { unsigned short len; unsigned char arr[11]; } nd_con_date;
...
struct { unsigned short len; unsigned char arr[11]; } d_ar_inv_patient_id;

struct { unsigned short len; unsigned char arr[7]; } d_ar_inv_bill_doc_type;
...
struct { unsigned short len; unsigned char arr[12]; } d_ar_inv_bill_date;
...
struct { unsigned short len; unsigned char arr[101]; } d_ar_contact_name;

struct { unsigned short len; unsigned char arr[61]; } d_ar_contact_name_title;
...
struct { unsigned short len; unsigned char arr[101]; } d_misc_contact_name_title;

struct { unsigned short len; unsigned char arr[31]; } nd_acc_rowid;

struct { unsigned short len; unsigned char arr[9]; } nd_next_num;
...
struct { unsigned short len; unsigned char arr[100]; } temp_file_name;
...
b5,:b6,:b7,:b8,:b9,:b10  from SY_PROG_PARAM where ((PGM_ID='ARRCONIN' and SESS\
ION_ID=:b11) and PGM_DATE=:b12)";
   ...
   sqlstm.sqhstv[2] = (         void  *)&nd_fm_doc_type;
   ...
   sqlstm.sqhstv[8] = (         void  *)&nd_bill_type;
   ...
   sqlstm.sqhstv[9] = (         void  *)&nd_con_doc_type;
   ...
   sqlstm.sqhstv[10] = (         void  *)&nd_con_date;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "delete  from SY_PROG_PARAM  where ((PGM_ID='ARRCONIN' and \
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select ACC_ENTITY_NAME ,TO_CHAR(SYSDATE,'DD/MM/YYYY') ,BAS\
...
5  from SY_ACC_ENTITY where ACC_ENTITY_ID=:b6";
   ...
   sqlstm.sqadto[4] = (unsigned short )0;
   sqlstm.sqtdso[4] = (unsigned short )0;
   sqlstm.sqhstv[5] = (         void  *)&no_of_decimal;
...

{
    ...
    sqlstm.sqltdsp = &sqltds;
    sqlbuft((void **)0, 
      "select DOC_TYPE_CODE ,DOC_NUM ,TO_CHAR(DOC_DATE,'DD/MM/YYYY') ,CUST_C\
ODE ,PATIENT_ID ,BILL_DOC_TYPE_CODE ,BILL_NUM ,TO_CHAR(BILL_DATE,'DD/MM/YYYY\
') ,CUST_REF ,NARRATION ,NVL(GROSS_AMT,0) ,NVL(DISCOUNT_AMT,0) ,NVL(PAYABLE_\
AMT,0) ,MISC_CUST_LONG_NAME ,MISC_CUST_SHORT_NAME ,MISC_CUST_ADD1_DESC ,MISC\
_CUST_ADD2_DESC ,MISC_CUST_ADD3_DESC ,MISC_CUST_ZIP_DESC ,MISC_CUST_LONG_NAM\
E_CHINESE ,MISC_CUST_SHORT_NAME_CHINESE ,MISC_CUST_ADD1_DESC_CHINESE ,MISC_C\
UST_ADD2_DESC_CHINESE ,MISC_CUST_ADD3_DESC_CHINESE ,MISC_CUST_ZIP_DESC_CHINE\
SE ,CONTACT_NAME ,CONTACT_NAME_TITLE ,ROWID  from AR_PENDING_DOC where ((((C\
UST_CODE=:b0 and (RPAD(DOC_TYPE_CODE,6,' ')||LTRIM(TO_CHAR(DOC_NUM,'00000009\
'))) between (RPAD(NVL(:b1,'!!!!!!'),6)||NVL(:b2,'00000000')) and (RPAD(NVL(\
:b3,'~~~~~~'),6)||NVL(:b4,'99999999'))) and NVL(DOC_DATE,SYSDATE)>=NVL(TO_DA\
TE(:b5,'DD/MM/YYYY'),to_date('00010101','YYYYDDMM'))) and NVL(DOC_DATE,SYSDA\
TE)<=NVL(TO_DATE(:b6,'DD/MM/YYYY'),to_date('47123112','YYYYDDMM'))) and BILL\
_TYPE_CODE=:b7) order by DOC_TYPE_CODE,DOC_");
    sqlstm.stmt = sq0005;
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqadto[6] = (unsigned short )0;
    sqlstm.sqtdso[6] = (unsigned short )0;
    sqlstm.sqhstv[7] = (         void  *)&nd_bill_type;
...

{
    ...
    sqlstm.sqadto[4] = (unsigned short )0;
    sqlstm.sqtdso[4] = (unsigned short )0;
    sqlstm.sqhstv[5] = (         void  *)&d_ar_inv_bill_doc_type;
    ...
    sqlstm.sqadto[6] = (unsigned short )0;
    sqlstm.sqtdso[6] = (unsigned short )0;
    sqlstm.sqhstv[7] = (         void  *)&d_ar_inv_bill_date;
    ...
    sqlstm.sqadto[7] = (unsigned short )0;
    sqlstm.sqtdso[7] = (unsigned short )0;
    sqlstm.sqhstv[8] = (         void  *)&d_ar_inv_cust_ref;
    ...
    sqlstm.sqadto[8] = (unsigned short )0;
    sqlstm.sqtdso[8] = (unsigned short )0;
    sqlstm.sqhstv[9] = (         void  *)&d_ar_inv_narration;
    ...
    sqlstm.sqadto[9] = (unsigned short )0;
    sqlstm.sqtdso[9] = (unsigned short )0;
    sqlstm.sqhstv[10] = (         void  *)&d_ar_inv_gross_amt;
    ...
    sqlstm.sqadto[10] = (unsigned short )0;
    sqlstm.sqtdso[10] = (unsigned short )0;
    sqlstm.sqhstv[11] = (         void  *)&d_ar_inv_discount_amt;
    ...
    sqlstm.sqadto[11] = (unsigned short )0;
    sqlstm.sqtdso[11] = (unsigned short )0;
    sqlstm.sqhstv[12] = (         void  *)&d_ar_inv_payable_amt;
    ...
    sqlstm.sqhstv[26] = (         void  *)&d_misc_contact_name_title;
    ...
    sqlstm.sqhstv[27] = (         void  *)&d_ar_inv_rowid;
...

{
    ...
    sqlstm.sqadto[5] = (unsigned short )0;
    sqlstm.sqtdso[5] = (unsigned short )0;
    sqlstm.sqhstv[6] = (         void  *)&d_ar_contact_name;
    ...
    sqlstm.sqadto[6] = (unsigned short )0;
    sqlstm.sqtdso[6] = (unsigned short )0;
    sqlstm.sqhstv[7] = (         void  *)&d_ar_contact_name_title;
...

{
     ...
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqcmod = (unsigned int )0;
     sqlstm.sqhstv[0] = (         void  *)&d_ar_inv_patient_id;
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "select ROWID ,NEXT_DOC_NO into :b0,:b1  from SY_ACC_ENTI\
TY_DOC_TYPE where DOC_TYPE_CODE=:b2 for update of NEXT_DOC_NO ";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqlety = (unsigned short)4352;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (         void  *)&nd_acc_rowid;
     sqlstm.sqhstl[0] = (unsigned int  )33;
     sqlstm.sqhsts[0] = (         int  )0;
     sqlstm.sqindv[0] = (         void  *)0;
     sqlstm.sqinds[0] = (         int  )0;
     ...
     sqlstm.sqadto[0] = (unsigned short )0;
     sqlstm.sqtdso[0] = (unsigned short )0;
     sqlstm.sqhstv[1] = (         void  *)&nd_next_num;
     ...
     sqlstm.sqadto[1] = (unsigned short )0;
     sqlstm.sqtdso[1] = (unsigned short )0;
     sqlstm.sqhstv[2] = (         void  *)&nd_con_doc_type;
     sqlstm.sqhstl[2] = (unsigned int  )9;
     sqlstm.sqhsts[2] = (         int  )0;
     sqlstm.sqindv[2] = (         void  *)0;
     sqlstm.sqinds[2] = (         int  )0;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update SY_ACC_ENTITY_DOC_TYPE  set NEXT_DOC_NO=(:b0+1) wh\
ere ROWID=:b1";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (         void  *)&nd_next_num;
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (         void  *)&nd_acc_rowid;
