...
{
    54,
    "d:\\madhu\\billing\\madhu\\post adjustment\\11g\\arbadpst.pc"
};


static unsigned long sqlctx = 1150672619;
...
"select DOC_TYPE_CODE ,DOC_NUM  from AR_ADJ_HDR where (((((((OPERATING_FACILI\
...
_YN  from AR_ADJ_INV_HDR where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:\
b1) and DOC_NUM=:b2) for update of LAST_LINE_NUM nowait ";
...
ARRATION ,ROWID  from AR_ADJ_LINE where ((((OPERATING_FACILITY_ID=:b0 and DOC_\
TYPE_CODE=:b1) and DOC_NUM=:b2) and ORG_DOC_TYPE_CODE=:b3) and ORG_DOC_NUM=:b4\
...
R_ADJ_HDR where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM\
=:b2) for update of ERROR_FLAG nowait ";
...
{10,4274,0,0,0,
5,0,0,1,232,0,4,338,0,0,12,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,1,9,0,0,
68,0,0,2,97,0,4,355,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
91,0,0,3,0,0,29,494,0,0,0,0,0,1,0,
106,0,0,4,0,0,30,503,0,0,0,0,0,1,0,
121,0,0,5,0,0,30,520,0,0,0,0,0,1,0,
136,0,0,6,439,0,9,550,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
179,0,0,8,834,0,9,678,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
206,0,0,10,0,0,29,684,0,0,0,0,0,1,0,
221,0,0,9,420,0,9,702,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
256,0,0,11,0,0,29,708,0,0,0,0,0,1,0,
271,0,0,6,0,0,13,733,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
294,0,0,7,270,0,9,819,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
321,0,0,7,0,0,13,826,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
380,0,0,12,104,0,4,963,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
407,0,0,13,89,0,4,977,0,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
434,0,0,8,0,0,13,1257,0,0,45,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
9,0,0,
629,0,0,9,0,0,13,1428,0,0,17,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,
712,0,0,14,70,0,2,1538,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
735,0,0,15,71,0,2,1545,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
758,0,0,16,183,0,3,1649,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
809,0,0,17,183,0,3,1722,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
860,0,0,18,53,0,5,1757,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
883,0,0,19,60,0,2,1770,0,0,1,1,0,1,0,1,9,0,0,
902,0,0,20,0,0,29,1777,0,0,0,0,0,1,0,
917,0,0,21,0,0,27,1788,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
948,0,0,22,118,0,4,1804,0,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
979,0,0,23,62,0,6,1815,0,0,1,1,0,1,0,2,9,0,0,
998,0,0,24,44,0,4,1822,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1021,0,0,25,44,0,4,1826,0,0,2,1,0,1,0,1,9,0,0,2,3,0,0,
1044,0,0,26,84,0,4,1863,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
1067,0,0,27,140,0,4,1874,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1098,0,0,28,120,0,4,1987,0,0,4,3,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1129,0,0,29,117,0,4,1996,0,0,4,3,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
};
  ...
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
   ...
   disp_message(INFO_MESG,"Inside while...\n"); 
    ...
    disp_message(INFO_MESG,"Not Online GL interface\n");
		...
		ins_gl_distrbn(d_ad_hdr_doc_type_code.arr,d_ad_hdr_doc_num.arr,4,nd_facility_id.arr); /* added by madhu nd_facility_id.arr for gdoh-crf-0107*/
...
o/
               ...
               FROM AR_ADJ_HDR
              WHERE OPERATING_FACILITY_ID=:nd_facility_id    /oADDED BY MADHUSUDHAN FOR GDOH-CRF-0107o/
                AND DOC_TYPE_CODE = :d_ad_hdr_doc_type_code
...
validate_ar_header(
            ...
            'A',
			d_doc_nature.arr,
			nd_facility_id.arr /* added by madhu nd_facility_id.arr for gdoh-crf-0107*/
);
...
D) values (:b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8)";
 ...
 /*OPERATING_FACILITY_ID ADDED BY MADHU FOR GDOH-CRF-0107*/
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select count(*)  into :b0  from AR_ADJ_INV_HDR where ((OPERA\
TING_FACILITY_ID=:b1 and DOC_TYPE_CODE=:b2) and DOC_NUM=:b3)";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (         void  *)&d_ad_hdr_doc_type_code;
 sqlstm.sqhstl[2] = (unsigned int  )9;
 sqlstm.sqhsts[2] = (         int  )0;
 sqlstm.sqindv[2] = (         void  *)0;
 sqlstm.sqinds[2] = (         int  )0;
 ...
 sqlstm.sqadto[2] = (unsigned short )0;
 sqlstm.sqtdso[2] = (unsigned short )0;
 sqlstm.sqhstv[3] = (         void  *)&d_ad_hdr_doc_num;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select count(*)  into :b0  from AR_ADJ_LINE where ((OPERATIN\
G_FACILITY_ID=:b1 and DOC_TYPE_CODE=:b2) and DOC_NUM=:b3)";
 sqlstm.iters = (unsigned int  )1;
