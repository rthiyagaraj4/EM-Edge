...
{
    34,
    "D:\\BLTEST\\12x\\GDOH_CRF\\Arrinpt1.pc"
};


static unsigned long sqlctx = 230554525;
...
"_DATE(:b6,'DD/MM/YYYY'),to_date('47123112','YYYYDDMM'))) order by DOC_TYPE_C\
ODE,DOC_NUM            ";
...
DD/MM/YYYY') ,A.AMOUNT  from AR_PATIENT_DTLS A ,AR_INV_HDR B where ((((((A.OPE\
RATING_FACILITY_ID=B.OPERATING_FACILITY_ID and A.OPERATING_FACILITY_ID=:b0) an\
d A.DOC_TYPE_CODE=:b1) and A.DOC_NUM=:b2) and A.DOC_TYPE_CODE=B.DOC_TYPE_CODE)\
 and A.DOC_NUM=B.DOC_NUM) and NVL(B.POSTED_FLAG,'N')='Y') union select A.PATIE\
NT_ID ,A.DOC_TYPE_CODE BILL_DOC_TYPE_CODE ,A.DOC_NUM BILL_NUM ,TO_CHAR(A.DOC_D\
ATE,'DD/MM/YYYY') BILL_DATE ,A.DOC_AMT AMOUNT  from AR_PAT_BILLS_TEMP A ,AR_IN\
V_HDR B where ((((((A.OPERATING_FACILITY_ID=B.OPERATING_FACILITY_ID and A.OPER\
ATING_FACILITY_ID=:b0) and A.AR_INVOICE_DOC_TYPE_CODE=:b1) and A.AR_INVOICE_DO\
C_NUM=:b2) and A.AR_INVOICE_DOC_TYPE_CODE=B.DOC_TYPE_CODE) and A.AR_INVOICE_DO\
C_NUM=B.DOC_NUM) and NVL(B.POSTED_FLAG,'N')='N') order by 2,3            ";

 static const char *sq0009 = 
"select PATIENT_ID ,BILL_DOC_TYPE_CODE ,BILL_NUM ,TO_CHAR(BILL_DATE,'DD/MM/YY\
YY') ,REMARKS ,LAB_TEST ,AMOUNT  from AR_PATIENT_DTLS where ((OPERATING_FACILI\
TY_ID=:b0 and DOC_TYPE_CODE=:b1) and DOC_NUM=:b2) order by BILL_DATE,2,3      \
      ";

 static const char *sq0010 = 
"select DOC_TYPE_CODE ,DOC_NUM ,TO_CHAR(DOC_DATE,'DD/MM/YYYY') ,DOC_REF ,DOC_\
AMT  from AR_EXT_SALES_DP_DTLS where ((OPERATING_FACILITY_ID=:b0 and AR_INVOIC\
E_DOC_TYPE_CODE=:b1) and AR_INVOICE_DOC_NUM=:b2) order by DOC_TYPE_CODE,DOC_NU\
M            ";

 static const char *sq0008 = 
"select PATIENT_ID ,BILL_DOC_TYPE_CODE ,BILL_NUM ,TO_CHAR(BILL_DATE,'DD/MM/YY\
YY') ,GROSS_AMT  from AR_INV_HDR where (((OPERATING_FACILITY_ID=:b0 and DOC_TY\
PE_CODE=:b1) and DOC_NUM=:b2) and BILL_NUM is  not null )           ";
...
{10,4274,0,0,0,
5,0,0,1,227,0,4,258,0,0,11,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,
64,0,0,2,75,0,4,286,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
87,0,0,3,91,0,2,481,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
110,0,0,4,0,0,30,493,0,0,0,0,0,1,0,
125,0,0,5,181,0,4,514,0,0,7,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
3,0,0,1,9,0,0,
168,0,0,6,1123,0,9,721,0,0,7,7,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
211,0,0,6,0,0,13,811,0,0,35,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
...
0,0,
366,0,0,11,516,0,9,890,0,0,1,1,0,1,0,1,9,0,0,
385,0,0,11,0,0,13,915,0,0,10,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,1,0,0,2,1,0,0,
440,0,0,7,851,0,9,975,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
479,0,0,9,238,0,9,985,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
506,0,0,9,0,0,13,1015,0,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,4,0,0,
549,0,0,10,245,0,9,1093,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
576,0,0,10,0,0,13,1121,0,0,5,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,
611,0,0,7,0,0,13,1167,0,0,5,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,
646,0,0,8,222,0,9,1195,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
673,0,0,8,0,0,13,1223,0,0,5,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,
708,0,0,12,82,0,4,1434,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
731,0,0,13,82,0,4,1441,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
754,0,0,14,136,0,4,1463,0,0,5,3,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
789,0,0,15,77,0,4,1494,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
812,0,0,16,53,0,5,1691,0,0,1,1,0,1,0,1,9,0,0,
831,0,0,17,0,0,29,1697,0,0,0,0,0,1,0,
846,0,0,18,0,0,27,1720,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
};
...
struct { unsigned short len; unsigned char arr[3]; } p_language_id;
   ...
   /* VARCHAR nd_facility_id   [3],
		   nd_facility_name   [35], /o ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 06-01-2017o/
		   nd_session_id    [16],
           nd_fm_doc_type   [7],
           nd_to_doc_type   [7],
           nd_fm_doc_num    [10],
...
struct { unsigned short len; unsigned char arr[35]; } nd_facility_name;
...
p_language_id.len = l_language_id.len;
   ...
   nd_facility_id.arr[0]	= '\0';  /* ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 */
     nd_facility_name.arr[0] = '\0'; /* ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 06-01-2017 */
   ...
   nd_facility_id.len 		= 0;  /* ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 */
   nd_facility_name.len = 0; /* ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 06-01-2017 */
...
GM_DATE=:b10)";
   ...
   if (NOT_FOUND)
	...
	nd_facility_id.arr[nd_facility_id.len] 	= '\0';	 /* ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 */
   ...
   d_rep_option.arr[d_rep_option.len] = '\0';
        ...
        /* ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 06-01-2017 */
...
#ifdef DEBUG
/* ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 */
   sprintf(string_var,"Operating facility id is <%d> - <%s>\n",nd_facility_id.len ,nd_facility_id.arr);  
...
declare_cursors() 
{
    ...
    */
	...
	/* EXEC SQL DECLARE AR_PATIENT_DTLS_CUR CURSOR FOR
	               SELECT A.PATIENT_ID,
                    ...
                    WHERE A.OPERATING_FACILITY_ID = B.OPERATING_FACILITY_ID /o ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 o/
					  AND A.OPERATING_FACILITY_ID = :nd_facility_id /o ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 o/
					  AND A.DOC_TYPE_CODE = :d_ar_inv_doc_type_code
              ...
              UNION
                   SELECT A.PATIENT_ID,
                    ...
                    WHERE A.OPERATING_FACILITY_ID = B.OPERATING_FACILITY_ID /o ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 o/
					  AND A.OPERATING_FACILITY_ID = :nd_facility_id /o ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 o/
					  AND A.AR_INVOICE_DOC_TYPE_CODE  = :d_ar_inv_doc_type_code
    ...
    /* EXEC SQL DECLARE AR_PATIENT_DTLS_INV_CUR CURSOR FOR
                SELECT PATIENT_ID ,
                  ...
                  FROM  AR_INV_HDR
				  WHERE OPERATING_FACILITY_ID = :nd_facility_id /o ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 o/
				  AND 	DOC_TYPE_CODE = :d_ar_inv_doc_type_code
                  AND   DOC_NUM       = :d_ar_inv_doc_num
   ...
   /* EXEC SQL DECLARE AR_DP_DTLS_CUR CURSOR FOR
		...
		WHERE    OPERATING_FACILITY_ID = :nd_facility_id /o ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 03-01-2017 o/
		AND		AR_INVOICE_DOC_TYPE_CODE  = :d_ar_inv_doc_type_code
...
T_FLAG,'N') ,NVL(DP_INVOICE_YN,'N')  from AR_INV_HDR where ((((((OPERATING_F\
ACILITY_ID=:b0 and DOC_TYPE_CODE>=NVL(:b1,'      ')) and DOC_TYPE_CODE<=NVL(\
:b2,'~~~~~~')) and DOC_NUM>=NVL(:b3,0)) and DOC_NUM<=NVL(:b4,99999999)) and \
NVL(DOC_DATE,SYSDATE)>=NVL(TO_DATE(:b5,'DD/MM/YYYY'),to_date('00010101','YYY\
YDDMM'))) and NVL(DOC_DATE,SYSDATE)<=NVL(TO");
    sqlstm.stmt = sq0006;
    sqlstm.iters = (unsigned int  )1;
...

{
   ...
   sqlstm.sqadto[3] = (unsigned short )0;
   sqlstm.sqtdso[3] = (unsigned short )0;
   sqlstm.sqhstv[4] = (         void  *)&d_ar_inv_doc_type_code;
   sqlstm.sqhstl[4] = (unsigned int  )9;
   sqlstm.sqhsts[4] = (         int  )0;
   sqlstm.sqindv[4] = (         void  *)0;
   sqlstm.sqinds[4] = (         int  )0;
   ...
   sqlstm.sqadto[4] = (unsigned short )0;
   sqlstm.sqtdso[4] = (unsigned short )0;
   sqlstm.sqhstv[5] = (         void  *)&d_ar_inv_doc_num;
   sqlstm.sqhstl[5] = (unsigned int  )12;
   sqlstm.sqhsts[5] = (         int  )0;
   sqlstm.sqindv[5] = (         void  *)0;
   sqlstm.sqinds[5] = (         int  )0;
...
pctr += 1;
lctr = 0;
fprintf(fp,"%-30s\n",nd_facility_name.arr); /* ADDED BY SHIKHA FOR GDOH-CRF-0107 ON 06-01-2017*/
