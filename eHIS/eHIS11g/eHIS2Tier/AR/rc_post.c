...
{
    23,
    "D:\\test\\PROC\\RC_POST.PC"
};


static unsigned long sqlctx = 587462091;
...
RG_DOC_TYPE_CODE ,ORG_DOC_NUM ,LINE_TYPE_CODE ,NARRATION ,CONSOLIDATED_INV_YN \
 from AR_REC_LINE where ((OPERATING_FACILITY_ID=:b0 and DOC_TYPE_CODE=:b1) and\
 DOC_NUM=:b2)           ";
...
{10,4274,0,0,0,
5,0,0,1,183,0,4,348,0,0,7,5,0,1,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,1,9,0,0,
48,0,0,2,179,0,5,363,0,0,6,6,0,1,0,1,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
87,0,0,3,179,0,5,378,0,0,6,6,0,1,0,1,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
126,0,0,4,324,0,4,416,0,0,12,4,0,1,0,2,3,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
189,0,0,5,244,0,5,460,0,0,7,7,0,1,0,1,9,0,0,1,4,0,0,1,3,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,
232,0,0,6,1051,0,3,482,0,0,37,37,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
...
395,0,0,7,355,0,3,589,0,0,17,17,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,3,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,9,0,0,1,9,0,0,
478,0,0,8,104,0,5,644,0,0,2,2,0,1,0,1,4,0,0,1,9,0,0,
501,0,0,9,191,0,5,651,0,0,5,5,0,1,0,1,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
536,0,0,10,163,0,5,666,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
563,0,0,11,278,0,9,709,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
590,0,0,11,0,0,13,736,0,0,9,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,
641,0,0,12,334,0,9,795,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
668,0,0,12,0,0,13,840,0,0,14,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
739,0,0,13,469,0,3,894,0,0,9,9,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
790,0,0,14,350,0,3,952,0,0,13,13,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
857,0,0,15,359,0,3,1007,0,0,14,14,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
...
struct { unsigned short len; unsigned char arr[2]; } l_facility_id;
...
struct { unsigned short len; unsigned char arr[11]; } l_line_dept_code;

struct { unsigned short len; unsigned char arr[4]; } l_line_product_group_code;

struct { unsigned short len; unsigned char arr[9]; } l_line_product_line_code;
...
strcpy(l_facility_id.arr,passed_facility_id);
...
T_DTLS where ((((OPERATING_FACILITY_ID=:b2 and DOC_TYPE_CODE=:b3) and DOC_NUM=\
:b4) and BILL_DOC_TYPE_CODE=:b5) and BILL_NUM=:b6)";
      ...
      sqlstm.sqhstv[2] = (         void  *)&l_facility_id;
      ...
      sqlstm.sqhstv[3] = (         void  *)&d_pat_inv_doc_type_code;
      ...
      sqlstm.sqhstv[4] = (         void  *)&d_pat_inv_doc_num;
      ...
      sqlstm.sqhstv[5] = (         void  *)&d_pat_bill_doc_type_code;
      ...
      sqlstm.sqhstv[6] = (         void  *)&d_pat_bill_num;
...
b0) where ((((OPERATING_FACILITY_ID=:b1 and DOC_TYPE_CODE=:b2) and DOC_NUM=:b3\
...
,:b5,(:b6* (-1)),(:b6* (-1)),0,(:b6* (-1)),0,:b9,:b10,:b11,:b12,:b13,:b14,:b\
15,:b16,:b17,:b18,:b19,:b20,:b21,:b22,:b23,:b24,:b25,:b26,:b27,:b28,:b29,:b3\
0,:b31,:b32,:b33,:b34,:b35,'5',SYSDATE,USER");
    sqlstm.stmt = ",SYSDATE,USER,SYSDATE,:b36)";
    sqlstm.iters = (unsigned int  )1;
...
/MM/YYYY'),:b8,(:b9* (-1)),:b10,'5',:b11,:b12,:b13,:b14,:b15,:b16)";
      sqlstm.iters = (unsigned int  )1;
...
E(:b0,'O','Y','N'),POSTED_DATE=SYSDATE,POSTED_BY_ID=USER where (OPERATING_FACI\
LITY_ID=:b1 and ROWID=:b2)";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)&l_hdr_rowid;
