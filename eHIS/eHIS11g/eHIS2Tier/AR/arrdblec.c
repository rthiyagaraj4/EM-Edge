...
{
    78,
    "E:\\Work Gdoh\\ar-proc-source form team\\PROC_Files_10052017\\ARRDBLEC\\arrdblec.pc"
};


static unsigned long sqlctx = 1096674819;
...
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
335,0,0,7,361,0,9,699,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
358,0,0,5,0,0,13,720,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
389,0,0,6,0,0,13,729,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
420,0,0,7,0,0,13,772,0,0,12,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
483,0,0,8,217,0,9,808,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
514,0,0,8,0,0,13,821,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
541,0,0,9,0,0,27,1096,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
};
...

{
   ...
   /* EXEC SQL DECLARE AR_CUST_TRN_CUR CURSOR FOR
             SELECT ORG_DOC_TYPE_CODE, ORG_DOC_NUM,
					...
					NVL(POST_YEAR,0)
               FROM AR_CUST_TRN
              WHERE  OPERATING_FACILITY_ID = :nd_facility_id /o added for gdoh crf-0107o/
