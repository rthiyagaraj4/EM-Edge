...
{
    41,
    "Y:\\trunk\\eHIS11g\\eHIS2Tier/AR/Arrlbdtl.pc"
};


static unsigned int sqlctx = 1288485435;
...
"select D.CUST_CODE ,TO_CHAR(C.SPEC_REGD_DATE_TIME,'DD/MM/YYYY') ,C.DOC_TYPE_\
CODE ,C.DOC_NUM ,C.SPECIMEN_NO ,A.SHORT_NAME ,C.SECTION_CODE ,sum(NVL(B.NET_CH\
ARGE,0))  from BL_AM_REFERRAL D ,RL_PATIENT_MAST A ,RL_REQUEST_DETAIL B ,RL_RE\
QUEST_HEADER C where (((((((((SPEC_REGD_DATE_TIME>=TO_DATE((:b0||'0000'),'dd/m\
m/yyyyhh24mi') and SPEC_REGD_DATE_TIME<(TO_DATE((:b1||'0000'),'dd/mm/yyyyhh24m\
i')+1)) and D.CUST_CODE between NVL(:b2,'!!!!!!!!') and NVL(:b3,'~~~~~~~~')) a\
nd NVL(INVOICED_YN,'N')='N') and NVL(B.CANCELLED_YN,'N')='N') and A.PATIENT_ID\
=C.PATIENT_ID) and B.SPECIMEN_NO=C.SPECIMEN_NO) and D.CUST_CODE is  not null )\
 and D.REFERRAL_CODE=C.SOURCE_CODE) and D.CHARGE_POSTING_MODE='A') group by D.\
CUST_CODE,TO_CHAR(C.SPEC_REGD_DATE_TIME,'DD/MM/YYYY'),C.DOC_TYPE_CODE,C.DOC_NU\
M,C.SPECIMEN_NO,A.SHORT_NAME,C.SECTION_CODE order by D.CUST_CODE,C.SPECIMEN_NO\
            ";
...
{12,4274,178,0,0,
5,0,0,0,0,0,27,106,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,30,139,0,0,0,0,0,1,0,
51,0,0,3,162,0,4,156,0,0,8,3,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,
0,0,1,9,0,0,1,9,0,0,
98,0,0,4,84,0,2,182,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
125,0,0,5,0,0,13,257,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,4,0,0,
172,0,0,6,71,0,4,284,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
195,0,0,7,63,0,4,303,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
218,0,0,5,868,0,9,323,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
249,0,0,8,147,0,4,552,0,0,5,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[11]; } d_lab_date;
...
struct { unsigned short len; unsigned char arr[16]; } d_section_name;
...
M4 into :b0,:b1,:b2,:b3,:b4  from SY_PROG_PARAM where ((PGM_ID=:b5 and SESSION\
_ID=:b6) and PGM_DATE=:b7)";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqhstv[3] = (         void  *)&nd_fm_cust;
   ...
   sqlstm.sqhstv[4] = (         void  *)&nd_to_cust;
...

{
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (         void  *)&d_lab_date;
    sqlstm.sqhstl[1] = (unsigned int  )13;
    sqlstm.sqhsts[1] = (         int  )0;
    sqlstm.sqindv[1] = (         void  *)0;
    sqlstm.sqinds[1] = (         int  )0;
    ...
    sqlstm.sqadto[5] = (unsigned short )0;
    sqlstm.sqtdso[5] = (unsigned short )0;
    sqlstm.sqhstv[6] = (         void  *)&d_section_code;
    ...
    sqlstm.sqadto[6] = (unsigned short )0;
    sqlstm.sqtdso[6] = (unsigned short )0;
    sqlstm.sqhstv[7] = (         void  *)&d_debit_amt;
...

{
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (         void  *)&nd_fm_cust;
    ...
    sqlstm.sqadto[2] = (unsigned short )0;
    sqlstm.sqtdso[2] = (unsigned short )0;
    sqlstm.sqhstv[3] = (         void  *)&nd_to_cust;
    sqlstm.sqhstl[3] = (unsigned int  )11;
    sqlstm.sqhsts[3] = (         int  )0;
    sqlstm.sqindv[3] = (         void  *)0;
    sqlstm.sqinds[3] = (         int  )0;
...
MI') ,USER ,NO_OF_DECIMAL into :b0,:b1,:b2,:b3  from SY_ACC_ENTITY where ACC_E\
NTITY_ID=:b4";
    sqlstm.iters = (unsigned int  )1;
