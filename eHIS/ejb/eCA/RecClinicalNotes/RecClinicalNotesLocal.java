...
public abstract interface RecClinicalNotesLocal extends EJBLocalObject
{
  ...
  public abstract HashMap rejectRecClinicalNotes(Properties paramProperties, HashMap paramHashMap);//IN67872
  
  public abstract HashMap recordRecClinicalNotesAutosave(Properties paramProperties, HashMap paramHashMap, RecClinicalNotesSectionBean paramRecClinicalNotesSectionBean, XMLtoHTML paramXMLtoHTML, String paramString);//IN071264
}
