...
*	view-type="both"
*	jndi-name="MRPHoliday"
*	local-jndi-name="MRPHoliday"
*	impl-class-name="eMR.MRPHoliday.MRPHolidayManager"
*	
*
* @ejb.interface
*	extends="javax.ejb.EJBObject"
*	local-extends="javax.ejb.EJBLocalObject" 
*	local-class="eMR.MRPHoliday.MRPHolidayManagerLocal"
*	remote-class="eMR.MRPHoliday.MRPHolidayManagerRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eMR.MRPHoliday.MRPHolidayManagerLocalHome"
*	remote-class="eMR.MRPHoliday.MRPHolidayManagerHome"
*	generate= "local,remote"
*
*
*/
public class MRPHolidayManager implements SessionBean {
...
*	 view-type="both"
*/
public java.util.HashMap insertMRPHoliday(java.util.Properties p,java.util.HashMap passObjects){
	...
	holidayQuery="insert into mr_report_holiday(facility_id,holiday_date,reason_for_holiday,added_by_id,added_date,added_at_ws_no,added_facility_id,modified_by_id,modified_date,modified_at_ws_no,modified_facility_id,HOLIDAY_CHECK_YN) values(?,to_date(?,'dd/mm/yyyy'),?,?,sysdate,?,?,?,sysdate,?,?,'Y')";
...
*	 view-type="both"
*/
	public java.util.HashMap updateMRPHoliday(java.util.Properties p,
			...
			StringBuffer sb = new StringBuffer( "" ) ;
			String sql = "update mr_report_holiday set reason_for_holiday=?, modified_by_id=?, modified_date= sysdate, modified_at_ws_no= ?, MODIFIED_FACILITY_ID =? where holiday_date= to_date('"+holidaydate+"','dd/mm/yyyy') and facility_id = ? ";
...
*	 view-type="both"
*/
public java.util.HashMap deleteMRPHoliday(java.util.Properties p, java.util.HashMap passObjects) {
			...
			StringBuffer sb = new StringBuffer( "" ) ;
			String sql = "delete from mr_report_holiday  where holiday_date= to_date('"+holidaydate+"','dd/mm/yyyy') and facility_id = ? ";
...
public java.util.HashMap deleteMultipleMRPHolidays(java.util.Properties p,java.util.HashMap passObjects){
	...
	con = ConnectionManager.getConnection(p);
	con.setAutoCommit(false);
	deleteholidayQuery="delete from mr_report_holiday where facility_id=? and  holiday_date=to_date(?,'dd/mm/yyyy')";
