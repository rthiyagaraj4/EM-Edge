...
*
* @ejb.bean
*	name="SpecialtyForAssessmentNote"
*	type="Stateless"
*	transaction-type="Bean"
*	view-type="both"
*	jndi-name="SpecialtyForAssessmentNote"
*	local-jndi-name="SpecialtyForAssessmentNote"
*	impl-class-name="eCP.SpecialtyForAssessmentNote.SpecialtyForAssessmentNoteManager"
...
*	local-class="eCP.SpecialtyForAssessmentNote.SpecialtyForAssessmentNoteLocal"
*	remote-class="eCP.SpecialtyForAssessmentNote.SpecialtyForAssessmentNoteRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eCP.SpecialtyForAssessmentNote.SpecialtyForAssessmentNoteLocalHome"
*	remote-class="eCP.SpecialtyForAssessmentNote.SpecialtyForAssessmentNoteHome"
*	generate= "local,remote"
*
*
*/
public class SpecialtyForAssessmentNoteManager implements SessionBean
{
	Connection con;
    PreparedStatement pstmt;

    public SpecialtyForAssessmentNoteManager()
    {
    }
	...
	*/	
	...
	String locale=(String)hashtable.get("locale")==null?"en":(String)hashtable.get("locale");
        ...
        try
        {
            ...
            String sql_delete = "";
            int j = 0;
            sql_delete = "delete from cp_assess_note_splty where assess_note_id='"+assess_note_id+"' ";
			...
			String sql_insert = "Insert into cp_assess_note_splty (assess_note_id,specialty_code,  ADDED_BY_ID, ADDED_DATE, ADDED_AT_WS_NO, ADDED_FACILITY_ID, MODIFIED_BY_ID, MODIFIED_DATE, MODIFIED_AT_WS_NO, MODIFIED_FACILITY_ID) values ( ?, ?, ?, sysdate, ?, ?, ?, sysdate, ?, ? )";
			...
			for(int k = 0; k < i; k++)
            {
                specialty_code = (String)hashtable.get("chk" + k);
                pstmt.setString(1,assess_note_id);
                pstmt.setString(2, specialty_code);
