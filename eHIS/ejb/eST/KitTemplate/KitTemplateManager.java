...
*	view-type="both"
*	jndi-name="KitTemplate"
*	local-jndi-name="KitTemplate"
*	impl-class-name="eST.KitTemplate.KitTemplateManager"
*	
*
* @ejb.interface
*	extends="javax.ejb.EJBObject"
*	local-extends="javax.ejb.EJBLocalObject" 
*	local-class="eST.KitTemplate.KitTemplateLocal"
*	remote-class="eST.KitTemplate.KitTemplateRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eST.KitTemplate.KitTemplateLocalHome"
*	remote-class="eST.KitTemplate.KitTemplateHome"
*	generate= "local,remote"
*
*
*/

public class KitTemplateManager extends StEJBSessionAdapter
{
    public KitTemplateManager()
    {
    }
/**
