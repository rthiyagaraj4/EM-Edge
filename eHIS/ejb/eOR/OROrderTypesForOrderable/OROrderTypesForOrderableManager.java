 ...
 ******************************************************************************/
package eOR.OROrderTypesForOrderable;
...
*
* @ejb.bean
*	name="OROrderTypesForOrderable"
*	type="Stateless"
*	transaction-type="Bean"
*	view-type="both"
*	jndi-name="OROrderTypesForOrderable"
*	local-jndi-name="OROrderTypesForOrderable"
*	impl-class-name="eOR.OROrderTypesForOrderable.OROrderTypesForOrderableManager"
*	
*
* @ejb.interface
*	extends="javax.ejb.EJBObject"
*	local-extends="javax.ejb.EJBLocalObject" 
*	local-class="eOR.OROrderTypesForOrderable.OROrderTypesForOrderableLocal"
*	remote-class="eOR.OROrderTypesForOrderable.OROrderTypesForOrderableRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eOR.OROrderTypesForOrderable.OROrderTypesForOrderableLocalHome"
*	remote-class="eOR.OROrderTypesForOrderable.OROrderTypesForOrderableHome"
*	generate= "local,remote"
*
*
*/

public class OROrderTypesForOrderableManager extends OrEJBSessionAdapter {
...
*/
    ...
    public HashMap insert( HashMap tabDataParam, HashMap sqlMap ) {
	 ...
	 pstmt_del = null ;
		...
		String SQL_ORDER_TYPES_ORDERABLE_INSERT = (String) sqlMap.get("SQL_ORDER_TYPES_ORDERABLE_INSERT");
		String SQL_ORDER_TYPES_ORDERABLE_DELETE = (String) sqlMap.get("SQL_ORDER_TYPES_ORDERABLE_DELETE");

		traceVal.append(SQL_ORDER_TYPES_ORDERABLE_DELETE);
		...
		try{
			...
			if(insertArrList.size() >0){
				...
				pstmt					= connection.prepareStatement(SQL_ORDER_TYPES_ORDERABLE_INSERT);
			...
			if(insert_flag && deleteArrList.size() >0 ){
				...
				pstmt_del	= connection.prepareStatement(SQL_ORDER_TYPES_ORDERABLE_DELETE);

				HashMap delMapData  = new HashMap();

				for(int k=0 ; k < deleteArrList.size() ; k++){
				delMapData  = (HashMap)deleteArrList.get(k);
				pstmt_del.setString(1 ,order_type_code);
