...
*	view-type="both"
*	jndi-name="IssueGroup"
*	local-jndi-name="IssueGroup"
*	impl-class-name="eSS.IssueGroup.IssueGroupManager"
...
*	local-class="eSS.IssueGroup.IssueGroupLocal"
*	remote-class="eSS.IssueGroup.IssueGroupRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eSS.IssueGroup.IssueGroupLocalHome"
*	remote-class="eSS.IssueGroup.IssueGroupHome"
*	generate= "local,remote"
*
*
*/

public class  IssueGroupManager extends SsEJBSessionAdapter {
	...
	*/
	...
	public HashMap insert(HashMap hmData, HashMap hmSQL)  {
		...
		try {
			...
			boolean Acknowledge_flag = fetchRecord(connection,"SELECT ISS_ACK_REQ_YN FROM SS_FACILITY_PARAM WHERE FACILITY_ID = ?", (String)alHdrData.get(0)).get("ISS_ACK_REQ_YN").toString().equals("Y");
