 ...
 ******************************************************************************/
 package eSS.ProcessGLDistribution;
...
*
* @ejb.bean
*	name="ProcessGLDistribution"
*	type="Stateless"
*	transaction-type="Bean"
*	view-type="both"
*	jndi-name="ProcessGLDistribution"
*	local-jndi-name="ProcessGLDistribution"
*	impl-class-name="eSS.ProcessGLDistribution.ProcessGLDistributionManager"
...
*	local-class="eSS.ProcessGLDistribution.ProcessGLDistributionLocal"
*	remote-class="eSS.ProcessGLDistribution.ProcessGLDistributionRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eSS.ProcessGLDistribution.ProcessGLDistributionLocalHome"
*	remote-class="eSS.ProcessGLDistribution.ProcessGLDistributionHome"
*	generate= "local,remote"
*
*
*/
...
public class  ProcessGLDistributionManager extends SsEJBSessionAdapter {
	...
	*/
	...
	public HashMap insert(HashMap hmData, HashMap hmSQL)	{
		...
		try {
			...
			message_id = callableStatement.getString(4);
			value = callableStatement.getInt(5);
			if (value>=0) {
				result = true;
				connection.commit();
			}
			...
			hmReturn.put("message",message_id);
			hmReturn.put("msgid",message_id);
