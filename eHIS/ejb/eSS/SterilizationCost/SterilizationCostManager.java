...
*
* @ejb.bean
*	name="SterilizationCost"
*	type="Stateless"
*	transaction-type="Bean"
*	view-type="both"
*	jndi-name="SterilizationCost"
*	local-jndi-name="SterilizationCost"
*	impl-class-name="eSS.SterilizationCost.SterilizationCostManager"
...
*	local-class="eSS.SterilizationCost.SterilizationCostLocal"
*	remote-class="eSS.SterilizationCost.SterilizationCostRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="eSS.SterilizationCost.SterilizationCostLocalHome"
*	remote-class="eSS.SterilizationCost.SterilizationCostHome"
*	generate= "local,remote"
*
*
*/
...
public class  SterilizationCostManager extends SsEJBSessionAdapter {
...
/**
	...
	*/
    ...
    public HashMap insert( HashMap tabData, HashMap sqlMap ) {  
		...
		final String SQL_SS_STERILIZATION_COST_INSERT = (String)  sqlMap.get( "SQL_SS_STERILIZATION_COST_INSERT" );
		final String SQL_SS_STERILIZATION_COST_UPDATE = (String) sqlMap.get( "SQL_SS_STERILIZATION_COST_UPDATE" );
		final String SQL_SS_STERILIZATION_COST_DELETE = (String)  sqlMap.get( "SQL_SS_STERILIZATION_COST_DELETE" );
		...
		try {
			...
			pstmt_insert = connection.prepareStatement( SQL_SS_STERILIZATION_COST_INSERT ) ;
			...
			if(modify_rec){
				pstmt_modify = connection.prepareStatement( SQL_SS_STERILIZATION_COST_UPDATE ) ;
				// clear the batch
			...
			if(delete_rec){
				pstmt_delete = connection.prepareStatement( SQL_SS_STERILIZATION_COST_DELETE ) ;
				// clear the batch
			...
			if(insert_rec || modify_rec || delete_rec){
				connection.commit();
				map.put( "result", new Boolean( true ) ) ;
				messages.append( "RECORD_INSERTED" ) ;
				//System.err.println("SterilizationCostmessages"+messages);
			}
			else{
				connection.rollback();
				map.put( "result", new Boolean( false ) ) ;
