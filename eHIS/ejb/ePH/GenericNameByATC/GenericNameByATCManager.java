...
*
* @ejb.bean
*	name="GenericNameByATC"
*	type="Stateless"
*	transaction-type="Bean"
*	view-type="both"
*	jndi-name="GenericNameByATC"
*	local-jndi-name="GenericNameByATC"
*	impl-class-name="ePH.GenericNameByATC.GenericNameByATCManager"
*	
*
* @ejb.interface
*	extends="javax.ejb.EJBObject"
*	local-extends="javax.ejb.EJBLocalObject" 
*	local-class="ePH.GenericNameByATC.GenericNameByATCLocal"
*	remote-class="ePH.GenericNameByATC.GenericNameByATCRemote"
*	generate= "local,remote"
*
* @ejb.home
*	extends="javax.ejb.EJBHome" 
*	local-extends="javax.ejb.EJBLocalHome"
*	local-class="ePH.GenericNameByATC.GenericNameByATCLocalHome"
*	remote-class="ePH.GenericNameByATC.GenericNameByATCHome"
*	generate= "local,remote"
*
*
*/
public class GenericNameByATCManager extends PhEJBSessionAdapter {

	Properties prop=null;

	String SQL_PH_GENERIC_NAME_BY_ATC_CLASS_SELECT3="";
	String SQL_PH_GENERIC_NAME_BY_ATC_CLASS_SELECT4="";
/**
	...
	*/	
    ...
    public HashMap insert( HashMap tabData, HashMap sqlMap )  {
		...
		final String SQL_PH_GENERIC_NAME_BY_ATC_CLASS_INSERT = (String) sqlMap.get( "SQL_PH_GENERIC_NAME_BY_ATC_CLASS_INSERT" );
					 ...
					 SQL_PH_GENERIC_NAME_BY_ATC_CLASS_SELECT4= (String) sqlMap.get( "SQL_PH_GENERIC_NAME_BY_ATC_CLASS_SELECT4");
...
//  modify method starts here
	...
	public HashMap modify( HashMap tabData, HashMap sqlMap )  {
		...
		final String SQL_PH_GENERIC_NAME_UPDATE1 = (String) sqlMap.get( "SQL_PH_GENERIC_NAME_UPDATE1" );
		...
		String	   call_from					= (String)tabData.get("call_from");
		ArrayList  arrListbyATCModify			= (ArrayList)tabData.get("updateByATC");
		...
		try {
			 ...
			 * @Date - 18/12/2009
			 * @Inc# - IN017314
			 * @Desc - allows to update the effective status of generic name when we selected search by ATC Classfication in Query Mode
			 */
			if (call_from.equals("UpdateByATCClassification"))
			{
				pstmt_update1 = connection.prepareStatement( SQL_PH_GENERIC_NAME_UPDATE1 ) ;
				for (int i=0;i< arrListbyATCModify.size();i+=15 )
				{
					pstmt_update1.setString(1,arrListbyATCModify.get(i+4).toString());//eff_status
					pstmt_update1.setString(2,login_by_id);
					pstmt_update1.setString(3,login_at_ws_no);
					pstmt_update1.setString(4,login_facility_id);
					pstmt_update1.setString(5,arrListbyATCModify.get(i+1).toString());//generic_id
					result = pstmt_update1.executeUpdate();
					if (result<0)
					{
						connection.rollback();
...
/**
	...
	*/
	...
	public int getSrNo(String generic_id) throws Exception
	{
		...
		try {
			connection = getConnection(prop) ;
			pstmt = connection.prepareStatement( SQL_PH_GENERIC_NAME_BY_ATC_CLASS_SELECT4 );
