...
public interface DispMedicationWorkSheetRemote extends PhEJBRemote {
	...
	public HashMap modifyManufacturLabel( HashMap tabData, HashMap sqlMap ) throws RemoteException;
