...
public final class __oaapptschedulingforrd extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoa/jsp/OAApptSchedulingForRD.jsp", 1718354630654L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block3 ="\' == \'RESCHEDULE\'){\n\t\t\t\t\twindow.open(\'../../eOA/jsp/TransferAppointmentFrame.jsp?";
    ...
    private final static java.lang.String  _wl_block6 ="\',\'eHIS\',\'location=0,height=700,width=1200,top=0,left=0,resizable=yes\');\t\n\n\t\t\t\t}else if(\'";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="\' == \'CANCEL\'){\n\t\t\t\t\twindow.open(\'../../eOA/jsp/CancelAppointmentFrame.jsp?";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\' == \'SCHAPPT\'){\n\t\t\t\t\twindow.open(\'../../eOA/jsp/CAOAAppointment.jsp?";
