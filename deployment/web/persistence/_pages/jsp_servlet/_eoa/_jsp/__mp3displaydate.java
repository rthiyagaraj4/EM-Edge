...
public final class __mp3displaydate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoa/jsp/MP3DisplayDate.jsp", 1709119241959L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\' onkeypress=\"return check_val(event)\" onblur=\"DateCheck_new1(\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\',this)\" ";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 =" style=\"width:75\"><img src=\"../../eCommon/images/CommonCalendar.gif\" id=\'cal1\' onClick=\"document.forms[0].valid_date.select();return showCalendar(\'date_of_expiry\');\" style=\'visibility\'><img src=\"../../eCommon/images/mandatory.gif\" align=\'center\'></img></td>\n\t\t\t\t\n\t\t\t<td  class=\'label\' id = day1 width = \'10%\'><b>";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="</b></td>\n\t\t\t\t\n\t\t\t<td class=\'button\'>\n\t\t\t\n\t\t\t<script>document.forms[0].date_of_expiry.focus();hide();</script>\n\t\t\t\t\n\t\t\t<input type=\'button\' name=\'go\' id=\'go\' value=\'";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\' class=\'button\' onClick=\'blankdatechk()\'>\n\t\t\t\n\t\t\t<input type=hidden size=\'1\' name=\'gggg\' id=\'gggg\' value=";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 =" disabled style=\'visibility:hidden\'>\n\t\t\t</td>\n\t\t</tr>\n\t</table>\n\t</td>\n\t\n\t\t<td valign=\"top\" align=\"left\" width=\"34%\">\n\t\t\n\t<table border=0 width=\"100%\" cellpadding=0 cellspacing=0>\n\t\t<tr>\n\t\t\t<td class=label  nowrap>";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="</td>\n\t\t\t\n\t\t\t<td class=\'fields\'><input id = \'date_of_expiry1\' type=text size=10 maxlength = 10 name=\'valid_date1\' id=\'valid_date1\' value=\'";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\' onkeypress=\"return check_val(event)\" onblur=\"DateCheck_new2(\'";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 =" style=\"width:75\"><img   src=\"../../eCommon/images/CommonCalendar.gif\" id=\'cal2\' onClick=\"document.forms[0].valid_date1.select();return showCalendar(\'date_of_expiry1\');\" style=\'visibility\'><img src=\"../../eCommon/images/mandatory.gif\" align=\'center\'></img></td>\n\t\t\t\t\n\t\t\t<td class=\'label\' id = day2 ><b>";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="</b></td>\n\t\t\t\n\t\t\t<td class=\'button\'>\n\t\t\t\n\t\t\t<script>document.forms[0].date_of_expiry1.focus();hide();</script>\n\t\t\t\n\t\t\t<input type=\'button\' name=\'goY\' id=\'goY\' value=\'";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\' class=\'button\' onClick=\'blankdatechk()\' >\n\t\t\t\n\t\t\t<input type=hidden size=\'1\' name=\'gggg\' id=\'gggg\' value=";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 =" disabled style=\'visibility:hidden\'></td>\n\t\t</tr>\n\t</table>\n\t</td>\n\t\n\t\t<td valign=\"top\" align=\"left\" width=\"33.5%\">\n\t\t<table border=0 width=\"100%\" cellpadding=0 cellspacing=0>\n\t\t<tr>\t\n\t\t\t<td class=label nowrap>";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="</td>\n\t\t\t\n\t\t\t<td class=\'fields\' ><input id = \'date_of_expiry2\' type=text size=10 maxlength = 10 name=\'valid_date2\' id=\'valid_date2\' value=\'";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\' onkeypress=\"return check_val(event)\" onblur=\"DateCheck_new3(\'";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 =" style=\"width:75\"><img src=\"../../eCommon/images/CommonCalendar.gif\" id=\'cal3\' onClick=\"document.forms[0].valid_date2.select();return showCalendar(\'date_of_expiry2\');\" style=\'visibility\'><img src=\"../../eCommon/images/mandatory.gif\" align=\'center\'></img></td>\n\t\t\t\t\n\t\t\t<td class=\'label\' id = day3 ><b>";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 ="</b></td>\n\t\t\t\n\t\t\t<td class=\'button\'>\n\t\t\t\n\t\t\t<script>document.forms[0].date_of_expiry2.focus();hide();</script>\n\t\t\t\t\n\t\t\t<input type=\'button\' name=\'goX\' id=\'goX\' value=\'";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 =" disabled style=\'visibility:hidden\'>\n\t\t\t</td>\n\t\t</tr>\n\t\t</table>\n\t</td>\n</tr>\n</table>\n\t\t\t<input type=hidden name=\"cur_dt\" id=\"cur_dt\" value=\"";
    ...
    private final static java.lang.String  _wl_block33 =" >\n\t\t\t<input type=\'hidden\' name=\'clinic3\' id=\'clinic3\' value=";
    private final static byte[]  _wl_block33Bytes = _getBytes( _wl_block33 );

    private final static java.lang.String  _wl_block34 =" >\n\t\t\t<input type=\'hidden\' name=\'practitioner3\' id=\'practitioner3\' value=";
    ...
    private final static java.lang.String  _wl_block47 ="\' >\n\t\t\t<input type=\'hidden\' name=\'go1\' id=\'go1\' value=\'Go\'>\n\t\t\t<input type=\'hidden\' name=\'go2\' id=\'go2\' value=\'Go\' >\n\t\t\t<input type=\"hidden\" name=\"clinic_type1\" id=\"clinic_type1\" value=\"";
    ...
    private final static java.lang.String  _wl_block82 ="\'><!-- added for the incident 40965-->\n\n\n";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		/*Added on 4/24/2008*/
 //		out.println("capture_fin_dtls_yn==in Date==>" +capture_fin_dtls_yn);
		...
		if(ca_practitioner_id!=null && !(ca_practitioner_id.equals(""))){
		ca_mode="ca_mode";
		}
		else{
		}
	...
	try
	{
			...
			// stmt = con.createStatement();
			 //String sql="select replace(to_char(to_date('"+date+"','dd/mm/yyyy'), 'Day, Month,dd,yyyy'),' ','')dat_val, to_char(to_date('"+valid_date+"','dd/mm/yyyy'),'Day') day1,to_char(to_date('"+date1+"','dd/mm/yyyy'),'Day') day2,to_char(to_date('"+date2+"','dd/mm/yyyy'),'Day') day3,to_char(sysdate,'dd/mm/yyyy')sys_date from dual";
			//rs=stmt.executeQuery(sql);
			String sql="select replace(to_char(to_date(?,'dd/mm/yyyy'), 'Day, Month,dd,yyyy'),' ','')dat_val, to_char(to_date(?,'dd/mm/yyyy'),'Day') day1,to_char(to_date(?,'dd/mm/yyyy'),'Day') day2,to_char(to_date(?,'dd/mm/yyyy'),'Day') day3,to_char(sysdate,'dd/mm/yyyy')sys_date from dual";
		...
		rs.next();
		String display=rs.getString("dat_val");
...
String day_show2="";
		...
		day3=day3.trim();
String day_show3="";
		if(day3.equals("Sunday"))
		{
			day_show3=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.sun.label","common_labels");
		}else if(day3.equals("Monday"))
		{
			day_show3=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.mon.label","common_labels");
		}else if(day3.equals("Tuesday"))
		{
			day_show3=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.tue.label","common_labels");
		}else if(day3.equals("Wednesday"))
		{
			day_show3=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.wed.label","common_labels");
		}else if(day3.equals("Thursday"))
		{
			day_show3=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.thu.label","common_labels");
		}else if(day3.equals("Friday"))
		{
			day_show3=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.fri.label","common_labels");
		}else if(day3.equals("Saturday"))
		{
			day_show3=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.sat.label","common_labels");
		}
		...
		valid_date_display3=DateUtils.convertDate(date2,"DMY","en",locale);
            ...
            out.print( String.valueOf(valid_date_display3));
            _bw.write(_wl_block24Bytes, _wl_block24);
            out.print( String.valueOf(sysdate));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(read_only_date));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf(day_show3));
...
finally
{
    ...
    private boolean _jsp__tag5(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag5.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.Go.label", java.lang.String .class,"key"));
