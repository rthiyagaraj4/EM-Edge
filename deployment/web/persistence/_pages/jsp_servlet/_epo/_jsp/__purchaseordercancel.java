...
public final class __purchaseordercancel extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/PurchaseOrderCancel.jsp", 1709528310077L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	PurchaseOrderCancelBean bean = (PurchaseOrderCancelBean) getBeanObject("PurchaseOrderCancelBean","ePO.PurchaseOrderCancelBean",request);  
...
putObjectInBean("PurchaseOrderCancelBean",bean,request);
