...
public final class __mastertypeframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/MasterTypeFrame.jsp", 1709121590013L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="</td>\n\t<td  class=\"fields\"  colspan=\"2\">&nbsp;&nbsp;<select name=\"master_type\" id=\"master_type\" onchange=\"changetype()\" ";
	...
	if ( mode.equals((String) CommonRepository.getCommonKeyValue( "MODE_MODIFY") )) {
		//bean.loadData();
		 ...
		 bean.setMasterType(master_type);
            ...
            out.print( String.valueOf(bean.getMasterType()));
	...
	for(int i=0;i<arrLength; i++)
	{
		...
		if(master_type_code.trim().equals(master_type.trim()))
		{
            ...
            out.print( String.valueOf(master_type_code));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(master_type_select));
