...
import ePO.PurchaseOrderStatusBean;
import java.util.*;
...
public final class __purchaseorderstatus extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/PurchaseOrderStatus.jsp", 1709121595388L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	putObjectInBean("purchaseOrderStatusBean",bean,request);
