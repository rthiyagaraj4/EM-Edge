...
public final class __amendpurchaseorder extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/AmendPurchaseOrder.jsp", 1709526212225L ,"10.3.6.0","Asia/Calcutta")) return true;
...
("PREFERRED_STYLE"):"IeStyle.css";
	...
	AmendPurchaseOrderBean bean = (AmendPurchaseOrderBean) getBeanObject("amendPurchaseOrderBean","ePO.AmendPurchaseOrderBean", request );  
	bean.initialize();
	...
	putObjectInBean("amendPurchaseOrderBean",bean,request);
