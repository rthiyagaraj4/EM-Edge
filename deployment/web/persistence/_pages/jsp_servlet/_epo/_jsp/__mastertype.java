...
public final class __mastertype extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/MasterType.jsp", 1709527372549L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	String source = url + params ;
	 ...
	 MultipleInsertMasterTypeBean bean = (MultipleInsertMasterTypeBean) getBeanObject("multipleInsertMasterTypeBean","ePO.MultipleInsertMasterTypeBean", request );  
	 bean.initialize();
	...
	putObjectInBean("multipleInsertMasterTypeBean",bean,request);
