...
public final class __purchaseorder extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/PurchaseOrder.jsp", 1709528251094L ,"10.3.6.0","Asia/Calcutta")) return true;
...
("PREFERRED_STYLE"):"IeStyle.css";
	...
	PurchaseOrderBean bean = (PurchaseOrderBean) getBeanObject("purchaseOrderBean","ePO.PurchaseOrderBean", request );  
	bean.initialize();
	...
	putObjectInBean("purchaseOrderBean",bean,request);
