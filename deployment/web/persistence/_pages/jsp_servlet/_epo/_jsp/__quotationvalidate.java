...
public final class __quotationvalidate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/QuotationValidate.jsp", 1741325932098L ,"10.3.6.0","Asia/Calcutta")) return true;
...
if(functionType.equals("LOADCURRENCY")){
		System.out.println("LOADCURRENCY");
		String local_currency = request.getParameter("localCurrency");
		System.out.println("supplier in po validate = "+supplier);
		...
		System.out.println("dflt_currency in po validate = "+dflt_currency);
		
		out.println("clearListItems('formQuotationHeader.currency_code'); ");
		ArrayList currency_code = bean.getCurrencyLists();
		HashMap record = new HashMap();
			for(int i=0; i< currency_code.size(); i++) {
				record = (HashMap)currency_code.get(i);
				out.println("addListItem(\"formQuotationHeader.currency_code\", \"" + record.get("CURRENCY_CODE") + "\",\"" + record.get("SHORT_DESC") + "\",\"" +dflt_currency+ "\");");
			}
		out.println("parent.QuotDetailFrame.document.getElementById('currency_label_1').innerHTML = '" +  dflt_currency +"'; ");
		out.println("parent.QuotDetailFrame.document.getElementById('currency_label_2').innerHTML = '" +  dflt_currency +"'; ");
		out.println("parent.QuotDetailFrame.document.getElementById('currency_label_3').innerHTML = '" +  dflt_currency +"'; ");
		out.println("parent.QuotDetailFrame.document.getElementById('currency_label_4').innerHTML = '" +  dflt_currency +"'; ");
		  out.println("parent.QuotListFrame.document.getElementById('currency_label_5').innerHTML = '" +  dflt_currency +"'; ");
		  out.println("parent.QuotListFrame.document.getElementById('currency_label_6').innerHTML = '" +  dflt_currency +"'; ");
		  out.println("parent.QuotListFrame.document.getElementById('currency_label_7').innerHTML = '" +  dflt_currency +"'; ");
	//	out.println("parent.QuotDetailFrame.document.getElementById("currency_label_8").innerHTML = '" +  dflt_currency +"'; ");
		if(dflt_currency.equals(local_currency)){
			out.println("document.getElementById('exc_rate').value = '" +  1 +"'; ");
			out.println("document.getElementById('exc_rate').disabled = true; ");
		}else{
	...
	else if(functionType.equals("UPDATEREMARKS")){
	...
	//	out.println(" formDeliveryOrderHeader.currency_code.disabled=true ; ");	
		out.println("parent.QuotDetailFrame.document.getElementById('currency_label_1').innerHTML = '" +  currency_desc +"'; ");
		out.println("parent.QuotDetailFrame.document.getElementById('currency_label_2').innerHTML = '" +  currency_desc +"'; ");
		out.println("parent.QuotDetailFrame.document.getElementById('currency_label_3').innerHTML = '" +  currency_desc +"'; ");
		out.println("parent.QuotDetailFrame.document.getElementById('currency_label_4').innerHTML = '" +  currency_desc +"'; ");
		  out.println("parent.QuotListFrame.document.getElementById('currency_label_5').innerHTML = '" +  currency_desc +"'; ");
		  out.println("parent.QuotListFrame.document.getElementById('currency_label_6').innerHTML = '" +  currency_desc +"'; ");
		  out.println("parent.QuotListFrame.document.getElementById('currency_label_7').innerHTML = '" +  currency_desc +"'; ");
		  out.println("parent.QuotListFrame.document.getElementById('currency_label_8').innerHTML = '" +  currency_desc_lc +"'; ");
	...
	*/
		...
		System.out.println("LOADTRADEID");
		String item_code = request.getParameter("item_code");
		
		System.out.println("item_code in do validate = "+item_code);
		
		
		
		out.println("clearListItems('formQuotMoreDetails.trade_id'); ");
		ArrayList trade_name = bean.getTrade_id_List(item_code);
		
		HashMap record = new HashMap();
			for(int i=0; i< trade_name.size(); i++) {
				record = (HashMap)trade_name.get(i);
				out.println("addListItem(\"formQuotMoreDetails.trade_id\", \"" + record.get("TRADE_ID") + "\",\"" + record.get("SHORT_NAME") + "\");");
			}
	
	}
	else if(functionType.equals("LOADMANUFACTURER")){
		System.out.println("LOADMANUFACTURER");
		String item_code = request.getParameter("item_code");
		String trade_id = request.getParameter("trade_id");
		
		out.println("clearListItems('formQuotMoreDetails.manufactur_id'); ");
		ArrayList manufacturer_name = bean.getManufacturer_id(trade_id);
		
		HashMap record = new HashMap();
			for(int i=0; i< manufacturer_name.size(); i++) {
				record = (HashMap)manufacturer_name.get(i);
				out.println("addListItem(\"formQuotMoreDetails.manufactur_id\", \"" + record.get("MANUFACTURER_ID") + "\",\"" + record.get("SHORT_NAME") + "\");");
			}
	
	}
	else if(functionType.equals("CLEARVALUES")){
		System.out.println("CLEARVALUES");
		
		out.println("clearListItems('formQuotationDetail.manufactur_id'); ");
		out.println("clearListItems('formQuotationDetail.trade_id'); ");
				...
				try {
						...
						alRecord.add(item_code);
						 ...
						 if(def_uom != null && def_uom != ""){
							...
							out.println("document.getElementById('uom_label_')" + count + ".innerHTML = '" +  def_uom_desc +"'; ");
							...
							if(delivery_uom_code.equals(def_uom)){
								...
								out.println("document.getElementById('dist_conv_fact_')" + count + ".value = '" +  eqvl_value +"'; ");
							}
						 }else{
							...
							out.println("document.getElementById('uom_label_')" + count + ".innerHTML = '" +  "" +"'; ");
						 }
		...
		out.println("document.getElementById('temp_commt').value = '" +  commt_desc +"'; ");
			...
			try{
				...
				String advt_date = request.getParameter("advt_date");
				...
				String quotation_remarks = request.getParameter("quotation_remarks");
				...
				String drug_purchase_date = request.getParameter("drug_purchase_date");
				String clerk_date = request.getParameter("clerk_date");
				String initial_eval_date = request.getParameter("initial_eval_date");
				String qc_res_date = request.getParameter("qc_res_date");
				String checked_date = request.getParameter("checked_date");
				String meeting_date = request.getParameter("meeting_date");
				String after_meeting_date = request.getParameter("after_meeting_date");
				String submitted_date = request.getParameter("submitted_date");
				
				
                bean.setContact_person(contact_person);
				bean.setAdvt_date(advt_date);
				bean.setPmnt_term(pmnt_term);
				bean.setTerms_conditions(terms_conditions);
				bean.setDelivery_mode(delivery_mode);
				bean.setQuotation_remarks(quotation_remarks);
				bean.setApproved_date(approved_date);
				bean.setOpen_date(open_date);
				bean.setClosed_date(closed_date);
				bean.setDrug_purchase_date(drug_purchase_date);
				bean.setClerk_date(clerk_date);
				bean.setInitial_eval_date(initial_eval_date);
				bean.setQc_res_date(qc_res_date);
				bean.setChecked_date(checked_date);
				bean.setMeeting_date(meeting_date);
				bean.setAfter_meeting_date(after_meeting_date);
				bean.setSubmitted_date(submitted_date);
	 	...
	 	try{
				System.out.println("hash in SETSELECTIONCRITERIAVALUES =  "+hash);
				System.out.println("item_code:"+stitem_code);
	...
	else if(functionType.equals("SETEVALUATAIONFACTORVALUES")){
	 	try{
				System.out.println("hash in SETEVALUATAIONFACTORVALUES =  "+hash);
				System.out.println("item_code:"+stitem_code);

				bean.updateEvaluationFactorRecords(stitem_code, hash);
	...
	*/	
			...
			putObjectInBean(bean_id,bean,request);
				...
				if (alItemKeys != null && (alItemKeys.size()>0)) {
					...
					QuotationDetailBean detailBean;
					for (int i=0;	i<totalSize;	i++){
						itemStoreKey = (String) alItemKeys.get(i);
						detailBean = (QuotationDetailBean)hmItemStore.get(itemStoreKey);
		 ...
		 //    String itemcode_reqno = item_code +""+ req_no;
			...
			out.println("document.formQuotationDetail.quotation_uom.value='"+bean.checkForNull(def_uom_code)+"'");
		...
		}else if(functionType.equals("CHECKFORAUTHORIZE"))
		{
			...
			if (resultMap != null) {
				String authorize = (String)resultMap.get("QUOT_APPROVE_ALLOWED_YN");  
