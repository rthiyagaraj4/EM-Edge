...
public final class __amendposearchwindowcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ePO/jsp/AmendPOSearchWindowCriteria.jsp", 1709121582966L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="\' onclick=\"document.formAmendPOSearchWindowCriteria.submit();\" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n\t\t\t\t\t<input type=button name=\"reset\" id=\"reset\" value=\'";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\' style=\"font-family:verdana;width:5em\"  onclick=\"ReloadPurchaseOrderWindow();\"></td>\n\t\t\t</tr>\n\t\t</table>\n\n\t\t<input type=\"hidden\" \tname=\"SQL_ST_ITEM_LOOKUP\" id=\"SQL_ST_ITEM_LOOKUP\"  \tvalue=\"";
	...
	String minusdate	       =    com.ehis.util.DateUtils.minusDate(currentdate,"DMY",locale,7,"d");
            ...
            out.print( String.valueOf(bean.getFacilityList()));
