...
public final class __condemnexpiredbatchesheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/CondemnExpiredBatchesHeader.jsp", 1720269006645L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block24 ="\n\t\t\t\t</b>\n\t\t\t</td>\n\n\t\t\t<td class=ITEMSELECT>\n\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;\n\t\t\t</td>\n\t\t\t<td class=ITEMSELECT>\n\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;\n\t\t\t</td>\n\n\t\t</tr>\n\t\t<tr>\n\t\t\t<td class=ITEMSELECT >\n\t\t\t\t<b>\n\t\t\t\t</b>\n\t\t\t</td>\t\t\t\n\t\t\t<td class=ITEMSELECT  colspan = 5>\n\t\t\t\t <span id=\"adj_remarks\"> \n\t\t\t\t\t<b>\n\t\t\t\t\t\t &nbsp; \n\t\t\t\t\t</b>\n\t\t\t\t</span>\t\t\t\t\n\t\t\t</td>\n\t\t</tr>\n\n\t</table>\n\t<input type=\"hidden\" name=\"adj_doc_no\" id=\"adj_doc_no\" value=\"";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 ="\">\n\t<input type=\"hidden\" name=\"adj_doc_ref\" id=\"adj_doc_ref\" value=\"";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 ="\"> \n\t<input type=\"hidden\" name=\"adj_doc_type_code\" id=\"adj_doc_type_code\" value=\"";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="\">\n\t<input type=\"hidden\" name=\"mode\" id=\"mode\" value=\"";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="\">\t\n\t<!--//Added by Rabbani #Inc no:30304(Bru-HIMS-CRF-185) on 13-NOV-2013 -->\n     <input type=\"hidden\" name=\"hdr_remarks\" id=\"hdr_remarks\" value=\"";
    ...
    private final static java.lang.String  _wl_block31 ="\t</body>\n</html>\n\n";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	bean.setMode(mode); 
            ...
            out.print( String.valueOf(bean.getDoc_type_desc(bean.getDoc_type_code())));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf((bean.getCon_doc_no().equals(""))?"":"/"+bean.getCon_doc_no()));
...
if ( mode.equals( eCommon.Common.CommonRepository.getCommonKeyValue("MODE_INSERT"))){ 
            ...
            out.print( String.valueOf(bean.getAdj_remarks_Desc()));
...
if (!bean.hasAllMandatoryValue()) {
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.ReportExecutedBy.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.TransferExecutedby.label", java.lang.String .class,"key"));
