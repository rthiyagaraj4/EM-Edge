...
public final class __issuereturnframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/IssueReturnFrame.jsp", 1720593009321L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\n\n\t\t<iframe name=\'frameIssueReturnHeader\' id=\'frameIssueReturnHeader\' src=\"../../eST/jsp/IssueReturnHeader.jsp?";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\" frameborder=0 scrolling=\'no\'   noresize style=\'height:13vh;width:100vw\'></iframe>\n\t\t\t<iframe name=\'frameIssueReturnDetail\' id=\'frameIssueReturnDetail\' src=\"../../eST/jsp/IssueReturnDetail.jsp?";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\" frameborder=0 scrolling=\'auto\'   noresize style=\'height:74vh;width:24vw\'></iframe>\n\t\t\t<iframe name=\'frameIssueReturnList\' id=\'frameIssueReturnList\' src=\"../../eST/jsp/IssueReturnListFrame.jsp?";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\" frameborder=0 scrolling=\'no\' noresize style=\'height:74vh;width:74vw\'></iframe>\n\t<!--\n\t\t* @Name - Priya\n\t\t* @Date - 21/12/2009\n\t\t* @Inc# - IN017084\n\t\t* @Desc - To avoid the duplication records display in Modify mode\n\t\t -->\n\t<script>\n\t\tclearMessageFrame();\n\t</script>\n</html>\n\n";
