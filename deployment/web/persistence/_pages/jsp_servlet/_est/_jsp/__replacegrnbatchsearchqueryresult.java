...
public final class __replacegrnbatchsearchqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/ReplaceGRNBatchSearchQueryResult.jsp", 1742883086035L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\" id=\"item_code";
    ...
    private final static java.lang.String  _wl_block18 ="\" id=\"item_desc";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\" >\n\n\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="\" nowrap  value=\"\">";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="</td>\n\t\t\t\t<input type=\"hidden\" name=\"doc_type_code";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\" id=\"doc_type_code";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="\" nowrap   value=\"\">";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="</td>\n\t\t\t\t<input type=\"hidden\" name=\"doc_no";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 ="\" id=\"doc_no";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 ="\" nowrap value=\"\">";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="</td>\n\t\t\t\t<input type=\"hidden\" name=\"doc_srl_no";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="\" id=\"doc_srl_no";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 ="\" >\n\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 ="</td>\n\t\t\t\t<input type=\"hidden\" name=\"pur_uom_desc";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 ="\" id=\"pur_uom_desc";
    private final static byte[]  _wl_block31Bytes = _getBytes( _wl_block31 );

    private final static java.lang.String  _wl_block32 ="\" >\n\t\t\t\t \t<!-- \t\t\t\t\t\n\t\t\t\t\t\t* @Name - Priya\n\t\t\t\t\t\t* @Date - 19/02/2010\n\t\t\t\t\t\t* @Inc# - IN019466\n\t\t\t\t\t\t* @Desc - To right align Replacement Qty, Pending Qty.\t\t\t\t\n\t\t\t\t\t-->\n\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block32Bytes = _getBytes( _wl_block32 );

    private final static java.lang.String  _wl_block33 ="\" nowrap style=\"TEXT-ALIGN:right\"    value=\"\">";
    private final static byte[]  _wl_block33Bytes = _getBytes( _wl_block33 );

    private final static java.lang.String  _wl_block34 ="&nbsp;</td>\n\t\t\t\t<input type=\"hidden\" name=\"rtv_repl_qty";
    private final static byte[]  _wl_block34Bytes = _getBytes( _wl_block34 );

    private final static java.lang.String  _wl_block35 ="\" id=\"rtv_repl_qty";
    private final static byte[]  _wl_block35Bytes = _getBytes( _wl_block35 );

    private final static java.lang.String  _wl_block36 ="&nbsp;</td>\n\t\t\t\t<input type=\"hidden\" name=\"pend_repl_qty";
    private final static byte[]  _wl_block36Bytes = _getBytes( _wl_block36 );

    private final static java.lang.String  _wl_block37 ="\" id=\"pend_repl_qty";
    private final static byte[]  _wl_block37Bytes = _getBytes( _wl_block37 );

    private final static java.lang.String  _wl_block38 ="\" >\n\t\t\t\t<input type=\"hidden\" name=\"rtv_unit_cost";
    private final static byte[]  _wl_block38Bytes = _getBytes( _wl_block38 );

    private final static java.lang.String  _wl_block39 ="\" id=\"rtv_unit_cost";
    private final static byte[]  _wl_block39Bytes = _getBytes( _wl_block39 );

    private final static java.lang.String  _wl_block40 ="\" >\n\n\n\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block40Bytes = _getBytes( _wl_block40 );

    private final static java.lang.String  _wl_block41 ="\" ><input type=\'text\' size=\'5\' name=\"received_qty";
    private final static byte[]  _wl_block41Bytes = _getBytes( _wl_block41 );

    private final static java.lang.String  _wl_block42 ="\" id=\"received_qty";
    private final static byte[]  _wl_block42Bytes = _getBytes( _wl_block42 );

    private final static java.lang.String  _wl_block43 ="\" value=\"\" class=\"NUMBER\" onkeypress = \"allow_restrict_decimals2(this,event);\" onblur=\"checkDoubleFormat(this,true)\"></td>\n\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block43Bytes = _getBytes( _wl_block43 );

    private final static java.lang.String  _wl_block44 ="\" ><input type=\'checkbox\' name=\"close_yn";
    private final static byte[]  _wl_block44Bytes = _getBytes( _wl_block44 );

    private final static java.lang.String  _wl_block45 ="\" id=\"close_yn";
    private final static byte[]  _wl_block45Bytes = _getBytes( _wl_block45 );

    private final static java.lang.String  _wl_block46 ="\" value=\"N\" onClick=\"setValue(";
    private final static byte[]  _wl_block46Bytes = _getBytes( _wl_block46 );

    private final static java.lang.String  _wl_block47 =")\"></td>\n\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block47Bytes = _getBytes( _wl_block47 );

    private final static java.lang.String  _wl_block48 ="\" ><input type=checkbox onClick=\"setCloseValue(";
    private final static byte[]  _wl_block48Bytes = _getBytes( _wl_block48 );

    private final static java.lang.String  _wl_block49 =")\" name=\"check";
    private final static byte[]  _wl_block49Bytes = _getBytes( _wl_block49 );

    private final static java.lang.String  _wl_block50 ="\" id=\"check";
    private final static byte[]  _wl_block50Bytes = _getBytes( _wl_block50 );

    private final static java.lang.String  _wl_block51 ="\" value=\"N\" ></td>\n\t\t\t\t\n\t\t\t\t";
    private final static byte[]  _wl_block51Bytes = _getBytes( _wl_block51 );

    private final static java.lang.String  _wl_block52 ="\n           \t</tr>\n\t\t\t\t\t\t\t\t\n\t\t";
    private final static byte[]  _wl_block52Bytes = _getBytes( _wl_block52 );

    private final static java.lang.String  _wl_block53 =" </table>\n\t\t    <input type=\"hidden\" name=\"start\" id=\"start\"\t\t\tvalue=\"";
...
//out.println(hmBatchRecord);
            ...
            out.print( String.valueOf(hmBatchRecord.get("ITEM_CODE")));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(className));
            _bw.write(_wl_block16Bytes, _wl_block16);
            out.print( String.valueOf(hmBatchRecord.get("ITEM_DESC")));
            ...
            out.print( String.valueOf(bean.checkForNull((String)hmBatchRecord.get("DOC_SRL_NO"))));
            ...
            out.print( String.valueOf(className));
            _bw.write(_wl_block26Bytes, _wl_block26);
            out.print( String.valueOf(bean.checkForNull((String)hmBatchRecord.get("PUR_UOM_DESC"))));
            ...
            out.print( String.valueOf(bean.setNumber(bean.checkForNull((String)hmBatchRecord.get("RTV_REPL_QTY"),"0"),Integer.parseInt(no_deci))));
            _bw.write(_wl_block34Bytes, _wl_block34);
            out.print( String.valueOf(count));
            _bw.write(_wl_block35Bytes, _wl_block35);
            out.print( String.valueOf(count));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(bean.checkForNull((String)hmBatchRecord.get("RTV_REPL_QTY"),"0")));
            _bw.write(_wl_block19Bytes, _wl_block19);
            out.print( String.valueOf(className));
            _bw.write(_wl_block33Bytes, _wl_block33);
            out.print( String.valueOf(bean.setNumber(bean.checkForNull((String)hmBatchRecord.get("PEND_REPL_QTY"),"0"),Integer.parseInt(no_deci))));
            _bw.write(_wl_block36Bytes, _wl_block36);
            out.print( String.valueOf(count));
            _bw.write(_wl_block37Bytes, _wl_block37);
            out.print( String.valueOf(count));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(bean.checkForNull((String)hmBatchRecord.get("PEND_REPL_QTY"),"0")));
            _bw.write(_wl_block38Bytes, _wl_block38);
            out.print( String.valueOf(count));
            _bw.write(_wl_block39Bytes, _wl_block39);
            out.print( String.valueOf(count));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(bean.checkForNull((String)hmBatchRecord.get("RTV_UNIT_COST"),"0")));
...
//putObjectInBean("batchSearchReplaceGRNBean",bean,request);
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.DocSrlNo.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.PurchaseUOM.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag5(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag5.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.ReplacementQty.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag7(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag7.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.ReceivedQuantity.label", java.lang.String .class,"key"));
