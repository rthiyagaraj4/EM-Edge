...
public final class __adjuststock extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/AdjustStock.jsp", 1710485800345L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\n\t\t<script>\n\t\t\t\tparent.workAreaFrame.f_query_add_mod.document.location.href = \"../../eST/jsp/AdjustStockQueryFrame.jsp?mode=2&";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	eST.AdjustStockBean bean = (eST.AdjustStockBean)getBeanObject( "adjustStockBean","eST.AdjustStockBean",request );
	bean.clear();
