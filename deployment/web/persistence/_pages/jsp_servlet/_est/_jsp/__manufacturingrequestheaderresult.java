...
public final class __manufacturingrequestheaderresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/ManufacturingRequestHeaderResult.jsp", 1742813649471L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block18 ="\"><input type=\"checkbox\" ";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 =" name=\"del_";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="\" value=\"\"  ></td>\n\t\t\t<td class=\"";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\"    style=\"WORD-BREAK:BREAK-ALL;\"><a name=\"a_";
    ...
    private final static java.lang.String  _wl_block25 ="\"    nowrap><font size=1>";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 ="</font></td>\n\t\t\t<!-- \t\t\t\t\t\n\t\t\t\t\t\t* @Name - Priya\n\t\t\t\t\t\t* @Date - 19/02/2010\n\t\t\t\t\t\t* @Inc# - IN019466\n\t\t\t\t\t\t* @Desc - To right align Quantity.\t\t\t\t\n\t\t\t\t\t-->\n\t\t\t<td class=\"";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="\"    nowrap  style=\"TEXT-ALIGN:right\"><font size=1>";
    ...
    private final static java.lang.String  _wl_block30 ="\"    nowrap onmouseover=\"onMMove(msg,event,\'";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 ="\')\" onMouseout=\"onMOut(msg);\"  ><font size=1>";
    ...
    private final static java.lang.String  _wl_block39 =".scrollIntoView();\n\tchangeRowColor(document.getElementById(\'tr_\')";
...
//	String index						=		bean.checkForNull(request.getParameter("index"),"-1");
 ...
 //ends
		...
		for	(i	=0;	i<recordSet.size();i++){
            ...
            out.print( String.valueOf(((String)hmRecord.get("SELECTED")).equals("Y")?"checked":""));
            ...
            out.print( String.valueOf(bean.checkForNull((String)hmRecord.get("MFG_ITEM_DESC"),(String)hmRecord.get("SHORT_DESC"))));
            _bw.write(_wl_block24Bytes, _wl_block24);
            out.print( String.valueOf(classvalue));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf(bean.checkForNull((String)hmRecord.get("STOCK_UOM"),"&nbsp;")));
            _bw.write(_wl_block26Bytes, _wl_block26);
            out.print( String.valueOf(classvalue));
            _bw.write(_wl_block27Bytes, _wl_block27);
            out.print( String.valueOf(bean.checkForNull(bean.setNumber((String)hmRecord.get("REQUEST_QTY"),Integer.parseInt(no_deci)),"&nbsp;")));
            _bw.write(_wl_block28Bytes, _wl_block28);
            out.print( String.valueOf(classvalue));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf(bean.checkForNull(preparation_desc,"&nbsp;")));
            ...
            out.print( String.valueOf(patinetName));
            _bw.write(_wl_block31Bytes, _wl_block31);
            out.print( String.valueOf(bean.checkForNull((String)hmRecord.get("PATIENT_ID"),"&nbsp;")));
...
if (request.getParameter("index")!=null) {
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.MFGItem.label", java.lang.String .class,"key"));
