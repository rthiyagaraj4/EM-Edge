...
public final class __srrmedicationlistreportquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/SRRMedicationListReportQueryCriteria.jsp", 1709122191353L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="</td>\n\t\t\t\t<td class=fields >&nbsp;&nbsp;<input type=\'text\' name=\'patient_id\' id=\'patient_id\' size=20 maxLength=\"";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\" value=\"\" ><input type=\'button\' class=\'button\' value=\"?\" onclick=\"callPatientLookup();\"></td>\t \t  \n\t\t\t\t</tr>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t   \n\t\t\t\t<!-- Added if conditions  onblur of dates ==by sandhya-->\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=label align=right>";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="</td>\n\t\t\t\t\t<td class=fields>&nbsp;&nbsp;<input type=text name=p_disp_date_from size=10 maxlength=10 class=\"DATE\" value=\"";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\"  onBlur=\"if(CheckDate(this))if(DateCheck(currentdate,p_disp_date_from))validate_date(this,\'TO_DATE_LESS_FROM\')\"><img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'p_disp_date_from\');\" ></img>&nbsp;<IMG SRC=\"../../eCommon/images/mandatory.gif\" BORDER=\"0\"  ></IMG></td>\t\t\t\t   \n\n\t\t\t\t\t<td  class=\"label\" >";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="<td class=fields colspan=5>&nbsp;&nbsp;<input type=text name=p_disp_date_to size=10 maxlength=10 class=\"DATE\" value=\"";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\"  onBlur=\"if(CheckDate(this))if(DateCheck(currentdate,p_disp_date_to))validate_date(this,\'TO_DATE_LESS_FROM\')\"><img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'p_disp_date_to\');\" ></img>&nbsp;<IMG SRC=\"../../eCommon/images/mandatory.gif\" BORDER=\"0\"  ></IMG></td>\n\t\t\t\t</tr>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t\t\t\t\t   \n                 <tr>\t\t\t\t\t \t\t\t\t   \n\t\t\t     <td class=label align=right>";
    ...
    private final static java.lang.String  _wl_block15 ="<td class=fields colspan=5>&nbsp;&nbsp;<input class=\"NUMBER\" type=\"text\" size=\"12\" maxlength=\"8\" \n\t\t\t\t\t\tonKeyPress=\"return isValidInteger();\" name=\"sale_doc_no_to\" id=\"sale_doc_no_to\" \n\t\t\t\t\t\tonBlur=\"numberValidation(document.forms[0].sale_doc_no_from,this)\" ></td>    \t\t\t\t  \t \t\t\t\t\t\t \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  \n\t\t\t\t</tr>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t   \n\t\t\t\t<tr>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \n\t\t\t<td class=\"label\" align=right>";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="</td>\n\t\t\t\t\t<td class=fields>&nbsp;&nbsp;<select name=\"store\" id=\"store\">";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\t</select>&nbsp;<IMG\t\t\t   SRC=\"../../eCommon/images/mandatory.gif\" BORDER=\"0\"  ></IMG></td>\n                  <td  class=\"label\" ></td>\n\t\t\t\t\t<td  class=\"button\" ><input type=\"button\" name=\"search\" id=\"search\" value=\'";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\' class=\"button\" onClick=\"showResult()\">&nbsp;<input type=\"button\" name=\"print\" id=\"print\" value=\'";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\' class=\"button\" onClick=\"showPrint(\'\');\" disabled></td>\n\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t<td align=\"right\" colspan=4>&nbsp;</td>\n\t\t\t\t</tr>\t\t\t\t\t\t\t\t\t\t\t\t\t\t \n\n\t\t\t   \n\t\t\t\n                \n\t\t\t\t</table>\n\t\t\t\t</td>  \t\t\t\t\t\t\t\t\t\t\t    \n\n\t\t\t\t</tr>\n\t\t\t</table>\n<INPUT TYPE=\"hidden\" name=\"p_facility_id\" id=\"p_facility_id\" VALUE=\"";
   ...
   doc_type_code = (String)((HashMap)bean.fetchRecord("SELECT a.doc_type_code FROM st_trn_doc_type a  WHERE a.facility_id=?  AND a.trn_type ='SAL' ",facility_id)).get("DOC_TYPE_CODE");
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.SalesDocNo.label", java.lang.String .class,"key"));
