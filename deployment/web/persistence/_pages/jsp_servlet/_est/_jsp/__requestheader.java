...
public final class __requestheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/RequestHeader.jsp", 1709122154713L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block29 ="</font></label>&nbsp;&nbsp;<b><img src=\"../../eCommon/images/mandatory.gif\" align=center style=\"";
	...
	String visibility				=		"visibility:hidden"; //Added by Rabbani INC NO:34758(RUT-CRF-0082) on 07/FEB/2013
            ...
            {java.lang.String __page ="../../eST/jsp/StDuoHeader.jsp";
                java.lang.String[][] __queryParams = {{ weblogic.utils.StringUtils.valueOf("mode"), weblogic.utils.StringUtils.valueOf(mode
                        ...
                        )},{ weblogic.utils.StringUtils.valueOf("sales_req_yn"), weblogic.utils.StringUtils.valueOf(sales_req_yn
                        )},};
            ...
            out.print( String.valueOf(req_delete_yn));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(bean.getItem_class_code()));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(locale));
            _bw.write(_wl_block22Bytes, _wl_block22);
            out.print( String.valueOf(bean.checkForNull(bean.getHdrRemarks_Desc(),"")));
            ...
            out.print( String.valueOf(bean.getRequestTypeList()));
