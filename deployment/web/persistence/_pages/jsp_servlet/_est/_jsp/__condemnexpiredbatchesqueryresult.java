...
public final class __condemnexpiredbatchesqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/CondemnExpiredBatchesQueryResult.jsp", 1709122025762L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		try{
            ...
            out.print( String.valueOf(classvalue));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(CommonBean.checkForNull((String)records.get(4),"&nbsb")));
            _bw.write(_wl_block19Bytes, _wl_block19);
            out.print( String.valueOf(classvalue));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(CommonBean.checkForNull((String)records.get(5),"&nbsb")));
