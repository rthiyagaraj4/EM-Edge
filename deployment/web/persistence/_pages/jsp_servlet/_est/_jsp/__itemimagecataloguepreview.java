...
public final class __itemimagecataloguepreview extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/ItemImageCataloguePreview.jsp", 1709122069480L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\" border=0 align=\'center\' >\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr  height=\'5\'>\n\t\t\t\t\t<td  align=\'right\' >\n\t\t\t\t\t\t<input type=\"button\" class=\"button\" name=\"ok\" id=\"ok\" value=\'";
