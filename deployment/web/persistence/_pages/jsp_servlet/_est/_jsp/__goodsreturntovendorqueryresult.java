...
public final class __goodsreturntovendorqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/GoodsReturnToVendorQueryResult.jsp", 1732111576588L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//				  doc_date_conv = com.ehis.util.DateUtils.convertDate(doc_date_conv,"DMY",locale,"en");
            ...
            out.print( String.valueOf(classvalue));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(doc_date_conv));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(classvalue));
