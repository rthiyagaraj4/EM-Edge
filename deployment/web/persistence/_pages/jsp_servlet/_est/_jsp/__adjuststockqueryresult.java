...
public final class __adjuststockqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/AdjustStockQueryResult.jsp", 1709121989684L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="</th><!-- Modified for IN:074037  -->\n\t\t\t\t</tr>\t\t\n\t\t";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		try{
			...
			sqlMap.put("sqlData", eST.Common.StRepository.getStKeyValue("SQL_ST_ADJUST_STOCK_HDR_QUERY_RESULT"));
		...
		out.println(CommonBean.setForm (request ,"../../eST/jsp/AdjustStockQueryResult.jsp", searched));
	}
	catch(Exception e) {
		e.printStackTrace();
	}finally{
