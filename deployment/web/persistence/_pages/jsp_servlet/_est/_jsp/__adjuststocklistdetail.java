...
public final class __adjuststocklistdetail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/AdjustStockListDetail.jsp", 1732630892389L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\" id=\"expiry_date_or_receipt_date_";
    ...
    private final static java.lang.String  _wl_block16 ="\" size=10 maxlength=10 \n\t\t\tonBlur=\"javascript:getBatchIDFromExpiryDate(expiry_date_or_receipt_date_";
    ...
    private final static java.lang.String  _wl_block20 ="\');CheckMaxYearForExpiryDate(this,\'";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\');CheckDateLeap(this,\'DMY\',\'";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\');\" ";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 =">\n\t\t\t\n\t\t\t\t<img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"if (\'";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\' !== \'disabled\') { return showCalendarLocal(\'expiry_date_or_receipt_date_";
    ...
    private final static java.lang.String  _wl_block27 ="\" id=\"batch_id_";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="\" value=\"";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 ="\" oninput=\"this.value = this.value.toUpperCase()\" size=20 maxlength=20 ";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 =" onKeyPress=\"return  CheckForSpecialChars(event);\" >\n\t\t</td>\n\t\t<td class=\'fields\'>\n\t";
    ...
    private final static java.lang.String  _wl_block38 ="\" id=\"bin_location_code_";
    ...
    private final static java.lang.String  _wl_block42 ="\" id=\"item_qty_";
    private final static byte[]  _wl_block42Bytes = _getBytes( _wl_block42 );

    private final static java.lang.String  _wl_block43 ="\" class=\"NUMBER\" onKeyPress=\"return isValidNumber(this,event,7,";
    private final static byte[]  _wl_block43Bytes = _getBytes( _wl_block43 );

    private final static java.lang.String  _wl_block44 =");\" onblur=\"checkDoubleFormat(this);checkDoubleFormatForAllNumbers(this);checkAvlQty(this,\'";
    private final static byte[]  _wl_block44Bytes = _getBytes( _wl_block44 );

    private final static java.lang.String  _wl_block45 ="\')\" size=12 maxlength=12>\n\t\t</td>\n\t</tr>\n\t";
    private final static byte[]  _wl_block45Bytes = _getBytes( _wl_block45 );

    private final static java.lang.String  _wl_block46 ="\t \n\t<tr>\n\t\t<td class=\'fields\'>\n\t\t\t<input type=\'text\' name=\"expiry_date_or_receipt_date_";
    private final static byte[]  _wl_block46Bytes = _getBytes( _wl_block46 );

    private final static java.lang.String  _wl_block47 ="\" size=10 maxlength=10 ";
    private final static byte[]  _wl_block47Bytes = _getBytes( _wl_block47 );

    private final static java.lang.String  _wl_block48 ="  \n\t\t\tonBlur=\"javascript:getBatchIDFromExpiryDate(expiry_date_or_receipt_date_";
    private final static byte[]  _wl_block48Bytes = _getBytes( _wl_block48 );

    private final static java.lang.String  _wl_block49 ="><!--Added CheckDateLeap and locale by B.Badmavathi for SRR20056-SCF-14071 on 22/7/2015-->\n\n\t\t\t";
    ...
    private final static java.lang.String  _wl_block52 =" onKeyPress=\"return  CheckForSpecialChars(event);\" >\n\t\t</td>\n\t\t<td class=\'fields\'>\n\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block57 ="</select>\n\t\t\t\t";
    private final static byte[]  _wl_block57Bytes = _getBytes( _wl_block57 );

    private final static java.lang.String  _wl_block58 ="\n\t\t\t</select>\n\t\t</td>\n\t\t<!-- \t\t\n\t\t\t* @Name - Priya\n\t\t\t* @Date - 13/01/2010\n\t\t\t* @Inc# - 15496 (SRR20056-CRF-0537.2)\n\t\t\t* @Desc - For the field \'item_qty_\' No.of Decimals is passed to isValidNumber function and maxlength is increased to 12, onblur, checkdoubleformat is called.\t\t\t\n\t\t-->\n\t\t<td class=\'fields\'>\n\t\t\t<input type=\'text\' name=\"item_qty_";
    private final static byte[]  _wl_block58Bytes = _getBytes( _wl_block58 );

    private final static java.lang.String  _wl_block59 =");\" onblur=\"checkDoubleFormat(this);checkAvlQty(this,\'";
    private final static byte[]  _wl_block59Bytes = _getBytes( _wl_block59 );

    private final static java.lang.String  _wl_block60 ="\n\t<tr>\n\t\t<td class=\'fields\'>\n\t\t\t<input type=\'text\' name=\"expiry_date_or_receipt_date_";
    private final static byte[]  _wl_block60Bytes = _getBytes( _wl_block60 );

    private final static java.lang.String  _wl_block61 ="\" size=10 maxlength=10 onBlur=\"javascript:getBatchIDFromExpiryDate(expiry_date_or_receipt_date_";
    private final static byte[]  _wl_block61Bytes = _getBytes( _wl_block61 );

    private final static java.lang.String  _wl_block62 =">\n\t\t\t";
    private final static byte[]  _wl_block62Bytes = _getBytes( _wl_block62 );

    private final static java.lang.String  _wl_block63 ="</img>\t\t\t\t\t\t   <!-- Added CheckDateLeap and Locale  by B.Badmavathi for SRR20056-SCF-14071 on 22/7/2015--> \n\t\t\t\t<img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"if (\'";
    private final static byte[]  _wl_block63Bytes = _getBytes( _wl_block63 );

    private final static java.lang.String  _wl_block64 ="></img>\n\t\t\n\t\t</td>\n\t\t<td class=\'fields\'>\n\t\t\t&nbsp;<input type=\'text\' name=\"batch_id_";
    private final static byte[]  _wl_block64Bytes = _getBytes( _wl_block64 );

    private final static java.lang.String  _wl_block65 ="\" oninput=\"this.value = this.value.toUpperCase()\" value=\"";
    private final static byte[]  _wl_block65Bytes = _getBytes( _wl_block65 );

    private final static java.lang.String  _wl_block66 ="\" size=20 maxlength=20 ";
    private final static byte[]  _wl_block66Bytes = _getBytes( _wl_block66 );

    private final static java.lang.String  _wl_block67 =" onKeyPress=\"return  CheckForSpecialChars(event);\" >\n\t\t</td>\n\t\t<td class=\'fields\'>\n\t\t\t";
    ...
    private final static java.lang.String  _wl_block74 ="\" class=\"NUMBER\"onKeyPress=\"return isValidNumber(this,event,7,";
    private final static byte[]  _wl_block74Bytes = _getBytes( _wl_block74 );

    private final static java.lang.String  _wl_block75 ="\')\" size=12 maxlength=12>\n\t\t</td>\n\t</tr>\n\n\t";
    ...
    private final static java.lang.String  _wl_block78 ="\' class=button onclick=\"if(issueUOMQtyChk()) addToList(\'modify\');\"><input type=button name=Cancel value=\'";
    private final static byte[]  _wl_block78Bytes = _getBytes( _wl_block78 );

    private final static java.lang.String  _wl_block79 ="\'  class=button onclick=\"cancel_me();\"></td>\n\t</tr>\n\t";
    private final static byte[]  _wl_block79Bytes = _getBytes( _wl_block79 );

    private final static java.lang.String  _wl_block80 ="\n\t<tr>\n\t\t<td colspan=7 class=WHITE>&nbsp;</td>\n\t</tr>\n\t<tr>\n\t\t<td colspan=3 class=WHITE></td>\n\t\t<td  colspan=2 class=WHITE><input type=button name=\'Add\' id=\'Add\' value=\'";
    private final static byte[]  _wl_block80Bytes = _getBytes( _wl_block80 );

    private final static java.lang.String  _wl_block81 ="\' class=button onclick=\"if(issueUOMQtyChk()) addToList(\'add\');\"><input type=button name=Cancel value=\'";
    private final static byte[]  _wl_block81Bytes = _getBytes( _wl_block81 );

    private final static java.lang.String  _wl_block82 ="\' class=button onclick=\"cancel_me();\"></td>\n\t</tr>\n\t";
	...
	//ends
		...
		String  first=(String)hashDtl.get("first");
		 ...
		 if(adjustment_type.equals("N")){
            ...
            out.print( String.valueOf(i));
            _bw.write(_wl_block28Bytes, _wl_block28);
            out.print( String.valueOf(bean.setNumber(bean.checkForNull((String)item_qty1,"0"),no_of_decimals).replace(".", "")));
...
if(trade_id_applicable_yn.equals("Y")){
            ...
            out.print( String.valueOf(j));
            _bw.write(_wl_block39Bytes, _wl_block39);
            out.print( String.valueOf(bin_location_code_List));
		...
		for(int i=0;i<10;i++) {
            ...
            out.print( String.valueOf(bean.getTradeListDflt(dflt_trade_id.trim())));
...
//putObjectInBean("stHeaderBean",beanHdr,request);
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.Modify.label", java.lang.String .class,"key"));
