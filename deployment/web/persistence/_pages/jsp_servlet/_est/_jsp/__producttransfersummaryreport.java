...
public final class __producttransfersummaryreport extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/ProductTransferSummaryReport.jsp", 1742878527111L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block26 ="\');\"  ><img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'dt_from_1\');\" ></img>&nbsp;&nbsp;&nbsp;&nbsp;</td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td><td class=fields colspan=5>&nbsp;&nbsp;<input type=text name=\'dt_to_1\' id=\'dt_to_1\' size=10 maxlength=10 class=\"DATE\" value=\"\" onBlur=\"CheckDate(this,\'";
...
*/
 ...
 if(restrict_stores_user_access_yn){ 
            ...
            out.print( String.valueOf( eST.Common.StRepository.getStKeyValue("SQL_ST_ITEM_CLASS_LOOKUP")));
