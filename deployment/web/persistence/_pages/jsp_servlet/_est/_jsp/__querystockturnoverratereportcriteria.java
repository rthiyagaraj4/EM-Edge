...
public final class __querystockturnoverratereportcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/QueryStockTurnoverRateReportCriteria.jsp", 1709122133385L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		String bean_id = "queryStockTurnoverRateBean";
		String bean_name = "eST.QueryStockTurnoverRateBean";
	//	String p_report_id = null;
		String facility_id  =  (String) session.getValue( "facility_id" ) ;
	//	String user_name  =  (String) session.getValue( "login_user" ) ;
		
		
		QueryStockTurnoverRateBean bean = (QueryStockTurnoverRateBean)getBeanObject( bean_id, bean_name,request);  
		bean.clear();
    ...
    private boolean _jsp__tag5(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag5.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eST.AccountingPeriod.label", java.lang.String .class,"key"));
