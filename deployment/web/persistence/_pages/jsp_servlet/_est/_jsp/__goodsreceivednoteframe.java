...
public final class __goodsreceivednoteframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/GoodsReceivedNoteFrame.jsp", 1732009010193L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\n\t<!--<frameset rows=\'85,*\'>-->\n\t\t<iframe name=\'frameGoodsReceivedNoteHeader\'\t id=\'frameGoodsReceivedNoteHeader\'\tsrc=\"../../eST/jsp/GoodsReceivedNoteHeader.jsp?";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\" frameborder=0 scrolling=\'no\'  noresize style=\'height:20vh;width:99vw\'></iframe>\n\t\t<!--<frameset cols=\"30%,*\" 58 >-->\n\t\t\t<iframe name=\'frameGoodsReceivedNoteDetail\' id=\'frameGoodsReceivedNoteDetail\'\tsrc=\"../../eST/jsp/GoodsReceivedNoteDetail.jsp?";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\"\t\t\t\t\tframeborder=0 scrolling=\'auto\'   noresize style=\'height:74vh;width:24vw\'></iframe>\n\t\t\t<iframe name=\'frameGoodsReceivedNoteList\' id=\'frameGoodsReceivedNoteList\'\tsrc=\"../../eST/jsp/GoodsReceivedNoteListFrame.jsp?";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\"\t\t\t\t\tframeborder=0 scrolling=\'no\' noresize style=\'height:74vh;width:74vw\'></iframe>\n\t\t<!--</frameset>\n\t</frameset>-->\n\t <!--\n\t\t* @Name - Priya\n\t\t* @Date - 21/12/2009\n\t\t* @Inc# - IN017084\n\t\t* @Desc - To avoid the duplication records display in Modify mode\n\t\t -->\n\t<script>\n\t\tclearMessageFrame();\n\t</script>\n</html>\n \n";
