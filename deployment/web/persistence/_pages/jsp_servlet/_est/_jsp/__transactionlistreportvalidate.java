...
import eST.TransactionListReportBean;
import com.ehis.persist.*;
import eCommon.Common.*;
import java.lang.*;
import java.util.*;

public final class __transactionlistreportvalidate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/est/jsp/TransactionListReportValidate.jsp", 1719302251655L ,"10.3.6.0","Asia/Calcutta")) return true;
