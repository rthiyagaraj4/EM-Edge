...
public final class __patsrchnataltidcomponentvalues extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/PatSrchNatAltIDComponentValues.jsp", 1729577663620L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block19 ="\';\n\t\t\t\t\t\t\tif(document.getElementById(\"nationality_desc_hid\"))\n\t\t\t\t\t\t\t\tdocument.getElementById(\"nationality_desc_hid\").value=\'";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="\';\t\t\t\t\t\t\t\n\t\t\t\t\t\t\tif(document.getElementById(\"Nationality_hid\"))\n\t\t\t\t\t\t\t\tdocument.getElementById(\"Nationality_hid\").value=\'";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\';\n\t\t\t\t\t\t\tif(document.getElementById(\"ethnic_group_hid\"))\n\t\t\t\t\t\t\t\tdocument.getElementById(\"ethnic_group_hid\").value=\'";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\';\n\t\t\t\t\t\t\tif(document.getElementById(\"ethnic_group_desc\"))\n\t\t\t\t\t\t\t\tdocument.getElementById(\"ethnic_group_desc\").value=\'";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="\';\n\t\t\t\t\t\t\tif(document.getElementById(\"ethnic_group_desc_hid\"))\n\t\t\t\t\t\t\t\tdocument.getElementById(\"ethnic_group_desc_hid\").value=\'";
    ...
    private final static java.lang.String  _wl_block48 ="\',\'MP\');\n\t\t\t\t\t\t\tvar val = msg.replace(\"#\",\'";
    ...
    private final static java.lang.String  _wl_block52 ="\',\'MP\');\n\t\t\t\t\t\t\talert(msg);\t\n\t\t\t\t\t\t\tdocument.forms[0].National_Id_No.value=\'\';\n\t\t\t\t\t\t\tdocument.forms[0].National_Id_No.focus();\n\n\t\t\t\t\t\t\t";
...
//						String religion_code=rset3.getString("RELIGION_CODE")==null?"":rset3.getString("RELIGION_CODE");//checkstyle changes - 35886
	//					String religion_desc=rset3.getString("RELIGION_DESC")==null?"":rset3.getString("RELIGION_DESC");
		...
		if(!patient_id.equals("") && nat_id_no.equals(""))//Condition is changed for ML-MMOH-SCF-1462 BY KAMATCHI S on 17-AUG-2020
		{
