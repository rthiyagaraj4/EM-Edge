...
public final class __regpatreferralnotes extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/RegPatReferralNotes.jsp", 1709118716449L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\' onClick=\"returnText(\'O\')\"><input type=\"button\" class=BUTTON value=\'";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\' onClick=\"returnText(\'C\')\"></td>\n\t</tr>\n\t</table>\n\n<script language=\"JavaScript\">\n<!--\n\tvar a = window.dialogArguments;\n\tif(a != \'\')\n\t\t\tdocument.getElementById(\"ref_notes\").value = a;\n//-->\n</script>\n<script src=\'../../eCommon/js/showModalDialog.js\' language=\'JavaScript\'></script>\n\n</body>\n</html>\n\n";
