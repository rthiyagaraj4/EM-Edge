...
public final class __patnumforrelpopulation extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/PatNumForRelPopulation.jsp", 1709118687887L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="\n\t\t        <script>\n\t\t\t\t \n\t\t\t\t     //top.content.frames[1].frames[1].document.forms[0].SeparatorValue.value=\"";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\";\n\t\t\t\t     parent.frames[1].document.forms[0].SeparatorValue.value=\"";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\";\n\t\t\t\t\t//top.content.frames[1].frames[1].document.forms[0].SeparatorPosition.value=\"";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\";\n\t\t\t\t\tparent.frames[1].document.forms[0].SeparatorPosition.value=\"";
	   ...
	   if(!pat_ser_grp_code.equals(""))
		{
            ...
            out.print( String.valueOf(separator_value));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(separator_value));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(separator_position1));
