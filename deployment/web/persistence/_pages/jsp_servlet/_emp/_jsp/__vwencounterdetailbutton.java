...
public final class __vwencounterdetailbutton extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/vwEncounterDetailButton.jsp", 1709118765386L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\' onclick=\'close_me()\' ></TD>\n</TR>\n</TABLE>\n</FORM>\t\t\t\t\t\t\t\t\t\t\t\t\t\n</body>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n</html>\n\n";
