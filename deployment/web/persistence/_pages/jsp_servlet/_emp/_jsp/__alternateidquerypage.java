...
public final class __alternateidquerypage extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/AlternateIDQueryPage.jsp", 1709116986548L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	//	con = (Connection) session.getValue( "connection" );
		...
		firstItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.AlternateIDType.label","mp_labels"));	  // label
		firstItem.add("alt_id_type");	//name of field
		...
		secondItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.AlternateIDDesc.label","mp_labels"));  // label
		...
		*/
		...
		orderByCols[0] = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.AlternateIDType.label","mp_labels");
		orderByCols[1] = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.AlternateIDDesc.label","mp_labels");

		orderByColVals[0] = "alt_id_type";
		orderByColVals[1] = "long_desc";

		strbuff = qrypg.getQueryPage(con,finAr,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMP.AlternateIDType.label","mp_labels"),"../jsp/queryAlternateID.jsp",com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.SortOrder.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.QueryCriteria.label","common_labels"),com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.defaultSelect.label","common_labels") ,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.orderBy.label","common_labels"),orderByCols, orderByColVals,com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.ExecuteQuery.label","common_labels"));
