...
public final class __newbornmotherbabylinktools extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emp/jsp/NewbornMotherBabyLinkTools.jsp", 1742375369259L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\' onClick=\"toNewBornMain(\'\', \'C\',\'";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\')\"></td>\n\t\t<td><input type=button class=button value=\'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\'  onClick=\"toNewBornMain(\'";
    ...
    private final static java.lang.String  _wl_block14 ="\n\t\t<td class=\'BODYCOLORFILLED\'><input type=button class=button value=\'";
