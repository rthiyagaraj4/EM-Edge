...
public final class __staffprofilesetupshowexpltext extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ers/jsp/StaffProfileSetupShowExplText.jsp", 1709121662980L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\n\n<body  onload=\'FocusFirstElement()\' onMouseDown=\"CodeArrest()\" onKeyDown=\"lockKey()\" >\n<form name=form_ExplanatoryText>\n\t<table cellpadding=0 cellspacing=0 border=\'0\' width=\"100%\" height=\"100%\" align=\"center\">\n\t<tr>\n\t\t<td >&nbsp;&nbsp;<TEXTAREA NAME=\"explanatory_text\" ROWS=\"8\" COLS=\"43\"      ALIGN=\'ABSMIDDLE\' readonly>";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="</TEXTAREA>\n\t\t</td>\n\t\t\n</tr>\n <tr>\t\n\t<td  align=\'right\' valign=\'bottom\'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=button name=ok align=\'right\' value=\'";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\'onclick=\"window.close()\" class=\"BUTTON\"></td>\n</tr> \n</table>\n</form>\n\t</body>\n\n</html>\n";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	try{
		...
		if(expl_txt == null || expl_txt.equals("null")) expl_txt =" "; else expl_txt = expl_txt.trim();
            ...
            out.print( String.valueOf(expl_txt));
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.ExplanatoryText.label", java.lang.String .class,"key"));
