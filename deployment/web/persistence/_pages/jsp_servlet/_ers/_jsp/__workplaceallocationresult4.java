...
public final class __workplaceallocationresult4 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ers/jsp/WorkplaceAllocationResult4.jsp", 1709121669636L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block34 ="\n\n<tr >\n\t\t<td class=\'EmptyEven\' width=\'3%\' nowrap><b>";
    private final static byte[]  _wl_block34Bytes = _getBytes( _wl_block34 );

    private final static java.lang.String  _wl_block35 ="\n\t\t\t\t<td class=\"";
    private final static byte[]  _wl_block35Bytes = _getBytes( _wl_block35 );

    private final static java.lang.String  _wl_block36 ="\" width=\'3%\' align=\'center\' id=";
    ...
    private final static java.lang.String  _wl_block45 ="\"  width=\'3%\' align=\'center\'>&nbsp;";
    private final static byte[]  _wl_block45Bytes = _getBytes( _wl_block45 );

    private final static java.lang.String  _wl_block46 ="\n\t\t<td class=\'";
    private final static byte[]  _wl_block46Bytes = _getBytes( _wl_block46 );

    private final static java.lang.String  _wl_block47 ="\'  width=\'3%\'>&nbsp;&nbsp; </td>\n\t\t";
...
try{
		...
		statement.execute() ;
			...
			//sql_wp_allocation_det="select b.workplace_desc,c.short_desc shift_desc, d.position_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff)  allocated from rs_work_schedule_summ a, rs_workplace b, am_shift c, am_position d where a.facility_id = ? and (? is null or a.workplace_code = ?) and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' and d.position_code = a.position_code group by b.workplace_desc, c.short_desc, d.position_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') order by b.workplace_desc, c.short_desc, d.position_desc, sch_date ";
			//sql_wp_allocation_det="select b.workplace_desc,c.short_desc shift_desc, d.position_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff)  allocated from rs_work_schedule_summ a, rs_workplace_lang_vw b, am_shift_lang_vw c, am_position_lang_vw d where a.facility_id = ? and (? is null or a.workplace_code = ?) and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' and d.position_code = a.position_code group by b.workplace_desc, c.short_desc, d.position_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') and b.language_id = ? and c.language_id = b.language_id and d.language_id = b.language_id order by b.workplace_desc, c.short_desc, d.position_desc, sch_date";
		...
		stmt_wp_allocation_det.setString(8,new_from_date);
...
int aa_sh[]=new int[15];
int rr_sh[]=new int[15];
...
{		
	...
	{ 
            ...
            _bw.write(_wl_block32Bytes, _wl_block32);
				...
				while (wp_temp.equals(wp) && sh_temp.equals(sh) && pos_temp.equals(pos) && flag.equals("1"))
				{ 
            ...
            out.print( String.valueOf(a[kkk]));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(r[kkk]));
            _bw.write(_wl_block39Bytes, _wl_block39);

if((aa_sh[kkk]==0) && (rr_sh[kkk]==0))
{
	aa_sh[kkk]=all;
	rr_sh[kkk]=req;
}
...
{
	aa_sh[kkk]=aa_sh[kkk]+all;
	rr_sh[kkk]=rr_sh[kkk]+req;
}
					borderc = "";				
					}else{
		...
		if((a[kkk1]!=null) && (r[kkk1]!=null)){
				 ...
				 if(( aa_sh[kkk1] == 0 ) && ( rr_sh[kkk1] == 0 ))
					{
					 classval1   =   "DEFAULT";
					}
		
            _bw.write(_wl_block44Bytes, _wl_block44);
            out.print( String.valueOf(classval1));
            _bw.write(_wl_block45Bytes, _wl_block45);
            out.print( String.valueOf(aa_sh[kkk1]));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(rr_sh[kkk1]));
            _bw.write(_wl_block12Bytes, _wl_block12);
 
			if(aa_wp[kkk1]==0)
			{
				aa_wp[kkk1]=aa_sh[kkk1];
				rr_wp[kkk1]=rr_sh[kkk1];
			}
			else
			{
				aa_wp[kkk1]=aa_wp[kkk1]+aa_sh[kkk1];
				rr_wp[kkk1]=rr_wp[kkk1]+rr_sh[kkk1];
			}	
		}
		else
		{
	...
	wp_temp = wp;
		...
		for(int kkk1=0;kkk1<14;kkk1++){
           if((a[kkk1]!=null) && (r[kkk1]!=null)){
            ...
            _bw.write(_wl_block44Bytes, _wl_block44);
            out.print( String.valueOf(classval2));
            _bw.write(_wl_block45Bytes, _wl_block45);
            out.print( String.valueOf(aa_wp[kkk1]));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(rr_wp[kkk1]));
            _bw.write(_wl_block12Bytes, _wl_block12);
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eRS.TotalByWorkPlace.label", java.lang.String .class,"key"));
