...
public final class __workplaceallocationresult10 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ers/jsp/WorkplaceAllocationResult10.jsp", 1709121669042L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block39 =" width=\'3%\' align=\'center\' id=";
    ...
    private final static java.lang.String  _wl_block44 =" width=\'3%\'>&nbsp;&nbsp;\n\t\t\t\t\t";
    ...
    private final static java.lang.String  _wl_block48 =" width=\'3%\' align=\'center\'>&nbsp;";
    private final static byte[]  _wl_block48Bytes = _getBytes( _wl_block48 );

    private final static java.lang.String  _wl_block49 ="\n\t\t<td class=\"";
    private final static byte[]  _wl_block49Bytes = _getBytes( _wl_block49 );

    private final static java.lang.String  _wl_block50 ="\"  width=\'3%\'>";
    ...
    private final static java.lang.String  _wl_block55 ="  width=\'3%\' align=\'center\'>&nbsp;";
    private final static byte[]  _wl_block55Bytes = _getBytes( _wl_block55 );

    private final static java.lang.String  _wl_block56 ="\n\t\t<td class=\'EmptyCell\'  width=\'3%\' align=\'center\'>&nbsp;&nbsp;</td>\n\t\t";
    private final static byte[]  _wl_block56Bytes = _getBytes( _wl_block56 );

    private final static java.lang.String  _wl_block57 ="\n\t\t<td class=\'EmptyCell\'  width=\'3%\'>&nbsp; </td>\n\t\t";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		statement2.execute() ;
			...
			//sql_wp_allocation_det="select d.position_desc, b.workplace_desc, c.short_desc shift_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace b, am_shift c, am_position d where a.facility_id = ? and (? is null or a.workplace_code = ?) and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' and d.position_code = a.position_code group by d.position_desc, b.workplace_desc, c.short_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') order by d.position_desc, b.workplace_desc, shift_desc, sch_date"; 
			sql_wp_allocation_det="select d.position_desc, b.workplace_desc, c.short_desc shift_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace_lang_vw b, am_shift_lang_vw c, am_position_lang_vw d where a.facility_id = ? and (? is null or a.workplace_code = ?) and a.schedule_date between to_date(?,'dd/mm/yyyy') and (to_date(?,'dd/mm/yyyy')) and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' and d.position_code = a.position_code and b.language_id = ? and c.language_id = b.language_id and d.language_id = b.language_id group by d.position_desc, b.workplace_desc, c.short_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') order by d.position_desc, b.workplace_desc, shift_desc, sch_date"; 
...
int total_wp[]=new int[15];
int total_wp11[]=new int[15];
...
{		
	...
	{ 
		...
		while (pos_temp.equals(pos) && wp_temp.equals(wp)&& flag.equals("1"))
				{ 
					for(int y = 0; y<14; y++)
					cell_no1[y] = -1; 
            ...
            _bw.write(_wl_block36Bytes, _wl_block36);
				...
				while (pos_temp.equals(pos) && wp_temp.equals(wp) && sh_temp.equals(sh)&& flag.equals("1"))
				{ 
            ...
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(n[kkk]));
            _bw.write(_wl_block42Bytes, _wl_block42);

					if(total_wp[kkk]==0){
					total_wp[kkk]=m[kkk];
					total_wp11[kkk]=total_wp11[kkk]+n[kkk];
					}
				else
					{
					total_wp[kkk]=total_wp[kkk]+m[kkk];
					total_wp11[kkk]=total_wp11[kkk]+n[kkk];
					}	
					borderc = "";				
					}else{
		...
		for(int kkk1=0;kkk1<14;kkk1++){
			String disp=total_wp[kkk1]+"/"+total_wp11[kkk1];
		if(total_wp[kkk1]!=0 && total_wp11[kkk1]!=0){
		if(total_wp[kkk1] == total_wp11[kkk1])
		{
			classval	=	"OPTIMAL";
		}
		if(total_wp[kkk1] > total_wp11[kkk1])
		...
		if(( total_wp[kkk1] == 0 ) && ( total_wp11[kkk1] == 0 ))
		{
			...
			if(total_pos[kkk1]==0){
					total_pos[kkk1]=total_wp[kkk1];
					total_pos11[kkk1]=total_pos11[kkk1]+total_wp11[kkk1];
				}
				else
					{
					total_pos[kkk1]=total_pos[kkk1]+total_wp[kkk1];
					total_pos11[kkk1]=total_pos11[kkk1]+total_wp11[kkk1];
					}	
		}
		else if(total_wp[kkk1]==0 && total_wp11[kkk1]!=0)
		{
			if(total_wp[kkk1] == total_wp11[kkk1])
		{
			classval	=	"OPTIMAL";
...
if(rs_wp_allocation_det != null)
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eRS.TotalByWorkPlace.label", java.lang.String .class,"key"));
