...
public final class __searchstafffetchotherstafftype extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ers/jsp/SearchStaffFetchOtherStaffType.jsp", 1709121650605L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	{	
		...
		sql="Select other_staff_type, short_desc from am_other_staff_type_lang_vw where language_id = ? and eff_status = 'E' order by short_desc";

		comp="parent.document.frames[1].document.forms[0].p_other_staff_type";			
