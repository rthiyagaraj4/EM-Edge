...
public final class __workplaceallocationresult3 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ers/jsp/WorkplaceAllocationResult3.jsp", 1709121669449L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block46 ="\"  width=\'3%\' align=\'center\'>&nbsp;";
    private final static byte[]  _wl_block46Bytes = _getBytes( _wl_block46 );

    private final static java.lang.String  _wl_block47 ="\n\t\t<td class=\'";
    private final static byte[]  _wl_block47Bytes = _getBytes( _wl_block47 );

    private final static java.lang.String  _wl_block48 ="\'  width=\'3%\'>&nbsp;&nbsp; </td>\n\t\t";
...
try{
		...
		statement.execute() ;
			...
			//sql_wp_allocation_det="select b.workplace_desc,c.short_desc shift_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace b, am_shift c where a.facility_id = ? and (? is null or a.workplace_code =?)  and a.schedule_date between to_date(?,'dd/mm/yyyy') and to_date(?,'dd/mm/yyyy') and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' group by b.workplace_desc, c.short_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') order by b.workplace_desc,c.short_desc, sch_date ";
			//sql_wp_allocation_det="select b.workplace_desc,c.short_desc shift_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace_lang_vw b, am_shift_lang_vw c where a.facility_id = ? and (? is null or a.workplace_code =?)  and a.schedule_date between to_date(?,'dd/mm/yyyy') and to_date(?,'dd/mm/yyyy') and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' group by b.workplace_desc, c.short_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy') and b.language_id = ? and c.language_id = b.language_id order by b.workplace_desc,c.short_desc, sch_date ";
			sql_wp_allocation_det="select b.workplace_desc,c.short_desc shift_desc, trunc(a.schedule_date) sch_date,(trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')) cell_no, sum(a.required_staff) required, sum(a.allocated_staff) allocated from rs_work_schedule_summ a, rs_workplace_lang_vw b, am_shift_lang_vw c where a.facility_id = ? and (? is null or a.workplace_code =?)  and a.schedule_date between to_date(?,'dd/mm/yyyy') and to_date(?,'dd/mm/yyyy') and b.facility_id = a.facility_id and b.workplace_code = a.workplace_code and c.shift_code = a.shift_code and c.shift_indicator = 'P' and b.language_id = ? and c.language_id = b.language_id group by b.workplace_desc, c.short_desc, trunc(a.schedule_date), trunc(a.schedule_date) - to_date(?,'dd/mm/yyyy')  order by b.workplace_desc,c.short_desc, sch_date ";
        try
    	{
