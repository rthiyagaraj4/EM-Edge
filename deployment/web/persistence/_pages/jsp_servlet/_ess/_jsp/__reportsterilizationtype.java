...
public final class __reportsterilizationtype extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ReportSterilizationType.jsp", 1734898981064L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\n\t\n\t<body onLoad=\"FocusFirstElement();\" onMouseDown=\'CodeArrest();\'>\n\t\t<form name=\"formReportSterilizationType\" id=\"formReportSterilizationType\" action=\"../../eCommon/jsp/report_options.jsp\"  target=\"messageFrame\" >\n\t\t<br><br>\n\t\t<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\'100%\' align=\'center\' >\n\t\t\t<tr>\n\t\t\t<td width=\'100%\' align=\'center\' class=\"WHITE\">\n\t\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" width=\"70%\" align=\"center\" border=\"0\">\n\t\t\t\t<th colspan=4 align=left>";
    ...
    private final static java.lang.String  _wl_block14 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input maxLength=4 size=4 name=\"p_fm_code\" id=\"p_fm_code\" value=\"\"  ><input class=\"button\" onClick=\"return searchCodeSterilizationType(p_fm_code);\" type=\"button\" value=\"?\"></td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input maxLength=4 size=4 name=\"p_to_code\" id=\"p_to_code\" value=\"\"  ><input class=\"button\" onClick=\"return searchCodeSterilizationType(p_to_code);\" type=\"button\" value=\"?\"></td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t\t<td align=\"right\">&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\" class=\"label\" >";
...
//		String p_report_id = null;
		...
		bean.clear();
            ...
            out.print( String.valueOf(bean.getOrderBySterilizationType()));
