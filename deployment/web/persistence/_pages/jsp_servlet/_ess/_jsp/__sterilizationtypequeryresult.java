...
public final class __sterilizationtypequeryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/SterilizationTypeQueryResult.jsp", 1709121885727L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	try{
		...
		sterile_type = CommonBean.checkForNull(sterile_type).trim()+"%";
		long_desc = CommonBean.checkForNull(long_desc).trim()+"%";
		eff_status = CommonBean.checkForNull(eff_status);

		HashMap sqlMap = new HashMap();
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_STERILIZATION_TYPE_QUERY_RESULT"));
		...
		displayFields.add("sterile_life");
            ...
            _bw.write(_wl_block18Bytes, _wl_block18);
						 ...
						 //if gif has to be provided
							if(colCount == 4) {
								...
								out.println("align='right'>"+CommonBean.checkForNull((String)records.get( colCount ),"&nbsp;"));
							}
							else {
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/SterilizationTypeQueryResult.jsp", searched) );
	}
	catch(Exception e) {
