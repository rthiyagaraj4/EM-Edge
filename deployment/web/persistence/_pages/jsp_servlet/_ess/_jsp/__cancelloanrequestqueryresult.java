...
public final class __cancelloanrequestqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/CancelLoanRequestQueryResult.jsp", 1709121779571L ,"10.3.6.0","Asia/Calcutta")) return true;
...
*/
	...
	try{
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_LOAN_REQUEST_HDR_QUERY_RESULT_CANCEL") );
		...
		if((result.size()>=3) && (!(((String) result.get(0)).equals("0")))){
            ...
            out.print( String.valueOf((colCount==1)?"right":((colCount==2)?"center":"")));
