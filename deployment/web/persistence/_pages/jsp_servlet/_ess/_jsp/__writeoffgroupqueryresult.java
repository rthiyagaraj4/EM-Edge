...
public final class __writeoffgroupqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/WriteOffGroupQueryResult.jsp", 1709121914289L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	try{
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_WRITE_OFF_HDR_QUERY_RESULT") );
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/WriteOffGroupQueryResult.jsp", searched) );
	}
	catch(Exception e) {
