...
public final class __rofentryqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ROFEntryQueryResult.jsp", 1709121871555L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="</th>\n\t\t\t\t\t<th width=\"100\">Prepare Doc No</th>\n\t\t\t\t\t<th width=\"100\">";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		try{
			...
			sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_ROF_HDR_ENTRY_QUERY_RESULT"));
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/ROFEntryQueryResult.jsp", searched) );
	}
	catch(Exception e) {
