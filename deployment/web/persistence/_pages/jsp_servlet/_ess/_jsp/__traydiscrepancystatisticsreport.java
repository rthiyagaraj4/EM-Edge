...
public final class __traydiscrepancystatisticsreport extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/TrayDiscrepancyStatisticsReport.jsp", 1734936291568L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block15 ="\');\" >&nbsp;<img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'p_fm_doc_date1\');\"></img></td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input maxLength=10 size=10 name=\"p_to_doc_date1\" id=\"p_to_doc_date1\" value=\"\" onBlur=\"CheckDate(this,\'";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\');\"    >&nbsp;<img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'p_to_doc_date1\');\"></img></td>\n\t\t\t\t</tr>\n\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td  class=\"label\">";
    ...
    private final static java.lang.String  _wl_block18 ="</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input class=\"NUMBER\" maxLength=8 size=8 name=\"p_fm_tray_no\" id=\"p_fm_tray_no\" value=\"\" onKeyPress=\"return isValidInteger(event);\" onBlur=\"checkIntegerFormat(this);\"  ></td>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td class=label>&nbsp;&nbsp;<input class=\"NUMBER\" maxLength=8 size=8 name=\"p_to_tray_no\" id=\"p_to_tray_no\" value=\"\" onKeyPress=\"return isValidInteger(event);\" onBlur=\"checkIntegerFormat(this);\"  ></td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td >&nbsp;</td>\n\t\t\t\t\t<td >&nbsp;</td>\n\t\t\t\t\t<td >&nbsp;</td>\n\t\t\t\t\t<td >&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t</table>\n\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\t\n\t\t\t<input type=\"hidden\" name=\"P_facility_id\" id=\"P_facility_id\"\t\t\t\tvalue=\"";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\">\n\t\t\t<input type=\"hidden\" name=\"p_report_id\" id=\"p_report_id\"\t\t\t\t\tvalue=\"SSBTRYDS\">\n\t\t\t<input type=\"hidden\" name=\"p_fm_doc_date\" id=\"p_fm_doc_date\"\t\t\t\tvalue=\"\">\n\t\t\t<input type=\"hidden\" name=\"p_to_doc_date\" id=\"p_to_doc_date\"\t\t\t\tvalue=\"\">\n\t\t\t<input type=\"hidden\" name=\"p_module_id\" id=\"p_module_id\"\t\t\t\t\tvalue=\"SS\">\n\t\t\t<input type=\"hidden\" name=\"p_user_name\" id=\"p_user_name\"\t\t\t\t\tvalue=\"";
