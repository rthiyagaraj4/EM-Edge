...
public final class __writeoffreasonqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/WriteOffReasonQueryResult.jsp", 1709121916242L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	String classvalue					=	"";
	try{
		write_off_reason_code			=	CommonBean.checkForNull(write_off_reason_code)+"%";
		long_desc						=	CommonBean.checkForNull(long_desc)+"%";
		eff_status						=	CommonBean.checkForNull(eff_status);

		HashMap sqlMap					=	new HashMap();
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_WRITE_OFF_REASON_QUERY_RESULT"));
		HashMap funcMap					=	new HashMap();

		//The fields are going to be display
		ArrayList displayFields			=	new ArrayList();

		displayFields.add("write_off_reason_code");
		...
		chkFields.add( write_off_reason_code);
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/WriteOffReasonQueryResult.jsp", searched) );
	}
	catch(Exception e) {
