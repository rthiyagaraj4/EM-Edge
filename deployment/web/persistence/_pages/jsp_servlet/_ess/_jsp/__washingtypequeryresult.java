...
public final class __washingtypequeryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/WashingTypeQueryResult.jsp", 1709121911851L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	try{
		washing_type			= CommonBean.checkForNull(washing_type)+"%";
		long_desc				= CommonBean.checkForNull(long_desc)+"%";
		eff_status				= CommonBean.checkForNull(eff_status);

		HashMap sqlMap			=	new HashMap();
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_WASHING_TYPE_QUERY_RESULT"));
		HashMap funcMap = new HashMap();

		ArrayList displayFields = new ArrayList();
		displayFields.add("washing_type");
		displayFields.add("long_desc");
		displayFields.add("short_desc");
		displayFields.add("eff_status");

		ArrayList chkFields = new ArrayList();
		chkFields.add( washing_type);
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/WashingTypeQueryResult.jsp", searched) );
	}
	catch(Exception e) {
