...
public final class __returngroupqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ReturnGroupQueryResult.jsp", 1709121861383L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		try{
			...
			sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_RETURN_HDR_QUERY_RESULT"));
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/ReturnGroupQueryResult.jsp", searched) );
	}
	catch(Exception e) {
