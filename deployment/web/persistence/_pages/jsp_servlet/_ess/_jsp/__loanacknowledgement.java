...
public final class __loanacknowledgement extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/LoanAcknowledgement.jsp", 1729592024025L ,"10.3.6.0","Asia/Calcutta")) return true;
...
*/
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
	 ...
	 System.out.println("source"+source);
		...
		if(!(bean.getLoanAckReqd())) {
			out.println("<script>alert(getMessage('LOAN_ACK_NOT_APPLICABLE','SS'));window.location.href ='../../eCommon/jsp/dmenu.jsp;'</script>");
		}	
