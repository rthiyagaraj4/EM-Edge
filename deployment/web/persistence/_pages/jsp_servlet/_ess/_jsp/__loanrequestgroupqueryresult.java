...
public final class __loanrequestgroupqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/LoanRequestGroupQueryResult.jsp", 1709121818930L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	try{
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_LOAN_REQUEST_HDR_QUERY_RESULT") );
		...
		if((result.size()>=3) && (!(((String) result.get(0)).equals("0")))){
            ...
            out.print( String.valueOf((colCount==1)?"right":(((colCount==2)||(colCount==6))?"center":"")));
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/LoanRequestGroupQueryResult.jsp", searched) );
	}
	catch(Exception e) {
