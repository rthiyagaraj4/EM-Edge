...
import eSS.TrayNoSearchBean;

public final class __rofentrytrayquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ROFEntryTrayQueryCriteria.jsp", 1709121871789L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="><input type=\"hidden\" value=\"";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\" name=\"group_code\"><input type=\"button\" class=\"BUTTON\" value=\'?\' onClick=\"searchGroupCode(group_code, group_desc);\" ";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		bean.setLanguageId(locale);
            ...
            out.print( String.valueOf(bean.getBinLocations() ));
            _bw.write(_wl_block19Bytes, _wl_block19);
            out.print( String.valueOf(wash_yn));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(pack_yn));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(sterilize_yn));
