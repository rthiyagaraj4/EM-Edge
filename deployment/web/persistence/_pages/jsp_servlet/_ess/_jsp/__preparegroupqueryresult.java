...
public final class __preparegroupqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/PrepareGroupQueryResult.jsp", 1709121840789L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	String sStyle			=	(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		try{
			...
			sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_PREPARE_GROUP_HDR_QUERY_RESULT"));
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/PrepareGroupQueryResult.jsp", searched) );
	}
	catch(Exception e) {
