...
public final class __usagetypequeryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/UsageTypeQueryResult.jsp", 1709121898414L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	try{
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_USAGE_TYPE_QUERY_RESULT"));
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/UsageTypeQueryResult.jsp", searched) );
	}
	catch(Exception e) {
