...
public final class __statisticalgroupqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/StatisticalGroupQueryResult.jsp", 1709121880445L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	String stat_group_code		=	request.getParameter("stat_group_code");
	...
	try{
		...
		stat_group_code			=	CommonBean.checkForNull(stat_group_code)+"%";
		long_desc				=	CommonBean.checkForNull(long_desc)+"%";
		eff_status				=	CommonBean.checkForNull(eff_status);

		HashMap sqlMap			=	new HashMap();
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_STAT_GROUP_QUERY_RESULT") );
		...
		displayFields.add("stat_group_code");
		displayFields.add("long_desc");
		displayFields.add("short_desc");
        displayFields.add("count_components_yn");
		displayFields.add("eff_status");

		//The fields are going to be in where condition * should match with the query
		ArrayList chkFields		=	new ArrayList();
		chkFields.add( stat_group_code);
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/StatisticalGroupQueryResult.jsp", searched) );
	}
	catch(Exception e) {
