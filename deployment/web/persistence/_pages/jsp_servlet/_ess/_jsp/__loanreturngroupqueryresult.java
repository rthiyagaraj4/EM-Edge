...
public final class __loanreturngroupqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/LoanReturnGroupQueryResult.jsp", 1709121824305L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block15 ="\" onmouseover=\"changeCursor(this);\" >\n\t\t\t\t\t\t<font class=\'HYPERLINK\'>  ";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		String entry_completed_yn   =		"N";

		if (request.getParameter("entry_completed_yn") != null) {
			entry_completed_yn		=		request.getParameter("entry_completed_yn");
		}
		...
		try{
			...
			fr_store_code			=		CommonBean.checkForNull(fr_store_code,"%");
			to_store_code			=		CommonBean.checkForNull(to_store_code,"%");

			HashMap sqlMap			=		new HashMap();
			sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_LOAN_RETURN_HDR_QUERY_RESULT"));
			...
			displayFields.add("fr_store_code");
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/LoanReturnGroupQueryResult.jsp", searched) );
	}
	catch(Exception e) {
