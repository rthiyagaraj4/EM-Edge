...
public final class __checklistmain extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/CheckListMain.jsp", 1733391181140L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="&nbsp;&nbsp;</td>-->CheckList Code\n\t\t\t\t\t<td class=\'fields\'>\n\t\t\t\t\t\t<input type=text name=\'checklist_code\' id=\'checklist_code\' oninput=\'this.value = this.value.toUpperCase();\' size=20 maxlength=20 value=\"";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\"  onKeyPress=\"return CheckForSpecChars(event)\" onBlur=\"CheckForSpecCharAlphaCode(this)\" ";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 =">\n\t\t\t\t\t\t<img src=\"../../eCommon/images/mandatory.gif\" align=\"center\"></img>\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n                <tr>\n\t\t\t\t      <td class=label><!--";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="&nbsp;&nbsp;</td>-->CheckList Description<td class=\'fields\'><input type=text name=\'checklist_desc\' id=\'checklist_desc\' size=40 maxlength=60 value=\"";
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		if (mode.equals(eCommon.Common.CommonRepository.getCommonKeyValue("MODE_MODIFY"))) {
		 ...
		 bean.setMode_Temp("MODE_MODIFY");
            ...
            out.print( String.valueOf(checklist_desc));
