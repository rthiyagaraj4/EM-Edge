...
public final class __returngroupheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ReturnGroupHeader.jsp", 1741261350360L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
            ...
            _bw.write(_wl_block2Bytes, _wl_block2);
            eSS.ReturnGroupBean we= null;{
                we=(eSS.ReturnGroupBean)pageContext.getAttribute("we");
                if(we==null){
                    we=new eSS.ReturnGroupBean();
		...
		//To get Entered By User Name from User ID
            ...
            out.print( String.valueOf(docTypeOption));
