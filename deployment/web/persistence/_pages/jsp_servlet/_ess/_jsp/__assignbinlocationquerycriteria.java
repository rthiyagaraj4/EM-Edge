...
public final class __assignbinlocationquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/AssignBinLocationQueryCriteria.jsp", 1709121767447L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		bean.setStore_code(default_store_code);
            ...
            out.print( String.valueOf(bean.getDocTypes(default_doc_type_code)));
            ...
            out.print( String.valueOf(bean.getStores(default_store)));
