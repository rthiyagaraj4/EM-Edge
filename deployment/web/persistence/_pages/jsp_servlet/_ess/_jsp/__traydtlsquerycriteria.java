...
public final class __traydtlsquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/TrayDtlsQueryCriteria.jsp", 1709121894633L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 =" ><input type=\'button\' class=\'BUTTON\' value=\'?\' onClick=\"searchGroupCode(group_code, description);\"  name=\"group_search\" id=\"group_search\" ><input type=\'hidden\' name=\"group_code\" id=\"group_code\" ></td>\n\t\t\t\t\t<td class=label >";
...
//	String facility_id						=		(String) session.getValue("facility_id");
	...
	//end 
            ...
            out.print( String.valueOf(bean.getStatus_List()));
