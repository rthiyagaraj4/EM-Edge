...
public final class __requestgroupqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/RequestGroupQueryResult.jsp", 1709121854774L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	try{
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_REQUEST_HDR_QUERY_RESULT") );
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/RequestGroupQueryResult.jsp", searched) );
	}
	catch(Exception e) {
