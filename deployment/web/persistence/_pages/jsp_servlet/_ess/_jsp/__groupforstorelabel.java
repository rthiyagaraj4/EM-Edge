...
import java.lang.*;
import java.util.*;
import eSS.GroupForStoreBean;

public final class __groupforstorelabel extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/groupforstoreLabel.jsp", 1741326081712L ,"10.3.6.0","Asia/Calcutta")) return true;
