...
public final class __surgerytypequeryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/SurgeryTypeQueryResult.jsp", 1709121889914L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	String classvalue			=	"";
	try{
		SurgeryTypeBean bean = (SurgeryTypeBean)getBeanObject( "surgeryTypeJBean" , "eSS.SurgeryTypeBean", request ) ; 
		...
		sqlMap.put("sqlData", eSS.Common.SsRepository.getSsKeyValue("SQL_SS_SURGERY_TYPE_QUERY_RESULT"));
		...
		displayFields.add("surg_desc");//Added by sakti against KDAH_CRF_0247 surg_desc from OT
		displayFields.add("nature_type");//Added by sakti against KDAH_CRF_0247
		}
...
if(surg_nature_link_to_OT_yn.equals("Y")){
            ...
            _bw.write(_wl_block19Bytes, _wl_block19);
						 ...
						 //if gif has to be provided
							...
							else if(surg_nature_link_to_OT_yn.equals("N") && colCount == 3) {
								out.println(" align=\'center\'>");
								if( ((String)records.get( colCount )).equals("E"))
									out.println("<img src=\'../../eCommon/images/enabled.gif\'></img>");
								else
		...
		out.println(CommonBean.setForm ( request ,"../../eSS/jsp/SurgeryTypeQueryResult.jsp", searched) );
	}
	catch(Exception e) {
