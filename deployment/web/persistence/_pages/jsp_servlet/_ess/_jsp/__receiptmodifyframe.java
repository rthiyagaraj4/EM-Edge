...
public final class __receiptmodifyframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ReceiptModifyFrame.jsp", 1709117485977L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block7 ="\n\t<frameset rows=\'100,*\'>\n\t\t<frame name=\'frameDispatchHeader\'\t\t\t\tsrc=\"../../eSS/jsp/ReceiptAddModify.jsp?";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\" frameborder=0 scrolling=\'no\'   noresize>\n\t\t<frameset cols=\"40%,*\" >\n\t\t\t<frame name=\'frameDispatchDetail\'\t\t\tsrc=\"../../eSS/jsp/ReceiptModifyDetail.jsp?";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\"\t\t\t\t\tframeborder=0 scrolling=\'no\'   noresize>\n<!-- \t\t\t<frameset rows=\"15,*\">\n\t\t\t\t<frame name=\'framePackingListHeader\'\tsrc=\'../../eSS/html/PackingListHeader.html\'\t\t\tframeborder=0 scrolling=\'no\'   noresize>\n -->\t\t\t\t<frame name=\'frameDispatchList\'\t\t\tsrc=\"../../eSS/jsp/ReceiptList.jsp?";
	...
	if( (doc_no!=null) && (doc_type_code!=null) )
	{
		...
		alDispatchRecords=bean.fetchRecords(bean.getSsRepositoryValue("SQL_SS_RECEIPT_ROF_DTL"),alParameters);//out.println(alDispatchRecords);
		...
		//
			for (int i=0;i<alDispatchRecords.size();i++){
				...
				hmDispatchRecord.put("RECEIPT_DATE",	(String)hmDispatchRecord.get("RECEIPTDATE"));
