...
public final class __rofuserdetailsqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ess/jsp/ROFUserDetailsQueryResult.jsp", 1733752185362L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\n\t\t\t<tr onClick=\"changeRowColor(this,8);Modify(\'";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\',\'";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\',this);\" id=\"";
	...
	String service_location_code	=		request.getParameter("def_service_location_code");
...
try{
	...
	sqlMap.put( "sqlData", SsRepository.getSsKeyValue( "SQL_ROF_USER_DETAIL_DETAIL_QUERY"));
	...
	displayFields.add( "rof_status_desc" );
	...
	if( (result.size()>0) && ( !( ((String) result.get(0)).equals("0")) )){
		...
		for(int recCount=2; recCount<result.size(); recCount++)
		{
			...
			String doc_date_disp = (String)records.get(3);
...
//			String link_columns = "1";
			...
			if(records.get(9).equals("Y"))
			{
				classvalue ="PATIENTLINECOLOROTHLANG";}
            ...
            out.print( String.valueOf(CommonBean.checkForNull(doc_date_disp,"&nbsp;")));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(classvalue));
            _bw.write(_wl_block21Bytes, _wl_block21);
	...
	out.println(CommonBean.setForm ( request ,"../../eSS/jsp/ROFUserDetailsQueryResult.jsp", searched) );
} catch(Exception e) {
    ...
    private boolean _jsp__tag5(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag5.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSS.Tray.label", java.lang.String .class,"key"));
