...
public final class __preopindicatoraddmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/PreOpIndicatorAddModify.jsp", 1709120320000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\"  size=\'40\' maxlength=\'40\' onBlur=\"if(this.value!=\'\')callLOVForDISCR_MSR_ID(DISCR_MSR_ID,SHORT_DESC); else DISCR_MSR_ID.value=\'\';\">\n\t<input type=\"button\" class=\"button\" name=\"generic_search\" id=\"generic_search\" value=\"?\" onclick=\"callLOVForDISCR_MSR_ID(DISCR_MSR_ID,SHORT_DESC);\">\n\t<img src=\'../../eCommon/images/mandatory.gif\'>\n\n\t</td>\n</tr>\n<tr>\n\t<td class=label width=\"25%\">\n\t";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\n\t</td>\n\t<td class=\'fields\' width=\"25%\">\n\t<input type=\"text\" name=\"DISCR_MSR_ID\" id=\"DISCR_MSR_ID\" value=\"";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\" size=\'15\' maxlength=\'15\' readonly >\n\t\n\t</td>\n</tr>\n\n</table>\n<input type=\"hidden\" name=\'mode\' id=\'mode\' value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\'>\n<input type=\"hidden\" name=\"DISCR_MSR_ID1\" id=\"DISCR_MSR_ID1\" value=\"";
...
/*if(mode.equals("delete"))
{
	con=ConnectionManager.getConnection(request);
		...
		if(rs!=null && rs.next())
		{
            ...
            out.print( String.valueOf(short_description));
