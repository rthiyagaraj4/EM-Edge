...
public final class __implantsrecord extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/ImplantsRecord.jsp", 1723526174000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block22 =" </td>\n     <td class=\"fields\" width=\'25%\'>\n\t\t<input type=\'text\' name=\'manufacturer\' id=\'manufacturer\' maxlength=\'30\' size=\'20\' ";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 =" > \n\t</td>\n</tr>\n<tr>\n\t <td class=\"label\" width=\'25%\'>";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 =" </td>\n     <td class=\"fields\" width=\'25%\'>\n\t\t<input type=\'text\' name=\'batch\' id=\'batch\' maxlength=\'30\' size=\'20\'  ";
    ...
    private final static java.lang.String  _wl_block28 ="\' onClick=\'assignCodes(document.forms[0].operation);addRow();\' ";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 =" >\n\t\t<input type=\'button\' name=\"btn_cancel\" id=\"btn_cancel\" class=\'button\' value=\'";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 ="\' onClick=\'removeRow();\' ";
    ...
    private final static java.lang.String  _wl_block33 ="\' width=\'100%\' height=\'15\'/> \n\t\t\t\t";
...
String imgUrl="";
	...
	if(tab.equals("record_surgeon")){
		...
		nursing_doc_comp_yn = checkForNull(request.getParameter("nursing_doc_comp_yn"));//taken for not populating picklist values when nursing_doc_comp_yn = "N"
	...
	//String PICK_LIST_DEFINED="SELECT A.OPER_CODE OPR_CODE,C.SHORT_DESC OPR_DESC,A.ITEM_ID ACC_CODE,B.SHORT_DESC ACC_DESC,A.ITEM_QTY TR_NO FROM  OT_PICK_LISTS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.OPERATING_FACILITY_ID = ? AND A.PATIENT_ID = ? AND A.TEAM_DOCTOR_CODE  = ? AND (A.BOOKING_NUM= ? OR A.OPER_NUM = ?) AND A.OPER_CODE = C.OPER_CODE AND NVL(FINALIZED_YN,'N')= 'Y' AND A.ITEM_TYPE = 'S' AND A.ITEM_ID = B.PROSTHESIS_CODE";

 	String PICK_LIST_DEFINED="SELECT A.OPER_CODE OPR_CODE,GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',A.OPER_CODE) OPR_DESC,A.ITEM_ID ACC_CODE,GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.ITEM_ID) ACC_DESC,NVL(A.ITEM_QTY,1) TR_NO FROM  OT_PICK_LISTS A, OT_PROSTHESIS_LANG_VW B, OT_OPER_MAST C WHERE A.OPERATING_FACILITY_ID = ? AND A.PATIENT_ID = ? AND A.TEAM_DOCTOR_CODE  = ? AND (A.BOOKING_NUM= ? OR A.OPER_NUM = ?) AND A.OPER_CODE = C.OPER_CODE AND NVL(FINALIZED_YN,'N')= 'Y' AND A.ITEM_TYPE = 'S' AND A.ITEM_ID = B.PROSTHESIS_CODE AND B.LANGUAGE_ID='"+locale+"' ";
	String PICK_LIST_UNDEFINED="";
	
	//String SQL = "SELECT A.OPER_CODE OPR_CODE, A.OPER_LINE_NUM LN_NUM, B.SHORT_DESC OPR_DESC, A.ACCESSORY_CODE ACC_CODE, C.SHORT_DESC ACC_DESC, A.QUANTITY TR_NO, A.PROSTHESIS_MFR MFR,A.PROSTHESIS_BATCH_NO BTCH, A.REMARKS REMKS FROM OT_SURGICAL_ACCESSORIES A , OT_OPER_MAST B, OT_PROSTHESIS C WHERE A.OPERATING_FACILITY_ID=? AND A.OPER_NUM=? AND A.OPER_CODE=B.OPER_CODE AND A.ACCESSORY_CODE = C.PROSTHESIS_CODE ";
	//Modified against MMS-QH-CRF-0199
	String SQL = "SELECT A.OPER_CODE OPR_CODE, A.OPER_LINE_NUM LN_NUM, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','LONG_DESC','OPER_CODE',A.OPER_CODE)  OPR_DESC, A.ACCESSORY_CODE ACC_CODE, GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.ACCESSORY_CODE) ACC_DESC, A.QUANTITY TR_NO, A.PROSTHESIS_MFR MFR,A.PROSTHESIS_BATCH_NO BTCH, A.REMARKS REMKS,BILL_SUB_REGN_NUM KEY, BILL_SUB_REGN_LINE_NUM KEY_LINE FROM OT_SURGICAL_ACCESSORIES A , OT_OPER_MAST B, OT_PROSTHESIS_LANG_VW C WHERE A.OPERATING_FACILITY_ID=? AND A.OPER_NUM=? AND ACCESSORY_TYPE = 'S' AND  A.OPER_CODE=B.OPER_CODE AND A.ACCESSORY_CODE = C.PROSTHESIS_CODE AND C.LANGUAGE_ID='"+locale+"' ";

	String SQL1 = "SELECT A.OPER_CODE OPR_CODE,A.OPER_LINE_NUM LN_NUM,B.SHORT_DESC OPR_DESC FROM OT_POST_OPER_DTLS A, OT_OPER_MAST B WHERE OPERATING_FACILITY_ID=? AND OPER_NUM=? AND A.OPER_CODE=B.OPER_CODE";
...
// test code ends here */
		...
		out.println("<script>assignRecId()</script>");
			...
			out.println("<script>loadDBRows('"+checkForNull(rst.getString("OPR_CODE"))+"','"+encode(checkForNull(rst.getString("OPR_DESC")))+"','"+line_no+"','"+checkForNull(rst.getString("ACC_CODE"))+"','"+encode(checkForNull(rst.getString("ACC_DESC")))+"','"+checkForNull(rst.getString("TR_NO"))+"','','','','"+index+"','L','2','"+bill_str+"','"+panel_str+"','"+key+"','"+key_line+"'); </script>");	
			}//end of while loop
			if(rst!=null)rst.close();
			if(pstmt!=null)pstmt.close();
			out.println("<script>refresh()</script>");
			out.println("<script>assignRecId()</script>");
				...
				//PICK_LIST_UNDEFINED;
				/*PICK_LIST_UNDEFINED="SELECT A.OPER_CODE OPR_CODE,C.SHORT_DESC OPR_DESC,A.PROSTHESIS_CODE ACC_CODE,B.SHORT_DESC ACC_DESC,A.NO_OF_UNITS TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B,OT_OPER_MAST C WHERE  A.OPER_CODE IN ("+oper_codes.toString()+") AND A.PROSTHESIS_CODE  = B.PROSTHESIS_CODE AND A.OPER_CODE = C.OPER_CODE";*/
				//PICK_LIST_UNDEFINED="SELECT A.OPER_CODE OPR_CODE, C.SHORT_DESC OPR_DESC, A.PROSTHESIS_CODE ACC_CODE,   B.SHORT_DESC ACC_DESC,   A.NO_OF_UNITS TR_NO FROM  OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.APPLICABILITY = 'AOPR' AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE AND C.OPER_CODE IN ("+oper_codes.toString()+") UNION SELECT A.OPER_CODE OPR_CODE, C.SHORT_DESC OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, B.SHORT_DESC ACC_DESC, A.NO_OF_UNITS TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.APPLICABILITY = 'SSPL' AND A.SPECIALITY_CODE   = C.SPECIALITY_CODE AND C.OPER_CODE IN ("+oper_codes.toString()+") AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE UNION SELECT A.OPER_CODE OPR_CODE, C.SHORT_DESC OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, B.SHORT_DESC ACC_DESC,   A.NO_OF_UNITS TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C, OT_OPER_FOR_GROUP_CAT D WHERE A.APPLICABILITY = 'SCAT' AND A.SPECIALITY_CODE = D.OPER_GROUP_CODE AND A.OPER_CAT_CODE = D.OPER_CAT_CODE AND D.OPER_CODE            IN ("+oper_codes.toString()+") AND C.OPER_CODE = D.OPER_CODE AND A.PROSTHESIS_CODE  = B.PROSTHESIS_CODE UNION SELECT A.OPER_CODE OPR_CODE, C.SHORT_DESC OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, B.SHORT_DESC ACC_DESC, A.NO_OF_UNITS TR_NO   FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C, OT_OPER_FOR_GROUP_CAT D WHERE A.APPLICABILITY = 'SSUB'AND A.SPECIALITY_CODE = D.OPER_GROUP_CODE AND  A.OPER_CAT_CODE = D.OPER_CAT_CODE AND A.OPER_SUB_CAT_CODE = D.OPER_SUB_CAT_CODE     AND D.OPER_CODE IN ("+oper_codes.toString()+") AND C.OPER_CODE = D.OPER_CODE      AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE UNION SELECT A.OPER_CODE OPR_CODE, C.SHORT_DESC OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, B.SHORT_DESC ACC_DESC,   A.NO_OF_UNITS TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.APPLICABILITY = 'SOPR' AND A.OPER_CODE IN ("+oper_codes.toString()+") AND A.OPER_CODE = C.OPER_CODE AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE";
				//PICK_LIST_UNDEFINED="SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',C.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE,  GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.PROSTHESIS_CODE) ACC_DESC,   NVL(A.NO_OF_UNITS,1) TR_NO FROM  OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.APPLICABILITY = 'AOPR' AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE AND C.OPER_CODE IN ("+oper_codes.toString()+")   UNION SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',A.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, B.SHORT_DESC ACC_DESC,NVL(A.NO_OF_UNITS,1) TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.APPLICABILITY = 'SSPL' AND A.SPECIALITY_CODE   = C.SPECIALITY_CODE AND C.OPER_CODE IN ("+oper_codes.toString()+") AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE UNION SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',A.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.PROSTHESIS_CODE) ACC_DESC,  NVL(A.NO_OF_UNITS,1) TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C, OT_OPER_FOR_GROUP_CAT D WHERE A.APPLICABILITY = 'SCAT' AND A.SPECIALITY_CODE = D.OPER_GROUP_CODE AND A.OPER_CAT_CODE = D.OPER_CAT_CODE AND D.OPER_CODE  IN ("+oper_codes.toString()+") AND C.OPER_CODE = D.OPER_CODE AND A.PROSTHESIS_CODE  = B.PROSTHESIS_CODE UNION SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',A.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.PROSTHESIS_CODE) ACC_DESC, NVL(A.NO_OF_UNITS,1) TR_NO   FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C, OT_OPER_FOR_GROUP_CAT D WHERE A.APPLICABILITY = 'SSUB'AND A.SPECIALITY_CODE = D.OPER_GROUP_CODE AND  A.OPER_CAT_CODE = D.OPER_CAT_CODE AND A.OPER_SUB_CAT_CODE = D.OPER_SUB_CAT_CODE     AND D.OPER_CODE IN ("+oper_codes.toString()+") AND C.OPER_CODE = D.OPER_CODE      AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE UNION SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',A.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.PROSTHESIS_CODE) ACC_DESC,  NVL(A.NO_OF_UNITS,1) TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.APPLICABILITY = 'SOPR' AND A.OPER_CODE IN ("+oper_codes.toString()+") AND A.OPER_CODE = C.OPER_CODE AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE  ";
                 /* query changed by sathish on 17/02/2009 given by vishwa */
				PICK_LIST_UNDEFINED="SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',C.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE,  GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.PROSTHESIS_CODE) ACC_DESC,   NVL(A.NO_OF_UNITS,1) TR_NO FROM  OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.APPLICABILITY = 'AOPR' AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE AND C.OPER_CODE IN ("+oper_codes.toString()+")   UNION SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',C.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, B.SHORT_DESC ACC_DESC,NVL(A.NO_OF_UNITS,1) TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.APPLICABILITY = 'SSPL' AND A.SPECIALITY_CODE   = C.SPECIALITY_CODE AND C.OPER_CODE IN ("+oper_codes.toString()+") AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE UNION SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',C.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.PROSTHESIS_CODE) ACC_DESC,  NVL(A.NO_OF_UNITS,1) TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C, OT_OPER_FOR_GROUP_CAT D WHERE A.APPLICABILITY = 'SCAT' AND A.SPECIALITY_CODE = D.OPER_GROUP_CODE AND A.OPER_CAT_CODE = D.OPER_CAT_CODE AND D.OPER_CODE  IN ("+oper_codes.toString()+") AND C.OPER_CODE = D.OPER_CODE AND A.PROSTHESIS_CODE  = B.PROSTHESIS_CODE UNION SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',C.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.PROSTHESIS_CODE) ACC_DESC, NVL(A.NO_OF_UNITS,1) TR_NO   FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C, OT_OPER_FOR_GROUP_CAT D WHERE A.APPLICABILITY = 'SSUB'AND A.SPECIALITY_CODE = D.OPER_GROUP_CODE AND  A.OPER_CAT_CODE = D.OPER_CAT_CODE AND A.OPER_SUB_CAT_CODE = D.OPER_SUB_CAT_CODE     AND D.OPER_CODE IN ("+oper_codes.toString()+") AND C.OPER_CODE = D.OPER_CODE      AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE UNION SELECT C.OPER_CODE OPR_CODE, GET_DESC('"+locale+"','OT_OPER_MAST_LANG_VW','SHORT_DESC','OPER_CODE',C.OPER_CODE)  OPR_DESC, A.PROSTHESIS_CODE ACC_CODE, GET_DESC('"+locale+"','OT_PROSTHESIS_LANG_VW','LONG_DESC','PROSTHESIS_CODE',A.PROSTHESIS_CODE) ACC_DESC,  NVL(A.NO_OF_UNITS,1) TR_NO FROM OT_OPER_PROSTHESIS A, OT_PROSTHESIS B, OT_OPER_MAST C WHERE A.APPLICABILITY = 'SOPR' AND A.OPER_CODE IN ("+oper_codes.toString()+") AND A.OPER_CODE = C.OPER_CODE AND A.PROSTHESIS_CODE = B.PROSTHESIS_CODE";  
				...
				out.println("<script>loadDBRows('"+checkForNull(rst.getString("OPR_CODE"))+"','"+checkForNull(rst.getString("OPR_DESC"))+"','"+line_no+"','"+checkForNull(rst.getString("ACC_CODE"))+"','"+checkForNull(rst.getString("ACC_DESC"))+"','"+checkForNull(rst.getString("TR_NO"))+"','','','','"+index+"','L','3','"+bill_str+"','"+panel_str+"','"+key+"','"+key_line+"'); </script>");	
		}//end of while loop
		if(rst!=null)rst.close();
			if(pstmt!=null)pstmt.close();
		out.println("<script>refresh()</script>");
...
if(!imgUrl.equals("")){ 
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.Batch.label", java.lang.String .class,"key"));
