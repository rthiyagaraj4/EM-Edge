...
public final class __otslatescreenmultiple extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/OTSlateScreenMultiple.jsp", 1709120296000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block44 =" Of ";
...
try 
{
	...
	if(beanMap != null && beanMap.size() > 0)
	{
		...
		if(beanList != null && beanList.size() > 0)
		{
            ...
            out.print( String.valueOf(patientRoomStatusBean.roomCount));
