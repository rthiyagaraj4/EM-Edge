...
public final class __summaryofoperbyotroomreports extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/SummaryOfOperByOtRoomReports.jsp", 1709120370000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
locale=locale.toLowerCase();
 ...
 request.setCharacterEncoding("UTF-8");
	...
	String surgery_date = "";
	//String sql_surgery_type = "SELECT NATURE_CODE, SHORT_DESC FROM OT_NATURE_OF_SURGERY_lang_vw where language_id = ? ORDER BY 2"; /* this Code is only for Siriraj Purpose*/
	Connection con = null;
	...
	try{
		...
		/* this Code is only for Siriraj Purpose
