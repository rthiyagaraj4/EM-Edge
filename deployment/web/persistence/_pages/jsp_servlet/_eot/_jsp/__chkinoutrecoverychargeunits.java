...
public final class __chkinoutrecoverychargeunits extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/ChkInOutRecoveryChargeUnits.jsp", 1709117256000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
public HashMap CToHashMap( Hashtable table ) {
 ...
 request.setCharacterEncoding("UTF-8");
	...
	System.err.println("chk_in_dt_time*****************"+chk_in_dt_time);
	System.err.println("chk_out_dt_time*****************"+chk_out_dt_time);
	System.err.println("recovery_room_code*****************"+recovery_room_code);
	System.err.println("units*****************"+units);
	System.err.println("serv_code*****************"+serv_code);
	...
	System.err.println("speciality_code*****************"+speciality_code);
	System.err.println("oper_code*****************"+oper_code);
	System.err.println("surgeon_code*****************"+surgeon_code);*/
	...
	try{
		...
		if(func_mode.equalsIgnoreCase("callChargeUnits")){	
			...
			/*System.err.println(" Chargable Units ");
			System.err.println(" Error Message Code : "+strErrorCode);
			System.err.println(" Error Message Id   : "+strSysMsgId);
			System.err.println(" Error Message Text : "+strErrText);*/
		...
		//getHoldingAreaCheck
			...
			e.printStackTrace();
			System.err.println("Err Msg from ChkInOutRecoveryChargeUnits..jsp :"+e);
		}
		finally{
