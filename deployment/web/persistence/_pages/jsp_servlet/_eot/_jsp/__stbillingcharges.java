...
public final class __stbillingcharges extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/STbillingcharges.jsp", 1709117286000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String sql_mm_code="select MM_ITEM_CODE from OT_PROSTHESIS where PROSTHESIS_CODE='"+item_code+"'";
	...
	out.println("alert(\"" + e + "\");") ;
	e.printStackTrace();
    System.err.println("Err Msg from STBillingCharges.jsp :"+e);
}
