...
public final class __functionsforuserquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/FunctionsForUserQueryCriteria.jsp", 1709120222000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
firstItem.add("SELECT APPL_USER_ID, APPL_USER_NAME FROM SM_APPL_USER WHERE NVL(EFF_STATUS,'E') = 'E'  ORDER BY 1"); // SIZE
...
strbuff = qrypg.getQueryPage( con,finAr,"Functions ","../../eOT/jsp/FunctionsForUserQueryResult.jsp",sortorder,queryCriteria,select ,orderby,orderByCols, orderByColVals,executequery);
