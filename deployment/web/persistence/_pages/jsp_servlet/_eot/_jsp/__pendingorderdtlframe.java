...
public final class __pendingorderdtlframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/PendingOrderDtlFrame.jsp", 1739864366000L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	else
	{
            ...
            out.print( String.valueOf(scheduleURL));
