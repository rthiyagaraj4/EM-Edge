...
public final class __operationsproceduresdtls extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/OperationsProceduresDtls.jsp", 1709117268000L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
 ...
 request.setCharacterEncoding("UTF-8");
	...
	try{
		...
		if (type.equals("appt_time")){
		   ...
		   String sql_instr_local_text = "SELECT patient_instrn_local  FROM   ot_pat_age_sex_instrn  WHERE  oper_code                = ?  AND    pat_preps_or_instrns_ind = 'IS' and language_id <> 'en'";																 
...
out.println(appt_time+"::"+order_type_code+"::"+splty_code+"::"+splty_desc+"::"+pat_instr_text_eng+"::"+pat_instr_text_local+"::"+x_cnt);
		...
		System.err.println("Err Msg in OperationsProceduresDtls.jsp"+e.getMessage());
	} finally{
		try{
			if(resultset!=null)resultset.close();
			if(pstmt!=null)pstmt.close();
