...
public final class __calendarmodalframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/CalendarModalFrame.jsp", 1709120182000L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 request.setCharacterEncoding("UTF-8");
	...
	if(alternateBooking != null && alternateBooking.equals("Y"))
	{
		...
		java.util.ResourceBundle common_labels = java.util.ResourceBundle.getBundle( "eCommon.resources.Labels",loc);		
            ...
            out.print( String.valueOf(common_labels.getString("Common.booking.label")));
