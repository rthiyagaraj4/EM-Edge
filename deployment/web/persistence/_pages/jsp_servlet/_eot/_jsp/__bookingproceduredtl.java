...
public final class __bookingproceduredtl extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/BookingProcedureDtl.jsp", 1723882664000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block20 ="\">\n<input type=\'hidden\' name=\'oper_multiple\' id=\'oper_multiple\' value=\"";
    ...
    private final static java.lang.String  _wl_block26 ="\'>\n<input type=\'hidden\' name=\'tot_time\' id=\'tot_time\' value=\"";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	if((fetchCount%2)==0)	 strQuery="gridData";
            ...
            out.print( String.valueOf(strQuery));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(strRightLeftFlag));
            _bw.write(_wl_block16Bytes, _wl_block16);
            out.print( String.valueOf(strQuery));
            _bw.write(_wl_block15Bytes, _wl_block15);
	...
	if(tot_min<=9) 
	 ...
	 tot_time=tot_hr2+":"+tot_min2;
		...
		if(fetchCount > 1)	   strMultipleOperYN="Y";
            ...
            out.print( String.valueOf(strMultipleOperYN));
            ...
            out.print( String.valueOf(tot_time));
