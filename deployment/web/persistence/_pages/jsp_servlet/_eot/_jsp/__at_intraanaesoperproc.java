...
public final class __at_intraanaesoperproc extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eot/jsp/AT_IntraAnaesOperProc.jsp", 1709120154000L ,"10.3.6.0","Asia/Calcutta")) return true;
   ...
   //Added Against MMS Vulnerability Issue - Ends
	...
	try{
		...
		while(resultSet!=null && resultSet.next()){
            ...
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(resultSet.getString(2)));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block14Bytes, _wl_block14);
