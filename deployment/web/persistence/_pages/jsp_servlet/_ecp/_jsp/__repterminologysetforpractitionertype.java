...
public final class __repterminologysetforpractitionertype extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/repTerminologySetForPractitionerType.jsp", 1709116615043L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block8 ="\"/></TD>\n\t\t\t\t\t    </TR>\n\t\t\t\t\t <TR>\n\t\t\t\t\t\t<TD class=\"label\" align=\"right\" nowrap><fmt:message key=\"Common.practitionertype.label\" bundle=\"";
