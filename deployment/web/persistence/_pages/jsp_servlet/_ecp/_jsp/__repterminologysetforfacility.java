...
public final class __repterminologysetforfacility extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/repTerminologySetForFacility.jsp", 1709116614777L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block5 ="\n<BODY  OnMouseDown=\"CodeArrest()\"  onKeyDown = \'lockKey()\'>\n\t<FORM name=\"repTerminologySetForFacilityForm\" id=\"repTerminologySetForFacilityForm\" action=\"../../eCommon/jsp/report_options.jsp\" target=\"messageFrame\">\n\t<BR>\n\t<TABLE width=\'80%\' align=\'center\' valign=\'top\'>\n\t\t<TH align=\'left\'> <fmt:message key=\"Common.reportcritera.label\" bundle=\"";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="\"/></TH>\n\t      <TR>\n\t\t\t<TD width=\"100%\" class=\"Border\" align=\'center\'>\n\t\t\t\t<TABLE width=\'80%\'cellPadding=\"0\" cellSpacing=\"0\"  align=\'center\' >\n\t    \n\t\t<!-- <br> -->\n\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t<td align=\"right\" class=\"label\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Facilty&nbsp;</td>\n\t\t\t\t<td align=\"left\" ><select name=\"p_facility_code\" id=\"p_facility_code\">\n\t\t\t\t\t<option value=\"\" selected>----------<fmt:message key=\"Common.defaultSelect.label\" bundle=\"";
    ...
    private final static java.lang.String  _wl_block12 ="\"/></TD>\n\t\t\t\t\t\t<TD class=\"label\" width=\"45%\">&nbsp;&nbsp;<fmt:message key=\"Common.to.label\" bundle=\"";
...
con = ConnectionManager.getConnection(request);
					ps = con.prepareStatement("select FACILITY_NAME from  sm_facility_param");
					rs = ps.executeQuery();
