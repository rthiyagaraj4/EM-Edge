...
public final class __repfactorlist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/repFactorList.jsp", 1709116612996L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block7 ="\"/></TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD class=\"label\" align=\"right\">Factor&nbsp;</TD>\n\t\t\t\t\t\t<TD>\n\t\t\t\t\t\t\t<input type=text  name=\'p_factor_code_from\' id=\'p_factor_code_from\' size=\"10\" maxlength=\"10\" align=\"center\">\n\t\t\t\t\t\t\t<input type=\'button\' name=\'Factortype\' id=\'Factortype\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_factor_code_from)\'>\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t\t<TD>\n\t\t\t\t\t\t\t<input type=text  name=\'p_factor_code_to\' id=\'p_factor_code_to\' size=\"10\" maxlength=\"10\" align=\"center\">\n\t\t\t\t\t\t\t<input type=\'button\' name=\'Factortype1\' id=\'Factortype1\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_factor_code_to)\'>\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t</TR>\n\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD colspan=\"2\">&nbsp;</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD align=\'right\' width=\'40%\' class=\"label\"><fmt:message key=\"Common.type.label\" bundle=\"";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\"/> &nbsp;</TD>\n\t\t\t\t\t\t<TD  width=\'20%\' align=\"left\">\n\t\t\t\t\t\t\t<select name=\'p_type\' id=\'p_type\'>\n\t\t\t\t\t\t\t\t<option value=\"\">--<fmt:message key=\"Common.defaultSelect.label\" bundle=\"";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\"/>--\n\t\t\t\t\t\t\t\t<option value=\"DC\">Defining Characteristic\n\t\t\t\t\t\t\t\t<option value=\"RF\">Related Factor\n\t\t\t\t\t\t\t\t<option value=\"RRF\">Related and Risk Factor\n\t\t\t\t\t\t\t\t<option value=\"RIF\">Risk Factor\n\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD colspan=\"2\">&nbsp;</TD>\n\t\t\t\t\t</TR>\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD align=\'right\' width=\'30%\' class=\"label\"><fmt:message key=\"Common.Nature.label\" bundle=\"";
