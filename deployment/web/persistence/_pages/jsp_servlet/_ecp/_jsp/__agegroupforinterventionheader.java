...
public final class __agegroupforinterventionheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/AgeGroupForInterventionHeader.jsp", 1728284757647L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="\' onclick=\'searchDetails()\'></td>\n\t\t\t\t\t<td class = \"label\" colspan=\"1\">\n\t\t\t\t\t</td>\n\t\t\t  </tr>\n\t\t\t <tr><td colspan=\"5\">&nbsp</td></tr>\n\t\t  </table>\t\n\t  </form>\n ";
