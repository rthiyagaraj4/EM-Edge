...
public final class __assigncaremanagerqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/AssignCareManagerQueryResult.jsp", 1709116567591L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//		strQuery = "SELECT A.CARE_MANAGER_ID code,B.practitioner_name description,TO_CHAR(A.EFF_DATE_FROM,'DD/MM/YYYY HH24:MI') EFFFROM, TO_CHAR(A.EFF_DATE_TO,'DD/MM/YYYY HH24:MI') EFFUPTO  from CP_PAT_CARE_PLAN_MANAGER A, 	am_practitioner B where A.CARE_PLAN_ID = ? AND A.PATIENT_ID = ? AND upper(B.practitioner_id) = upper(A.CARE_MANAGER_ID) ORDER BY A.EFF_DATE_FROM,A.CARE_MANAGER_ID,A.SRL_NO ";
		...
		while (rsACM.next() )
		{
            ...
            out.print( String.valueOf(strCPMgrName));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(strClassValue));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(strCPMgrFrom));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(strClassValue));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(strCPMgrUpto));
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eCP.CarePlanManager.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eCP.PeriodUpto.label", java.lang.String .class,"key"));
