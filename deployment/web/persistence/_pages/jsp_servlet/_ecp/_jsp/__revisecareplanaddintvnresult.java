...
public final class __revisecareplanaddintvnresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecp/jsp/ReviseCarePlanAddIntvnResult.jsp", 1740026279351L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="\" ONCLICK=\"UpdateIntvn(this,\'";
...
String sStyle =(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	for(int i=0;i<Diagnosis.size();i=i+11){
		...
		if(termSet.equals(temptermSet) && termCode.equals(temptermCode)){
            ...
            out.print( String.valueOf(Intervention.get(k+0)));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(Intervention.get(k+1)));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(Intervention.get(k+0)));
            _bw.write(_wl_block16Bytes, _wl_block16);
            out.print( String.valueOf(Intervention.get(k+0)));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(Intervention.get(k)));
