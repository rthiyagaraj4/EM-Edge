...
public final class __checkpatientexists extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/edr/jsp/CheckPatientExists.jsp", 1719913782213L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t\t\t\t<script>\n\t\t\t\t\tvar errors = getMessage(\"CHANGE_ID_SERIES_NOT_ALLOWED\",\"DR\") ;\n\t\t\t\t\tparent.frames[2].location.href =\"../../eCommon/jsp/error.jsp?err_val=&err_num=\"+errors;\t\n\t\t\t\t\tparent.parent.frames[2].frames[1].location.href = \'../../eDR/jsp/ChangeIDSeries.jsp?patient_id=";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="&p_short_desc=\'+ \'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="&p_dis_id=";
    ...
    private final static java.lang.String  _wl_block14 ="\n\t\t\t<script>\n\t\t\t\tparent.parent.frames[2].frames[1].document.getElementById(\'p_existing_series_group\').value = \'";
 ...
 String locale=(String)session.getAttribute("LOCALE");  
	...
	try
	{
		...
		else
		{
            ...
            out.print( String.valueOf(p_dis_id));
