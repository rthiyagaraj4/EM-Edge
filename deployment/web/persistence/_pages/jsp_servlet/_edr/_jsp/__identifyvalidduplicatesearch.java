...
public final class __identifyvalidduplicatesearch extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/edr/jsp/IdentifyValidDuplicateSearch.jsp", 1725532087721L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\n\t\n\t<table border=\'0\' width=\'100%\' cellspacing=\'0\' id=\'query\'>\n\t \t\t\n\t\t<tr><th class=\'columnheader\' colspan=\'3\' style=\"text-align:left;\">";
    ...
    private final static java.lang.String  _wl_block13 ="\' name=\'patient_id\' value=\'";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' onBlur=\"touppercase(this)\"><input type=\'button\' name=\'patient_search_button\' id=\'patient_search_button\' value=\'?\' class=\'button\' onClick=\"callPatientSearch()\">\n\t\t\t\t</td>\n\t\t\t\t\n\t\t\t<td class=\'button\' ><input type=button class=button name=\'search\' id=\'search\' value=\'";
