...
public final class __enterduplicatequerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/edr/jsp/EnterDuplicateQueryCriteria.jsp", 1742292069689L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\" name=\'patient_id1\' value=\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' onKeyPress=\"return CheckForSpecChars(event)\" onBlur=\"makeValidQueryCriteria(this);callPatientLine1(this,\'ENTER_DUPLICATE1\')\" ><input type=\'button\' name=\'patient_search_button\' id=\'patient_search_button\' value=\'?\' class=\'button\' onClick=\"callPatientSearch1()\">\n\t\t\t\t<input type=hidden name=\'mode\' id=\'mode\' value=\'first\'></td>\n\t\t\t\n\t\t\t<td class=label colspan=1  ></td>\n\t\t\t\n\t\t\t<td class=\'label\' ></td>\n\t\t\t\n\t\t\t<td class=\'button\' >\n\t\t\t\t<input type=button class=button name=\'search\' id=\'search\' value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' onClick=\"callResult()\">\t\t\n\t\t\t\t<input type=button class=button name=\'clear\' id=\'clear\' value=\'";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' onclick=\"callClear();\" >\n\t\t\t</td>\n\t\t\t\n\t\t<tr><td class=\'label\' colspan=\'5\'></td></tr>\n\t\t<input type=\'hidden\' name=\'function_name\' id=\'function_name\' value=\'";
