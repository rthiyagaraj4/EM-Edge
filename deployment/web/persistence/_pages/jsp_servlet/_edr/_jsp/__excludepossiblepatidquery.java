...
public final class __excludepossiblepatidquery extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/edr/jsp/ExcludePossiblePatIdQuery.jsp", 1709116651245L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\' onblur=\"call_patient_query(this);\"><input type=\'button\' class=\'button\' value=\'?\' onClick =\"pat_search();\">\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t\n\t\t\t<tr>\n\t\t\t\t<td colspan=\'1\' class=\'label\' >&nbsp;</td>\n\t\t\t\t<td colspan=\'1\' class=\'othlanglabel\' id=\'pat_name1\'>";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="</td>\n\t\t\t</tr>\n\t\t\t\n\t\t\t<tr> <!-- below Search button change added against ML-MMOH-SCF-0760 by Mano-->\n\t\t\t\t<td align=\'center\' colspan=\'2\'><input type=\'button\' class=\'button\' name=\'Search\' id=\'Search\' value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' onClick=\'execute_query();\'></td>\n\t\t\t</tr>\n\t\t<input type=\'hidden\' name=\'CheckBoxes\' id=\'CheckBoxes\' value=\'\'> \n\t\t\t\t</table>\n\t</form>\n\t";
