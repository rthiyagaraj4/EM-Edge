...
public final class __mergeduplicatepatidquery extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/edr/jsp/MergeDuplicatePatIdQuery.jsp", 1725532138531L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="</td>\n\t\t\t\t\t\t\t<td class=\'fields\' width=\'30%\'>\n\t\t\t\t\t\t\t\t<input type=\'text\' name=\'patient_id\' id=\'patient_id\' size=\'20\' onblur = \'ChangeUpperCase(this);\' maxlength=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' tabindex=\'1\'><input type=\'button\' class=\'button\' value=\'?\' onClick =\"callPatientSearch()\"><img src=\'../../eCommon/images/mandatory.gif\'>\n\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t<td class=\'button\'>\n\t\t\t\t\t\t\t\t<input type=\'button\' class=\'button\' name=\'Execute\' id=\'Execute\' value=\'";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' onClick=\'execute_query();\' tabindex=\'2\' style=\"float:right;margin-right:10px;\"></td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</table>\n\t\t\t\t</form>\n\t\t\t</body>\n\t\t\t";
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.Execute.label", java.lang.String .class,"key"));
