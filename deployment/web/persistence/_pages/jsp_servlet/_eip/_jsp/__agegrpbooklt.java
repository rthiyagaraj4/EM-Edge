...
public final class __agegrpbooklt extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/AgeGrpBookLt.jsp", 1710353902306L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	//MMS-ME-SCF-0096 vulnerability Issue
		...
		try
		{
			...
			if(rs!= null)
			{
				...
				if(!(bookinglimit.equals("2")))
				out.print("<script>alert(getMessage('CHECK_LIMIT_BY_NURS_UNIT','IP'));document.location.href='../../eCommon/jsp/dmenu.jsp';</script>");
				else
				{	
