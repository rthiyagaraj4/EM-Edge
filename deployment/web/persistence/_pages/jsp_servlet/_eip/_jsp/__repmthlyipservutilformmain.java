...
public final class __repmthlyipservutilformmain extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/repMthlyIPServUtilFormMain.jsp", 1731907667607L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 =" &nbsp;</td>\n\n\t\t\t\t<td align=\"left\" width=\"20%\">\n\t\t\t\t\t<input type=\"text\" id=\'regnagenatstatfrom\'  name=\"p_trn_date\" id=\"p_trn_date\" size=\"7\" maxlength=\"7\" onblur=\"if(validDateObj(this,\'MY\',localeName)){chkWithSysDt(this);}\"><img src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"return showCalendar(\'regnagenatstatfrom\', \'mm/y\', null);\"><img src=\'../../eCommon/images/mandatory.gif\'></img>\n\t\t\t\t</td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t</tr>\n\t\t\t<tr>\n\t\t\t\t <td colspan=4>&nbsp;</td>\n\t\t\t</tr>\n\t\t\t<tr>\n\t\t\t\t<td align=\"center\" width=\"20%\">&nbsp;</td>\n\t\t\t\t<td class=\"querydata\" width=\"20%\" style=\"font-weight: bold;\">";
