...
public final class __cancelrejectremarks extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/CancelRejectRemarks.jsp", 1709117729691L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 String statusCode = checkForNull(request.getParameter("statusCode")); 
  ...
  try{
	...
	System.err.println("CancelRejectRemarks.jsp cancelRejectRemarks===>"+cancelRejectRemarks);
            ...
            out.print( String.valueOf(cancelRejectRemarks));
