...
public final class __repblockingtype extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eip/jsp/RepBlockingType.jsp", 1720629121319L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'20%\'  >\n\t\t\t\t\t\t\t<input type=text  name=\'p_fr_blocking_type\' id=\'p_fr_blocking_type\' size=\"2\" maxlength=\"2\" align=\"center\"><input type=\'button\' name=\'block_code\' id=\'block_code\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_fr_blocking_type)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t<td class=\"fields\" width=\'40%\'> \n\t\t\t\t\t\t\t<input type=text  name=\'p_to_blocking_type\' id=\'p_to_blocking_type\' size=\"2\" maxlength=\"2\" align=\"center\"><input type=\'button\' name=\'block_code\' id=\'block_code\' value=\'?\' class=\'button\' onclick=\'searchCode(this, p_to_blocking_type)\'>\n\t\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"label\">&nbsp;</td>\n\t\t\t\t\t<Td class=\"label\">&nbsp;</td>\n\t\t\t\t</tr>\t\t\t\t\t\t\t\t\n\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\'left\' width=\'30%\' class=\"label\">";
