...
public final class __mrepgingivalstatus extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoh/jsp/MRepGingivalStatus.jsp", 1742903127515L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 =" &nbsp;</td>\n\t\t\t<td align=\"left\">\n\t\t\t\t<select name=\"p_gstatus_from\" id=\"p_gstatus_from\" tabIndex=\"3\" >\n\t\t\t\t\t<option value=\"\">";
    ...
    private final static java.lang.String  _wl_block17 =" &nbsp;</td>\n\t\t\t<td align=\"left\">\n\t\t\t\t<select name=\"p_gstatus_to\" id=\"p_gstatus_to\" tabIndex=\"3\" >\n\t\t\t\t\t<option value=\"\">";
...
try{
	con=ConnectionManager.getConnection(request);
            ...
            _bw.write(_wl_block12Bytes, _wl_block12);
				...
				try{
					pstmt=con.prepareStatement("SELECT GINGIVAL_STATUS_CODE, GINGIVAL_STATUS_DESC FROM OH_GINGIVAL_STATUS_LANG_VW WHERE LANGUAGE_ID=? ORDER BY UPPER(GINGIVAL_STATUS_CODE)");
					pstmt.setString(1,locale);
					rs=pstmt.executeQuery();
					while(rs.next()){
						gingival_status_code=rs.getString(1);
						gingival_status_desc=rs.getString(2);
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOH.GStatusCodeFrom.Label", java.lang.String .class,"key"));
