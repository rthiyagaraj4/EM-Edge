...
public final class __mrepcomplications extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoh/jsp/MRepComplications.jsp", 1742903047021L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 =" &nbsp;</td>\n\t\t\t<td align=\"left\" width=\"25%\">\n\t\t\t<select name=\"p_from_complication_code\" id=\"p_from_complication_code\">\n\t\t\t\t<option value=\"\">";
    ...
    private final static java.lang.String  _wl_block17 =" &nbsp;</td>\n\t\t\t<td align=\"left\" width=\"25%\">\n\t\t\t<select name=\"p_to_complication_code\" id=\"p_to_complication_code\">\n\t\t\t\t<option value=\"\">";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\t\t\n\t\t\t</select>\n\t\t\t</td>\n\t\t</tr>\n\t\t<tr>\n\t\t\t<td colspan=\"4\">&nbsp;</td>\n\t\t</tr>\n\t\t<tr>\n\t\t\t<td align=\"right\" width=\"25%\" class=\"label\" nowrap>";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 =" &nbsp;</td>\n\t\t\t<td align=\"left\" width=\"25%\" colspan=\"3\">\n\t\t\t<select name=\"p_trmt_category_type\" id=\"p_trmt_category_type\">\n\t\t\t\t<option value=\"\">";
...
try{
	...
	con=ConnectionManager.getConnection(request);
            ...
            _bw.write(_wl_block12Bytes, _wl_block12);
					...
					try{
						pstmt=con.prepareStatement("SELECT COMPLICATION_CODE, COMPLICATION_DESC FROM OH_COMPLICATION_LANG_VW WHERE LANGUAGE_ID=? ORDER BY COMPLICATION_DESC");
						pstmt.setString(1,locale);
						rs=pstmt.executeQuery();
						while(rs.next()){
							complication_code=rs.getString(1);
							complication_desc=rs.getString(2);
            ...
            _bw.write(_wl_block12Bytes, _wl_block12);
					...
					try{
						pstmt=con.prepareStatement("SELECT TRMT_CATEGORY_TYPE, TRMT_CATEGORY_TYPE_DESC FROM OH_TRTMT_CATEGORY_TYPE_LANG_VW WHERE LANGUAGE_ID=? ORDER BY TRMT_CATEGORY_TYPE_DESC");
						pstmt.setString(1,locale);
						rs=pstmt.executeQuery();
						while(rs.next()){
							trmt_category_type=rs.getString(1);
							trmt_category_type_desc=rs.getString(2);
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOH.ComplicationsFrom.Label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag5(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag5.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOH.TreatmentCategoryType.Label", java.lang.String .class,"key"));
