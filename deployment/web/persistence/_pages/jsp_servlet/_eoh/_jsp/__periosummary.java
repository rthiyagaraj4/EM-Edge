...
public final class __periosummary extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eoh/jsp/PerioSummary.jsp", 1709119362708L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 request.setCharacterEncoding("UTF-8"); 
	...
	try{
		...
		while(rs!= null && rs.next()){
            ...
            out.print( String.valueOf(display_index_desc));
