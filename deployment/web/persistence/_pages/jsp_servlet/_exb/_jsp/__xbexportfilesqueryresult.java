...
public final class __xbexportfilesqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exb/jsp/XBExportFilesQueryResult.jsp", 1709122251618L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block30 =" align=\"left\">\n\t\t";
...
if(arrRow.size()==0)
{
	...
	{		
		...
		else
		{
            ...
            out.print( String.valueOf(XBDBAdapter.checkNull((String)arrCol.get(1))+""));
            _bw.write(_wl_block29Bytes, _wl_block29);
            out.print( String.valueOf(strTDClass));
            _bw.write(_wl_block30Bytes, _wl_block30);
            out.print( String.valueOf(XBDBAdapter.checkNull((String)arrCol.get(4)).equals("")?"&nbsp;":XBDBAdapter.checkNull((String)arrCol.get(4))+""));
            _bw.write(_wl_block29Bytes, _wl_block29);
            out.print( String.valueOf(strTDClass));
            _bw.write(_wl_block30Bytes, _wl_block30);
            ...
            out.print( String.valueOf(strTDClass));
            _bw.write(_wl_block30Bytes, _wl_block30);
            out.print( String.valueOf(XBDBAdapter.checkNull((String)arrCol.get(2)).equals("")?"&nbsp;":XBDBAdapter.checkNull((String)arrCol.get(2))+""));
            _bw.write(_wl_block29Bytes, _wl_block29);
            out.print( String.valueOf(strTDClass));
            _bw.write(_wl_block30Bytes, _wl_block30);
            out.print( String.valueOf(XBDBAdapter.checkNull((String)arrCol.get(3)).equals("")?"&nbsp;":XBDBAdapter.checkNull((String)arrCol.get(3))+""));
            _bw.write(_wl_block29Bytes, _wl_block29);
            out.print( String.valueOf(strTDClass));
            _bw.write(_wl_block30Bytes, _wl_block30);
            out.print( String.valueOf(XBDBAdapter.checkNull((String)arrCol.get(6)).equals("")?"&nbsp;":XBDBAdapter.checkNull((String)arrCol.get(6))+""));
            _bw.write(_wl_block29Bytes, _wl_block29);
            out.print( String.valueOf(strTDClass));
            _bw.write(_wl_block30Bytes, _wl_block30);
            out.print( String.valueOf(XBDBAdapter.checkNull((String)arrCol.get(7)).equals("")?"&nbsp;":XBDBAdapter.checkNull((String)arrCol.get(7))+""));
