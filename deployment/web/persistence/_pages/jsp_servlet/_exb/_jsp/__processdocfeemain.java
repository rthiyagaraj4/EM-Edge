...
public final class __processdocfeemain extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exb/jsp/processDocFeeMain.jsp", 1709293678531L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
request.setCharacterEncoding("UTF-8"); 
		...
		String monQryCriteriaURL = "../../eXI/jsp/MonitorItemsMoreCriteria.jsp?funcID=XF_DF_HEALTHCAREDELIVERY&queueType=ONLINE";
            ...
            out.print( String.valueOf( monQryCriteriaURL ));
