...
public final class __fmissuefileremoverec extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/FMIssueFileRemoveRec.jsp", 1709116859953L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
            ...
            _bw.write(_wl_block1Bytes, _wl_block1);
            webbeans.eFM.FMFilesIssueDetail FMFilesIssueDetail= null;synchronized(session){
                FMFilesIssueDetail=(webbeans.eFM.FMFilesIssueDetail)pageContext.getAttribute("FMFilesIssueDetail",javax.servlet.jsp.PageContext.SESSION_SCOPE);
                if(FMFilesIssueDetail==null){
                    FMFilesIssueDetail=new webbeans.eFM.FMFilesIssueDetail();
                    pageContext.setAttribute("FMFilesIssueDetail",FMFilesIssueDetail,javax.servlet.jsp.PageContext.SESSION_SCOPE);
