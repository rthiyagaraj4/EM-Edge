...
public final class __queryfmcurrentfilestatusview extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/QueryFMCurrentFileStatusView.jsp", 1709116882750L ,"10.3.6.0","Asia/Calcutta")) return true;
...
while(rset.next()){
            ...
            out.print( String.valueOf((rset.getString("APPT_REF_NO")==null)?"":"<b>"+rset.getString("APPT_REF_NO")));
            _bw.write(_wl_block22Bytes, _wl_block22);
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block23Bytes, _wl_block23);
            out.print( String.valueOf((rset.getString("APPT_DATE")==null)?"&nbsp":rset.getString("APPT_DATE")));
            _bw.write(_wl_block24Bytes, _wl_block24);
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf((rset.getString("DAY")==null)?"&nbsp":rset.getString("DAY")));
            _bw.write(_wl_block26Bytes, _wl_block26);
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf((rset.getString("PRACTITIONER_SHORT_NAME")==null)?"&nbsp":
			rset.getString("PRACTITIONER_SHORT_NAME")));
            _bw.write(_wl_block27Bytes, _wl_block27);
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf((rset.getString("CLINIC_SHORT_DESC")==null)?"&nbsp":rset.getString("CLINIC_SHORT_DESC")));
            ...
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf(DecodeVisitTypeCode));
            _bw.write(_wl_block30Bytes, _wl_block30);
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block31Bytes, _wl_block31);
            out.print( String.valueOf((rset.getString("APPT_FROM_TIME")==null)?"&nbsp":rset.getString("APPT_FROM_TIME")));
            _bw.write(_wl_block32Bytes, _wl_block32);
            out.print( String.valueOf((rset.getString("APPT_TO_TIME")==null)?
