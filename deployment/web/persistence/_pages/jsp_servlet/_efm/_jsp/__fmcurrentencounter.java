...
public final class __fmcurrentencounter extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/FMCurrentEncounter.jsp", 1742884557909L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block19 =" days</td> \t\n\t  <td colspan=4></td>\n\t  </tr>\t  \n   </table> \n  \t<script>\n \t\t//displayCurEncDetail(\'";
