...
public final class __querylocnwisedetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/efm/jsp/QueryLocnWiseDetails.jsp", 1724922805408L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		locn_type_code = request.getParameter("doc_type_code");
		if(locn_type_code == null || locn_type_code.equals("null"))
			locn_type_code = "";

		mysql = " SELECT a.doc_folder_id,c.doc_folder_name,TO_CHAR(c.from_period, 'dd/mm/rrrr') from_period,TO_CHAR(c.to_period, 'dd/mm/rrrr') to_period,c.patient_id,b.curr_fs_locn_desc,b.doc_type_name, DECODE(b.curr_file_status,'A','Archive','E','External','I','Inside','L','Lost','O','Outside','R','Returned','T','Transit') curr_file_status FROM fm_encounter_doc_type_link a,fm_curr_locn_vw b,fm_doc_folder c WHERE a.facility_id = c.facility_id AND a.doc_folder_id = c.doc_folder_id AND a.facility_id=b.facility_id AND a.doc_folder_id = b.doc_folder_id AND a.file_no = b.file_no AND b.CURR_FS_LOCN_CODE='"+locn_type_code+"' AND a.facility_id='"+facility_id+"' ORDER BY c.doc_folder_name";
		...
		try
		{
			...
			while(rst != null && rst.next())
			{
				...
				out.println(((rst.getString("doc_type_name")== null) || (rst.getString("doc_type_name").equals("null"))) ? "" : rst.getString("doc_type_name")+"</FONT></TD>");
