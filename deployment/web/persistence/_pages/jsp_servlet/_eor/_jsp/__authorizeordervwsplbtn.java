...
public final class __authorizeordervwsplbtn extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/AuthorizeOrderVwSplBtn.jsp", 1709119638000L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block6 ="\n<form name=\'spl_apprvl\' id=\'spl_apprvl\' target=\'messageFrame\' >\n<table cellpadding=3 cellspacing=0 border=0 width=\"100%\" align=center>\n\t<tr><td colspan=2 class=\'button\'>\n\t\t<input type=button class=\'button\' value=\'<fmt:message key=\"Common.ok.label\" bundle=\"";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="\"/>\' onClick=\'authoriseSpecial()\'>\n\t\t</td>\n\t</tr>\n</table>\n\n<input type=\"hidden\" name=\"bean_id\" id=\"bean_id\" value=\"";
