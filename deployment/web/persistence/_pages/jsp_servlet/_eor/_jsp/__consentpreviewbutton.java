...
public final class __consentpreviewbutton extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ConsentPreviewButton.jsp", 1732106110000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\' onClick=\'closePreview()\'>\n\t\t\t\t<input type=\"button\" class=\"BUTTON\" name=\"print\" id=\"print\" value=\'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\' onClick=\"printPreview()\">\n\t\t\t</td>\n\t</tr>\n\t<tr>\n\t\t<td class=\"label\">\n\t\t\t<table cellpadding=3 cellspacing=0 border=0 width=\"100%\" align=center>\n\t \n";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\n\t\t\t\t<!--<tr><td class=\"label\"><font size=\"1\"><A href=\'javascript:reprintNotes(\"";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\")\'>";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="</a></font></td></tr>-->\n";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	String cons_form_label  = "", cons_form_id = "";
            ...
            out.print( String.valueOf(cons_form_id));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(((cons_form_label==null||cons_form_label.equals(""))?cons_form_id:cons_form_label)));
