...
public final class __orplaceordersforothpractaddmodifybottom extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ORPlaceOrdersForOthPractAddModifyBottom.jsp", 1721657274000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block1 ="\n<!--ORPlaceOrdersForOthPractAddModifyBottom.jsp -->\n";
    ...
    private final static java.lang.String  _wl_block12 ="\n<body onMouseDown=\'CodeArrest()\'; onKeyDown=\'lockKey()\'>\n<form name=\"place_order_pract_bottom\" id=\"place_order_pract_bottom\">\n\t<table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\' align=\'center\'>\n\t\t<tr align=\'right\' width=\'10%\'>\n\t\t";
    ...
    private final static java.lang.String  _wl_block16 ="\n\t\t</tr>\n\t</table>\n\t<table class=\'grid\' width=\'100%\'>\n\t<th class=\"columnheader\" width=\'75%\'>";
    ...
    private final static java.lang.String  _wl_block23 ="\' align=\'center\'><input type=\'checkbox\' name=\'select_yn";
    ...
    private final static java.lang.String  _wl_block31 ="\' align=\'left\'><b>";
    ...
    private final static java.lang.String  _wl_block46 =">\n\t<input type=\"hidden\" name=\"allowed_type\" id=\"allowed_type\" value=\"";
...
//	String mode				=	request.getParameter( "mode" ) ;
	...
	String allowed_type = "", disp_label="", code="";
	String mode="1";
	...
	allowed_type		=	request.getParameter("allowed_type");
	...
	if(allowed_type == null || allowed_type.equals("null")) allowed_type="";
	...
	bean.setAllowedType(allowed_type);
	if(dispMode.equals(""))
	{
		bean.fetchDBRecords();
	...
	else
	{
		...
		if ( !( (start+row_disp) >= row_count ) ){
            ...
            out.print( String.valueOf(disp_label));
...
if(valid.equals("Y"))
	...
	catch(Exception e)
	{
		System.out.println("Exception@2: "+e);
            ...
            out.print( String.valueOf(allowed_type));
