...
public final class __ordercatalogaddmodifydetail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderCatalogAddModifyDetail.jsp", 1732249568000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block7 ="\' noresize scrolling=\'auto\' frameborder=0 style=";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	//out.println(src2);
            ...
            out.print( String.valueOf(detailUpperStyle));
            _bw.write(_wl_block8Bytes, _wl_block8);
            out.print( String.valueOf(src2));
            _bw.write(_wl_block7Bytes, _wl_block7);
            out.print( String.valueOf(detailLower));
