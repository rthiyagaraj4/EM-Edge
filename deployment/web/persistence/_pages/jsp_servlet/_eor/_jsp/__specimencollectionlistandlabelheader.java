...
public final class __specimencollectionlistandlabelheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/SpecimenCollectionListAndLabelHeader.jsp", 1709120024000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\n\t\t\t<a  class=\"gridLink\" id=\'hdr\' title=\'\'><font color=\'white\'>";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="</a><input type=checkbox  name=\'check_all\' id=\'check_all\' onClick=\'clickAll(this)\' disabled></td>\n\t\t";
...
//out.println("<script>alert('select_td_style="+select_td_style+"');</script>");
            ...
            out.print( String.valueOf(select_td_style));
