...
public final class __orderentryformatitemvalidate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderEntryFormatItemValidate.jsp", 1721627178000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block3 ="\n\t<script>alert(\"Exception thrown at  ...Chk in OrderEntryFormatItemValidate.jsp\"+\"";
    private final static byte[]  _wl_block3Bytes = _getBytes( _wl_block3 );

    private final static java.lang.String  _wl_block4 ="\");</script>\n";
    private final static byte[]  _wl_block4Bytes = _getBytes( _wl_block4 );

    private final static java.lang.String  _wl_block5 ="\n\t<script>alert(\"Exception thrown ...Chk in OrderEntryFormatItemValidate.jsp\"+\"";
