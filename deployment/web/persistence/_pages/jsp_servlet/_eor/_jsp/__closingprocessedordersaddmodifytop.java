...
public final class __closingprocessedordersaddmodifytop extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ClosingProcessedOrdersAddModifyTop.jsp", 1719922780000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	bean.setMode(mode);
            ...
            out.print( String.valueOf(record1[1]));
