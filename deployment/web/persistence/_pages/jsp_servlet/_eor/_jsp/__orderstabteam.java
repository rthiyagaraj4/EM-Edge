...
public final class __orderstabteam extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrdersTabTeam.jsp", 1709119862000L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
	...
	String sStyle	= ((session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!=""))?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
            ...
            out.print( String.valueOf( OrRepository.getOrKeyValue("SQL_OR_USER_FOR_REVIEW_TEAM_LOOKUP") ));
