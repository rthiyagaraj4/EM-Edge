...
public final class __ororderdruginteractiondetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OROrderDrugInteractionDetails.jsp", 1709119886000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block24 ="</td>\n\t\t\t\t\t\t<td width=\"2%\"  align=\"center\" class=\"label\">:</td>\n\t\t\t\t\t\t<td width=\"78%\" align=\"left\" class=\"fields\" colspan=\"7\">\n\t\t\t\t\t\t\t<textarea disabled rows=\"4\" cols=\"90\" maxLength=\"4000\" onblur=\"makeValidString(this)\" onpaste=\"makeValidString(this)\" placeholder=\"Enter text here\" id=\'overRemarks";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085 
	...
	String sStyle	= ((session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!=""))?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		if(null!=interdrugDtls){
            ...
            out.print( String.valueOf(data.getOverrideRemarks() ));
