...
public final class __orderentryformatbuttons extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/OrderEntryFormatButtons.jsp", 1722856748000L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block5 ="\' onClick=\'recordOrderFormatValues()\' name=\'ok\' id=\'ok\' disabled><input type=\'button\' class=\'button\' value=\'";
    ...
    private final static java.lang.String  _wl_block7 ="\')\n\t\tparent.OrderFormat.document.location.href =\'OrderEntryOrderFormat.jsp?";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\';\n\telse if(\'L\'==\'";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\')\n\t\tparent.OrderFormat.document.location.href =\'OrderEntryOrderFormatTempFrame.jsp?";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	String orderFormatHL = request.getParameter("orderFormatHL")==null?"":(String)request.getParameter("orderFormatHL"); //IN056822 
            ...
            out.print( String.valueOf(orderFormatHL));
