...
public final class __chargetypesingle extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ChargeTypeSingle.jsp", 1725254908000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="</td>\n\t\t\t<td align=\"left\" >\n\t\t   <input type=\"text\" name=\"charge_type_code\" id=\"charge_type_code\" readOnly value=\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\'  size=\"10\" maxLength=\"10\"  disabled><img src=\"../../eCommon/images/mandatory.gif\" align=\"center\"></img>\n\n\t\t</td>\n\t\t\t<td class=\"label\" colspan=\'2\'></td>\n\t\t</tr>\n\n\t\t\n\n\t\t<tr>\n\t\t\t<td class=\"label\" ></td>\n\t\t\t<td  class=\"label\">";
    ...
    private final static java.lang.String  _wl_block23 ="</TEXTAREA><img src=\"../../eCommon/images/mandatory.gif\"></img></td>\n\t\t\t</td>\n\t\t\t<td class=\"label\" colspan=\'2\'></td>\n\t\t</tr>\t\t\n\t\t\t\t\n\t\t\n\t\t\n\n\t  </table>\n\t<input type=\"hidden\" name=\"mode\" id=\"mode\" value=\"";
...
//out.println("<script>alert('###explanatory_note="+loadDataVal[1]+"')</script>");
	...
	//out.println("<script>alert('order_category_desc="+order_category_desc+"')</script>");
            ...
            out.print( String.valueOf(explanatory_note));
