...
import eOR.OrderEntryDrawingToolBean;
import java.util.*;
import com.ehis.util.*;

public final class __resultentrydrawingtoolbutton extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ResultEntryDrawingToolButton.jsp", 1741325556000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\n \n\t\t<table border=\"0\" cellpadding=\"3\" cellspacing=\"0\" width=\"100%\" align=center>\n\t\t\t<tr>\n\t\t\t\t<td  class=\"button\"><input type=\"button\" name=\"record\" id=\"record\" class=\"BUTTON\" value =\"";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\" title =\"Record\" onClick=\"resultApply()\"> \n\t\t\t </tr>\n\n\t\t\n\t\t<input type=\"hidden\" name=\"image_content\" id=\"image_content\" value=\"\"> <!-- to store the image -->\n\t\t<input type=\"hidden\" name=\"bean_id\" id=\"bean_id\" value=\"";
