...
public final class __frequencyscopeaddmodifytop extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/FrequencyScopeAddModifyTop.jsp", 1733388684000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//out.println("the value of mod in top  :"+mode);
            ...
            out.print( String.valueOf(OrRepository.getOrKeyValue("SQL_OR_FREQUENCY")));
