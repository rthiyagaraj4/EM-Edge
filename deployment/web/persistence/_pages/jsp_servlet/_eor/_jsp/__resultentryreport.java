...
public final class __resultentryreport extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ResultEntryReport.jsp", 1709119988000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="\' size=14 maxlength=40 onFocus=\'\'";
    ...
    private final static java.lang.String  _wl_block20 ="<!-- <input type=\'button\' name=\'practitioner_button\' id=\'practitioner_button\' class=\'button\'   value=\'?\' onClick=\'show_practitioner_window(document.getElementById(\"practitioner_desc\"),\"Y\")\'> \n\t\t&nbsp;<img src=\"../../eCommon/images/mandatory.gif\"> -->";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="</td>\n\t\t<input type=\'hidden\' name=\'practitioner\' id=\'practitioner\' value=\'";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="\' size=30 maxlength=40 >\n\t\t<!--OLD LOOK UP -->\n\t\t<!-- <input type=\'text\' name=\'practitioner\' id=\'practitioner\' size=\'14\' value=\'";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="\' readonly>";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="<input type=\'button\' name=\'practitioner_button\' id=\'practitioner_button\' class=\'button\' value=\'?\' onClick=\'show_practitioner_window()\'>&nbsp;";
    ...
    private final static java.lang.String  _wl_block27 ="<a class=\"gridLink\" href=\"javascript:callBilling(\'0\',\'";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="\',\'";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 ="\')\" title=\'Charge Details\'> <!--";
    private final static byte[]  _wl_block29Bytes = _getBytes( _wl_block29 );

    private final static java.lang.String  _wl_block30 ="--><FONT SIZE=\"2\" >";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 ="</FONT></a></td>\n\t\t";
    ...
    private final static java.lang.String  _wl_block36 ="\',\'\',\'\',\'\',\'LB\')\">";
    private final static byte[]  _wl_block36Bytes = _getBytes( _wl_block36 );

    private final static java.lang.String  _wl_block37 ="</a>\n\t\t\n";
    private final static byte[]  _wl_block37Bytes = _getBytes( _wl_block37 );

    private final static java.lang.String  _wl_block38 ="\t\t\t<a class=\"gridLink\" href=\"#\" onclick=\'callAllergies(\"";
    ...
    private final static java.lang.String  _wl_block68 ="\")\' title=\'Order Format\'>\n\t\t\t\t<img src=\'../../eOR/images/Flex_blue.gif\' align=\'center\'></img>\n\t\t\t</a>\n";
...
//	out.println("<script>alert('=can_order_type="+request.getParameter("can_order_type")+"=')</script>");
	...
	if(pract_idfrom_db.equals("") && pract_namefrom_db.equals(""))
	{
		...
		{
			//System.err.println("####pract_idfrom_db="+pract_idfrom_db);
...
//out.println("<script>alert('result_status::"+headerDetails[0]+", rslt_status::"+headerDetails[1]+"')</script>");
...
if(headerDetails[0].equalsIgnoreCase("In Progress"))
				...
				else if (headerDetails[0].equalsIgnoreCase("Complete")) //29803
				headerdetails_1.append(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOR.Prelim.label","or_labels")); //29803
...
if(canChangePractId){
	...
	String catalog_desc = bean.getCatalogDesc(orderId); 
		...
		String decideAuth = bean.getAuthorization1(practitioner_id, resp_id, orderId, order_category,order_line_num);
...
//=OrRepository.getOrKeyValue("SQL_OR_USER_FOR_REVIEW_PRAC_LOOKUP")
            ...
            out.print( String.valueOf(OrRepositoryExt.getOrKeyValue("SQL_OR_PRACTITIONER_LOOKUP")));
