...
public final class __patientinterventionsdetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/PatientInterventionsDetails.jsp", 1709119906000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
*/
	...
	displayContent = bean.getInterventionFormContent(patientId,encounterId,facilityId,interventionId,consentformId);
            ...
            out.print( String.valueOf(displayContent));
