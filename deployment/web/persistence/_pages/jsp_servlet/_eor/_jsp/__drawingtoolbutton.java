...
public final class __drawingtoolbutton extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/DrawingToolButton.jsp", 1709119682000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\">\t\t<!-- order entry bean --> \n\t\t<input type=\"hidden\" name=\"bean_name1\" id=\"bean_name1\" value=\"";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\"> <!-- order entry bean --> \n\t\n \n\t\t<input type=\"hidden\" name=\"mode\" id=\"mode\" value=\"1\">\n\t\t<input type=\"hidden\" name=\"patient_id\" id=\"patient_id\" value=\"";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	String sStyle	= ((session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!=""))?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		beanObj.clear();
            ...
            out.print( String.valueOf(bean.getEpisodeVisitNum()));
