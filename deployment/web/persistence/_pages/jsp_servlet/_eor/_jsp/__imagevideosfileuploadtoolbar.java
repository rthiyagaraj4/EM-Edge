...
public final class __imagevideosfileuploadtoolbar extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eor/jsp/ImageVideosFileUploadToolbar.jsp", 1709119718000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\' onClick=\'checkFileExtn(this)\' ></input>\n\t\t\t\t <input type=\'button\' class=\'button\' id=\'noterecord_sec\' name=\'record_sec\' id=\'record_sec\' value=\'";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\' onClick=\'checkFileExtn(this,\"\")\'></input>\n\t\t\t\t <input type=\'button\' class=\'button\' name=\'clear\' id=\'clear\' id=\'clear\' value=\'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\'onClick=\'clearFileName(\"uploadFile_div\")\' ></input>\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t</table>\t\n\t\t</form>\n\t</body>\n</html>\n\n";
