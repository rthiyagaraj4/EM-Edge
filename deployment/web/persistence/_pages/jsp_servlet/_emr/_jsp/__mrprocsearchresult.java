...
public final class __mrprocsearchresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/MRProcSearchResult.jsp", 1722863930943L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//	out.println("joi"+i);
    ...
    code=rs.getString(1);
    desc=rs.getString(2);
    out.println("<tr style='background-color:;'><td class='"+rowclass+"' width='25%'>");
	me=code+"/"+desc;
	me=me.replace('>','`');
	me=me.replace(' ','%');
	out.println("<a    href=javascript:closewd('"+me+"')>");
	out.println(code+"</a></td><td  class='"+rowclass+"' width='75%'>");
