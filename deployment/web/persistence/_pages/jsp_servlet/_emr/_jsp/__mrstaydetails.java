...
public final class __mrstaydetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/MRStayDetails.jsp", 1722863962862L ,"10.3.6.0","Asia/Calcutta")) return true;
		...
		String trn_date_time_converted = "";
		 ...
		 String whoDoneIt = checkForNull(rset1.getString("ADDED_BY_ID"),"&nbsp;");
		  ...
		  if(action.equalsIgnoreCase("Departed"))
            ...
            out.print( String.valueOf(classValue));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(whoDoneIt));
