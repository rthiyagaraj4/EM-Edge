...
public final class __authorizemraccessframe extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/AuthorizeMRAccessFrame.jsp", 1709118884829L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    throws javax.servlet.ServletException, java.io.IOException {
		...
		if (P_patient_type.equals("C")){
            ...
            out.print( String.valueOf(L_access_detail.toString()));
