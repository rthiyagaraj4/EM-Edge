...
public final class __medrecrequestrecordheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/MedRecRequestRecordHeader.jsp", 1709118961454L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="&nbsp;</td>\n \t  <td align =\'left\' class=\'QUERYDATA\' nowrap align=\'center\'>&nbsp;";
    ...
    private final static java.lang.String  _wl_block17 =" days</td> \t\n\t  <td colspan=4></td>\n</tr>\n   </table> \n  \t<script>\n \t\t//displayCurEncDetail(\'";
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	sqlBuff.append(" Select facility_id , encounter_id,");
	sqlBuff.append(" to_char(admission_date_time,'dd/mm/yyyy hh24:mi') admission_date_time, ");
	sqlBuff.append("practitioner_name , specialty_short_desc ,admission_short_desc , ");
	sqlBuff.append("patient_type_short_desc , patient_type_short_desc,");
	sqlBuff.append(" TRUNC(SYSDATE-admission_date_time+1) no_of_days  ");
	sqlBuff.append("from ip_open_encounter_vw where encounter_id = '"+encounterId+"' and "); sqlBuff.append(" facility_id='"+facility_Id+"' ");
	...
	try{
		...
		String no_of_days=rset.getString("no_of_days");
...
finally
{
    ...
    private boolean _jsp__tag7(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag7.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.noofdays.label", java.lang.String .class,"key"));
