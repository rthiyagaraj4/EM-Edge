...
public final class __perpl205setupsearchresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/PERPL205SetupSearchResult.jsp", 1721801868132L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block26 ="\'>\n\t\t\t<input type =\'hidden\' name =\'location_list\' value =\'";
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
		...
		if(noOfRecords == 0)
		{
            ...
            out.print( String.valueOf(location_list));
