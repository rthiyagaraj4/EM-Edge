...
public final class __mrsearchscreen2 extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/MRSearchScreen2.jsp", 1722321664475L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block21 ="<a><br>\n\t\t\t\t\t\t\n\t\t\t\t\t</td>\n\t\t\t\t\t</tr>\n\t\t\t";
