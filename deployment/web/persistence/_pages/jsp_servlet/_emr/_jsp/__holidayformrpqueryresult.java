...
public final class __holidayformrpqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/HolidayForMrpQueryResult.jsp", 1723374596619L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n<script>\nfunction nextRecs(start,end,whereclause,fromPag){ \n\tvar flag=false;\n\tvar len=document.querySelectorAll(\'input[type=\"checkbox\"]\').length;\n\tvar currentPage=document.forms[0].currentPage.value;\n\tvar operation =document.forms[0].operation.value;\n\t\n\t\n\tvar holiday_date=document.forms[0].holiday_date.value;\n\t\n\t\n\tvar obj=parent.frames[1].document.MRPHolidayQueryResult.checkBox;\n\tvar Obj=parent.frames[1].document.MRPHolidayQueryResult;\n\tif (len!=null && len!=\'\'){\n\t\tfor(i=0;i<len;i++){\n\t\t\tif(document.querySelectorAll(\'input[type=\"checkbox\"]\')[i]){\n\t\t\t\tif(document.querySelectorAll(\'input[type=\"checkbox\"]\')[i].checked==true){\n\t\t\t\t\tflag=true;\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}else if(len==null){\n\t\tif(obj.checked){\n\t\t  flag=true;\n\t\t}\n\t}\n\t\n\t\n\tif(flag==false){\n\t\tvar url=\"../../eMR/jsp/HolidayForMrpQueryResult.jsp?operation=\"+operation+\"&from=\"+(start)+\"&to=\"+(end)+\"&holiday_date=\"+holiday_date+\"&fromPage=\"+currentPage+\"&link=next&selCheckBoxes=\";\t \t\n\t\tparent.f_query_add_mod.location.href=url;\n\t}else{\n\t\tvar conf = confirm(getMessage(\"DELETE_CANCEL_HOLIDAY_NEXT\",\"FM\"));\n\t\tif(conf){\n\t\t\tvar selValues=\"\";\n\t\t\tvar selValues1=\"\";\n\t\t\t\n\t\t\tif (Obj.selectall.checked){\n\t\t\t\tvar str=\"111111111111111\";\n\t\t\t}else{\n\t\t\t\tvar str=\"000000000000000\";\n\t\t\t}\n\t\t\tif (len!=null && len!=\'\'){\n\t\t\t\tfor (i=0;i<len;i++){\n\t\t\t\t\tif (obj[i].checked){ \n\t\t\t\t\t\tstr=parent.frames[1].replace(str,i+1,\'1\') ;\n\t\t\t\t\t\tselValues1=Obj.holidayDate[i].value+\'|\';\n\t\t\t\t\t\tselValues+=selValues1;\n\t\t\t\t\t }\n\t\t\t\t}\n\t\t\t}else if(len==null){\n\t\t\t   if(obj.checked){\n\t\t\t\tvar str=\"10000000000000\";\n\t\t\t\tselValues=Obj.holidayDate.value+\'|\';\n\t\t\t    }\n\t\t\t}\n\t\t\t\t\t\t\n\t\t\t\n\t\t\tparent.frames[1].document.MRPHolidayQueryResult.selectedValues.value=selValues;\n\t\t\tparent.frames[1].document.MRPHolidayQueryResult.selCheckBoxes.value=str;\n\t\t\tparent.frames[1].document.MRPHolidayQueryResult.prevnextsubm.value=\"Y\";\n\t\t\tvar fromPage=parent.frames[1].document.MRPHolidayQueryResult.currentPage.value;\t\n\t\t\tparent.frames[1].document.MRPHolidayQueryResult.submit();\t\t\t\t\t\n\t\t\n\t\t\t\n\t\t}else{\n\t\t\tClearAll();\n\t\t\tvar url=\"../../eMR/jsp/HolidayForMrpQueryResult.jsp?operation=\"+operation+\"&from=\"+start+\"&to=\"+end+\"&holiday_date=\"+holiday_date+\"&fromPage=\"+currentPage+\"&link=next&selCheckBoxes=\";\n\t\t\tparent.f_query_add_mod.location.href=url;\n\t\t\t\n\t\t}\n\t}\n}\nfunction ClearAll(){\n\tvar len=document.getElementById(\"checkBox\").length\n\tfor(i=0;i<len;i++){\n\t\tif(document.getElementById(\"checkBox\")[i]){\n\t\t\tif(document.getElementById(\"checkBox\")[i].checked==true){\n\t\t\t\tdocument.getElementById(\"checkBox\")[i].checked=false;\n\t\t\t}\n\t\t}\n\t}\n\tif(document.forms[0].selectall.checked==true){\n\t\tdocument.forms[0].selectall.checked=false;\n\t}\n}\nfunction  prevRecs(start,end,whereclause,fromPag){ \n\tvar flag=false;\n\tvar len=document.querySelectorAll(\'input[type=\"checkbox\"]\').length;\n\tvar operation=\"";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\";\n\tvar currentPage=\"";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\";\n\t\n\tvar holiday_date=document.forms[0].holiday_date.value;\t\n\t\t\n\tvar obj=parent.frames[1].document.MRPHolidayQueryResult.checkBox;\n\tvar Obj=parent.frames[1].document.MRPHolidayQueryResult;\n\t\n\tif (len!=null && len!=\'\'){\n\t\tfor(i=0;i<len;i++){\n\t\t\tif(document.querySelectorAll(\'input[type=\"checkbox\"]\')[i]){\n\t\t\t\tif(document.querySelectorAll(\'input[type=\"checkbox\"]\').checked==true){\n\t\t\t\t\tflag=true;\n\t\t\t\t}\n\t\t}\n\t }\n\t}else if(len==null){\n\t\tif(obj.checked){\n\t\t\tflag=true;\n\t    }\n\t}\n\t\n\t\n\tif(flag==false){\n\t\t\n\t\tvar url=\"../../eMR/jsp/HolidayForMrpQueryResult.jsp?operation=\"+operation+\"&from=\"+(start)+\"&to=\"+(end)+\"&holiday_date=\"+holiday_date+\"&fromPage=\"+currentPage+\"&link=prev&selCheckBoxes=\";\n\t\tparent.f_query_add_mod.location.href=url;\n\t}else{\n\t\tvar conf = confirm(getMessage(\"DELETE_CANCEL_HOLIDAY_NEXT\",\"FM\"));\n\t\tif(conf){\n\t\t\tvar selValues=\"\";\n\t\t\tvar selValues1=\"\";\n\t\t\t/*len=parent.frames[1].document.MRPHolidayQueryResult.checkBox.length;\n\t\t\tobj=parent.frames[1].document.MRPHolidayQueryResult.checkBox;\n\t\t\tObj=parent.frames[1].document.MRPHolidayQueryResult;*/\n\t\t\tif (Obj.selectall.checked){\n\t\t\t\tvar str=\"111111111111111\";\n\t\t\t}else{\n\t\t\t\tvar str=\"000000000000000\";\n\t\t\t}\n\t\t\tif (len!=null && len!=\'\'){\n\t\t\t\tfor (i=0;i<len;i++){\n\t\t\t\t\tif (obj[i].checked){ \n\t\t\t\t\t\tstr=parent.frames[1].replace(str,i+1,\'1\') ;\n\t\t\t\t\t\tselValues1=Obj.holidayDate[i].value+\'|\';\n\t\t\t\t\t\tselValues+=selValues1;\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}else if(len==null){\n\t\t\t   if(obj.checked){\n\t\t\t\tvar str=\"10000000000000\";\n\t\t\t\tselValues=Obj.holidayDate.value+\'|\';\n\t\t\t\t}\n\t\t\t}\n\t\t\t\n\t\t\tparent.frames[1].document.MRPHolidayQueryResult.selectedValues.value=selValues;\n\t\t\tparent.frames[1].document.MRPHolidayQueryResult.selCheckBoxes.value=str;\n\t\t\tvar fromPage=parent.frames[1].document.MRPHolidayQueryResult.currentPage.value;\n\t\t\tparent.frames[1].document.MRPHolidayQueryResult.prevnextsubm.value=\"Y\";\n\t\t\tparent.frames[1].document.MRPHolidayQueryResult.submit();\n\t\t\t//parent.parent.frames[2].document.getElementById(\"holiday\").rows=\"8%,28%,*,8%\";\n\t\t}else{\n\t\t\tClearAll();\n\t\t\t\n\t\t\tvar url=\"../../eMR/jsp/HolidayForMrpQueryResult.jsp?operation=\"+operation+\"&holiday_date=\"+holiday_date+\"&fromPage=\"+currentPage+\"&link=prev&selCheckBoxes=\";\n\t\t\tparent.f_query_add_mod.location.href=url;\n\t\t}\n\t}\n}\t\n</script>\n";
    ...
    private final static java.lang.String  _wl_block19 ="\n</td>\n</tr>\n</table>\n<br><br>\n</P>\t\n\n\n<form name=\'MRPHolidayQueryResult\' id=\'MRPHolidayQueryResult\' method=\'post\' action=\'../../servlet/eMR.MRPHolidayServlet\' target=\'messageFrame\'>\n\t<table id=\'QRTable\' border=\"1\" width=\"100%\" cellspacing=\'0\' cellpadding=\'0\'>\n\t<tr>\t\n\n\t<td class=\"COLUMNHEADER\"   >";
    ...
    private final static java.lang.String  _wl_block24 ="\' >\n\t\t\t<a href=\'javascript:modifyMRPHoliday(\"";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 ="\")\'>";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 ="</a><input type=hidden name=\'holidayDate\' id=\'holidayDate\' value=\'";
    ...
    private final static java.lang.String  _wl_block32 ="\' align=\'center\'><input type=\'checkbox\' id=\'check_Box";
    private final static byte[]  _wl_block32Bytes = _getBytes( _wl_block32 );

    private final static java.lang.String  _wl_block33 ="\' class=\'checkBox\' name=\'checkBox\' onClick=\'javascript:checkBoxOnClick(this,";
    ...
    private final static java.lang.String  _wl_block36 ="\'==0){alert(getMessage(\'NO_RECORD_FOUND_FOR_CRITERIA\',\'Common\'));}</script>\n\t";
...
{	
	...
	strsql2.append("SELECT TO_CHAR (holiday_date, 'dd/mm/yyyy') holiday_val_date, holiday_date,reason_for_holiday, facility_id facilityid,TO_CHAR (holiday_date, 'Day') d  FROM mr_report_holiday  WHERE TRUNC (holiday_date) >= TRUNC (SYSDATE)   AND facility_id = '"+facilityId+"' ");
