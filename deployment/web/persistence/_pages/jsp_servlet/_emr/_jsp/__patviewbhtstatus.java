...
public final class __patviewbhtstatus extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/PatViewBHTStatus.jsp", 1721304077781L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	String url_name = "PatBHTViewCriteria.jsp?&module_id="+module_id;
