...
public final class __selecttermcodedynamicvalues extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/SelectTermCodeDynamicValues.jsp", 1709117080607L ,"10.3.6.0","Asia/Calcutta")) return true;
...
try
{
	...
	//defnlevelStmt = con.createStatement();
