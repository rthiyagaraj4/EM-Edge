...
public final class __termsetcritforpatientclasspopulate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/TermSetCritforPatientClassPopulate.jsp", 1709119128082L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 request.setCharacterEncoding("UTF-8"); 
	...
	try
	{
		...
		if((accuracyVal.equals("Certain")) || (accuracyVal.equals("Uncertain")))
		{
            ...
            out.print( String.valueOf(rs.getString("accuracy_code")));
