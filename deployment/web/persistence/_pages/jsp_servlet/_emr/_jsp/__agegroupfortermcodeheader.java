...
public final class __agegroupfortermcodeheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/AgeGroupForTermCodeHeader.jsp", 1709118875610L ,"10.3.6.0","Asia/Calcutta")) return true;
...
for(int i=0;i<Agegroup_list.size();i+=2){
            ...
            out.print( String.valueOf(Agegroup_list.get(i)));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(Agegroup_list.get(i+1)));
