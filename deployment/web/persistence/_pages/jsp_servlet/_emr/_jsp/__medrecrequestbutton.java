...
public final class __medrecrequestbutton extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/MedRecRequestButton.jsp", 1709118955610L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block4 ="\n\t\t<form name=\"frmButton\" id=\"frmButton\">\n\t\t\t<table cellspacing=0 cellpadding=0 width=100%>\n\t\t\t\t<tr>\n\t\t\t\t\t<td width=\"75%\" class=\"label\">&nbsp;</td>\n\t\t\t\t\t<td width=\"25%\" class=\'button\'><input type=\'button\' name=\'showPrevDtls\' id=\'showPrevDtls\' ";
    private final static byte[]  _wl_block4Bytes = _getBytes( _wl_block4 );

    private final static java.lang.String  _wl_block5 =" value=\'";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="\' class=\'button\' onclick=\'showPrevDelReports()\' ><input type=\'button\' name=\'search\' id=\'search\' value=\'";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="\' class=\'button\' onclick=\'showModalCurEnc()\' disabled></td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\t<input type=\"hidden\" name=\"selitem\" id=\"selitem\" value=";
 ...
 //out.println("<script>alert(\""+request.getQueryString()+"\");</script>");
		...
		disable="disabled";
            ...
            out.print( String.valueOf(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eMR.MedicalReport.label","mr_labels")));
