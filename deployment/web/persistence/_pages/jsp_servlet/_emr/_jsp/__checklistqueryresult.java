...
public final class __checklistqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emr/jsp/CheckListQueryResult.jsp", 1709118890360L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 String sStyle = checkForNull((String)session.getAttribute("PREFERRED_STYLE"), "IeStyle.css"); 
	...
	{
	sql="";
	String cd = request.getParameter("chk_list_code");
	...
	if ( !(cd == null || cd.equals("")) )
			{
			sql = "where upper(chk_list_code)  like  upper('"+cd+"%') ";
			andCheck = 1;
			}
...
try{
	...
	String strsql2="select * from CHK_LIST_MEDICAL_REPORT "+sql;
	 ...
	 while ( i<=end && rs.next() )
		{
			...
			if ( !(start <= 1) )
				out.println("<td align ='right' id='prev'><A HREF='../../eMR/jsp/CheckListQueryResult.jsp?from="+(start-14)+"&to="+(end-14)+"&whereclause="+URLEncoder.encode(sql)+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.previous.label","common_labels")+"</A></td>");

				out.println("<td align ='right' id='next' style='visibility:hidden'><A HREF='../../eMR/jsp/CheckListQueryResult.jsp?from="+(start+14)+"&to="+(end+14)+"&whereclause="+URLEncoder.encode(sql)+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.next.label","common_labels")+"</A></td>");
		...
		String code = rs.getString("chk_list_code");

		out.println("<a href='../../eMR/jsp/ChecklistMedReportAddModify.jsp?chk_list_code="+ code+"&mode=modify'>");
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eMR.CheckLists.label", java.lang.String .class,"key"));
