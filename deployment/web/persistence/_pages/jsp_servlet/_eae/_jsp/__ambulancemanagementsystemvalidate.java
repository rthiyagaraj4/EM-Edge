...
public final class __ambulancemanagementsystemvalidate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/AmbulanceManagementSystemValidate.jsp", 1709113772629L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {;
            ...
            _bw.write(_wl_block1Bytes, _wl_block1);
            eAE.AmbulanceManagementSystemBean bean= null;{
                bean=(eAE.AmbulanceManagementSystemBean)pageContext.getAttribute("bean");
                if(bean==null){
                    bean=new eAE.AmbulanceManagementSystemBean();
