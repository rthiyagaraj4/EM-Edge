...
public final class __getscoreval extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/GetScoreVal.jsp", 1709113875850L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
try
{
	...
	if(gcs_score.equals(""))gcs_score="0";
            ...
            out.print( String.valueOf(scoreValue));
