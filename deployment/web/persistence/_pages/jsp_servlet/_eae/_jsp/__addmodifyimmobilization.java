...
public final class __addmodifyimmobilization extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/addModifyImmobilization.jsp", 1709113824491L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="</td>\n\t\t      <td class=\'field\'  width=\'50%\'><input type=\'text\' name=\'immobilization_code\' id=\'immobilization_code\' value=\'";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\' maxLength=\'6\' size=\'6\' ";
	 ...
	 while(rset!=null && rset.next())
	  ...
	  if(mode.equalsIgnoreCase("INSERT"))
		  checkBoxAttribute = "CHECKED";
            ...
            out.print( String.valueOf(immobilization_code));
