...
public final class __practfortreatmentareaqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/PractforTreatmentAreaQueryResult.jsp", 1709113879896L ,"10.3.6.0","Asia/Calcutta")) return true;
...
if ( !(cd== null || cd.equals("")) )
	 ...
	 if ( !(practitioner_id == null || practitioner_id.equals("")) )
	 	 {
	 	    ...
	 	    {
	 	          sql.append(" and ");
	 	     	  sql.append(" PRACTITIONER_ID like'"+practitioner_id+"%'");
	 	    }
	 	    else
	 	    {
				sql.append(" where PRACTITIONER_ID like '"+practitioner_id+"%'");
				andCheck = 1;
	 	    }
	 }
	...
	try
	{
	  ...
	  strsql2.append("select * from AE_PRACT_FOR_TMT_AREA_VW ");
...
if ( !(start <= 1) )
	out.println("<A HREF='../../eAE/jsp/PractforTreatmentAreaQueryResult.jsp?from="+(start-14)+"&to="+(end-14)+"&whereclause="+URLEncoder.encode(sql.toString())+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.previous.label","common_labels")+"</A>");

  if (endOfRes.equals("1"))
	out.println("<A id='nextvalue' HREF='../../eAE/jsp/PractforTreatmentAreaQueryResult.jsp?from="+(start+14)+"&to="+(end+14)+"&whereclause="+URLEncoder.encode(sql.toString())+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.next.label","common_labels")+"</A>");
	...
	String practitioner_id_dis = rs.getString("PRACTITIONER_ID");
	
	out.println("<a href='../../eAE/jsp/addModifyPractforTreatmentArea.jsp?clinic_code="+clinic_code+"&treatment_area_code="+treatment_area_code+"&practitioner_id="+practitioner_id_dis+"' target='f_query_add_mod' >");
	...
	out.println(practitioner_id_dis+"</td><td class='" + classValue + "' nowrap >");
	String practitioner_name_dis = rs.getString("PRACTITIONER_NAME");
	out.println(practitioner_name_dis);
	out.println("</td>");
...
if(stmt!=null)	stmt.close();
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.LocationDescription.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eAE.TreatmentAreaCode.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eAE.TreatmentAreaDesc.label", java.lang.String .class,"key"));
