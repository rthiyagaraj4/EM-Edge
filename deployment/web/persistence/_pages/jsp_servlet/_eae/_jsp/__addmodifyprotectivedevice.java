...
public final class __addmodifyprotectivedevice extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eae/jsp/addModifyProtectiveDevice.jsp", 1709113825632L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="</td>\n\t\t      <td class=\'field\'  width=\'50%\'><input type=\'text\' name=\'protective_device_code\' id=\'protective_device_code\' value=\'";
	 ...
	 while(rset!=null && rset.next())
	  ...
	  if(mode.equalsIgnoreCase("INSERT"))
		  checkBoxAttribute = "CHECKED";
            ...
            out.print( String.valueOf(protective_device_code));
