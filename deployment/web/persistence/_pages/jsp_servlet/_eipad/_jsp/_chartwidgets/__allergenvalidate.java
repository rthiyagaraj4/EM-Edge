...
public final class __allergenvalidate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/chartwidgets/AllergenValidate.jsp", 1709116940739L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
if(allergyResponse != null && allergyResponse.getAllergyDetails() != null && allergyResponse.getAllergyDetails().size() > 0)
{
	responseText = "true";
            ...
            out.print( String.valueOf(responseText));
            _bw.write(_wl_block2Bytes, _wl_block2);
