...
public final class __pendingorders extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/PendingOrders.jsp", 1709118029365L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
if(nListSize > 0)
{
	  for(nLoopCount = 0 ; nLoopCount < nListSize;nLoopCount ++)
	  {
		  ...
		  if(oPendingOrder != null && nRowCount < 7)
		  {
            ...
            out.print( String.valueOf(oPendingOrder.getsOrdercount()));
