...
public final class __widgetpendingscheduledetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eipad/jsp/WidgetPendingScheduleDetails.jsp", 1709118034583L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
	...
	if (session.getValue("EpisodeId") != null) {
		oPatientContext.sEncounterId = (String) session
            ...
            out.print( String.valueOf(oPendingSchedules.getsDateTime()));
            _bw.write(_wl_block5Bytes, _wl_block5);
            out.print( String.valueOf(oPendingSchedules.getsLocation()));
            _bw.write(_wl_block6Bytes, _wl_block6);
            out.print( String.valueOf(oPendingSchedules.getsResourceName()));
            _bw.write(_wl_block5Bytes, _wl_block5);
            out.print( String.valueOf(oPendingSchedules.getsSpeciality()));
            _bw.write(_wl_block5Bytes, _wl_block5);
            out.print( String.valueOf(oPendingSchedules.getsVisitType()));
            _bw.write(_wl_block5Bytes, _wl_block5);
            out.print( String.valueOf(oPendingSchedules.getsAppointmentNumber()));
