...
public final class __ingredientsquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/IngredientsQueryCriteria.jsp", 1709116732000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String ingredients =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOT.IngredientCode.Label","ot_labels") ;
...
try {
   ...
   con  =  ConnectionManager.getConnection(request);
	...
	orderByCols[0] = ingredients;
	orderByCols[1] = longDesc;
	orderByCols[2] = shortDesc;
    orderByCols[3] = nature;

	orderByColVals[0] = "ingredient_code";
	orderByColVals[1] = "long_desc";
	orderByColVals[2] = "short_desc";
	orderByColVals[3] = "eff_status";

	strbuff = qrypg.getQueryPage( con,finAr,"Instruments ","../../eDS/jsp/IngredientsQueryResult.jsp?ph_module_yn="+ph_module_yn,sortorder,queryCriteria,comSelect ,orderby,orderByCols, orderByColVals,"Execute Query");
