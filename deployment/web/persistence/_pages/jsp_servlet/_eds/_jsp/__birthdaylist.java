...
public final class __birthdaylist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/BirthdayList.jsp", 1724241452000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="</td>\n\t\t\t\t\t\t\t<td class=\'fields\'><input type=\"text\" name=\"date\" id=\"date\"  maxlength=\"10\" size=\"10\" value=\"";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\" onkeypress=\"return checkForSpecCharsforID(event);\"  onblur=\'validDateObj(this,\"DMY\",\"";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\");\'><img src=\'../../eCommon/images/CommonCalendar.gif\' onClick=\"return showCalendar(\'date\');\"><img src=\'../../eCommon/images/mandatory.gif\' /></td>\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t</tr>\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\n\t\t\t\t<tr>\n\t\t\t\t\t<td  class=\"label\">\n\t\t\t\t\t\t";
