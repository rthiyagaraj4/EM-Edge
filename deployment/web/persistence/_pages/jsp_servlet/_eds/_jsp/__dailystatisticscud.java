...
public final class __dailystatisticscud extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/DailyStatisticsCud.jsp", 1724230534000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block38 ="\n\n<!-- Added against MMS-DM-SCF-0009 -->\n\t\t\t<input type=\"hidden\" name=\"report_id\" id=\"report_id\" id = \"report_id\" value=\"DSRDWSDT\">\n\t\t\t<input type=\"hidden\" name=\"p_report_id\" id=\"p_report_id\" id = \"p_report_id\" value=\"DSRDWSDT\">\n<!-- Added against MMS-DM-SCF-0009 -->\n\n\t\t\t<input type=\'hidden\' name=\'locale\' id=\'locale\' value=\'";
...
pstmt=conn.prepareStatement(sql);
            ...
            _bw.write(_wl_block27Bytes, _wl_block27);
							...
							try
							{
							sql ="SELECT DIET_TYPE,SHORT_DESC from  DS_DIET_TYPE_LANG_VW  WHERE  LANGUAGE_ID ='"+locale+"' AND EFF_STATUS='E' order by lower(DIET_TYPE)";//55558
            ...
            _bw.write(_wl_block21Bytes, _wl_block21);
						 ...
						 finally
						   {
								try{
									...
									System.err.println("Exception in Daily Statistics CUD.jsp"+e);
								}
						   }
