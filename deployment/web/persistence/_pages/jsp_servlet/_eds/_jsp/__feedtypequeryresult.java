...
public final class __feedtypequeryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eds/jsp/FeedTypeQueryResult.jsp", 1724582716000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
try{
    ...
    String sql = " ";
    String feedType = request.getParameter("feed_Type")==null?"":request.getParameter( "feed_Type" ).trim().toUpperCase();
	...
	int cnt=0;
		...
		if ( !(feedType == null || feedType.equals("")) ){
	        sql = sql + " where upper(feed_type) like upper('"+feedType +"%')";
			cnt++;
        }
...
ResultSet rs = null;
	...
	try{
		...
		String strsql="select count(*) as total from ds_feed_type "+sql;
		String strsql1="select feed_type,long_desc,short_desc,eff_status from ds_feed_type "+sql;
...
if ( !(start <= 1) )
    out.println("<A HREF='../../eDS/jsp/FeedTypeQueryResult.jsp?from="+(start-14)+"&ph_module_yn="+ph_module_yn+"&to="+(end-14)+"&whereclause=" + URLEncoder.encode(sql) + "'" + " text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.previous.label","common_labels")+"</A>");

if ( !( (start+14) > maxRecord ) )
    out.println("<A HREF='../../eDS/jsp/FeedTypeQueryResult.jsp?from="+(start+14)+"&ph_module_yn="+ph_module_yn+"&to="+(end+14)+"&whereclause="+URLEncoder.encode(sql)+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.next.label","common_labels")+"</A>");
      ...
      while ( rset.next() && i<=end  )
{
	...
	String mode="modify";
	out.println("<a href='../../eDS/jsp/FeedTypeAddModify.jsp?mode="+mode+"&feedType="+ feedType+"' target='f_query_add_mod' >");
    out.println(feedType+"</a></td>");
...
catch(Exception e)
{
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eOT.FeedType.Label", java.lang.String .class,"key"));
