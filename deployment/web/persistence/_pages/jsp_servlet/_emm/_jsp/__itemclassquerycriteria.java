...
import eMM.ItemClassBean;
import java.util.*;
import com.ehis.util.*;

public final class __itemclassquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emm/jsp/ItemClassQueryCriteria.jsp", 1709116968000L ,"10.3.6.0","Asia/Calcutta")) return true;
