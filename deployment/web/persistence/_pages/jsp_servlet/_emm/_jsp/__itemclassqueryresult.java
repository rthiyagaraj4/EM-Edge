...
public final class __itemclassqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emm/jsp/ItemClassQueryResult.jsp", 1709118370000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//		String primary_lang		= (String)session.getAttribute("PRIMARY_LANG");
	...
	//Search Criteria's from Query Criteria page
	 ...
	 String item_class_code	= ((request.getParameter("item_class_code") == null) || (request.getParameter("item_class_code").trim() == ""))  ? "%" : (request.getParameter("item_class_code").trim())+"%";		
	 ...
	 String eff_status	= ((request.getParameter("nature") == null) || (request.getParameter("nature").trim() == ""))  ? "%" : (request.getParameter("nature").trim())+"%";		
	//String ord[]		= request.getParameterValues("orderbycolumns");
	 boolean searched	=(request.getParameter("searched") == null) ?false:true;
	
try{
	String classvalue			= "";
//	String bean_id				= "itemClassBean" ;
//	String bean_name			= "eMM.ItemClassBean";
//	String facility_id			="";
//	facility_id					=(String) session.getAttribute("facility_id");
//	ItemClassBean bean = (ItemClassBean)mh.getBeanObject( bean_id, request, bean_name ) ;
	...
	sqlMap.put( "sqlData", MmRepository.getMmKeyValue( "SQL_MM_ITEM_CLASS_QUERYCRIT"));
