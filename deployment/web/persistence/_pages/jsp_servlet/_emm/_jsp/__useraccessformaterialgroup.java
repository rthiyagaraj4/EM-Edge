...
public final class __useraccessformaterialgroup extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emm/jsp/UserAccessForMaterialGroup.jsp", 1717497520000L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
            ...
            _bw.write(_wl_block1Bytes, _wl_block1);
            eMM.Common.MmRepository ll= null;{
                ll=(eMM.Common.MmRepository)pageContext.getAttribute("ll");
                if(ll==null){
                    ll=new eMM.Common.MmRepository();
                    pageContext.setAttribute("ll",ll);

                }
            }
            _bw.write(_wl_block1Bytes, _wl_block1);
            eMM.MM_license_rights lwl= null;{
                lwl=(eMM.MM_license_rights)pageContext.getAttribute("lwl");
                if(lwl==null){
                    lwl=new eMM.MM_license_rights();
                    pageContext.setAttribute("lwl",lwl);

                }
            }
            _bw.write(_wl_block1Bytes, _wl_block1);
            eMM.UserAccessForMaterialGroupBean lll= null;{
                lll=(eMM.UserAccessForMaterialGroupBean)pageContext.getAttribute("lll");
                if(lll==null){
                    lll=new eMM.UserAccessForMaterialGroupBean();
                    pageContext.setAttribute("lll",lll);
