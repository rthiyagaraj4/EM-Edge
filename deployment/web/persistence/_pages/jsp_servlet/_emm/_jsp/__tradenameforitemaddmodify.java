...
public final class __tradenameforitemaddmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emm/jsp/TradeNameForItemAddModify.jsp", 1709118376000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block18 ="\" value=\"Y\" checked onClick=\"assignFlag(";
    ...
    throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {;
            ...
            _bw.write(_wl_block2Bytes, _wl_block2);
            eMM.TradeNameForItemBean TradeNameForItemBean= null;{
                TradeNameForItemBean=(eMM.TradeNameForItemBean)pageContext.getAttribute("TradeNameForItemBean");
                if(TradeNameForItemBean==null){
                    TradeNameForItemBean=new eMM.TradeNameForItemBean();
                    pageContext.setAttribute("TradeNameForItemBean",TradeNameForItemBean);
...
//	int end						=	noOfRecords;
	...
	if((hmRecord.get("MODE").toString()).equals("1")) {
            ...
            out.print( String.valueOf(hmRecord.get("TRADE_NAME")));
		...
		if(hmRecord.get("MANUFACTURER_NAME") == null) {
            ...
            out.print( String.valueOf(hmRecord.get("MANUFACTURER_NAME")));
