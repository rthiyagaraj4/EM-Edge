...
public final class __catalogcodequeryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emm/jsp/CatalogCodeQueryResult.jsp", 1709118370000L ,"10.3.6.0","Asia/Calcutta")) return true;
...
*/ 
	...
	String item_catalog_code		=		request.getParameter( "catalog_code" ) ; 
...
try{
	...
	item_catalog_code				=		CommonBean.checkForNull( item_catalog_code )+'%'; 
	...
	sqlMap.put( "sqlData", MmRepository.getMmKeyValue("SQL_MM_CATALOG_CODE_QUERYCRIT")); 
	...
	displayFields.add( "catalog_code" );
	...
	chkFields.add(item_catalog_code); 
	...
	out.println(CommonBean.setForm ( request ,"../../eMM/jsp/CatalogCodeQueryResult.jsp", searched) );
} catch(Exception e) {
