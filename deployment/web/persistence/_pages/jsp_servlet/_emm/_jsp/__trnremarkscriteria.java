...
public final class __trnremarkscriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emm/jsp/TrnRemarksCriteria.jsp", 1709118378000L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="&nbsp;</td>\n\t<td class=\"fields\" >\n\t\t<SELECT name=\'module_id\' id=\'module_id\' onChange=\"setmoduleid(this);\" ";
...
//	mod_id					=	request.getParameter( "mod_id" )==null?"ST":request.getParameter("mod_id");
	...
	catch(Exception e)
	{
		...
		e.printStackTrace(); // COMMON-ICN-0184
            ...
            out.print( String.valueOf(objMmUtils.getListOptions( MmRepository.getMmKeyValue("SQL_MODULE_ID"),"ST",locale)
		));
