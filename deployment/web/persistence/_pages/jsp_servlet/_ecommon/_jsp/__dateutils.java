...
public final class __dateutils extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecommon/jsp/DateUtils.jsp", 1710944375988L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
	...
	if(methodName.equals("CONVERTDATE")){
		out.print(convertDate(date, format, fromLocale, toLocale));
	}else if(methodName.equals("GETCURRENTDATE")){
		out.print(getCurrentDate(format, locale));
	}else if(methodName.equals("VALIDDATE")){
		out.print(validDate(date, format, locale));
	}else if(methodName.equals("ISBEFORE")){
		out.print(isBefore(fromDate, toDate, format, locale));
	}else if(methodName.equals("ISBEFORENOW")){
		out.print(isBeforeNow(currDate, format, locale));
	}else if(methodName.equals("ISAFTERNOW")){
		out.print(isAfterNow(currDate, format, locale));
	}else if(methodName.equals("ISAFTER")){
		out.print(isAfter(fromDate, toDate, format, locale));
	}else if(methodName.equals("ISBETWEEN")){
		out.print(isBetween(fromDate, toDate, currDate, format, locale));
	}else if(methodName.equals("GETDAYOFMONTH")){
		out.print(getDayOfMonth(currDate, format, locale));
	}else if(methodName.equals("GETDAYOFWEEK")){
		out.println(getDayOfWeek(currDate, format, locale));
	}else if(methodName.equals("GETDAYOFWEEKASLONGTEXT")){
		out.print(getDayOfWeekAsLongText(currDate, format, locale));
	}else if(methodName.equals("GETDAYOFWEEKASSHORTTEXT")){
		out.print(getDayOfWeekAsShortText(currDate, format, locale));
	}else if(methodName.equals("GETMONTHOFYEAR")){
		out.print(getMonthOfYear(currDate, format, locale));
	}else if(methodName.equals("GETMONTHOFYEARASLONGTEXT")){	
		out.print(getMonthOfYearAsLongText(currDate, format, locale));
	}else if(methodName.equals("GETMONTHOFYEARASSHORTTEXT")){
		out.print(getMonthOfYearAsShortText(currDate, format, locale));
	}else if(methodName.equals("GETYEAR")){	
		out.print(getYear(currDate, format, locale));
	}else if(methodName.equals("GETHOUROFDAY")){
		out.print(getHourOfDay(currDate, format, locale));
	}else if(methodName.equals("GETMINUTEOFHOUR")){	
		out.print(getMinuteOfHour(currDate, format, locale));
	}else if(methodName.equals("MINUSDATE")){
		out.print(minusDate(currDate, format, locale, val, interval));
	}else if(methodName.equals("PLUSDATE")){
		out.print(plusDate(currDate, format, locale, val, interval));
	}else if(methodName.equals("DAYSBETWEEN")){
		out.print(daysBetween(fromDate,toDate,format,locale));
	}else if(methodName.equals("WEEKSBETWEEN")){
		out.print(weeksBetween(fromDate,toDate,format,locale));
	}else if(methodName.equals("MONTHSBETWEEN")){
		out.print(monthsBetween(fromDate,toDate,format,locale));
	}else if(methodName.equals("YEARSBETWEEN")){
		out.print(yearsBetween(fromDate,toDate,format,locale));
	...
	}else if(methodName.equals("SECONDSBETWEEN")){
		out.print(secondsBetween(fromDate,toDate,format,locale));
	}else if(methodName.equals("DURATIONBETWEEN")){
		out.print(durationBetween(fromDate,toDate,format,locale));
	}else if(methodName.equals("GETDAYSINMONTH")){
		out.print(getDaysInMonth(date,format,locale));
	}else if(methodName.equals("ISLEAPYEAR")){
		out.print(isLeapYear(date,format,locale));
	}else if(methodName.equals("FORMATDATE")){
		out.print(formatDate(date,fromFormat,toFormat,locale));
	}
