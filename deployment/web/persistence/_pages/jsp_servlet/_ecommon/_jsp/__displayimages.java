...
public final class __displayimages extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ecommon/jsp/DisplayImages.jsp", 1709116504014L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
String qryImgContent = "";
					...
					if(logo_name.equals("clientlogo")){
					qryImgContent = "select SITE_LOGO_LOGIN_SCREEN LOGO from SM_SITE_PARAM";
					}else if(logo_name.equals("facilityimage")){
						qryImgContent = "select FACILITY_LOGO LOGO from SM_FACILITY_PARAM where facility_id='"+session.getValue("facility_id")+"'";
					}
