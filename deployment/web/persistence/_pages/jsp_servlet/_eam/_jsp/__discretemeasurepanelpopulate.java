...
public final class __discretemeasurepanelpopulate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/DiscreteMeasurePanelPopulate.jsp", 1709113987289L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 =".document.createElement(\'OPTION\'); \n\t\t\t\topt.text\t=\t\"";
    ...
    private final static java.lang.String  _wl_block12 =".document.forms[0].discr_msr_id.add(opt); \n\t\t\t</script>\n\t\t\t";
