...
public final class __md_addmodifyoppfforfacilityquery extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/md_addModifyOPPFForFacilityQuery.jsp", 1712931200156L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block19 ="\' class=\'button\' onClick=\'callPractitioner()\'></td>\n   \t\t\t\t</tr>\n\t\t\t\t\t\t\t<!-- <td></td>\n\t\t\t\t\t\t\t<td></td> -->\n\t\t\t\t\t\t\t</table>\n\t\t\t\n    \t\t\t\t    \t ";
