...
public final class __healthcaresettingtypemodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/HealthCareSettingTypeModify.jsp", 1714474440584L ,"10.3.6.0","Asia/Calcutta")) return true;
...
if(eff_status.equals("D"))
{
	mod_prop="READONLY";
            ...
            out.print( String.valueOf( rset.getString("hcare_setting_type_code") ));
