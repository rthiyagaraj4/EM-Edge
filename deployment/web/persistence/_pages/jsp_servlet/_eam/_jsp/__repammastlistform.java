...
public final class __repammastlistform extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/repAmMastListForm.jsp", 1709114039585L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	ResultSet rs = null;
            ...
            out.print( String.valueOf( strTableId ));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf( strCodeDesc ));
