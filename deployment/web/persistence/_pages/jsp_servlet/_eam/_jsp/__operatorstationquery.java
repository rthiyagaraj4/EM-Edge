...
public final class __operatorstationquery extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/OperatorStationQuery.jsp", 1720597604909L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="<a href=\"javascript:qryModify(\'";
    ...
    private final static java.lang.String  _wl_block14 ="</a></td><td class=\'";
...
String eff_status="";
	...
	try{	conn = ConnectionManager.getConnection(request);
		...
		//if ( !( (start+14) > maxRecord ) )
            ...
            out.print( String.valueOf(facilityid1));
