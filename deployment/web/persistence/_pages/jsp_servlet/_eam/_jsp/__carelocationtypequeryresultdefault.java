...
public final class __carelocationtypequeryresultdefault extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/CarelocationtypeQueryResultDefault.jsp", 1710444255309L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String strsql2="select * from am_care_locn_type where sys_user_def_ind like 'S%' order by locn_type";
...
//if ( !( (start+14) > maxRecord ) )
	...
	out.println("<tr><td class='" + classValue + "'>"+rs.getString("locn_type")+"</td>");
