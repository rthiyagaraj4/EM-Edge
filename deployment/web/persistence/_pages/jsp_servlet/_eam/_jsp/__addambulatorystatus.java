...
public final class __addambulatorystatus extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eam/jsp/addAmbulatoryStatus.jsp", 1709113959770L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="</td><!--width=\'40%\'-->\n      \t\t    <td class=\'fields\'>&nbsp;&nbsp;<!--width=\'60%\' colspan=\'2\'-->\n      \t\t    <input type=\'text\' name=\'ambulatory_status\' id=\'ambulatory_status\'  onBlur=\"makeValidString(this);changeCase(this)\" onKeyPress=\"return CheckForSpecChars(event)\"  value=\"";
