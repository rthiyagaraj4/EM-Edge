...
public final class __visitregistrationint extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eop/jsp/VisitRegistrationInt.jsp", 1744017203674L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block5 ="\n\t\t\t\t\t\t\t; async function toHoldShowModal1(){\n\t\t\t\t\t\t\tvar dialogHeight= \"80vh\" ;\n\t\t\t\t\t\t\tvar dialogWidth = \"80vw\" ;\n\t\t                    var wintop = \"210\"\n\t\t\t\t\t\t\tvar features    = \"dialogHeight:\" + dialogHeight + \"; dialogWidth:\" + dialogWidth +\";dialogTop:\" + wintop +\";status=no\";\n\t\t                    var arguments   = \"\" ;\n\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t/*Below line modified for this SCF MMS-SCF-0071 [IN:042582]*/\n\n\t\t\t\t\t\t\tvar patientId = await top.window.showModalDialog(\"../../eOP/jsp/OPPatientListforAltId.jsp?altIdNo1=";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="&altIdNo2=";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="&altIdNo3=";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="&altIdNo4=";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="&otherAlternateIDType=";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="&otherAlternateIDNo=";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="&names_in_oth_lang_yn=";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\",arguments,features); \t\t\t\t\t\t    \n\t\t\t\t\t\t\tif(patientId!=undefined && patientId!=\'undefined\') {\n\t\t\t\t\t\t\t\tshowPatientListforAltId1(patientId);\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\ttoHoldShowModal1();\n\t\t\t\t\t\t\t";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\n\t\t    patFlag=pat_id.charAt(0);\n\t\t\tif(patFlag==\"Y\")\n\t\t\t\tpat_id=pat_id.substring(1,pat_id.length);\n\t\t\telse if(patFlag==\"N\")\n\t\t\t    pat_id=pat_id.substring(1,pat_id.length);\n\t\t\tif(pat_id!=\"N\" &&pat_id!=\"C\") {\t\t\t /*if(updatePatDet(pat_id,\"\",\"\",\"";
    ...
    private final static java.lang.String  _wl_block16 ="\n               parent.frames[1].frames[3].document.location.href=\"../../eOP/jsp/VisitRegistrationResult.jsp?emer_regn_allow_yn=";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="visit_for_inpat_yn=";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="&order_catalog_code=";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="&q_practitioner_id=";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="&referral_id=";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="&q_clinic_code=";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="&locn_ind=";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="&or_install_yn=";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="&build_episode_rule=";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 ="&oper_stn_id=";
    private final static byte[]  _wl_block25Bytes = _getBytes( _wl_block25 );

    private final static java.lang.String  _wl_block26 ="&bl_interface_yn=";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="&functionId=";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="&menu_function_id=";
    private final static byte[]  _wl_block28Bytes = _getBytes( _wl_block28 );

    private final static java.lang.String  _wl_block29 ="&patient=\"+pat_id+\"&patFlag=\"+patFlag+\"&query_String=\"+encodeURIComponent(\"";
    ...
    private final static java.lang.String  _wl_block32 ="\n\t\t\t\t\t\tparent.frames[1].frames[1].document.forms[0].pat_id1.value=\"";
    ...
    private final static java.lang.String  _wl_block36 ="&visit_for_inpat_yn=";
    private final static byte[]  _wl_block36Bytes = _getBytes( _wl_block36 );

    private final static java.lang.String  _wl_block37 ="&upt_contact_dtls_oa_yn=";
    private final static byte[]  _wl_block37Bytes = _getBytes( _wl_block37 );

    private final static java.lang.String  _wl_block38 ="&patient=";
    private final static byte[]  _wl_block38Bytes = _getBytes( _wl_block38 );

    private final static java.lang.String  _wl_block39 ="\"\n\t\t   \n\t\t }\n\t }\n       ";
    private final static byte[]  _wl_block39Bytes = _getBytes( _wl_block39 );

    private final static java.lang.String  _wl_block40 ="\n\t\t\n\t\t\tparent.frames[1].frames[3].document.forms[0].locationSpeciality.value=\'";
...
if (list_name.equals("check_pat"))// on blur if patient id...
 {
	...
	if(!altIdNo1.equals("") || !altIdNo2.equals("") || !altIdNo3.equals("") || !altIdNo4.equals("") || !otherAlternateIDNo.equals("")) { 
            ...
            out.print( String.valueOf(otherAlternateIDType));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(otherAlternateIDNo));
...
if(!(isUHID_valid_appl && chk_valid == true && bl_install_yn.equals("Y")) ){
            ...
            out.print( String.valueOf(to_order_code));
            _bw.write(_wl_block19Bytes, _wl_block19);
            out.print( String.valueOf(to_pract_id));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(p_referral_id));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(to_clinic_code));
