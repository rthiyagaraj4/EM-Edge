...
public final class __procunitcatalogcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eop/jsp/ProcUnitCatalogCriteria.jsp", 1709117143582L ,"10.3.6.0","Asia/Calcutta")) return true;
...
thirdItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOP.ProcedureUnitCode.label","op_labels"));	// label
...
fourthItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOP.ProcedureUnitDescription.label","op_labels"));	 // label
...
firstItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOP.OrderCatalogNo.label","op_labels"));     // label
...
secondItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.OrderCatalogDescription.label","common_labels"));     // label
...
orderByCols[2] = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eOP.OrderCatalogNo.label","op_labels");
