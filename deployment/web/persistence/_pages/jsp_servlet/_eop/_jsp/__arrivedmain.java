...
public final class __arrivedmain extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eop/jsp/ArrivedMain.jsp", 1709119424726L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 =" <!--Below condition was added by Venkatesh.S on 16-Nov-2012 against SS-CRF-010 -->\n\t\t\t\t\t\t\t   ";
    ...
    private final static java.lang.String  _wl_block23 ="\t\t\t\t\t\t\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t<tr>\t\t\t\t\t\t\t\n\t\t\t\t\t\t<td align=\'right\' colspan=\'4\'><input type=\'button\' class=\'button\' name=\'ok\' id=\'ok\' value=\'";
    private final static byte[]  _wl_block23Bytes = _getBytes( _wl_block23 );

    private final static java.lang.String  _wl_block24 ="\' onClick=\"submit_ok()\"><input type=\'button\'class=\'button\' name=\'close\' id=\'close\' value=\'";
    private final static byte[]  _wl_block24Bytes = _getBytes( _wl_block24 );

    private final static java.lang.String  _wl_block25 ="\' onClick=\'exitArrived()\'>\n\t\t\t\t\t\t</td>\t\t\t\t\t\t\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t </table>\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t</table>\n\n\t\t<input type=\'hidden\' name=\"pat_id\" id=\"pat_id\" value=\"";
