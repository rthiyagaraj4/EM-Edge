...
public final class __viewqryreprocess extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/Viewqryreprocess.jsp", 1709122410240L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
String exceptions="";
 ...
 Querystatus=request.getParameter("qstatus");
    ...
    {
       System.out.println("Error in dooperate method of Viewqryreprocess.jsp :"+exp.toString());	
