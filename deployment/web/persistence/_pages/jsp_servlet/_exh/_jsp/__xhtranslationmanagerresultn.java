...
public final class __xhtranslationmanagerresultn extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/XHTranslationManagerResultN.jsp", 1744722941843L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block6 ="\'></link>\n<script src=\'../../eCommon/js/ValidateControl.js\' language=\'javascript\'></script>\n<script src=\'../../eCommon/js/common.js\' language=\'javascript\'></script>\n<script language=\'javascript\' src=\'../js/XHTranslationManagerN.js\'></script>\n<script src=\'../../eCommon/js/showModalDialog.js\' language=\'JavaScript\'></script>\n\n\n\n\n\n</head>\n <body onLoad=\'FocusFirstElement()\' OnMouseDown=\'CodeArrest()\' onKeyDown = \'lockKey()\'>\n<form name=\"TranslationResult\" id=\"TranslationResult\" method=post  action= \'../../servlet/eXH.XHTranslationManagerServletN\'  target=\"messageFrame\">\n\n ";
    ...
    private final static java.lang.String  _wl_block12 ="</b></td></td>\n</table>\n<table cellspacing=0 cellpadding=0  width=\"100%\" border=\"0\">\n<tr> \n";
    ...
    private final static java.lang.String  _wl_block17 ="\n\t <th align=left>Label</th>\n     <th align=left>eHIS Value</th>\n     <th align=left>Translated Value</th>\t \n\t";
    ...
    private final static java.lang.String  _wl_block30 ="\"   onblur=\'return makeValidString(this);\'\n\t\t\t\t maxlength=\'";
    private final static byte[]  _wl_block30Bytes = _getBytes( _wl_block30 );

    private final static java.lang.String  _wl_block31 ="\'  value=\'";
    private final static byte[]  _wl_block31Bytes = _getBytes( _wl_block31 );

    private final static java.lang.String  _wl_block32 ="\' size=40 > </td> \n\t\t\t\t -->\n\t\t\t\t ";
    ...
    private final static java.lang.String  _wl_block46 ="\' ><INPUT TYPE=\"text\" name=\"desc";
    private final static byte[]  _wl_block46Bytes = _getBytes( _wl_block46 );

    private final static java.lang.String  _wl_block47 ="0\" id=\"desc";
    private final static byte[]  _wl_block47Bytes = _getBytes( _wl_block47 );

    private final static java.lang.String  _wl_block48 ="0\"  onblur=\'return makeValidString(this);\'\n\t\t\t\t maxlength=\'";
    private final static byte[]  _wl_block48Bytes = _getBytes( _wl_block48 );

    private final static java.lang.String  _wl_block49 ="\' size=60 > </td> \n\t\t";
    ...
    private final static java.lang.String  _wl_block58 ="\' ><INPUT TYPE=\"text\" NAME=desc";
    private final static byte[]  _wl_block58Bytes = _getBytes( _wl_block58 );

    private final static java.lang.String  _wl_block59 =" ID=desc";
    private final static byte[]  _wl_block59Bytes = _getBytes( _wl_block59 );

    private final static java.lang.String  _wl_block60 =" onblur=\'return makeValidString(this);\'\n\t\t\t\t maxlength=\'";
    private final static byte[]  _wl_block60Bytes = _getBytes( _wl_block60 );

    private final static java.lang.String  _wl_block61 ="\' size=50 > </td> \n\t\t";
    private final static byte[]  _wl_block61Bytes = _getBytes( _wl_block61 );

    private final static java.lang.String  _wl_block62 ="\n\n </tr>\n\t \n ";
    private final static byte[]  _wl_block62Bytes = _getBytes( _wl_block62 );

    private final static java.lang.String  _wl_block63 ="  id=pk";
...
String loggedUser = p.getProperty("login_user");
	...
	count++;
	 ...
	 trans_tbl_type = trans_table_id.substring(trans_tbl_len-4,trans_tbl_len);
	 if(count==0){
			//System.out.println("XHTranslationManagerResult.jsp trans_table_id : "+trans_table_id);
			//System.out.println("XHTranslationManagerResult.jsp master_table_id : "+master_table_id);
	}
...
//	count++;
 ...
 // added on Mar 16th
 /*  Cmmntd in Jun10th  if(!trans_table_id.equals("XH_OTH_APPL_DATA_SKEY") && !trans_table_id.equals("XH_OTH_APPL_DATA_DKEY")) {
			if ( from == null )
			start = 1 ;
			else
			start = Integer.parseInt(from) ;
...
/*	  
			...
			for( startVal=0;startVal<pkval.size();startVal++)
			 {		  
			  	 // code added on 24th Dec - Name Prefix - only for Code
					  ...
					  /* Commented by Sethu on 24/12/2021 */
	...
	// Non- Translated
	 ...
	 {	 
		 ...
		 {
			 //Select count(*)  total from (Select 'en' APPLICATION_ID, 1 seq_no,CREDIT_CO_CODE,CREDIT_CO_NAME   FROM  BL_CREDIT_COMPANY  WHERE (CREDIT_CO_CODE)   in (select PK_VALUE from  XH_OTH_APPL_DATA_SKEY  where table_id='BL_CREDIT_COMPANY' and APPLICATION_ID='HSWITCH' 	and OUTBOUND_YN='X' ) AND UPPER(NVL(CREDIT_CO_CODE,'*')) like upper('%')  union	 SELECT  'HSWITCH' APPLICATION_ID,2 SEQ_NO, pk_value,desc2_Value   FROM  XH_OTH_APPL_DATA_SKEY  WHERE  APPLICATION_ID = 'HSWITCH' and table_id='BL_CREDIT_COMPANY'  and OUTBOUND_YN='X'  AND pk_value IN (SELECT CREDIT_CO_CODE  from BL_CREDIT_COMPANY  where UPPER(NVL(CREDIT_CO_CODE,'*')) LIKE upper('%')))

			 sql.append("table_id='"+masterName+"' and APPLICATION_ID='"+appl+"'   and OUTBOUND_YN='"+outbound_yn+"'  ");
			 if(columnVal.size()>0)
			{
				 //added by prithivi on 15/06/2017
				   sql.append("	 and (desc2_value is null AND ext_pk_id is null ) ) AND ( UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) like upper('"+searchText+"') )");
			 }
			 else
			{
			     //cmmntd on jan6th for srchtxt
			     //sql.append(" and ext_pk_id is null ) ");
				 sql.append(" and ext_pk_id is null AND UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"')) ");
			 }
		  }
		  if(trans_table_id.equals("XH_OTH_APPL_DATA_DKEY"))
			 {
                //Added by prithivi on 19/06/2017
				if(columnVal.size()>1)
				{
					 //added by prithivi on 19/06/2017
					   sql.append("table_id='"+masterName+"' and APPLICATION_ID='"+appl+"' and OUTBOUND_YN='"+outbound_yn+"'  and (desc2_value is null AND ext_pk1_value IS  NULL AND ext_pk2_value IS  NULL) ) AND ( UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"') OR  UPPER(NVL("+columnVal.get(0)+",'*')) like upper('"+searchText+"'))  AND ( UPPER(NVL("+pkval.get(1)+",'*')) like upper('"+searchpk2+"') OR UPPER(NVL("+columnVal.get(1)+",'*')) like upper('"+searchpk2+"'))");
				 }
				 else
				{
					//old query
					sql.append("table_id='"+masterName+"' and APPLICATION_ID='"+appl+"' and OUTBOUND_YN='"+outbound_yn+"'  and (desc2_value is null AND ext_pk1_value IS  NULL AND ext_pk2_value IS  NULL) ) AND UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"')  AND UPPER(NVL("+pkval.get(1)+",'*')) like upper('"+searchpk2+"') ");
				 }
	...
	//	     	Cmmnt on Oct16 sql.append("desc"+(startVal+1)+"_Value");
	 ...
	 if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY"))
		...
		sql.append("   FROM  "+trans_table_id+"  WHERE APPLICATION_ID = '"+appl+"' and table_id='"+masterName+"'  and OUTBOUND_YN='"+outbound_yn+"' ");

			if(columnVal.size()>0){
				sql.append("   and  (desc2_value is null AND ext_pk_id is null ) ");
			}
			else{
				sql.append("   and  ext_pk_id is null ");
			}
		...
		if((masterName.equals("SM_FUNCTION")||masterName.equals("SM_REPORT")||masterName.equals("SM_FUNCTION_LEGEND")||masterName.equals("SM_LABEL_ITEM")||masterName.equals("SM_LIST_ITEM")||masterName.equals("SM_RECORD_TRANS")))
				...
				sql.append(" and pk_value='"+Searchbymod+"')");
					...
					//added by prithivi on 15/06/2017
					   ...
					   {
							sql.append(" AND pk_value IN (SELECT "+pkval.get(0)+"  from "+masterName+"  where ( UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"') OR UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"') )))");
					   }
					   else
					   {
						   sql.append(" AND pk_value IN (SELECT "+pkval.get(0)+"  from "+masterName+"  where UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"')))");
					   }
				}
			 
			 }// end of XH_OTH_APPL_DATA_SKEY 
			 else if(trans_table_id.equals("XH_OTH_APPL_DATA_DKEY")){
				sql.append("   FROM  "+trans_table_id+"  WHERE  (DESC2_VALUE IS NULL AND ext_pk1_value IS NULL AND ext_pk2_value IS NULL) and APPLICATION_ID = '"+appl+"' and table_id='"+masterName+"'  and OUTBOUND_YN='"+outbound_yn+"' ");
				 if((masterName.equals("SM_FUNCTION")||masterName.equals("SM_REPORT")||masterName.equals("SM_FUNCTION_LEGEND")||masterName.equals("SM_LABEL_ITEM")||masterName.equals("SM_LIST_ITEM")||masterName.equals("SM_RECORD_TRANS")))
			{if(!Searchbymod.equals(""))
				{
			...
			sql.append(" AND (pk1_value,pk2_value) IN (SELECT "+pkval.get(0)+",");
			 ...
			 if(masterName.equals("SM_MASTER_CODE"))
			 {
				...
				if(columnVal!=null && columnVal.size() > 0)
				{
					sql.append("to_char("+pkval.get(1)+")  from "+masterName+"  where ( UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) LIKE upper('"+searchText+"')) ))");
				}
				else
				{
					//OLD QUERY
					sql.append("to_char("+pkval.get(1)+")  from "+masterName+"  where UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"')))");
				}
			 }
			 else
			 {
				...
				{
					sql.append(pkval.get(1)+"  from "+masterName+"  where  ( UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) like upper('"+searchText+"')) AND ( UPPER(NVL("+pkval.get(1)+",'*')) like upper('"+searchpk2+"') OR UPPER(NVL("+columnVal.get(1)+",'*')) like upper('"+searchpk2+"')) ))");
				}
				else
				{
					//OLD QUERY
					sql.append(pkval.get(1)+"  from "+masterName+"  where  UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"')  AND UPPER(NVL("+pkval.get(1)+",'*')) like upper('"+searchpk2+"') ))");
				}
				...
				sql.append("   FROM  "+trans_table_id+"  WHERE  (DESC2_VALUE IS NULL AND ext_pk1_value IS NULL AND ext_pk2_value IS NULL AND ext_pk3_value IS NULL) and APPLICATION_ID = '"+appl+"' and OUTBOUND_YN='"+outbound_yn+"' ");
			 
				sql.append(" AND (pk1_value,pk2_value,pk3_value) IN (SELECT "+pkval.get(0)+","+pkval.get(1)+","+pkval.get(2));
...
// 	 Translated
	 ...
	 if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY")){
					...
					if(columnVal.size()>0){
				 		sql.append("and (desc2_value is not null OR ext_pk_id is not null ) ) ");
					}
					else{
						sql.append(" AND ext_pk_id is not null ) ");
					}
					if(columnVal.size()>0){
				 		sql.append(" AND ( UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) like upper('"+searchText+"'))");
					}
					else{
						//old query
						sql.append(" AND UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"') ");
					}
	 }
	 if(trans_table_id.equals("XH_OTH_APPL_DATA_DKEY")){
				...
				if(columnVal!=null && columnVal.size()>1 )
				{
					sql.append("table_id='"+masterName+"' and APPLICATION_ID='"+appl+"'  and OUTBOUND_YN='"+outbound_yn+"' and (DESC2_VALUE IS NOT NULL OR ext_pk1_value IS NOT NULL OR ext_pk2_value IS NOT NULL)  ) AND (UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) like upper('"+searchText+"'))  AND (UPPER(NVL("+pkval.get(1)+",'*')) like upper('"+searchpk2+"') OR UPPER(NVL("+columnVal.get(1)+",'*')) like upper('"+searchpk2+"'))");
				}
				else{
					//old query
					sql.append("table_id='"+masterName+"' and APPLICATION_ID='"+appl+"'  and OUTBOUND_YN='"+outbound_yn+"' and (DESC2_VALUE IS NOT NULL OR ext_pk1_value IS NOT NULL OR ext_pk2_value IS NOT NULL)  ) AND UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"')  AND UPPER(NVL("+pkval.get(1)+",'*')) like upper('"+searchpk2+"') ");
				}
 ...
 if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY"))
		 {
			...
			sql.append(" and pk_value='"+Searchbymod+"')");
				...
				if(columnVal!=null && columnVal.size()>0 )
				{
					sql.append(" AND pk_value IN (SELECT "+pkval.get(0)+"  from "+masterName+"  where (UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) LIKE upper('"+searchText+"'))))");
				}
				else
				{
					//old query
			...
			sql.append("   FROM  "+trans_table_id+"  WHERE  (DESC2_VALUE IS not NULL OR ext_pk1_value IS not NULL OR ext_pk2_value IS not NULL) and APPLICATION_ID = '"+appl+"' and table_id='"+masterName+"'  and OUTBOUND_YN='"+outbound_yn+"' ");
					 if((masterName.equals("SM_FUNCTION")||masterName.equals("SM_REPORT")||masterName.equals("SM_FUNCTION_LEGEND")||masterName.equals("SM_LABEL_ITEM")||masterName.equals("SM_LIST_ITEM")||masterName.equals("SM_RECORD_TRANS")))
			{if(!Searchbymod.equals(""))
				{
			sql.append(" and pk1_value='"+Searchbymod+"'");
			...
			sql.append("   FROM  "+trans_table_id+"  WHERE  (DESC2_VALUE IS not NULL OR ext_pk1_value IS not NULL OR ext_pk2_value IS not NULL OR ext_pk3_value IS not NULL) and APPLICATION_ID = '"+appl+"'  and OUTBOUND_YN='"+outbound_yn+"'  ");
     ...
     if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY")||trans_table_id.equals("XH_OTH_APPL_DATA_DKEY"))
		 {
			 ...
			 if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY")){
				 //added by prithivi on 14/06/2017
				 if(columnVal != null && columnVal.size() > 0)
				 {
					 sql.append("AND ( UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) like upper('"+searchText+"') )");
				 }
				 ...
				 if(columnVal != null && columnVal.size() > 1)
				 {
					 sql.append("AND (UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) like upper('"+searchText+"'))  AND (UPPER(NVL("+pkval.get(1)+",'*')) like upper('"+searchpk2+"') OR UPPER(NVL("+columnVal.get(1)+",'*')) like upper('"+searchpk2+"'))");
				 }
				 else
				 {
                     // old search
					 sql.append("AND UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"')  AND UPPER(NVL("+pkval.get(1)+",'*')) like upper('"+searchpk2+"') ");
				 }
...
//	     	sql.append("desc"+(startVal+2)+"_Value");
 ...
 if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY"))
	...
	if((masterName.equals("SM_FUNCTION")||masterName.equals("SM_REPORT")||masterName.equals("SM_FUNCTION_LEGEND")||masterName.equals("SM_LABEL_ITEM")||masterName.equals("SM_LIST_ITEM")||masterName.equals("SM_RECORD_TRANS")))
		 ...
		 sql.append("   FROM  "+trans_table_id+"  WHERE  APPLICATION_ID = '"+appl+"'  and OUTBOUND_YN='"+outbound_yn+"'   ");
		 	// and table_id='"+masterName+"' and OUTBOUND_YN='"+outbound_yn+"'
			if((masterName.equals("SM_FUNCTION")||masterName.equals("SM_REPORT")||masterName.equals("SM_FUNCTION_LEGEND")||masterName.equals("SM_LABEL_ITEM")||masterName.equals("SM_LIST_ITEM")||masterName.equals("SM_RECORD_TRANS")))
			{if(!Searchbymod.equals(""))
				{
			sql.append(" and pk1_value='"+Searchbymod+"'");
...
//			sql.append(" AND ("+pkval.get(0)+","+pkval.get(1)+","+pkval.get(2)+") IN (SELECT "+pkval.get(0)+",");
	...
	if(maxRecord==0)
	 {
		 out.println("<script>alert(getMessage('NO_RECORD_FOUND_FOR_CRITERIA','common'));parent.Search.document.forms[0].synchronize.disabled=false;parent.dummyFrame.location.href='../../eCommon/html/blank.html';</script>");
	 }else{
		String export_data_yn="N";
		String upload_data_yn="N";
	String authSql = "SELECT export_data_yn,upload_data_yn FROM xh_authorized_user WHERE UPPER(LOGIN_NAME)=UPPER('"+loggedUser+"')"; 
	...
	{ 
		...
		{	
		 ...
		 {
			System.out.println("Exception in XHTranslationMangerResult :"+e);
		 }
		 if(authRS!=null)
		 authRS.close();
...
//	 if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY")||trans_table_id.equals("XH_OTH_APPL_DATA_DKEY")){
			 if ( !(start <= 1) )
				out.println(" <A HREF='javascript:recordPrevData()'  text-decoration='none'>"+"Previous"+"</A>");
				
			if ( !( (start+20) > maxRecord ) )
			out.println(" <A href='javascript:recordNextData()' text-decoration='none'>"+"Next"+"</A>");
	//} // end of SKEY || DKEY
/*	 else{
	 ...
	 for( startVal=0;startVal<pkval.size();startVal++)
	  {
	   ...
	   if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY")){
			...
			// modified on Dec 24 for Name Prefix - only for code
				if(columnVal.size()>0){
					sql.append(pkval.get(0)+" ext_pk_id,");
				}
				else{												    
					sql.append(pkval.get(0)+" ext_pk_id");
				}
	   ...
	   // added on Oct15
			...
			{
			    sql.append("a.");
				sql.append(pkval.get(startVal)+" ext_pk"+pkCnt+"_value,");
				pkCnt++;
			}
	   }
 	    ...
 	    if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY")||trans_table_id.equals("XH_OTH_APPL_DATA_DKEY")||trans_tbl_type.equals("APPL")) {
				for( startVal=0;startVal<columnVal.size();startVal++)
			   {
				...
				for( startVal=0;startVal<colValue.size();startVal++,startVal1++){
					sql.append("a.");
					if(((String)columnVal.get(startVal)).substring(0,3).equals("EXT")){

						sql.append(colValue.get(startVal)+" EXT_"+(String)colValue.get(startVal));
					}
					else{
						sql.append(colValue.get(startVal));
					}
...
//		 sql.append("pk1_value,pk2_value,");
		 sql.append("pk1_value,pk2_value, pk3_value,ext_pk1_value,ext_pk2_value,ext_pk3_value,");
		  for(startVal=0;startVal<columnVal.size();startVal++)
	       {
// cmmntd on jan6th	     	sql.append("desc"+(startVal+1)+"_Value");
	     	sql.append("desc"+(startVal+2)+"_Value");
 ...
 if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY"))
		...
		// cmmntd on jan6th 			if(columnVal.size()>0){
			//below code was commented by prithivi
						//sql.append(" AND pk_value IN (SELECT "+pkval.get(0)+"  from "+masterName+"  where UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"'))");
//					}
					// end of code added 
                    //added by prithivi on 15/06/2017
...
//	sql.append("   FROM  "+trans_table_id+"  WHERE  "+columnVal.get(0)+" is null and APPLICATION_ID = '"+appl+"' " ); 
	 ...
	 sql.append("   FROM  "+trans_table_id+"  WHERE  APPLICATION_ID = '"+appl+"' " ); 
		...
		if(columnVal!=null && columnVal.size()>0)
		{
			sql.append(" from "+masterName+ "  where (UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) LIKE upper('"+searchText+"')))");
		}
		else
		{
			...
			if(masterName.equals("SM_MASTER_CODE"))
			 {
				if(columnVal!=null && columnVal.size()>0)
					{
						sql.append("to_char("+pkval.get(1)+")  from "+masterName+"  where (UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"') OR UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"')) )");
					}
					else
					{
						sql.append("to_char("+pkval.get(1)+")  from "+masterName+"  where (UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"') OR UPPER(NVL("+columnVal.get(0)+",'*')) LIKE upper('"+searchText+"')) )");
     ...
     if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY")||trans_table_id.equals("XH_OTH_APPL_DATA_DKEY"))
		 {
			...
			sql.append("table_id='"+masterName+"' and APPLICATION_ID='"+appl+"'  and OUTBOUND_YN='"+outbound_yn+"' ) ");
			 ...
			 if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY")){
			 //added by prithivi on 15/06/2017
				//sql.append("AND UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"') OR UPPER (NVL ("+pkval.get(0)+", '*')) LIKE upper('"+searchText+"') ");
				...
				{
					sql.append("AND UPPER(NVL("+pkval.get(0)+",'*')) like upper('"+searchText+"')");  //old query
				}
 ...
 if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY"))
		 ...
		 sql.append("   FROM  "+trans_table_id+"  WHERE  APPLICATION_ID = '"+appl+"' and table_id='"+masterName+"'  and OUTBOUND_YN='"+outbound_yn+"' ");
			...
			sql.append(" and pk_value='"+Searchbymod+"'");
				...
				// sql.append(" AND pk_value IN (SELECT "+pkval.get(0)+"  from "+masterName+"  where UPPER(NVL("+pkval.get(0)+",'*')) LIKE upper('"+searchText+"'))"); //old query
	...
	sql.append("   FROM  "+trans_table_id+"  WHERE  APPLICATION_ID = '"+appl+"'  and OUTBOUND_YN='"+outbound_yn+"'  ");
			...
			sql.append("  AND (pk1_value,pk2_value,pk3_value) IN (SELECT "+pkval.get(0)+",");
	...
	String keyName = "";
            ...
            _bw.write(_wl_block23Bytes, _wl_block23);
						  ...
						  if(trans_table_id.equals("XH_OTH_APPL_DATA_DKEY")){
							 ...
							 else if(trans_table_id.equals("XH_OTH_APPL_DATA_SKEY")){
 								 keyName = "ext_pk_id";
							 }
            ...
            out.print( String.valueOf(rs.getString((String)keyName)==null?"":rs.getString((String)keyName)));
            ...
            out.print( String.valueOf(rs.getString((String)pkval.get(startVal))==null?"":rs.getString((String)pkval.get(startVal))));
...
for( startVal=0;startVal<pkval.size();startVal++)
  {
            ...
            out.print( String.valueOf((rs.getString((String)colValue.get(colDispCount))==null)? "":(rs.getString((String)colValue.get(colDispCount)))));
            ...
            out.print( String.valueOf("engLang"+(colDispCount)+"0"));
...
//		
	...
	if(lang.equals("en"))
	 {																  
            ...
            out.print( String.valueOf(colCount));
            _bw.write(_wl_block42Bytes, _wl_block42);
            out.print( String.valueOf("engLang"+(engColCount)+(colCount)));
            _bw.write(_wl_block43Bytes, _wl_block43);
            out.print( String.valueOf(rs.getString((String)columnVal.get(startVal))==null?"":rs.getString((String)columnVal.get(startVal))));
            _bw.write(_wl_block44Bytes, _wl_block44);
engColCount++ ;}else {
...
if(!lang.equals("en"))
 ...
 {
		System.out.println("XHTranslationManagerResultN.jsp Error"+e);
		e.printStackTrace();
 }finally{
