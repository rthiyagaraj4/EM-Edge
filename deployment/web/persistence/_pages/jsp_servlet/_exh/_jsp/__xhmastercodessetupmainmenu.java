...
public final class __xhmastercodessetupmainmenu extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/XHMasterCodesSetupMainMenu.jsp", 1709122418615L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t\t<tr onclick=\'chcol(this)\'>\n\t\t\t<td  class=\'MENUSUBLEVELCOLOR\' onClick=\"javascript:callJSPs(\'";
...
(session.getAttribute("PREFERRED_STYLE")!=null)?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	 ...
	 while(rset.next())
	  {
            ...
            out.print( String.valueOf(rset.getString(5)+"?"+"module_id=XH"+"&"+"function_id="+rset.getString(2)+"&"+"function_name="+rset.getString(3)+"&"+"function_type="+rset.getString(4)+"&"+"access="+rset.getString(6)+rset.getString(7)+rset.getString(8)+rset.getString(9)+rset.getString(10)));
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eXH.MENU.Label", java.lang.String .class,"key"));
