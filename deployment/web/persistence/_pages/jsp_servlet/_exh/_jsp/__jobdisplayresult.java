...
public final class __jobdisplayresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/JobDisplayResult.jsp", 1729246519972L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
 ...
 String p_action=(String)request.getAttribute("p_action");	   
  if((status.equals("0")) ||(status.equals("2")))
	{ 
            ...
            out.print( String.valueOf(p_action));
