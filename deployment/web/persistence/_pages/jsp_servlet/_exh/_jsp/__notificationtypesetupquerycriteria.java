...
public final class __notificationtypesetupquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/NotificationTypeSetupQueryCriteria.jsp", 1733050703350L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
firstItem.add("Type Code");     // label
firstItem.add("typeCode");  //name of field
...
secondItem.add("shortDesc");  //name of field
...
orderByCols[0] = "Type Code";
orderByCols[1] = "Description";

orderByColVals[0] = "1";
orderByColVals[1] = "2";

strbuff = qrypg.getQueryPage(con, finAr, "NotificationType", 
	"../../servlet/eXH.NotificationTypeSetupServlet?requestType=QUERY",
