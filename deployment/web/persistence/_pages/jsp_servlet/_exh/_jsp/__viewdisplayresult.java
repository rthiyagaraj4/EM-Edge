...
public final class __viewdisplayresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/ViewDisplayResult.jsp", 1729586176250L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block36 ="\'>\n<input type=\'hidden\' name=\'protocolMode\' id=\'protocolMode\' value=\'";
	...
	try
	{
		...
		String commMode = XHDBAdapter.checkNull((String)request.getParameter("comm_mode"));
		String srlNo =  XHDBAdapter.checkNull((String)request.getParameter("srlNo"));
	...
	*/
		...
		protocolMode = request.getParameter("protocolMode");

		if(result != null && (result.indexOf("<br>") != -1))
		{
			result = result.substring(0,result.indexOf("<br>")-1);
		}
