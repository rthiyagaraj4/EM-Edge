...
public final class __msgforappleventtypeupdt extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/MsgForApplEventTypeUpdt.jsp", 1709122360929L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
//        System.out.println("coming : here 47");
		...
		System.out.println("stnd_code"+stnd_code+"appl_id :"+appl_id+"msg_type :"+msg_type);
        ...
        XHMsgForApplicationElementControllerBean xhBean=XHMsgForApplicationElementControllerBean.getBean(XHMsgForApplicationElementControllerBean.strBeanName,request,session);
		...
		xhBean.action(request,con);
	       ostmtleval = con.prepareCall("{ call xhmast.event_for_application(?,?,?,?,?,?,?,?) }" ); 
...
//		   System.out.println("set field :"+strData[i][10]);  
		  //String  s1=(String)gen_arr.get(2);
     // if(strData[i][10].equals("Y"))
			// {
   	     ostmtleval.setString(1,appl_id);
		 ostmtleval.setString(2,strData[i][1]);   
		 ostmtleval.setString(3,strData[i][6]);
		 ostmtleval.setString(4,strData[i][5]);
		 ostmtleval.setString(5,usr_added_by_id);
		 ostmtleval.setString(6,usr_added_at_ws_no);
