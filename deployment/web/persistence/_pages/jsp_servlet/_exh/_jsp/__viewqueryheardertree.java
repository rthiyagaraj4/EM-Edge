...
public final class __viewqueryheardertree extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/ViewQueryHearderTree.jsp", 1743587214636L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block20 ="\'>\n\t<input type=\'hidden\' name=\'even_type\' id=\'even_type\' value=\'";
...
String img=XHDBAdapter.checkNull(request.getParameter("img"));
            ...
            out.print( String.valueOf(java.net.URLEncoder.encode(facilityName) ));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(java.net.URLEncoder.encode(applicationName) ));
            ...
            out.print( String.valueOf(even_type ));
