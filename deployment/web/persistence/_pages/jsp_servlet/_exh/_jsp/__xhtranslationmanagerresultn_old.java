...
public final class __xhtranslationmanagerresultn_old extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/XHTranslationManagerResultN_OLD.jsp", 1742552633294L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block41 ="\" id=\"engLang";
    ...
    private final static java.lang.String  _wl_block59 ="  onblur=\'return makeValidString(this);\'\n\t\t\t\t maxlength=\'";
    private final static byte[]  _wl_block59Bytes = _getBytes( _wl_block59 );

    private final static java.lang.String  _wl_block60 ="\' size=50 > </td> \n\t\t";
...
for( startVal=0;startVal<pkval.size();startVal++)
  {
            ...
            out.print( String.valueOf(colCount% id=pk<%=colCount));
            out.print( String.valueOf(startVal));
...
engColCount++ ;}else {
            ...
            out.print( String.valueOf(colCount1++% id=desc<%=colCount1++));
            out.print( String.valueOf(colCount));
