...
public final class __profilerefelementid extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/ProfileRefElementID.jsp", 1709122375303L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 =" align=\"left\" nowrap>\n<a  href=\" javascript:func1(\'";
    ...
    private final static java.lang.String  _wl_block22 =" align=\"left\" nowrap>\n<input type=\'hidden\' id=";
    ...
    private final static java.lang.String  _wl_block37 ="\" size=8 disabled>\n<input type=\'hidden\' name=\'";
    ...
    private final static java.lang.String  _wl_block41 ="\n\t\n\n\t\t<input type=\"hidden\" name=\"Num_colu\" id=\"Num_colu\" value=";
    private final static byte[]  _wl_block41Bytes = _getBytes( _wl_block41 );

    private final static java.lang.String  _wl_block42 ="><input type=\'hidden\' name=\'action_type\' id=\'action_type\' value=\'U\' >\n\n\t</table> \n\n\n</form>\n</body>\n</html>\n\n\n";
...
try
{
	...
	strPrevious = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.previous.label","cmmmon_labels");
	...
	{
		//out.println("Error da nan thanda="+e1);
	}
...
//System.out.println("application_id174"+application_id+"element_id174"+element_id);
if(application_id.equals("") )
{
if(element_id.equals(""))
	{

sql="select B.ELEMENT_ID,B.ELEMENT_NAME,A.DERIVATION_TYPE,B.IN_USE_YN,A.CONDITION_EXP1_VAL,A.EXPECTED_VALUE,A.EXECUTION_ORDER,A.EXPECTED_VALUE2,A.POSITION,A.PROFILE_ID from XH_PROFILE_DERIVATION_RULES A, xh_element_crossref B where A.ELEMENT_ID=B.ELEMENT_ID ";
...
else if(application_id!=null  )
{
	...
	if(element_id.equals(""))
	{
	 ...
	 sql="select B.ELEMENT_ID,B.ELEMENT_NAME,A.DERIVATION_TYPE,B.IN_USE_YN,A.CONDITION_EXP1_VAL,A.EXPECTED_VALUE,A.EXECUTION_ORDER,A.EXPECTED_VALUE2,A.POSITION,A.PROFILE_ID from XH_PROFILE_DERIVATION_RULES A, xh_element_crossref B where A.ELEMENT_ID=B.ELEMENT_ID and A.PROFILE_ID='"+application_id+"'  " ;

	}
	else
	{
		
sql="select B.ELEMENT_ID,B.ELEMENT_NAME,A.DERIVATION_TYPE,B.IN_USE_YN,A.CONDITION_EXP1_VAL,A.EXPECTED_VALUE,A.EXECUTION_ORDER,A.EXPECTED_VALUE2,A.POSITION,A.PROFILE_ID from XH_PROFILE_DERIVATION_RULES A, xh_element_crossref B where A.ELEMENT_ID=B.ELEMENT_ID and A.PROFILE_ID='"+application_id+"' and A.ELEMENT_ID='"+element_id+"' " ;
...
strstyle = "class='QRYODD'";
            ...
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf( rset.getString(8) ));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf( rset.getString(9) ));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf( rset.getString(10) ));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf(rset.getString(10).equals("null")?"":rset.getString(10) ));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf(strstyle));
            _bw.write(_wl_block22Bytes, _wl_block22);
            out.print( String.valueOf(i+"Profile_ID"));
            _bw.write(_wl_block23Bytes, _wl_block23);
            out.print( String.valueOf(i+"Profile_ID"));
            _bw.write(_wl_block24Bytes, _wl_block24);
            out.print( String.valueOf(rset.getString(10)));
            _bw.write(_wl_block25Bytes, _wl_block25);
            out.print( String.valueOf(i+"Element_ID"));
            _bw.write(_wl_block23Bytes, _wl_block23);
            out.print( String.valueOf(i+"Element_ID"));
            _bw.write(_wl_block26Bytes, _wl_block26);
            out.print( String.valueOf(rset.getString(1)));
            _bw.write(_wl_block27Bytes, _wl_block27);
            out.print( String.valueOf(i+"_Combo"));
            ...
            out.print( String.valueOf(XHDBAdapter.checkNull(rset.getString(3))));
            _bw.write(_wl_block32Bytes, _wl_block32);
            out.print( String.valueOf(strstyle));
            _bw.write(_wl_block33Bytes, _wl_block33);
            out.print( String.valueOf(i+"_C/E"));
            _bw.write(_wl_block34Bytes, _wl_block34);
            out.print( String.valueOf(i+"_C/E"));
            _bw.write(_wl_block31Bytes, _wl_block31);
            out.print( String.valueOf(XHDBAdapter.checkNull(rset.getString(5))));
            _bw.write(_wl_block35Bytes, _wl_block35);
            out.print( String.valueOf(strstyle));
            _bw.write(_wl_block36Bytes, _wl_block36);
            out.print( String.valueOf(i+"_EV"));
            _bw.write(_wl_block34Bytes, _wl_block34);
            out.print( String.valueOf(i+"_EV"));
            _bw.write(_wl_block31Bytes, _wl_block31);
            out.print( String.valueOf(XHDBAdapter.checkNull(rset.getString(6))));
            _bw.write(_wl_block35Bytes, _wl_block35);
            out.print( String.valueOf(strstyle));
            _bw.write(_wl_block36Bytes, _wl_block36);
            out.print( String.valueOf(i+"_EO1"));
            _bw.write(_wl_block34Bytes, _wl_block34);
            out.print( String.valueOf(i+"_EO1"));
            _bw.write(_wl_block31Bytes, _wl_block31);
            out.print( String.valueOf(XHDBAdapter.checkNull(rset.getString(7))));
            _bw.write(_wl_block37Bytes, _wl_block37);
            out.print( String.valueOf(i+"_EO"));
            _bw.write(_wl_block28Bytes, _wl_block28);
            out.print( String.valueOf(i+"_EO"));
            _bw.write(_wl_block26Bytes, _wl_block26);
            out.print( String.valueOf(XHDBAdapter.checkNull(rset.getString(7))));
            ...
            out.print( String.valueOf(strstyle));
            _bw.write(_wl_block33Bytes, _wl_block33);
            out.print( String.valueOf(i+"_EV2"));
            _bw.write(_wl_block34Bytes, _wl_block34);
            out.print( String.valueOf(i+"_EV2"));
            _bw.write(_wl_block31Bytes, _wl_block31);
            out.print( String.valueOf(XHDBAdapter.checkNull(rset.getString(8))));
            _bw.write(_wl_block39Bytes, _wl_block39);
            out.print( String.valueOf(strstyle));
            _bw.write(_wl_block33Bytes, _wl_block33);
            out.print( String.valueOf(i+"_PO"));
            _bw.write(_wl_block34Bytes, _wl_block34);
            out.print( String.valueOf(i+"_PO"));
            _bw.write(_wl_block31Bytes, _wl_block31);
            out.print( String.valueOf(XHDBAdapter.checkNull(rset.getString(9))));
...
columval=i;
    ...
    private boolean _jsp__tag1(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag1.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eXH.ProtocolLinkId.Label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag4.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eXH.ExpectedValue1.Label", java.lang.String .class,"key"));
