...
public final class __ekyccomparisonpopup extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/exh/jsp/EkycComparisonPopup.jsp", 1709122327460L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block41 ="\" >\n\t\t<input type=hidden name=\"aFamilyName\" id=\"aFamilyName\" value=\"";
    ...
    private final static java.lang.String  _wl_block56 ="\" >\n\t\t<input type=hidden name=\"kFamilyName\" id=\"kFamilyName\" value=\"";
 ...
 String sStyle = (String)session.getAttribute("PREFERRED_STYLE"); 
		...
		String aadharNumber = request.getParameter("aadharId")== null? "" : request.getParameter("aadharId");
            ...
            out.print( String.valueOf(aFamilyName ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(kFamilyName ));
            _bw.write(_wl_block10Bytes, _wl_block10);
