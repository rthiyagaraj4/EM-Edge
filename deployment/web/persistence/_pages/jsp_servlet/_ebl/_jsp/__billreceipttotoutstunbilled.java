...
public final class __billreceipttotoutstunbilled extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BillReceiptTotOutstUnBilled.jsp", 1738423960675L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
...
map = bc.getOutstandingUnbilled(billRequest);
            ...
            out.print( String.valueOf(map.get("outst") ));
            _bw.write(_wl_block6Bytes, _wl_block6);
            out.print( String.valueOf(map.get("unbilled") ));
