...
public final class __addmodifypatfindetailsinsbodyeditframe_aprer extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/AddModifyPatFinDetailsInsBodyEditFrame_APRER.jsp", 1709114334980L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    throws javax.servlet.ServletException, java.io.IOException {
		...
		String rows="*,0%,0%,0%,0%";
		if(package_enabled_yn.equals("Y") && (calling_module_id.equals("OP") || calling_module_id.equals("IP"))){
			rows="59%,0%,0%,17%,17%,7%";		
		}
