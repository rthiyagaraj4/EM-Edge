...
public final class __pkgadhocdiscountdtlsforpatient extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/PkgAdhocDiscountDtlsForPatient.jsp", 1709114681350L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block22 ="\' onClick=\"displayAdhocDiscountDtls(\'";
...
try{
	...
	while(rs.next())
	{
		...
		if(packagelongDesc.length()>30)
            ...
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(rs.getString("CUST_GROUP_CODE") ));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf(rs.getString("CUST_CODE") ));
