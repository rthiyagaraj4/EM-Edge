...
public final class __blpolicycode extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/BLPolicyCode.jsp", 1741168804209L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	//out.println("alert(parent.frames[1].document.forms[0].name);");
		...
		query_ref_source = "Select short_desc, policy_type_code from bl_ins_policy_types_lang_vw where language_id='"+locale+"'  and nvl(status,'N') <> 'S' order by short_desc";
