...
public final class __blinsrcmpayerspecsupdocconfigmain extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eBL/jsp/BLInsRCMPayerSpecSupDocConfigMain.jsp", 1725942903411L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
	...
	String functionID	     = "EBL_INS_PYR_SPEC_DOC_CON";
	String privilegeID	     = "INS_PYR_SPEC_DOC_CON";
...
if("Y".equals(validUserYN)){
	...
	{
		System.err.println("Exception in BLInsRCMPayerSpecSupDocConfigMain.jsp: "+ee);	
	}
	finally
	{		
		if(cstmt1 != null) 	
...
System.err.println("In BLInsRCMPayerSpecSupDocConfigMain.jsp end1");			
