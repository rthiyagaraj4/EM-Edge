...
public final class __pkgvisitadhocdiscountdtlsforpatient extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/PkgVisitAdhocDiscountDtlsForPatient.jsp", 1709114752740L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\' onClick=\"displaypkgDtls(\'";
    ...
    private final static java.lang.String  _wl_block20 ="\' onClick=\"displayAdhocDiscountDtls(\'";
...
try{
	...
	while(rs.next())
	{
		...
		if(packagelongDesc.length()>30)
            ...
            out.print( String.valueOf(checkForNull(packagelongDesc)));
