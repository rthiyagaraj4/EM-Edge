...
public final class __blinsrcmpayerspecsupdocconfigqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eBL/jsp/BLInsRCMPayerSpecSupDocConfigQueryResult.jsp", 1725509318100L ,"10.3.6.0","Asia/Calcutta")) return true;
...
ResultSet rs = null;
	...
	try{
		...
		String strsql="select distinct count(*) as total "+
				"from BL_SUPPORT_DOC_SETUP_HDR hdr "+
				"where operating_facility_id=? "+sql;
				
		
		String strsql1=	"select distinct hdr.CUST_GROUP_CODE, "+
				...
				"decode(hdr.POLICY_TYPE_CODE,'**','All Policy',(select pol.long_desc policy_type from bl_ins_policy_types pol where pol.policy_type_code = hdr.policy_type_code and operating_facility_id=? ))  policy_type "+
				"from BL_SUPPORT_DOC_SETUP_HDR hdr "+
				"where operating_facility_id=?"+sql;
...
if ( !(start <= 1) )
    out.println("<A HREF='../../eBL/jsp/BLInsRCMPayerSpecSupDocConfigQueryResult.jsp?from="+(start-14)+"&to="+(end-14)+"&whereclause=" + URLEncoder.encode(sql) + "'" + " text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.previous.label","common_labels")+"</A>");

if ( !( (start+14) > maxRecord ) )
    out.println("<A HREF='../../eBL/jsp/BLInsRCMPayerSpecSupDocConfigQueryResult.jsp?from="+(start+14)+"&to="+(end+14)+"&whereclause="+URLEncoder.encode(sql)+"'"+" text-decoration='none'>"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.next.label","common_labels")+"</A>");
      ...
      while ( rset.next() && i<=end  )
{
	...
	String mode="modify";
	out.println("<a href='../../eBL/jsp/BLInsRCMPayerSpecSupDocConfigMainFrame.jsp?mode=modify&payergroupCode="+ payerGroupCode+"&payerCode="+payerCode+"&facilityId="+facility_id+"&policyCode="+policyCode+"' target='BLInsRCMPayerSpecSupDocConfigMain' >");
