...
public final class __pkguseraccessqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/PkgUserAccessQueryResult.jsp", 1722935556783L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block15 ="\" onmouseover=\"changeCursor(this);\"><a class=\'gridLink\' href=\'#\'>";
	...
	if( (result.size()>=3) && ( !( ((String) result.get(0)).equals("0")) )){
		...
		for(int colCount=0; colCount<records.size(); colCount++){
            ...
            out.print( String.valueOf((String)records.get(colCount)==null ? "N" :(String)records.get(colCount)));
