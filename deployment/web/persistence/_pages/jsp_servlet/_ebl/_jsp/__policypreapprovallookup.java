...
public final class __policypreapprovallookup extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/ebl/jsp/PolicyPreapprovalLookup.jsp", 1709114767520L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block66 ="\",\"preApprovalLookup\")\'>\n\t\t\t \t<td nowrap class=\'fields\'>\n\t\t\t \t\t";
	...
	//MMS-QH-CRF-0170-US-4  PALANINARAYANAN 9/7/2020 ENDS-->
		...
		if(rst!=null){
			...
			while (rst.next()) {
				...
				fmtDtlsBean.setPreApprDurCapping(rst.getString("preapproval_dur_capping"));//mms-crf-126
				if("Y".equals(SiteSpecGroupServiceInd)){
				fmtDtlsBean.setpreAppGroupRservice(rst.getString("GROUP_SERVICE_IND"));	//26-8-2020
				}
				fmtDtlsBean.setServLimit(rst.getString("service_level_approval_yn"));
				fmtDtlsBean.setPreacrossenc(rst.getString("ACROSS_ENC_PREAPP_YN"));//dhananjay
