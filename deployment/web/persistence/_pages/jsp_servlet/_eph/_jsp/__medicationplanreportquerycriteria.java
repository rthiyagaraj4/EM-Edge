...
public final class __medicationplanreportquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/MedicationPlanReportQueryCriteria.jsp", 1709120959319L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	String currentdate = com.ehis.util.DateUtils.getCurrentDate("DMY", locale);
            ...
            out.print( String.valueOf(medplan_bean.getPatientIDLength()));
