...
public final class __tpnprecipitationinfo extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/TPNPrecipitationInfo.jsp", 1709121514842L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//				const_genric_per_vol_desc=com.ehis.util.BundleMessage.getBundleMessage(pageContext,"ePH.PerLitre.label","ph_labels");
            ...
            out.print( String.valueOf(consPreciptateInfo.get(i+1)));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(consPreciptateInfo.get(i+3)));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(consPreciptateInfo.get(i+6)));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(consPreciptateInfo.get(i+7)));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(consPreciptateInfo.get(i+10)));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(const_genric_per_vol_desc));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(consPreciptateInfo.get(i+8)));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(consPreciptateInfo.get(i+9)));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(consPreciptateInfo.get(i+10)));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(const_genric_per_vol_desc));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(consPreciptateInfo.get(i+13)));
