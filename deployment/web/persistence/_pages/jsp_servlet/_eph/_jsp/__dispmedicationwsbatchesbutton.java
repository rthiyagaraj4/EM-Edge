...
public final class __dispmedicationwsbatchesbutton extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/DispMedicationWSBatchesButton.jsp", 1709120751301L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t\t\t\t<input type=\"button\" name=\"btnOK\" id=\"btnOK\" class=\"button\" value=\'";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\' onClick=\"saveSelectedBatches(\'";
    ...
    private final static java.lang.String  _wl_block13 ="\' onClick=\"saveAllocatedBatches(\'";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' onClick=\"saveAllocatedBatches(\'CANCEL\')\">&nbsp;&nbsp;&nbsp;&nbsp;\n\t\t\t";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\' onClick=\"showDisplaySection()\">&nbsp;&nbsp;&nbsp;&nbsp;\n\t\t\t";
