...
public final class __phreportsmasterlist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/PHReportsMasterList.jsp", 1709121101750L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	/* Initialize Function specific end*/
		...
		for (int i=0; i<masterList.size(); i+=2) {
            ...
            out.print( String.valueOf( masterList.get(i+1) ));
