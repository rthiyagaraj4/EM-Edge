...
public final class __dispmedicationwspreviewdetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/DispMedicationWSPreviewDetails.jsp", 1709120754332L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\n\t\t\t<td class=\"white\">\n\t\t\t\t<input type=\"button\" name=\"btnPreview\" id=\"btnPreview\" class=\"button\" value=\'";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\' onClick=\"previewSelectedBatches()\">&nbsp;&nbsp;&nbsp;&nbsp;\n\t\t\t</td>\n\t\t\t";
