...
public final class __locationstoreitemsdetail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/LocationStoreItemsDetail.jsp", 1709120914939L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	int count=from;
            ...
            out.print( String.valueOf(locForDetails.get(index++)));
