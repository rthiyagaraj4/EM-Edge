...
public final class __constructuserdesktop extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/ConstructUserDesktop.jsp", 1709120650861L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block15 ="</b><br><Select name=\"Menuopts\" id=\"Menuopts\"   ";
    ...
    private final static java.lang.String  _wl_block19 =" rowspan=\"5\"  valign=\"top\" size=\"5\" style=\"HEIGHT: 140px; WIDTH: 275px\" Onclick=\"clearfun()\" >\n";
	...
	if ( operation == null ) 
		operation="insert";
	code = request.getParameter("Desktop_code")==null?"":request.getParameter("Desktop_code");
	name = request.getParameter("Desktop_name")==null?"":request.getParameter("Desktop_name");
	...
	try{
		con	= ConnectionManager.getConnection();
            ...
            _bw.write(_wl_block16Bytes, _wl_block16);
							...
							while(rs2.next()){ 
								menu_id_opt		=	rs2.getString("menu_id")==null?"":rs2.getString("menu_id");
								short_desc_opt	=	rs2.getString("short_desc")==null?"":rs2.getString("short_desc");
