...
public final class __phrepmedicationlistopdbcpquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/PHRepMedicationListOPDBCPQueryCriteria.jsp", 1709121098453L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="&nbsp;</td>\n\t\t\t\t\t<td class=\"label\">\n\t\t\t\t\t\t<input type=\'text\' id=\'admin_from_date\' name=\'p_fr_date\' id=\'p_fr_date\' size=\"10\" maxlength=\"10\" align=\"center\" value=\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' onBlur=\"CheckDateT(this);\"><img style=\"cursor:pointer\" src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"document.forms[0].p_fr_date.select();return showCalendar(\'admin_from_date\');\">&nbsp;<img align=\'center\' src=\'../../eCommon/images/mandatory.gif\'></img>\n\t\t\t\t\t</td><!--changed CheckDate to CheckDateT for Leap year calculation on 24/02/2012 -->\n\t\t\t\t\t<td class=\"label\"> \n\t\t\t\t\t\t<input type=\'text\' id=\'admin_to_date\' name=\'p_to_date\' id=\'p_to_date\' size=\"10\" maxlength=\"10\" align=\"center\"  value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\'  onBlur=\"CheckDateT(this);\"><img style=\"cursor:pointer\" src=\"../../eCommon/images/CommonCalendar.gif\" onClick=\"document.forms[0].p_to_date.select(); return showCalendar(\'admin_to_date\');\">&nbsp;<img align=\'center\' src=\'../../eCommon/images/mandatory.gif\'></img>\n\t\t\t\t\t</td><!--changed CheckDate to CheckDateT for Leap year calculation on 24/02/2012 -->\n\t\t\t\t\t\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td colspan=\'3\'>&nbsp;</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\'right\' class=\"label\">";
	...
	String date_range_week = currentandweek[1];
            ...
            out.print( String.valueOf( PhRepository.getPhKeyValue( "SQL_PH_REPORTS_BCP_LOCATION_LOOKUP" ) ));
