...
public final class __storeforlocationheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/StoreForLocationHeader.jsp", 1709121490421L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\'  onClick=\"popstoreforlocation(document.storeforlocationheaderform.dispense_location);\"  name=\"storforlocation_search\">\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t\t</table>\n\t\t\t<input type=\"hidden\" name=\"locale\" id=\"locale\" value=\"";
