...
public final class __pharmacisthomelogin extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/PharmacistHomeLogin.jsp", 1733314922426L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\' onClick=\"proceedLogin(event)\">\t\n\t\t\t\t\t\t<input type=\"button\" class=\"BUTTON\" value=\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\' onclick=\"goHome()\">\n\t\t\t\t\t</td>\t\n\t\t\t\t</tr>\n\t\t\t</TABLE>\n\t\t\t<input type=\"hidden\" name=\"bean_id\" id=\"bean_id\" value=\"";
	...
	if(identityForSwitch.equals("Switch")){
		storeCode		= bean.getStore_code();
            ...
            out.print( String.valueOf(bean.getStore_code_List(storeCode)));
