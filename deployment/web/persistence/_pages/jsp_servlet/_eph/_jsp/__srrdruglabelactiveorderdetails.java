...
public final class __srrdruglabelactiveorderdetails extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/SRRDrugLabelActiveOrderDetails.jsp", 1709121424157L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="<input type=\"checkbox\" name=\"selectall_yn\" id=\"selectall_yn\" value=\"\"  onClick=\"return chkall_durg(activeOrderDetailsForm);\"></th>\n\t\t\n\t\t\n\t\t<!-- \t<th  class=\"small\" width=\"20%\">";
    ...
    private final static java.lang.String  _wl_block34 ="\" width=\"10%\" ><label onClick=\"callFreqDet(\'";
    private final static byte[]  _wl_block34Bytes = _getBytes( _wl_block34 );

    private final static java.lang.String  _wl_block35 ="\',\'";
    private final static byte[]  _wl_block35Bytes = _getBytes( _wl_block35 );

    private final static java.lang.String  _wl_block36 ="\')\" style=\"cursor:pointer;color:blue\" nowrap>";
    ...
    private final static java.lang.String  _wl_block44 ="\" style=\"cursor:pointer;color:blue\" nowrap><label onClick=\"callDiagText(\'";
    private final static byte[]  _wl_block44Bytes = _getBytes( _wl_block44 );

    private final static java.lang.String  _wl_block45 ="\')\">Details</label></td>\n\n";
    private final static byte[]  _wl_block45Bytes = _getBytes( _wl_block45 );

    private final static java.lang.String  _wl_block46 ="\" nowrap>&nbsp;</td>\n\n";
    ...
    private final static java.lang.String  _wl_block50 ="\" id=\"p_print_yn";
    private final static byte[]  _wl_block50Bytes = _getBytes( _wl_block50 );

    private final static java.lang.String  _wl_block51 ="\" value=\"";
    private final static byte[]  _wl_block51Bytes = _getBytes( _wl_block51 );

    private final static java.lang.String  _wl_block52 ="\"  onClick=\"assignValue_inner(this);calvalidation(activeOrderDetailsForm,this,\'";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-008
	...
	String sStyle = (session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		String generic_id			=	CommonBean.checkForNull(request.getParameter("generic_id"));
		...
		String p_order_date			=	CommonBean.checkForNull(request.getParameter("p_order_date"));
		...
		String p_token_dly_seq_no	=	CommonBean.checkForNull(request.getParameter("p_token_dly_seq_no"));
...
// added for SRR20056-SCF-7214 IN2727 -end
			...
			active_orders	=	bean.getPatientActiveOrders(patient_id,patient_class,p_order_date,orderid,p_disp_locn_code,facility_id,locale,p_token_dly_seq_no,p_langue);
		...
		for (int i=0; i<active_orders.size(); i++) {
			...
			sliding_scale_yn = CommonBean.checkForNull((String) record.get("sliding_scale_yn")); 
			drug_yn			=	 CommonBean.checkForNull((String) record.get("drug_yn")); 
// Below code added for IN25905 --14-01-2011-- priya
			if(drug_yn.equals("N"))
			{
				freq_desc = "&nbsp;";
				freq_code = "";
	...
	/*if(!locale.equals("en")){
		...
		end_date = DateUtils.convertDate(end_date, "DMYHM","en",locale);
			...
			if(sliding_scale_yn.equals("N")) ////if-else condition added for IN25462 --16/12/2010-- priya
				{	
 ...
 putObjectInBean(bean_id,bean,request); 
    ...
    private boolean _jsp__tag13(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag13.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.SlidingScale.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag14(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag14.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.SlidingScale.label", java.lang.String .class,"key"));
