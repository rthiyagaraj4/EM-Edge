...
public final class __adminroutecategory extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/AdminRouteCategory.jsp", 1709363136861L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css"; 
	...
	//out.println("source-----> in AdminRouteCategory.jsp-->" +source);
