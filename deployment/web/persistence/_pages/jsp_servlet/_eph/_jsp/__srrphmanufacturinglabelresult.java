...
public final class __srrphmanufacturinglabelresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/SRRPhManufacturinglabelResult.jsp", 1722318102789L ,"10.3.6.0","Asia/Calcutta")) return true;
   ...
   try{
	...
	if( (result.size()>=2) && ( !( ((String) result.get(0)).equals("0")) )){ 
		...
		//record[0]=com.ehis.util.DateUtils.convertDate(record[0],"DMY","en",locale);
            ...
            out.print( String.valueOf(p_type_ord));
            _bw.write(_wl_block17Bytes, _wl_block17);
