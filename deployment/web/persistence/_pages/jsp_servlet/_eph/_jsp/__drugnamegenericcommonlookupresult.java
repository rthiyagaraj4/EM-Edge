...
public final class __drugnamegenericcommonlookupresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/DrugNameGenericCommonLookupResult.jsp", 1730182019230L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block18 ="\" onclick=\"disableClick(event);\" style=\'WORD-BREAK:BREAK-ALL;\'>";
...
if( !callFrom.equals("0") ) {
	...
	if( displayOrder.equals("CODE_DESC") ) { 
            ...
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(ind_desc));
