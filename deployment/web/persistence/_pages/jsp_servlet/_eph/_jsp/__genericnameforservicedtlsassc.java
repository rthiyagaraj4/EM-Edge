...
public final class __genericnameforservicedtlsassc extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/GenericNameForServiceDtlsAssc.jsp", 1709120858688L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="</a>&nbsp;&nbsp;<a href=\"javascript:goNext(\'association\');\" id=\"next\" style=\"visibility:hidden\" >";
    ...
    private final static java.lang.String  _wl_block23 ="\" id=\"generic_name";
    ...
    private final static java.lang.String  _wl_block26 ="\" id=\"generic_id";
    private final static byte[]  _wl_block26Bytes = _getBytes( _wl_block26 );

    private final static java.lang.String  _wl_block27 ="\"></input></td>\n\t\t\t<td class=\"";
    private final static byte[]  _wl_block27Bytes = _getBytes( _wl_block27 );

    private final static java.lang.String  _wl_block28 ="\" align=\"center\" width=\"10%\"><input type=\"checkbox\" ";
    ...
    private final static java.lang.String  _wl_block32 ="\" align=\"center\" width=\"10%\">\n\n\t";
...
initString=initString.append("~").append((String)dataList.get("EFF_STATUS")).append("|").append(((String)dataList.get("OPER_MODE"))).append("|").append((String)dataList.get("GENERIC_ID")).append("|").append((String)dataList.get("GENERIC_NAME"));	//initString+="~"+((String)dataList.get("EFF_STATUS"))+"|"+((String)dataList.get("OPER_MODE"))+"|"+(String)dataList.get("GENERIC_ID")+"|"+(String)dataList.get("GENERIC_NAME");
	...
	if( ((String)dataList.get("SOURCE")).equals("FB") ){
		...
		if(((String)dataList.get("EFF_STATUS")).equals("E")){
            ...
            out.print( String.valueOf(count));
            _bw.write(_wl_block24Bytes, _wl_block24);
            out.print( String.valueOf( (String)dataList.get("GENERIC_ID") ));
