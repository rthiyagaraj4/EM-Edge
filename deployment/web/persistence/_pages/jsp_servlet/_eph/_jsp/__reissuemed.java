...
public final class __reissuemed extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/ReissueMed.jsp", 1709121387564L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block16 ="\');</script> commented for 26057--> \n\t\t\t\t<script>showLoginWindow(\'\',\'";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0086
		...
		if(result.size()>0) {
            ...
            out.print( String.valueOf(disp_locn_dtl));
