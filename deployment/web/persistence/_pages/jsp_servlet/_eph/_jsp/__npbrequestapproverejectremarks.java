...
public final class __npbrequestapproverejectremarks extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/NPBRequestApproveRejectRemarks.jsp", 1738054096258L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\n\t<body onMouseDown=\"CodeArrest()\" onKeyDown=\"lockKey()\">\n\t\t<form name=\"NPBRemarksForm\" id=\"NPBRemarksForm\">\n\t\t\t<table  border=0 align=\"center\" width=\'100%\' cellpadding=\'0\' cellspacing=\'0\'>\n\t\t\t\t<tr> \n\t\t\t\t\t<td  class=\"label\">&nbsp\n\t\t\t\t\t\t<textarea cols=\"80\" rows=\"10\" name=\"NPBRemarks\" onkeypress=\"return CheckRemMaxLen()\"  onblur=\" CheckRemMaxLen()\" ";
    ...
    private final static java.lang.String  _wl_block13 ="\' onClick=\'storeNPBRemarks();\'>\n\t\t\t\t\t\t<input type=\"button\" class=\"BUTTON\" name=\"close\" id=\"close\" value=\'";
...
//end.
	...
	if(NPBRemarks!=null && !NPBRemarks.equals(""))
		NPBRemarks=java.net.URLDecoder.decode(NPBRemarks,"UTF-8");
            ...
            out.print( String.valueOf(editOption));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(NPBRemarks));
