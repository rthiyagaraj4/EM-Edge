...
public final class __adrreportingdruglookupsearch extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/ADRReportingDrugLookUpSearch.jsp", 1722921591542L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="</option>                \n\t\t\t\t\t\t</select>\n\t\t\t\t\t\t<input type=\'button\' name=\'btn_search\' id=\'btn_search\' value=\'";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\' onclick=\'loaddrugdetails(\"";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="\")\' class=\'button\'>\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t</table> \n\t\t</form>\n\t</body>\n</html>\n\n";
