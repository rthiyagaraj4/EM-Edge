...
public final class __rfdaddmodify extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/RFDAddModify.jsp", 1709121405673L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block15 ="\">\n<INPUT TYPE=\"hidden\" name=\"drug_name_query\" id=\"drug_name_query\" VALUE=\"";
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	/* Initialize Function specific end */
            ...
            out.print( String.valueOf( PhRepository.getPhKeyValue( "SQL_PH_DRUGNAME_LOOKUP" ) ));
