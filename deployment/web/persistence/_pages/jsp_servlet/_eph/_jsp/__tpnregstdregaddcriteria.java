...
import java.util.*;
import ePH.TPNStandardRegimenBean;
import eOR.*;
import ePH.Common.*;
import eOR.Common.*;
...
public final class __tpnregstdregaddcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/TPNRegStdRegAddCriteria.jsp", 1709121525905L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="&nbsp;<input type=text name=\'";
    ...
    private final static java.lang.String  _wl_block16 ="\' maxlength=5 class=\"number\" size=5 onBlur=\"CheckPositiveNumber(this)\">\n\t\t\t</td><td width=\"10%\"  class=\"label\">&nbsp;<B>";
...
//	out.println(generics);
            ...
            out.print( String.valueOf(generics.get(i+1)));
            ...
            out.print( String.valueOf(generics.get(i)));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(generics.get(i)));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf(generics.get(i)));
            _bw.write(_wl_block16Bytes, _wl_block16);
            out.print( String.valueOf(generics.get(i+2)));
