...
public final class __dispmedicationordercomments extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/DispMedicationOrderComments.jsp", 1709120730801L ,"10.3.6.0","Asia/Calcutta")) return true;
...
String sStyle=(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	if(!pres_remarks.equals("")) {
		order_comments	=	pres_remarks;
            ...
            out.print( String.valueOf(order_comments));
