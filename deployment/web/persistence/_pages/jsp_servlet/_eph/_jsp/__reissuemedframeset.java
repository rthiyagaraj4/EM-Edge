...
public final class __reissuemedframeset extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/ReissueMedFrameset.jsp", 1731574873539L ,"10.3.6.0","Asia/Calcutta")) return true;
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0086
	...
	String QSource = "../../ePH/jsp/ReissueMedQuery.jsp?disp_locn="+disp_locn+"&disp_locn_desc="+URLEncoder.encode(disp_locn_desc);
            ...
            out.print( String.valueOf(QSource ));
