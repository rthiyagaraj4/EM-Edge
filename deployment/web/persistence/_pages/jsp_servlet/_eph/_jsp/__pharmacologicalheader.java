...
public final class __pharmacologicalheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/PharmacologicalHeader.jsp", 1709121021600L ,"10.3.6.0","Asia/Calcutta")) return true;
...
(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	if(level_num!=""){	
		  ...
		  if(level_num.equals("4"))	  level_value =com.ehis.util.BundleMessage.getBundleMessage(pageContext,"ePH.ViewHierarchy.label","ph_labels");
            ...
            out.print( String.valueOf(level_value));
