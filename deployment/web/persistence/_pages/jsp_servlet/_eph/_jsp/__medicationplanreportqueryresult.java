...
public final class __medicationplanreportqueryresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/MedicationPlanReportQueryResult.jsp", 1709120959975L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="</th>\n\t\t<tr>\n\t\t\t<td class=\"label\"><font class=\"hyperlink\" style=\"cursor:pointer\" onClick=\"callMediPlan(\'";
    ...
    private final static java.lang.String  _wl_block16 ="</td>\n            <input type=\"hidden\" name=\"med_plan_id\" id=\"med_plan_id\" value=\"";
	...
	try{
		...
		if(result.size()>0){
            ...
            out.print( String.valueOf((String)result.get(0)));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf((String)result.get(3)));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(order_date_from));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(order_date_to));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf((String)result.get(4)));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf(disp_locn_code));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf((String)result.get(2)));
            _bw.write(_wl_block11Bytes, _wl_block11);
            out.print( String.valueOf((String)result.get(5)));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf((String)result.get(0)));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf((String)result.get(1)));
