...
public final class __editlabelviewaudittrail extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/EditLabelViewAuditTrail.jsp", 1709120832361L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	ArrayList audit_trail = (ArrayList) bean.getAuditTrailDatails(dispense_no);
		...
		if(audit_trail.size() > 0){
            ...
            out.print( String.valueOf(com.ehis.util.DateUtils.convertDate((String) audit_trail.get(i),"DMYHM","en",locale)));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(audit_trail.get(i+1)));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(audit_trail.get(i+2)));
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("ePH.ViewAuditTrail.label", java.lang.String .class,"key"));
