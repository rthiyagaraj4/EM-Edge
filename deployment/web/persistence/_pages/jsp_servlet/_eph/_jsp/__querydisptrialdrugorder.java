...
public final class __querydisptrialdrugorder extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/QueryDispTrialDrugOrder.jsp", 1709121329643L ,"10.3.6.0","Asia/Calcutta")) return true;
...
//ends
	...
	String sql=PhRepository.getPhKeyValue("SQL_QUERY_DISP_TRIAL_DRUG_SELECT2");
	chkFields.add(locale);
	
   sql=sql+" and f.facility_id=?";
   String facility_id= (String)session.getValue( "facility_id" );
	...
	if (  ( (String)result.get(1)!=null ) && ( (String)result.get(1)!="" ) )
		...
		for(int recCount=2; recCount<result.size(); recCount++) 
			...
			out.println(CommonBean.setForm ( request ,"../../ePH/jsp/QueryDispTrialDrugOrder.jsp", searched) );
		}//end of try
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("ePH.PatientNameAgeSex.label", java.lang.String .class,"key"));
