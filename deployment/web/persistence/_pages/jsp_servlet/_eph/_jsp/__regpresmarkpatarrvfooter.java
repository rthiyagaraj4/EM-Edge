...
public final class __regpresmarkpatarrvfooter extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/RegPresMarkPatArrvFooter.jsp", 1709121384689L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block5 ="\n\t\t<form name=\"MarkPatArrivalFooter\" id=\"MarkPatArrivalFooter\" >\n\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" align=\"center\" border=\"0\" >\n\t\t\t\t<tr>\n\t\t\t\t\t<td align=\"right\"><input type=\"button\" name=\"btnPres\" id=\"btnPres\" value=\"";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="\" class=\"button\"  onClick=\"MarkPatArrival(MarkPatArrivalFooter);\" >\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t\t<input type=\"hidden\" name=\"sysdate\" id=\"sysdate\" value=\"";
	...
	//ends
		...
		String disp_locn_code=request.getParameter("disp_locn_code");
            ...
            out.print( String.valueOf(buttontitle));
