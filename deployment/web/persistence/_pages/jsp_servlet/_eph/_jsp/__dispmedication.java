...
public final class __dispmedication extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/DispMedication.jsp", 1709120709880L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="\')</script>  <!-- Added homepage, store_code for Bru-HIMS-CRF-073 [IN:029939]-->\n";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0086
	...
	String disp_stage = request.getParameter("stage")==null?"":request.getParameter("stage"); //Added for Bru-HIMS-CRF-073.1 [IN:047222]
	...
	//bean.setLoginAtWsNo( bean.getLoginAtWsNo() ) ;
	...
	if(result.size()>0) {
		...
		if(((String)result.get(0)).indexOf("NO DISPLAY")> -1){//Added for Bru-HIMS-CRF-073 [IN:029939]
            ...
            _bw.write(_wl_block13Bytes, _wl_block13);
			  ...
			  // commented by Shaiju H for UAT 3 issue
			  //String disp_locn_dtl=(String)result.get(0);
              //disp_locn_dtl=java.net.URLEncoder.encode(disp_locn_dtl);
