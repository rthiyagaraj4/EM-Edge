...
public final class __constructuserdesktopforpharmacist extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/ConstructUserDesktopforPharmacist.jsp", 1709120651252L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="</b></td>\n\t</tr>\n\t</table>\n\t\n\t\n\t<table border=\"0\" cellspacing=\"0\" cellpadding=\"3\" width=\"85%\" align=\'center\' >\n\t<tr>\n\t<td width=\"50%\" class=\"label\" >&nbsp;&nbsp;</td><td width=\"50%\" class=\"fields\">";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="&nbsp;&nbsp; <select name=\"Menu\" id=\"Menu\"  Onchange=\"loadTree()\" ";
    ...
    private final static java.lang.String  _wl_block15 ="</b><br>\n\t\t\t<Select name=\"Menuopts\" id=\"Menuopts\"   ";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 =" rowspan=\"5\" size=\"50\" style=\"HEIGHT: 140px; WIDTH: 275px\" Onclick=\"Menufun()\">\n\t\t";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\t\n\t\t    </Select>\n\n\t\n\t<table border=\"0\" cellspacing=\"0\" cellpadding=\"3\" width=\"100%\" align=\'center\'>\n\t\t<tr>\n\t\t\t<td class=\'fields\' ><b>";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="</b><br>\n\t\t\t<Select name=\"funcopt\" id=\"funcopt\"  ";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 =" rowspan=\"5\"  valign=\"top\" size=\"5\" style=\"HEIGHT: 140px; WIDTH: 275px\" Onclick=\"clearfun()\" ><!-- 197px   275px -->\n\t\t\t\n\t\t\t";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="\n\t\t\t\n\t\t\t</select></td>\n\t\t</tr>\n\t</table></td>\n\t\n\t<td class=\'fields\'><b>";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="</b>\n\t\t\t<Select name=\"MainMenus\" id=\"MainMenus\"   ";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 =" size=\"15\" style=\"HEIGHT: 290px; WIDTH: 337px\" Onclick=\"putVal()\" scrolling=\"auto\"></td> <!-- 390px   337px -->\n\n\t\t<td class=\'label\' >&nbsp;</td>\n \t  </tr>\n\n\t  <tr>\n\t  <td>&nbsp;</td>\n\t  <td>\n\t\t  <input type=\'button\' name=\'Up\' id=\'Up\'\t\tclass=\"Button\" value=\" ^ \" Onclick=\"MoveIndex(1)\"></input>\n\t\t  <input type=\'button\' name=\'Down\' id=\'Down\'\t\tclass=\"Button\" value=\" v \" Onclick=\"MoveIndex(2)\"></input>\n\t\t  <input type=\'button\' name=\'Right\' id=\'Right\'\tclass=\"Button\" value=\" > \" Onclick=\"MoveIndex(3)\"></input>\n\t\t  <input type=\'button\' name=\'Left\' id=\'Left\'\t\tclass=\"Button\" value=\" < \" Onclick=\"MoveIndex(4)\"></input>\n\t\t  <input type=\'button\' name=\'Remove\' id=\'Remove\'\tclass=\"Button\" value=\" X \" Onclick=\"remove()\"></input>\n\t  </td>\n\t  </tr>\n\t</table>\n  </td>\n</tr>\n</table>\n\n\t<input type=\"hidden\" name=\'mode\' id=\'mode\' value = \'";
    ...
    private final static java.lang.String  _wl_block26 ="\'==\'modify\')\n{\n\tloadTreeonLoad();\n}\n</script>\n\n";
...
try
{
		...
		if(module_id.equals("PH"))
			stmt2=con.prepareStatement("select DESKTOP_SUMMARY_ID,DESKTOP_SUMMARY_NAME from SM_DESKTOP_SUM_HDR where SYS_USER_DEF_IND ='S' AND DESKTOP_SUMMARY_TYPE IN ('P','I') ");
		else if(module_id.equals("ST"))
			stmt2=con.prepareStatement("select DESKTOP_SUMMARY_ID,DESKTOP_SUMMARY_NAME from SM_DESKTOP_SUM_HDR where SYS_USER_DEF_IND ='S' AND DESKTOP_SUMMARY_TYPE='I' ");
		else
 ...
 // 187px   275px
				...
				if(module_id.equals("PH"))
					menuoptsql.append("SELECT SUMMARY_COMP_ID menu_id,SUMMARY_COMP_DESC short_desc FROM SM_DESKTOP_SUM_COMP WHERE SUMMARY_COMP_TYPE	='T' AND APPLICABLITY_SCOPE IN ('P','I') ORDER BY 2");
				else if(module_id.equals("ST"))
					menuoptsql.append("SELECT SUMMARY_COMP_ID menu_id,SUMMARY_COMP_DESC short_desc FROM SM_DESKTOP_SUM_COMP WHERE SUMMARY_COMP_TYPE	='T' AND APPLICABLITY_SCOPE='I'  ORDER BY 2");
				else
            ...
            _bw.write(_wl_block19Bytes, _wl_block19);
				...
				if(module_id.equals("PH"))
					menuoptsql.append("SELECT SUMMARY_COMP_ID menu_id,SUMMARY_COMP_DESC short_desc FROM SM_DESKTOP_SUM_COMP WHERE SUMMARY_COMP_TYPE	='S' and APPLICABLITY_SCOPE IN ('P','I') ORDER BY 2");
				else if(module_id.equals("ST"))
					menuoptsql.append("SELECT SUMMARY_COMP_ID menu_id,SUMMARY_COMP_DESC short_desc FROM SM_DESKTOP_SUM_COMP WHERE SUMMARY_COMP_TYPE	='S' and APPLICABLITY_SCOPE='I' ORDER BY 2");	
				else
...
}finally
{
    ...
    private boolean _jsp__tag0(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag0.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSM.Summary.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag2(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag2.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSM.Customisation.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag6(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag6.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSM.Summary.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag7(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag7.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.Header.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag8(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag8.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSM.Summary.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag9(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag9.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSM.Links.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag10(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag10.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eSM.Selected.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag11(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag11.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("Common.Items.label", java.lang.String .class,"key"));
