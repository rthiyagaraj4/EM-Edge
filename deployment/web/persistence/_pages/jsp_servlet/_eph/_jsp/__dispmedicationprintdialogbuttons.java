...
public final class __dispmedicationprintdialogbuttons extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eph/jsp/DispMedicationPrintDialogButtons.jsp", 1740139865970L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\' onClick=\"if(validateRecordMandatory()){validateEditDetails(parent.editLabelFrame.document.DispMedicationEditLabel,\'PRINT_DIALOG\');};\" onKeyPress=\'ok_enter_event(event, this);\'>&nbsp;&nbsp;\n";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\n\t\t\t\t\t<input type = \"button\" name = \"disp_sheet\" value=\"Print Dispense Sheet\" onclick = \"printDispSheet();\">&nbsp;\n";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\n\t\t\t\t\t<input type=\"button\" name = \'btnCancel\' class=\"button\" value=\'";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\' onClick=\"if(validateRecordMandatory()){closePrintDialogWindow();}\">&nbsp;&nbsp;&nbsp;\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t\t</table>\n\n\n\t\n\t<script>\n\t\tdocument.frmPrintDialogButtons.btnOk.focus(); //Added for AMS-CRF-0009[IN:030935]\n\t</script>\n";
    ...
    private final static java.lang.String  _wl_block17 ="\"> <!-- Added for GHL-CRF-0669 -->\n\t\t\t\t\t\n</form></body>\n\n</html>\n\n";
