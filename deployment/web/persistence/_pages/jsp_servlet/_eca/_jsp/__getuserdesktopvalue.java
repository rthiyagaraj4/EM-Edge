...
public final class __getuserdesktopvalue extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/GetUserDesktopValue.jsp", 1709115895075L ,"10.3.6.0","Asia/Calcutta")) return true;
 ...
 String sStyle=(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css"; 
   ...
   String dev_tool="";
	...
	try
	{
		...
		//Statement stmt = con.createStatement();//common-icn-0180
		ResultSet rs;

		//sql ="select function_id, function_name from Sm_Function where module_id='" + module_id + "'  and desktop_appl_yn='Y'  order by  function_name";//common-icn-0180
		sql ="select function_id, function_name from Sm_Function where module_id= ?  and desktop_appl_yn='Y'  order by  function_name";//common-icn-0180
		...
		while(rs.next())
		{
			...
			if(rs!=null)rs.close();
			//if(stmt!=null)stmt.close();//common-icn-0180
...
/*
	...
	{ 
		//out.println("Exception in GetUserDesktopValue.jsp mode = function ..."+e.toString());//COMMON-ICN-0181
