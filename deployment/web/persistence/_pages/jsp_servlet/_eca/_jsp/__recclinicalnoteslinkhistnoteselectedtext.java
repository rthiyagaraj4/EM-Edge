...
public final class __recclinicalnoteslinkhistnoteselectedtext extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/RecClinicalNotesLinkHistNoteSelectedText.jsp", 1709116160482L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 ="\n</div> \n\n<input type=\"hidden\" name=\"inHTML\" id=\"inHTML\" value=\'";
	...
	buffer = buff.toString();
            ...
            out.print( String.valueOf(buffer));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(java.net.URLEncoder.encode(buffer)));
