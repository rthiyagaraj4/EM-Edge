...
public final class __casectiontemplatelinkingtoolbar extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CASectionTemplateLinkingToolbar.jsp", 1736786631112L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\" class=\"button\" onClick=\"callOnBack()\">&nbsp;<input type=\"button\" value=\"";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\" class=\"button\" onClick=\"callOnOk()\">&nbsp;<input type=\"button\" value=\"";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="\" class=\"button\" onClick=\"parent.window.close();\"></td>\n\t\t</tr> </table>\n\t\t<input name=qs type=hidden value=";
