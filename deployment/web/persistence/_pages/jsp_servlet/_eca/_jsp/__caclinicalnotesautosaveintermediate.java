...
import eCA.CAClinicalNotesAutoSaveBean;
import java.sql.*;
import java.util.*;
import eCA.*;
import java.net.*;
...
public final class __caclinicalnotesautosaveintermediate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CAClinicalNotesAutoSaveIntermediate.jsp", 1739448942040L ,"10.3.6.0","Asia/Calcutta")) return true;
