...
public final class __patalertqueryallergyresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/PatAlertQueryAllergyResult.jsp", 1731638983344L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\" == \"Y\")\t{\nparent.PatAlertQueryResult.location.href=\'PatAlertQueryResult.jsp?patient_id=";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="\'\n\t\t\tparent.PatAlertQueryAllergyClass.location.href=\'PatAlertQueryAllergyClass.jsp?radio_par=\'+selected_val+\'&patient_id=";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="&called_from_ip=";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\'\n\t\t\t}else{\n\t\t\t\t\ttop.content.workAreaFrame.PatAlertQueryResult.location.href=\'PatAlertQueryResult.jsp?patient_id=";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\'\n\t\t\ttop.content.workAreaFrame.PatAlertQueryAllergyClass.location.href=\'PatAlertQueryAllergyClass.jsp?radio_par=\'+selected_val+\'&patient_id=";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\'\n\t\t\t}\n\t\t}\n</script>\n<form name=\"radio\" id=\"radio\">\n<table align=\'center\' width=\'110%\' class=\'grid\'>\n\t<td class=\'columnHeader\'  colspan=2 style=\"background-color:#73a5ad; color: white;\"><font size=1>";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="</font><td>\n\t<tr onclick=\'javascript:refer(this)\'>\n\t\t<td class=\'gridData\' colspan=2 >\n\t\t<input type=\"radio\" name=\"allergies_radio\" id=\"allergies_radio\" class=\"label\" value=\"A\" onClick=\"CallDescFrame(this)\" checked ><font size=1>";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="</font>\n\t\t&nbsp&nbsp&nbsp&nbsp<input type=\"radio\" name=\"allergies_radio\" id=\"allergies_radio\" class=\"label\" value=\"O\" onClick=\"CallDescFrame(this)\"><font size=1>";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="</font>\n\t\t</td>\n\t</tr>\n\t<!--<tr>\n\t\t<td colspan=2 width=100% >\n\t\t\t<table align=center width=125% height=100% border=0 cellspacing=\'0\' cellpadding=\'3\' id=\'tab\'>\n\t\t\t<td class=\'columnHeadercenter\'    width=\'40%\' id=\'cw\'><font size=1>";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="</font></td>\n\t\t\t<td class=\'columnHeadercenter\'  ><font size=1>";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="</font></td>\n\t\t\t<td class=\'columnHeadercenter\'  id=\'h\'  ><font size=1>";
...
//	java.util.Properties p = (java.util.Properties) session.getValue( "jdbc" ) ;
    ...
    private boolean _jsp__tag3(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag3.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eCA.AllergicTo.label", java.lang.String .class,"key"));
