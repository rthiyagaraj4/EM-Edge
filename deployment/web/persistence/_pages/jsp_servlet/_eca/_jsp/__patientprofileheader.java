...
public final class __patientprofileheader extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/PatientProfileHeader.jsp", 1709115992607L ,"10.3.6.0","Asia/Calcutta")) return true;
...
try
{
	...
	if (oRs.next())
		patient_info = oRs.getString("Pline");
            ...
            out.print( String.valueOf(patient_info));
