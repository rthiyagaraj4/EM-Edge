...
public final class __viewchartcolortoolbar extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ViewChartColorToolBar.jsp", 1709116427729L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="\t\n\t<TABLE border=\"0\" cellpadding=3 cellspacing=\"0\"  width=\"100%\" >\n\t\t<TR>\n\t\t\t<TD align=\"center\">\n\t\t\t\t<TABLE border=\"0\" cellpadding=3 cellspacing=\"0\"  width=\"97%\" >\n\t\t\t\t\t<TR>\n\t\t\t\t\t\t<TD width=\"20%\" ><font style=\'background-color:";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 =";size:1;width:16px;height:16px\' >&nbsp;&nbsp;</font>&nbsp;<font size=1>";
    private final static byte[]  _wl_block9Bytes = _getBytes( _wl_block9 );

    private final static java.lang.String  _wl_block10 ="</font></TD>\n\t\t\t\t\t\t<TD width=\"20%\" ><font style=\'background-color:";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 ="</font></TD>\t\t\t\t\t\t\n\t\t\t\t\t\t<TD width=\"20%\" ><font style=\'background-color:#32CD32;size:1;width:16px;height:16px\' >&nbsp;&nbsp;</font>&nbsp;<font size=1>";
	...
	String sStyle =			(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
		...
		try{
            ...
            out.print( String.valueOf(lcCode ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(lsDesc));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(hcCode));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(hsDesc ));
            _bw.write(_wl_block11Bytes, _wl_block11);

            if (_jsp__tag0(request, response, pageContext, _activeTag, null))
             return;
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(clcCode ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(clDesc ));
            _bw.write(_wl_block10Bytes, _wl_block10);
            out.print( String.valueOf(chcCode ));
            _bw.write(_wl_block9Bytes, _wl_block9);
            out.print( String.valueOf(chDesc ));
            _bw.write(_wl_block12Bytes, _wl_block12);
            out.print( String.valueOf(asDesc ));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(ccCode ));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(csDesc ));
            _bw.write(_wl_block13Bytes, _wl_block13);
            out.print( String.valueOf(chcCode ));
            _bw.write(_wl_block14Bytes, _wl_block14);
            out.print( String.valueOf(chDesc ));
