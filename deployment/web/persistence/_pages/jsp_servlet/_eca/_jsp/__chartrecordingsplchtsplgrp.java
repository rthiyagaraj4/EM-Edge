...
public final class __chartrecordingsplchtsplgrp extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ChartRecordingSplChtSplGrp.jsp", 1709115682590L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block13 ="\'>\n\t\t\t\t<input type=\'hidden\' name=\'splChtType\' id=\'splChtType\' value=\'";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
            ...
            out.print( String.valueOf(splChtType));
