...
public final class __userprvlgtoprintandemailpract extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/UserPrvlgToPrintAndEMailPract.jsp", 1709116406542L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="\n\t\t\t</table>\n\t\t\t<input type=\'hidden\' name=\'privilegeFor\' id=\'privilegeFor\' value=\'";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="\'>\n\t\t\t<input type=\'hidden\' name=\'patMedicalReport\' id=\'patMedicalReport\' value=\'";
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
		...
		finally
		{
            ...
            out.print( String.valueOf(prvlgId));
