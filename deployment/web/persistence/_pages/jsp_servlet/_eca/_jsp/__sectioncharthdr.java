...
public final class __sectioncharthdr extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/SectionChartHdr.jsp", 1709116295167L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\' OnClick=\'setTimeout(\"searchChartSection()\",1000)\'>\n\t\t\t\t</td>\n\t\t\t </tr>\n\t\t\t </table>\n\t\t\t <!-- added by arvind @ 08-12-08 -->\n\n\t\t\t";
