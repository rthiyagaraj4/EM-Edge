...
public final class __caprintingemrpatientcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CAPrintingEmrPatientCriteria.jsp", 1742378857020L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block10 =" maxLength=\'20\' size=\'20\' onKeyPress=\"return CheckForSpecChars(event);\">\n\t\t\t\t\t\t\t\t<input type=\"button\" name=\"patient_search\" id=\"patient_search\" class=BUTTON value=\"?\" ";
    private final static byte[]  _wl_block10Bytes = _getBytes( _wl_block10 );

    private final static java.lang.String  _wl_block11 =" onClick=\"callPatientSearch()\" />\n\t\t\t\t\t\t</td>\t\t\n\t\t\t\t\t\t <td class=\'LABEL\' width=\'16%\'>";
    private final static byte[]  _wl_block11Bytes = _getBytes( _wl_block11 );

    private final static java.lang.String  _wl_block12 ="</td>\n\t\t\t\t\t\t <td class=\'fields\' width=\'16%\'>\n\t\t\t\t\t\t\t<input type=\"text\" maxlength=10 size=\"8\" value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' name=\"p_date_from\" id = \"p_date_from\" onBlur=\'chkDateTime(this,\"DMY\",\"";
    private final static byte[]  _wl_block13Bytes = _getBytes( _wl_block13 );

    private final static java.lang.String  _wl_block14 ="\"); \'><img src=\"../../eCommon/images/CommonCalendar.gif\"  onclick=\"return showCalendarValidate(\'p_date_from\');\" ><img src=\"../../eCommon/images/mandatory.gif\"></img>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t\t <td  class=label width=\'16%\'>";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="&nbsp;";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="\' name=\"p_date_to\" id = \"p_date_to\" onBlur=\'chkDateTime(this,\"DMY\",\"";
    private final static byte[]  _wl_block16Bytes = _getBytes( _wl_block16 );

    private final static java.lang.String  _wl_block17 ="\");\'><img src=\"../../eCommon/images/CommonCalendar.gif\"  onclick=\"return showCalendarValidate(\'p_date_to\');\" ><img src=\"../../eCommon/images/mandatory.gif\"></img>\n\t\t\t\t\t\t </td>\n\t\t\t\t\t</tr>\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<td></td><td></td><td></td><td></td><td></td>\n\t\t\t\t\t\t <td align=\'right\' class=\'button\'>\n\t\t\t\t\t\t <input type=\'button\' name=\'search\' id=\'search\' value=\'";
    private final static byte[]  _wl_block17Bytes = _getBytes( _wl_block17 );

    private final static java.lang.String  _wl_block18 ="\' class=\'button\' onClick=\'submitPage();\'>\n\t\t\t\t\t\t <input type=\'button\' name=\'clear\' id=\'clear\' value=\'";
    private final static byte[]  _wl_block18Bytes = _getBytes( _wl_block18 );

    private final static java.lang.String  _wl_block19 ="\' class=\'button\' onClick=\'clearAll();\'>\n\t\t\t\t\t\t </td>\n\t\t\t\t\t</tr>\n\t\t\t\t</table>\n\t\t\t\t  <input type=\'hidden\' name=\'facility_id\' id=\'facility_id\' value=\'";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="\'>\n\t\t\t\t  <input type=\'hidden\' name=\'clinicianId\' id=\'clinicianId\' value=\'";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="\'>  <!-- 32902 -->\n\t\t\t\t  <input type=\'hidden\' name=\'language_id\' id=\'language_id\' value=\'";
