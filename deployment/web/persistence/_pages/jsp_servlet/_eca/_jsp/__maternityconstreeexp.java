...
public final class __maternityconstreeexp extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/MaternityConsTreeExp.jsp", 1736157589838L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	localeName 		 = (localeName == null )?"en":localeName.toLowerCase();
		...
		String displayCollapse ="display";
            ...
            out.print( String.valueOf(displayExpand));
            _bw.write(_wl_block8Bytes, _wl_block8);
            out.print( String.valueOf(displayCollapse));
