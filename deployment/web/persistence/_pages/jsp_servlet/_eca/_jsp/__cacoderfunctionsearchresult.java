...
public final class __cacoderfunctionsearchresult extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CACoderFunctionSearchResult.jsp", 1709115493247L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block11 ="</th>\n\t\t\t\t\t\t\t\t<th width =\"30%\" class=\'COLUMNHEADER\'>";
    ...
    private final static java.lang.String  _wl_block14 ="\n\t\t\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t\t    \n\t\t\t\t\t\t\t\t\t<td class=\"gridData\" name=\"visit_date\" nowrap>";
    private final static byte[]  _wl_block14Bytes = _getBytes( _wl_block14 );

    private final static java.lang.String  _wl_block15 ="</td>\n\t\t\t\t\t\t\t\t\t<td class=\"gridData\" name=\"enc_id\" nowrap>";
    private final static byte[]  _wl_block15Bytes = _getBytes( _wl_block15 );

    private final static java.lang.String  _wl_block16 ="</td>\n\t\t\t\t\t\t\t\t\t<td class=\"gridData\" name=\"pat_id\" nowrap ><a href=\"javascript:callCoderFunction(\'";
    ...
    private final static java.lang.String  _wl_block19 ="</a></td>\n\t\t\t\t\t\t\t\t\t<td class=\"gridData\" name=\"pat_name\" nowrap >";
    private final static byte[]  _wl_block19Bytes = _getBytes( _wl_block19 );

    private final static java.lang.String  _wl_block20 ="&nbsp;</td>\n\t\t\t\t\t\t\t\t\t<td class=\"gridData\" name=\"gender\" nowrap >";
    private final static byte[]  _wl_block20Bytes = _getBytes( _wl_block20 );

    private final static java.lang.String  _wl_block21 ="</td>\n\t\t\t\t\t\t\t\t\t<td class=\"gridData\" name=\"pract_name\" nowrap>";
    private final static byte[]  _wl_block21Bytes = _getBytes( _wl_block21 );

    private final static java.lang.String  _wl_block22 ="</td>\n\t\t\t\t\t\t\t\t\t<td class=\"gridData\" name=\"blgp_id\" nowrap >";
    private final static byte[]  _wl_block22Bytes = _getBytes( _wl_block22 );

    private final static java.lang.String  _wl_block23 ="</td>\n\t\t\t\t\t\t\t\t\t<td class=\"gridData\" name=\"coder_status\" nowrap>";
...
String sStyle =			(session.getAttribute("PREFERRED_STYLE")!=null)||(session.getAttribute("PREFERRED_STYLE")!="")?(String)session.getAttribute("PREFERRED_STYLE"):"IeStyle.css";
	...
	String pat_id ="",enc_id="",pat_calss ="";
 		...
 		if( result.size()>0 ){
            ...
            out.print( String.valueOf((String)result.get(recCount)));
            _bw.write(_wl_block15Bytes, _wl_block15);
            out.print( String.valueOf((String)result.get(recCount+1)));
            _bw.write(_wl_block16Bytes, _wl_block16);
            out.print( String.valueOf(pat_id));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(enc_id));
            _bw.write(_wl_block17Bytes, _wl_block17);
            out.print( String.valueOf(pat_calss));
            _bw.write(_wl_block18Bytes, _wl_block18);
            out.print( String.valueOf((String)result.get(recCount+2)));
            _bw.write(_wl_block19Bytes, _wl_block19);
            out.print( String.valueOf((String)result.get(recCount+3)));
            _bw.write(_wl_block20Bytes, _wl_block20);
            out.print( String.valueOf((String)result.get(recCount+4)));
            _bw.write(_wl_block21Bytes, _wl_block21);
            out.print( String.valueOf((String)result.get(recCount+5)));
            _bw.write(_wl_block22Bytes, _wl_block22);
            out.print( String.valueOf((String)result.get(recCount+6)));
            _bw.write(_wl_block23Bytes, _wl_block23);
            out.print( String.valueOf((String)result.get(recCount+7)));
...
putObjectInBean(bean_id,bean,request); 
    ...
    private boolean _jsp__tag5(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag5.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eCA.DoctorName.label", java.lang.String .class,"key"));
    ...
    private boolean _jsp__tag7(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.jsp.PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, javax.servlet.jsp.tagext.JspTag parent) throws java.lang.Throwable
    {
        ...
        __tag7.setKey(( java.lang.String ) weblogic.jsp.internal.jsp.utils.JspRuntimeUtils.convertType("eCA.CodingStatus.label", java.lang.String .class,"key"));
