...
public final class __recclinicalnotestree extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/RecClinicalNotesTree.jsp", 1709116203950L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block9 ="\">\n\t<table cellspacing=0 cellpadding=\'3\' width=\'100%\' border=1 id=\'tb1\'>\n";
			...
			while (rs.next())
			{
				...
				if(recordCounter > 0)
				{
					...
					if(!eventdatePrev.equals("") && !preveventdate.equals(eventdatePrev))
					{
						...
						{
							out.println("<tr><td colspan=1 onClick=\"javascript:showDetails('"+valuePrev.toString()+"','Heading')\" class='COMMONTOOLBARFUNCTION'><font size=1>"+eventdatePrev+"</font></td><td class='COMMONTOOLBARFUNCTION'><input type='checkbox'   onClick=CheckAllClass('"+newEventGroupCodePrev+"','"+eventDateWithoutSlashPrev+"','"+newEventClassCodePrev+"',this)></td></tr>");
						}
					...
					if(!newEventClassCodePrev.equals("") && (!preveventclassCode.equals(newEventClassCodePrev) ||!preveventdate.equals(eventdatePrev)))
					{
						...
						{
							out.println("<tr><td colspan=1 onClick=\"javascript:showDetails('"+valuePrev.toString()+"','Heading')\" class='CAGROUP'><font size=1>"+eventclassdescPrev+"</font></td><td class='CAGROUP'><input type='checkbox'   value='"+newEventClassCodePrev+"~"+newEventGroupCodePrev+"' title='"+eventTimeWithoutColonPrev+"' name='a"+eventDateWithoutSlashPrev+counterForClass+"' id='a"+eventDateWithoutSlashPrev+counterForClass+"' onClick=CheckAllGroup('"+newEventGroupCodePrev+"','"+eventDateWithoutSlashPrev+"','"+newEventClassCodePrev+"',this,"+counterForClass+")></td></tr>");
						}
						j++;
					...
					if ( result_linked_rec_type.equals("DIAG")||result_linked_rec_type.equals("MEDN") )
					{
						out.println("<tr id='tblrow_id"+l+"' title='"+prevMedType+"'><td class='"+classValue+"'><font size=1>"+"&nbsp;&nbsp;"+eventcodedescPrev+"</font></td><td class='"+classValue+"'><input type='checkbox' name='checkBoxEventCode_"+l+"' id='checkBoxEventCode_"+l+"' id='"+accessionnumPrev+"' value='"+valuePrev.toString()+"' onClick='OnCheckBoxClick(this)'></td></tr>");
					}
					else
					{
