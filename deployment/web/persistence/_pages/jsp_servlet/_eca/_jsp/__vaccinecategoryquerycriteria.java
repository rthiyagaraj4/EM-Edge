...
public final class __vaccinecategoryquerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/VaccineCategoryQueryCriteria.jsp", 1709116413370L ,"10.3.6.0","Asia/Calcutta")) return true;
...
try
	{
		...
		firstItem.add("Text"); 
        firstItem.add(com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eCA.CategoryId.label","ca_labels"));     // label
        firstItem.add("vaccine_Category_id");   //name of field
		...
		orderByCols[0] = com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eCA.CategoryId.label","ca_labels") ;
