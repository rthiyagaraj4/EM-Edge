...
public final class __consultationtaggingquery extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ConsultationTaggingQuery.jsp", 1742180261711L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 ="</td>\n\t\t\t\t\t<td class=\'fields\' align=\'center\' width=\'18%\'><input type=\'text\' id=\'patient_id\' name=\'patient_id\' id=\'patient_id\'  value=\'";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\' maxLength=\'16\' size=\'16\' onKeyPress=\"return CheckForSpecChars(event);\"><input type=\"button\" id=\"patient_search\" name=\"patient_search\" id=\"patient_search\" class=BUTTON value=\"?\" onClick=\"callPatientSearch()\">\n\t\t\t\t\t<img src=\"../../eCommon/images/mandatory.gif\"></img></td>\n\t\t\t\t\t\n\t\t\t\t\t\t<td></td><td></td>\n\t\t\t\t\t\t <td align=\'center\'>\n\t\t\t\t\t\t <input type=\'button\' name=\'search\' id=\'search\' value=\'";
