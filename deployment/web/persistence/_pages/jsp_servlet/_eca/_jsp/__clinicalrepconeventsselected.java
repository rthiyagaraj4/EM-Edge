...
public final class __clinicalrepconeventsselected extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ClinicalRepConEventsSelected.jsp", 1709115750730L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block14 ="\" checked  onClick=\"selTextrelink(this)\" value=\"";
	  ...
	  for(int l=0;l<RelinkBean.getSize();l+=2)
	   {
			...
			if(remval.equalsIgnoreCase(code2))
			{
				...
				d=RelinkBean.getRecordSetHandle();
				int size=0;
				size=d.size();
				d.clear();*/
				w=0;
...
if(mode.equals("ins"))
	...
	{
	//out.println("Exception in FlowSheetApplicabilityIntermediate.jsp:"+eee.toString());//common-icn-0181
       eee.printStackTrace();//COMMON-ICN-0181
	}
	finally
	{
