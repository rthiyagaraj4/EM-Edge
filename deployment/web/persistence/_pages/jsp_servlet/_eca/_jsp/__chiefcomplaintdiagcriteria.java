...
public final class __chiefcomplaintdiagcriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/ChiefComplaintDiagCriteria.jsp", 1709115719918L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block12 ="\n\t\t</select><img src=\'../../eCommon/images/mandatory.gif\'></td>\t\t\n\t\t<td colspan=2></td>\n\t\t\n\t\t<td> <input type=\'button\' name=\'search\' id=\'search\' class=\'Button\' value=\'";
    private final static byte[]  _wl_block12Bytes = _getBytes( _wl_block12 );

    private final static java.lang.String  _wl_block13 ="\' onClick=\"populate()\"> </input></td>\n\t\t</tr>\n\t</table>\n\t<!-- added by arvind @ 07-12-08 -->\n\n\t\t\t";
