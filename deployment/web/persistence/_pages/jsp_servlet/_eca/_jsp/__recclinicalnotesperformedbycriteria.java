...
public final class __recclinicalnotesperformedbycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/RecClinicalNotesPerformedByCriteria.jsp", 1721131841674L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block8 =" </td>\n       <td colspan=3 class=\'fields\' width=\'25%\' align=\"center\"><input type=\"radio\" name=\"search_by\" id=\"search_by\" value=\"D\"  checked  onclick=\"\tdocument.RecClinicalNotesPerformedByCriteriaForm.radBtnVal.value = this.value;\">";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="\n        <input type=\"radio\" name=\"search_by\" id=\"search_by\" class=\"label\" value=\"C\" onclick=\"\tdocument.RecClinicalNotesPerformedByCriteriaForm.radBtnVal.value = this.value;\">";
