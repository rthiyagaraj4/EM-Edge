...
public final class __tasklistbtrequirementdtls extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/TaskListBTRequirementDtls.jsp", 1709116384449L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	sql = "SELECT A.REQUIREMENT_CODE REQUIREMENT_CODE1,A.SHORT_DESC SHORT_DESC1 FROM BT_TRANSFUSE_REQ_LANG_VW A, BT_PATIENT_REQUIREMENT B WHERE A.REQUIREMENT_CODE = B.REQUIREMENT_CODE AND B.PATIENT_ID = ? and A.Language_id = ?";
	   ...
	   rs = pstmt.executeQuery();
	   	while(rs!=null && rs.next())
		{
            ...
            out.print( String.valueOf(requirement_code));
