...
public final class __commonstaticcalenderglad extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CommonStaticCalenderGlad.jsp", 1709115772638L ,"10.3.6.0","Asia/Calcutta")) return true;
        return false;
    }
    ...
    private final static java.lang.String  _wl_block4 ="\n</form>\n</Body>\n\t\t<script type=\"text/javascript\" src=\"../../eCA/js/calScript/";
    private final static byte[]  _wl_block4Bytes = _getBytes( _wl_block4 );

    private final static java.lang.String  _wl_block5 ="/calendar.js\"></script>\n\t\t<script type=\"text/javascript\" src=\"../../eCommon/js/common.js\"></script>\n<script src=\'../../eCommon/js/showModalDialog.js\' language=\'JavaScript\'></script>\n\n\t\t<script>\n\t\tbasicTheme = \'";
    private final static byte[]  _wl_block5Bytes = _getBytes( _wl_block5 );

    private final static java.lang.String  _wl_block6 ="\'\n\t\tgenerateCalendar(\"\",\"\",\"\",\"destination\",\"\",\"\",\"\",\"";
