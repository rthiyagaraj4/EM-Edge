...
public final class __catabinsuranceform extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/CATabInsuranceForm.jsp", 1738424480425L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block17 ="&Param=PAT_PHOTO\' width=\"400\" border=0 height=\"250\"></td>\n\t\t\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t\t\t<td class=\"borderBot content-txt \">Card ID Number : ";
    ...
    private final static java.lang.String  _wl_block39 ="> MRI <input type=\"checkbox\" name=\"checkbox13\" id=\"checkbox13\" ";
    private final static byte[]  _wl_block39Bytes = _getBytes( _wl_block39 );

    private final static java.lang.String  _wl_block40 =" id=\"checkbox13\"> CT\n\t\t\t\t\t\t\t\t\t\t\tScan <input type=\"checkbox\" name=\"checkbox14\" id=\"checkbox14\" id=\"checkbox14\" ";
    private final static byte[]  _wl_block40Bytes = _getBytes( _wl_block40 );

    private final static java.lang.String  _wl_block41 =">\n\t\t\t\t\t\t\t\t\t\t\tPhysiotherapy <input type=\"checkbox\" name=\"checkbox15\" id=\"checkbox15\"\n\t\t\t\t\t\t\t\t\t\t\tid=\"checkbox15\" ";
    private final static byte[]  _wl_block41Bytes = _getBytes( _wl_block41 );

    private final static java.lang.String  _wl_block42 ="> Home Nursing <input type=\"checkbox\"\n\t\t\t\t\t\t\t\t\t\t\tname=\"checkbox16\" id=\"checkbox16\" id=\"checkbox16\" ";
    private final static byte[]  _wl_block42Bytes = _getBytes( _wl_block42 );

    private final static java.lang.String  _wl_block43 ="> Endoscopy <input type=\"checkbox\" name=\"checkbox17\" id=\"checkbox17\" id=\"checkbox17\" ";
    private final static byte[]  _wl_block43Bytes = _getBytes( _wl_block43 );

    private final static java.lang.String  _wl_block44 =">\n\t\t\t\t\t\t\t\t\t\t\tOthers\n\t\t\t\t\t\t\t\t\t</label></td>\n\t\t\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t\t\t<td colspan=\"4\" class=\" content-txt \">Specify:\n\t\t\t\t\t\t\t\t\t\t";
    private final static byte[]  _wl_block44Bytes = _getBytes( _wl_block44 );

    private final static java.lang.String  _wl_block45 ="__________________________________________________________________________";
