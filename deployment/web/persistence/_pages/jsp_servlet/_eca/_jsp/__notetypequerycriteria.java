...
public final class __notetypequerycriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/NoteTypeQueryCriteria.jsp", 1709115969108L ,"10.3.6.0","Asia/Calcutta")) return true;
...
if(isClinician)//IN067236 starts
thirdItem.add("'',"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.all.label","common_labels")+",PHY$,"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.practitioner.label","common_labels")+",NUR$,"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Nursing.label","common_labels")+",CLI$,"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"eCA.Therapist.label","common_labels")+"");
else
	thirdItem.add("'',"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.all.label","common_labels")+",PHY$,"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.practitioner.label","common_labels")+",NUR$,"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Nursing.label","common_labels")+",CLI$,"+com.ehis.util.BundleMessage.getBundleMessage(pageContext,"Common.Clinician.label","common_labels")+"");//IN067236 ends
