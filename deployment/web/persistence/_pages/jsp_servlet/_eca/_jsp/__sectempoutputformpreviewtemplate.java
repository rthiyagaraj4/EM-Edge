...
public final class __sectempoutputformpreviewtemplate extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/eca/jsp/SecTempOutputFormPreviewTemplate.jsp", 1733285686382L ,"10.3.6.0","Asia/Calcutta")) return true;
	...
	public ArrayList getTemplateValues(String field_mnemonic_type) throws Exception {
		...
		try {
				...
				pstmt		= connection.prepareStatement("SELECT field_mnemonic_desc,field_mnemonic,field_mnemonic_type,field_mnemonic_data_type,field_mnemonic_query FROM or_order_mnemonic WHERE eff_Status = 'E' and field_mnemonic_type = ? ORDER BY srl_no") ;
...
response.addHeader("X-Content-Type-Options", "nosniff"); //MMS-ME-SCF-0085
	...
	templateValues		= getTemplateValues("P"); 
	...
	templateValues		= getTemplateValues("E"); 
	if(templateValues!=null && templateValues.size()>0) {  		 
