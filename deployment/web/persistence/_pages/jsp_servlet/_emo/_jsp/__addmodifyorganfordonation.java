...
public final class __addmodifyorganfordonation extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emo/jsp/addModifyOrganForDonation.jsp", 1709118396228L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block6 ="\'></link>\n\n<script src=\"../js/MOOrganForDonation.js\" language=\"javascript\"></script>\n<link rel=\'stylesheet\' type=\'text/css\' href=\'../../eCommon/html/";
    private final static byte[]  _wl_block6Bytes = _getBytes( _wl_block6 );

    private final static java.lang.String  _wl_block7 ="\'></link>\n<script src=\'../../eCommon/js/ValidateControl.js\' language=\'javascript\'></script>\n<script src=\'../../eCommon/js/common.js\' language=\'javascript\'></script>\n<script src=\'../../eCommon/js/showModalDialog.js\' language=\'JavaScript\'></script>\n\n\n</head>\n\n <body onLoad=\'FocusFirstElement()\' OnMouseDown=\'CodeArrest()\' onKeyDown = \'lockKey()\'>\n";
    private final static byte[]  _wl_block7Bytes = _getBytes( _wl_block7 );

    private final static java.lang.String  _wl_block8 ="\n<form name=\"MOOrganForDonat_form\" id=\"MOOrganForDonat_form\"  action=\'../../servlet/eMO.MOOrganForDonationServlet\' method=\'post\' target=\'messageFrame\'>\n<br><br><br><br><br><br><br><br><br><br>\n\n\t<table cellspacing=0 cellpadding=5 align=\"center\" width=\"80%\" border=\"0\">\n\t<tr>\n\t\t<td class=\"label\" width=\"40%\">";
    private final static byte[]  _wl_block8Bytes = _getBytes( _wl_block8 );

    private final static java.lang.String  _wl_block9 ="</td>\n\t\t<td class=\'fields\'><input type=\"text\" name=\"organ_code\" id=\"organ_code\" size=\"4\" maxlength=\"4\" value=\"";
    ...
    private final static java.lang.String  _wl_block19 =" onClick=\"change()\"></td>\n\t</tr>\n\t</table>\n\n ";
   ...
   StringBuffer sql=new  StringBuffer();
	code=request.getParameter("organ_code");
	if(code==null){
	code="";
	long_desc="";
	short_desc="";
	...
	ResultSet rset=null;
     try{
	sql.setLength(0);
	sql.append("select ORGAN_CODE,LONG_DESC,SHORT_DESC,EFF_STATUS from MO_ORGAN_FOR_DONATION where ORGAN_CODE=?");
	pstmt = conn.prepareStatement(sql.toString());
	pstmt.setString(1,code);
	rset = pstmt.executeQuery();
	rset.next();
	code=rset.getString("ORGAN_CODE");
