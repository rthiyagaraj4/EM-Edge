...
public final class __getclaim extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/emo/jsp/GetClaim.jsp", 1709118398541L ,"10.3.6.0","Asia/Calcutta")) return true;
  ...
  con = ConnectionManager.getConnection(request);
	...
	//{
		...
		if(claimcode==null)claimcode="";
            ...
            out.print( String.valueOf(cmgfrmbdypart));
...
rs4=pstmt4.executeQuery();
		...
		{int i=0;
            ...
            out.print( String.valueOf(claimcode));
