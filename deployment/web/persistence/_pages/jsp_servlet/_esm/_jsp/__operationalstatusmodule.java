...
public final class __operationalstatusmodule extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/esm/jsp/OperationalStatusModule.jsp", 1709121708307L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block20 ="\' id=\'chbox";
	...
	try
	{
	   ...
	   String modId="";	
            ...
            out.print( String.valueOf( disableData));
