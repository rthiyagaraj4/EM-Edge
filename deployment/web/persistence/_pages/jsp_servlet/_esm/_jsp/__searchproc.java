...
public final class __searchproc extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/esm/jsp/SearchProc.jsp", 1742365935999L ,"10.3.6.0","Asia/Calcutta")) return true;
  ...
  try
	...
	if (count==0)
		...
		rs = stmt.executeQuery(strsql2);
            ...
            out.print( String.valueOf(proc_id+"/"+long_desc+"/"+proc_srt_cmd));
