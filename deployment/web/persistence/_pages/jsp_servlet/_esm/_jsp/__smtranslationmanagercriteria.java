...
public final class __smtranslationmanagercriteria extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/esm/jsp/SMTranslationManagerCriteria.jsp", 1711346555654L ,"10.3.6.0","Asia/Calcutta")) return true;
    ...
    private final static java.lang.String  _wl_block32 ="\'  class=button onClick=\'showResultPage()\'>\n\t\t  <!--&nbsp;-->\n\t\t  <INPUT TYPE=\"button\"  class=button name=\"clear\" id=\"clear\" value=\'";
    private final static byte[]  _wl_block32Bytes = _getBytes( _wl_block32 );

    private final static java.lang.String  _wl_block33 ="\' onClick=\'clearData()\' ></td>\n\t\t  </tr>\n\t\t   <input type=\'hidden\' name=\'language_direction\' id=\'language_direction\' value=\"\">\n\n\t\t<tr><td colspan=4 ></td></tr>\n ";
